...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let h=u.querySelector(".cw-hero-grid"),y=u.querySelector(".cw-acc-container"),b=u.querySelector(".cw-results-container"),m=u.querySelector(".cw-search-input"),k=u.querySelector(".cw-status-bar"),C=u.querySelector(".cw-status-text"),F=u.querySelector(".cw-footer-icons");s.forEach(([_,q])=>{let B=i(q.name),X=document.createElement("div");X.className="cw-hero-card",X.id=`hero-${_}`,X.style.setProperty("--hero-color",B.color),X.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(m,k)=>{P.playClick(),a.querySelector(`.${m}`).classList.toggle("active"),k()};if(a.querySelector(".notes").onclick=m=>{m.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=m=>{m.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=m=>{m.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=m=>{m.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=m=>{m.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=m=>{m.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=m=>{m.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=m=>{m.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=m=>{m.stopPropagation(),i("broadcast",()=>{let k=m.currentTarget.querySelector(".cw-badge");k&&k.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(m=>{m.addEventListener("mouseenter",()=>P.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let m=document.createElement("div");m.className="cw-badge",a.querySelector(".broadcast").appendChild(m)}let s=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(s=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{s&&clearTimeout(s)},(async function(){let k=()=>{let F=be();if(F){let j=F.split("@")[0].toLowerCase();if(bt.includes(j)){let M=a.querySelector("#cw-admin-tag");M&&M.classList.add("visible")}}else setTimeout(k,2e3)};k(),await ot(2800),a.classList.add("docked"),await ot(300);let C=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(F=>F.classList.add("visible"));for(let F=0;F<C.length;F++)C[F].classList.add("popped"),await ot(40);await ot(100),a.classList.add("system-check"),await ot(100),a.classList.add("system-ready"),setTimeout(()=>a.classList.remove("system-ready"),400)})();let r=!1,c,u,d,p,h=3;a.onmousedown=m=>{if(m.target.closest("button"))return;m.preventDefault(),c=m.clientX,u=m.clientY;let k=a.getBoundingClientRect();d=k.left,p=k.top,document.addEventListener("mousemove",y),document.addEventListener("mouseup",b)};function y(m){let k=m.clientX-c,C=m.clientY-u;!r&&Math.sqrt(k*k+C*C)>h&&(r=!0,a.classList.add("dragging"),a.style.transition="none",s&&clearTimeout(s)),r&&(a.style.left=`${d+k}px`,a.style.top=`${p+C}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function b(m){if(document.removeEventListener("mousemove",y),document.removeEventListener("mouseup",b),r){r=!1,a.classList.remove("dragging");let k=window.innerWidth,C=window.innerHeight,F=a.getBoundingClientRect(),j=F.left+F.width/2,M;j<k/2?(M=24,a.classList.remove("side-right"),a.classList.add("side-left")):(M=k-F.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let Q=Math.max(24,Math.min(F.top,C-F.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.3s cubic-bezier(0.4, 0, 0.2, 1), top 0.3s cubic-bezier(0.4, 0, 0.2, 1)","important"),a.style.left=`${M}px`,a.style.top=`${Q}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let k=a.querySelector(".cw-btn.active"),C=m.target.closest("button");if(a.classList.contains("collapsed")){let F=a.getBoundingClientRect(),j=window.innerHeight,M=F.top>j/2;if(a.style.setProperty("transition","none","important"),M){let Q=j-F.bottom;a.style.top="auto",a.style.bottom=`${Q}px`}else a.style.bottom="auto",a.style.top=`${F.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),P.playGenieOpen()}else!k&&!C&&(a.classList.add("collapsed"),P.playGenieOpen());C&&(C.style.transform="scale(0.9)",setTimeout(()=>C.style.transform="",150))}}}function at(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,te("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let s=Date.now()-n,r=Math.max(0,2e3-s);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let c=o.querySelector(".cw-center-dots"),u=o.querySelector(".cw-center-text"),d=o.querySelector(".cw-center-success"),p=o.querySelector(".cw-abort-btn");c&&(c.style.display="none"),u&&(u.style.display="none"),p&&(p.style.display="none"),d&&d.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},r)}}function go(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let u=document.createElement("div");u.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",u.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let d=document.createElement("button");d.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',d.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",d.onmouseenter=()=>d.style.background="#F1F3F4",d.onmouseleave=()=>d.style.background="transparent",d.onclick=()=>h(!1),u.appendChild(d);let p=document.createElement("div");p.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",c.appendChild(u),c.appendChild(p);function h(b){let m=c.style.transform==="translateY(0%)";(b!==void 0?b:!m)?(y(),c.style.transform="translateY(0%)"):c.style.transform="translateY(110%)"}function y(){let b=xe.getAll();if(p.innerHTML="",b.length===0){p.innerHTML=`
                ...
                </div>`;return}b.forEach(m=>{let k=document.createElement("div");k.style.cssText=`
...
`.replace(/\n/g,"<br>");nt(_);let q=await yt();q?(q.innerText.trim()===""&&(q.innerHTML=""),document.execCommand("insertHTML",!1,_),ht(q),te("Nota gerada e inserida!")):te("Copiado! Abra uma nota para colar.")},e}var he=t=>new Promise(e=>setTimeout(e,t));function Se(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function qe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function vt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ge(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let d=e.getBoundingClientRect();s=d.left+d.width/2,r=d.top+d.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let c=i.x-s,u=i.y-r;t?(P.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof vo=="function"&&vo(e,o)):(P.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Mt=="function"&&Mt(e))}function vo(t,e){Mt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Mt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function wo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=io(t,X),s=uo(g),r=po(()=>{R(),W.setActiveTasks(r.getCheckedElements())},g,W),c=document.createElement("div");c.style.display="none";let u=co((x,O)=>{N(x,O)});c.appendChild(u);let d=document.createElement("div");d.id="evidence-container",Object.assign(d.style,{display:"none",marginTop:"16px",padding:"16px",background:H.bgInput,border:`1px solid ${H.border}`,borderRadius:ue.medium,boxShadow:Re.subtle});let p=document.createElement("div");p.className="cw-section-title",p.textContent=g("evidencias_contato"),d.appendChild(p);let h={},y=(x,O)=>{let $=document.createElement("div");$.style.marginBottom="12px";let J=document.createElement("label");J.textContent=O,J.setAttribute("for",x),J.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${H.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let V=document.createElement("input");return V.type="text",V.id=x,V.className="cw-input",V.placeholder="https://screenshot.googleplex.com/...",V.style.marginBottom="0",$.appendChild(J),$.appendChild(V),h[x]=V,$};d.appendChild(y("evidence-l1",g("ligacao_1"))),d.appendChild(y("evidence-l2",g("ligacao_2"))),d.appendChild(y("evidence-msg",g("mensagem_am")));let b=go({onSaveCurrent:async()=>{let x=await v();return w(),x},onLoadDraft:x=>{S(x)},t:x=>g(x)}),m=L(),k=z(),C=document.createElement("div"),F=U(),j=K(b,g);o.appendChild(m),o.appendChild(k),o.appendChild(F),o.appendChild(c),o.appendChild(C),o.appendChild(d),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let M=document.createElement("button");M.id="manual-task-toggle",M.textContent=g("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",M.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${H.primary}; background: ${H.surface}; color: ${H.primary}; border-radius: ${ue.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${le}; text-transform: uppercase; letter-spacing: 0.5px;`,M.onmouseenter=()=>{M.style.background=H.primaryBg},M.onmouseleave=()=>{M.style.background=H.surface},M.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",M.style.display="none"},o.appendChild(M),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(j);let Q=document.createElement("div");Q.style.display="none",Q.style.flexGrow="1",Q.style.minHeight="0",Q.style.overflow="hidden";let ae=xo(()=>G());ae.style.height="100%",Q.appendChild(ae),e.insertBefore(Q,i);let _=a.lastElementChild;_&&(_.insertBefore(b.historyBtnWrapper,_.firstChild),_.insertBefore(T(),_.firstChild)),e.appendChild(b.drawer);let q=null;W.subscribe(x=>{ee(x),B(),x.isDirty?(q&&clearTimeout(q),q=setTimeout(async()=>{let O=await v(!0);O.subStatus?xe.saveEmergency(O):xe.clearEmergency(),x.isDirty=!1},2e3)):q&&(clearTimeout(q),q=null)});function B(){let x=xe.getCount()>0,O=!!W.currentSubStatus;ft(x||O)}function X(){W.visible=!W.visible,ge(W.visible,e,"cw-btn-notes")}function G(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",Q.style.display="flex",Q.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",Q.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function L(){let x=document.createElement("div");if(x.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let $=document.createElement("style");$.id="cw-segmented-styles",$.innerHTML=`
            ...
            `,document.head.appendChild($)}let O=($,J)=>{let oe=x.querySelector(`#${$}`).querySelector(".cw-segmented-indicator");oe&&(oe.style.transform=`translateX(${J*100}%) translateX(${J*2}px)`)};return x.querySelectorAll("#lang-selector button").forEach(($,J)=>{$.onclick=()=>{W.setLanguage($.dataset.lang),x.querySelectorAll("#lang-selector button").forEach(V=>V.classList.remove("active")),$.classList.add("active"),O("lang-selector",J),P.playHover(),W.currentSubStatus&&A(W.currentSubStatus)}}),x.querySelectorAll("#type-selector button").forEach(($,J)=>{$.onclick=()=>{W.setCaseType($.dataset.type),x.querySelectorAll("#type-selector button").forEach(V=>V.classList.remove("active")),$.classList.add("active"),O("type-selector",J),P.playHover(),W.currentSubStatus&&A(W.currentSubStatus)}}),x.querySelectorAll("#portugal-selector button").forEach(($,J)=>{$.onclick=()=>{W.setPortugalCase($.dataset.val==="true"),x.querySelectorAll("#portugal-selector button").forEach(V=>V.classList.remove("active")),$.classList.add("active"),O("portugal-selector",J),P.playHover(),W.currentSubStatus&&A(W.currentSubStatus)}}),x}function z(){let x=document.createElement("div");x.className="cw-status-section",x.style.cssText="display: flex; flex-direction: column; gap: 8px;",x.innerHTML=`
        ...
        `;let O=x.querySelector("#main-status-select"),$=x.querySelector("#sub-status-select");return O.onchange=()=>{W.setStatus(O.value),f(O.value,$),W.setSubStatus(""),A("")},$.onchange=()=>{W.setSubStatus($.value),A($.value)},x}function D(){return d.style.display==="none"?null:{l1:h["evidence-l1"]?.value.trim()||"",l2:h["evidence-l2"]?.value.trim()||"",msg:h["evidence-msg"]?.value.trim()||""}}function f(x,O){if(O.innerHTML=`<option value="">${g("select_substatus")}</option>`,!x){O.disabled=!0;return}for(let $ in Oe)if(Oe[$].status===x){let J=document.createElement("option");J.value=$,J.textContent=Oe[$].name,O.appendChild(J)}O.disabled=!1}function A(x){let O=Oe[x],$=x==="NI_Attempted_Contact"||O&&O.name&&O.name.toLowerCase().includes("attempted contact");if(u.render&&u.render(x,W.currentCaseType),!x){d.style.display="none",h["evidence-l1"]&&(h["evidence-l1"].value=""),h["evidence-l2"]&&(h["evidence-l2"].value=""),h["evidence-msg"]&&(h["evidence-msg"].value=""),c.style.display="none",C.style.display="none";let re=document.getElementById("manual-task-toggle");re&&(re.style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",F.style.display="flex",F.style.opacity="1",j.style.display="none";return}$?d.style.display="block":(d.style.display="none",h["evidence-l1"]&&(h["evidence-l1"].value=""),h["evidence-l2"]&&(h["evidence-l2"].value=""),h["evidence-msg"]&&(h["evidence-msg"].value="")),F.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(F.style.display="none")},400),j.style.display="grid",O&&O.templateFields&&W.setActiveFields(O.templateFields),l(),Ot(x,C,W),C.style.display="block",c.style.display="block";let J=x.startsWith("SO_"),V=x==="NI_Awaiting_Validation",oe=document.getElementById("manual-task-toggle");J||V?(r.selectionElement.style.display="block",oe.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",oe.style.display="block");let Y=x==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(Y),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(x),R();let ne=document.getElementById("email-automation-toggle-row");ne&&(ne.style.display=We[x]?"flex":"none")}function R(){let x=r.getCheckedElements().map(O=>O.value);s.updateVisibility(W.currentSubStatus,x)}function N(x,O){let $=ut[x];if($){for(let J in $)if(J==="linkedTask")r.toggleTask($.linkedTask,O);else if(J==="activeTasks")$.activeTasks.forEach(V=>{O?r.setTaskCount(V.value,V.count):r.setTaskCount(V.value,0)});else if(J.startsWith("field-")){let V=J,oe=$[J],Y=document.getElementById(V);if(Y){let ne=Xe.includes(V.replace("field-",""));if(O)if(ne){let re=Y.value.trim();re.includes(oe.trim())||(Y.value=re?re+`
...
`))}else Y.value.trim()===oe.trim()&&(Y.value="");W.updateField(V,Y.value),Y.dispatchEvent(new Event("input"))}}}}function K(x,O){let $=document.createElement("div");if($.className="cw-actions-section",$.style.cssText=`
        ...
        `;let V=x.parkButton;V.classList.add("js-btn-park"),V.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let oe=document.createElement("button");oe.className="cw-btn-secondary js-btn-reset",oe.textContent=O("limpar"),oe.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.textSub}; border: 1px solid ${H.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,oe.onclick=()=>w();let Y=document.createElement("button");Y.className="cw-btn-secondary js-btn-copy",Y.textContent=O("copiar"),Y.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.primary}; border: 1px solid ${H.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,Y.onclick=()=>I();let ne=document.createElement("button");return ne.className="cw-btn-primary js-btn-generate",ne.textContent=O("preencher"),ne.style.cssText=`width: 100%; height: 38px; background: ${H.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ne.onclick=()=>Z(),$.appendChild(J),$.appendChild(V),$.appendChild(oe),$.appendChild(Y),$.appendChild(ne),$}async function I(){if(!W.currentSubStatus){te(g("select_substatus"),{error:!0});return}let x=qt(W,r,s,D());x?(nt(x),te(g("copiado_sucesso")),P.playClick()):te(g("select_substatus"),{error:!0})}async function Z(){if(!W.currentSubStatus){te(g("select_substatus"),{error:!0});return}let x=qt(W,r,s,D());nt(x),X();let O=at(),$=await yt();if($){$.focus(),document.execCommand("insertHTML",!1,x),ht($);let J=document.getElementById("email-automation-checkbox");(!J||J.checked)&&W.currentSubStatus&&We[W.currentSubStatus]&&await St(We[W.currentSubStatus]),te(g("inserido_copiado")),P.playSuccess(),w()}O()}function l(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let x=Oe[W.currentSubStatus];x&&x.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function w(){W.reset(),r.reset(),s.reset(),B(),xe.clearEmergency(),o.querySelectorAll("select").forEach(O=>O.value=""),o.querySelector("#sub-status-select").disabled=!0;let x=document.getElementById("email-automation-toggle-row");x&&(x.style.display="none"),C.innerHTML="",c.style.display="none",F.style.display="flex",F.style.opacity="1",j.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",d.style.display="none",h["evidence-l1"]&&(h["evidence-l1"].value=""),h["evidence-l2"]&&(h["evidence-l2"].value=""),h["evidence-msg"]&&(h["evidence-msg"].value="")}async function v(x=!1){let O={};C.querySelectorAll("input, textarea, select").forEach(Y=>{(Y.id.startsWith("field-")||Y.id==="consent-select")&&(O[Y.id]=Y.value)});let $="Cliente",J="---";if(!x)try{let Y=await Ce();$=Y.advertiserName,J=Y.cid}catch(Y){console.warn("Erro ao coletar pageData:",Y)}let V=r.getCheckedElements().map(Y=>({key:Y.value,count:Y.count})),oe=V.map(Y=>{let ne=Ee[Y.key];return ne?ne.name:Y.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:O,activeTasks:V,summaryTags:oe,clientName:$,cid:J,timestamp:new Date().toISOString()}}let E=x=>new Promise(O=>setTimeout(O,x));async function S(x){W.setLanguage(x.currentLang||"pt"),W.setCaseType(x.currentCaseType||"bau"),W.setPortugalCase(x.isPortugalCase||!1),W.setConsent(x.consent||!1),W.setExcludedFields(x.excludedFields||[]),x.activeFields&&W.setActiveFields(x.activeFields);let O=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);O&&O.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(V=>{V!==O&&V.classList.remove("active")});let $=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);$&&$.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(V=>{V!==$&&V.classList.remove("active")});let J=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if(J&&J.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(V=>{V!==J&&V.classList.remove("active")}),x.status){let V=o.querySelector("#main-status-select");V.value=x.status,W.setStatus(x.status);let oe=o.querySelector("#sub-status-select");if(f(x.status,oe),await E(50),x.subStatus){if(oe.value=x.subStatus,W.setSubStatus(x.subStatus),A(x.subStatus),await E(100),x.tagSupportUsed!==void 0){W.setTagSupportUsed(x.tagSupportUsed);let Y=s.element.querySelector('input[value="Sim"]'),ne=s.element.querySelector('input[value="N\xE3o"]');x.tagSupportUsed&&Y?Y.checked=!0:ne&&(ne.checked=!0),s.element.querySelector("div:last-child").style.display=x.tagSupportUsed?"none":"block"}x.forcedScreenshots&&W.setForcedScreenshots(x.forcedScreenshots);for(let Y in x.formData){let ne=document.getElementById(Y);ne&&(ne.value=x.formData[Y],W.updateField(Y,ne.value))}x.activeTasks&&(x.activeTasks.forEach(Y=>r.setTaskCount(Y.key,Y.count)),W.setActiveTasks(r.getCheckedElements()))}}W.isDirty=!1}function g(x){return Ae[W.currentLang]?.[x]||Ae.pt?.[x]||x}function T(){let x=document.createElement("div");return x.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',x.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",x.onclick=O=>{O.stopPropagation(),G()},x.title="Alternar para Split & Transfer",x}function U(){let x=document.createElement("div");return x.id="notes-empty-state",x.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(u),Object.assign(c.style,fe,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let d=me(c,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:c},()=>z()),p=document.createElement("div");Object.assign(p.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:r.bgApp});let h=document.createElement("div");Object.assign(h.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${r.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let y=document.createElement("div");Object.assign(y.style,{padding:"16px",borderBottom:`1px solid ${r.borderSubtle}`,position:"relative"});let b=document.createElement("input");b.placeholder="Buscar templates...",Object.assign(b.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:r.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),b.onfocus=()=>{b.style.backgroundColor="#FFFFFF",b.style.borderColor=r.primary,b.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",b.style.transform="scale(1.02)"},b.onblur=()=>{b.style.backgroundColor="#E3E3E8",b.style.borderColor="transparent",b.style.boxShadow="none",b.style.transform="scale(1)"};let m=document.createElement("div");m.id="email-template-list",Object.assign(m.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let k=document.createElement("div");k.innerHTML="\u2715",Object.assign(k.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),k.onclick=()=>{b.value="",n="",k.style.display="none",f(),b.focus()},y.appendChild(b),y.appendChild(k),h.appendChild(y),h.appendChild(m);let C=document.createElement("div");Object.assign(C.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:r.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let F=document.createElement("div");Object.assign(F.style,{padding:"20px",borderBottom:`1px solid ${r.borderSubtle}`,backgroundColor:r.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let j=document.createElement("div");Object.assign(j.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:r.bgApp,overflow:"hidden"});let M=document.createElement("div");Object.assign(M.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let Q=document.createElement("span");Q.textContent="Preview do E-mail",Object.assign(Q.style,{fontSize:"12px",fontWeight:"600",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let ae=document.createElement("div");Object.assign(ae.style,{display:"flex",gap:"8px"});let _=(I,Z=!1)=>{let l=document.createElement("button");return l.textContent=I,Object.assign(l.style,{padding:"8px 14px",borderRadius:"10px",border:Z?"none":`1.5px solid ${r.primary}`,background:Z?r.primary:"transparent",color:Z?"#fff":r.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:Z?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),l.onmouseenter=()=>{Z?(l.style.backgroundColor="#0062CC",l.style.transform="translateY(-1px)",l.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):l.style.backgroundColor="rgba(0, 122, 255, 0.05)"},l.onmouseleave=()=>{Z?(l.style.backgroundColor=r.primary,l.style.transform="translateY(0)",l.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(l.style.backgroundColor="transparent",l.style.transform="translateY(0)")},l.onmousedown=()=>l.style.transform="scale(0.94)",l.onmouseup=()=>l.style.transform="scale(1)",l},q=_("Copiar HTML"),B=_("Preencher no CRM",!0),X=_("Smart CR");X.style.borderColor="#E67E22",X.style.color="#E67E22",X.style.display="none",ae.appendChild(X),ae.appendChild(q),ae.appendChild(B),M.appendChild(Q),M.appendChild(ae);let G=document.createElement("div");G.contentEditable="true",Object.assign(G.style,{flex:"1",backgroundColor:r.bgSurface,border:`1px solid ${r.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:r.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),j.appendChild(M),j.appendChild(G),K(),C.appendChild(F),C.appendChild(j),p.appendChild(h),p.appendChild(C),c.appendChild(d),c.appendChild(p);let L=document.createElement("div");Object.assign(L.style,Ie),c.appendChild(L),Le(c,L),document.body.appendChild(c);function z(){e=!e,e?(c.style.display="flex",Qt(c),o.length===0&&D()):c.style.display="none",ge(e,c,"cw-btn-email")}async function D(){m.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await Co.getTemplates(),f()}function f(){m.innerHTML="";let I=o.filter(E=>E.name.toLowerCase().includes(n.toLowerCase())||E.category.toLowerCase().includes(n.toLowerCase())),Z=Object.entries(We).filter(([E,S])=>S&&(E.toLowerCase().includes(n.toLowerCase())||S.toLowerCase().includes(n.toLowerCase()))).map(([E,S])=>({id:E,name:E.replace(/_/g," "),category:"\u26A1 Smart CRs",code:S,isSmartCR:!0})),l=we.getSnippets("email").filter(E=>E.title.toLowerCase().includes(n.toLowerCase())||E.subject&&E.subject.toLowerCase().includes(n.toLowerCase())).map(E=>{let S=[],g=E.content.match(/\[([^\]]+)\]/g);return g&&[...new Set(g)].forEach(T=>{S.push({key:T,label:T.replace("[","").replace("]",""),type:T.toLowerCase().includes("data")?"date":"text",auto:T.toLowerCase().includes("nome")&&T.toLowerCase().includes("seu")?"agentName":null})}),{id:E.id||`snippet-${Math.random()}`,name:E.title,category:"\u{1F464} Pessoal",subject:E.subject||"Sem Assunto",template:E.content,placeholders:S}}),w=[...I,...Z,...l];if(w.length===0){m.innerHTML=`
                ...
                </div>`;return}[...new Set(w.map(E=>E.category))].sort((E,S)=>E.localeCompare(S)).forEach(E=>{let S=s.has(E)||n.length>0,g=w.filter($=>$.category===E),T=document.createElement("div");Object.assign(T.style,{padding:"12px 16px 12px 24px",fontSize:"11px",fontWeight:"700",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.8px",position:"sticky",top:"-8px",backgroundColor:"rgba(239, 239, 240, 0.9)",zIndex:"10",backdropFilter:"blur(20px)",margin:"0 -8px 8px -8px",borderBottom:`0.5px solid ${r.borderSubtle}`,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none",transition:"background-color 0.2s ease"}),T.onmouseenter=()=>T.style.backgroundColor="rgba(230, 230, 232, 0.9)",T.onmouseleave=()=>T.style.backgroundColor="rgba(239, 239, 240, 0.9)";let U=document.createElement("span");U.textContent=E,T.appendChild(U);let ee=document.createElement("span");ee.textContent=g.length,Object.assign(ee.style,{backgroundColor:"rgba(0, 0, 0, 0.05)",padding:"2px 8px",borderRadius:"10px",fontSize:"10px",color:r.textSecondary});let x=document.createElement("span");x.innerHTML=S?"\u{10012A}":"\u{10012B}",x.innerHTML=S?"\u25BE":"\u25B8",x.style.marginLeft="8px",x.style.transition="transform 0.3s ease";let O=document.createElement("div");O.style.display="flex",O.style.alignItems="center",O.appendChild(ee),O.appendChild(x),T.appendChild(O),T.onclick=()=>{s.has(E)?s.delete(E):s.add(E),f()},m.appendChild(T),S&&g.forEach($=>{let J=a&&a.id===$.id,V=document.createElement("div");if(Object.assign(V.style,{padding:"12px 14px",fontSize:"14px",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)",borderRadius:"10px",color:r.textPrimary,margin:"4px 6px",display:"flex",alignItems:"center",gap:"12px",backgroundColor:J?r.primary:r.bgSurface,boxShadow:J?"0 4px 12px rgba(0, 122, 255, 0.3)":"0 1px 2px rgba(0,0,0,0.05)",border:J?"none":`1px solid ${r.borderSubtle}`,position:"relative",overflow:"hidden"}),J){let ne=document.createElement("div");Object.assign(ne.style,{position:"absolute",left:"0",top:"0",bottom:"0",width:"4px",backgroundColor:"#fff",borderRadius:"0 4px 4px 0"}),V.appendChild(ne)}let oe=document.createElement("span");oe.innerHTML=$.isSmartCR?"\u26A1":$.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",oe.style.fontSize="12px",oe.style.opacity="0.7",oe.style.flexShrink="0",V.appendChild(oe);let Y=document.createElement("span");Y.textContent=$.name,Y.style.overflow="hidden",Y.style.textOverflow="ellipsis",Y.style.whiteSpace="nowrap",Y.style.flex="1",V.appendChild(Y),J&&(V.style.color="#fff",V.style.fontWeight="600",oe.style.opacity="1"),V.onmouseenter=()=>{J||(V.style.backgroundColor="#f8f8f9",V.style.transform="translateY(-1px) scale(1.01)",V.style.boxShadow="0 4px 8px rgba(0,0,0,0.08)",V.style.borderColor="rgba(0, 122, 255, 0.2)")},V.onmouseleave=()=>{J||(V.style.backgroundColor=r.bgSurface,V.style.transform="translateY(0) scale(1)",V.style.boxShadow="0 1px 2px rgba(0,0,0,0.05)",V.style.borderColor=r.borderSubtle)},V.onmousedown=()=>{V.style.transform=J?"scale(0.97)":"scale(0.98)"},V.onmouseup=()=>{V.style.transform=J?"scale(1)":"translateY(-1px) scale(1.01)"},V.onclick=()=>{R($)},m.appendChild(V)})})}let A=null;async function R(I){a?.id!==I.id&&(a=I,A&&clearTimeout(A),C.style.opacity="0",C.style.transform="translateY(5px)",A=setTimeout(()=>{X.style.display=I.isSmartCR?"block":"none",B.style.display=I.isSmartCR?"none":"block",q.style.display=I.isSmartCR?"none":"block",f(),N(),K(),C.style.opacity="1",C.style.transform="translateY(0)",A=null},150))}function N(){if(F.innerHTML="",!a||a.isSmartCR){a?.isSmartCR?(F.style.display="block",F.innerHTML=`<div style="padding: 12px; font-size: 13px; color: #856404; background: #FFF3CD; border: 1px solid #FFEEBA; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
                ...
                </div>`):F.style.display="none";return}let I=a.placeholders&&a.placeholders.length>0;if(F.style.display=I?"block":"none",!I)return;let Z=document.createElement("div");Object.assign(Z.style,{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"}),(a.placeholders||[]).forEach(l=>{let w=document.createElement("div"),v=document.createElement("label");v.textContent=l.label,Object.assign(v.style,{display:"block",fontSize:"11px",fontWeight:"700",color:r.textSecondary,marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.5px"});let E=document.createElement("input");E.type=l.type||"text",E.dataset.key=l.key,Object.assign(E.style,{width:"100%",padding:"10px 12px",borderRadius:"8px",border:`1.5px solid ${r.borderSubtle}`,backgroundColor:"#FBFBFD",fontSize:"14px",boxSizing:"border-box",transition:"all 0.2s ease",outline:"none"}),E.onfocus=()=>{E.style.borderColor=r.primary,E.style.backgroundColor="#FFFFFF",E.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)"},E.onblur=()=>{E.style.borderColor=r.borderSubtle,E.style.backgroundColor="#FBFBFD",E.style.boxShadow="none"},l.auto==="agentName"&&(E.value=Qe().split(" ")[0]),E.addEventListener("input",K),w.appendChild(v),w.appendChild(E),Z.appendChild(w)}),F.appendChild(Z)}function K(){if(!a){G.innerHTML=`
...
E-mail: ${g.clientEmail||"---"}`;U&&(U.value=x),ee&&(ee.style.display="block",ee.style.maxHeight="300px",ee.style.opacity="1",ee.scrollIntoView({behavior:"smooth",block:"end"}))})}function y(){r=!r,ge(r,c,"cw-btn-script"),r?(p(),d||(d=setInterval(p,2e3))):d&&(clearInterval(d),d=null)}let b=me(c,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",u,()=>{y()});c.appendChild(b);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
  ...
  `,m.onfocus=()=>{y.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",y.style.border="1px solid #1a73e8"},m.onblur=()=>{y.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",y.style.border="1px solid transparent"},y.appendChild(b),y.appendChild(m),h.appendChild(y),p.appendChild(h);let k=document.createElement("div");k.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(k);let C=null;function F(){if(C)return;C=document.createElement("div"),C.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let L=document.createElement("div");L.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",L.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let z=document.createElement("button");z.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',z.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",z.onclick=()=>{M(),n=!1,q()},L.appendChild(z),C.appendChild(L);let D=document.createElement("div");D.id="cw-history-list",D.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",C.appendChild(D),p.appendChild(C)}function j(){C||F();let L=C.querySelector("#cw-history-list");L.innerHTML="";let z=pa();z.length===0?L.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':z.forEach(D=>{let f=X(D,Ge[D._originalCat],!0,D._originalCat);L.appendChild(f)}),requestAnimationFrame(()=>C.style.transform="translateY(0)")}function M(){C&&(C.style.transform="translateY(100%)")}function Q(){d.innerHTML="";let L=ae("history","Recentes",Ge.history);L.id="cw-sidebar-btn-history",L.onclick=()=>{P.playClick(),n=!n,n?j():M(),q()},d.appendChild(L);let z=document.createElement("div");z.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(z),Object.keys(it).forEach(D=>{let f=it[D],A=ae(D,f.label,Ge[D]);A.id=`cw-sidebar-btn-${D}`,A.onclick=()=>{P.playClick(),n&&(n=!1,M()),_(D)},d.appendChild(A)})}function ae(L,z,D){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=z,f.dataset.key=L;let A=document.createElement("div");A.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",A.innerHTML=D||Ge.tasks;let R=document.createElement("div");return R.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",R.textContent=z,f.appendChild(A),f.appendChild(R),f.onmouseenter=()=>{a!==L&&!(L==="history"&&n)&&(f.style.background="#F1F3F4",A.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==L&&!(L==="history"&&n)&&(f.style.background="transparent",A.style.transform="scale(1)")},f}function _(L){let z=document.getElementById(`cat-anchor-${L}`);z&&(z.scrollIntoView({behavior:"smooth",block:"start"}),a=L,q())}function q(){Object.keys(it).forEach(z=>{let D=d.querySelector(`#cw-sidebar-btn-${z}`);if(D)if(a===z&&!n){let f=Ct[z];D.style.background=f.bg,D.style.color=f.color,D.querySelector("div:first-child").style.transform="scale(1.1)"}else D.style.background="transparent",D.style.color=i.textSecondary,D.querySelector("div:first-child").style.transform="scale(1)"});let L=d.querySelector("#cw-sidebar-btn-history");L&&(n?(L.style.background="#3C4043",L.style.color="#FFFFFF"):(L.style.background="transparent",L.style.color=i.textSecondary))}function B(){if(k.innerHTML="",e.trim()!==""){let z=[];if(Object.entries(it).forEach(([f,A])=>{let R=A.links.filter(N=>N.name.toLowerCase().includes(e.toLowerCase())||N.desc.toLowerCase().includes(e.toLowerCase()));z.push(...R.map(N=>({...N,_cat:f})))}),z.length===0){k.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let D=document.createElement("div");D.innerHTML="Resultados da busca",D.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",k.appendChild(D),z.forEach(f=>{let A=X(f,Ge[f._cat],!1,f._cat);k.appendChild(A)});return}Object.entries(it).forEach(([z,D])=>{let f=Ct[z],A=document.createElement("div"),R=document.createElement("div");R.id=`cat-anchor-${z}`,R.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,R.innerHTML=`
            ...
            ${D.label}
          `,A.appendChild(R);let N=document.createElement("div");N.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",D.links.forEach(K=>{let I=X(K,Ge[z],!1,z);N.appendChild(I)}),A.appendChild(N),k.appendChild(A)});let L=document.createElement("div");L.style.height="80px",k.appendChild(L)}function X(L,z,D,f){let A=document.createElement("div"),R=Ct[f]||Ct.history;A.style.cssText=`
      ...
      `;let N=document.createElement("div");N.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,N.innerHTML=z||Ge.tasks;let K=N.querySelector("svg");K&&(K.style.width="22px",K.style.height="22px");let I=document.createElement("div");I.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let Z=document.createElement("div");Z.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,Z.textContent=L.name;let l=document.createElement("div");l.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,l.textContent=L.desc,I.appendChild(Z),I.appendChild(l);let w=document.createElement("div");return w.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',w.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,w.title="Copiar URL",A.onmouseenter=()=>{A.style.transform="translateY(-2px)",A.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",A.style.borderColor="rgba(0,0,0,0.05)",A.style.borderLeft=`4px solid ${R.color}`,w.style.opacity="1",w.style.background="#F1F3F4"},A.onmouseleave=()=>{A.style.transform="translateY(0)",A.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",A.style.border="1px solid transparent",w.style.opacity="0",w.style.background="transparent"},A.onclick=()=>{!D&&f&&Fo(L,f),window.open(L.url,"_blank")},w.onclick=v=>{v.stopPropagation(),P.playClick(),navigator.clipboard.writeText(L.url),!D&&f&&Fo(L,f),te("Link copiado!")},A.appendChild(N),A.appendChild(I),A.appendChild(w),A}m.addEventListener("input",L=>{e=L.target.value,B()});function G(){o=!o,ge(o,s,"cw-btn-links")}return document.body.appendChild(s),Q(),B(),G}var Be=[];function zt(t){Be=t}var ua=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Lo(){let t="v4.9",e=!1,o=null,a=null;function n(f){if(!f)return"";try{let A=new Date(f);return isNaN(A.getTime())?String(f):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,b.querySelectorAll('input[name="cw-bc-type"]').forEach(N=>{N.addEventListener("change",()=>{b.querySelectorAll(".cw-radio-option").forEach(K=>K.classList.remove("checked")),N.parentElement.classList.add("checked")})}),setTimeout(()=>{let N=b.querySelector(".cw-radio-option.info");N&&N.classList.add("checked")},100);let f=b.querySelector("#cw-bc-cancel"),A=b.querySelector("#cw-bc-close-x"),R=b.querySelector("#cw-bc-send");f.onclick=j,A.onclick=j,R.onclick=M,u.appendChild(b)}function F(f=null){if(!b)return;let A=b.querySelector("#cw-editor-title-label"),R=b.querySelector("#cw-bc-title"),N=b.querySelector("#cw-bc-text"),K=b.querySelector("#cw-bc-send");if(f){a=f.id,A.textContent="Editar Aviso",R.value=f.title||"",N.value=f.text||"",K.textContent="Salvar Altera\xE7\xF5es";let I=f.type||"info",Z=b.querySelector(`input[name="cw-bc-type"][value="${I}"]`);Z&&Z.click()}else{a=null,A.textContent="Novo Aviso",R.value="",N.value="",K.textContent="Publicar";let I=b.querySelector('input[name="cw-bc-type"][value="info"]');I&&I.click()}b.classList.add("active"),setTimeout(()=>R.focus(),300)}function j(){b&&b.classList.remove("active"),a=null}async function M(){let f=b.querySelector("#cw-bc-send"),A=b.querySelector("#cw-bc-title"),R=b.querySelector("#cw-bc-text"),N=b.querySelector('input[name="cw-bc-type"]:checked'),K=N?N.value:"info";if(!A.value.trim()||!R.value.trim()){te("Preencha todos os campos!",{error:!0});return}f.textContent="Salvando...",f.style.opacity="0.7";let I=!1;a?I=await de.updateBroadcast(a,{title:A.value,text:R.value,type:K}):I=await de.sendBroadcast({title:A.value,text:R.value,type:K,author:window._cwCurrentUser||"admin"}),I?(te(a?"Atualizado!":"Publicado!"),P.playSuccess(),j(),setTimeout(()=>_(),1500)):(te("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),f.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",f.style.opacity="1")}async function Q(f){if(await ve("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await de.deleteBroadcast(f)){te("Aviso removido."),P.playClick();let N=Be.findIndex(K=>K.id===f);N>-1&&Be.splice(N,1),B(),setTimeout(()=>_(),1500)}else te("Erro ao excluir.",{error:!0})}let ae=document.createElement("div");ae.className="cw-nice-scroll",Object.assign(ae.style,i.feedContainer),u.appendChild(ae);async function _(){e&&(k.style.display="block",k.innerHTML="\u{1F504} Sincronizando...");try{let f=await de.fetchData();f&&f.broadcast&&(zt(f.broadcast),q(),e&&(B(),k.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{k.style.display="none"},1500)))}catch{e&&(k.innerHTML="\u26A0\uFE0F Offline")}}function q(){let f=document.getElementById("cw-btn-broadcast");if(!f)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Be.some(N=>!A.includes(N.id))){if(f.classList.add("has-new"),!f.querySelector(".cw-badge")){let N=document.createElement("div");N.className="cw-badge",Object.assign(N.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),f.appendChild(N)}}else{f.classList.remove("has-new");let N=f.querySelector(".cw-badge");N&&N.remove()}}function B(){ae.innerHTML="";let f=u.querySelector("#cw-bau-widget");f&&f.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),R=[...Be].sort((l,w)=>{let v=new Date(l.date).getTime()||0;return(new Date(w.date).getTime()||0)-v}),N=R.findIndex(l=>l.title&&l.title.toLowerCase().includes("disponibilidade bau"));if(N!==-1){let l=R[N];R.splice(N,1);let w=document.createElement("div");w.id="cw-bau-widget",Object.assign(w.style,i.bauContainer);let v=[],E=(l.text||"").split(`
`),S=/\d{1,2}\/\d{1,2}/,g="\u{1F4C5}";if(E.forEach(O=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(O)?g="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(O)&&(g="\u{1F1EA}\u{1F1F8}");let $=O.match(S);if($){let J=$[0],V=g;/🇧🇷|🇵🇹|PT|BR/i.test(O)?V="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(O)&&(V="\u{1F1EA}\u{1F1F8}"),v.some(Y=>Y.flag===V&&Y.date===J)||v.push({flag:V,date:J})}}),v.length===0){let O=(l.text||"").match(/\d{1,2}\/\d{1,2}/g);O&&[...new Set(O)].forEach($=>v.push({flag:"\u{1F4C5}",date:$}))}let T="",U='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(U=`
          ...
          `,k.after(w);let ee=w.querySelector("#cw-bau-toggle-btn"),x=w.querySelector("#cw-bau-full");if(ee&&x&&(ee.onclick=()=>{let O=x.style.display==="none";x.style.display=O?"block":"none",ee.textContent=O?"Ocultar":"Detalhes"}),window._cwIsAdmin){let O=w.querySelector(".cw-bau-edit");O&&(O.onclick=()=>F(l))}}let K=R.sort((l,w)=>{let v=A.includes(l.id),E=A.includes(w.id);return v===E?0:v?1:-1});if(K.length===0&&!N){let l=document.createElement("div");Object.assign(l.style,i.emptyState),l.innerHTML=`
           ...
           `,ae.appendChild(l)}let I=K.filter(l=>!A.includes(l.id)),Z=K.filter(l=>A.includes(l.id));if(I.forEach(l=>ae.appendChild(X(l,!1))),Z.length>0){let l=document.createElement("div");Object.assign(l.style,i.historyDivider),l.innerHTML=`<span>Hist\xF3rico (${Z.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let w=document.createElement("div");Object.assign(w.style,i.historyContainer),Z.forEach(E=>w.appendChild(X(E,!0)));let v=!1;l.onclick=()=>{P.playClick(),v=!v,w.style.display=v?"flex":"none",l.querySelector("svg").style.transform=v?"rotate(180deg)":"rotate(0deg)"},ae.appendChild(l),ae.appendChild(w)}}function X(f,A){let R=document.createElement("div");Object.assign(R.style,A?i.cardHistory:i.card);let N=s[f.type]||s.info,K=document.createElement("div");Object.assign(K.style,i.cardHeader);let I=document.createElement("div");Object.assign(I.style,i.typeTag,{color:N.color,background:N.bg}),I.innerHTML=`${N.icon} <span>${f.type}</span>`;let Z=document.createElement("span");if(Object.assign(Z.style,i.dateTag),Z.textContent=n(f.date),K.appendChild(I),A)K.appendChild(Z);else{let S=document.createElement("button");S.className="cw-btn-interactive",Object.assign(S.style,i.dismissBtn),S.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',S.onmouseenter=()=>{S.style.color="#1e8e3e",S.style.background="#e6f4ea",S.style.borderColor="#1e8e3e"},S.onmouseleave=()=>{S.style.color="#5f6368",S.style.background="#fff",S.style.borderColor="rgba(0,0,0,0.1)"},S.onclick=g=>{g.stopPropagation(),P.playClick(),R.style.transform="translateX(20px)",R.style.opacity="0",setTimeout(()=>{let T=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");T.push(f.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(T)),B(),q()},200)},K.appendChild(S)}let l=document.createElement("div");Object.assign(l.style,i.cardContent);let w=document.createElement("div");Object.assign(w.style,i.msgTitle),w.textContent=f.title;let v=document.createElement("div");Object.assign(v.style,i.msgBody),v.innerHTML=c(f.text);let E=document.createElement("div");if(Object.assign(E.style,i.msgMeta),E.innerHTML=`Publicado por <b>${f.author||"Sistema"}</b>`,A||(E.innerHTML+=` \u2022 ${n(f.date)}`),l.appendChild(w),l.appendChild(v),l.appendChild(E),R.appendChild(K),R.appendChild(l),window._cwIsAdmin){let S=document.createElement("div");S.className="cw-card-actions";let g=document.createElement("button");g.className="cw-action-btn edit",g.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',g.onclick=()=>F(f);let T=document.createElement("button");T.className="cw-action-btn delete",T.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',T.onclick=()=>Q(f.id),S.appendChild(g),S.appendChild(T),R.appendChild(S)}return R}let G=de.getCachedBroadcasts();G.length>0&&(zt(G),B()),setTimeout(m,500),_(),o||(o=setInterval(_,ua));let L=document.createElement("div");Object.assign(L.style,Ie),L.className="no-drag",u.appendChild(L),Le(u,L),document.body.appendChild(u);let z=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),D=Be.some(f=>!z.includes(f.id));return{toggle:p,hasUnread:D}}function Oo(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let c=document.createElement("div");Object.assign(c.style,o.dotsContainer);let u=document.createElement("div");Object.assign(u.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let p=document.createElement("button");p.textContent="Pr\xF3ximo",Object.assign(p.style,o.btn,o.btnNext),p.onmouseover=()=>p.style.transform="scale(1.05)",p.onmouseout=()=>p.style.transform="scale(1)",u.appendChild(d),u.appendChild(p),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(c),n.appendChild(u),a.appendChild(n),document.body.appendChild(a);function h(b){let m=t[b];i.textContent=m.icon,s.textContent=m.title,r.textContent=m.text,c.innerHTML="",t.forEach((k,C)=>{let F=document.createElement("div");Object.assign(F.style,o.dot),C===b&&Object.assign(F.style,o.dotActive),c.appendChild(F)}),m.isLast?(d.style.display="none",p.textContent="Come\xE7ar \u{1F680}",p.style.width="100%"):(d.style.display="block",p.textContent="Pr\xF3ximo",p.style.width="auto")}function y(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),P.playSuccess(),te("Tudo pronto! Use o menu flutuante.")}p.onclick=()=>{P.playClick(),e<t.length-1?(e++,h(e)):y()},d.onclick=async()=>{await ve("Pular o tutorial?")&&y()},h(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var qo={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function _o(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&ma(t)}function ma(t){let e=qo.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let c=document.createElement("div");Object.assign(c.style,a.title);let u=document.createElement("div");Object.assign(u.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let p=document.createElement("button");Object.assign(p.style,a.btn),p.onmouseover=()=>p.style.transform="scale(1.02)",p.onmouseout=()=>p.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(c),i.appendChild(u),i.appendChild(d),i.appendChild(p),n.appendChild(i),document.body.appendChild(n);function h(b){let m=e[b];r.textContent=m.icon,c.textContent=m.title,u.textContent=m.text,d.innerHTML="",e.forEach((k,C)=>{let F=document.createElement("div");Object.assign(F.style,a.dot),C===b&&Object.assign(F.style,a.dotActive),d.appendChild(F)}),b===e.length-1?p.textContent="Entendi, vamos l\xE1! \u{1F44D}":p.textContent="Pr\xF3ximo"}function y(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),P.playSuccess(),te(`TechSol atualizado para ${t}!`)}p.onclick=()=>{P.playClick(),o<e.length-1?(o++,h(o)):y()},h(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Do="cw_timezone_pinned",Rt=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],ga=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function Mo(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Do)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let c={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},u={container:{display:"flex",flexDirection:"column",height:"100%",background:c.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:c.surface,borderBottom:`1px solid ${c.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:c.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:c.primary,borderBottomColor:c.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:c.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:c.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${c.border}`,background:c.surface,color:c.textSub,transition:"all 0.2s"},chipActive:{background:c.primaryBg,color:c.primary,borderColor:c.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:c.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${c.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:c.surface,border:`1px solid ${c.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:c.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,fe,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let h=me(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>A());d.appendChild(h);let y=document.createElement("div");Object.assign(y.style,u.container),d.appendChild(y);let b=document.createElement("div");Object.assign(b.style,u.tabHeader);let m=document.createElement("div");m.textContent="Monitoramento",Object.assign(m.style,u.tabBtn,u.tabActive);let k=document.createElement("div");k.textContent="Planejador",Object.assign(k.style,u.tabBtn),b.appendChild(m),b.appendChild(k),y.appendChild(b);let C=document.createElement("div");Object.assign(C.style,u.toolbar);let F=document.createElement("div");Object.assign(F.style,u.searchInputWrapper);let j=document.createElement("div");j.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(j.style,u.searchIcon);let M=document.createElement("input");M.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(M.style,u.searchInput),M.onfocus=()=>{M.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",M.style.borderColor="rgba(26,115,232,0.3)"},M.onblur=()=>{M.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",M.style.borderColor="transparent"},M.oninput=R=>{i=R.target.value.toLowerCase(),L()},F.appendChild(j),F.appendChild(M),C.appendChild(F);let Q=document.createElement("div");Object.assign(Q.style,u.chipsRow),ga.forEach(R=>{let N=document.createElement("div");N.textContent=R.label,N.id=`tz-filter-${R.id}`,Object.assign(N.style,u.chip),R.id===s&&Object.assign(N.style,u.chipActive),N.onclick=()=>{P.playClick(),s=R.id,Array.from(Q.children).forEach(K=>{Object.assign(K.style,u.chip)}),Object.assign(N.style,u.chipActive),L()},Q.appendChild(N)}),C.appendChild(Q),y.appendChild(C);let ae=document.createElement("div");Object.assign(ae.style,u.listContainer);let _=document.createElement("style");_.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",y.appendChild(_);let q=document.createElement("div");Object.assign(q.style,u.plannerWrapper,{display:"none"}),y.appendChild(ae),y.appendChild(q),m.onclick=()=>B("live"),k.onclick=()=>B("plan");function B(R){P.playClick(),R==="live"?(Object.assign(m.style,u.tabActive),Object.assign(k.style,u.tabBtn),k.style.borderBottomColor="transparent",ae.style.display="flex",C.style.display="flex",q.style.display="none",D()):(Object.assign(k.style,u.tabActive),Object.assign(m.style,u.tabBtn),m.style.borderBottomColor="transparent",q.style.display="flex",ae.style.display="none",C.style.display="none",f(),z())}function X(R){return R>=9&&R<17?{color:c.success,bg:c.successBg,label:"Aberto",icon:"\u{1F7E2}"}:R>=8&&R<9?{color:c.warning,bg:c.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:R>=17&&R<19?{color:c.warning,bg:c.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:c.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function G(R){n.includes(R)?n=n.filter(N=>N!==R):n.push(R),localStorage.setItem(Do,JSON.stringify(n)),L(),P.playClick()}function L(){ae.innerHTML="";let R=new Date,N=Rt.filter(I=>{let Z=I.name.toLowerCase().includes(i)||I.label.toLowerCase().includes(i),l=s==="all"||I.region===s;return Z&&l});if(N.sort((I,Z)=>{let l=n.includes(I.id),w=n.includes(Z.id);return l&&!w?-1:!l&&w?1:I.name.localeCompare(Z.name)}),N.length===0){ae.innerHTML=`
            ...
            `,S.onmouseenter=()=>{S.style.transform="translateY(-2px)",S.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},S.onmouseleave=()=>{S.style.transform="translateY(0)",S.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let U=S.querySelector(".cw-pin-btn");U.onmouseenter=()=>{U.style.backgroundColor="#F1F3F4"},U.onmouseleave=()=>{U.style.backgroundColor="transparent"},U.onclick=ee=>{ee.stopPropagation(),G(I.id)},S.onclick=()=>{a=I.id,B("plan")},ae.appendChild(S)});let K=document.createElement("div");K.style.height="20px",K.style.width="100%",ae.appendChild(K)}function z(){q.innerHTML="";let R=document.createElement("div"),N=document.createElement("label");N.textContent="Onde est\xE1 o cliente?",N.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let K=document.createElement("select");Object.assign(K.style,Kt),K.style.padding="14px",[...Rt].sort((oe,Y)=>oe.name.localeCompare(Y.name)).forEach(oe=>{let Y=document.createElement("option");Y.value=oe.id,Y.textContent=`${oe.flag} ${oe.name} (${oe.zone})`,oe.id===a&&(Y.selected=!0),K.appendChild(Y)}),K.onchange=oe=>{a=oe.target.value,V(),P.playClick()},R.appendChild(N),R.appendChild(K),q.appendChild(R);let Z=document.createElement("div");Object.assign(Z.style,u.timeComparisonRow);let l=document.createElement("div");Object.assign(l.style,u.timeCard),l.style.backgroundColor="#F8FAFF",l.style.borderColor="#E8F0FE",l.innerHTML=`
        ...
        `,document.head.appendChild(D)}let s={bg:"linear-gradient(180deg, #F8FAFD 0%, #EEF2F8 100%)",surface:"rgba(255, 255, 255, 0.85)",glass:"rgba(255, 255, 255, 0.7)",primary:"#1a73e8",primaryLight:"rgba(26, 115, 232, 0.1)",text:"#1f1f1f",textSub:"#474747",border:"rgba(0, 0, 0, 0.06)",danger:"#d93025"},r={container:{display:"flex",flexDirection:"column",height:"100%",background:s.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"16px 24px 0 24px",background:"transparent",borderBottom:`1px solid ${s.border}`,gap:"8px"},tabBtn:{flex:1,padding:"14px 16px",textAlign:"center",cursor:"pointer",fontSize:"14px",fontWeight:"500",color:s.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s ease",userSelect:"none",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",borderRadius:"12px 12px 0 0"},tabActive:{color:s.primary,borderBottomColor:s.primary,fontWeight:"600",background:"rgba(26, 115, 232, 0.04)"},listContainer:{flex:1,overflowY:"auto",padding:"24px",display:"flex",flexDirection:"column",gap:"16px"},emptyState:{padding:"60px 24px",textAlign:"center",color:s.textSub,display:"flex",flexDirection:"column",alignItems:"center",gap:"16px"},card:{background:s.surface,borderRadius:"24px",padding:"20px",border:`1px solid ${s.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.03)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"12px"},cardTitle:{fontSize:"15px",fontWeight:"600",color:s.text,letterSpacing:"-0.01em"},cardPreview:{fontSize:"13px",color:s.textSub,lineHeight:"1.6",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"12px",marginTop:"16px",paddingTop:"16px",borderTop:`1px solid ${s.border}`},actionBtn:{padding:"8px 14px",borderRadius:"10px",fontSize:"13px",fontWeight:"500",cursor:"pointer",border:"none",background:"transparent",transition:"all 0.2s",display:"flex",alignItems:"center",gap:"6px"},fab:{position:"absolute",bottom:"32px",right:"32px",width:"64px",height:"64px",borderRadius:"20px",background:`linear-gradient(135deg, ${s.primary}, #0059c1)`,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 8px 24px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.9)",backdropFilter:"blur(30px) saturate(180%)",webkitBackdropFilter:"blur(30px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.6s cubic-bezier(0.16, 1, 0.3, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"24px 32px",background:"transparent",borderBottom:`1px solid ${s.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"32px",overflowY:"auto"},inputGroup:{marginBottom:"24px"},label:{display:"block",fontSize:"13px",fontWeight:"600",color:s.textSub,marginBottom:"10px",letterSpacing:"0.02em"},input:{width:"100%",padding:"14px 18px",borderRadius:"14px",border:`1px solid ${s.border}`,fontSize:"15px",fontFamily:"inherit",outline:"none",background:s.surface,transition:"all 0.2s ease",boxSizing:"border-box"}},c=document.createElement("div");c.id="library-popup",c.classList.add("cw-module-window"),Object.assign(c.style,fe,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)"});let d=me(c,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:c},()=>z());c.appendChild(d);let p=document.createElement("div");Object.assign(p.style,r.container),c.appendChild(p);let h=document.createElement("div");Object.assign(h.style,r.tabHeader);let y=[{id:"general",label:"Geral",icon:i.tabs.general},{id:"note",label:"Notas",icon:i.tabs.note},{id:"email",label:"Emails",icon:i.tabs.email}];y.forEach(D=>{let f=document.createElement("div");f.innerHTML=`${D.icon} <span>${D.label}</span>`,f.id=`lib-tab-${D.id}`,Object.assign(f.style,r.tabBtn),D.id===o&&Object.assign(f.style,r.tabActive),f.onmouseenter=()=>P.playHover(),f.onclick=()=>ae(D.id),h.appendChild(f)}),p.appendChild(h);let b=document.createElement("div");Object.assign(b.style,r.listContainer),p.appendChild(b);let m=document.createElement("div");m.className="cw-fab cw-tactile",Object.assign(m.style,r.fab),m.innerHTML=i.actions.add,m.onmouseenter=()=>{m.style.transform="scale(1.1)",m.style.boxShadow="0 12px 32px rgba(26, 115, 232, 0.5)"},m.onmouseleave=()=>{m.style.transform="scale(1)",m.style.boxShadow="0 8px 24px rgba(26, 115, 232, 0.4)"},m.onclick=()=>q(),p.appendChild(m),a=document.createElement("div"),Object.assign(a.style,r.editorOverlay);let k=document.createElement("div");Object.assign(k.style,r.editorHeader),k.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let C=document.createElement("button");C.innerHTML="Cancelar",C.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",C.onclick=B,k.appendChild(C),a.appendChild(k);let F=document.createElement("div");Object.assign(F.style,r.editorBody),a.appendChild(F);let j=document.createElement("div");j.style.cssText="padding:24px 32px; border-top:1px solid rgba(0,0,0,0.06); background:transparent; display:flex; justify-content:flex-end;";let M=document.createElement("button");M.textContent="Salvar",M.style.cssText="padding:12px 32px; background:linear-gradient(135deg, #1a73e8, #0059c1); color:white; border:none; border-radius:14px; font-weight:600; cursor:pointer; box-shadow:0 4px 12px rgba(26,115,232,0.3); transition: all 0.2s;",M.onclick=X,j.appendChild(M),a.appendChild(j),p.appendChild(a);let Q=document.createElement("div");Object.assign(Q.style,Ie),Q.className="no-drag",c.appendChild(Q),Le(c,Q),document.body.appendChild(c);function ae(D){P.playClick(),o=D,y.forEach(f=>{let A=document.getElementById(`lib-tab-${f.id}`);f.id===D?Object.assign(A.style,r.tabActive):Object.assign(A.style,r.tabBtn)}),_()}function _(){b.innerHTML="";let D=we.getSnippets(o);if(D.length===0){b.innerHTML=`
            ...
            `;return}D.forEach(f=>{let A=document.createElement("div");A.className="cw-aura-card",Object.assign(A.style,r.card),f.isCode&&(A.style.borderLeft=`4px solid ${s.primary}`,A.style.background="rgba(26, 115, 232, 0.02)");let R=f.content,N="";if(f.isRich){let K=document.createElement("div");K.innerHTML=f.content;let I=K.querySelector("img");R=K.innerText.substring(0,150)+(K.innerText.length>150?"...":""),I&&(N=`<span style="display:inline-flex; align-items:center; background:rgba(26, 115, 232, 0.1); color:#1a73e8; padding:2px 8px; border-radius:10px; font-size:11px; margin-bottom:8px; font-weight:600;">${i.media} Media</span>`)}A.innerHTML=`
            ...
            `,A.onmouseenter=()=>{P.playHover()},A.querySelector(".cw-act-copy").onclick=K=>{if(K.stopPropagation(),P.playClick(),f.isRich){let I=new Blob([f.content],{type:"text/html"}),Z=document.createElement("div");Z.style.whiteSpace="pre-wrap",Z.innerHTML=f.content;let l=new Blob([Z.innerText],{type:"text/plain"}),w=[new ClipboardItem({"text/html":I,"text/plain":l})];navigator.clipboard.write(w)}else navigator.clipboard.writeText(f.content);te("Copiado!")},A.querySelector(".cw-act-edit").onclick=K=>{K.stopPropagation(),P.playClick(),q(f)},A.querySelector(".cw-act-del").onclick=async K=>{K.stopPropagation(),P.playClick(),await ve("Excluir este item?")&&(we.delete(f.id),_(),te("Item exclu\xEDdo."))},b.appendChild(A)})}function q(D=null){n=D?D.id:null,F.innerHTML="",F.appendChild(G("title","T\xEDtulo / Nome",D?D.title:"")),o==="email"&&F.appendChild(G("subject","Assunto do Email",D?D.subject:""));let f="Conte\xFAdo";o==="email"&&(f="Corpo do Email (HTML)"),o==="note"&&(f="Texto da Nota (Reason)"),F.appendChild(G("content",f,D?D.content:"",{isRich:!0,isCode:D?D.isCode:!1})),k.querySelector("span").textContent=D?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let A=F.querySelector("input");A&&A.focus()},300)}function B(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function X(){let D=F.querySelector("#cw-inp-title"),f=F.querySelector("#cw-inp-content"),A=D.value.trim(),R=f.contentEditable==="true"?f.innerHTML:f.value.trim(),N=f.getAttribute("data-is-code")==="true";if(!A||!R||R==="<br>"){te("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let K={id:n,type:o,title:A,content:R,isCode:N,isRich:f.contentEditable==="true"};if(o==="email"){let I=F.querySelector("#cw-inp-subject").value.trim();if(!I){te("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}K.subject=I}M.textContent="Salvando...",await we.save(K),M.textContent="Salvar",B(),_(),te("Salvo com sucesso!"),P.playSuccess()}function G(D,f,A,R={}){let N=document.createElement("div");Object.assign(N.style,r.inputGroup);let K=document.createElement("label");K.textContent=f,Object.assign(K.style,r.label);let I;if(R.isRich){let Z=document.createElement("div");Z.style.cssText="display:flex; gap:8px; margin-bottom:14px; background:rgba(255, 255, 255, 0.5); padding:8px; border-radius:14px; border:1px solid rgba(0,0,0,0.06); backdrop-filter: blur(10px); width: fit-content;",Z.innerHTML=`
            ...
            `,I=document.createElement("div"),I.contentEditable="true",Object.assign(I.style,r.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),I.innerHTML=A||"",R.isCode&&(I.style.fontFamily="'Roboto Mono', monospace",I.style.backgroundColor="#F8F9FA",I.setAttribute("data-is-code","true")),Z.querySelectorAll(".cw-toolbar-btn").forEach(l=>{l.onmouseenter=()=>P.playHover(),l.onmousedown=()=>P.playClick()}),Z.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),I.focus()},Z.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),I.focus()},Z.querySelector(".cw-tb-code").onclick=l=>{let v=!(I.getAttribute("data-is-code")==="true");I.setAttribute("data-is-code",v),I.style.fontFamily=v?"'Roboto Mono', monospace":"inherit",I.style.backgroundColor=v?"rgba(0, 122, 255, 0.03)":s.surface,v?l.currentTarget.classList.add("active"):l.currentTarget.classList.remove("active"),I.focus()},Z.querySelector(".cw-tb-img").onclick=async()=>{let l=await ao("Cole a URL da imagem:");l&&(document.execCommand("insertImage",!1,l),I.querySelectorAll("img").forEach(v=>{v.style.maxWidth="100%",v.style.borderRadius="8px"}))},I.onpaste=l=>{let w=(l.clipboardData||l.originalEvent.clipboardData).items;for(let v of w)if(v.kind==="file"&&v.type.startsWith("image/")){l.preventDefault();let E=v.getAsFile(),S=new FileReader;S.onload=g=>{let T=`<img src="${g.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,T)},S.readAsDataURL(E)}},N.appendChild(K),N.appendChild(Z)}else I=document.createElement("input"),I.type="text",Object.assign(I.style,r.input),I.value=A||"",N.appendChild(K);return I.id=`cw-inp-${D}`,I.onfocus=()=>{I.style.borderColor=s.primary,I.style.boxShadow=`0 0 0 2px ${s.primaryBg}`},I.onblur=()=>{I.style.borderColor=s.border,I.style.boxShadow="none"},N.appendChild(I),N}function L(D){return Object.entries(D).map(([f,A])=>`${f.replace(/[A-Z]/g,R=>"-"+R.toLowerCase())}:${A}`).join(";")}function z(){e=!e,ge(e,c,"cw-btn-library"),e&&_()}return z}function zo(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let b=document.createElement("style");b.id=a,b.innerHTML=`
        ...
        `,setTimeout(async()=>{try{let b=be(),m=b?b.split("@")[0]:"user",k=await st(m);if(!k){c.innerHTML=`
  ...
  `,document.head.appendChild(t)};var Ve={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var pe={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function Bo(t){let e=document.createElement("div");if(e.className="bau-dynamic-input",e.id=`wrapper-${t.id}`,t.label){let a=document.createElement("label");a.className="bau-label",a.textContent=t.label,t.tooltip&&a.setAttribute("data-tooltip",t.tooltip),e.appendChild(a)}let o;switch(t.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",e.appendChild(o);break;case"select":o=document.createElement("select"),t.groups?t.groups.forEach(s=>{let r=document.createElement("optgroup");r.label=s.label,s.options.forEach(c=>{let u=document.createElement("option");u.value=c.value,u.textContent=c.text,r.appendChild(u)}),o.appendChild(r)}):t.options&&t.options.forEach(s=>{let r=document.createElement("option");r.value=s.value,r.textContent=s.text,o.appendChild(r)}),e.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",t.options.forEach(s=>{let r=document.createElement("label");r.className="bau-task-item",r.innerHTML=`<input type="checkbox" name="${t.name}" value="${s}"><span>${s}</span>`,r.addEventListener("click",c=>{c.preventDefault();let u=r.querySelector("input");u.checked=!u.checked,r.classList.toggle("active",u.checked),P.playClick()}),o.appendChild(r)}),e.appendChild(o),e;case"datetime-group":o=document.createElement("div"),o.className="bau-availability-container",t.fields.forEach(s=>{let r=document.createElement("div");r.className="bau-availability-field",r.innerHTML=`
    ...
    `,y.appendChild(b);let m=document.createElement("div");m.className="bau-content",y.appendChild(m);let k=document.createElement("div");k.className="bau-progress-indicator",m.appendChild(k);let C=document.createElement("form");C.id="bau-escalation-form",C.noValidate=!0,m.appendChild(C),Ve.steps.forEach(l=>{let w=document.createElement("div");if(w.className="bau-step"+(l.id===a?" active":""),w.id=`bau-step-${l.id}`,l.isBranching)w.innerHTML=`
            ...
            `,w.querySelector("#bau-opt-full").onclick=()=>{n="BAU",a=1,C.querySelectorAll(".bau-highlight-panel").forEach(v=>v.classList.remove("discard-theme")),z(),P.playClick()},w.querySelector("#bau-opt-discard").onclick=()=>{n="DISCARD",a=5,C.querySelectorAll(".bau-highlight-panel").forEach(v=>v.classList.add("discard-theme")),z(),P.playClick()};else if(l.isConfirmation)w.innerHTML=`
                <div class="bau-card">
            ...
            `;else{let v=document.createElement("div");if(v.className="bau-card",l.id===1||l.id===5){v.innerHTML=`
                ...
                `;let E=v.querySelector(".bau-dynamic-inputs-container");l.fields.forEach(g=>{E.appendChild(Bo(g))});let S=v.querySelector("#wrapper-cid");if(S){let g=document.createElement("div");g.id="bau-cid-error",g.className="bau-cid-error-hint",g.style.display="none",g.textContent="Formato de CID incorreto",S.appendChild(g)}}else l.fields.forEach(E=>{v.appendChild(Bo(E))});w.appendChild(v)}C.appendChild(w)});let F=document.createElement("div");F.className="bau-footer";let j=document.createElement("button");j.type="button",j.id="bau-step-back-btn",j.className="bau-btn-secondary",j.textContent="Voltar";let M=document.createElement("button");M.type="button",M.id="bau-step-next-btn",M.className="bau-btn-primary",M.textContent="Pr\xF3ximo";let Q=document.createElement("button");Q.type="submit",Q.className="bau-btn-submit",Q.innerHTML=`${pe.send} Enviar para o TL`,Q.style.display="none",F.appendChild(j),F.appendChild(M),F.appendChild(Q),C.appendChild(F),d.appendChild(y);let ae=document.createElement("div");ae.id="bau-view-success",ae.className="bau-view bau-success-view",ae.innerHTML=`
    ...
    `,d.appendChild(ae),document.body.appendChild(c);function _(l){e=l,c.querySelectorAll(".bau-view").forEach(g=>g.classList.remove("active"));let w=c.querySelector(`#bau-view-${l}`);w&&w.classList.add("active");let v=u.querySelector(".cw-module-header-title")||u.querySelector("h2"),E=u.querySelector(".cw-module-header-subtitle")||u.querySelector("p");v&&(l==="form"?v.textContent=i?`Editando Caso #${s}`:"Novo Caso BAU":v.textContent="BAU Central"),E&&(E.textContent=l==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU");let S=C.querySelector(".bau-btn-submit");S&&(S.innerHTML=i?`${pe.send} Salvar Altera\xE7\xF5es`:`${pe.send} Enviar para o TL`)}function q(){let l=c.querySelector("#bau-case-list-container"),w=c.querySelector("#bau-dashboard-metrics");w&&(w.innerHTML=`
        ...
        `).join(""))}async function B(){let l=c.querySelector("#bau-case-list-container"),w=c.querySelector("#bau-dashboard-metrics");if(!(!l||!w)){q();try{let v=await jt();if(!Array.isArray(v))throw new Error("API response is not a valid array");L(v)}catch(v){console.error("Critical Error loading BAU cases:",v),w&&(w.innerHTML=""),l.innerHTML=`
        ...
        `;let S=p.querySelector(".bau-details-close-btn");S.onclick=()=>{p.classList.remove("active"),P.playSwoosh(),setTimeout(()=>{p.style.display="none"},600)},p.querySelectorAll(".bau-copy-btn").forEach(g=>{g.onclick=T=>{let U=T.target.closest(".bau-details-row").querySelector(".bau-details-value").textContent;E(U,g)}}),p.style.display="flex",requestAnimationFrame(()=>{p.classList.add("active"),P.playClick()})}function G(l){if(!l)return"";let v=(O=>{switch(O){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:O||"Pendente",class:"status-gray",aura:""}}})(l?.status),E=lt(l?.date),S="",g="";if(l?.status==="PENDING_TL_CREATION"&&l?.availability_1){let O=new Date(l.availability_1),$=new Date;(O<=$||O-$<36e5*2)&&(S='<span class="bau-sla-badge">Urgente</span>',g="bau-pulse-attention")}let T=l?.reason&&l.reason.trim()?l.reason:"Nenhum contexto adicional fornecido pelo agente.",ee=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(l?.cid||""),x=!l?.caseId||l.caseId==="N/A"||!ee;return x&&l?.status==="PENDING_TL_CREATION"&&(g="bau-pulse-attention"),`
        ...
        `}function L(l){let w=c.querySelector("#bau-case-list-container"),v=c.querySelector("#bau-dashboard-metrics");if(!w||!v)return;let E=Array.isArray(l)?l.filter(Boolean):[];if(E.length===0){v.innerHTML=`
            ...
            `,c.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>B());return}let S=E.filter(x=>x.status==="PENDING_TL_CREATION").length,g=E.filter(x=>x.status==="CREATED").length;v.innerHTML=`
        ...
        `;let T=v.querySelector("#bau-refresh-dashboard");T?.addEventListener("click",async()=>{T.classList.contains("spinning")||(T.classList.add("spinning"),P.playClick(),await B(),setTimeout(()=>T.classList.remove("spinning"),1e3))}),w.innerHTML="";let U=E.slice(0,5),ee=E.slice(5);if(U.forEach(x=>{let O=G(x),$=document.createElement("div");$.innerHTML=O;let J=$.firstElementChild;J.addEventListener("click",oe=>{oe.target.closest(".bau-case-edit-btn")||X(x)});let V=J.querySelector(".bau-case-edit-btn");V&&(V.onclick=oe=>{oe.stopPropagation(),K(x)}),w.appendChild(J)}),ee.length>0){let x=document.createElement("li");x.className="bau-accordion-container";let O=document.createElement("button");O.className="bau-accordion-toggle",O.innerHTML=`${pe.expand} <span>Mostrar ${ee.length} casos mais antigos</span>`;let $=document.createElement("ul");$.className="bau-case-list bau-accordion-content",$.style.display="none",ee.forEach(J=>{let V=G(J),oe=document.createElement("div");oe.innerHTML=V;let Y=oe.firstElementChild;Y.addEventListener("click",re=>{re.target.closest(".bau-case-edit-btn")||X(J)});let ne=Y.querySelector(".bau-case-edit-btn");ne&&(ne.onclick=re=>{re.stopPropagation(),K(J)}),$.appendChild(Y)}),O.addEventListener("click",()=>{let J=$.style.display==="none";$.style.display=J?"block":"none",O.classList.toggle("expanded",J),O.querySelector("span").textContent=J?"Esconder casos mais antigos":`Mostrar ${ee.length} casos mais antigos`,P.playClick()}),x.appendChild(O),x.appendChild($),w.appendChild(x)}}function z(){let l=n==="BAU"?[1,2,3,4]:[5,4];C.querySelectorAll(".bau-step").forEach(E=>{let S=parseInt(E.id.replace("bau-step-","")),g=S===a,T=l.includes(S)||S===0;E.classList.toggle("active",g),E.style.display=g?"block":"none",E.querySelectorAll("input, select, textarea").forEach(U=>{U.disabled=!T})});let w=a===0;if(k.style.display=w?"none":"flex",!w){k.innerHTML="";let E=n==="BAU"?[1,2,3,4]:[5,4];E.forEach((S,g)=>{let T=document.createElement("div"),U=S===a,ee=E.indexOf(a),x=g<ee;T.className=`bau-progress-step ${U?"active":x?"completed":""}`,T.textContent=g+1,k.appendChild(T)})}let v=a===4;j.style.display=a>0?"inline-block":"none",M.style.display=!w&&!v?"inline-block":"none",Q.style.display=v?"flex":"none",v&&N()}function D(l){let w=Ve.steps.find(v=>v.id===l);if(!w||!w.fields||w.isConfirmation)return!0;for(let v of w.fields){let E=C.querySelector(`#bau-step-${l} #wrapper-${v.id}`);if(!(E&&E.style.display==="none")&&v.validation){let S=C.querySelector(`#bau-step-${l} [name="${v.name}"]`);if(S&&S.offsetParent!==null&&S.value.trim())if(new RegExp(v.validation.regex).test(S.value.trim())){S.classList.remove("invalid-cid");let T=C.querySelector("#bau-cid-error");T&&(T.style.display="none")}else{console.warn(`Validation failed for field "${v.name}" in step ${l}: Regex mismatch.`),te(`Erro: ${v.validation.error}`,{error:!0}),S.classList.add("invalid-cid");let T=C.querySelector("#bau-cid-error");return T&&(T.style.display="flex"),!1}}}return!0}function f(l){if(!C.querySelector(`#bau-step-${l}`))return!1;let v=Ve.steps.find(S=>S.id===l);if(!v||!v.fields||v.isConfirmation)return!0;let E=!0;for(let S of v.fields){let g=C.querySelector(`#bau-step-${l} #wrapper-${S.id}`);if(!(g&&g.style.display==="none")&&S.required){let T=!0,U="";if(S.type==="checkbox-grid")C.querySelector(`#bau-step-${l} input[name="${S.name}"]:checked`)||(U="No option selected in checkbox-grid",te(`Erro: Selecione pelo menos uma op\xE7\xE3o para "${S.label}".`,{error:!0}),T=!1);else if(S.type==="datetime-group"){let ee=C.querySelector(`#bau-step-${l} input[name="${S.fields[0].name}"]`);if(!ee||ee.offsetParent===null)continue;ee.value.trim()||(U="Datetime group first field is empty",te(`Erro: O campo "${S.fields[0].label}" \xE9 obrigat\xF3rio.`,{error:!0}),T=!1)}else{let ee=C.querySelector(`#bau-step-${l} [name="${S.name}"]`);if(!ee||ee.offsetParent===null)continue;ee.value.trim()||(U="Field is empty",te(`Erro: O campo '${S.label}' \xE9 obrigat\xF3rio.`,{error:!0}),T=!1)}if(!T){console.warn(`Validation failed for required field "${S.name}" in step ${l}: ${U}`),E=!1;break}}}return E}M.addEventListener("click",()=>{if(D(a)&&f(a)){n==="BAU"?a++:a===5?a=4:a++,z();let l=c.querySelector(".bau-content");l&&(l.scrollTop=0),P.playClick()}}),j.addEventListener("click",()=>{a>0&&(n==="BAU"?a--:a===4?a=5:a===5?a=0:a--,z(),P.playClick())});async function A(){let l=await Ce()||{};(!l.amName||l.amName==="N/A")&&(l.amName=l.internalEmail||"N/A"),o=l,C.querySelectorAll(".bau-vital-highlights").forEach(E=>{let S=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"Website",value:l.site||l.website},{label:"Case ID",value:l.caseId}];E.innerHTML=S.map(g=>{let T=g.value&&g.value!=="N/A"&&g.value!=="undefined"&&g.value!=="null"?g.value:"N\xE3o capturado";return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${g.label}</span>
                        <span class="bau-highlight-value">${T}</span>
                    </div>
                `}).join("")}),Ve.steps.forEach(E=>{E.fields&&E.fields.forEach(S=>{if(S.isSmart){let g=l[S.id];S.id==="language"&&l.userProfile?.defaultLanguage&&(g=l.userProfile.defaultLanguage);let T=C.querySelector(`#bau-step-${E.id} [name="${S.name}"]`),U=C.querySelector(`#bau-step-${E.id} #wrapper-${S.id}`);if(T&&(T.value=g&&g!=="N/A"?g:"",S.id==="language"&&g&&g!=="N/A"&&(T.readOnly=!0,T.style.background="#F1F3F4",T.style.cursor="not-allowed")),U){let ee=g&&g!==""&&g!=="N/A"&&g!=="undefined"&&g!=="null";S.id==="language"?U.style.display="block":U.style.display=ee?"none":"block"}}})}),C.querySelectorAll(".bau-all-data").forEach(E=>{let S=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"AM",value:l.amName},{label:"SE ID",value:l.seId},{label:"Site",value:l.site},{label:"Email",value:l.email},{label:"Timezone",value:l.timezone},{label:"Case ID",value:l.caseId},{label:"Programa",value:l.salesProgram},{label:"Idioma",value:l.language}];E.innerHTML=`
                <div class="bau-context-badges-grid">
                    ${S.filter(g=>g.value&&g.value!=="N/A"&&g.value!=="---"&&g.value!=="undefined"&&g.value!=="null").map(g=>`
            ...
            `})}c.querySelector("#bau-top-se-search")?.addEventListener("click",l=>{l.preventDefault(),mt("bau-form-seId")});let R=c.querySelector("#bau-form-cid");R&&R.addEventListener("input",()=>D(1));function N(){let l=new FormData(C),w=Object.fromEntries(l.entries()),v=c.querySelector("#bau-confirmation-details");if(v){if(n==="BAU"){let E=l.getAll("taskType"),S=E.length>0?E.join(", "):"Nenhuma";v.innerHTML=`
            ...
            `;v.querySelectorAll(".bau-confirm-value-input").forEach(E=>{E.addEventListener("input",S=>{let g=S.target.dataset.field,T=S.target.dataset.step;if(!g||!T)return;let U=C.querySelector(`#bau-step-${T} [name="${g}"]`);U&&(U.value=S.target.value,g==="cid"&&D(1))})})}}async function K(l){I(),i=!0,s=l.id,n=l.status==="PENDING_TL_DISCARD"||l.reason&&!l.task?"DISCARD":"BAU",_("form"),await A(),o={...o,advName:l.advName||o.advName,cid:l.cid||o.cid,caseId:l.caseId||o.caseId,seId:l.seId||o.seId,site:l.site||o.site,email:l.advEmail||o.email,timezone:l.timezone||o.timezone,language:l.language||o.language,amName:l.amName||o.amName,salesProgram:l.salesProgram||o.salesProgram};let w=l.availability?l.availability.split("|").map(v=>v.trim()):[];C.querySelectorAll("input, select, textarea").forEach(v=>{let E=v.name,S={advEmail:"advEmail",website:"site",site:"site"};if(E==="taskType"){let g=(l.task||l.taskType||"").split(",").map(T=>T.trim());v.type==="checkbox"&&(v.checked=g.includes(v.value),v.closest(".bau-task-item")?.classList.toggle("active",v.checked))}else if(E.startsWith("availability_")){let g=parseInt(E.split("_")[1])-1,T=w[g];if(T&&v.type==="datetime-local")try{let U=new Date(T);if(!isNaN(U.getTime())){let ee=new Date(U.getTime()-U.getTimezoneOffset()*6e4).toISOString().slice(0,16);v.value=ee}}catch{}}else l[E]!==void 0?v.value=l[E]:E==="reason"?v.value=l.reason:E==="description"?v.value=l.description:E==="nonImplementationReason"&&(v.value=l.nonImplementationReason||"")}),a=n==="BAU"?1:5,z(),P.playClick()}C.onsubmit=async l=>{l.preventDefault();let w=n==="BAU"?[1,2,3]:[5];for(let U of w)if(!Ve.steps.find(x=>x.id===U)?.isConfirmation&&(!D(U)||!f(U))){console.warn(`Form submission blocked by validation failure in step ${U}`),a=U,z();return}let v=c.querySelector(".bau-btn-submit");v.disabled=!0,v.innerHTML="Enviando...";let E=new FormData(C),S=Object.fromEntries(E.entries()),g=o||{},T={...g,...S,requestType:n};if(S.advEmail?T.advEmail=S.advEmail:g.email&&(T.advEmail=g.email),S.website?T.website=S.website:g.site&&(T.website=g.site),n==="BAU"){let U=E.getAll("taskType"),ee=[S.availability_1,S.availability_2,S.availability_3].filter(x=>x&&x.trim()!=="").join(" | ");T.taskType=U.join(", "),T.availability=ee}else T.taskType="",T.availability="",T.nonImplementationReason="",T.reason=S.reason;try{i?await Gt(s,T):await Ht(T,g.agentEmail||"anon"),P.playSuccess();let U=c.querySelector(".bau-success-title");U&&(i?U.textContent="Caso atualizado com sucesso!":U.textContent=n==="DISCARD"?"Caso enviado para descarte com sucesso!":"Caso enviado com sucesso!"),_("success")}catch(U){te("Erro: "+(U.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",T)}finally{v.disabled=!1,v.innerHTML=`${pe.send} Enviar para o TL`}};function I(){C.reset(),a=0,n="BAU",i=!1,s=null,z(),C.querySelectorAll(".bau-task-item.active").forEach(w=>w.classList.remove("active"));let l=C.querySelector('[name="language"]');l&&(l.readOnly=!1,l.style.background="",l.style.cursor="")}c.querySelector("#bau-new-case-btn").addEventListener("click",()=>{I(),_("form"),A()}),c.querySelector("#bau-form-back-btn").addEventListener("click",()=>_("dashboard")),c.querySelector("#bau-success-back-btn").addEventListener("click",()=>_("dashboard"));async function Z(){t=!t,c.style.display=t?"flex":"none",t&&(_("dashboard"),B()),ge(t,c,"cw-btn-bauform")}return z(),Z}function ba(){if(window.techSolInitialized){It();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Xt();try{P.initGlobalListeners(),P.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}de.fetchTips(),It();let e=wo(),o=Eo(),a=To(),n=Io(),i=Mo(),s=No(),r=zo(),c=$o(),u=Lo();mo({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:c,broadcastControl:u}),setTimeout(()=>{de.logEvent("App","Start","Session Start"),Oo(),setTimeout(()=>{_o(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),te("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}ba();})();
