...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let h=u.querySelector(".cw-hero-grid"),y=u.querySelector(".cw-acc-container"),b=u.querySelector(".cw-results-container"),m=u.querySelector(".cw-search-input"),T=u.querySelector(".cw-status-bar"),E=u.querySelector(".cw-status-text"),F=u.querySelector(".cw-footer-icons");s.forEach(([_,q])=>{let B=i(q.name),X=document.createElement("div");X.className="cw-hero-card",X.id=`hero-${_}`,X.style.setProperty("--hero-color",B.color),X.innerHTML=`
...
<b>If Yes, user access email:</b> ${ee}
...
`.replace(/\n/g,"<br>");nt(_);let q=await yt();q?(q.innerText.trim()===""&&(q.innerHTML=""),document.execCommand("insertHTML",!1,_),ht(q),te("Nota gerada e inserida!")):te("Copiado! Abra uma nota para colar.")},e}var ye=t=>new Promise(e=>setTimeout(e,t));function Se(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function qe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function vt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ge(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let d=e.getBoundingClientRect();s=d.left+d.width/2,r=d.top+d.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let c=i.x-s,u=i.y-r;t?(P.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof wo=="function"&&wo(e,o)):(P.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof zt=="function"&&zt(e))}function wo(t,e){zt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function zt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function So(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=so(t,X),s=mo(g),r=uo(()=>{R(),W.setActiveTasks(r.getCheckedElements())},g,W),c=document.createElement("div");c.style.display="none";let u=po((f,O)=>{N(f,O)});c.appendChild(u);let d=document.createElement("div");d.id="evidence-container",Object.assign(d.style,{display:"none",marginTop:"16px",padding:"16px",background:H.bgInput,border:`1px solid ${H.border}`,borderRadius:ue.medium,boxShadow:Re.subtle});let p=document.createElement("div");p.className="cw-section-title",p.textContent=g("evidencias_contato"),d.appendChild(p);let h={},y=(f,O)=>{let $=document.createElement("div");$.style.marginBottom="12px";let J=document.createElement("label");J.textContent=O,J.setAttribute("for",f),J.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${H.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let V=document.createElement("input");return V.type="text",V.id=f,V.className="cw-input",V.placeholder="https://screenshot.googleplex.com/...",V.style.marginBottom="0",$.appendChild(J),$.appendChild(V),h[f]=V,$};d.appendChild(y("evidence-l1",g("ligacao_1"))),d.appendChild(y("evidence-l2",g("ligacao_2"))),d.appendChild(y("evidence-msg",g("mensagem_am")));let b=bo({onSaveCurrent:async()=>{let f=await w();return C(),f},onLoadDraft:f=>{v(f)},t:f=>g(f)}),m=L(),T=z(),E=document.createElement("div"),F=U(),j=Z(b,g);o.appendChild(m),o.appendChild(T),o.appendChild(F),o.appendChild(c),o.appendChild(E),o.appendChild(d),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let M=document.createElement("button");M.id="manual-task-toggle",M.textContent=g("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",M.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${H.primary}; background: ${H.surface}; color: ${H.primary}; border-radius: ${ue.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${le}; text-transform: uppercase; letter-spacing: 0.5px;`,M.onmouseenter=()=>{M.style.background=H.primaryBg},M.onmouseleave=()=>{M.style.background=H.surface},M.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",M.style.display="none"},o.appendChild(M),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(j);let ee=document.createElement("div");ee.style.display="none",ee.style.flexGrow="1",ee.style.minHeight="0",ee.style.overflow="hidden";let ae=ho(()=>G());ae.style.height="100%",ee.appendChild(ae),e.insertBefore(ee,i);let _=a.lastElementChild;_&&(_.insertBefore(b.historyBtnWrapper,_.firstChild),_.insertBefore(S(),_.firstChild)),e.appendChild(b.drawer);let q=null;W.subscribe(f=>{K(f),B(),f.isDirty?(q&&clearTimeout(q),q=setTimeout(async()=>{let O=await w(!0);O.subStatus?he.saveEmergency(O):he.clearEmergency(),f.isDirty=!1},2e3)):q&&(clearTimeout(q),q=null)});function B(){let f=he.getCount()>0,O=!!W.currentSubStatus;ft(f||O)}function X(){W.visible=!W.visible,ge(W.visible,e,"cw-btn-notes")}function G(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",ee.style.display="flex",ee.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",ee.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function L(){let f=document.createElement("div");if(f.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let $=document.createElement("style");$.id="cw-segmented-styles",$.innerHTML=`
            ...
            `,document.head.appendChild($)}let O=($,J)=>{let oe=f.querySelector(`#${$}`).querySelector(".cw-segmented-indicator");oe&&(oe.style.transform=`translateX(${J*100}%) translateX(${J*2}px)`)};return f.querySelectorAll("#lang-selector button").forEach(($,J)=>{$.onclick=()=>{W.setLanguage($.dataset.lang),f.querySelectorAll("#lang-selector button").forEach(V=>V.classList.remove("active")),$.classList.add("active"),O("lang-selector",J),P.playHover(),W.currentSubStatus&&k(W.currentSubStatus)}}),f.querySelectorAll("#type-selector button").forEach(($,J)=>{$.onclick=()=>{W.setCaseType($.dataset.type),f.querySelectorAll("#type-selector button").forEach(V=>V.classList.remove("active")),$.classList.add("active"),O("type-selector",J),P.playHover(),W.currentSubStatus&&k(W.currentSubStatus)}}),f.querySelectorAll("#portugal-selector button").forEach(($,J)=>{$.onclick=()=>{W.setPortugalCase($.dataset.val==="true"),f.querySelectorAll("#portugal-selector button").forEach(V=>V.classList.remove("active")),$.classList.add("active"),O("portugal-selector",J),P.playHover(),W.currentSubStatus&&k(W.currentSubStatus)}}),f}function z(){let f=document.createElement("div");f.className="cw-status-section",f.style.cssText="display: flex; flex-direction: column; gap: 8px;",f.innerHTML=`
        ...
        `;let O=f.querySelector("#main-status-select"),$=f.querySelector("#sub-status-select");return O.onchange=()=>{W.setStatus(O.value),x(O.value,$),W.setSubStatus(""),k("")},$.onchange=()=>{W.setSubStatus($.value),k($.value)},f}function D(){return d.style.display==="none"?null:{l1:h["evidence-l1"]?.value.trim()||"",l2:h["evidence-l2"]?.value.trim()||"",msg:h["evidence-msg"]?.value.trim()||""}}function x(f,O){if(O.innerHTML=`<option value="">${g("select_substatus")}</option>`,!f){O.disabled=!0;return}for(let $ in Oe)if(Oe[$].status===f){let J=document.createElement("option");J.value=$,J.textContent=Oe[$].name,O.appendChild(J)}O.disabled=!1}function k(f){let O=Oe[f],$=f==="NI_Attempted_Contact"||O&&O.name&&O.name.toLowerCase().includes("attempted contact");if(u.render&&u.render(f,W.currentCaseType),!f){d.style.display="none",h["evidence-l1"]&&(h["evidence-l1"].value=""),h["evidence-l2"]&&(h["evidence-l2"].value=""),h["evidence-msg"]&&(h["evidence-msg"].value=""),c.style.display="none",E.style.display="none";let re=document.getElementById("manual-task-toggle");re&&(re.style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",F.style.display="flex",F.style.opacity="1",j.style.display="none";return}$?d.style.display="block":(d.style.display="none",h["evidence-l1"]&&(h["evidence-l1"].value=""),h["evidence-l2"]&&(h["evidence-l2"].value=""),h["evidence-msg"]&&(h["evidence-msg"].value="")),F.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(F.style.display="none")},400),j.style.display="grid",O&&O.templateFields&&W.setActiveFields(O.templateFields),l(),_t(f,E,W),E.style.display="block",c.style.display="block";let J=f.startsWith("SO_"),V=f==="NI_Awaiting_Validation",oe=document.getElementById("manual-task-toggle");J||V?(r.selectionElement.style.display="block",oe.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",oe.style.display="block");let Y=f==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(Y),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(f),R();let ne=document.getElementById("email-automation-toggle-row");ne&&(ne.style.display=We[f]?"flex":"none")}function R(){let f=r.getCheckedElements().map(O=>O.value);s.updateVisibility(W.currentSubStatus,f)}function N(f,O){let $=ut[f];if($){for(let J in $)if(J==="linkedTask")r.toggleTask($.linkedTask,O);else if(J==="activeTasks")$.activeTasks.forEach(V=>{O?r.setTaskCount(V.value,V.count):r.setTaskCount(V.value,0)});else if(J.startsWith("field-")){let V=J,oe=$[J],Y=document.getElementById(V);if(Y){let ne=Xe.includes(V.replace("field-",""));if(O)if(ne){let re=Y.value.trim();re.includes(oe.trim())||(Y.value=re?re+`
...
`))}else Y.value.trim()===oe.trim()&&(Y.value="");W.updateField(V,Y.value),Y.dispatchEvent(new Event("input"))}}}}function Z(f,O){let $=document.createElement("div");if($.className="cw-actions-section",$.style.cssText=`
            display: grid;
        ...
        `;let V=f.parkButton;V.classList.add("js-btn-park"),V.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let oe=document.createElement("button");oe.className="cw-btn-secondary js-btn-reset",oe.textContent=O("limpar"),oe.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.textSub}; border: 1px solid ${H.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,oe.onclick=()=>C();let Y=document.createElement("button");Y.className="cw-btn-secondary js-btn-copy",Y.textContent=O("copiar"),Y.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.primary}; border: 1px solid ${H.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,Y.onclick=()=>I();let ne=document.createElement("button");return ne.className="cw-btn-primary js-btn-generate",ne.textContent=O("preencher"),ne.style.cssText=`width: 100%; height: 38px; background: ${H.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ne.onclick=()=>Q(),$.appendChild(J),$.appendChild(V),$.appendChild(oe),$.appendChild(Y),$.appendChild(ne),$}async function I(){if(!W.currentSubStatus){te(g("select_substatus"),{error:!0});return}let f=Dt(W,r,s,D());f?(nt(f),te(g("copiado_sucesso")),P.playClick()):te(g("select_substatus"),{error:!0})}async function Q(){if(!W.currentSubStatus){te(g("select_substatus"),{error:!0});return}let f=Dt(W,r,s,D());nt(f),X();let O=at(),$=await yt();if($){$.focus(),document.execCommand("insertHTML",!1,f),ht($);let J=document.getElementById("email-automation-checkbox");(!J||J.checked)&&W.currentSubStatus&&We[W.currentSubStatus]&&await St(We[W.currentSubStatus]),te(g("inserido_copiado")),P.playSuccess(),C()}O()}function l(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let f=Oe[W.currentSubStatus];f&&f.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function C(){W.reset(),r.reset(),s.reset(),B(),he.clearEmergency(),o.querySelectorAll("select").forEach(O=>O.value=""),o.querySelector("#sub-status-select").disabled=!0;let f=document.getElementById("email-automation-toggle-row");f&&(f.style.display="none"),E.innerHTML="",c.style.display="none",F.style.display="flex",F.style.opacity="1",j.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",d.style.display="none",h["evidence-l1"]&&(h["evidence-l1"].value=""),h["evidence-l2"]&&(h["evidence-l2"].value=""),h["evidence-msg"]&&(h["evidence-msg"].value="")}async function w(f=!1){let O={};E.querySelectorAll("input, textarea, select").forEach(Y=>{(Y.id.startsWith("field-")||Y.id==="consent-select")&&(O[Y.id]=Y.value)});let $="Cliente",J="---";if(!f)try{let Y=await Ce();$=Y.advertiserName,J=Y.cid}catch(Y){console.warn("Erro ao coletar pageData:",Y)}let V=r.getCheckedElements().map(Y=>({key:Y.value,count:Y.count})),oe=V.map(Y=>{let ne=Ee[Y.key];return ne?ne.name:Y.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:O,activeTasks:V,summaryTags:oe,clientName:$,cid:J,timestamp:new Date().toISOString()}}let A=f=>new Promise(O=>setTimeout(O,f));async function v(f){W.setLanguage(f.currentLang||"pt"),W.setCaseType(f.currentCaseType||"bau"),W.setPortugalCase(f.isPortugalCase||!1),W.setConsent(f.consent||!1),W.setExcludedFields(f.excludedFields||[]),f.activeFields&&W.setActiveFields(f.activeFields);let O=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);O&&O.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(V=>{V!==O&&V.classList.remove("active")});let $=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);$&&$.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(V=>{V!==$&&V.classList.remove("active")});let J=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if(J&&J.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(V=>{V!==J&&V.classList.remove("active")}),f.status){let V=o.querySelector("#main-status-select");V.value=f.status,W.setStatus(f.status);let oe=o.querySelector("#sub-status-select");if(x(f.status,oe),await A(50),f.subStatus){if(oe.value=f.subStatus,W.setSubStatus(f.subStatus),k(f.subStatus),await A(100),f.tagSupportUsed!==void 0){W.setTagSupportUsed(f.tagSupportUsed);let Y=s.element.querySelector('input[value="Sim"]'),ne=s.element.querySelector('input[value="N\xE3o"]');f.tagSupportUsed&&Y?Y.checked=!0:ne&&(ne.checked=!0),s.element.querySelector("div:last-child").style.display=f.tagSupportUsed?"none":"block"}f.forcedScreenshots&&W.setForcedScreenshots(f.forcedScreenshots);for(let Y in f.formData){let ne=document.getElementById(Y);ne&&(ne.value=f.formData[Y],W.updateField(Y,ne.value))}f.activeTasks&&(f.activeTasks.forEach(Y=>r.setTaskCount(Y.key,Y.count)),W.setActiveTasks(r.getCheckedElements()))}}W.isDirty=!1}function g(f){return Ae[W.currentLang]?.[f]||Ae.pt?.[f]||f}function S(){let f=document.createElement("div");return f.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',f.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",f.onclick=O=>{O.stopPropagation(),G()},f.title="Alternar para Split & Transfer",f}function U(){let f=document.createElement("div");return f.id="notes-empty-state",f.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(u),Object.assign(c.style,fe,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let d=me(c,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:c},()=>z()),p=document.createElement("div");Object.assign(p.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:r.bgApp});let h=document.createElement("div");Object.assign(h.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${r.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let y=document.createElement("div");Object.assign(y.style,{padding:"16px",borderBottom:`1px solid ${r.borderSubtle}`,position:"relative"});let b=document.createElement("input");b.placeholder="Buscar templates...",Object.assign(b.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:r.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),b.onfocus=()=>{b.style.backgroundColor="#FFFFFF",b.style.borderColor=r.primary,b.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",b.style.transform="scale(1.02)"},b.onblur=()=>{b.style.backgroundColor="#E3E3E8",b.style.borderColor="transparent",b.style.boxShadow="none",b.style.transform="scale(1)"};let m=document.createElement("div");m.id="email-template-list",Object.assign(m.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let T=document.createElement("div");T.innerHTML="\u2715",Object.assign(T.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),T.onclick=()=>{b.value="",n="",T.style.display="none",x(),b.focus()},y.appendChild(b),y.appendChild(T),h.appendChild(y),h.appendChild(m);let E=document.createElement("div");Object.assign(E.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:r.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let F=document.createElement("div");Object.assign(F.style,{padding:"20px",borderBottom:`1px solid ${r.borderSubtle}`,backgroundColor:r.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let j=document.createElement("div");Object.assign(j.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:r.bgApp,overflow:"hidden"});let M=document.createElement("div");Object.assign(M.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let ee=document.createElement("span");ee.textContent="Preview do E-mail",Object.assign(ee.style,{fontSize:"12px",fontWeight:"600",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let ae=document.createElement("div");Object.assign(ae.style,{display:"flex",gap:"8px"});let _=(I,Q=!1)=>{let l=document.createElement("button");return l.textContent=I,Object.assign(l.style,{padding:"8px 14px",borderRadius:"10px",border:Q?"none":`1.5px solid ${r.primary}`,background:Q?r.primary:"transparent",color:Q?"#fff":r.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:Q?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),l.onmouseenter=()=>{Q?(l.style.backgroundColor="#0062CC",l.style.transform="translateY(-1px)",l.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):l.style.backgroundColor="rgba(0, 122, 255, 0.05)"},l.onmouseleave=()=>{Q?(l.style.backgroundColor=r.primary,l.style.transform="translateY(0)",l.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(l.style.backgroundColor="transparent",l.style.transform="translateY(0)")},l.onmousedown=()=>l.style.transform="scale(0.94)",l.onmouseup=()=>l.style.transform="scale(1)",l},q=_("Copiar HTML"),B=_("Preencher no CRM",!0),X=_("Smart CR");X.style.borderColor="#E67E22",X.style.color="#E67E22",X.style.display="none",ae.appendChild(X),ae.appendChild(q),ae.appendChild(B),M.appendChild(ee),M.appendChild(ae);let G=document.createElement("div");G.contentEditable="true",Object.assign(G.style,{flex:"1",backgroundColor:r.bgSurface,border:`1px solid ${r.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:r.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),j.appendChild(M),j.appendChild(G),Z(),E.appendChild(F),E.appendChild(j),p.appendChild(h),p.appendChild(E),c.appendChild(d),c.appendChild(p);let L=document.createElement("div");Object.assign(L.style,Ie),c.appendChild(L),Le(c,L),document.body.appendChild(c);function z(){e=!e,e?(c.style.display="flex",eo(c),o.length===0&&D()):c.style.display="none",ge(e,c,"cw-btn-email")}async function D(){m.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await Ao.getTemplates(),x()}function x(){m.innerHTML="";let I=o.filter(A=>A.name.toLowerCase().includes(n.toLowerCase())||A.category.toLowerCase().includes(n.toLowerCase())),Q=Object.entries(We).filter(([A,v])=>v&&(A.toLowerCase().includes(n.toLowerCase())||v.toLowerCase().includes(n.toLowerCase()))).map(([A,v])=>({id:A,name:A.replace(/_/g," "),category:"\u26A1 Smart CRs",code:v,isSmartCR:!0})),l=we.getSnippets("email").filter(A=>A.title.toLowerCase().includes(n.toLowerCase())||A.subject&&A.subject.toLowerCase().includes(n.toLowerCase())).map(A=>{let v=[],g=A.content.match(/\[([^\]]+)\]/g);return g&&[...new Set(g)].forEach(S=>{v.push({key:S,label:S.replace("[","").replace("]",""),type:S.toLowerCase().includes("data")?"date":"text",auto:S.toLowerCase().includes("nome")&&S.toLowerCase().includes("seu")?"agentName":null})}),{id:A.id||`snippet-${Math.random()}`,name:A.title,category:"\u{1F464} Pessoal",subject:A.subject||"Sem Assunto",template:A.content,placeholders:v}}),C=[...I,...Q,...l];if(C.length===0){m.innerHTML=`
                ...
                </div>`;return}[...new Set(C.map(A=>A.category))].sort((A,v)=>A.localeCompare(v)).forEach(A=>{let v=s.has(A)||n.length>0,g=C.filter($=>$.category===A),S=document.createElement("div");Object.assign(S.style,{padding:"12px 16px 12px 24px",fontSize:"11px",fontWeight:"700",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.8px",position:"sticky",top:"-8px",backgroundColor:"rgba(239, 239, 240, 0.9)",zIndex:"10",backdropFilter:"blur(20px)",margin:"0 -8px 8px -8px",borderBottom:`0.5px solid ${r.borderSubtle}`,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none",transition:"background-color 0.2s ease"}),S.onmouseenter=()=>S.style.backgroundColor="rgba(230, 230, 232, 0.9)",S.onmouseleave=()=>S.style.backgroundColor="rgba(239, 239, 240, 0.9)";let U=document.createElement("span");U.textContent=A,S.appendChild(U);let K=document.createElement("span");K.textContent=g.length,Object.assign(K.style,{backgroundColor:"rgba(0, 0, 0, 0.05)",padding:"2px 8px",borderRadius:"10px",fontSize:"10px",color:r.textSecondary});let f=document.createElement("span");f.innerHTML=v?"\u{10012A}":"\u{10012B}",f.innerHTML=v?"\u25BE":"\u25B8",f.style.marginLeft="8px",f.style.transition="transform 0.3s ease";let O=document.createElement("div");O.style.display="flex",O.style.alignItems="center",O.appendChild(K),O.appendChild(f),S.appendChild(O),S.onclick=()=>{s.has(A)?s.delete(A):s.add(A),x()},m.appendChild(S),v&&g.forEach($=>{let J=a&&a.id===$.id,V=document.createElement("div");if(Object.assign(V.style,{padding:"12px 14px",fontSize:"14px",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)",borderRadius:"10px",color:r.textPrimary,margin:"4px 6px",display:"flex",alignItems:"center",gap:"12px",backgroundColor:J?r.primary:r.bgSurface,boxShadow:J?"0 4px 12px rgba(0, 122, 255, 0.3)":"0 1px 2px rgba(0,0,0,0.05)",border:J?"none":`1px solid ${r.borderSubtle}`,position:"relative",overflow:"hidden"}),J){let ne=document.createElement("div");Object.assign(ne.style,{position:"absolute",left:"0",top:"0",bottom:"0",width:"4px",backgroundColor:"#fff",borderRadius:"0 4px 4px 0"}),V.appendChild(ne)}let oe=document.createElement("span");oe.innerHTML=$.isSmartCR?"\u26A1":$.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",oe.style.fontSize="12px",oe.style.opacity="0.7",oe.style.flexShrink="0",V.appendChild(oe);let Y=document.createElement("span");Y.textContent=$.name,Y.style.overflow="hidden",Y.style.textOverflow="ellipsis",Y.style.whiteSpace="nowrap",Y.style.flex="1",V.appendChild(Y),J&&(V.style.color="#fff",V.style.fontWeight="600",oe.style.opacity="1"),V.onmouseenter=()=>{J||(V.style.backgroundColor="#f8f8f9",V.style.transform="translateY(-1px) scale(1.01)",V.style.boxShadow="0 4px 8px rgba(0,0,0,0.08)",V.style.borderColor="rgba(0, 122, 255, 0.2)")},V.onmouseleave=()=>{J||(V.style.backgroundColor=r.bgSurface,V.style.transform="translateY(0) scale(1)",V.style.boxShadow="0 1px 2px rgba(0,0,0,0.05)",V.style.borderColor=r.borderSubtle)},V.onmousedown=()=>{V.style.transform=J?"scale(0.97)":"scale(0.98)"},V.onmouseup=()=>{V.style.transform=J?"scale(1)":"translateY(-1px) scale(1.01)"},V.onclick=()=>{R($)},m.appendChild(V)})})}let k=null;async function R(I){a?.id!==I.id&&(a=I,k&&clearTimeout(k),E.style.opacity="0",E.style.transform="translateY(5px)",k=setTimeout(()=>{X.style.display=I.isSmartCR?"block":"none",B.style.display=I.isSmartCR?"none":"block",q.style.display=I.isSmartCR?"none":"block",x(),N(),Z(),E.style.opacity="1",E.style.transform="translateY(0)",k=null},150))}function N(){if(F.innerHTML="",!a||a.isSmartCR){a?.isSmartCR?(F.style.display="block",F.innerHTML=`<div style="padding: 12px; font-size: 13px; color: #856404; background: #FFF3CD; border: 1px solid #FFEEBA; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
                ...
                </div>`):F.style.display="none";return}let I=a.placeholders&&a.placeholders.length>0;if(F.style.display=I?"block":"none",!I)return;let Q=document.createElement("div");Object.assign(Q.style,{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"}),(a.placeholders||[]).forEach(l=>{let C=document.createElement("div"),w=document.createElement("label");w.textContent=l.label,Object.assign(w.style,{display:"block",fontSize:"11px",fontWeight:"700",color:r.textSecondary,marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.5px"});let A=document.createElement("input");A.type=l.type||"text",A.dataset.key=l.key,Object.assign(A.style,{width:"100%",padding:"10px 12px",borderRadius:"8px",border:`1.5px solid ${r.borderSubtle}`,backgroundColor:"#FBFBFD",fontSize:"14px",boxSizing:"border-box",transition:"all 0.2s ease",outline:"none"}),A.onfocus=()=>{A.style.borderColor=r.primary,A.style.backgroundColor="#FFFFFF",A.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)"},A.onblur=()=>{A.style.borderColor=r.borderSubtle,A.style.backgroundColor="#FBFBFD",A.style.boxShadow="none"},l.auto==="agentName"&&(A.value=Qe().split(" ")[0]),A.addEventListener("input",Z),C.appendChild(w),C.appendChild(A),Q.appendChild(C)}),F.appendChild(Q)}function Z(){if(!a){G.innerHTML=`
...
CID: ${g.cid||"---"}
Case ID: ${g.caseId||"---"}
E-mail: ${g.clientEmail||"---"}`;U&&(U.value=f),K&&(K.style.display="block",K.style.maxHeight="300px",K.style.opacity="1",K.scrollIntoView({behavior:"smooth",block:"end"}))})}function y(){r=!r,ge(r,c,"cw-btn-script"),r?(p(),d||(d=setInterval(p,2e3))):d&&(clearInterval(d),d=null)}let b=me(c,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",u,()=>{y()});c.appendChild(b);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
  ...
  `;let T=m.querySelector("#csa-toggle-options"),E=m.querySelector("#csa-options-content"),F=m.querySelector("#csa-options-arrow"),j=!1;T.onclick=()=>{j=!j,F.style.transform=j?"rotate(180deg)":"rotate(0deg)",E.style.maxHeight=j?"400px":"0",E.style.opacity=j?"1":"0",E.style.marginTop=j?"8px":"0",P.playClick()};let M=m.querySelector("#cw-pill-message"),ee=m.querySelector("#cw-am-copy-final"),ae=m.querySelector("#cw-am-message-area");M.onmouseenter=()=>{M.style.borderColor="#007AFF",M.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},M.onmouseleave=()=>{M.style.borderColor="#DADCE0",M.style.boxShadow="0 1px 2px rgba(0,0,0,0.02)"},M.addEventListener("click",()=>{h()}),ee.addEventListener("click",()=>{ae.value&&(navigator.clipboard.writeText(ae.value),te("Mensagem copiada!"),P.playSuccess(),ee.style.background="#34A853",ee.textContent="Copiado!",setTimeout(()=>{ee.style.background="#1A73E8",ee.textContent="Copiar Mensagem Final"},2e3))});let _=(g,S)=>{let U=m.querySelector(g),K=m.querySelector(S);U.onclick=()=>{let f=K.textContent;!f||f.includes("---")||f.includes("N\xE3o encontrado")||(navigator.clipboard.writeText(f),P.playSuccess(),U.classList.add("copied"),setTimeout(()=>U.classList.remove("copied"),1500))}};c.appendChild(m);let q=document.createElement("div");Object.assign(q.style,a.progressBarContainer);let B=document.createElement("div");B.className="csa-progress-fill",Object.assign(B.style,a.progressBarFill),q.appendChild(B),c.appendChild(q);let X=document.createElement("div");X.id="csa-content",Object.assign(X.style,a.contentArea),c.appendChild(X);let G=document.createElement("div");Object.assign(G.style,a.footer);let L=document.createElement("span");L.textContent="by lucaste@",Object.assign(L.style,{fontSize:"10px",color:"#bdc1c6"});let z=document.createElement("button");z.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> Resetar Script',Object.assign(z.style,a.resetBtn),z.onmouseenter=()=>z.style.background="#fce8e6",z.onmouseleave=()=>z.style.background="transparent",z.onclick=()=>{z.style.transform="scale(0.9)",setTimeout(()=>z.style.transform="scale(1)",150);for(let g in n)delete n[g];w()},G.appendChild(L),G.appendChild(z),c.appendChild(G);let D=document.createElement("div");Object.assign(D.style,{display:"flex",flexDirection:"column",gap:"8px",marginBottom:"16px"});let x=document.createElement("div");x.className="csa-segmented-control",x.innerHTML=`
  ...
  `,m.onfocus=()=>{y.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",y.style.border="1px solid #1a73e8"},m.onblur=()=>{y.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",y.style.border="1px solid transparent"},y.appendChild(b),y.appendChild(m),h.appendChild(y),p.appendChild(h);let T=document.createElement("div");T.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(T);let E=null;function F(){if(E)return;E=document.createElement("div"),E.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let L=document.createElement("div");L.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",L.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let z=document.createElement("button");z.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',z.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",z.onclick=()=>{M(),n=!1,q()},L.appendChild(z),E.appendChild(L);let D=document.createElement("div");D.id="cw-history-list",D.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",E.appendChild(D),p.appendChild(E)}function j(){E||F();let L=E.querySelector("#cw-history-list");L.innerHTML="";let z=ua();z.length===0?L.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':z.forEach(D=>{let x=X(D,Ge[D._originalCat],!0,D._originalCat);L.appendChild(x)}),requestAnimationFrame(()=>E.style.transform="translateY(0)")}function M(){E&&(E.style.transform="translateY(100%)")}function ee(){d.innerHTML="";let L=ae("history","Recentes",Ge.history);L.id="cw-sidebar-btn-history",L.onclick=()=>{P.playClick(),n=!n,n?j():M(),q()},d.appendChild(L);let z=document.createElement("div");z.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(z),Object.keys(it).forEach(D=>{let x=it[D],k=ae(D,x.label,Ge[D]);k.id=`cw-sidebar-btn-${D}`,k.onclick=()=>{P.playClick(),n&&(n=!1,M()),_(D)},d.appendChild(k)})}function ae(L,z,D){let x=document.createElement("div");x.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,x.title=z,x.dataset.key=L;let k=document.createElement("div");k.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",k.innerHTML=D||Ge.tasks;let R=document.createElement("div");return R.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",R.textContent=z,x.appendChild(k),x.appendChild(R),x.onmouseenter=()=>{a!==L&&!(L==="history"&&n)&&(x.style.background="#F1F3F4",k.style.transform="scale(1.1)")},x.onmouseleave=()=>{a!==L&&!(L==="history"&&n)&&(x.style.background="transparent",k.style.transform="scale(1)")},x}function _(L){let z=document.getElementById(`cat-anchor-${L}`);z&&(z.scrollIntoView({behavior:"smooth",block:"start"}),a=L,q())}function q(){Object.keys(it).forEach(z=>{let D=d.querySelector(`#cw-sidebar-btn-${z}`);if(D)if(a===z&&!n){let x=Ct[z];D.style.background=x.bg,D.style.color=x.color,D.querySelector("div:first-child").style.transform="scale(1.1)"}else D.style.background="transparent",D.style.color=i.textSecondary,D.querySelector("div:first-child").style.transform="scale(1)"});let L=d.querySelector("#cw-sidebar-btn-history");L&&(n?(L.style.background="#3C4043",L.style.color="#FFFFFF"):(L.style.background="transparent",L.style.color=i.textSecondary))}function B(){if(T.innerHTML="",e.trim()!==""){let z=[];if(Object.entries(it).forEach(([x,k])=>{let R=k.links.filter(N=>N.name.toLowerCase().includes(e.toLowerCase())||N.desc.toLowerCase().includes(e.toLowerCase()));z.push(...R.map(N=>({...N,_cat:x})))}),z.length===0){T.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let D=document.createElement("div");D.innerHTML="Resultados da busca",D.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",T.appendChild(D),z.forEach(x=>{let k=X(x,Ge[x._cat],!1,x._cat);T.appendChild(k)});return}Object.entries(it).forEach(([z,D])=>{let x=Ct[z],k=document.createElement("div"),R=document.createElement("div");R.id=`cat-anchor-${z}`,R.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,R.innerHTML=`
            ...
            ${D.label}
          `,k.appendChild(R);let N=document.createElement("div");N.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",D.links.forEach(Z=>{let I=X(Z,Ge[z],!1,z);N.appendChild(I)}),k.appendChild(N),T.appendChild(k)});let L=document.createElement("div");L.style.height="80px",T.appendChild(L)}function X(L,z,D,x){let k=document.createElement("div"),R=Ct[x]||Ct.history;k.style.cssText=`
      ...
      `;let N=document.createElement("div");N.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,N.innerHTML=z||Ge.tasks;let Z=N.querySelector("svg");Z&&(Z.style.width="22px",Z.style.height="22px");let I=document.createElement("div");I.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let Q=document.createElement("div");Q.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,Q.textContent=L.name;let l=document.createElement("div");l.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,l.textContent=L.desc,I.appendChild(Q),I.appendChild(l);let C=document.createElement("div");return C.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',C.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,C.title="Copiar URL",k.onmouseenter=()=>{k.style.transform="translateY(-2px)",k.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",k.style.borderColor="rgba(0,0,0,0.05)",k.style.borderLeft=`4px solid ${R.color}`,C.style.opacity="1",C.style.background="#F1F3F4"},k.onmouseleave=()=>{k.style.transform="translateY(0)",k.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",k.style.border="1px solid transparent",C.style.opacity="0",C.style.background="transparent"},k.onclick=()=>{!D&&x&&Io(L,x),window.open(L.url,"_blank")},C.onclick=w=>{w.stopPropagation(),P.playClick(),navigator.clipboard.writeText(L.url),!D&&x&&Io(L,x),te("Link copiado!")},k.appendChild(N),k.appendChild(I),k.appendChild(C),k}m.addEventListener("input",L=>{e=L.target.value,B()});function G(){o=!o,ge(o,s,"cw-btn-links")}return document.body.appendChild(s),ee(),B(),G}var Be=[];function Bt(t){Be=t}var ma=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Oo(){let t="v4.9",e=!1,o=null,a=null;function n(x){if(!x)return"";try{let k=new Date(x);return isNaN(k.getTime())?String(x):k.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(x)}}if(!document.getElementById("cw-broadcast-hd-css")){let x=document.createElement("style");x.id="cw-broadcast-hd-css",x.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,b.querySelectorAll('input[name="cw-bc-type"]').forEach(N=>{N.addEventListener("change",()=>{b.querySelectorAll(".cw-radio-option").forEach(Z=>Z.classList.remove("checked")),N.parentElement.classList.add("checked")})}),setTimeout(()=>{let N=b.querySelector(".cw-radio-option.info");N&&N.classList.add("checked")},100);let x=b.querySelector("#cw-bc-cancel"),k=b.querySelector("#cw-bc-close-x"),R=b.querySelector("#cw-bc-send");x.onclick=j,k.onclick=j,R.onclick=M,u.appendChild(b)}function F(x=null){if(!b)return;let k=b.querySelector("#cw-editor-title-label"),R=b.querySelector("#cw-bc-title"),N=b.querySelector("#cw-bc-text"),Z=b.querySelector("#cw-bc-send");if(x){a=x.id,k.textContent="Editar Aviso",R.value=x.title||"",N.value=x.text||"",Z.textContent="Salvar Altera\xE7\xF5es";let I=x.type||"info",Q=b.querySelector(`input[name="cw-bc-type"][value="${I}"]`);Q&&Q.click()}else{a=null,k.textContent="Novo Aviso",R.value="",N.value="",Z.textContent="Publicar";let I=b.querySelector('input[name="cw-bc-type"][value="info"]');I&&I.click()}b.classList.add("active"),setTimeout(()=>R.focus(),300)}function j(){b&&b.classList.remove("active"),a=null}async function M(){let x=b.querySelector("#cw-bc-send"),k=b.querySelector("#cw-bc-title"),R=b.querySelector("#cw-bc-text"),N=b.querySelector('input[name="cw-bc-type"]:checked'),Z=N?N.value:"info";if(!k.value.trim()||!R.value.trim()){te("Preencha todos os campos!",{error:!0});return}x.textContent="Salvando...",x.style.opacity="0.7";let I=!1;a?I=await de.updateBroadcast(a,{title:k.value,text:R.value,type:Z}):I=await de.sendBroadcast({title:k.value,text:R.value,type:Z,author:window._cwCurrentUser||"admin"}),I?(te(a?"Atualizado!":"Publicado!"),P.playSuccess(),j(),setTimeout(()=>_(),1500)):(te("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),x.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",x.style.opacity="1")}async function ee(x){if(await xe("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await de.deleteBroadcast(x)){te("Aviso removido."),P.playClick();let N=Be.findIndex(Z=>Z.id===x);N>-1&&Be.splice(N,1),B(),setTimeout(()=>_(),1500)}else te("Erro ao excluir.",{error:!0})}let ae=document.createElement("div");ae.className="cw-nice-scroll",Object.assign(ae.style,i.feedContainer),u.appendChild(ae);async function _(){e&&(T.style.display="block",T.innerHTML="\u{1F504} Sincronizando...");try{let x=await de.fetchData();x&&x.broadcast&&(Bt(x.broadcast),q(),e&&(B(),T.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{T.style.display="none"},1500)))}catch{e&&(T.innerHTML="\u26A0\uFE0F Offline")}}function q(){let x=document.getElementById("cw-btn-broadcast");if(!x)return;let k=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Be.some(N=>!k.includes(N.id))){if(x.classList.add("has-new"),!x.querySelector(".cw-badge")){let N=document.createElement("div");N.className="cw-badge",Object.assign(N.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),x.appendChild(N)}}else{x.classList.remove("has-new");let N=x.querySelector(".cw-badge");N&&N.remove()}}function B(){ae.innerHTML="";let x=u.querySelector("#cw-bau-widget");x&&x.remove();let k=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),R=[...Be].sort((l,C)=>{let w=new Date(l.date).getTime()||0;return(new Date(C.date).getTime()||0)-w}),N=R.findIndex(l=>l.title&&l.title.toLowerCase().includes("disponibilidade bau"));if(N!==-1){let l=R[N];R.splice(N,1);let C=document.createElement("div");C.id="cw-bau-widget",Object.assign(C.style,i.bauContainer);let w=[],A=(l.text||"").split(`
`),v=/\d{1,2}\/\d{1,2}/,g="\u{1F4C5}";if(A.forEach(O=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(O)?g="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(O)&&(g="\u{1F1EA}\u{1F1F8}");let $=O.match(v);if($){let J=$[0],V=g;/🇧🇷|🇵🇹|PT|BR/i.test(O)?V="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(O)&&(V="\u{1F1EA}\u{1F1F8}"),w.some(Y=>Y.flag===V&&Y.date===J)||w.push({flag:V,date:J})}}),w.length===0){let O=(l.text||"").match(/\d{1,2}\/\d{1,2}/g);O&&[...new Set(O)].forEach($=>w.push({flag:"\u{1F4C5}",date:$}))}let S="",U='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(U=`
              ...
              `),w.length>0?S=`
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                      <div style="flex:1; display:flex; gap:8px;">${w.map($=>`
          ...
          `,T.after(C);let K=C.querySelector("#cw-bau-toggle-btn"),f=C.querySelector("#cw-bau-full");if(K&&f&&(K.onclick=()=>{let O=f.style.display==="none";f.style.display=O?"block":"none",K.textContent=O?"Ocultar":"Detalhes"}),window._cwIsAdmin){let O=C.querySelector(".cw-bau-edit");O&&(O.onclick=()=>F(l))}}let Z=R.sort((l,C)=>{let w=k.includes(l.id),A=k.includes(C.id);return w===A?0:w?1:-1});if(Z.length===0&&!N){let l=document.createElement("div");Object.assign(l.style,i.emptyState),l.innerHTML=`
           ...
           `,ae.appendChild(l)}let I=Z.filter(l=>!k.includes(l.id)),Q=Z.filter(l=>k.includes(l.id));if(I.forEach(l=>ae.appendChild(X(l,!1))),Q.length>0){let l=document.createElement("div");Object.assign(l.style,i.historyDivider),l.innerHTML=`<span>Hist\xF3rico (${Q.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let C=document.createElement("div");Object.assign(C.style,i.historyContainer),Q.forEach(A=>C.appendChild(X(A,!0)));let w=!1;l.onclick=()=>{P.playClick(),w=!w,C.style.display=w?"flex":"none",l.querySelector("svg").style.transform=w?"rotate(180deg)":"rotate(0deg)"},ae.appendChild(l),ae.appendChild(C)}}function X(x,k){let R=document.createElement("div");Object.assign(R.style,k?i.cardHistory:i.card);let N=s[x.type]||s.info,Z=document.createElement("div");Object.assign(Z.style,i.cardHeader);let I=document.createElement("div");Object.assign(I.style,i.typeTag,{color:N.color,background:N.bg}),I.innerHTML=`${N.icon} <span>${x.type}</span>`;let Q=document.createElement("span");if(Object.assign(Q.style,i.dateTag),Q.textContent=n(x.date),Z.appendChild(I),k)Z.appendChild(Q);else{let v=document.createElement("button");v.className="cw-btn-interactive",Object.assign(v.style,i.dismissBtn),v.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',v.onmouseenter=()=>{v.style.color="#1e8e3e",v.style.background="#e6f4ea",v.style.borderColor="#1e8e3e"},v.onmouseleave=()=>{v.style.color="#5f6368",v.style.background="#fff",v.style.borderColor="rgba(0,0,0,0.1)"},v.onclick=g=>{g.stopPropagation(),P.playClick(),R.style.transform="translateX(20px)",R.style.opacity="0",setTimeout(()=>{let S=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");S.push(x.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(S)),B(),q()},200)},Z.appendChild(v)}let l=document.createElement("div");Object.assign(l.style,i.cardContent);let C=document.createElement("div");Object.assign(C.style,i.msgTitle),C.textContent=x.title;let w=document.createElement("div");Object.assign(w.style,i.msgBody),w.innerHTML=c(x.text);let A=document.createElement("div");if(Object.assign(A.style,i.msgMeta),A.innerHTML=`Publicado por <b>${x.author||"Sistema"}</b>`,k||(A.innerHTML+=` \u2022 ${n(x.date)}`),l.appendChild(C),l.appendChild(w),l.appendChild(A),R.appendChild(Z),R.appendChild(l),window._cwIsAdmin){let v=document.createElement("div");v.className="cw-card-actions";let g=document.createElement("button");g.className="cw-action-btn edit",g.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',g.onclick=()=>F(x);let S=document.createElement("button");S.className="cw-action-btn delete",S.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',S.onclick=()=>ee(x.id),v.appendChild(g),v.appendChild(S),R.appendChild(v)}return R}let G=de.getCachedBroadcasts();G.length>0&&(Bt(G),B()),setTimeout(m,500),_(),o||(o=setInterval(_,ma));let L=document.createElement("div");Object.assign(L.style,Ie),L.className="no-drag",u.appendChild(L),Le(u,L),document.body.appendChild(u);let z=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),D=Be.some(x=>!z.includes(x.id));return{toggle:p,hasUnread:D}}function qo(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let c=document.createElement("div");Object.assign(c.style,o.dotsContainer);let u=document.createElement("div");Object.assign(u.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let p=document.createElement("button");p.textContent="Pr\xF3ximo",Object.assign(p.style,o.btn,o.btnNext),p.onmouseover=()=>p.style.transform="scale(1.05)",p.onmouseout=()=>p.style.transform="scale(1)",u.appendChild(d),u.appendChild(p),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(c),n.appendChild(u),a.appendChild(n),document.body.appendChild(a);function h(b){let m=t[b];i.textContent=m.icon,s.textContent=m.title,r.textContent=m.text,c.innerHTML="",t.forEach((T,E)=>{let F=document.createElement("div");Object.assign(F.style,o.dot),E===b&&Object.assign(F.style,o.dotActive),c.appendChild(F)}),m.isLast?(d.style.display="none",p.textContent="Come\xE7ar \u{1F680}",p.style.width="100%"):(d.style.display="block",p.textContent="Pr\xF3ximo",p.style.width="auto")}function y(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),P.playSuccess(),te("Tudo pronto! Use o menu flutuante.")}p.onclick=()=>{P.playClick(),e<t.length-1?(e++,h(e)):y()},d.onclick=async()=>{await xe("Pular o tutorial?")&&y()},h(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var _o={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function Do(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&ga(t)}function ga(t){let e=_o.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let c=document.createElement("div");Object.assign(c.style,a.title);let u=document.createElement("div");Object.assign(u.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let p=document.createElement("button");Object.assign(p.style,a.btn),p.onmouseover=()=>p.style.transform="scale(1.02)",p.onmouseout=()=>p.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(c),i.appendChild(u),i.appendChild(d),i.appendChild(p),n.appendChild(i),document.body.appendChild(n);function h(b){let m=e[b];r.textContent=m.icon,c.textContent=m.title,u.textContent=m.text,d.innerHTML="",e.forEach((T,E)=>{let F=document.createElement("div");Object.assign(F.style,a.dot),E===b&&Object.assign(F.style,a.dotActive),d.appendChild(F)}),b===e.length-1?p.textContent="Entendi, vamos l\xE1! \u{1F44D}":p.textContent="Pr\xF3ximo"}function y(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),P.playSuccess(),te(`TechSol atualizado para ${t}!`)}p.onclick=()=>{P.playClick(),o<e.length-1?(o++,h(o)):y()},h(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Mo="cw_timezone_pinned",$t=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],ba=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function No(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Mo)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let c={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},u={container:{display:"flex",flexDirection:"column",height:"100%",background:c.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:c.surface,borderBottom:`1px solid ${c.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:c.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:c.primary,borderBottomColor:c.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:c.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:c.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${c.border}`,background:c.surface,color:c.textSub,transition:"all 0.2s"},chipActive:{background:c.primaryBg,color:c.primary,borderColor:c.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:c.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${c.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:c.surface,border:`1px solid ${c.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:c.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,fe,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let h=me(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>k());d.appendChild(h);let y=document.createElement("div");Object.assign(y.style,u.container),d.appendChild(y);let b=document.createElement("div");Object.assign(b.style,u.tabHeader);let m=document.createElement("div");m.textContent="Monitoramento",Object.assign(m.style,u.tabBtn,u.tabActive);let T=document.createElement("div");T.textContent="Planejador",Object.assign(T.style,u.tabBtn),b.appendChild(m),b.appendChild(T),y.appendChild(b);let E=document.createElement("div");Object.assign(E.style,u.toolbar);let F=document.createElement("div");Object.assign(F.style,u.searchInputWrapper);let j=document.createElement("div");j.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(j.style,u.searchIcon);let M=document.createElement("input");M.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(M.style,u.searchInput),M.onfocus=()=>{M.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",M.style.borderColor="rgba(26,115,232,0.3)"},M.onblur=()=>{M.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",M.style.borderColor="transparent"},M.oninput=R=>{i=R.target.value.toLowerCase(),L()},F.appendChild(j),F.appendChild(M),E.appendChild(F);let ee=document.createElement("div");Object.assign(ee.style,u.chipsRow),ba.forEach(R=>{let N=document.createElement("div");N.textContent=R.label,N.id=`tz-filter-${R.id}`,Object.assign(N.style,u.chip),R.id===s&&Object.assign(N.style,u.chipActive),N.onclick=()=>{P.playClick(),s=R.id,Array.from(ee.children).forEach(Z=>{Object.assign(Z.style,u.chip)}),Object.assign(N.style,u.chipActive),L()},ee.appendChild(N)}),E.appendChild(ee),y.appendChild(E);let ae=document.createElement("div");Object.assign(ae.style,u.listContainer);let _=document.createElement("style");_.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",y.appendChild(_);let q=document.createElement("div");Object.assign(q.style,u.plannerWrapper,{display:"none"}),y.appendChild(ae),y.appendChild(q),m.onclick=()=>B("live"),T.onclick=()=>B("plan");function B(R){P.playClick(),R==="live"?(Object.assign(m.style,u.tabActive),Object.assign(T.style,u.tabBtn),T.style.borderBottomColor="transparent",ae.style.display="flex",E.style.display="flex",q.style.display="none",D()):(Object.assign(T.style,u.tabActive),Object.assign(m.style,u.tabBtn),m.style.borderBottomColor="transparent",q.style.display="flex",ae.style.display="none",E.style.display="none",x(),z())}function X(R){return R>=9&&R<17?{color:c.success,bg:c.successBg,label:"Aberto",icon:"\u{1F7E2}"}:R>=8&&R<9?{color:c.warning,bg:c.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:R>=17&&R<19?{color:c.warning,bg:c.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:c.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function G(R){n.includes(R)?n=n.filter(N=>N!==R):n.push(R),localStorage.setItem(Mo,JSON.stringify(n)),L(),P.playClick()}function L(){ae.innerHTML="";let R=new Date,N=$t.filter(I=>{let Q=I.name.toLowerCase().includes(i)||I.label.toLowerCase().includes(i),l=s==="all"||I.region===s;return Q&&l});if(N.sort((I,Q)=>{let l=n.includes(I.id),C=n.includes(Q.id);return l&&!C?-1:!l&&C?1:I.name.localeCompare(Q.name)}),N.length===0){ae.innerHTML=`
            ...
            `,v.onmouseenter=()=>{v.style.transform="translateY(-2px)",v.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},v.onmouseleave=()=>{v.style.transform="translateY(0)",v.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let U=v.querySelector(".cw-pin-btn");U.onmouseenter=()=>{U.style.backgroundColor="#F1F3F4"},U.onmouseleave=()=>{U.style.backgroundColor="transparent"},U.onclick=K=>{K.stopPropagation(),G(I.id)},v.onclick=()=>{a=I.id,B("plan")},ae.appendChild(v)});let Z=document.createElement("div");Z.style.height="20px",Z.style.width="100%",ae.appendChild(Z)}function z(){q.innerHTML="";let R=document.createElement("div"),N=document.createElement("label");N.textContent="Onde est\xE1 o cliente?",N.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let Z=document.createElement("select");Object.assign(Z.style,Zt),Z.style.padding="14px",[...$t].sort((oe,Y)=>oe.name.localeCompare(Y.name)).forEach(oe=>{let Y=document.createElement("option");Y.value=oe.id,Y.textContent=`${oe.flag} ${oe.name} (${oe.zone})`,oe.id===a&&(Y.selected=!0),Z.appendChild(Y)}),Z.onchange=oe=>{a=oe.target.value,V(),P.playClick()},R.appendChild(N),R.appendChild(Z),q.appendChild(R);let Q=document.createElement("div");Object.assign(Q.style,u.timeComparisonRow);let l=document.createElement("div");Object.assign(l.style,u.timeCard),l.style.backgroundColor="#F8FAFF",l.style.borderColor="#E8F0FE",l.innerHTML=`
        ...
        `,document.head.appendChild(D)}let s={bg:"linear-gradient(180deg, #F8FAFD 0%, #EEF2F8 100%)",surface:"rgba(255, 255, 255, 0.85)",glass:"rgba(255, 255, 255, 0.7)",primary:"#1a73e8",primaryLight:"rgba(26, 115, 232, 0.1)",text:"#1f1f1f",textSub:"#474747",border:"rgba(0, 0, 0, 0.06)",danger:"#d93025"},r={container:{display:"flex",flexDirection:"column",height:"100%",background:s.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"16px 24px 0 24px",background:"transparent",borderBottom:`1px solid ${s.border}`,gap:"8px"},tabBtn:{flex:1,padding:"14px 16px",textAlign:"center",cursor:"pointer",fontSize:"14px",fontWeight:"500",color:s.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s ease",userSelect:"none",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",borderRadius:"12px 12px 0 0"},tabActive:{color:s.primary,borderBottomColor:s.primary,fontWeight:"600",background:"rgba(26, 115, 232, 0.04)"},listContainer:{flex:1,overflowY:"auto",padding:"24px",display:"flex",flexDirection:"column",gap:"16px"},emptyState:{padding:"60px 24px",textAlign:"center",color:s.textSub,display:"flex",flexDirection:"column",alignItems:"center",gap:"16px"},card:{background:s.surface,borderRadius:"24px",padding:"20px",border:`1px solid ${s.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.03)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"12px"},cardTitle:{fontSize:"15px",fontWeight:"600",color:s.text,letterSpacing:"-0.01em"},cardPreview:{fontSize:"13px",color:s.textSub,lineHeight:"1.6",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"12px",marginTop:"16px",paddingTop:"16px",borderTop:`1px solid ${s.border}`},actionBtn:{padding:"8px 14px",borderRadius:"10px",fontSize:"13px",fontWeight:"500",cursor:"pointer",border:"none",background:"transparent",transition:"all 0.2s",display:"flex",alignItems:"center",gap:"6px"},fab:{position:"absolute",bottom:"32px",right:"32px",width:"64px",height:"64px",borderRadius:"20px",background:`linear-gradient(135deg, ${s.primary}, #0059c1)`,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 8px 24px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.9)",backdropFilter:"blur(30px) saturate(180%)",webkitBackdropFilter:"blur(30px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.6s cubic-bezier(0.16, 1, 0.3, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"24px 32px",background:"transparent",borderBottom:`1px solid ${s.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"32px",overflowY:"auto"},inputGroup:{marginBottom:"24px"},label:{display:"block",fontSize:"13px",fontWeight:"600",color:s.textSub,marginBottom:"10px",letterSpacing:"0.02em"},input:{width:"100%",padding:"14px 18px",borderRadius:"14px",border:`1px solid ${s.border}`,fontSize:"15px",fontFamily:"inherit",outline:"none",background:s.surface,transition:"all 0.2s ease",boxSizing:"border-box"}},c=document.createElement("div");c.id="library-popup",c.classList.add("cw-module-window"),Object.assign(c.style,fe,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)"});let d=me(c,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:c},()=>z());c.appendChild(d);let p=document.createElement("div");Object.assign(p.style,r.container),c.appendChild(p);let h=document.createElement("div");Object.assign(h.style,r.tabHeader);let y=[{id:"general",label:"Geral",icon:i.tabs.general},{id:"note",label:"Notas",icon:i.tabs.note},{id:"email",label:"Emails",icon:i.tabs.email}];y.forEach(D=>{let x=document.createElement("div");x.innerHTML=`${D.icon} <span>${D.label}</span>`,x.id=`lib-tab-${D.id}`,Object.assign(x.style,r.tabBtn),D.id===o&&Object.assign(x.style,r.tabActive),x.onmouseenter=()=>P.playHover(),x.onclick=()=>ae(D.id),h.appendChild(x)}),p.appendChild(h);let b=document.createElement("div");Object.assign(b.style,r.listContainer),p.appendChild(b);let m=document.createElement("div");m.className="cw-fab cw-tactile",Object.assign(m.style,r.fab),m.innerHTML=i.actions.add,m.onmouseenter=()=>{m.style.transform="scale(1.1)",m.style.boxShadow="0 12px 32px rgba(26, 115, 232, 0.5)"},m.onmouseleave=()=>{m.style.transform="scale(1)",m.style.boxShadow="0 8px 24px rgba(26, 115, 232, 0.4)"},m.onclick=()=>q(),p.appendChild(m),a=document.createElement("div"),Object.assign(a.style,r.editorOverlay);let T=document.createElement("div");Object.assign(T.style,r.editorHeader),T.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let E=document.createElement("button");E.innerHTML="Cancelar",E.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",E.onclick=B,T.appendChild(E),a.appendChild(T);let F=document.createElement("div");Object.assign(F.style,r.editorBody),a.appendChild(F);let j=document.createElement("div");j.style.cssText="padding:24px 32px; border-top:1px solid rgba(0,0,0,0.06); background:transparent; display:flex; justify-content:flex-end;";let M=document.createElement("button");M.textContent="Salvar",M.style.cssText="padding:12px 32px; background:linear-gradient(135deg, #1a73e8, #0059c1); color:white; border:none; border-radius:14px; font-weight:600; cursor:pointer; box-shadow:0 4px 12px rgba(26,115,232,0.3); transition: all 0.2s;",M.onclick=X,j.appendChild(M),a.appendChild(j),p.appendChild(a);let ee=document.createElement("div");Object.assign(ee.style,Ie),ee.className="no-drag",c.appendChild(ee),Le(c,ee),document.body.appendChild(c);function ae(D){P.playClick(),o=D,y.forEach(x=>{let k=document.getElementById(`lib-tab-${x.id}`);x.id===D?Object.assign(k.style,r.tabActive):Object.assign(k.style,r.tabBtn)}),_()}function _(){b.innerHTML="";let D=we.getSnippets(o);if(D.length===0){b.innerHTML=`
            ...
            `;return}D.forEach(x=>{let k=document.createElement("div");k.className="cw-aura-card",Object.assign(k.style,r.card),x.isCode&&(k.style.borderLeft=`4px solid ${s.primary}`,k.style.background="rgba(26, 115, 232, 0.02)");let R=x.content,N="";if(x.isRich){let Z=document.createElement("div");Z.innerHTML=x.content;let I=Z.querySelector("img");R=Z.innerText.substring(0,150)+(Z.innerText.length>150?"...":""),I&&(N=`<span style="display:inline-flex; align-items:center; background:rgba(26, 115, 232, 0.1); color:#1a73e8; padding:2px 8px; border-radius:10px; font-size:11px; margin-bottom:8px; font-weight:600;">${i.media} Media</span>`)}k.innerHTML=`
                <div style="${L(r.cardHeader)}">
                    <div style="${L(r.cardTitle)}">${x.title}</div>
                ...
                ${N}
                <div style="${L(r.cardPreview)}; ${x.isCode?"font-family:'Roboto Mono', monospace; font-size:12px; background:rgba(0,0,0,0.02); padding:12px; border-radius:12px;":""}">${R}</div>
            ...
            `,k.onmouseenter=()=>{P.playHover()},k.querySelector(".cw-act-copy").onclick=Z=>{if(Z.stopPropagation(),P.playClick(),x.isRich){let I=new Blob([x.content],{type:"text/html"}),Q=document.createElement("div");Q.style.whiteSpace="pre-wrap",Q.innerHTML=x.content;let l=new Blob([Q.innerText],{type:"text/plain"}),C=[new ClipboardItem({"text/html":I,"text/plain":l})];navigator.clipboard.write(C)}else navigator.clipboard.writeText(x.content);te("Copiado!")},k.querySelector(".cw-act-edit").onclick=Z=>{Z.stopPropagation(),P.playClick(),q(x)},k.querySelector(".cw-act-del").onclick=async Z=>{Z.stopPropagation(),P.playClick(),await xe("Excluir este item?")&&(we.delete(x.id),_(),te("Item exclu\xEDdo."))},b.appendChild(k)})}function q(D=null){n=D?D.id:null,F.innerHTML="",F.appendChild(G("title","T\xEDtulo / Nome",D?D.title:"")),o==="email"&&F.appendChild(G("subject","Assunto do Email",D?D.subject:""));let x="Conte\xFAdo";o==="email"&&(x="Corpo do Email (HTML)"),o==="note"&&(x="Texto da Nota (Reason)"),F.appendChild(G("content",x,D?D.content:"",{isRich:!0,isCode:D?D.isCode:!1})),T.querySelector("span").textContent=D?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let k=F.querySelector("input");k&&k.focus()},300)}function B(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function X(){let D=F.querySelector("#cw-inp-title"),x=F.querySelector("#cw-inp-content"),k=D.value.trim(),R=x.contentEditable==="true"?x.innerHTML:x.value.trim(),N=x.getAttribute("data-is-code")==="true";if(!k||!R||R==="<br>"){te("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let Z={id:n,type:o,title:k,content:R,isCode:N,isRich:x.contentEditable==="true"};if(o==="email"){let I=F.querySelector("#cw-inp-subject").value.trim();if(!I){te("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}Z.subject=I}M.textContent="Salvando...",await we.save(Z),M.textContent="Salvar",B(),_(),te("Salvo com sucesso!"),P.playSuccess()}function G(D,x,k,R={}){let N=document.createElement("div");Object.assign(N.style,r.inputGroup);let Z=document.createElement("label");Z.textContent=x,Object.assign(Z.style,r.label);let I;if(R.isRich){let Q=document.createElement("div");Q.style.cssText="display:flex; gap:8px; margin-bottom:14px; background:rgba(255, 255, 255, 0.5); padding:8px; border-radius:14px; border:1px solid rgba(0,0,0,0.06); backdrop-filter: blur(10px); width: fit-content;",Q.innerHTML=`
            ...
            `,I=document.createElement("div"),I.contentEditable="true",Object.assign(I.style,r.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),I.innerHTML=k||"",R.isCode&&(I.style.fontFamily="'Roboto Mono', monospace",I.style.backgroundColor="#F8F9FA",I.setAttribute("data-is-code","true")),Q.querySelectorAll(".cw-toolbar-btn").forEach(l=>{l.onmouseenter=()=>P.playHover(),l.onmousedown=()=>P.playClick()}),Q.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),I.focus()},Q.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),I.focus()},Q.querySelector(".cw-tb-code").onclick=l=>{let w=!(I.getAttribute("data-is-code")==="true");I.setAttribute("data-is-code",w),I.style.fontFamily=w?"'Roboto Mono', monospace":"inherit",I.style.backgroundColor=w?"rgba(0, 122, 255, 0.03)":s.surface,w?l.currentTarget.classList.add("active"):l.currentTarget.classList.remove("active"),I.focus()},Q.querySelector(".cw-tb-img").onclick=async()=>{let l=await no("Cole a URL da imagem:");l&&(document.execCommand("insertImage",!1,l),I.querySelectorAll("img").forEach(w=>{w.style.maxWidth="100%",w.style.borderRadius="8px"}))},I.onpaste=l=>{let C=(l.clipboardData||l.originalEvent.clipboardData).items;for(let w of C)if(w.kind==="file"&&w.type.startsWith("image/")){l.preventDefault();let A=w.getAsFile(),v=new FileReader;v.onload=g=>{let S=`<img src="${g.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,S)},v.readAsDataURL(A)}},N.appendChild(Z),N.appendChild(Q)}else I=document.createElement("input"),I.type="text",Object.assign(I.style,r.input),I.value=k||"",N.appendChild(Z);return I.id=`cw-inp-${D}`,I.onfocus=()=>{I.style.borderColor=s.primary,I.style.boxShadow=`0 0 0 2px ${s.primaryBg}`},I.onblur=()=>{I.style.borderColor=s.border,I.style.boxShadow="none"},N.appendChild(I),N}function L(D){return Object.entries(D).map(([x,k])=>`${x.replace(/[A-Z]/g,R=>"-"+R.toLowerCase())}:${k}`).join(";")}function z(){e=!e,ge(e,c,"cw-btn-library"),e&&_()}return z}function Ro(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let b=document.createElement("style");b.id=a,b.innerHTML=`
  ...
  `,document.head.appendChild(t)};var Ve={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var pe={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function $o(t){let e=document.createElement("div");if(e.className="bau-dynamic-input",e.id=`wrapper-${t.id}`,t.label){let a=document.createElement("label");a.className="bau-label",a.textContent=t.label,t.tooltip&&a.setAttribute("data-tooltip",t.tooltip),e.appendChild(a)}let o;switch(t.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",e.appendChild(o);break;case"select":o=document.createElement("select"),t.groups?t.groups.forEach(s=>{let r=document.createElement("optgroup");r.label=s.label,s.options.forEach(c=>{let u=document.createElement("option");u.value=c.value,u.textContent=c.text,r.appendChild(u)}),o.appendChild(r)}):t.options&&t.options.forEach(s=>{let r=document.createElement("option");r.value=s.value,r.textContent=s.text,o.appendChild(r)}),e.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",t.options.forEach(s=>{let r=document.createElement("label");r.className="bau-task-item",r.innerHTML=`<input type="checkbox" name="${t.name}" value="${s}"><span>${s}</span>`,r.addEventListener("click",c=>{c.preventDefault();let u=r.querySelector("input");u.checked=!u.checked,r.classList.toggle("active",u.checked),P.playClick()}),o.appendChild(r)}),e.appendChild(o),e;case"datetime-group":o=document.createElement("div"),o.className="bau-availability-container",t.fields.forEach(s=>{let r=document.createElement("div");r.className="bau-availability-field",r.innerHTML=`
    ...
    `,y.appendChild(b);let m=document.createElement("div");m.className="bau-content",y.appendChild(m);let T=document.createElement("div");T.className="bau-progress-indicator",m.appendChild(T);let E=document.createElement("form");E.id="bau-escalation-form",E.noValidate=!0,m.appendChild(E),Ve.steps.forEach(l=>{let C=document.createElement("div");if(C.className="bau-step"+(l.id===a?" active":""),C.id=`bau-step-${l.id}`,l.isBranching)C.innerHTML=`
            ...
            `,C.querySelector("#bau-opt-full").onclick=()=>{n="BAU",a=1,E.querySelectorAll(".bau-highlight-panel").forEach(w=>w.classList.remove("discard-theme")),z(),P.playClick()},C.querySelector("#bau-opt-discard").onclick=()=>{n="DISCARD",a=5,E.querySelectorAll(".bau-highlight-panel").forEach(w=>w.classList.add("discard-theme")),z(),P.playClick()};else if(l.isConfirmation)C.innerHTML=`
                <div class="bau-card">
                    <h3 class="bau-step-title">Confirme os dados antes de enviar</h3>
                    <div id="bau-confirmation-details"></div>
                </div>
            `;else{let w=document.createElement("div");if(w.className="bau-card",l.id===1||l.id===5){w.innerHTML=`
                ...
                `;let A=w.querySelector(".bau-dynamic-inputs-container");l.fields.forEach(g=>{A.appendChild($o(g))});let v=w.querySelector("#wrapper-cid");if(v){let g=document.createElement("div");g.id="bau-cid-error",g.className="bau-cid-error-hint",g.style.display="none",g.textContent="Formato de CID incorreto",v.appendChild(g)}}else l.fields.forEach(A=>{w.appendChild($o(A))});C.appendChild(w)}E.appendChild(C)});let F=document.createElement("div");F.className="bau-footer";let j=document.createElement("button");j.type="button",j.id="bau-step-back-btn",j.className="bau-btn-secondary",j.textContent="Voltar";let M=document.createElement("button");M.type="button",M.id="bau-step-next-btn",M.className="bau-btn-primary",M.textContent="Pr\xF3ximo";let ee=document.createElement("button");ee.type="submit",ee.className="bau-btn-submit",ee.innerHTML=`${pe.send} Enviar para o TL`,ee.style.display="none",F.appendChild(j),F.appendChild(M),F.appendChild(ee),E.appendChild(F),d.appendChild(y);let ae=document.createElement("div");ae.id="bau-view-success",ae.className="bau-view bau-success-view",ae.innerHTML=`
    ...
    `,d.appendChild(ae),document.body.appendChild(c);function _(l){e=l,c.querySelectorAll(".bau-view").forEach(g=>g.classList.remove("active"));let C=c.querySelector(`#bau-view-${l}`);C&&C.classList.add("active");let w=u.querySelector(".cw-module-header-title")||u.querySelector("h2"),A=u.querySelector(".cw-module-header-subtitle")||u.querySelector("p");w&&(l==="form"?w.textContent=i?`Editando Caso #${s}`:"Novo Caso BAU":w.textContent="BAU Central"),A&&(A.textContent=l==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU");let v=E.querySelector(".bau-btn-submit");v&&(v.innerHTML=i?`${pe.send} Salvar Altera\xE7\xF5es`:`${pe.send} Enviar para o TL`)}function q(){let l=c.querySelector("#bau-case-list-container"),C=c.querySelector("#bau-dashboard-metrics");C&&(C.innerHTML=`
        ...
        `).join(""))}async function B(){let l=c.querySelector("#bau-case-list-container"),C=c.querySelector("#bau-dashboard-metrics");if(!(!l||!C)){q();try{let w=await Ut();if(!Array.isArray(w))throw new Error("API response is not a valid array");L(w)}catch(w){console.error("Critical Error loading BAU cases:",w),C&&(C.innerHTML=""),l.innerHTML=`
            ...
            `,c.querySelector("#bau-retry-btn")?.addEventListener("click",()=>B()),te("Erro ao carregar Dashboard. Verifique sua conex\xE3o.",{error:!0})}}}function X(l){if(!l)return;let w=(g=>{switch(g){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray"};default:return{text:g||"Pendente",class:"status-gray"}}})(l.status),A=(g,S)=>{navigator.clipboard.writeText(g).then(()=>{te("Copiado para a \xE1rea de transfer\xEAncia!"),P.playClick();let U=S.style.color;S.style.color="#1E8E3E",setTimeout(()=>{S.style.color=U},800)})};p.innerHTML=`
        ...
        `;let v=p.querySelector(".bau-details-close-btn");v.onclick=()=>{p.classList.remove("active"),P.playSwoosh(),setTimeout(()=>{p.style.display="none"},600)},p.querySelectorAll(".bau-copy-btn").forEach(g=>{g.onclick=S=>{let U=S.target.closest(".bau-details-row").querySelector(".bau-details-value").textContent;A(U,g)}}),p.style.display="flex",requestAnimationFrame(()=>{p.classList.add("active"),P.playClick()})}function G(l){if(!l)return"";let w=(O=>{switch(O){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:O||"Pendente",class:"status-gray",aura:""}}})(l?.status),A=lt(l?.date),v="",g="";if(l?.status==="PENDING_TL_CREATION"&&l?.availability_1){let O=new Date(l.availability_1),$=new Date;(O<=$||O-$<36e5*2)&&(v='<span class="bau-sla-badge">Urgente</span>',g="bau-pulse-attention")}let S=l?.reason&&l.reason.trim()?l.reason:"Nenhum contexto adicional fornecido pelo agente.",K=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(l?.cid||""),f=!l?.caseId||l.caseId==="N/A"||!K;return f&&l?.status==="PENDING_TL_CREATION"&&(g="bau-pulse-attention"),`
            <li class="bau-case-card ${w.aura} ${g}" data-case-id="${l?.id||""}">
                <div class="bau-case-main">
                    ...
                    <div class="bau-case-info">
                        ...
                        <p class="bau-case-details">
                            ...
                            <span data-tooltip="CID do Anunciante (Formato: 000-000-0000)" class="${K?"":"bau-error-text"}">CID: ${l?.cid||"N/A"}</span> \u2022
                            <span data-tooltip="O que deve ser feito em BAU">Motivo: ${S}</span>
                        </p>
                        ${f?`<div class="bau-data-error-hint">${!l?.caseId||l?.caseId==="N/A"?"Dados Incompletos":"CID Inv\xE1lido"} - Contate o Suporte</div>`:""}
                    </div>
                </div>
        ...
        `}function L(l){let C=c.querySelector("#bau-case-list-container"),w=c.querySelector("#bau-dashboard-metrics");if(!C||!w)return;let A=Array.isArray(l)?l.filter(Boolean):[];if(A.length===0){w.innerHTML=`
            ...
            `,c.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>B());return}let v=A.filter(f=>f.status==="PENDING_TL_CREATION").length,g=A.filter(f=>f.status==="CREATED").length;w.innerHTML=`
        ...
        `;let S=w.querySelector("#bau-refresh-dashboard");S?.addEventListener("click",async()=>{S.classList.contains("spinning")||(S.classList.add("spinning"),P.playClick(),await B(),setTimeout(()=>S.classList.remove("spinning"),1e3))}),C.innerHTML="";let U=A.slice(0,5),K=A.slice(5);if(U.forEach(f=>{let O=G(f),$=document.createElement("div");$.innerHTML=O;let J=$.firstElementChild;J.addEventListener("click",oe=>{oe.target.closest(".bau-case-edit-btn")||X(f)});let V=J.querySelector(".bau-case-edit-btn");V&&(V.onclick=oe=>{oe.stopPropagation(),Z(f)}),C.appendChild(J)}),K.length>0){let f=document.createElement("li");f.className="bau-accordion-container";let O=document.createElement("button");O.className="bau-accordion-toggle",O.innerHTML=`${pe.expand} <span>Mostrar ${K.length} casos mais antigos</span>`;let $=document.createElement("ul");$.className="bau-case-list bau-accordion-content",$.style.display="none",K.forEach(J=>{let V=G(J),oe=document.createElement("div");oe.innerHTML=V;let Y=oe.firstElementChild;Y.addEventListener("click",re=>{re.target.closest(".bau-case-edit-btn")||X(J)});let ne=Y.querySelector(".bau-case-edit-btn");ne&&(ne.onclick=re=>{re.stopPropagation(),Z(J)}),$.appendChild(Y)}),O.addEventListener("click",()=>{let J=$.style.display==="none";$.style.display=J?"block":"none",O.classList.toggle("expanded",J),O.querySelector("span").textContent=J?"Esconder casos mais antigos":`Mostrar ${K.length} casos mais antigos`,P.playClick()}),f.appendChild(O),f.appendChild($),C.appendChild(f)}}function z(){let l=n==="BAU"?[1,2,3,4]:[5,4];E.querySelectorAll(".bau-step").forEach(A=>{let v=parseInt(A.id.replace("bau-step-","")),g=v===a,S=l.includes(v)||v===0;A.classList.toggle("active",g),A.style.display=g?"block":"none",A.querySelectorAll("input, select, textarea").forEach(U=>{U.disabled=!S})});let C=a===0;if(T.style.display=C?"none":"flex",!C){T.innerHTML="";let A=n==="BAU"?[1,2,3,4]:[5,4];A.forEach((v,g)=>{let S=document.createElement("div"),U=v===a,K=A.indexOf(a),f=g<K;S.className=`bau-progress-step ${U?"active":f?"completed":""}`,S.textContent=g+1,T.appendChild(S)})}let w=a===4;j.style.display=a>0?"inline-block":"none",M.style.display=!C&&!w?"inline-block":"none",ee.style.display=w?"flex":"none",w&&N()}function D(l){let C=Ve.steps.find(w=>w.id===l);if(!C||!C.fields||C.isConfirmation)return!0;for(let w of C.fields){let A=E.querySelector(`#bau-step-${l} #wrapper-${w.id}`);if(!(A&&A.style.display==="none")&&w.validation){let v=E.querySelector(`#bau-step-${l} [name="${w.name}"]`);if(v&&v.offsetParent!==null&&v.value.trim())if(new RegExp(w.validation.regex).test(v.value.trim())){v.classList.remove("invalid-cid");let S=E.querySelector("#bau-cid-error");S&&(S.style.display="none")}else{console.warn(`Validation failed for field "${w.name}" in step ${l}: Regex mismatch.`),te(`Erro: ${w.validation.error}`,{error:!0}),v.classList.add("invalid-cid");let S=E.querySelector("#bau-cid-error");return S&&(S.style.display="flex"),!1}}}return!0}function x(l){if(!E.querySelector(`#bau-step-${l}`))return!1;let w=Ve.steps.find(v=>v.id===l);if(!w||!w.fields||w.isConfirmation)return!0;let A=!0;for(let v of w.fields){let g=E.querySelector(`#bau-step-${l} #wrapper-${v.id}`);if(!(g&&g.style.display==="none")&&v.required){let S=!0,U="";if(v.type==="checkbox-grid")E.querySelector(`#bau-step-${l} input[name="${v.name}"]:checked`)||(U="No option selected in checkbox-grid",te(`Erro: Selecione pelo menos uma op\xE7\xE3o para "${v.label}".`,{error:!0}),S=!1);else if(v.type==="datetime-group"){let K=E.querySelector(`#bau-step-${l} input[name="${v.fields[0].name}"]`);if(!K||K.offsetParent===null)continue;K.value.trim()||(U="Datetime group first field is empty",te(`Erro: O campo "${v.fields[0].label}" \xE9 obrigat\xF3rio.`,{error:!0}),S=!1)}else{let K=E.querySelector(`#bau-step-${l} [name="${v.name}"]`);if(!K||K.offsetParent===null)continue;K.value.trim()||(U="Field is empty",te(`Erro: O campo '${v.label}' \xE9 obrigat\xF3rio.`,{error:!0}),S=!1)}if(!S){console.warn(`Validation failed for required field "${v.name}" in step ${l}: ${U}`),A=!1;break}}}return A}M.addEventListener("click",()=>{if(D(a)&&x(a)){n==="BAU"?a++:a===5?a=4:a++,z();let l=c.querySelector(".bau-content");l&&(l.scrollTop=0),P.playClick()}}),j.addEventListener("click",()=>{a>0&&(n==="BAU"?a--:a===4?a=5:a===5?a=0:a--,z(),P.playClick())});async function k(){let l=await Ce()||{};(!l.amName||l.amName==="N/A")&&(l.amName=l.internalEmail||"N/A"),o=l,E.querySelectorAll(".bau-vital-highlights").forEach(A=>{let v=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"Website",value:l.site||l.website},{label:"Case ID",value:l.caseId}];A.innerHTML=v.map(g=>{let S=g.value&&g.value!=="N/A"&&g.value!=="undefined"&&g.value!=="null"?g.value:"N\xE3o capturado";return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${g.label}</span>
                        <span class="bau-highlight-value">${S}</span>
                    </div>
                `}).join("")}),Ve.steps.forEach(A=>{A.fields&&A.fields.forEach(v=>{if(v.isSmart){let g=l[v.id];v.id==="language"&&l.userProfile?.defaultLanguage&&(g=l.userProfile.defaultLanguage);let S=E.querySelector(`#bau-step-${A.id} [name="${v.name}"]`),U=E.querySelector(`#bau-step-${A.id} #wrapper-${v.id}`);if(S&&(S.value=g&&g!=="N/A"?g:"",v.id==="language"&&g&&g!=="N/A"&&(S.readOnly=!0,S.style.background="#F1F3F4",S.style.cursor="not-allowed")),U){let K=g&&g!==""&&g!=="N/A"&&g!=="undefined"&&g!=="null";v.id==="language"?U.style.display="block":U.style.display=K?"none":"block"}}})}),E.querySelectorAll(".bau-all-data").forEach(A=>{let v=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"AM",value:l.amName},{label:"SE ID",value:l.seId},{label:"Site",value:l.site},{label:"Email",value:l.email},{label:"Timezone",value:l.timezone},{label:"Case ID",value:l.caseId},{label:"Programa",value:l.salesProgram},{label:"Idioma",value:l.language}];A.innerHTML=`
                <div class="bau-context-badges-grid">
                    ${v.filter(g=>g.value&&g.value!=="N/A"&&g.value!=="---"&&g.value!=="undefined"&&g.value!=="null").map(g=>`
            ...
            `})}c.querySelector("#bau-top-se-search")?.addEventListener("click",l=>{l.preventDefault(),mt("bau-form-seId")});let R=c.querySelector("#bau-form-cid");R&&R.addEventListener("input",()=>D(1));function N(){let l=new FormData(E),C=Object.fromEntries(l.entries()),w=c.querySelector("#bau-confirmation-details");if(w){if(n==="BAU"){let A=l.getAll("taskType"),v=A.length>0?A.join(", "):"Nenhuma";w.innerHTML=`
            ...
            `;w.querySelectorAll(".bau-confirm-value-input").forEach(A=>{A.addEventListener("input",v=>{let g=v.target.dataset.field,S=v.target.dataset.step;if(!g||!S)return;let U=E.querySelector(`#bau-step-${S} [name="${g}"]`);U&&(U.value=v.target.value,g==="cid"&&D(1))})})}}async function Z(l){if(!await xe("Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",{confirmText:"Estou na p\xE1gina correta"}))return;I(),i=!0,s=l.id,n=l.status==="PENDING_TL_DISCARD"||l.reason&&!l.task?"DISCARD":"BAU",_("form"),await k(),o={...o,advName:l.advName||o.advName,cid:l.cid||o.cid,caseId:l.caseId||o.caseId,seId:l.seId||o.seId,site:l.site||o.site,email:l.advEmail||o.email,timezone:l.timezone||o.timezone,language:l.language||o.language,amName:l.amName||o.amName,salesProgram:l.salesProgram||o.salesProgram};let w=l.availability?l.availability.split("|").map(A=>A.trim()):[];E.querySelectorAll("input, select, textarea").forEach(A=>{let v=A.name,g={advEmail:"advEmail",website:"site",site:"site"};if(v==="taskType"){let S=(l.task||l.taskType||"").split(",").map(U=>U.trim());A.type==="checkbox"&&(A.checked=S.includes(A.value),A.closest(".bau-task-item")?.classList.toggle("active",A.checked))}else if(v.startsWith("availability_")){let S=parseInt(v.split("_")[1])-1,U=w[S];if(U&&A.type==="datetime-local")try{let K=new Date(U);if(!isNaN(K.getTime())){let f=new Date(K.getTime()-K.getTimezoneOffset()*6e4).toISOString().slice(0,16);A.value=f}}catch{}}else l[v]!==void 0?A.value=l[v]:v==="reason"?A.value=l.reason:v==="description"?A.value=l.description:v==="nonImplementationReason"&&(A.value=l.nonImplementationReason||"")}),a=n==="BAU"?1:5,z(),P.playClick()}E.onsubmit=async l=>{l.preventDefault();let C=n==="BAU"?[1,2,3]:[5];for(let U of C)if(!Ve.steps.find(f=>f.id===U)?.isConfirmation&&(!D(U)||!x(U))){console.warn(`Form submission blocked by validation failure in step ${U}`),a=U,z();return}let w=c.querySelector(".bau-btn-submit");w.disabled=!0,w.innerHTML="Enviando...";let A=new FormData(E),v=Object.fromEntries(A.entries()),g=o||{},S={...g,...v,requestType:n};if(v.advEmail?S.advEmail=v.advEmail:g.email&&(S.advEmail=g.email),v.website?S.website=v.website:g.site&&(S.website=g.site),n==="BAU"){let U=A.getAll("taskType"),K=[v.availability_1,v.availability_2,v.availability_3].filter(f=>f&&f.trim()!=="").join(" | ");S.taskType=U.join(", "),S.availability=K,i?(v.nonImplementationReason?S.nonImplementationReason=v.nonImplementationReason:delete S.nonImplementationReason,v.description?S.description=v.description:delete S.description):(S.nonImplementationReason=v.nonImplementationReason||"",S.description=v.description||"",S.nonImplementationReason||console.warn("Aviso: Campo 'Justificativa' (nonImplementationReason) est\xE1 saindo vazio."),S.description||console.warn("Aviso: Campo 'Descri\xE7\xE3o detalhada' (description) est\xE1 saindo vazio."))}else S.reason=v.reason,i?(v.description?S.description=v.description:delete S.description,delete S.taskType,delete S.availability,delete S.nonImplementationReason):(S.taskType="",S.availability="",S.nonImplementationReason="",S.description=v.description||"");try{i?await Vt(s,S):await Gt(S,g.agentEmail||"anon"),P.playSuccess();let U=c.querySelector(".bau-success-title");U&&(i?U.textContent="Caso atualizado com sucesso!":U.textContent=n==="DISCARD"?"Caso enviado para descarte com sucesso!":"Caso enviado com sucesso!"),_("success")}catch(U){te("Erro: "+(U.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",S)}finally{w.disabled=!1,w.innerHTML=`${pe.send} Enviar para o TL`}};function I(){E.reset(),a=0,n="BAU",i=!1,s=null,z(),E.querySelectorAll(".bau-task-item.active").forEach(C=>C.classList.remove("active"));let l=E.querySelector('[name="language"]');l&&(l.readOnly=!1,l.style.background="",l.style.cursor="")}c.querySelector("#bau-new-case-btn").addEventListener("click",()=>{I(),_("form"),k()}),c.querySelector("#bau-form-back-btn").addEventListener("click",()=>_("dashboard")),c.querySelector("#bau-success-back-btn").addEventListener("click",()=>_("dashboard"));async function Q(){t=!t,c.style.display=t?"flex":"none",t&&(_("dashboard"),B()),ge(t,c,"cw-btn-bauform")}return z(),Q}function fa(){if(window.techSolInitialized){Ot();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Jt();try{P.initGlobalListeners(),P.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}de.fetchTips(),Ot();let e=So(),o=ko(),a=Fo(),n=Lo(),i=No(),s=zo(),r=Ro(),c=Po(),u=Oo();go({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:c,broadcastControl:u}),setTimeout(()=>{de.logEvent("App","Start","Session Start"),qo(),setTimeout(()=>{Do(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),te("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}fa();})();
