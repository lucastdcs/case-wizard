...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var vt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Pt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Ht={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Le=t=>new Promise(e=>setTimeout(e,t));async function Uo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Le(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let s=Math.floor(Math.random()*60)+30;a===0&&(s=150),a>e.length-3&&(s=30),await Le(s)}await Le(600),o&&(o.style.display="none")}async function wt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Le(200);let e=await Mt(),o=Nt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),s=t.querySelector("#p3"),r=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),s&&(s.textContent=o.suffix),await Le(300);let c=a?a.querySelector("svg"):null;if(c&&(c.style.opacity="1",c.style.transform="scale(1)"),await Le(400),n&&(n.style.opacity="1"),j.playStartup(),i&&await Uo(i,o.name),s&&(s.style.opacity="1",s.style.transform="translateY(0)"),o.isFriday&&r){await Le(400),r.style.display="block",r.offsetWidth;let u=r.querySelector(".sextou-badge");u&&(u.style.opacity="1",u.style.transform="scale(1)")}await Le(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Le(900),t.parentNode&&t.parentNode.removeChild(t)}}function $t(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,s=a-e.height-n,r=parseFloat(t.style.left)||e.left,c=parseFloat(t.style.top)||e.top,u=Math.max(n,Math.min(r,i)),p=Math.max(n,Math.min(c,s));if(u!==r||p!==c){let d=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${u}px`,t.style.top=`${p}px`,setTimeout(()=>{t.style.transition=d},300)}}var Ee={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Ae(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,s=a.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),c=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),u=i,p=s,d=!1;function x(m){u=m.clientX,p=m.clientY,d||(window.requestAnimationFrame(()=>{g(),d=!1}),d=!0)}function g(){let m=r+(u-i),S=c+(p-s);m>360&&(t.style.width=m+"px"),S>300&&(t.style.height=S+"px")}function b(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",b),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",b)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function jt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Gt(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Ut(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function fe(t,e={}){return new Promise(o=>{let a=Gt(),n=Ut(),i=e.danger?"#FF3B30":"#007AFF",s=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
...
Irei solicitar descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var je=t=>new Promise(e=>setTimeout(e,t));function Xe(t){t&&["mousedown","mouseup","click"].forEach(e=>t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window})))}var Xt="cw-automation-styles";if(!document.getElementById(Xt)){let t=document.createElement("style");t.id=Xt,t.innerHTML=`
    ...
    `,document.head.appendChild(t)}function Jt(t){let e=document.getElementById("cw-loading-overlay");t?e?e.style.opacity="1":(e=document.createElement("div"),e.id="cw-loading-overlay",document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1")):e&&(e.style.opacity="0",setTimeout(()=>e.remove(),300))}async function st(t){console.log("\u{1F680} Iniciando extra\xE7\xE3o autom\xE1tica...");let e=document.getElementById(t),o="";Jt(!0),e&&(o=e.placeholder,e.placeholder="Buscando ID...",e.value="",e.classList.add("cw-scanning-active"));try{let a=document.querySelector('material-button[debug-id="dock-item-case-log"]');a&&!a.classList.contains("selected")&&(Xe(a),await je(1200));let n=document.querySelector("search-filter dropdown-button .button");if(n&&!(n.innerText||"").includes("All")){Xe(n),await je(600);let x=document.querySelector('material-checkbox[debug-id="check-all-box"]');x&&x.getAttribute("aria-checked")!=="true"&&(Xe(x),await je(300));let g=document.querySelector('material-button[debug-id="apply-filter"]');g&&(Xe(g),await je(1500))}let i=document.querySelector(".scroll-container")||document.querySelector(".case-log-container");i&&(i.scrollTop=i.scrollHeight,await je(500));let s=Array.from(document.querySelectorAll(".message-header"));for(let d=s.length-1;d>=0;d--){let x=s[d],g=x.querySelector("i.material-icons-extended"),b=g&&g.innerText.trim()==="phone_in_talk",m=x.innerText||"",S=m.includes("Agent joined")||m.includes("outbound-call")||m.includes("Speakeasy");if(b||S){x.getAttribute("aria-expanded")==="true"||(console.log("\u{1F4C2} Expandindo mensagem de chamada...",x),e&&(e.placeholder="Lendo mensagem..."),Xe(x),await je(1e3));break}}let c=Array.from(document.querySelectorAll(".preview, .speakeasy-agent-activity, .message-body, .content-container")),u=/Speakeasy.*?(P\d{15,25})/i,p=null;for(let d=c.length-1;d>=0;d--){let x=c[d];if(x.offsetParent===null)continue;let g=(x.innerText||"").match(u);if(g&&g[1]){p=g[1];break}}if(e)if(p){try{await navigator.clipboard.writeText(p)}catch{}e.tagName==="INPUT"||e.tagName==="TEXTAREA"?e.value=p:e.textContent=p,e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),j.playSuccess(),J(`ID Localizado: ${p}`),e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(15, 157, 88, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}else j.playError(),J("Nenhum ID encontrado.",{error:!0}),e.placeholder="N\xE3o encontrado",e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(234, 67, 53, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}catch(a){console.error("Erro na automa\xE7\xE3o:",a),J("Erro ao processar.",{error:!0})}finally{e&&(e.classList.remove("cw-scanning-active"),e.value||(e.placeholder=o)),Jt(!1)}}function Kt(t){t.dataset.bulletEnabled!=="true"&&(t.dataset.bulletEnabled="true",(t.value.trim()===""||t.value.trim()==="\u2022")&&(t.value="\u2022 "),t.addEventListener("keydown",function(e){let o=this.selectionStart,a=this.selectionEnd,n=this.value,i=n.lastIndexOf(`
...
`+r;this.value=n.substring(0,o)+c+n.substring(a),this.selectionStart=this.selectionEnd=o+c.length}else if(e.key==="Tab")e.preventDefault(),e.shiftKey?s.startsWith("  ")&&(this.value=n.substring(0,i)+s.substring(2)+n.substring(o),this.selectionStart=this.selectionEnd=o-2):(this.value=n.substring(0,i)+"  "+s+n.substring(o),this.selectionStart=this.selectionEnd=o+2);else if(e.key==="Backspace"&&o===a&&o>0){let r=n.substring(0,o);r.endsWith("\u2022 ")?(e.preventDefault(),this.value=r.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2):r.endsWith("  ")&&s.trim().startsWith("\u2022")&&(e.preventDefault(),this.value=r.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2)}}))}function Ct(t,e,o){if(e.innerHTML="",!!Te[t]&&(o.activeFields.forEach(n=>{if(["TAGS_IMPLEMENTED","SCREENSHOTS_LIST","CONSENTIU_GRAVACAO","CASO_PORTUGAL","label_substatus"].includes(n))return;let i=`field-${n}`,s=document.createElement("label"),r=d=>Se[o.currentLang]?.[d]||Se.pt?.[d]||d;s.textContent=r(n.toLowerCase())!==n.toLowerCase()?r(n.toLowerCase()):n.replace(/_/g," ").replace(/\b\w/g,d=>d.toUpperCase())+":",Object.assign(s.style,{display:"flex",alignItems:"center",justifyContent:"space-between",fontSize:"13px",fontWeight:"700",color:P.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let c=document.createElement("span");if(c.textContent=s.textContent,s.innerHTML="",s.appendChild(c),n==="SPEAKEASY_ID"){let d=document.createElement("button");d.innerHTML="\u2728 Auto Busca",d.style.cssText=`font-size: 11px; font-weight: 700; color: ${P.primary}; background-color: ${P.primaryBg}; border: none; border-radius: ${de.pill}; padding: 6px 14px; margin-left: 10px; cursor: pointer; transition: all 0.2s ${se};`,d.onmouseenter=()=>d.style.backgroundColor="#d2e3fc",d.onmouseleave=()=>d.style.backgroundColor=P.primaryBg,d.onclick=x=>{x.preventDefault(),st(i)},s.appendChild(d)}let u=document.createElement("button");u.innerHTML="\u2715",u.style.cssText=`font-size: 14px; background: ${P.bgInput}; border: none; color: ${P.textSub}; cursor: pointer; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-left: auto; transition: all 0.2s ${se};`,u.onmouseenter=()=>{u.style.background=P.error,u.style.color=P.surface},u.onmouseleave=()=>{u.style.background=P.bgInput,u.style.color=P.textSub},u.onclick=async d=>{d.preventDefault(),await fe(`Tem certeza que deseja remover o campo "${c.textContent.replace(":","")}"?`)&&(o.removeField(n),Ct(t,e,o))},s.appendChild(u);let p;$e.includes(n)?(p=document.createElement("textarea"),p.classList.add("bullet-textarea","cw-textarea"),p.placeholder="Utilize marcadores para detalhar...",Kt(p)):nt.includes(n)?(p=document.createElement("textarea"),p.classList.add("cw-textarea"),p.placeholder="Descreva as considera\xE7\xF5es..."):(p=document.createElement("input"),p.type="text",p.classList.add("cw-input")),p.id=i,p.value=o.formData[i]||"",p.addEventListener("input",d=>o.updateField(i,d.target.value)),e.appendChild(s),e.appendChild(p)}),o.activeFields.includes("CONSENTIU_GRAVACAO"))){let n=r=>Se[o.currentLang]?.[r]||Se.pt?.[r]||r,i=document.createElement("label");i.textContent=n("consentiu_gravacao"),Object.assign(i.style,{display:"block",fontSize:"13px",fontWeight:"700",color:P.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let s=document.createElement("select");s.className="cw-select",s.innerHTML=`
            <option value="false">${n("nao")}</option>
            <option value="true">${n("sim")}</option>
        `,s.value=o.consent?"true":"false",s.onchange=()=>o.setConsent(s.value==="true"),e.appendChild(i),e.appendChild(s)}}function Et(t,e,o){let a=t.currentSubStatus;if(!a)return null;let n=Te[a],i=Se[t.currentLang]||Se.pt,s=u=>i[u]||Se.pt?.[u]||u,r='style="margin-bottom: 12px; padding-left: 30px;"',c="";if(t.activeFields.forEach(u=>{let p=s(u.toLowerCase()),d="N/A";if(u==="label_substatus")p=s("label_substatus"),d=n.name;else if(u==="TAGS_IMPLEMENTED"){p=s("tags_implemented");let x=[];e.getCheckedElements().forEach(b=>{let m=b.value,S=Ce[m],E=b.count||1,H=m==="ads_conversion_tracking"||m==="ads_enhanced_conversions";t.tagSupportUsed&&H&&!t.forcedScreenshots.has(m)?x.push(`${S.name} - ${s("ts_output_disclaimer")}`):x.push(E>1?`${S.name} (x${E})`:S.name)}),d=x.join(", ")||"N/A"}else if(u==="SCREENSHOTS_LIST"){p=s("screenshots_list");let x="",g=e.screenshotsElement;g&&Array.from(g.querySelectorAll('input[id^="name-"]')).forEach(m=>{let S=m.value,E=m.closest(".cw-screen-card");if(E){let H=E.querySelectorAll('input[id^="screen-"]'),z=!1,$="";H.forEach(K=>{let _=K.closest(".cw-input-group")?.querySelector(".cw-input-label")?.textContent||"Evid\xEAncia",F=K.value.trim();F&&($+=`<li>${_} - ${F}</li>`,z=!0)}),z&&(x+=`<div style="margin-bottom: 8px;"><b>${S}</b><ul ${r}>${$}</ul></div>`)}}),d=x||"N/A"}else if(u==="CASO_PORTUGAL")p=s("caso_portugal"),d=s("sim");else if(u==="CONSENTIU_GRAVACAO")p=s("consentiu_gravacao"),d=t.consent?s("sim"):s("nao");else{let x=`field-${u}`,g=t.formData[x],b="";if(n.fieldPrefixes&&n.fieldPrefixes[u]&&(b=n.fieldPrefixes[u]+" "),g&&g.trim()!==""&&g.trim()!=="\u2022"){let m=g.trim();if($e.includes(u)){let S=m.split(`
`).map(E=>E.trim()).filter(E=>E!==""&&E!=="\u2022").map(E=>E.startsWith("\u2022 ")?E.substring(2):E).map(E=>`<li>${E}</li>`).join("");d=S?`${b}<ul ${r}>${S}</ul>`:"N/A"}else nt.includes(u)?d=b+m.split(`
`).filter(S=>S.trim()!=="").map(S=>`<p style="margin: 0 0 8px 0;">${S}</p>`).join(""):d=b+m}else b&&(d=b.trim())}c+=`<b>${p}</b><br>${d}<br><br>`}),n.customFooter&&(c+=`${n.customFooter}<br><br>`),o?.getOutput){let u=o.getOutput();u&&(c+=`${u}<br><br>`)}return c+="<i>Nota criada atrav\xE9s do Cases Wizard.</i>",c.replace(/(<br>\s*){3,}/g,"<br><br>").trim()}function Zt(t){let e=document.createElement("div");e.className="cw-step-scenarios";let o="Passe o mouse sobre um cen\xE1rio para visualizar o texto...",a=document.createElement("div");Object.assign(a.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let n=document.createElement("div");Object.assign(n.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"44px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s cubic-bezier(0.4, 0, 0.2, 1)",overflow:"hidden"});let i=document.createElement("span");i.style.transition="opacity 0.2s ease, transform 0.2s ease",i.textContent=o,n.appendChild(i);let s=new Set,r=null;return e.render=(c,u)=>{s.clear();let p=Object.entries(it).filter(([d,x])=>{let g=!x.type||x.type==="all"||x.type===u,b=!1;return c.startsWith("NI_")?b=d.includes("-ni-")||d.includes("attempted"):c.startsWith("SO_")?b=d.includes("gtm")||d.includes("whatsapp")||d.includes("form")||d.includes("ecw4")||d.includes("ga4")||d.includes("-so-"):c.startsWith("AS_")?b=d.includes("-as-"):c.startsWith("IN_")?b=d.includes("-in-"):c.startsWith("DC_")&&(b=d.includes("-dc-")),g&&b});a.innerHTML="",p.forEach(([d,x])=>{let g=document.createElement("div"),b=d.replace("quickfill-","").replace(/-/g," ");g.textContent=b,g.dataset.id=d,Object.assign(g.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)"});let m=x["field-REASON_COMMENTS"]||x["field-CONTEXTO_CALL"]||d;g.onmouseenter=()=>{r&&clearTimeout(r),s.has(d)||(g.style.background="#f1f3f4"),i.style.opacity="0",i.style.transform="translateY(5px)",r=setTimeout(()=>{i.textContent=m.substring(0,120)+(m.length>120?"...":""),i.style.opacity="1",i.style.transform="translateY(0)"},50)},g.onmouseleave=()=>{r&&clearTimeout(r),s.has(d)||(g.style.background="#ffffff"),r=setTimeout(()=>{s.size===0&&(i.style.opacity="0",setTimeout(()=>{i.textContent=o,i.style.opacity="1"},50))},100)},g.onclick=()=>{j.playClick();let S=!s.has(d);S?(s.add(d),g.style.background="#e8f0fe",g.style.borderColor="#1a73e8",g.style.color="#1967d2"):(s.delete(d),g.style.background="#ffffff",g.style.borderColor="#dadce0",g.style.color="#3c4043"),t(d,S)},a.appendChild(g)}),p.length===0?e.style.display="none":e.style.display="block"},e.appendChild(a),e.appendChild(n),e}var ae={bg:P.bgInput,white:P.surface,border:P.border,textMain:P.text,textSub:P.textSub,blue:P.blue,blueLight:P.primaryBg,brands:{ads:{id:"ads",label:"Google Ads",color:P.blue,bg:P.primaryBg,icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:P.yellow,bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:P.primary,bg:P.primaryBg,icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:P.green,bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},ze={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function Qt(t,e,o){let a={},n="implementation";o&&o.subscribe(()=>{K(),Z()});function i(_){let F=_.toLowerCase();return F.includes("ads")||F.includes("conversion")||F.includes("remarketing")?ae.brands.ads:F.includes("ga4")||F.includes("analytics")?ae.brands.ga4:F.includes("gtm")||F.includes("tag manager")||F.includes("container")?ae.brands.gtm:F.includes("merchant")||F.includes("shopping")||F.includes("feed")?ae.brands.gmc:ae.brands.default}let s=Object.entries(Ce).filter(([_,F])=>F.popular),r={};Object.entries(Ce).forEach(([_,F])=>{if(F.popular)return;let R=i(F.name);r[R.label]||(r[R.label]={brand:R,tasks:[]}),r[R.label].tasks.push({key:_,...F})});let c="cw-zen-tasks";if(!document.getElementById(c)){let _=document.createElement("style");_.id=c,_.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(_)}let u=document.createElement("div");u.className="cw-zen-container";let p=document.createElement("div");Object.assign(p.style,{display:"none"});let d=document.createElement("div");d.className="cw-screens-container",p.appendChild(d),u.innerHTML=`
    ...
    `;let x=u.querySelector(".cw-hero-grid"),g=u.querySelector(".cw-acc-container"),b=u.querySelector(".cw-results-container"),m=u.querySelector(".cw-search-input"),S=u.querySelector(".cw-status-bar"),E=u.querySelector(".cw-status-text"),H=u.querySelector(".cw-footer-icons");s.forEach(([_,F])=>{let R=i(F.name),G=document.createElement("div");G.className="cw-hero-card",G.id=`hero-${_}`,G.style.setProperty("--hero-color",R.color),G.innerHTML=`
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,J("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let s=Date.now()-n,r=Math.max(0,2e3-s);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let c=o.querySelector(".cw-center-dots"),u=o.querySelector(".cw-center-text"),p=o.querySelector(".cw-center-success"),d=o.querySelector(".cw-abort-btn");c&&(c.style.display="none"),u&&(u.style.display="none"),d&&(d.style.display="none"),p&&p.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},r)}}function io(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let u=document.createElement("div");u.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",u.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let p=document.createElement("button");p.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',p.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",p.onmouseenter=()=>p.style.background="#F1F3F4",p.onmouseleave=()=>p.style.background="transparent",p.onclick=()=>x(!1),u.appendChild(p);let d=document.createElement("div");d.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",c.appendChild(u),c.appendChild(d);function x(b){let m=c.style.transform==="translateY(0%)";(b!==void 0?b:!m)?(g(),c.style.transform="translateY(0%)"):c.style.transform="translateY(110%)"}function g(){let b=ge.getAll();if(d.innerHTML="",b.length===0){d.innerHTML=`
                ...
                </div>`;return}b.forEach(m=>{let S=document.createElement("div");S.style.cssText=`
...
`.replace(/\n/g,"<br>");Ke(_);let F=await mt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,_),ut(F),J("Nota gerada e inserida!")):J("Copiado! Abra uma nota para colar.")},e}var be=t=>new Promise(e=>setTimeout(e,t));function he(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function ke(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function gt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let s=i.querySelector(".cw-close-btn");s.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&s.click()},25e3)}async function bt(t,e){if(!t||!e)return;t.focus(),t.value="",t.dispatchEvent(new Event("input",{bubbles:!0})),await be(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(t,e),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0})),await be(100),t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function kt(){let e=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let a=o.offsetParent!==null,n=o.closest("case-message-view")!==null,i=o.closest(".editor")!==null||o.closest("write-card")!==null;return a&&!n&&i});return e&&he("Editor visualmente detectado.","success"),e}async function co(){he("\u{1F680} FASE 1: Tentando abrir a janela de email...");let t=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(d=>d.innerText.trim()==="email");if(o&&o.offsetParent!==null){he("Bot\xE3o de email direto encontrado.");let d=o.closest("material-button")||o.closest("material-fab")||o;ke(d),t=!0}else{he("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let d=document.querySelector("material-fab-speed-dial");if(d){let x=d.querySelector(".trigger");if(x){ke(x),await be(800);let b=Array.from(document.querySelectorAll("i.material-icons-extended")).find(m=>m.innerText.trim()==="email");b&&(ke(b),t=!0)}}}if(!t)return J("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;he("\u{1F680} FASE 2: Verificando rascunhos...");let a=null,n=0,i=20;for(;n<i;){await be(250);let d=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(a=Array.from(d).find(x=>x.offsetParent!==null),a){he("\u26A0\uFE0F Rascunho detectado!","warn");break}n++}if(a){he("\u{1F5D1}\uFE0F Descartando..."),ke(a),a.click();let d=null,x=0;for(;x<15;){await be(300);let g=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(d=Array.from(g).find(b=>b.offsetParent!==null),d)break;x++}d&&(ke(d),J("Limpando rascunho antigo...",{duration:2e3}),await be(2500))}he("\u{1F680} FASE 3: Buscando editor final...");let s=0,r=null;for(;s<20&&(r=kt(),!r);)await be(250),s++;if(!r)return J("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let c=r.closest('[id="email-body-content-top"]'),p=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(c){if(p){let x=p.closest('[aria-hidden="true"]');x&&x.removeAttribute("aria-hidden"),p.focus(),ke(p)}await be(300),c.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let d=c.querySelector("#cases-body-field");if(d){let x=document.createRange();x.selectNodeContents(d),x.collapse(!0);let g=window.getSelection();g.removeAllRanges(),g.addRange(x)}return!0}return!1}async function ft(t){if(!t||!await co())return;let o=await we();he("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let a=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(a&&(a.click(),await be(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await bt(i,o.clientEmail),gt(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await bt(i,o.internalEmail),gt(i,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}await be(500);let n=document.querySelector('material-button[debug-id="canned_response_button"]');if(n){ke(n),await be(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){ke(i),document.execCommand("insertText",!1,t),i.dispatchEvent(new Event("input",{bubbles:!0})),he("\u23F3 Buscando resultado da Canned Response...","info");let s=null,r=0,c=15e3,u=500;for(;r<c&&(s=document.querySelector("material-select-dropdown-item"),!s);)await be(u),r+=u;if(s){ke(s),await be(1500);let p=kt();if(p){let x=Array.from(p.querySelectorAll("span.field")).filter(b=>b.innerText.includes("{Requested Task Type}"));if(x.length>0){let b=x.map(S=>S.closest("tr")).filter(S=>S!==null),m=[...new Set(b)];if(m.length>0){let E=m[0].querySelector('td[width="100%"]');E&&(E.innerHTML='<span class="field" style="color:rgb(60, 64, 67)">Enhanced Conversions - Aguardando Valida\xE7\xE3o - Dentro de 7 dias</span>');for(let H=1;H<m.length;H++)m[H].remove()}}let g=p.innerHTML;o.advertiserName&&g.includes("{%ADVERTISER_NAME%}")&&(g=g.replace(/{%ADVERTISER_NAME%}/g,o.advertiserName)),g.includes("{%^79285%}")&&(g=g.replace(/{%\^79285%}/g,o.websiteUrl||"seu site")),p.innerHTML=g}J("Canned Response aplicada!")}else he(`\u274C Timeout: Resultado '${t}' n\xE3o apareceu ap\xF3s 15s.`,"error"),J(`Timeout: Template '${t}' n\xE3o carregou.`,{error:!0})}}else J("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function po(t){if(he(`\u{1F680} Iniciando Quick Email: ${t.name}`),!await co())return;let o=await we(),a=Ye();await be(600);let n=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(n&&(n.click(),await be(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let r=document.querySelector('input[aria-label="Enter To email address"]');r&&(await bt(r,o.clientEmail),gt(r,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let r=document.querySelector('input[aria-label="Enter Bcc email address"]');r&&(await bt(r,o.internalEmail),gt(r,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}let i=document.querySelector('input[aria-label="Subject"]');i&&t.subject&&(i.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(i,t.subject),i.dispatchEvent(new Event("input",{bubbles:!0})),await be(300));let s=kt();if(s){let c=(s.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');c&&(c.focus(),ke(c));let u=new Date;u.setDate(u.getDate()+3);let p=u.getDay();p===6?u.setDate(u.getDate()+2):p===0&&u.setDate(u.getDate()+1);let d=u.toLocaleDateString("pt-BR"),x=t.body;x=x.replace(/\[Nome do Cliente\]/g,o.advertiserName||"Cliente"),x=x.replace(/\[INSERIR URL\]/g,o.websiteUrl||"seu site"),x=x.replace(/\[URL\]/g,o.websiteUrl||"seu site"),x=x.replace(/\[Seu Nome\]/g,a),x=x.replace(/\[MM\/DD\/YYYY\]/g,d),document.execCommand("insertHTML",!1,x),c&&(c.dispatchEvent(new Event("input",{bubbles:!0})),c.dispatchEvent(new Event("change",{bubbles:!0}))),J("Email preenchido com sucesso!",{duration:2e3}),he("\u2705 Processo finalizado com sucesso.","success")}else J("Erro ao focar no editor.",{error:!0})}if(!document.getElementById("cw-module-styles")){let t=document.createElement("style");t.id="cw-module-styles",t.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let p=a.getBoundingClientRect();i.x=p.left+p.width/2,i.y=p.top+p.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let p=e.getBoundingClientRect();s=p.left+p.width/2,r=p.top+p.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let c=i.x-s,u=i.y-r;t?(j.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof uo=="function"&&uo(e,o)):(j.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Ft=="function"&&Ft(e))}function uo(t,e){Ft(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Ft(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function mo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Wt(t,Z),s=eo(y),r=Qt(()=>{T(),Y.setActiveTasks(r.getCheckedElements())},y,Y),c=document.createElement("div");c.style.display="none";let u=Zt((l,h)=>{C(l,h)});c.appendChild(u);let p=io({onSaveCurrent:async()=>{let l=await N();return q(),l},onLoadDraft:l=>{W(l)},t:l=>y(l)}),d=F(),x=R(),g=document.createElement("div"),b=X(),m=O(p,y);o.appendChild(d),o.appendChild(x),o.appendChild(b),o.appendChild(c),o.appendChild(g),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let S=document.createElement("button");S.id="manual-task-toggle",S.textContent=y("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",S.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${P.primary}; background: ${P.surface}; color: ${P.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,S.onmouseenter=()=>{S.style.background=P.primaryBg},S.onmouseleave=()=>{S.style.background=P.surface},S.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",S.style.display="none"},o.appendChild(S),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(m);let E=document.createElement("div");E.style.display="none",E.style.flexGrow="1",E.style.minHeight="0",E.style.overflow="hidden";let H=lo(()=>_());H.style.height="100%",E.appendChild(H),e.insertBefore(E,i);let z=a.lastElementChild;z&&(z.insertBefore(p.historyBtnWrapper,z.firstChild),z.insertBefore(V(),z.firstChild)),e.appendChild(p.drawer);let $=null;Y.subscribe(l=>{w(l),K(),l.isDirty?($&&clearTimeout($),$=setTimeout(async()=>{let h=await N(!0);h.subStatus?ge.saveEmergency(h):ge.clearEmergency(),l.isDirty=!1},2e3)):$&&(clearTimeout($),$=null)});function K(){let l=ge.getCount()>0,h=!!Y.currentSubStatus;dt(l||h)}function Z(){Y.visible=!Y.visible,ue(Y.visible,e,"cw-btn-notes")}function _(){Y.isSplitView=!Y.isSplitView,Y.isSplitView?(o.style.display="none",E.style.display="flex",E.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",E.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function F(){let l=document.createElement("div");if(l.innerHTML=`
        ...
        `;let h=l.querySelector("#main-status-select"),v=l.querySelector("#sub-status-select");return h.onchange=()=>{Y.setStatus(h.value),G(h.value,v),Y.setSubStatus(""),I("")},v.onchange=()=>{Y.setSubStatus(v.value),I(v.value)},l}function G(l,h){if(h.innerHTML=`<option value="">${y("select_substatus")}</option>`,!l){h.disabled=!0;return}for(let v in Te)if(Te[v].status===l){let k=document.createElement("option");k.value=v,k.textContent=Te[v].name,h.appendChild(k)}h.disabled=!1}function I(l){if(u.render&&u.render(l,Y.currentCaseType),!l){c.style.display="none",g.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",b.style.display="flex",b.style.opacity="1",m.style.display="none";return}b.style.opacity="0",setTimeout(()=>{Y.currentSubStatus&&(b.style.display="none")},400),m.style.display="grid";let h=Te[l];h&&h.templateFields&&Y.setActiveFields(h.templateFields),L(),Ct(l,g,Y),g.style.display="block",c.style.display="block";let v=l.startsWith("SO_"),k=l==="NI_Awaiting_Validation",M=document.getElementById("manual-task-toggle");v||k?(r.selectionElement.style.display="block",M.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",M.style.display="block");let U=l==="SO_Education_Only"?"education":"implementation";Y.setScreenshotMode(U),Y.currentCaseType==="lm"?Y.toggleFieldExclusion("field-ON_CALL",!0):Y.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(l),T();let D=document.getElementById("email-automation-toggle-row");D&&(D.style.display=He[l]?"flex":"none")}function T(){let l=r.getCheckedElements().map(h=>h.value);s.updateVisibility(Y.currentSubStatus,l)}function C(l,h){let v=it[l];if(v){for(let k in v)if(k==="linkedTask")r.toggleTask(v.linkedTask,h);else if(k==="activeTasks")v.activeTasks.forEach(M=>{h?r.setTaskCount(M.value,M.count):r.setTaskCount(M.value,0)});else if(k.startsWith("field-")){let M=k,U=v[k],D=document.getElementById(M);if(D){let Q=$e.includes(M.replace("field-",""));if(h)if(Q){let oe=D.value.trim();oe.includes(U.trim())||(D.value=oe?oe+`
...
CID: ${h.cid||"---"}
Case ID: ${h.caseId||"---"}
E-mail: ${h.clientEmail||"---"}`;k&&(k.value=U),M&&(M.style.display="block",M.style.maxHeight="300px",M.style.opacity="1",M.scrollIntoView({behavior:"smooth",block:"end"}))})}function g(){r=!r,ue(r,c,"cw-btn-script"),r?(d(),p||(p=setInterval(d,2e3))):p&&(clearInterval(p),p=null)}let b=pe(c,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",u,()=>{g()});c.appendChild(b);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
  ...
  `,m.onfocus=()=>{g.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",g.style.border="1px solid #1a73e8"},m.onblur=()=>{g.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",g.style.border="1px solid transparent"},g.appendChild(b),g.appendChild(m),x.appendChild(g),d.appendChild(x);let S=document.createElement("div");S.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",d.appendChild(S);let E=null;function H(){if(E)return;E=document.createElement("div"),E.style.cssText=`
      ...
      `,V.title="Copiar URL",A.onmouseenter=()=>{A.style.transform="translateY(-2px)",A.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",A.style.borderColor="rgba(0,0,0,0.05)",A.style.borderLeft=`4px solid ${L.color}`,V.style.opacity="1",V.style.background="#F1F3F4"},A.onmouseleave=()=>{A.style.transform="translateY(0)",A.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",A.style.border="1px solid transparent",V.style.opacity="0",V.style.background="transparent"},A.onclick=()=>{!O&&f&&vo(T,f),window.open(T.url,"_blank")},V.onclick=X=>{X.stopPropagation(),j.playClick(),navigator.clipboard.writeText(T.url),!O&&f&&vo(T,f),J("Link copiado!")},A.appendChild(q),A.appendChild(B),A.appendChild(V),A}m.addEventListener("input",T=>{e=T.target.value,R()});function I(){o=!o,ue(o,s,"cw-btn-links")}return document.body.appendChild(s),K(),R(),I}var qe=[];function Lt(t){qe=t}var aa=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function So(){let t="v4.9",e=!1,o=null,a=null;function n(f){if(!f)return"";try{let A=new Date(f);return isNaN(A.getTime())?String(f):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
...
`),l=/\d{1,2}\/\d{1,2}/,h="\u{1F4C5}";if(w.forEach(D=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(D)?h="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(D)&&(h="\u{1F1EA}\u{1F1F8}");let Q=D.match(l);if(Q){let oe=Q[0],ee=h;/🇧🇷|🇵🇹|PT|BR/i.test(D)?ee="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(D)&&(ee="\u{1F1EA}\u{1F1F8}"),X.some(te=>te.flag===ee&&te.date===oe)||X.push({flag:ee,date:oe})}}),X.length===0){let D=(y.text||"").match(/\d{1,2}\/\d{1,2}/g);D&&[...new Set(D)].forEach(Q=>X.push({flag:"\u{1F4C5}",date:Q}))}let v="",k='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(k=`
        ...
        `,W.appendChild(y),W.appendChild(V),F.appendChild(W);let X=document.createElement("div");X.id="cw-planner-status",Object.assign(X.style,u.statusBadge),F.appendChild(X);let w=document.createElement("div");Object.assign(w.style,{padding:"0 4px",marginTop:"12px"});let l=document.createElement("div");l.textContent="Arraste para simular o hor\xE1rio:",l.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let h=document.createElement("div");Object.assign(h.style,u.timelineContainer);let v=document.createElement("div");Object.assign(v.style,u.timelineTrack);let k=document.createElement("div");Object.assign(k.style,u.dayZone),v.appendChild(k);let M=document.createElement("input");M.type="range",M.min="0",M.max="1439",M.step="15",M.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let U=document.createElement("div");U.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",U.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",h.appendChild(v),h.appendChild(M),h.appendChild(U),w.appendChild(l),w.appendChild(h),F.appendChild(w);let D=y.querySelector("#cw-time-input-br"),Q=V.querySelector("#cw-time-display-client"),oe=V.querySelector("#cw-client-label");function ee(){let ne=It.find(Me=>Me.id===a);oe.textContent=`${ne.flag} ${ne.label} (${ne.zone})`;let te=r.getHours(),re=r.getMinutes(),Ve=`${String(te).padStart(2,"0")}:${String(re).padStart(2,"0")}`;D.value=Ve,M.value=te*60+re;let Qe=r.toLocaleTimeString("pt-BR",{timeZone:ne.zone,hour:"2-digit",minute:"2-digit"});Q.textContent=Qe;let Ie=parseInt(Qe.split(":")[0]);Ie>=9&&Ie<17?(X.style.background=c.successBg,X.style.color=c.success,X.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):Ie>=8&&Ie<9||Ie>=17&&Ie<19?(X.style.background=c.warningBg,X.style.color=c.warning,X.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(X.style.background=c.errorBg,X.style.color=c.error,X.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}M.oninput=ne=>{let te=parseInt(ne.target.value);r.setHours(Math.floor(te/60)),r.setMinutes(te%60),ee()},D.oninput=ne=>{let[te,re]=ne.target.value.split(":");te&&re&&(r.setHours(parseInt(te)),r.setMinutes(parseInt(re)),ee())},ee()}function O(){T(),o||(o=setInterval(T,6e4))}function f(){o&&(clearInterval(o),o=null)}function A(){e=!e,ue(e,p,"cw-btn-timezone"),e?R("live"):f()}return document.body.appendChild(p),A}function Fo(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let C=document.createElement("style");C.id="cw-lib-styles",C.innerHTML=`
    ...
    `;let u=c.querySelector("#cw-config-sound-toggle");u.onchange=x=>{j.setMuted(!x.target.checked),x.target.checked&&j.playClick()},r.appendChild(c);let p=document.createElement("div");p.className="cw-configs-section",p.innerHTML=`
    ...
    `,r.appendChild(p);function d(){e=!e,ue(e,n,"cw-btn-configs"),e&&j.playClick()}return document.body.appendChild(n),d}var Lo="cubic-bezier(0.4, 0, 0.2, 1)",ys=`all 0.3s ${Lo}`,Io=()=>{if(document.getElementById("bau-form-global-styles"))return;let t=document.createElement("style");t.id="bau-form-global-styles",t.textContent=`
  ...
  `,document.head.appendChild(t)};var _e={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>'};function qo(){Io();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=pe(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>X());i.appendChild(s);let r=document.createElement("div");r.className="bau-view-container",i.appendChild(r);let c=document.createElement("div");c.id="bau-view-dashboard",c.className="bau-view active",c.innerHTML=`
    ...
    `,r.appendChild(c);let u=document.createElement("div");u.id="bau-view-form",u.className="bau-view";let p=document.createElement("div");p.className="bau-view-header",p.innerHTML=`
      <button class="bau-back-btn" id="bau-form-back-btn">
        ${_e.back}
        Voltar ao Dashboard
      </button>
    `,u.appendChild(p);let d=document.createElement("div");d.className="bau-content",u.appendChild(d);let x=document.createElement("div");x.className="bau-progress-indicator",d.appendChild(x);let g=document.createElement("form");g.id="bau-escalation-form",d.appendChild(g);let b=document.createElement("input");b.type="hidden",b.name="language",g.appendChild(b);let m=document.createElement("div");m.className="bau-step active",m.id="bau-step-1";let S=document.createElement("div");S.className="bau-dynamic-inputs-container",S.innerHTML=`
    ...
    `,z.querySelectorAll(".bau-task-item").forEach(w=>{let l=w.querySelector("input");w.addEventListener("click",()=>{l.checked=!l.checked,w.classList.toggle("active",l.checked),j.playClick()})}),H.appendChild(z),g.appendChild(H);let K=document.createElement("div");K.className="bau-step",K.id="bau-step-3";let Z=document.createElement("div");Z.className="bau-card",Z.innerHTML=`
    ...
    `,r.appendChild(T),document.body.appendChild(i);function C(w){e=w,i.querySelectorAll(".bau-view").forEach(k=>k.classList.remove("active"));let l=i.querySelector(`#bau-view-${w}`);l&&l.classList.add("active");let h=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),v=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");h&&(h.textContent=w==="form"?"Novo Caso BAU":"BAU Central"),v&&(v.textContent=w==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function O(){let w=i.querySelector("#bau-case-list-container");if(w){w.innerHTML="<p>Carregando casos...</p>";try{let l=await ao();f(l)}catch{w.innerHTML='<p class="bau-error-text">Erro ao carregar casos.</p>'}}}function f(w){let l=i.querySelector("#bau-case-list-container"),h=i.querySelector("#bau-dashboard-metrics");if(!l)return;let v=U=>{switch(U){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray"};default:return{text:U||"Pendente",class:"status-gray"}}};if(!w||w.length===0){h&&(h.innerHTML=""),l.innerHTML=`
            ...
            `}}i.querySelector("#bau-top-se-search").onclick=w=>{w.preventDefault(),st("bau-context-se-id-input")};function N(){let w=new FormData(g),l=Object.fromEntries(w.entries()),h=w.getAll("taskType"),v=i.querySelector("#bau-confirmation-details");if(!v)return;let k=h.length>0?h.join(", "):"Nenhuma";v.innerHTML=`
        ...
        `}g.onsubmit=async w=>{if(w.preventDefault(),!L(n))return;let l=i.querySelector(".bau-btn-submit");l.disabled=!0,l.innerHTML="Enviando...";let h=new FormData(g),v=Object.fromEntries(h.entries()),k=h.getAll("taskType"),M=o||{},U=[v.availability_1,v.availability_2,v.availability_3].filter(Q=>Q&&Q.trim()!=="").join(" | "),D={...M,...v,taskType:k.join(", "),availability:U};try{await oo(D,M.agentEmail||"anon"),j.playSuccess(),C("success")}catch(Q){J("Erro: "+(Q.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",D)}finally{l.disabled=!1,l.innerHTML=`${_e.send} Enviar para o TL`}};function B(){g.reset(),a=1,A(),z.querySelectorAll(".bau-task-item.active").forEach(w=>w.classList.remove("active"))}let W=i.querySelector("#bau-new-case-btn");W&&(W.onclick=()=>{B(),C("form"),q()});let y=i.querySelector("#bau-form-back-btn");y&&(y.onclick=()=>C("dashboard"));let V=i.querySelector("#bau-success-back-btn");V&&(V.onclick=()=>C("dashboard"));async function X(){t=!t,i.style.display=t?"flex":"none",t&&(C("dashboard"),O()),ue(t,i,"cw-btn-bauform")}return A(),X}function sa(){if(window.techSolInitialized){wt();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{zt();try{j.initGlobalListeners(),j.playStartup()}catch(p){console.warn("\xC1udio bloqueado:",p)}ce.fetchTips(),wt();let e=mo(),o=xo(),a=yo(),n=wo(),i=ko(),s=Fo(),r=Oo(),c=qo(),u=So();no({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:c,broadcastControl:u}),setTimeout(()=>{ce.logEvent("App","Start","Session Start"),Co(),setTimeout(()=>{Ao(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),J("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}sa();})();
