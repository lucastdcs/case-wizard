...
Irei solicitar descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var $e=t=>new Promise(e=>setTimeout(e,t));function Ye(t){t&&["mousedown","mouseup","click"].forEach(e=>t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window})))}var Yt="cw-automation-styles";if(!document.getElementById(Yt)){let t=document.createElement("style");t.id=Yt,t.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let x=p.querySelector(".cw-hero-grid"),g=p.querySelector(".cw-acc-container"),f=p.querySelector(".cw-results-container"),u=p.querySelector(".cw-search-input"),y=p.querySelector(".cw-status-bar"),S=p.querySelector(".cw-status-text"),z=p.querySelector(".cw-footer-icons");s.forEach(([q,T])=>{let M=i(T.name),V=document.createElement("div");V.className="cw-hero-card",V.id=`hero-${q}`,V.style.setProperty("--hero-color",M.color),V.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${Re[M.icon]}</div>
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,X("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let s=Date.now()-n,r=Math.max(0,2e3-s);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let l=o.querySelector(".cw-center-dots"),p=o.querySelector(".cw-center-text"),d=o.querySelector(".cw-center-success"),c=o.querySelector(".cw-abort-btn");l&&(l.style.display="none"),p&&(p.style.display="none"),c&&(c.style.display="none"),d&&d.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},r)}}function no(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let p=document.createElement("div");p.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",p.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let d=document.createElement("button");d.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',d.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",d.onmouseenter=()=>d.style.background="#F1F3F4",d.onmouseleave=()=>d.style.background="transparent",d.onclick=()=>x(!1),p.appendChild(d);let c=document.createElement("div");c.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",l.appendChild(p),l.appendChild(c);function x(f){let u=l.style.transform==="translateY(0%)";(f!==void 0?f:!u)?(g(),l.style.transform="translateY(0%)"):l.style.transform="translateY(110%)"}function g(){let f=ge.getAll();if(c.innerHTML="",f.length===0){c.innerHTML=`
                ...
                border: 1.5px solid ${H.bgInput}; box-shadow: ${De.subtle};
...
`.replace(/\n/g,"<br>");Je(q);let T=await ut();T?(T.innerText.trim()===""&&(T.innerHTML=""),document.execCommand("insertHTML",!1,q),pt(T),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var fe=t=>new Promise(e=>setTimeout(e,t));function he(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function ke(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function mt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let d=e.getBoundingClientRect();s=d.left+d.width/2,r=d.top+d.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,p=i.y-r;t?(G.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof po=="function"&&po(e,o)):(G.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof kt=="function"&&kt(e))}function po(t,e){kt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function kt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function uo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Wt(t,J),s=Qt(h),r=Zt(()=>{k(),W.setActiveTasks(r.getCheckedElements())},h,W),l=document.createElement("div");l.style.display="none";let p=Kt((m,w)=>{C(m,w)});l.appendChild(p);let d=no({onSaveCurrent:async()=>{let m=await N();return I(),m},onLoadDraft:m=>{Y(m)},t:m=>h(m)}),c=T(),x=M(),g=document.createElement("div"),f=_(),u=F(d,h);o.appendChild(c),o.appendChild(x),o.appendChild(f),o.appendChild(l),o.appendChild(g),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let y=document.createElement("button");y.id="manual-task-toggle",y.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",y.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${H.primary}; background: ${H.surface}; color: ${H.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,y.onmouseenter=()=>{y.style.background=H.primaryBg},y.onmouseleave=()=>{y.style.background=H.surface},y.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",y.style.display="none"},o.appendChild(y),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(u);let S=document.createElement("div");S.style.display="none",S.style.flexGrow="1",S.style.minHeight="0",S.style.overflow="hidden";let z=ro(()=>q());z.style.height="100%",S.appendChild(z),e.insertBefore(S,i);let B=a.lastElementChild;B&&(B.insertBefore(d.historyBtnWrapper,B.firstChild),B.insertBefore(v(),B.firstChild)),e.appendChild(d.drawer);let P=null;W.subscribe(m=>{D(m),K(),m.isDirty?(P&&clearTimeout(P),P=setTimeout(async()=>{let w=await N(!0);w.subStatus?ge.saveEmergency(w):ge.clearEmergency(),m.isDirty=!1},2e3)):P&&(clearTimeout(P),P=null)});function K(){let m=ge.getCount()>0,w=!!W.currentSubStatus;ct(m||w)}function J(){W.visible=!W.visible,ue(W.visible,e,"cw-btn-notes")}function q(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",S.style.display="flex",S.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",S.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function T(){let m=document.createElement("div");if(m.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let E=document.createElement("style");E.id="cw-segmented-styles",E.innerHTML=`
            ...
            `,document.head.appendChild(E)}let w=(E,$)=>{let Z=m.querySelector(`#${E}`).querySelector(".cw-segmented-indicator");Z&&(Z.style.transform=`translateX(${$*100}%) translateX(${$*2}px)`)};return m.querySelectorAll("#lang-selector button").forEach((E,$)=>{E.onclick=()=>{W.setLanguage(E.dataset.lang),m.querySelectorAll("#lang-selector button").forEach(j=>j.classList.remove("active")),E.classList.add("active"),w("lang-selector",$),G.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m.querySelectorAll("#type-selector button").forEach((E,$)=>{E.onclick=()=>{W.setCaseType(E.dataset.type),m.querySelectorAll("#type-selector button").forEach(j=>j.classList.remove("active")),E.classList.add("active"),w("type-selector",$),G.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m.querySelectorAll("#portugal-selector button").forEach((E,$)=>{E.onclick=()=>{W.setPortugalCase(E.dataset.val==="true"),m.querySelectorAll("#portugal-selector button").forEach(j=>j.classList.remove("active")),E.classList.add("active"),w("portugal-selector",$),G.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m}function M(){let m=document.createElement("div");m.className="cw-status-section",m.style.cssText="display: flex; flex-direction: column; gap: 8px;",m.innerHTML=`
        ...
        `;let w=m.querySelector("#main-status-select"),E=m.querySelector("#sub-status-select");return w.onchange=()=>{W.setStatus(w.value),V(w.value,E),W.setSubStatus(""),L("")},E.onchange=()=>{W.setSubStatus(E.value),L(E.value)},m}function V(m,w){if(w.innerHTML=`<option value="">${h("select_substatus")}</option>`,!m){w.disabled=!0;return}for(let E in Te)if(Te[E].status===m){let $=document.createElement("option");$.value=E,$.textContent=Te[E].name,w.appendChild($)}w.disabled=!1}function L(m){if(p.render&&p.render(m,W.currentCaseType),!m){l.style.display="none",g.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",f.style.display="flex",f.style.opacity="1",u.style.display="none";return}f.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(f.style.display="none")},400),u.style.display="grid";let w=Te[m];w&&w.templateFields&&W.setActiveFields(w.templateFields),O(),St(m,g,W),g.style.display="block",l.style.display="block";let E=m.startsWith("SO_"),$=m==="NI_Awaiting_Validation",j=document.getElementById("manual-task-toggle");E||$?(r.selectionElement.style.display="block",j.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",j.style.display="block");let Z=m==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(Z),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(m),k();let U=document.getElementById("email-automation-toggle-row");U&&(U.style.display=Pe[m]?"flex":"none")}function k(){let m=r.getCheckedElements().map(w=>w.value);s.updateVisibility(W.currentSubStatus,m)}function C(m,w){let E=nt[m];if(E){for(let $ in E)if($==="linkedTask")r.toggleTask(E.linkedTask,w);else if($==="activeTasks")E.activeTasks.forEach(j=>{w?r.setTaskCount(j.value,j.count):r.setTaskCount(j.value,0)});else if($.startsWith("field-")){let j=$,Z=E[$],U=document.getElementById(j);if(U){let ee=He.includes(j.replace("field-",""));if(w)if(ee){let oe=U.value.trim();oe.includes(Z.trim())||(U.value=oe?oe+`
`+Z.trim():Z.trim())}else U.value=Z;else if(ee){let oe=U.value.trim(),Q=Z.trim();oe.includes(Q)&&(U.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else U.value.trim()===Z.trim()&&(U.value="");W.updateField(j,U.value),U.dispatchEvent(new Event("input"))}}}}function F(m,w){let E=document.createElement("div");if(E.className="cw-actions-section",E.style.cssText=`
            display: grid;
        ...
        `;let j=m.parkButton;j.classList.add("js-btn-park"),j.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let Z=document.createElement("button");Z.className="cw-btn-secondary js-btn-reset",Z.textContent=w("limpar"),Z.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.textSub}; border: 1px solid ${H.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,Z.onclick=()=>I();let U=document.createElement("button");U.className="cw-btn-secondary js-btn-copy",U.textContent=w("copiar"),U.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.primary}; border: 1px solid ${H.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,U.onclick=()=>b();let ee=document.createElement("button");return ee.className="cw-btn-primary js-btn-generate",ee.textContent=w("preencher"),ee.style.cssText=`width: 100%; height: 38px; background: ${H.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ee.onclick=()=>A(),E.appendChild($),E.appendChild(j),E.appendChild(Z),E.appendChild(U),E.appendChild(ee),E}async function b(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Ct(W,r,s);m?(Je(m),X(h("copiado_sucesso")),G.playClick()):X(h("select_substatus"),{error:!0})}async function A(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Ct(W,r,s);Je(m),J();let w=Xe(),E=await ut();if(E){E.focus(),document.execCommand("insertHTML",!1,m),pt(E);let $=document.getElementById("email-automation-checkbox");(!$||$.checked)&&W.currentSubStatus&&Pe[W.currentSubStatus]&&await ft(Pe[W.currentSubStatus]),X(h("inserido_copiado")),G.playSuccess(),I()}w()}function O(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let m=Te[W.currentSubStatus];m&&m.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function I(){W.reset(),r.reset(),s.reset(),K(),ge.clearEmergency(),o.querySelectorAll("select").forEach(w=>w.value=""),o.querySelector("#sub-status-select").disabled=!0;let m=document.getElementById("email-automation-toggle-row");m&&(m.style.display="none"),g.innerHTML="",l.style.display="none",f.style.display="flex",f.style.opacity="1",u.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none"}async function N(m=!1){let w={};g.querySelectorAll("input, textarea, select").forEach(U=>{(U.id.startsWith("field-")||U.id==="consent-select")&&(w[U.id]=U.value)});let E="Cliente",$="---";if(!m)try{let U=await we();E=U.advertiserName,$=U.cid}catch(U){console.warn("Erro ao coletar pageData:",U)}let j=r.getCheckedElements().map(U=>({key:U.value,count:U.count})),Z=j.map(U=>{let ee=Ce[U.key];return ee?ee.name:U.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:w,activeTasks:j,summaryTags:Z,clientName:E,cid:$,timestamp:new Date().toISOString()}}let R=m=>new Promise(w=>setTimeout(w,m));async function Y(m){W.setLanguage(m.currentLang||"pt"),W.setCaseType(m.currentCaseType||"bau"),W.setPortugalCase(m.isPortugalCase||!1),W.setConsent(m.consent||!1),W.setExcludedFields(m.excludedFields||[]),m.activeFields&&W.setActiveFields(m.activeFields);let w=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);w&&w.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(j=>{j!==w&&j.classList.remove("active")});let E=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);E&&E.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(j=>{j!==E&&j.classList.remove("active")});let $=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if($&&$.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(j=>{j!==$&&j.classList.remove("active")}),m.status){let j=o.querySelector("#main-status-select");j.value=m.status,W.setStatus(m.status);let Z=o.querySelector("#sub-status-select");if(V(m.status,Z),await R(50),m.subStatus){if(Z.value=m.subStatus,W.setSubStatus(m.subStatus),L(m.subStatus),await R(100),m.tagSupportUsed!==void 0){W.setTagSupportUsed(m.tagSupportUsed);let U=s.element.querySelector('input[value="Sim"]'),ee=s.element.querySelector('input[value="N\xE3o"]');m.tagSupportUsed&&U?U.checked=!0:ee&&(ee.checked=!0),s.element.querySelector("div:last-child").style.display=m.tagSupportUsed?"none":"block"}m.forcedScreenshots&&W.setForcedScreenshots(m.forcedScreenshots);for(let U in m.formData){let ee=document.getElementById(U);ee&&(ee.value=m.formData[U],W.updateField(U,ee.value))}m.activeTasks&&(m.activeTasks.forEach(U=>r.setTaskCount(U.key,U.count)),W.setActiveTasks(r.getCheckedElements()))}}W.isDirty=!1}function h(m){return Se[W.currentLang]?.[m]||Se.pt?.[m]||m}function v(){let m=document.createElement("div");return m.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',m.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",m.onclick=w=>{w.stopPropagation(),q()},m.title="Alternar para Split & Transfer",m}function _(){let m=document.createElement("div");return m.id="notes-empty-state",m.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
...
CID: ${w.cid||"---"}
Case ID: ${w.caseId||"---"}
E-mail: ${w.clientEmail||"---"}`;$&&($.value=Z),j&&(j.style.display="block",j.style.maxHeight="300px",j.style.opacity="1",j.scrollIntoView({behavior:"smooth",block:"end"}))})}function g(){r=!r,ue(r,l,"cw-btn-script"),r?(c(),d||(d=setInterval(c,2e3))):d&&(clearInterval(d),d=null)}let f=pe(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",p,()=>{g()});l.appendChild(f);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `,u.onfocus=()=>{g.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",g.style.border="1px solid #1a73e8"},u.onblur=()=>{g.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",g.style.border="1px solid transparent"},g.appendChild(f),g.appendChild(u),x.appendChild(g),c.appendChild(x);let y=document.createElement("div");y.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",c.appendChild(y);let S=null;function z(){if(S)return;S=document.createElement("div"),S.style.cssText=`
      ...
      `,b.title=C,b.dataset.key=k;let A=document.createElement("div");A.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",A.innerHTML=F||ze.tasks;let O=document.createElement("div");return O.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",O.textContent=C,b.appendChild(A),b.appendChild(O),b.onmouseenter=()=>{a!==k&&!(k==="history"&&n)&&(b.style.background="#F1F3F4",A.style.transform="scale(1.1)")},b.onmouseleave=()=>{a!==k&&!(k==="history"&&n)&&(b.style.background="transparent",A.style.transform="scale(1)")},b}function q(k){let C=document.getElementById(`cat-anchor-${k}`);C&&(C.scrollIntoView({behavior:"smooth",block:"start"}),a=k,T())}function T(){Object.keys(Ke).forEach(C=>{let F=d.querySelector(`#cw-sidebar-btn-${C}`);if(F)if(a===C&&!n){let b=bt[C];F.style.background=b.bg,F.style.color=b.color,F.querySelector("div:first-child").style.transform="scale(1.1)"}else F.style.background="transparent",F.style.color=i.textSecondary,F.querySelector("div:first-child").style.transform="scale(1)"});let k=d.querySelector("#cw-sidebar-btn-history");k&&(n?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=i.textSecondary))}function M(){if(y.innerHTML="",e.trim()!==""){let C=[];if(Object.entries(Ke).forEach(([b,A])=>{let O=A.links.filter(I=>I.name.toLowerCase().includes(e.toLowerCase())||I.desc.toLowerCase().includes(e.toLowerCase()));C.push(...O.map(I=>({...I,_cat:b})))}),C.length===0){y.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let F=document.createElement("div");F.innerHTML="Resultados da busca",F.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",y.appendChild(F),C.forEach(b=>{let A=V(b,ze[b._cat],!1,b._cat);y.appendChild(A)});return}Object.entries(Ke).forEach(([C,F])=>{let b=bt[C],A=document.createElement("div"),O=document.createElement("div");O.id=`cat-anchor-${C}`,O.style.cssText=`
          ...
          `,O.innerHTML=`
            ...
            ${F.label}
          `,A.appendChild(O);let I=document.createElement("div");I.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",F.links.forEach(N=>{let R=V(N,ze[C],!1,C);I.appendChild(R)}),A.appendChild(I),y.appendChild(A)});let k=document.createElement("div");k.style.height="80px",y.appendChild(k)}function V(k,C,F,b){let A=document.createElement("div"),O=bt[b]||bt.history;A.style.cssText=`
      ...
      `,f.querySelectorAll('input[name="cw-bc-type"]').forEach(I=>{I.addEventListener("change",()=>{f.querySelectorAll(".cw-radio-option").forEach(N=>N.classList.remove("checked")),I.parentElement.classList.add("checked")})}),setTimeout(()=>{let I=f.querySelector(".cw-radio-option.info");I&&I.classList.add("checked")},100);let b=f.querySelector("#cw-bc-cancel"),A=f.querySelector("#cw-bc-close-x"),O=f.querySelector("#cw-bc-send");b.onclick=B,A.onclick=B,O.onclick=P,p.appendChild(f)}function z(b=null){if(!f)return;let A=f.querySelector("#cw-editor-title-label"),O=f.querySelector("#cw-bc-title"),I=f.querySelector("#cw-bc-text"),N=f.querySelector("#cw-bc-send");if(b){a=b.id,A.textContent="Editar Aviso",O.value=b.title||"",I.value=b.text||"",N.textContent="Salvar Altera\xE7\xF5es";let R=b.type||"info",Y=f.querySelector(`input[name="cw-bc-type"][value="${R}"]`);Y&&Y.click()}else{a=null,A.textContent="Novo Aviso",O.value="",I.value="",N.textContent="Publicar";let R=f.querySelector('input[name="cw-bc-type"][value="info"]');R&&R.click()}f.classList.add("active"),setTimeout(()=>O.focus(),300)}function B(){f&&f.classList.remove("active"),a=null}async function P(){let b=f.querySelector("#cw-bc-send"),A=f.querySelector("#cw-bc-title"),O=f.querySelector("#cw-bc-text"),I=f.querySelector('input[name="cw-bc-type"]:checked'),N=I?I.value:"info";if(!A.value.trim()||!O.value.trim()){X("Preencha todos os campos!",{error:!0});return}b.textContent="Salvando...",b.style.opacity="0.7";let R=!1;a?R=await ce.updateBroadcast(a,{title:A.value,text:O.value,type:N}):R=await ce.sendBroadcast({title:A.value,text:O.value,type:N,author:window._cwCurrentUser||"admin"}),R?(X(a?"Atualizado!":"Publicado!"),G.playSuccess(),B(),setTimeout(()=>q(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),b.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",b.style.opacity="1")}async function K(b){if(await be("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await ce.deleteBroadcast(b)){X("Aviso removido."),G.playClick();let I=Ie.findIndex(N=>N.id===b);I>-1&&Ie.splice(I,1),M(),setTimeout(()=>q(),1500)}else X("Erro ao excluir.",{error:!0})}let J=document.createElement("div");J.className="cw-nice-scroll",Object.assign(J.style,i.feedContainer),p.appendChild(J);async function q(){e&&(y.style.display="block",y.innerHTML="\u{1F504} Sincronizando...");try{let b=await ce.fetchData();b&&b.broadcast&&(Ot(b.broadcast),T(),e&&(M(),y.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{y.style.display="none"},1500)))}catch{e&&(y.innerHTML="\u26A0\uFE0F Offline")}}function T(){let b=document.getElementById("cw-btn-broadcast");if(!b)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Ie.some(I=>!A.includes(I.id))){if(b.classList.add("has-new"),!b.querySelector(".cw-badge")){let I=document.createElement("div");I.className="cw-badge",Object.assign(I.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),b.appendChild(I)}}else{b.classList.remove("has-new");let I=b.querySelector(".cw-badge");I&&I.remove()}}function M(){J.innerHTML="";let b=p.querySelector("#cw-bau-widget");b&&b.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=[...Ie].sort((h,v)=>{let _=new Date(h.date).getTime()||0;return(new Date(v.date).getTime()||0)-_}),I=O.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(I!==-1){let h=O[I];O.splice(I,1);let v=document.createElement("div");v.id="cw-bau-widget",Object.assign(v.style,i.bauContainer);let _=[],D=(h.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,w="\u{1F4C5}";if(D.forEach(U=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(U)?w="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(U)&&(w="\u{1F1EA}\u{1F1F8}");let ee=U.match(m);if(ee){let oe=ee[0],Q=w;/🇧🇷|🇵🇹|PT|BR/i.test(U)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(U)&&(Q="\u{1F1EA}\u{1F1F8}"),_.some(te=>te.flag===Q&&te.date===oe)||_.push({flag:Q,date:oe})}}),_.length===0){let U=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);U&&[...new Set(U)].forEach(ee=>_.push({flag:"\u{1F4C5}",date:ee}))}let E="",$='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&($=`
          ...
          `,y.after(v);let j=v.querySelector("#cw-bau-toggle-btn"),Z=v.querySelector("#cw-bau-full");if(j&&Z&&(j.onclick=()=>{let U=Z.style.display==="none";Z.style.display=U?"block":"none",j.textContent=U?"Ocultar":"Detalhes"}),window._cwIsAdmin){let U=v.querySelector(".cw-bau-edit");U&&(U.onclick=()=>z(h))}}let N=O.sort((h,v)=>{let _=A.includes(h.id),D=A.includes(v.id);return _===D?0:_?1:-1});if(N.length===0&&!I){let h=document.createElement("div");Object.assign(h.style,i.emptyState),h.innerHTML=`
           ...
           `,J.appendChild(h)}let R=N.filter(h=>!A.includes(h.id)),Y=N.filter(h=>A.includes(h.id));if(R.forEach(h=>J.appendChild(V(h,!1))),Y.length>0){let h=document.createElement("div");Object.assign(h.style,i.historyDivider),h.innerHTML=`<span>Hist\xF3rico (${Y.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let v=document.createElement("div");Object.assign(v.style,i.historyContainer),Y.forEach(D=>v.appendChild(V(D,!0)));let _=!1;h.onclick=()=>{G.playClick(),_=!_,v.style.display=_?"flex":"none",h.querySelector("svg").style.transform=_?"rotate(180deg)":"rotate(0deg)"},J.appendChild(h),J.appendChild(v)}}function V(b,A){let O=document.createElement("div");Object.assign(O.style,A?i.cardHistory:i.card);let I=s[b.type]||s.info,N=document.createElement("div");Object.assign(N.style,i.cardHeader);let R=document.createElement("div");Object.assign(R.style,i.typeTag,{color:I.color,background:I.bg}),R.innerHTML=`${I.icon} <span>${b.type}</span>`;let Y=document.createElement("span");if(Object.assign(Y.style,i.dateTag),Y.textContent=n(b.date),N.appendChild(R),A)N.appendChild(Y);else{let m=document.createElement("button");m.className="cw-btn-interactive",Object.assign(m.style,i.dismissBtn),m.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',m.onmouseenter=()=>{m.style.color="#1e8e3e",m.style.background="#e6f4ea",m.style.borderColor="#1e8e3e"},m.onmouseleave=()=>{m.style.color="#5f6368",m.style.background="#fff",m.style.borderColor="rgba(0,0,0,0.1)"},m.onclick=w=>{w.stopPropagation(),G.playClick(),O.style.transform="translateX(20px)",O.style.opacity="0",setTimeout(()=>{let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");E.push(b.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(E)),M(),T()},200)},N.appendChild(m)}let h=document.createElement("div");Object.assign(h.style,i.cardContent);let v=document.createElement("div");Object.assign(v.style,i.msgTitle),v.textContent=b.title;let _=document.createElement("div");Object.assign(_.style,i.msgBody),_.innerHTML=l(b.text);let D=document.createElement("div");if(Object.assign(D.style,i.msgMeta),D.innerHTML=`Publicado por <b>${b.author||"Sistema"}</b>`,A||(D.innerHTML+=` \u2022 ${n(b.date)}`),h.appendChild(v),h.appendChild(_),h.appendChild(D),O.appendChild(N),O.appendChild(h),window._cwIsAdmin){let m=document.createElement("div");m.className="cw-card-actions";let w=document.createElement("button");w.className="cw-action-btn edit",w.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',w.onclick=()=>z(b);let E=document.createElement("button");E.className="cw-action-btn delete",E.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',E.onclick=()=>K(b.id),m.appendChild(w),m.appendChild(E),O.appendChild(m)}return O}let L=ce.getCachedBroadcasts();L.length>0&&(Ot(L),M()),setTimeout(u,500),q(),o||(o=setInterval(q,oa));let k=document.createElement("div");Object.assign(k.style,Ee),k.className="no-drag",p.appendChild(k),Ae(p,k),document.body.appendChild(p);let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),F=Ie.some(b=>!C.includes(b.id));return{toggle:c,hasUnread:F}}function So(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let l=document.createElement("div");Object.assign(l.style,o.dotsContainer);let p=document.createElement("div");Object.assign(p.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let c=document.createElement("button");c.textContent="Pr\xF3ximo",Object.assign(c.style,o.btn,o.btnNext),c.onmouseover=()=>c.style.transform="scale(1.05)",c.onmouseout=()=>c.style.transform="scale(1)",p.appendChild(d),p.appendChild(c),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(l),n.appendChild(p),a.appendChild(n),document.body.appendChild(a);function x(f){let u=t[f];i.textContent=u.icon,s.textContent=u.title,r.textContent=u.text,l.innerHTML="",t.forEach((y,S)=>{let z=document.createElement("div");Object.assign(z.style,o.dot),S===f&&Object.assign(z.style,o.dotActive),l.appendChild(z)}),u.isLast?(d.style.display="none",c.textContent="Come\xE7ar \u{1F680}",c.style.width="100%"):(d.style.display="block",c.textContent="Pr\xF3ximo",c.style.width="auto")}function g(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),G.playSuccess(),X("Tudo pronto! Use o menu flutuante.")}c.onclick=()=>{G.playClick(),e<t.length-1?(e++,x(e)):g()},d.onclick=async()=>{await be("Pular o tutorial?")&&g()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var Co={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function Eo(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&aa(t)}function aa(t){let e=Co.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let l=document.createElement("div");Object.assign(l.style,a.title);let p=document.createElement("div");Object.assign(p.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let c=document.createElement("button");Object.assign(c.style,a.btn),c.onmouseover=()=>c.style.transform="scale(1.02)",c.onmouseout=()=>c.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(l),i.appendChild(p),i.appendChild(d),i.appendChild(c),n.appendChild(i),document.body.appendChild(n);function x(f){let u=e[f];r.textContent=u.icon,l.textContent=u.title,p.textContent=u.text,d.innerHTML="",e.forEach((y,S)=>{let z=document.createElement("div");Object.assign(z.style,a.dot),S===f&&Object.assign(z.style,a.dotActive),d.appendChild(z)}),f===e.length-1?c.textContent="Entendi, vamos l\xE1! \u{1F44D}":c.textContent="Pr\xF3ximo"}function g(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),G.playSuccess(),X(`TechSol atualizado para ${t}!`)}c.onclick=()=>{G.playClick(),o<e.length-1?(o++,x(o)):g()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Ao="cw_timezone_pinned",qt=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],na=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function To(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Ao)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},p={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=pe(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>A());d.appendChild(x);let g=document.createElement("div");Object.assign(g.style,p.container),d.appendChild(g);let f=document.createElement("div");Object.assign(f.style,p.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,p.tabBtn,p.tabActive);let y=document.createElement("div");y.textContent="Planejador",Object.assign(y.style,p.tabBtn),f.appendChild(u),f.appendChild(y),g.appendChild(f);let S=document.createElement("div");Object.assign(S.style,p.toolbar);let z=document.createElement("div");Object.assign(z.style,p.searchInputWrapper);let B=document.createElement("div");B.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(B.style,p.searchIcon);let P=document.createElement("input");P.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(P.style,p.searchInput),P.onfocus=()=>{P.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",P.style.borderColor="rgba(26,115,232,0.3)"},P.onblur=()=>{P.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",P.style.borderColor="transparent"},P.oninput=O=>{i=O.target.value.toLowerCase(),k()},z.appendChild(B),z.appendChild(P),S.appendChild(z);let K=document.createElement("div");Object.assign(K.style,p.chipsRow),na.forEach(O=>{let I=document.createElement("div");I.textContent=O.label,I.id=`tz-filter-${O.id}`,Object.assign(I.style,p.chip),O.id===s&&Object.assign(I.style,p.chipActive),I.onclick=()=>{G.playClick(),s=O.id,Array.from(K.children).forEach(N=>{Object.assign(N.style,p.chip)}),Object.assign(I.style,p.chipActive),k()},K.appendChild(I)}),S.appendChild(K),g.appendChild(S);let J=document.createElement("div");Object.assign(J.style,p.listContainer);let q=document.createElement("style");q.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",g.appendChild(q);let T=document.createElement("div");Object.assign(T.style,p.plannerWrapper,{display:"none"}),g.appendChild(J),g.appendChild(T),u.onclick=()=>M("live"),y.onclick=()=>M("plan");function M(O){G.playClick(),O==="live"?(Object.assign(u.style,p.tabActive),Object.assign(y.style,p.tabBtn),y.style.borderBottomColor="transparent",J.style.display="flex",S.style.display="flex",T.style.display="none",F()):(Object.assign(y.style,p.tabActive),Object.assign(u.style,p.tabBtn),u.style.borderBottomColor="transparent",T.style.display="flex",J.style.display="none",S.style.display="none",b(),C())}function V(O){return O>=9&&O<17?{color:l.success,bg:l.successBg,label:"Aberto",icon:"\u{1F7E2}"}:O>=8&&O<9?{color:l.warning,bg:l.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:O>=17&&O<19?{color:l.warning,bg:l.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function L(O){n.includes(O)?n=n.filter(I=>I!==O):n.push(O),localStorage.setItem(Ao,JSON.stringify(n)),k(),G.playClick()}function k(){J.innerHTML="";let O=new Date,I=qt.filter(R=>{let Y=R.name.toLowerCase().includes(i)||R.label.toLowerCase().includes(i),h=s==="all"||R.region===s;return Y&&h});if(I.sort((R,Y)=>{let h=n.includes(R.id),v=n.includes(Y.id);return h&&!v?-1:!h&&v?1:R.name.localeCompare(Y.name)}),I.length===0){J.innerHTML=`
            ...
            `,m.onmouseenter=()=>{m.style.transform="translateY(-2px)",m.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},m.onmouseleave=()=>{m.style.transform="translateY(0)",m.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let $=m.querySelector(".cw-pin-btn");$.onmouseenter=()=>{$.style.backgroundColor="#F1F3F4"},$.onmouseleave=()=>{$.style.backgroundColor="transparent"},$.onclick=j=>{j.stopPropagation(),L(R.id)},m.onclick=()=>{a=R.id,M("plan")},J.appendChild(m)});let N=document.createElement("div");N.style.height="20px",N.style.width="100%",J.appendChild(N)}function C(){T.innerHTML="";let O=document.createElement("div"),I=document.createElement("label");I.textContent="Onde est\xE1 o cliente?",I.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let N=document.createElement("select");Object.assign(N.style,Bt),N.style.padding="14px",[...qt].sort((ne,te)=>ne.name.localeCompare(te.name)).forEach(ne=>{let te=document.createElement("option");te.value=ne.id,te.textContent=`${ne.flag} ${ne.name} (${ne.zone})`,ne.id===a&&(te.selected=!0),N.appendChild(te)}),N.onchange=ne=>{a=ne.target.value,Q(),G.playClick()},O.appendChild(I),O.appendChild(N),T.appendChild(O);let Y=document.createElement("div");Object.assign(Y.style,p.timeComparisonRow);let h=document.createElement("div");Object.assign(h.style,p.timeCard),h.style.backgroundColor="#F8FAFF",h.style.borderColor="#E8F0FE",h.innerHTML=`
        ...
        `,Y.appendChild(h),Y.appendChild(v),T.appendChild(Y);let _=document.createElement("div");_.id="cw-planner-status",Object.assign(_.style,p.statusBadge),T.appendChild(_);let D=document.createElement("div");Object.assign(D.style,{padding:"0 4px",marginTop:"12px"});let m=document.createElement("div");m.textContent="Arraste para simular o hor\xE1rio:",m.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let w=document.createElement("div");Object.assign(w.style,p.timelineContainer);let E=document.createElement("div");Object.assign(E.style,p.timelineTrack);let $=document.createElement("div");Object.assign($.style,p.dayZone),E.appendChild($);let j=document.createElement("input");j.type="range",j.min="0",j.max="1439",j.step="15",j.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let Z=document.createElement("div");Z.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",Z.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",w.appendChild(E),w.appendChild(j),w.appendChild(Z),D.appendChild(m),D.appendChild(w),T.appendChild(D);let U=h.querySelector("#cw-time-input-br"),ee=v.querySelector("#cw-time-display-client"),oe=v.querySelector("#cw-client-label");function Q(){let ne=qt.find(_e=>_e.id===a);oe.textContent=`${ne.flag} ${ne.label} (${ne.zone})`;let te=r.getHours(),re=r.getMinutes(),Ue=`${String(te).padStart(2,"0")}:${String(re).padStart(2,"0")}`;U.value=Ue,j.value=te*60+re;let Ze=r.toLocaleTimeString("pt-BR",{timeZone:ne.zone,hour:"2-digit",minute:"2-digit"});ee.textContent=Ze;let Le=parseInt(Ze.split(":")[0]);Le>=9&&Le<17?(_.style.background=l.successBg,_.style.color=l.success,_.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):Le>=8&&Le<9||Le>=17&&Le<19?(_.style.background=l.warningBg,_.style.color=l.warning,_.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(_.style.background=l.errorBg,_.style.color=l.error,_.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}j.oninput=ne=>{let te=parseInt(ne.target.value);r.setHours(Math.floor(te/60)),r.setMinutes(te%60),Q()},U.oninput=ne=>{let[te,re]=ne.target.value.split(":");te&&re&&(r.setHours(parseInt(te)),r.setMinutes(parseInt(re)),Q())},Q()}function F(){k(),o||(o=setInterval(k,6e4))}function b(){o&&(clearInterval(o),o=null)}function A(){e=!e,ue(e,d,"cw-btn-timezone"),e?M("live"):b()}return document.body.appendChild(d),A}function ko(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let C=document.createElement("style");C.id="cw-lib-styles",C.innerHTML=`
        ...
        `,document.head.appendChild(C)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},s={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let p=pe(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>k());r.appendChild(p);let d=document.createElement("div");Object.assign(d.style,s.container),r.appendChild(d);let c=document.createElement("div");Object.assign(c.style,s.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(C=>{let F=document.createElement("div");F.innerHTML=`${C.icon} ${C.label}`,F.id=`lib-tab-${C.id}`,Object.assign(F.style,s.tabBtn),C.id===o&&Object.assign(F.style,s.tabActive),F.onmouseenter=()=>G.playHover(),F.onclick=()=>K(C.id),c.appendChild(F)}),d.appendChild(c);let g=document.createElement("div");Object.assign(g.style,s.listContainer),d.appendChild(g);let f=document.createElement("div");f.className="cw-fab cw-tactile",Object.assign(f.style,s.fab),f.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',f.onmouseenter=()=>f.style.transform="scale(1.1)",f.onmouseleave=()=>f.style.transform="scale(1)",f.onclick=()=>q(),d.appendChild(f),a=document.createElement("div"),Object.assign(a.style,s.editorOverlay);let u=document.createElement("div");Object.assign(u.style,s.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let y=document.createElement("button");y.innerHTML="Cancelar",y.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",y.onclick=T,u.appendChild(y),a.appendChild(u);let S=document.createElement("div");Object.assign(S.style,s.editorBody),a.appendChild(S);let z=document.createElement("div");z.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let B=document.createElement("button");B.textContent="Salvar",B.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",B.onclick=M,z.appendChild(B),a.appendChild(z),d.appendChild(a);let P=document.createElement("div");Object.assign(P.style,Ee),P.className="no-drag",r.appendChild(P),Ae(r,P),document.body.appendChild(r);function K(C){G.playClick(),o=C,x.forEach(F=>{let b=document.getElementById(`lib-tab-${F.id}`);F.id===C?Object.assign(b.style,s.tabActive):Object.assign(b.style,s.tabBtn)}),J()}function J(){g.innerHTML="";let C=xe.getSnippets(o);if(C.length===0){g.innerHTML=`
            ...
            `;return}C.forEach(F=>{let b=document.createElement("div");b.className="cw-lib-card",Object.assign(b.style,s.card),F.isCode&&(b.style.borderLeft=`4px solid ${i.primary}`,b.style.background="rgba(0, 122, 255, 0.02)");let A=F.content;if(F.isRich){let O=document.createElement("div");O.innerHTML=F.content;let I=O.querySelector("img");A=O.innerText.substring(0,150)+(O.innerText.length>150?"...":""),I&&(A="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+A)}b.innerHTML=`
            ...
            `,b.onmouseenter=()=>{G.playHover()},b.querySelector(".cw-act-copy").onclick=O=>{if(O.stopPropagation(),G.playClick(),F.isRich){let I=new Blob([F.content],{type:"text/html"}),N=document.createElement("div");N.style.whiteSpace="pre-wrap",N.innerHTML=F.content;let R=new Blob([N.innerText],{type:"text/plain"}),Y=[new ClipboardItem({"text/html":I,"text/plain":R})];navigator.clipboard.write(Y)}else navigator.clipboard.writeText(F.content);X("Copiado!")},b.querySelector(".cw-act-edit").onclick=O=>{O.stopPropagation(),G.playClick(),q(F)},b.querySelector(".cw-act-del").onclick=async O=>{O.stopPropagation(),G.playClick(),await be("Excluir este item?")&&(xe.delete(F.id),J(),X("Item exclu\xEDdo."))},g.appendChild(b)})}function q(C=null){n=C?C.id:null,S.innerHTML="",S.appendChild(V("title","T\xEDtulo / Nome",C?C.title:"")),o==="email"&&S.appendChild(V("subject","Assunto do Email",C?C.subject:""));let F="Conte\xFAdo";o==="email"&&(F="Corpo do Email (HTML)"),o==="note"&&(F="Texto da Nota (Reason)"),S.appendChild(V("content",F,C?C.content:"",{isRich:!0,isCode:C?C.isCode:!1})),u.querySelector("span").textContent=C?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let b=S.querySelector("input");b&&b.focus()},300)}function T(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function M(){let C=S.querySelector("#cw-inp-title"),F=S.querySelector("#cw-inp-content"),b=C.value.trim(),A=F.contentEditable==="true"?F.innerHTML:F.value.trim(),O=F.getAttribute("data-is-code")==="true";if(!b||!A||A==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let I={id:n,type:o,title:b,content:A,isCode:O,isRich:F.contentEditable==="true"};if(o==="email"){let N=S.querySelector("#cw-inp-subject").value.trim();if(!N){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}I.subject=N}B.textContent="Salvando...",await xe.save(I),B.textContent="Salvar",T(),J(),X("Salvo com sucesso!"),G.playSuccess()}function V(C,F,b,A={}){let O=document.createElement("div");Object.assign(O.style,s.inputGroup);let I=document.createElement("label");I.textContent=F,Object.assign(I.style,s.label);let N;if(A.isRich){let R=document.createElement("div");R.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",R.innerHTML=`
    ...
    `,r.appendChild(d);function c(){e=!e,ue(e,n,"cw-btn-configs"),e&&G.playClick()}return document.body.appendChild(n),c}var Oo={blue:"#1A73E8",red:"#D93025",yellow:"#F9AB00",green:"#1E8E3E",blueLight:"#E8F0FE",redLight:"#FCE8E6",yellowLight:"#FEF7E0",greenLight:"#E6F4EA",textPrimary:"#202124",textSecondary:"#5F6368",border:"#DADCE0",surface:"rgba(255, 255, 255, 0.8)",white:"#FFFFFF"};var ia="cubic-bezier(0.4, 0, 0.2, 1)",ys=`all 0.3s ${ia}`,qo=()=>{if(document.getElementById("bau-form-global-styles"))return;let t=document.createElement("style");t.id="bau-form-global-styles",t.textContent=`
...
`,document.head.appendChild(t)};function Lo(){qo();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=pe(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>h());i.appendChild(s);let r=document.createElement("div");r.className="bau-view-container",i.appendChild(r);let l=document.createElement("div");l.id="bau-view-dashboard",l.className="bau-view active",l.innerHTML=`
    ...
    `,z.querySelectorAll(".bau-task-item").forEach(v=>{let _=v.querySelector("input");v.addEventListener("click",()=>{_.checked=!_.checked,v.classList.toggle("active",_.checked),G.playClick()})}),S.appendChild(z),g.appendChild(S);let B=document.createElement("div");B.className="bau-step",B.id="bau-step-3";let P=document.createElement("div");P.className="bau-card",P.innerHTML=`
    ...
    `,B.appendChild(P),g.appendChild(B);let K=document.createElement("div");K.className="bau-step",K.id="bau-step-4",K.innerHTML=`
        <div class="bau-card">
            <h3 style="margin-top: 0; color: ${Oo.blue}; font-size: 16px; margin-bottom: 20px;">Confirme os dados antes de enviar</h3>
            <div id="bau-confirmation-details"></div>
        </div>
    `,g.appendChild(K);let J=document.createElement("div");J.className="bau-footer";let q=document.createElement("button");q.type="button",q.id="bau-step-back-btn",q.className="bau-btn-secondary",q.textContent="Voltar",J.appendChild(q);let T=document.createElement("button");T.type="button",T.id="bau-step-next-btn",T.className="bau-btn-primary",T.textContent="Pr\xF3ximo",J.appendChild(T);let M=document.createElement("button");M.type="submit",M.className="bau-btn-submit",M.setAttribute("form","bau-escalation-form"),M.innerHTML='<span class="material-icons">send</span> Enviar para o TL',M.style.display="none",J.appendChild(M),g.appendChild(J),r.appendChild(p);let V=document.createElement("div");V.id="bau-view-success",V.className="bau-view",V.innerHTML=`
    ...
    `,r.appendChild(V),document.body.appendChild(i);function L(v){e=v,i.querySelectorAll(".bau-view").forEach(w=>w.classList.remove("active"));let _=i.querySelector(`#bau-view-${v}`);_&&_.classList.add("active");let D=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),m=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");D&&(D.textContent=v==="form"?"Novo Caso BAU":"BAU Central"),m&&(m.textContent=v==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function k(){let v=i.querySelector("#bau-case-list-container");if(v){v.innerHTML="<p>Carregando casos...</p>";try{let _=await oo();C(_)}catch{v.innerHTML='<p style="color: red;">Erro ao carregar casos.</p>'}}}function C(v){let _=i.querySelector("#bau-case-list-container");if(_){if(!v||v.length===0){_.innerHTML="<p>Nenhum caso BAU encontrado.</p>";return}_.innerHTML=v.map(D=>`
        ...
        `).join("")}}function F(){g.querySelectorAll(".bau-step").forEach((v,_)=>{v.classList.toggle("active",_+1===a)}),x.innerHTML="";for(let v=1;v<=n;v++){let _=document.createElement("div");_.className=`bau-progress-step ${v===a?"active":v<a?"completed":""}`,_.textContent=v,x.appendChild(_)}q.style.display=a>1?"inline-block":"none",T.style.display=a<n?"inline-block":"none",M.style.display=a===n?"inline-block":"none",a===4&&O()}function b(v){let _=i.querySelector(`#bau-step-${v}`);if(!_)return!0;if(v===2)return g.querySelector('select[name="reason"]').value?g.querySelector('input[name="taskType"]:checked')?!0:(X("Erro: Selecione pelo menos uma Task.",{error:!0}),!1):(X("Erro: O Motivo da Abertura \xE9 obrigat\xF3rio.",{error:!0}),!1);for(let D of _.querySelectorAll("[required]"))if(!D.value.trim())return X(`Erro: O campo '${D.name||D.placeholder}' \xE9 obrigat\xF3rio.`,{error:!0}),!1;return!0}T.onclick=()=>{b(a)&&(a++,F(),G.playClick())},q.onclick=()=>{a>1&&(a--,F(),G.playClick())};async function A(){let v=await we()||{};o=v,g.querySelector('[name="advName"]').value=v.advName||"",g.querySelector('[name="cid"]').value=v.cid||"",g.querySelector('[name="amName"]').value=v.amName||"",g.querySelector('[name="seId"]').value=v.seId||""}i.querySelector("#bau-top-se-search").onclick=v=>{v.preventDefault(),it("bau-context-se-id-input")};function O(){let v=new FormData(g),_=Object.fromEntries(v.entries()),D=v.getAll("taskType"),m=i.querySelector("#bau-confirmation-details");m&&(m.innerHTML=`
        ...
        `)}g.onsubmit=async v=>{if(v.preventDefault(),!b(n))return;M.disabled=!0,M.innerHTML="Enviando...";let _=new FormData(g),D=Object.fromEntries(_.entries()),m=_.getAll("taskType"),w=o||{},E={...D,taskType:m.join(", "),...w};try{await to(E,w.agentEmail||"anon"),G.playSuccess(),L("success")}catch($){X("Falha ao enviar: "+($.message||"Erro desconhecido"),"error")}finally{M.disabled=!1,M.innerHTML='<span class="material-icons">send</span> Enviar para o TL'}};function I(){g.reset(),a=1,F(),z.querySelectorAll(".bau-task-item.active").forEach(v=>v.classList.remove("active"))}let N=i.querySelector("#bau-new-case-btn");N&&(N.onclick=()=>{I(),L("form"),A()});let R=i.querySelector("#bau-form-back-btn");R&&(R.onclick=()=>L("dashboard"));let Y=i.querySelector("#bau-success-back-btn");Y&&(Y.onclick=()=>L("dashboard"));async function h(){t=!t,i.style.display=t?"flex":"none",t&&(L("dashboard"),k()),ue(t,i,"cw-btn-bauform")}return F(),h}function sa(){if(window.techSolInitialized){vt();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Rt();try{G.initGlobalListeners(),G.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}ce.fetchTips(),vt();let e=uo(),o=bo(),a=ho(),n=vo(),i=To(),s=ko(),r=Fo(),l=Lo(),p=wo();ao({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:l,broadcastControl:p}),setTimeout(()=>{ce.logEvent("App","Start","Session Start"),So(),setTimeout(()=>{Eo(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}sa();})();
