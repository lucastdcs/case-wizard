...
@media (prefers-reduced-motion: reduce) {
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Oa={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ro={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var $o={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Do=!1;function Ji(){if(Do||document.getElementById("techsol-google-styles"))return;let e=document.createElement("style");e.id="techsol-google-styles",e.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await ge(200);let t=await Bt(),a=Lo(t),o=e.querySelector("#w-icon"),n=e.querySelector("#p1"),i=e.querySelector("#p2"),r=e.querySelector("#p3"),c=e.querySelector("#p-sextou");o&&(o.innerHTML=a.icon),n&&(n.textContent=a.prefix),r&&(r.textContent=a.suffix),await ge(300);let l=o?o.querySelector("svg"):null;if(l&&(l.style.opacity="1",l.style.transform="scale(1)"),await ge(400),n&&(n.style.opacity="1"),y.playStartup(),i&&await Zi(i,a.name),r&&(r.style.opacity="1",r.style.transform="translateY(0)"),a.isFriday&&c){await ge(400),c.style.display="block",c.offsetWidth;let g=c.querySelector(".sextou-badge");g&&(g.style.opacity="1",g.style.transform="scale(1)")}await ge(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await ge(900),e.parentNode&&e.parentNode.removeChild(e)}}function Po(e){if(!e)return;let t=e.getBoundingClientRect(),a=window.innerWidth,o=window.innerHeight,n=24,i=a-t.width-n,r=o-t.height-n,c=parseFloat(e.style.left)||t.left,l=parseFloat(e.style.top)||t.top,g=wt(c,n,i),d=wt(l,n,r);if(g!==c||d!==l){let w=e.style.transition;e.style.transition="left 0.3s var(--cw-ease-elastic), top 0.3s var(--cw-ease-elastic)",e.style.left=`${g}px`,e.style.top=`${d}px`,setTimeout(()=>{e.style.transition=w},300)}}var it={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function rt(e,t){t.onmousedown=a;function a(o){o.stopPropagation(),o.preventDefault();let n=e.style.transition;e.style.transition="none";let i=o.clientX,r=o.clientY,c=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),l=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),g=i,d=r,w=!1;function m(v){g=v.clientX,d=v.clientY,w||(window.requestAnimationFrame(()=>{p(),w=!1}),w=!0)}function p(){let v=c+(g-i),f=l+(d-r);v>360&&(e.style.width=v+"px"),f>300&&(e.style.height=f+"px")}function F(){document.removeEventListener("mousemove",m),document.removeEventListener("mouseup",F),setTimeout(()=>{e.style.transition=n},50)}document.addEventListener("mousemove",m),document.addEventListener("mouseup",F)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function na(e){if(!e||e==="N/A"||e==="undefined")return"Data indispon\xEDvel";if(String(e).includes(" | "))return e.split(" | ").map(t=>na(t.trim())).filter(t=>t!=="Data indispon\xEDvel").join(" | ");try{let t=new Date(e);if(isNaN(t.getTime()))return"Data indispon\xEDvel";let a=t.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),o=t.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`${a} \xE0s ${o}`}catch{return"Data indispon\xEDvel"}}function Go(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,a=>t[a]?t[a]:"")}function jo(){let e=document.createElement("div");return e.className="cw-dialog-overlay",Object.assign(e.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:Me.TOP,opacity:0,transition:"opacity 0.3s ease"}),e}function Ho(){let e=document.createElement("div");return Object.assign(e.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s var(--cw-ease-spring)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),e}function Ie(e,t={}){return new Promise(a=>{let o=jo(),n=Ho(),i=t.danger?"#FF3B30":"#007AFF",r=pe()==="es"?"Eliminar":"Excluir",c=t.confirmText||(t.danger?r:"Confirmar");n.innerHTML=`
        ...
        `,o.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{o.style.opacity=1,n.style.transform="scale(1)"});let l=w=>{o.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{o.remove(),a(w)},300)},g=n.querySelector("#cw-conf-cancel"),d=n.querySelector("#cw-conf-ok");[g,d].forEach(w=>w.onmouseenter=()=>y.playHover()),g.onclick=()=>{y.playClick(),l(!1)},d.onclick=()=>{y.playClick(),l(!0)}})}function ia(e,t=""){return new Promise(a=>{let o=jo(),n=Ho();n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let w=l.querySelector(".cw-hero-grid"),m=l.querySelector(".cw-acc-container"),p=l.querySelector(".cw-results-container"),F=l.querySelector(".cw-search-input");ta(l,".cw-acc-header, .cw-task-item");let v=l.querySelector(".cw-status-bar"),f=l.querySelector(".cw-status-text"),O=l.querySelector(".cw-footer-icons");function T(N,A){return _=>{if(_.target.closest(".cw-step-btn-hero, .cw-step-btn-list"))return;let L=o[N]?o[N].count:0;x(N,L>0?-L:1,A)}}i.forEach(([N,A])=>{let _=n(A.name),L=document.createElement("div");L.className="cw-hero-card",L.id=`hero-${N}`,L.style.setProperty("--hero-color",_.color),L.innerHTML=`
        ...
        `,L.onclick=T(N,A),L.querySelector(".minus").onclick=()=>x(N,-1,A),L.querySelector(".plus").onclick=()=>x(N,1,A),L.tabIndex=0,L.setAttribute("role","button"),L.setAttribute("aria-pressed","false"),L.addEventListener("keydown",D=>{(D.key==="Enter"||D.key===" ")&&(D.preventDefault(),L.click())}),L.dataset.color=_.color,w.appendChild(L)});function B(N,A){let _=n(A.name),L=document.createElement("div");return L.className="cw-task-item",L.dataset.id=N,L.innerHTML=`
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(i),mn(),Se(()=>{let x=i.querySelector(".js-cc-quicksearch");x&&(x.title=Ct("quickSearch"));let q=i.querySelector(".js-cc-casestoday");q&&(q.title=Ct("casesToday"));let z=i.querySelector(".js-cc-drag");z&&(z.title=Ct("drag"))});let c=x=>{y.playClick(),x()};if(i.querySelector(".notes").onclick=x=>{x.stopPropagation(),c(e.toggleNotes)},i.querySelector(".bauform").onclick=x=>{x.stopPropagation(),c(e.toggleBAUForm)},i.querySelector(".email").onclick=x=>{x.stopPropagation(),c(e.toggleEmail)},i.querySelector(".script").onclick=x=>{x.stopPropagation(),c(e.toggleScript)},i.querySelector(".links").onclick=x=>{x.stopPropagation(),c(e.toggleLinks)},i.querySelector(".library").onclick=x=>{x.stopPropagation(),c(e.toggleLibrary)},i.querySelector(".timezone").onclick=x=>{x.stopPropagation(),c(e.toggleTimezone)},i.querySelector(".configs").onclick=x=>{x.stopPropagation(),c(e.toggleConfigs)},i.querySelector(".broadcast").onclick=x=>{x.stopPropagation(),c(()=>{let q=x.currentTarget.querySelector(".cw-badge");q&&q.remove(),e.broadcastControl&&e.broadcastControl.toggle()})},i.querySelectorAll(".cw-btn").forEach(x=>{x.addEventListener("mouseenter",()=>y.playHover())}),e.broadcastControl&&e.broadcastControl.hasUnread){let x=document.createElement("div");x.className="cw-badge",i.querySelector(".broadcast").appendChild(x)}let l=()=>window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function g(){if(l()){i.classList.remove("collapsed"),y.playGenieOpen();return}let x=i.getBoundingClientRect(),q=window.innerHeight,z=x.top>q/2,N=x.height;i.style.setProperty("transition","none","important"),i.classList.remove("collapsed");let A=i.scrollHeight;if(i.classList.add("collapsed"),i.style.height=`${N}px`,z){let _=q-x.bottom;i.style.top="auto",i.style.bottom=`${_}px`}else i.style.bottom="auto",i.style.top=`${x.top}px`;i.style.overflow="hidden",i.offsetWidth,i.style.removeProperty("transition"),i.classList.remove("collapsed"),i.style.height=`${A}px`,y.playGenieOpen(),setTimeout(()=>{i.style.height="",i.style.overflow=""},350)}function d(x=!0){if(i.classList.contains("collapsed"))return;if(l()){i.classList.add("collapsed"),x&&y.playSwoosh();return}let q=i.getBoundingClientRect().height;i.style.setProperty("transition","none","important"),i.style.height=`${q}px`,i.offsetWidth,i.style.removeProperty("transition"),i.classList.add("collapsed"),i.style.height=`${Ha}px`,x&&y.playSwoosh(),setTimeout(()=>{i.style.height=""},700)}Ua=d;let w=null;i.onmouseleave=()=>{document.querySelector(".cw-processing-card")||(w=setTimeout(()=>{i.querySelector(".cw-btn.active")||d()},3e3))},i.onmouseenter=()=>{w&&clearTimeout(w)},(async function(){let q=()=>{let z=ke();if(z){let N=z.split("@")[0].toLowerCase();if(ua.includes(N)){let A=i.querySelector("#cw-admin-tag");A&&A.classList.add("visible")}}else setTimeout(q,2e3)};if(q(),t&&typeof t.then=="function"){try{await t}catch{}await ge(150)}else await ge(2800);i.classList.add("arriving"),y.playReady(),i.querySelectorAll(".cw-sep").forEach(z=>z.classList.add("visible"))})();let m=!1,p,F,v,f,O=3;i.onmousedown=x=>{if(x.target.closest("button"))return;x.preventDefault(),p=x.clientX,F=x.clientY;let q=i.getBoundingClientRect();v=q.left,f=q.top,document.addEventListener("mousemove",T),document.addEventListener("mouseup",B)};function T(x){let q=x.clientX-p,z=x.clientY-F;!m&&Math.sqrt(q*q+z*z)>O&&(m=!0,i.classList.add("dragging"),i.style.transition="none",w&&clearTimeout(w)),m&&(i.style.left=`${v+q}px`,i.style.top=`${f+z}px`,i.style.right="auto",i.style.bottom="auto",i.style.transform="none")}function B(x){if(document.removeEventListener("mousemove",T),document.removeEventListener("mouseup",B),m){m=!1,i.classList.remove("dragging");let q=window.innerWidth,z=window.innerHeight,N=i.getBoundingClientRect(),A=N.left+N.width/2,_;A<q/2?(_=24,i.classList.remove("side-right"),i.classList.add("side-left")):(_=q-N.width-24,i.classList.remove("side-left"),i.classList.add("side-right"));let L=wt(N.top,24,z-N.height-24);setTimeout(()=>{i.style.setProperty("transition","left 0.3s cubic-bezier(0.4, 0, 0.2, 1), top 0.3s cubic-bezier(0.4, 0, 0.2, 1)","important"),i.style.left=`${_}px`,i.style.top=`${L}px`,i.style.bottom="auto",i.style.transform=""},10),setTimeout(()=>{i.style.transition="",i.style.removeProperty("transition")},700)}else{let q=i.querySelector(".cw-btn.active"),z=x.target.closest("button");i.classList.contains("collapsed")?g():!q&&!z&&d(),z&&(z.style.transform="scale(0.9)",setTimeout(()=>z.style.transform="",150))}}}function Xt(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");window._CW_ABORT_PROCESS=!1;let a=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;e&&Ua?Ua(!1):e&&e.classList.add("collapsed"),e&&e.classList.add("cw-busy");let o=document.createElement("div");o.className="cw-processing-card",o.innerHTML=`
...
`))}else le.value.trim()===de.trim()&&(le.value="");Y.updateField(ie,le.value),le.dispatchEvent(new Event("input"))}}}}function ae(b,M){let W=document.createElement("div");if(W.className="cw-actions-section",W.style.cssText=`
    ...
    `,document.head.appendChild(e)}function Er(e,t){return e.map(a=>Pn(a,pe())).filter(a=>a.name.toLowerCase().includes(t.toLowerCase())||a.category.toLowerCase().includes(t.toLowerCase()))}function Cr(e){return Object.entries(It).filter(([t,a])=>a&&(t.toLowerCase().includes(e.toLowerCase())||a.toLowerCase().includes(e.toLowerCase()))).map(([t,a])=>({id:t,name:t.replace(/_/g," "),category:"\u26A1 Smart CRs",code:a,isSmartCR:!0}))}function Ar(e){return Re.getSnippets("email").filter(t=>t.title.toLowerCase().includes(e.toLowerCase())||t.subject&&t.subject.toLowerCase().includes(e.toLowerCase())).map(t=>{let a=[],o=t.content.match(/\[([^\]]+)\]/g);return o&&[...new Set(o)].forEach(n=>{a.push({key:n,label:n.replace("[","").replace("]",""),type:n.toLowerCase().includes("data")?"date":"text",auto:n.toLowerCase().includes("nome")&&n.toLowerCase().includes("seu")?"agentName":null})}),{id:t.id||`snippet-${Math.random()}`,name:t.title,category:"\u{1F464} Pessoal",subject:t.subject||Xe("noSubject"),template:t.content,placeholders:a}})}function kr(e,t){return[...Er(e,t),...Cr(t),...Ar(t)]}function Vn(){let e="v6.0.0",t=!1,a=[],o=null,n="",i=new Set;Sr();let r=document.createElement("div");r.id="email-assistant-popup",r.classList.add("cw-module-window","cw-email-popup"),Object.assign(r.style,Ge,{width:"850px",height:"650px"}),r.style.display="none",r.style.flexDirection="column";let c=De(r,Xe("headerTitle"),e,Xe("headerDesc"),{popup:r},()=>L()),l=document.createElement("div");l.className="cw-email-main";let g=document.createElement("div");g.className="cw-email-left-panel";let d=document.createElement("div");d.className="cw-email-search-container";let w=document.createElement("input");w.className="cw-email-search-input",w.placeholder=Xe("searchPlaceholder");let m=document.createElement("div");m.id="email-template-list",ta(m,".cw-email-cat-header, .cw-email-list-item");let p=document.createElement("div");p.className="cw-email-clear-btn",p.innerHTML="\u2715",p.onclick=()=>{w.value="",n="",p.style.display="none",Z(),w.focus()},d.appendChild(w),d.appendChild(p),g.appendChild(d),g.appendChild(m);let F=document.createElement("div");F.className="cw-email-right-panel";let v=document.createElement("div");v.className="cw-email-fields-section";let f=document.createElement("div");f.className="cw-email-preview-section";let O=document.createElement("div");O.className="cw-email-preview-header";let T=document.createElement("span");T.textContent=Xe("previewTitle"),T.className="cw-email-preview-title";let B=document.createElement("div");B.className="cw-email-preview-actions";let x=(G,ae=!1)=>{let Q=document.createElement("button");return Q.textContent=G,Q.className="cw-email-btn"+(ae?" primary":""),Q},q=x("Copiar HTML"),z=x("Preencher no CRM",!0),N=x("Smart CR");N.classList.add("warning"),B.appendChild(N),B.appendChild(q),B.appendChild(z),O.appendChild(T),O.appendChild(B);let A=document.createElement("div");A.contentEditable="true",A.className="cw-email-preview-content",f.appendChild(O),f.appendChild(A),J(),F.appendChild(v),F.appendChild(f),l.appendChild(g),l.appendChild(F),r.appendChild(c),r.appendChild(l);let _=document.createElement("div");Object.assign(_.style,it),r.appendChild(_),rt(r,_),document.body.appendChild(r);function L(){t=!He(r),t?(Te(),r.style.display="flex",Po(r),a.length===0&&D()):(qe(),r.style.display="none"),Oe(t,r,"cw-btn-email")}async function D(){m.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',a=await jn.getTemplates(),Z()}function U(G,ae,Q){let oe=document.createElement("div");oe.className="cw-email-cat-header",oe.tabIndex=0,oe.setAttribute("role","button"),oe.setAttribute("aria-expanded",String(Q));let re=document.createElement("span");re.textContent=G,oe.appendChild(re);let C=document.createElement("span");C.className="cw-email-cat-badge",C.textContent=ae;let H=document.createElement("span");H.className="cw-email-cat-arrow",H.textContent=Q?"\u25BE":"\u25B8";let s=document.createElement("div");return s.className="cw-email-cat-right",s.appendChild(C),s.appendChild(H),oe.appendChild(s),oe.onclick=()=>{i.has(G)?i.delete(G):i.add(G),Z()},oe.addEventListener("keydown",u=>{(u.key==="Enter"||u.key===" ")&&(u.preventDefault(),oe.click())}),oe}function R(G){let ae=o&&o.id===G.id,Q=document.createElement("div");if(Q.className="cw-email-list-item"+(ae?" selected":""),Q.tabIndex=0,Q.setAttribute("role","button"),Q.setAttribute("aria-pressed",String(!!ae)),ae){let C=document.createElement("div");C.className="cw-email-list-indicator",Q.appendChild(C)}let oe=document.createElement("span");oe.className="cw-email-list-icon",oe.innerHTML=G.isSmartCR?"\u26A1":G.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",Q.appendChild(oe);let re=document.createElement("span");return re.className="cw-email-list-text",re.textContent=G.name,Q.appendChild(re),Q.onclick=()=>X(G),Q.addEventListener("keydown",C=>{(C.key==="Enter"||C.key===" ")&&(C.preventDefault(),Q.click())}),Q}function Z(){m.innerHTML="";let G=kr(a,n);if(G.length===0){m.innerHTML=`
                ...
                </div>`;return}[...new Set(G.map(Q=>Q.category))].sort((Q,oe)=>Q.localeCompare(oe)).forEach(Q=>{let oe=i.has(Q)||n.length>0,re=G.filter(C=>C.category===Q);m.appendChild(U(Q,re.length,oe)),oe&&re.forEach(C=>{m.appendChild(R(C))})})}let ce=null;async function X(G){o?.id!==G.id&&(o=G,ce&&clearTimeout(ce),F.style.opacity="0",F.style.transform="translateY(5px)",ce=setTimeout(()=>{N.style.display=G.isSmartCR?"block":"none",z.style.display=G.isSmartCR?"none":"block",q.style.display=G.isSmartCR?"none":"block",Z(),P(),J(),F.style.opacity="1",F.style.transform="translateY(0)",ce=null},150))}function P(){if(v.innerHTML="",!o||o.isSmartCR){o?.isSmartCR?(v.style.display="block",v.innerHTML=`<div class="cw-email-smartcr-hint">
                ...
                </div>`):v.style.display="none";return}let G=o.placeholders&&o.placeholders.length>0;if(v.style.display=G?"block":"none",!G)return;let ae=document.createElement("div");ae.className="cw-email-fields-grid",(o.placeholders||[]).forEach(Q=>{let oe=document.createElement("div"),re=document.createElement("label");re.className="cw-email-field-label",re.textContent=Q.label;let C=document.createElement("input");C.className="cw-email-field-input",C.type=Q.type||"text",C.dataset.key=Q.key,Q.auto==="agentName"&&(C.value=Pt().split(" ")[0]),C.addEventListener("input",J),oe.appendChild(re),oe.appendChild(C),ae.appendChild(oe)}),v.appendChild(ae)}function J(){if(!o){A.innerHTML=`
...
CID: ${e.cid||"---"}
Case ID: ${e.caseId||"---"}
E-mail: ${e.clientEmail||"---"}`,dateLocale:"es-ES"}};function Jn(){return pe()==="es"?"ES":"PT"}function xe(e){let t=pe();return Kn[t]?.[e]??Kn.pt[e]}var be={bgApp:"#F5F5F7",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.07)",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",textPrimary:"#1D1D1F",textSecondary:"#6E6E73",danger:"#D93025",dangerBg:"#FCE8E6",success:"#34A853",successBg:"#E6F4EA"},qr={inicio:{PT:"Abertura",ES:"Apertura"},meio:{PT:"Implementa\xE7\xE3o (Tag Support)",ES:"Implementaci\xF3n"},fim:{PT:"Fechamento",ES:"Cierre"}};function Lr(){if(document.getElementById("csa-styles-v2"))return;let e=document.createElement("style");e.id="csa-styles-v2",e.textContent=`
    ...
    `,document.head.appendChild(e)}function Zn(){let e="v3.1.0";Lr();let t={},a=Jn(),o="BAU",n=!1,i=document.createElement("div");i.id="call-script-popup",i.classList.add("cw-module-window"),Object.assign(i.style,Ge,{right:"auto",left:"50%",width:"420px",height:"700px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:i,googleLine:null},c=null;function l(){n&&Je().then(C=>{let H=i.querySelector("#cw-ctx-name"),s=i.querySelector("#cw-ctx-cid"),u=i.querySelector("#cw-ctx-email");if(H&&(H.textContent=C.advertiserName||xe("unknownClient")),s){let E=C.cid||"---";s.textContent!==E&&(s.textContent=E)}if(u){let E=C.clientEmail||xe("notFound");u.textContent!==E&&(u.textContent=E,u.title=E)}})}function g(){Je().then(C=>{let H=new Date().toLocaleDateString(xe("dateLocale")),s=i.querySelector("#cw-am-message-area"),u=i.querySelector("#cw-am-review-container"),E=xe("amMessage")(C,H);s&&(s.value=E),u&&(u.classList.add("visible"),u.scrollIntoView({behavior:"smooth",block:"end"}))})}function d(){n=!He(i),Oe(n,i,"cw-btn-script"),n?(Te(),l(),c||(c=setInterval(l,2e3))):(qe(),c&&(clearInterval(c),c=null))}let w=De(i,xe("headerTitle"),e,xe("headerDesc"),r,()=>{d()});i.appendChild(w);let m=w.querySelector("span"),p=document.createElement("div");p.className="csa-context-banner",p.innerHTML=`
...
`),o=/\d{1,2}\/\d{1,2}/,n="\u{1F4C5}";if(a.forEach(i=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(i)?n="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(i)&&(n="\u{1F1EA}\u{1F1F8}");let r=i.match(o);if(r){let c=r[0],l=n;/🇧🇷|🇵🇹|PT|BR/i.test(i)?l="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(i)&&(l="\u{1F1EA}\u{1F1F8}"),t.some(d=>d.flag===l&&d.date===c)||t.push({flag:l,date:c})}}),t.length===0){let i=(e||"").match(/\d{1,2}\/\d{1,2}/g);i&&[...new Set(i)].forEach(r=>t.push({flag:"\u{1F4C5}",date:r}))}return t}function ri(){let e="v4.9",t=!1,a=null,o=null,n="",i=!1,r=!1,c=null,l=0,g=null;Or();let d=document.createElement("div");d.id="broadcast-popup",d.classList.add("cw-module-window"),Object.assign(d.style,Ge,{right:"auto",left:"50%",width:"420px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",backgroundColor:"#FAFAFA",overflow:"hidden"});let w={popup:d,googleLine:null};function m(){if(t=!He(d),Oe(t,d,"cw-btn-broadcast"),t){Te();let C=document.getElementById("cw-btn-broadcast");C&&C.classList.remove("has-new"),R()}else qe()}let p=De(d,ne("headerTitle"),e,ne("headerDesc"),w,()=>m()),F=p.querySelector("span"),v=p.querySelector(".cw-header-actions")||p.lastElementChild,f=null;function O(){let C=null;try{C=ke()}catch{console.warn("TechSol: Auth Pending")}if(C){if(c=C.split("@")[0].toLowerCase(),r=ua.includes(c),r&&v&&!v.querySelector("#cw-admin-btn")){let H=document.createElement("div");H.id="cw-admin-btn",H.className="cw-btn-interactive",H.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',Object.assign(H.style,{width:"32px",height:"32px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#1a73e8",background:"rgba(26, 115, 232, 0.1)",marginRight:"8px"}),H.title=ne("newNotice"),H.onclick=s=>{s.stopPropagation(),A()},v.insertBefore(H,v.firstChild),f||N(),J()}}else l<5&&(l++,setTimeout(O,2e3))}if(v){let C=document.createElement("button");C.textContent=ne("clear"),C.className="cw-btn-interactive",Object.assign(C.style,{fontSize:"12px",color:"#1a73e8",background:"transparent",border:"none",padding:"8px",fontWeight:"600"}),C.onclick=H=>{H.stopPropagation(),y.playSuccess();let s=ht.map(u=>u.id);localStorage.setItem("cw_read_broadcasts",JSON.stringify(s)),J(),Z()},v.insertBefore(C,v.firstChild)}d.appendChild(p);let T=document.createElement("div");T.className="cw-bc-search-wrap";let B=document.createElement("div");B.className="cw-bc-search-icon",B.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let x=document.createElement("input");x.className="cw-bc-search-input no-drag",x.type="text",x.placeholder=ne("searchPlaceholder");let q=document.createElement("div");q.className="cw-bc-search-clear cw-btn-interactive",q.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',T.append(B,x,q),d.appendChild(T),x.addEventListener("input",C=>{n=C.target.value,q.classList.toggle("visible",n.length>0),J()}),q.onclick=()=>{x.value="",n="",q.classList.remove("visible"),J(),x.focus()};let z=document.createElement("div");z.id="cw-update-status",z.style.cssText="padding: 8px; text-align: center; font-size: 11px; color: #5f6368; background: #FAFAFA; border-bottom: 1px solid transparent; font-weight:500; display:none;",d.appendChild(z);function N(){f=document.createElement("div"),f.className="cw-editor-overlay",f.innerHTML=`
    ...
    `,document.head.appendChild(e)}function yi(){Gr();let e="v2.2 Pro",t=!1,a=null,o="mx",n=JSON.parse(localStorage.getItem(fi)||"[]"),i="",r="all",c=new Date;c.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},g={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,Ge,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let w={popup:d},m=De(d,"Time Zone Traveler",e,Ee("headerDesc"),w,()=>X());d.appendChild(m);let p=document.createElement("div");Object.assign(p.style,g.container),d.appendChild(p);let F=document.createElement("div");Object.assign(F.style,g.tabHeader);let v=document.createElement("div");v.textContent=Ee("tabLive"),v.className="tz-tab-btn",v.tabIndex=0,v.setAttribute("role","tab"),Object.assign(v.style,g.tabBtn,g.tabActive);let f=document.createElement("div");f.textContent=Ee("tabPlan"),f.className="tz-tab-btn",f.tabIndex=0,f.setAttribute("role","tab"),Object.assign(f.style,g.tabBtn),[v,f].forEach(P=>{P.addEventListener("keydown",J=>{(J.key==="Enter"||J.key===" ")&&(J.preventDefault(),P.click())})}),F.appendChild(v),F.appendChild(f),p.appendChild(F);let O=document.createElement("div");Object.assign(O.style,g.toolbar);let T=document.createElement("div");Object.assign(T.style,g.searchInputWrapper);let B=document.createElement("div");B.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(B.style,g.searchIcon);let x=document.createElement("input");x.placeholder=Ee("searchPlaceholder"),Object.assign(x.style,g.searchInput),x.onfocus=()=>{x.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",x.style.borderColor="rgba(26,115,232,0.3)"},x.onblur=()=>{x.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",x.style.borderColor="transparent"},x.oninput=P=>{i=P.target.value.toLowerCase(),U()},T.appendChild(B),T.appendChild(x),O.appendChild(T);let q=document.createElement("div");Object.assign(q.style,g.chipsRow),xi.forEach(P=>{let J=document.createElement("div");J.textContent=Ee("filters")[P.id],J.id=`tz-filter-${P.id}`,J.className="tz-chip",J.tabIndex=0,J.setAttribute("role","button"),Object.assign(J.style,g.chip),P.id===r&&Object.assign(J.style,g.chipActive),J.onclick=()=>{y.playClick(),r=P.id,Array.from(q.children).forEach(G=>{Object.assign(G.style,g.chip)}),Object.assign(J.style,g.chipActive),U()},J.addEventListener("keydown",G=>{(G.key==="Enter"||G.key===" ")&&(G.preventDefault(),J.click())}),q.appendChild(J)}),O.appendChild(q),p.appendChild(O);let z=document.createElement("div");Object.assign(z.style,g.listContainer);let N=document.createElement("style");N.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",p.appendChild(N);let A=document.createElement("div");Object.assign(A.style,g.plannerWrapper,{display:"none"}),p.appendChild(z),p.appendChild(A),v.onclick=()=>_("live"),f.onclick=()=>_("plan");function _(P){y.playClick(),P==="live"?(Object.assign(v.style,g.tabActive),Object.assign(f.style,g.tabBtn),f.style.borderBottomColor="transparent",v.setAttribute("aria-selected","true"),f.setAttribute("aria-selected","false"),z.style.display="flex",O.style.display="flex",A.style.display="none",Z()):(Object.assign(f.style,g.tabActive),Object.assign(v.style,g.tabBtn),v.style.borderBottomColor="transparent",A.style.display="flex",z.style.display="none",O.style.display="none",ce(),R())}function L(P){return P>=9&&P<17?{color:l.success,bg:l.successBg,label:Ee("statusOpen"),icon:"\u{1F7E2}"}:P>=8&&P<9?{color:l.warning,bg:l.warningBg,label:Ee("statusOpening"),icon:"\u{1F7E1}"}:P>=17&&P<19?{color:l.warning,bg:l.warningBg,label:Ee("statusClosing"),icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:Ee("statusClosed"),icon:"\u{1F534}"}}function D(P){n.includes(P)?n=n.filter(J=>J!==P):n.push(P),localStorage.setItem(fi,JSON.stringify(n)),U(),y.playClick()}function U(){z.innerHTML="";let P=new Date,J=lo.filter(ae=>{let Q=gt(ae).toLowerCase().includes(i)||co(ae).toLowerCase().includes(i),oe=r==="all"||ae.region===r;return Q&&oe});if(J.sort((ae,Q)=>{let oe=n.includes(ae.id),re=n.includes(Q.id);return oe&&!re?-1:!oe&&re?1:gt(ae).localeCompare(gt(Q))}),J.length===0){z.innerHTML=`
            ...
            `;let k=s.querySelector(".cw-pin-btn");k.onclick=S=>{S.stopPropagation(),D(ae.id)},k.addEventListener("keydown",S=>{(S.key==="Enter"||S.key===" ")&&(S.preventDefault(),S.stopPropagation(),D(ae.id))}),s.onclick=()=>{o=ae.id,_("plan")},s.addEventListener("keydown",S=>{(S.key==="Enter"||S.key===" ")&&S.target===s&&(S.preventDefault(),s.click())}),z.appendChild(s)});let G=document.createElement("div");G.style.height="20px",G.style.width="100%",z.appendChild(G)}function R(){A.innerHTML="";let P=document.createElement("div"),J=document.createElement("label");J.textContent=Ee("whereIsClient"),J.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let G=document.createElement("select");Object.assign(G.style,Ro),G.style.padding="14px",[...lo].sort((b,M)=>gt(b).localeCompare(gt(M))).forEach(b=>{let M=document.createElement("option");M.value=b.id,M.textContent=`${b.flag} ${gt(b)} (${b.zone})`,b.id===o&&(M.selected=!0),G.appendChild(M)}),G.onchange=b=>{o=b.target.value,se(),y.playClick()},P.appendChild(J),P.appendChild(G),A.appendChild(P);let Q=document.createElement("div");Object.assign(Q.style,g.timeComparisonRow);let oe=document.createElement("div");Object.assign(oe.style,g.timeCard),oe.style.backgroundColor="#F8FAFF",oe.style.borderColor="#E8F0FE",oe.innerHTML=`
    ...
    `,document.head.appendChild(e)}function Ei(){let e="v2.0",t=!1,a="general",o="",n=null,i=null;Ur();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,Ge,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let c={popup:r},l=De(r,ue("headerTitle"),e,ue("headerDesc"),c,()=>H());r.appendChild(l);let g=l.querySelector("span"),d=document.createElement("div");d.className="cw-lib-container",r.appendChild(d);let w=document.createElement("div");w.className="cw-lib-toolbar";let m=document.createElement("div");m.className="cw-lib-search-wrap";let p=document.createElement("div");p.className="cw-lib-search-icon",p.innerHTML=$e.search;let F=document.createElement("input");F.className="cw-lib-search no-drag",F.placeholder=ue("searchPlaceholder"),F.type="text";let v=document.createElement("div");v.className="cw-lib-search-clear cw-tactile",v.innerHTML=$e.clear,m.append(p,F,v);let f=document.createElement("div");f.className="cw-lib-tabs",po.forEach(s=>{let u=document.createElement("div");u.className="cw-lib-tab"+(s.id===a?" active":""),u.id=`lib-tab-${s.id}`,u.innerHTML=`${s.icon}<span class="js-lib-tab-label">${ue("tabs")[s.id]}</span>`,u.onmouseenter=()=>y.playHover(),u.onclick=()=>R(s.id),f.appendChild(u)}),w.append(m,f),d.appendChild(w);let O=document.createElement("div");O.className="cw-lib-grid",d.appendChild(O);let T=document.createElement("div");T.className="cw-lib-fab cw-tactile",T.title=ue("newItem"),T.innerHTML=$e.add,T.onclick=()=>ae(),d.appendChild(T);let B=document.createElement("div");B.className="cw-lib-sheet";let x=document.createElement("div");x.className="cw-lib-sheet-handle";let q=document.createElement("div");q.className="cw-lib-sheet-head";let z=document.createElement("div");z.className="cw-lib-sheet-back no-drag",z.innerHTML=$e.back,z.title=ue("cancel"),z.onclick=Q;let N=document.createElement("span");N.className="cw-lib-sheet-title",N.textContent=ue("newItemTitle"),q.append(z,N);let A=document.createElement("div");A.className="cw-lib-sheet-body";let _=document.createElement("div");_.className="cw-lib-sheet-foot";let L=document.createElement("button");L.className="cw-lib-save-btn no-drag",L.textContent=ue("save"),L.onclick=oe,_.appendChild(L);let D=document.createElement("div");D.className="cw-lib-loading",D.innerHTML=`<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text js-lib-saving">${ue("saving")}</div>`,B.append(x,q,A,_,D),d.appendChild(B);let U=document.createElement("div");Object.assign(U.style,it),U.className="no-drag",r.appendChild(U),rt(r,U),document.body.appendChild(r),document.addEventListener("mousedown",s=>{i&&!i.contains(s.target)&&Z()});function R(s){y.playClick(),a=s,po.forEach(u=>{document.getElementById(`lib-tab-${u.id}`).classList.toggle("active",u.id===s)}),P()}function Z(){if(i){let s=i.querySelector(".cw-lib-menu");s&&s.classList.remove("open"),i.classList.remove("menu-open"),i=null}}function ce(s,u){return u?`${s.title} ${s.content}`.toLowerCase().includes(u):!0}function X(s){let u=document.createElement("div");u.className="cw-lib-recent-section",u.innerHTML=`<div class="cw-lib-recent-title">${ue("recentlyUsed")}</div>`;let E=document.createElement("div");return E.className="cw-lib-recent-row",s.forEach(k=>{let S=document.createElement("div");S.className="cw-lib-recent-chip",S.tabIndex=0,S.setAttribute("role","button"),S.title=k.title,S.innerHTML=`<span>${C(k.title)}</span>`,S.onclick=()=>{y.playClick(),G(k)},S.addEventListener("keydown",I=>{(I.key==="Enter"||I.key===" ")&&(I.preventDefault(),S.click())}),E.appendChild(S)}),u.appendChild(E),u}function P(){Z(),O.innerHTML="";let s=o.trim().toLowerCase(),u=Re.getSnippets(a).filter(E=>ce(E,s));if(!s){let E=Hr(a);E.length>0&&O.appendChild(X(E))}if(u.length===0){let E=document.createElement("div");E.className="cw-lib-empty";let k=s.length>0;E.innerHTML=`
    ...
    `;let o=a.querySelector(".js-sc-body"),n=a.querySelector(".js-sc-sort-toggle");n.onchange=async m=>{y.playClick(),await Le.setSortedByUsage(m.target.checked),c()};function i(m){let p=Fe[m.payload.subStatus],F=p?p.name:m.payload.subStatus,v=(m.payload.scenarios||[]).length,f=[m.payload.caseType.toUpperCase(),F,v===1?e("scOneScenario"):e("scNScenarios").replace("{n}",v)];return m.alias&&f.push(`"${m.alias}"`),f.join(" \xB7 ")}function r(m,p,F){if(m.textContent="",F){let v=document.createElement("span");v.className="cw-sc-warn",v.textContent=e("scBroken"),m.appendChild(v),m.appendChild(document.createTextNode(" \xB7 "))}m.appendChild(document.createTextNode(i(p)))}function c(){o.innerHTML="",n.checked=Le.isSortedByUsage();let m=Le.isSortedByUsage(),p=m?Le.list():Le.listRaw(),F=!m;if(!p.length){let f=document.createElement("div");f.className="cw-sc-empty",f.textContent=e("scEmpty"),o.appendChild(f)}p.forEach((f,O)=>{let T=An(f),B=document.createElement("div");B.className="cw-sc-item"+(T.length?" broken":""),B.dataset.id=f.id,B.dataset.index=String(O),B.innerHTML=`
        ...
        `,document.head.appendChild(L)}let i=document.createElement("div");i.id="configs-popup",i.classList.add("cw-module-window"),Object.assign(i.style,Ge,{right:"100px",width:"400px",height:"600px",overflow:"hidden",borderRadius:"24px"});let r={popup:i},c=De(i,e("title"),t,e("headerDesc"),r,()=>_());i.appendChild(c);let l=c.querySelector("span"),g=document.createElement("div");g.className="cw-configs-container",i.appendChild(g);let d=document.createElement("div");d.className="cw-profile-card",d.id="cw-user-profile-section",d.style.display="none",g.appendChild(d);let w;function m(L,D){if(w={ldap:L,profile:D},!D){d.innerHTML=`
            ...
            `;return}d.innerHTML=`
        <img src="https://moma-teams-photos.corp.google.com/photos/${L}?sz=600&type=PLUS"
    ...
    `}async function p(){d.style.display="flex",d.innerHTML=`
        ...
        `,(async()=>{try{ke()||await Bt();let L=ke(),D=L?L.split("@")[0]:"user",U=await Tt(D);m(D,U)}catch(L){console.warn("Erro ao renderizar perfil:",L),d.style.display="none"}})()}p();let F=document.createElement("div");if(F.className="cw-configs-section",F.innerHTML=`
    ...
    `,!document.getElementById("cw-lang-toggle-styles")){let L=document.createElement("style");L.id="cw-lang-toggle-styles",L.innerHTML=`
        ...
        `,document.head.appendChild(L)}let v=F.querySelector("#cw-config-lang-toggle");function f(){v.querySelectorAll("button").forEach(L=>{L.classList.toggle("active",L.dataset.lang===pe())})}f(),v.querySelectorAll("button").forEach(L=>{L.onclick=()=>{Ma(L.dataset.lang),y.playClick()}}),g.appendChild(F);let O=Ci(e,o);g.appendChild(O);let T=document.createElement("div");T.className="cw-configs-section",T.innerHTML=`
    ...
    `;let B=T.querySelector("#cw-config-sound-toggle");B.onchange=L=>{y.setMuted(!L.target.checked),L.target.checked&&y.playClick()},g.appendChild(T);let x=document.createElement("div");x.className="cw-configs-section",x.innerHTML=`
    ...
    `,g.appendChild(x);let q=Ot(),z=document.createElement("div");z.className="cw-configs-section",z.innerHTML=`
    ...
    `,z.querySelector(".cw-env-chip").textContent=`${q.isDev?"DEV":"PROD"} \xB7 \u2026${q.fingerprint}`,g.appendChild(z);let N=document.createElement("style");N.innerHTML=`
        .cw-env-chip {
  ...
  `,document.head.appendChild(e)};var vt={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",i18nKey:"description_justificativa",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",i18nKey:"seId_descarte",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",i18nKey:"description_descarte",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var Zr={advName:{label:"Nombre del Anunciante",placeholder:"Nombre del Anunciante"},cid:{label:"CID",placeholder:"000-000-0000",tooltip:"Usa el formato 000-000-0000 o 10 d\xEDgitos",error:"Formato de CID incorrecto"},amName:{label:"Account Manager (AM)",placeholder:"Nombre del AM"},website:{label:"Website",placeholder:"https://www.ejemplo.com"},seId:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID",buttonTitle:"Buscar ID autom\xE1ticamente"},seId_descarte:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID"},reason:{label:"Qu\xE9 debe hacerse en BAU",placeholder:"Describe las acciones esperadas..."},taskType:{label:"Tareas para BAU (Selecciona 1 o m\xE1s)",tooltip:"Selecciona los tipos de implementaci\xF3n t\xE9cnica"},nonImplementationReason:{label:"Motivo de la No Implementaci\xF3n (Justificaci\xF3n BAU)"},description_justificativa:{label:"Justificaci\xF3n / Descripci\xF3n",placeholder:"Describe detalladamente qu\xE9 se necesita hacer..."},availability:{label:"Disponibilidad (m\xEDnimo 1 opci\xF3n)"},availability_1:{label:"Opci\xF3n 1 (Prioridad)"},availability_2:{label:"Opci\xF3n 2 (Opcional)"},availability_3:{label:"Opci\xF3n 3 (Opcional)"},caseId:{label:"Case ID",placeholder:"Case ID"},language:{label:"Idioma",placeholder:"Idioma"},description_descarte:{label:"Descripci\xF3n",placeholder:"Describe el motivo del descarte..."},discardReason:{label:"Motivo del Descarte"}},Qr={"Selecione um motivo...":"Selecciona un motivo...","Tempo da consultoria esgotado":"Tiempo de la consultor\xEDa agotado","Solicita\xE7\xE3o de reagendamento pelo anunciante":"Solicitud de reprogramaci\xF3n por parte del anunciante","Falta de acessos ou backup do site":"Falta de accesos o copia de seguridad del sitio","Anunciante indispon\xEDvel ou n\xE3o preparado":"Anunciante no disponible o no preparado","Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)":"Implementaci\xF3n parcial (no todas las tareas completadas)","Solicita\xE7\xE3o de tarefas (tasks) adicionais":"Solicitud de tareas adicionales","Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)":"Necesidad de nuevos cambios (fase de seguimiento)","Retorno de contato ap\xF3s prazo de 14 dias expirado":"Retorno de contacto despu\xE9s de vencido el plazo de 14 d\xEDas","Caso Filho gerado no atendimento":"Caso Hijo generado en la atenci\xF3n","3\xAA Tentativa de contato sem sucesso":"3.\xBA intento de contacto sin \xE9xito","Apenas o AM presente":"Solo el AM presente","Estouro de tempo para conclus\xE3o":"Tiempo excedido para la conclusi\xF3n","Gera\xE7\xE3o de caso BAU (Reagendamento)":"Generaci\xF3n de caso BAU (Reprogramaci\xF3n)"};function es(e){return e?.i18nKey||e?.id||e?.name}function Ke(e,t){let a=e?.[t];return pe()!=="es"?a:Zr[es(e)]?.[t]??a}function at(e){return pe()!=="es"?e:Qr[e]??e}var Ti={pt:{statusPending:"Aguardando TL",statusApproved:"Aprovado / Criado",statusDiscarded:"Descartado pelo TL",statusCanceled:"Cancelado",statusDefault:"Pendente",timezoneWarningStrong:"Aten\xE7\xE3o:",timezoneWarningText:"Para clientes fora do fuso hor\xE1rio do Brasil, o hor\xE1rio inserido deve corresponder sempre ao hor\xE1rio local do cliente, e n\xE3o ao do agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone n\xE3o encontrado.",headerTitle:"BAU Central",headerDesc:"Dashboard de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Fluxo completo para implementa\xE7\xF5es t\xE9cnicas e suporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Fluxo simplificado para casos que n\xE3o requerem implementa\xE7\xE3o.",back:"Voltar",next:"Pr\xF3ximo",configuringEdit:"Configurando Edi\xE7\xE3o...",loadDashboardError:"Erro ao carregar Dashboard. Verifique sua conex\xE3o.",copiedToClipboard:"Copiado para a \xE1rea de transfer\xEAncia!",noAdditionalContext:"Nenhum contexto adicional fornecido pelo agente.",notCaptured:"N\xE3o capturado",none:"Nenhuma",language:"Idioma",editPageWarning:"Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",onCorrectPage:"Estou na p\xE1gina correta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso criado, mas n\xE3o conseguimos confirmar por email.",unknownError:"Erro desconhecido",newBauCase:"Novo Caso BAU",backToDashboard:"Voltar ao Dashboard",confirmDataBeforeSending:"Confirme os dados antes de enviar",submitToTl:"Enviar para o TL",saveChanges:"Salvar Altera\xE7\xF5es",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Preencha os detalhes abaixo",caseSentSuccess:"Caso enviado com sucesso!",caseSentSuccessSub:"Sua solicita\xE7\xE3o foi recebida e ser\xE1 processada em breve.",genericErrorTitle:"Ops! Algo deu errado",genericErrorSub:"N\xE3o conseguimos carregar seus casos BAU no momento.",tryAgain:"Tentar Novamente",notInformed:"N\xE3o informado",reasonTooltip:"O que deve ser feito em BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Aguardando TL",caseDetailsTitle:"Detalhes do Caso",copy:"Copiar",advertiser:"Anunciante",status:"Status",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email do Anunciante",site:"Site",timezone:"Timezone",responsibleAm:"AM Respons\xE1vel",salesProgram:"Programa de Vendas",bauReason:"Motivo BAU",requestedTasks:"Tasks solicitadas",justification:"Justificativa",detailedDescription:"Descri\xE7\xE3o detalhada",availability:"Disponibilidade",urgent:"Urgente",undefinedName:"Nome indefinido",customerIdTooltip:"Customer ID do Anunciante",cidTooltip:"CID do Anunciante (Formato: 000-000-0000)",incompleteData:"Dados Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contate o Suporte",editRequest:"Editar Solicita\xE7\xE3o",edit:"Editar",refresh:"Atualizar",noRecentCases:"Nenhum caso recente",casesWillAppear:"Seus casos BAU aparecer\xE3o aqui",createdApproved:"Criados / Aprovados",refreshDashboard:"Atualizar Dashboard",errorPrefix:e=>`Erro: ${e}`,selectAtLeastOne:e=>`Erro: Selecione pelo menos uma op\xE7\xE3o para "${e}".`,fieldRequiredDouble:e=>`Erro: O campo "${e}" \xE9 obrigat\xF3rio.`,fieldRequiredSingle:e=>`Erro: O campo '${e}' \xE9 obrigat\xF3rio.`,whatMustBeDone:"O que deve ser feito",editTasksHint:"Para editar as tasks, volte ao Passo 2",bauJustification:"Justificativa BAU",description:"Descri\xE7\xE3o",availabilityPriority:"Disponibilidade (Prioridade)",editingCaseHash:e=>`Voc\xEA est\xE1 editando o caso #${e}`,editingDiscardHash:e=>`Voc\xEA est\xE1 editando o descarte do caso #${e}`,discardReason:"Motivo do Descarte",discardDescription:"Descri\xE7\xE3o do Descarte",notInformedPlaceholder:"N\xE3o informado",caseUpdatedSuccess:"Caso atualizado com sucesso!",caseDiscardSentSuccess:"Caso enviado para descarte com sucesso!"},es:{statusPending:"Esperando al TL",statusApproved:"Aprobado / Creado",statusDiscarded:"Descartado por el TL",statusCanceled:"Cancelado",statusDefault:"Pendiente",timezoneWarningStrong:"Atenci\xF3n:",timezoneWarningText:"Para clientes fuera del huso horario de Brasil, el horario ingresado siempre debe corresponder al horario local del cliente, no al del agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone no encontrado.",headerTitle:"BAU Central",headerDesc:"Panel de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Flujo completo para implementaciones t\xE9cnicas y soporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Flujo simplificado para casos que no requieren implementaci\xF3n.",back:"Volver",next:"Siguiente",configuringEdit:"Configurando Edici\xF3n...",loadDashboardError:"Error al cargar el Panel. Verifica tu conexi\xF3n.",copiedToClipboard:"\xA1Copiado al portapapeles!",noAdditionalContext:"Ning\xFAn contexto adicional proporcionado por el agente.",notCaptured:"No capturado",none:"Ninguna",language:"Idioma",editPageWarning:"Atenci\xF3n: Para editar la informaci\xF3n, debes tener abierta en el sistema la p\xE1gina de este Caso espec\xEDfico. De lo contrario, los datos capturados estar\xE1n incorrectos.",onCorrectPage:"Estoy en la p\xE1gina correcta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso creado, pero no pudimos confirmar por email.",unknownError:"Error desconocido",newBauCase:"Nuevo Caso BAU",backToDashboard:"Volver al Panel",confirmDataBeforeSending:"Confirma los datos antes de enviar",submitToTl:"Enviar al TL",saveChanges:"Guardar Cambios",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Completa los detalles a continuaci\xF3n",caseSentSuccess:"\xA1Caso enviado con \xE9xito!",caseSentSuccessSub:"Tu solicitud fue recibida y ser\xE1 procesada en breve.",genericErrorTitle:"\xA1Ups! Algo sali\xF3 mal",genericErrorSub:"No pudimos cargar tus casos BAU en este momento.",tryAgain:"Intentar de Nuevo",notInformed:"No informado",reasonTooltip:"Qu\xE9 debe hacerse en BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Esperando al TL",caseDetailsTitle:"Detalles del Caso",copy:"Copiar",advertiser:"Anunciante",status:"Estado",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email del Anunciante",site:"Sitio",timezone:"Timezone",responsibleAm:"AM Responsable",salesProgram:"Programa de Ventas",bauReason:"Motivo BAU",requestedTasks:"Tareas solicitadas",justification:"Justificaci\xF3n",detailedDescription:"Descripci\xF3n detallada",availability:"Disponibilidad",urgent:"Urgente",undefinedName:"Nombre indefinido",customerIdTooltip:"Customer ID del Anunciante",cidTooltip:"CID del Anunciante (Formato: 000-000-0000)",incompleteData:"Datos Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contacta al Soporte",editRequest:"Editar Solicitud",edit:"Editar",refresh:"Actualizar",noRecentCases:"Ning\xFAn caso reciente",casesWillAppear:"Tus casos BAU aparecer\xE1n aqu\xED",createdApproved:"Creados / Aprobados",refreshDashboard:"Actualizar Panel",errorPrefix:e=>`Error: ${e}`,selectAtLeastOne:e=>`Error: Selecciona al menos una opci\xF3n para "${e}".`,fieldRequiredDouble:e=>`Error: El campo "${e}" es obligatorio.`,fieldRequiredSingle:e=>`Error: El campo '${e}' es obligatorio.`,whatMustBeDone:"Qu\xE9 debe hacerse",editTasksHint:"Para editar las tareas, vuelve al Paso 2",bauJustification:"Justificaci\xF3n BAU",description:"Descripci\xF3n",availabilityPriority:"Disponibilidad (Prioridad)",editingCaseHash:e=>`Est\xE1s editando el caso #${e}`,editingDiscardHash:e=>`Est\xE1s editando el descarte del caso #${e}`,discardReason:"Motivo del Descarte",discardDescription:"Descripci\xF3n del Descarte",notInformedPlaceholder:"No informado",caseUpdatedSuccess:"\xA1Caso actualizado con \xE9xito!",caseDiscardSentSuccess:"\xA1Caso enviado a descarte con \xE9xito!"}};function $(e){let t=pe();return Ti[t]?.[e]??Ti.pt[e]}var Ae={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function qi(e){switch(e){case"PENDING_TL_CREATION":return{text:$("statusPending"),class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:$("statusApproved"),class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:$("statusDiscarded"),class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:$("statusCanceled"),class:"status-gray",aura:""};default:return{text:e||$("statusDefault"),class:"status-gray",aura:""}}}function Li(e){let t=document.createElement("div");if(t.className="bau-dynamic-input",t.id=`wrapper-${e.id}`,e.label){let o=document.createElement("label");o.className="bau-label",o.textContent=Ke(e,"label"),e.tooltip&&o.setAttribute("data-tooltip",Ke(e,"tooltip")),t.appendChild(o)}let a;switch(e.type){case"textarea":a=document.createElement("textarea"),a.style.minHeight="80px",t.appendChild(a);break;case"select":a=document.createElement("select"),e.groups?e.groups.forEach(r=>{let c=document.createElement("optgroup");c.label=r.label,r.options.forEach(l=>{let g=document.createElement("option");g.value=l.value,g.textContent=at(l.text),c.appendChild(g)}),a.appendChild(c)}):e.options&&e.options.forEach(r=>{let c=document.createElement("option");c.value=r.value,c.textContent=at(r.text),a.appendChild(c)}),t.appendChild(a);break;case"checkbox-grid":return a=document.createElement("div"),a.className="bau-tasks-grid",e.options.forEach(r=>{let c=document.createElement("label");c.className="bau-task-item",c.innerHTML=`<input type="checkbox" name="${e.name}" value="${r}"><span>${r}</span>`,c.addEventListener("click",l=>{l.preventDefault();let g=c.querySelector("input");g.checked=!g.checked,c.classList.toggle("active",g.checked),y.playClick()}),a.appendChild(c)}),t.appendChild(a),t;case"datetime-group":a=document.createElement("div"),a.className="bau-availability-container",e.fields.forEach(r=>{let c=document.createElement("div");c.className="bau-availability-field",c.innerHTML=`
    ...
    `,O.appendChild(T);let B=s=>{T.classList.toggle("active",s)},x=document.createElement("div");x.className="bau-progress-indicator",O.appendChild(x);let q=document.createElement("form");q.id="bau-escalation-form",q.noValidate=!0,O.appendChild(q),vt.steps.forEach(s=>{let u=document.createElement("div");if(u.className="bau-step"+(s.id===o?" active":""),u.id=`bau-step-${s.id}`,s.isBranching)u.innerHTML=`
            ...
            `,u.querySelector("#bau-opt-full").onclick=()=>{n="BAU",o=1,q.querySelectorAll(".bau-highlight-panel").forEach(E=>E.classList.remove("discard-theme")),P(),y.playClick()},u.querySelector("#bau-opt-discard").onclick=()=>{n="DISCARD",o=5,q.querySelectorAll(".bau-highlight-panel").forEach(E=>E.classList.add("discard-theme")),P(),y.playClick()};else if(s.isConfirmation)u.innerHTML=`
                <div class="bau-card">
    ...
    `,m.appendChild(L),document.body.appendChild(l);function D(s){t=s,l.querySelectorAll(".bau-view").forEach(I=>I.classList.remove("active"));let u=l.querySelector(`#bau-view-${s}`);u&&u.classList.add("active");let E=w.querySelector(".cw-module-header-title")||w.querySelector("h2"),k=w.querySelector(".cw-module-header-subtitle")||w.querySelector("p");E&&(s==="form"?E.textContent=i?$("editingCase")(r):$("newBauCase"):E.textContent=$("headerTitle")),k&&(k.textContent=$(s==="form"?"fillDetailsBelow":"headerDesc"));let S=q.querySelector(".bau-btn-submit");S&&(S.innerHTML=i?`${Ae.send} ${$("saveChanges")}`:`${Ae.send} ${$("submitToTl")}`)}function U(){let s=l.querySelector("#bau-case-list-container"),u=l.querySelector("#bau-dashboard-metrics");u&&(u.innerHTML=`
        ...
        `).join(""))}async function R(){let s=l.querySelector("#bau-case-list-container"),u=l.querySelector("#bau-dashboard-metrics");if(!(!s||!u)){U();try{let E=await Eo();if(!Array.isArray(E))throw new Error("API response is not a valid array");X(E)}catch(E){console.error("Critical Error loading BAU cases:",E),u&&(u.innerHTML=""),s.innerHTML=`
            ...
            `,l.querySelector("#bau-retry-btn")?.addEventListener("click",()=>R()),y.playError(),K($("loadDashboardError"),{error:!0})}}}function Z(s){if(!s)return;let u=qi(s.status),E=(S,I)=>{navigator.clipboard.writeText(S).then(()=>{K($("copiedToClipboard")),y.playClick();let h=I.style.color;I.style.color="#1E8E3E",setTimeout(()=>{I.style.color=h},800)})};p.innerHTML=`
        ...
        `;let h=E.querySelector("#bau-refresh-dashboard");h?.addEventListener("click",async()=>{h.classList.contains("spinning")||(h.classList.add("spinning"),y.playClick(),await R(),setTimeout(()=>h.classList.remove("spinning"),1e3))}),u.innerHTML="";let V=k.slice(0,5),ee=k.slice(5);if(V.forEach(se=>{let b=ce(se),M=document.createElement("div");M.innerHTML=b;let W=M.firstElementChild;W.addEventListener("click",ie=>{ie.target.closest(".bau-case-edit-btn")||Z(se)});let te=W.querySelector(".bau-case-edit-btn");te&&(te.onclick=ie=>{ie.stopPropagation(),re(se)}),u.appendChild(W)}),ee.length>0){let se=document.createElement("li");se.className="bau-accordion-container";let b=document.createElement("button");b.className="bau-accordion-toggle",b.innerHTML=`${Ae.expand} <span>Mostrar ${ee.length} casos mais antigos</span>`;let M=document.createElement("ul");M.className="bau-case-list bau-accordion-content",M.style.display="none",ee.forEach(W=>{let te=ce(W),ie=document.createElement("div");ie.innerHTML=te;let de=ie.firstElementChild;de.addEventListener("click",we=>{we.target.closest(".bau-case-edit-btn")||Z(W)});let le=de.querySelector(".bau-case-edit-btn");le&&(le.onclick=we=>{we.stopPropagation(),re(W)}),M.appendChild(de)}),b.addEventListener("click",()=>{let W=M.style.display==="none";M.style.display=W?"block":"none",b.classList.toggle("expanded",W),b.querySelector("span").textContent=W?"Esconder casos mais antigos":`Mostrar ${ee.length} casos mais antigos`,y.playClick()}),se.appendChild(b),se.appendChild(M),u.appendChild(se)}}function P(){let s=n==="BAU"?[1,2,3,4]:[5,4];q.querySelectorAll(".bau-step").forEach(k=>{let S=parseInt(k.id.replace("bau-step-","")),I=S===o,h=s.includes(S)||S===0;k.classList.toggle("active",I),k.style.display=I?"block":"none",k.querySelectorAll("input, select, textarea").forEach(V=>{V.disabled=!h})});let u=o===0;if(x.style.display=u?"none":"flex",!u){x.innerHTML="";let k=n==="BAU"?[1,2,3,4]:[5,4];k.forEach((S,I)=>{let h=document.createElement("div"),V=S===o,ee=k.indexOf(o),se=I<ee;h.className=`bau-progress-step ${V?"active":se?"completed":""}`,h.textContent=I+1,x.appendChild(h)})}let E=o===4;N.style.display=o>0?"inline-block":"none",A.style.display=!u&&!E?"inline-block":"none",_.style.display=E?"flex":"none",E&&oe()}function J(s){let u=vt.steps.find(E=>E.id===s);if(!u||!u.fields||u.isConfirmation)return!0;for(let E of u.fields){let k=q.querySelector(`#bau-step-${s} #wrapper-${E.id}`);if(!(k&&k.style.display==="none")&&E.validation){let S=q.querySelector(`#bau-step-${s} [name="${E.name}"]`);if(S&&S.offsetParent!==null&&S.value.trim())if(new RegExp(E.validation.regex).test(S.value.trim())){S.classList.remove("invalid-cid");let h=q.querySelector("#bau-cid-error");h&&(h.style.display="none")}else{console.warn(`Validation failed for field "${E.name}" in step ${s}: Regex mismatch.`),y.playError(),K($("errorPrefix")(Ke(E,"error")||E.validation.error),{error:!0}),S.classList.add("invalid-cid");let h=q.querySelector("#bau-cid-error");return h&&(h.style.display="flex"),!1}}}return!0}function G(s){if(!q.querySelector(`#bau-step-${s}`))return!1;let E=vt.steps.find(S=>S.id===s);if(!E||!E.fields||E.isConfirmation)return!0;let k=!0;for(let S of E.fields){let I=q.querySelector(`#bau-step-${s} #wrapper-${S.id}`);if(!(I&&I.style.display==="none")&&S.required){let h=!0,V="";if(S.type==="checkbox-grid")q.querySelector(`#bau-step-${s} input[name="${S.name}"]:checked`)||(V="No option selected in checkbox-grid",y.playError(),K($("selectAtLeastOne")(Ke(S,"label")),{error:!0}),h=!1);else if(S.type==="datetime-group"){let ee=q.querySelector(`#bau-step-${s} input[name="${S.fields[0].name}"]`);if(!ee||ee.offsetParent===null)continue;ee.value.trim()||(V="Datetime group first field is empty",y.playError(),K($("fieldRequiredDouble")(Ke(S.fields[0],"label")),{error:!0}),h=!1)}else{let ee=q.querySelector(`#bau-step-${s} [name="${S.name}"]`);if(!ee||ee.offsetParent===null)continue;ee.value.trim()||(V="Field is empty",y.playError(),K($("fieldRequiredSingle")(Ke(S,"label")),{error:!0}),h=!1)}if(!h){console.warn(`Validation failed for required field "${S.name}" in step ${s}: ${V}`),k=!1;break}}}return k}A.addEventListener("click",()=>{if(J(o)&&G(o)){n==="BAU"?o++:o===5?o=4:o++,P();let s=l.querySelector(".bau-content");s&&(s.scrollTop=0),y.playClick()}}),N.addEventListener("click",()=>{o>0&&(n==="BAU"?o--:o===4?o=5:o===5?o=0:o--,P(),y.playClick())});async function ae(){let s=await Je()||{};(!s.amName||s.amName==="N/A")&&(s.amName=s.internalEmail||"N/A"),a=s,q.querySelectorAll(".bau-vital-highlights").forEach(k=>{let S=[{label:"Anunciante",value:s.advName},{label:"CID",value:s.cid},{label:"Website",value:s.website||s.site},{label:"Case ID",value:s.caseId}];k.innerHTML=S.map(I=>{let h=I.value&&I.value!=="N/A"&&I.value!=="undefined"&&I.value!=="null"?I.value:$("notCaptured");return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${I.label}</span>
                        <span class="bau-highlight-value">${h}</span>
                    </div>
                `}).join("")}),vt.steps.forEach(k=>{k.fields&&k.fields.forEach(S=>{if(S.isSmart){let I=s[S.id];S.id==="language"&&s.userProfile?.defaultLanguage&&(I=s.userProfile.defaultLanguage);let h=q.querySelector(`#bau-step-${k.id} [name="${S.name}"]`),V=q.querySelector(`#bau-step-${k.id} #wrapper-${S.id}`);if(h&&(h.value=I&&I!=="N/A"?I:"",S.id==="language"&&I&&I!=="N/A"&&(h.readOnly=!0,h.style.background="#F1F3F4",h.style.cursor="not-allowed")),V){let ee=I&&I!==""&&I!=="N/A"&&I!=="undefined"&&I!=="null";S.id==="language"?V.style.display="block":V.style.display=ee?"none":"block"}}})}),q.querySelectorAll(".bau-all-data").forEach(k=>{let S=[{label:"Anunciante",value:s.advName},{label:"CID",value:s.cid},{label:"AM",value:s.amName},{label:"SE ID",value:s.seId},{label:"Site",value:s.website||s.site},{label:"Email",value:s.email},{label:"Timezone",value:s.timezone},{label:"Case ID",value:s.caseId},{label:"Programa",value:s.salesProgram},{label:"Idioma",value:s.language}];k.innerHTML=`
    ...
    `,g.appendChild(d),g.onmousedown=T=>{T.target===g&&f()};let w=d.querySelector(".cw-palette-input"),m=d.querySelector(".cw-palette-list");function p(){if(m.innerHTML="",l.length===0){m.innerHTML=`<div class="cw-palette-empty">${ot("empty")}</div>`;return}let T=[],B=null;l.forEach((q,z)=>{if(q.group!==B){B=q.group;let A=document.createElement("div");A.className="cw-palette-group",A.textContent=ot(q.group==="shortcuts"?"groupShortcuts":"groupModules"),A.setAttribute("aria-hidden","true"),m.appendChild(A)}let N=document.createElement("div");N.className="cw-palette-item"+(z===r?" selected":""),N.innerHTML=`
