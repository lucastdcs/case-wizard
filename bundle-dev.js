...
.cw-dropdown-option.selected {
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var At={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Zt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Qt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};async function ta(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await ne(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let r=Math.floor(Math.random()*60)+30;a===0&&(r=150),a>e.length-3&&(r=30),await ne(r)}await ne(600),o&&(o.style.display="none")}async function kt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await ne(200);let e=await Ct(),o=Yt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),r=t.querySelector("#p3"),s=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),r&&(r.textContent=o.suffix),await ne(300);let l=a?a.querySelector("svg"):null;if(l&&(l.style.opacity="1",l.style.transform="scale(1)"),await ne(400),n&&(n.style.opacity="1"),$.playStartup(),i&&await ta(i,o.name),r&&(r.style.opacity="1",r.style.transform="translateY(0)"),o.isFriday&&s){await ne(400),s.style.display="block",s.offsetWidth;let m=s.querySelector(".sextou-badge");m&&(m.style.opacity="1",m.style.transform="scale(1)")}await ne(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await ne(900),t.parentNode&&t.parentNode.removeChild(t)}}function eo(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,r=a-e.height-n,s=parseFloat(t.style.left)||e.left,l=parseFloat(t.style.top)||e.top,m=Be(s,n,i),d=Be(l,n,r);if(m!==s||d!==l){let b=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${m}px`,t.style.top=`${d}px`,setTimeout(()=>{t.style.transition=b},300)}}var qe={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Oe(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,r=a.clientY,s=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),l=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),m=i,d=r,b=!1;function f(x){m=x.clientX,d=x.clientY,b||(window.requestAnimationFrame(()=>{g(),b=!1}),b=!0)}function g(){let x=s+(m-i),k=l+(d-r);x>360&&(t.style.width=x+"px"),k>300&&(t.style.height=k+"px")}function h(){document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",h),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",f),document.addEventListener("mouseup",h)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function it(t){if(!t||t==="N/A"||t==="undefined")return"Data indispon\xEDvel";if(String(t).includes(" | "))return t.split(" | ").map(e=>it(e.trim())).filter(e=>e!=="Data indispon\xEDvel").join(" | ");try{let e=new Date(t);if(isNaN(e.getTime()))return"Data indispon\xEDvel";let o=e.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),a=e.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`${o} \xE0s ${a}`}catch{return"Data indispon\xEDvel"}}function to(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function oo(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function ao(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function ve(t,e={}){return new Promise(o=>{let a=oo(),n=ao(),i=e.danger?"#FF3B30":"#007AFF",r=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let s=d=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(d)},300)},l=n.querySelector("#cw-conf-cancel"),m=n.querySelector("#cw-conf-ok");[l,m].forEach(d=>d.onmouseenter=()=>$.playHover()),l.onclick=()=>{$.playClick(),s(!1)},m.onclick=()=>{$.playClick(),s(!0)}})}function no(t,e=""){return new Promise(o=>{let a=oo(),n=ao();n.innerHTML=`
...
Irei solicitar descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var ro="cw-automation-styles";if(!document.getElementById(ro)){let t=document.createElement("style");t.id=ro,t.innerHTML=`
    ...
    `,document.head.appendChild(t)}function lo(t){let e=document.getElementById("cw-loading-overlay");t?e?e.style.opacity="1":(e=document.createElement("div"),e.id="cw-loading-overlay",document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1")):e&&(e.style.opacity="0",setTimeout(()=>e.remove(),300))}async function ct(t){await St();let e=document.getElementById(t),o="";lo(!0),e&&(o=e.placeholder,e.placeholder="Buscando ID...",e.value="",e.classList.add("cw-scanning-active"));try{let a=document.querySelector('material-button[debug-id="dock-item-case-log"]');a&&!a.classList.contains("selected")&&(Ve(a),await ne(1200));let n=document.querySelector("search-filter dropdown-button .button");if(n&&!(n.innerText||"").includes("All")){Ve(n),await ne(600);let f=document.querySelector('material-checkbox[debug-id="check-all-box"]');f&&f.getAttribute("aria-checked")!=="true"&&(Ve(f),await ne(300));let g=document.querySelector('material-button[debug-id="apply-filter"]');g&&(Ve(g),await ne(1500))}let i=document.querySelector(".scroll-container")||document.querySelector(".case-log-container");i&&(i.scrollTop=i.scrollHeight,await ne(500));let r=Array.from(document.querySelectorAll(".message-header"));for(let b=r.length-1;b>=0;b--){let f=r[b],g=f.querySelector("i.material-icons-extended"),h=g&&g.innerText.trim()==="phone_in_talk",x=f.innerText||"",k=x.includes("Agent joined")||x.includes("outbound-call")||x.includes("Speakeasy");if(h||k){f.getAttribute("aria-expanded")==="true"||(e&&(e.placeholder="Lendo mensagem..."),Ve(f),await ne(1e3));break}}let l=Array.from(document.querySelectorAll(".preview, .speakeasy-agent-activity, .message-body, .content-container")),m=/Speakeasy.*?(P\d{15,25})/i,d=null;for(let b=l.length-1;b>=0;b--){let f=l[b];if(f.offsetParent===null)continue;let g=(f.innerText||"").match(m);if(g&&g[1]){d=g[1];break}}if(e)if(d){try{await navigator.clipboard.writeText(d)}catch{}e.tagName==="INPUT"||e.tagName==="TEXTAREA"?e.value=d:e.textContent=d,e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),$.playSuccess(),Z(`ID Localizado: ${d}`),e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(15, 157, 88, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}else $.playError(),Z("Nenhum ID encontrado.",{error:!0}),e.placeholder="N\xE3o encontrado",e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(234, 67, 53, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}catch(a){console.error("Erro na automa\xE7\xE3o:",a),Z("Erro ao processar.",{error:!0})}finally{e&&(e.classList.remove("cw-scanning-active"),e.value||(e.placeholder=o)),lo(!1)}}function co(t){t.dataset.bulletEnabled!=="true"&&(t.dataset.bulletEnabled="true",(t.value.trim()===""||t.value.trim()==="\u2022")&&(t.value="\u2022 "),t.addEventListener("keydown",function(e){let o=this.selectionStart,a=this.selectionEnd,n=this.value,i=n.lastIndexOf(`
...
`+s;this.value=n.substring(0,o)+l+n.substring(a),this.selectionStart=this.selectionEnd=o+l.length}else if(e.key==="Tab")e.preventDefault(),e.shiftKey?r.startsWith("  ")&&(this.value=n.substring(0,i)+r.substring(2)+n.substring(o),this.selectionStart=this.selectionEnd=o-2):(this.value=n.substring(0,i)+"  "+r+n.substring(o),this.selectionStart=this.selectionEnd=o+2);else if(e.key==="Backspace"&&o===a&&o>0){let s=n.substring(0,o);s.endsWith("\u2022 ")?(e.preventDefault(),this.value=s.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2):s.endsWith("  ")&&r.trim().startsWith("\u2022")&&(e.preventDefault(),this.value=s.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2)}}))}function dt(t,e,o){e.innerHTML="";let a=Le[t];if(!a)return;let n=Ze(a);if(o.activeFields.forEach(s=>{if(["TAGS_IMPLEMENTED","SCREENSHOTS_LIST","CONSENTIU_GRAVACAO","CASO_PORTUGAL","label_substatus"].includes(s))return;let l=`field-${s}`,m=document.createElement("label"),d=h=>Ce[o.currentLang]?.[h]||Ce.pt?.[h]||h;m.textContent=d(s.toLowerCase())!==s.toLowerCase()?d(s.toLowerCase()):s.replace(/_/g," ").replace(/\b\w/g,h=>h.toUpperCase())+":",Object.assign(m.style,{display:"flex",alignItems:"center",justifyContent:"space-between",fontSize:"13px",fontWeight:"700",color:B.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let b=n.includes(s),f=document.createElement("span");if(f.textContent=m.textContent,b){let h=document.createElement("span");h.textContent=" *",h.style.color=B.error,f.appendChild(h)}if(m.innerHTML="",m.appendChild(f),s==="SPEAKEASY_ID"){let h=document.createElement("button");h.innerHTML="\u2728 Auto Busca",h.style.cssText=`font-size: 11px; font-weight: 700; color: ${B.primary}; background-color: ${B.primaryBg}; border: none; border-radius: ${ue.pill}; padding: 6px 14px; margin-left: 10px; cursor: pointer; transition: all 0.2s ${ce};`,h.onmouseenter=()=>h.style.backgroundColor="#d2e3fc",h.onmouseleave=()=>h.style.backgroundColor=B.primaryBg,h.onclick=x=>{x.preventDefault(),ct(l)},m.appendChild(h)}if(!b){let h=document.createElement("button");h.innerHTML="\u2715",h.style.cssText=`font-size: 14px; background: ${B.bgInput}; border: none; color: ${B.textSub}; cursor: pointer; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-left: auto; transition: all 0.2s ${ce};`,h.onmouseenter=()=>{h.style.background=B.error,h.style.color=B.surface},h.onmouseleave=()=>{h.style.background=B.bgInput,h.style.color=B.textSub},h.onclick=async x=>{x.preventDefault(),await ve(`Tem certeza que deseja remover o campo "${f.textContent.replace(":","")}"?`)&&(o.removeField(s),dt(t,e,o))},m.appendChild(h)}let g;We.includes(s)?(g=document.createElement("textarea"),g.classList.add("bullet-textarea","cw-textarea"),g.placeholder="Utilize marcadores para detalhar...",co(g)):rt.includes(s)?(g=document.createElement("textarea"),g.classList.add("cw-textarea"),g.placeholder="Descreva as considera\xE7\xF5es..."):(g=document.createElement("input"),g.type="text",g.classList.add("cw-input")),g.id=l,g.value=o.formData[l]||"",g.addEventListener("input",h=>o.updateField(l,h.target.value)),e.appendChild(m),e.appendChild(g)}),o.activeFields.includes("CONSENTIU_GRAVACAO")){let s=d=>Ce[o.currentLang]?.[d]||Ce.pt?.[d]||d,l=document.createElement("label");l.textContent=s("consentiu_gravacao"),Object.assign(l.style,{display:"block",fontSize:"13px",fontWeight:"700",color:B.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let m=document.createElement("select");m.className="cw-select",m.innerHTML=`
            <option value="false">${s("nao")}</option>
            <option value="true">${s("sim")}</option>
        `,m.value=o.consent?"true":"false",m.onchange=()=>o.setConsent(m.value==="true"),e.appendChild(l),e.appendChild(m)}let i=st(a),r=(a.templateFields||[]).filter(s=>i.includes(s)&&!o.activeFields.includes(s));if(r.length>0){let s=m=>Ce[o.currentLang]?.[m]||Ce.pt?.[m]||m,l=document.createElement("div");Object.assign(l.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginTop:"24px"}),r.forEach(m=>{let d=s(m.toLowerCase())!==m.toLowerCase()?s(m.toLowerCase()):m.replace(/_/g," ").replace(/\b\w/g,f=>f.toUpperCase())+":",b=document.createElement("button");b.type="button",b.textContent=`+ ${d.replace(/:$/,"")}`,b.style.cssText=`font-size: 12px; font-weight: 600; color: ${B.primary}; background-color: ${B.primaryBg}; border: none; border-radius: ${ue.pill}; padding: 6px 14px; cursor: pointer; transition: all 0.2s ${ce};`,b.onmouseenter=()=>b.style.backgroundColor="#d2e3fc",b.onmouseleave=()=>b.style.backgroundColor=B.primaryBg,b.onclick=f=>{f.preventDefault(),o.addFieldAt(m,o.activeFields.length),dt(t,e,o)},l.appendChild(b)}),e.appendChild(l)}}function It(t,e,o,a=null){let n=t.currentSubStatus;if(!n)return null;let i=Le[n],r=Ce[t.currentLang]||Ce.pt,s=d=>r[d]||Ce.pt?.[d]||d,l='style="margin-bottom: 12px; padding-left: 30px;"',m="";if(t.activeFields.forEach(d=>{let b=s(d.toLowerCase()),f="N/A";if(d==="label_substatus")b=s("label_substatus"),f=i.name;else if(d==="TAGS_IMPLEMENTED"){b=s("tags_implemented");let g=[];e.getCheckedElements().forEach(x=>{let k=x.value,O=Ie[k],L=x.count||1,_=k==="ads_conversion_tracking"||k==="ads_enhanced_conversions";t.tagSupportUsed&&_&&!t.forcedScreenshots.has(k)?g.push(`${O.name} - ${s("ts_output_disclaimer")}`):g.push(L>1?`${O.name} (x${L})`:O.name)}),f=g.join(", ")||"N/A"}else if(d==="SCREENSHOTS_LIST"){b=s("screenshots_list");let g="",h=e.screenshotsElement;h&&Array.from(h.querySelectorAll('input[id^="name-"]')).forEach(k=>{let O=k.value,L=k.closest(".cw-screen-card");if(L){let _=L.querySelectorAll('input[id^="screen-"]'),H=!1,J="";_.forEach(oe=>{let F=oe.closest(".cw-input-group")?.querySelector(".cw-input-label")?.textContent||"Evid\xEAncia",z=oe.value.trim();z&&(J+=`<li>${F} - ${z}</li>`,H=!0)}),H&&(g+=`<div style="margin-bottom: 8px;"><b>${O}</b><ul ${l}>${J}</ul></div>`)}}),f=g||"N/A"}else if(d==="CASO_PORTUGAL")b=s("caso_portugal"),f=s("sim");else if(d==="CONSENTIU_GRAVACAO")b=s("consentiu_gravacao"),f=t.consent?s("sim"):s("nao");else{let g=`field-${d}`,h=t.formData[g],x="";if(i.fieldPrefixes&&i.fieldPrefixes[d]&&(x=i.fieldPrefixes[d]+" "),h&&h.trim()!==""&&h.trim()!=="\u2022"){let k=h.trim();if(We.includes(d)){let O=k.split(`
`).map(L=>L.trim()).filter(L=>L!==""&&L!=="\u2022").map(L=>L.startsWith("\u2022 ")?L.substring(2):L).map(L=>`<li>${L}</li>`).join("");f=O?`${x}<ul ${l}>${O}</ul>`:"N/A"}else rt.includes(d)?f=x+k.split(`
`).filter(O=>O.trim()!=="").map(O=>`<p style="margin: 0 0 8px 0;">${O}</p>`).join(""):f=x+k}else x&&(f=x.trim())}m+=`<b>${b}</b><br>${f}<br><br>`}),a){let d="";a.l1&&(d+=`<li>${s("ligacao_1")}: ${a.l1}</li>`),a.l2&&(d+=`<li>${s("ligacao_2")}: ${a.l2}</li>`),a.msg&&(d+=`<li>${s("mensagem_am")}: ${a.msg}</li>`),d&&(m+=`<b>${s("evidencias_contato")}</b><br><ul ${l}>${d}</ul><br>`)}if(i.customFooter&&(m+=`${i.customFooter}<br><br>`),o?.getOutput){let d=o.getOutput();d&&(m+=`${d}<br><br>`)}return m+="<i>Nota criada atrav\xE9s do Cases Wizard.</i>",m.replace(/(<br>\s*){3,}/g,"<br><br>").trim()}function po(t){let e=document.createElement("div");e.className="cw-step-scenarios";let o="Passe o mouse sobre um cen\xE1rio para visualizar o texto...",a=document.createElement("div");Object.assign(a.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let n=document.createElement("div");Object.assign(n.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"44px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s cubic-bezier(0.4, 0, 0.2, 1)",overflow:"hidden"});let i=document.createElement("span");i.style.transition="opacity 0.2s ease, transform 0.2s ease",i.textContent=o,n.appendChild(i);let r=new Set,s=null;return e.render=(l,m)=>{r.clear();let d=Object.entries(lt).filter(([b,f])=>{let g=!f.type||f.type==="all"||f.type===m,h=!1;return l.startsWith("NI_")?h=b.includes("-ni-")||b.includes("attempted"):l.startsWith("SO_")?h=b.includes("gtm")||b.includes("whatsapp")||b.includes("form")||b.includes("ecw4")||b.includes("ga4")||b.includes("-so-"):l.startsWith("AS_")?h=b.includes("-as-"):l.startsWith("IN_")?h=b.includes("-in-"):l.startsWith("DC_")&&(h=b.includes("-dc-")),g&&h});a.innerHTML="",d.forEach(([b,f])=>{let g=document.createElement("div"),h=b.replace("quickfill-","").replace(/-/g," ");g.textContent=h,g.dataset.id=b,Object.assign(g.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)"});let x=f["field-REASON_COMMENTS"]||f["field-CONTEXTO_CALL"]||b;g.onmouseenter=()=>{s&&clearTimeout(s),r.has(b)||(g.style.background="#f1f3f4"),i.style.opacity="0",i.style.transform="translateY(5px)",s=setTimeout(()=>{i.textContent=x.substring(0,120)+(x.length>120?"...":""),i.style.opacity="1",i.style.transform="translateY(0)"},50)},g.onmouseleave=()=>{s&&clearTimeout(s),r.has(b)||(g.style.background="#ffffff"),s=setTimeout(()=>{r.size===0&&(i.style.opacity="0",setTimeout(()=>{i.textContent=o,i.style.opacity="1"},50))},100)},g.onclick=()=>{$.playClick();let k=!r.has(b);k?(r.add(b),g.style.background="#e8f0fe",g.style.borderColor="#1a73e8",g.style.color="#1967d2"):(r.delete(b),g.style.background="#ffffff",g.style.borderColor="#dadce0",g.style.color="#3c4043"),t(b,k)},a.appendChild(g)}),d.length===0?e.style.display="none":e.style.display="block"},e.appendChild(a),e.appendChild(n),e}function la(t){return t==="ads_conversion_tracking"||t==="ads_enhanced_conversions"}function Lt(t,e){return e.tagSupportUsed&&la(t)&&!e.forcedScreenshots.has(t)}var re={bg:B.bgInput,white:B.surface,border:B.border,textMain:B.text,textSub:B.textSub,blue:B.blue,blueLight:B.primaryBg,brands:{ads:{id:"ads",label:"Google Ads",color:B.blue,bg:B.primaryBg,icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:B.yellow,bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:B.primary,bg:B.primaryBg,icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:B.green,bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},He={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function uo(t,e,o){let a={};o&&o.subscribe(()=>{J(),oe()});function n(q){let F=q.toLowerCase();return F.includes("ads")||F.includes("conversion")||F.includes("remarketing")?re.brands.ads:F.includes("ga4")||F.includes("analytics")?re.brands.ga4:F.includes("gtm")||F.includes("tag manager")||F.includes("container")?re.brands.gtm:F.includes("merchant")||F.includes("shopping")||F.includes("feed")?re.brands.gmc:re.brands.default}let i=Object.entries(Ie).filter(([q,F])=>F.popular),r={};Object.entries(Ie).forEach(([q,F])=>{if(F.popular)return;let z=n(F.name);r[z.label]||(r[z.label]={brand:z,tasks:[]}),r[z.label].tasks.push({key:q,...F})});let s="cw-zen-tasks";if(!document.getElementById(s)){let q=document.createElement("style");q.id=s,q.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(q)}let l=document.createElement("div");l.className="cw-zen-container";let m=document.createElement("div");Object.assign(m.style,{display:"none"});let d=document.createElement("div");d.className="cw-screens-container",m.appendChild(d),l.innerHTML=`
    ...
    `;let b=l.querySelector(".cw-hero-grid"),f=l.querySelector(".cw-acc-container"),g=l.querySelector(".cw-results-container"),h=l.querySelector(".cw-search-input"),x=l.querySelector(".cw-status-bar"),k=l.querySelector(".cw-status-text"),O=l.querySelector(".cw-footer-icons");function L(q,F){return z=>{if(z.target.closest(".cw-step-btn-hero, .cw-step-btn-list"))return;let V=a[q]?a[q].count:0;H(q,V>0?-V:1,F)}}i.forEach(([q,F])=>{let z=n(F.name),V=document.createElement("div");V.className="cw-hero-card",V.id=`hero-${q}`,V.style.setProperty("--hero-color",z.color),V.innerHTML=`
        ...
        `,V.onclick=L(q,F),V.querySelector(".minus").onclick=()=>H(q,-1,F),V.querySelector(".plus").onclick=()=>H(q,1,F),V.dataset.color=z.color,b.appendChild(V)});function _(q,F){let z=n(F.name),V=document.createElement("div");return V.className="cw-task-item",V.dataset.id=q,V.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(x,k)=>{$.playClick(),a.querySelector(`.${x}`).classList.toggle("active"),k()};if(a.querySelector(".notes").onclick=x=>{x.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=x=>{x.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=x=>{x.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=x=>{x.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=x=>{x.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=x=>{x.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=x=>{x.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=x=>{x.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=x=>{x.stopPropagation(),i("broadcast",()=>{let k=x.currentTarget.querySelector(".cw-badge");k&&k.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(x=>{x.addEventListener("mouseenter",()=>$.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let x=document.createElement("div");x.className="cw-badge",a.querySelector(".broadcast").appendChild(x)}let r=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(r=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{r&&clearTimeout(r)},(async function(){let k=()=>{let L=fe();if(L){let _=L.split("@")[0].toLowerCase();if(ut.includes(_)){let H=a.querySelector("#cw-admin-tag");H&&H.classList.add("visible")}}else setTimeout(k,2e3)};k(),await ne(2800),a.classList.add("docked"),await ne(300);let O=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(L=>L.classList.add("visible"));for(let L=0;L<O.length;L++)O[L].classList.add("popped"),await ne(40);await ne(100),a.classList.add("system-check"),await ne(100),a.classList.add("system-ready"),setTimeout(()=>a.classList.remove("system-ready"),400)})();let s=!1,l,m,d,b,f=3;a.onmousedown=x=>{if(x.target.closest("button"))return;x.preventDefault(),l=x.clientX,m=x.clientY;let k=a.getBoundingClientRect();d=k.left,b=k.top,document.addEventListener("mousemove",g),document.addEventListener("mouseup",h)};function g(x){let k=x.clientX-l,O=x.clientY-m;!s&&Math.sqrt(k*k+O*O)>f&&(s=!0,a.classList.add("dragging"),a.style.transition="none",r&&clearTimeout(r)),s&&(a.style.left=`${d+k}px`,a.style.top=`${b+O}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function h(x){if(document.removeEventListener("mousemove",g),document.removeEventListener("mouseup",h),s){s=!1,a.classList.remove("dragging");let k=window.innerWidth,O=window.innerHeight,L=a.getBoundingClientRect(),_=L.left+L.width/2,H;_<k/2?(H=24,a.classList.remove("side-right"),a.classList.add("side-left")):(H=k-L.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let J=Be(L.top,24,O-L.height-24);setTimeout(()=>{a.style.setProperty("transition","left 0.3s cubic-bezier(0.4, 0, 0.2, 1), top 0.3s cubic-bezier(0.4, 0, 0.2, 1)","important"),a.style.left=`${H}px`,a.style.top=`${J}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let k=a.querySelector(".cw-btn.active"),O=x.target.closest("button");if(a.classList.contains("collapsed")){let L=a.getBoundingClientRect(),_=window.innerHeight,H=L.top>_/2;if(a.style.setProperty("transition","none","important"),H){let J=_-L.bottom;a.style.top="auto",a.style.bottom=`${J}px`}else a.style.bottom="auto",a.style.top=`${L.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),$.playGenieOpen()}else!k&&!O&&(a.classList.add("collapsed"),$.playGenieOpen());O&&(O.style.transform="scale(0.9)",setTimeout(()=>O.style.transform="",150))}}}function Qe(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
      <div class="cw-center-dots"><span></span><span></span><span></span></div>
      <div class="cw-center-text">${de.getRandomTip()}</div>
      <div class="cw-center-success"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,Z("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let r=Date.now()-n,s=Math.max(0,2e3-r);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let l=o.querySelector(".cw-center-dots"),m=o.querySelector(".cw-center-text"),d=o.querySelector(".cw-center-success"),b=o.querySelector(".cw-abort-btn");l&&(l.style.display="none"),m&&(m.style.display="none"),b&&(b.style.display="none"),d&&d.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},s)}}function bo(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let m=document.createElement("div");m.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",m.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let d=document.createElement("button");d.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',d.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",d.onmouseenter=()=>d.style.background="#F1F3F4",d.onmouseleave=()=>d.style.background="transparent",d.onclick=()=>f(!1),m.appendChild(d);let b=document.createElement("div");b.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",l.appendChild(m),l.appendChild(b);function f(h){let x=l.style.transform==="translateY(0%)";(h!==void 0?h:!x)?(g(),l.style.transform="translateY(0%)"):l.style.transform="translateY(110%)"}function g(){let h=we.getAll();if(b.innerHTML="",h.length===0){b.innerHTML=`
                ...
                </div>`;return}h.forEach(x=>{let k=document.createElement("div");k.style.cssText=`
            ...
            `;let L=new Date(x.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),_="";x.summaryTags&&x.summaryTags.length>0&&(_=`<div style="font-size:11px; color:#1A73E8; background:#E8F0FE; display:inline-block; padding:2px 6px; border-radius:4px; margin-top:4px;">\u{1F3F7}\uFE0F ${x.summaryTags.slice(0,3).join(", ")+(x.summaryTags.length>3?"...":"")}</div>`),k.innerHTML=`
...
`.replace(/\n/g,"<br>");et(q);let F=await bt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,q),gt(F),Z("Nota gerada e inserida!")):Z("Copiado! Abra uma nota para colar.")},e}function ke(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function be(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let r,s;if(!n)r=window.innerWidth/2,s=window.innerHeight/2;else{let d=e.getBoundingClientRect();r=d.left+d.width/2,s=d.top+d.height/2,r===0&&s===0&&(r=window.innerWidth/2,s=window.innerHeight/2)}let l=i.x-r,m=i.y-s;t?($.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${m}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${m}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof vo=="function"&&vo(e,o)):($.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${m}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${m}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof _t=="function"&&_t(e))}function vo(t,e){_t(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),r=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):r||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function _t(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function wo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=so(t,V),r=mo(y),s=uo(()=>{R(),W.setActiveTasks(s.getCheckedElements())},y,W),l=document.createElement("div");l.style.display="none";let m=po((p,E)=>{ee(p,E)});l.appendChild(m);let d=document.createElement("div");d.id="evidence-container",Object.assign(d.style,{display:"none",marginTop:"16px",padding:"16px",background:B.bgInput,border:`1px solid ${B.border}`,borderRadius:ue.medium,boxShadow:De.subtle});let b=document.createElement("div");b.className="cw-section-title",b.textContent=y("evidencias_contato"),d.appendChild(b);let f={},g=(p,E)=>{let T=document.createElement("div");T.style.marginBottom="12px";let P=document.createElement("label");P.textContent=E,P.setAttribute("for",p),P.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${B.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let N=document.createElement("input");return N.type="text",N.id=p,N.className="cw-input",N.placeholder="https://screenshot.googleplex.com/...",N.style.marginBottom="0",T.appendChild(P),T.appendChild(N),f[p]=N,T};d.appendChild(g("evidence-l1",y("ligacao_1"))),d.appendChild(g("evidence-l2",y("ligacao_2"))),d.appendChild(g("evidence-msg",y("mensagem_am")));let h=bo({onSaveCurrent:async()=>{let p=await c();return K(),p},onLoadDraft:p=>{v(p)},t:p=>y(p)}),x=D(),k=Y(),O=document.createElement("div"),L=C(),_=ae(h,y);o.appendChild(x),o.appendChild(k),o.appendChild(L),o.appendChild(l),o.appendChild(O),o.appendChild(d),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none";let H=document.createElement("button");H.id="manual-task-toggle",H.textContent=y("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",H.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${B.primary}; background: ${B.surface}; color: ${B.primary}; border-radius: ${ue.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${ce}; text-transform: uppercase; letter-spacing: 0.5px;`,H.onmouseenter=()=>{H.style.background=B.primaryBg},H.onmouseleave=()=>{H.style.background=B.surface},H.onclick=()=>{s.selectionElement.style.display="block",s.screenshotsElement.style.display="block",H.style.display="none"},o.appendChild(H),o.appendChild(s.selectionElement),o.appendChild(r.element),o.appendChild(s.screenshotsElement),o.appendChild(_);let J=document.createElement("div");J.style.display="none",J.style.flexGrow="1",J.style.minHeight="0",J.style.overflow="hidden";let oe=xo(()=>M());oe.style.height="100%",J.appendChild(oe),e.insertBefore(J,i);let q=a.lastElementChild;q&&(q.insertBefore(h.historyBtnWrapper,q.firstChild),q.insertBefore(w(),q.firstChild)),e.appendChild(h.drawer);let F=null;W.subscribe(p=>{S(p),z(),p.isDirty?(F&&clearTimeout(F),F=setTimeout(async()=>{let E=await c(!0);E.subStatus?we.saveEmergency(E):we.clearEmergency(),p.isDirty=!1},2e3)):F&&(clearTimeout(F),F=null)});function z(){let p=we.getCount()>0,E=!!W.currentSubStatus;mt(p||E)}function V(){W.visible=!W.visible,be(W.visible,e,"cw-btn-notes")}function M(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",J.style.display="flex",J.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",J.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function D(){let p=document.createElement("div");if(p.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let T=document.createElement("style");T.id="cw-segmented-styles",T.innerHTML=`
            ...
            `,document.head.appendChild(T)}let E=(T,P)=>{let Q=p.querySelector(`#${T}`).querySelector(".cw-segmented-indicator");Q&&(Q.style.transform=`translateX(${P*100}%) translateX(${P*2}px)`)};return p.querySelectorAll("#lang-selector button").forEach((T,P)=>{T.onclick=()=>{W.setLanguage(T.dataset.lang),p.querySelectorAll("#lang-selector button").forEach(N=>N.classList.remove("active")),T.classList.add("active"),E("lang-selector",P),$.playHover(),W.currentSubStatus&&G(W.currentSubStatus)}}),p.querySelectorAll("#type-selector button").forEach((T,P)=>{T.onclick=()=>{W.setCaseType(T.dataset.type),p.querySelectorAll("#type-selector button").forEach(N=>N.classList.remove("active")),T.classList.add("active"),E("type-selector",P),$.playHover(),W.currentSubStatus&&G(W.currentSubStatus)}}),p.querySelectorAll("#portugal-selector button").forEach((T,P)=>{T.onclick=()=>{W.setPortugalCase(T.dataset.val==="true"),p.querySelectorAll("#portugal-selector button").forEach(N=>N.classList.remove("active")),T.classList.add("active"),E("portugal-selector",P),$.playHover(),W.currentSubStatus&&G(W.currentSubStatus)}}),p}function Y(){let p=document.createElement("div");p.className="cw-status-section",p.style.cssText="display: flex; flex-direction: column; gap: 8px;",p.innerHTML=`
        ...
        `;let E=p.querySelector("#main-status-select"),T=p.querySelector("#sub-status-select");return E.onchange=()=>{W.setStatus(E.value),I(E.value,T),W.setSubStatus(""),G("")},T.onchange=()=>{W.setSubStatus(T.value),G(T.value)},p}function A(){return d.style.display==="none"?null:{l1:f["evidence-l1"]?.value.trim()||"",l2:f["evidence-l2"]?.value.trim()||"",msg:f["evidence-msg"]?.value.trim()||""}}function I(p,E){if(E.innerHTML=`<option value="">${y("select_substatus")}</option>`,!p){E.disabled=!0;return}for(let T in Le)if(Le[T].status===p){let P=document.createElement("option");P.value=T,P.textContent=Le[T].name,E.appendChild(P)}E.disabled=!1}function G(p){let E=Le[p],T=p==="NI_Attempted_Contact"||E&&E.name&&E.name.toLowerCase().includes("attempted contact");if(m.render&&m.render(p,W.currentCaseType),!p){d.style.display="none",f["evidence-l1"]&&(f["evidence-l1"].value=""),f["evidence-l2"]&&(f["evidence-l2"].value=""),f["evidence-msg"]&&(f["evidence-msg"].value=""),l.style.display="none",O.style.display="none";let pe=document.getElementById("manual-task-toggle");pe&&(pe.style.display="none"),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",L.style.display="flex",L.style.opacity="1",_.style.display="none";return}if(T?d.style.display="block":(d.style.display="none",f["evidence-l1"]&&(f["evidence-l1"].value=""),f["evidence-l2"]&&(f["evidence-l2"].value=""),f["evidence-msg"]&&(f["evidence-msg"].value="")),L.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(L.style.display="none")},400),_.style.display="grid",E&&E.templateFields){let pe=st(E);W.setActiveFields(E.templateFields.filter(Ee=>!pe.includes(Ee)))}U(),dt(p,O,W),O.style.display="block",l.style.display="block";let P=p.startsWith("SO_"),N=p==="NI_Awaiting_Validation",Q=document.getElementById("manual-task-toggle");P||N?(s.selectionElement.style.display="block",Q.style.display="none"):(s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",Q.style.display="block");let X=p==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(X),s.updateSubStatus(p),R();let se=document.getElementById("email-automation-toggle-row");se&&(se.style.display=Ye[p]?"flex":"none")}function R(){let p=s.getCheckedElements().map(E=>E.value);r.updateVisibility(W.currentSubStatus,p)}function ee(p,E){let T=lt[p];if(T){for(let P in T)if(P==="linkedTask")s.toggleTask(T.linkedTask,E);else if(P==="activeTasks")T.activeTasks.forEach(N=>{E?s.setTaskCount(N.value,N.count):s.setTaskCount(N.value,0)});else if(P.startsWith("field-")){let N=P,Q=T[P],X=document.getElementById(N);if(X){let se=We.includes(N.replace("field-",""));if(E)if(se){let pe=X.value.trim();pe.includes(Q.trim())||(X.value=pe?pe+`
`+Q.trim():Q.trim())}else X.value=Q;else if(se){let pe=X.value.trim(),Ee=Q.trim();pe.includes(Ee)&&(X.value=pe.replace(Ee,"").trim().replace(/\n{3,}/g,`

`))}else X.value.trim()===Q.trim()&&(X.value="");W.updateField(N,X.value),X.dispatchEvent(new Event("input"))}}}}function ae(p,E){let T=document.createElement("div");if(T.className="cw-actions-section",T.style.cssText=`
            display: grid;
        ...
        `;let N=p.parkButton;N.classList.add("js-btn-park"),N.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let Q=document.createElement("button");Q.className="cw-btn-secondary js-btn-reset",Q.textContent=E("limpar"),Q.style.cssText=`width: 100%; height: 34px; background: ${B.surface}; color: ${B.textSub}; border: 1px solid ${B.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,Q.onclick=()=>K();let X=document.createElement("button");X.className="cw-btn-secondary js-btn-copy",X.textContent=E("copiar"),X.style.cssText=`width: 100%; height: 34px; background: ${B.surface}; color: ${B.primary}; border: 1px solid ${B.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,X.onclick=()=>te();let se=document.createElement("button");return se.className="cw-btn-primary js-btn-generate",se.textContent=E("preencher"),se.style.cssText=`width: 100%; height: 38px; background: ${B.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: 1 / -1; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,se.onclick=()=>j(),T.appendChild(P),T.appendChild(N),T.appendChild(Q),T.appendChild(X),T.appendChild(se),T}async function te(){if(!W.currentSubStatus){Z(y("select_substatus"),{error:!0});return}let p=It(W,s,r,A());p?(et(p),Z(y("copiado_sucesso")),$.playClick()):Z(y("select_substatus"),{error:!0})}async function j(){if(!W.currentSubStatus){Z(y("select_substatus"),{error:!0});return}let p=Le[W.currentSubStatus],E=Ze(p).filter(Q=>{if(!W.activeFields.includes(Q))return!1;let X=W.formData[`field-${Q}`];return!X||!X.trim()});if(E.length>0){Z(`Preencha o campo obrigat\xF3rio antes de gerar: ${y(E[0].toLowerCase())}`,{error:!0});return}if(p?.requiresTasks&&s.getCheckedElements().length===0){Z("Selecione ao menos uma tarefa antes de gerar a nota.",{error:!0});return}let T=It(W,s,r,A());et(T),V();let P=Qe(),N=await bt();if(N){N.focus(),document.execCommand("insertHTML",!1,T),gt(N);let Q=document.getElementById("email-automation-checkbox");(!Q||Q.checked)&&W.currentSubStatus&&Ye[W.currentSubStatus]&&await ht(Ye[W.currentSubStatus]),Z(y("inserido_copiado")),$.playSuccess(),K()}else Z("N\xE3o foi poss\xEDvel abrir a nota no CRM. O conte\xFAdo j\xE1 est\xE1 copiado \u2014 cole manualmente.",{error:!0}),V();P()}function U(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let p=Le[W.currentSubStatus];p&&p.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function K(){W.reset(),s.reset(),r.reset(),z(),we.clearEmergency(),o.querySelectorAll("select").forEach(E=>E.value=""),o.querySelector("#sub-status-select").disabled=!0;let p=document.getElementById("email-automation-toggle-row");p&&(p.style.display="none"),O.innerHTML="",l.style.display="none",L.style.display="flex",L.style.opacity="1",_.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",d.style.display="none",f["evidence-l1"]&&(f["evidence-l1"].value=""),f["evidence-l2"]&&(f["evidence-l2"].value=""),f["evidence-msg"]&&(f["evidence-msg"].value="")}async function c(p=!1){let E={};O.querySelectorAll("input, textarea, select").forEach(X=>{(X.id.startsWith("field-")||X.id==="consent-select")&&(E[X.id]=X.value)});let T="Cliente",P="---";if(!p)try{let X=await Fe();T=X.advertiserName,P=X.cid}catch(X){console.warn("Erro ao coletar pageData:",X)}let N=s.getCheckedElements().map(X=>({key:X.value,count:X.count})),Q=N.map(X=>{let se=Ie[X.key];return se?se.name:X.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:E,activeTasks:N,summaryTags:Q,clientName:T,cid:P,timestamp:new Date().toISOString()}}let u=p=>new Promise(E=>setTimeout(E,p));async function v(p){W.setLanguage(p.currentLang||"pt"),W.setCaseType(p.currentCaseType||"bau"),W.setPortugalCase(p.isPortugalCase||!1),W.setConsent(p.consent||!1),p.activeFields&&W.setActiveFields(p.activeFields);let E=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);E&&E.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(N=>{N!==E&&N.classList.remove("active")});let T=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);T&&T.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(N=>{N!==T&&N.classList.remove("active")});let P=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if(P&&P.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(N=>{N!==P&&N.classList.remove("active")}),p.status){let N=o.querySelector("#main-status-select");N.value=p.status,W.setStatus(p.status);let Q=o.querySelector("#sub-status-select");if(I(p.status,Q),await u(50),p.subStatus){if(Q.value=p.subStatus,W.setSubStatus(p.subStatus),G(p.subStatus),await u(100),p.tagSupportUsed!==void 0){W.setTagSupportUsed(p.tagSupportUsed);let X=r.element.querySelector('input[value="Sim"]'),se=r.element.querySelector('input[value="N\xE3o"]');p.tagSupportUsed&&X?X.checked=!0:se&&(se.checked=!0),r.element.querySelector("div:last-child").style.display=p.tagSupportUsed?"none":"block"}p.forcedScreenshots&&W.setForcedScreenshots(p.forcedScreenshots);for(let X in p.formData){let se=document.getElementById(X);se&&(se.value=p.formData[X],W.updateField(X,se.value))}p.activeTasks&&(p.activeTasks.forEach(X=>s.setTaskCount(X.key,X.count)),W.setActiveTasks(s.getCheckedElements()))}}W.isDirty=!1}function y(p){return Ce[W.currentLang]?.[p]||Ce.pt?.[p]||p}function w(){let p=document.createElement("div");return p.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',p.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",p.onclick=E=>{E.stopPropagation(),M()},p.title="Alternar para Split & Transfer",p}function C(){let p=document.createElement("div");return p.id="notes-empty-state",p.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(m),Object.assign(l.style,ye,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let d=ge(l,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:l},()=>Y()),b=document.createElement("div");Object.assign(b.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:s.bgApp});let f=document.createElement("div");Object.assign(f.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${s.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let g=document.createElement("div");Object.assign(g.style,{padding:"16px",borderBottom:`1px solid ${s.borderSubtle}`,position:"relative"});let h=document.createElement("input");h.placeholder="Buscar templates...",Object.assign(h.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:s.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),h.onfocus=()=>{h.style.backgroundColor="#FFFFFF",h.style.borderColor=s.primary,h.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",h.style.transform="scale(1.02)"},h.onblur=()=>{h.style.backgroundColor="#E3E3E8",h.style.borderColor="transparent",h.style.boxShadow="none",h.style.transform="scale(1)"};let x=document.createElement("div");x.id="email-template-list",Object.assign(x.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let k=document.createElement("div");k.innerHTML="\u2715",Object.assign(k.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),k.onclick=()=>{h.value="",n="",k.style.display="none",I(),h.focus()},g.appendChild(h),g.appendChild(k),f.appendChild(g),f.appendChild(x);let O=document.createElement("div");Object.assign(O.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:s.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let L=document.createElement("div");Object.assign(L.style,{padding:"20px",borderBottom:`1px solid ${s.borderSubtle}`,backgroundColor:s.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let _=document.createElement("div");Object.assign(_.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:s.bgApp,overflow:"hidden"});let H=document.createElement("div");Object.assign(H.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let J=document.createElement("span");J.textContent="Preview do E-mail",Object.assign(J.style,{fontSize:"12px",fontWeight:"600",color:s.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let oe=document.createElement("div");Object.assign(oe.style,{display:"flex",gap:"8px"});let q=(te,j=!1)=>{let U=document.createElement("button");return U.textContent=te,Object.assign(U.style,{padding:"8px 14px",borderRadius:"10px",border:j?"none":`1.5px solid ${s.primary}`,background:j?s.primary:"transparent",color:j?"#fff":s.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:j?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),U.onmouseenter=()=>{j?(U.style.backgroundColor="#0062CC",U.style.transform="translateY(-1px)",U.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):U.style.backgroundColor="rgba(0, 122, 255, 0.05)"},U.onmouseleave=()=>{j?(U.style.backgroundColor=s.primary,U.style.transform="translateY(0)",U.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(U.style.backgroundColor="transparent",U.style.transform="translateY(0)")},U.onmousedown=()=>U.style.transform="scale(0.94)",U.onmouseup=()=>U.style.transform="scale(1)",U},F=q("Copiar HTML"),z=q("Preencher no CRM",!0),V=q("Smart CR");V.style.borderColor="#E67E22",V.style.color="#E67E22",V.style.display="none",oe.appendChild(V),oe.appendChild(F),oe.appendChild(z),H.appendChild(J),H.appendChild(oe);let M=document.createElement("div");M.contentEditable="true",Object.assign(M.style,{flex:"1",backgroundColor:s.bgSurface,border:`1px solid ${s.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:s.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),_.appendChild(H),_.appendChild(M),ae(),O.appendChild(L),O.appendChild(_),b.appendChild(f),b.appendChild(O),l.appendChild(d),l.appendChild(b);let D=document.createElement("div");Object.assign(D.style,qe),l.appendChild(D),Oe(l,D),document.body.appendChild(l);function Y(){e=!e,e?(l.style.display="flex",eo(l),o.length===0&&A()):l.style.display="none",be(e,l,"cw-btn-email")}async function A(){x.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await Co.getTemplates(),I()}function I(){x.innerHTML="";let te=o.filter(u=>u.name.toLowerCase().includes(n.toLowerCase())||u.category.toLowerCase().includes(n.toLowerCase())),j=Object.entries(Ye).filter(([u,v])=>v&&(u.toLowerCase().includes(n.toLowerCase())||v.toLowerCase().includes(n.toLowerCase()))).map(([u,v])=>({id:u,name:u.replace(/_/g," "),category:"\u26A1 Smart CRs",code:v,isSmartCR:!0})),U=Se.getSnippets("email").filter(u=>u.title.toLowerCase().includes(n.toLowerCase())||u.subject&&u.subject.toLowerCase().includes(n.toLowerCase())).map(u=>{let v=[],y=u.content.match(/\[([^\]]+)\]/g);return y&&[...new Set(y)].forEach(w=>{v.push({key:w,label:w.replace("[","").replace("]",""),type:w.toLowerCase().includes("data")?"date":"text",auto:w.toLowerCase().includes("nome")&&w.toLowerCase().includes("seu")?"agentName":null})}),{id:u.id||`snippet-${Math.random()}`,name:u.title,category:"\u{1F464} Pessoal",subject:u.subject||"Sem Assunto",template:u.content,placeholders:v}}),K=[...te,...j,...U];if(K.length===0){x.innerHTML=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condiciones.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las herramientas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfacci\xF3n.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes d\xEDas."]}};var ie={bgApp:"#F5F5F7",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.07)",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",textPrimary:"#1D1D1F",textSecondary:"#6E6E73",danger:"#D93025",dangerBg:"#FCE8E6",success:"#34A853",successBg:"#E6F4EA"},ma={inicio:{PT:"Abertura",ES:"Apertura"},meio:{PT:"Implementa\xE7\xE3o (Tag Support)",ES:"Implementaci\xF3n"},fim:{PT:"Fechamento",ES:"Cierre"}};function ga(){if(document.getElementById("csa-styles-v2"))return;let t=document.createElement("style");t.id="csa-styles-v2",t.textContent=`
    ...
    `,document.head.appendChild(t)}function To(){let t="v3.1.0";ga();let e={},o="PT",a="BAU",n=!1,i=document.createElement("div");i.id="call-script-popup",i.classList.add("cw-module-window"),Object.assign(i.style,ye,{right:"auto",left:"50%",width:"420px",height:"700px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:i,googleLine:null},s=null;function l(){n&&Fe().then(v=>{let y=i.querySelector("#cw-ctx-name"),w=i.querySelector("#cw-ctx-cid"),C=i.querySelector("#cw-ctx-email");if(y&&(y.textContent=v.advertiserName||"Cliente Desconhecido"),w){let S=v.cid||"---";w.textContent!==S&&(w.textContent=S)}if(C){let S=v.clientEmail||"N\xE3o encontrado";C.textContent!==S&&(C.textContent=S,C.title=S)}})}function m(){Fe().then(v=>{let y=new Date().toLocaleDateString("pt-BR"),w=i.querySelector("#cw-am-message-area"),C=i.querySelector("#cw-am-review-container"),S=`Ol\xE1. Bom dia!

Estou com um caso do seu cliente (${v.advertiserName||"Cliente"}) em andamento hoje (${y}). Fiz a primeira tentativa de contato agora h\xE1 pouco, mas n\xE3o tive sucesso.
...
CID: ${v.cid||"---"}
Case ID: ${v.caseId||"---"}
E-mail: ${v.clientEmail||"---"}`;w&&(w.value=S),C&&(C.classList.add("visible"),C.scrollIntoView({behavior:"smooth",block:"end"}))})}function d(){n=!n,be(n,i,"cw-btn-script"),n?(l(),s||(s=setInterval(l,2e3))):s&&(clearInterval(s),s=null)}let b=ge(i,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{d()});i.appendChild(b);let f=document.createElement("div");f.className="csa-context-banner",f.innerHTML=`
  ...
  `,x.onfocus=()=>{g.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",g.style.border="1px solid #1a73e8"},x.onblur=()=>{g.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",g.style.border="1px solid transparent"},g.appendChild(h),g.appendChild(x),f.appendChild(g),b.appendChild(f);let k=document.createElement("div");k.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",b.appendChild(k);let O=null;function L(){if(O)return;O=document.createElement("div"),O.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let D=document.createElement("div");D.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",D.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let Y=document.createElement("button");Y.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',Y.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",Y.onclick=()=>{H(),n=!1,F()},D.appendChild(Y),O.appendChild(D);let A=document.createElement("div");A.id="cw-history-list",A.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",O.appendChild(A),b.appendChild(O)}function _(){O||L();let D=O.querySelector("#cw-history-list");D.innerHTML="";let Y=ba();Y.length===0?D.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':Y.forEach(A=>{let I=V(A,Ge[A._originalCat],!0,A._originalCat);D.appendChild(I)}),requestAnimationFrame(()=>O.style.transform="translateY(0)")}function H(){O&&(O.style.transform="translateY(100%)")}function J(){d.innerHTML="";let D=oe("history","Recentes",Ge.history);D.id="cw-sidebar-btn-history",D.onclick=()=>{$.playClick(),n=!n,n?_():H(),F()},d.appendChild(D);let Y=document.createElement("div");Y.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(Y),Object.keys(tt).forEach(A=>{let I=tt[A],G=oe(A,I.label,Ge[A]);G.id=`cw-sidebar-btn-${A}`,G.onclick=()=>{$.playClick(),n&&(n=!1,H()),q(A)},d.appendChild(G)})}function oe(D,Y,A){let I=document.createElement("div");I.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,I.title=Y,I.dataset.key=D;let G=document.createElement("div");G.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",G.innerHTML=A||Ge.tasks;let R=document.createElement("div");return R.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",R.textContent=Y,I.appendChild(G),I.appendChild(R),I.onmouseenter=()=>{a!==D&&!(D==="history"&&n)&&(I.style.background="#F1F3F4",G.style.transform="scale(1.1)")},I.onmouseleave=()=>{a!==D&&!(D==="history"&&n)&&(I.style.background="transparent",G.style.transform="scale(1)")},I}function q(D){let Y=document.getElementById(`cat-anchor-${D}`);Y&&(Y.scrollIntoView({behavior:"smooth",block:"start"}),a=D,F())}function F(){Object.keys(tt).forEach(Y=>{let A=d.querySelector(`#cw-sidebar-btn-${Y}`);if(A)if(a===Y&&!n){let I=yt[Y];A.style.background=I.bg,A.style.color=I.color,A.querySelector("div:first-child").style.transform="scale(1.1)"}else A.style.background="transparent",A.style.color=i.textSecondary,A.querySelector("div:first-child").style.transform="scale(1)"});let D=d.querySelector("#cw-sidebar-btn-history");D&&(n?(D.style.background="#3C4043",D.style.color="#FFFFFF"):(D.style.background="transparent",D.style.color=i.textSecondary))}function z(){if(k.innerHTML="",e.trim()!==""){let Y=[];if(Object.entries(tt).forEach(([I,G])=>{let R=G.links.filter(ee=>ee.name.toLowerCase().includes(e.toLowerCase())||ee.desc.toLowerCase().includes(e.toLowerCase()));Y.push(...R.map(ee=>({...ee,_cat:I})))}),Y.length===0){k.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let A=document.createElement("div");A.innerHTML="Resultados da busca",A.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",k.appendChild(A),Y.forEach(I=>{let G=V(I,Ge[I._cat],!1,I._cat);k.appendChild(G)});return}Object.entries(tt).forEach(([Y,A])=>{let I=yt[Y],G=document.createElement("div"),R=document.createElement("div");R.id=`cat-anchor-${Y}`,R.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,R.innerHTML=`
            ...
            ${A.label}
          `,G.appendChild(R);let ee=document.createElement("div");ee.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",A.links.forEach(ae=>{let te=V(ae,Ge[Y],!1,Y);ee.appendChild(te)}),G.appendChild(ee),k.appendChild(G)});let D=document.createElement("div");D.style.height="80px",k.appendChild(D)}function V(D,Y,A,I){let G=document.createElement("div"),R=yt[I]||yt.history;G.style.cssText=`
      ...
      `,K.title="Copiar URL",G.onmouseenter=()=>{G.style.transform="translateY(-2px)",G.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",G.style.borderColor="rgba(0,0,0,0.05)",G.style.borderLeft=`4px solid ${R.color}`,K.style.opacity="1",K.style.background="#F1F3F4"},G.onmouseleave=()=>{G.style.transform="translateY(0)",G.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",G.style.border="1px solid transparent",K.style.opacity="0",K.style.background="transparent"},G.onclick=()=>{!A&&I&&Fo(D,I),window.open(D.url,"_blank")},K.onclick=c=>{c.stopPropagation(),$.playClick(),navigator.clipboard.writeText(D.url),!A&&I&&Fo(D,I),Z("Link copiado!")},G.appendChild(ee),G.appendChild(te),G.appendChild(K),G}x.addEventListener("input",D=>{e=D.target.value,z()});function M(){o=!o,be(o,r,"cw-btn-links")}return document.body.appendChild(r),J(),z(),M}var ze=[];function Nt(t){ze=t}var fa=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Lo(){let t="v4.9",e=!1,o=null,a=null;function n(A){if(!A)return"";try{let I=new Date(A);return isNaN(I.getTime())?String(A):I.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(A)}}if(!document.getElementById("cw-broadcast-hd-css")){let A=document.createElement("style");A.id="cw-broadcast-hd-css",A.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,g.querySelectorAll('input[name="cw-bc-type"]').forEach(R=>{R.addEventListener("change",()=>{g.querySelectorAll(".cw-radio-option").forEach(ee=>ee.classList.remove("checked")),R.parentElement.classList.add("checked")})}),setTimeout(()=>{let R=g.querySelector(".cw-radio-option.info");R&&R.classList.add("checked")},100);let A=g.querySelector("#cw-bc-cancel"),I=g.querySelector("#cw-bc-close-x"),G=g.querySelector("#cw-bc-send");A.onclick=L,I.onclick=L,G.onclick=_,l.appendChild(g)}function O(A=null){if(!g)return;let I=g.querySelector("#cw-editor-title-label"),G=g.querySelector("#cw-bc-title"),R=g.querySelector("#cw-bc-text"),ee=g.querySelector("#cw-bc-send");if(A){a=A.id,I.textContent="Editar Aviso",G.value=A.title||"",R.value=A.text||"",ee.textContent="Salvar Altera\xE7\xF5es";let ae=A.type||"info",te=g.querySelector(`input[name="cw-bc-type"][value="${ae}"]`);te&&te.click()}else{a=null,I.textContent="Novo Aviso",G.value="",R.value="",ee.textContent="Publicar";let ae=g.querySelector('input[name="cw-bc-type"][value="info"]');ae&&ae.click()}g.classList.add("active"),setTimeout(()=>G.focus(),300)}function L(){g&&g.classList.remove("active"),a=null}async function _(){let A=g.querySelector("#cw-bc-send"),I=g.querySelector("#cw-bc-title"),G=g.querySelector("#cw-bc-text"),R=g.querySelector('input[name="cw-bc-type"]:checked'),ee=R?R.value:"info";if(!I.value.trim()||!G.value.trim()){Z("Preencha todos os campos!",{error:!0});return}A.textContent="Salvando...",A.style.opacity="0.7";let ae=!1;a?ae=await de.updateBroadcast(a,{title:I.value,text:G.value,type:ee}):ae=await de.sendBroadcast({title:I.value,text:G.value,type:ee,author:window._cwCurrentUser||"admin"}),ae?(Z(a?"Atualizado!":"Publicado!"),$.playSuccess(),L(),setTimeout(()=>oe(),1500)):(Z("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),A.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",A.style.opacity="1")}async function H(A){if(await ve("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await de.deleteBroadcast(A)){Z("Aviso removido."),$.playClick();let R=ze.findIndex(ee=>ee.id===A);R>-1&&ze.splice(R,1),F(),setTimeout(()=>oe(),1500)}else Z("Erro ao excluir.",{error:!0})}let J=document.createElement("div");J.className="cw-nice-scroll",Object.assign(J.style,i.feedContainer),l.appendChild(J);async function oe(){e&&(x.style.display="block",x.innerHTML="\u{1F504} Sincronizando...");try{let A=await de.fetchData();A&&A.broadcast&&(Nt(A.broadcast),q(),e&&(F(),x.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{x.style.display="none"},1500)))}catch{e&&(x.innerHTML="\u26A0\uFE0F Offline")}}function q(){let A=document.getElementById("cw-btn-broadcast");if(!A)return;let I=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(ze.some(R=>!I.includes(R.id))){if(A.classList.add("has-new"),!A.querySelector(".cw-badge")){let R=document.createElement("div");R.className="cw-badge",Object.assign(R.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),A.appendChild(R)}}else{A.classList.remove("has-new");let R=A.querySelector(".cw-badge");R&&R.remove()}}function F(){J.innerHTML="";let A=l.querySelector("#cw-bau-widget");A&&A.remove();let I=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),G=[...ze].sort((j,U)=>{let K=new Date(j.date).getTime()||0;return(new Date(U.date).getTime()||0)-K}),R=G.findIndex(j=>j.title&&j.title.toLowerCase().includes("disponibilidade bau"));if(R!==-1){let j=G[R];G.splice(R,1);let U=document.createElement("div");U.id="cw-bau-widget",Object.assign(U.style,i.bauContainer);let K=[],c=(j.text||"").split(`
`),u=/\d{1,2}\/\d{1,2}/,v="\u{1F4C5}";if(c.forEach(p=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(p)?v="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(p)&&(v="\u{1F1EA}\u{1F1F8}");let E=p.match(u);if(E){let T=E[0],P=v;/🇧🇷|🇵🇹|PT|BR/i.test(p)?P="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(p)&&(P="\u{1F1EA}\u{1F1F8}"),K.some(Q=>Q.flag===P&&Q.date===T)||K.push({flag:P,date:T})}}),K.length===0){let p=(j.text||"").match(/\d{1,2}\/\d{1,2}/g);p&&[...new Set(p)].forEach(E=>K.push({flag:"\u{1F4C5}",date:E}))}let y="",w='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(w=`
    ...
    `,document.head.appendChild(t)}function zo(){let t="v2.0",e=!1,o="general",a="",n=null,i=null;ya();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,ye,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let l=ge(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>K());r.appendChild(l);let m=document.createElement("div");m.className="cw-lib-container",r.appendChild(m);let d=document.createElement("div");d.className="cw-lib-toolbar";let b=document.createElement("div");b.className="cw-lib-search-wrap";let f=document.createElement("div");f.className="cw-lib-search-icon",f.innerHTML=xe.search;let g=document.createElement("input");g.className="cw-lib-search no-drag",g.placeholder="Buscar por t\xEDtulo ou conte\xFAdo...",g.type="text";let h=document.createElement("div");h.className="cw-lib-search-clear cw-tactile",h.innerHTML=xe.clear,b.append(f,g,h);let x=document.createElement("div");x.className="cw-lib-tabs",No.forEach(c=>{let u=document.createElement("div");u.className="cw-lib-tab"+(c.id===o?" active":""),u.id=`lib-tab-${c.id}`,u.innerHTML=`${c.icon}<span>${c.label}</span>`,u.onmouseenter=()=>$.playHover(),u.onclick=()=>D(c.id),x.appendChild(u)}),d.append(b,x),m.appendChild(d);let k=document.createElement("div");k.className="cw-lib-grid",m.appendChild(k);let O=document.createElement("div");O.className="cw-lib-fab cw-tactile",O.title="Novo item",O.innerHTML=xe.add,O.onclick=()=>ee(),m.appendChild(O);let L=document.createElement("div");L.className="cw-lib-sheet";let _=document.createElement("div");_.className="cw-lib-sheet-handle";let H=document.createElement("div");H.className="cw-lib-sheet-head";let J=document.createElement("div");J.className="cw-lib-sheet-back no-drag",J.innerHTML=xe.back,J.title="Cancelar",J.onclick=ae;let oe=document.createElement("span");oe.className="cw-lib-sheet-title",oe.textContent="Novo Item",H.append(J,oe);let q=document.createElement("div");q.className="cw-lib-sheet-body";let F=document.createElement("div");F.className="cw-lib-sheet-foot";let z=document.createElement("button");z.className="cw-lib-save-btn no-drag",z.textContent="Salvar",z.onclick=te,F.appendChild(z);let V=document.createElement("div");V.className="cw-lib-loading",V.innerHTML='<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text">Salvando...</div>',L.append(_,H,q,F,V),m.appendChild(L);let M=document.createElement("div");Object.assign(M.style,qe),M.className="no-drag",r.appendChild(M),Oe(r,M),document.body.appendChild(r),document.addEventListener("mousedown",c=>{i&&!i.contains(c.target)&&Y()});function D(c){$.playClick(),o=c,No.forEach(u=>{document.getElementById(`lib-tab-${u.id}`).classList.toggle("active",u.id===c)}),I()}function Y(){if(i){let c=i.querySelector(".cw-lib-menu");c&&c.classList.remove("open"),i=null}}function A(c,u){return u?`${c.title} ${c.content}`.toLowerCase().includes(u):!0}function I(){Y(),k.innerHTML="";let c=a.trim().toLowerCase(),u=Se.getSnippets(o).filter(v=>A(v,c));if(u.length===0){let v=document.createElement("div");v.className="cw-lib-empty";let y=c.length>0;v.innerHTML=`
                <div style="opacity:0.5;">${xe.empty}</div>
                <div class="cw-lib-empty-title">${y?"Nada encontrado":"Nada aqui ainda"}</div>
                <div class="cw-lib-empty-sub">${y?`Nenhum item bate com "${a.trim()}" nesta aba.`:"Clique no + para come\xE7ar sua cole\xE7\xE3o."}</div>
            `,k.appendChild(v);return}u.forEach(v=>k.appendChild(G(v)))}function G(c){let u=document.createElement("div");u.className="cw-lib-card"+(c.isCode?" is-code":"");let v=c.content,y="";if(c.isRich){let p=document.createElement("div");p.innerHTML=c.content;let E=!!p.querySelector("img");v=p.innerText.substring(0,200),E&&(y=`<span class="cw-lib-media-tag">${xe.media} M\xEDdia</span>`)}let w=[c.isCode?'<span class="cw-lib-badge code">CODE</span>':"",o==="email"?'<span class="cw-lib-badge template">TEMPLATE</span>':""].join("");u.innerHTML=`
        ...
        `,u.querySelector(".cw-act-copy").onclick=p=>{p.stopPropagation(),$.playClick(),R(c)};let C=u.querySelector(".cw-act-more"),S=u.querySelector(".cw-lib-menu");return C.onclick=p=>{p.stopPropagation(),$.playClick();let E=S.classList.contains("open");Y(),E||(S.classList.add("open"),i=u)},u.querySelector(".cw-act-edit").onclick=p=>{p.stopPropagation(),$.playClick(),Y(),ee(c)},u.querySelector(".cw-act-del").onclick=async p=>{p.stopPropagation(),$.playClick(),Y(),await ve(`Excluir "${c.title}"?`)&&(Se.delete(c.id),I(),Z("Item exclu\xEDdo."))},u}function R(c){if(c.isRich){let u=new Blob([c.content],{type:"text/html"}),v=document.createElement("div");v.innerHTML=c.content;let y=new Blob([v.innerText],{type:"text/plain"});navigator.clipboard.write([new ClipboardItem({"text/html":u,"text/plain":y})])}else navigator.clipboard.writeText(c.content);Z("Copiado!")}function ee(c=null){n=c?c.id:null,q.innerHTML="",q.appendChild(j("title","T\xEDtulo / Nome",c?c.title:"")),o==="email"&&q.appendChild(j("subject","Assunto do Email",c?c.subject:""));let u="Conte\xFAdo";o==="email"&&(u="Corpo do Email (HTML)"),o==="note"&&(u="Texto da Nota"),q.appendChild(j("content",u,c?c.content:"",{isRich:!0,isCode:c?c.isCode:!1})),oe.textContent=c?"Editar Item":"Novo Item",z.textContent=c?"Salvar Altera\xE7\xF5es":"Salvar",L.classList.add("open"),setTimeout(()=>{let v=q.querySelector("input");v&&v.focus()},350)}function ae(){$.playSwoosh(),L.classList.remove("open"),setTimeout(()=>{n=null},300)}async function te(){V.classList.add("active"),z.disabled=!0;try{let c=q.querySelector("#cw-lib-inp-title"),u=q.querySelector("#cw-lib-inp-content"),v=c.value.trim(),y=u.contentEditable==="true"?u.innerHTML:u.value.trim(),w=u.getAttribute("data-is-code")==="true";if(!v||!y||y==="<br>"){Z("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let C={id:n,type:o,title:v,content:y,isCode:w,isRich:u.contentEditable==="true"};if(o==="email"){let p=q.querySelector("#cw-lib-inp-subject").value.trim();if(!p){Z("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}C.subject=p}let S=await Se.save(C);if(S===!1){Z("N\xE3o foi poss\xEDvel salvar: usu\xE1rio n\xE3o identificado. Recarregue a p\xE1gina e tente de novo.",{error:!0});return}I(),ae(),S.synced===!1?Z("Salvo localmente \u2014 sem conex\xE3o com a nuvem no momento.",{error:!0}):(Z("Salvo e sincronizado!"),$.playSuccess())}catch(c){console.error("Erro ao salvar item da biblioteca:",c),Z("Erro ao salvar item.",{error:!0})}finally{V.classList.remove("active"),z.disabled=!1}}function j(c,u,v,y={}){let w=document.createElement("div");w.className="cw-lib-field";let C=document.createElement("label");C.className="cw-lib-label",C.textContent=u,w.appendChild(C);let S;if(y.isRich){let p=document.createElement("div");p.className="cw-lib-toolbar-mini",p.innerHTML=`
            ...
            `,S=document.createElement("div"),S.className="cw-lib-input cw-lib-editable",S.contentEditable="true",S.innerHTML=v||"",y.isCode&&(S.style.fontFamily="'Roboto Mono', monospace",S.style.background="#F8F9FA",S.setAttribute("data-is-code","true"),p.querySelector(".cw-tb-code").classList.add("active")),p.querySelectorAll(".cw-lib-tb-btn").forEach(E=>{E.onmouseenter=()=>$.playHover(),E.onmousedown=()=>$.playClick()}),p.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),S.focus()},p.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),S.focus()},p.querySelector(".cw-tb-code").onclick=E=>{let P=!(S.getAttribute("data-is-code")==="true");S.setAttribute("data-is-code",String(P)),S.style.fontFamily=P?"'Roboto Mono', monospace":"inherit",S.style.background=P?"#F8F9FA":"#fff",E.currentTarget.classList.toggle("active",P),S.focus()},p.querySelector(".cw-tb-img").onclick=async()=>{let E=await no("Cole a URL da imagem:");E&&(document.execCommand("insertImage",!1,E),S.querySelectorAll("img").forEach(T=>{T.style.maxWidth="100%",T.style.borderRadius="8px"}))},S.onpaste=E=>{let T=(E.clipboardData||E.originalEvent.clipboardData).items;for(let P of T)if(P.kind==="file"&&P.type.startsWith("image/")){E.preventDefault();let N=new FileReader;N.onload=Q=>{document.execCommand("insertHTML",!1,`<img src="${Q.target.result}" style="max-width:100%;border-radius:8px;margin:8px 0;display:block;">`)},N.readAsDataURL(P.getAsFile())}},w.appendChild(p)}else S=document.createElement("input"),S.className="cw-lib-input",S.type="text",S.value=v||"";return S.id=`cw-lib-inp-${c}`,w.appendChild(S),w}function U(c){let u=document.createElement("div");return u.textContent=c||"",u.innerHTML}g.addEventListener("input",c=>{a=c.target.value,h.classList.toggle("visible",a.length>0),I()}),h.onclick=()=>{g.value="",a="",h.classList.remove("visible"),I(),g.focus()};function K(){e=!e,be(e,r,"cw-btn-library"),e?(document.body.style.overflow="hidden",I()):(document.body.style.overflow="",Y())}return K}function Ro(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let h=document.createElement("style");h.id=a,h.innerHTML=`
        ...
        `,document.head.appendChild(h)}let n=document.createElement("div");n.id="configs-popup",n.classList.add("cw-module-window"),Object.assign(n.style,ye,{right:"100px",width:"400px",height:"600px",overflow:"hidden",borderRadius:"24px"});let r=ge(n,"Configura\xE7\xF5es",t,"Personalize sua experi\xEAncia e prefer\xEAncias.",{popup:n},()=>g());n.appendChild(r);let s=document.createElement("div");s.className="cw-configs-container",n.appendChild(s);let l=document.createElement("div");l.className="cw-profile-card",l.id="cw-user-profile-section",l.style.display="none",s.appendChild(l);async function m(){l.style.display="flex",l.innerHTML=`
        ...
        `,setTimeout(async()=>{try{let h=fe(),x=h?h.split("@")[0]:"user",k=await at(x);if(!k){l.innerHTML=`
            ...
            `;return}l.innerHTML=`
        <img src="https://moma-teams-photos.corp.google.com/photos/${x}?sz=600&type=PLUS"
    ...
    `}catch(h){console.warn("Erro ao renderizar perfil:",h),l.style.display="none"}},3e3)}m();let d=document.createElement("div");d.className="cw-configs-section",d.innerHTML=`
    ...
    `;let b=d.querySelector("#cw-config-sound-toggle");b.onchange=h=>{$.setMuted(!h.target.checked),h.target.checked&&$.playClick()},s.appendChild(d);let f=document.createElement("div");f.className="cw-configs-section",f.innerHTML=`
  ...
  `,document.head.appendChild(t)};var Ue={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var me={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function $o(t){switch(t){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:t||"Pendente",class:"status-gray",aura:""}}}function Po(t){let e=document.createElement("div");if(e.className="bau-dynamic-input",e.id=`wrapper-${t.id}`,t.label){let a=document.createElement("label");a.className="bau-label",a.textContent=t.label,t.tooltip&&a.setAttribute("data-tooltip",t.tooltip),e.appendChild(a)}let o;switch(t.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",e.appendChild(o);break;case"select":o=document.createElement("select"),t.groups?t.groups.forEach(r=>{let s=document.createElement("optgroup");s.label=r.label,r.options.forEach(l=>{let m=document.createElement("option");m.value=l.value,m.textContent=l.text,s.appendChild(m)}),o.appendChild(s)}):t.options&&t.options.forEach(r=>{let s=document.createElement("option");s.value=r.value,s.textContent=r.text,o.appendChild(s)}),e.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",t.options.forEach(r=>{let s=document.createElement("label");s.className="bau-task-item",s.innerHTML=`<input type="checkbox" name="${t.name}" value="${r}"><span>${r}</span>`,s.addEventListener("click",l=>{l.preventDefault();let m=s.querySelector("input");m.checked=!m.checked,s.classList.toggle("active",m.checked),$.playClick()}),o.appendChild(s)}),e.appendChild(o),e;case"datetime-group":o=document.createElement("div"),o.className="bau-availability-container",t.fields.forEach(r=>{let s=document.createElement("div");s.className="bau-availability-field",s.innerHTML=`
    ...
    `,d.appendChild(f);let g=document.createElement("div");g.id="bau-view-form",g.className="bau-view";let h=document.createElement("div");h.className="bau-view-header",h.innerHTML=`
      <button class="bau-back-btn" id="bau-form-back-btn">
        ${me.back}
        Voltar ao Dashboard
      </button>
    `,g.appendChild(h);let x=document.createElement("div");x.className="bau-content",g.appendChild(x);let k=document.createElement("div");k.className="bau-form-loading-overlay",k.innerHTML=`
        <div class="bau-spinner"></div>
        <div class="bau-loading-text">Configurando Edi\xE7\xE3o...</div>
    `,x.appendChild(k);let O=c=>{k.classList.toggle("active",c)},L=document.createElement("div");L.className="bau-progress-indicator",x.appendChild(L);let _=document.createElement("form");_.id="bau-escalation-form",_.noValidate=!0,x.appendChild(_),Ue.steps.forEach(c=>{let u=document.createElement("div");if(u.className="bau-step"+(c.id===a?" active":""),u.id=`bau-step-${c.id}`,c.isBranching)u.innerHTML=`
            ...
            `,u.querySelector("#bau-opt-full").onclick=()=>{n="BAU",a=1,_.querySelectorAll(".bau-highlight-panel").forEach(v=>v.classList.remove("discard-theme")),I(),$.playClick()},u.querySelector("#bau-opt-discard").onclick=()=>{n="DISCARD",a=5,_.querySelectorAll(".bau-highlight-panel").forEach(v=>v.classList.add("discard-theme")),I(),$.playClick()};else if(c.isConfirmation)u.innerHTML=`
                <div class="bau-card">
            ...
            `;else{let v=document.createElement("div");if(v.className="bau-card",c.id===1||c.id===5){v.innerHTML=`
                ...
                `;let y=v.querySelector(".bau-dynamic-inputs-container");c.fields.forEach(C=>{y.appendChild(Po(C))});let w=v.querySelector("#wrapper-cid");if(w){let C=document.createElement("div");C.id="bau-cid-error",C.className="bau-cid-error-hint",C.style.display="none",C.textContent="Formato de CID incorreto",w.appendChild(C)}}else c.fields.forEach(y=>{v.appendChild(Po(y))});u.appendChild(v)}_.appendChild(u)});let H=document.createElement("div");H.className="bau-footer";let J=document.createElement("button");J.type="button",J.id="bau-step-back-btn",J.className="bau-btn-secondary",J.textContent="Voltar";let oe=document.createElement("button");oe.type="button",oe.id="bau-step-next-btn",oe.className="bau-btn-primary",oe.textContent="Pr\xF3ximo";let q=document.createElement("button");q.type="submit",q.className="bau-btn-submit",q.innerHTML=`${me.send} Enviar para o TL`,q.style.display="none",H.appendChild(J),H.appendChild(oe),H.appendChild(q),_.appendChild(H),d.appendChild(g);let F=document.createElement("div");F.id="bau-view-success",F.className="bau-view bau-success-view",F.innerHTML=`
    ...
    `,d.appendChild(F),document.body.appendChild(l);function z(c){e=c,l.querySelectorAll(".bau-view").forEach(C=>C.classList.remove("active"));let u=l.querySelector(`#bau-view-${c}`);u&&u.classList.add("active");let v=m.querySelector(".cw-module-header-title")||m.querySelector("h2"),y=m.querySelector(".cw-module-header-subtitle")||m.querySelector("p");v&&(c==="form"?v.textContent=i?`Editando Caso #${r}`:"Novo Caso BAU":v.textContent="BAU Central"),y&&(y.textContent=c==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU");let w=_.querySelector(".bau-btn-submit");w&&(w.innerHTML=i?`${me.send} Salvar Altera\xE7\xF5es`:`${me.send} Enviar para o TL`)}function V(){let c=l.querySelector("#bau-case-list-container"),u=l.querySelector("#bau-dashboard-metrics");u&&(u.innerHTML=`
        ...
        `).join(""))}async function M(){let c=l.querySelector("#bau-case-list-container"),u=l.querySelector("#bau-dashboard-metrics");if(!(!c||!u)){V();try{let v=await Ut();if(!Array.isArray(v))throw new Error("API response is not a valid array");A(v)}catch(v){console.error("Critical Error loading BAU cases:",v),u&&(u.innerHTML=""),c.innerHTML=`
            ...
            `,l.querySelector("#bau-retry-btn")?.addEventListener("click",()=>M()),Z("Erro ao carregar Dashboard. Verifique sua conex\xE3o.",{error:!0})}}}function D(c){if(!c)return;let u=$o(c.status),v=(w,C)=>{navigator.clipboard.writeText(w).then(()=>{Z("Copiado para a \xE1rea de transfer\xEAncia!"),$.playClick();let S=C.style.color;C.style.color="#1E8E3E",setTimeout(()=>{C.style.color=S},800)})};b.innerHTML=`
        ...
        `;let y=b.querySelector(".bau-details-close-btn");y.onclick=()=>{b.classList.remove("active"),$.playSwoosh(),setTimeout(()=>{b.style.display="none"},600)},b.querySelectorAll(".bau-copy-btn").forEach(w=>{w.onclick=C=>{let S=C.target.closest(".bau-details-row").querySelector(".bau-details-value").textContent;v(S,w)}}),b.style.display="flex",requestAnimationFrame(()=>{b.classList.add("active"),$.playClick()})}function Y(c){if(!c)return"";let u=$o(c?.status),v=it(c?.date),y="",w="";if(c?.status==="PENDING_TL_CREATION"&&c?.availability_1){let T=new Date(c.availability_1),P=new Date;(T<=P||T-P<36e5*2)&&(y='<span class="bau-sla-badge">Urgente</span>',w="bau-pulse-attention")}let C=c?.reason&&c.reason.trim()?c.reason:"Nenhum contexto adicional fornecido pelo agente.",p=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(c?.cid||""),E=!c?.caseId||c.caseId==="N/A"||!p;return E&&c?.status==="PENDING_TL_CREATION"&&(w="bau-pulse-attention"),`
            <li class="bau-case-card ${u.aura} ${w}" data-case-id="${c?.id||""}">
        ...
        `}function A(c){let u=l.querySelector("#bau-case-list-container"),v=l.querySelector("#bau-dashboard-metrics");if(!u||!v)return;let y=Array.isArray(c)?c.filter(Boolean):[];if(y.length===0){v.innerHTML=`
            ...
            `,l.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>M());return}let w=y.filter(T=>T.status==="PENDING_TL_CREATION").length,C=y.filter(T=>T.status==="CREATED").length;v.innerHTML=`
        ...
        `;let S=v.querySelector("#bau-refresh-dashboard");S?.addEventListener("click",async()=>{S.classList.contains("spinning")||(S.classList.add("spinning"),$.playClick(),await M(),setTimeout(()=>S.classList.remove("spinning"),1e3))}),u.innerHTML="";let p=y.slice(0,5),E=y.slice(5);if(p.forEach(T=>{let P=Y(T),N=document.createElement("div");N.innerHTML=P;let Q=N.firstElementChild;Q.addEventListener("click",se=>{se.target.closest(".bau-case-edit-btn")||D(T)});let X=Q.querySelector(".bau-case-edit-btn");X&&(X.onclick=se=>{se.stopPropagation(),j(T)}),u.appendChild(Q)}),E.length>0){let T=document.createElement("li");T.className="bau-accordion-container";let P=document.createElement("button");P.className="bau-accordion-toggle",P.innerHTML=`${me.expand} <span>Mostrar ${E.length} casos mais antigos</span>`;let N=document.createElement("ul");N.className="bau-case-list bau-accordion-content",N.style.display="none",E.forEach(Q=>{let X=Y(Q),se=document.createElement("div");se.innerHTML=X;let pe=se.firstElementChild;pe.addEventListener("click",Ae=>{Ae.target.closest(".bau-case-edit-btn")||D(Q)});let Ee=pe.querySelector(".bau-case-edit-btn");Ee&&(Ee.onclick=Ae=>{Ae.stopPropagation(),j(Q)}),N.appendChild(pe)}),P.addEventListener("click",()=>{let Q=N.style.display==="none";N.style.display=Q?"block":"none",P.classList.toggle("expanded",Q),P.querySelector("span").textContent=Q?"Esconder casos mais antigos":`Mostrar ${E.length} casos mais antigos`,$.playClick()}),T.appendChild(P),T.appendChild(N),u.appendChild(T)}}function I(){let c=n==="BAU"?[1,2,3,4]:[5,4];_.querySelectorAll(".bau-step").forEach(y=>{let w=parseInt(y.id.replace("bau-step-","")),C=w===a,S=c.includes(w)||w===0;y.classList.toggle("active",C),y.style.display=C?"block":"none",y.querySelectorAll("input, select, textarea").forEach(p=>{p.disabled=!S})});let u=a===0;if(L.style.display=u?"none":"flex",!u){L.innerHTML="";let y=n==="BAU"?[1,2,3,4]:[5,4];y.forEach((w,C)=>{let S=document.createElement("div"),p=w===a,E=y.indexOf(a),T=C<E;S.className=`bau-progress-step ${p?"active":T?"completed":""}`,S.textContent=C+1,L.appendChild(S)})}let v=a===4;J.style.display=a>0?"inline-block":"none",oe.style.display=!u&&!v?"inline-block":"none",q.style.display=v?"flex":"none",v&&te()}function G(c){let u=Ue.steps.find(v=>v.id===c);if(!u||!u.fields||u.isConfirmation)return!0;for(let v of u.fields){let y=_.querySelector(`#bau-step-${c} #wrapper-${v.id}`);if(!(y&&y.style.display==="none")&&v.validation){let w=_.querySelector(`#bau-step-${c} [name="${v.name}"]`);if(w&&w.offsetParent!==null&&w.value.trim())if(new RegExp(v.validation.regex).test(w.value.trim())){w.classList.remove("invalid-cid");let S=_.querySelector("#bau-cid-error");S&&(S.style.display="none")}else{console.warn(`Validation failed for field "${v.name}" in step ${c}: Regex mismatch.`),Z(`Erro: ${v.validation.error}`,{error:!0}),w.classList.add("invalid-cid");let S=_.querySelector("#bau-cid-error");return S&&(S.style.display="flex"),!1}}}return!0}function R(c){if(!_.querySelector(`#bau-step-${c}`))return!1;let v=Ue.steps.find(w=>w.id===c);if(!v||!v.fields||v.isConfirmation)return!0;let y=!0;for(let w of v.fields){let C=_.querySelector(`#bau-step-${c} #wrapper-${w.id}`);if(!(C&&C.style.display==="none")&&w.required){let S=!0,p="";if(w.type==="checkbox-grid")_.querySelector(`#bau-step-${c} input[name="${w.name}"]:checked`)||(p="No option selected in checkbox-grid",Z(`Erro: Selecione pelo menos uma op\xE7\xE3o para "${w.label}".`,{error:!0}),S=!1);else if(w.type==="datetime-group"){let E=_.querySelector(`#bau-step-${c} input[name="${w.fields[0].name}"]`);if(!E||E.offsetParent===null)continue;E.value.trim()||(p="Datetime group first field is empty",Z(`Erro: O campo "${w.fields[0].label}" \xE9 obrigat\xF3rio.`,{error:!0}),S=!1)}else{let E=_.querySelector(`#bau-step-${c} [name="${w.name}"]`);if(!E||E.offsetParent===null)continue;E.value.trim()||(p="Field is empty",Z(`Erro: O campo '${w.label}' \xE9 obrigat\xF3rio.`,{error:!0}),S=!1)}if(!S){console.warn(`Validation failed for required field "${w.name}" in step ${c}: ${p}`),y=!1;break}}}return y}oe.addEventListener("click",()=>{if(G(a)&&R(a)){n==="BAU"?a++:a===5?a=4:a++,I();let c=l.querySelector(".bau-content");c&&(c.scrollTop=0),$.playClick()}}),J.addEventListener("click",()=>{a>0&&(n==="BAU"?a--:a===4?a=5:a===5?a=0:a--,I(),$.playClick())});async function ee(){let c=await Fe()||{};(!c.amName||c.amName==="N/A")&&(c.amName=c.internalEmail||"N/A"),o=c,_.querySelectorAll(".bau-vital-highlights").forEach(y=>{let w=[{label:"Anunciante",value:c.advName},{label:"CID",value:c.cid},{label:"Website",value:c.website||c.site},{label:"Case ID",value:c.caseId}];y.innerHTML=w.map(C=>{let S=C.value&&C.value!=="N/A"&&C.value!=="undefined"&&C.value!=="null"?C.value:"N\xE3o capturado";return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${C.label}</span>
                        <span class="bau-highlight-value">${S}</span>
                    </div>
                `}).join("")}),Ue.steps.forEach(y=>{y.fields&&y.fields.forEach(w=>{if(w.isSmart){let C=c[w.id];w.id==="language"&&c.userProfile?.defaultLanguage&&(C=c.userProfile.defaultLanguage);let S=_.querySelector(`#bau-step-${y.id} [name="${w.name}"]`),p=_.querySelector(`#bau-step-${y.id} #wrapper-${w.id}`);if(S&&(S.value=C&&C!=="N/A"?C:"",w.id==="language"&&C&&C!=="N/A"&&(S.readOnly=!0,S.style.background="#F1F3F4",S.style.cursor="not-allowed")),p){let E=C&&C!==""&&C!=="N/A"&&C!=="undefined"&&C!=="null";w.id==="language"?p.style.display="block":p.style.display=E?"none":"block"}}})}),_.querySelectorAll(".bau-all-data").forEach(y=>{let w=[{label:"Anunciante",value:c.advName},{label:"CID",value:c.cid},{label:"AM",value:c.amName},{label:"SE ID",value:c.seId},{label:"Site",value:c.website||c.site},{label:"Email",value:c.email},{label:"Timezone",value:c.timezone},{label:"Case ID",value:c.caseId},{label:"Programa",value:c.salesProgram},{label:"Idioma",value:c.language}];y.innerHTML=`
                <div class="bau-context-badges-grid">
                    ${w.filter(C=>C.value&&C.value!=="N/A"&&C.value!=="---"&&C.value!=="undefined"&&C.value!=="null").map(C=>`
            ...
            `})}l.querySelector("#bau-top-se-search")?.addEventListener("click",c=>{c.preventDefault(),ct("bau-form-seId")});let ae=l.querySelector("#bau-form-cid");ae&&ae.addEventListener("input",()=>G(1));function te(){let c=new FormData(_),u=Object.fromEntries(c.entries()),v=l.querySelector("#bau-confirmation-details");if(v){if(n==="BAU"){let y=c.getAll("taskType"),w=y.length>0?y.join(", "):"Nenhuma";v.innerHTML=`
            ...
            `;v.querySelectorAll(".bau-confirm-value-input").forEach(y=>{y.addEventListener("input",w=>{let C=w.target.dataset.field,S=w.target.dataset.step;if(!C||!S)return;let p=_.querySelector(`#bau-step-${S} [name="${C}"]`);p&&(p.value=w.target.value,C==="cid"&&G(1))})})}}async function j(c){if(!await ve("Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",{confirmText:"Estou na p\xE1gina correta"}))return;O(!0),U(),i=!0,r=c.id,n=c.status==="PENDING_TL_DISCARD"||c.reason&&!c.task?"DISCARD":"BAU",z("form"),await ee(),o={...o,advName:c.advName||o.advName,cid:c.cid||o.cid,caseId:c.caseId||o.caseId,seId:c.seId||o.seId,site:c.site||c.website||o.site||o.website,email:c.advEmail||o.email,timezone:c.timezone||o.timezone,language:c.language||o.language,amName:c.amName||o.amName,salesProgram:c.salesProgram||o.salesProgram};let v=c.availability?c.availability.split("|").map(y=>y.trim()):[];_.querySelectorAll("input, select, textarea").forEach(y=>{let w=y.name,S={advEmail:"advEmail",website:"site",site:"site"}[w]||w;if(w==="taskType"){let p=(c.task||c.taskType||"").split(",").map(E=>E.trim());y.type==="checkbox"&&(y.checked=p.includes(y.value),y.closest(".bau-task-item")?.classList.toggle("active",y.checked))}else if(w.startsWith("availability_")){let p=parseInt(w.split("_")[1])-1,E=v[p];if(E&&y.type==="datetime-local")try{let T=new Date(E);if(!isNaN(T.getTime())){let P=new Date(T.getTime()-T.getTimezoneOffset()*6e4).toISOString().slice(0,16);y.value=P}}catch{}}else c[S]!==void 0?y.value=c[S]:w==="reason"?y.value=c.reason:w==="description"?y.value=c.description:w==="nonImplementationReason"&&(y.value=c.nonImplementationReason||"")}),a=n==="BAU"?1:5,I(),$.playClick(),setTimeout(()=>O(!1),500)}_.onsubmit=async c=>{c.preventDefault();let u=n==="BAU"?[1,2,3]:[5];for(let p of u)if(!Ue.steps.find(T=>T.id===p)?.isConfirmation&&(!G(p)||!R(p))){console.warn(`Form submission blocked by validation failure in step ${p}`),a=p,I();return}let v=l.querySelector(".bau-btn-submit");v.disabled=!0,v.innerHTML="Enviando...";let y=new FormData(_),w=Object.fromEntries(y.entries()),C=o||{},S={...C,...w,requestType:n};if(w.advEmail?S.advEmail=w.advEmail:C.email&&(S.advEmail=C.email),w.website?S.website=w.website:C.website?S.website=C.website:C.site&&(S.website=C.site),n==="BAU"){let p=y.getAll("taskType"),E=[w.availability_1,w.availability_2,w.availability_3].filter(T=>T&&T.trim()!=="").join(" | ");S.taskType=p.join(", "),S.availability=E,i?(w.nonImplementationReason?S.nonImplementationReason=w.nonImplementationReason:delete S.nonImplementationReason,w.description?S.description=w.description:delete S.description):(S.nonImplementationReason=w.nonImplementationReason||"",S.description=w.description||"",S.nonImplementationReason||console.warn("Aviso: Campo 'Justificativa' (nonImplementationReason) est\xE1 saindo vazio."),S.description||console.warn("Aviso: Campo 'Descri\xE7\xE3o detalhada' (description) est\xE1 saindo vazio."))}else S.reason=w.reason,i?(w.description?S.description=w.description:delete S.description,delete S.taskType,delete S.availability,delete S.nonImplementationReason):(S.taskType="",S.availability="",S.nonImplementationReason="",S.description=w.description||"");try{i?await Vt(r,S):await jt(S,C.agentEmail||"anon"),$.playSuccess();let p=l.querySelector(".bau-success-title");p&&(i?p.textContent="Caso atualizado com sucesso!":p.textContent=n==="DISCARD"?"Caso enviado para descarte com sucesso!":"Caso enviado com sucesso!"),z("success")}catch(p){Z("Erro: "+(p.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",S)}finally{v.disabled=!1,v.innerHTML=`${me.send} Enviar para o TL`}};function U(){_.reset(),a=0,n="BAU",i=!1,r=null,I(),_.querySelectorAll(".bau-task-item.active").forEach(u=>u.classList.remove("active"));let c=_.querySelector('[name="language"]');c&&(c.readOnly=!1,c.style.background="",c.style.cursor="")}l.querySelector("#bau-new-case-btn").addEventListener("click",()=>{U(),z("form"),ee()}),l.querySelector("#bau-form-back-btn").addEventListener("click",()=>z("dashboard")),l.querySelector("#bau-success-back-btn").addEventListener("click",()=>z("dashboard"));async function K(){t=!t,l.style.display=t?"flex":"none",t&&(z("dashboard"),M()),be(t,l,"cw-btn-bauform")}return I(),K}function va(){if(window.techSolInitialized){kt();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Jt();try{$.initGlobalListeners(),$.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}de.fetchTips(),kt();let e=wo(),o=Ao(),a=To(),n=Io(),i=Do(),r=zo(),s=Ro(),l=Ho(),m=Lo();go({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:r,toggleConfigs:s,toggleBAUForm:l,broadcastControl:m}),setTimeout(()=>{de.logEvent("App","Start","Session Start"),qo(),setTimeout(()=>{_o(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),Z("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}va();})();
