...
Irei solicitar descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var ao="cw-automation-styles";if(!document.getElementById(ao)){let t=document.createElement("style");t.id=ao,t.innerHTML=`
    ...
    `,document.head.appendChild(t)}function no(t){let e=document.getElementById("cw-loading-overlay");t?e?e.style.opacity="1":(e=document.createElement("div"),e.id="cw-loading-overlay",document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1")):e&&(e.style.opacity="0",setTimeout(()=>e.remove(),300))}async function pt(t){console.log("\u{1F680} Iniciando extra\xE7\xE3o autom\xE1tica..."),await Ct();let e=document.getElementById(t),o="";no(!0),e&&(o=e.placeholder,e.placeholder="Buscando ID...",e.value="",e.classList.add("cw-scanning-active"));try{let a=document.querySelector('material-button[debug-id="dock-item-case-log"]');a&&!a.classList.contains("selected")&&(We(a),await ie(1200));let n=document.querySelector("search-filter dropdown-button .button");if(n&&!(n.innerText||"").includes("All")){We(n),await ie(600);let x=document.querySelector('material-checkbox[debug-id="check-all-box"]');x&&x.getAttribute("aria-checked")!=="true"&&(We(x),await ie(300));let b=document.querySelector('material-button[debug-id="apply-filter"]');b&&(We(b),await ie(1500))}let i=document.querySelector(".scroll-container")||document.querySelector(".case-log-container");i&&(i.scrollTop=i.scrollHeight,await ie(500));let s=Array.from(document.querySelectorAll(".message-header"));for(let p=s.length-1;p>=0;p--){let x=s[p],b=x.querySelector("i.material-icons-extended"),y=b&&b.innerText.trim()==="phone_in_talk",m=x.innerText||"",C=m.includes("Agent joined")||m.includes("outbound-call")||m.includes("Speakeasy");if(y||C){x.getAttribute("aria-expanded")==="true"||(console.log("\u{1F4C2} Expandindo mensagem de chamada...",x),e&&(e.placeholder="Lendo mensagem..."),We(x),await ie(1e3));break}}let l=Array.from(document.querySelectorAll(".preview, .speakeasy-agent-activity, .message-body, .content-container")),g=/Speakeasy.*?(P\d{15,25})/i,c=null;for(let p=l.length-1;p>=0;p--){let x=l[p];if(x.offsetParent===null)continue;let b=(x.innerText||"").match(g);if(b&&b[1]){c=b[1];break}}if(e)if(c){try{await navigator.clipboard.writeText(c)}catch{}e.tagName==="INPUT"||e.tagName==="TEXTAREA"?e.value=c:e.textContent=c,e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),P.playSuccess(),ee(`ID Localizado: ${c}`),e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(15, 157, 88, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}else P.playError(),ee("Nenhum ID encontrado.",{error:!0}),e.placeholder="N\xE3o encontrado",e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(234, 67, 53, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}catch(a){console.error("Erro na automa\xE7\xE3o:",a),ee("Erro ao processar.",{error:!0})}finally{e&&(e.classList.remove("cw-scanning-active"),e.value||(e.placeholder=o)),no(!1)}}function io(t){t.dataset.bulletEnabled!=="true"&&(t.dataset.bulletEnabled="true",(t.value.trim()===""||t.value.trim()==="\u2022")&&(t.value="\u2022 "),t.addEventListener("keydown",function(e){let o=this.selectionStart,a=this.selectionEnd,n=this.value,i=n.lastIndexOf(`
...
`+r;this.value=n.substring(0,o)+l+n.substring(a),this.selectionStart=this.selectionEnd=o+l.length}else if(e.key==="Tab")e.preventDefault(),e.shiftKey?s.startsWith("  ")&&(this.value=n.substring(0,i)+s.substring(2)+n.substring(o),this.selectionStart=this.selectionEnd=o-2):(this.value=n.substring(0,i)+"  "+s+n.substring(o),this.selectionStart=this.selectionEnd=o+2);else if(e.key==="Backspace"&&o===a&&o>0){let r=n.substring(0,o);r.endsWith("\u2022 ")?(e.preventDefault(),this.value=r.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2):r.endsWith("  ")&&s.trim().startsWith("\u2022")&&(e.preventDefault(),this.value=r.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2)}}))}function It(t,e,o){if(e.innerHTML="",!!De[t]&&(o.activeFields.forEach(n=>{if(["TAGS_IMPLEMENTED","SCREENSHOTS_LIST","CONSENTIU_GRAVACAO","CASO_PORTUGAL","label_substatus"].includes(n))return;let i=`field-${n}`,s=document.createElement("label"),r=p=>Ie[o.currentLang]?.[p]||Ie.pt?.[p]||p;s.textContent=r(n.toLowerCase())!==n.toLowerCase()?r(n.toLowerCase()):n.replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase())+":",Object.assign(s.style,{display:"flex",alignItems:"center",justifyContent:"space-between",fontSize:"13px",fontWeight:"700",color:j.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let l=document.createElement("span");if(l.textContent=s.textContent,s.innerHTML="",s.appendChild(l),n==="SPEAKEASY_ID"){let p=document.createElement("button");p.innerHTML="\u2728 Auto Busca",p.style.cssText=`font-size: 11px; font-weight: 700; color: ${j.primary}; background-color: ${j.primaryBg}; border: none; border-radius: ${me.pill}; padding: 6px 14px; margin-left: 10px; cursor: pointer; transition: all 0.2s ${de};`,p.onmouseenter=()=>p.style.backgroundColor="#d2e3fc",p.onmouseleave=()=>p.style.backgroundColor=j.primaryBg,p.onclick=x=>{x.preventDefault(),pt(i)},s.appendChild(p)}let g=document.createElement("button");g.innerHTML="\u2715",g.style.cssText=`font-size: 14px; background: ${j.bgInput}; border: none; color: ${j.textSub}; cursor: pointer; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-left: auto; transition: all 0.2s ${de};`,g.onmouseenter=()=>{g.style.background=j.error,g.style.color=j.surface},g.onmouseleave=()=>{g.style.background=j.bgInput,g.style.color=j.textSub},g.onclick=async p=>{p.preventDefault(),await ve(`Tem certeza que deseja remover o campo "${l.textContent.replace(":","")}"?`)&&(o.removeField(n),It(t,e,o))},s.appendChild(g);let c;Je.includes(n)?(c=document.createElement("textarea"),c.classList.add("bullet-textarea","cw-textarea"),c.placeholder="Utilize marcadores para detalhar...",io(c)):ct.includes(n)?(c=document.createElement("textarea"),c.classList.add("cw-textarea"),c.placeholder="Descreva as considera\xE7\xF5es..."):(c=document.createElement("input"),c.type="text",c.classList.add("cw-input")),c.id=i,c.value=o.formData[i]||"",c.addEventListener("input",p=>o.updateField(i,p.target.value)),e.appendChild(s),e.appendChild(c)}),o.activeFields.includes("CONSENTIU_GRAVACAO"))){let n=r=>Ie[o.currentLang]?.[r]||Ie.pt?.[r]||r,i=document.createElement("label");i.textContent=n("consentiu_gravacao"),Object.assign(i.style,{display:"block",fontSize:"13px",fontWeight:"700",color:j.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let s=document.createElement("select");s.className="cw-select",s.innerHTML=`
            <option value="false">${n("nao")}</option>
            <option value="true">${n("sim")}</option>
        `,s.value=o.consent?"true":"false",s.onchange=()=>o.setConsent(s.value==="true"),e.appendChild(i),e.appendChild(s)}}function Lt(t,e,o,a=null){let n=t.currentSubStatus;if(!n)return null;let i=De[n],s=Ie[t.currentLang]||Ie.pt,r=c=>s[c]||Ie.pt?.[c]||c,l='style="margin-bottom: 12px; padding-left: 30px;"',g="";if(t.activeFields.forEach(c=>{let p=r(c.toLowerCase()),x="N/A";if(c==="label_substatus")p=r("label_substatus"),x=i.name;else if(c==="TAGS_IMPLEMENTED"){p=r("tags_implemented");let b=[];e.getCheckedElements().forEach(m=>{let C=m.value,_=Le[C],F=m.count||1,q=C==="ads_conversion_tracking"||C==="ads_enhanced_conversions";t.tagSupportUsed&&q&&!t.forcedScreenshots.has(C)?b.push(`${_.name} - ${r("ts_output_disclaimer")}`):b.push(F>1?`${_.name} (x${F})`:_.name)}),x=b.join(", ")||"N/A"}else if(c==="SCREENSHOTS_LIST"){p=r("screenshots_list");let b="",y=e.screenshotsElement;y&&Array.from(y.querySelectorAll('input[id^="name-"]')).forEach(C=>{let _=C.value,F=C.closest(".cw-screen-card");if(F){let q=F.querySelectorAll('input[id^="screen-"]'),$=!1,W="";q.forEach(ae=>{let I=ae.closest(".cw-input-group")?.querySelector(".cw-input-label")?.textContent||"Evid\xEAncia",H=ae.value.trim();H&&(W+=`<li>${I} - ${H}</li>`,$=!0)}),$&&(b+=`<div style="margin-bottom: 8px;"><b>${_}</b><ul ${l}>${W}</ul></div>`)}}),x=b||"N/A"}else if(c==="CASO_PORTUGAL")p=r("caso_portugal"),x=r("sim");else if(c==="CONSENTIU_GRAVACAO")p=r("consentiu_gravacao"),x=t.consent?r("sim"):r("nao");else{let b=`field-${c}`,y=t.formData[b],m="";if(i.fieldPrefixes&&i.fieldPrefixes[c]&&(m=i.fieldPrefixes[c]+" "),y&&y.trim()!==""&&y.trim()!=="\u2022"){let C=y.trim();if(Je.includes(c)){let _=C.split(`
`).map(F=>F.trim()).filter(F=>F!==""&&F!=="\u2022").map(F=>F.startsWith("\u2022 ")?F.substring(2):F).map(F=>`<li>${F}</li>`).join("");x=_?`${m}<ul ${l}>${_}</ul>`:"N/A"}else ct.includes(c)?x=m+C.split(`
`).filter(_=>_.trim()!=="").map(_=>`<p style="margin: 0 0 8px 0;">${_}</p>`).join(""):x=m+C}else m&&(x=m.trim())}g+=`<b>${p}</b><br>${x}<br><br>`}),a){let c="";a.l1&&(c+=`<li>${r("ligacao_1")}: ${a.l1}</li>`),a.l2&&(c+=`<li>${r("ligacao_2")}: ${a.l2}</li>`),a.msg&&(c+=`<li>${r("mensagem_am")}: ${a.msg}</li>`),c&&(g+=`<b>${r("evidencias_contato")}</b><br><ul ${l}>${c}</ul><br>`)}if(i.customFooter&&(g+=`${i.customFooter}<br><br>`),o?.getOutput){let c=o.getOutput();c&&(g+=`${c}<br><br>`)}return g+="<i>Nota criada atrav\xE9s do Cases Wizard.</i>",g.replace(/(<br>\s*){3,}/g,"<br><br>").trim()}function so(t){let e=document.createElement("div");e.className="cw-step-scenarios";let o="Passe o mouse sobre um cen\xE1rio para visualizar o texto...",a=document.createElement("div");Object.assign(a.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let n=document.createElement("div");Object.assign(n.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"44px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s cubic-bezier(0.4, 0, 0.2, 1)",overflow:"hidden"});let i=document.createElement("span");i.style.transition="opacity 0.2s ease, transform 0.2s ease",i.textContent=o,n.appendChild(i);let s=new Set,r=null;return e.render=(l,g)=>{s.clear();let c=Object.entries(dt).filter(([p,x])=>{let b=!x.type||x.type==="all"||x.type===g,y=!1;return l.startsWith("NI_")?y=p.includes("-ni-")||p.includes("attempted"):l.startsWith("SO_")?y=p.includes("gtm")||p.includes("whatsapp")||p.includes("form")||p.includes("ecw4")||p.includes("ga4")||p.includes("-so-"):l.startsWith("AS_")?y=p.includes("-as-"):l.startsWith("IN_")?y=p.includes("-in-"):l.startsWith("DC_")&&(y=p.includes("-dc-")),b&&y});a.innerHTML="",c.forEach(([p,x])=>{let b=document.createElement("div"),y=p.replace("quickfill-","").replace(/-/g," ");b.textContent=y,b.dataset.id=p,Object.assign(b.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)"});let m=x["field-REASON_COMMENTS"]||x["field-CONTEXTO_CALL"]||p;b.onmouseenter=()=>{r&&clearTimeout(r),s.has(p)||(b.style.background="#f1f3f4"),i.style.opacity="0",i.style.transform="translateY(5px)",r=setTimeout(()=>{i.textContent=m.substring(0,120)+(m.length>120?"...":""),i.style.opacity="1",i.style.transform="translateY(0)"},50)},b.onmouseleave=()=>{r&&clearTimeout(r),s.has(p)||(b.style.background="#ffffff"),r=setTimeout(()=>{s.size===0&&(i.style.opacity="0",setTimeout(()=>{i.textContent=o,i.style.opacity="1"},50))},100)},b.onclick=()=>{P.playClick();let C=!s.has(p);C?(s.add(p),b.style.background="#e8f0fe",b.style.borderColor="#1a73e8",b.style.color="#1967d2"):(s.delete(p),b.style.background="#ffffff",b.style.borderColor="#dadce0",b.style.color="#3c4043"),t(p,C)},a.appendChild(b)}),c.length===0?e.style.display="none":e.style.display="block"},e.appendChild(a),e.appendChild(n),e}var se={bg:j.bgInput,white:j.surface,border:j.border,textMain:j.text,textSub:j.textSub,blue:j.blue,blueLight:j.primaryBg,brands:{ads:{id:"ads",label:"Google Ads",color:j.blue,bg:j.primaryBg,icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:j.yellow,bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:j.primary,bg:j.primaryBg,icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:j.green,bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},je={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function ro(t,e,o){let a={},n="implementation";o&&o.subscribe(()=>{W(),ae()});function i(B){let I=B.toLowerCase();return I.includes("ads")||I.includes("conversion")||I.includes("remarketing")?se.brands.ads:I.includes("ga4")||I.includes("analytics")?se.brands.ga4:I.includes("gtm")||I.includes("tag manager")||I.includes("container")?se.brands.gtm:I.includes("merchant")||I.includes("shopping")||I.includes("feed")?se.brands.gmc:se.brands.default}let s=Object.entries(Le).filter(([B,I])=>I.popular),r={};Object.entries(Le).forEach(([B,I])=>{if(I.popular)return;let H=i(I.name);r[H.label]||(r[H.label]={brand:H,tasks:[]}),r[H.label].tasks.push({key:B,...I})});let l="cw-zen-tasks";if(!document.getElementById(l)){let B=document.createElement("style");B.id=l,B.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let x=g.querySelector(".cw-hero-grid"),b=g.querySelector(".cw-acc-container"),y=g.querySelector(".cw-results-container"),m=g.querySelector(".cw-search-input"),C=g.querySelector(".cw-status-bar"),_=g.querySelector(".cw-status-text"),F=g.querySelector(".cw-footer-icons");s.forEach(([B,I])=>{let H=i(I.name),K=document.createElement("div");K.className="cw-hero-card",K.id=`hero-${B}`,K.style.setProperty("--hero-color",H.color),K.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${je[H.icon]}</div>
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(m,C)=>{P.playClick(),a.querySelector(`.${m}`).classList.toggle("active"),C()};if(a.querySelector(".notes").onclick=m=>{m.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=m=>{m.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=m=>{m.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=m=>{m.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=m=>{m.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=m=>{m.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=m=>{m.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=m=>{m.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=m=>{m.stopPropagation(),i("broadcast",()=>{let C=m.currentTarget.querySelector(".cw-badge");C&&C.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(m=>{m.addEventListener("mouseenter",()=>P.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let m=document.createElement("div");m.className="cw-badge",a.querySelector(".broadcast").appendChild(m)}let s=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(s=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{s&&clearTimeout(s)},(async function(){let C=()=>{let F=fe();if(F){let q=F.split("@")[0].toLowerCase();if(mt.includes(q)){let $=a.querySelector("#cw-admin-tag");$&&$.classList.add("visible")}}else setTimeout(C,2e3)};C(),await ie(2800),a.classList.add("docked"),await ie(300);let _=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(F=>F.classList.add("visible"));for(let F=0;F<_.length;F++)_[F].classList.add("popped"),await ie(40);await ie(100),a.classList.add("system-check"),await ie(100),a.classList.add("system-ready"),setTimeout(()=>a.classList.remove("system-ready"),400)})();let r=!1,l,g,c,p,x=3;a.onmousedown=m=>{if(m.target.closest("button"))return;m.preventDefault(),l=m.clientX,g=m.clientY;let C=a.getBoundingClientRect();c=C.left,p=C.top,document.addEventListener("mousemove",b),document.addEventListener("mouseup",y)};function b(m){let C=m.clientX-l,_=m.clientY-g;!r&&Math.sqrt(C*C+_*_)>x&&(r=!0,a.classList.add("dragging"),a.style.transition="none",s&&clearTimeout(s)),r&&(a.style.left=`${c+C}px`,a.style.top=`${p+_}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function y(m){if(document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",y),r){r=!1,a.classList.remove("dragging");let C=window.innerWidth,_=window.innerHeight,F=a.getBoundingClientRect(),q=F.left+F.width/2,$;q<C/2?($=24,a.classList.remove("side-right"),a.classList.add("side-left")):($=C-F.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let W=Math.max(24,Math.min(F.top,_-F.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.3s cubic-bezier(0.4, 0, 0.2, 1), top 0.3s cubic-bezier(0.4, 0, 0.2, 1)","important"),a.style.left=`${$}px`,a.style.top=`${W}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let C=a.querySelector(".cw-btn.active"),_=m.target.closest("button");if(a.classList.contains("collapsed")){let F=a.getBoundingClientRect(),q=window.innerHeight,$=F.top>q/2;if(a.style.setProperty("transition","none","important"),$){let W=q-F.bottom;a.style.top="auto",a.style.bottom=`${W}px`}else a.style.bottom="auto",a.style.top=`${F.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),P.playGenieOpen()}else!C&&!_&&(a.classList.add("collapsed"),P.playGenieOpen());_&&(_.style.transform="scale(0.9)",setTimeout(()=>_.style.transform="",150))}}}function tt(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,ee("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let s=Date.now()-n,r=Math.max(0,2e3-s);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let l=o.querySelector(".cw-center-dots"),g=o.querySelector(".cw-center-text"),c=o.querySelector(".cw-center-success"),p=o.querySelector(".cw-abort-btn");l&&(l.style.display="none"),g&&(g.style.display="none"),p&&(p.style.display="none"),c&&c.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},r)}}function po(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let g=document.createElement("div");g.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",g.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let c=document.createElement("button");c.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',c.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",c.onmouseenter=()=>c.style.background="#F1F3F4",c.onmouseleave=()=>c.style.background="transparent",c.onclick=()=>x(!1),g.appendChild(c);let p=document.createElement("div");p.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",l.appendChild(g),l.appendChild(p);function x(y){let m=l.style.transform==="translateY(0%)";(y!==void 0?y:!m)?(b(),l.style.transform="translateY(0%)"):l.style.transform="translateY(110%)"}function b(){let y=we.getAll();if(p.innerHTML="",y.length===0){p.innerHTML=`
                ...
                </div>`;return}y.forEach(m=>{let C=document.createElement("div");C.style.cssText=`
...
`.replace(/\n/g,"<br>");ot(B);let I=await ft();I?(I.innerText.trim()===""&&(I.innerHTML=""),document.execCommand("insertHTML",!1,B),bt(I),ee("Nota gerada e inserida!")):ee("Copiado! Abra uma nota para colar.")},e}function ke(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function xt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
        position: fixed;
        top: ${n.bottom+8}px;
        left: ${n.left}px;
        min-width: 300px;
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let s=i.querySelector(".cw-close-btn");s.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&s.click()},25e3)}async function ht(t,e){if(!t||!e)return;t.focus(),t.value="",t.dispatchEvent(new Event("input",{bubbles:!0})),await ie(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(t,e),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0})),await ie(100),t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function qt(){let e=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let a=o.offsetParent!==null,n=o.closest("case-message-view")!==null,i=o.closest(".editor")!==null||o.closest("write-card")!==null;return a&&!n&&i});return e&&ke("Editor visualmente detectado.","success"),e}async function go(){ke("\u{1F680} FASE 1: Tentando abrir a janela de email...");let t=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(p=>p.innerText.trim()==="email");if(o&&o.offsetParent!==null){ke("Bot\xE3o de email direto encontrado.");let p=o.closest("material-button")||o.closest("material-fab")||o;he(p),t=!0}else{ke("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let p=document.querySelector("material-fab-speed-dial");if(p){let x=p.querySelector(".trigger");if(x){he(x),await ie(800);let y=Array.from(document.querySelectorAll("i.material-icons-extended")).find(m=>m.innerText.trim()==="email");y&&(he(y),t=!0)}}}if(!t)return ee("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;ke("\u{1F680} FASE 2: Verificando rascunhos...");let a=null,n=0,i=20;for(;n<i;){await ie(250);let p=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(a=Array.from(p).find(x=>x.offsetParent!==null),a){ke("\u26A0\uFE0F Rascunho detectado!","warn");break}n++}if(a){ke("\u{1F5D1}\uFE0F Descartando..."),he(a),a.click();let p=null,x=0;for(;x<15;){await ie(300);let b=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(p=Array.from(b).find(y=>y.offsetParent!==null),p)break;x++}p&&(he(p),ee("Limpando rascunho antigo...",{duration:2e3}),await ie(2500))}ke("\u{1F680} FASE 3: Buscando editor final...");let s=0,r=null;for(;s<20&&(r=qt(),!r);)await ie(250),s++;if(!r)return ee("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let l=r.closest('[id="email-body-content-top"]'),c=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(l){if(c){let x=c.closest('[aria-hidden="true"]');x&&x.removeAttribute("aria-hidden"),c.focus(),he(c)}await ie(300),l.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let p=l.querySelector("#cases-body-field");if(p){let x=document.createRange();x.selectNodeContents(p),x.collapse(!0);let b=window.getSelection();b.removeAllRanges(),b.addRange(x)}return!0}return!1}async function yt(t){if(!t||!await go())return;let o=await Fe();ke("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let a=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(a&&(a.click(),await ie(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await ht(i,o.clientEmail),xt(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await ht(i,o.internalEmail),xt(i,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}await ie(500);let n=document.querySelector('material-button[debug-id="canned_response_button"]');if(n){he(n),await ie(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){he(i),document.execCommand("insertText",!1,t),i.dispatchEvent(new Event("input",{bubbles:!0})),ke("\u23F3 Buscando resultado da Canned Response...","info");let s=null,r=0,l=15e3,g=500;for(;r<l&&(s=document.querySelector("material-select-dropdown-item"),!s);)await ie(g),r+=g;if(s){he(s),await ie(1500);let c=qt();if(c){let x=Array.from(c.querySelectorAll("span.field")).filter(y=>y.innerText.includes("{Requested Task Type}"));if(x.length>0){let y=x.map(C=>C.closest("tr")).filter(C=>C!==null),m=[...new Set(y)];if(m.length>0){let _=m[0].querySelector('td[width="100%"]');_&&(_.innerHTML='<span class="field" style="color:rgb(60, 64, 67)">Enhanced Conversions - Aguardando Valida\xE7\xE3o - Dentro de 7 dias</span>');for(let F=1;F<m.length;F++)m[F].remove()}}let b=c.innerHTML;o.advertiserName&&b.includes("{%ADVERTISER_NAME%}")&&(b=b.replace(/{%ADVERTISER_NAME%}/g,o.advertiserName)),b.includes("{%^79285%}")&&(b=b.replace(/{%\^79285%}/g,o.websiteUrl||"seu site")),c.innerHTML=b}ee("Canned Response aplicada!")}else ke(`\u274C Timeout: Resultado '${t}' n\xE3o apareceu ap\xF3s 15s.`,"error"),ee(`Timeout: Template '${t}' n\xE3o carregou.`,{error:!0})}}else ee("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function bo(t){if(ke(`\u{1F680} Iniciando Quick Email: ${t.name}`),!await go())return;let o=await Fe(),a=Qe();await ie(600);let n=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(n&&(n.click(),await ie(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let r=document.querySelector('input[aria-label="Enter To email address"]');r&&(await ht(r,o.clientEmail),xt(r,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let r=document.querySelector('input[aria-label="Enter Bcc email address"]');r&&(await ht(r,o.internalEmail),xt(r,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}let i=document.querySelector('input[aria-label="Subject"]');i&&t.subject&&(i.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(i,t.subject),i.dispatchEvent(new Event("input",{bubbles:!0})),await ie(300));let s=qt();if(s){let l=(s.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');l&&(l.focus(),he(l));let g=new Date;g.setDate(g.getDate()+3);let c=g.getDay();c===6?g.setDate(g.getDate()+2):c===0&&g.setDate(g.getDate()+1);let p=g.toLocaleDateString("pt-BR"),x=t.body;x=x.replace(/\[Nome do Cliente\]/g,o.advertiserName||"Cliente"),x=x.replace(/\[INSERIR URL\]/g,o.websiteUrl||"seu site"),x=x.replace(/\[URL\]/g,o.websiteUrl||"seu site"),x=x.replace(/\[Seu Nome\]/g,a),x=x.replace(/\[MM\/DD\/YYYY\]/g,p),document.execCommand("insertHTML",!1,x),l&&(l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))),ee("Email preenchido com sucesso!",{duration:2e3}),ke("\u2705 Processo finalizado com sucesso.","success")}else ee("Erro ao focar no editor.",{error:!0})}if(!document.getElementById("cw-module-styles")){let t=document.createElement("style");t.id="cw-module-styles",t.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
    ...
    `,document.head.appendChild(t)}function be(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let c=a.getBoundingClientRect();i.x=c.left+c.width/2,i.y=c.top+c.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let c=e.getBoundingClientRect();s=c.left+c.width/2,r=c.top+c.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,g=i.y-r;t?(P.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${g}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${g}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof fo=="function"&&fo(e,o)):(P.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${g}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${g}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof _t=="function"&&_t(e))}function fo(t,e){_t(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function _t(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function xo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=oo(t,K),s=lo(f),r=ro(()=>{M(),J.setActiveTasks(r.getCheckedElements())},f,J),l=document.createElement("div");l.style.display="none";let g=so((u,L)=>{Z(u,L)});l.appendChild(g);let c=document.createElement("div");c.id="evidence-container",Object.assign(c.style,{display:"none",marginTop:"16px",padding:"16px",background:j.bgInput,border:`1px solid ${j.border}`,borderRadius:me.medium,boxShadow:Re.subtle});let p=document.createElement("div");p.className="cw-section-title",p.textContent=f("evidencias_contato"),c.appendChild(p);let x={},b=(u,L)=>{let N=document.createElement("div");N.style.marginBottom="12px";let X=document.createElement("label");X.textContent=L,X.setAttribute("for",u),X.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${j.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let V=document.createElement("input");return V.type="text",V.id=u,V.className="cw-input",V.placeholder="https://screenshot.googleplex.com/...",V.style.marginBottom="0",N.appendChild(X),N.appendChild(V),x[u]=V,N};c.appendChild(b("evidence-l1",f("ligacao_1"))),c.appendChild(b("evidence-l2",f("ligacao_2"))),c.appendChild(b("evidence-msg",f("mensagem_am")));let y=po({onSaveCurrent:async()=>{let u=await d();return Q(),u},onLoadDraft:u=>{k(u)},t:u=>f(u)}),m=D(),C=U(),_=document.createElement("div"),F=A(),q=oe(y,f);o.appendChild(m),o.appendChild(C),o.appendChild(F),o.appendChild(l),o.appendChild(_),o.appendChild(c),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let $=document.createElement("button");$.id="manual-task-toggle",$.textContent=f("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",$.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${j.primary}; background: ${j.surface}; color: ${j.primary}; border-radius: ${me.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${de}; text-transform: uppercase; letter-spacing: 0.5px;`,$.onmouseenter=()=>{$.style.background=j.primaryBg},$.onmouseleave=()=>{$.style.background=j.surface},$.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",$.style.display="none"},o.appendChild($),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(q);let W=document.createElement("div");W.style.display="none",W.style.flexGrow="1",W.style.minHeight="0",W.style.overflow="hidden";let ae=mo(()=>G());ae.style.height="100%",W.appendChild(ae),e.insertBefore(W,i);let B=a.lastElementChild;B&&(B.insertBefore(y.historyBtnWrapper,B.firstChild),B.insertBefore(S(),B.firstChild)),e.appendChild(y.drawer);let I=null;J.subscribe(u=>{T(u),H(),u.isDirty?(I&&clearTimeout(I),I=setTimeout(async()=>{let L=await d(!0);L.subStatus?we.saveEmergency(L):we.clearEmergency(),u.isDirty=!1},2e3)):I&&(clearTimeout(I),I=null)});function H(){let u=we.getCount()>0,L=!!J.currentSubStatus;gt(u||L)}function K(){J.visible=!J.visible,be(J.visible,e,"cw-btn-notes")}function G(){J.isSplitView=!J.isSplitView,J.isSplitView?(o.style.display="none",W.style.display="flex",W.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",W.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function D(){let u=document.createElement("div");if(u.innerHTML=`
        ...
        `;let L=u.querySelector("#main-status-select"),N=u.querySelector("#sub-status-select");return L.onchange=()=>{J.setStatus(L.value),w(L.value,N),J.setSubStatus(""),E("")},N.onchange=()=>{J.setSubStatus(N.value),E(N.value)},u}function h(){return c.style.display==="none"?null:{l1:x["evidence-l1"]?.value.trim()||"",l2:x["evidence-l2"]?.value.trim()||"",msg:x["evidence-msg"]?.value.trim()||""}}function w(u,L){if(L.innerHTML=`<option value="">${f("select_substatus")}</option>`,!u){L.disabled=!0;return}for(let N in De)if(De[N].status===u){let X=document.createElement("option");X.value=N,X.textContent=De[N].name,L.appendChild(X)}L.disabled=!1}function E(u){let L=De[u],N=u==="NI_Attempted_Contact"||L&&L.name&&L.name.toLowerCase().includes("attempted contact");if(g.render&&g.render(u,J.currentCaseType),!u){c.style.display="none",x["evidence-l1"]&&(x["evidence-l1"].value=""),x["evidence-l2"]&&(x["evidence-l2"].value=""),x["evidence-msg"]&&(x["evidence-msg"].value=""),l.style.display="none",_.style.display="none";let le=document.getElementById("manual-task-toggle");le&&(le.style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",F.style.display="flex",F.style.opacity="1",q.style.display="none";return}N?c.style.display="block":(c.style.display="none",x["evidence-l1"]&&(x["evidence-l1"].value=""),x["evidence-l2"]&&(x["evidence-l2"].value=""),x["evidence-msg"]&&(x["evidence-msg"].value="")),F.style.opacity="0",setTimeout(()=>{J.currentSubStatus&&(F.style.display="none")},400),q.style.display="grid",L&&L.templateFields&&J.setActiveFields(L.templateFields),z(),It(u,_,J),_.style.display="block",l.style.display="block";let X=u.startsWith("SO_"),V=u==="NI_Awaiting_Validation",te=document.getElementById("manual-task-toggle");X||V?(r.selectionElement.style.display="block",te.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",te.style.display="block");let Y=u==="SO_Education_Only"?"education":"implementation";J.setScreenshotMode(Y),J.currentCaseType==="lm"?J.toggleFieldExclusion("field-ON_CALL",!0):J.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(u),M();let ne=document.getElementById("email-automation-toggle-row");ne&&(ne.style.display=Xe[u]?"flex":"none")}function M(){let u=r.getCheckedElements().map(L=>L.value);s.updateVisibility(J.currentSubStatus,u)}function Z(u,L){let N=dt[u];if(N){for(let X in N)if(X==="linkedTask")r.toggleTask(N.linkedTask,L);else if(X==="activeTasks")N.activeTasks.forEach(V=>{L?r.setTaskCount(V.value,V.count):r.setTaskCount(V.value,0)});else if(X.startsWith("field-")){let V=X,te=N[X],Y=document.getElementById(V);if(Y){let ne=Je.includes(V.replace("field-",""));if(L)if(ne){let le=Y.value.trim();le.includes(te.trim())||(Y.value=le?le+`
...
`))}else Y.value.trim()===te.trim()&&(Y.value="");J.updateField(V,Y.value),Y.dispatchEvent(new Event("input"))}}}}function oe(u,L){let N=document.createElement("div");if(N.className="cw-actions-section",N.style.cssText=`
    ...
    `,document.head.appendChild(g),Object.assign(l.style,ye,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let c=ge(l,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:l},()=>U()),p=document.createElement("div");Object.assign(p.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:r.bgApp});let x=document.createElement("div");Object.assign(x.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${r.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let b=document.createElement("div");Object.assign(b.style,{padding:"16px",borderBottom:`1px solid ${r.borderSubtle}`,position:"relative"});let y=document.createElement("input");y.placeholder="Buscar templates...",Object.assign(y.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:r.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),y.onfocus=()=>{y.style.backgroundColor="#FFFFFF",y.style.borderColor=r.primary,y.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",y.style.transform="scale(1.02)"},y.onblur=()=>{y.style.backgroundColor="#E3E3E8",y.style.borderColor="transparent",y.style.boxShadow="none",y.style.transform="scale(1)"};let m=document.createElement("div");m.id="email-template-list",Object.assign(m.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let C=document.createElement("div");C.innerHTML="\u2715",Object.assign(C.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),C.onclick=()=>{y.value="",n="",C.style.display="none",w(),y.focus()},b.appendChild(y),b.appendChild(C),x.appendChild(b),x.appendChild(m);let _=document.createElement("div");Object.assign(_.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:r.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let F=document.createElement("div");Object.assign(F.style,{padding:"20px",borderBottom:`1px solid ${r.borderSubtle}`,backgroundColor:r.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let q=document.createElement("div");Object.assign(q.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:r.bgApp,overflow:"hidden"});let $=document.createElement("div");Object.assign($.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let W=document.createElement("span");W.textContent="Preview do E-mail",Object.assign(W.style,{fontSize:"12px",fontWeight:"600",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let ae=document.createElement("div");Object.assign(ae.style,{display:"flex",gap:"8px"});let B=(O,R=!1)=>{let z=document.createElement("button");return z.textContent=O,Object.assign(z.style,{padding:"8px 14px",borderRadius:"10px",border:R?"none":`1.5px solid ${r.primary}`,background:R?r.primary:"transparent",color:R?"#fff":r.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:R?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),z.onmouseenter=()=>{R?(z.style.backgroundColor="#0062CC",z.style.transform="translateY(-1px)",z.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):z.style.backgroundColor="rgba(0, 122, 255, 0.05)"},z.onmouseleave=()=>{R?(z.style.backgroundColor=r.primary,z.style.transform="translateY(0)",z.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(z.style.backgroundColor="transparent",z.style.transform="translateY(0)")},z.onmousedown=()=>z.style.transform="scale(0.94)",z.onmouseup=()=>z.style.transform="scale(1)",z},I=B("Copiar HTML"),H=B("Preencher no CRM",!0),K=B("Smart CR");K.style.borderColor="#E67E22",K.style.color="#E67E22",K.style.display="none",ae.appendChild(K),ae.appendChild(I),ae.appendChild(H),$.appendChild(W),$.appendChild(ae);let G=document.createElement("div");G.contentEditable="true",Object.assign(G.style,{flex:"1",backgroundColor:r.bgSurface,border:`1px solid ${r.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:r.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),q.appendChild($),q.appendChild(G),oe(),_.appendChild(F),_.appendChild(q),p.appendChild(x),p.appendChild(_),l.appendChild(c),l.appendChild(p);let D=document.createElement("div");Object.assign(D.style,qe),l.appendChild(D),_e(l,D),document.body.appendChild(l);function U(){e=!e,e?(l.style.display="flex",Jt(l),o.length===0&&h()):l.style.display="none",be(e,l,"cw-btn-email")}async function h(){m.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await yo.getTemplates(),w()}function w(){m.innerHTML="";let O=o.filter(v=>v.name.toLowerCase().includes(n.toLowerCase())||v.category.toLowerCase().includes(n.toLowerCase())),R=Object.entries(Xe).filter(([v,k])=>k&&(v.toLowerCase().includes(n.toLowerCase())||k.toLowerCase().includes(n.toLowerCase()))).map(([v,k])=>({id:v,name:v.replace(/_/g," "),category:"\u26A1 Smart CRs",code:k,isSmartCR:!0})),z=Ee.getSnippets("email").filter(v=>v.title.toLowerCase().includes(n.toLowerCase())||v.subject&&v.subject.toLowerCase().includes(n.toLowerCase())).map(v=>{let k=[],f=v.content.match(/\[([^\]]+)\]/g);return f&&[...new Set(f)].forEach(S=>{k.push({key:S,label:S.replace("[","").replace("]",""),type:S.toLowerCase().includes("data")?"date":"text",auto:S.toLowerCase().includes("nome")&&S.toLowerCase().includes("seu")?"agentName":null})}),{id:v.id||`snippet-${Math.random()}`,name:v.title,category:"\u{1F464} Pessoal",subject:v.subject||"Sem Assunto",template:v.content,placeholders:k}}),Q=[...O,...R,...z];if(Q.length===0){m.innerHTML=`
                ...
                </div>`;return}[...new Set(Q.map(v=>v.category))].sort((v,k)=>v.localeCompare(k)).forEach(v=>{let k=s.has(v)||n.length>0,f=Q.filter(N=>N.category===v),S=document.createElement("div");Object.assign(S.style,{padding:"12px 16px 12px 24px",fontSize:"11px",fontWeight:"700",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.8px",position:"sticky",top:"-8px",backgroundColor:"rgba(239, 239, 240, 0.9)",zIndex:"10",backdropFilter:"blur(20px)",margin:"0 -8px 8px -8px",borderBottom:`0.5px solid ${r.borderSubtle}`,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none",transition:"background-color 0.2s ease"}),S.onmouseenter=()=>S.style.backgroundColor="rgba(230, 230, 232, 0.9)",S.onmouseleave=()=>S.style.backgroundColor="rgba(239, 239, 240, 0.9)";let A=document.createElement("span");A.textContent=v,S.appendChild(A);let T=document.createElement("span");T.textContent=f.length,Object.assign(T.style,{backgroundColor:"rgba(0, 0, 0, 0.05)",padding:"2px 8px",borderRadius:"10px",fontSize:"10px",color:r.textSecondary});let u=document.createElement("span");u.innerHTML=k?"\u{10012A}":"\u{10012B}",u.innerHTML=k?"\u25BE":"\u25B8",u.style.marginLeft="8px",u.style.transition="transform 0.3s ease";let L=document.createElement("div");L.style.display="flex",L.style.alignItems="center",L.appendChild(T),L.appendChild(u),S.appendChild(L),S.onclick=()=>{s.has(v)?s.delete(v):s.add(v),w()},m.appendChild(S),k&&f.forEach(N=>{let X=a&&a.id===N.id,V=document.createElement("div");if(Object.assign(V.style,{padding:"12px 14px",fontSize:"14px",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)",borderRadius:"10px",color:r.textPrimary,margin:"4px 6px",display:"flex",alignItems:"center",gap:"12px",backgroundColor:X?r.primary:r.bgSurface,boxShadow:X?"0 4px 12px rgba(0, 122, 255, 0.3)":"0 1px 2px rgba(0,0,0,0.05)",border:X?"none":`1px solid ${r.borderSubtle}`,position:"relative",overflow:"hidden"}),X){let ne=document.createElement("div");Object.assign(ne.style,{position:"absolute",left:"0",top:"0",bottom:"0",width:"4px",backgroundColor:"#fff",borderRadius:"0 4px 4px 0"}),V.appendChild(ne)}let te=document.createElement("span");te.innerHTML=N.isSmartCR?"\u26A1":N.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",te.style.fontSize="12px",te.style.opacity="0.7",te.style.flexShrink="0",V.appendChild(te);let Y=document.createElement("span");Y.textContent=N.name,Y.style.overflow="hidden",Y.style.textOverflow="ellipsis",Y.style.whiteSpace="nowrap",Y.style.flex="1",V.appendChild(Y),X&&(V.style.color="#fff",V.style.fontWeight="600",te.style.opacity="1"),V.onmouseenter=()=>{X||(V.style.backgroundColor="#f8f8f9",V.style.transform="translateY(-1px) scale(1.01)",V.style.boxShadow="0 4px 8px rgba(0,0,0,0.08)",V.style.borderColor="rgba(0, 122, 255, 0.2)")},V.onmouseleave=()=>{X||(V.style.backgroundColor=r.bgSurface,V.style.transform="translateY(0) scale(1)",V.style.boxShadow="0 1px 2px rgba(0,0,0,0.05)",V.style.borderColor=r.borderSubtle)},V.onmousedown=()=>{V.style.transform=X?"scale(0.97)":"scale(0.98)"},V.onmouseup=()=>{V.style.transform=X?"scale(1)":"translateY(-1px) scale(1.01)"},V.onclick=()=>{M(N)},m.appendChild(V)})})}let E=null;async function M(O){a?.id!==O.id&&(a=O,E&&clearTimeout(E),_.style.opacity="0",_.style.transform="translateY(5px)",E=setTimeout(()=>{K.style.display=O.isSmartCR?"block":"none",H.style.display=O.isSmartCR?"none":"block",I.style.display=O.isSmartCR?"none":"block",w(),Z(),oe(),_.style.opacity="1",_.style.transform="translateY(0)",E=null},150))}function Z(){if(F.innerHTML="",!a||a.isSmartCR){a?.isSmartCR?(F.style.display="block",F.innerHTML=`<div style="padding: 12px; font-size: 13px; color: #856404; background: #FFF3CD; border: 1px solid #FFEEBA; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
...
CID: ${f.cid||"---"}
Case ID: ${f.caseId||"---"}
E-mail: ${f.clientEmail||"---"}`;A&&(A.value=u),T&&(T.style.display="block",T.style.maxHeight="300px",T.style.opacity="1",T.scrollIntoView({behavior:"smooth",block:"end"}))})}function b(){r=!r,be(r,l,"cw-btn-script"),r?(p(),c||(c=setInterval(p,2e3))):c&&(clearInterval(c),c=null)}let y=ge(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",g,()=>{b()});l.appendChild(y);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
  ...
  `,m.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},m.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(y),b.appendChild(m),x.appendChild(b),p.appendChild(x);let C=document.createElement("div");C.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(C);let _=null;function F(){if(_)return;_=document.createElement("div"),_.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let D=document.createElement("div");D.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",D.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let U=document.createElement("button");U.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',U.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",U.onclick=()=>{$(),n=!1,I()},D.appendChild(U),_.appendChild(D);let h=document.createElement("div");h.id="cw-history-list",h.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",_.appendChild(h),p.appendChild(_)}function q(){_||F();let D=_.querySelector("#cw-history-list");D.innerHTML="";let U=la();U.length===0?D.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':U.forEach(h=>{let w=K(h,Ge[h._originalCat],!0,h._originalCat);D.appendChild(w)}),requestAnimationFrame(()=>_.style.transform="translateY(0)")}function $(){_&&(_.style.transform="translateY(100%)")}function W(){c.innerHTML="";let D=ae("history","Recentes",Ge.history);D.id="cw-sidebar-btn-history",D.onclick=()=>{P.playClick(),n=!n,n?q():$(),I()},c.appendChild(D);let U=document.createElement("div");U.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",c.appendChild(U),Object.keys(at).forEach(h=>{let w=at[h],E=ae(h,w.label,Ge[h]);E.id=`cw-sidebar-btn-${h}`,E.onclick=()=>{P.playClick(),n&&(n=!1,$()),B(h)},c.appendChild(E)})}function ae(D,U,h){let w=document.createElement("div");w.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,w.title=U,w.dataset.key=D;let E=document.createElement("div");E.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",E.innerHTML=h||Ge.tasks;let M=document.createElement("div");return M.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",M.textContent=U,w.appendChild(E),w.appendChild(M),w.onmouseenter=()=>{a!==D&&!(D==="history"&&n)&&(w.style.background="#F1F3F4",E.style.transform="scale(1.1)")},w.onmouseleave=()=>{a!==D&&!(D==="history"&&n)&&(w.style.background="transparent",E.style.transform="scale(1)")},w}function B(D){let U=document.getElementById(`cat-anchor-${D}`);U&&(U.scrollIntoView({behavior:"smooth",block:"start"}),a=D,I())}function I(){Object.keys(at).forEach(U=>{let h=c.querySelector(`#cw-sidebar-btn-${U}`);if(h)if(a===U&&!n){let w=vt[U];h.style.background=w.bg,h.style.color=w.color,h.querySelector("div:first-child").style.transform="scale(1.1)"}else h.style.background="transparent",h.style.color=i.textSecondary,h.querySelector("div:first-child").style.transform="scale(1)"});let D=c.querySelector("#cw-sidebar-btn-history");D&&(n?(D.style.background="#3C4043",D.style.color="#FFFFFF"):(D.style.background="transparent",D.style.color=i.textSecondary))}function H(){if(C.innerHTML="",e.trim()!==""){let U=[];if(Object.entries(at).forEach(([w,E])=>{let M=E.links.filter(Z=>Z.name.toLowerCase().includes(e.toLowerCase())||Z.desc.toLowerCase().includes(e.toLowerCase()));U.push(...M.map(Z=>({...Z,_cat:w})))}),U.length===0){C.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let h=document.createElement("div");h.innerHTML="Resultados da busca",h.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",C.appendChild(h),U.forEach(w=>{let E=K(w,Ge[w._cat],!1,w._cat);C.appendChild(E)});return}Object.entries(at).forEach(([U,h])=>{let w=vt[U],E=document.createElement("div"),M=document.createElement("div");M.id=`cat-anchor-${U}`,M.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,M.innerHTML=`
            ...
            ${h.label}
          `,E.appendChild(M);let Z=document.createElement("div");Z.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",h.links.forEach(oe=>{let O=K(oe,Ge[U],!1,U);Z.appendChild(O)}),E.appendChild(Z),C.appendChild(E)});let D=document.createElement("div");D.style.height="80px",C.appendChild(D)}function K(D,U,h,w){let E=document.createElement("div"),M=vt[w]||vt.history;E.style.cssText=`
      ...
      `;let Z=document.createElement("div");Z.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,Z.innerHTML=U||Ge.tasks;let oe=Z.querySelector("svg");oe&&(oe.style.width="22px",oe.style.height="22px");let O=document.createElement("div");O.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let R=document.createElement("div");R.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,R.textContent=D.name;let z=document.createElement("div");z.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,z.textContent=D.desc,O.appendChild(R),O.appendChild(z);let Q=document.createElement("div");return Q.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',Q.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,Q.title="Copiar URL",E.onmouseenter=()=>{E.style.transform="translateY(-2px)",E.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",E.style.borderColor="rgba(0,0,0,0.05)",E.style.borderLeft=`4px solid ${M.color}`,Q.style.opacity="1",Q.style.background="#F1F3F4"},E.onmouseleave=()=>{E.style.transform="translateY(0)",E.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",E.style.border="1px solid transparent",Q.style.opacity="0",Q.style.background="transparent"},E.onclick=()=>{!h&&w&&Eo(D,w),window.open(D.url,"_blank")},Q.onclick=d=>{d.stopPropagation(),P.playClick(),navigator.clipboard.writeText(D.url),!h&&w&&Eo(D,w),ee("Link copiado!")},E.appendChild(Z),E.appendChild(O),E.appendChild(Q),E}m.addEventListener("input",D=>{e=D.target.value,H()});function G(){o=!o,be(o,s,"cw-btn-links")}return document.body.appendChild(s),W(),H(),G}var Be=[];function Mt(t){Be=t}var ca=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function ko(){let t="v4.9",e=!1,o=null,a=null;function n(h){if(!h)return"";try{let w=new Date(h);return isNaN(w.getTime())?String(h):w.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(h)}}if(!document.getElementById("cw-broadcast-hd-css")){let h=document.createElement("style");h.id="cw-broadcast-hd-css",h.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,b.querySelectorAll('input[name="cw-bc-type"]').forEach(M=>{M.addEventListener("change",()=>{b.querySelectorAll(".cw-radio-option").forEach(Z=>Z.classList.remove("checked")),M.parentElement.classList.add("checked")})}),setTimeout(()=>{let M=b.querySelector(".cw-radio-option.info");M&&M.classList.add("checked")},100);let h=b.querySelector("#cw-bc-cancel"),w=b.querySelector("#cw-bc-close-x"),E=b.querySelector("#cw-bc-send");h.onclick=F,w.onclick=F,E.onclick=q,l.appendChild(b)}function _(h=null){if(!b)return;let w=b.querySelector("#cw-editor-title-label"),E=b.querySelector("#cw-bc-title"),M=b.querySelector("#cw-bc-text"),Z=b.querySelector("#cw-bc-send");if(h){a=h.id,w.textContent="Editar Aviso",E.value=h.title||"",M.value=h.text||"",Z.textContent="Salvar Altera\xE7\xF5es";let oe=h.type||"info",O=b.querySelector(`input[name="cw-bc-type"][value="${oe}"]`);O&&O.click()}else{a=null,w.textContent="Novo Aviso",E.value="",M.value="",Z.textContent="Publicar";let oe=b.querySelector('input[name="cw-bc-type"][value="info"]');oe&&oe.click()}b.classList.add("active"),setTimeout(()=>E.focus(),300)}function F(){b&&b.classList.remove("active"),a=null}async function q(){let h=b.querySelector("#cw-bc-send"),w=b.querySelector("#cw-bc-title"),E=b.querySelector("#cw-bc-text"),M=b.querySelector('input[name="cw-bc-type"]:checked'),Z=M?M.value:"info";if(!w.value.trim()||!E.value.trim()){ee("Preencha todos os campos!",{error:!0});return}h.textContent="Salvando...",h.style.opacity="0.7";let oe=!1;a?oe=await ce.updateBroadcast(a,{title:w.value,text:E.value,type:Z}):oe=await ce.sendBroadcast({title:w.value,text:E.value,type:Z,author:window._cwCurrentUser||"admin"}),oe?(ee(a?"Atualizado!":"Publicado!"),P.playSuccess(),F(),setTimeout(()=>ae(),1500)):(ee("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),h.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",h.style.opacity="1")}async function $(h){if(await ve("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await ce.deleteBroadcast(h)){ee("Aviso removido."),P.playClick();let M=Be.findIndex(Z=>Z.id===h);M>-1&&Be.splice(M,1),I(),setTimeout(()=>ae(),1500)}else ee("Erro ao excluir.",{error:!0})}let W=document.createElement("div");W.className="cw-nice-scroll",Object.assign(W.style,i.feedContainer),l.appendChild(W);async function ae(){e&&(m.style.display="block",m.innerHTML="\u{1F504} Sincronizando...");try{let h=await ce.fetchData();h&&h.broadcast&&(Mt(h.broadcast),B(),e&&(I(),m.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{m.style.display="none"},1500)))}catch{e&&(m.innerHTML="\u26A0\uFE0F Offline")}}function B(){let h=document.getElementById("cw-btn-broadcast");if(!h)return;let w=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Be.some(M=>!w.includes(M.id))){if(h.classList.add("has-new"),!h.querySelector(".cw-badge")){let M=document.createElement("div");M.className="cw-badge",Object.assign(M.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),h.appendChild(M)}}else{h.classList.remove("has-new");let M=h.querySelector(".cw-badge");M&&M.remove()}}function I(){W.innerHTML="";let h=l.querySelector("#cw-bau-widget");h&&h.remove();let w=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),E=[...Be].sort((R,z)=>{let Q=new Date(R.date).getTime()||0;return(new Date(z.date).getTime()||0)-Q}),M=E.findIndex(R=>R.title&&R.title.toLowerCase().includes("disponibilidade bau"));if(M!==-1){let R=E[M];E.splice(M,1);let z=document.createElement("div");z.id="cw-bau-widget",Object.assign(z.style,i.bauContainer);let Q=[],d=(R.text||"").split(`
`),v=/\d{1,2}\/\d{1,2}/,k="\u{1F4C5}";if(d.forEach(u=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(u)?k="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(u)&&(k="\u{1F1EA}\u{1F1F8}");let L=u.match(v);if(L){let N=L[0],X=k;/🇧🇷|🇵🇹|PT|BR/i.test(u)?X="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(u)&&(X="\u{1F1EA}\u{1F1F8}"),Q.some(te=>te.flag===X&&te.date===N)||Q.push({flag:X,date:N})}}),Q.length===0){let u=(R.text||"").match(/\d{1,2}\/\d{1,2}/g);u&&[...new Set(u)].forEach(L=>Q.push({flag:"\u{1F4C5}",date:L}))}let f="",S='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(S=`
    ...
    `,a.appendChild(W),p.appendChild(a);let ae=document.createElement("div");Object.assign(ae.style,qe),ae.className="no-drag",l.appendChild(ae),_e(l,ae),document.body.appendChild(l);function B(h){P.playClick(),o=h,b.forEach(w=>{let E=document.getElementById(`lib-tab-${w.id}`);w.id===h?Object.assign(E.style,r.tabActive):Object.assign(E.style,r.tabBtn)}),I()}function I(){y.innerHTML="";let h=Ee.getSnippets(o);if(h.length===0){y.innerHTML=`
            ...
            `;return}h.forEach(w=>{let E=document.createElement("div");E.className="cw-aura-card",Object.assign(E.style,r.card),w.isCode&&(E.style.borderLeft=`4px solid ${s.primary}`,E.style.background="rgba(26, 115, 232, 0.02)");let M=w.content,Z="";if(w.isRich){let oe=document.createElement("div");oe.innerHTML=w.content;let O=oe.querySelector("img");M=oe.innerText.substring(0,150)+(oe.innerText.length>150?"...":""),O&&(Z=`<span style="display:inline-flex; align-items:center; background:rgba(26, 115, 232, 0.1); color:#1a73e8; padding:2px 8px; border-radius:10px; font-size:11px; margin-bottom:8px; font-weight:600;">${i.media} Media</span>`)}E.innerHTML=`
            ...
            `,E.onmouseenter=()=>{P.playHover()},E.querySelector(".cw-act-copy").onclick=oe=>{if(oe.stopPropagation(),P.playClick(),w.isRich){let O=new Blob([w.content],{type:"text/html"}),R=document.createElement("div");R.style.whiteSpace="pre-wrap",R.innerHTML=w.content;let z=new Blob([R.innerText],{type:"text/plain"}),Q=[new ClipboardItem({"text/html":O,"text/plain":z})];navigator.clipboard.write(Q)}else navigator.clipboard.writeText(w.content);ee("Copiado!")},E.querySelector(".cw-act-edit").onclick=oe=>{oe.stopPropagation(),P.playClick(),H(w)},E.querySelector(".cw-act-del").onclick=async oe=>{oe.stopPropagation(),P.playClick(),await ve("Excluir este item?")&&(Ee.delete(w.id),I(),ee("Item exclu\xEDdo."))},y.appendChild(E)})}function H(h=null){n=h?h.id:null,F.innerHTML="",F.appendChild(D("title","T\xEDtulo / Nome",h?h.title:"")),o==="email"&&F.appendChild(D("subject","Assunto do Email",h?h.subject:""));let w="Conte\xFAdo";o==="email"&&(w="Corpo do Email (HTML)"),o==="note"&&(w="Texto da Nota (Reason)"),F.appendChild(D("content",w,h?h.content:"",{isRich:!0,isCode:h?h.isCode:!1})),C.querySelector("span").textContent=h?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let E=F.querySelector("input");E&&E.focus()},300)}function K(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function G(){let h=F.querySelector("#cw-inp-title"),w=F.querySelector("#cw-inp-content"),E=h.value.trim(),M=w.contentEditable==="true"?w.innerHTML:w.value.trim(),Z=w.getAttribute("data-is-code")==="true";if(!E||!M||M==="<br>"){ee("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let oe={id:n,type:o,title:E,content:M,isCode:Z,isRich:w.contentEditable==="true"};if(o==="email"){let O=F.querySelector("#cw-inp-subject").value.trim();if(!O){ee("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}oe.subject=O}W.classList.add("active"),$.disabled=!0;try{await Ee.save(oe),I(),K(),ee("Salvo com sucesso!"),P.playSuccess()}catch(O){console.error("Erro ao salvar nota:",O),ee("Erro ao salvar nota.",{error:!0})}finally{W.classList.remove("active"),$.disabled=!1}}function D(h,w,E,M={}){let Z=document.createElement("div");Object.assign(Z.style,r.inputGroup);let oe=document.createElement("label");oe.textContent=w,Object.assign(oe.style,r.label);let O;if(M.isRich){let R=document.createElement("div");R.style.cssText="display:flex; gap:8px; margin-bottom:16px; background:rgba(255, 255, 255, 0.5); padding:8px; border-radius:16px; border:1px solid rgba(0,0,0,0.06); backdrop-filter: blur(10px); width: fit-content;",R.innerHTML=`
            ...
            `,O=document.createElement("div"),O.contentEditable="true",Object.assign(O.style,r.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),O.innerHTML=E||"",M.isCode&&(O.style.fontFamily="'Roboto Mono', monospace",O.style.backgroundColor="#F8F9FA",O.setAttribute("data-is-code","true")),R.querySelectorAll(".cw-toolbar-btn").forEach(z=>{z.onmouseenter=()=>P.playHover(),z.onmousedown=()=>P.playClick()}),R.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),O.focus()},R.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),O.focus()},R.querySelector(".cw-tb-code").onclick=z=>{let d=!(O.getAttribute("data-is-code")==="true");O.setAttribute("data-is-code",d),O.style.fontFamily=d?"'Roboto Mono', monospace":"inherit",O.style.backgroundColor=d?"rgba(0, 122, 255, 0.03)":s.surface,d?z.currentTarget.classList.add("active"):z.currentTarget.classList.remove("active"),O.focus()},R.querySelector(".cw-tb-img").onclick=async()=>{let z=await eo("Cole a URL da imagem:");z&&(document.execCommand("insertImage",!1,z),O.querySelectorAll("img").forEach(d=>{d.style.maxWidth="100%",d.style.borderRadius="8px"}))},O.onpaste=z=>{let Q=(z.clipboardData||z.originalEvent.clipboardData).items;for(let d of Q)if(d.kind==="file"&&d.type.startsWith("image/")){z.preventDefault();let v=d.getAsFile(),k=new FileReader;k.onload=f=>{let S=`<img src="${f.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,S)},k.readAsDataURL(v)}},Z.appendChild(oe),Z.appendChild(R)}else O=document.createElement("input"),O.type="text",Object.assign(O.style,r.input),O.value=E||"",Z.appendChild(oe);return O.id=`cw-inp-${h}`,O.onfocus=()=>{O.style.borderColor=s.primary,O.style.boxShadow=`0 0 0 2px ${s.primaryBg}`},O.onblur=()=>{O.style.borderColor=s.border,O.style.boxShadow="none"},Z.appendChild(O),Z}function U(){e=!e,be(e,l,"cw-btn-library"),e?(document.body.style.overflow="hidden",I()):document.body.style.overflow=""}return U}function _o(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let y=document.createElement("style");y.id=a,y.innerHTML=`
        ...
        `,setTimeout(async()=>{try{let y=fe(),m=y?y.split("@")[0]:"user",C=await nt(m);if(!C){l.innerHTML=`
  ...
  `,document.head.appendChild(t)};var Ve={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var ue={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function Mo(t){switch(t){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:t||"Pendente",class:"status-gray",aura:""}}}function No(t){let e=document.createElement("div");if(e.className="bau-dynamic-input",e.id=`wrapper-${t.id}`,t.label){let a=document.createElement("label");a.className="bau-label",a.textContent=t.label,t.tooltip&&a.setAttribute("data-tooltip",t.tooltip),e.appendChild(a)}let o;switch(t.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",e.appendChild(o);break;case"select":o=document.createElement("select"),t.groups?t.groups.forEach(s=>{let r=document.createElement("optgroup");r.label=s.label,s.options.forEach(l=>{let g=document.createElement("option");g.value=l.value,g.textContent=l.text,r.appendChild(g)}),o.appendChild(r)}):t.options&&t.options.forEach(s=>{let r=document.createElement("option");r.value=s.value,r.textContent=s.text,o.appendChild(r)}),e.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",t.options.forEach(s=>{let r=document.createElement("label");r.className="bau-task-item",r.innerHTML=`<input type="checkbox" name="${t.name}" value="${s}"><span>${s}</span>`,r.addEventListener("click",l=>{l.preventDefault();let g=r.querySelector("input");g.checked=!g.checked,r.classList.toggle("active",g.checked),P.playClick()}),o.appendChild(r)}),e.appendChild(o),e;case"datetime-group":o=document.createElement("div"),o.className="bau-availability-container",t.fields.forEach(s=>{let r=document.createElement("div");r.className="bau-availability-field",r.innerHTML=`
    ...
    `,c.appendChild(x);let b=document.createElement("div");b.id="bau-view-form",b.className="bau-view";let y=document.createElement("div");y.className="bau-view-header",y.innerHTML=`
      <button class="bau-back-btn" id="bau-form-back-btn">
        ${ue.back}
        Voltar ao Dashboard
      </button>
    `,b.appendChild(y);let m=document.createElement("div");m.className="bau-content",b.appendChild(m);let C=document.createElement("div");C.className="bau-form-loading-overlay",C.innerHTML=`
        <div class="bau-spinner"></div>
        <div class="bau-loading-text">Configurando Edi\xE7\xE3o...</div>
    `,m.appendChild(C);let _=d=>{C.classList.toggle("active",d)},F=document.createElement("div");F.className="bau-progress-indicator",m.appendChild(F);let q=document.createElement("form");q.id="bau-escalation-form",q.noValidate=!0,m.appendChild(q),Ve.steps.forEach(d=>{let v=document.createElement("div");if(v.className="bau-step"+(d.id===a?" active":""),v.id=`bau-step-${d.id}`,d.isBranching)v.innerHTML=`
            ...
            `;else{let k=document.createElement("div");if(k.className="bau-card",d.id===1||d.id===5){k.innerHTML=`
                ...
                `;let f=k.querySelector(".bau-dynamic-inputs-container");d.fields.forEach(A=>{f.appendChild(No(A))});let S=k.querySelector("#wrapper-cid");if(S){let A=document.createElement("div");A.id="bau-cid-error",A.className="bau-cid-error-hint",A.style.display="none",A.textContent="Formato de CID incorreto",S.appendChild(A)}}else d.fields.forEach(f=>{k.appendChild(No(f))});v.appendChild(k)}q.appendChild(v)});let $=document.createElement("div");$.className="bau-footer";let W=document.createElement("button");W.type="button",W.id="bau-step-back-btn",W.className="bau-btn-secondary",W.textContent="Voltar";let ae=document.createElement("button");ae.type="button",ae.id="bau-step-next-btn",ae.className="bau-btn-primary",ae.textContent="Pr\xF3ximo";let B=document.createElement("button");B.type="submit",B.className="bau-btn-submit",B.innerHTML=`${ue.send} Enviar para o TL`,B.style.display="none",$.appendChild(W),$.appendChild(ae),$.appendChild(B),q.appendChild($),c.appendChild(b);let I=document.createElement("div");I.id="bau-view-success",I.className="bau-view bau-success-view",I.innerHTML=`
    ...
    `,c.appendChild(I),document.body.appendChild(l);function H(d){e=d,l.querySelectorAll(".bau-view").forEach(A=>A.classList.remove("active"));let v=l.querySelector(`#bau-view-${d}`);v&&v.classList.add("active");let k=g.querySelector(".cw-module-header-title")||g.querySelector("h2"),f=g.querySelector(".cw-module-header-subtitle")||g.querySelector("p");k&&(d==="form"?k.textContent=i?`Editando Caso #${s}`:"Novo Caso BAU":k.textContent="BAU Central"),f&&(f.textContent=d==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU");let S=q.querySelector(".bau-btn-submit");S&&(S.innerHTML=i?`${ue.send} Salvar Altera\xE7\xF5es`:`${ue.send} Enviar para o TL`)}function K(){let d=l.querySelector("#bau-case-list-container"),v=l.querySelector("#bau-dashboard-metrics");v&&(v.innerHTML=`
        ...
        `).join(""))}async function G(){let d=l.querySelector("#bau-case-list-container"),v=l.querySelector("#bau-dashboard-metrics");if(!(!d||!v)){K();try{let k=await Pt();if(!Array.isArray(k))throw new Error("API response is not a valid array");h(k)}catch(k){console.error("Critical Error loading BAU cases:",k),v&&(v.innerHTML=""),d.innerHTML=`
            ...
            `,l.querySelector("#bau-retry-btn")?.addEventListener("click",()=>G()),ee("Erro ao carregar Dashboard. Verifique sua conex\xE3o.",{error:!0})}}}function D(d){if(!d)return;let v=Mo(d.status),k=(S,A)=>{navigator.clipboard.writeText(S).then(()=>{ee("Copiado para a \xE1rea de transfer\xEAncia!"),P.playClick();let T=A.style.color;A.style.color="#1E8E3E",setTimeout(()=>{A.style.color=T},800)})};p.innerHTML=`
                ...
                <div class="bau-details-grid">
                    ...
                    <div class="bau-details-card full-width">
                        ...
                        <div class="bau-details-row">
                            ...
                            <span class="bau-details-value">${st(d.availability)}</span>
                        </div>
                    </div>
                </div>
            </div>
        `;let f=p.querySelector(".bau-details-close-btn");f.onclick=()=>{p.classList.remove("active"),P.playSwoosh(),setTimeout(()=>{p.style.display="none"},600)},p.querySelectorAll(".bau-copy-btn").forEach(S=>{S.onclick=A=>{let T=A.target.closest(".bau-details-row").querySelector(".bau-details-value").textContent;k(T,S)}}),p.style.display="flex",requestAnimationFrame(()=>{p.classList.add("active"),P.playClick()})}function U(d){if(!d)return"";let v=Mo(d?.status),k=st(d?.date),f="",S="";if(d?.status==="PENDING_TL_CREATION"&&d?.availability_1){let N=new Date(d.availability_1),X=new Date;(N<=X||N-X<36e5*2)&&(f='<span class="bau-sla-badge">Urgente</span>',S="bau-pulse-attention")}let A=d?.reason&&d.reason.trim()?d.reason:"Nenhum contexto adicional fornecido pelo agente.",u=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(d?.cid||""),L=!d?.caseId||d.caseId==="N/A"||!u;return L&&d?.status==="PENDING_TL_CREATION"&&(S="bau-pulse-attention"),`
        ...
        `}function h(d){let v=l.querySelector("#bau-case-list-container"),k=l.querySelector("#bau-dashboard-metrics");if(!v||!k)return;let f=Array.isArray(d)?d.filter(Boolean):[];if(f.length===0){k.innerHTML=`
            ...
            `,l.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>G());return}let S=f.filter(N=>N.status==="PENDING_TL_CREATION").length,A=f.filter(N=>N.status==="CREATED").length;k.innerHTML=`
        ...
        `;let T=k.querySelector("#bau-refresh-dashboard");T?.addEventListener("click",async()=>{T.classList.contains("spinning")||(T.classList.add("spinning"),P.playClick(),await G(),setTimeout(()=>T.classList.remove("spinning"),1e3))}),v.innerHTML="";let u=f.slice(0,5),L=f.slice(5);if(u.forEach(N=>{let X=U(N),V=document.createElement("div");V.innerHTML=X;let te=V.firstElementChild;te.addEventListener("click",ne=>{ne.target.closest(".bau-case-edit-btn")||D(N)});let Y=te.querySelector(".bau-case-edit-btn");Y&&(Y.onclick=ne=>{ne.stopPropagation(),R(N)}),v.appendChild(te)}),L.length>0){let N=document.createElement("li");N.className="bau-accordion-container";let X=document.createElement("button");X.className="bau-accordion-toggle",X.innerHTML=`${ue.expand} <span>Mostrar ${L.length} casos mais antigos</span>`;let V=document.createElement("ul");V.className="bau-case-list bau-accordion-content",V.style.display="none",L.forEach(te=>{let Y=U(te),ne=document.createElement("div");ne.innerHTML=Y;let le=ne.firstElementChild;le.addEventListener("click",Se=>{Se.target.closest(".bau-case-edit-btn")||D(te)});let Ae=le.querySelector(".bau-case-edit-btn");Ae&&(Ae.onclick=Se=>{Se.stopPropagation(),R(te)}),V.appendChild(le)}),X.addEventListener("click",()=>{let te=V.style.display==="none";V.style.display=te?"block":"none",X.classList.toggle("expanded",te),X.querySelector("span").textContent=te?"Esconder casos mais antigos":`Mostrar ${L.length} casos mais antigos`,P.playClick()}),N.appendChild(X),N.appendChild(V),v.appendChild(N)}}function w(){let d=n==="BAU"?[1,2,3,4]:[5,4];q.querySelectorAll(".bau-step").forEach(f=>{let S=parseInt(f.id.replace("bau-step-","")),A=S===a,T=d.includes(S)||S===0;f.classList.toggle("active",A),f.style.display=A?"block":"none",f.querySelectorAll("input, select, textarea").forEach(u=>{u.disabled=!T})});let v=a===0;if(F.style.display=v?"none":"flex",!v){F.innerHTML="";let f=n==="BAU"?[1,2,3,4]:[5,4];f.forEach((S,A)=>{let T=document.createElement("div"),u=S===a,L=f.indexOf(a),N=A<L;T.className=`bau-progress-step ${u?"active":N?"completed":""}`,T.textContent=A+1,F.appendChild(T)})}let k=a===4;W.style.display=a>0?"inline-block":"none",ae.style.display=!v&&!k?"inline-block":"none",B.style.display=k?"flex":"none",k&&O()}function E(d){let v=Ve.steps.find(k=>k.id===d);if(!v||!v.fields||v.isConfirmation)return!0;for(let k of v.fields){let f=q.querySelector(`#bau-step-${d} #wrapper-${k.id}`);if(!(f&&f.style.display==="none")&&k.validation){let S=q.querySelector(`#bau-step-${d} [name="${k.name}"]`);if(S&&S.offsetParent!==null&&S.value.trim())if(new RegExp(k.validation.regex).test(S.value.trim())){S.classList.remove("invalid-cid");let T=q.querySelector("#bau-cid-error");T&&(T.style.display="none")}else{console.warn(`Validation failed for field "${k.name}" in step ${d}: Regex mismatch.`),ee(`Erro: ${k.validation.error}`,{error:!0}),S.classList.add("invalid-cid");let T=q.querySelector("#bau-cid-error");return T&&(T.style.display="flex"),!1}}}return!0}function M(d){if(!q.querySelector(`#bau-step-${d}`))return!1;let k=Ve.steps.find(S=>S.id===d);if(!k||!k.fields||k.isConfirmation)return!0;let f=!0;for(let S of k.fields){let A=q.querySelector(`#bau-step-${d} #wrapper-${S.id}`);if(!(A&&A.style.display==="none")&&S.required){let T=!0,u="";if(S.type==="checkbox-grid")q.querySelector(`#bau-step-${d} input[name="${S.name}"]:checked`)||(u="No option selected in checkbox-grid",ee(`Erro: Selecione pelo menos uma op\xE7\xE3o para "${S.label}".`,{error:!0}),T=!1);else if(S.type==="datetime-group"){let L=q.querySelector(`#bau-step-${d} input[name="${S.fields[0].name}"]`);if(!L||L.offsetParent===null)continue;L.value.trim()||(u="Datetime group first field is empty",ee(`Erro: O campo "${S.fields[0].label}" \xE9 obrigat\xF3rio.`,{error:!0}),T=!1)}else{let L=q.querySelector(`#bau-step-${d} [name="${S.name}"]`);if(!L||L.offsetParent===null)continue;L.value.trim()||(u="Field is empty",ee(`Erro: O campo '${S.label}' \xE9 obrigat\xF3rio.`,{error:!0}),T=!1)}if(!T){console.warn(`Validation failed for required field "${S.name}" in step ${d}: ${u}`),f=!1;break}}}return f}ae.addEventListener("click",()=>{if(E(a)&&M(a)){n==="BAU"?a++:a===5?a=4:a++,w();let d=l.querySelector(".bau-content");d&&(d.scrollTop=0),P.playClick()}}),W.addEventListener("click",()=>{a>0&&(n==="BAU"?a--:a===4?a=5:a===5?a=0:a--,w(),P.playClick())});async function Z(){let d=await Fe()||{};(!d.amName||d.amName==="N/A")&&(d.amName=d.internalEmail||"N/A"),o=d,q.querySelectorAll(".bau-vital-highlights").forEach(f=>{let S=[{label:"Anunciante",value:d.advName},{label:"CID",value:d.cid},{label:"Website",value:d.website||d.site},{label:"Case ID",value:d.caseId}];f.innerHTML=S.map(A=>{let T=A.value&&A.value!=="N/A"&&A.value!=="undefined"&&A.value!=="null"?A.value:"N\xE3o capturado";return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${A.label}</span>
                        <span class="bau-highlight-value">${T}</span>
                    </div>
                `}).join("")}),Ve.steps.forEach(f=>{f.fields&&f.fields.forEach(S=>{if(S.isSmart){let A=d[S.id];S.id==="language"&&d.userProfile?.defaultLanguage&&(A=d.userProfile.defaultLanguage);let T=q.querySelector(`#bau-step-${f.id} [name="${S.name}"]`),u=q.querySelector(`#bau-step-${f.id} #wrapper-${S.id}`);if(T&&(T.value=A&&A!=="N/A"?A:"",S.id==="language"&&A&&A!=="N/A"&&(T.readOnly=!0,T.style.background="#F1F3F4",T.style.cursor="not-allowed")),u){let L=A&&A!==""&&A!=="N/A"&&A!=="undefined"&&A!=="null";S.id==="language"?u.style.display="block":u.style.display=L?"none":"block"}}})}),q.querySelectorAll(".bau-all-data").forEach(f=>{let S=[{label:"Anunciante",value:d.advName},{label:"CID",value:d.cid},{label:"AM",value:d.amName},{label:"SE ID",value:d.seId},{label:"Site",value:d.website||d.site},{label:"Email",value:d.email},{label:"Timezone",value:d.timezone},{label:"Case ID",value:d.caseId},{label:"Programa",value:d.salesProgram},{label:"Idioma",value:d.language}];f.innerHTML=`
            ...
            `})}l.querySelector("#bau-top-se-search")?.addEventListener("click",d=>{d.preventDefault(),pt("bau-form-seId")});let oe=l.querySelector("#bau-form-cid");oe&&oe.addEventListener("input",()=>E(1));function O(){let d=new FormData(q),v=Object.fromEntries(d.entries()),k=l.querySelector("#bau-confirmation-details");if(k){if(n==="BAU"){let f=d.getAll("taskType"),S=f.length>0?f.join(", "):"Nenhuma";k.innerHTML=`
            ...
            `;k.querySelectorAll(".bau-confirm-value-input").forEach(f=>{f.addEventListener("input",S=>{let A=S.target.dataset.field,T=S.target.dataset.step;if(!A||!T)return;let u=q.querySelector(`#bau-step-${T} [name="${A}"]`);u&&(u.value=S.target.value,A==="cid"&&E(1))})})}}async function R(d){if(!await ve("Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",{confirmText:"Estou na p\xE1gina correta"}))return;_(!0),z(),i=!0,s=d.id,n=d.status==="PENDING_TL_DISCARD"||d.reason&&!d.task?"DISCARD":"BAU",H("form"),await Z(),o={...o,advName:d.advName||o.advName,cid:d.cid||o.cid,caseId:d.caseId||o.caseId,seId:d.seId||o.seId,site:d.site||d.website||o.site||o.website,email:d.advEmail||o.email,timezone:d.timezone||o.timezone,language:d.language||o.language,amName:d.amName||o.amName,salesProgram:d.salesProgram||o.salesProgram};let k=d.availability?d.availability.split("|").map(f=>f.trim()):[];q.querySelectorAll("input, select, textarea").forEach(f=>{let S=f.name,T={advEmail:"advEmail",website:"site",site:"site"}[S]||S;if(S==="taskType"){let u=(d.task||d.taskType||"").split(",").map(L=>L.trim());f.type==="checkbox"&&(f.checked=u.includes(f.value),f.closest(".bau-task-item")?.classList.toggle("active",f.checked))}else if(S.startsWith("availability_")){let u=parseInt(S.split("_")[1])-1,L=k[u];if(L&&f.type==="datetime-local")try{let N=new Date(L);if(!isNaN(N.getTime())){let X=new Date(N.getTime()-N.getTimezoneOffset()*6e4).toISOString().slice(0,16);f.value=X}}catch{}}else d[T]!==void 0?f.value=d[T]:S==="reason"?f.value=d.reason:S==="description"?f.value=d.description:S==="nonImplementationReason"&&(f.value=d.nonImplementationReason||"")}),a=n==="BAU"?1:5,w(),P.playClick(),setTimeout(()=>_(!1),500)}q.onsubmit=async d=>{d.preventDefault();let v=n==="BAU"?[1,2,3]:[5];for(let u of v)if(!Ve.steps.find(N=>N.id===u)?.isConfirmation&&(!E(u)||!M(u))){console.warn(`Form submission blocked by validation failure in step ${u}`),a=u,w();return}let k=l.querySelector(".bau-btn-submit");k.disabled=!0,k.innerHTML="Enviando...";let f=new FormData(q),S=Object.fromEntries(f.entries()),A=o||{},T={...A,...S,requestType:n};if(S.advEmail?T.advEmail=S.advEmail:A.email&&(T.advEmail=A.email),S.website?T.website=S.website:A.website?T.website=A.website:A.site&&(T.website=A.site),n==="BAU"){let u=f.getAll("taskType"),L=[S.availability_1,S.availability_2,S.availability_3].filter(N=>N&&N.trim()!=="").join(" | ");T.taskType=u.join(", "),T.availability=L,i?(S.nonImplementationReason?T.nonImplementationReason=S.nonImplementationReason:delete T.nonImplementationReason,S.description?T.description=S.description:delete T.description):(T.nonImplementationReason=S.nonImplementationReason||"",T.description=S.description||"",T.nonImplementationReason||console.warn("Aviso: Campo 'Justificativa' (nonImplementationReason) est\xE1 saindo vazio."),T.description||console.warn("Aviso: Campo 'Descri\xE7\xE3o detalhada' (description) est\xE1 saindo vazio."))}else T.reason=S.reason,i?(S.description?T.description=S.description:delete T.description,delete T.taskType,delete T.availability,delete T.nonImplementationReason):(T.taskType="",T.availability="",T.nonImplementationReason="",T.description=S.description||"");try{i?await Ht(s,T):await $t(T,A.agentEmail||"anon"),P.playSuccess();let u=l.querySelector(".bau-success-title");u&&(i?u.textContent="Caso atualizado com sucesso!":u.textContent=n==="DISCARD"?"Caso enviado para descarte com sucesso!":"Caso enviado com sucesso!"),H("success")}catch(u){ee("Erro: "+(u.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",T)}finally{k.disabled=!1,k.innerHTML=`${ue.send} Enviar para o TL`}};function z(){q.reset(),a=0,n="BAU",i=!1,s=null,w(),q.querySelectorAll(".bau-task-item.active").forEach(v=>v.classList.remove("active"));let d=q.querySelector('[name="language"]');d&&(d.readOnly=!1,d.style.background="",d.style.cursor="")}l.querySelector("#bau-new-case-btn").addEventListener("click",()=>{z(),H("form"),Z()}),l.querySelector("#bau-form-back-btn").addEventListener("click",()=>H("dashboard")),l.querySelector("#bau-success-back-btn").addEventListener("click",()=>H("dashboard"));async function Q(){t=!t,l.style.display=t?"flex":"none",t&&(H("dashboard"),G()),be(t,l,"cw-btn-bauform")}return w(),Q}function ua(){if(window.techSolInitialized){Tt();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Vt();try{P.initGlobalListeners(),P.playStartup()}catch(c){console.warn("\xC1udio bloqueado:",c)}ce.fetchTips(),Tt();let e=xo(),o=wo(),a=Co(),n=Ao(),i=Oo(),s=qo(),r=_o(),l=zo(),g=ko();co({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:l,broadcastControl:g}),setTimeout(()=>{ce.logEvent("App","Start","Session Start"),To(),setTimeout(()=>{Io(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),ee("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}ua();})();
