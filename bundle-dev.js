...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(m,S)=>{G.playClick(),a.querySelector(`.${m}`).classList.toggle("active"),S()};if(a.querySelector(".notes").onclick=m=>{m.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=m=>{m.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=m=>{m.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=m=>{m.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=m=>{m.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=m=>{m.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=m=>{m.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=m=>{m.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=m=>{m.stopPropagation(),i("broadcast",()=>{let S=m.currentTarget.querySelector(".cw-badge");S&&S.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(m=>{m.addEventListener("mouseenter",()=>G.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let m=document.createElement("div");m.className="cw-badge",a.querySelector(".broadcast").appendChild(m)}let s=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(s=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{s&&clearTimeout(s)},(async function(){let S=()=>{let H=he();if(H){let j=H.split("@")[0].toLowerCase();if(lt.includes(j)){let B=a.querySelector("#cw-admin-tag");B&&B.classList.add("visible")}}else setTimeout(S,2e3)};S(),await ct(2800),a.classList.add("docked"),await ct(300);let C=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(H=>H.classList.add("visible"));for(let H=0;H<C.length;H++)C[H].classList.add("popped"),await ct(90);await ct(200),a.classList.add("system-check")})();let r=!1,l,d,c,p,x=3;a.onmousedown=m=>{if(m.target.closest("button"))return;m.preventDefault(),l=m.clientX,d=m.clientY;let S=a.getBoundingClientRect();c=S.left,p=S.top,document.addEventListener("mousemove",b),document.addEventListener("mouseup",g)};function b(m){let S=m.clientX-l,C=m.clientY-d;!r&&Math.sqrt(S*S+C*C)>x&&(r=!0,a.classList.add("dragging"),a.style.transition="none",s&&clearTimeout(s)),r&&(a.style.left=`${c+S}px`,a.style.top=`${p+C}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function g(m){if(document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",g),r){r=!1,a.classList.remove("dragging");let S=window.innerWidth,C=window.innerHeight,H=a.getBoundingClientRect(),j=H.left+H.width/2,B;j<S/2?(B=24,a.classList.remove("side-right"),a.classList.add("side-left")):(B=S-H.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let Z=Math.max(24,Math.min(H.top,C-H.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${B}px`,a.style.top=`${Z}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let S=a.querySelector(".cw-btn.active"),C=m.target.closest("button");if(a.classList.contains("collapsed")){let H=a.getBoundingClientRect(),j=window.innerHeight,B=H.top>j/2;if(a.style.setProperty("transition","none","important"),B){let Z=j-H.bottom;a.style.top="auto",a.style.bottom=`${Z}px`}else a.style.bottom="auto",a.style.top=`${H.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),G.playGenieOpen()}else!S&&!C&&(a.classList.add("collapsed"),G.playGenieOpen());C&&(C.style.transform="scale(0.9)",setTimeout(()=>C.style.transform="",150))}}}function Je(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
`.replace(/\n/g,"<br>");Ze(N);let O=await mt();O?(O.innerText.trim()===""&&(O.innerHTML=""),document.execCommand("insertHTML",!1,N),ut(O),K("Nota gerada e inserida!")):K("Copiado! Abra uma nota para colar.")},e}var be=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function ke(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function gt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let c=a.getBoundingClientRect();i.x=c.left+c.width/2,i.y=c.top+c.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let c=e.getBoundingClientRect();s=c.left+c.width/2,r=c.top+c.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,d=i.y-r;t?(G.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${d}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${d}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof go=="function"&&go(e,o)):(G.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${d}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${d}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Lt=="function"&&Lt(e))}function go(t,e){Lt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Lt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function bo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Qt(t,J),s=io(h),r=no(()=>{F(),W.setActiveTasks(r.getCheckedElements())},h,W),l=document.createElement("div");l.style.display="none";let d=ao((u,y)=>{E(u,y)});l.appendChild(d);let c=ro({onSaveCurrent:async()=>{let u=await R();return _(),u},onLoadDraft:u=>{Y(u)},t:u=>h(u)}),p=O(),x=z(),b=document.createElement("div"),g=w(),m=I(c,h);o.appendChild(p),o.appendChild(x),o.appendChild(g),o.appendChild(l),o.appendChild(b),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let S=document.createElement("button");S.id="manual-task-toggle",S.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",S.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${$.primary}; background: ${$.surface}; color: ${$.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,S.onmouseenter=()=>{S.style.background=$.primaryBg},S.onmouseleave=()=>{S.style.background=$.surface},S.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",S.style.display="none"},o.appendChild(S),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(m);let C=document.createElement("div");C.style.display="none",C.style.flexGrow="1",C.style.minHeight="0",C.style.overflow="hidden";let H=po(()=>N());H.style.height="100%",C.appendChild(H),e.insertBefore(C,i);let j=a.lastElementChild;j&&(j.insertBefore(c.historyBtnWrapper,j.firstChild),j.insertBefore(V(),j.firstChild)),e.appendChild(c.drawer);let B=null;W.subscribe(u=>{k(u),Z(),u.isDirty?(B&&clearTimeout(B),B=setTimeout(async()=>{let y=await R(!0);y.subStatus?ge.saveEmergency(y):ge.clearEmergency(),u.isDirty=!1},2e3)):B&&(clearTimeout(B),B=null)});function Z(){let u=ge.getCount()>0,y=!!W.currentSubStatus;dt(u||y)}function J(){W.visible=!W.visible,ue(W.visible,e,"cw-btn-notes")}function N(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",C.style.display="flex",C.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",C.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function O(){let u=document.createElement("div");if(u.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let v=document.createElement("style");v.id="cw-segmented-styles",v.innerHTML=`
            ...
            `,document.head.appendChild(v)}let y=(v,T)=>{let X=u.querySelector(`#${v}`).querySelector(".cw-segmented-indicator");X&&(X.style.transform=`translateX(${T*100}%) translateX(${T*2}px)`)};return u.querySelectorAll("#lang-selector button").forEach((v,T)=>{v.onclick=()=>{W.setLanguage(v.dataset.lang),u.querySelectorAll("#lang-selector button").forEach(L=>L.classList.remove("active")),v.classList.add("active"),y("lang-selector",T),G.playHover(),W.currentSubStatus&&M(W.currentSubStatus)}}),u.querySelectorAll("#type-selector button").forEach((v,T)=>{v.onclick=()=>{W.setCaseType(v.dataset.type),u.querySelectorAll("#type-selector button").forEach(L=>L.classList.remove("active")),v.classList.add("active"),y("type-selector",T),G.playHover(),W.currentSubStatus&&M(W.currentSubStatus)}}),u.querySelectorAll("#portugal-selector button").forEach((v,T)=>{v.onclick=()=>{W.setPortugalCase(v.dataset.val==="true"),u.querySelectorAll("#portugal-selector button").forEach(L=>L.classList.remove("active")),v.classList.add("active"),y("portugal-selector",T),G.playHover(),W.currentSubStatus&&M(W.currentSubStatus)}}),u}function z(){let u=document.createElement("div");u.className="cw-status-section",u.style.cssText="display: flex; flex-direction: column; gap: 8px;",u.innerHTML=`
        ...
        `;let y=u.querySelector("#main-status-select"),v=u.querySelector("#sub-status-select");return y.onchange=()=>{W.setStatus(y.value),U(y.value,v),W.setSubStatus(""),M("")},v.onchange=()=>{W.setSubStatus(v.value),M(v.value)},u}function U(u,y){if(y.innerHTML=`<option value="">${h("select_substatus")}</option>`,!u){y.disabled=!0;return}for(let v in Te)if(Te[v].status===u){let T=document.createElement("option");T.value=v,T.textContent=Te[v].name,y.appendChild(T)}y.disabled=!1}function M(u){if(d.render&&d.render(u,W.currentCaseType),!u){l.style.display="none",b.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",g.style.display="flex",g.style.opacity="1",m.style.display="none";return}g.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(g.style.display="none")},400),m.style.display="grid";let y=Te[u];y&&y.templateFields&&W.setActiveFields(y.templateFields),q(),Tt(u,b,W),b.style.display="block",l.style.display="block";let v=u.startsWith("SO_"),T=u==="NI_Awaiting_Validation",L=document.getElementById("manual-task-toggle");v||T?(r.selectionElement.style.display="block",L.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",L.style.display="block");let X=u==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(X),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(u),F();let D=document.getElementById("email-automation-toggle-row");D&&(D.style.display=$e[u]?"flex":"none")}function F(){let u=r.getCheckedElements().map(y=>y.value);s.updateVisibility(W.currentSubStatus,u)}function E(u,y){let v=it[u];if(v){for(let T in v)if(T==="linkedTask")r.toggleTask(v.linkedTask,y);else if(T==="activeTasks")v.activeTasks.forEach(L=>{y?r.setTaskCount(L.value,L.count):r.setTaskCount(L.value,0)});else if(T.startsWith("field-")){let L=T,X=v[T],D=document.getElementById(L);if(D){let ee=je.includes(L.replace("field-",""));if(y)if(ee){let oe=D.value.trim();oe.includes(X.trim())||(D.value=oe?oe+`
`+X.trim():X.trim())}else D.value=X;else if(ee){let oe=D.value.trim(),Q=X.trim();oe.includes(Q)&&(D.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else D.value.trim()===X.trim()&&(D.value="");W.updateField(L,D.value),D.dispatchEvent(new Event("input"))}}}}function I(u,y){let v=document.createElement("div");if(v.className="cw-actions-section",v.style.cssText=`
            display: grid;
        ...
        `;let L=u.parkButton;L.classList.add("js-btn-park"),L.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let X=document.createElement("button");X.className="cw-btn-secondary js-btn-reset",X.textContent=y("limpar"),X.style.cssText=`width: 100%; height: 34px; background: ${$.surface}; color: ${$.textSub}; border: 1px solid ${$.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,X.onclick=()=>_();let D=document.createElement("button");D.className="cw-btn-secondary js-btn-copy",D.textContent=y("copiar"),D.style.cssText=`width: 100%; height: 34px; background: ${$.surface}; color: ${$.primary}; border: 1px solid ${$.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,D.onclick=()=>f();let ee=document.createElement("button");return ee.className="cw-btn-primary js-btn-generate",ee.textContent=y("preencher"),ee.style.cssText=`width: 100%; height: 38px; background: ${$.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ee.onclick=()=>A(),v.appendChild(T),v.appendChild(L),v.appendChild(X),v.appendChild(D),v.appendChild(ee),v}async function f(){if(!W.currentSubStatus){K(h("select_substatus"),{error:!0});return}let u=kt(W,r,s);u?(Ze(u),K(h("copiado_sucesso")),G.playClick()):K(h("select_substatus"),{error:!0})}async function A(){if(!W.currentSubStatus){K(h("select_substatus"),{error:!0});return}let u=kt(W,r,s);Ze(u),J();let y=Je(),v=await mt();if(v){v.focus(),document.execCommand("insertHTML",!1,u),ut(v);let T=document.getElementById("email-automation-checkbox");(!T||T.checked)&&W.currentSubStatus&&$e[W.currentSubStatus]&&await ft($e[W.currentSubStatus]),K(h("inserido_copiado")),G.playSuccess(),_()}y()}function q(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let u=Te[W.currentSubStatus];u&&u.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function _(){W.reset(),r.reset(),s.reset(),Z(),ge.clearEmergency(),o.querySelectorAll("select").forEach(y=>y.value=""),o.querySelector("#sub-status-select").disabled=!0;let u=document.getElementById("email-automation-toggle-row");u&&(u.style.display="none"),b.innerHTML="",l.style.display="none",g.style.display="flex",g.style.opacity="1",m.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none"}async function R(u=!1){let y={};b.querySelectorAll("input, textarea, select").forEach(D=>{(D.id.startsWith("field-")||D.id==="consent-select")&&(y[D.id]=D.value)});let v="Cliente",T="---";if(!u)try{let D=await we();v=D.advertiserName,T=D.cid}catch(D){console.warn("Erro ao coletar pageData:",D)}let L=r.getCheckedElements().map(D=>({key:D.value,count:D.count})),X=L.map(D=>{let ee=Ce[D.key];return ee?ee.name:D.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:y,activeTasks:L,summaryTags:X,clientName:v,cid:T,timestamp:new Date().toISOString()}}let P=u=>new Promise(y=>setTimeout(y,u));async function Y(u){W.setLanguage(u.currentLang||"pt"),W.setCaseType(u.currentCaseType||"bau"),W.setPortugalCase(u.isPortugalCase||!1),W.setConsent(u.consent||!1),W.setExcludedFields(u.excludedFields||[]),u.activeFields&&W.setActiveFields(u.activeFields);let y=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);y&&y.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(L=>{L!==y&&L.classList.remove("active")});let v=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);v&&v.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(L=>{L!==v&&L.classList.remove("active")});let T=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if(T&&T.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(L=>{L!==T&&L.classList.remove("active")}),u.status){let L=o.querySelector("#main-status-select");L.value=u.status,W.setStatus(u.status);let X=o.querySelector("#sub-status-select");if(U(u.status,X),await P(50),u.subStatus){if(X.value=u.subStatus,W.setSubStatus(u.subStatus),M(u.subStatus),await P(100),u.tagSupportUsed!==void 0){W.setTagSupportUsed(u.tagSupportUsed);let D=s.element.querySelector('input[value="Sim"]'),ee=s.element.querySelector('input[value="N\xE3o"]');u.tagSupportUsed&&D?D.checked=!0:ee&&(ee.checked=!0),s.element.querySelector("div:last-child").style.display=u.tagSupportUsed?"none":"block"}u.forcedScreenshots&&W.setForcedScreenshots(u.forcedScreenshots);for(let D in u.formData){let ee=document.getElementById(D);ee&&(ee.value=u.formData[D],W.updateField(D,ee.value))}u.activeTasks&&(u.activeTasks.forEach(D=>r.setTaskCount(D.key,D.count)),W.setActiveTasks(r.getCheckedElements()))}}W.isDirty=!1}function h(u){return Se[W.currentLang]?.[u]||Se.pt?.[u]||u}function V(){let u=document.createElement("div");return u.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',u.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",u.onclick=y=>{y.stopPropagation(),N()},u.title="Alternar para Split & Transfer",u}function w(){let u=document.createElement("div");return u.id="notes-empty-state",u.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
...
CID: ${y.cid||"---"}
Case ID: ${y.caseId||"---"}
E-mail: ${y.clientEmail||"---"}`;T&&(T.value=X),L&&(L.style.display="block",L.style.maxHeight="300px",L.style.opacity="1",L.scrollIntoView({behavior:"smooth",block:"end"}))})}function b(){r=!r,ue(r,l,"cw-btn-script"),r?(p(),c||(c=setInterval(p,2e3))):c&&(clearInterval(c),c=null)}let g=pe(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",d,()=>{b()});l.appendChild(g);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
  ...
  `,m.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},m.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(g),b.appendChild(m),x.appendChild(b),p.appendChild(x);let S=document.createElement("div");S.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(S);let C=null;function H(){if(C)return;C=document.createElement("div"),C.style.cssText=`
      ...
      `,V.title="Copiar URL",A.onmouseenter=()=>{A.style.transform="translateY(-2px)",A.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",A.style.borderColor="rgba(0,0,0,0.05)",A.style.borderLeft=`4px solid ${q.color}`,V.style.opacity="1",V.style.background="#F1F3F4"},A.onmouseleave=()=>{A.style.transform="translateY(0)",A.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",A.style.border="1px solid transparent",V.style.opacity="0",V.style.background="transparent"},A.onclick=()=>{!I&&f&&So(F,f),window.open(F.url,"_blank")},V.onclick=w=>{w.stopPropagation(),G.playClick(),navigator.clipboard.writeText(F.url),!I&&f&&So(F,f),K("Link copiado!")},A.appendChild(_),A.appendChild(P),A.appendChild(V),A}m.addEventListener("input",F=>{e=F.target.value,z()});function M(){o=!o,ue(o,s,"cw-btn-links")}return document.body.appendChild(s),Z(),z(),M}var qe=[];function qt(t){qe=t}var ia=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Eo(){let t="v4.9",e=!1,o=null,a=null;function n(f){if(!f)return"";try{let A=new Date(f);return isNaN(A.getTime())?String(f):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
...
`),u=/\d{1,2}\/\d{1,2}/,y="\u{1F4C5}";if(k.forEach(D=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(D)?y="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(D)&&(y="\u{1F1EA}\u{1F1F8}");let ee=D.match(u);if(ee){let oe=ee[0],Q=y;/🇧🇷|🇵🇹|PT|BR/i.test(D)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(D)&&(Q="\u{1F1EA}\u{1F1F8}"),w.some(te=>te.flag===Q&&te.date===oe)||w.push({flag:Q,date:oe})}}),w.length===0){let D=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);D&&[...new Set(D)].forEach(ee=>w.push({flag:"\u{1F4C5}",date:ee}))}let v="",T='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(T=`
  ...
  `,document.head.appendChild(t)};var _e={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>'};function Mo(){_o();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=pe(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>V());i.appendChild(s);let r=document.createElement("div");r.className="bau-view-container",i.appendChild(r);let l=document.createElement("div");l.id="bau-view-dashboard",l.className="bau-view active",l.innerHTML=`
    ...
    `,r.appendChild(M),document.body.appendChild(i);function F(w){e=w,i.querySelectorAll(".bau-view").forEach(v=>v.classList.remove("active"));let k=i.querySelector(`#bau-view-${w}`);k&&k.classList.add("active");let u=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),y=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");u&&(u.textContent=w==="form"?"Novo Caso BAU":"BAU Central"),y&&(y.textContent=w==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function E(){let w=i.querySelector("#bau-case-list-container");if(w){w.innerHTML="<p>Carregando casos...</p>";try{let k=await Rt();I(k)}catch{w.innerHTML='<p class="bau-error-text">Erro ao carregar casos.</p>'}}}function I(w){let k=i.querySelector("#bau-case-list-container"),u=i.querySelector("#bau-dashboard-metrics");if(!k)return;let y=L=>{switch(L){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray"};default:return{text:L||"Pendente",class:"status-gray"}}};if(!w||w.length===0){u&&(u.innerHTML=""),k.innerHTML=`
            ...
            `;return}let v=w.filter(L=>L.status==="PENDING_TL_CREATION").length,T=w.filter(L=>L.status==="CREATED").length;u&&(u.innerHTML=`
            ...
            `}}i.querySelector("#bau-top-se-search").onclick=w=>{w.preventDefault(),st("bau-context-se-id-input")};function _(){let w=new FormData(b),k=Object.fromEntries(w.entries()),u=w.getAll("taskType"),y=i.querySelector("#bau-confirmation-details");if(!y)return;let v=u.length>0?u.join(", "):"Nenhuma";y.innerHTML=`
