...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(q)}let l=document.createElement("div");l.className="cw-zen-container";let b=document.createElement("div");Object.assign(b.style,{display:"none"});let d=document.createElement("div");d.className="cw-screens-container",b.appendChild(d),l.innerHTML=`
    ...
    `;let g=l.querySelector(".cw-hero-grid"),u=l.querySelector(".cw-acc-container"),x=l.querySelector(".cw-results-container"),S=l.querySelector(".cw-search-input"),h=l.querySelector(".cw-status-bar"),T=l.querySelector(".cw-status-text"),O=l.querySelector(".cw-footer-icons");function I(q,F){return z=>{if(z.target.closest(".cw-step-btn-hero, .cw-step-btn-list"))return;let V=a[q]?a[q].count:0;H(q,V>0?-V:1,F)}}i.forEach(([q,F])=>{let z=n(F.name),V=document.createElement("div");V.className="cw-hero-card",V.id=`hero-${q}`,V.style.setProperty("--hero-color",z.color),V.innerHTML=`
        ...
        `,V.onclick=I(q,F),V.querySelector(".minus").onclick=()=>H(q,-1,F),V.querySelector(".plus").onclick=()=>H(q,1,F),V.dataset.color=z.color,g.appendChild(V)});function _(q,F){let z=n(F.name),V=document.createElement("div");return V.className="cw-task-item",V.dataset.id=q,V.innerHTML=`
...
`.replace(/\n/g,"<br>");Qe(q);let F=await bt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,q),gt(F),Z("Nota gerada e inserida!")):Z("Copiado! Abra uma nota para colar.")},e}function Ae(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function be(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let r,s;if(!n)r=window.innerWidth/2,s=window.innerHeight/2;else{let d=e.getBoundingClientRect();r=d.left+d.width/2,s=d.top+d.height/2,r===0&&s===0&&(r=window.innerWidth/2,s=window.innerHeight/2)}let l=i.x-r,b=i.y-s;t?($.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${b}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${b}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof vo=="function"&&vo(e,o)):($.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${b}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${b}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof _t=="function"&&_t(e))}function vo(t,e){_t(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),r=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):r||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function _t(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function wo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=so(t,V),r=mo(f),s=uo(()=>{R(),W.setActiveTasks(s.getCheckedElements())},f,W),l=document.createElement("div");l.style.display="none";let b=po((p,E)=>{ee(p,E)});l.appendChild(b);let d=document.createElement("div");d.id="evidence-container",Object.assign(d.style,{display:"none",marginTop:"16px",padding:"16px",background:B.bgInput,border:`1px solid ${B.border}`,borderRadius:ue.medium,boxShadow:Me.subtle});let g=document.createElement("div");g.className="cw-section-title",g.textContent=f("evidencias_contato"),d.appendChild(g);let u={},x=(p,E)=>{let k=document.createElement("div");k.style.marginBottom="12px";let P=document.createElement("label");P.textContent=E,P.setAttribute("for",p),P.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${B.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let N=document.createElement("input");return N.type="text",N.id=p,N.className="cw-input",N.placeholder="https://screenshot.googleplex.com/...",N.style.marginBottom="0",k.appendChild(P),k.appendChild(N),u[p]=N,k};d.appendChild(x("evidence-l1",f("ligacao_1"))),d.appendChild(x("evidence-l2",f("ligacao_2"))),d.appendChild(x("evidence-msg",f("mensagem_am")));let S=bo({onSaveCurrent:async()=>{let p=await c();return K(),p},onLoadDraft:p=>{y(p)},t:p=>f(p)}),h=M(),T=Y(),O=document.createElement("div"),I=C(),_=ae(S,f);o.appendChild(h),o.appendChild(T),o.appendChild(I),o.appendChild(l),o.appendChild(O),o.appendChild(d),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none";let H=document.createElement("button");H.id="manual-task-toggle",H.textContent=f("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",H.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${B.primary}; background: ${B.surface}; color: ${B.primary}; border-radius: ${ue.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${ce}; text-transform: uppercase; letter-spacing: 0.5px;`,H.onmouseenter=()=>{H.style.background=B.primaryBg},H.onmouseleave=()=>{H.style.background=B.surface},H.onclick=()=>{s.selectionElement.style.display="block",s.screenshotsElement.style.display="block",H.style.display="none"},o.appendChild(H),o.appendChild(s.selectionElement),o.appendChild(r.element),o.appendChild(s.screenshotsElement),o.appendChild(_);let J=document.createElement("div");J.style.display="none",J.style.flexGrow="1",J.style.minHeight="0",J.style.overflow="hidden";let oe=xo(()=>D());oe.style.height="100%",J.appendChild(oe),e.insertBefore(J,i);let q=a.lastElementChild;q&&(q.insertBefore(S.historyBtnWrapper,q.firstChild),q.insertBefore(v(),q.firstChild)),e.appendChild(S.drawer);let F=null;W.subscribe(p=>{w(p),z(),p.isDirty?(F&&clearTimeout(F),F=setTimeout(async()=>{let E=await c(!0);E.subStatus?we.saveEmergency(E):we.clearEmergency(),p.isDirty=!1},2e3)):F&&(clearTimeout(F),F=null)});function z(){let p=we.getCount()>0,E=!!W.currentSubStatus;mt(p||E)}function V(){W.visible=!W.visible,be(W.visible,e,"cw-btn-notes")}function D(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",J.style.display="flex",J.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",J.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function M(){let p=document.createElement("div");if(p.innerHTML=`
        ...
        `;let E=p.querySelector("#main-status-select"),k=p.querySelector("#sub-status-select");return E.onchange=()=>{W.setStatus(E.value),L(E.value,k),W.setSubStatus(""),G("")},k.onchange=()=>{W.setSubStatus(k.value),G(k.value)},p}function A(){return d.style.display==="none"?null:{l1:u["evidence-l1"]?.value.trim()||"",l2:u["evidence-l2"]?.value.trim()||"",msg:u["evidence-msg"]?.value.trim()||""}}function L(p,E){if(E.innerHTML=`<option value="">${f("select_substatus")}</option>`,!p){E.disabled=!0;return}for(let k in Ie)if(Ie[k].status===p){let P=document.createElement("option");P.value=k,P.textContent=Ie[k].name,E.appendChild(P)}E.disabled=!1}function G(p){let E=Ie[p],k=p==="NI_Attempted_Contact"||E&&E.name&&E.name.toLowerCase().includes("attempted contact");if(b.render&&b.render(p,W.currentCaseType),!p){d.style.display="none",u["evidence-l1"]&&(u["evidence-l1"].value=""),u["evidence-l2"]&&(u["evidence-l2"].value=""),u["evidence-msg"]&&(u["evidence-msg"].value=""),l.style.display="none",O.style.display="none";let pe=document.getElementById("manual-task-toggle");pe&&(pe.style.display="none"),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",I.style.display="flex",I.style.opacity="1",_.style.display="none";return}k?d.style.display="block":(d.style.display="none",u["evidence-l1"]&&(u["evidence-l1"].value=""),u["evidence-l2"]&&(u["evidence-l2"].value=""),u["evidence-msg"]&&(u["evidence-msg"].value="")),I.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(I.style.display="none")},400),_.style.display="grid",E&&E.templateFields&&W.setActiveFields(E.templateFields.filter(pe=>!it.includes(pe))),U(),dt(p,O,W),O.style.display="block",l.style.display="block";let P=p.startsWith("SO_"),N=p==="NI_Awaiting_Validation",Q=document.getElementById("manual-task-toggle");P||N?(s.selectionElement.style.display="block",Q.style.display="none"):(s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",Q.style.display="block");let X=p==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(X),s.updateSubStatus(p),R();let se=document.getElementById("email-automation-toggle-row");se&&(se.style.display=Ye[p]?"flex":"none")}function R(){let p=s.getCheckedElements().map(E=>E.value);r.updateVisibility(W.currentSubStatus,p)}function ee(p,E){let k=lt[p];if(k){for(let P in k)if(P==="linkedTask")s.toggleTask(k.linkedTask,E);else if(P==="activeTasks")k.activeTasks.forEach(N=>{E?s.setTaskCount(N.value,N.count):s.setTaskCount(N.value,0)});else if(P.startsWith("field-")){let N=P,Q=k[P],X=document.getElementById(N);if(X){let se=We.includes(N.replace("field-",""));if(E)if(se){let pe=X.value.trim();pe.includes(Q.trim())||(X.value=pe?pe+`
`+Q.trim():Q.trim())}else X.value=Q;else if(se){let pe=X.value.trim(),Le=Q.trim();pe.includes(Le)&&(X.value=pe.replace(Le,"").trim().replace(/\n{3,}/g,`
...
`))}else X.value.trim()===Q.trim()&&(X.value="");W.updateField(N,X.value),X.dispatchEvent(new Event("input"))}}}}function ae(p,E){let k=document.createElement("div");if(k.className="cw-actions-section",k.style.cssText=`
 ...
 D) Nombre del sitio web.`,"autenticar la cuenta del anunciante en el cases, si corresponde.","T\xE9rminos y condiciones.","Informar las Task solicitadas y AM.","Cerrar contenido sensible.","Confirmaci\xF3n de copia de seguridad y acceso de administrador a las herramientas.","Resumen de llamada."],fim:["Ofrecer ayuda adicional.","Dejar de compartir la pantalla.","Pasos siguientes (Si se le har\xE1 seguimiento al caso).","Encuesta de Satisfacci\xF3n.","Informar al cliente que el equipo de QA ir\xE1 a realizar pruebas en los siguientes d\xEDas."]}};var ie={bgApp:"#F5F5F7",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.07)",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",textPrimary:"#1D1D1F",textSecondary:"#6E6E73",danger:"#D93025",dangerBg:"#FCE8E6",success:"#34A853",successBg:"#E6F4EA"},pa={inicio:{PT:"Abertura",ES:"Apertura"},meio:{PT:"Implementa\xE7\xE3o (Tag Support)",ES:"Implementaci\xF3n"},fim:{PT:"Fechamento",ES:"Cierre"}};function ua(){if(document.getElementById("csa-styles-v2"))return;let t=document.createElement("style");t.id="csa-styles-v2",t.textContent=`
    ...
    `,document.head.appendChild(t)}function To(){let t="v3.1.0";ua();let e={},o="PT",a="BAU",n=!1,i=document.createElement("div");i.id="call-script-popup",i.classList.add("cw-module-window"),Object.assign(i.style,ye,{right:"auto",left:"50%",width:"420px",height:"700px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:i,googleLine:null},s=null;function l(){n&&Te().then(y=>{let f=i.querySelector("#cw-ctx-name"),v=i.querySelector("#cw-ctx-cid"),C=i.querySelector("#cw-ctx-email");if(f&&(f.textContent=y.advertiserName||"Cliente Desconhecido"),v){let w=y.cid||"---";v.textContent!==w&&(v.textContent=w)}if(C){let w=y.clientEmail||"N\xE3o encontrado";C.textContent!==w&&(C.textContent=w,C.title=w)}})}function b(){Te().then(y=>{let f=new Date().toLocaleDateString("pt-BR"),v=i.querySelector("#cw-am-message-area"),C=i.querySelector("#cw-am-review-container"),w=`Ol\xE1. Bom dia!
...
CID: ${y.cid||"---"}
Case ID: ${y.caseId||"---"}
E-mail: ${y.clientEmail||"---"}`;v&&(v.value=w),C&&(C.classList.add("visible"),C.scrollIntoView({behavior:"smooth",block:"end"}))})}function d(){n=!n,be(n,i,"cw-btn-script"),n?(l(),s||(s=setInterval(l,2e3))):s&&(clearInterval(s),s=null)}let g=ge(i,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{d()});i.appendChild(g);let u=document.createElement("div");u.className="csa-context-banner",u.innerHTML=`
  ...
  `,h.onfocus=()=>{x.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",x.style.border="1px solid #1a73e8"},h.onblur=()=>{x.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",x.style.border="1px solid transparent"},x.appendChild(S),x.appendChild(h),u.appendChild(x),g.appendChild(u);let T=document.createElement("div");T.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",g.appendChild(T);let O=null;function I(){if(O)return;O=document.createElement("div"),O.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let M=document.createElement("div");M.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",M.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let Y=document.createElement("button");Y.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',Y.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",Y.onclick=()=>{H(),n=!1,F()},M.appendChild(Y),O.appendChild(M);let A=document.createElement("div");A.id="cw-history-list",A.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",O.appendChild(A),g.appendChild(O)}function _(){O||I();let M=O.querySelector("#cw-history-list");M.innerHTML="";let Y=ma();Y.length===0?M.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':Y.forEach(A=>{let L=V(A,Ge[A._originalCat],!0,A._originalCat);M.appendChild(L)}),requestAnimationFrame(()=>O.style.transform="translateY(0)")}function H(){O&&(O.style.transform="translateY(100%)")}function J(){d.innerHTML="";let M=oe("history","Recentes",Ge.history);M.id="cw-sidebar-btn-history",M.onclick=()=>{$.playClick(),n=!n,n?_():H(),F()},d.appendChild(M);let Y=document.createElement("div");Y.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(Y),Object.keys(et).forEach(A=>{let L=et[A],G=oe(A,L.label,Ge[A]);G.id=`cw-sidebar-btn-${A}`,G.onclick=()=>{$.playClick(),n&&(n=!1,H()),q(A)},d.appendChild(G)})}function oe(M,Y,A){let L=document.createElement("div");L.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,L.title=Y,L.dataset.key=M;let G=document.createElement("div");G.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",G.innerHTML=A||Ge.tasks;let R=document.createElement("div");return R.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",R.textContent=Y,L.appendChild(G),L.appendChild(R),L.onmouseenter=()=>{a!==M&&!(M==="history"&&n)&&(L.style.background="#F1F3F4",G.style.transform="scale(1.1)")},L.onmouseleave=()=>{a!==M&&!(M==="history"&&n)&&(L.style.background="transparent",G.style.transform="scale(1)")},L}function q(M){let Y=document.getElementById(`cat-anchor-${M}`);Y&&(Y.scrollIntoView({behavior:"smooth",block:"start"}),a=M,F())}function F(){Object.keys(et).forEach(Y=>{let A=d.querySelector(`#cw-sidebar-btn-${Y}`);if(A)if(a===Y&&!n){let L=yt[Y];A.style.background=L.bg,A.style.color=L.color,A.querySelector("div:first-child").style.transform="scale(1.1)"}else A.style.background="transparent",A.style.color=i.textSecondary,A.querySelector("div:first-child").style.transform="scale(1)"});let M=d.querySelector("#cw-sidebar-btn-history");M&&(n?(M.style.background="#3C4043",M.style.color="#FFFFFF"):(M.style.background="transparent",M.style.color=i.textSecondary))}function z(){if(T.innerHTML="",e.trim()!==""){let Y=[];if(Object.entries(et).forEach(([L,G])=>{let R=G.links.filter(ee=>ee.name.toLowerCase().includes(e.toLowerCase())||ee.desc.toLowerCase().includes(e.toLowerCase()));Y.push(...R.map(ee=>({...ee,_cat:L})))}),Y.length===0){T.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let A=document.createElement("div");A.innerHTML="Resultados da busca",A.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",T.appendChild(A),Y.forEach(L=>{let G=V(L,Ge[L._cat],!1,L._cat);T.appendChild(G)});return}Object.entries(et).forEach(([Y,A])=>{let L=yt[Y],G=document.createElement("div"),R=document.createElement("div");R.id=`cat-anchor-${Y}`,R.style.cssText=`
              display: flex; align-items: center; gap: 8px;
      ...
      `,x.querySelectorAll('input[name="cw-bc-type"]').forEach(R=>{R.addEventListener("change",()=>{x.querySelectorAll(".cw-radio-option").forEach(ee=>ee.classList.remove("checked")),R.parentElement.classList.add("checked")})}),setTimeout(()=>{let R=x.querySelector(".cw-radio-option.info");R&&R.classList.add("checked")},100);let A=x.querySelector("#cw-bc-cancel"),L=x.querySelector("#cw-bc-close-x"),G=x.querySelector("#cw-bc-send");A.onclick=I,L.onclick=I,G.onclick=_,l.appendChild(x)}function O(A=null){if(!x)return;let L=x.querySelector("#cw-editor-title-label"),G=x.querySelector("#cw-bc-title"),R=x.querySelector("#cw-bc-text"),ee=x.querySelector("#cw-bc-send");if(A){a=A.id,L.textContent="Editar Aviso",G.value=A.title||"",R.value=A.text||"",ee.textContent="Salvar Altera\xE7\xF5es";let ae=A.type||"info",te=x.querySelector(`input[name="cw-bc-type"][value="${ae}"]`);te&&te.click()}else{a=null,L.textContent="Novo Aviso",G.value="",R.value="",ee.textContent="Publicar";let ae=x.querySelector('input[name="cw-bc-type"][value="info"]');ae&&ae.click()}x.classList.add("active"),setTimeout(()=>G.focus(),300)}function I(){x&&x.classList.remove("active"),a=null}async function _(){let A=x.querySelector("#cw-bc-send"),L=x.querySelector("#cw-bc-title"),G=x.querySelector("#cw-bc-text"),R=x.querySelector('input[name="cw-bc-type"]:checked'),ee=R?R.value:"info";if(!L.value.trim()||!G.value.trim()){Z("Preencha todos os campos!",{error:!0});return}A.textContent="Salvando...",A.style.opacity="0.7";let ae=!1;a?ae=await de.updateBroadcast(a,{title:L.value,text:G.value,type:ee}):ae=await de.sendBroadcast({title:L.value,text:G.value,type:ee,author:window._cwCurrentUser||"admin"}),ae?(Z(a?"Atualizado!":"Publicado!"),$.playSuccess(),I(),setTimeout(()=>oe(),1500)):(Z("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),A.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",A.style.opacity="1")}async function H(A){if(await ve("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await de.deleteBroadcast(A)){Z("Aviso removido."),$.playClick();let R=ze.findIndex(ee=>ee.id===A);R>-1&&ze.splice(R,1),F(),setTimeout(()=>oe(),1500)}else Z("Erro ao excluir.",{error:!0})}let J=document.createElement("div");J.className="cw-nice-scroll",Object.assign(J.style,i.feedContainer),l.appendChild(J);async function oe(){e&&(h.style.display="block",h.innerHTML="\u{1F504} Sincronizando...");try{let A=await de.fetchData();A&&A.broadcast&&(Nt(A.broadcast),q(),e&&(F(),h.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{h.style.display="none"},1500)))}catch{e&&(h.innerHTML="\u26A0\uFE0F Offline")}}function q(){let A=document.getElementById("cw-btn-broadcast");if(!A)return;let L=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(ze.some(R=>!L.includes(R.id))){if(A.classList.add("has-new"),!A.querySelector(".cw-badge")){let R=document.createElement("div");R.className="cw-badge",Object.assign(R.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),A.appendChild(R)}}else{A.classList.remove("has-new");let R=A.querySelector(".cw-badge");R&&R.remove()}}function F(){J.innerHTML="";let A=l.querySelector("#cw-bau-widget");A&&A.remove();let L=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),G=[...ze].sort((j,U)=>{let K=new Date(j.date).getTime()||0;return(new Date(U.date).getTime()||0)-K}),R=G.findIndex(j=>j.title&&j.title.toLowerCase().includes("disponibilidade bau"));if(R!==-1){let j=G[R];G.splice(R,1);let U=document.createElement("div");U.id="cw-bau-widget",Object.assign(U.style,i.bauContainer);let K=[],c=(j.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,y="\u{1F4C5}";if(c.forEach(p=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(p)?y="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(p)&&(y="\u{1F1EA}\u{1F1F8}");let E=p.match(m);if(E){let k=E[0],P=y;/🇧🇷|🇵🇹|PT|BR/i.test(p)?P="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(p)&&(P="\u{1F1EA}\u{1F1F8}"),K.some(Q=>Q.flag===P&&Q.date===k)||K.push({flag:P,date:k})}}),K.length===0){let p=(j.text||"").match(/\d{1,2}\/\d{1,2}/g);p&&[...new Set(p)].forEach(E=>K.push({flag:"\u{1F4C5}",date:E}))}let f="",v='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(v=`
    ...
    `,document.head.appendChild(t)}function zo(){let t="v2.0",e=!1,o="general",a="",n=null,i=null;xa();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,ye,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let l=ge(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>K());r.appendChild(l);let b=document.createElement("div");b.className="cw-lib-container",r.appendChild(b);let d=document.createElement("div");d.className="cw-lib-toolbar";let g=document.createElement("div");g.className="cw-lib-search-wrap";let u=document.createElement("div");u.className="cw-lib-search-icon",u.innerHTML=xe.search;let x=document.createElement("input");x.className="cw-lib-search no-drag",x.placeholder="Buscar por t\xEDtulo ou conte\xFAdo...",x.type="text";let S=document.createElement("div");S.className="cw-lib-search-clear cw-tactile",S.innerHTML=xe.clear,g.append(u,x,S);let h=document.createElement("div");h.className="cw-lib-tabs",No.forEach(c=>{let m=document.createElement("div");m.className="cw-lib-tab"+(c.id===o?" active":""),m.id=`lib-tab-${c.id}`,m.innerHTML=`${c.icon}<span>${c.label}</span>`,m.onmouseenter=()=>$.playHover(),m.onclick=()=>M(c.id),h.appendChild(m)}),d.append(g,h),b.appendChild(d);let T=document.createElement("div");T.className="cw-lib-grid",b.appendChild(T);let O=document.createElement("div");O.className="cw-lib-fab cw-tactile",O.title="Novo item",O.innerHTML=xe.add,O.onclick=()=>ee(),b.appendChild(O);let I=document.createElement("div");I.className="cw-lib-sheet";let _=document.createElement("div");_.className="cw-lib-sheet-handle";let H=document.createElement("div");H.className="cw-lib-sheet-head";let J=document.createElement("div");J.className="cw-lib-sheet-back no-drag",J.innerHTML=xe.back,J.title="Cancelar",J.onclick=ae;let oe=document.createElement("span");oe.className="cw-lib-sheet-title",oe.textContent="Novo Item",H.append(J,oe);let q=document.createElement("div");q.className="cw-lib-sheet-body";let F=document.createElement("div");F.className="cw-lib-sheet-foot";let z=document.createElement("button");z.className="cw-lib-save-btn no-drag",z.textContent="Salvar",z.onclick=te,F.appendChild(z);let V=document.createElement("div");V.className="cw-lib-loading",V.innerHTML='<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text">Salvando...</div>',I.append(_,H,q,F,V),b.appendChild(I);let D=document.createElement("div");Object.assign(D.style,qe),D.className="no-drag",r.appendChild(D),Oe(r,D),document.body.appendChild(r),document.addEventListener("mousedown",c=>{i&&!i.contains(c.target)&&Y()});function M(c){$.playClick(),o=c,No.forEach(m=>{document.getElementById(`lib-tab-${m.id}`).classList.toggle("active",m.id===c)}),L()}function Y(){if(i){let c=i.querySelector(".cw-lib-menu");c&&c.classList.remove("open"),i=null}}function A(c,m){return m?`${c.title} ${c.content}`.toLowerCase().includes(m):!0}function L(){Y(),T.innerHTML="";let c=a.trim().toLowerCase(),m=Se.getSnippets(o).filter(y=>A(y,c));if(m.length===0){let y=document.createElement("div");y.className="cw-lib-empty";let f=c.length>0;y.innerHTML=`
            ...
            `,T.appendChild(y);return}m.forEach(y=>T.appendChild(G(y)))}function G(c){let m=document.createElement("div");m.className="cw-lib-card"+(c.isCode?" is-code":"");let y=c.content,f="";if(c.isRich){let p=document.createElement("div");p.innerHTML=c.content;let E=!!p.querySelector("img");y=p.innerText.substring(0,200),E&&(f=`<span class="cw-lib-media-tag">${xe.media} M\xEDdia</span>`)}let v=[c.isCode?'<span class="cw-lib-badge code">CODE</span>':"",o==="email"?'<span class="cw-lib-badge template">TEMPLATE</span>':""].join("");m.innerHTML=`
            <div class="cw-lib-card-head">
                <div class="cw-lib-card-title">${U(c.title)}</div>
                <div class="cw-lib-card-badges">${v}</div>
            </div>
            ${f}
            <div class="cw-lib-card-preview${c.isCode?" code":""}">${U(y)}</div>
        ...
        `,m.querySelector(".cw-act-copy").onclick=p=>{p.stopPropagation(),$.playClick(),R(c)};let C=m.querySelector(".cw-act-more"),w=m.querySelector(".cw-lib-menu");return C.onclick=p=>{p.stopPropagation(),$.playClick();let E=w.classList.contains("open");Y(),E||(w.classList.add("open"),i=m)},m.querySelector(".cw-act-edit").onclick=p=>{p.stopPropagation(),$.playClick(),Y(),ee(c)},m.querySelector(".cw-act-del").onclick=async p=>{p.stopPropagation(),$.playClick(),Y(),await ve(`Excluir "${c.title}"?`)&&(Se.delete(c.id),L(),Z("Item exclu\xEDdo."))},m}function R(c){if(c.isRich){let m=new Blob([c.content],{type:"text/html"}),y=document.createElement("div");y.innerHTML=c.content;let f=new Blob([y.innerText],{type:"text/plain"});navigator.clipboard.write([new ClipboardItem({"text/html":m,"text/plain":f})])}else navigator.clipboard.writeText(c.content);Z("Copiado!")}function ee(c=null){n=c?c.id:null,q.innerHTML="",q.appendChild(j("title","T\xEDtulo / Nome",c?c.title:"")),o==="email"&&q.appendChild(j("subject","Assunto do Email",c?c.subject:""));let m="Conte\xFAdo";o==="email"&&(m="Corpo do Email (HTML)"),o==="note"&&(m="Texto da Nota"),q.appendChild(j("content",m,c?c.content:"",{isRich:!0,isCode:c?c.isCode:!1})),oe.textContent=c?"Editar Item":"Novo Item",z.textContent=c?"Salvar Altera\xE7\xF5es":"Salvar",I.classList.add("open"),setTimeout(()=>{let y=q.querySelector("input");y&&y.focus()},350)}function ae(){$.playSwoosh(),I.classList.remove("open"),setTimeout(()=>{n=null},300)}async function te(){V.classList.add("active"),z.disabled=!0;try{let c=q.querySelector("#cw-lib-inp-title"),m=q.querySelector("#cw-lib-inp-content"),y=c.value.trim(),f=m.contentEditable==="true"?m.innerHTML:m.value.trim(),v=m.getAttribute("data-is-code")==="true";if(!y||!f||f==="<br>"){Z("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let C={id:n,type:o,title:y,content:f,isCode:v,isRich:m.contentEditable==="true"};if(o==="email"){let p=q.querySelector("#cw-lib-inp-subject").value.trim();if(!p){Z("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}C.subject=p}let w=await Se.save(C);if(w===!1){Z("N\xE3o foi poss\xEDvel salvar: usu\xE1rio n\xE3o identificado. Recarregue a p\xE1gina e tente de novo.",{error:!0});return}L(),ae(),w.synced===!1?Z("Salvo localmente \u2014 sem conex\xE3o com a nuvem no momento.",{error:!0}):(Z("Salvo e sincronizado!"),$.playSuccess())}catch(c){console.error("Erro ao salvar item da biblioteca:",c),Z("Erro ao salvar item.",{error:!0})}finally{V.classList.remove("active"),z.disabled=!1}}function j(c,m,y,f={}){let v=document.createElement("div");v.className="cw-lib-field";let C=document.createElement("label");C.className="cw-lib-label",C.textContent=m,v.appendChild(C);let w;if(f.isRich){let p=document.createElement("div");p.className="cw-lib-toolbar-mini",p.innerHTML=`
        ...
        `,setTimeout(async()=>{try{let S=fe(),h=S?S.split("@")[0]:"user",T=await ot(h);if(!T){l.innerHTML=`
    ...
    `}catch(S){console.warn("Erro ao renderizar perfil:",S),l.style.display="none"}},3e3)}b();let d=document.createElement("div");d.className="cw-configs-section",d.innerHTML=`
  ...
  `,document.head.appendChild(t)};var Ue={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var me={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function $o(t){switch(t){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:t||"Pendente",class:"status-gray",aura:""}}}function Po(t){let e=document.createElement("div");if(e.className="bau-dynamic-input",e.id=`wrapper-${t.id}`,t.label){let a=document.createElement("label");a.className="bau-label",a.textContent=t.label,t.tooltip&&a.setAttribute("data-tooltip",t.tooltip),e.appendChild(a)}let o;switch(t.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",e.appendChild(o);break;case"select":o=document.createElement("select"),t.groups?t.groups.forEach(r=>{let s=document.createElement("optgroup");s.label=r.label,r.options.forEach(l=>{let b=document.createElement("option");b.value=l.value,b.textContent=l.text,s.appendChild(b)}),o.appendChild(s)}):t.options&&t.options.forEach(r=>{let s=document.createElement("option");s.value=r.value,s.textContent=r.text,o.appendChild(s)}),e.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",t.options.forEach(r=>{let s=document.createElement("label");s.className="bau-task-item",s.innerHTML=`<input type="checkbox" name="${t.name}" value="${r}"><span>${r}</span>`,s.addEventListener("click",l=>{l.preventDefault();let b=s.querySelector("input");b.checked=!b.checked,s.classList.toggle("active",b.checked),$.playClick()}),o.appendChild(s)}),e.appendChild(o),e;case"datetime-group":o=document.createElement("div"),o.className="bau-availability-container",t.fields.forEach(r=>{let s=document.createElement("div");s.className="bau-availability-field",s.innerHTML=`
    ...
    `,h.appendChild(T);let O=c=>{T.classList.toggle("active",c)},I=document.createElement("div");I.className="bau-progress-indicator",h.appendChild(I);let _=document.createElement("form");_.id="bau-escalation-form",_.noValidate=!0,h.appendChild(_),Ue.steps.forEach(c=>{let m=document.createElement("div");if(m.className="bau-step"+(c.id===a?" active":""),m.id=`bau-step-${c.id}`,c.isBranching)m.innerHTML=`
            ...
            `,m.querySelector("#bau-opt-full").onclick=()=>{n="BAU",a=1,_.querySelectorAll(".bau-highlight-panel").forEach(y=>y.classList.remove("discard-theme")),L(),$.playClick()},m.querySelector("#bau-opt-discard").onclick=()=>{n="DISCARD",a=5,_.querySelectorAll(".bau-highlight-panel").forEach(y=>y.classList.add("discard-theme")),L(),$.playClick()};else if(c.isConfirmation)m.innerHTML=`
                <div class="bau-card">
                    <h3 class="bau-step-title">Confirme os dados antes de enviar</h3>
                    <div id="bau-confirmation-details"></div>
                </div>
            `;else{let y=document.createElement("div");if(y.className="bau-card",c.id===1||c.id===5){y.innerHTML=`
    ...
    `,d.appendChild(F),document.body.appendChild(l);function z(c){e=c,l.querySelectorAll(".bau-view").forEach(C=>C.classList.remove("active"));let m=l.querySelector(`#bau-view-${c}`);m&&m.classList.add("active");let y=b.querySelector(".cw-module-header-title")||b.querySelector("h2"),f=b.querySelector(".cw-module-header-subtitle")||b.querySelector("p");y&&(c==="form"?y.textContent=i?`Editando Caso #${r}`:"Novo Caso BAU":y.textContent="BAU Central"),f&&(f.textContent=c==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU");let v=_.querySelector(".bau-btn-submit");v&&(v.innerHTML=i?`${me.send} Salvar Altera\xE7\xF5es`:`${me.send} Enviar para o TL`)}function V(){let c=l.querySelector("#bau-case-list-container"),m=l.querySelector("#bau-dashboard-metrics");m&&(m.innerHTML=`
        ...
        `).join(""))}async function D(){let c=l.querySelector("#bau-case-list-container"),m=l.querySelector("#bau-dashboard-metrics");if(!(!c||!m)){V();try{let y=await Ut();if(!Array.isArray(y))throw new Error("API response is not a valid array");A(y)}catch(y){console.error("Critical Error loading BAU cases:",y),m&&(m.innerHTML=""),c.innerHTML=`
            ...
            `,l.querySelector("#bau-retry-btn")?.addEventListener("click",()=>D()),Z("Erro ao carregar Dashboard. Verifique sua conex\xE3o.",{error:!0})}}}function M(c){if(!c)return;let m=$o(c.status),y=(v,C)=>{navigator.clipboard.writeText(v).then(()=>{Z("Copiado para a \xE1rea de transfer\xEAncia!"),$.playClick();let w=C.style.color;C.style.color="#1E8E3E",setTimeout(()=>{C.style.color=w},800)})};g.innerHTML=`
                ...
                <div class="bau-details-grid">
                    ...
                    <div class="bau-details-card full-width">
                        ...
                        <div class="bau-details-row">
                            ...
                            <span class="bau-details-value">${nt(c.availability)}</span>
                        </div>
                    </div>
                </div>
            </div>
        `;let f=g.querySelector(".bau-details-close-btn");f.onclick=()=>{g.classList.remove("active"),$.playSwoosh(),setTimeout(()=>{g.style.display="none"},600)},g.querySelectorAll(".bau-copy-btn").forEach(v=>{v.onclick=C=>{let w=C.target.closest(".bau-details-row").querySelector(".bau-details-value").textContent;y(w,v)}}),g.style.display="flex",requestAnimationFrame(()=>{g.classList.add("active"),$.playClick()})}function Y(c){if(!c)return"";let m=$o(c?.status),y=nt(c?.date),f="",v="";if(c?.status==="PENDING_TL_CREATION"&&c?.availability_1){let k=new Date(c.availability_1),P=new Date;(k<=P||k-P<36e5*2)&&(f='<span class="bau-sla-badge">Urgente</span>',v="bau-pulse-attention")}let C=c?.reason&&c.reason.trim()?c.reason:"Nenhum contexto adicional fornecido pelo agente.",p=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(c?.cid||""),E=!c?.caseId||c.caseId==="N/A"||!p;return E&&c?.status==="PENDING_TL_CREATION"&&(v="bau-pulse-attention"),`
            <li class="bau-case-card ${m.aura} ${v}" data-case-id="${c?.id||""}">
                <div class="bau-case-main">
                    ...
                    <div class="bau-case-info">
                        ...
                        <p class="bau-case-details">
                            ...
                            <span data-tooltip="CID do Anunciante (Formato: 000-000-0000)" class="${p?"":"bau-error-text"}">CID: ${c?.cid||"N/A"}</span> \u2022
                            <span data-tooltip="O que deve ser feito em BAU">Motivo: ${C}</span>
                        </p>
                        ${E?`<div class="bau-data-error-hint">${!c?.caseId||c?.caseId==="N/A"?"Dados Incompletos":"CID Inv\xE1lido"} - Contate o Suporte</div>`:""}
                    </div>
                </div>
        ...
        `}function A(c){let m=l.querySelector("#bau-case-list-container"),y=l.querySelector("#bau-dashboard-metrics");if(!m||!y)return;let f=Array.isArray(c)?c.filter(Boolean):[];if(f.length===0){y.innerHTML=`
            ...
            `,l.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>D());return}let v=f.filter(k=>k.status==="PENDING_TL_CREATION").length,C=f.filter(k=>k.status==="CREATED").length;y.innerHTML=`
        ...
        `;let w=y.querySelector("#bau-refresh-dashboard");w?.addEventListener("click",async()=>{w.classList.contains("spinning")||(w.classList.add("spinning"),$.playClick(),await D(),setTimeout(()=>w.classList.remove("spinning"),1e3))}),m.innerHTML="";let p=f.slice(0,5),E=f.slice(5);if(p.forEach(k=>{let P=Y(k),N=document.createElement("div");N.innerHTML=P;let Q=N.firstElementChild;Q.addEventListener("click",se=>{se.target.closest(".bau-case-edit-btn")||M(k)});let X=Q.querySelector(".bau-case-edit-btn");X&&(X.onclick=se=>{se.stopPropagation(),j(k)}),m.appendChild(Q)}),E.length>0){let k=document.createElement("li");k.className="bau-accordion-container";let P=document.createElement("button");P.className="bau-accordion-toggle",P.innerHTML=`${me.expand} <span>Mostrar ${E.length} casos mais antigos</span>`;let N=document.createElement("ul");N.className="bau-case-list bau-accordion-content",N.style.display="none",E.forEach(Q=>{let X=Y(Q),se=document.createElement("div");se.innerHTML=X;let pe=se.firstElementChild;pe.addEventListener("click",Ee=>{Ee.target.closest(".bau-case-edit-btn")||M(Q)});let Le=pe.querySelector(".bau-case-edit-btn");Le&&(Le.onclick=Ee=>{Ee.stopPropagation(),j(Q)}),N.appendChild(pe)}),P.addEventListener("click",()=>{let Q=N.style.display==="none";N.style.display=Q?"block":"none",P.classList.toggle("expanded",Q),P.querySelector("span").textContent=Q?"Esconder casos mais antigos":`Mostrar ${E.length} casos mais antigos`,$.playClick()}),k.appendChild(P),k.appendChild(N),m.appendChild(k)}}function L(){let c=n==="BAU"?[1,2,3,4]:[5,4];_.querySelectorAll(".bau-step").forEach(f=>{let v=parseInt(f.id.replace("bau-step-","")),C=v===a,w=c.includes(v)||v===0;f.classList.toggle("active",C),f.style.display=C?"block":"none",f.querySelectorAll("input, select, textarea").forEach(p=>{p.disabled=!w})});let m=a===0;if(I.style.display=m?"none":"flex",!m){I.innerHTML="";let f=n==="BAU"?[1,2,3,4]:[5,4];f.forEach((v,C)=>{let w=document.createElement("div"),p=v===a,E=f.indexOf(a),k=C<E;w.className=`bau-progress-step ${p?"active":k?"completed":""}`,w.textContent=C+1,I.appendChild(w)})}let y=a===4;J.style.display=a>0?"inline-block":"none",oe.style.display=!m&&!y?"inline-block":"none",q.style.display=y?"flex":"none",y&&te()}function G(c){let m=Ue.steps.find(y=>y.id===c);if(!m||!m.fields||m.isConfirmation)return!0;for(let y of m.fields){let f=_.querySelector(`#bau-step-${c} #wrapper-${y.id}`);if(!(f&&f.style.display==="none")&&y.validation){let v=_.querySelector(`#bau-step-${c} [name="${y.name}"]`);if(v&&v.offsetParent!==null&&v.value.trim())if(new RegExp(y.validation.regex).test(v.value.trim())){v.classList.remove("invalid-cid");let w=_.querySelector("#bau-cid-error");w&&(w.style.display="none")}else{console.warn(`Validation failed for field "${y.name}" in step ${c}: Regex mismatch.`),Z(`Erro: ${y.validation.error}`,{error:!0}),v.classList.add("invalid-cid");let w=_.querySelector("#bau-cid-error");return w&&(w.style.display="flex"),!1}}}return!0}function R(c){if(!_.querySelector(`#bau-step-${c}`))return!1;let y=Ue.steps.find(v=>v.id===c);if(!y||!y.fields||y.isConfirmation)return!0;let f=!0;for(let v of y.fields){let C=_.querySelector(`#bau-step-${c} #wrapper-${v.id}`);if(!(C&&C.style.display==="none")&&v.required){let w=!0,p="";if(v.type==="checkbox-grid")_.querySelector(`#bau-step-${c} input[name="${v.name}"]:checked`)||(p="No option selected in checkbox-grid",Z(`Erro: Selecione pelo menos uma op\xE7\xE3o para "${v.label}".`,{error:!0}),w=!1);else if(v.type==="datetime-group"){let E=_.querySelector(`#bau-step-${c} input[name="${v.fields[0].name}"]`);if(!E||E.offsetParent===null)continue;E.value.trim()||(p="Datetime group first field is empty",Z(`Erro: O campo "${v.fields[0].label}" \xE9 obrigat\xF3rio.`,{error:!0}),w=!1)}else{let E=_.querySelector(`#bau-step-${c} [name="${v.name}"]`);if(!E||E.offsetParent===null)continue;E.value.trim()||(p="Field is empty",Z(`Erro: O campo '${v.label}' \xE9 obrigat\xF3rio.`,{error:!0}),w=!1)}if(!w){console.warn(`Validation failed for required field "${v.name}" in step ${c}: ${p}`),f=!1;break}}}return f}oe.addEventListener("click",()=>{if(G(a)&&R(a)){n==="BAU"?a++:a===5?a=4:a++,L();let c=l.querySelector(".bau-content");c&&(c.scrollTop=0),$.playClick()}}),J.addEventListener("click",()=>{a>0&&(n==="BAU"?a--:a===4?a=5:a===5?a=0:a--,L(),$.playClick())});async function ee(){let c=await Te()||{};(!c.amName||c.amName==="N/A")&&(c.amName=c.internalEmail||"N/A"),o=c,_.querySelectorAll(".bau-vital-highlights").forEach(f=>{let v=[{label:"Anunciante",value:c.advName},{label:"CID",value:c.cid},{label:"Website",value:c.website||c.site},{label:"Case ID",value:c.caseId}];f.innerHTML=v.map(C=>{let w=C.value&&C.value!=="N/A"&&C.value!=="undefined"&&C.value!=="null"?C.value:"N\xE3o capturado";return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${C.label}</span>
                        <span class="bau-highlight-value">${w}</span>
                    </div>
                `}).join("")}),Ue.steps.forEach(f=>{f.fields&&f.fields.forEach(v=>{if(v.isSmart){let C=c[v.id];v.id==="language"&&c.userProfile?.defaultLanguage&&(C=c.userProfile.defaultLanguage);let w=_.querySelector(`#bau-step-${f.id} [name="${v.name}"]`),p=_.querySelector(`#bau-step-${f.id} #wrapper-${v.id}`);if(w&&(w.value=C&&C!=="N/A"?C:"",v.id==="language"&&C&&C!=="N/A"&&(w.readOnly=!0,w.style.background="#F1F3F4",w.style.cursor="not-allowed")),p){let E=C&&C!==""&&C!=="N/A"&&C!=="undefined"&&C!=="null";v.id==="language"?p.style.display="block":p.style.display=E?"none":"block"}}})}),_.querySelectorAll(".bau-all-data").forEach(f=>{let v=[{label:"Anunciante",value:c.advName},{label:"CID",value:c.cid},{label:"AM",value:c.amName},{label:"SE ID",value:c.seId},{label:"Site",value:c.website||c.site},{label:"Email",value:c.email},{label:"Timezone",value:c.timezone},{label:"Case ID",value:c.caseId},{label:"Programa",value:c.salesProgram},{label:"Idioma",value:c.language}];f.innerHTML=`
            ...
            `})}l.querySelector("#bau-top-se-search")?.addEventListener("click",c=>{c.preventDefault(),ct("bau-form-seId")});let ae=l.querySelector("#bau-form-cid");ae&&ae.addEventListener("input",()=>G(1));function te(){let c=new FormData(_),m=Object.fromEntries(c.entries()),y=l.querySelector("#bau-confirmation-details");if(y){if(n==="BAU"){let f=c.getAll("taskType"),v=f.length>0?f.join(", "):"Nenhuma";y.innerHTML=`
            ...
            `;y.querySelectorAll(".bau-confirm-value-input").forEach(f=>{f.addEventListener("input",v=>{let C=v.target.dataset.field,w=v.target.dataset.step;if(!C||!w)return;let p=_.querySelector(`#bau-step-${w} [name="${C}"]`);p&&(p.value=v.target.value,C==="cid"&&G(1))})})}}async function j(c){if(!await ve("Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",{confirmText:"Estou na p\xE1gina correta"}))return;O(!0),U(),i=!0,r=c.id,n=c.status==="PENDING_TL_DISCARD"||c.reason&&!c.task?"DISCARD":"BAU",z("form"),await ee(),o={...o,advName:c.advName||o.advName,cid:c.cid||o.cid,caseId:c.caseId||o.caseId,seId:c.seId||o.seId,site:c.site||c.website||o.site||o.website,email:c.advEmail||o.email,timezone:c.timezone||o.timezone,language:c.language||o.language,amName:c.amName||o.amName,salesProgram:c.salesProgram||o.salesProgram};let y=c.availability?c.availability.split("|").map(f=>f.trim()):[];_.querySelectorAll("input, select, textarea").forEach(f=>{let v=f.name,w={advEmail:"advEmail",website:"site",site:"site"}[v]||v;if(v==="taskType"){let p=(c.task||c.taskType||"").split(",").map(E=>E.trim());f.type==="checkbox"&&(f.checked=p.includes(f.value),f.closest(".bau-task-item")?.classList.toggle("active",f.checked))}else if(v.startsWith("availability_")){let p=parseInt(v.split("_")[1])-1,E=y[p];if(E&&f.type==="datetime-local")try{let k=new Date(E);if(!isNaN(k.getTime())){let P=new Date(k.getTime()-k.getTimezoneOffset()*6e4).toISOString().slice(0,16);f.value=P}}catch{}}else c[w]!==void 0?f.value=c[w]:v==="reason"?f.value=c.reason:v==="description"?f.value=c.description:v==="nonImplementationReason"&&(f.value=c.nonImplementationReason||"")}),a=n==="BAU"?1:5,L(),$.playClick(),setTimeout(()=>O(!1),500)}_.onsubmit=async c=>{c.preventDefault();let m=n==="BAU"?[1,2,3]:[5];for(let p of m)if(!Ue.steps.find(k=>k.id===p)?.isConfirmation&&(!G(p)||!R(p))){console.warn(`Form submission blocked by validation failure in step ${p}`),a=p,L();return}let y=l.querySelector(".bau-btn-submit");y.disabled=!0,y.innerHTML="Enviando...";let f=new FormData(_),v=Object.fromEntries(f.entries()),C=o||{},w={...C,...v,requestType:n};if(v.advEmail?w.advEmail=v.advEmail:C.email&&(w.advEmail=C.email),v.website?w.website=v.website:C.website?w.website=C.website:C.site&&(w.website=C.site),n==="BAU"){let p=f.getAll("taskType"),E=[v.availability_1,v.availability_2,v.availability_3].filter(k=>k&&k.trim()!=="").join(" | ");w.taskType=p.join(", "),w.availability=E,i?(v.nonImplementationReason?w.nonImplementationReason=v.nonImplementationReason:delete w.nonImplementationReason,v.description?w.description=v.description:delete w.description):(w.nonImplementationReason=v.nonImplementationReason||"",w.description=v.description||"",w.nonImplementationReason||console.warn("Aviso: Campo 'Justificativa' (nonImplementationReason) est\xE1 saindo vazio."),w.description||console.warn("Aviso: Campo 'Descri\xE7\xE3o detalhada' (description) est\xE1 saindo vazio."))}else w.reason=v.reason,i?(v.description?w.description=v.description:delete w.description,delete w.taskType,delete w.availability,delete w.nonImplementationReason):(w.taskType="",w.availability="",w.nonImplementationReason="",w.description=v.description||"");try{i?await Vt(r,w):await jt(w,C.agentEmail||"anon"),$.playSuccess();let p=l.querySelector(".bau-success-title");p&&(i?p.textContent="Caso atualizado com sucesso!":p.textContent=n==="DISCARD"?"Caso enviado para descarte com sucesso!":"Caso enviado com sucesso!"),z("success")}catch(p){Z("Erro: "+(p.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",w)}finally{y.disabled=!1,y.innerHTML=`${me.send} Enviar para o TL`}};function U(){_.reset(),a=0,n="BAU",i=!1,r=null,L(),_.querySelectorAll(".bau-task-item.active").forEach(m=>m.classList.remove("active"));let c=_.querySelector('[name="language"]');c&&(c.readOnly=!1,c.style.background="",c.style.cursor="")}l.querySelector("#bau-new-case-btn").addEventListener("click",()=>{U(),z("form"),ee()}),l.querySelector("#bau-form-back-btn").addEventListener("click",()=>z("dashboard")),l.querySelector("#bau-success-back-btn").addEventListener("click",()=>z("dashboard"));async function K(){t=!t,l.style.display=t?"flex":"none",t&&(z("dashboard"),D()),be(t,l,"cw-btn-bauform")}return L(),K}function ha(){if(window.techSolInitialized){kt();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Jt();try{$.initGlobalListeners(),$.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}de.fetchTips(),kt();let e=wo(),o=Ao(),a=To(),n=Lo(),i=Mo(),r=zo(),s=Ro(),l=Ho(),b=Io();go({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:r,toggleConfigs:s,toggleBAUForm:l,broadcastControl:b}),setTimeout(()=>{de.logEvent("App","Start","Session Start"),qo(),setTimeout(()=>{_o(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),Z("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}ha();})();
