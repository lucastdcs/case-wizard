...
CID: ${v.cid||"---"}
Case ID: ${v.caseId||"---"}
E-mail: ${v.clientEmail||"---"}`;D&&(D.value=K),$&&($.style.display="block",$.style.maxHeight="300px",$.style.opacity="1",$.scrollIntoView({behavior:"smooth",block:"end"}))})}function x(){s=!s,ue(s,c,"cw-btn-script"),s?(d(),l||(l=setInterval(d,2e3))):l&&(clearInterval(l),l=null)}let b=pe(c,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",p,()=>{x()});c.appendChild(b);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
