...
.cw-dropdown-option.selected {
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Tt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Wt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Xt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Ne=t=>new Promise(e=>setTimeout(e,t));async function Zo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Ne(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let s=Math.floor(Math.random()*60)+30;a===0&&(s=150),a>e.length-3&&(s=30),await Ne(s)}await Ne(600),o&&(o.style.display="none")}async function Ft(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Ne(200);let e=await Et(),o=jt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),s=t.querySelector("#p3"),r=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),s&&(s.textContent=o.suffix),await Ne(300);let d=a?a.querySelector("svg"):null;if(d&&(d.style.opacity="1",d.style.transform="scale(1)"),await Ne(400),n&&(n.style.opacity="1"),H.playStartup(),i&&await Zo(i,o.name),s&&(s.style.opacity="1",s.style.transform="translateY(0)"),o.isFriday&&r){await Ne(400),r.style.display="block",r.offsetWidth;let m=r.querySelector(".sextou-badge");m&&(m.style.opacity="1",m.style.transform="scale(1)")}await Ne(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Ne(900),t.parentNode&&t.parentNode.removeChild(t)}}function Jt(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,s=a-e.height-n,r=parseFloat(t.style.left)||e.left,d=parseFloat(t.style.top)||e.top,m=Math.max(n,Math.min(r,i)),l=Math.max(n,Math.min(d,s));if(m!==r||l!==d){let p=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${m}px`,t.style.top=`${l}px`,setTimeout(()=>{t.style.transition=p},300)}}var Oe={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Le(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,s=a.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),d=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),m=i,l=s,p=!1;function x(u){m=u.clientX,l=u.clientY,p||(window.requestAnimationFrame(()=>{f(),p=!1}),p=!0)}function f(){let u=r+(m-i),C=d+(l-s);u>360&&(t.style.width=u+"px"),C>300&&(t.style.height=C+"px")}function g(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",g),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",g)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Kt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Zt(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Qt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function ye(t,e={}){return new Promise(o=>{let a=Zt(),n=Qt(),i=e.danger?"#FF3B30":"#007AFF",s=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let r=l=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(l)},300)},d=n.querySelector("#cw-conf-cancel"),m=n.querySelector("#cw-conf-ok");[d,m].forEach(l=>l.onmouseenter=()=>H.playHover()),d.onclick=()=>{H.playClick(),r(!1)},m.onclick=()=>{H.playClick(),r(!0)}})}function eo(t,e=""){return new Promise(o=>{let a=Zt(),n=Qt();n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let x=m.querySelector(".cw-hero-grid"),f=m.querySelector(".cw-acc-container"),g=m.querySelector(".cw-results-container"),u=m.querySelector(".cw-search-input"),C=m.querySelector(".cw-status-bar"),F=m.querySelector(".cw-status-text"),k=m.querySelector(".cw-footer-icons");s.forEach(([I,O])=>{let N=i(O.name),X=document.createElement("div");X.className="cw-hero-card",X.id=`hero-${I}`,X.style.setProperty("--hero-color",N.color),X.innerHTML=`
...
`.replace(/\n/g,"<br>");ot(I);let O=await xt();O?(O.innerText.trim()===""&&(O.innerHTML=""),document.execCommand("insertHTML",!1,I),ft(O),Z("Nota gerada e inserida!")):Z("Copiado! Abra uma nota para colar.")},e}var xe=t=>new Promise(e=>setTimeout(e,t));function we(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function qe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function ht(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function me(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let l=a.getBoundingClientRect();i.x=l.left+l.width/2,i.y=l.top+l.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let l=e.getBoundingClientRect();s=l.left+l.width/2,r=l.top+l.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let d=i.x-s,m=i.y-r;t?(H.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${d}px, ${m}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${d}px), calc(-50% + ${m}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof xo=="function"&&xo(e,o)):(H.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${d}px, ${m}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${d}px), calc(-50% + ${m}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Mt=="function"&&Mt(e))}function xo(t,e){Mt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Mt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function ho(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=oo(t,X),s=lo(A),r=ro(()=>{w(),W.setActiveTasks(r.getCheckedElements())},A,W),d=document.createElement("div");d.style.display="none";let m=so((h,D)=>{y(h,D)});d.appendChild(m);let l=document.createElement("div");l.id="evidence-container",Object.assign(l.style,{display:"none",marginTop:"16px",padding:"16px",background:z.bgInput,border:`1px solid ${z.border}`,borderRadius:pe.medium,boxShadow:ze.subtle});let p=document.createElement("div");p.className="cw-section-title",p.textContent=A("evidencias_contato"),l.appendChild(p);let x={},f=(h,D)=>{let Y=document.createElement("div");Y.style.marginBottom="12px";let Q=document.createElement("label");Q.textContent=D,Q.setAttribute("for",h),Q.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${z.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let j=document.createElement("input");return j.type="text",j.id=h,j.className="cw-input",j.placeholder="https://screenshot.googleplex.com/...",j.style.marginBottom="0",Y.appendChild(Q),Y.appendChild(j),x[h]=j,Y};l.appendChild(f("evidence-l1",A("ligacao_1"))),l.appendChild(f("evidence-l2",A("ligacao_2"))),l.appendChild(f("evidence-msg",A("mensagem_am")));let g=po({onSaveCurrent:async()=>{let h=await _();return V(),h},onLoadDraft:h=>{G(h)},t:h=>A(h)}),u=T(),C=R(),F=document.createElement("div"),k=ae(),P=E(g,A);o.appendChild(u),o.appendChild(C),o.appendChild(k),o.appendChild(d),o.appendChild(F),o.appendChild(l),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let M=document.createElement("button");M.id="manual-task-toggle",M.textContent=A("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",M.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${z.primary}; background: ${z.surface}; color: ${z.primary}; border-radius: ${pe.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${re}; text-transform: uppercase; letter-spacing: 0.5px;`,M.onmouseenter=()=>{M.style.background=z.primaryBg},M.onmouseleave=()=>{M.style.background=z.surface},M.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",M.style.display="none"},o.appendChild(M),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(P);let J=document.createElement("div");J.style.display="none",J.style.flexGrow="1",J.style.minHeight="0",J.style.overflow="hidden";let ee=go(()=>$());ee.style.height="100%",J.appendChild(ee),e.insertBefore(J,i);let I=a.lastElementChild;I&&(I.insertBefore(g.historyBtnWrapper,I.firstChild),I.insertBefore(K(),I.firstChild)),e.appendChild(g.drawer);let O=null;W.subscribe(h=>{oe(h),N(),h.isDirty?(O&&clearTimeout(O),O=setTimeout(async()=>{let D=await _(!0);D.subStatus?fe.saveEmergency(D):fe.clearEmergency(),h.isDirty=!1},2e3)):O&&(clearTimeout(O),O=null)});function N(){let h=fe.getCount()>0,D=!!W.currentSubStatus;gt(h||D)}function X(){W.visible=!W.visible,me(W.visible,e,"cw-btn-notes")}function $(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",J.style.display="flex",J.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",J.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function T(){let h=document.createElement("div");if(h.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let Y=document.createElement("style");Y.id="cw-segmented-styles",Y.innerHTML=`
            ...
            `,document.head.appendChild(Y)}let D=(Y,Q)=>{let te=h.querySelector(`#${Y}`).querySelector(".cw-segmented-indicator");te&&(te.style.transform=`translateX(${Q*100}%) translateX(${Q*2}px)`)};return h.querySelectorAll("#lang-selector button").forEach((Y,Q)=>{Y.onclick=()=>{W.setLanguage(Y.dataset.lang),h.querySelectorAll("#lang-selector button").forEach(j=>j.classList.remove("active")),Y.classList.add("active"),D("lang-selector",Q),H.playHover(),W.currentSubStatus&&c(W.currentSubStatus)}}),h.querySelectorAll("#type-selector button").forEach((Y,Q)=>{Y.onclick=()=>{W.setCaseType(Y.dataset.type),h.querySelectorAll("#type-selector button").forEach(j=>j.classList.remove("active")),Y.classList.add("active"),D("type-selector",Q),H.playHover(),W.currentSubStatus&&c(W.currentSubStatus)}}),h.querySelectorAll("#portugal-selector button").forEach((Y,Q)=>{Y.onclick=()=>{W.setPortugalCase(Y.dataset.val==="true"),h.querySelectorAll("#portugal-selector button").forEach(j=>j.classList.remove("active")),Y.classList.add("active"),D("portugal-selector",Q),H.playHover(),W.currentSubStatus&&c(W.currentSubStatus)}}),h}function R(){let h=document.createElement("div");h.className="cw-status-section",h.style.cssText="display: flex; flex-direction: column; gap: 8px;",h.innerHTML=`
        ...
        `;let D=h.querySelector("#main-status-select"),Y=h.querySelector("#sub-status-select");return D.onchange=()=>{W.setStatus(D.value),b(D.value,Y),W.setSubStatus(""),c("")},Y.onchange=()=>{W.setSubStatus(Y.value),c(Y.value)},h}function q(){return l.style.display==="none"?null:{l1:x["evidence-l1"]?.value.trim()||"",l2:x["evidence-l2"]?.value.trim()||"",msg:x["evidence-msg"]?.value.trim()||""}}function b(h,D){if(D.innerHTML=`<option value="">${A("select_substatus")}</option>`,!h){D.disabled=!0;return}for(let Y in Ie)if(Ie[Y].status===h){let Q=document.createElement("option");Q.value=Y,Q.textContent=Ie[Y].name,D.appendChild(Q)}D.disabled=!1}function c(h){let D=Ie[h],Y=h==="NI_Attempted_Contact"||D&&D.name&&D.name.toLowerCase().includes("attempted contact");if(m.render&&m.render(h,W.currentCaseType),!h){l.style.display="none",x["evidence-l1"]&&(x["evidence-l1"].value=""),x["evidence-l2"]&&(x["evidence-l2"].value=""),x["evidence-msg"]&&(x["evidence-msg"].value=""),d.style.display="none",F.style.display="none";let ce=document.getElementById("manual-task-toggle");ce&&(ce.style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",k.style.display="flex",k.style.opacity="1",P.style.display="none";return}Y?l.style.display="block":(l.style.display="none",x["evidence-l1"]&&(x["evidence-l1"].value=""),x["evidence-l2"]&&(x["evidence-l2"].value=""),x["evidence-msg"]&&(x["evidence-msg"].value="")),k.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(k.style.display="none")},400),P.style.display="grid",D&&D.templateFields&&W.setActiveFields(D.templateFields),S(),Lt(h,F,W),F.style.display="block",d.style.display="block";let Q=h.startsWith("SO_"),j=h==="NI_Awaiting_Validation",te=document.getElementById("manual-task-toggle");Q||j?(r.selectionElement.style.display="block",te.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",te.style.display="block");let U=h==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(U),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(h),w();let ne=document.getElementById("email-automation-toggle-row");ne&&(ne.style.display=Ye[h]?"flex":"none")}function w(){let h=r.getCheckedElements().map(D=>D.value);s.updateVisibility(W.currentSubStatus,h)}function y(h,D){let Y=ct[h];if(Y){for(let Q in Y)if(Q==="linkedTask")r.toggleTask(Y.linkedTask,D);else if(Q==="activeTasks")Y.activeTasks.forEach(j=>{D?r.setTaskCount(j.value,j.count):r.setTaskCount(j.value,0)});else if(Q.startsWith("field-")){let j=Q,te=Y[Q],U=document.getElementById(j);if(U){let ne=We.includes(j.replace("field-",""));if(D)if(ne){let ce=U.value.trim();ce.includes(te.trim())||(U.value=ce?ce+`
...
`))}else U.value.trim()===te.trim()&&(U.value="");W.updateField(j,U.value),U.dispatchEvent(new Event("input"))}}}}function E(h,D){let Y=document.createElement("div");if(Y.className="cw-actions-section",Y.style.cssText=`
            display: grid;
        ...
        `;let j=h.parkButton;j.classList.add("js-btn-park"),j.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let te=document.createElement("button");te.className="cw-btn-secondary js-btn-reset",te.textContent=D("limpar"),te.style.cssText=`width: 100%; height: 34px; background: ${z.surface}; color: ${z.textSub}; border: 1px solid ${z.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,te.onclick=()=>V();let U=document.createElement("button");U.className="cw-btn-secondary js-btn-copy",U.textContent=D("copiar"),U.style.cssText=`width: 100%; height: 34px; background: ${z.surface}; color: ${z.primary}; border: 1px solid ${z.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,U.onclick=()=>v();let ne=document.createElement("button");return ne.className="cw-btn-primary js-btn-generate",ne.textContent=D("preencher"),ne.style.cssText=`width: 100%; height: 38px; background: ${z.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ne.onclick=()=>L(),Y.appendChild(Q),Y.appendChild(j),Y.appendChild(te),Y.appendChild(U),Y.appendChild(ne),Y}async function v(){if(!W.currentSubStatus){Z(A("select_substatus"),{error:!0});return}let h=It(W,r,s,q());h?(ot(h),Z(A("copiado_sucesso")),H.playClick()):Z(A("select_substatus"),{error:!0})}async function L(){if(!W.currentSubStatus){Z(A("select_substatus"),{error:!0});return}let h=It(W,r,s,q());ot(h),X();let D=tt(),Y=await xt();if(Y){Y.focus(),document.execCommand("insertHTML",!1,h),ft(Y);let Q=document.getElementById("email-automation-checkbox");(!Q||Q.checked)&&W.currentSubStatus&&Ye[W.currentSubStatus]&&await vt(Ye[W.currentSubStatus]),Z(A("inserido_copiado")),H.playSuccess(),V()}D()}function S(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let h=Ie[W.currentSubStatus];h&&h.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function V(){W.reset(),r.reset(),s.reset(),N(),fe.clearEmergency(),o.querySelectorAll("select").forEach(D=>D.value=""),o.querySelector("#sub-status-select").disabled=!0;let h=document.getElementById("email-automation-toggle-row");h&&(h.style.display="none"),F.innerHTML="",d.style.display="none",k.style.display="flex",k.style.opacity="1",P.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",l.style.display="none",x["evidence-l1"]&&(x["evidence-l1"].value=""),x["evidence-l2"]&&(x["evidence-l2"].value=""),x["evidence-msg"]&&(x["evidence-msg"].value="")}async function _(h=!1){let D={};F.querySelectorAll("input, textarea, select").forEach(U=>{(U.id.startsWith("field-")||U.id==="consent-select")&&(D[U.id]=U.value)});let Y="Cliente",Q="---";if(!h)try{let U=await Se();Y=U.advertiserName,Q=U.cid}catch(U){console.warn("Erro ao coletar pageData:",U)}let j=r.getCheckedElements().map(U=>({key:U.value,count:U.count})),te=j.map(U=>{let ne=Ae[U.key];return ne?ne.name:U.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:D,activeTasks:j,summaryTags:te,clientName:Y,cid:Q,timestamp:new Date().toISOString()}}let B=h=>new Promise(D=>setTimeout(D,h));async function G(h){W.setLanguage(h.currentLang||"pt"),W.setCaseType(h.currentCaseType||"bau"),W.setPortugalCase(h.isPortugalCase||!1),W.setConsent(h.consent||!1),W.setExcludedFields(h.excludedFields||[]),h.activeFields&&W.setActiveFields(h.activeFields);let D=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);D&&D.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(j=>{j!==D&&j.classList.remove("active")});let Y=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);Y&&Y.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(j=>{j!==Y&&j.classList.remove("active")});let Q=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if(Q&&Q.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(j=>{j!==Q&&j.classList.remove("active")}),h.status){let j=o.querySelector("#main-status-select");j.value=h.status,W.setStatus(h.status);let te=o.querySelector("#sub-status-select");if(b(h.status,te),await B(50),h.subStatus){if(te.value=h.subStatus,W.setSubStatus(h.subStatus),c(h.subStatus),await B(100),h.tagSupportUsed!==void 0){W.setTagSupportUsed(h.tagSupportUsed);let U=s.element.querySelector('input[value="Sim"]'),ne=s.element.querySelector('input[value="N\xE3o"]');h.tagSupportUsed&&U?U.checked=!0:ne&&(ne.checked=!0),s.element.querySelector("div:last-child").style.display=h.tagSupportUsed?"none":"block"}h.forcedScreenshots&&W.setForcedScreenshots(h.forcedScreenshots);for(let U in h.formData){let ne=document.getElementById(U);ne&&(ne.value=h.formData[U],W.updateField(U,ne.value))}h.activeTasks&&(h.activeTasks.forEach(U=>r.setTaskCount(U.key,U.count)),W.setActiveTasks(r.getCheckedElements()))}}W.isDirty=!1}function A(h){return Ce[W.currentLang]?.[h]||Ce.pt?.[h]||h}function K(){let h=document.createElement("div");return h.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',h.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",h.onclick=D=>{D.stopPropagation(),$()},h.title="Alternar para Split & Transfer",h}function ae(){let h=document.createElement("div");return h.id="notes-empty-state",h.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(m),Object.assign(d.style,be,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let l=ue(d,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:d},()=>R()),p=document.createElement("div");Object.assign(p.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:r.bgApp});let x=document.createElement("div");Object.assign(x.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${r.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let f=document.createElement("div");Object.assign(f.style,{padding:"16px",borderBottom:`1px solid ${r.borderSubtle}`,position:"relative"});let g=document.createElement("input");g.placeholder="Buscar templates...",Object.assign(g.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:r.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),g.onfocus=()=>{g.style.backgroundColor="#FFFFFF",g.style.borderColor=r.primary,g.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",g.style.transform="scale(1.02)"},g.onblur=()=>{g.style.backgroundColor="#E3E3E8",g.style.borderColor="transparent",g.style.boxShadow="none",g.style.transform="scale(1)"};let u=document.createElement("div");u.id="email-template-list",Object.assign(u.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let C=document.createElement("div");C.innerHTML="\u2715",Object.assign(C.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),C.onclick=()=>{g.value="",n="",C.style.display="none",b(),g.focus()},f.appendChild(g),f.appendChild(C),x.appendChild(f),x.appendChild(u);let F=document.createElement("div");Object.assign(F.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:r.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let k=document.createElement("div");Object.assign(k.style,{padding:"20px",borderBottom:`1px solid ${r.borderSubtle}`,backgroundColor:r.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let P=document.createElement("div");Object.assign(P.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:r.bgApp,overflow:"hidden"});let M=document.createElement("div");Object.assign(M.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let J=document.createElement("span");J.textContent="Preview do E-mail",Object.assign(J.style,{fontSize:"12px",fontWeight:"600",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let ee=document.createElement("div");Object.assign(ee.style,{display:"flex",gap:"8px"});let I=(v,L=!1)=>{let S=document.createElement("button");return S.textContent=v,Object.assign(S.style,{padding:"8px 14px",borderRadius:"10px",border:L?"none":`1.5px solid ${r.primary}`,background:L?r.primary:"transparent",color:L?"#fff":r.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:L?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),S.onmouseenter=()=>{L?(S.style.backgroundColor="#0062CC",S.style.transform="translateY(-1px)",S.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):S.style.backgroundColor="rgba(0, 122, 255, 0.05)"},S.onmouseleave=()=>{L?(S.style.backgroundColor=r.primary,S.style.transform="translateY(0)",S.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(S.style.backgroundColor="transparent",S.style.transform="translateY(0)")},S.onmousedown=()=>S.style.transform="scale(0.94)",S.onmouseup=()=>S.style.transform="scale(1)",S},O=I("Copiar HTML"),N=I("Preencher no CRM",!0),X=I("Smart CR");X.style.borderColor="#E67E22",X.style.color="#E67E22",X.style.display="none",ee.appendChild(X),ee.appendChild(O),ee.appendChild(N),M.appendChild(J),M.appendChild(ee);let $=document.createElement("div");$.contentEditable="true",Object.assign($.style,{flex:"1",backgroundColor:r.bgSurface,border:`1px solid ${r.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:r.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),P.appendChild(M),P.appendChild($),E(),F.appendChild(k),F.appendChild(P),p.appendChild(x),p.appendChild(F),d.appendChild(l),d.appendChild(p);let T=document.createElement("div");Object.assign(T.style,Oe),d.appendChild(T),Le(d,T),document.body.appendChild(d);function R(){e=!e,e?(d.style.display="flex",Jt(d),o.length===0&&q()):d.style.display="none",me(e,d,"cw-btn-email")}async function q(){u.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await vo.getTemplates(),b()}function b(){u.innerHTML="";let v=o.filter(B=>B.name.toLowerCase().includes(n.toLowerCase())||B.category.toLowerCase().includes(n.toLowerCase())),L=Object.entries(Ye).filter(([B,G])=>G&&(B.toLowerCase().includes(n.toLowerCase())||G.toLowerCase().includes(n.toLowerCase()))).map(([B,G])=>({id:B,name:B.replace(/_/g," "),category:"\u26A1 Smart CRs",code:G,isSmartCR:!0})),S=ve.getSnippets("email").filter(B=>B.title.toLowerCase().includes(n.toLowerCase())||B.subject&&B.subject.toLowerCase().includes(n.toLowerCase())).map(B=>{let G=[],A=B.content.match(/\[([^\]]+)\]/g);return A&&[...new Set(A)].forEach(K=>{G.push({key:K,label:K.replace("[","").replace("]",""),type:K.toLowerCase().includes("data")?"date":"text",auto:K.toLowerCase().includes("nome")&&K.toLowerCase().includes("seu")?"agentName":null})}),{id:B.id||`snippet-${Math.random()}`,name:B.title,category:"\u{1F464} Pessoal",subject:B.subject||"Sem Assunto",template:B.content,placeholders:G}}),V=[...v,...L,...S];if(V.length===0){u.innerHTML=`
                ...
                </div>`;return}[...new Set(V.map(B=>B.category))].sort((B,G)=>B.localeCompare(G)).forEach(B=>{let G=s.has(B)||n.length>0,A=V.filter(Y=>Y.category===B),K=document.createElement("div");Object.assign(K.style,{padding:"12px 16px 12px 24px",fontSize:"11px",fontWeight:"700",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.8px",position:"sticky",top:"-8px",backgroundColor:"rgba(239, 239, 240, 0.9)",zIndex:"10",backdropFilter:"blur(20px)",margin:"0 -8px 8px -8px",borderBottom:`0.5px solid ${r.borderSubtle}`,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none",transition:"background-color 0.2s ease"}),K.onmouseenter=()=>K.style.backgroundColor="rgba(230, 230, 232, 0.9)",K.onmouseleave=()=>K.style.backgroundColor="rgba(239, 239, 240, 0.9)";let ae=document.createElement("span");ae.textContent=B,K.appendChild(ae);let oe=document.createElement("span");oe.textContent=A.length,Object.assign(oe.style,{backgroundColor:"rgba(0, 0, 0, 0.05)",padding:"2px 8px",borderRadius:"10px",fontSize:"10px",color:r.textSecondary});let h=document.createElement("span");h.innerHTML=G?"\u{10012A}":"\u{10012B}",h.innerHTML=G?"\u25BE":"\u25B8",h.style.marginLeft="8px",h.style.transition="transform 0.3s ease";let D=document.createElement("div");D.style.display="flex",D.style.alignItems="center",D.appendChild(oe),D.appendChild(h),K.appendChild(D),K.onclick=()=>{s.has(B)?s.delete(B):s.add(B),b()},u.appendChild(K),G&&A.forEach(Y=>{let Q=a&&a.id===Y.id,j=document.createElement("div");if(Object.assign(j.style,{padding:"12px 14px",fontSize:"14px",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)",borderRadius:"10px",color:r.textPrimary,margin:"4px 6px",display:"flex",alignItems:"center",gap:"12px",backgroundColor:Q?r.primary:r.bgSurface,boxShadow:Q?"0 4px 12px rgba(0, 122, 255, 0.3)":"0 1px 2px rgba(0,0,0,0.05)",border:Q?"none":`1px solid ${r.borderSubtle}`,position:"relative",overflow:"hidden"}),Q){let ne=document.createElement("div");Object.assign(ne.style,{position:"absolute",left:"0",top:"0",bottom:"0",width:"4px",backgroundColor:"#fff",borderRadius:"0 4px 4px 0"}),j.appendChild(ne)}let te=document.createElement("span");te.innerHTML=Y.isSmartCR?"\u26A1":Y.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",te.style.fontSize="12px",te.style.opacity="0.7",te.style.flexShrink="0",j.appendChild(te);let U=document.createElement("span");U.textContent=Y.name,U.style.overflow="hidden",U.style.textOverflow="ellipsis",U.style.whiteSpace="nowrap",U.style.flex="1",j.appendChild(U),Q&&(j.style.color="#fff",j.style.fontWeight="600",te.style.opacity="1"),j.onmouseenter=()=>{Q||(j.style.backgroundColor="#f8f8f9",j.style.transform="translateY(-1px) scale(1.01)",j.style.boxShadow="0 4px 8px rgba(0,0,0,0.08)",j.style.borderColor="rgba(0, 122, 255, 0.2)")},j.onmouseleave=()=>{Q||(j.style.backgroundColor=r.bgSurface,j.style.transform="translateY(0) scale(1)",j.style.boxShadow="0 1px 2px rgba(0,0,0,0.05)",j.style.borderColor=r.borderSubtle)},j.onmousedown=()=>{j.style.transform=Q?"scale(0.97)":"scale(0.98)"},j.onmouseup=()=>{j.style.transform=Q?"scale(1)":"translateY(-1px) scale(1.01)"},j.onclick=()=>{w(Y)},u.appendChild(j)})})}let c=null;async function w(v){a?.id!==v.id&&(a=v,c&&clearTimeout(c),F.style.opacity="0",F.style.transform="translateY(5px)",c=setTimeout(()=>{X.style.display=v.isSmartCR?"block":"none",N.style.display=v.isSmartCR?"none":"block",O.style.display=v.isSmartCR?"none":"block",b(),y(),E(),F.style.opacity="1",F.style.transform="translateY(0)",c=null},150))}function y(){if(k.innerHTML="",!a||a.isSmartCR){a?.isSmartCR?(k.style.display="block",k.innerHTML=`<div style="padding: 12px; font-size: 13px; color: #856404; background: #FFF3CD; border: 1px solid #FFEEBA; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
...
`),G=/\d{1,2}\/\d{1,2}/,A="\u{1F4C5}";if(B.forEach(D=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(D)?A="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(D)&&(A="\u{1F1EA}\u{1F1F8}");let Y=D.match(G);if(Y){let Q=Y[0],j=A;/🇧🇷|🇵🇹|PT|BR/i.test(D)?j="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(D)&&(j="\u{1F1EA}\u{1F1F8}"),_.some(U=>U.flag===j&&U.date===Q)||_.push({flag:j,date:Q})}}),_.length===0){let D=(S.text||"").match(/\d{1,2}\/\d{1,2}/g);D&&[...new Set(D)].forEach(Y=>_.push({flag:"\u{1F4C5}",date:Y}))}let K="",ae='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(ae=`
              ...
              `),_.length>0?K=`
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                      <div style="flex:1; display:flex; gap:8px;">${_.map(Y=>`
        ...
        `,document.head.appendChild(q)}let s={bg:"linear-gradient(180deg, #F8FAFD 0%, #EEF2F8 100%)",surface:"rgba(255, 255, 255, 0.85)",glass:"rgba(255, 255, 255, 0.7)",primary:"#1a73e8",primaryLight:"rgba(26, 115, 232, 0.1)",text:"#1f1f1f",textSub:"#474747",border:"rgba(0, 0, 0, 0.06)",danger:"#d93025"},r={container:{display:"flex",flexDirection:"column",height:"100%",background:s.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"16px 24px 0 24px",background:"transparent",borderBottom:`1px solid ${s.border}`,gap:"8px"},tabBtn:{flex:1,padding:"14px 16px",textAlign:"center",cursor:"pointer",fontSize:"14px",fontWeight:"500",color:s.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s ease",userSelect:"none",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",borderRadius:"12px 12px 0 0"},tabActive:{color:s.primary,borderBottomColor:s.primary,fontWeight:"600",background:"rgba(26, 115, 232, 0.04)"},listContainer:{flex:1,overflowY:"auto",padding:"24px",display:"flex",flexDirection:"column",gap:"16px"},emptyState:{padding:"60px 24px",textAlign:"center",color:s.textSub,display:"flex",flexDirection:"column",alignItems:"center",gap:"16px"},card:{background:s.surface,borderRadius:"24px",padding:"20px",border:`1px solid ${s.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.03)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"12px"},cardTitle:{fontSize:"15px",fontWeight:"600",color:s.text,letterSpacing:"-0.01em"},cardPreview:{fontSize:"13px",color:s.textSub,lineHeight:"1.6",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"12px",marginTop:"16px",paddingTop:"16px",borderTop:`1px solid ${s.border}`},actionBtn:{padding:"8px 14px",borderRadius:"10px",fontSize:"13px",fontWeight:"500",cursor:"pointer",border:"none",background:"transparent",transition:"all 0.2s",display:"flex",alignItems:"center",gap:"6px"},fab:{position:"absolute",bottom:"32px",right:"32px",width:"64px",height:"64px",borderRadius:"20px",background:`linear-gradient(135deg, ${s.primary}, #0059c1)`,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 8px 24px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.9)",backdropFilter:"blur(30px) saturate(180%)",webkitBackdropFilter:"blur(30px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.6s cubic-bezier(0.16, 1, 0.3, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"24px 32px",background:"transparent",borderBottom:`1px solid ${s.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"32px",overflowY:"auto"},inputGroup:{marginBottom:"24px"},label:{display:"block",fontSize:"13px",fontWeight:"600",color:s.textSub,marginBottom:"10px",letterSpacing:"0.02em"},input:{width:"100%",padding:"14px 18px",borderRadius:"14px",border:`1px solid ${s.border}`,fontSize:"15px",fontFamily:"inherit",outline:"none",background:s.surface,transition:"all 0.2s ease",boxSizing:"border-box"}},d=document.createElement("div");d.id="library-popup",d.classList.add("cw-module-window"),Object.assign(d.style,be,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)"});let l=ue(d,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:d},()=>R());d.appendChild(l);let p=document.createElement("div");Object.assign(p.style,r.container),d.appendChild(p);let x=document.createElement("div");Object.assign(x.style,r.tabHeader);let f=[{id:"general",label:"Geral",icon:i.tabs.general},{id:"note",label:"Notas",icon:i.tabs.note},{id:"email",label:"Emails",icon:i.tabs.email}];f.forEach(q=>{let b=document.createElement("div");b.innerHTML=`${q.icon} <span>${q.label}</span>`,b.id=`lib-tab-${q.id}`,Object.assign(b.style,r.tabBtn),q.id===o&&Object.assign(b.style,r.tabActive),b.onmouseenter=()=>H.playHover(),b.onclick=()=>ee(q.id),x.appendChild(b)}),p.appendChild(x);let g=document.createElement("div");Object.assign(g.style,r.listContainer),p.appendChild(g);let u=document.createElement("div");u.className="cw-fab cw-tactile",Object.assign(u.style,r.fab),u.innerHTML=i.actions.add,u.onmouseenter=()=>{u.style.transform="scale(1.1)",u.style.boxShadow="0 12px 32px rgba(26, 115, 232, 0.5)"},u.onmouseleave=()=>{u.style.transform="scale(1)",u.style.boxShadow="0 8px 24px rgba(26, 115, 232, 0.4)"},u.onclick=()=>O(),p.appendChild(u),a=document.createElement("div"),Object.assign(a.style,r.editorOverlay);let C=document.createElement("div");Object.assign(C.style,r.editorHeader),C.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let F=document.createElement("button");F.innerHTML="Cancelar",F.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",F.onclick=N,C.appendChild(F),a.appendChild(C);let k=document.createElement("div");Object.assign(k.style,r.editorBody),a.appendChild(k);let P=document.createElement("div");P.style.cssText="padding:24px 32px; border-top:1px solid rgba(0,0,0,0.06); background:transparent; display:flex; justify-content:flex-end;";let M=document.createElement("button");M.textContent="Salvar",M.style.cssText="padding:12px 32px; background:linear-gradient(135deg, #1a73e8, #0059c1); color:white; border:none; border-radius:14px; font-weight:600; cursor:pointer; box-shadow:0 4px 12px rgba(26,115,232,0.3); transition: all 0.2s;",M.onclick=X,P.appendChild(M),a.appendChild(P),p.appendChild(a);let J=document.createElement("div");Object.assign(J.style,Oe),J.className="no-drag",d.appendChild(J),Le(d,J),document.body.appendChild(d);function ee(q){H.playClick(),o=q,f.forEach(b=>{let c=document.getElementById(`lib-tab-${b.id}`);b.id===q?Object.assign(c.style,r.tabActive):Object.assign(c.style,r.tabBtn)}),I()}function I(){g.innerHTML="";let q=ve.getSnippets(o);if(q.length===0){g.innerHTML=`
            ...
            `;return}q.forEach(b=>{let c=document.createElement("div");c.className="cw-aura-card",Object.assign(c.style,r.card),b.isCode&&(c.style.borderLeft=`4px solid ${s.primary}`,c.style.background="rgba(26, 115, 232, 0.02)");let w=b.content,y="";if(b.isRich){let E=document.createElement("div");E.innerHTML=b.content;let v=E.querySelector("img");w=E.innerText.substring(0,150)+(E.innerText.length>150?"...":""),v&&(y=`<span style="display:inline-flex; align-items:center; background:rgba(26, 115, 232, 0.1); color:#1a73e8; padding:2px 8px; border-radius:10px; font-size:11px; margin-bottom:8px; font-weight:600;">${i.media} Media</span>`)}c.innerHTML=`
                ...
                ${y}
                <div style="${T(r.cardPreview)}; ${b.isCode?"font-family:'Roboto Mono', monospace; font-size:12px; background:rgba(0,0,0,0.02); padding:12px; border-radius:12px;":""}">${w}</div>
    ...
    `;let p=l.querySelector("#cw-config-sound-toggle");p.onchange=g=>{H.setMuted(!g.target.checked),g.target.checked&&H.playClick()},r.appendChild(l);let x=document.createElement("div");x.className="cw-configs-section",x.innerHTML=`
    ...
    `,r.appendChild(x);function f(){e=!e,me(e,n,"cw-btn-configs"),e&&H.playClick()}return document.body.appendChild(n),f}var St={blue:"#1A73E8",red:"#D93025",yellow:"#F9AB00",green:"#1E8E3E",blueLight:"#E8F0FE",redLight:"#FCE8E6",yellowLight:"#FEF7E0",greenLight:"#E6F4EA",textPrimary:"#202124",textSecondary:"#5F6368",border:"#DADCE0",surface:"rgba(255, 255, 255, 0.8)",white:"#FFFFFF"};var Ge="cubic-bezier(0.4, 0, 0.2, 1)",Fs=`all 0.3s ${Ge}`,Do=()=>{if(document.getElementById("bau-form-global-styles"))return;let t=document.createElement("style");t.id="bau-form-global-styles",t.textContent=`
  ...
  `,document.head.appendChild(t)};var Ue={steps:[{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0}]};var ke={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>'};function No(t){let e=document.createElement("div");if(e.className="bau-dynamic-input",e.id=`wrapper-${t.id}`,t.label){let a=document.createElement("label");a.className="bau-label",a.textContent=t.label,t.tooltip&&a.setAttribute("data-tooltip",t.tooltip),e.appendChild(a)}let o;switch(t.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",e.appendChild(o);break;case"select":o=document.createElement("select"),t.options.forEach(i=>{let s=document.createElement("option");s.value=i.value,s.textContent=i.text,o.appendChild(s)}),e.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",t.options.forEach(i=>{let s=document.createElement("label");s.className="bau-task-item",s.innerHTML=`<input type="checkbox" name="${t.name}" value="${i}"><span>${i}</span>`,s.addEventListener("click",r=>{r.preventDefault();let d=s.querySelector("input");d.checked=!d.checked,s.classList.toggle("active",d.checked),H.playClick()}),o.appendChild(s)}),e.appendChild(o),e;case"datetime-group":return o=document.createElement("div"),o.className="bau-availability-container",t.fields.forEach(i=>{let s=document.createElement("div");s.className="bau-availability-field",s.innerHTML=`
    ...
    `,m.appendChild(l);let p=document.createElement("div");p.className="bau-content",m.appendChild(p);let x=document.createElement("div");x.className="bau-progress-indicator",p.appendChild(x);let f=document.createElement("form");f.id="bau-escalation-form",p.appendChild(f),Ue.steps.forEach((c,w)=>{let y=document.createElement("div");if(y.className="bau-step"+(w===0?" active":""),y.id=`bau-step-${c.id}`,c.isConfirmation)y.innerHTML=`
                <div class="bau-card">
    ...
    `,r.appendChild(k),document.body.appendChild(i);function P(c){e=c,i.querySelectorAll(".bau-view").forEach(v=>v.classList.remove("active"));let w=i.querySelector(`#bau-view-${c}`);w&&w.classList.add("active");let y=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),E=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");y&&(y.textContent=c==="form"?"Novo Caso BAU":"BAU Central"),E&&(E.textContent=c==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}function M(){let c=i.querySelector("#bau-case-list-container"),w=i.querySelector("#bau-dashboard-metrics");w&&(w.innerHTML=`
