(()=>{var No={production:"AKfycbxkheuq28ENsHMZMH8t9-u4EIrktHC6cBi-87boDre0jJfl1lnSCPBzaEkw6hy3Cx6fAg",development:"AKfycbyUtczRMulDAyO_1ku39Rb01zarPMw1JvO7aNOdJPYeAgCC7G9mmb-P_EuXP6kvo8l2LA"},pa="development",mr=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",Io=No[pa]||No.development,Ba=mr?"dev":"exec",gr=`https://script.google.com/a/macros/google.com/s/${Io}/${Ba}`,_o=Io.slice(-6);function Ut(){return{env:pa,isDev:pa!=="production",endpoint:Ba,fingerprint:_o}}console.log(`[Case Wizard] backend: ${pa}/${Ba} \xB7 implanta\xE7\xE3o \u2026${_o}`);var br="cw_data_broadcast",fr="cw_data_tips",$a="cw_content_",Ra=new Set,hr=["Processando...","Mantenha o foco!","Aguarde..."];function xr(e={}){return Object.keys(e).filter(t=>e[t]!==null&&e[t]!==void 0).map(t=>encodeURIComponent(t)+"="+encodeURIComponent(e[t])).join("&")}function Je(e,t={}){return new Promise((a,o)=>{let n="cw_cb_"+Math.round(1e5*Math.random()),i=document.createElement("script"),r=setTimeout(()=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],o(new Error("Timeout: A API demorou muito para responder. (Apps Script bloqueado ou erro 500)"))},15e3);window[n]=m=>{clearTimeout(r),document.body.contains(i)&&document.body.removeChild(i),delete window[n],a(m)};let s=xr(t),l=`${gr}?op=${e}&callback=${n}&t=${Date.now()}&${s}`;i.src=l,i.onerror=()=>{clearTimeout(r),document.body.contains(i)&&document.body.removeChild(i),delete window[n],o(new Error("Erro de conex\xE3o JSONP."))},document.body.appendChild(i)})}var me={fetchTips:async()=>{try{await me.fetchContentModule("tips")}catch(e){console.warn("Tips offline",e)}},getCachedBroadcasts:()=>{try{return JSON.parse(localStorage.getItem(br)||"[]")}catch{return[]}},fetchContentModule:async e=>{if(Ra.has(e)){let a=me.getCachedContent(e);if(a)return a}let t=`${$a}${e}`;try{let a=await Je("content_public",{module:e});if(a?.status==="success"&&Array.isArray(a.items))return localStorage.setItem(t,JSON.stringify(a.items)),Ra.add(e),a.items}catch(a){console.warn(`Conte\xFAdo '${e}' offline`,a)}return me.getCachedContent(e)},fetchContentModules:async e=>{let t=(e||[]).filter(Boolean);if(!t.length)return{};try{let a=await Je("content_public",{modules:t.join(",")});if(a?.status==="success"&&a.modules)return Object.keys(a.modules).forEach(o=>{let n=a.modules[o];Array.isArray(n)&&(localStorage.setItem(`${$a}${o}`,JSON.stringify(n)),Ra.add(o))}),a.modules}catch(a){console.warn("Pr\xE9-carregamento de conte\xFAdo indispon\xEDvel",a)}return{}},getCachedContent:e=>{try{return JSON.parse(localStorage.getItem(`${$a}${e}`)||"null")}catch{return null}},getRandomTip:()=>{let e=null,t=me.getCachedContent("tips");if(Array.isArray(t)&&t.length&&(e=t.map(a=>a.value).filter(Boolean)),!e||!e.length){let a=localStorage.getItem(fr);if(a)try{e=JSON.parse(a)}catch{}}return(!Array.isArray(e)||!e.length)&&(e=hr),e[Math.floor(Math.random()*e.length)]},logEvent:(e,t,a="",o=null)=>{try{let n="anon";try{let r=Le();r&&(n=r.split("@")[0].toLowerCase())}catch{}let i={timestamp:new Date().toISOString(),user:n,version:"v5.1",category:e,action:t,label:a,value:o||""};Je("log",i).catch(r=>{})}catch(n){console.warn("Analytics error",n)}},logUsage:()=>{},sendBAUEscalation:async(e,t)=>{let a={...e,user:t,date:new Date().toISOString()};try{console.log("Executando create_bau...",a);let o=await Je("create_bau",a);if(o&&o.status==="success")return console.log("Sucesso: create_bau"),o;throw new Error(o?.error||o?.message||"Falha na opera\xE7\xE3o BAU")}catch(o){throw console.error("Erro JSONP (BAU):",o),o}},readAgentBAU:async()=>{let e=Le();if(!e)return console.warn("Email n\xE3o encontrado. N\xE3o foi poss\xEDvel buscar casos BAU."),[];try{console.log("Buscando casos BAU para:",e);let t=await Je("read_agent_bau",{user:e});if(t&&t.status==="success"&&Array.isArray(t.cases))return t.cases;if(t&&t.status==="error")throw new Error(t.message||"Erro retornado pela API de leitura");return[]}catch(t){throw console.error("Erro ao buscar casos BAU:",t),t}},updateBAUStatus:async(e,t,a={})=>{let o=Le();try{console.log(`Atualizando status BAU ${e} para ${t}...`);let n=await Je("update_bau_status",{id:e,status:t,user:o,...a});return n&&n.status==="success"}catch(n){return console.error("Erro ao atualizar status BAU:",n),!1}},updateBAUEscalation:async(e,t)=>{let a=Le(),o={...t,id:e,user:a,date_edited:new Date().toISOString()};try{console.log(`Executando update_bau para ${e}...`,o);let n=await Je("update_bau",o);if(n&&n.status==="success")return console.log("Sucesso: update_bau"),n;throw new Error(n?.error||n?.message||"Falha na atualiza\xE7\xE3o BAU")}catch(n){throw console.error("Erro JSONP (Update BAU):",n),n}},fetchUserProfile:async e=>{try{console.log(`Buscando perfil para: ${e}`);let t=await Je("get_user_profile",{ldap:e});return console.log("Resposta bruta do servidor:",t),t&&t.status==="success"&&t.profile?t.profile:null}catch(t){return console.error("Erro ao buscar perfil:",t),null}},getUserSnippets:async e=>{try{return console.log("Buscando snippets para:",e),await Je("get_user_snippets",{user:e})}catch(t){return console.error("Erro ao carregar snippets:",t),{status:"error",snippets:[]}}},saveSnippet:async(e,t)=>{let a={id:e.id,type:e.type,title:e.title,content:e.content,subject:e.subject||"",isCode:e.isCode,isRich:e.isRich,user:t};try{console.log("Salvando snippet na nuvem:",a);let o=await Je("save_snippet",a);return o&&o.status==="success"}catch(o){return console.error("Erro ao salvar snippet:",o),!1}},deleteSnippet:async(e,t)=>{try{console.log(`Deletando snippet ${e}...`);let a=await Je("delete_snippet",{id:e,user:t});return a&&a.status==="success"}catch(a){return console.error("Erro ao deletar snippet:",a),!1}},getUserPrefs:async e=>{try{let t=await Je("get_user_prefs",{user:e});return t&&t.status==="success"?t.prefs||{}:null}catch(t){return console.warn("Erro ao carregar prefer\xEAncias:",t),null}},saveUserPrefs:async(e,t)=>{try{let a=await Je("save_user_prefs",{user:t,prefs:JSON.stringify(e||{})});return!!(a&&a.status==="success")}catch(a){return console.warn("Erro ao salvar prefer\xEAncias:",a),!1}}},Fo=me.sendBAUEscalation,Do=me.readAgentBAU,pl=me.updateBAUStatus,Mo=me.updateBAUEscalation,Dt=me.fetchUserProfile,ul=me.getUserSnippets,ml=me.saveSnippet,gl=me.deleteSnippet,bl=me.getUserPrefs,fl=me.saveUserPrefs;var pe=e=>new Promise(t=>setTimeout(t,e));function Me(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(a=>e.dispatchEvent(new MouseEvent(a,t)))}function yt(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}function Tt(e,t,a){return Math.max(t,Math.min(e,a))}var Vt=0,Mt=0;function ke(){if(Vt===0&&(Mt=window.innerWidth-document.documentElement.clientWidth,Mt>0)){let e=parseFloat(getComputedStyle(document.body).paddingRight)||0;document.body.style.paddingRight=`${e+Mt}px`}Vt++,document.body.style.overflow="hidden"}function Te(){if(Vt=Math.max(0,Vt-1),Vt===0&&(document.body.style.overflow="",Mt>0)){let e=parseFloat(getComputedStyle(document.body).paddingRight)||0,t=Math.max(0,e-Mt);document.body.style.paddingRight=t?`${t}px`:"",Mt=0}}var Oo=!1;function vr(){if(Oo||document.getElementById("cw-filled-check-styles"))return;let e=document.createElement("style");e.id="cw-filled-check-styles",e.textContent=`
    ...
    `,document.head.appendChild(e),Oo=!0}var zo=!1;function yr(){if(zo||document.getElementById("cw-empty-state-styles"))return;let e=document.createElement("style");e.id="cw-empty-state-styles",e.textContent=`
    ...
    `,document.head.appendChild(e),zo=!0}function Wt({icon:e,title:t,subtitle:a="",size:o=88}){yr();let n=document.createElement("div");return n.className="cw-empty-illustrated",n.innerHTML=`
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ja={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},rn={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var sn={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var an=!1;function Jr(){if(an||document.getElementById("techsol-google-styles"))return;let e=document.createElement("style");e.id="techsol-google-styles",e.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await pe(200);let t=await Xt(),a=Yo(t),o=e.querySelector("#w-icon"),n=e.querySelector("#p1"),i=e.querySelector("#p2"),r=e.querySelector("#p3"),s=e.querySelector("#p-sextou");o&&(o.innerHTML=a.icon),n&&(n.textContent=a.prefix),r&&(r.textContent=a.suffix),await pe(300);let l=o?o.querySelector("svg"):null;if(l&&(l.style.opacity="1",l.style.transform="scale(1)"),await pe(400),n&&(n.style.opacity="1"),v.playStartup(),i&&await Zr(i,a.name),r&&(r.style.opacity="1",r.style.transform="translateY(0)"),a.isFriday&&s){await pe(400),s.style.display="block",s.offsetWidth;let m=s.querySelector(".sextou-badge");m&&(m.style.opacity="1",m.style.transform="scale(1)")}await pe(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await pe(900),e.parentNode&&e.parentNode.removeChild(e)}}function cn(e){if(!e)return;let t=e.getBoundingClientRect(),a=window.innerWidth,o=window.innerHeight,n=24,i=a-t.width-n,r=o-t.height-n,s=parseFloat(e.style.left)||t.left,l=parseFloat(e.style.top)||t.top,m=Tt(s,n,i),u=Tt(l,n,r);if(m!==s||u!==l){let f=e.style.transition;e.style.transition="left 0.3s var(--cw-ease-elastic), top 0.3s var(--cw-ease-elastic)",e.style.left=`${m}px`,e.style.top=`${u}px`,setTimeout(()=>{e.style.transition=f},300)}}var ct={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function dt(e,t){t.onmousedown=a;function a(o){o.stopPropagation(),o.preventDefault();let n=e.style.transition;e.style.transition="none";let i=o.clientX,r=o.clientY,s=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),l=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),m=i,u=r,f=!1;function g(x){m=x.clientX,u=x.clientY,f||(window.requestAnimationFrame(()=>{b(),f=!1}),f=!0)}function b(){let x=s+(m-i),w=l+(u-r);x>360&&(e.style.width=x+"px"),w>300&&(e.style.height=w+"px")}function N(){document.removeEventListener("mousemove",g),document.removeEventListener("mouseup",N),setTimeout(()=>{e.style.transition=n},50)}document.addEventListener("mousemove",g),document.addEventListener("mouseup",N)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function fa(e){if(!e||e==="N/A"||e==="undefined")return"Data indispon\xEDvel";if(String(e).includes(" | "))return e.split(" | ").map(t=>fa(t.trim())).filter(t=>t!=="Data indispon\xEDvel").join(" | ");try{let t=new Date(e);if(isNaN(t.getTime()))return"Data indispon\xEDvel";let a=t.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),o=t.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`${a} \xE0s ${o}`}catch{return"Data indispon\xEDvel"}}function dn(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,a=>t[a]?t[a]:"")}function pn(){let e=document.createElement("div");return e.className="cw-dialog-overlay",Object.assign(e.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:Oe.TOP,opacity:0,transition:"opacity 0.3s ease"}),e}function un(){let e=document.createElement("div");return Object.assign(e.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s var(--cw-ease-spring)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),e}function De(e,t={}){return new Promise(a=>{let o=pn(),n=un(),i=t.danger?"#FF3B30":"#007AFF",r=de()==="es"?"Eliminar":"Excluir",s=t.confirmText||(t.danger?r:"Confirmar");n.innerHTML=`
        ...
        <div style="margin-bottom: 32px;">
            <a href="${Ot}" target="_blank" rel="noopener noreferrer" id="cw-feedback-link" style="
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
  ...
  `;let n=document.createElement("div");n.className="cw-abort-btn",n.textContent="Cancelar",n.onclick=l=>{l.stopPropagation(),window._CW_ABORT_PROCESS=!0,v.stopThinking(),ee("Cancelado!",{duration:3e3}),s()},o.appendChild(n),document.body.appendChild(o),t&&t.classList.add("active"),requestAnimationFrame(()=>{requestAnimationFrame(()=>o.classList.add("visible"))}),v.startThinking();let i=Date.now(),r=!1;function s(){r||(r=!0,v.stopThinking(),t&&t.classList.remove("active"),e&&e.classList.remove("cw-busy"),o.classList.remove("visible"),setTimeout(()=>o.remove(),a?200:320))}return function(){if(window._CW_ABORT_PROCESS||r)return;let m=Math.max(0,2e3-(Date.now()-i));setTimeout(()=>{if(window._CW_ABORT_PROCESS||r)return;v.stopThinking();let u=o.querySelector(".cw-center-dots"),f=o.querySelector(".cw-center-success");u&&u.classList.add("hidden"),n.classList.add("hidden"),f&&f.classList.add("show"),setTimeout(()=>{f&&f.classList.remove("show"),setTimeout(s,200)},850)},m)}}function Bn(e){let{onSaveCurrent:t,onLoadDraft:a,t:o}=e,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let u=document.createElement("div");u.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",u.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${o("rascunhos_salvos")}</span>`;let f=document.createElement("button");f.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',f.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",f.onmouseenter=()=>f.style.background="#F1F3F4",f.onmouseleave=()=>f.style.background="transparent",f.onclick=()=>b(!1),u.appendChild(f);let g=document.createElement("div");g.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",m.appendChild(u),m.appendChild(g);function b(x){let w=m.style.transform==="translateY(0%)";(x!==void 0?x:!w)?(N(),m.style.transform="translateY(0%)"):m.style.transform="translateY(110%)"}function N(){let x=Ve.getAll();if(g.innerHTML="",x.length===0){g.innerHTML=`
                ...
                </div>`;return}x.forEach(w=>{let D=document.createElement("div");D.style.cssText=`
                background: ${V.surface}; padding: 20px; border-radius: ${Ne.large};
                border: 1.5px solid ${V.bgInput}; box-shadow: ${bt.subtle};
                position: relative;
            `;let M=new Date(w.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),h="";w.summaryTags&&w.summaryTags.length>0&&(h=`<div style="font-size:11px; color:#1A73E8; background:#E8F0FE; display:inline-block; padding:2px 6px; border-radius:4px; margin-top:4px;">\u{1F3F7}\uFE0F ${w.summaryTags.slice(0,3).join(", ")+(w.summaryTags.length>3?"...":"")}</div>`),D.innerHTML=`
...
`))}else ce.value.trim()===oe.trim()&&(ce.value="");X.updateField(te,ce.value),ce.dispatchEvent(new Event("input"))}}}}function le(p,S){let T=document.createElement("div");if(T.className="cw-actions-section",T.style.cssText=`
    ...
    `,document.head.appendChild(e)}function Es(e,t){return e.map(a=>pi(a,de())).filter(a=>a.name.toLowerCase().includes(t.toLowerCase())||a.category.toLowerCase().includes(t.toLowerCase()))}function As(e){return Object.entries(zt).filter(([t,a])=>a&&(t.toLowerCase().includes(e.toLowerCase())||a.toLowerCase().includes(e.toLowerCase()))).map(([t,a])=>({id:t,name:t.replace(/_/g," "),category:"\u26A1 Smart CRs",code:a,isSmartCR:!0}))}function Cs(e){return je.getSnippets("email").filter(t=>t.title.toLowerCase().includes(e.toLowerCase())||t.subject&&t.subject.toLowerCase().includes(e.toLowerCase())).map(t=>{let a=[],o=t.content.match(/\[([^\]]+)\]/g);return o&&[...new Set(o)].forEach(n=>{a.push({key:n,label:n.replace("[","").replace("]",""),type:n.toLowerCase().includes("data")?"date":"text",auto:n.toLowerCase().includes("nome")&&n.toLowerCase().includes("seu")?"agentName":null})}),{id:t.id||`snippet-${Math.random()}`,name:t.title,category:"\u{1F464} Pessoal",subject:t.subject||Ze("noSubject"),template:t.content,placeholders:a}})}function ks(e,t){return[...Es(e,t),...As(t),...Cs(t)]}function fi(){let e="v6.0.0",t=!1,a=[],o=null,n="",i=new Set;Ss();let r=document.createElement("div");r.id="email-assistant-popup",r.classList.add("cw-module-window","cw-email-popup"),Object.assign(r.style,Ue,{width:"850px",height:"650px"}),r.style.display="none",r.style.flexDirection="column";let s=ze(r,Ze("headerTitle"),e,Ze("headerDesc"),{popup:r},()=>E()),l=document.createElement("div");l.className="cw-email-main";let m=document.createElement("div");m.className="cw-email-left-panel";let u=document.createElement("div");u.className="cw-email-search-container";let f=document.createElement("input");f.className="cw-email-search-input",f.placeholder=Ze("searchPlaceholder");let g=document.createElement("div");g.id="email-template-list",ua(g,".cw-email-cat-header, .cw-email-list-item");let b=document.createElement("div");b.className="cw-email-clear-btn",b.innerHTML="\u2715",b.onclick=()=>{f.value="",n="",b.style.display="none",R(),f.focus()},u.appendChild(f),u.appendChild(b),m.appendChild(u),m.appendChild(g);let N=document.createElement("div");N.className="cw-email-right-panel";let x=document.createElement("div");x.className="cw-email-fields-section";let w=document.createElement("div");w.className="cw-email-preview-section";let D=document.createElement("div");D.className="cw-email-preview-header";let A=document.createElement("span");A.textContent=Ze("previewTitle"),A.className="cw-email-preview-title";let M=document.createElement("div");M.className="cw-email-preview-actions";let h=(K,le=!1)=>{let O=document.createElement("button");return O.textContent=K,O.className="cw-email-btn"+(le?" primary":""),O},k=h("Copiar HTML"),$=h("Preencher no CRM",!0),U=h("Smart CR");U.classList.add("warning"),M.appendChild(U),M.appendChild(k),M.appendChild($),D.appendChild(A),D.appendChild(M);let B=document.createElement("div");B.contentEditable="true",B.className="cw-email-preview-content",w.appendChild(D),w.appendChild(B),ne(),N.appendChild(x),N.appendChild(w),l.appendChild(m),l.appendChild(N),r.appendChild(s),r.appendChild(l);let j=document.createElement("div");Object.assign(j.style,ct),r.appendChild(j),dt(r,j),document.body.appendChild(r);function E(){t=!We(r),t?(ke(),r.style.display="flex",cn(r),a.length===0&&q()):(Te(),r.style.display="none"),$e(t,r,"cw-btn-email")}async function q(){g.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',a=await mi.getTemplates(),R()}function P(K,le,O){let Q=document.createElement("div");Q.className="cw-email-cat-header",Q.tabIndex=0,Q.setAttribute("role","button"),Q.setAttribute("aria-expanded",String(O));let re=document.createElement("span");re.textContent=K,Q.appendChild(re);let W=document.createElement("span");W.className="cw-email-cat-badge",W.textContent=le;let se=document.createElement("span");se.className="cw-email-cat-arrow",se.textContent=O?"\u25BE":"\u25B8";let I=document.createElement("div");return I.className="cw-email-cat-right",I.appendChild(W),I.appendChild(se),Q.appendChild(I),Q.onclick=()=>{i.has(K)?i.delete(K):i.add(K),R()},Q.addEventListener("keydown",G=>{(G.key==="Enter"||G.key===" ")&&(G.preventDefault(),Q.click())}),Q}function C(K){let le=o&&o.id===K.id,O=document.createElement("div");if(O.className="cw-email-list-item"+(le?" selected":""),O.tabIndex=0,O.setAttribute("role","button"),O.setAttribute("aria-pressed",String(!!le)),le){let W=document.createElement("div");W.className="cw-email-list-indicator",O.appendChild(W)}let Q=document.createElement("span");Q.className="cw-email-list-icon",Q.innerHTML=K.isSmartCR?"\u26A1":K.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",O.appendChild(Q);let re=document.createElement("span");return re.className="cw-email-list-text",re.textContent=K.name,O.appendChild(re),O.onclick=()=>ie(K),O.addEventListener("keydown",W=>{(W.key==="Enter"||W.key===" ")&&(W.preventDefault(),O.click())}),O}function R(){g.innerHTML="";let K=ks(a,n);if(K.length===0){g.innerHTML=`
                ...
                </div>`;return}[...new Set(K.map(O=>O.category))].sort((O,Q)=>O.localeCompare(Q)).forEach(O=>{let Q=i.has(O)||n.length>0,re=K.filter(W=>W.category===O);g.appendChild(P(O,re.length,Q)),Q&&re.forEach(W=>{g.appendChild(C(W))})})}let J=null;async function ie(K){o?.id!==K.id&&(o=K,J&&clearTimeout(J),N.style.opacity="0",N.style.transform="translateY(5px)",J=setTimeout(()=>{U.style.display=K.isSmartCR?"block":"none",$.style.display=K.isSmartCR?"none":"block",k.style.display=K.isSmartCR?"none":"block",R(),H(),ne(),N.style.opacity="1",N.style.transform="translateY(0)",J=null},150))}function H(){if(x.innerHTML="",!o||o.isSmartCR){o?.isSmartCR?(x.style.display="block",x.innerHTML=`<div class="cw-email-smartcr-hint">
                ...
                </div>`):x.style.display="none";return}let K=o.placeholders&&o.placeholders.length>0;if(x.style.display=K?"block":"none",!K)return;let le=document.createElement("div");le.className="cw-email-fields-grid",(o.placeholders||[]).forEach(O=>{let Q=document.createElement("div"),re=document.createElement("label");re.className="cw-email-field-label",re.textContent=O.label;let W=document.createElement("input");W.className="cw-email-field-input",W.type=O.type||"text",W.dataset.key=O.key,O.auto==="agentName"&&(W.value=Kt().split(" ")[0]),W.addEventListener("input",ne),Q.appendChild(re),Q.appendChild(W),le.appendChild(Q)}),x.appendChild(le)}function ne(){if(!o){B.innerHTML=`
...
CID: ${e.cid||"---"}
Case ID: ${e.caseId||"---"}
E-mail: ${e.clientEmail||"---"}`,dateLocale:"es-ES"}};function wi(){return de()==="es"?"ES":"PT"}function ve(e){let t=de();return yi[t]?.[e]??yi.pt[e]}var ge={bgApp:"#F5F5F7",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.07)",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",textPrimary:"#1D1D1F",textSecondary:"#6E6E73",danger:"#D93025",dangerBg:"#FCE8E6",success:"#34A853",successBg:"#E6F4EA"},qs={inicio:{PT:"Abertura",ES:"Apertura"},meio:{PT:"Implementa\xE7\xE3o (Tag Support)",ES:"Implementaci\xF3n"},fim:{PT:"Fechamento",ES:"Cierre"}};function Ls(){if(document.getElementById("csa-styles-v2"))return;let e=document.createElement("style");e.id="csa-styles-v2",e.textContent=`
    ...
    `,document.head.appendChild(e)}function Si(){let e="v3.1.0";Ls();let t={},a=wi(),o="BAU",n=!1,i=document.createElement("div");i.id="call-script-popup",i.classList.add("cw-module-window"),Object.assign(i.style,Ue,{right:"auto",left:"50%",width:"420px",height:"700px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:i,googleLine:null},s=null;function l(){n&&et().then(W=>{let se=i.querySelector("#cw-ctx-name"),I=i.querySelector("#cw-ctx-cid"),G=i.querySelector("#cw-ctx-email");if(se&&(se.textContent=W.advertiserName||ve("unknownClient")),I){let Z=W.cid||"---";I.textContent!==Z&&(I.textContent=Z)}if(G){let Z=W.clientEmail||ve("notFound");G.textContent!==Z&&(G.textContent=Z,G.title=Z)}})}function m(){et().then(W=>{let se=new Date().toLocaleDateString(ve("dateLocale")),I=i.querySelector("#cw-am-message-area"),G=i.querySelector("#cw-am-review-container"),Z=ve("amMessage")(W,se);I&&(I.value=Z),G&&(G.classList.add("visible"),G.scrollIntoView({behavior:"smooth",block:"end"}))})}function u(){n=!We(i),$e(n,i,"cw-btn-script"),n?(ke(),l(),s||(s=setInterval(l,2e3))):(Te(),s&&(clearInterval(s),s=null))}let f=ze(i,ve("headerTitle"),e,ve("headerDesc"),r,()=>{u()});i.appendChild(f);let g=f.querySelector("span"),b=document.createElement("div");b.className="csa-context-banner",b.innerHTML=`
  ...
  `,P.appendChild(C),B.appendChild(P);let R=C.querySelectorAll("button"),J=C.querySelector("#type-indicator");R.forEach((W,se)=>{W.onclick=()=>{R.forEach(I=>I.classList.remove("active")),W.classList.add("active"),J.style.transform=`translateX(${se*(C.offsetWidth/2-2)}px)`,o=W.dataset.type,v.playClick(),O()}}),Ae(()=>{a=wi(),g&&(g.textContent=ve("headerTitle"));let W=i.querySelector(".cw-help-title");W&&(W.textContent=ve("headerTitle"));let se=i.querySelector(".cw-help-description");se&&(se.textContent=ve("headerDesc"));let I=b.querySelector(".js-csa-monitoring");I&&(I.title=ve("activeMonitoring"));let G=b.querySelector(".js-csa-cid-label");G&&(G.textContent=ve("cidLabel"));let Z=b.querySelector(".js-csa-email-label");Z&&(Z.textContent=ve("emailLabel")),b.querySelectorAll(".csa-copy-hint").forEach(d=>d.textContent=ve("copied"));let z=b.querySelector(".js-csa-am-title");z&&(z.textContent=ve("amMessageTitle"));let c=b.querySelector(".js-csa-am-sub");c&&(c.textContent=ve("amMessageSub")),M&&(M.textContent=ve("copyFinalMessage"));let y=q.querySelector(".js-csa-reset-label");y&&(y.textContent=ve("resetScript")),O()});let ie=document.createElement("div");ie.id="csa-checklist-area",B.appendChild(ie);let H=document.createElement("div");Object.assign(H.style,ct),H.className="no-drag",H.title=ve("resize"),i.appendChild(H),dt(i,H),document.body.appendChild(i),k("#cw-pill-cid","#cw-ctx-cid"),k("#cw-pill-email","#cw-ctx-email");function ne(W){return W.replace(/\n/g,"<br>")}function K(W,se,I,G){let Z=`${W}-${se}-${G}`,z=!!t[Z],c=document.createElement("div");c.className="csa-item-row"+(z?" completed":"");let y=document.createElement("div");y.className="csa-checkbox"+(z?" checked":""),y.innerHTML=z?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"";let d=document.createElement("span");return d.className="csa-item-text"+(z?" completed":""),d.innerHTML=ne(I),c.onclick=()=>{let L=!t[Z];t[Z]=L,v.playClick(),c.classList.toggle("completed",L),d.classList.toggle("completed",L),y.classList.toggle("checked",L),y.innerHTML=L?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"",L&&(y.classList.add("pulse"),setTimeout(()=>y.classList.remove("pulse"),150)),Q(W,jt[W])},c.appendChild(y),c.appendChild(d),{row:c,isDone:z}}function le(W,se,I){let G=document.createElement("div");G.className="csa-card";let Z=document.createElement("div");Z.className="csa-card-title",Z.textContent=qs[se][a]||"";let z=document.createElement("span");z.className="csa-card-counter",Z.appendChild(z),G.appendChild(Z);let c=0;I.forEach((d,L)=>{let{row:_,isDone:ae}=K(W,se,d,L);ae&&c++,G.appendChild(_)});let y=c===I.length&&I.length>0;return G.classList.toggle("done",y),z.classList.toggle("done",y),z.textContent=`${c}/${I.length}`,G}function O(){ie.innerHTML="";let W=`${a} ${o}`,se=jt[W];if(!se){ie.innerHTML=`<div class="csa-empty-state"><div class="csa-empty-state-icon">\u2615</div><div>${ve("scriptNotConfigured")}</div></div>`,U.style.width="0%";return}let I=0,G=0;["inicio","meio","fim"].forEach(Z=>{se[Z]&&(I+=se[Z].length)}),["inicio","meio","fim"].forEach(Z=>{let z=se[Z];!z||z.length===0||(z.forEach((c,y)=>{let d=`${W}-${Z}-${y}`;t[d]&&G++}),ie.appendChild(le(W,Z,z)))}),re(I,G)}function Q(W,se){let I=0,G=0;["inicio","meio","fim"].forEach(Z=>{let z=se[Z]||[];I+=z.length,z.forEach((c,y)=>{t[`${W}-${Z}-${y}`]&&G++})}),re(I,G),setTimeout(()=>O(),200)}function re(W,se){let I=W===0?0:se/W*100;U.style.width=`${I}%`,U.classList.toggle("complete",I===100)}return O(),vi(()=>O()),u}var Ns={"Ponto Eletr\xF4nico":"Control de Asistencia","Ferramenta de ajuda":"Herramienta de ayuda","Intranet Google":"Intranet Google","Relat\xF3rio Follow-ups":"Informe de Follow-ups","Dashboard WFM":"Dashboard WFM","Tech Solutions SAO":"Tech Solutions SAO","Form Grava\xE7\xE3o":"Form Grabaci\xF3n","Form Escala\xE7\xE3o":"Form Escalaci\xF3n","Instru\xE7\xF5es Split":"Instrucciones Split","Single Page App":"Single Page App","Procedimento Padr\xE3o":"Procedimiento Est\xE1ndar","Valida\xE7\xE3o C\xF3digo":"Validaci\xF3n C\xF3digo","Convers\xE3o Chamada":"Conversi\xF3n Llamada","Valida\xE7\xE3o WCC":"Validaci\xF3n WCC",ECW4:"ECW4","Monitoramento EC":"Monitoreo EC","Resolu\xE7\xE3o problemas":"Resoluci\xF3n de problemas","Implementa\xE7\xE3o RMKT":"Implementaci\xF3n RMKT","Pontua\xE7\xE3o Leads":"Puntuaci\xF3n de Leads","Instala\xE7\xE3o Container":"Instalaci\xF3n Container","Instala\xE7\xE3o Config.":"Instalaci\xF3n Config.","Valida\xE7\xE3o GA4":"Validaci\xF3n GA4","Guia Dev":"Gu\xEDa Dev","Resolu\xE7\xE3o Problemas":"Resoluci\xF3n de Problemas","Dom\xEDnio Cruzado":"Dominio Cruzado","Lista Oficial":"Lista Oficial","Criador URLs":"Creador de URLs","Setup Inicial":"Setup Inicial","Otimiza\xE7\xE3o Feed":"Optimizaci\xF3n Feed","Ferramenta Interna":"Herramienta Interna",Avalia\u00E7\u00F5es:"Rese\xF1as","Feeds Offline":"Feeds Offline","Help Center":"Help Center","Guias CMS":"Gu\xEDas CMS","Solu\xE7\xF5es Iframes":"Soluciones Iframes","Ghost Ads":"Ghost Ads","Ghost Analytics":"Ghost Analytics","Ghost GTM":"Ghost GTM",Ferramenta:"Herramienta","Ghost MC":"Ghost MC","Playground JS":"Playground JS","Testador Regex":"Probador Regex","Doc. CSP":"Doc. CSP","Guia CoMo":"Gu\xEDa CoMo","Debug CoMo":"Debug CoMo","Portal Colaborador":"Portal del Colaborador","Apps e Sistemas":"Apps y Sistemas","Folha Pagamento":"N\xF3mina","Reportar problemas":"Reportar problemas","Registro chamadas":"Registro de llamadas","Erros de sistema":"Errores de sistema","BAU/Descarte/Monitoria":"BAU/Descarte/Monitoreo","Feedback positivo":"Feedback positivo","Casos dif\xEDceis":"Casos dif\xEDciles","Chat/Email Ads":"Chat/Email Ads","Chat/Email Shopping":"Chat/Email Shopping","Perfil da Empresa":"Perfil de la Empresa","Console API":"Console API","Lista de n\xFAmeros":"Lista de n\xFAmeros",Cursos:"Cursos"};function Ei(e){let t=e&&typeof e=="object"?e:{desc:e},a=t.desc||"";return de()!=="es"?a:t.descEs||Ns[a]||a}var Ai={pt:{headerTitle:"Central de Links",headerDesc:"Navegue pelas categorias ou use a busca.",searchPlaceholder:"Buscar ferramenta ou SOP...",recent:"Recentes",nothingHereYet:"Nada por aqui ainda",nothingHereSub:"Os links que voc\xEA abrir aparecem aqui pra acesso r\xE1pido depois.",searchResults:"Resultados da busca",nothingFound:"Nada encontrado",noLinkMatches:e=>`Nenhum link bate com "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"Link copiado!",copyFailedToast:"N\xE3o foi poss\xEDvel copiar o link.",categoryLabels:{tasks:"Tarefas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RH",lm:"Forms",qa:"QA",suporte:"Ajuda"}},es:{headerTitle:"Central de Enlaces",headerDesc:"Navega por las categor\xEDas o usa la b\xFAsqueda.",searchPlaceholder:"Buscar herramienta o SOP...",recent:"Recientes",nothingHereYet:"Todav\xEDa no hay nada aqu\xED",nothingHereSub:"Los enlaces que abras aparecen aqu\xED para acceso r\xE1pido despu\xE9s.",searchResults:"Resultados de la b\xFAsqueda",nothingFound:"No se encontr\xF3 nada",noLinkMatches:e=>`Ning\xFAn enlace coincide con "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"\xA1Enlace copiado!",copyFailedToast:"No se pudo copiar el enlace.",categoryLabels:{tasks:"Tareas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RRHH",lm:"Forms",qa:"QA",suporte:"Ayuda"}}};function Re(e){let t=de();return Ai[t]?.[e]??Ai.pt[e]}function Ci(e){return Re("categoryLabels")[e]??ht[e]?.label??e}var ht={tasks:{label:"Tarefas",links:[{name:"Web Clock Punch",url:"https://compass.talent.cognizant.com/psp/HCMPRD/EMPLOYEE/HRMS/h/?tab=DEFAULT",desc:"Ponto Eletr\xF4nico"},{name:"Web\xE3o Help Deluxe",url:"http://go/webao-help-deluxe",desc:"Ferramenta de ajuda"},{name:"Moma Home",url:"https://moma.corp.google.com/",desc:"Intranet Google"},{name:"Plx DataSites",url:"https://data.corp.google.com/sites/7kpryuwxw9jw/agents_follow_ups_report/",desc:"Relat\xF3rio Follow-ups"},{name:"Escala & Ader\xEAncia",url:"https://lookerstudio.google.com/c/u/0/reporting/f8966844-b70e-4070-9b7f-a29028401bf4/page/p_0tayxfleid",desc:"Dashboard WFM"},{name:"Performance Indiv.",url:"https://dashboards.corp.google.com/_a981e311_424f_410b_925f_9b019ee186ce",desc:"Tech Solutions SAO"},{name:"Solicitar Grava\xE7\xE3o",url:"https://support.google.com/policies/contact/sar",desc:"Form Grava\xE7\xE3o"},{name:"Escala\xE7\xE3o Sellers",url:"https://forms.gle/HWMhML56eE4CPZCs5",desc:"Form Escala\xE7\xE3o"},{name:"[SOP] Split",url:"https://sites.google.com/corp/google.com/technicalsolutions/case-handling_1/out-of-scope?authuser=0#h.obb5iieru15o",desc:"Instru\xE7\xF5es Split"}]},ads:{label:"Ads",links:[{name:"SPA (Tag Support)",url:"https://tagsupport.corp.google.com/create-session",desc:"Single Page App"},{name:"[SOP] Conv. Tracking",url:"https://docs.google.com/document/d/1By5Jv40kGeGWFUzMXT9xuNAeUl_s1clYybZO1nhNnAI/edit",desc:"Procedimento Padr\xE3o"},{name:"Win Criteria: Code",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit",desc:"Valida\xE7\xE3o C\xF3digo"},{name:"[SOP] Call Conv.",url:"https://docs.google.com/document/d/1es_tvx8nhMkWn-Hh9n3Jd3vzo91RpY6PuwMBlsTd-kA/edit",desc:"Convers\xE3o Chamada"},{name:"Win Criteria: WCC",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A10:A15",desc:"Valida\xE7\xE3o WCC"},{name:"[SOP] Enhanced Conv.",url:"https://docs.google.com/document/d/1R59-cUeBaX-5dOxAXxvzsRXgkVdFPzTzOCSBQWt42H0/edit",desc:"ECW4"},{name:"Ads EC Dashboard",url:"https://dashboards.corp.google.com/edit/_0ded1099_6ef3_4bc9_bba0_2445840d1b69",desc:"Monitoramento EC"},{name:"[SOP] Troubleshooting",url:"https://docs.google.com/document/d/10M0FAkMFmlhgHQJtAQPNtLRGh-BpPzR_6z1s6xYOQEk/edit",desc:"Resolu\xE7\xE3o problemas"},{name:"[SOP] Remarketing",url:"https://docs.google.com/document/d/1awOuj4rFBrukfByYuvcCFOAGbZX7H1j_EelPeCaUcoU/edit",desc:"Implementa\xE7\xE3o RMKT"},{name:"[SOP] Lead Scoring",url:"https://docs.google.com/document/d/1jyFVLvKnk1K2ojyj-K37PXcmQdU9A8wiHWj-w49yOBg/edit",desc:"Pontua\xE7\xE3o Leads"},{name:"[SOP] GTM Install",url:"https://docs.google.com/document/d/1Uj-fkPNxygeL-YQIVgLfIPo579SKF1oe78i5nHx5eLs/edit",desc:"Instala\xE7\xE3o Container"}]},analytics:{label:"GA4",links:[{name:"[SOP] GA4 Setup",url:"https://docs.google.com/document/d/1cLDh6RIo-lxfv-pffvBwhFpI-fSTOaAsMXwwsID1yNk/edit",desc:"Instala\xE7\xE3o Config."},{name:"Win Criteria: GA4",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A45:A51",desc:"Valida\xE7\xE3o GA4"},{name:"GA4 E-commerce",url:"https://developers.google.com/analytics/devguides/collection/ga4/ecommerce?hl=pt-br",desc:"Guia Dev"},{name:"[SOP] Troubleshoot GA4",url:"https://docs.google.com/document/d/14fxyQMlcT57ILtsaBdYBFZs2DDZeSbXsvniXfo_eJaU/edit",desc:"Resolu\xE7\xE3o Problemas"},{name:"[SOP] Cross Domain",url:"https://support.google.com/ads-help/answer/12282402",desc:"Dom\xEDnio Cruzado"},{name:"Eventos Recomendados",url:"https://developers.google.com/analytics/devguides/collection/ga4/reference/events",desc:"Lista Oficial"},{name:"UTM Builder",url:"https://ga-dev-tools.google/ga4/campaign-url-builder/",desc:"Criador URLs"}]},shopping:{label:"Shop",links:[{name:"[SOP] Onboarding MC",url:"https://docs.google.com/document/d/1yJGEssn9Uvxa3eWjp2Y5MQSkL26AElh6sSAKgD6qmjg/edit",desc:"Setup Inicial"},{name:"[SOP] Feed Opt",url:"https://docs.google.com/document/d/1VBYH6b3r0uyjXHN749pDK7IajF5Ii0-rm6M-BZuaJGY/edit",desc:"Otimiza\xE7\xE3o Feed"},{name:"ShopTroubleshooting",url:"http://go/shoptroubleshooting",desc:"Ferramenta Interna"},{name:"[SOP] Product Reviews",url:"https://docs.google.com/document/d/1v2xH6QLgWc5_-C85Pmj40GSe5lxstRXnjd8vEW92TBk/edit",desc:"Avalia\xE7\xF5es"},{name:"[SOP] Offline Feed",url:"https://docs.google.com/document/d/1Q3cJxf4ucfA_bu6vDId63Tj1P8ZofgE7CqnK9KUgLuU/edit",desc:"Feeds Offline"},{name:"Especifica\xE7\xE3o Dados",url:"https://support.google.com/merchants/answer/7052112",desc:"Help Center"}]},tech:{label:"Tech",links:[{name:"Solu\xE7\xF5es por CMS",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-via-cms?authuser=0",desc:"Guias CMS"},{name:"Iframes & Cross-Origin",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-t%C3%A9cnicas/iframes-contentdocument-e-message?authuser=0",desc:"Solu\xE7\xF5es Iframes"},{name:"Ads ICS Ghost",url:"http://go/pqp",desc:"Ghost Ads"},{name:"Analytics ICS Ghost",url:"http://go/analytics-ics",desc:"Ghost Analytics"},{name:"GTM ICS Ghost",url:"http://go/tagmanager-ics",desc:"Ghost GTM"},{name:"Gearloose",url:"http://go/gearloose",desc:"Ferramenta"},{name:"MC ICS Ghost",url:"https://mcn-ics.corp.google.com/mc/overview",desc:"Ghost MC"},{name:"JSFiddle",url:"https://jsfiddle.net/",desc:"Playground JS"},{name:"RegExr",url:"https://regexr.com/",desc:"Testador Regex"},{name:"Doc. CSP",url:"https://developers.google.com/tag-platform/tag-manager/web/csp?hl=pt-br.",desc:"Doc. CSP"},{name:"Consent Mode Install",url:"https://developers.google.com/tag-platform/security/guides/consent?consentmode=advanced",desc:"Guia CoMo"},{name:"Consent Mode Debug",url:"https://developers.google.com/tag-platform/security/guides/consent-debugging",desc:"Debug CoMo"}]},hr:{label:"RH",links:[{name:"Be.Cognizant",url:"https://cognizantonline.sharepoint.com/sites/GlobalHR/SitePages/Brazil.aspx",desc:"Portal Colaborador"},{name:"OneCognizant",url:"https://onecognizant.cognizant.com/Home",desc:"Apps e Sistemas"},{name:"ADP eXpert",url:"https://expert.cloud.brasil.adp.com/expert2/v4/",desc:"Folha Pagamento"}]},lm:{label:"Forms",links:[{name:"Ocorr\xEAncias e Pausas",url:"https://docs.google.com/forms/d/e/1FAIpQLSc6CamPehrREeVr7yCWMyqFETrFYYezNcLb_13W4yZDQkfY6Q/viewform",desc:"Reportar problemas"},{name:"Chamadas >50min",url:"https://docs.google.com/forms/d/e/1FAIpQLSfE8EMHNJMTKYeA6XM2RZjZ9AQ4LhGk1Dwm_WLu3kcMdKMikA/viewform",desc:"Registro chamadas"},{name:"Relat\xF3rio de Bugs",url:"https://docs.google.com/forms/d/e/1FAIpQLSfkqRqT2Kbf08IStz31fQPE84MDOtGxk7cetJmc3xzShXIXRA/viewform",desc:"Erros de sistema"},{name:"Suporte LM",url:"https://script.google.com/a/macros/google.com/s/AKfycbxYMlFCMZvqgHMIImeS_u-lNZPiertXmem-5m9Fox3jvZaq0ZOQDoc5ma96ltSvWHY/exec",desc:"BAU/Descarte/Monitoria"}]},qa:{label:"QA",links:[{name:"Elogios",url:"https://docs.google.com/forms/d/e/1FAIpQLSezY5K-trQDv0LkL5IoTlV0Tl0oOqGTEszylmgcbMRXcC9Weg/viewform",desc:"Feedback positivo"},{name:"Casos Complexos",url:"https://docs.google.com/forms/d/e/1FAIpQLSe26q1LEloFNRfOAVZtA7DCOQTqdu1BAEeWuxtK6oPwZhLp-A/viewform?resourcekey=0-c1N4h8gntza2gQowqYAqMw",desc:"Casos dif\xEDceis"}]},suporte:{label:"Ajuda",links:[{name:"Fale Conosco Ads",url:"https://support.google.com/google-ads/gethelp",desc:"Chat/Email Ads"},{name:"Fale Conosco Merchant",url:"https://support.google.com/merchants/gethelp",desc:"Chat/Email Shopping"},{name:"Fale Conosco GMB",url:"https://support.google.com/business/gethelp",desc:"Perfil da Empresa"},{name:"Suporte API",url:"https://support.google.com/googleapi",desc:"Console API"},{name:"Telefones Suporte",url:"https://www.adwordsrobot.com/en/list-of-google-adwords-support-phone-numbers",desc:"Lista de n\xFAmeros"},{name:"Skill Shop",url:"https://skillshop.withgoogle.com/intl/pt-BR_ALL/",desc:"Cursos"}]}};function ki(e){if(!Array.isArray(e)||!e.length)return!1;let t={};for(let a of e){let o=a.key;if(!o)continue;let n;try{n=JSON.parse(a.value||"{}")}catch{continue}!n.name||!n.url||(t[o]||(t[o]={label:ht[o]?.label||o,links:[]}),t[o].links.push({name:n.name,url:n.url,desc:n.desc||"",descEs:n.desc_es||""}))}if(!Object.keys(t).length)return!1;for(let a of Object.keys(ht))delete ht[a];return Object.assign(ht,t),!0}async function Is(e){let t=me.getCachedContent("links");ki(t)&&e?.();try{let a=await me.fetchContentModule("links");ki(a)&&e?.()}catch(a){console.warn("Central de Conte\xFAdo indispon\xEDvel; usando links embutidos.",a)}}var Et={tasks:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>',lm:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/></svg>',qa:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>',suporte:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',ads:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>',analytics:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>',shopping:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>',tech:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg>',hr:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',history:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>'},At={bgApp:"#F8F9FA",bgSidebar:"#FFFFFF",bgSurface:"#FFFFFF",textPrimary:"#202124",textSecondary:"#5F6368",borderSubtle:"rgba(0,0,0,0.06)"},_a={tasks:{color:"#0097A7",bg:"#E0F7FA"},ads:{color:"#1967D2",bg:"#E8F0FE"},analytics:{color:"#E37400",bg:"#FEF7E0"},shopping:{color:"#188038",bg:"#E6F4EA"},tech:{color:"#9334E6",bg:"#F3E8FD"},hr:{color:"#C5221F",bg:"#FCE8E6"},lm:{color:"#5F6368",bg:"#F1F3F4"},qa:{color:"#F09D00",bg:"#FFF3E0"},suporte:{color:"#0B57D0",bg:"#D3E3FD"},history:{color:"#5F6368",bg:"#FFFFFF"}};function _s(){if(document.getElementById("cw-links-styles"))return;let e=document.createElement("style");e.id="cw-links-styles",e.textContent=`
        ...
        .cw-links-nav-btn {
            ...
            display: flex; flex-direction: column; align-items: center; justify-content: center;
            cursor: pointer; color: ${At.textSecondary};
        ...
        /* --- CONTE\xDADO --- */
        .cw-links-content { flex: 1; display: flex; flex-direction: column; overflow: hidden; background: ${At.bgApp}; position: relative; z-index: 1; }
        ...
        .cw-links-search-input {
            ...
            padding: 0 12px; font-size: 14px; color: ${At.textPrimary};
        ...
        .cw-links-card-title { font-size: 14px; font-weight: 600; color: ${At.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .cw-links-card-desc { font-size: 12px; color: ${At.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    `,document.head.appendChild(e)}var xo="cw_link_history_v4",Fs=10;function Ti(e,t){try{let a=JSON.parse(localStorage.getItem(xo)||"[]");a=a.filter(o=>o.url!==e.url),a.unshift({...e,_originalCat:t}),a=a.slice(0,Fs),localStorage.setItem(xo,JSON.stringify(a))}catch(a){console.warn("Erro ao salvar hist\xF3rico",a)}}function Ds(){try{return JSON.parse(localStorage.getItem(xo)||"[]")}catch{return[]}}function qi(){let e="v4.6",t="",a=!1,o=null,n=!1;_s();let i=document.createElement("div");i.id="links-popup",i.classList.add("cw-module-window"),Object.assign(i.style,Ue,{right:"100px",width:"600px",height:"650px",background:At.bgApp,overflow:"hidden"});let r={popup:i,googleLine:null},s=ze(i,Re("headerTitle"),e,Re("headerDesc"),r,()=>P());i.appendChild(s);let l=s.querySelector("span"),m=document.createElement("div");m.className="cw-links-layout",i.appendChild(m);let u=document.createElement("div");u.className="cw-links-sidebar",m.appendChild(u);let f=document.createElement("div");f.className="cw-links-content",m.appendChild(f);let g=document.createElement("div");g.className="cw-links-search-bar";let b=document.createElement("div");b.className="cw-links-search-wrap";let N=document.createElement("div");N.className="cw-links-search-icon",N.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#5F6368" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let x=document.createElement("input");x.className="cw-links-search-input",x.type="text",x.placeholder=Re("searchPlaceholder"),b.appendChild(N),b.appendChild(x),g.appendChild(b),f.appendChild(g);let w=document.createElement("div");w.className="cw-links-scroll",f.appendChild(w);let D=null;function A(){if(D)return;D=document.createElement("div"),D.className="cw-links-history-overlay";let C=document.createElement("div");C.className="cw-links-history-head",C.innerHTML=`<span class="cw-links-history-title js-links-recent">\u{1F552} ${Re("recent")}</span>`;let R=document.createElement("button");R.className="cw-links-history-close",R.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',R.onclick=()=>M(),C.appendChild(R),D.appendChild(C);let J=document.createElement("div");J.id="cw-history-list",J.className="cw-links-history-list",D.appendChild(J),f.appendChild(D)}function M(){n&&(n=!1,k(),j())}function h(){D||A();let C=D.querySelector("#cw-history-list");C.innerHTML="";let R=Ds();R.length===0?C.appendChild(Wt({icon:Et.history,title:Re("nothingHereYet"),subtitle:Re("nothingHereSub")})):R.forEach(J=>{let ie=q(J,Et[J._originalCat],!0,J._originalCat);C.appendChild(ie)}),requestAnimationFrame(()=>D.style.transform="translateY(0)")}function k(){D&&(D.style.transform="translateY(100%)")}document.addEventListener("mousedown",C=>{!n||!D||!D.contains(C.target)&&!u.contains(C.target)&&M()}),document.addEventListener("keydown",C=>{C.key==="Escape"&&n&&M()});function $(){u.innerHTML="";let C=U("history",Re("recent"),Et.history);C.id="cw-sidebar-btn-history",C.onclick=()=>{v.playClick(),n=!n,n?h():k(),j()},u.appendChild(C);let R=document.createElement("div");R.className="cw-links-nav-sep",u.appendChild(R),Object.keys(ht).forEach(J=>{let ie=U(J,Ci(J),Et[J]);ie.id=`cw-sidebar-btn-${J}`,ie.onclick=()=>{v.playClick(),n&&M(),B(J)},u.appendChild(ie)})}function U(C,R,J){let ie=document.createElement("div");ie.className="cw-links-nav-btn",ie.title=R,ie.dataset.key=C;let H=_a[C];H&&(ie.style.setProperty("--cat-color",H.color),ie.style.setProperty("--cat-bg",H.bg));let ne=document.createElement("div");ne.className="cw-links-nav-icon",ne.innerHTML=J||Et.tasks;let K=document.createElement("div");return K.className="cw-links-nav-label",K.textContent=R,ie.appendChild(ne),ie.appendChild(K),ie}function B(C){let R=document.getElementById(`cat-anchor-${C}`);R&&(R.scrollIntoView({behavior:"smooth",block:"start"}),o=C,j())}function j(){Object.keys(ht).forEach(R=>{let J=u.querySelector(`#cw-sidebar-btn-${R}`);J&&J.classList.toggle("active",o===R&&!n)});let C=u.querySelector("#cw-sidebar-btn-history");C&&C.classList.toggle("history-open",n)}function E(){if(w.innerHTML="",t.trim()!==""){let R=[];if(Object.entries(ht).forEach(([ie,H])=>{let ne=H.links.filter(K=>K.name.toLowerCase().includes(t.toLowerCase())||Ei(K).toLowerCase().includes(t.toLowerCase()));R.push(...ne.map(K=>({...K,_cat:ie})))}),R.length===0){w.appendChild(Wt({icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',title:Re("nothingFound"),subtitle:Re("noLinkMatches")(t.trim())}));return}let J=document.createElement("div");J.className="cw-links-search-results-label",J.textContent=Re("searchResults"),w.appendChild(J),R.forEach(ie=>{let H=q(ie,Et[ie._cat],!1,ie._cat);w.appendChild(H)});return}Object.entries(ht).forEach(([R,J])=>{let ie=_a[R],H=document.createElement("div"),ne=document.createElement("div");ne.id=`cat-anchor-${R}`,ne.className="cw-links-cat-header",ne.style.setProperty("--cat-color",ie.color),ne.innerHTML=`<div class="cw-links-cat-dot"></div>${Ci(R)}`,H.appendChild(ne);let K=document.createElement("div");K.className="cw-links-cat-grid",J.links.forEach(le=>{let O=q(le,Et[R],!1,R);K.appendChild(O)}),H.appendChild(K),w.appendChild(H)});let C=document.createElement("div");C.className="cw-links-spacer",w.appendChild(C)}function q(C,R,J,ie){let H=document.createElement("a");H.className="cw-links-card",H.href=C.url,H.target="_blank",H.rel="noopener noreferrer";let ne=_a[ie]||_a.history;H.style.setProperty("--cat-color",ne.color),H.style.setProperty("--cat-bg",ne.bg);let K=document.createElement("div");K.className="cw-links-icon-box",K.innerHTML=R||Et.tasks;let le=document.createElement("div");le.className="cw-links-card-meta";let O=document.createElement("div");O.className="cw-links-card-title",O.textContent=C.name;let Q=document.createElement("div");Q.className="cw-links-card-desc",Q.textContent=Ei(C),le.appendChild(O),le.appendChild(Q);let re=document.createElement("div");return re.className="cw-links-copy-btn",re.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',re.title=Re("copyUrl"),H.onclick=()=>{!J&&ie&&Ti(C,ie)},re.onclick=W=>{W.preventDefault(),W.stopPropagation(),navigator.clipboard.writeText(C.url).then(()=>{v.playClick(),!J&&ie&&Ti(C,ie),ee(Re("linkCopiedToast"))}).catch(()=>{v.playError(),ee(Re("copyFailedToast"),{error:!0})})},H.appendChild(K),H.appendChild(le),H.appendChild(re),H}x.addEventListener("input",C=>{t=C.target.value,E()});function P(){a=!We(i),a?ke():Te(),$e(a,i,"cw-btn-links")}return document.body.appendChild(i),$(),E(),Is(()=>{$(),E(),j()}),Ae(()=>{l&&(l.textContent=Re("headerTitle"));let C=i.querySelector(".cw-help-title");C&&(C.textContent=Re("headerTitle"));let R=i.querySelector(".cw-help-description");R&&(R.textContent=Re("headerDesc")),x.placeholder=Re("searchPlaceholder"),$(),E(),j(),n&&h()}),P}var Ms=60*1e3,Mi="cw_read_broadcasts",Li={pt:{headerTitle:"Central de Avisos",headerDesc:"Comunica\xE7\xE3o oficial da opera\xE7\xE3o.",searchPlaceholder:"Buscar avisos\u2026",clearSearch:"Limpar a busca",markRead:e=>`Marcar \u201C${e}\u201D como lido`,markReadShort:"Marcar como lido",publishedBy:e=>`Publicado por ${e}`,system:"Sistema",bauAvailability:"Disponibilidade BAU",attention:"aten\xE7\xE3o",full:"total",noDates:"sem datas publicadas",asideLabel:"Estado da opera\xE7\xE3o",filtersTitle:"Filtrar por tipo",filterAll:"Todos",readTitle:"Leitura",readCount:e=>e===1?"1 lido":`${e} lidos`,markAllRead:"Marcar tudo como lido",updatedAgo:e=>`Atualizado ${e}`,swapTo:e=>`Ver disponibilidade de ${e}`,justNow:"agora",minutesAgo:e=>`h\xE1 ${e} min`,hoursAgo:e=>`h\xE1 ${e} h`,yesterday:"ontem",nothingFound:"Nada encontrado.",allRead:"Tudo lido!",history:e=>`Hist\xF3rico (${e})`,typeLabel:{info:"Info",critical:"Alerta",success:"Sucesso"},syncing:"Sincronizando\u2026",updated:"Atualizado",offline:"Sem conex\xE3o \u2014 mostrando o que j\xE1 estava aqui"},es:{headerTitle:"Central de Avisos",headerDesc:"Comunicaci\xF3n oficial de la operaci\xF3n.",searchPlaceholder:"Buscar avisos\u2026",clearSearch:"Limpiar la b\xFAsqueda",markRead:e=>`Marcar \u201C${e}\u201D como le\xEDdo`,markReadShort:"Marcar como le\xEDdo",publishedBy:e=>`Publicado por ${e}`,system:"Sistema",bauAvailability:"Disponibilidad BAU",attention:"atenci\xF3n",full:"total",noDates:"sin fechas publicadas",asideLabel:"Estado de la operaci\xF3n",filtersTitle:"Filtrar por tipo",filterAll:"Todos",readTitle:"Lectura",readCount:e=>e===1?"1 le\xEDdo":`${e} le\xEDdos`,markAllRead:"Marcar todo como le\xEDdo",updatedAgo:e=>`Actualizado ${e}`,swapTo:e=>`Ver disponibilidad de ${e}`,justNow:"ahora",minutesAgo:e=>`hace ${e} min`,hoursAgo:e=>`hace ${e} h`,yesterday:"ayer",nothingFound:"No se encontr\xF3 nada.",allRead:"\xA1Todo le\xEDdo!",history:e=>`Historial (${e})`,typeLabel:{info:"Info",critical:"Alerta",success:"\xC9xito"},syncing:"Sincronizando\u2026",updated:"Actualizado",offline:"Sin conexi\xF3n \u2014 mostrando lo que ya estaba aqu\xED"}};function be(e){let t=de();return Li[t]?.[e]??Li.pt[e]}var Fa={PT:{label:"PT-BR",flag:'<svg class="cw-bc-bau-flag" viewBox="0 0 21 15" aria-hidden="true"><rect width="21" height="15" fill="#009B3A"/><path d="M10.5 1.9 19.1 7.5 10.5 13.1 1.9 7.5Z" fill="#FEDF00"/><circle cx="10.5" cy="7.5" r="3.3" fill="#002776"/></svg>'},ES:{label:"ES",flag:'<svg class="cw-bc-bau-flag" viewBox="0 0 21 15" aria-hidden="true"><rect width="21" height="15" fill="#AA151B"/><rect y="3.75" width="21" height="7.5" fill="#F1BF00"/></svg>'}},Os='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="17 2 21 6 17 10"></polyline><path d="M3 12V10a4 4 0 0 1 4-4h14"></path><polyline points="7 22 3 18 7 14"></polyline><path d="M21 12v2a4 4 0 0 1-4 4H3"></path></svg>',vo={critical:!0,info:!0,success:!0};function zs(){if(document.getElementById("cw-broadcast-styles"))return;let e=document.createElement("style");e.id="cw-broadcast-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}var $s={pt:"pt-BR",es:"es-ES"};function Oi(e){if(!e)return"";try{let t=new Date(e);return isNaN(t.getTime())?String(e):new Intl.DateTimeFormat($s[de()]||"pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).format(t)}catch{return String(e)}}function Rs(e){let t=String(e||"").split("-");return t.length===3?`${t[2]}/${t[1]}`:String(e||"")}function Bs(e){let t=new Date(e).getTime();if(!t||isNaN(t))return"";let a=Math.floor((Date.now()-t)/6e4);if(a<1)return be("justNow");if(a<60)return be("minutesAgo")(a);let o=Math.floor(a/60);return o<24?be("hoursAgo")(o):o<48?be("yesterday"):Oi(e).split(",")[0]}function Ni(e){if(!e||typeof e!="string")return"";let t=e;return t=t.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="cw-bc-link">$1</a>'),t=t.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),t=t.replace(/_(.*?)_/g,"<i>$1</i>"),t=t.replace(/\n/g,"<br>"),t=dn(t),t}function Ii(e){if(!e)return null;let t={};try{t=JSON.parse(e.value||"{}")}catch{return null}let a=String(t.title||e.label||"").trim(),o=String(t.text||"").trim();return!a||!o?null:{id:String(e.key||e.id||""),type:vo[t.type]?t.type:"info",title:a,text:o,date:String(t.publishedAt||e.publishedAt||""),author:String(t.author||e.publishedBy||""),lang:String(e.lang||"ALL").toUpperCase()}}function Ps(e){if(!e)return null;let t=String(e.title||"").trim(),a=String(e.text||"").trim();return!t||!a||t.toLowerCase().includes("disponibilidade bau")?null:{id:String(e.id||""),type:vo[e.type]?e.type:"info",title:t,text:a,date:String(e.date||""),author:String(e.author||""),lang:"ALL"}}function _i(e){let t=(e||[])[0];if(!t)return null;let a={};try{a=JSON.parse(t.value||"{}")}catch{return null}let o=a.segments||{},n={};return Object.keys(o).forEach(i=>{let r=String(o[i]?.attention||""),s=String(o[i]?.full||"");(r||s)&&(n[i]={attention:r,full:s})}),Object.keys(n).length?{updatedAt:String(a.updatedAt||t.publishedAt||""),author:String(a.author||t.publishedBy||""),note:String(a.note||""),segments:n}:null}function Fi(e,t){return e.lang==="ALL"||e.lang===t}function Gt(){try{let e=JSON.parse(localStorage.getItem(Mi)||"[]");return Array.isArray(e)?e:[]}catch{return[]}}function Di(e){try{localStorage.setItem(Mi,JSON.stringify(e))}catch{}}function zi(){let e="v5.0",t=!1,a=null,o="",n=null,i=null,r=!1,s=[],l=null,m=null,u=null,f=null;zs();let g=document.createElement("div");g.id="broadcast-popup",g.classList.add("cw-module-window"),Object.assign(g.style,Ue,{right:"auto",left:"50%",width:"760px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let b={popup:g,googleLine:null};function N(){if(t=!We(g),$e(t,g,"cw-btn-broadcast"),t){ke();let z=document.getElementById("cw-btn-broadcast");z&&z.classList.remove("has-new"),n=null,i=null,r=!1,R()}else Te()}let x=ze(g,be("headerTitle"),e,be("headerDesc"),b,()=>N()),w=x.querySelector("span");g.appendChild(x);let D=document.createElement("div");D.className="cw-bc-search-wrap";let A=document.createElement("div");A.className="cw-bc-search-icon",A.setAttribute("aria-hidden","true"),A.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let M=document.createElement("input");M.className="cw-bc-search-input no-drag",M.type="search",M.name="cw-broadcast-search",M.autocomplete="off",M.spellcheck=!1,M.placeholder=be("searchPlaceholder"),M.setAttribute("aria-label",be("searchPlaceholder"));let h=document.createElement("button");h.type="button",h.className="cw-bc-search-clear",h.setAttribute("aria-label",be("clearSearch")),h.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';let k=document.createElement("div");k.className="cw-bc-search-field",k.append(A,M,h),D.appendChild(k),g.appendChild(D),M.addEventListener("input",z=>{o=z.target.value,h.classList.toggle("visible",o.length>0),se()}),h.onclick=()=>{M.value="",o="",h.classList.remove("visible"),se(),M.focus()};let $=document.createElement("div");$.className="cw-bc-body",g.appendChild($);let U=document.createElement("div");U.className="cw-nice-scroll cw-bc-feed",U.setAttribute("role","feed"),U.setAttribute("aria-label",be("headerTitle")),$.appendChild(U);let B=document.createElement("aside");B.className="cw-nice-scroll cw-bc-aside",B.setAttribute("aria-label",be("asideLabel")),$.appendChild(B);let j=document.createElement("div");j.id="cw-bau-widget",j.className="cw-bc-panel",j.style.display="none",B.appendChild(j);let E=document.createElement("div");E.className="cw-bc-panel",B.appendChild(E);let q=document.createElement("div");q.className="cw-bc-panel",B.appendChild(q);let P=document.createElement("div");P.id="cw-update-status",P.className="cw-bc-sync",P.setAttribute("role","status"),P.setAttribute("aria-live","polite"),B.appendChild(P);function C({syncing:z=!1,online:c=!0}={}){if(P.classList.toggle("offline",!z&&!c),z){P.innerHTML=`<span class="cw-bc-spinner" aria-hidden="true"></span><span>${be("syncing")}</span>`;return}let y=f?Bs(f):"",d=c?y?be("updatedAgo")(y):be("updated"):be("offline");P.innerHTML=`<span class="cw-bc-sync-dot" aria-hidden="true"></span><span>${d}</span>`}async function R(){C({syncing:!0});let z=!0,c=Jt();try{let[y,d]=await Promise.all([me.fetchContentModule("broadcast"),me.fetchContentModule("bau_availability")]);if(Array.isArray(y)){let L=y.map(Ii).filter(Boolean).filter(_=>Fi(_,c));s=ie(L)}else z=!1;l=_i(d)}catch{z=!1}z&&(f=new Date().toISOString()),J(),H(),se(),C({online:z})}function J(){let z=l?l.updatedAt:null;if(!(m===null)&&!t){let y=Gt();(s.some(_=>!m.has(_.id)&&!y.includes(_.id))||z&&z!==u)&&v.playNotification()}m=new Set(s.map(y=>y.id)),u=z}function ie(z){return z.slice().sort((c,y)=>{let d=new Date(c.date).getTime()||0;return(new Date(y.date).getTime()||0)-d})}function H(){let z=document.getElementById("cw-btn-broadcast");if(!z)return;let c=Gt();if(s.some(d=>!c.includes(d.id))){if(z.classList.add("has-new"),!z.querySelector(".cw-badge")){let d=document.createElement("div");d.className="cw-badge",Object.assign(d.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),z.appendChild(d)}}else{z.classList.remove("has-new");let d=z.querySelector(".cw-badge");d&&d.remove()}}function ne(){if(!l){j.style.display="none",j.innerHTML="";return}let z=Object.keys(Fa).filter(T=>l.segments[T]);if(!z.length){j.style.display="none",j.innerHTML="";return}let c=n&&z.includes(n)?n:z.includes(Jt())?Jt():z[0],y=Fa[c],d=l.segments[c]||{},L=(T,Y)=>`
          ...
          </span>`,_=[d.attention?L("attention",d.attention):"",d.full?L("full",d.full):""].join(""),ae=z.find(T=>T!==c),p=ae?`<button class="cw-bc-bau-swap" type="button"
                     aria-label="${be("swapTo")(Fa[ae].label)}"
                     title="${be("swapTo")(Fa[ae].label)}">${Os}</button>`:"";j.style.display="flex",j.innerHTML=`
      ...
      `;let S=j.querySelector(".cw-bc-bau-swap");S&&(S.onclick=()=>{n=ae,v.playClick(),ne()})}function K(){let z={critical:0,info:0,success:0};s.forEach(d=>{z[d.type]=(z[d.type]||0)+1});let c=(d,L,_)=>`
      ...
      `,E.querySelectorAll(".cw-bc-filter").forEach(d=>{d.onclick=()=>{let L=d.dataset.tipo;i=L==="all"||L===i?null:L,v.playClick(),se()}});let y=E.querySelector('[data-tipo="all"]');y&&y.setAttribute("aria-pressed",String(i===null))}function le(){let z=Gt(),c=s.filter(d=>z.includes(d.id)).length,y=s.length-c;q.innerHTML=`
    ...
    `,!c){let T=document.createElement("button");T.type="button",T.className="cw-bc-dismiss-btn",T.setAttribute("aria-label",be("markRead")(z.title)),T.title=be("markReadShort"),T.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>',T.onclick=Y=>{Y.stopPropagation(),v.playClick(),y.style.transform="translateX(20px)",y.style.opacity="0",setTimeout(()=>{let te=Gt();te.push(z.id),Di(te),se(),H()},300)},_.appendChild(T)}let ae=document.createElement("h3");ae.className="cw-bc-msg-title",ae.id=L,ae.textContent=z.title;let p=document.createElement("div");p.className="cw-bc-msg-body",p.innerHTML=Ni(z.text);let S=document.createElement("div");return S.className="cw-bc-msg-author",S.textContent=be("publishedBy")(z.author||be("system")),y.append(_,ae,p,S),y}function re(z,c){return i&&z.type!==i?!1:c?`${z.title||""} ${z.text||""}`.toLowerCase().includes(c):!0}function W(z,c){let y=z.filter(L=>!c.includes(L.id)),d=z.filter(L=>c.includes(L.id));if(!y.length&&!(r&&d.length)){let L=o.trim().length>0||i!==null,_=document.createElement("div");_.className="cw-bc-empty",_.innerHTML=L?`<div>${be("nothingFound")}</div>`:`
               ...
               <div>${be("allRead")}</div>
              `,U.appendChild(_);return}if(y.forEach(L=>U.appendChild(Q(L,!1))),r&&d.length){let L=document.createElement("div");L.className="cw-bc-history-container",L.id="cw-bc-history",L.style.display="flex",d.forEach(_=>L.appendChild(Q(_,!0))),U.appendChild(L)}}function se(){ne(),K(),le(),U.innerHTML="";let z=Gt(),c=o.trim().toLowerCase();W(s.filter(y=>re(y,c)),z)}let I=me.getCachedContent("broadcast");Array.isArray(I)&&I.length?s=ie(I.map(Ii).filter(Boolean).filter(z=>Fi(z,Jt()))):s=ie(me.getCachedBroadcasts().map(Ps).filter(Boolean)),l=_i(me.getCachedContent("bau_availability")),se(),R(),a||(a=setInterval(R,Ms));let G=document.createElement("div");Object.assign(G.style,ct),G.className="no-drag",g.appendChild(G),dt(g,G),document.body.appendChild(g);let Z=s.some(z=>!Gt().includes(z.id));return Ae(()=>{w&&(w.textContent=be("headerTitle"));let z=g.querySelector(".cw-help-title");z&&(z.textContent=be("headerTitle"));let c=g.querySelector(".cw-help-description");c&&(c.textContent=be("headerDesc")),M.placeholder=be("searchPlaceholder"),M.setAttribute("aria-label",be("searchPlaceholder")),h.setAttribute("aria-label",be("clearSearch")),U.setAttribute("aria-label",be("headerTitle")),B.setAttribute("aria-label",be("asideLabel")),se(),C({online:!0})}),{toggle:N,hasUnread:Z}}var $i="cw-wizard-shell-styles",Ri={pt:{back:"Voltar",skip:"Pular",next:"Pr\xF3ximo",done:"Concluir",dotsGroup:"Navega\xE7\xE3o entre os slides",report:"Reportar bug ou sugest\xE3o",slideLabel:(e,t)=>`Slide ${e} de ${t}`,announce:(e,t,a,o)=>`Slide ${e} de ${t}: ${a}. ${o}`},es:{back:"Volver",skip:"Omitir",next:"Siguiente",done:"Finalizar",dotsGroup:"Navegaci\xF3n entre las diapositivas",report:"Reportar error o sugerencia",slideLabel:(e,t)=>`Diapositiva ${e} de ${t}`,announce:(e,t,a,o)=>`Diapositiva ${e} de ${t}: ${a}. ${o}`}};function Ct(e){let t=de();return Ri[t]?.[e]??Ri.pt[e]}var Bi=160,yo=320,js=()=>window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function Gs(){if(document.getElementById($i))return;let e=document.createElement("style");e.id=$i,e.textContent=`
        .cw-wiz-overlay {
            --cw-wiz-swap: ${Bi}ms;
            --cw-wiz-shell: ${yo}ms;
    ...
    `,document.head.appendChild(e)}function Qi(){Ys();let e="v2.2 Pro",t=!1,a=null,o="mx",n=JSON.parse(localStorage.getItem(Xi)||"[]"),i="",r="all",s=new Date;s.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},m={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},u=document.createElement("div");u.id="timezone-popup",u.classList.add("cw-module-window"),Object.assign(u.style,Ue,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let f={popup:u},g=ze(u,"Time Zone Traveler",e,Ce("headerDesc"),f,()=>ie());u.appendChild(g);let b=document.createElement("div");Object.assign(b.style,m.container),u.appendChild(b);let N=document.createElement("div");Object.assign(N.style,m.tabHeader);let x=document.createElement("div");x.textContent=Ce("tabLive"),x.className="tz-tab-btn",x.tabIndex=0,x.setAttribute("role","tab"),Object.assign(x.style,m.tabBtn,m.tabActive);let w=document.createElement("div");w.textContent=Ce("tabPlan"),w.className="tz-tab-btn",w.tabIndex=0,w.setAttribute("role","tab"),Object.assign(w.style,m.tabBtn),[x,w].forEach(H=>{H.addEventListener("keydown",ne=>{(ne.key==="Enter"||ne.key===" ")&&(ne.preventDefault(),H.click())})}),N.appendChild(x),N.appendChild(w),b.appendChild(N);let D=document.createElement("div");Object.assign(D.style,m.toolbar);let A=document.createElement("div");Object.assign(A.style,m.searchInputWrapper);let M=document.createElement("div");M.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(M.style,m.searchIcon);let h=document.createElement("input");h.placeholder=Ce("searchPlaceholder"),Object.assign(h.style,m.searchInput),h.onfocus=()=>{h.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",h.style.borderColor="rgba(26,115,232,0.3)"},h.onblur=()=>{h.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",h.style.borderColor="transparent"},h.oninput=H=>{i=H.target.value.toLowerCase(),P()},A.appendChild(M),A.appendChild(h),D.appendChild(A);let k=document.createElement("div");Object.assign(k.style,m.chipsRow),Ji.forEach(H=>{let ne=document.createElement("div");ne.textContent=Ce("filters")[H.id],ne.id=`tz-filter-${H.id}`,ne.className="tz-chip",ne.tabIndex=0,ne.setAttribute("role","button"),Object.assign(ne.style,m.chip),H.id===r&&Object.assign(ne.style,m.chipActive),ne.onclick=()=>{v.playClick(),r=H.id,Array.from(k.children).forEach(K=>{Object.assign(K.style,m.chip)}),Object.assign(ne.style,m.chipActive),P()},ne.addEventListener("keydown",K=>{(K.key==="Enter"||K.key===" ")&&(K.preventDefault(),ne.click())}),k.appendChild(ne)}),D.appendChild(k),b.appendChild(D);let $=document.createElement("div");Object.assign($.style,m.listContainer);let U=document.createElement("style");U.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",b.appendChild(U);let B=document.createElement("div");Object.assign(B.style,m.plannerWrapper,{display:"none"}),b.appendChild($),b.appendChild(B),x.onclick=()=>j("live"),w.onclick=()=>j("plan");function j(H){v.playClick(),H==="live"?(Object.assign(x.style,m.tabActive),Object.assign(w.style,m.tabBtn),w.style.borderBottomColor="transparent",x.setAttribute("aria-selected","true"),w.setAttribute("aria-selected","false"),$.style.display="flex",D.style.display="flex",B.style.display="none",R()):(Object.assign(w.style,m.tabActive),Object.assign(x.style,m.tabBtn),x.style.borderBottomColor="transparent",B.style.display="flex",$.style.display="none",D.style.display="none",J(),C())}function E(H){return H>=9&&H<17?{color:l.success,bg:l.successBg,label:Ce("statusOpen"),icon:"\u{1F7E2}"}:H>=8&&H<9?{color:l.warning,bg:l.warningBg,label:Ce("statusOpening"),icon:"\u{1F7E1}"}:H>=17&&H<19?{color:l.warning,bg:l.warningBg,label:Ce("statusClosing"),icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:Ce("statusClosed"),icon:"\u{1F534}"}}function q(H){n.includes(H)?n=n.filter(ne=>ne!==H):n.push(H),localStorage.setItem(Xi,JSON.stringify(n)),P(),v.playClick()}function P(){$.innerHTML="";let H=new Date,ne=Ao.filter(le=>{let O=xt(le).toLowerCase().includes(i)||Eo(le).toLowerCase().includes(i),Q=r==="all"||le.region===r;return O&&Q});if(ne.sort((le,O)=>{let Q=n.includes(le.id),re=n.includes(O.id);return Q&&!re?-1:!Q&&re?1:xt(le).localeCompare(xt(O))}),ne.length===0){$.innerHTML=`
            ...
            `;let z=I.querySelector(".cw-pin-btn");z.onclick=c=>{c.stopPropagation(),q(le.id)},z.addEventListener("keydown",c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),c.stopPropagation(),q(le.id))}),I.onclick=()=>{o=le.id,j("plan")},I.addEventListener("keydown",c=>{(c.key==="Enter"||c.key===" ")&&c.target===I&&(c.preventDefault(),I.click())}),$.appendChild(I)});let K=document.createElement("div");K.style.height="20px",K.style.width="100%",$.appendChild(K)}function C(){B.innerHTML="";let H=document.createElement("div"),ne=document.createElement("label");ne.textContent=Ce("whereIsClient"),ne.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let K=document.createElement("select");Object.assign(K.style,rn),K.style.padding="14px",[...Ao].sort((p,S)=>xt(p).localeCompare(xt(S))).forEach(p=>{let S=document.createElement("option");S.value=p.id,S.textContent=`${p.flag} ${xt(p)} (${p.zone})`,p.id===o&&(S.selected=!0),K.appendChild(S)}),K.onchange=p=>{o=p.target.value,ae(),v.playClick()},H.appendChild(ne),H.appendChild(K),B.appendChild(H);let O=document.createElement("div");Object.assign(O.style,m.timeComparisonRow);let Q=document.createElement("div");Object.assign(Q.style,m.timeCard),Q.style.backgroundColor="#F8FAFF",Q.style.borderColor="#E8F0FE",Q.innerHTML=`
    ...
    `,document.head.appendChild(e)}function ar(){let e="v2.0",t=!1,a="general",o="",n=null,i=null;Js();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,Ue,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let s={popup:r},l=ze(r,ue("headerTitle"),e,ue("headerDesc"),s,()=>se());r.appendChild(l);let m=l.querySelector("span"),u=document.createElement("div");u.className="cw-lib-container",r.appendChild(u);let f=document.createElement("div");f.className="cw-lib-toolbar";let g=document.createElement("div");g.className="cw-lib-search-wrap";let b=document.createElement("div");b.className="cw-lib-search-icon",b.innerHTML=Ge.search;let N=document.createElement("input");N.className="cw-lib-search no-drag",N.placeholder=ue("searchPlaceholder"),N.type="text";let x=document.createElement("div");x.className="cw-lib-search-clear cw-tactile",x.innerHTML=Ge.clear,g.append(b,N,x);let w=document.createElement("div");w.className="cw-lib-tabs",Co.forEach(I=>{let G=document.createElement("div");G.className="cw-lib-tab"+(I.id===a?" active":""),G.id=`lib-tab-${I.id}`,G.innerHTML=`${I.icon}<span class="js-lib-tab-label">${ue("tabs")[I.id]}</span>`,G.onmouseenter=()=>v.playHover(),G.onclick=()=>C(I.id),w.appendChild(G)}),f.append(g,w),u.appendChild(f);let D=document.createElement("div");D.className="cw-lib-grid",u.appendChild(D);let A=document.createElement("div");A.className="cw-lib-fab cw-tactile",A.title=ue("newItem"),A.innerHTML=Ge.add,A.onclick=()=>le(),u.appendChild(A);let M=document.createElement("div");M.className="cw-lib-sheet";let h=document.createElement("div");h.className="cw-lib-sheet-handle";let k=document.createElement("div");k.className="cw-lib-sheet-head";let $=document.createElement("div");$.className="cw-lib-sheet-back no-drag",$.innerHTML=Ge.back,$.title=ue("cancel"),$.onclick=O;let U=document.createElement("span");U.className="cw-lib-sheet-title",U.textContent=ue("newItemTitle"),k.append($,U);let B=document.createElement("div");B.className="cw-lib-sheet-body";let j=document.createElement("div");j.className="cw-lib-sheet-foot";let E=document.createElement("button");E.className="cw-lib-save-btn no-drag",E.textContent=ue("save"),E.onclick=Q,j.appendChild(E);let q=document.createElement("div");q.className="cw-lib-loading",q.innerHTML=`<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text js-lib-saving">${ue("saving")}</div>`,M.append(h,k,B,j,q),u.appendChild(M);let P=document.createElement("div");Object.assign(P.style,ct),P.className="no-drag",r.appendChild(P),dt(r,P),document.body.appendChild(r),document.addEventListener("mousedown",I=>{i&&!i.contains(I.target)&&R()});function C(I){v.playClick(),a=I,Co.forEach(G=>{document.getElementById(`lib-tab-${G.id}`).classList.toggle("active",G.id===I)}),H()}function R(){if(i){let I=i.querySelector(".cw-lib-menu");I&&I.classList.remove("open"),i.classList.remove("menu-open"),i=null}}function J(I,G){return G?`${I.title} ${I.content}`.toLowerCase().includes(G):!0}function ie(I){let G=document.createElement("div");G.className="cw-lib-recent-section",G.innerHTML=`<div class="cw-lib-recent-title">${ue("recentlyUsed")}</div>`;let Z=document.createElement("div");return Z.className="cw-lib-recent-row",I.forEach(z=>{let c=document.createElement("div");c.className="cw-lib-recent-chip",c.tabIndex=0,c.setAttribute("role","button"),c.title=z.title,c.innerHTML=`<span>${W(z.title)}</span>`,c.onclick=()=>{v.playClick(),K(z)},c.addEventListener("keydown",y=>{(y.key==="Enter"||y.key===" ")&&(y.preventDefault(),c.click())}),Z.appendChild(c)}),G.appendChild(Z),G}function H(){R(),D.innerHTML="";let I=o.trim().toLowerCase(),G=je.getSnippets(a).filter(Z=>J(Z,I));if(!I){let Z=Ks(a);Z.length>0&&D.appendChild(ie(Z))}if(G.length===0){let Z=document.createElement("div");Z.className="cw-lib-empty";let z=I.length>0;Z.innerHTML=`
            ...
            `,D.appendChild(Z);return}G.forEach(Z=>D.appendChild(ne(Z)))}function ne(I){let G=document.createElement("div");G.className="cw-lib-card"+(I.isCode?" is-code":"");let Z=I.content,z="";if(I.isRich){let L=document.createElement("div");L.innerHTML=I.content;let _=!!L.querySelector("img");Z=L.innerText.substring(0,200),_&&(z=`<span class="cw-lib-media-tag">${Ge.media} M\xEDdia</span>`)}let c=[I.isCode?'<span class="cw-lib-badge code">CODE</span>':"",a==="email"?'<span class="cw-lib-badge template">TEMPLATE</span>':""].join("");G.innerHTML=`
        ...
        `,G.querySelector(".cw-act-copy").onclick=L=>{L.stopPropagation(),v.playClick(),K(I)};let y=G.querySelector(".cw-act-more"),d=G.querySelector(".cw-lib-menu");return y.onclick=L=>{L.stopPropagation(),v.playClick();let _=d.classList.contains("open");R(),_||(d.classList.add("open"),G.classList.add("menu-open"),i=G)},G.querySelector(".cw-act-edit").onclick=L=>{L.stopPropagation(),v.playClick(),R(),le(I)},G.querySelector(".cw-act-del").onclick=async L=>{L.stopPropagation(),v.playClick(),R(),await De(ue("deleteConfirm")(I.title))&&(je.delete(I.id),H(),ee(ue("itemDeletedToast")))},G}function K(I){if(I.isRich){let G=new Blob([I.content],{type:"text/html"}),Z=document.createElement("div");Z.innerHTML=I.content;let z=new Blob([Z.innerText],{type:"text/plain"});navigator.clipboard.write([new ClipboardItem({"text/html":G,"text/plain":z})])}else navigator.clipboard.writeText(I.content);Xs(I.id),ee(ue("copiedToast"))}function le(I=null){n=I?I.id:null,B.innerHTML="",B.appendChild(re("title",ue("titleLabel"),I?I.title:"")),a==="email"&&B.appendChild(re("subject",ue("subjectLabel"),I?I.subject:""));let G=ue("contentLabel");a==="email"&&(G=ue("emailBodyLabel")),a==="note"&&(G=ue("noteTextLabel")),B.appendChild(re("content",G,I?I.content:"",{isRich:!0,isCode:I?I.isCode:!1})),U.textContent=ue(I?"editItemTitle":"newItemTitle"),E.textContent=ue(I?"saveChanges":"save"),M.classList.add("open"),setTimeout(()=>{let Z=B.querySelector("input");Z&&Z.focus()},500)}function O(){v.playSwoosh(),M.classList.remove("open"),setTimeout(()=>{n=null},500)}async function Q(){q.classList.add("active"),E.disabled=!0;try{let I=B.querySelector("#cw-lib-inp-title"),G=B.querySelector("#cw-lib-inp-content"),Z=I.value.trim(),z=G.contentEditable==="true"?G.innerHTML:G.value.trim(),c=G.getAttribute("data-is-code")==="true";if(!Z||!z||z==="<br>"){v.playError(),ee(ue("fillTitleAndContent"),{error:!0});return}let y={id:n,type:a,title:Z,content:z,isCode:c,isRich:G.contentEditable==="true"};if(a==="email"){let L=B.querySelector("#cw-lib-inp-subject").value.trim();if(!L){v.playError(),ee(ue("subjectRequired"),{error:!0});return}y.subject=L}let d=await je.save(y);if(d===!1){v.playError(),ee(ue("saveFailedNoUser"),{error:!0});return}H(),O(),d.synced===!1?(v.playError(),ee(ue("savedLocalOnly"),{error:!0})):(ee(ue("savedAndSynced")),v.playSuccess())}catch(I){console.error("Erro ao salvar item da biblioteca:",I),v.playError(),ee(ue("saveError"),{error:!0})}finally{q.classList.remove("active"),E.disabled=!1}}function re(I,G,Z,z={}){let c=document.createElement("div");c.className="cw-lib-field";let y=document.createElement("label");y.className="cw-lib-label",y.textContent=G,c.appendChild(y);let d;if(z.isRich){let L=document.createElement("div");L.className="cw-lib-toolbar-mini",L.innerHTML=`
    ...
    `;let o=a.querySelector(".js-sc-body"),n=a.querySelector(".js-sc-sort-toggle");n.onchange=async g=>{v.playClick(),await qe.setSortedByUsage(g.target.checked),s()};function i(g){let b=Fe[g.payload.subStatus],N=b?b.name:g.payload.subStatus,x=(g.payload.scenarios||[]).length,w=[g.payload.caseType.toUpperCase(),N,x===1?e("scOneScenario"):e("scNScenarios").replace("{n}",x)];return g.alias&&w.push(`"${g.alias}"`),w.join(" \xB7 ")}function r(g,b,N){if(g.textContent="",N){let x=document.createElement("span");x.className="cw-sc-warn",x.textContent=e("scBroken"),g.appendChild(x),g.appendChild(document.createTextNode(" \xB7 "))}g.appendChild(document.createTextNode(i(b)))}function s(){o.innerHTML="",n.checked=qe.isSortedByUsage();let g=qe.isSortedByUsage(),b=g?qe.list():qe.listRaw(),N=!g;if(!b.length){let w=document.createElement("div");w.className="cw-sc-empty",w.textContent=e("scEmpty"),o.appendChild(w)}b.forEach((w,D)=>{let A=Xn(w),M=document.createElement("div");M.className="cw-sc-item"+(A.length?" broken":""),M.dataset.id=w.id,M.dataset.index=String(D),M.innerHTML=`
            ...
            `;let h=M.querySelector(".cw-sc-label");h.textContent=w.label,h.title=w.label,r(M.querySelector(".cw-sc-meta"),w,A.length>0),M.querySelector(".js-sc-edit").onclick=()=>f(w),M.querySelector(".js-sc-del").onclick=()=>l(w),N&&m(M,D,b.length),o.appendChild(M)});let x=document.createElement("button");x.type="button",x.className="cw-sc-add",x.textContent=e("scAdd"),x.disabled=b.length>=ft,x.disabled&&(x.textContent=e("scLimit").replace("{max}",ft)),x.onclick=()=>f(null),o.appendChild(x)}async function l(g){await De(e("scDeleteConfirm").replace("{name}",g.label),{danger:!0})&&(await qe.remove(g.id),v.playClick(),s())}function m(g,b,N){let x=g.querySelector(".cw-sc-grip");g.draggable=!0;let w=!1;x.onmousedown=()=>{w=!0},g.onmouseup=()=>{w=!1},x.onkeydown=async D=>{let A=D.key==="ArrowUp"?-1:D.key==="ArrowDown"?1:0;if(!A)return;D.preventDefault();let M=b+A;if(M<0||M>=N)return;await qe.reorder(g.dataset.id,M),v.playClick(),s();let h=o.querySelector(`.cw-sc-item[data-id="${g.dataset.id}"] .cw-sc-grip`);h&&h.focus()},g.ondragstart=D=>{if(!w){D.preventDefault();return}D.dataTransfer.effectAllowed="move",D.dataTransfer.setData("text/plain",g.dataset.id),g.classList.add("dragging")},g.ondragend=()=>{g.classList.remove("dragging"),w=!1,o.querySelectorAll(".drop-target").forEach(D=>D.classList.remove("drop-target"))},g.ondragover=D=>{D.preventDefault(),g.classList.add("drop-target")},g.ondragleave=()=>g.classList.remove("drop-target"),g.ondrop=async D=>{D.preventDefault(),g.classList.remove("drop-target");let A=D.dataTransfer.getData("text/plain");!A||A===g.dataset.id||(await qe.reorder(A,Number(g.dataset.index)),v.playClick(),s())}}function u(){let g=[];for(let b in Fe){let N=Fe[b].status;N&&!g.includes(N)&&g.push(N)}return g}function f(g){let N=!!g?JSON.parse(JSON.stringify(g)):{id:ca(),kind:"note",label:"",alias:"",payload:{caseType:"bau",status:"",subStatus:"",scenarios:[]}};o.innerHTML="";let x=document.createElement("div");x.style.cssText="display: flex; flex-direction: column; gap: 14px;",x.innerHTML=`
    ...
    `}async function b(){u.style.display="flex",u.innerHTML=`
        ...
        `,(async()=>{try{Le()||await Xt();let E=Le(),q=E?E.split("@")[0]:"user",P=await Dt(q);g(q,P)}catch(E){console.warn("Erro ao renderizar perfil:",E),u.style.display="none"}})()}b();let N=document.createElement("div");if(N.className="cw-configs-section",N.innerHTML=`
    ...
    `;let M=A.querySelector("#cw-config-sound-toggle");M.onchange=E=>{v.setMuted(!E.target.checked),E.target.checked&&v.playClick()},m.appendChild(A);let h=document.createElement("div");h.className="cw-configs-section",h.innerHTML=`
        ...
        <div class="cw-configs-card">
            <div style="display:flex; flex-direction:column; gap:12px;">
                <a class="cw-configs-btn js-support-link" href="${Ot}" target="_blank" rel="noopener noreferrer"></a>
            </div>
        </div>
  ...
  `,document.head.appendChild(e)};var rr=[{value:"PT-BR",text:"Portugu\xEAs (PT-BR)"},{value:"ES",text:"Espanhol (ES)"},{value:"EN",text:"Ingl\xEAs (EN)"}],vt={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"advLastName",name:"advLastName",label:"Sobrenome do Anunciante",type:"text",placeholder:"Sobrenome do Anunciante",required:!1,isSmart:!0},{id:"advPhone",name:"advPhone",label:"Telefone do Anunciante",type:"text",placeholder:"+55 11 90000-0000",required:!1,isSmart:!0},{id:"advEmail",name:"advEmail",label:"Email do Anunciante",type:"text",placeholder:"email@exemplo.com",required:!0,isSmart:!0,validation:{regex:"^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$",error:"Formato de email inv\xE1lido"}},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"am@google.com",required:!0,isSmart:!0,validation:{regex:"^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$",error:"Informe o e-mail do AM (ex.: am@google.com)"}},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}},{id:"language",name:"language",label:"Idioma do Atendimento",type:"select",required:!0,tooltip:"Vem do seu segmento na planilha People. Troque s\xF3 quando este caso fugir da regra.",options:rr}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",i18nKey:"description_justificativa",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]},{id:"suggestDiscard",name:"suggestDiscard",label:"O caso deve ser descartado pelo TL?",type:"select",required:!1,options:[{value:"N\xE3o",text:"N\xE3o"},{value:"Sim",text:"Sim"}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",i18nKey:"language_descarte",name:"language",label:"Idioma do Atendimento",type:"select",required:!0,options:rr},{id:"seId",i18nKey:"seId_descarte",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!0,isSmart:!0,button:{id:"bau-discard-se-search",icon:"wand",title:"Buscar ID automaticamente"}},{id:"description",i18nKey:"description_descarte",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var nl={advName:{label:"Nombre del Anunciante",placeholder:"Nombre del Anunciante"},advLastName:{label:"Apellido del Anunciante",placeholder:"Apellido del Anunciante"},advPhone:{label:"Tel\xE9fono del Anunciante",placeholder:"+55 11 90000-0000"},advEmail:{label:"Email del Anunciante",placeholder:"email@ejemplo.com",error:"Formato de correo inv\xE1lido"},cid:{label:"CID",placeholder:"000-000-0000",tooltip:"Usa el formato 000-000-0000 o 10 d\xEDgitos",error:"Formato de CID incorrecto"},amName:{label:"Account Manager (AM)",placeholder:"am@google.com",error:"Informa el correo del AM (ej.: am@google.com)"},website:{label:"Website",placeholder:"https://www.ejemplo.com"},seId:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID",buttonTitle:"Buscar ID autom\xE1ticamente"},seId_descarte:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID",buttonTitle:"Buscar ID autom\xE1ticamente"},reason:{label:"Qu\xE9 debe hacerse en BAU",placeholder:"Describe las acciones esperadas..."},taskType:{label:"Tareas para BAU (Selecciona 1 o m\xE1s)",tooltip:"Selecciona los tipos de implementaci\xF3n t\xE9cnica"},nonImplementationReason:{label:"Motivo de la No Implementaci\xF3n (Justificaci\xF3n BAU)"},description_justificativa:{label:"Justificaci\xF3n / Descripci\xF3n",placeholder:"Describe detalladamente qu\xE9 se necesita hacer..."},availability:{label:"Disponibilidad (m\xEDnimo 1 opci\xF3n)"},availability_1:{label:"Opci\xF3n 1 (Prioridad)"},availability_2:{label:"Opci\xF3n 2 (Opcional)"},availability_3:{label:"Opci\xF3n 3 (Opcional)"},suggestDiscard:{label:"\xBFEl caso debe ser descartado por el TL?"},caseId:{label:"Case ID",placeholder:"Case ID"},language:{label:"Idioma de la Atenci\xF3n",tooltip:"Viene de tu segmento en la hoja People. C\xE1mbialo solo cuando este caso se salga de la regla."},language_descarte:{label:"Idioma de la Atenci\xF3n"},description_descarte:{label:"Descripci\xF3n",placeholder:"Describe el motivo del descarte..."},discardReason:{label:"Motivo del Descarte"}},il={"Selecione um motivo...":"Selecciona un motivo...","Tempo da consultoria esgotado":"Tiempo de la consultor\xEDa agotado","Solicita\xE7\xE3o de reagendamento pelo anunciante":"Solicitud de reprogramaci\xF3n por parte del anunciante","Falta de acessos ou backup do site":"Falta de accesos o copia de seguridad del sitio","Anunciante indispon\xEDvel ou n\xE3o preparado":"Anunciante no disponible o no preparado","Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)":"Implementaci\xF3n parcial (no todas las tareas completadas)","Solicita\xE7\xE3o de tarefas (tasks) adicionais":"Solicitud de tareas adicionales","Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)":"Necesidad de nuevos cambios (fase de seguimiento)","Retorno de contato ap\xF3s prazo de 14 dias expirado":"Retorno de contacto despu\xE9s de vencido el plazo de 14 d\xEDas","Caso Filho gerado no atendimento":"Caso Hijo generado en la atenci\xF3n","3\xAA Tentativa de contato sem sucesso":"3.\xBA intento de contacto sin \xE9xito","Apenas o AM presente":"Solo el AM presente","Estouro de tempo para conclus\xE3o":"Tiempo excedido para la conclusi\xF3n","Gera\xE7\xE3o de caso BAU (Reagendamento)":"Generaci\xF3n de caso BAU (Reprogramaci\xF3n)",Sim:"S\xED",N\u00E3o:"No","Portugu\xEAs (PT-BR)":"Portugu\xE9s (PT-BR)","Espanhol (ES)":"Espa\xF1ol (ES)","Ingl\xEAs (EN)":"Ingl\xE9s (EN)"};function rl(e){return e?.i18nKey||e?.id||e?.name}function Qe(e,t){let a=e?.[t];return de()!=="es"?a:nl[rl(e)]?.[t]??a}function Xe(e){return de()!=="es"?e:il[e]??e}var sl=(()=>{let e=[];for(let t=420;t<=1260;t+=30)e.push(String(Math.floor(t/60)).padStart(2,"0")+":"+String(t%60).padStart(2,"0"));return e})(),sr={pt:{statusPending:"Aguardando TL",statusApproved:"Aprovado / Criado",statusDiscarded:"Descartado pelo TL",statusCanceled:"Cancelado",statusDefault:"Pendente",timezoneWarningStrong:"Aten\xE7\xE3o:",timezoneWarningText:"Para clientes fora do fuso hor\xE1rio do Brasil, o hor\xE1rio inserido deve corresponder sempre ao hor\xE1rio local do cliente, e n\xE3o ao do agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone n\xE3o encontrado.",headerTitle:"BAU Central",headerDesc:"Dashboard de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Fluxo completo para implementa\xE7\xF5es t\xE9cnicas e suporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Fluxo simplificado para casos que n\xE3o requerem implementa\xE7\xE3o.",back:"Voltar",next:"Pr\xF3ximo",configuringEdit:"Configurando Edi\xE7\xE3o...",loadDashboardError:"Erro ao carregar Dashboard. Verifique sua conex\xE3o.",copiedToClipboard:"Copiado para a \xE1rea de transfer\xEAncia!",noAdditionalContext:"Nenhum contexto adicional fornecido pelo agente.",notCaptured:"N\xE3o capturado",none:"Nenhuma",language:"Idioma",lastName:"Sobrenome",phone:"Telefone",clientTimezone:"Fuso hor\xE1rio do cliente",echoEquivalence:(e,t,a)=>`<strong>${e}</strong> em ${t} equivale a <strong>${a}</strong> em Bras\xEDlia.`,echoSameZone:"O cliente est\xE1 no mesmo fuso que voc\xEA.",editPageWarning:"Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",onCorrectPage:"Estou na p\xE1gina correta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso criado, mas n\xE3o conseguimos confirmar por email.",unknownError:"Erro desconhecido",newBauCase:"Novo Caso BAU",backToDashboard:"Voltar ao Dashboard",confirmDataBeforeSending:"Confirme os dados antes de enviar",submitToTl:"Enviar para o TL",saveChanges:"Salvar Altera\xE7\xF5es",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Preencha os detalhes abaixo",caseSentSuccess:"Caso enviado com sucesso!",caseSentSuccessSub:"Sua solicita\xE7\xE3o foi recebida e ser\xE1 processada em breve.",genericErrorTitle:"Ops! Algo deu errado",genericErrorSub:"N\xE3o conseguimos carregar seus casos BAU no momento.",tryAgain:"Tentar Novamente",notInformed:"N\xE3o informado",reasonTooltip:"O que deve ser feito em BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Aguardando TL",caseDetailsTitle:"Detalhes do Caso",copy:"Copiar",advertiser:"Anunciante",status:"Status",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email do Anunciante",site:"Site",timezone:"Timezone",responsibleAm:"AM Respons\xE1vel",salesProgram:"Programa de Vendas",bauReason:"Motivo BAU",requestedTasks:"Tasks solicitadas",justification:"Justificativa",detailedDescription:"Descri\xE7\xE3o detalhada",availability:"Disponibilidade",urgent:"Urgente",undefinedName:"Nome indefinido",customerIdTooltip:"Customer ID do Anunciante",cidTooltip:"CID do Anunciante (Formato: 000-000-0000)",incompleteData:"Dados Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contate o Suporte",editRequest:"Editar Solicita\xE7\xE3o",edit:"Editar",refresh:"Atualizar",noRecentCases:"Nenhum caso recente",casesWillAppear:"Seus casos BAU aparecer\xE3o aqui",createdApproved:"Criados / Aprovados",refreshDashboard:"Atualizar Dashboard",rescanTitle:"Recapturar os dados desta tela",rescanDone:"Dados recapturados da tela atual.",errorPrefix:e=>`Erro: ${e}`,selectAtLeastOne:e=>`Erro: Selecione pelo menos uma op\xE7\xE3o para "${e}".`,fieldRequiredDouble:e=>`Erro: O campo "${e}" \xE9 obrigat\xF3rio.`,fieldRequiredSingle:e=>`Erro: O campo '${e}' \xE9 obrigat\xF3rio.`,whatMustBeDone:"O que deve ser feito",editTasksHint:"Para editar as tasks, volte ao Passo 2",editScheduleHint:"Para editar o agendamento, volte ao Passo 3",bauJustification:"Justificativa BAU",description:"Descri\xE7\xE3o",availabilityPriority:"Disponibilidade (Prioridade)",suggestDiscardQuestion:"O caso deve ser descartado pelo TL?",editingCaseHash:e=>`Voc\xEA est\xE1 editando o caso #${e}`,editingDiscardHash:e=>`Voc\xEA est\xE1 editando o descarte do caso #${e}`,discardReason:"Motivo do Descarte",discardDescription:"Descri\xE7\xE3o do Descarte",notInformedPlaceholder:"N\xE3o informado",caseUpdatedSuccess:"Caso atualizado com sucesso!",caseDiscardSentSuccess:"Caso enviado para descarte com sucesso!"},es:{statusPending:"Esperando al TL",statusApproved:"Aprobado / Creado",statusDiscarded:"Descartado por el TL",statusCanceled:"Cancelado",statusDefault:"Pendiente",timezoneWarningStrong:"Atenci\xF3n:",timezoneWarningText:"Para clientes fuera del huso horario de Brasil, el horario ingresado siempre debe corresponder al horario local del cliente, no al del agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone no encontrado.",headerTitle:"BAU Central",headerDesc:"Panel de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Flujo completo para implementaciones t\xE9cnicas y soporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Flujo simplificado para casos que no requieren implementaci\xF3n.",back:"Volver",next:"Siguiente",configuringEdit:"Configurando Edici\xF3n...",loadDashboardError:"Error al cargar el Panel. Verifica tu conexi\xF3n.",copiedToClipboard:"\xA1Copiado al portapapeles!",noAdditionalContext:"Ning\xFAn contexto adicional proporcionado por el agente.",notCaptured:"No capturado",none:"Ninguna",language:"Idioma",lastName:"Apellido",phone:"Tel\xE9fono",clientTimezone:"Huso horario del cliente",echoEquivalence:(e,t,a)=>`<strong>${e}</strong> en ${t} equivale a <strong>${a}</strong> en Brasilia.`,echoSameZone:"El cliente est\xE1 en el mismo huso que t\xFA.",editPageWarning:"Atenci\xF3n: Para editar la informaci\xF3n, debes tener abierta en el sistema la p\xE1gina de este Caso espec\xEDfico. De lo contrario, los datos capturados estar\xE1n incorrectos.",onCorrectPage:"Estoy en la p\xE1gina correcta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso creado, pero no pudimos confirmar por email.",unknownError:"Error desconocido",newBauCase:"Nuevo Caso BAU",backToDashboard:"Volver al Panel",confirmDataBeforeSending:"Confirma los datos antes de enviar",submitToTl:"Enviar al TL",saveChanges:"Guardar Cambios",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Completa los detalles a continuaci\xF3n",caseSentSuccess:"\xA1Caso enviado con \xE9xito!",caseSentSuccessSub:"Tu solicitud fue recibida y ser\xE1 procesada en breve.",genericErrorTitle:"\xA1Ups! Algo sali\xF3 mal",genericErrorSub:"No pudimos cargar tus casos BAU en este momento.",tryAgain:"Intentar de Nuevo",notInformed:"No informado",reasonTooltip:"Qu\xE9 debe hacerse en BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Esperando al TL",caseDetailsTitle:"Detalles del Caso",copy:"Copiar",advertiser:"Anunciante",status:"Estado",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email del Anunciante",site:"Sitio",timezone:"Timezone",responsibleAm:"AM Responsable",salesProgram:"Programa de Ventas",bauReason:"Motivo BAU",requestedTasks:"Tareas solicitadas",justification:"Justificaci\xF3n",detailedDescription:"Descripci\xF3n detallada",availability:"Disponibilidad",urgent:"Urgente",undefinedName:"Nombre indefinido",customerIdTooltip:"Customer ID del Anunciante",cidTooltip:"CID del Anunciante (Formato: 000-000-0000)",incompleteData:"Datos Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contacta al Soporte",editRequest:"Editar Solicitud",edit:"Editar",refresh:"Actualizar",noRecentCases:"Ning\xFAn caso reciente",casesWillAppear:"Tus casos BAU aparecer\xE1n aqu\xED",createdApproved:"Creados / Aprobados",refreshDashboard:"Actualizar Panel",rescanTitle:"Recapturar los datos de esta pantalla",rescanDone:"Datos recapturados de la pantalla actual.",errorPrefix:e=>`Error: ${e}`,selectAtLeastOne:e=>`Error: Selecciona al menos una opci\xF3n para "${e}".`,fieldRequiredDouble:e=>`Error: El campo "${e}" es obligatorio.`,fieldRequiredSingle:e=>`Error: El campo '${e}' es obligatorio.`,whatMustBeDone:"Qu\xE9 debe hacerse",editTasksHint:"Para editar las tareas, vuelve al Paso 2",editScheduleHint:"Para editar la programaci\xF3n, vuelve al Paso 3",bauJustification:"Justificaci\xF3n BAU",description:"Descripci\xF3n",availabilityPriority:"Disponibilidad (Prioridad)",suggestDiscardQuestion:"\xBFEl caso debe ser descartado por el TL?",editingCaseHash:e=>`Est\xE1s editando el caso #${e}`,editingDiscardHash:e=>`Est\xE1s editando el descarte del caso #${e}`,discardReason:"Motivo del Descarte",discardDescription:"Descripci\xF3n del Descarte",notInformedPlaceholder:"No informado",caseUpdatedSuccess:"\xA1Caso actualizado con \xE9xito!",caseDiscardSentSuccess:"\xA1Caso enviado a descarte con \xE9xito!"}};function F(e){let t=de();return sr[t]?.[e]??sr.pt[e]}var Ee={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function lr(e){switch(e){case"PENDING_TL_CREATION":return{text:F("statusPending"),class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:F("statusApproved"),class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:F("statusDiscarded"),class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:F("statusCanceled"),class:"status-gray",aura:""};default:return{text:e||F("statusDefault"),class:"status-gray",aura:""}}}function cr(e){let t=document.createElement("div");if(t.className="bau-dynamic-input",t.id=`wrapper-${e.id}`,e.label){let o=document.createElement("label");o.className="bau-label",o.textContent=Qe(e,"label"),e.tooltip&&o.setAttribute("data-tooltip",Qe(e,"tooltip")),t.appendChild(o)}let a;switch(e.type){case"textarea":a=document.createElement("textarea"),a.style.minHeight="80px",t.appendChild(a);break;case"select":a=document.createElement("select"),e.groups?e.groups.forEach(l=>{let m=document.createElement("optgroup");m.label=l.label,l.options.forEach(u=>{let f=document.createElement("option");f.value=u.value,f.textContent=Xe(u.text),m.appendChild(f)}),a.appendChild(m)}):e.options&&e.options.forEach(l=>{let m=document.createElement("option");m.value=l.value,m.textContent=Xe(l.text),a.appendChild(m)}),t.appendChild(a);break;case"checkbox-grid":return a=document.createElement("div"),a.className="bau-tasks-grid",e.options.forEach(l=>{let m=document.createElement("label");m.className="bau-task-item",m.innerHTML=`<input type="checkbox" name="${e.name}" value="${l}"><span>${l}</span>`,m.addEventListener("click",u=>{u.preventDefault();let f=m.querySelector("input");f.checked=!f.checked,m.classList.toggle("active",f.checked),v.playClick()}),a.appendChild(m)}),t.appendChild(a),t;case"datetime-group":a=document.createElement("div"),a.className="bau-availability-container";let o=document.createElement("div");o.className="bau-timezone-row",o.innerHTML=`
            ...
            `,i.querySelector("#bau-open-timezone").onclick=()=>{let l=document.getElementById("cw-btn-timezone");l?(l.click(),v.playClick()):(v.playError(),ee(F("timezoneModuleNotFound"),{error:!0}))},t.appendChild(a),t.appendChild(i),t;case"text-with-button":let r=document.createElement("div");r.className="bau-input-group",a=document.createElement("input"),a.type="text";let s=document.createElement("button");s.type="button",s.id=e.button.id,s.className="bau-mini-btn-input",s.title=Qe(e,"buttonTitle")||e.button.title,s.innerHTML=Ee[e.button.icon]||"",r.appendChild(a),r.appendChild(s),t.appendChild(r);break;default:a=document.createElement("input"),a.type="text",t.appendChild(a)}return a&&e.type!=="checkbox-grid"&&e.type!=="datetime-group"&&(a.id=`bau-form-${e.id}`,a.name=e.name,a.className=e.type==="select"?"bau-select":e.type==="textarea"?"bau-textarea":"bau-input",e.placeholder&&(a.placeholder=Qe(e,"placeholder")),e.required&&(a.required=!0)),t}function dr(){ir();let e=!1,t="dashboard",a=null,o=0,n="BAU",i=!1,r=null,s=vt.steps.length,l=document.createElement("div");l.id="bau-form-popup",l.className="bau-popup cw-module-window",l.style.display="none";let m=F("headerTitle"),u=F("headerDesc"),f=ze(l,m,"v2.2.0",u,{},()=>z());l.appendChild(f);let g=document.createElement("div");g.className="bau-view-container",l.appendChild(g);let b=document.createElement("div");b.id="bau-view-details",b.className="bau-details-view",g.appendChild(b);let N=document.createElement("div");N.id="bau-view-dashboard",N.className="bau-view active",N.innerHTML=`
    ...
    `,x.appendChild(w);let D=document.createElement("div");D.className="bau-content",x.appendChild(D);let A=document.createElement("div");A.className="bau-form-loading-overlay",A.innerHTML=`
        <div class="bau-spinner"></div>
        <div class="bau-loading-text js-bau-configuring-edit">${F("configuringEdit")}</div>
    `,D.appendChild(A);let M=c=>{A.classList.toggle("active",c)},h=document.createElement("div");h.className="bau-progress-indicator",D.appendChild(h);let k=document.createElement("form");k.id="bau-escalation-form",k.noValidate=!0,D.appendChild(k),vt.steps.forEach(c=>{let y=document.createElement("div");if(y.className="bau-step"+(c.id===o?" active":""),y.id=`bau-step-${c.id}`,c.isBranching)y.innerHTML=`
            ...
            `;else{let d=document.createElement("div");if(d.className="bau-card",c.id===1||c.id===5){d.innerHTML=`
                ...
                `;let L=d.querySelector(".bau-dynamic-inputs-container");c.fields.forEach(ae=>{L.appendChild(cr(ae))});let _=d.querySelector("#wrapper-cid");if(_){let ae=document.createElement("div");ae.id="bau-cid-error",ae.className="bau-cid-error-hint",ae.style.display="none",ae.textContent="Formato de CID incorreto",_.appendChild(ae)}}else c.fields.forEach(L=>{d.appendChild(cr(L))});y.appendChild(d)}k.appendChild(y)});let $=document.createElement("div");$.className="bau-footer";let U=document.createElement("button");U.type="button",U.id="bau-step-back-btn",U.className="bau-btn-secondary",U.textContent=F("back");let B=document.createElement("button");B.type="button",B.id="bau-step-next-btn",B.className="bau-btn-primary",B.textContent=F("next");let j=document.createElement("button");j.type="submit",j.className="bau-btn-submit",j.innerHTML=`${Ee.send} ${F("submitToTl")}`,j.style.display="none",$.appendChild(U),$.appendChild(B),$.appendChild(j),k.appendChild($),g.appendChild(x);let E=document.createElement("div");E.id="bau-view-success",E.className="bau-view bau-success-view",E.innerHTML=`
    ...
    `,g.appendChild(E),document.body.appendChild(l);function q(c){t=c,l.querySelectorAll(".bau-view").forEach(ae=>ae.classList.remove("active"));let y=l.querySelector(`#bau-view-${c}`);y&&y.classList.add("active");let d=f.querySelector(".cw-module-header-title")||f.querySelector("h2"),L=f.querySelector(".cw-module-header-subtitle")||f.querySelector("p");d&&(c==="form"?d.textContent=i?F("editingCase")(r):F("newBauCase"):d.textContent=F("headerTitle")),L&&(L.textContent=F(c==="form"?"fillDetailsBelow":"headerDesc"));let _=k.querySelector(".bau-btn-submit");_&&(_.innerHTML=i?`${Ee.send} ${F("saveChanges")}`:`${Ee.send} ${F("submitToTl")}`)}function P(){let c=l.querySelector("#bau-case-list-container"),y=l.querySelector("#bau-dashboard-metrics");y&&(y.innerHTML=`
        ...
        `).join(""))}async function C(){let c=l.querySelector("#bau-case-list-container"),y=l.querySelector("#bau-dashboard-metrics");if(!(!c||!y)){P();try{let d=await Do();if(!Array.isArray(d))throw new Error("API response is not a valid array");ie(d)}catch(d){console.error("Critical Error loading BAU cases:",d),y&&(y.innerHTML=""),c.innerHTML=`
            ...
            `,l.querySelector("#bau-retry-btn")?.addEventListener("click",()=>C()),v.playError(),ee(F("loadDashboardError"),{error:!0})}}}function R(c){if(!c)return;let y=lr(c.status),d=(_,ae)=>{navigator.clipboard.writeText(_).then(()=>{ee(F("copiedToClipboard")),v.playClick();let p=ae.style.color;ae.style.color="#1E8E3E",setTimeout(()=>{ae.style.color=p},800)})};b.innerHTML=`
                ...
                <div class="bau-details-grid">
                    <div class="bau-details-card">
                        <div class="bau-details-row">
                            ...
                            <button class="bau-copy-btn" title="${F("copy")}">${Ee.wand}</button>
                        </div>
                        <div class="bau-details-row">
        ...
        `}function ie(c){let y=l.querySelector("#bau-case-list-container"),d=l.querySelector("#bau-dashboard-metrics");if(!y||!d)return;let L=Array.isArray(c)?c.filter(Boolean):[];if(L.length===0){d.innerHTML=`
            ...
            `,l.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>C());return}let _=L.filter(Y=>Y.status==="PENDING_TL_CREATION").length,ae=L.filter(Y=>Y.status==="CREATED").length;d.innerHTML=`
        ...
        `;let p=d.querySelector("#bau-refresh-dashboard");p?.addEventListener("click",async()=>{p.classList.contains("spinning")||(p.classList.add("spinning"),v.playClick(),await C(),setTimeout(()=>p.classList.remove("spinning"),1e3))}),y.innerHTML="";let S=L.slice(0,5),T=L.slice(5);if(S.forEach(Y=>{let te=J(Y),oe=document.createElement("div");oe.innerHTML=te;let ce=oe.firstElementChild;ce.addEventListener("click",we=>{we.target.closest(".bau-case-edit-btn")||R(Y)});let he=ce.querySelector(".bau-case-edit-btn");he&&(he.onclick=we=>{we.stopPropagation(),G(Y)}),y.appendChild(ce)}),T.length>0){let Y=document.createElement("li");Y.className="bau-accordion-container";let te=document.createElement("button");te.className="bau-accordion-toggle",te.innerHTML=`${Ee.expand} <span>Mostrar ${T.length} casos mais antigos</span>`;let oe=document.createElement("ul");oe.className="bau-case-list bau-accordion-content",oe.style.display="none",T.forEach(ce=>{let he=J(ce),we=document.createElement("div");we.innerHTML=he;let Be=we.firstElementChild;Be.addEventListener("click",Ye=>{Ye.target.closest(".bau-case-edit-btn")||R(ce)});let _e=Be.querySelector(".bau-case-edit-btn");_e&&(_e.onclick=Ye=>{Ye.stopPropagation(),G(ce)}),oe.appendChild(Be)}),te.addEventListener("click",()=>{let ce=oe.style.display==="none";oe.style.display=ce?"block":"none",te.classList.toggle("expanded",ce),te.querySelector("span").textContent=ce?"Esconder casos mais antigos":`Mostrar ${T.length} casos mais antigos`,v.playClick()}),Y.appendChild(te),Y.appendChild(oe),y.appendChild(Y)}}function H(){let c=n==="BAU"?[1,2,3,4]:[5,4];k.querySelectorAll(".bau-step").forEach(L=>{let _=parseInt(L.id.replace("bau-step-","")),ae=_===o,p=c.includes(_)||_===0;L.classList.toggle("active",ae),L.style.display=ae?"block":"none",L.querySelectorAll("input, select, textarea").forEach(S=>{S.disabled=!p})});let y=o===0;if(h.style.display=y?"none":"flex",!y){h.innerHTML="";let L=n==="BAU"?[1,2,3,4]:[5,4];L.forEach((_,ae)=>{let p=document.createElement("div"),S=_===o,T=L.indexOf(o),Y=ae<T;p.className=`bau-progress-step ${S?"active":Y?"completed":""}`,p.textContent=ae+1,h.appendChild(p)})}let d=o===4;U.style.display=o>0?"inline-block":"none",B.style.display=!y&&!d?"inline-block":"none",j.style.display=d?"flex":"none",d&&I()}function ne(c){let y=vt.steps.find(d=>d.id===c);if(!y||!y.fields||y.isConfirmation)return!0;for(let d of y.fields){let L=k.querySelector(`#bau-step-${c} #wrapper-${d.id}`);if(!(L&&L.style.display==="none")&&d.validation){let _=k.querySelector(`#bau-step-${c} [name="${d.name}"]`);if(_&&_.offsetParent!==null&&_.value.trim())if(new RegExp(d.validation.regex).test(_.value.trim())){_.classList.remove("invalid-cid");let p=k.querySelector("#bau-cid-error");p&&(p.style.display="none")}else{console.warn(`Validation failed for field "${d.name}" in step ${c}: Regex mismatch.`),v.playError(),ee(F("errorPrefix")(Qe(d,"error")||d.validation.error),{error:!0}),_.classList.add("invalid-cid");let p=k.querySelector("#bau-cid-error");return p&&(p.style.display="flex"),!1}}}return!0}function K(c){if(!k.querySelector(`#bau-step-${c}`))return!1;let d=vt.steps.find(_=>_.id===c);if(!d||!d.fields||d.isConfirmation)return!0;let L=!0;for(let _ of d.fields){let ae=k.querySelector(`#bau-step-${c} #wrapper-${_.id}`);if(!(ae&&ae.style.display==="none")&&_.required){let p=!0,S="";if(_.type==="checkbox-grid")k.querySelector(`#bau-step-${c} input[name="${_.name}"]:checked`)||(S="No option selected in checkbox-grid",v.playError(),ee(F("selectAtLeastOne")(Qe(_,"label")),{error:!0}),p=!1);else if(_.type==="datetime-group"){let T=_.fields[0].name,Y=k.querySelector(`#bau-step-${c} input[name="${T}_date"]`),te=k.querySelector(`#bau-step-${c} select[name="${T}_time"]`);if(!Y||Y.offsetParent===null)continue;(!Y.value.trim()||!te||!te.value.trim())&&(S="Datetime group first field is empty",v.playError(),ee(F("fieldRequiredDouble")(Qe(_.fields[0],"label")),{error:!0}),p=!1)}else{let T=k.querySelector(`#bau-step-${c} [name="${_.name}"]`);if(!T||T.offsetParent===null)continue;T.value.trim()||(S="Field is empty",v.playError(),ee(F("fieldRequiredSingle")(Qe(_,"label")),{error:!0}),p=!1)}if(!p){console.warn(`Validation failed for required field "${_.name}" in step ${c}: ${S}`),L=!1;break}}}return L}B.addEventListener("click",()=>{if(ne(o)&&K(o)){n==="BAU"?o++:o===5?o=4:o++,H();let c=l.querySelector(".bau-content");c&&(c.scrollTop=0),v.playClick()}}),U.addEventListener("click",()=>{o>0&&(n==="BAU"?o--:o===4?o=5:o===5?o=0:o--,H(),v.playClick())});async function le(){let c=await et()||{};(!c.amName||c.amName==="N/A")&&(c.amName=c.internalEmail||"N/A"),a=c,k.querySelectorAll(".bau-vital-highlights").forEach(p=>{let S=[{label:"Anunciante",value:c.advName},{label:"CID",value:c.cid},{label:"Website",value:c.website||c.site},{label:"Case ID",value:c.caseId}];p.innerHTML=S.map(T=>{let Y=T.value&&T.value!=="N/A"&&T.value!=="undefined"&&T.value!=="null"?T.value:F("notCaptured");return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${T.label}</span>
                        <span class="bau-highlight-value">${Y}</span>
                    </div>
                `}).join("")+`
                <button type="button" class="bau-rescan-btn" title="${F("rescanTitle")}" aria-label="${F("rescanTitle")}">
                    ${Ee.refresh}
                </button>
            `}),vt.steps.forEach(p=>{p.fields&&p.fields.forEach(S=>{if(S.isSmart){let T=c[S.id],Y=k.querySelector(`#bau-step-${p.id} [name="${S.name}"]`),te=k.querySelector(`#bau-step-${p.id} #wrapper-${S.id}`);if(Y&&(Y.value=T&&T!=="N/A"?T:""),te){let oe=T&&T!==""&&T!=="N/A"&&T!=="undefined"&&T!=="null";te.style.display=oe?"none":"block"}}})});let d=So(c.timezone)||kt,L=k.querySelector('select[name="availabilityTimezone"]');L&&(L.value=d,W());let _=c.userProfile?.defaultLanguage;_&&k.querySelectorAll('select[name="language"]').forEach(p=>{p.value=_}),k.querySelectorAll(".bau-all-data").forEach(p=>{let S=[{label:"Anunciante",value:c.advName},{label:"CID",value:c.cid},{label:"AM",value:c.amName},{label:"SE ID",value:c.seId},{label:"Site",value:c.website||c.site},{label:"Email",value:c.email},{label:"Timezone",value:c.timezone},{label:"Case ID",value:c.caseId},{label:"Programa",value:c.salesProgram},{label:"Idioma",value:c.language}];p.innerHTML=`
            ...
            `})}l.addEventListener("click",async c=>{let y=c.target.closest(".bau-rescan-btn");if(!(!y||y.classList.contains("spinning"))){c.preventDefault(),y.classList.add("spinning"),v.playClick();try{await le(),ee(F("rescanDone"))}catch(d){console.warn("Falha ao recapturar o contexto:",d),v.playError(),ee(F("genericErrorTitle"),{error:!0})}finally{l.querySelectorAll(".bau-rescan-btn.spinning").forEach(d=>d.classList.remove("spinning"))}}}),l.addEventListener("click",c=>{let y=c.target.closest(".bau-mini-btn-input");if(!y)return;let d=y.closest(".bau-input-group")?.querySelector('input[name="seId"]');d&&(c.preventDefault(),v.playClick(),Sa(d))});let O=l.querySelector("#bau-form-cid");O&&O.addEventListener("input",()=>ne(1)),k.addEventListener("change",c=>{let y=c.target?.name||"";(y==="availabilityTimezone"||y.startsWith("availability_"))&&W()});function Q(c){let y=c.availabilityTimezone||kt;return["availability_1","availability_2","availability_3"].map(d=>{let L=c[`${d}_date`],_=c[`${d}_time`];return!L||!_?"":wo(`${L}T${_}`,y)}).filter(Boolean)}function re(c){let y=c.availabilityTimezone||kt,d=_t.find(ae=>ae.zone===y),L=Q(c);return L.length===0?F("notInformedPlaceholder"):`${L.map(ae=>{let[p,S]=ae.split("T"),[T,Y,te]=p.split("-");return`${te}/${Y} ${S.slice(0,5)}`}).join("  \xB7  ")} \u2014 ${d?d.label:y}`}function W(){let c=k.querySelector("#bau-availability-echo");if(!c)return;let y=Object.fromEntries(new FormData(k).entries()),d=y.availabilityTimezone||kt,L=y.availability_1_date,_=y.availability_1_time;if(!L||!_){c.innerHTML="";return}if(d===kt){c.textContent=F("echoSameZone");return}let ae=wo(`${L}T${_}`,d),p=new Date(ae);if(isNaN(p.getTime())){c.innerHTML="";return}let S=new Intl.DateTimeFormat("pt-BR",{timeZone:kt,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}).format(p),T=_t.find(Y=>Y.zone===d);c.innerHTML=F("echoEquivalence")(_,T?T.label:d,S)}function se(c){return(vt.steps.flatMap(d=>d.fields||[]).find(d=>d.id==="language")?.options||[]).map(d=>`<option value="${d.value}" ${d.value===c?"selected":""}>${Xe(d.text)}</option>`).join("")}function I(){let c=new FormData(k),y=Object.fromEntries(c.entries()),d=l.querySelector("#bau-confirmation-details");if(d){if(n==="BAU"){let L=c.getAll("taskType"),_=L.length>0?L.join(", "):F("none");d.innerHTML=`
                ${i?`<div class="bau-highlight-panel" style="margin-bottom: 16px; padding: 12px; border: 1px solid ${nt.yellow}; background: rgba(255, 186, 0, 0.05); border-radius: 8px; font-weight: 500;">${F("editingCaseHash")(`<span style="color: ${nt.yellow}">${r}</span>`)}</div>`:""}
                <div class="bau-confirmation-grid">
                    ...
                    <div class="bau-confirm-row">
                        ...
                        <input class="bau-confirm-value-input" data-field="advLastName" data-step="1" value="${y.advLastName||""}" placeholder="${F("notInformedPlaceholder")}">
                    </div>
                    <div class="bau-confirm-row">
                    ...
                    <div class="bau-confirm-row">
                        ...
                        <input class="bau-confirm-value-input" data-field="advPhone" data-step="1" value="${y.advPhone||""}" placeholder="${F("notInformedPlaceholder")}">
                    </div>
                    <div class="bau-confirm-row">
                    ...
                    <div class="bau-confirm-row">
                        ...
                        <input class="bau-confirm-value-input" data-field="seId" data-step="1" value="${y.seId||""}" placeholder="${F("notInformedPlaceholder")}">
                    </div>
                    <div class="bau-confirm-row">
                    ...
                    <div class="bau-confirm-row full-width">
                        ...
                        <select class="bau-confirm-value-input" data-field="nonImplementationReason" data-step="3">
                            <option value="Tempo da consultoria esgotado" ${y.nonImplementationReason==="Tempo da consultoria esgotado"?"selected":""}>${Xe("Tempo da consultoria esgotado")}</option>
                            <option value="Solicita\xE7\xE3o de reagendamento pelo anunciante" ${y.nonImplementationReason==="Solicita\xE7\xE3o de reagendamento pelo anunciante"?"selected":""}>${Xe("Solicita\xE7\xE3o de reagendamento pelo anunciante")}</option>
                            <option value="Falta de acessos ou backup do site" ${y.nonImplementationReason==="Falta de acessos ou backup do site"?"selected":""}>${Xe("Falta de acessos ou backup do site")}</option>
                            <option value="Anunciante indispon\xEDvel ou n\xE3o preparado" ${y.nonImplementationReason==="Anunciante indispon\xEDvel ou n\xE3o preparado"?"selected":""}>${Xe("Anunciante indispon\xEDvel ou n\xE3o preparado")}</option>
                            <option value="Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)" ${y.nonImplementationReason==="Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"?"selected":""}>${Xe("Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)")}</option>
                            <option value="Solicita\xE7\xE3o de tarefas (tasks) adicionais" ${y.nonImplementationReason==="Solicita\xE7\xE3o de tarefas (tasks) adicionais"?"selected":""}>${Xe("Solicita\xE7\xE3o de tarefas (tasks) adicionais")}</option>
                            <option value="Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)" ${y.nonImplementationReason==="Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"?"selected":""}>${Xe("Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)")}</option>
                            <option value="Retorno de contato ap\xF3s prazo de 14 dias expirado" ${y.nonImplementationReason==="Retorno de contato ap\xF3s prazo de 14 dias expirado"?"selected":""}>${Xe("Retorno de contato ap\xF3s prazo de 14 dias expirado")}</option>
                        </select>
                    </div>
                    <div class="bau-confirm-row full-width">
                    ...
                    <div class="bau-confirm-row full-width">
                        ...
                        <span class="bau-confirm-value-input" style="cursor: default; opacity: 0.8;" title="${F("editScheduleHint")}">${re(y)}</span>
                    </div>
                    <div class="bau-confirm-row">
                        ...
                        <select class="bau-confirm-value-input" data-field="suggestDiscard" data-step="3">
                            <option value="N\xE3o" ${y.suggestDiscard==="N\xE3o"?"selected":""}>${Xe("N\xE3o")}</option>
                            <option value="Sim" ${y.suggestDiscard==="Sim"?"selected":""}>${Xe("Sim")}</option>
                        </select>
                    </div>
                </div>
            `}else d.innerHTML=`
                ${i?`<div class="bau-highlight-panel discard-theme" style="margin-bottom: 16px; padding: 12px; border: 1px solid ${nt.red}; background: rgba(217, 48, 37, 0.05); border-radius: 8px; font-weight: 500;">${F("editingDiscardHash")(`<span style="color: ${nt.red}">${r}</span>`)}</div>`:""}
                <div class="bau-confirmation-grid">
                    <div class="bau-confirm-row">
    ...
    `,m.appendChild(u),m.onmousedown=A=>{A.target===m&&w()};let f=u.querySelector(".cw-palette-input"),g=u.querySelector(".cw-palette-list");function b(){if(g.innerHTML="",l.length===0){g.innerHTML=`<div class="cw-palette-empty">${it("empty")}</div>`;return}let A=[],M=null;l.forEach((k,$)=>{if(k.group!==M){M=k.group;let B=document.createElement("div");B.className="cw-palette-group",B.textContent=it(k.group==="shortcuts"?"groupShortcuts":"groupModules"),B.setAttribute("aria-hidden","true"),g.appendChild(B)}let U=document.createElement("div");U.className="cw-palette-item"+($===r?" selected":""),U.innerHTML=`
            ...
            `,U.onmouseenter=()=>{r=$,b()},U.onclick=()=>N($),g.appendChild(U),A.push(U)});let h=A[r];h&&h.scrollIntoView({block:"nearest"})}function N(A){let M=l[A];M&&(v.playClick(),w(),M.run())}function x(){i||(i=!0,s=n(),l=s,r=0,f.value="",b(),ke(),document.body.appendChild(m),v.playGenieOpen(),requestAnimationFrame(()=>{m.classList.add("active"),f.focus()}))}function w(){i&&(i=!1,Te(),m.classList.remove("active"),setTimeout(()=>m.remove(),200))}function D(){i?w():x()}return f.addEventListener("input",()=>{let A=t(f.value.trim());l=A?s.filter(M=>M._haystack.includes(A)):s,r=0,b()}),f.addEventListener("keydown",A=>{A.key==="ArrowDown"?(A.preventDefault(),r=Math.min(r+1,l.length-1),b()):A.key==="ArrowUp"?(A.preventDefault(),r=Math.max(r-1,0),b()):A.key==="Enter"?(A.preventDefault(),N(r)):A.key==="Escape"&&(A.preventDefault(),w())}),document.addEventListener("keydown",A=>{(A.metaKey||A.ctrlKey)&&A.key.toLowerCase()==="k"&&(A.preventDefault(),D())}),Ae(()=>{m.setAttribute("aria-label",it("ariaLabel")),f.placeholder=it("placeholder");let A=u.querySelector(".js-cp-navigate");A&&(A.innerHTML=`${He.arrowDown}${He.arrowUp} ${it("navigate")}`);let M=u.querySelector(".js-cp-select");M&&(M.innerHTML=`${He.enter} ${it("select")}`);let h=u.querySelector(".js-cp-close");h&&(h.textContent=it("close")),b()}),{open:x,close:w,toggle:D}}function cl(){if(window.techSolInitialized){Za();return}window.techSolInitialized=!0;let e="v6.3.3";console.log(`\u{1F680} TechSol Suite Initializing (${e})...`);try{on();try{v.initGlobalListeners()}catch(g){console.warn("\xC1udio bloqueado:",g)}me.fetchContentModules(["tips","broadcast","bau_availability","links","call_script","email_template","note_template","task_screenshots"]);let t=Za(),a=ci(),o=fi(),n=Si(),i=qi(),r=Qi(),s=ar(),l=nr(),m=dr(),u=zi(),f={toggleNotes:a,toggleEmail:o,toggleScript:n,toggleLinks:i,toggleTimezone:r,toggleLibrary:s,toggleConfigs:l,toggleBAUForm:m,broadcastControl:u};Rn(f,t),ur(f),setTimeout(()=>{me.logEvent("App","Start","Session Start");let g=Le();mt.sync(),(g?Dt(g.split("@")[0]).then(N=>{N&&(Qo(N),Xo(N))}).catch(N=>console.warn("N\xE3o foi poss\xEDvel resolver o idioma do perfil:",N)):Promise.resolve()).finally(()=>{Hi(),setTimeout(()=>{Vi(e)},500)})},2500)}catch(t){console.error("Erro fatal na inicializa\xE7\xE3o:",t),v.playError(),ee("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}cl();})();
