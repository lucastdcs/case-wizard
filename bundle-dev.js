...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ct={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Gt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var jt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Le=t=>new Promise(e=>setTimeout(e,t));async function Yo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Le(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let r=Math.floor(Math.random()*60)+30;a===0&&(r=150),a>e.length-3&&(r=30),await Le(r)}await Le(600),o&&(o.style.display="none")}async function Et(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Le(200);let e=await Rt(),o=zt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),r=t.querySelector("#p3"),s=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),r&&(r.textContent=o.suffix),await Le(300);let c=a?a.querySelector("svg"):null;if(c&&(c.style.opacity="1",c.style.transform="scale(1)"),await Le(400),n&&(n.style.opacity="1"),j.playStartup(),i&&await Yo(i,o.name),r&&(r.style.opacity="1",r.style.transform="translateY(0)"),o.isFriday&&s){await Le(400),s.style.display="block",s.offsetWidth;let l=s.querySelector(".sextou-badge");l&&(l.style.opacity="1",l.style.transform="scale(1)")}await Le(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Le(900),t.parentNode&&t.parentNode.removeChild(t)}}function Ut(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,r=a-e.height-n,s=parseFloat(t.style.left)||e.left,c=parseFloat(t.style.top)||e.top,l=Math.max(n,Math.min(s,i)),d=Math.max(n,Math.min(c,r));if(l!==s||d!==c){let p=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${l}px`,t.style.top=`${d}px`,setTimeout(()=>{t.style.transition=p},300)}}var Ae={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Te(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,r=a.clientY,s=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),c=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),l=i,d=r,p=!1;function x(m){l=m.clientX,d=m.clientY,p||(window.requestAnimationFrame(()=>{f(),p=!1}),p=!0)}function f(){let m=s+(l-i),y=c+(d-r);m>360&&(t.style.width=m+"px"),y>300&&(t.style.height=y+"px")}function g(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",g),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",g)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Vt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Wt(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Yt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function xe(t,e={}){return new Promise(o=>{let a=Wt(),n=Yt(),i=e.danger?"#FF3B30":"#007AFF",r=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let s=d=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(d)},300)},c=n.querySelector("#cw-conf-cancel"),l=n.querySelector("#cw-conf-ok");[c,l].forEach(d=>d.onmouseenter=()=>j.playHover()),c.onclick=()=>{j.playClick(),s(!1)},l.onclick=()=>{j.playClick(),s(!0)}})}function Xt(t,e=""){return new Promise(o=>{let a=Wt(),n=Yt();n.innerHTML=`
...
Irei solicitar descarte do mesmo, levando em conta a falta de acessos e solicita\xE7\xE3o de reagendamento do mesmo.`}};var Ge=t=>new Promise(e=>setTimeout(e,t));function Ke(t){t&&["mousedown","mouseup","click"].forEach(e=>t.dispatchEvent(new MouseEvent(e,{bubbles:!0,cancelable:!0,view:window})))}var Zt="cw-automation-styles";if(!document.getElementById(Zt)){let t=document.createElement("style");t.id=Zt,t.innerHTML=`
    ...
    `,document.head.appendChild(t)}function Qt(t){let e=document.getElementById("cw-loading-overlay");t?e?e.style.opacity="1":(e=document.createElement("div"),e.id="cw-loading-overlay",document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1")):e&&(e.style.opacity="0",setTimeout(()=>e.remove(),300))}async function Je(t){console.log("\u{1F680} Iniciando extra\xE7\xE3o autom\xE1tica...");let e=document.getElementById(t),o="";Qt(!0),e&&(o=e.placeholder,e.placeholder="Buscando ID...",e.value="",e.classList.add("cw-scanning-active"));try{let a=document.querySelector('material-button[debug-id="dock-item-case-log"]');a&&!a.classList.contains("selected")&&(Ke(a),await Ge(1200));let n=document.querySelector("search-filter dropdown-button .button");if(n&&!(n.innerText||"").includes("All")){Ke(n),await Ge(600);let x=document.querySelector('material-checkbox[debug-id="check-all-box"]');x&&x.getAttribute("aria-checked")!=="true"&&(Ke(x),await Ge(300));let f=document.querySelector('material-button[debug-id="apply-filter"]');f&&(Ke(f),await Ge(1500))}let i=document.querySelector(".scroll-container")||document.querySelector(".case-log-container");i&&(i.scrollTop=i.scrollHeight,await Ge(500));let r=Array.from(document.querySelectorAll(".message-header"));for(let p=r.length-1;p>=0;p--){let x=r[p],f=x.querySelector("i.material-icons-extended"),g=f&&f.innerText.trim()==="phone_in_talk",m=x.innerText||"",y=m.includes("Agent joined")||m.includes("outbound-call")||m.includes("Speakeasy");if(g||y){x.getAttribute("aria-expanded")==="true"||(console.log("\u{1F4C2} Expandindo mensagem de chamada...",x),e&&(e.placeholder="Lendo mensagem..."),Ke(x),await Ge(1e3));break}}let c=Array.from(document.querySelectorAll(".preview, .speakeasy-agent-activity, .message-body, .content-container")),l=/Speakeasy.*?(P\d{15,25})/i,d=null;for(let p=c.length-1;p>=0;p--){let x=c[p];if(x.offsetParent===null)continue;let f=(x.innerText||"").match(l);if(f&&f[1]){d=f[1];break}}if(e)if(d){try{await navigator.clipboard.writeText(d)}catch{}e.tagName==="INPUT"||e.tagName==="TEXTAREA"?e.value=d:e.textContent=d,e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),j.playSuccess(),X(`ID Localizado: ${d}`),e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(15, 157, 88, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}else j.playError(),X("Nenhum ID encontrado.",{error:!0}),e.placeholder="N\xE3o encontrado",e.style.transition="background-color 0.3s",e.style.backgroundColor="rgba(234, 67, 53, 0.1)",setTimeout(()=>e.style.backgroundColor="",1e3)}catch(a){console.error("Erro na automa\xE7\xE3o:",a),X("Erro ao processar.",{error:!0})}finally{e&&(e.classList.remove("cw-scanning-active"),e.value||(e.placeholder=o)),Qt(!1)}}function eo(t){t.dataset.bulletEnabled!=="true"&&(t.dataset.bulletEnabled="true",(t.value.trim()===""||t.value.trim()==="\u2022")&&(t.value="\u2022 "),t.addEventListener("keydown",function(e){let o=this.selectionStart,a=this.selectionEnd,n=this.value,i=n.lastIndexOf(`
...
`+s;this.value=n.substring(0,o)+c+n.substring(a),this.selectionStart=this.selectionEnd=o+c.length}else if(e.key==="Tab")e.preventDefault(),e.shiftKey?r.startsWith("  ")&&(this.value=n.substring(0,i)+r.substring(2)+n.substring(o),this.selectionStart=this.selectionEnd=o-2):(this.value=n.substring(0,i)+"  "+r+n.substring(o),this.selectionStart=this.selectionEnd=o+2);else if(e.key==="Backspace"&&o===a&&o>0){let s=n.substring(0,o);s.endsWith("\u2022 ")?(e.preventDefault(),this.value=s.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2):s.endsWith("  ")&&r.trim().startsWith("\u2022")&&(e.preventDefault(),this.value=s.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2)}}))}function Tt(t,e,o){if(e.innerHTML="",!!ke[t]&&(o.activeFields.forEach(n=>{if(["TAGS_IMPLEMENTED","SCREENSHOTS_LIST","CONSENTIU_GRAVACAO","CASO_PORTUGAL","label_substatus"].includes(n))return;let i=`field-${n}`,r=document.createElement("label"),s=p=>Se[o.currentLang]?.[p]||Se.pt?.[p]||p;r.textContent=s(n.toLowerCase())!==n.toLowerCase()?s(n.toLowerCase()):n.replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase())+":",Object.assign(r.style,{display:"flex",alignItems:"center",justifyContent:"space-between",fontSize:"13px",fontWeight:"700",color:H.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let c=document.createElement("span");if(c.textContent=r.textContent,r.innerHTML="",r.appendChild(c),n==="SPEAKEASY_ID"){let p=document.createElement("button");p.innerHTML="\u2728 Auto Busca",p.style.cssText=`font-size: 11px; font-weight: 700; color: ${H.primary}; background-color: ${H.primaryBg}; border: none; border-radius: ${de.pill}; padding: 6px 14px; margin-left: 10px; cursor: pointer; transition: all 0.2s ${se};`,p.onmouseenter=()=>p.style.backgroundColor="#d2e3fc",p.onmouseleave=()=>p.style.backgroundColor=H.primaryBg,p.onclick=x=>{x.preventDefault(),Je(i)},r.appendChild(p)}let l=document.createElement("button");l.innerHTML="\u2715",l.style.cssText=`font-size: 14px; background: ${H.bgInput}; border: none; color: ${H.textSub}; cursor: pointer; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-left: auto; transition: all 0.2s ${se};`,l.onmouseenter=()=>{l.style.background=H.error,l.style.color=H.surface},l.onmouseleave=()=>{l.style.background=H.bgInput,l.style.color=H.textSub},l.onclick=async p=>{p.preventDefault(),await xe(`Tem certeza que deseja remover o campo "${c.textContent.replace(":","")}"?`)&&(o.removeField(n),Tt(t,e,o))},r.appendChild(l);let d;He.includes(n)?(d=document.createElement("textarea"),d.classList.add("bullet-textarea","cw-textarea"),d.placeholder="Utilize marcadores para detalhar...",eo(d)):st.includes(n)?(d=document.createElement("textarea"),d.classList.add("cw-textarea"),d.placeholder="Descreva as considera\xE7\xF5es..."):(d=document.createElement("input"),d.type="text",d.classList.add("cw-input")),d.id=i,d.value=o.formData[i]||"",d.addEventListener("input",p=>o.updateField(i,p.target.value)),e.appendChild(r),e.appendChild(d)}),o.activeFields.includes("CONSENTIU_GRAVACAO"))){let n=s=>Se[o.currentLang]?.[s]||Se.pt?.[s]||s,i=document.createElement("label");i.textContent=n("consentiu_gravacao"),Object.assign(i.style,{display:"block",fontSize:"13px",fontWeight:"700",color:H.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let r=document.createElement("select");r.className="cw-select",r.innerHTML=`
            <option value="false">${n("nao")}</option>
            <option value="true">${n("sim")}</option>
        `,r.value=o.consent?"true":"false",r.onchange=()=>o.setConsent(r.value==="true"),e.appendChild(i),e.appendChild(r)}}function kt(t,e,o){let a=t.currentSubStatus;if(!a)return null;let n=ke[a],i=Se[t.currentLang]||Se.pt,r=l=>i[l]||Se.pt?.[l]||l,s='style="margin-bottom: 12px; padding-left: 30px;"',c="";if(t.activeFields.forEach(l=>{let d=r(l.toLowerCase()),p="N/A";if(l==="label_substatus")d=r("label_substatus"),p=n.name;else if(l==="TAGS_IMPLEMENTED"){d=r("tags_implemented");let x=[];e.getCheckedElements().forEach(g=>{let m=g.value,y=Ce[m],E=g.count||1,P=m==="ads_conversion_tracking"||m==="ads_enhanced_conversions";t.tagSupportUsed&&P&&!t.forcedScreenshots.has(m)?x.push(`${y.name} - ${r("ts_output_disclaimer")}`):x.push(E>1?`${y.name} (x${E})`:y.name)}),p=x.join(", ")||"N/A"}else if(l==="SCREENSHOTS_LIST"){d=r("screenshots_list");let x="",f=e.screenshotsElement;f&&Array.from(f.querySelectorAll('input[id^="name-"]')).forEach(m=>{let y=m.value,E=m.closest(".cw-screen-card");if(E){let P=E.querySelectorAll('input[id^="screen-"]'),$=!1,B="";P.forEach(K=>{let M=K.closest(".cw-input-group")?.querySelector(".cw-input-label")?.textContent||"Evid\xEAncia",F=K.value.trim();F&&(B+=`<li>${M} - ${F}</li>`,$=!0)}),$&&(x+=`<div style="margin-bottom: 8px;"><b>${y}</b><ul ${s}>${B}</ul></div>`)}}),p=x||"N/A"}else if(l==="CASO_PORTUGAL")d=r("caso_portugal"),p=r("sim");else if(l==="CONSENTIU_GRAVACAO")d=r("consentiu_gravacao"),p=t.consent?r("sim"):r("nao");else{let x=`field-${l}`,f=t.formData[x],g="";if(n.fieldPrefixes&&n.fieldPrefixes[l]&&(g=n.fieldPrefixes[l]+" "),f&&f.trim()!==""&&f.trim()!=="\u2022"){let m=f.trim();if(He.includes(l)){let y=m.split(`
`).map(E=>E.trim()).filter(E=>E!==""&&E!=="\u2022").map(E=>E.startsWith("\u2022 ")?E.substring(2):E).map(E=>`<li>${E}</li>`).join("");p=y?`${g}<ul ${s}>${y}</ul>`:"N/A"}else st.includes(l)?p=g+m.split(`
`).filter(y=>y.trim()!=="").map(y=>`<p style="margin: 0 0 8px 0;">${y}</p>`).join(""):p=g+m}else g&&(p=g.trim())}c+=`<b>${d}</b><br>${p}<br><br>`}),n.customFooter&&(c+=`${n.customFooter}<br><br>`),o?.getOutput){let l=o.getOutput();l&&(c+=`${l}<br><br>`)}return c+="<i>Nota criada atrav\xE9s do Cases Wizard.</i>",c.replace(/(<br>\s*){3,}/g,"<br><br>").trim()}function to(t){let e=document.createElement("div");e.className="cw-step-scenarios";let o="Passe o mouse sobre um cen\xE1rio para visualizar o texto...",a=document.createElement("div");Object.assign(a.style,{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"12px"});let n=document.createElement("div");Object.assign(n.style,{padding:"12px",background:"#f8f9fa",border:"1px dashed #dadce0",borderRadius:"8px",fontSize:"12px",color:"#5f6368",lineHeight:"1.5",minHeight:"44px",display:"flex",alignItems:"center",fontStyle:"italic",transition:"all 0.2s cubic-bezier(0.4, 0, 0.2, 1)",overflow:"hidden"});let i=document.createElement("span");i.style.transition="opacity 0.2s ease, transform 0.2s ease",i.textContent=o,n.appendChild(i);let r=new Set,s=null;return e.render=(c,l)=>{r.clear();let d=Object.entries(lt).filter(([p,x])=>{let f=!x.type||x.type==="all"||x.type===l,g=!1;return c.startsWith("NI_")?g=p.includes("-ni-")||p.includes("attempted"):c.startsWith("SO_")?g=p.includes("gtm")||p.includes("whatsapp")||p.includes("form")||p.includes("ecw4")||p.includes("ga4")||p.includes("-so-"):c.startsWith("AS_")?g=p.includes("-as-"):c.startsWith("IN_")?g=p.includes("-in-"):c.startsWith("DC_")&&(g=p.includes("-dc-")),f&&g});a.innerHTML="",d.forEach(([p,x])=>{let f=document.createElement("div"),g=p.replace("quickfill-","").replace(/-/g," ");f.textContent=g,f.dataset.id=p,Object.assign(f.style,{padding:"6px 12px",borderRadius:"16px",border:"1px solid #dadce0",background:"#ffffff",fontSize:"13px",color:"#3c4043",cursor:"pointer",userSelect:"none",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)"});let m=x["field-REASON_COMMENTS"]||x["field-CONTEXTO_CALL"]||p;f.onmouseenter=()=>{s&&clearTimeout(s),r.has(p)||(f.style.background="#f1f3f4"),i.style.opacity="0",i.style.transform="translateY(5px)",s=setTimeout(()=>{i.textContent=m.substring(0,120)+(m.length>120?"...":""),i.style.opacity="1",i.style.transform="translateY(0)"},50)},f.onmouseleave=()=>{s&&clearTimeout(s),r.has(p)||(f.style.background="#ffffff"),s=setTimeout(()=>{r.size===0&&(i.style.opacity="0",setTimeout(()=>{i.textContent=o,i.style.opacity="1"},50))},100)},f.onclick=()=>{j.playClick();let y=!r.has(p);y?(r.add(p),f.style.background="#e8f0fe",f.style.borderColor="#1a73e8",f.style.color="#1967d2"):(r.delete(p),f.style.background="#ffffff",f.style.borderColor="#dadce0",f.style.color="#3c4043"),t(p,y)},a.appendChild(f)}),d.length===0?e.style.display="none":e.style.display="block"},e.appendChild(a),e.appendChild(n),e}var ae={bg:H.bgInput,white:H.surface,border:H.border,textMain:H.text,textSub:H.textSub,blue:H.blue,blueLight:H.primaryBg,brands:{ads:{id:"ads",label:"Google Ads",color:H.blue,bg:H.primaryBg,icon:"ads"},ga4:{id:"ga4",label:"Google Analytics 4",color:H.yellow,bg:"#FEF7E0",icon:"ga4"},gtm:{id:"gtm",label:"Tag Manager",color:H.primary,bg:H.primaryBg,icon:"gtm"},gmc:{id:"gmc",label:"Merchant Center",color:H.green,bg:"#E6F4EA",icon:"gmc"},default:{id:"gen",label:"Geral",color:"#5F6368",bg:"#F3F4F6",icon:"default"}},shadowCard:"0 1px 2px rgba(0,0,0,0.05)",shadowFloat:"0 -4px 20px rgba(0,0,0,0.08)",font:"'Google Sans', -apple-system, Roboto, sans-serif"},ze={ads:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M38.85 144.47l-26.27-26.28a12.72 12.72 0 0 1 0-17.92L106 5.86a12.72 12.72 0 0 1 17.92 0l26.28 26.27a12.72 12.72 0 0 1 0 17.92l-93.43 94.42a12.73 12.73 0 0 1-17.92 0z"/><path fill="#1A73E8" d="M165.73 100.27l-26.28-26.28a12.72 12.72 0 0 0-17.92 0L28.1 167.42a12.72 12.72 0 0 0 0 17.92l26.28 26.28a12.72 12.72 0 0 0 17.92 0l93.43-93.43a12.72 12.72 0 0 0 0-17.92z"/><path fill="#34A853" d="M38.85 144.47a12.63 12.63 0 0 1 0-17.92l54.58-54.58a12.72 12.72 0 0 1 17.92 0l-54.58 54.58 37.07 37.07a12.72 12.72 0 0 1 0 17.92l-37.07-37.07z"/></svg>',ga4:'<svg viewBox="0 0 192 192"><path fill="#F9AB00" d="M22 138v28h28v-28H22z"/><path fill="#E37400" d="M66 84v82h28V84H66z"/><path fill="#E37400" d="M110 22v144h28V22h-28z"/></svg>',gtm:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M40 32h112c4.42 0 8 3.58 8 8v112c0 4.42-3.58 8-8 8H40c-4.42 0-8-3.58-8-8V40c0-4.42 3.58-8 8-8z"/><path fill="#8AB4F8" d="M136 76h-20v-20h-40v20H56v40h20v20h40v-20h20V76z"/><circle cx="96" cy="96" r="24" fill="#1967D2"/></svg>',gmc:'<svg viewBox="0 0 192 192"><path fill="#4285F4" d="M22 66l18-36h112l18 36v100H22V66z"/><path fill="#1967D2" d="M152 30H40L22 66h148l-18-36z"/><path fill="#8AB4F8" d="M40 30h112v36H40z"/></svg>',default:'<svg viewBox="0 0 24 24"><path fill="#5F6368" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>'};function oo(t,e,o){let a={},n="implementation";o&&o.subscribe(()=>{K(),Z()});function i(M){let F=M.toLowerCase();return F.includes("ads")||F.includes("conversion")||F.includes("remarketing")?ae.brands.ads:F.includes("ga4")||F.includes("analytics")?ae.brands.ga4:F.includes("gtm")||F.includes("tag manager")||F.includes("container")?ae.brands.gtm:F.includes("merchant")||F.includes("shopping")||F.includes("feed")?ae.brands.gmc:ae.brands.default}let r=Object.entries(Ce).filter(([M,F])=>F.popular),s={};Object.entries(Ce).forEach(([M,F])=>{if(F.popular)return;let G=i(F.name);s[G.label]||(s[G.label]={brand:G,tasks:[]}),s[G.label].tasks.push({key:M,...F})});let c="cw-zen-tasks";if(!document.getElementById(c)){let M=document.createElement("style");M.id=c,M.innerHTML=`
            .cw-zen-container {
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(M)}let l=document.createElement("div");l.className="cw-zen-container";let d=document.createElement("div");Object.assign(d.style,{display:"none"});let p=document.createElement("div");p.className="cw-screens-container",d.appendChild(p),l.innerHTML=`
    ...
    `;let x=l.querySelector(".cw-hero-grid"),f=l.querySelector(".cw-acc-container"),g=l.querySelector(".cw-results-container"),m=l.querySelector(".cw-search-input"),y=l.querySelector(".cw-status-bar"),E=l.querySelector(".cw-status-text"),P=l.querySelector(".cw-footer-icons");r.forEach(([M,F])=>{let G=i(F.name),V=document.createElement("div");V.className="cw-hero-card",V.id=`hero-${M}`,V.style.setProperty("--hero-color",G.color),V.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${ze[G.icon]}</div>
        ...
        `,V.onclick=q=>{if(q.target.closest(".cw-step-btn"))return;let k=a[M]?a[M].count:0;B(M,k>0?-k:1,F)},V.querySelector(".minus").onclick=()=>B(M,-1,F),V.querySelector(".plus").onclick=()=>B(M,1,F),V.dataset.color=G.color,x.appendChild(V)});function $(M,F){let G=i(F.name),V=document.createElement("div");return V.className="cw-task-item",V.dataset.id=M,V.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${G.bg}; color:${G.color}">
                    ${ze[G.icon]||ze.default}
                </div>
        ...
        `,V.onclick=q=>{if(q.target.closest(".cw-step-btn"))return;let k=a[M]?a[M].count:0;B(M,k>0?-k:1,F)},V.querySelector(".minus").onclick=()=>B(M,-1,F),V.querySelector(".plus").onclick=()=>B(M,1,F),V}Object.entries(s).forEach(([M,F])=>{let G=document.createElement("div");G.className="cw-acc-group";let V=document.createElement("div");V.className="cw-acc-header",V.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${F.brand.color}"></div>
                ${M}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,V.onclick=()=>{f.querySelectorAll(".cw-acc-group.open").forEach(k=>{k!==G&&k.classList.remove("open")}),G.classList.toggle("open")};let q=document.createElement("div");q.className="cw-acc-body",F.tasks.forEach(k=>{let S=$(k.key,k);q.appendChild(S)}),G.appendChild(V),G.appendChild(q),f.appendChild(G)});function B(M,F,G){a[M]||(a[M]={count:0,data:G,brand:i(G.name)}),a[M].count+=F,a[M].count<=0&&delete a[M],K(),Z(),t&&t()}function K(){let M=o.tagSupportUsed;r.forEach(([k])=>{let S=x.querySelector(`#hero-${k}`);if(!S)return;let T=a[k];T?(S.classList.add("active"),S.querySelector(".cw-step-val").textContent=T.count,S.querySelector(".cw-step-val").style.color=S.dataset.color,M&&(k==="ads_conversion_tracking"||k==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(k)?S.classList.add("ts-success"):S.classList.remove("ts-success")):(S.classList.remove("active"),S.classList.remove("ts-success"))}),l.querySelectorAll(".cw-task-item").forEach(k=>{let S=k.dataset.id,T=a[S];T?(k.classList.add("selected"),k.querySelector(".cw-step-val").textContent=T.count,M&&(S==="ads_conversion_tracking"||S==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(S)?k.classList.add("ts-success"):k.classList.remove("ts-success")):(k.classList.remove("selected"),k.classList.remove("ts-success"))});let G=Object.keys(a),V=0,q=[];if(G.forEach(k=>{let S=a[k];V+=S.count;for(let T=0;T<S.count;T++)q.length<6&&q.push(S.brand)}),V>0){y.classList.add("visible");let k=V>1?"A\xE7\xF5es":"A\xE7\xE3o",S=V>1?"definidas":"definida";E.textContent=`${V} ${k} ${S}`,P.innerHTML="",q.forEach(T=>{let b=document.createElement("div");b.className="cw-mini-icon",b.innerHTML=ze[T.icon]||ze.default;let A=b.querySelector("svg");A&&(A.style.width="14px",A.style.height="14px"),P.appendChild(b)})}else y.classList.remove("visible")}m.addEventListener("input",M=>{let F=M.target.value.toLowerCase();if(F.length>0){f.style.display="none",g.style.display="block",g.innerHTML="";let G=!1;Object.entries(Ce).forEach(([V,q])=>{if(q.name.toLowerCase().includes(F)){G=!0;let k=$(V,q);a[V]&&(k.classList.add("selected"),k.querySelector(".cw-step-val").textContent=a[V].count),g.appendChild(k)}}),G||(g.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else f.style.display="block",g.style.display="none"});function Z(){p.innerHTML="";let M=Object.keys(a),F=!1;if(M.length===0){p.innerHTML=`<div class="cw-empty-state">${e("selecione_tarefas")}</div>`,d.style.display="none";return}let G=o.tagSupportUsed,V=document.createElement("div");V.className="cw-info-banner",V.innerHTML=`
            <span style="font-size:14px">\u2139\uFE0F</span>
            <span>
                Os screenshots seguem as diretrizes atuais do Win Criteria e pol\xEDticas de Tag Support.
            </span>
        `,p.appendChild(V),M.forEach(q=>{let k=a[q].data,S=a[q].count,T=a[q].brand,A=G&&(q==="ads_conversion_tracking"||q==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(q),O=o.screenshotMode||"implementation",_=k.screenshots?.[O]||[];if(_.length>0||A){F=!0;for(let D=1;D<=S;D++){let C=document.createElement("div");C.className="cw-screen-card",A&&C.classList.add("ts-success"),C.style.setProperty("--brand-color",T.color),C.style.setProperty("--brand-bg",T.bg),C.style.setProperty("--brand-shadow",T.color+"40");let I=document.createElement("div");I.className="cw-card-header";let h=document.createElement("div");h.className="cw-card-icon",h.innerHTML=ze[T.icon]||ze.default;let N=document.createElement("div");N.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let Y=document.createElement("input");Y.className="cw-card-title-input",Y.id=`name-${q}-${D}`,Y.value=`${k.name}${S>1?" #"+D:""}`,Y.title="Clique para renomear esta task";let z=document.createElement("span");if(z.className="cw-edit-hint",z.innerHTML="\u270E Renomear",N.appendChild(Y),N.appendChild(z),I.appendChild(h),I.appendChild(N),C.appendChild(I),A){let u=document.createElement("div");u.className="cw-ts-disclaimer-box",u.innerHTML=`
                <span>${e("ts_disclaimer")}</span>
                <button class="cw-btn-ts-force">${e("incluir_mesmo_assim")}</button>
            `,u.querySelector("button").onclick=()=>{o.toggleForcedScreenshot(q,!0)},C.appendChild(u)}else _.forEach((u,v)=>{let w=document.createElement("div");w.className="cw-input-group";let L=document.createElement("label");L.className="cw-input-label",L.textContent=u;let R=document.createElement("input");R.className="cw-input-field",R.id=`screen-${q}-${D}-${v}`,R.placeholder="Cole o link aqui...",R.setAttribute("autocomplete","off"),R.addEventListener("input",()=>{R.value.trim().length>5?R.classList.add("filled"):R.classList.remove("filled")});let J=document.createElement("div");J.className="cw-input-check",J.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',w.appendChild(L),w.appendChild(R),w.appendChild(J),C.appendChild(w)});p.appendChild(C)}}}),d.style.display=F?"block":"none"}return{selectionElement:l,screenshotsElement:d,updateSubStatus:()=>Z(),getCheckedElements:()=>Object.keys(a).map(M=>({value:M,count:a[M].count})),setTaskCount:(M,F)=>{a[M]&&delete a[M],F>0&&Ce[M]&&B(M,F,Ce[M])},toggleTask:(M,F=!0)=>{let G=a[M];F&&!G?B(M,1,Ce[M]):!F&&G&&B(M,-G.count,Ce[M])},setLanguage:M=>{e=M;let F=l.querySelector(".js-hero-title");F&&(F.textContent=e("acesso_rapido"));let G=l.querySelector(".cw-search-input");G&&(G.placeholder=e("buscar_catalogo")),Z()},reset:()=>{for(let M in a)delete a[M];m.value="",f.style.display="block",g.style.display="none",K(),Z()}}}var Qo={marginTop:"24px",marginBottom:"16px",padding:"20px",background:"#fff9e6",borderRadius:"20px",border:"1.5px solid #fbbc0540",display:"none",boxShadow:"0 4px 12px rgba(251, 188, 5, 0.05)"},ea={fontSize:"12px",color:"#b06000",marginTop:"8px",lineHeight:"1.4"},ta={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1.5px solid #dadce0",fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",background:"#fff"},oa={display:"flex",gap:"20px",marginBottom:"12px"};function ao(t){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Qo);let o=document.createElement("label");o.className="js-ts-main-label",o.textContent=t("utilizou_tag_support"),Object.assign(o.style,Ct,{marginTop:"0"});let a=document.createElement("div");Object.assign(a.style,oa);let n=document.createElement("input");n.type="radio",n.name="ts_usage_mod",n.value="Sim",Object.assign(n.style,At);let i=document.createElement("label");i.textContent="Sim";let r=document.createElement("div");Object.assign(r.style,{display:"flex",alignItems:"center"}),r.appendChild(n),r.appendChild(i);let s=document.createElement("input");s.type="radio",s.name="ts_usage_mod",s.value="N\xE3o",s.checked=!0,Object.assign(s.style,At);let c=document.createElement("label");c.textContent="N\xE3o";let l=document.createElement("div");Object.assign(l.style,{display:"flex",alignItems:"center"}),l.appendChild(s),l.appendChild(c),a.appendChild(r),a.appendChild(l);let d=document.createElement("div");d.style.display="block";let p=document.createElement("label");p.className="js-ts-reason-label",p.textContent=t("motivo_ts"),Object.assign(p.style,Ct,{fontSize:"12px"});let x=document.createElement("input");x.type="text",Object.assign(x.style,ta);let f=document.createElement("div");f.className="js-ts-warning",f.innerHTML=`\u26A0\uFE0F <strong>${t("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>`,Object.assign(f.style,ea),d.appendChild(p),d.appendChild(x),d.appendChild(f),e.appendChild(o),e.appendChild(a),e.appendChild(d),n.onchange=()=>{d.style.display="none",Promise.resolve().then(()=>(Xe(),rt)).then(P=>P.notesState.setTagSupportUsed(!0))},s.onchange=()=>{d.style.display="block",Promise.resolve().then(()=>(Xe(),rt)).then(P=>P.notesState.setTagSupportUsed(!1))};function g(P,$){if(e.style.display="none",!P||!$||$.length===0)return;$.some(K=>K==="ads_conversion_tracking"||K==="ads_enhanced_conversions")?e.style.display="block":(E(),Promise.resolve().then(()=>(Xe(),rt)).then(K=>K.notesState.setTagSupportUsed(!1)))}function m(){if(e.style.display==="none")return"";let P=`<br><b>Utilizou Tag Support?</b> ${n.checked?"\u2705 Sim":"\u274C N\xE3o"}`;return s.checked&&x.value.trim()!==""&&(P+=`<br><b>Motivo:</b> ${x.value}`),P+="<br>",P}function y(P){t=P,o.textContent=t("utilizou_tag_support"),p.textContent=t("motivo_ts"),f.innerHTML=`\u26A0\uFE0F <strong>${t("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#b06000; text-decoration:underline;">Link aqui</a>`}function E(){e.style.display="none",s.checked=!0,n.checked=!1,d.style.display="block",x.value=""}return{element:e,updateVisibility:g,getOutput:m,setLanguage:y,reset:E}}var Ft="cw_notes_parking_lot",ct="cw_notes_emergency_save";var ge={getAll:()=>{try{return JSON.parse(localStorage.getItem(Ft)||"[]")}catch{return[]}},save:t=>{let e=ge.getAll(),o={id:Date.now().toString(),timestamp:new Date().toISOString(),...t};return e.unshift(o),e.length>5&&e.pop(),localStorage.setItem(Ft,JSON.stringify(e)),o},delete:t=>{let e=ge.getAll();return e=e.filter(o=>o.id!==t),localStorage.setItem(Ft,JSON.stringify(e)),e},getCount:()=>ge.getAll().length,saveEmergency:t=>{let e={timestamp:Date.now(),data:t};localStorage.setItem(ct,JSON.stringify(e))},getEmergency:()=>{try{let t=localStorage.getItem(ct);if(!t)return null;let e=JSON.parse(t);return Date.now()-e.timestamp>432e5?(localStorage.removeItem(ct),null):!e.data||!e.data.subStatus?null:e.data}catch{return null}},clearEmergency:()=>{localStorage.removeItem(ct)}};var aa="https://script.google.com/a/macros/google.com/s/AKfycbyz2baawbO3gqSCFwlriDZRUUaW44CpjAbQT_0pRgCU2HVcNx0h9e_4pZn4UtdMAFN4zQ/exec",Ot="cw_data_broadcast",no="cw_data_tips",na=["Processando...","Mantenha o foco!","Aguarde..."];function Ze(t,e={}){return new Promise((o,a)=>{let n="cw_cb_"+Math.round(1e5*Math.random()),i=document.createElement("script");window[n]=c=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],o(c)};let r=Object.keys(e).map(c=>encodeURIComponent(c)+"="+encodeURIComponent(e[c])).join("&"),s=`${aa}?op=${t}&callback=${n}&t=${Date.now()}&${r}`;i.src=s,i.onerror=()=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],a(new Error("JSONP Error (Check Corp Login)"))},document.body.appendChild(i)})}async function je(t,e){try{console.log(`\u{1F4E4} Executando ${t}...`,e);let o=await Ze(t,e);if(o&&o.status==="success")return console.log("\u2705 Sucesso:",t),o;throw console.warn("\u26A0\uFE0F Falha:",o),new Error(o.message||`Opera\xE7\xE3o ${t} falhou.`)}catch(o){throw console.error(`\u274C Erro na opera\xE7\xE3o ${t}:`,o),o}}var fe={fetchTips:async()=>{try{let t=await Ze("tips");t?.tips&&localStorage.setItem(no,JSON.stringify(t.tips))}catch(t){console.warn("Tips offline",t)}},fetchData:async()=>{try{let t=await Ze("broadcast");if(t?.broadcast)return localStorage.setItem(Ot,JSON.stringify(t.broadcast)),t}catch(t){console.warn("Broadcast offline",t)}return{broadcast:JSON.parse(localStorage.getItem(Ot)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Ot)||"[]"),getRandomTip:()=>{let t=na,e=localStorage.getItem(no);if(e)try{t=JSON.parse(e)}catch{}return t[Math.floor(Math.random()*t.length)]},sendBroadcast:async t=>{let e={...t,date:new Date().toISOString(),id:Date.now().toString()};return await je("new_broadcast",e)},updateBroadcast:async(t,e)=>{let o={id:t,...e};return await je("update_broadcast",o)},deleteBroadcast:async t=>await je("delete_broadcast",{id:t}),logEvent:(t,e,o="",a=null)=>{try{let n="anon";try{let r=Ee();r&&(n=r.split("@")[0].toLowerCase())}catch{}let i={timestamp:new Date().toISOString(),user:n,version:"v5.1",category:t,action:e,label:o,value:a||""};Ze("log",i).catch(r=>{})}catch(n){console.warn("Analytics error",n)}},logUsage:()=>{},getUserSnippets:async t=>{try{return await Ze("get_user_snippets",{user:t})}catch(e){return console.warn("Erro ao buscar snippets:",e),null}},saveSnippet:async(t,e)=>{let o={...t,user:e};return await je("save_snippet",o)},deleteSnippet:async(t,e)=>await je("delete_snippet",{id:t,user:e})},io=async(t,e)=>{let o={...t,user:e,date:new Date().toISOString()};return await je("create_bau_escalation",o),!0};var dt=["lucaste","ricardogi"];var re={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00",teal:"#00BFA5",pink:"#F48FB1",gray:"#9AA0A6"},pt=t=>new Promise(e=>setTimeout(e,t));function ut(t){let e=document.getElementById("cw-btn-notes");if(!e)return;let o=e.querySelector(".cw-dot-dirty");t?o||(o=document.createElement("div"),o.className="cw-dot-dirty",e.appendChild(o)):o&&o.remove()}function ro(t){let e="cw-command-center-style";if(!document.getElementById(e)){let m=document.createElement("style");m.id=e,m.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(m,y)=>{j.playClick(),a.querySelector(`.${m}`).classList.toggle("active"),y()};if(a.querySelector(".notes").onclick=m=>{m.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=m=>{m.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=m=>{m.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=m=>{m.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=m=>{m.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=m=>{m.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=m=>{m.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=m=>{m.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=m=>{m.stopPropagation(),i("broadcast",()=>{let y=m.currentTarget.querySelector(".cw-badge");y&&y.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(m=>{m.addEventListener("mouseenter",()=>j.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let m=document.createElement("div");m.className="cw-badge",a.querySelector(".broadcast").appendChild(m)}let r=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(r=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{r&&clearTimeout(r)},(async function(){let y=()=>{let P=Ee();if(P){let $=P.split("@")[0].toLowerCase();if(dt.includes($)){let B=a.querySelector("#cw-admin-tag");B&&B.classList.add("visible")}}else setTimeout(y,2e3)};y(),await pt(2800),a.classList.add("docked"),await pt(300);let E=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(P=>P.classList.add("visible"));for(let P=0;P<E.length;P++)E[P].classList.add("popped"),await pt(90);await pt(200),a.classList.add("system-check")})();let s=!1,c,l,d,p,x=3;a.onmousedown=m=>{if(m.target.closest("button"))return;m.preventDefault(),c=m.clientX,l=m.clientY;let y=a.getBoundingClientRect();d=y.left,p=y.top,document.addEventListener("mousemove",f),document.addEventListener("mouseup",g)};function f(m){let y=m.clientX-c,E=m.clientY-l;!s&&Math.sqrt(y*y+E*E)>x&&(s=!0,a.classList.add("dragging"),a.style.transition="none",r&&clearTimeout(r)),s&&(a.style.left=`${d+y}px`,a.style.top=`${p+E}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function g(m){if(document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",g),s){s=!1,a.classList.remove("dragging");let y=window.innerWidth,E=window.innerHeight,P=a.getBoundingClientRect(),$=P.left+P.width/2,B;$<y/2?(B=24,a.classList.remove("side-right"),a.classList.add("side-left")):(B=y-P.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let K=Math.max(24,Math.min(P.top,E-P.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${B}px`,a.style.top=`${K}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let y=a.querySelector(".cw-btn.active"),E=m.target.closest("button");if(a.classList.contains("collapsed")){let P=a.getBoundingClientRect(),$=window.innerHeight,B=P.top>$/2;if(a.style.setProperty("transition","none","important"),B){let K=$-P.bottom;a.style.top="auto",a.style.bottom=`${K}px`}else a.style.bottom="auto",a.style.top=`${P.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),j.playGenieOpen()}else!y&&!E&&(a.classList.add("collapsed"),j.playGenieOpen());E&&(E.style.transform="scale(0.9)",setTimeout(()=>E.style.transform="",150))}}}function Qe(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,X("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let r=Date.now()-n,s=Math.max(0,2e3-r);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let c=o.querySelector(".cw-center-dots"),l=o.querySelector(".cw-center-text"),d=o.querySelector(".cw-center-success"),p=o.querySelector(".cw-abort-btn");c&&(c.style.display="none"),l&&(l.style.display="none"),p&&(p.style.display="none"),d&&d.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},s)}}function so(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let l=document.createElement("div");l.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",l.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let d=document.createElement("button");d.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',d.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",d.onmouseenter=()=>d.style.background="#F1F3F4",d.onmouseleave=()=>d.style.background="transparent",d.onclick=()=>x(!1),l.appendChild(d);let p=document.createElement("div");p.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",c.appendChild(l),c.appendChild(p);function x(g){let m=c.style.transform==="translateY(0%)";(g!==void 0?g:!m)?(f(),c.style.transform="translateY(0%)"):c.style.transform="translateY(110%)"}function f(){let g=ge.getAll();if(p.innerHTML="",g.length===0){p.innerHTML=`
            ...
            `;let P=new Date(m.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),$="";m.summaryTags&&m.summaryTags.length>0&&($=`<div style="font-size:11px; color:#1A73E8; background:#E8F0FE; display:inline-block; padding:2px 6px; border-radius:4px; margin-top:4px;">\u{1F3F7}\uFE0F ${m.summaryTags.slice(0,3).join(", ")+(m.summaryTags.length>3?"...":"")}</div>`),y.innerHTML=`
                <div style="display:flex; justify-content:space-between; margin-bottom:6px; align-items:flex-start;">
                    ...
                    <div style="font-size:11px; color:#9AA0A6;">${P}</div>
                </div>
...
`.replace(/\n/g,"<br>");et(M);let F=await bt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,M),gt(F),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var be=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Fe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let r,s;if(!n)r=window.innerWidth/2,s=window.innerHeight/2;else{let d=e.getBoundingClientRect();r=d.left+d.width/2,s=d.top+d.height/2,r===0&&s===0&&(r=window.innerWidth/2,s=window.innerHeight/2)}let c=i.x-r,l=i.y-s;t?(j.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${c}px, ${l}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${l}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof go=="function"&&go(e,o)):(j.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${c}px, ${l}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${l}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Lt=="function"&&Lt(e))}function go(t,e){Lt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),r=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):r||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Lt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function bo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Jt(t,Z),r=ao(h),s=oo(()=>{k(),W.setActiveTasks(s.getCheckedElements())},h,W),c=document.createElement("div");c.style.display="none";let l=to((u,v)=>{S(u,v)});c.appendChild(l);let d=so({onSaveCurrent:async()=>{let u=await D();return _(),u},onLoadDraft:u=>{I(u)},t:u=>h(u)}),p=F(),x=G(),f=document.createElement("div"),g=Y(),m=T(d,h);o.appendChild(p),o.appendChild(x),o.appendChild(g),o.appendChild(c),o.appendChild(f),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none";let y=document.createElement("button");y.id="manual-task-toggle",y.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",y.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${H.primary}; background: ${H.surface}; color: ${H.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,y.onmouseenter=()=>{y.style.background=H.primaryBg},y.onmouseleave=()=>{y.style.background=H.surface},y.onclick=()=>{s.selectionElement.style.display="block",s.screenshotsElement.style.display="block",y.style.display="none"},o.appendChild(y),o.appendChild(s.selectionElement),o.appendChild(r.element),o.appendChild(s.screenshotsElement),o.appendChild(m);let E=document.createElement("div");E.style.display="none",E.style.flexGrow="1",E.style.minHeight="0",E.style.overflow="hidden";let P=po(()=>M());P.style.height="100%",E.appendChild(P),e.insertBefore(E,i);let $=a.lastElementChild;$&&($.insertBefore(d.historyBtnWrapper,$.firstChild),$.insertBefore(N(),$.firstChild)),e.appendChild(d.drawer);let B=null;W.subscribe(u=>{z(u),K(),u.isDirty?(B&&clearTimeout(B),B=setTimeout(async()=>{let v=await D(!0);v.subStatus?ge.saveEmergency(v):ge.clearEmergency(),u.isDirty=!1},2e3)):B&&(clearTimeout(B),B=null)});function K(){let u=ge.getCount()>0,v=!!W.currentSubStatus;ut(u||v)}function Z(){W.visible=!W.visible,ue(W.visible,e,"cw-btn-notes")}function M(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",E.style.display="flex",E.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",E.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function F(){let u=document.createElement("div");if(u.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let w=document.createElement("style");w.id="cw-segmented-styles",w.innerHTML=`
            ...
            `,document.head.appendChild(w)}let v=(w,L)=>{let J=u.querySelector(`#${w}`).querySelector(".cw-segmented-indicator");J&&(J.style.transform=`translateX(${L*100}%) translateX(${L*2}px)`)};return u.querySelectorAll("#lang-selector button").forEach((w,L)=>{w.onclick=()=>{W.setLanguage(w.dataset.lang),u.querySelectorAll("#lang-selector button").forEach(R=>R.classList.remove("active")),w.classList.add("active"),v("lang-selector",L),j.playHover(),W.currentSubStatus&&q(W.currentSubStatus)}}),u.querySelectorAll("#type-selector button").forEach((w,L)=>{w.onclick=()=>{W.setCaseType(w.dataset.type),u.querySelectorAll("#type-selector button").forEach(R=>R.classList.remove("active")),w.classList.add("active"),v("type-selector",L),j.playHover(),W.currentSubStatus&&q(W.currentSubStatus)}}),u.querySelectorAll("#portugal-selector button").forEach((w,L)=>{w.onclick=()=>{W.setPortugalCase(w.dataset.val==="true"),u.querySelectorAll("#portugal-selector button").forEach(R=>R.classList.remove("active")),w.classList.add("active"),v("portugal-selector",L),j.playHover(),W.currentSubStatus&&q(W.currentSubStatus)}}),u}function G(){let u=document.createElement("div");u.className="cw-status-section",u.style.cssText="display: flex; flex-direction: column; gap: 8px;",u.innerHTML=`
        ...
        `;let v=u.querySelector("#main-status-select"),w=u.querySelector("#sub-status-select");return v.onchange=()=>{W.setStatus(v.value),V(v.value,w),W.setSubStatus(""),q("")},w.onchange=()=>{W.setSubStatus(w.value),q(w.value)},u}function V(u,v){if(v.innerHTML=`<option value="">${h("select_substatus")}</option>`,!u){v.disabled=!0;return}for(let w in ke)if(ke[w].status===u){let L=document.createElement("option");L.value=w,L.textContent=ke[w].name,v.appendChild(L)}v.disabled=!1}function q(u){if(l.render&&l.render(u,W.currentCaseType),!u){c.style.display="none",f.style.display="none",document.getElementById("manual-task-toggle").style.display="none",s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",g.style.display="flex",g.style.opacity="1",m.style.display="none";return}g.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(g.style.display="none")},400),m.style.display="grid";let v=ke[u];v&&v.templateFields&&W.setActiveFields(v.templateFields),O(),Tt(u,f,W),f.style.display="block",c.style.display="block";let w=u.startsWith("SO_"),L=u==="NI_Awaiting_Validation",R=document.getElementById("manual-task-toggle");w||L?(s.selectionElement.style.display="block",R.style.display="none"):(s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",R.style.display="block");let J=u==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(J),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),s.updateSubStatus(u),k();let U=document.getElementById("email-automation-toggle-row");U&&(U.style.display=$e[u]?"flex":"none")}function k(){let u=s.getCheckedElements().map(v=>v.value);r.updateVisibility(W.currentSubStatus,u)}function S(u,v){let w=lt[u];if(w){for(let L in w)if(L==="linkedTask")s.toggleTask(w.linkedTask,v);else if(L==="activeTasks")w.activeTasks.forEach(R=>{v?s.setTaskCount(R.value,R.count):s.setTaskCount(R.value,0)});else if(L.startsWith("field-")){let R=L,J=w[L],U=document.getElementById(R);if(U){let ee=He.includes(R.replace("field-",""));if(v)if(ee){let oe=U.value.trim();oe.includes(J.trim())||(U.value=oe?oe+`
`+J.trim():J.trim())}else U.value=J;else if(ee){let oe=U.value.trim(),Q=J.trim();oe.includes(Q)&&(U.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else U.value.trim()===J.trim()&&(U.value="");W.updateField(R,U.value),U.dispatchEvent(new Event("input"))}}}}function T(u,v){let w=document.createElement("div");if(w.className="cw-actions-section",w.style.cssText=`
            display: grid;
        ...
        `,!document.getElementById("cw-actions-hover-styles")){let oe=document.createElement("style");oe.id="cw-actions-hover-styles",oe.innerHTML=`
            ...
            `,document.head.appendChild(oe)}let L=document.createElement("div");L.id="email-automation-toggle-row",L.style.cssText="grid-column: span 2; display: none; align-items: center; justify-content: center; padding-bottom: 6px; border-bottom: 1px solid rgba(0,0,0,0.05); margin-bottom: 2px;",L.innerHTML=`
        ...
        `;let R=u.parkButton;R.classList.add("js-btn-park"),R.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let J=document.createElement("button");J.className="cw-btn-secondary js-btn-reset",J.textContent=v("limpar"),J.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.textSub}; border: 1px solid ${H.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,J.onclick=()=>_();let U=document.createElement("button");U.className="cw-btn-secondary js-btn-copy",U.textContent=v("copiar"),U.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.primary}; border: 1px solid ${H.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,U.onclick=()=>b();let ee=document.createElement("button");return ee.className="cw-btn-primary js-btn-generate",ee.textContent=v("preencher"),ee.style.cssText=`width: 100%; height: 38px; background: ${H.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ee.onclick=()=>A(),w.appendChild(L),w.appendChild(R),w.appendChild(J),w.appendChild(U),w.appendChild(ee),w}async function b(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let u=kt(W,s,r);u?(et(u),X(h("copiado_sucesso")),j.playClick()):X(h("select_substatus"),{error:!0})}async function A(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let u=kt(W,s,r);et(u),Z();let v=Qe(),w=await bt();if(w){w.focus(),document.execCommand("insertHTML",!1,u),gt(w);let L=document.getElementById("email-automation-checkbox");(!L||L.checked)&&W.currentSubStatus&&$e[W.currentSubStatus]&&await ht($e[W.currentSubStatus]),X(h("inserido_copiado")),j.playSuccess(),_()}v()}function O(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let u=ke[W.currentSubStatus];u&&u.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function _(){W.reset(),s.reset(),r.reset(),K(),ge.clearEmergency(),o.querySelectorAll("select").forEach(v=>v.value=""),o.querySelector("#sub-status-select").disabled=!0;let u=document.getElementById("email-automation-toggle-row");u&&(u.style.display="none"),f.innerHTML="",c.style.display="none",g.style.display="flex",g.style.opacity="1",m.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none"}async function D(u=!1){let v={};f.querySelectorAll("input, textarea, select").forEach(U=>{(U.id.startsWith("field-")||U.id==="consent-select")&&(v[U.id]=U.value)});let w="Cliente",L="---";if(!u)try{let U=await we();w=U.advertiserName,L=U.cid}catch(U){console.warn("Erro ao coletar pageData:",U)}let R=s.getCheckedElements().map(U=>({key:U.value,count:U.count})),J=R.map(U=>{let ee=Ce[U.key];return ee?ee.name:U.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:v,activeTasks:R,summaryTags:J,clientName:w,cid:L,timestamp:new Date().toISOString()}}let C=u=>new Promise(v=>setTimeout(v,u));async function I(u){W.setLanguage(u.currentLang||"pt"),W.setCaseType(u.currentCaseType||"bau"),W.setPortugalCase(u.isPortugalCase||!1),W.setConsent(u.consent||!1),W.setExcludedFields(u.excludedFields||[]),u.activeFields&&W.setActiveFields(u.activeFields);let v=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);v&&v.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(R=>{R!==v&&R.classList.remove("active")});let w=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);w&&w.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(R=>{R!==w&&R.classList.remove("active")});let L=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if(L&&L.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(R=>{R!==L&&R.classList.remove("active")}),u.status){let R=o.querySelector("#main-status-select");R.value=u.status,W.setStatus(u.status);let J=o.querySelector("#sub-status-select");if(V(u.status,J),await C(50),u.subStatus){if(J.value=u.subStatus,W.setSubStatus(u.subStatus),q(u.subStatus),await C(100),u.tagSupportUsed!==void 0){W.setTagSupportUsed(u.tagSupportUsed);let U=r.element.querySelector('input[value="Sim"]'),ee=r.element.querySelector('input[value="N\xE3o"]');u.tagSupportUsed&&U?U.checked=!0:ee&&(ee.checked=!0),r.element.querySelector("div:last-child").style.display=u.tagSupportUsed?"none":"block"}u.forcedScreenshots&&W.setForcedScreenshots(u.forcedScreenshots);for(let U in u.formData){let ee=document.getElementById(U);ee&&(ee.value=u.formData[U],W.updateField(U,ee.value))}u.activeTasks&&(u.activeTasks.forEach(U=>s.setTaskCount(U.key,U.count)),W.setActiveTasks(s.getCheckedElements()))}}W.isDirty=!1}function h(u){return Se[W.currentLang]?.[u]||Se.pt?.[u]||u}function N(){let u=document.createElement("div");return u.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',u.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",u.onclick=v=>{v.stopPropagation(),M()},u.title="Alternar para Split & Transfer",u}function Y(){let u=document.createElement("div");return u.id="notes-empty-state",u.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(l),Object.assign(c.style,me,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let d=pe(c,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:c},()=>S()),p=document.createElement("div");Object.assign(p.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:s.bgApp});let x=document.createElement("div");Object.assign(x.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${s.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let f=document.createElement("div");Object.assign(f.style,{padding:"16px",borderBottom:`1px solid ${s.borderSubtle}`,position:"relative"});let g=document.createElement("input");g.placeholder="Buscar templates...",Object.assign(g.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:s.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),g.onfocus=()=>{g.style.backgroundColor="#FFFFFF",g.style.borderColor=s.primary,g.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",g.style.transform="scale(1.02)"},g.onblur=()=>{g.style.backgroundColor="#E3E3E8",g.style.borderColor="transparent",g.style.boxShadow="none",g.style.transform="scale(1)"};let m=document.createElement("div");m.id="email-template-list",Object.assign(m.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let y=document.createElement("div");y.innerHTML="\u2715",Object.assign(y.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),y.onclick=()=>{g.value="",n="",y.style.display="none",b(),g.focus()},f.appendChild(g),f.appendChild(y),x.appendChild(f),x.appendChild(m);let E=document.createElement("div");Object.assign(E.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:s.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let P=document.createElement("div");Object.assign(P.style,{padding:"20px",borderBottom:`1px solid ${s.borderSubtle}`,backgroundColor:s.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let $=document.createElement("div");Object.assign($.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:s.bgApp,overflow:"hidden"});let B=document.createElement("div");Object.assign(B.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let K=document.createElement("span");K.textContent="Preview do E-mail",Object.assign(K.style,{fontSize:"12px",fontWeight:"600",color:s.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let Z=document.createElement("div");Object.assign(Z.style,{display:"flex",gap:"8px"});let M=(C,I=!1)=>{let h=document.createElement("button");return h.textContent=C,Object.assign(h.style,{padding:"8px 14px",borderRadius:"10px",border:I?"none":`1.5px solid ${s.primary}`,background:I?s.primary:"transparent",color:I?"#fff":s.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:I?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),h.onmouseenter=()=>{I?(h.style.backgroundColor="#0062CC",h.style.transform="translateY(-1px)",h.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):h.style.backgroundColor="rgba(0, 122, 255, 0.05)"},h.onmouseleave=()=>{I?(h.style.backgroundColor=s.primary,h.style.transform="translateY(0)",h.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(h.style.backgroundColor="transparent",h.style.transform="translateY(0)")},h.onmousedown=()=>h.style.transform="scale(0.94)",h.onmouseup=()=>h.style.transform="scale(1)",h},F=M("Copiar HTML"),G=M("Preencher no CRM",!0),V=M("Smart CR");V.style.borderColor="#E67E22",V.style.color="#E67E22",V.style.display="none",Z.appendChild(V),Z.appendChild(F),Z.appendChild(G),B.appendChild(K),B.appendChild(Z);let q=document.createElement("div");q.contentEditable="true",Object.assign(q.style,{flex:"1",backgroundColor:s.bgSurface,border:`1px solid ${s.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:s.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),$.appendChild(B),$.appendChild(q),D(),E.appendChild(P),E.appendChild($),p.appendChild(x),p.appendChild(E),c.appendChild(d),c.appendChild(p);let k=document.createElement("div");Object.assign(k.style,Ae),c.appendChild(k),Te(c,k),document.body.appendChild(c);function S(){e=!e,e?(c.style.display="flex",Ut(c),o.length===0&&T()):c.style.display="none",ue(e,c,"cw-btn-email")}async function T(){m.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await xo.getTemplates(),b()}function b(){m.innerHTML="";let C=o.filter(z=>z.name.toLowerCase().includes(n.toLowerCase())||z.category.toLowerCase().includes(n.toLowerCase())),I=Object.entries($e).filter(([z,u])=>u&&(z.toLowerCase().includes(n.toLowerCase())||u.toLowerCase().includes(n.toLowerCase()))).map(([z,u])=>({id:z,name:z.replace(/_/g," "),category:"\u26A1 Smart CRs",code:u,isSmartCR:!0})),h=he.getSnippets("email").filter(z=>z.title.toLowerCase().includes(n.toLowerCase())||z.subject&&z.subject.toLowerCase().includes(n.toLowerCase())).map(z=>{let u=[],v=z.content.match(/\[([^\]]+)\]/g);return v&&[...new Set(v)].forEach(w=>{u.push({key:w,label:w.replace("[","").replace("]",""),type:w.toLowerCase().includes("data")?"date":"text",auto:w.toLowerCase().includes("nome")&&w.toLowerCase().includes("seu")?"agentName":null})}),{id:z.id||`snippet-${Math.random()}`,name:z.title,category:"\u{1F464} Pessoal",subject:z.subject||"Sem Assunto",template:z.content,placeholders:u}}),N=[...C,...I,...h];if(N.length===0){m.innerHTML=`
                ...
                </div>`):P.style.display="none";return}let C=a.placeholders&&a.placeholders.length>0;if(P.style.display=C?"block":"none",!C)return;let I=document.createElement("div");Object.assign(I.style,{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"}),(a.placeholders||[]).forEach(h=>{let N=document.createElement("div"),Y=document.createElement("label");Y.textContent=h.label,Object.assign(Y.style,{display:"block",fontSize:"11px",fontWeight:"700",color:s.textSecondary,marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.5px"});let z=document.createElement("input");z.type=h.type||"text",z.dataset.key=h.key,Object.assign(z.style,{width:"100%",padding:"10px 12px",borderRadius:"8px",border:`1.5px solid ${s.borderSubtle}`,backgroundColor:"#FBFBFD",fontSize:"14px",boxSizing:"border-box",transition:"all 0.2s ease",outline:"none"}),z.onfocus=()=>{z.style.borderColor=s.primary,z.style.backgroundColor="#FFFFFF",z.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)"},z.onblur=()=>{z.style.borderColor=s.borderSubtle,z.style.backgroundColor="#FBFBFD",z.style.boxShadow="none"},h.auto==="agentName"&&(z.value=Ye().split(" ")[0]),z.addEventListener("input",D),N.appendChild(Y),N.appendChild(z),I.appendChild(N)}),P.appendChild(I)}function D(){if(!a){q.innerHTML=`
...
CID: ${v.cid||"---"}
Case ID: ${v.caseId||"---"}
E-mail: ${v.clientEmail||"---"}`;L&&(L.value=J),R&&(R.style.display="block",R.style.maxHeight="300px",R.style.opacity="1",R.scrollIntoView({behavior:"smooth",block:"end"}))})}function f(){s=!s,ue(s,c,"cw-btn-script"),s?(p(),d||(d=setInterval(p,2e3))):d&&(clearInterval(d),d=null)}let g=pe(c,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{f()});c.appendChild(g);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
  ...
  `;let y=m.querySelector("#csa-toggle-options"),E=m.querySelector("#csa-options-content"),P=m.querySelector("#csa-options-arrow"),$=!1;y.onclick=()=>{$=!$,P.style.transform=$?"rotate(180deg)":"rotate(0deg)",E.style.maxHeight=$?"400px":"0",E.style.opacity=$?"1":"0",E.style.marginTop=$?"8px":"0",j.playClick()};let B=m.querySelector("#cw-pill-message"),K=m.querySelector("#cw-am-copy-final"),Z=m.querySelector("#cw-am-message-area");B.onmouseenter=()=>{B.style.borderColor="#007AFF",B.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},B.onmouseleave=()=>{B.style.borderColor="#DADCE0",B.style.boxShadow="0 1px 2px rgba(0,0,0,0.02)"},B.addEventListener("click",()=>{x()}),K.addEventListener("click",()=>{Z.value&&(navigator.clipboard.writeText(Z.value),X("Mensagem copiada!"),j.playSuccess(),K.style.background="#34A853",K.textContent="Copiado!",setTimeout(()=>{K.style.background="#1A73E8",K.textContent="Copiar Mensagem Final"},2e3))});let M=(v,w)=>{let L=m.querySelector(v),R=m.querySelector(w);L.onclick=()=>{let J=R.textContent;!J||J.includes("---")||J.includes("N\xE3o encontrado")||(navigator.clipboard.writeText(J),j.playSuccess(),L.classList.add("copied"),setTimeout(()=>L.classList.remove("copied"),1500))}};c.appendChild(m);let F=document.createElement("div");Object.assign(F.style,a.progressBarContainer);let G=document.createElement("div");G.className="csa-progress-fill",Object.assign(G.style,a.progressBarFill),F.appendChild(G),c.appendChild(F);let V=document.createElement("div");V.id="csa-content",Object.assign(V.style,a.contentArea),c.appendChild(V);let q=document.createElement("div");Object.assign(q.style,a.footer);let k=document.createElement("span");k.textContent="by lucaste@",Object.assign(k.style,{fontSize:"10px",color:"#bdc1c6"});let S=document.createElement("button");S.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> Resetar Script',Object.assign(S.style,a.resetBtn),S.onmouseenter=()=>S.style.background="#fce8e6",S.onmouseleave=()=>S.style.background="transparent",S.onclick=()=>{S.style.transform="scale(0.9)",setTimeout(()=>S.style.transform="scale(1)",150);for(let v in n)delete n[v];Y()},q.appendChild(k),q.appendChild(S),c.appendChild(q);let T=document.createElement("div");Object.assign(T.style,{display:"flex",flexDirection:"column",gap:"8px",marginBottom:"16px"});let b=document.createElement("div");b.className="csa-segmented-control",b.innerHTML=`
  ...
  `,m.onfocus=()=>{f.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",f.style.border="1px solid #1a73e8"},m.onblur=()=>{f.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",f.style.border="1px solid transparent"},f.appendChild(g),f.appendChild(m),x.appendChild(f),p.appendChild(x);let y=document.createElement("div");y.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(y);let E=null;function P(){if(E)return;E=document.createElement("div"),E.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let k=document.createElement("div");k.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",k.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let S=document.createElement("button");S.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',S.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",S.onclick=()=>{B(),n=!1,F()},k.appendChild(S),E.appendChild(k);let T=document.createElement("div");T.id="cw-history-list",T.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",E.appendChild(T),p.appendChild(E)}function $(){E||P();let k=E.querySelector("#cw-history-list");k.innerHTML="";let S=ia();S.length===0?k.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':S.forEach(T=>{let b=V(T,Be[T._originalCat],!0,T._originalCat);k.appendChild(b)}),requestAnimationFrame(()=>E.style.transform="translateY(0)")}function B(){E&&(E.style.transform="translateY(100%)")}function K(){d.innerHTML="";let k=Z("history","Recentes",Be.history);k.id="cw-sidebar-btn-history",k.onclick=()=>{j.playClick(),n=!n,n?$():B(),F()},d.appendChild(k);let S=document.createElement("div");S.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(S),Object.keys(tt).forEach(T=>{let b=tt[T],A=Z(T,b.label,Be[T]);A.id=`cw-sidebar-btn-${T}`,A.onclick=()=>{j.playClick(),n&&(n=!1,B()),M(T)},d.appendChild(A)})}function Z(k,S,T){let b=document.createElement("div");b.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,b.title=S,b.dataset.key=k;let A=document.createElement("div");A.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",A.innerHTML=T||Be.tasks;let O=document.createElement("div");return O.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",O.textContent=S,b.appendChild(A),b.appendChild(O),b.onmouseenter=()=>{a!==k&&!(k==="history"&&n)&&(b.style.background="#F1F3F4",A.style.transform="scale(1.1)")},b.onmouseleave=()=>{a!==k&&!(k==="history"&&n)&&(b.style.background="transparent",A.style.transform="scale(1)")},b}function M(k){let S=document.getElementById(`cat-anchor-${k}`);S&&(S.scrollIntoView({behavior:"smooth",block:"start"}),a=k,F())}function F(){Object.keys(tt).forEach(S=>{let T=d.querySelector(`#cw-sidebar-btn-${S}`);if(T)if(a===S&&!n){let b=yt[S];T.style.background=b.bg,T.style.color=b.color,T.querySelector("div:first-child").style.transform="scale(1.1)"}else T.style.background="transparent",T.style.color=i.textSecondary,T.querySelector("div:first-child").style.transform="scale(1)"});let k=d.querySelector("#cw-sidebar-btn-history");k&&(n?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=i.textSecondary))}function G(){if(y.innerHTML="",e.trim()!==""){let S=[];if(Object.entries(tt).forEach(([b,A])=>{let O=A.links.filter(_=>_.name.toLowerCase().includes(e.toLowerCase())||_.desc.toLowerCase().includes(e.toLowerCase()));S.push(...O.map(_=>({..._,_cat:b})))}),S.length===0){y.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let T=document.createElement("div");T.innerHTML="Resultados da busca",T.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",y.appendChild(T),S.forEach(b=>{let A=V(b,Be[b._cat],!1,b._cat);y.appendChild(A)});return}Object.entries(tt).forEach(([S,T])=>{let b=yt[S],A=document.createElement("div"),O=document.createElement("div");O.id=`cat-anchor-${S}`,O.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,O.innerHTML=`
            ...
            ${T.label}
          `,A.appendChild(O);let _=document.createElement("div");_.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",T.links.forEach(D=>{let C=V(D,Be[S],!1,S);_.appendChild(C)}),A.appendChild(_),y.appendChild(A)});let k=document.createElement("div");k.style.height="80px",y.appendChild(k)}function V(k,S,T,b){let A=document.createElement("div"),O=yt[b]||yt.history;A.style.cssText=`
      ...
      `;let _=document.createElement("div");_.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,_.innerHTML=S||Be.tasks;let D=_.querySelector("svg");D&&(D.style.width="22px",D.style.height="22px");let C=document.createElement("div");C.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let I=document.createElement("div");I.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,I.textContent=k.name;let h=document.createElement("div");h.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,h.textContent=k.desc,C.appendChild(I),C.appendChild(h);let N=document.createElement("div");return N.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',N.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,N.title="Copiar URL",A.onmouseenter=()=>{A.style.transform="translateY(-2px)",A.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",A.style.borderColor="rgba(0,0,0,0.05)",A.style.borderLeft=`4px solid ${O.color}`,N.style.opacity="1",N.style.background="#F1F3F4"},A.onmouseleave=()=>{A.style.transform="translateY(0)",A.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",A.style.border="1px solid transparent",N.style.opacity="0",N.style.background="transparent"},A.onclick=()=>{!T&&b&&So(k,b),window.open(k.url,"_blank")},N.onclick=Y=>{Y.stopPropagation(),j.playClick(),navigator.clipboard.writeText(k.url),!T&&b&&So(k,b),X("Link copiado!")},A.appendChild(_),A.appendChild(C),A.appendChild(N),A}m.addEventListener("input",k=>{e=k.target.value,G()});function q(){o=!o,ue(o,r,"cw-btn-links")}return document.body.appendChild(r),K(),G(),q}var _e=[];function _t(t){_e=t}var ra=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Eo(){let t="v4.9",e=!1,o=null,a=null;function n(b){if(!b)return"";try{let A=new Date(b);return isNaN(A.getTime())?String(b):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(b)}}if(!document.getElementById("cw-broadcast-hd-css")){let b=document.createElement("style");b.id="cw-broadcast-hd-css",b.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,g.querySelectorAll('input[name="cw-bc-type"]').forEach(_=>{_.addEventListener("change",()=>{g.querySelectorAll(".cw-radio-option").forEach(D=>D.classList.remove("checked")),_.parentElement.classList.add("checked")})}),setTimeout(()=>{let _=g.querySelector(".cw-radio-option.info");_&&_.classList.add("checked")},100);let b=g.querySelector("#cw-bc-cancel"),A=g.querySelector("#cw-bc-close-x"),O=g.querySelector("#cw-bc-send");b.onclick=$,A.onclick=$,O.onclick=B,l.appendChild(g)}function P(b=null){if(!g)return;let A=g.querySelector("#cw-editor-title-label"),O=g.querySelector("#cw-bc-title"),_=g.querySelector("#cw-bc-text"),D=g.querySelector("#cw-bc-send");if(b){a=b.id,A.textContent="Editar Aviso",O.value=b.title||"",_.value=b.text||"",D.textContent="Salvar Altera\xE7\xF5es";let C=b.type||"info",I=g.querySelector(`input[name="cw-bc-type"][value="${C}"]`);I&&I.click()}else{a=null,A.textContent="Novo Aviso",O.value="",_.value="",D.textContent="Publicar";let C=g.querySelector('input[name="cw-bc-type"][value="info"]');C&&C.click()}g.classList.add("active"),setTimeout(()=>O.focus(),300)}function $(){g&&g.classList.remove("active"),a=null}async function B(){let b=g.querySelector("#cw-bc-send"),A=g.querySelector("#cw-bc-title"),O=g.querySelector("#cw-bc-text"),_=g.querySelector('input[name="cw-bc-type"]:checked'),D=_?_.value:"info";if(!A.value.trim()||!O.value.trim()){X("Preencha todos os campos!",{error:!0});return}b.textContent="Salvando...",b.style.opacity="0.7";let C=!1;a?C=await fe.updateBroadcast(a,{title:A.value,text:O.value,type:D}):C=await fe.sendBroadcast({title:A.value,text:O.value,type:D,author:window._cwCurrentUser||"admin"}),C?(X(a?"Atualizado!":"Publicado!"),j.playSuccess(),$(),setTimeout(()=>M(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),b.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",b.style.opacity="1")}async function K(b){if(await xe("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await fe.deleteBroadcast(b)){X("Aviso removido."),j.playClick();let _=_e.findIndex(D=>D.id===b);_>-1&&_e.splice(_,1),G(),setTimeout(()=>M(),1500)}else X("Erro ao excluir.",{error:!0})}let Z=document.createElement("div");Z.className="cw-nice-scroll",Object.assign(Z.style,i.feedContainer),l.appendChild(Z);async function M(){e&&(y.style.display="block",y.innerHTML="\u{1F504} Sincronizando...");try{let b=await fe.fetchData();b&&b.broadcast&&(_t(b.broadcast),F(),e&&(G(),y.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{y.style.display="none"},1500)))}catch{e&&(y.innerHTML="\u26A0\uFE0F Offline")}}function F(){let b=document.getElementById("cw-btn-broadcast");if(!b)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(_e.some(_=>!A.includes(_.id))){if(b.classList.add("has-new"),!b.querySelector(".cw-badge")){let _=document.createElement("div");_.className="cw-badge",Object.assign(_.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),b.appendChild(_)}}else{b.classList.remove("has-new");let _=b.querySelector(".cw-badge");_&&_.remove()}}function G(){Z.innerHTML="";let b=l.querySelector("#cw-bau-widget");b&&b.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=[..._e].sort((h,N)=>{let Y=new Date(h.date).getTime()||0;return(new Date(N.date).getTime()||0)-Y}),_=O.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(_!==-1){let h=O[_];O.splice(_,1);let N=document.createElement("div");N.id="cw-bau-widget",Object.assign(N.style,i.bauContainer);let Y=[],z=(h.text||"").split(`
`),u=/\d{1,2}\/\d{1,2}/,v="\u{1F4C5}";if(z.forEach(U=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(U)?v="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(U)&&(v="\u{1F1EA}\u{1F1F8}");let ee=U.match(u);if(ee){let oe=ee[0],Q=v;/🇧🇷|🇵🇹|PT|BR/i.test(U)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(U)&&(Q="\u{1F1EA}\u{1F1F8}"),Y.some(te=>te.flag===Q&&te.date===oe)||Y.push({flag:Q,date:oe})}}),Y.length===0){let U=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);U&&[...new Set(U)].forEach(ee=>Y.push({flag:"\u{1F4C5}",date:ee}))}let w="",L='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(L=`
           ...
           `,Z.appendChild(h)}let C=D.filter(h=>!A.includes(h.id)),I=D.filter(h=>A.includes(h.id));if(C.forEach(h=>Z.appendChild(V(h,!1))),I.length>0){let h=document.createElement("div");Object.assign(h.style,i.historyDivider),h.innerHTML=`<span>Hist\xF3rico (${I.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let N=document.createElement("div");Object.assign(N.style,i.historyContainer),I.forEach(z=>N.appendChild(V(z,!0)));let Y=!1;h.onclick=()=>{j.playClick(),Y=!Y,N.style.display=Y?"flex":"none",h.querySelector("svg").style.transform=Y?"rotate(180deg)":"rotate(0deg)"},Z.appendChild(h),Z.appendChild(N)}}function V(b,A){let O=document.createElement("div");Object.assign(O.style,A?i.cardHistory:i.card);let _=r[b.type]||r.info,D=document.createElement("div");Object.assign(D.style,i.cardHeader);let C=document.createElement("div");Object.assign(C.style,i.typeTag,{color:_.color,background:_.bg}),C.innerHTML=`${_.icon} <span>${b.type}</span>`;let I=document.createElement("span");if(Object.assign(I.style,i.dateTag),I.textContent=n(b.date),D.appendChild(C),A)D.appendChild(I);else{let u=document.createElement("button");u.className="cw-btn-interactive",Object.assign(u.style,i.dismissBtn),u.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',u.onmouseenter=()=>{u.style.color="#1e8e3e",u.style.background="#e6f4ea",u.style.borderColor="#1e8e3e"},u.onmouseleave=()=>{u.style.color="#5f6368",u.style.background="#fff",u.style.borderColor="rgba(0,0,0,0.1)"},u.onclick=v=>{v.stopPropagation(),j.playClick(),O.style.transform="translateX(20px)",O.style.opacity="0",setTimeout(()=>{let w=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");w.push(b.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(w)),G(),F()},200)},D.appendChild(u)}let h=document.createElement("div");Object.assign(h.style,i.cardContent);let N=document.createElement("div");Object.assign(N.style,i.msgTitle),N.textContent=b.title;let Y=document.createElement("div");Object.assign(Y.style,i.msgBody),Y.innerHTML=c(b.text);let z=document.createElement("div");if(Object.assign(z.style,i.msgMeta),z.innerHTML=`Publicado por <b>${b.author||"Sistema"}</b>`,A||(z.innerHTML+=` \u2022 ${n(b.date)}`),h.appendChild(N),h.appendChild(Y),h.appendChild(z),O.appendChild(D),O.appendChild(h),window._cwIsAdmin){let u=document.createElement("div");u.className="cw-card-actions";let v=document.createElement("button");v.className="cw-action-btn edit",v.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',v.onclick=()=>P(b);let w=document.createElement("button");w.className="cw-action-btn delete",w.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',w.onclick=()=>K(b.id),u.appendChild(v),u.appendChild(w),O.appendChild(u)}return O}let q=fe.getCachedBroadcasts();q.length>0&&(_t(q),G()),setTimeout(m,500),M(),o||(o=setInterval(M,ra));let k=document.createElement("div");Object.assign(k.style,Ae),k.className="no-drag",l.appendChild(k),Te(l,k),document.body.appendChild(l);let S=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),T=_e.some(b=>!S.includes(b.id));return{toggle:p,hasUnread:T}}function Ao(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let r=document.createElement("div");Object.assign(r.style,o.title);let s=document.createElement("div");Object.assign(s.style,o.text);let c=document.createElement("div");Object.assign(c.style,o.dotsContainer);let l=document.createElement("div");Object.assign(l.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let p=document.createElement("button");p.textContent="Pr\xF3ximo",Object.assign(p.style,o.btn,o.btnNext),p.onmouseover=()=>p.style.transform="scale(1.05)",p.onmouseout=()=>p.style.transform="scale(1)",l.appendChild(d),l.appendChild(p),n.appendChild(i),n.appendChild(r),n.appendChild(s),n.appendChild(c),n.appendChild(l),a.appendChild(n),document.body.appendChild(a);function x(g){let m=t[g];i.textContent=m.icon,r.textContent=m.title,s.textContent=m.text,c.innerHTML="",t.forEach((y,E)=>{let P=document.createElement("div");Object.assign(P.style,o.dot),E===g&&Object.assign(P.style,o.dotActive),c.appendChild(P)}),m.isLast?(d.style.display="none",p.textContent="Come\xE7ar \u{1F680}",p.style.width="100%"):(d.style.display="block",p.textContent="Pr\xF3ximo",p.style.width="auto")}function f(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),j.playSuccess(),X("Tudo pronto! Use o menu flutuante.")}p.onclick=()=>{j.playClick(),e<t.length-1?(e++,x(e)):f()},d.onclick=async()=>{await xe("Pular o tutorial?")&&f()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var To={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function ko(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&sa(t)}function sa(t){let e=To.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let r=document.createElement("div");Object.assign(r.style,a.badge),r.textContent=`Atualiza\xE7\xE3o ${t}`;let s=document.createElement("div");Object.assign(s.style,a.icon);let c=document.createElement("div");Object.assign(c.style,a.title);let l=document.createElement("div");Object.assign(l.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let p=document.createElement("button");Object.assign(p.style,a.btn),p.onmouseover=()=>p.style.transform="scale(1.02)",p.onmouseout=()=>p.style.transform="scale(1)",i.appendChild(r),i.appendChild(s),i.appendChild(c),i.appendChild(l),i.appendChild(d),i.appendChild(p),n.appendChild(i),document.body.appendChild(n);function x(g){let m=e[g];s.textContent=m.icon,c.textContent=m.title,l.textContent=m.text,d.innerHTML="",e.forEach((y,E)=>{let P=document.createElement("div");Object.assign(P.style,a.dot),E===g&&Object.assign(P.style,a.dotActive),d.appendChild(P)}),g===e.length-1?p.textContent="Entendi, vamos l\xE1! \u{1F44D}":p.textContent="Pr\xF3ximo"}function f(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),j.playSuccess(),X(`TechSol atualizado para ${t}!`)}p.onclick=()=>{j.playClick(),o<e.length-1?(o++,x(o)):f()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Fo="cw_timezone_pinned",Mt=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],la=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function Oo(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Fo)||"[]"),i="",r="all",s=new Date;s.setHours(14,0,0,0);let c={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},l={container:{display:"flex",flexDirection:"column",height:"100%",background:c.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:c.surface,borderBottom:`1px solid ${c.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:c.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:c.primary,borderBottomColor:c.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:c.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:c.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${c.border}`,background:c.surface,color:c.textSub,transition:"all 0.2s"},chipActive:{background:c.primaryBg,color:c.primary,borderColor:c.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:c.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${c.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:c.surface,border:`1px solid ${c.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:c.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=pe(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>A());d.appendChild(x);let f=document.createElement("div");Object.assign(f.style,l.container),d.appendChild(f);let g=document.createElement("div");Object.assign(g.style,l.tabHeader);let m=document.createElement("div");m.textContent="Monitoramento",Object.assign(m.style,l.tabBtn,l.tabActive);let y=document.createElement("div");y.textContent="Planejador",Object.assign(y.style,l.tabBtn),g.appendChild(m),g.appendChild(y),f.appendChild(g);let E=document.createElement("div");Object.assign(E.style,l.toolbar);let P=document.createElement("div");Object.assign(P.style,l.searchInputWrapper);let $=document.createElement("div");$.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign($.style,l.searchIcon);let B=document.createElement("input");B.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(B.style,l.searchInput),B.onfocus=()=>{B.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",B.style.borderColor="rgba(26,115,232,0.3)"},B.onblur=()=>{B.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",B.style.borderColor="transparent"},B.oninput=O=>{i=O.target.value.toLowerCase(),k()},P.appendChild($),P.appendChild(B),E.appendChild(P);let K=document.createElement("div");Object.assign(K.style,l.chipsRow),la.forEach(O=>{let _=document.createElement("div");_.textContent=O.label,_.id=`tz-filter-${O.id}`,Object.assign(_.style,l.chip),O.id===r&&Object.assign(_.style,l.chipActive),_.onclick=()=>{j.playClick(),r=O.id,Array.from(K.children).forEach(D=>{Object.assign(D.style,l.chip)}),Object.assign(_.style,l.chipActive),k()},K.appendChild(_)}),E.appendChild(K),f.appendChild(E);let Z=document.createElement("div");Object.assign(Z.style,l.listContainer);let M=document.createElement("style");M.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",f.appendChild(M);let F=document.createElement("div");Object.assign(F.style,l.plannerWrapper,{display:"none"}),f.appendChild(Z),f.appendChild(F),m.onclick=()=>G("live"),y.onclick=()=>G("plan");function G(O){j.playClick(),O==="live"?(Object.assign(m.style,l.tabActive),Object.assign(y.style,l.tabBtn),y.style.borderBottomColor="transparent",Z.style.display="flex",E.style.display="flex",F.style.display="none",T()):(Object.assign(y.style,l.tabActive),Object.assign(m.style,l.tabBtn),m.style.borderBottomColor="transparent",F.style.display="flex",Z.style.display="none",E.style.display="none",b(),S())}function V(O){return O>=9&&O<17?{color:c.success,bg:c.successBg,label:"Aberto",icon:"\u{1F7E2}"}:O>=8&&O<9?{color:c.warning,bg:c.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:O>=17&&O<19?{color:c.warning,bg:c.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:c.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function q(O){n.includes(O)?n=n.filter(_=>_!==O):n.push(O),localStorage.setItem(Fo,JSON.stringify(n)),k(),j.playClick()}function k(){Z.innerHTML="";let O=new Date,_=Mt.filter(C=>{let I=C.name.toLowerCase().includes(i)||C.label.toLowerCase().includes(i),h=r==="all"||C.region===r;return I&&h});if(_.sort((C,I)=>{let h=n.includes(C.id),N=n.includes(I.id);return h&&!N?-1:!h&&N?1:C.name.localeCompare(I.name)}),_.length===0){Z.innerHTML=`
            ...
            `;return}_.forEach(C=>{let I=n.includes(C.id),h=O.toLocaleTimeString("pt-BR",{timeZone:C.zone,hour:"2-digit",minute:"2-digit"}),N=parseInt(h.split(":")[0]),Y=V(N),z=N<6||N>18,u=document.createElement("div");Object.assign(u.style,l.hubCard),I&&Object.assign(u.style,l.hubCardPinned);let v=I?"\u2605":"\u2606",w=I?"#F9AB00":"#DADCE0";u.innerHTML=`
                <div style="display:flex; alignItems:center; gap:16px;">
                    ...
                    <div>
                        <div style="font-size:15px; font-weight:600; color:${c.text}; letter-spacing:-0.2px;">${C.name}</div>
            ...
            `,u.onmouseenter=()=>{u.style.transform="translateY(-2px)",u.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},u.onmouseleave=()=>{u.style.transform="translateY(0)",u.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let L=u.querySelector(".cw-pin-btn");L.onmouseenter=()=>{L.style.backgroundColor="#F1F3F4"},L.onmouseleave=()=>{L.style.backgroundColor="transparent"},L.onclick=R=>{R.stopPropagation(),q(C.id)},u.onclick=()=>{a=C.id,G("plan")},Z.appendChild(u)});let D=document.createElement("div");D.style.height="20px",D.style.width="100%",Z.appendChild(D)}function S(){F.innerHTML="";let O=document.createElement("div"),_=document.createElement("label");_.textContent="Onde est\xE1 o cliente?",_.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let D=document.createElement("select");Object.assign(D.style,Gt),D.style.padding="14px",[...Mt].sort((ne,te)=>ne.name.localeCompare(te.name)).forEach(ne=>{let te=document.createElement("option");te.value=ne.id,te.textContent=`${ne.flag} ${ne.name} (${ne.zone})`,ne.id===a&&(te.selected=!0),D.appendChild(te)}),D.onchange=ne=>{a=ne.target.value,Q(),j.playClick()},O.appendChild(_),O.appendChild(D),F.appendChild(O);let I=document.createElement("div");Object.assign(I.style,l.timeComparisonRow);let h=document.createElement("div");Object.assign(h.style,l.timeCard),h.style.backgroundColor="#F8FAFF",h.style.borderColor="#E8F0FE",h.innerHTML=`
        ...
        `,I.appendChild(h),I.appendChild(N),F.appendChild(I);let Y=document.createElement("div");Y.id="cw-planner-status",Object.assign(Y.style,l.statusBadge),F.appendChild(Y);let z=document.createElement("div");Object.assign(z.style,{padding:"0 4px",marginTop:"12px"});let u=document.createElement("div");u.textContent="Arraste para simular o hor\xE1rio:",u.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let v=document.createElement("div");Object.assign(v.style,l.timelineContainer);let w=document.createElement("div");Object.assign(w.style,l.timelineTrack);let L=document.createElement("div");Object.assign(L.style,l.dayZone),w.appendChild(L);let R=document.createElement("input");R.type="range",R.min="0",R.max="1439",R.step="15",R.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let J=document.createElement("div");J.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",J.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",v.appendChild(w),v.appendChild(R),v.appendChild(J),z.appendChild(u),z.appendChild(v),F.appendChild(z);let U=h.querySelector("#cw-time-input-br"),ee=N.querySelector("#cw-time-display-client"),oe=N.querySelector("#cw-client-label");function Q(){let ne=Mt.find(Me=>Me.id===a);oe.textContent=`${ne.flag} ${ne.label} (${ne.zone})`;let te=s.getHours(),le=s.getMinutes(),We=`${String(te).padStart(2,"0")}:${String(le).padStart(2,"0")}`;U.value=We,R.value=te*60+le;let ot=s.toLocaleTimeString("pt-BR",{timeZone:ne.zone,hour:"2-digit",minute:"2-digit"});ee.textContent=ot;let qe=parseInt(ot.split(":")[0]);qe>=9&&qe<17?(Y.style.background=c.successBg,Y.style.color=c.success,Y.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):qe>=8&&qe<9||qe>=17&&qe<19?(Y.style.background=c.warningBg,Y.style.color=c.warning,Y.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(Y.style.background=c.errorBg,Y.style.color=c.error,Y.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}R.oninput=ne=>{let te=parseInt(ne.target.value);s.setHours(Math.floor(te/60)),s.setMinutes(te%60),Q()},U.oninput=ne=>{let[te,le]=ne.target.value.split(":");te&&le&&(s.setHours(parseInt(te)),s.setMinutes(parseInt(le)),Q())},Q()}function T(){k(),o||(o=setInterval(k,6e4))}function b(){o&&(clearInterval(o),o=null)}function A(){e=!e,ue(e,d,"cw-btn-timezone"),e?G("live"):b()}return document.body.appendChild(d),A}function Io(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let S=document.createElement("style");S.id="cw-lib-styles",S.innerHTML=`
        ...
        `,document.head.appendChild(S)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},r={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},s=document.createElement("div");s.id="library-popup",s.classList.add("cw-module-window"),Object.assign(s.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let l=pe(s,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:s},()=>k());s.appendChild(l);let d=document.createElement("div");Object.assign(d.style,r.container),s.appendChild(d);let p=document.createElement("div");Object.assign(p.style,r.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(S=>{let T=document.createElement("div");T.innerHTML=`${S.icon} ${S.label}`,T.id=`lib-tab-${S.id}`,Object.assign(T.style,r.tabBtn),S.id===o&&Object.assign(T.style,r.tabActive),T.onmouseenter=()=>j.playHover(),T.onclick=()=>K(S.id),p.appendChild(T)}),d.appendChild(p);let f=document.createElement("div");Object.assign(f.style,r.listContainer),d.appendChild(f);let g=document.createElement("div");g.className="cw-fab cw-tactile",Object.assign(g.style,r.fab),g.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',g.onmouseenter=()=>g.style.transform="scale(1.1)",g.onmouseleave=()=>g.style.transform="scale(1)",g.onclick=()=>M(),d.appendChild(g),a=document.createElement("div"),Object.assign(a.style,r.editorOverlay);let m=document.createElement("div");Object.assign(m.style,r.editorHeader),m.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let y=document.createElement("button");y.innerHTML="Cancelar",y.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",y.onclick=F,m.appendChild(y),a.appendChild(m);let E=document.createElement("div");Object.assign(E.style,r.editorBody),a.appendChild(E);let P=document.createElement("div");P.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let $=document.createElement("button");$.textContent="Salvar",$.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",$.onclick=G,P.appendChild($),a.appendChild(P),d.appendChild(a);let B=document.createElement("div");Object.assign(B.style,Ae),B.className="no-drag",s.appendChild(B),Te(s,B),document.body.appendChild(s);function K(S){j.playClick(),o=S,x.forEach(T=>{let b=document.getElementById(`lib-tab-${T.id}`);T.id===S?Object.assign(b.style,r.tabActive):Object.assign(b.style,r.tabBtn)}),Z()}function Z(){f.innerHTML="";let S=he.getSnippets(o);if(S.length===0){f.innerHTML=`
            ...
            `;return}S.forEach(T=>{let b=document.createElement("div");b.className="cw-lib-card",Object.assign(b.style,r.card),T.isCode&&(b.style.borderLeft=`4px solid ${i.primary}`,b.style.background="rgba(0, 122, 255, 0.02)");let A=T.content;if(T.isRich){let O=document.createElement("div");O.innerHTML=T.content;let _=O.querySelector("img");A=O.innerText.substring(0,150)+(O.innerText.length>150?"...":""),_&&(A="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+A)}b.innerHTML=`
                <div style="${q(r.cardHeader)}">
                    <div style="${q(r.cardTitle)}">${T.title}</div>
                ...
                <div style="${q(r.cardPreview)}; ${T.isCode?"font-family:'Roboto Mono', monospace; font-size:11px;":""}">${A}</div>
            ...
            `,b.onmouseenter=()=>{j.playHover()},b.querySelector(".cw-act-copy").onclick=O=>{if(O.stopPropagation(),j.playClick(),T.isRich){let _=new Blob([T.content],{type:"text/html"}),D=document.createElement("div");D.style.whiteSpace="pre-wrap",D.innerHTML=T.content;let C=new Blob([D.innerText],{type:"text/plain"}),I=[new ClipboardItem({"text/html":_,"text/plain":C})];navigator.clipboard.write(I)}else navigator.clipboard.writeText(T.content);X("Copiado!")},b.querySelector(".cw-act-edit").onclick=O=>{O.stopPropagation(),j.playClick(),M(T)},b.querySelector(".cw-act-del").onclick=async O=>{O.stopPropagation(),j.playClick(),await xe("Excluir este item?")&&(he.delete(T.id),Z(),X("Item exclu\xEDdo."))},f.appendChild(b)})}function M(S=null){n=S?S.id:null,E.innerHTML="",E.appendChild(V("title","T\xEDtulo / Nome",S?S.title:"")),o==="email"&&E.appendChild(V("subject","Assunto do Email",S?S.subject:""));let T="Conte\xFAdo";o==="email"&&(T="Corpo do Email (HTML)"),o==="note"&&(T="Texto da Nota (Reason)"),E.appendChild(V("content",T,S?S.content:"",{isRich:!0,isCode:S?S.isCode:!1})),m.querySelector("span").textContent=S?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let b=E.querySelector("input");b&&b.focus()},300)}function F(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function G(){let S=E.querySelector("#cw-inp-title"),T=E.querySelector("#cw-inp-content"),b=S.value.trim(),A=T.contentEditable==="true"?T.innerHTML:T.value.trim(),O=T.getAttribute("data-is-code")==="true";if(!b||!A||A==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let _={id:n,type:o,title:b,content:A,isCode:O,isRich:T.contentEditable==="true"};if(o==="email"){let D=E.querySelector("#cw-inp-subject").value.trim();if(!D){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}_.subject=D}$.textContent="Salvando...",await he.save(_),$.textContent="Salvar",F(),Z(),X("Salvo com sucesso!"),j.playSuccess()}function V(S,T,b,A={}){let O=document.createElement("div");Object.assign(O.style,r.inputGroup);let _=document.createElement("label");_.textContent=T,Object.assign(_.style,r.label);let D;if(A.isRich){let C=document.createElement("div");C.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",C.innerHTML=`
            ...
            `,D=document.createElement("div"),D.contentEditable="true",Object.assign(D.style,r.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),D.innerHTML=b||"",A.isCode&&(D.style.fontFamily="'Roboto Mono', monospace",D.style.backgroundColor="#F8F9FA",D.setAttribute("data-is-code","true")),C.querySelectorAll(".cw-toolbar-btn").forEach(I=>{I.onmouseenter=()=>j.playHover(),I.onmousedown=()=>j.playClick()}),C.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),D.focus()},C.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),D.focus()},C.querySelector(".cw-tb-code").onclick=I=>{let N=!(D.getAttribute("data-is-code")==="true");D.setAttribute("data-is-code",N),D.style.fontFamily=N?"'Roboto Mono', monospace":"inherit",D.style.backgroundColor=N?"rgba(0, 122, 255, 0.03)":i.surface,N?I.currentTarget.classList.add("active"):I.currentTarget.classList.remove("active"),D.focus()},C.querySelector(".cw-tb-img").onclick=async()=>{let I=await Xt("Cole a URL da imagem:");I&&(document.execCommand("insertImage",!1,I),D.querySelectorAll("img").forEach(N=>{N.style.maxWidth="100%",N.style.borderRadius="8px"}))},D.onpaste=I=>{let h=(I.clipboardData||I.originalEvent.clipboardData).items;for(let N of h)if(N.kind==="file"&&N.type.startsWith("image/")){I.preventDefault();let Y=N.getAsFile(),z=new FileReader;z.onload=u=>{let v=`<img src="${u.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,v)},z.readAsDataURL(Y)}},O.appendChild(_),O.appendChild(C)}else D=document.createElement("input"),D.type="text",Object.assign(D.style,r.input),D.value=b||"",O.appendChild(_);return D.id=`cw-inp-${S}`,D.onfocus=()=>{D.style.borderColor=i.primary,D.style.boxShadow=`0 0 0 2px ${i.primaryBg}`},D.onblur=()=>{D.style.borderColor=i.border,D.style.boxShadow="none"},O.appendChild(D),O}function q(S){return Object.entries(S).map(([T,b])=>`${T.replace(/[A-Z]/g,A=>"-"+A.toLowerCase())}:${b}`).join(";")}function k(){e=!e,ue(e,s,"cw-btn-library"),e&&Z()}return k}function Lo(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let x=document.createElement("style");x.id=a,x.innerHTML=`
    ...
    `;let l=c.querySelector("#cw-config-sound-toggle");l.onchange=x=>{j.setMuted(!x.target.checked),x.target.checked&&j.playClick()},s.appendChild(c);let d=document.createElement("div");d.className="cw-configs-section",d.innerHTML=`
    ...
    `,s.appendChild(d);function p(){e=!e,ue(e,n,"cw-btn-configs"),e&&j.playClick()}return document.body.appendChild(n),p}var ie={blue:"#1A73E8",red:"#D93025",yellow:"#F9AB00",green:"#1E8E3E",blueLight:"#E8F0FE",redLight:"#FCE8E6",yellowLight:"#FEF7E0",greenLight:"#E6F4EA",textPrimary:"#202124",textSecondary:"#5F6368",border:"#DADCE0",surface:"rgba(255, 255, 255, 0.8)",white:"#FFFFFF"},Ve={small:"8px",medium:"12px",large:"16px",pill:"100px"},ca={deep:"0 12px 40px rgba(0,0,0,0.12)",subtle:"0 4px 12px rgba(0,0,0,0.05)"},qo="cubic-bezier(0.4, 0, 0.2, 1)",vt=`all 0.3s ${qo}`,_o=()=>{if(document.getElementById("bau-form-global-styles"))return;let t=document.createElement("style");t.id="bau-form-global-styles",t.innerHTML=`
    ...
    .bau-popup {
      ...
      border-radius: ${Ve.large} !important; box-shadow: ${ca.deep} !important;
    ...
    .bau-progress-step {
      ...
      background-color: #F1F3F4; color: ${ie.textSecondary};
      font-weight: 700; font-size: 14px; border: 2px solid #F1F3F4;
      transition: ${vt}; position: relative;
    }
    .bau-progress-step.active { background-color: ${ie.blueLight}; color: ${ie.blue}; border-color: ${ie.blue}; transform: scale(1.1); }
    .bau-progress-step.completed { background-color: ${ie.greenLight}; color: ${ie.green}; border-color: ${ie.green}; }
    
    /* --- CONTENT & STEPS --- */
    .bau-content { padding: 32px; overflow-y: auto; flex-grow: 1; }
    .bau-step { display: none; animation: fadeIn 0.5s ${qo}; }
    .bau-step.active { display: block; }

    .bau-card {
      background: ${ie.white}; border-radius: ${Ve.medium};
      padding: 24px; border: 1px solid ${ie.border};
      margin-bottom: 24px;
    }
    ...
    .bau-fallback-card {
        background-color: ${ie.yellowLight};
    ...
    .bau-chip {
      padding: 8px 16px;
      border-radius: ${Ve.pill};
      background-color: ${ie.blueLight};
      color: ${ie.blue};
      font-size: 12px;
      font-weight: 600;
      cursor: pointer;
  ...
  `,document.head.appendChild(t)};var Mo=[{id:"gtm",text:"\u{1F680} Instala\xE7\xE3o GTM",reason:"Nova Implementa\xE7\xE3o",task:"Setup GTM"},{id:"ecw4",text:"\u{1F6D2} ECW4 Purchase",reason:"Nova Implementa\xE7\xE3o",task:"Google Ads Conversion"},{id:"consent",text:"\u{1F6E1}\uFE0F Consent Mode",reason:"Corre\xE7\xE3o de Tag",task:"GA4 Events"}];function No(){_o();let t=!1,e=null,o=1,a=3,n=document.createElement("div");n.id="bau-form-popup",n.className="bau-popup cw-module-window",n.style.display="none";let r=pe(n,"BAU Form","v1.2.0","Solicite a abertura de casos BAU em um fluxo guiado.",{googleLine:null},()=>D());n.appendChild(r);let s=document.createElement("div");s.className="bau-progress-indicator",n.appendChild(s);let c=document.createElement("div");c.className="bau-content",n.appendChild(c);let l=document.createElement("form");c.appendChild(l);let d=document.createElement("div");d.className="bau-step active",d.id="bau-step-1";let p=document.createElement("div");p.className="bau-card bau-context-card";let x=document.createElement("div");x.className="bau-header-banner",p.appendChild(x);let f=document.createElement("div");f.innerHTML=`
    ...
    `,p.appendChild(f),d.appendChild(p);let g=document.createElement("div");g.id="bau-dynamic-fallback",g.className="bau-card bau-fallback-card",g.style.display="none",d.appendChild(g),l.appendChild(d);let m=document.createElement("div");m.className="bau-step",m.id="bau-step-2";let y=document.createElement("div");y.className="bau-card";let E=document.createElement("label");E.className="bau-label",E.textContent="A\xE7\xF5es R\xE1pidas (Preenche Motivo e Task)",y.appendChild(E);let P=document.createElement("div");P.className="bau-chips-container",Mo.forEach(C=>{let I=document.createElement("div");I.className="bau-chip",I.textContent=C.text,I.dataset.id=C.id,I.onclick=()=>{P.querySelectorAll(".bau-chip").forEach(h=>h.classList.remove("active")),I.classList.add("active"),j.playClick(),l.querySelector('select[name="reason"]').value=C.reason,l.querySelector('select[name="taskType"]').value=C.task},P.appendChild(I)}),y.appendChild(P);let $=document.createElement("div");$.className="bau-grid-2",$.style.marginTop="16px",$.innerHTML=`
        <div>
    ...
    `,y.appendChild($),m.appendChild(y),l.appendChild(m);let B=document.createElement("div");B.className="bau-step",B.id="bau-step-3";let K=document.createElement("div");K.className="bau-card";let Z=document.createElement("label");Z.className="bau-label",Z.textContent="Justificativa / Descri\xE7\xE3o",K.appendChild(Z);let M=document.createElement("textarea");M.name="description",M.required=!0,M.className="bau-textarea",M.placeholder="Descreva detalhadamente o que precisa ser feito...",M.style.minHeight="120px",K.appendChild(M);let F=document.createElement("label");F.className="bau-label",F.textContent="Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",F.style.marginTop="20px",K.appendChild(F);let G=document.createElement("div");G.className="bau-availability-container";for(let C=1;C<=3;C++){let I=document.createElement("input");I.type="datetime-local",I.name=`availability_${C}`,I.required=C===1,I.className="bau-input",G.appendChild(I)}K.appendChild(G);let V=document.createElement("div");V.className="bau-availability-hint",K.appendChild(V),B.appendChild(K),l.appendChild(B);let q=document.createElement("div");q.className="bau-footer";let k=document.createElement("button");k.type="button",k.className="bau-btn-secondary",k.textContent="Voltar",q.appendChild(k);let S=document.createElement("button");S.type="button",S.className="bau-btn-primary",S.textContent="Pr\xF3ximo",q.appendChild(S);let T=document.createElement("button");T.type="submit",T.className="bau-btn-submit",T.innerHTML="<span>\u{1F4DD}</span> Enviar para o TL",T.style.display="none",q.appendChild(T),n.appendChild(q),document.body.appendChild(n);function b(){l.querySelectorAll(".bau-step").forEach((C,I)=>{C.classList.toggle("active",I+1===o)}),s.innerHTML="";for(let C=1;C<=a;C++){let I=document.createElement("div");I.className=`bau-progress-step ${C===o?"active":C<o?"completed":""}`,I.textContent=C,s.appendChild(I)}k.style.display=o>1?"inline-block":"none",S.style.display=o<a?"inline-block":"none",T.style.display=o===a?"inline-block":"none"}function A(C){let I=l.querySelectorAll(`#bau-step-${C} [required]`);for(let h of I)if(!h.value.trim()){let N=h.closest("div").querySelector(".bau-label");return X(`Erro: O campo '${N?.textContent||h.name}' \xE9 obrigat\xF3rio.`,"error"),h.classList.add("input-error"),setTimeout(()=>h.classList.remove("input-error"),3e3),!1}return!0}S.onclick=()=>{A(o)&&(o++,b(),j.playClick())},k.onclick=()=>{o>1&&(o--,b(),j.playClick())};async function O(){let C=await we()||{};e=C,_(C)}function _(C){if(!C)return;document.getElementById("bau-adv-name").textContent=C.advName||"Anunciante Desconhecido",document.getElementById("bau-adv-details").textContent=`CID: ${C.cid||"N/A"} \u2022 AM: ${C.amName||"N/A"}`;let I=document.getElementById("bau-all-data");I&&(I.innerHTML="",[{label:"Email",value:C.email},{label:"Idioma",value:C.language},{label:"Programa",value:C.salesProgram},{label:"Speakeasy ID",value:C.seId,isSpeakeasy:!0},{label:"Timezone",value:C.timezone}].forEach(z=>{let u=document.createElement("div");u.style.display="flex",u.style.alignItems="center",u.style.gap="8px",u.style.marginBottom="4px";let v=document.createElement("b");v.textContent=`${z.label}:`,u.appendChild(v);let w=document.createElement("span");if(w.textContent=z.value||"N/A",z.isSpeakeasy&&(w.id="bau-context-se-id"),u.appendChild(w),z.isSpeakeasy){let L=document.createElement("button");L.type="button",L.innerHTML="\u2728 Auto Busca",L.style.cssText="font-size: 10px; font-weight: 700; color: #fff; background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); border-radius: 100px; padding: 2px 10px; cursor: pointer; transition: all 0.2s; margin-left: 4px;",L.onmouseenter=()=>L.style.background="rgba(255,255,255,0.3)",L.onmouseleave=()=>L.style.background="rgba(255,255,255,0.2)",L.onclick=async R=>{R.preventDefault(),await Je("bau-context-se-id");let J=document.getElementById("bau-context-se-id").value||document.getElementById("bau-context-se-id").textContent;e.seId=J},u.appendChild(L)}I.appendChild(u)})),V.innerHTML=`\u2139\uFE0F Lembrete: Os hor\xE1rios s\xE3o baseados no seu fuso hor\xE1rio atual (${C.timezone||"n\xE3o detectado"}). Fornecer mais de uma op\xE7\xE3o aumenta a chance de agendamento r\xE1pido.`;let N=[{key:"advName",label:"Nome do Anunciante"},{key:"cid",label:"Customer ID (CID)"},{key:"amName",label:"Account Manager"},{key:"email",label:"Email de Contato"}].filter(Y=>!C[Y.key]||C[Y.key]==="N/A"||C[Y.key].trim()==="---");if(N.length>0){g.innerHTML=`
            ...
            `;let Y=g.querySelector("#bau-fallback-grid");N.forEach(z=>{let u=document.createElement("div");u.style.position="relative";let v=document.createElement("div");v.style.display="flex",v.style.alignItems="center",v.style.justifyContent="space-between";let w=document.createElement("label");if(w.className="bau-label",w.textContent=z.label,v.appendChild(w),z.key==="seId"){let R=document.createElement("button");R.type="button",R.innerHTML="\u2728 Auto Busca",R.style.cssText=`font-size: 11px; font-weight: 700; color: ${ie.blue}; background: ${ie.blueLight}; border: none; border-radius: 100px; padding: 4px 12px; cursor: pointer; transition: all 0.2s; margin-top: 12px;`,R.onclick=J=>{J.preventDefault(),Je(`fallback-input-${z.key}`)},v.appendChild(R)}u.appendChild(v);let L=document.createElement("input");L.type="text",L.name=z.key,L.id=`fallback-input-${z.key}`,L.className="bau-input",L.placeholder=`Preencher ${z.label}...`,L.required=!0,u.appendChild(L),Y.appendChild(u)}),g.style.display="block",x.style.background="transparent",x.innerHTML="<span>\u26A0\uFE0F</span> Dados ausentes! Por favor, preencha os campos no card abaixo para continuar."}else g.style.display="none",x.style.background="transparent",x.innerHTML="<span>\u2705</span> Dados do CRM carregados com sucesso!"}l.onsubmit=async C=>{if(C.preventDefault(),!A(a))return;let I=T.innerHTML;T.disabled=!0,T.innerHTML="Enviando...";let h=new FormData(l),N=Object.fromEntries(h.entries()),Y={caseId:e.caseId||"",cid:N.cid||e.cid||"",seId:N.seId||e.seId||"",advName:N.advName||e.advName||"",email:N.email||e.email||"",language:N.language||e.language||"",amName:N.amName||e.amName||"",salesProgram:N.salesProgram||e.salesProgram||"",site:N.site||e.site||"",timezone:N.timezone||e.timezone||"",reason:N.reason,taskType:N.taskType,description:N.description,availability:`${N.availability_1||""} | ${N.availability_2||""} | ${N.availability_3||""}`.trim()};try{await io(Y,e.agentEmail||"anon"),j.playSuccess(),X("Escalonamento enviado com sucesso!","success"),l.reset(),P.querySelectorAll(".bau-chip.active").forEach(z=>z.classList.remove("active")),o=1,b(),D()}catch(z){console.error("Erro BAU:",z),X("Falha ao enviar: "+(z.message||"Erro desconhecido"),"error")}finally{T.disabled=!1,T.innerHTML=I}};async function D(){t=!t,n.style.display=t?"flex":"none",t&&(o=1,b(),await O()),ue(t,n,"cw-btn-bauform")}return b(),D}function da(){if(window.techSolInitialized){Et();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{$t();try{j.initGlobalListeners(),j.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}fe.fetchTips(),Et();let e=bo(),o=yo(),a=wo(),n=Co(),i=Oo(),r=Io(),s=Lo(),c=No(),l=Eo();ro({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:r,toggleConfigs:s,toggleBAUForm:c,broadcastControl:l}),setTimeout(()=>{fe.logEvent("App","Start","Session Start"),Ao(),setTimeout(()=>{ko(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}da();})();
