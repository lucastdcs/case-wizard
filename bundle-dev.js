...
@media (prefers-reduced-motion: reduce) {
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Pa={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Bo={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Po={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var zo=!1;function lr(){if(zo||document.getElementById("techsol-google-styles"))return;let e=document.createElement("style");e.id="techsol-google-styles",e.innerHTML=`
    ...
    `,document.head.appendChild(e),zo=!0}function Go(e){lr(),e.classList.remove("google-animate-click"),e.offsetWidth,e.classList.add("google-animate-click"),setTimeout(()=>{e.classList.remove("google-animate-click")},600)}async function cr(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let a=e.querySelector(".cursor");await ue(200);for(let o=0;o<t.length;o++){let n=t.charAt(o),i=document.createElement("span");i.textContent=n,a&&a.parentNode===e?a.before(i):e.appendChild(i);let r=Math.floor(Math.random()*60)+30;o===0&&(r=150),o>t.length-3&&(r=30),await ue(r)}await ue(600),a&&(a.style.display="none")}async function Ga(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await ue(200);let t=await jt(),a=Lo(t),o=e.querySelector("#w-icon"),n=e.querySelector("#p1"),i=e.querySelector("#p2"),r=e.querySelector("#p3"),l=e.querySelector("#p-sextou");o&&(o.innerHTML=a.icon),n&&(n.textContent=a.prefix),r&&(r.textContent=a.suffix),await ue(300);let c=o?o.querySelector("svg"):null;if(c&&(c.style.opacity="1",c.style.transform="scale(1)"),await ue(400),n&&(n.style.opacity="1"),S.playStartup(),i&&await cr(i,a.name),r&&(r.style.opacity="1",r.style.transform="translateY(0)"),a.isFriday&&l){await ue(400),l.style.display="block",l.offsetWidth;let g=l.querySelector(".sextou-badge");g&&(g.style.opacity="1",g.style.transform="scale(1)")}await ue(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await ue(900),e.parentNode&&e.parentNode.removeChild(e)}}function jo(e){if(!e)return;let t=e.getBoundingClientRect(),a=window.innerWidth,o=window.innerHeight,n=24,i=a-t.width-n,r=o-t.height-n,l=parseFloat(e.style.left)||t.left,c=parseFloat(e.style.top)||t.top,g=St(l,n,i),u=St(c,n,r);if(g!==l||u!==c){let v=e.style.transition;e.style.transition="left 0.3s var(--cw-ease-elastic), top 0.3s var(--cw-ease-elastic)",e.style.left=`${g}px`,e.style.top=`${u}px`,setTimeout(()=>{e.style.transition=v},300)}}var rt={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function st(e,t){t.onmousedown=a;function a(o){o.stopPropagation(),o.preventDefault();let n=e.style.transition;e.style.transition="none";let i=o.clientX,r=o.clientY,l=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),c=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),g=i,u=r,v=!1;function d(w){g=w.clientX,u=w.clientY,v||(window.requestAnimationFrame(()=>{p(),v=!1}),v=!0)}function p(){let w=l+(g-i),E=c+(u-r);w>360&&(e.style.width=w+"px"),E>300&&(e.style.height=E+"px")}function _(){document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",_),setTimeout(()=>{e.style.transition=n},50)}document.addEventListener("mousemove",d),document.addEventListener("mouseup",_)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function la(e){if(!e||e==="N/A"||e==="undefined")return"Data indispon\xEDvel";if(String(e).includes(" | "))return e.split(" | ").map(t=>la(t.trim())).filter(t=>t!=="Data indispon\xEDvel").join(" | ");try{let t=new Date(e);if(isNaN(t.getTime()))return"Data indispon\xEDvel";let a=t.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),o=t.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`${a} \xE0s ${o}`}catch{return"Data indispon\xEDvel"}}function Ho(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,a=>t[a]?t[a]:"")}function Uo(){let e=document.createElement("div");return e.className="cw-dialog-overlay",Object.assign(e.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:Oe.TOP,opacity:0,transition:"opacity 0.3s ease"}),e}function Vo(){let e=document.createElement("div");return Object.assign(e.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s var(--cw-ease-spring)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),e}function Fe(e,t={}){return new Promise(a=>{let o=Uo(),n=Vo(),i=t.danger?"#FF3B30":"#007AFF",r=se()==="es"?"Eliminar":"Excluir",l=t.confirmText||(t.danger?r:"Confirmar");n.innerHTML=`
        ...
        `,o.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{o.style.opacity=1,n.style.transform="scale(1)"});let c=v=>{o.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{o.remove(),a(v)},300)},g=n.querySelector("#cw-conf-cancel"),u=n.querySelector("#cw-conf-ok");[g,u].forEach(v=>v.onmouseenter=()=>S.playHover()),g.onclick=()=>{S.playClick(),c(!1)},u.onclick=()=>{S.playClick(),c(!0)}})}function ca(e,t=""){return new Promise(a=>{let o=Uo(),n=Vo();n.innerHTML=`
        ...
        <div style="margin-bottom: 32px;">
            <a href="${It}" target="_blank" rel="noopener noreferrer" id="cw-feedback-link" style="
...
Abrir\xE9 un caso en BAU para el d\xEDa solicitado y pedir\xE9 la inactivaci\xF3n del mismo.`}};var Qo={pt:{searching:"Buscando ID...",readingMessage:"Lendo mensagem...",idFound:e=>`ID Localizado: ${e}`,noIdFound:"Nenhum ID encontrado.",notFound:"N\xE3o encontrado",processingError:"Erro ao processar."},es:{searching:"Buscando ID...",readingMessage:"Leyendo mensaje...",idFound:e=>`ID Encontrado: ${e}`,noIdFound:"Ning\xFAn ID encontrado.",notFound:"No encontrado",processingError:"Error al procesar."}};function Ft(e){let t=se();return Qo[t]?.[e]??Qo.pt[e]}var en="cw-automation-styles";if(!document.getElementById(en)){let e=document.createElement("style");e.id=en,e.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let v=c.querySelector(".cw-hero-grid"),d=c.querySelector(".cw-acc-container"),p=c.querySelector(".cw-results-container"),_=c.querySelector(".cw-search-input");ia(c,".cw-acc-header, .cw-task-item");let w=c.querySelector(".cw-status-bar"),E=c.querySelector(".cw-status-text"),M=c.querySelector(".cw-footer-icons");function A(T,C){return N=>{if(N.target.closest(".cw-step-btn-hero, .cw-step-btn-list"))return;let k=o[T]?o[T].count:0;h(T,k>0?-k:1,C)}}i.forEach(([T,C])=>{let N=n(C.name),k=document.createElement("div");k.className="cw-hero-card",k.id=`hero-${T}`,k.style.setProperty("--hero-color",N.color),k.innerHTML=`
        ...
        `,k.onclick=A(T,C),k.querySelector(".minus").onclick=()=>h(T,-1,C),k.querySelector(".plus").onclick=()=>h(T,1,C),k.tabIndex=0,k.setAttribute("role","button"),k.setAttribute("aria-pressed","false"),k.setAttribute("aria-label",C.name),k.addEventListener("keydown",F=>{(F.key==="Enter"||F.key===" ")&&(F.preventDefault(),k.click())}),k}Object.entries(r).forEach(([T,C])=>{let N=document.createElement("div");N.className="cw-acc-group";let k=document.createElement("div");k.className="cw-acc-header",k.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${C.brand.color}"></div>
                ${T}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,k.tabIndex=0,k.setAttribute("role","button"),k.setAttribute("aria-expanded","false"),k.onclick=()=>{d.querySelectorAll(".cw-acc-group.open").forEach(z=>{z!==N&&(z.classList.remove("open"),z.querySelector(".cw-acc-header")?.setAttribute("aria-expanded","false"))});let j=N.classList.toggle("open");k.setAttribute("aria-expanded",String(j))},k.addEventListener("keydown",j=>{(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),k.click())});let F=document.createElement("div");F.className="cw-acc-body",C.tasks.forEach(j=>{let z=D(j.key,j);F.appendChild(z)}),N.appendChild(k),N.appendChild(F),d.appendChild(N)});function h(T,C,N){o[T]||(o[T]={count:0,data:N,brand:n(N.name)}),o[T].count+=C,o[T].count<=0&&delete o[T],q(),$(),e&&e()}function q(){i.forEach(([F])=>{let j=v.querySelector(`#hero-${F}`);if(!j)return;let z=o[F];z?(j.classList.add("active"),j.setAttribute("aria-pressed","true"),j.querySelector(".cw-step-val").textContent=z.count,j.querySelector(".cw-step-val").style.color=j.dataset.color,j.classList.toggle("ts-success",Va(F,a))):(j.classList.remove("active"),j.setAttribute("aria-pressed","false"),j.classList.remove("ts-success"))}),c.querySelectorAll(".cw-task-item").forEach(F=>{let j=F.dataset.id,z=o[j];z?(F.classList.add("selected"),F.setAttribute("aria-pressed","true"),F.querySelector(".cw-step-val").textContent=z.count,F.classList.toggle("ts-success",Va(j,a))):(F.classList.remove("selected"),F.setAttribute("aria-pressed","false"),F.classList.remove("ts-success"))});let C=Object.keys(o),N=0,k=[];if(C.forEach(F=>{let j=o[F];N+=j.count;for(let z=0;z<j.count;z++)k.length<6&&k.push(j.brand)}),N>0){w.classList.add("visible");let F=N>1?t("acoes_plural"):t("acao_singular"),j=N>1?t("definidas_plural"):t("definida_singular");E.textContent=`${N} ${F} ${j}`,M.innerHTML="",k.forEach(z=>{let K=document.createElement("div");K.className="cw-mini-icon-status",K.innerHTML=Ct[z.icon]||Ct.default;let ie=K.querySelector("svg");ie&&(ie.style.width="14px",ie.style.height="14px"),M.appendChild(K)})}else w.classList.remove("visible"),E.textContent="",M.innerHTML=""}_.addEventListener("input",T=>{let C=T.target.value.toLowerCase();if(C.length>0){d.style.display="none",p.style.display="block",p.innerHTML="";let N=!1;Object.entries(et).forEach(([k,F])=>{if(F.name.toLowerCase().includes(C)){N=!0;let j=D(k,F);o[k]&&(j.classList.add("selected"),j.setAttribute("aria-pressed","true"),j.querySelector(".cw-step-val").textContent=o[k].count),p.appendChild(j)}}),N||(p.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else d.style.display="block",p.style.display="none"});function $(){let T={};u.querySelectorAll(".cw-input-field").forEach(F=>{T[F.id]=F.value}),u.innerHTML="";let C=Object.keys(o),N=!1;if(C.length===0){u.appendChild(Bt({icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><path d="M21 15l-5-5L5 21"></path></svg>',title:t("selecione_tarefas")})),g.style.display="none";return}let k=document.createElement("div");k.className="cw-info-banner",k.innerHTML=`
            <span style="font-size:14px">\u2139\uFE0F</span>
            <span>
                Os screenshots seguem as diretrizes atuais do Win Criteria e pol\xEDticas de Tag Support.
            </span>
        `,u.appendChild(k),C.forEach(F=>{let j=o[F].data,z=o[F].count,K=o[F].brand,ie=Va(F,a),le=a.screenshotMode||"implementation",W=Ko(j,le,a.currentLang);if(W.length>0||ie){N=!0;for(let ee=1;ee<=z;ee++){let H=document.createElement("div");H.className="cw-screen-card",ie&&H.classList.add("ts-success"),H.style.setProperty("--brand-color",K.color),H.style.setProperty("--brand-bg",K.bg),H.style.setProperty("--brand-shadow",K.color+"40");let oe=document.createElement("div");oe.className="cw-card-header";let R=document.createElement("div");R.className="cw-card-icon",R.innerHTML=Ct[K.icon]||Ct.default;let J=document.createElement("div");J.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let te=document.createElement("input");te.className="cw-card-title-input",te.id=`name-${F}-${ee}`,te.value=`${j.name}${z>1?" #"+ee:""}`,te.title=t("renomear_tooltip");let V=document.createElement("span");if(V.className="cw-edit-hint",V.innerHTML=t("renomear_hint"),J.appendChild(te),J.appendChild(V),oe.appendChild(R),oe.appendChild(J),H.appendChild(oe),ie){let ae=document.createElement("div");ae.className="cw-ts-disclaimer-box",ae.innerHTML=`
                <span>${t("ts_disclaimer")}</span>
                <button class="cw-btn-ts-force">${t("incluir_mesmo_assim")}</button>
            `,ae.querySelector("button").onclick=()=>{a.toggleForcedScreenshot(F,!0)},H.appendChild(ae)}else W.forEach((ae,s)=>{let y=document.createElement("div");y.className="cw-input-group";let L=document.createElement("label");L.className="cw-input-label",L.textContent=ae;let b=document.createElement("input");b.className="cw-input-field",b.id=`screen-${F}-${ee}-${s}`,b.placeholder=t("cole_link_placeholder"),b.setAttribute("autocomplete","off"),T[b.id]&&(b.value=T[b.id],b.value.trim().length>5&&b.classList.add("filled")),b.addEventListener("input",()=>{b.value.trim().length>5?b.classList.add("filled"):b.classList.remove("filled")});let f=document.createElement("div");f.className="cw-input-check",f.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',y.appendChild(L),y.appendChild(b),y.appendChild(f),H.appendChild(y)});u.appendChild(H)}}}),g.style.display=N?"block":"none"}return{selectionElement:c,screenshotsElement:g,updateSubStatus:()=>$(),getCheckedElements:()=>Object.keys(o).map(T=>({value:T,count:o[T].count})),setTaskCount:(T,C)=>{o[T]&&delete o[T],C>0&&et[T]&&h(T,C,et[T])},toggleTask:(T,C=!0)=>{let N=o[T];C&&!N?h(T,1,et[T]):!C&&N&&h(T,-N.count,et[T])},setLanguage:T=>{t=T;let C=c.querySelector(".js-hero-title");C&&(C.textContent=t("acesso_rapido"));let N=c.querySelector(".cw-search-input");N&&(N.placeholder=t("buscar_catalogo")),$(),q()},reset:()=>{for(let T in o)delete o[T];_.value="",d.style.display="block",p.style.display="none",q(),$()}}}var yr={marginTop:"24px",marginBottom:"16px",padding:"20px",background:"#fff9e6",borderRadius:"20px",border:"1.5px solid #fbbc0540",display:"none",boxShadow:"0 4px 12px rgba(251, 188, 5, 0.05)"},wr={fontSize:"12px",color:"#b06000",marginTop:"8px",lineHeight:"1.4"},Sr={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1.5px solid #dadce0",fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",background:"#fff"},Er={display:"flex",gap:"20px",marginBottom:"12px"};function dn(e){let t=document.createElement("div");t.id="tag-support-container",Object.assign(t.style,yr);let a=document.createElement("label");a.className="js-ts-main-label",a.textContent=e("utilizou_tag_support"),Object.assign(a.style,Pa,{marginTop:"0"});let o=document.createElement("div");Object.assign(o.style,Er);let n=document.createElement("input");n.type="radio",n.name="ts_usage_mod",n.value="Sim",Object.assign(n.style,Ha);let i=document.createElement("label");i.className="js-ts-sim-label",i.textContent=e("sim");let r=document.createElement("div");Object.assign(r.style,{display:"flex",alignItems:"center"}),r.appendChild(n),r.appendChild(i);let l=document.createElement("input");l.type="radio",l.name="ts_usage_mod",l.value="N\xE3o",l.checked=!0,Object.assign(l.style,Ha);let c=document.createElement("label");c.className="js-ts-nao-label",c.textContent=e("nao");let g=document.createElement("div");Object.assign(g.style,{display:"flex",alignItems:"center"}),g.appendChild(l),g.appendChild(c),o.appendChild(r),o.appendChild(g);let u=document.createElement("div");u.style.display="block";let v=document.createElement("label");v.className="js-ts-reason-label",v.textContent=e("motivo_ts"),Object.assign(v.style,Pa,{fontSize:"12px"});let d=document.createElement("input");d.type="text",Object.assign(d.style,Sr);let p=document.createElement("div");p.className="js-ts-warning",p.innerHTML=`\u26A0\uFE0F <strong>${e("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" rel="noopener noreferrer" style="color:#e37400; text-decoration:underline;">${e("link_aqui")}</a>`,Object.assign(p.style,wr),u.appendChild(v),u.appendChild(d),u.appendChild(p),t.appendChild(a),t.appendChild(o),t.appendChild(u),n.onchange=()=>{S.playClick(),u.style.display="none",Y.setTagSupportUsed(!0)},l.onchange=()=>{S.playClick(),u.style.display="block",Y.setTagSupportUsed(!1)};function _(A,D){if(t.style.display="none",!A||!D||D.length===0)return;D.some(q=>q==="ads_conversion_tracking"||q==="ads_enhanced_conversions")?t.style.display="block":(M(),Y.setTagSupportUsed(!1))}function w(){if(t.style.display==="none")return"";let A=`<br><b>${e("tag_support_output_label")}</b> ${n.checked?`\u2705 ${e("sim")}`:`\u274C ${e("nao")}`}`;return l.checked&&d.value.trim()!==""&&(A+=`<br><b>${e("motivo_output_label")}</b> ${d.value}`),A+="<br>",A}function E(A){e=A,a.textContent=e("utilizou_tag_support"),v.textContent=e("motivo_ts"),i.textContent=e("sim"),c.textContent=e("nao"),p.innerHTML=`\u26A0\uFE0F <strong>${e("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" rel="noopener noreferrer" style="color:#b06000; text-decoration:underline;">${e("link_aqui")}</a>`}function M(){t.style.display="none",l.checked=!0,n.checked=!1,u.style.display="block",d.value=""}return{element:t,updateVisibility:_,getOutput:w,setLanguage:E,reset:M}}var Wa="cw_notes_parking_lot",ba="cw_notes_emergency_save";var je={getAll:()=>{try{return JSON.parse(localStorage.getItem(Wa)||"[]")}catch{return[]}},save:e=>{let t=je.getAll(),a={id:Date.now().toString(),timestamp:new Date().toISOString(),...e};return t.unshift(a),t.length>5&&t.pop(),localStorage.setItem(Wa,JSON.stringify(t)),a},delete:e=>{let t=je.getAll();return t=t.filter(a=>a.id!==e),localStorage.setItem(Wa,JSON.stringify(t)),t},getCount:()=>je.getAll().length,saveEmergency:e=>{let t={timestamp:Date.now(),data:e};localStorage.setItem(ba,JSON.stringify(t))},getEmergency:()=>{try{let e=localStorage.getItem(ba);if(!e)return null;let t=JSON.parse(e);return Date.now()-t.timestamp>432e5?(localStorage.removeItem(ba),null):!t.data||!t.data.subStatus?null:t.data}catch{return null}},clearEmergency:()=>{localStorage.removeItem(ba)}};var pn="cw_case_streak_v1",Cr=[5,10,15,20,25,30,40,50];function un(){let e=new Date;return`${e.getFullYear()}-${e.getMonth()+1}-${e.getDate()}`}function Ya(){try{let e=JSON.parse(localStorage.getItem(pn)||"{}");return e.date===un()&&e.count||0}catch{return 0}}function mn(){let e=Ya()+1;try{localStorage.setItem(pn,JSON.stringify({date:un(),count:e}))}catch{}return{count:e,isMilestone:Cr.includes(e)}}var gn={pt:{milestoneToast:e=>`\u{1F525} ${e} casos hoje!`,quickSearch:"Busca r\xE1pida: Ctrl/Cmd+K",casesToday:"Casos conclu\xEDdos hoje",drag:"Arrastar",cancel:"Cancelar",cancelledToast:"Cancelado!"},es:{milestoneToast:e=>`\u{1F525} \xA1${e} casos hoy!`,quickSearch:"B\xFAsqueda r\xE1pida: Ctrl/Cmd+K",casesToday:"Casos completados hoy",drag:"Arrastrar",cancel:"Cancelar",cancelledToast:"\xA1Cancelado!"}};function At(e){let t=se();return gn[t]?.[e]??gn.pt[e]}var ye={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00",teal:"#00BFA5",pink:"#F48FB1",gray:"#9AA0A6"},Xa=50,Ka=null;function fa(e){let t=document.getElementById("cw-btn-notes");if(!t)return;let a=t.querySelector(".cw-dot-dirty");e?a||(a=document.createElement("div"),a.className="cw-dot-dirty",t.appendChild(a)):a&&a.remove()}function bn(){let e=document.getElementById("cw-streak-badge"),t=document.getElementById("cw-streak-count");if(!e||!t)return;let a=Ya();t.textContent=a,e.classList.toggle("visible",a>0);let o=document.querySelector(".cw-pill");o&&(o.classList.toggle("has-streak",a>0),o.classList.toggle("streak-tier-2",a>=5&&a<15),o.classList.toggle("streak-tier-3",a>=15&&a<30),o.classList.toggle("streak-tier-4",a>=30))}function fn(){let{count:e,isMilestone:t}=mn();if(bn(),t){let a=document.querySelector(".cw-pill");S.playSuccess(),a&&Go(a),X(At("milestoneToast")(e))}}function hn(e,t){let a="cw-command-center-style";if(!document.getElementById(a)){let h=document.createElement("style");h.id=a,h.innerHTML=`
            ...
            .cw-pill.collapsed {
                width: ${Xa}px !important;
                height: ${Xa}px !important;
                padding: 0 !important;
                gap: 0 !important;
...
`.replace(/\n/g,"<br>");ea(C);let N=await xa();N?(N.innerText.trim()===""&&(N.innerHTML=""),document.execCommand("insertHTML",!1,C),ha(N),S.playSuccess(),X(ct("noteGeneratedToast"))):X(ct("copiedOpenNoteToast"))},t}var En="cw_user_prefs_v1",Qa="cw_user_prefs_pending_v1",Ja=!1,ta=null;function Mt(){try{let e=localStorage.getItem(En),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}function Sn(e){try{localStorage.setItem(En,JSON.stringify(e))}catch(t){console.warn("N\xE3o consegui gravar as prefer\xEAncias localmente:",t)}}function Za(e){try{e?localStorage.setItem(Qa,"1"):localStorage.removeItem(Qa)}catch{}}function Ar(){try{return localStorage.getItem(Qa)==="1"}catch{return!1}}var dt={get(e,t=null){let a=Mt();return e in a?a[e]:t},async set(e,t){let a=Mt();a[e]=t,Sn(a);let o=Ie();if(!o)return Za(!0),{saved:!0,synced:!1};Ja=!0;let n=!1;try{n=await me.saveUserPrefs(a,o)}catch(i){console.warn("Falha ao salvar prefer\xEAncias na nuvem:",i)}finally{Za(!n),setTimeout(()=>{Ja=!1},2e3)}return{saved:!0,synced:n}},sync(){return ta||(ta=(async()=>{let e=Ie();if(!e)return Mt();try{if(Ar()){let a=Mt(),o=await me.saveUserPrefs(a,e);return Za(!o),a}let t=await me.getUserPrefs(e);if(t&&typeof t=="object"&&!Ja){let a=Mt();JSON.stringify(t)!==JSON.stringify(a)&&Sn(t)}}catch(t){console.warn("Prefer\xEAncias indispon\xEDveis; seguindo com o cache local.",t)}finally{ta=null}return Mt()})(),ta)}};var aa="shortcuts",Cn="shortcutsSortByUsage",kn="cw_shortcut_usage_v1",mt=8,kr=[{id:"sc_default_ni_attempted",kind:"note",label:"NI Attempted \u2014 In\xEDcio 2 Day Rule",alias:"2day inicio",payload:{caseType:"bau",status:"NI",subStatus:"NI_Attempted_Contact",scenarios:[{id:"quickfill-ni-attempted-2day",substatus:"NI_Attempted_Contact"}]}},{id:"sc_default_in_not_reachable",kind:"note",label:"IN Not Reachable \u2014 Finaliza\xE7\xE3o 2 Day Rule",alias:"2day fim",payload:{caseType:"bau",status:"IN",subStatus:"IN_Not_Reachable",scenarios:[{id:"quickfill-in-no-show-bau",substatus:"IN_Not_Reachable"}]}}];function oa(){return"sc_"+Date.now().toString(36)+Math.floor(Math.random()*1e3).toString(36)}function to(e){if(!e||!e.id)return null;if(lt[e.id])return e.id;let t=Xt(e.id,e.substatus),a=Object.entries(lt),o=a.find(([i,r])=>Xt(i,e.substatus)===t&&Array.isArray(r.substatus)&&r.substatus.includes(e.substatus));if(o)return o[0];let n=a.find(([i])=>Xt(i,e.substatus)===t);return n?n[0]:null}function Tn(e){return(e.payload&&e.payload.scenarios||[]).filter(a=>!to(a)).map(a=>a.id)}function An(){try{return JSON.parse(localStorage.getItem(kn)||"{}")}catch{return{}}}function eo(e){return Array.isArray(e)?e.filter(t=>t&&t.id&&t.payload&&t.payload.subStatus).map((t,a)=>({id:t.id,kind:t.kind||"note",label:String(t.label||"Atalho"),alias:String(t.alias||""),order:Number.isFinite(t.order)?t.order:a,payload:{caseType:t.payload.caseType||"bau",status:t.payload.status||String(t.payload.subStatus).split("_")[0],subStatus:t.payload.subStatus,scenarios:Array.isArray(t.payload.scenarios)?t.payload.scenarios.filter(o=>o&&o.id).map(o=>({id:o.id,substatus:o.substatus||t.payload.subStatus})):[]}})):[]}var Le={list(){let e=dt.get(aa,null),t=eo(e===null?Le.defaults():e),a=An();return t.slice().sort((o,n)=>{if(Le.isSortedByUsage()){let i=(a[n.id]||0)-(a[o.id]||0);if(i)return i}return o.order-n.order})},listRaw(){let e=dt.get(aa,null);return eo(e===null?Le.defaults():e).sort((t,a)=>t.order-a.order)},defaults(){return kr.map((e,t)=>({...e,order:t}))},isSortedByUsage(){return dt.get(Cn,!0)!==!1},setSortedByUsage(e){return dt.set(Cn,!!e)},async save(e){let t=Le.listRaw(),a=t.findIndex(i=>i.id===e.id);if(a===-1&&t.length>=mt)return{ok:!1,reason:"limit"};let o=eo([{...e,id:e.id||oa()}])[0];return o?(a===-1?(o.order=t.length,t.push(o)):(o.order=t[a].order,t[a]=o),{ok:!0,synced:(await dt.set(aa,t)).synced,shortcut:o}):{ok:!1,reason:"invalid"}},async remove(e){let t=Le.listRaw().filter(a=>a.id!==e).map((a,o)=>({...a,order:o}));await dt.set(aa,t)},async reorder(e,t){let a=Le.listRaw(),o=a.findIndex(r=>r.id===e);if(o===-1)return;let[n]=a.splice(o,1),i=Math.max(0,Math.min(t,a.length));a.splice(i,0,n),await dt.set(aa,a.map((r,l)=>({...r,order:l})))},registerUse(e){try{let t=An();t[e]=(t[e]||0)+1,localStorage.setItem(kn,JSON.stringify(t))}catch{}}};var qn={pt:{emailButtonNotFound:"Erro: Bot\xE3o de email n\xE3o encontrado.",clearingOldDraft:"Limpando rascunho antigo...",editorNotLoaded:"Erro: Editor n\xE3o carregou.",cannedResponseApplied:"Canned Response aplicada!",cannedResponseTimeout:e=>`Timeout: Template '${e}' n\xE3o carregou.`,cannedResponseButtonNotFound:"Bot\xE3o Canned Response n\xE3o encontrado.",emailFilledSuccess:"Email preenchido com sucesso!",editorFocusError:"Erro ao focar no editor.",fallbackClient:"Cliente",fallbackSite:"seu site"},es:{emailButtonNotFound:"Error: Bot\xF3n de email no encontrado.",clearingOldDraft:"Limpiando borrador antiguo...",editorNotLoaded:"Error: El editor no carg\xF3.",cannedResponseApplied:"\xA1Canned Response aplicada!",cannedResponseTimeout:e=>`Tiempo agotado: la plantilla '${e}' no carg\xF3.`,cannedResponseButtonNotFound:"Bot\xF3n Canned Response no encontrado.",emailFilledSuccess:"\xA1Email completado con \xE9xito!",editorFocusError:"Error al enfocar el editor.",fallbackClient:"Cliente",fallbackSite:"su sitio"}};function tt(e){let t=se();return qn[t]?.[e]??qn.pt[e]}function Ae(e,t="info"){let a={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,a[t]||a.info)}function va(e,t){if(!e)return;let a=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(a);o&&o.remove();let n=e.getBoundingClientRect(),i=document.createElement("div");i.id=a,i.style.cssText=`
        position: fixed;
        top: ${n.bottom+8}px;
        left: ${n.left}px;
        min-width: 300px;
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let r=i.querySelector(".cw-close-btn");r.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&r.click()},25e3)}async function ya(e,t){if(!e||!t)return;e.focus(),e.value="",e.dispatchEvent(new Event("input",{bubbles:!0})),await ue(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0})),await ue(100),e.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),e.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function ao(){let t=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(a=>{let o=a.offsetParent!==null,n=a.closest("case-message-view")!==null,i=a.closest(".editor")!==null||a.closest("write-card")!==null;return o&&!n&&i});return t&&Ae("Editor visualmente detectado.","success"),t}var wa=e=>!!e&&e.getClientRects().length>0&&e.getAttribute("aria-disabled")!=="true";async function In(e,{timeout:t=3e3,intervalo:a=100}={}){let o=Date.now()+t;for(;Date.now()<o;){let n=e();if(n)return n;await ue(a)}return null}function Ln(){let e=Array.from(document.querySelectorAll('material-button.compose, material-button.speed-dial-mini-fab[role="menuitem"]')),t=e.find(a=>a.classList.contains("compose")&&wa(a));return t||e.find(a=>{let o=a.querySelector("i.material-icons-extended");return wa(a)&&o&&o.textContent.trim()==="email"})||null}async function Tr(){try{let e=Ln();if(e)Ae("Menu do speed dial j\xE1 estava aberto.");else{let t=document.querySelector("#action-bar-speed-dial-container material-button")||document.querySelector("material-button.action-bar-speed-dial-button");if(!wa(t))return Ae("Speed dial (+ Open) n\xE3o encontrado.","warn"),!1;Ae("Speed dial (+ Open) encontrado. Abrindo o menu..."),Me(t),await ue(350),e=await In(Ln,{timeout:3e3})}return e?(await ue(120),Me(e),Ae("Compose clicado via speed dial.","success"),!0):(Ae("Menu abriu, mas o bot\xE3o Compose n\xE3o apareceu.","warn"),!1)}catch(e){return Ae(`Falha no speed dial: ${e.message}`,"error"),!1}}function qr(){let t=Array.from(document.querySelectorAll("i.material-icons-extended")).find(o=>o.innerText.trim()==="email"&&o.offsetParent!==null);if(!t)return!1;Ae("Bot\xE3o de email direto encontrado.");let a=t.closest("material-button")||t.closest("material-fab")||t;return Me(a),!0}function Lr(){return Array.from(document.querySelectorAll("i.material-icons-extended")).find(e=>e.textContent.trim()==="email"&&wa(e))||null}async function Ir(){try{let e=document.querySelector("material-fab-speed-dial"),t=e&&e.querySelector(".trigger");if(!t)return!1;Ae("Speed dial da UI antiga encontrado. Abrindo o menu..."),Me(t);let a=await In(Lr,{timeout:3e3});if(!a)return Ae("Menu antigo abriu, mas o envelope n\xE3o apareceu.","warn"),!1;let o=a.closest("material-button")||a.closest("material-fab")||a;return Me(o),Ae("Email aberto via speed dial da UI antiga.","success"),!0}catch(e){return Ae(`Falha no speed dial antigo: ${e.message}`,"error"),!1}}async function Nn(){Ae("\u{1F680} FASE 1: Tentando abrir a janela de email...");let e=await Tr();if(e||(Ae("Speed dial novo indispon\xEDvel. Tentando o bot\xE3o de email direto...","warn"),e=qr()),e||(Ae("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando o speed dial da UI antiga...","warn"),e=await Ir()),!e)return S.playError(),X(tt("emailButtonNotFound"),{error:!0}),!1;Ae("\u{1F680} FASE 2: Verificando rascunhos...");let t=null,a=0,o=20;for(;a<o;){await ue(250);let g=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(t=Array.from(g).find(u=>u.offsetParent!==null),t){Ae("\u26A0\uFE0F Rascunho detectado!","warn");break}a++}if(t){Ae("\u{1F5D1}\uFE0F Descartando..."),Me(t),t.click();let g=null,u=0;for(;u<15;){await ue(300);let v=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(g=Array.from(v).find(d=>d.offsetParent!==null),g)break;u++}g&&(Me(g),X(tt("clearingOldDraft"),{duration:2e3}),await ue(2500))}Ae("\u{1F680} FASE 3: Buscando editor final...");let n=0,i=null;for(;n<20&&(i=ao(),!i);)await ue(250),n++;if(!i)return S.playError(),X(tt("editorNotLoaded"),{error:!0}),!1;let r=i.closest('[id="email-body-content-top"]'),c=(i.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(r){if(c){let u=c.closest('[aria-hidden="true"]');u&&u.removeAttribute("aria-hidden"),c.focus(),Me(c)}await ue(300),r.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let g=r.querySelector("#cases-body-field");if(g){let u=document.createRange();u.selectNodeContents(g),u.collapse(!0);let v=window.getSelection();v.removeAllRanges(),v.addRange(u)}return!0}return!1}async function Sa(e){if(!e||!await Nn())return;let a=await Je();Ae("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let o=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(o&&(o.click(),await ue(600)),a.clientEmail&&a.clientEmail!=="N/A"&&a.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await ya(i,a.clientEmail),va(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(a.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await ya(i,a.internalEmail),va(i,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}await ue(500);let n=document.querySelector('material-button[debug-id="canned_response_button"]');if(n){Me(n),await ue(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){Me(i),document.execCommand("insertText",!1,e),i.dispatchEvent(new Event("input",{bubbles:!0})),Ae("\u23F3 Buscando resultado da Canned Response...","info");let r=null,l=0,c=15e3,g=500;for(;l<c&&(r=document.querySelector("material-select-dropdown-item"),!r);)await ue(g),l+=g;if(r){Me(r),await ue(1500);let u=ao();if(u){let d=Array.from(u.querySelectorAll("span.field")).filter(_=>_.innerText.includes("{Requested Task Type}"));if(d.length>0){let _=d.map(E=>E.closest("tr")).filter(E=>E!==null),w=[...new Set(_)];if(w.length>0){let M=w[0].querySelector('td[width="100%"]');M&&(M.innerHTML='<span class="field" style="color:rgb(60, 64, 67)">Enhanced Conversions - Aguardando Valida\xE7\xE3o - Dentro de 7 dias</span>');for(let A=1;A<w.length;A++)w[A].remove()}}let p=u.innerHTML;a.advertiserName&&p.includes("{%ADVERTISER_NAME%}")&&(p=p.replace(/{%ADVERTISER_NAME%}/g,a.advertiserName)),p.includes("{%^79285%}")&&(p=p.replace(/{%\^79285%}/g,a.websiteUrl||tt("fallbackSite"))),u.innerHTML=p}X(tt("cannedResponseApplied"))}else Ae(`\u274C Timeout: Resultado '${e}' n\xE3o apareceu ap\xF3s 15s.`,"error"),S.playError(),X(tt("cannedResponseTimeout")(e),{error:!0})}}else S.playError(),X(tt("cannedResponseButtonNotFound"),{error:!0})}async function _n(e){if(Ae(`\u{1F680} Iniciando Quick Email: ${e.name}`),!await Nn())return;let a=await Je(),o=Ht();await ue(600);let n=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(n&&(n.click(),await ue(600)),a.clientEmail&&a.clientEmail!=="N/A"&&a.clientEmail!=="N/A (Bloqueado)"){let l=document.querySelector('input[aria-label="Enter To email address"]');l&&(await ya(l,a.clientEmail),va(l,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(a.internalEmail){let l=document.querySelector('input[aria-label="Enter Bcc email address"]');l&&(await ya(l,a.internalEmail),va(l,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}let i=document.querySelector('input[aria-label="Subject"]');i&&e.subject&&(i.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(i,e.subject),i.dispatchEvent(new Event("input",{bubbles:!0})),await ue(300));let r=ao();if(r){let c=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');c&&(c.focus(),Me(c));let g=new Date;g.setDate(g.getDate()+3);let u=g.getDay();u===6?g.setDate(g.getDate()+2):u===0&&g.setDate(g.getDate()+1);let v=g.toLocaleDateString("pt-BR"),d=e.body;d=d.replace(/\[Nome do Cliente\]/g,a.advertiserName||tt("fallbackClient")),d=d.replace(/\[INSERIR URL\]/g,a.websiteUrl||tt("fallbackSite")),d=d.replace(/\[URL\]/g,a.websiteUrl||tt("fallbackSite")),d=d.replace(/\[Seu Nome\]/g,o),d=d.replace(/\[MM\/DD\/YYYY\]/g,v),document.execCommand("insertHTML",!1,d),c&&(c.dispatchEvent(new Event("input",{bubbles:!0})),c.dispatchEvent(new Event("change",{bubbles:!0}))),X(tt("emailFilledSuccess"),{duration:2e3}),Ae("\u2705 Processo finalizado com sucesso.","success")}else S.playError(),X(tt("editorFocusError"),{error:!0})}var oo=460,no=280,Nr=200,io=.06;if(!document.getElementById("cw-module-styles")){let e=document.createElement("style");e.id="cw-module-styles",e.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
    ...
    `,document.head.appendChild(e)}window._cwEscapeListenerActive||(window._cwEscapeListenerActive=!0,document.addEventListener("keydown",e=>{if(e.key!=="Escape"||document.querySelector(".cw-dialog-overlay"))return;let t=document.querySelector(".cw-module-window.open");if(!t)return;let a=t.querySelector(".cw-header-close");a&&a.click()}));function $n(){return!!(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)}function Fn(e){let t=document.querySelector(".cw-pill"),a=e?document.getElementById(e):null,o=!!(t&&t.classList.contains("collapsed")),n=i=>{if(!i)return null;let r=i.getBoundingClientRect();return!r.width||!r.height?null:{x:r.left+r.width/2,y:r.top+r.height/2}};if(!o){let i=n(a);if(i)return i}return n(t)}function Mn(e,t){let a=e.style.transition,o=e.style.transform;e.style.transition="none",e.style.transform="none";let n=e.getBoundingClientRect();return e.style.transform=o,e.offsetWidth,e.style.transition=a,{left:t?n.left:n.left-n.width/2,top:t?n.top:n.top-n.height/2,width:n.width,height:n.height}}function On(e,t,a){if(!t){e.style.transformOrigin="50% 50%",e._cwOrigin=null;return}let o=`${Math.round(t.x-a.left)}px ${Math.round(t.y-a.top)}px`;e.style.transformOrigin=o,e._cwOrigin=o}function Dn(e){return e?`translate(0, 0) scale(${io})`:`translate(-50%, -50%) scale(${io})`}function _r(e){return e?"translate(0, 0) scale(1)":"translate(-50%, -50%) scale(1)"}function zn(e){!e||$n()||(e.classList.remove("cw-absorbing"),e.offsetWidth,e.classList.add("cw-absorbing"),setTimeout(()=>e.classList.remove("cw-absorbing"),400))}function He(e){return e?typeof e._cwOpen=="boolean"?e._cwOpen:e.classList.contains("open"):!1}function ze(e,t,a){let o=a?document.getElementById(a):null;if(!t)return;t._cwOpen=!!e;let n=(t._cwAnimToken||0)+1;t._cwAnimToken=n;let i=()=>t._cwAnimToken!==n;t._cwTeardown&&(t._cwTeardown(),t._cwTeardown=null);let r=$n(),l=t.getAttribute("data-moved")==="true";if(e){S.playGenieOpen();let c=Mn(t,l);On(t,Fn(a),c),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",t.style.transform=Dn(l),t.style.willChange="transform, opacity",t.classList.add("cw-animating"),t.offsetWidth,requestAnimationFrame(()=>{i()||(t.classList.add("open"),t.classList.remove("idle"),o&&o.classList.add("active"),zn(o),t.style.transition=r?"opacity 0.15s ease":`opacity ${Math.round(oo*.6)}ms ease-out, transform ${oo}ms var(--cw-ease-decelerate), filter 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease`,t.style.opacity="1",t.style.transform=_r(l),Rn(t,n,r?150:oo,()=>{t.style.willChange="auto",t.classList.remove("cw-animating"),t._cwSettled=!0}))}),t._cwSettled=!1,Fr(t,a)}else{if(S.playSwoosh(),t._cwSettled||!t._cwOrigin){let c=Mn(t,l);On(t,Fn(a),c)}if(t.style.transition=r?"opacity 0.15s ease":`opacity ${Math.round(no*.8)}ms ease, transform ${no}ms var(--cw-ease-accelerate)`,t.style.pointerEvents="none",t.style.willChange="transform, opacity",t.classList.add("cw-animating"),o&&t.contains(document.activeElement))try{o.focus({preventScroll:!0})}catch{o.focus()}requestAnimationFrame(()=>{i()||(t.style.opacity="0",t.style.transform=Dn(l),Rn(t,n,r?150:no,()=>{t.classList.remove("open"),t.classList.remove("idle"),t.style.zIndex="",o&&o.classList.remove("active"),zn(o),t.style.willChange="auto",t.classList.remove("cw-animating"),t.style.transition=""}))}),Bn(t)}}function Rn(e,t,a,o){let n=!1,i=()=>{e.removeEventListener("transitionend",l),clearTimeout(c),e._cwTeardown===i&&(e._cwTeardown=null)},r=()=>{n||(n=!0,i(),e._cwAnimToken===t&&o())},l=g=>{g.target===e&&g.propertyName==="transform"&&r()};e.addEventListener("transitionend",l);let c=setTimeout(r,a+Nr);e._cwTeardown=i}function Fr(e,t){Bn(e);let a=o=>{if(!e.classList.contains("open"))return;let n=e.contains(o.target),i=document.querySelector(".cw-pill"),r=i&&i.contains(o.target);n?(e.classList.remove("idle"),e.style.zIndex=String(Oe.MODULE_FOCUSED)):r||(e.classList.add("idle"),e.style.zIndex=String(Oe.MODULE_RESTING))};e._idleHandler=a,document.addEventListener("mousedown",a)}function Bn(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var Pn='<svg viewBox="0 0 24 24" fill="currentColor" style="width:13px;height:13px;flex-shrink:0;"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>';function Gn(){let e="v4.0.0",{popup:t,content:a,header:o,animRefs:n,credit:i}=Xo(e,F),r=dn(m),l=cn(()=>{ee(),Y.setActiveTasks(l.getCheckedElements())},m,Y),c=document.createElement("div");c.style.display="none";let g=ln((x,O)=>{H(x,O)});c.appendChild(g);let u=document.createElement("button");u.type="button",u.className="cw-save-shortcut-btn",u.style.cssText=`
    ...
    `,u.onmouseenter=()=>{u.style.borderColor=G.primary,u.style.color=G.primary,S.playHover()},u.onmouseleave=()=>{u.style.borderColor=G.border,u.style.color=G.textSub},u.onclick=()=>f(),u.innerHTML=`${Pn}<span>${m("salvar_como_atalho")}</span>`,c.appendChild(u);let v=document.createElement("div");v.id="evidence-container",Object.assign(v.style,{display:"none",marginTop:"16px",padding:"16px",background:G.bgInput,border:`1px solid ${G.border}`,borderRadius:Ne.medium,boxShadow:ut.subtle});let d=document.createElement("div");d.className="cw-section-title",d.textContent=m("evidencias_contato"),v.appendChild(d);let p={},_=(x,O)=>{let U=document.createElement("div");U.style.marginBottom="12px";let Q=document.createElement("label");Q.textContent=O,Q.setAttribute("for",x),Q.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${G.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let ne=document.createElement("input");return ne.type="text",ne.id=x,ne.className="cw-input",ne.placeholder="https://screenshot.googleplex.com/...",ne.style.marginBottom="0",U.appendChild(Q),U.appendChild(ne),ra(ne,{minLength:8}),p[x]=ne,U};v.appendChild(_("evidence-l1",m("ligacao_1"))),v.appendChild(_("evidence-l2",m("ligacao_2"))),v.appendChild(_("evidence-msg",m("mensagem_am")));let w=xn({onSaveCurrent:async()=>{let x=await ae();return V(),x},onLoadDraft:x=>{y(x)},t:x=>m(x)}),E=z(),M=K(),A=document.createElement("div"),D=Z(),h=oe(w,m);a.appendChild(E),a.appendChild(M),a.appendChild(D),a.appendChild(c),a.appendChild(A),a.appendChild(v),l.selectionElement.style.display="none",l.screenshotsElement.style.display="none";let q=document.createElement("button");q.id="manual-task-toggle",q.textContent=m("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",q.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${G.primary}; background: ${G.surface}; color: ${G.primary}; border-radius: ${Ne.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${he}; text-transform: uppercase; letter-spacing: 0.5px;`,q.onmouseenter=()=>{q.style.background=G.primaryBg},q.onmouseleave=()=>{q.style.background=G.surface},q.onclick=()=>{l.selectionElement.style.display="block",l.screenshotsElement.style.display="block",q.style.display="none"},a.appendChild(q),a.appendChild(l.selectionElement),a.appendChild(r.element),a.appendChild(l.screenshotsElement),a.appendChild(h);let $=document.createElement("div");$.style.display="none",$.style.flexGrow="1",$.style.minHeight="0",$.style.overflow="hidden";let T=wn(()=>j());T.style.height="100%",$.appendChild(T),t.insertBefore($,i);let C=o.lastElementChild;C&&(C.insertBefore(w.historyBtnWrapper,C.firstChild),C.insertBefore(P(),C.firstChild)),t.appendChild(w.drawer);let N=null;Y.subscribe(x=>{de(x),k(),x.isDirty?(N&&clearTimeout(N),N=setTimeout(async()=>{let O=await ae(!0);O.subStatus?je.saveEmergency(O):je.clearEmergency(),x.isDirty=!1},2e3)):N&&(clearTimeout(N),N=null)});function k(){let x=je.getCount()>0,O=!!Y.currentSubStatus;fa(x||O)}function F(){Y.visible=!Y.visible,Y.visible?Te():qe(),ze(Y.visible,t,"cw-btn-notes")}function j(){Y.isSplitView=!Y.isSplitView,Y.isSplitView?(a.style.display="none",$.style.display="flex",$.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(a.style.display="flex",$.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function z(){let x=document.createElement("div");if(x.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let U=document.createElement("style");U.id="cw-segmented-styles",U.innerHTML=`
            ...
            `,document.head.appendChild(U)}let O=(U,Q)=>{let ce=x.querySelector(`#${U}`).querySelector(".cw-segmented-indicator");ce&&(ce.style.transform=`translateX(${Q*100}%) translateX(${Q*2}px)`)};return x.querySelectorAll("#type-selector button").forEach((U,Q)=>{U.onclick=()=>{Y.setCaseType(U.dataset.type),x.querySelectorAll("#type-selector button").forEach(ne=>ne.classList.remove("active")),U.classList.add("active"),O("type-selector",Q),S.playClick(),Y.currentSubStatus&&W(Y.currentSubStatus)}}),x.querySelectorAll("#portugal-selector button").forEach((U,Q)=>{U.onclick=()=>{Y.setPortugalCase(U.dataset.val==="true"),x.querySelectorAll("#portugal-selector button").forEach(ne=>ne.classList.remove("active")),U.classList.add("active"),O("portugal-selector",Q),S.playClick(),Y.currentSubStatus&&W(Y.currentSubStatus)}}),x}function K(){let x=document.createElement("div");x.className="cw-status-section",x.style.cssText="display: flex; flex-direction: column; gap: 8px;",x.innerHTML=`
        ...
        `;let O=x.querySelector("#main-status-select"),U=x.querySelector("#sub-status-select");return O.onchange=()=>{Y.setStatus(O.value),le(O.value,U),Y.setSubStatus(""),W("")},U.onchange=()=>{Y.setSubStatus(U.value),W(U.value)},x}function ie(){return v.style.display==="none"?null:{l1:p["evidence-l1"]?.value.trim()||"",l2:p["evidence-l2"]?.value.trim()||"",msg:p["evidence-msg"]?.value.trim()||""}}function le(x,O){if(O.innerHTML=`<option value="">${m("select_substatus")}</option>`,!x){O.disabled=!0;return}let U=x==="IN"?(()=>{let Q=document.createElement("optgroup");return Q.label="Fora de Escopo",Q})():null;for(let Q in _e)if(_e[Q].status===x){let ne=document.createElement("option");ne.value=Q,ne.textContent=_e[Q].name,U&&Q.startsWith("IN_Out_of_Scope")?U.appendChild(ne):O.appendChild(ne)}U&&U.children.length>0&&O.appendChild(U),O.disabled=!1}function W(x){let O=_e[x],U=x==="NI_Attempted_Contact"||O&&O.name&&O.name.toLowerCase().includes("attempted contact");if(g.render&&g.render(x,Y.currentCaseType),!x){v.style.display="none",p["evidence-l1"]&&(p["evidence-l1"].value=""),p["evidence-l2"]&&(p["evidence-l2"].value=""),p["evidence-msg"]&&(p["evidence-msg"].value=""),c.style.display="none",A.style.display="none";let Ce=document.getElementById("manual-task-toggle");Ce&&(Ce.style.display="none"),l.selectionElement.style.display="none",l.screenshotsElement.style.display="none",D.style.display="flex",D.style.opacity="1",h.style.display="none";return}if(U?v.style.display="block":(v.style.display="none",p["evidence-l1"]&&(p["evidence-l1"].value=""),p["evidence-l2"]&&(p["evidence-l2"].value=""),p["evidence-msg"]&&(p["evidence-msg"].value="")),D.style.opacity="0",setTimeout(()=>{Y.currentSubStatus&&(D.style.display="none")},400),h.style.display="grid",O&&O.templateFields){let Ce=Zo(O);Y.setActiveFields(O.templateFields.filter(Ve=>!Ce.includes(Ve)))}te(),Zt(x,A,Y),A.style.display="block",c.style.display="block";let Q=x.startsWith("SO_"),ne=x==="NI_Awaiting_Validation",ce=document.getElementById("manual-task-toggle");Q||ne?(l.selectionElement.style.display="block",ce.style.display="none"):(l.selectionElement.style.display="none",l.screenshotsElement.style.display="none",ce.style.display="block");let re=x==="SO_Education_Only"?"education":"implementation";Y.setScreenshotMode(re),l.updateSubStatus(x),ee();let we=document.getElementById("email-automation-toggle-row");we&&(we.style.display=Nt[x]?"flex":"none")}function ee(){let x=l.getCheckedElements().map(O=>O.value);r.updateVisibility(Y.currentSubStatus,x)}function H(x,O){let U=da(lt[x],Y.currentLang,x);if(U){for(let Q in U)if(Q==="linkedTask")l.toggleTask(U.linkedTask,O);else if(Q==="activeTasks")U.activeTasks.forEach(ne=>{O?l.setTaskCount(ne.value,ne.count):l.setTaskCount(ne.value,0)});else if(Q.startsWith("field-")){let ne=Q,ce=U[Q],re=document.getElementById(ne);if(re){let we=_t.includes(ne.replace("field-",""));if(O)if(we){let Ce=re.value.trim();Ce.includes(ce.trim())||(re.value=Ce?Ce+`
...
`))}else re.value.trim()===ce.trim()&&(re.value="");Y.updateField(ne,re.value),re.dispatchEvent(new Event("input"))}}}}function oe(x,O){let U=document.createElement("div");if(U.className="cw-actions-section",U.style.cssText=`
            display: grid;
        ...
        `,!document.getElementById("cw-actions-hover-styles")){let Ce=document.createElement("style");Ce.id="cw-actions-hover-styles",Ce.innerHTML=`
            ...
            `,document.head.appendChild(Ce)}let Q=document.createElement("div");Q.id="email-automation-toggle-row",Q.style.cssText="grid-column: 1 / -1; display: none; align-items: center; justify-content: center; padding-bottom: 6px; border-bottom: 1px solid rgba(0,0,0,0.05); margin-bottom: 2px;",Q.innerHTML=`
        ...
        `;let ne=x.parkButton;ne.classList.add("js-btn-park"),ne.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let ce=document.createElement("button");ce.className="cw-btn-secondary js-btn-reset",ce.textContent=O("limpar"),ce.style.cssText=`width: 100%; height: 34px; background: ${G.surface}; color: ${G.textSub}; border: 1px solid ${G.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,ce.onclick=()=>V();let re=document.createElement("button");re.className="cw-btn-secondary js-btn-copy",re.textContent=O("copiar"),re.style.cssText=`width: 100%; height: 34px; background: ${G.surface}; color: ${G.primary}; border: 1px solid ${G.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,re.onclick=()=>R();let we=document.createElement("button");return we.className="cw-btn-primary js-btn-generate",we.textContent=O("preencher"),we.style.cssText=`width: 100%; height: 38px; background: ${G.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: 1 / -1; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,we.onclick=()=>J(),U.appendChild(Q),U.appendChild(ne),U.appendChild(ce),U.appendChild(re),U.appendChild(we),U}async function R(){if(!Y.currentSubStatus){S.playError(),X(m("select_substatus"),{error:!0});return}let x=Ua(Y,l,r,ie());x?(ea(x),X(m("copiado_sucesso")),S.playClick()):(S.playError(),X(m("select_substatus"),{error:!0}))}async function J(){if(!Y.currentSubStatus){S.playError(),X(m("select_substatus"),{error:!0});return}let x=_e[Y.currentSubStatus],O=Kt(x).filter(ce=>{if(!Y.activeFields.includes(ce))return!1;let re=Y.formData[`field-${ce}`];return!re||!re.trim()});if(O.length>0){S.playError(),X(`Preencha o campo obrigat\xF3rio antes de gerar: ${m(O[0].toLowerCase())}`,{error:!0});return}if(x?.requiresTasks&&l.getCheckedElements().length===0){S.playError(),X("Selecione ao menos uma tarefa antes de gerar a nota.",{error:!0});return}let U=Ua(Y,l,r,ie());ea(U),F();let Q=Qt(),ne=await xa();if(ne){ne.focus(),document.execCommand("insertHTML",!1,U),ha(ne);let ce=document.getElementById("email-automation-checkbox");(!ce||ce.checked)&&Y.currentSubStatus&&Nt[Y.currentSubStatus]&&await Sa(Nt[Y.currentSubStatus]),X(m("inserido_copiado")),S.playSuccess(),fn(),V()}else S.playError(),X("N\xE3o foi poss\xEDvel abrir a nota no CRM. O conte\xFAdo j\xE1 est\xE1 copiado \u2014 cole manualmente.",{error:!0}),F();Q()}function te(){if(Y.currentSubStatus){if(Y.currentCaseType==="lm")Y.removeField("ON_CALL");else{let x=_e[Y.currentSubStatus];x&&x.templateFields.includes("ON_CALL")&&Y.addFieldAt("ON_CALL",1)}Y.isPortugalCase?(Y.addFieldAt("CASO_PORTUGAL",1),Y.addFieldAt("CONSENTIU_GRAVACAO",2)):(Y.removeField("CASO_PORTUGAL"),Y.removeField("CONSENTIU_GRAVACAO"))}}function V(){Y.reset(),l.reset(),r.reset(),k(),je.clearEmergency(),a.querySelectorAll("select").forEach(O=>O.value=""),a.querySelector("#sub-status-select").disabled=!0;let x=document.getElementById("email-automation-toggle-row");x&&(x.style.display="none"),A.innerHTML="",c.style.display="none",D.style.display="flex",D.style.opacity="1",h.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),l.selectionElement.style.display="none",l.screenshotsElement.style.display="none",v.style.display="none",p["evidence-l1"]&&(p["evidence-l1"].value=""),p["evidence-l2"]&&(p["evidence-l2"].value=""),p["evidence-msg"]&&(p["evidence-msg"].value="")}async function ae(x=!1){let O={};A.querySelectorAll("input, textarea, select").forEach(re=>{(re.id.startsWith("field-")||re.id==="consent-select")&&(O[re.id]=re.value)});let U="Cliente",Q="---";if(!x)try{let re=await Je();U=re.advertiserName,Q=re.cid}catch(re){console.warn("Erro ao coletar pageData:",re)}let ne=l.getCheckedElements().map(re=>({key:re.value,count:re.count})),ce=ne.map(re=>{let we=et[re.key];return we?we.name:re.key});return{currentCaseType:Y.currentCaseType,currentLang:Y.currentLang,isPortugalCase:Y.isPortugalCase,consent:Y.consent,tagSupportUsed:Y.tagSupportUsed,forcedScreenshots:[...Y.forcedScreenshots],activeFields:Y.activeFields,status:Y.currentStatus,subStatus:Y.currentSubStatus,formData:O,activeTasks:ne,summaryTags:ce,clientName:U,cid:Q,timestamp:new Date().toISOString()}}let s=x=>new Promise(O=>setTimeout(O,x));async function y(x){Y.setCaseType(x.currentCaseType||"bau"),Y.setPortugalCase(x.isPortugalCase||!1),Y.setConsent(x.consent||!1),x.activeFields&&Y.setActiveFields(x.activeFields);let O=a.querySelector(`#type-selector button[data-type="${Y.currentCaseType}"]`);O&&O.classList.add("active"),a.querySelectorAll("#type-selector button").forEach(Q=>{Q!==O&&Q.classList.remove("active")});let U=a.querySelector(`#portugal-selector button[data-val="${Y.isPortugalCase}"]`);if(U&&U.classList.add("active"),a.querySelectorAll("#portugal-selector button").forEach(Q=>{Q!==U&&Q.classList.remove("active")}),x.status){let Q=a.querySelector("#main-status-select");Q.value=x.status,Y.setStatus(x.status);let ne=a.querySelector("#sub-status-select");if(le(x.status,ne),await s(50),x.subStatus){if(ne.value=x.subStatus,Y.setSubStatus(x.subStatus),W(x.subStatus),await s(100),x.tagSupportUsed!==void 0){Y.setTagSupportUsed(x.tagSupportUsed);let ce=r.element.querySelector('input[value="Sim"]'),re=r.element.querySelector('input[value="N\xE3o"]');x.tagSupportUsed&&ce?ce.checked=!0:re&&(re.checked=!0),r.element.querySelector("div:last-child").style.display=x.tagSupportUsed?"none":"block"}x.forcedScreenshots&&Y.setForcedScreenshots(x.forcedScreenshots);for(let ce in x.formData){let re=document.getElementById(ce);re&&(re.value=x.formData[ce],Y.updateField(ce,re.value))}x.activeTasks&&(x.activeTasks.forEach(ce=>l.setTaskCount(ce.key,ce.count)),Y.setActiveTasks(l.getCheckedElements()))}}Y.isDirty=!1}async function L(x){let O=x&&x.payload;if(!O||!O.subStatus)return{ok:!1,reason:"invalid"};let U=O.scenarios||[],Q=U.map(We=>to(We)),ne=U.filter((We,wt)=>!Q[wt]);if(Y.isDirty&&!await Fe(m("substituir_rascunho_confirm")))return{ok:!1,reason:"cancelled"};let ce=Y.visible;if(ce||F(),V(),ce||await s(550),O.caseType&&O.caseType!==Y.currentCaseType){let We=a.querySelector(`#type-selector button[data-type="${O.caseType}"]`);We&&We.click(),await s(60)}let re=a.querySelector("#main-status-select"),we=a.querySelector("#sub-status-select"),Ce=O.status||String(O.subStatus).split("_")[0];re.value=Ce,Y.setStatus(Ce),le(Ce,we),await s(60),we.value=O.subStatus,Y.setSubStatus(O.subStatus),W(O.subStatus),await s(160);for(let We of Q.filter(Boolean)){let wt=c.querySelector(`[data-id="${We}"]`);wt&&wt.click()}await s(120),ne.length?(S.playError(),X(m("atalho_cenario_sumiu"),{error:!0})):S.playSuccess();let Ve=b();return Ve&&qo(Ve),{ok:!0,missing:ne.map(We=>We.id)}}function b(){let x=a.querySelectorAll('input[id^="field-"], textarea[id^="field-"], input[id^="evidence-"]');for(let O of x)if(O.offsetParent!==null&&!String(O.value||"").trim())return O;return null}async function f(){let x=I();if(!x){S.playError(),X(m("select_substatus"),{error:!0});return}if(Le.listRaw().length>=mt){S.playError(),X(m("atalho_limite").replace("{max}",mt),{error:!0});return}let O=_e[x.payload.subStatus]?.name||x.payload.subStatus,U=await ca(m("atalho_nome_pergunta"),O);if(U!==null){u.disabled=!0,u.style.opacity="0.6";try{let Q=await Le.save({...x,id:oa(),label:String(U).trim()||O});if(!Q.ok){S.playError(),X(m("atalho_limite").replace("{max}",mt),{error:!0});return}S.playSuccess(),X(Q.synced?m("atalho_salvo"):m("atalho_salvo_local"))}finally{u.disabled=!1,u.style.opacity=""}}}function I(){if(!Y.currentSubStatus)return null;let x=g.getSelectedIds?g.getSelectedIds():[];return{kind:"note",payload:{caseType:Y.currentCaseType,status:Y.currentStatus,subStatus:Y.currentSubStatus,scenarios:x.map(O=>({id:O,substatus:Y.currentSubStatus}))}}}function m(x){return Ue[Y.currentLang]?.[x]||Ue.pt?.[x]||x}function P(){let x=document.createElement("div");return x.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',x.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",x.onclick=O=>{O.stopPropagation(),j()},x.title="Alternar para Split & Transfer",x}function Z(){let x=document.createElement("div");return x.id="notes-empty-state",x.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(e)}function Or(e,t){return e.map(a=>Hn(a,se())).filter(a=>a.name.toLowerCase().includes(t.toLowerCase())||a.category.toLowerCase().includes(t.toLowerCase()))}function Dr(e){return Object.entries(Nt).filter(([t,a])=>a&&(t.toLowerCase().includes(e.toLowerCase())||a.toLowerCase().includes(e.toLowerCase()))).map(([t,a])=>({id:t,name:t.replace(/_/g," "),category:"\u26A1 Smart CRs",code:a,isSmartCR:!0}))}function zr(e){return $e.getSnippets("email").filter(t=>t.title.toLowerCase().includes(e.toLowerCase())||t.subject&&t.subject.toLowerCase().includes(e.toLowerCase())).map(t=>{let a=[],o=t.content.match(/\[([^\]]+)\]/g);return o&&[...new Set(o)].forEach(n=>{a.push({key:n,label:n.replace("[","").replace("]",""),type:n.toLowerCase().includes("data")?"date":"text",auto:n.toLowerCase().includes("nome")&&n.toLowerCase().includes("seu")?"agentName":null})}),{id:t.id||`snippet-${Math.random()}`,name:t.title,category:"\u{1F464} Pessoal",subject:t.subject||Xe("noSubject"),template:t.content,placeholders:a}})}function Rr(e,t){return[...Or(e,t),...Dr(t),...zr(t)]}function Xn(){let e="v6.0.0",t=!1,a=[],o=null,n="",i=new Set;Mr();let r=document.createElement("div");r.id="email-assistant-popup",r.classList.add("cw-module-window","cw-email-popup"),Object.assign(r.style,Ge,{width:"850px",height:"650px"}),r.style.display="none",r.style.flexDirection="column";let l=De(r,Xe("headerTitle"),e,Xe("headerDesc"),{popup:r},()=>k()),c=document.createElement("div");c.className="cw-email-main";let g=document.createElement("div");g.className="cw-email-left-panel";let u=document.createElement("div");u.className="cw-email-search-container";let v=document.createElement("input");v.className="cw-email-search-input",v.placeholder=Xe("searchPlaceholder");let d=document.createElement("div");d.id="email-template-list",ia(d,".cw-email-cat-header, .cw-email-list-item");let p=document.createElement("div");p.className="cw-email-clear-btn",p.innerHTML="\u2715",p.onclick=()=>{v.value="",n="",p.style.display="none",K(),v.focus()},u.appendChild(v),u.appendChild(p),g.appendChild(u),g.appendChild(d);let _=document.createElement("div");_.className="cw-email-right-panel";let w=document.createElement("div");w.className="cw-email-fields-section";let E=document.createElement("div");E.className="cw-email-preview-section";let M=document.createElement("div");M.className="cw-email-preview-header";let A=document.createElement("span");A.textContent=Xe("previewTitle"),A.className="cw-email-preview-title";let D=document.createElement("div");D.className="cw-email-preview-actions";let h=(H,oe=!1)=>{let R=document.createElement("button");return R.textContent=H,R.className="cw-email-btn"+(oe?" primary":""),R},q=h("Copiar HTML"),$=h("Preencher no CRM",!0),T=h("Smart CR");T.classList.add("warning"),D.appendChild(T),D.appendChild(q),D.appendChild($),M.appendChild(A),M.appendChild(D);let C=document.createElement("div");C.contentEditable="true",C.className="cw-email-preview-content",E.appendChild(M),E.appendChild(C),ee(),_.appendChild(w),_.appendChild(E),c.appendChild(g),c.appendChild(_),r.appendChild(l),r.appendChild(c);let N=document.createElement("div");Object.assign(N.style,rt),r.appendChild(N),st(r,N),document.body.appendChild(r);function k(){t=!He(r),t?(Te(),r.style.display="flex",jo(r),a.length===0&&F()):(qe(),r.style.display="none"),ze(t,r,"cw-btn-email")}async function F(){d.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',a=await Vn.getTemplates(),K()}function j(H,oe,R){let J=document.createElement("div");J.className="cw-email-cat-header",J.tabIndex=0,J.setAttribute("role","button"),J.setAttribute("aria-expanded",String(R));let te=document.createElement("span");te.textContent=H,J.appendChild(te);let V=document.createElement("span");V.className="cw-email-cat-badge",V.textContent=oe;let ae=document.createElement("span");ae.className="cw-email-cat-arrow",ae.textContent=R?"\u25BE":"\u25B8";let s=document.createElement("div");return s.className="cw-email-cat-right",s.appendChild(V),s.appendChild(ae),J.appendChild(s),J.onclick=()=>{i.has(H)?i.delete(H):i.add(H),K()},J.addEventListener("keydown",y=>{(y.key==="Enter"||y.key===" ")&&(y.preventDefault(),J.click())}),J}function z(H){let oe=o&&o.id===H.id,R=document.createElement("div");if(R.className="cw-email-list-item"+(oe?" selected":""),R.tabIndex=0,R.setAttribute("role","button"),R.setAttribute("aria-pressed",String(!!oe)),oe){let V=document.createElement("div");V.className="cw-email-list-indicator",R.appendChild(V)}let J=document.createElement("span");J.className="cw-email-list-icon",J.innerHTML=H.isSmartCR?"\u26A1":H.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",R.appendChild(J);let te=document.createElement("span");return te.className="cw-email-list-text",te.textContent=H.name,R.appendChild(te),R.onclick=()=>le(H),R.addEventListener("keydown",V=>{(V.key==="Enter"||V.key===" ")&&(V.preventDefault(),R.click())}),R}function K(){d.innerHTML="";let H=Rr(a,n);if(H.length===0){d.innerHTML=`
...
CID: ${e.cid||"---"}
Case ID: ${e.caseId||"---"}
E-mail: ${e.clientEmail||"---"}`,dateLocale:"es-ES"}};function ei(){return se()==="es"?"ES":"PT"}function xe(e){let t=se();return Qn[t]?.[e]??Qn.pt[e]}var ge={bgApp:"#F5F5F7",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.07)",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",textPrimary:"#1D1D1F",textSecondary:"#6E6E73",danger:"#D93025",dangerBg:"#FCE8E6",success:"#34A853",successBg:"#E6F4EA"},Br={inicio:{PT:"Abertura",ES:"Apertura"},meio:{PT:"Implementa\xE7\xE3o (Tag Support)",ES:"Implementaci\xF3n"},fim:{PT:"Fechamento",ES:"Cierre"}};function Pr(){if(document.getElementById("csa-styles-v2"))return;let e=document.createElement("style");e.id="csa-styles-v2",e.textContent=`
    ...
    `,document.head.appendChild(e)}function ti(){let e="v3.1.0";Pr();let t={},a=ei(),o="BAU",n=!1,i=document.createElement("div");i.id="call-script-popup",i.classList.add("cw-module-window"),Object.assign(i.style,Ge,{right:"auto",left:"50%",width:"420px",height:"700px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)"});let r={popup:i,googleLine:null},l=null;function c(){n&&Je().then(V=>{let ae=i.querySelector("#cw-ctx-name"),s=i.querySelector("#cw-ctx-cid"),y=i.querySelector("#cw-ctx-email");if(ae&&(ae.textContent=V.advertiserName||xe("unknownClient")),s){let L=V.cid||"---";s.textContent!==L&&(s.textContent=L)}if(y){let L=V.clientEmail||xe("notFound");y.textContent!==L&&(y.textContent=L,y.title=L)}})}function g(){Je().then(V=>{let ae=new Date().toLocaleDateString(xe("dateLocale")),s=i.querySelector("#cw-am-message-area"),y=i.querySelector("#cw-am-review-container"),L=xe("amMessage")(V,ae);s&&(s.value=L),y&&(y.classList.add("visible"),y.scrollIntoView({behavior:"smooth",block:"end"}))})}function u(){n=!He(i),ze(n,i,"cw-btn-script"),n?(Te(),c(),l||(l=setInterval(c,2e3))):(qe(),l&&(clearInterval(l),l=null))}let v=De(i,xe("headerTitle"),e,xe("headerDesc"),r,()=>{u()});i.appendChild(v);let d=v.querySelector("span"),p=document.createElement("div");p.className="csa-context-banner",p.innerHTML=`
  ...
  `,j.appendChild(z),C.appendChild(j);let K=z.querySelectorAll("button"),ie=z.querySelector("#type-indicator");K.forEach((V,ae)=>{V.onclick=()=>{K.forEach(s=>s.classList.remove("active")),V.classList.add("active"),ie.style.transform=`translateX(${ae*(z.offsetWidth/2-2)}px)`,o=V.dataset.type,S.playClick(),R()}}),Se(()=>{a=ei(),d&&(d.textContent=xe("headerTitle"));let V=i.querySelector(".cw-help-title");V&&(V.textContent=xe("headerTitle"));let ae=i.querySelector(".cw-help-description");ae&&(ae.textContent=xe("headerDesc"));let s=p.querySelector(".js-csa-monitoring");s&&(s.title=xe("activeMonitoring"));let y=p.querySelector(".js-csa-cid-label");y&&(y.textContent=xe("cidLabel"));let L=p.querySelector(".js-csa-email-label");L&&(L.textContent=xe("emailLabel")),p.querySelectorAll(".csa-copy-hint").forEach(m=>m.textContent=xe("copied"));let b=p.querySelector(".js-csa-am-title");b&&(b.textContent=xe("amMessageTitle"));let f=p.querySelector(".js-csa-am-sub");f&&(f.textContent=xe("amMessageSub")),D&&(D.textContent=xe("copyFinalMessage"));let I=F.querySelector(".js-csa-reset-label");I&&(I.textContent=xe("resetScript")),R()});let le=document.createElement("div");le.id="csa-checklist-area",C.appendChild(le);let W=document.createElement("div");Object.assign(W.style,rt),W.className="no-drag",W.title=xe("resize"),i.appendChild(W),st(i,W),document.body.appendChild(i),q("#cw-pill-cid","#cw-ctx-cid"),q("#cw-pill-email","#cw-ctx-email");function ee(V){return V.replace(/\n/g,"<br>")}function H(V,ae,s,y){let L=`${V}-${ae}-${y}`,b=!!t[L],f=document.createElement("div");f.className="csa-item-row"+(b?" completed":"");let I=document.createElement("div");I.className="csa-checkbox"+(b?" checked":""),I.innerHTML=b?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"";let m=document.createElement("span");return m.className="csa-item-text"+(b?" completed":""),m.innerHTML=ee(s),f.onclick=()=>{let P=!t[L];t[L]=P,S.playClick(),f.classList.toggle("completed",P),m.classList.toggle("completed",P),I.classList.toggle("checked",P),I.innerHTML=P?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"",P&&(I.classList.add("pulse"),setTimeout(()=>I.classList.remove("pulse"),150)),J(V,Dt[V])},f.appendChild(I),f.appendChild(m),{row:f,isDone:b}}function oe(V,ae,s){let y=document.createElement("div");y.className="csa-card";let L=document.createElement("div");L.className="csa-card-title",L.textContent=Br[ae][a]||"";let b=document.createElement("span");b.className="csa-card-counter",L.appendChild(b),y.appendChild(L);let f=0;s.forEach((m,P)=>{let{row:Z,isDone:de}=H(V,ae,m,P);de&&f++,y.appendChild(Z)});let I=f===s.length&&s.length>0;return y.classList.toggle("done",I),b.classList.toggle("done",I),b.textContent=`${f}/${s.length}`,y}function R(){le.innerHTML="";let V=`${a} ${o}`,ae=Dt[V];if(!ae){le.innerHTML=`<div class="csa-empty-state"><div class="csa-empty-state-icon">\u2615</div><div>${xe("scriptNotConfigured")}</div></div>`,T.style.width="0%";return}let s=0,y=0;["inicio","meio","fim"].forEach(L=>{ae[L]&&(s+=ae[L].length)}),["inicio","meio","fim"].forEach(L=>{let b=ae[L];!b||b.length===0||(b.forEach((f,I)=>{let m=`${V}-${L}-${I}`;t[m]&&y++}),le.appendChild(oe(V,L,b)))}),te(s,y)}function J(V,ae){let s=0,y=0;["inicio","meio","fim"].forEach(L=>{let b=ae[L]||[];s+=b.length,b.forEach((f,I)=>{t[`${V}-${L}-${I}`]&&y++})}),te(s,y),setTimeout(()=>R(),200)}function te(V,ae){let s=V===0?0:ae/V*100;T.style.width=`${s}%`,T.classList.toggle("complete",s===100)}return R(),Zn(()=>R()),u}var Gr={"Ponto Eletr\xF4nico":"Control de Asistencia","Ferramenta de ajuda":"Herramienta de ayuda","Intranet Google":"Intranet Google","Relat\xF3rio Follow-ups":"Informe de Follow-ups","Dashboard WFM":"Dashboard WFM","Tech Solutions SAO":"Tech Solutions SAO","Form Grava\xE7\xE3o":"Form Grabaci\xF3n","Form Escala\xE7\xE3o":"Form Escalaci\xF3n","Instru\xE7\xF5es Split":"Instrucciones Split","Single Page App":"Single Page App","Procedimento Padr\xE3o":"Procedimiento Est\xE1ndar","Valida\xE7\xE3o C\xF3digo":"Validaci\xF3n C\xF3digo","Convers\xE3o Chamada":"Conversi\xF3n Llamada","Valida\xE7\xE3o WCC":"Validaci\xF3n WCC",ECW4:"ECW4","Monitoramento EC":"Monitoreo EC","Resolu\xE7\xE3o problemas":"Resoluci\xF3n de problemas","Implementa\xE7\xE3o RMKT":"Implementaci\xF3n RMKT","Pontua\xE7\xE3o Leads":"Puntuaci\xF3n de Leads","Instala\xE7\xE3o Container":"Instalaci\xF3n Container","Instala\xE7\xE3o Config.":"Instalaci\xF3n Config.","Valida\xE7\xE3o GA4":"Validaci\xF3n GA4","Guia Dev":"Gu\xEDa Dev","Resolu\xE7\xE3o Problemas":"Resoluci\xF3n de Problemas","Dom\xEDnio Cruzado":"Dominio Cruzado","Lista Oficial":"Lista Oficial","Criador URLs":"Creador de URLs","Setup Inicial":"Setup Inicial","Otimiza\xE7\xE3o Feed":"Optimizaci\xF3n Feed","Ferramenta Interna":"Herramienta Interna",Avalia\u00E7\u00F5es:"Rese\xF1as","Feeds Offline":"Feeds Offline","Help Center":"Help Center","Guias CMS":"Gu\xEDas CMS","Solu\xE7\xF5es Iframes":"Soluciones Iframes","Ghost Ads":"Ghost Ads","Ghost Analytics":"Ghost Analytics","Ghost GTM":"Ghost GTM",Ferramenta:"Herramienta","Ghost MC":"Ghost MC","Playground JS":"Playground JS","Testador Regex":"Probador Regex","Doc. CSP":"Doc. CSP","Guia CoMo":"Gu\xEDa CoMo","Debug CoMo":"Debug CoMo","Portal Colaborador":"Portal del Colaborador","Apps e Sistemas":"Apps y Sistemas","Folha Pagamento":"N\xF3mina","Reportar problemas":"Reportar problemas","Registro chamadas":"Registro de llamadas","Erros de sistema":"Errores de sistema","BAU/Descarte/Monitoria":"BAU/Descarte/Monitoreo","Feedback positivo":"Feedback positivo","Casos dif\xEDceis":"Casos dif\xEDciles","Chat/Email Ads":"Chat/Email Ads","Chat/Email Shopping":"Chat/Email Shopping","Perfil da Empresa":"Perfil de la Empresa","Console API":"Console API","Lista de n\xFAmeros":"Lista de n\xFAmeros",Cursos:"Cursos"};function ai(e){let t=e&&typeof e=="object"?e:{desc:e},a=t.desc||"";return se()!=="es"?a:t.descEs||Gr[a]||a}var oi={pt:{headerTitle:"Central de Links",headerDesc:"Navegue pelas categorias ou use a busca.",searchPlaceholder:"Buscar ferramenta ou SOP...",recent:"Recentes",nothingHereYet:"Nada por aqui ainda",nothingHereSub:"Os links que voc\xEA abrir aparecem aqui pra acesso r\xE1pido depois.",searchResults:"Resultados da busca",nothingFound:"Nada encontrado",noLinkMatches:e=>`Nenhum link bate com "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"Link copiado!",copyFailedToast:"N\xE3o foi poss\xEDvel copiar o link.",categoryLabels:{tasks:"Tarefas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RH",lm:"Forms",qa:"QA",suporte:"Ajuda"}},es:{headerTitle:"Central de Enlaces",headerDesc:"Navega por las categor\xEDas o usa la b\xFAsqueda.",searchPlaceholder:"Buscar herramienta o SOP...",recent:"Recientes",nothingHereYet:"Todav\xEDa no hay nada aqu\xED",nothingHereSub:"Los enlaces que abras aparecen aqu\xED para acceso r\xE1pido despu\xE9s.",searchResults:"Resultados de la b\xFAsqueda",nothingFound:"No se encontr\xF3 nada",noLinkMatches:e=>`Ning\xFAn enlace coincide con "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"\xA1Enlace copiado!",copyFailedToast:"No se pudo copiar el enlace.",categoryLabels:{tasks:"Tareas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RRHH",lm:"Forms",qa:"QA",suporte:"Ayuda"}}};function Re(e){let t=se();return oi[t]?.[e]??oi.pt[e]}function ni(e){return Re("categoryLabels")[e]??gt[e]?.label??e}var gt={tasks:{label:"Tarefas",links:[{name:"Web Clock Punch",url:"https://compass.talent.cognizant.com/psp/HCMPRD/EMPLOYEE/HRMS/h/?tab=DEFAULT",desc:"Ponto Eletr\xF4nico"},{name:"Web\xE3o Help Deluxe",url:"http://go/webao-help-deluxe",desc:"Ferramenta de ajuda"},{name:"Moma Home",url:"https://moma.corp.google.com/",desc:"Intranet Google"},{name:"Plx DataSites",url:"https://data.corp.google.com/sites/7kpryuwxw9jw/agents_follow_ups_report/",desc:"Relat\xF3rio Follow-ups"},{name:"Escala & Ader\xEAncia",url:"https://lookerstudio.google.com/c/u/0/reporting/f8966844-b70e-4070-9b7f-a29028401bf4/page/p_0tayxfleid",desc:"Dashboard WFM"},{name:"Performance Indiv.",url:"https://dashboards.corp.google.com/_a981e311_424f_410b_925f_9b019ee186ce",desc:"Tech Solutions SAO"},{name:"Solicitar Grava\xE7\xE3o",url:"https://support.google.com/policies/contact/sar",desc:"Form Grava\xE7\xE3o"},{name:"Escala\xE7\xE3o Sellers",url:"https://forms.gle/HWMhML56eE4CPZCs5",desc:"Form Escala\xE7\xE3o"},{name:"[SOP] Split",url:"https://sites.google.com/corp/google.com/technicalsolutions/case-handling_1/out-of-scope?authuser=0#h.obb5iieru15o",desc:"Instru\xE7\xF5es Split"}]},ads:{label:"Ads",links:[{name:"SPA (Tag Support)",url:"https://tagsupport.corp.google.com/create-session",desc:"Single Page App"},{name:"[SOP] Conv. Tracking",url:"https://docs.google.com/document/d/1By5Jv40kGeGWFUzMXT9xuNAeUl_s1clYybZO1nhNnAI/edit",desc:"Procedimento Padr\xE3o"},{name:"Win Criteria: Code",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit",desc:"Valida\xE7\xE3o C\xF3digo"},{name:"[SOP] Call Conv.",url:"https://docs.google.com/document/d/1es_tvx8nhMkWn-Hh9n3Jd3vzo91RpY6PuwMBlsTd-kA/edit",desc:"Convers\xE3o Chamada"},{name:"Win Criteria: WCC",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A10:A15",desc:"Valida\xE7\xE3o WCC"},{name:"[SOP] Enhanced Conv.",url:"https://docs.google.com/document/d/1R59-cUeBaX-5dOxAXxvzsRXgkVdFPzTzOCSBQWt42H0/edit",desc:"ECW4"},{name:"Ads EC Dashboard",url:"https://dashboards.corp.google.com/edit/_0ded1099_6ef3_4bc9_bba0_2445840d1b69",desc:"Monitoramento EC"},{name:"[SOP] Troubleshooting",url:"https://docs.google.com/document/d/10M0FAkMFmlhgHQJtAQPNtLRGh-BpPzR_6z1s6xYOQEk/edit",desc:"Resolu\xE7\xE3o problemas"},{name:"[SOP] Remarketing",url:"https://docs.google.com/document/d/1awOuj4rFBrukfByYuvcCFOAGbZX7H1j_EelPeCaUcoU/edit",desc:"Implementa\xE7\xE3o RMKT"},{name:"[SOP] Lead Scoring",url:"https://docs.google.com/document/d/1jyFVLvKnk1K2ojyj-K37PXcmQdU9A8wiHWj-w49yOBg/edit",desc:"Pontua\xE7\xE3o Leads"},{name:"[SOP] GTM Install",url:"https://docs.google.com/document/d/1Uj-fkPNxygeL-YQIVgLfIPo579SKF1oe78i5nHx5eLs/edit",desc:"Instala\xE7\xE3o Container"}]},analytics:{label:"GA4",links:[{name:"[SOP] GA4 Setup",url:"https://docs.google.com/document/d/1cLDh6RIo-lxfv-pffvBwhFpI-fSTOaAsMXwwsID1yNk/edit",desc:"Instala\xE7\xE3o Config."},{name:"Win Criteria: GA4",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A45:A51",desc:"Valida\xE7\xE3o GA4"},{name:"GA4 E-commerce",url:"https://developers.google.com/analytics/devguides/collection/ga4/ecommerce?hl=pt-br",desc:"Guia Dev"},{name:"[SOP] Troubleshoot GA4",url:"https://docs.google.com/document/d/14fxyQMlcT57ILtsaBdYBFZs2DDZeSbXsvniXfo_eJaU/edit",desc:"Resolu\xE7\xE3o Problemas"},{name:"[SOP] Cross Domain",url:"https://support.google.com/ads-help/answer/12282402",desc:"Dom\xEDnio Cruzado"},{name:"Eventos Recomendados",url:"https://developers.google.com/analytics/devguides/collection/ga4/reference/events",desc:"Lista Oficial"},{name:"UTM Builder",url:"https://ga-dev-tools.google/ga4/campaign-url-builder/",desc:"Criador URLs"}]},shopping:{label:"Shop",links:[{name:"[SOP] Onboarding MC",url:"https://docs.google.com/document/d/1yJGEssn9Uvxa3eWjp2Y5MQSkL26AElh6sSAKgD6qmjg/edit",desc:"Setup Inicial"},{name:"[SOP] Feed Opt",url:"https://docs.google.com/document/d/1VBYH6b3r0uyjXHN749pDK7IajF5Ii0-rm6M-BZuaJGY/edit",desc:"Otimiza\xE7\xE3o Feed"},{name:"ShopTroubleshooting",url:"http://go/shoptroubleshooting",desc:"Ferramenta Interna"},{name:"[SOP] Product Reviews",url:"https://docs.google.com/document/d/1v2xH6QLgWc5_-C85Pmj40GSe5lxstRXnjd8vEW92TBk/edit",desc:"Avalia\xE7\xF5es"},{name:"[SOP] Offline Feed",url:"https://docs.google.com/document/d/1Q3cJxf4ucfA_bu6vDId63Tj1P8ZofgE7CqnK9KUgLuU/edit",desc:"Feeds Offline"},{name:"Especifica\xE7\xE3o Dados",url:"https://support.google.com/merchants/answer/7052112",desc:"Help Center"}]},tech:{label:"Tech",links:[{name:"Solu\xE7\xF5es por CMS",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-via-cms?authuser=0",desc:"Guias CMS"},{name:"Iframes & Cross-Origin",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-t%C3%A9cnicas/iframes-contentdocument-e-message?authuser=0",desc:"Solu\xE7\xF5es Iframes"},{name:"Ads ICS Ghost",url:"http://go/pqp",desc:"Ghost Ads"},{name:"Analytics ICS Ghost",url:"http://go/analytics-ics",desc:"Ghost Analytics"},{name:"GTM ICS Ghost",url:"http://go/tagmanager-ics",desc:"Ghost GTM"},{name:"Gearloose",url:"http://go/gearloose",desc:"Ferramenta"},{name:"MC ICS Ghost",url:"https://mcn-ics.corp.google.com/mc/overview",desc:"Ghost MC"},{name:"JSFiddle",url:"https://jsfiddle.net/",desc:"Playground JS"},{name:"RegExr",url:"https://regexr.com/",desc:"Testador Regex"},{name:"Doc. CSP",url:"https://developers.google.com/tag-platform/tag-manager/web/csp?hl=pt-br.",desc:"Doc. CSP"},{name:"Consent Mode Install",url:"https://developers.google.com/tag-platform/security/guides/consent?consentmode=advanced",desc:"Guia CoMo"},{name:"Consent Mode Debug",url:"https://developers.google.com/tag-platform/security/guides/consent-debugging",desc:"Debug CoMo"}]},hr:{label:"RH",links:[{name:"Be.Cognizant",url:"https://cognizantonline.sharepoint.com/sites/GlobalHR/SitePages/Brazil.aspx",desc:"Portal Colaborador"},{name:"OneCognizant",url:"https://onecognizant.cognizant.com/Home",desc:"Apps e Sistemas"},{name:"ADP eXpert",url:"https://expert.cloud.brasil.adp.com/expert2/v4/",desc:"Folha Pagamento"}]},lm:{label:"Forms",links:[{name:"Ocorr\xEAncias e Pausas",url:"https://docs.google.com/forms/d/e/1FAIpQLSc6CamPehrREeVr7yCWMyqFETrFYYezNcLb_13W4yZDQkfY6Q/viewform",desc:"Reportar problemas"},{name:"Chamadas >50min",url:"https://docs.google.com/forms/d/e/1FAIpQLSfE8EMHNJMTKYeA6XM2RZjZ9AQ4LhGk1Dwm_WLu3kcMdKMikA/viewform",desc:"Registro chamadas"},{name:"Relat\xF3rio de Bugs",url:"https://docs.google.com/forms/d/e/1FAIpQLSfkqRqT2Kbf08IStz31fQPE84MDOtGxk7cetJmc3xzShXIXRA/viewform",desc:"Erros de sistema"},{name:"Suporte LM",url:"https://script.google.com/a/macros/google.com/s/AKfycbxYMlFCMZvqgHMIImeS_u-lNZPiertXmem-5m9Fox3jvZaq0ZOQDoc5ma96ltSvWHY/exec",desc:"BAU/Descarte/Monitoria"}]},qa:{label:"QA",links:[{name:"Elogios",url:"https://docs.google.com/forms/d/e/1FAIpQLSezY5K-trQDv0LkL5IoTlV0Tl0oOqGTEszylmgcbMRXcC9Weg/viewform",desc:"Feedback positivo"},{name:"Casos Complexos",url:"https://docs.google.com/forms/d/e/1FAIpQLSe26q1LEloFNRfOAVZtA7DCOQTqdu1BAEeWuxtK6oPwZhLp-A/viewform?resourcekey=0-c1N4h8gntza2gQowqYAqMw",desc:"Casos dif\xEDceis"}]},suporte:{label:"Ajuda",links:[{name:"Fale Conosco Ads",url:"https://support.google.com/google-ads/gethelp",desc:"Chat/Email Ads"},{name:"Fale Conosco Merchant",url:"https://support.google.com/merchants/gethelp",desc:"Chat/Email Shopping"},{name:"Fale Conosco GMB",url:"https://support.google.com/business/gethelp",desc:"Perfil da Empresa"},{name:"Suporte API",url:"https://support.google.com/googleapi",desc:"Console API"},{name:"Telefones Suporte",url:"https://www.adwordsrobot.com/en/list-of-google-adwords-support-phone-numbers",desc:"Lista de n\xFAmeros"},{name:"Skill Shop",url:"https://skillshop.withgoogle.com/intl/pt-BR_ALL/",desc:"Cursos"}]}};function ii(e){if(!Array.isArray(e)||!e.length)return!1;let t={};for(let a of e){let o=a.key;if(!o)continue;let n;try{n=JSON.parse(a.value||"{}")}catch{continue}!n.name||!n.url||(t[o]||(t[o]={label:gt[o]?.label||o,links:[]}),t[o].links.push({name:n.name,url:n.url,desc:n.desc||"",descEs:n.desc_es||""}))}if(!Object.keys(t).length)return!1;for(let a of Object.keys(gt))delete gt[a];return Object.assign(gt,t),!0}async function jr(e){let t=me.getCachedContent("links");ii(t)&&e?.();try{let a=await me.fetchContentModule("links");ii(a)&&e?.()}catch(a){console.warn("Central de Conte\xFAdo indispon\xEDvel; usando links embutidos.",a)}}var ft={tasks:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>',lm:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/></svg>',qa:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>',suporte:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',ads:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>',analytics:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>',shopping:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>',tech:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg>',hr:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',history:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>'},ht={bgApp:"#F8F9FA",bgSidebar:"#FFFFFF",bgSurface:"#FFFFFF",textPrimary:"#202124",textSecondary:"#5F6368",borderSubtle:"rgba(0,0,0,0.06)"},Aa={tasks:{color:"#0097A7",bg:"#E0F7FA"},ads:{color:"#1967D2",bg:"#E8F0FE"},analytics:{color:"#E37400",bg:"#FEF7E0"},shopping:{color:"#188038",bg:"#E6F4EA"},tech:{color:"#9334E6",bg:"#F3E8FD"},hr:{color:"#C5221F",bg:"#FCE8E6"},lm:{color:"#5F6368",bg:"#F1F3F4"},qa:{color:"#F09D00",bg:"#FFF3E0"},suporte:{color:"#0B57D0",bg:"#D3E3FD"},history:{color:"#5F6368",bg:"#FFFFFF"}};function Hr(){if(document.getElementById("cw-links-styles"))return;let e=document.createElement("style");e.id="cw-links-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}var ro="cw_link_history_v4",Ur=10;function ri(e,t){try{let a=JSON.parse(localStorage.getItem(ro)||"[]");a=a.filter(o=>o.url!==e.url),a.unshift({...e,_originalCat:t}),a=a.slice(0,Ur),localStorage.setItem(ro,JSON.stringify(a))}catch(a){console.warn("Erro ao salvar hist\xF3rico",a)}}function Vr(){try{return JSON.parse(localStorage.getItem(ro)||"[]")}catch{return[]}}function si(){let e="v4.6",t="",a=!1,o=null,n=!1;Hr();let i=document.createElement("div");i.id="links-popup",i.classList.add("cw-module-window"),Object.assign(i.style,Ge,{right:"100px",width:"600px",height:"650px",background:ht.bgApp,overflow:"hidden"});let r={popup:i,googleLine:null},l=De(i,Re("headerTitle"),e,Re("headerDesc"),r,()=>j());i.appendChild(l);let c=l.querySelector("span"),g=document.createElement("div");g.className="cw-links-layout",i.appendChild(g);let u=document.createElement("div");u.className="cw-links-sidebar",g.appendChild(u);let v=document.createElement("div");v.className="cw-links-content",g.appendChild(v);let d=document.createElement("div");d.className="cw-links-search-bar";let p=document.createElement("div");p.className="cw-links-search-wrap";let _=document.createElement("div");_.className="cw-links-search-icon",_.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#5F6368" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let w=document.createElement("input");w.className="cw-links-search-input",w.type="text",w.placeholder=Re("searchPlaceholder"),p.appendChild(_),p.appendChild(w),d.appendChild(p),v.appendChild(d);let E=document.createElement("div");E.className="cw-links-scroll",v.appendChild(E);let M=null;function A(){if(M)return;M=document.createElement("div"),M.className="cw-links-history-overlay";let z=document.createElement("div");z.className="cw-links-history-head",z.innerHTML=`<span class="cw-links-history-title js-links-recent">\u{1F552} ${Re("recent")}</span>`;let K=document.createElement("button");K.className="cw-links-history-close",K.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',K.onclick=()=>D(),z.appendChild(K),M.appendChild(z);let ie=document.createElement("div");ie.id="cw-history-list",ie.className="cw-links-history-list",M.appendChild(ie),v.appendChild(M)}function D(){n&&(n=!1,q(),N())}function h(){M||A();let z=M.querySelector("#cw-history-list");z.innerHTML="";let K=Vr();K.length===0?z.appendChild(Bt({icon:ft.history,title:Re("nothingHereYet"),subtitle:Re("nothingHereSub")})):K.forEach(ie=>{let le=F(ie,ft[ie._originalCat],!0,ie._originalCat);z.appendChild(le)}),requestAnimationFrame(()=>M.style.transform="translateY(0)")}function q(){M&&(M.style.transform="translateY(100%)")}document.addEventListener("mousedown",z=>{!n||!M||!M.contains(z.target)&&!u.contains(z.target)&&D()}),document.addEventListener("keydown",z=>{z.key==="Escape"&&n&&D()});function $(){u.innerHTML="";let z=T("history",Re("recent"),ft.history);z.id="cw-sidebar-btn-history",z.onclick=()=>{S.playClick(),n=!n,n?h():q(),N()},u.appendChild(z);let K=document.createElement("div");K.className="cw-links-nav-sep",u.appendChild(K),Object.keys(gt).forEach(ie=>{let le=T(ie,ni(ie),ft[ie]);le.id=`cw-sidebar-btn-${ie}`,le.onclick=()=>{S.playClick(),n&&D(),C(ie)},u.appendChild(le)})}function T(z,K,ie){let le=document.createElement("div");le.className="cw-links-nav-btn",le.title=K,le.dataset.key=z;let W=Aa[z];W&&(le.style.setProperty("--cat-color",W.color),le.style.setProperty("--cat-bg",W.bg));let ee=document.createElement("div");ee.className="cw-links-nav-icon",ee.innerHTML=ie||ft.tasks;let H=document.createElement("div");return H.className="cw-links-nav-label",H.textContent=K,le.appendChild(ee),le.appendChild(H),le}function C(z){let K=document.getElementById(`cat-anchor-${z}`);K&&(K.scrollIntoView({behavior:"smooth",block:"start"}),o=z,N())}function N(){Object.keys(gt).forEach(K=>{let ie=u.querySelector(`#cw-sidebar-btn-${K}`);ie&&ie.classList.toggle("active",o===K&&!n)});let z=u.querySelector("#cw-sidebar-btn-history");z&&z.classList.toggle("history-open",n)}function k(){if(E.innerHTML="",t.trim()!==""){let K=[];if(Object.entries(gt).forEach(([le,W])=>{let ee=W.links.filter(H=>H.name.toLowerCase().includes(t.toLowerCase())||ai(H).toLowerCase().includes(t.toLowerCase()));K.push(...ee.map(H=>({...H,_cat:le})))}),K.length===0){E.appendChild(Bt({icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',title:Re("nothingFound"),subtitle:Re("noLinkMatches")(t.trim())}));return}let ie=document.createElement("div");ie.className="cw-links-search-results-label",ie.textContent=Re("searchResults"),E.appendChild(ie),K.forEach(le=>{let W=F(le,ft[le._cat],!1,le._cat);E.appendChild(W)});return}Object.entries(gt).forEach(([K,ie])=>{let le=Aa[K],W=document.createElement("div"),ee=document.createElement("div");ee.id=`cat-anchor-${K}`,ee.className="cw-links-cat-header",ee.style.setProperty("--cat-color",le.color),ee.innerHTML=`<div class="cw-links-cat-dot"></div>${ni(K)}`,W.appendChild(ee);let H=document.createElement("div");H.className="cw-links-cat-grid",ie.links.forEach(oe=>{let R=F(oe,ft[K],!1,K);H.appendChild(R)}),W.appendChild(H),E.appendChild(W)});let z=document.createElement("div");z.className="cw-links-spacer",E.appendChild(z)}function F(z,K,ie,le){let W=document.createElement("a");W.className="cw-links-card",W.href=z.url,W.target="_blank",W.rel="noopener noreferrer";let ee=Aa[le]||Aa.history;W.style.setProperty("--cat-color",ee.color),W.style.setProperty("--cat-bg",ee.bg);let H=document.createElement("div");H.className="cw-links-icon-box",H.innerHTML=K||ft.tasks;let oe=document.createElement("div");oe.className="cw-links-card-meta";let R=document.createElement("div");R.className="cw-links-card-title",R.textContent=z.name;let J=document.createElement("div");J.className="cw-links-card-desc",J.textContent=ai(z),oe.appendChild(R),oe.appendChild(J);let te=document.createElement("div");return te.className="cw-links-copy-btn",te.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',te.title=Re("copyUrl"),W.onclick=()=>{!ie&&le&&ri(z,le)},te.onclick=V=>{V.preventDefault(),V.stopPropagation(),navigator.clipboard.writeText(z.url).then(()=>{S.playClick(),!ie&&le&&ri(z,le),X(Re("linkCopiedToast"))}).catch(()=>{S.playError(),X(Re("copyFailedToast"),{error:!0})})},W.appendChild(H),W.appendChild(oe),W.appendChild(te),W}w.addEventListener("input",z=>{t=z.target.value,k()});function j(){a=!He(i),a?Te():qe(),ze(a,i,"cw-btn-links")}return document.body.appendChild(i),$(),k(),jr(()=>{$(),k(),N()}),Se(()=>{c&&(c.textContent=Re("headerTitle"));let z=i.querySelector(".cw-help-title");z&&(z.textContent=Re("headerTitle"));let K=i.querySelector(".cw-help-description");K&&(K.textContent=Re("headerDesc")),w.placeholder=Re("searchPlaceholder"),$(),k(),N(),n&&h()}),j}var Wr=60*1e3,gi="cw_read_broadcasts",li={pt:{headerTitle:"Central de Avisos",headerDesc:"Comunica\xE7\xE3o oficial da opera\xE7\xE3o.",searchPlaceholder:"Buscar avisos\u2026",clearSearch:"Limpar a busca",markRead:e=>`Marcar \u201C${e}\u201D como lido`,markReadShort:"Marcar como lido",publishedBy:e=>`Publicado por ${e}`,system:"Sistema",bauAvailability:"Disponibilidade BAU",attention:"aten\xE7\xE3o",full:"total",noDates:"sem datas publicadas",asideLabel:"Estado da opera\xE7\xE3o",filtersTitle:"Filtrar por tipo",filterAll:"Todos",readTitle:"Leitura",readCount:e=>e===1?"1 lido":`${e} lidos`,markAllRead:"Marcar tudo como lido",updatedAgo:e=>`Atualizado ${e}`,swapTo:e=>`Ver disponibilidade de ${e}`,justNow:"agora",minutesAgo:e=>`h\xE1 ${e} min`,hoursAgo:e=>`h\xE1 ${e} h`,yesterday:"ontem",nothingFound:"Nada encontrado.",allRead:"Tudo lido!",history:e=>`Hist\xF3rico (${e})`,typeLabel:{info:"Info",critical:"Alerta",success:"Sucesso"},syncing:"Sincronizando\u2026",updated:"Atualizado",offline:"Sem conex\xE3o \u2014 mostrando o que j\xE1 estava aqui"},es:{headerTitle:"Central de Avisos",headerDesc:"Comunicaci\xF3n oficial de la operaci\xF3n.",searchPlaceholder:"Buscar avisos\u2026",clearSearch:"Limpiar la b\xFAsqueda",markRead:e=>`Marcar \u201C${e}\u201D como le\xEDdo`,markReadShort:"Marcar como le\xEDdo",publishedBy:e=>`Publicado por ${e}`,system:"Sistema",bauAvailability:"Disponibilidad BAU",attention:"atenci\xF3n",full:"total",noDates:"sin fechas publicadas",asideLabel:"Estado de la operaci\xF3n",filtersTitle:"Filtrar por tipo",filterAll:"Todos",readTitle:"Lectura",readCount:e=>e===1?"1 le\xEDdo":`${e} le\xEDdos`,markAllRead:"Marcar todo como le\xEDdo",updatedAgo:e=>`Actualizado ${e}`,swapTo:e=>`Ver disponibilidad de ${e}`,justNow:"ahora",minutesAgo:e=>`hace ${e} min`,hoursAgo:e=>`hace ${e} h`,yesterday:"ayer",nothingFound:"No se encontr\xF3 nada.",allRead:"\xA1Todo le\xEDdo!",history:e=>`Historial (${e})`,typeLabel:{info:"Info",critical:"Alerta",success:"\xC9xito"},syncing:"Sincronizando\u2026",updated:"Actualizado",offline:"Sin conexi\xF3n \u2014 mostrando lo que ya estaba aqu\xED"}};function be(e){let t=se();return li[t]?.[e]??li.pt[e]}var ka={PT:{label:"PT-BR",flag:'<svg class="cw-bc-bau-flag" viewBox="0 0 21 15" aria-hidden="true"><rect width="21" height="15" fill="#009B3A"/><path d="M10.5 1.9 19.1 7.5 10.5 13.1 1.9 7.5Z" fill="#FEDF00"/><circle cx="10.5" cy="7.5" r="3.3" fill="#002776"/></svg>'},ES:{label:"ES",flag:'<svg class="cw-bc-bau-flag" viewBox="0 0 21 15" aria-hidden="true"><rect width="21" height="15" fill="#AA151B"/><rect y="3.75" width="21" height="7.5" fill="#F1BF00"/></svg>'}},Yr='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="17 2 21 6 17 10"></polyline><path d="M3 12V10a4 4 0 0 1 4-4h14"></path><polyline points="7 22 3 18 7 14"></polyline><path d="M21 12v2a4 4 0 0 1-4 4H3"></path></svg>',so={critical:!0,info:!0,success:!0};function Xr(){if(document.getElementById("cw-broadcast-styles"))return;let e=document.createElement("style");e.id="cw-broadcast-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}var Kr={pt:"pt-BR",es:"es-ES"};function bi(e){if(!e)return"";try{let t=new Date(e);return isNaN(t.getTime())?String(e):new Intl.DateTimeFormat(Kr[se()]||"pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).format(t)}catch{return String(e)}}function Jr(e){let t=String(e||"").split("-");return t.length===3?`${t[2]}/${t[1]}`:String(e||"")}function Zr(e){let t=new Date(e).getTime();if(!t||isNaN(t))return"";let a=Math.floor((Date.now()-t)/6e4);if(a<1)return be("justNow");if(a<60)return be("minutesAgo")(a);let o=Math.floor(a/60);return o<24?be("hoursAgo")(o):o<48?be("yesterday"):bi(e).split(",")[0]}function ci(e){if(!e||typeof e!="string")return"";let t=e;return t=t.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="cw-bc-link">$1</a>'),t=t.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),t=t.replace(/_(.*?)_/g,"<i>$1</i>"),t=t.replace(/\n/g,"<br>"),t=Ho(t),t}function di(e){if(!e)return null;let t={};try{t=JSON.parse(e.value||"{}")}catch{return null}let a=String(t.title||e.label||"").trim(),o=String(t.text||"").trim();return!a||!o?null:{id:String(e.key||e.id||""),type:so[t.type]?t.type:"info",title:a,text:o,date:String(t.publishedAt||e.publishedAt||""),author:String(t.author||e.publishedBy||""),lang:String(e.lang||"ALL").toUpperCase()}}function Qr(e){if(!e)return null;let t=String(e.title||"").trim(),a=String(e.text||"").trim();return!t||!a||t.toLowerCase().includes("disponibilidade bau")?null:{id:String(e.id||""),type:so[e.type]?e.type:"info",title:t,text:a,date:String(e.date||""),author:String(e.author||""),lang:"ALL"}}function pi(e){let t=(e||[])[0];if(!t)return null;let a={};try{a=JSON.parse(t.value||"{}")}catch{return null}let o=a.segments||{},n={};return Object.keys(o).forEach(i=>{let r=String(o[i]?.attention||""),l=String(o[i]?.full||"");(r||l)&&(n[i]={attention:r,full:l})}),Object.keys(n).length?{updatedAt:String(a.updatedAt||t.publishedAt||""),author:String(a.author||t.publishedBy||""),note:String(a.note||""),segments:n}:null}function ui(e,t){return e.lang==="ALL"||e.lang===t}function zt(){try{let e=JSON.parse(localStorage.getItem(gi)||"[]");return Array.isArray(e)?e:[]}catch{return[]}}function mi(e){try{localStorage.setItem(gi,JSON.stringify(e))}catch{}}function fi(){let e="v5.0",t=!1,a=null,o="",n=null,i=null,r=!1,l=[],c=null,g=null,u=null,v=null;Xr();let d=document.createElement("div");d.id="broadcast-popup",d.classList.add("cw-module-window"),Object.assign(d.style,Ge,{right:"auto",left:"50%",width:"760px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let p={popup:d,googleLine:null};function _(){if(t=!He(d),ze(t,d,"cw-btn-broadcast"),t){Te();let b=document.getElementById("cw-btn-broadcast");b&&b.classList.remove("has-new"),n=null,i=null,r=!1,K()}else qe()}let w=De(d,be("headerTitle"),e,be("headerDesc"),p,()=>_()),E=w.querySelector("span");d.appendChild(w);let M=document.createElement("div");M.className="cw-bc-search-wrap";let A=document.createElement("div");A.className="cw-bc-search-icon",A.setAttribute("aria-hidden","true"),A.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let D=document.createElement("input");D.className="cw-bc-search-input no-drag",D.type="search",D.name="cw-broadcast-search",D.autocomplete="off",D.spellcheck=!1,D.placeholder=be("searchPlaceholder"),D.setAttribute("aria-label",be("searchPlaceholder"));let h=document.createElement("button");h.type="button",h.className="cw-bc-search-clear",h.setAttribute("aria-label",be("clearSearch")),h.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';let q=document.createElement("div");q.className="cw-bc-search-field",q.append(A,D,h),M.appendChild(q),d.appendChild(M),D.addEventListener("input",b=>{o=b.target.value,h.classList.toggle("visible",o.length>0),ae()}),h.onclick=()=>{D.value="",o="",h.classList.remove("visible"),ae(),D.focus()};let $=document.createElement("div");$.className="cw-bc-body",d.appendChild($);let T=document.createElement("div");T.className="cw-nice-scroll cw-bc-feed",T.setAttribute("role","feed"),T.setAttribute("aria-label",be("headerTitle")),$.appendChild(T);let C=document.createElement("aside");C.className="cw-nice-scroll cw-bc-aside",C.setAttribute("aria-label",be("asideLabel")),$.appendChild(C);let N=document.createElement("div");N.id="cw-bau-widget",N.className="cw-bc-panel",N.style.display="none",C.appendChild(N);let k=document.createElement("div");k.className="cw-bc-panel",C.appendChild(k);let F=document.createElement("div");F.className="cw-bc-panel",C.appendChild(F);let j=document.createElement("div");j.id="cw-update-status",j.className="cw-bc-sync",j.setAttribute("role","status"),j.setAttribute("aria-live","polite"),C.appendChild(j);function z({syncing:b=!1,online:f=!0}={}){if(j.classList.toggle("offline",!b&&!f),b){j.innerHTML=`<span class="cw-bc-spinner" aria-hidden="true"></span><span>${be("syncing")}</span>`;return}let I=v?Zr(v):"",m=f?I?be("updatedAgo")(I):be("updated"):be("offline");j.innerHTML=`<span class="cw-bc-sync-dot" aria-hidden="true"></span><span>${m}</span>`}async function K(){z({syncing:!0});let b=!0,f=Ut();try{let[I,m]=await Promise.all([me.fetchContentModule("broadcast"),me.fetchContentModule("bau_availability")]);if(Array.isArray(I)){let P=I.map(di).filter(Boolean).filter(Z=>ui(Z,f));l=le(P)}else b=!1;c=pi(m)}catch{b=!1}b&&(v=new Date().toISOString()),ie(),W(),ae(),z({online:b})}function ie(){let b=c?c.updatedAt:null;if(!(g===null)&&!t){let I=zt();(l.some(Z=>!g.has(Z.id)&&!I.includes(Z.id))||b&&b!==u)&&S.playNotification()}g=new Set(l.map(I=>I.id)),u=b}function le(b){return b.slice().sort((f,I)=>{let m=new Date(f.date).getTime()||0;return(new Date(I.date).getTime()||0)-m})}function W(){let b=document.getElementById("cw-btn-broadcast");if(!b)return;let f=zt();if(l.some(m=>!f.includes(m.id))){if(b.classList.add("has-new"),!b.querySelector(".cw-badge")){let m=document.createElement("div");m.className="cw-badge",Object.assign(m.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),b.appendChild(m)}}else{b.classList.remove("has-new");let m=b.querySelector(".cw-badge");m&&m.remove()}}function ee(){if(!c){N.style.display="none",N.innerHTML="";return}let b=Object.keys(ka).filter(U=>c.segments[U]);if(!b.length){N.style.display="none",N.innerHTML="";return}let f=n&&b.includes(n)?n:b.includes(Ut())?Ut():b[0],I=ka[f],m=c.segments[f]||{},P=(U,Q)=>`
          <span class="cw-bc-bau-date ${U}">
              <span class="cw-bc-bau-dot"></span>
              <span class="cw-bc-bau-kind">${be(U)}</span>
              <span class="cw-bc-bau-value">${Jr(Q)}</span>
          </span>`,Z=[m.attention?P("attention",m.attention):"",m.full?P("full",m.full):""].join(""),de=b.find(U=>U!==f),x=de?`<button class="cw-bc-bau-swap" type="button"
                     aria-label="${be("swapTo")(ka[de].label)}"
                     title="${be("swapTo")(ka[de].label)}">${Yr}</button>`:"";N.style.display="flex",N.innerHTML=`
          <div class="cw-bc-bau-top">
              ${I.flag}
              <span class="cw-bc-bau-label">${be("bauAvailability")}</span>
              <span class="cw-bc-bau-seg">${I.label}</span>
              ${x}
          </div>
          <div class="cw-bc-bau-dates">
              ${Z||`<span class="cw-bc-bau-empty">${be("noDates")}</span>`}
          </div>
          ${c.note?`<div class="cw-bc-bau-note">${ci(c.note)}</div>`:""}
      `;let O=N.querySelector(".cw-bc-bau-swap");O&&(O.onclick=()=>{n=de,S.playClick(),ee()})}function H(){let b={critical:0,info:0,success:0};l.forEach(m=>{b[m.type]=(b[m.type]||0)+1});let f=(m,P,Z)=>`
          <button class="cw-bc-filter" type="button" data-tipo="${m}"
                  aria-pressed="${i===m}">
              ${m==="all"?"":`<span class="cw-bc-type-dot ${m}"></span>`}
              <span>${P}</span>
              <span class="cw-bc-filter-count">${Z}</span>
          </button>`;k.innerHTML=`
      ...
      `,k.querySelectorAll(".cw-bc-filter").forEach(m=>{m.onclick=()=>{let P=m.dataset.tipo;i=P==="all"||P===i?null:P,S.playClick(),ae()}});let I=k.querySelector('[data-tipo="all"]');I&&I.setAttribute("aria-pressed",String(i===null))}function oe(){let b=zt(),f=l.filter(m=>b.includes(m.id)).length,I=l.length-f;F.innerHTML=`
          ...
          <button class="cw-bc-clear-btn" type="button" ${I?"":"disabled"}>
              ${be("markAllRead")}
          </button>
      `,F.querySelector(".cw-bc-history-divider").onclick=()=>{S.playClick(),r=!r,ae()},F.querySelector(".cw-bc-clear-btn").onclick=()=>{I&&(S.playSuccess(),mi(l.map(m=>m.id)),ae(),W())}}let R=0;function J(b,f){let I=document.createElement("article");I.className="cw-bc-card"+(f?" history":"");let m=so[b.type]?b.type:"info",P=`cw-bc-title-${++R}`;I.setAttribute("aria-labelledby",P);let Z=document.createElement("div");if(Z.className="cw-bc-card-meta",Z.innerHTML=`
        <span class="cw-bc-type">
            <span class="cw-bc-type-dot ${m}"></span>${be("typeLabel")[m]}
        </span>
        <span class="cw-bc-meta-sep" aria-hidden="true">\xB7</span>
        <span class="cw-bc-date-tag">${bi(b.date)}</span>
    `,!f){let U=document.createElement("button");U.type="button",U.className="cw-bc-dismiss-btn",U.setAttribute("aria-label",be("markRead")(b.title)),U.title=be("markReadShort"),U.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>',U.onclick=Q=>{Q.stopPropagation(),S.playClick(),I.style.transform="translateX(20px)",I.style.opacity="0",setTimeout(()=>{let ne=zt();ne.push(b.id),mi(ne),ae(),W()},300)},Z.appendChild(U)}let de=document.createElement("h3");de.className="cw-bc-msg-title",de.id=P,de.textContent=b.title;let x=document.createElement("div");x.className="cw-bc-msg-body",x.innerHTML=ci(b.text);let O=document.createElement("div");return O.className="cw-bc-msg-author",O.textContent=be("publishedBy")(b.author||be("system")),I.append(Z,de,x,O),I}function te(b,f){return i&&b.type!==i?!1:f?`${b.title||""} ${b.text||""}`.toLowerCase().includes(f):!0}function V(b,f){let I=b.filter(P=>!f.includes(P.id)),m=b.filter(P=>f.includes(P.id));if(!I.length&&!(r&&m.length)){let P=o.trim().length>0||i!==null,Z=document.createElement("div");Z.className="cw-bc-empty",Z.innerHTML=P?`<div>${be("nothingFound")}</div>`:`
               ...
               <div>${be("allRead")}</div>
              `,T.appendChild(Z);return}if(I.forEach(P=>T.appendChild(J(P,!1))),r&&m.length){let P=document.createElement("div");P.className="cw-bc-history-container",P.id="cw-bc-history",P.style.display="flex",m.forEach(Z=>P.appendChild(J(Z,!0))),T.appendChild(P)}}function ae(){ee(),H(),oe(),T.innerHTML="";let b=zt(),f=o.trim().toLowerCase();V(l.filter(I=>te(I,f)),b)}let s=me.getCachedContent("broadcast");Array.isArray(s)&&s.length?l=le(s.map(di).filter(Boolean).filter(b=>ui(b,Ut()))):l=le(me.getCachedBroadcasts().map(Qr).filter(Boolean)),c=pi(me.getCachedContent("bau_availability")),ae(),K(),a||(a=setInterval(K,Wr));let y=document.createElement("div");Object.assign(y.style,rt),y.className="no-drag",d.appendChild(y),st(d,y),document.body.appendChild(d);let L=l.some(b=>!zt().includes(b.id));return Se(()=>{E&&(E.textContent=be("headerTitle"));let b=d.querySelector(".cw-help-title");b&&(b.textContent=be("headerTitle"));let f=d.querySelector(".cw-help-description");f&&(f.textContent=be("headerDesc")),D.placeholder=be("searchPlaceholder"),D.setAttribute("aria-label",be("searchPlaceholder")),h.setAttribute("aria-label",be("clearSearch")),T.setAttribute("aria-label",be("headerTitle")),C.setAttribute("aria-label",be("asideLabel")),ae(),z({online:!0})}),{toggle:_,hasUnread:L}}var hi="cw-wizard-shell-styles",xi={pt:{back:"Voltar",skip:"Pular",next:"Pr\xF3ximo",done:"Concluir",dotsGroup:"Navega\xE7\xE3o entre os slides",report:"Reportar bug ou sugest\xE3o",slideLabel:(e,t)=>`Slide ${e} de ${t}`,announce:(e,t,a,o)=>`Slide ${e} de ${t}: ${a}. ${o}`},es:{back:"Volver",skip:"Omitir",next:"Siguiente",done:"Finalizar",dotsGroup:"Navegaci\xF3n entre las diapositivas",report:"Reportar error o sugerencia",slideLabel:(e,t)=>`Diapositiva ${e} de ${t}`,announce:(e,t,a,o)=>`Diapositiva ${e} de ${t}: ${a}. ${o}`}};function xt(e){let t=se();return xi[t]?.[e]??xi.pt[e]}var vi=160,lo=320,es=()=>window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function ts(){if(document.getElementById(hi))return;let e=document.createElement("style");e.id=hi,e.textContent=`
        .cw-wiz-overlay {
            --cw-wiz-swap: ${vi}ms;
            --cw-wiz-shell: ${lo}ms;
    ...
    `,document.head.appendChild(e)}var as='button:not([hidden]):not([disabled]), [href], input, select, textarea, [tabindex]:not([tabindex="-1"])';function Ta({slides:e,idPrefix:t,badge:a=null,nextLabel:o=null,finalLabel:n=null,skipLabel:i=null,onSkip:r=null,onClose:l=()=>{}}){let c={next:o||xt("next"),final:n||xt("done"),skip:i};if(!Array.isArray(e)||e.length===0)return console.warn("[wizard-shell] chamado sem slides; nada a mostrar."),{close:()=>{}};ts();let g=`${t}-title`,u=`${t}-text`,v=document.activeElement,d=0,p=!1,_=null,w=document.createElement("div");w.className="cw-wiz-overlay",w.setAttribute("role","dialog"),w.setAttribute("aria-modal","true"),w.setAttribute("aria-labelledby",g),w.setAttribute("aria-describedby",u);let E=document.createElement("div");if(E.className="cw-wiz-card",a){let R=document.createElement("div");R.className="cw-wiz-badge",R.textContent=a,E.appendChild(R)}let M=document.createElement("div");M.className="cw-wiz-stage";let A=document.createElement("div");A.className="cw-wiz-icon",A.setAttribute("aria-hidden","true");let D=document.createElement("div");D.className="cw-wiz-title",D.id=g;let h=document.createElement("div");h.className="cw-wiz-text",h.id=u,M.appendChild(A),M.appendChild(D),M.appendChild(h);let q=document.createElement("div");q.className="cw-wiz-live",q.setAttribute("aria-live","polite"),q.setAttribute("aria-atomic","true");let $=document.createElement("div");$.className="cw-wiz-dots",$.setAttribute("role","group"),$.setAttribute("aria-label",xt("dotsGroup"));let T=document.createElement("div");T.className="cw-wiz-actions";let C=document.createElement("button");C.type="button",C.className="cw-wiz-btn cw-wiz-btn-ghost",C.textContent=xt("back");let N=document.createElement("button");N.type="button",N.className="cw-wiz-skip",N.textContent=i||xt("skip"),i||(N.hidden=!0);let k=document.createElement("button");k.type="button",k.className="cw-wiz-btn cw-wiz-btn-primary",T.appendChild(C),T.appendChild(k),i&&(E.classList.add("has-skip"),E.appendChild(N)),E.appendChild(M),E.appendChild(q),E.appendChild($),E.appendChild(T);let F=document.createElement("div");F.className="cw-wiz-footer";let j=document.createElement("a");j.href=It,j.target="_blank",j.rel="noopener noreferrer",j.textContent=xt("report");let z=document.createElement("span");z.textContent="\xB7",z.style.opacity="0.5",z.setAttribute("aria-hidden","true");let K=document.createElement("span");K.append(se()==="es"?"creado por ":"criado por ");let ie=document.createElement("span");ie.className="cw-wiz-credit-name",ie.textContent=it,K.appendChild(ie),F.append(j,z,K),E.appendChild(F),w.appendChild(E);let le=e.map((R,J)=>{let te=document.createElement("button");return te.type="button",te.className="cw-wiz-dot",te.setAttribute("aria-label",xt("slideLabel")(J+1,e.length)),te.onmouseenter=()=>S.playHover(),te.onclick=()=>{J!==d&&(S.playClick(),ee(J))},$.appendChild(te),te});function W(R){let J=e[R];A.textContent=J.icon||"",D.textContent=J.title||"",h.textContent=J.text||"",le.forEach((V,ae)=>{V.classList.toggle("active",ae===R),V.setAttribute("aria-current",ae===R?"true":"false")});let te=R===e.length-1;k.textContent=te?c.final:c.next,C.hidden=R===0,N.hidden=!i||te,q.textContent=xt("announce")(R+1,e.length,J.title,J.text)}function ee(R){if(p||R===d||R<0||R>=e.length)return;let J=R>d?"swapping-next":"swapping-prev";if(d=R,es()){W(R);return}clearTimeout(_),M.classList.add(J),_=setTimeout(()=>{W(R),M.classList.remove("swapping-next","swapping-prev")},vi)}function H({silent:R=!1}={}){p||(p=!0,clearTimeout(_),document.removeEventListener("keydown",oe,!0),w.classList.add("closing"),w.classList.remove("open"),E.style.willChange="opacity, transform",R||S.playSuccess(),setTimeout(()=>{if(w.remove(),qe(),v&&document.contains(v))try{v.focus({preventScroll:!0})}catch{}l()},lo))}function oe(R){if(!p){if(R.key==="Tab"){let J=Array.from(E.querySelectorAll(as)).filter(ae=>!ae.hidden&&ae.offsetParent!==null);if(J.length===0)return;let te=J[0],V=J[J.length-1];R.shiftKey&&document.activeElement===te?(R.preventDefault(),V.focus()):!R.shiftKey&&document.activeElement===V&&(R.preventDefault(),te.focus());return}if(R.key==="Enter"){if(document.activeElement&&document.activeElement.classList.contains("cw-wiz-dot"))return;R.preventDefault(),R.stopPropagation(),k.click()}else R.key==="Escape"?(R.preventDefault(),R.stopPropagation(),N.hidden?H():N.click()):R.key==="ArrowRight"?(R.preventDefault(),d<e.length-1&&(S.playClick(),ee(d+1))):R.key==="ArrowLeft"&&(R.preventDefault(),d>0&&(S.playClick(),ee(d-1)))}}return[C,N,k].forEach(R=>{R.onmouseenter=()=>S.playHover()}),k.onclick=()=>{S.playClick(),d<e.length-1?ee(d+1):H()},C.onclick=()=>{S.playClick(),ee(d-1)},N.onclick=async()=>{S.playClick(),!(typeof r=="function"&&!await r())&&H({silent:!0})},document.body.appendChild(w),Te(),W(0),E.style.willChange="opacity, transform",requestAnimationFrame(()=>{w.classList.add("open")}),setTimeout(()=>{E.style.removeProperty("will-change"),k.focus({preventScroll:!0})},lo),document.addEventListener("keydown",oe,!0),{close:H}}var yi="cw_onboarding_seen_v1",wi={pt:[{icon:"\u{1F680}",title:"Bem-vindo ao Case Wizard",text:"Uma camada de produtividade que roda por cima do CRM. Ela n\xE3o substitui nada do que voc\xEA j\xE1 usa \u2014 s\xF3 tira o trabalho repetitivo do caminho."},{icon:"\u2328\uFE0F",title:"Tudo come\xE7a em dois lugares",text:"A p\xEDlula flutuante, sempre no canto da tela, abre qualquer m\xF3dulo com um clique. E Ctrl+K (ou \u2318K) abre a paleta de comandos: digite o que quer e v\xE1 direto, sem tirar a m\xE3o do teclado."},{icon:"\u{1F4DD}",title:"Notas e BAU sem retrabalho",text:"O Case Notes monta a nota t\xE9cnica do caso a partir do status e das tasks que voc\xEA marcar. O BAU Form cuida das solicita\xE7\xF5es de cria\xE7\xE3o e descarte, passo a passo."},{icon:"\u{1F4AC}",title:"Na hora de falar com o cliente",text:"O Email Assistant sugere templates que leem o contexto do caso, e o Call Script te guia pela chamada com um roteiro interativo \u2014 sem script decorado."},{icon:"\u{1F4DA}",title:"Seu material e o do time",text:'Minha Biblioteca guarda seus snippets e respostas prontas. A Central de Links re\xFAne SOPs e ferramentas, os Avisos trazem disponibilidade BAU, e os Fusos Hor\xE1rios respondem "que horas s\xE3o pra ele agora?".'},{icon:"\u{1F6DF}",title:"Nada se perde",text:"O que voc\xEA digita \xE9 salvo sozinho a cada poucos segundos, e d\xE1 pra estacionar um caso no meio e retomar de onde parou. Fechar a aba sem querer n\xE3o custa mais nada. Bom trabalho!"}],es:[{icon:"\u{1F680}",title:"Bienvenido a Case Wizard",text:"Una capa de productividad que funciona sobre el CRM. No reemplaza nada de lo que ya usas \u2014 solo quita el trabajo repetitivo del camino."},{icon:"\u2328\uFE0F",title:"Todo empieza en dos lugares",text:"La p\xEDldora flotante, siempre en la esquina de la pantalla, abre cualquier m\xF3dulo con un clic. Y Ctrl+K (o \u2318K) abre la paleta de comandos: escribe lo que buscas y ve directo, sin soltar el teclado."},{icon:"\u{1F4DD}",title:"Notas y BAU sin rehacer trabajo",text:"Case Notes arma la nota t\xE9cnica del caso a partir del estado y de las tareas que marques. BAU Form se encarga de las solicitudes de creaci\xF3n y descarte, paso a paso."},{icon:"\u{1F4AC}",title:"A la hora de hablar con el cliente",text:"Email Assistant sugiere plantillas que leen el contexto del caso, y Call Script te gu\xEDa por la llamada con un guion interactivo \u2014 sin nada memorizado."},{icon:"\u{1F4DA}",title:"Tu material y el del equipo",text:'Mi Biblioteca guarda tus fragmentos y respuestas listas. La Central de Enlaces re\xFAne SOPs y herramientas, los Avisos traen la disponibilidad BAU, y las Zonas Horarias responden "\xBFqu\xE9 hora es para \xE9l ahora?".'},{icon:"\u{1F6DF}",title:"Nada se pierde",text:"Lo que escribes se guarda solo cada pocos segundos, y puedes aparcar un caso a mitad de camino y retomarlo donde lo dejaste. Cerrar la pesta\xF1a sin querer ya no cuesta nada. \xA1Buen trabajo!"}]},Si={pt:{next:"Pr\xF3ximo",start:"Come\xE7ar \u{1F680}",skip:"Pular",skipConfirm:"Pular a apresenta\xE7\xE3o? Voc\xEA pode explorar tudo pelo menu flutuante.",readyToast:"Tudo pronto! Use o menu flutuante ou Ctrl+K."},es:{next:"Siguiente",start:"Empezar \u{1F680}",skip:"Omitir",skipConfirm:"\xBFOmitir la presentaci\xF3n? Puedes explorar todo desde el men\xFA flotante.",readyToast:"\xA1Todo listo! Usa el men\xFA flotante o Ctrl+K."}};function Ei(){if(localStorage.getItem(yi))return;localStorage.setItem(yi,"true");let e=se(),t=wi[e]||wi.pt,a=Si[e]||Si.pt;Ta({slides:t,idPrefix:"cw-onboarding",nextLabel:a.next,finalLabel:a.start,skipLabel:a.skip,onSkip:()=>Fe(a.skipConfirm),onClose:()=>X(a.readyToast)})}var qa={version:"v6.1.0",title:"Case Wizard v6.1.0",slides:[{icon:"\u{1F41E}",title:"Achou um bug? Agora d\xE1 pra contar",text:"Tem um formul\xE1rio de bugs e sugest\xF5es dentro do app. Se algo travar, sair errado ou s\xF3 te irritar, manda por ali \u2014 chega direto para quem cuida do Case Wizard, sem precisar ca\xE7ar ningu\xE9m no chat."},{icon:"\u{1F4E2}",title:"Avisos mais f\xE1ceis de ler",text:"O painel de avisos foi redesenhado em duas colunas, com o contraste corrigido e um espa\xE7o pr\xF3prio para o estado de cada aviso. Menos rolagem para achar o que importa hoje."},{icon:"\u{1F5C2}\uFE0F",title:"Para a lideran\xE7a: o time se atualiza pela Central",text:"A Central de Conte\xFAdo ganhou a aba Pessoas. Entrada, sa\xEDda, troca de fluxo e troca de idioma de um agente passam a ser feitas por ali, em vez de na planilha. TL prop\xF5e, ADMIN aprova \u2014 e o idioma em que o app abre para a pessoa acompanha a mudan\xE7a."}]};var Ia="cw_last_version",Ci={pt:{updateBadge:e=>`Atualiza\xE7\xE3o ${e}`,nextBtn:"Pr\xF3ximo",doneBtn:"Entendi, vamos l\xE1! \u{1F44D}",updatedToast:e=>`Case Wizard atualizado para ${e}!`},es:{updateBadge:e=>`Actualizaci\xF3n ${e}`,nextBtn:"Siguiente",doneBtn:"\xA1Entendido, vamos! \u{1F44D}",updatedToast:e=>`\xA1Case Wizard actualizado a ${e}!`}};function La(e){let t=se();return Ci[t]?.[e]??Ci.pt[e]}function Ai(e){let t=localStorage.getItem(Ia);if(!t){localStorage.setItem(Ia,e);return}if(t!==e){if(qa.version!==e){console.warn(`[changelog] APP_VERSION \xE9 ${e} mas RELEASE_NOTES.version \xE9 ${qa.version}. Modal suprimido at\xE9 os dois baterem (veja src/modules/changelog/changelog-data.js).`),localStorage.setItem(Ia,e);return}os(e)}}function os(e){Ta({slides:qa.slides,idPrefix:"cw-changelog",badge:La("updateBadge")(e),nextLabel:La("nextBtn"),finalLabel:La("doneBtn"),onClose:()=>{localStorage.setItem(Ia,e),X(La("updatedToast")(e))}})}var ki="cw_timezone_pinned",Li={es:{name:"Espa\xF1a"},bo:{name:"Bolivia"},co:{name:"Colombia"},ec:{name:"Ecuador"},py:{name:"Paraguay",label:"Asunci\xF3n"},uy:{name:"Uruguay",label:"Montevideo"},ni:{name:"Nicaragua",label:"Managua"},pr:{name:"Puerto Rico"},gt:{label:"C. de Guatemala"},pa:{label:"C. de Panam\xE1"}};function bt(e){return se()==="es"?Li[e.id]?.name??e.name:e.name}function co(e){return se()==="es"?Li[e.id]?.label??e.label:e.label}var Ti={pt:{headerDesc:"Monitoramento global e planejamento de chamadas.",tabLive:"Monitoramento",tabPlan:"Planejador",searchPlaceholder:"Buscar cidade ou pa\xEDs...",noLocationFound:"Nenhum local encontrado",unpin:"Desafixar",pin:"Fixar",statusOpen:"Aberto",statusOpening:"Abrindo",statusClosing:"Fechando",statusClosed:"Fechado",whereIsClient:"Onde est\xE1 o cliente?",you:"Voc\xEA",yourTimezone:"Bras\xEDlia (GMT-3)",client:"Cliente",dragToSimulate:"Arraste para simular o hor\xE1rio:",idealBusinessHours:"Hor\xE1rio Comercial Ideal",limitHours:"Hor\xE1rio Limite (Aten\xE7\xE3o)",outOfHours:"Fora de Hor\xE1rio",filters:{all:"Todos",sa:"Am\xE9rica do Sul",na:"Norte & Central",eu:"Europa"}},es:{headerDesc:"Monitoreo global y planificaci\xF3n de llamadas.",tabLive:"Monitoreo",tabPlan:"Planificador",searchPlaceholder:"Buscar ciudad o pa\xEDs...",noLocationFound:"No se encontr\xF3 ning\xFAn lugar",unpin:"Desanclar",pin:"Anclar",statusOpen:"Abierto",statusOpening:"Abriendo",statusClosing:"Cerrando",statusClosed:"Cerrado",whereIsClient:"\xBFD\xF3nde est\xE1 el cliente?",you:"T\xFA",yourTimezone:"Brasilia (GMT-3)",client:"Cliente",dragToSimulate:"Arrastra para simular el horario:",idealBusinessHours:"Horario Comercial Ideal",limitHours:"Horario L\xEDmite (Atenci\xF3n)",outOfHours:"Fuera de Horario",filters:{all:"Todos",sa:"Am\xE9rica del Sur",na:"Norte y Central",eu:"Europa"}}};function Ee(e){let t=se();return Ti[t]?.[e]??Ti.pt[e]}var po=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],qi=[{id:"all"},{id:"sa"},{id:"na"},{id:"eu"}];function ns(){if(document.getElementById("cw-timezone-interactive-styles"))return;let e=document.createElement("style");e.id="cw-timezone-interactive-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}function Fi(){let e="v2.0",t=!1,a="general",o="",n=null,i=null;ss();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,Ge,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let l={popup:r},c=De(r,pe("headerTitle"),e,pe("headerDesc"),l,()=>ae());r.appendChild(c);let g=c.querySelector("span"),u=document.createElement("div");u.className="cw-lib-container",r.appendChild(u);let v=document.createElement("div");v.className="cw-lib-toolbar";let d=document.createElement("div");d.className="cw-lib-search-wrap";let p=document.createElement("div");p.className="cw-lib-search-icon",p.innerHTML=Be.search;let _=document.createElement("input");_.className="cw-lib-search no-drag",_.placeholder=pe("searchPlaceholder"),_.type="text";let w=document.createElement("div");w.className="cw-lib-search-clear cw-tactile",w.innerHTML=Be.clear,d.append(p,_,w);let E=document.createElement("div");E.className="cw-lib-tabs",uo.forEach(s=>{let y=document.createElement("div");y.className="cw-lib-tab"+(s.id===a?" active":""),y.id=`lib-tab-${s.id}`,y.innerHTML=`${s.icon}<span class="js-lib-tab-label">${pe("tabs")[s.id]}</span>`,y.onmouseenter=()=>S.playHover(),y.onclick=()=>z(s.id),E.appendChild(y)}),v.append(d,E),u.appendChild(v);let M=document.createElement("div");M.className="cw-lib-grid",u.appendChild(M);let A=document.createElement("div");A.className="cw-lib-fab cw-tactile",A.title=pe("newItem"),A.innerHTML=Be.add,A.onclick=()=>oe(),u.appendChild(A);let D=document.createElement("div");D.className="cw-lib-sheet";let h=document.createElement("div");h.className="cw-lib-sheet-handle";let q=document.createElement("div");q.className="cw-lib-sheet-head";let $=document.createElement("div");$.className="cw-lib-sheet-back no-drag",$.innerHTML=Be.back,$.title=pe("cancel"),$.onclick=R;let T=document.createElement("span");T.className="cw-lib-sheet-title",T.textContent=pe("newItemTitle"),q.append($,T);let C=document.createElement("div");C.className="cw-lib-sheet-body";let N=document.createElement("div");N.className="cw-lib-sheet-foot";let k=document.createElement("button");k.className="cw-lib-save-btn no-drag",k.textContent=pe("save"),k.onclick=J,N.appendChild(k);let F=document.createElement("div");F.className="cw-lib-loading",F.innerHTML=`<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text js-lib-saving">${pe("saving")}</div>`,D.append(h,q,C,N,F),u.appendChild(D);let j=document.createElement("div");Object.assign(j.style,rt),j.className="no-drag",r.appendChild(j),st(r,j),document.body.appendChild(r),document.addEventListener("mousedown",s=>{i&&!i.contains(s.target)&&K()});function z(s){S.playClick(),a=s,uo.forEach(y=>{document.getElementById(`lib-tab-${y.id}`).classList.toggle("active",y.id===s)}),W()}function K(){if(i){let s=i.querySelector(".cw-lib-menu");s&&s.classList.remove("open"),i.classList.remove("menu-open"),i=null}}function ie(s,y){return y?`${s.title} ${s.content}`.toLowerCase().includes(y):!0}function le(s){let y=document.createElement("div");y.className="cw-lib-recent-section",y.innerHTML=`<div class="cw-lib-recent-title">${pe("recentlyUsed")}</div>`;let L=document.createElement("div");return L.className="cw-lib-recent-row",s.forEach(b=>{let f=document.createElement("div");f.className="cw-lib-recent-chip",f.tabIndex=0,f.setAttribute("role","button"),f.title=b.title,f.innerHTML=`<span>${V(b.title)}</span>`,f.onclick=()=>{S.playClick(),H(b)},f.addEventListener("keydown",I=>{(I.key==="Enter"||I.key===" ")&&(I.preventDefault(),f.click())}),L.appendChild(f)}),y.appendChild(L),y}function W(){K(),M.innerHTML="";let s=o.trim().toLowerCase(),y=$e.getSnippets(a).filter(L=>ie(L,s));if(!s){let L=rs(a);L.length>0&&M.appendChild(le(L))}if(y.length===0){let L=document.createElement("div");L.className="cw-lib-empty";let b=s.length>0;L.innerHTML=`
            ...
            `,M.appendChild(L);return}y.forEach(L=>M.appendChild(ee(L)))}function ee(s){let y=document.createElement("div");y.className="cw-lib-card"+(s.isCode?" is-code":"");let L=s.content,b="";if(s.isRich){let P=document.createElement("div");P.innerHTML=s.content;let Z=!!P.querySelector("img");L=P.innerText.substring(0,200),Z&&(b=`<span class="cw-lib-media-tag">${Be.media} M\xEDdia</span>`)}let f=[s.isCode?'<span class="cw-lib-badge code">CODE</span>':"",a==="email"?'<span class="cw-lib-badge template">TEMPLATE</span>':""].join("");y.innerHTML=`
        ...
        `,y.querySelector(".cw-act-copy").onclick=P=>{P.stopPropagation(),S.playClick(),H(s)};let I=y.querySelector(".cw-act-more"),m=y.querySelector(".cw-lib-menu");return I.onclick=P=>{P.stopPropagation(),S.playClick();let Z=m.classList.contains("open");K(),Z||(m.classList.add("open"),y.classList.add("menu-open"),i=y)},y.querySelector(".cw-act-edit").onclick=P=>{P.stopPropagation(),S.playClick(),K(),oe(s)},y.querySelector(".cw-act-del").onclick=async P=>{P.stopPropagation(),S.playClick(),K(),await Fe(pe("deleteConfirm")(s.title))&&($e.delete(s.id),W(),X(pe("itemDeletedToast")))},y}function H(s){if(s.isRich){let y=new Blob([s.content],{type:"text/html"}),L=document.createElement("div");L.innerHTML=s.content;let b=new Blob([L.innerText],{type:"text/plain"});navigator.clipboard.write([new ClipboardItem({"text/html":y,"text/plain":b})])}else navigator.clipboard.writeText(s.content);is(s.id),X(pe("copiedToast"))}function oe(s=null){n=s?s.id:null,C.innerHTML="",C.appendChild(te("title",pe("titleLabel"),s?s.title:"")),a==="email"&&C.appendChild(te("subject",pe("subjectLabel"),s?s.subject:""));let y=pe("contentLabel");a==="email"&&(y=pe("emailBodyLabel")),a==="note"&&(y=pe("noteTextLabel")),C.appendChild(te("content",y,s?s.content:"",{isRich:!0,isCode:s?s.isCode:!1})),T.textContent=pe(s?"editItemTitle":"newItemTitle"),k.textContent=pe(s?"saveChanges":"save"),D.classList.add("open"),setTimeout(()=>{let L=C.querySelector("input");L&&L.focus()},500)}function R(){S.playSwoosh(),D.classList.remove("open"),setTimeout(()=>{n=null},500)}async function J(){F.classList.add("active"),k.disabled=!0;try{let s=C.querySelector("#cw-lib-inp-title"),y=C.querySelector("#cw-lib-inp-content"),L=s.value.trim(),b=y.contentEditable==="true"?y.innerHTML:y.value.trim(),f=y.getAttribute("data-is-code")==="true";if(!L||!b||b==="<br>"){S.playError(),X(pe("fillTitleAndContent"),{error:!0});return}let I={id:n,type:a,title:L,content:b,isCode:f,isRich:y.contentEditable==="true"};if(a==="email"){let P=C.querySelector("#cw-lib-inp-subject").value.trim();if(!P){S.playError(),X(pe("subjectRequired"),{error:!0});return}I.subject=P}let m=await $e.save(I);if(m===!1){S.playError(),X(pe("saveFailedNoUser"),{error:!0});return}W(),R(),m.synced===!1?(S.playError(),X(pe("savedLocalOnly"),{error:!0})):(X(pe("savedAndSynced")),S.playSuccess())}catch(s){console.error("Erro ao salvar item da biblioteca:",s),S.playError(),X(pe("saveError"),{error:!0})}finally{F.classList.remove("active"),k.disabled=!1}}function te(s,y,L,b={}){let f=document.createElement("div");f.className="cw-lib-field";let I=document.createElement("label");I.className="cw-lib-label",I.textContent=y,f.appendChild(I);let m;if(b.isRich){let P=document.createElement("div");P.className="cw-lib-toolbar-mini",P.innerHTML=`
            ...
            `,m=document.createElement("div"),m.className="cw-lib-input cw-lib-editable",m.contentEditable="true",m.innerHTML=L||"",b.isCode&&(m.style.fontFamily="'Roboto Mono', monospace",m.style.background="#F8F9FA",m.setAttribute("data-is-code","true"),P.querySelector(".cw-tb-code").classList.add("active")),P.querySelectorAll(".cw-lib-tb-btn").forEach(Z=>{Z.onmouseenter=()=>S.playHover(),Z.onmousedown=()=>S.playClick()}),P.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),m.focus()},P.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),m.focus()},P.querySelector(".cw-tb-code").onclick=Z=>{let x=!(m.getAttribute("data-is-code")==="true");m.setAttribute("data-is-code",String(x)),m.style.fontFamily=x?"'Roboto Mono', monospace":"inherit",m.style.background=x?"#F8F9FA":"#fff",Z.currentTarget.classList.toggle("active",x),m.focus()},P.querySelector(".cw-tb-img").onclick=async()=>{let Z=await ca(pe("imageUrlPrompt"));Z&&(document.execCommand("insertImage",!1,Z),m.querySelectorAll("img").forEach(de=>{de.style.maxWidth="100%",de.style.borderRadius="8px"}))},m.onpaste=Z=>{let de=(Z.clipboardData||Z.originalEvent.clipboardData).items;for(let x of de)if(x.kind==="file"&&x.type.startsWith("image/")){Z.preventDefault();let O=new FileReader;O.onload=U=>{document.execCommand("insertHTML",!1,`<img src="${U.target.result}" style="max-width:100%;border-radius:8px;margin:8px 0;display:block;">`)},O.readAsDataURL(x.getAsFile())}},f.appendChild(P)}else m=document.createElement("input"),m.className="cw-lib-input",m.type="text",m.value=L||"";return m.id=`cw-lib-inp-${s}`,f.appendChild(m),f}function V(s){let y=document.createElement("div");return y.textContent=s||"",y.innerHTML}_.addEventListener("input",s=>{o=s.target.value,w.classList.toggle("visible",o.length>0),W()}),w.onclick=()=>{_.value="",o="",w.classList.remove("visible"),W(),_.focus()};function ae(){t=!He(r),ze(t,r,"cw-btn-library"),t?(Te(),W()):(qe(),K())}return Se(()=>{g&&(g.textContent=pe("headerTitle"));let s=r.querySelector(".cw-help-title");s&&(s.textContent=pe("headerTitle"));let y=r.querySelector(".cw-help-description");y&&(y.textContent=pe("headerDesc")),uo.forEach(b=>{let f=document.querySelector(`#lib-tab-${b.id} .js-lib-tab-label`);f&&(f.textContent=pe("tabs")[b.id])}),_.placeholder=pe("searchPlaceholder"),A.title=pe("newItem"),$.title=pe("cancel");let L=F.querySelector(".js-lib-saving");L&&(L.textContent=pe("saving")),W()}),ae}var ls='<svg viewBox="0 0 24 24" fill="currentColor" style="width:14px;height:14px;"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>',cs='<svg viewBox="0 0 24 24" fill="currentColor" style="width:14px;height:14px;"><circle cx="9" cy="6" r="1.6"/><circle cx="15" cy="6" r="1.6"/><circle cx="9" cy="12" r="1.6"/><circle cx="15" cy="12" r="1.6"/><circle cx="9" cy="18" r="1.6"/><circle cx="15" cy="18" r="1.6"/></svg>',ds='<svg viewBox="0 0 24 24" fill="currentColor" style="width:14px;height:14px;"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>',ps='<svg viewBox="0 0 24 24" fill="currentColor" style="width:14px;height:14px;"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg>';function us(e){if(document.getElementById("cw-shortcuts-styles"))return;let t=document.createElement("style");t.id="cw-shortcuts-styles",t.innerHTML=`
        .cw-sc-item {
    ...
    `,document.head.appendChild(t)}function Mi(e,t){us(t);let a=document.createElement("div");a.className="cw-configs-section",a.innerHTML=`
    ...
    `;let o=a.querySelector(".js-sc-body"),n=a.querySelector(".js-sc-sort-toggle");n.onchange=async d=>{S.playClick(),await Le.setSortedByUsage(d.target.checked),l()};function i(d){let p=_e[d.payload.subStatus],_=p?p.name:d.payload.subStatus,w=(d.payload.scenarios||[]).length,E=[d.payload.caseType.toUpperCase(),_,w===1?e("scOneScenario"):e("scNScenarios").replace("{n}",w)];return d.alias&&E.push(`"${d.alias}"`),E.join(" \xB7 ")}function r(d,p,_){if(d.textContent="",_){let w=document.createElement("span");w.className="cw-sc-warn",w.textContent=e("scBroken"),d.appendChild(w),d.appendChild(document.createTextNode(" \xB7 "))}d.appendChild(document.createTextNode(i(p)))}function l(){o.innerHTML="",n.checked=Le.isSortedByUsage();let d=Le.isSortedByUsage(),p=d?Le.list():Le.listRaw(),_=!d;if(!p.length){let E=document.createElement("div");E.className="cw-sc-empty",E.textContent=e("scEmpty"),o.appendChild(E)}p.forEach((E,M)=>{let A=Tn(E),D=document.createElement("div");D.className="cw-sc-item"+(A.length?" broken":""),D.dataset.id=E.id,D.dataset.index=String(M),D.innerHTML=`
                ${_?`<button type="button" class="cw-sc-grip" aria-label="${e("scReorder")}">${cs}</button>`:""}
    ...
    `}async function p(){u.style.display="flex",u.innerHTML=`
        ...
        `,(async()=>{try{Ie()||await jt();let k=Ie(),F=k?k.split("@")[0]:"user",j=await Tt(F);d(F,j)}catch(k){console.warn("Erro ao renderizar perfil:",k),u.style.display="none"}})()}p();let _=document.createElement("div");if(_.className="cw-configs-section",_.innerHTML=`
    ...
    `,!document.getElementById("cw-lang-toggle-styles")){let k=document.createElement("style");k.id="cw-lang-toggle-styles",k.innerHTML=`
        ...
        `,document.head.appendChild(k)}let w=_.querySelector("#cw-config-lang-toggle");function E(){w.querySelectorAll("button").forEach(k=>{k.classList.toggle("active",k.dataset.lang===se())})}E(),w.querySelectorAll("button").forEach(k=>{k.onclick=()=>{$a(k.dataset.lang),S.playClick()}}),g.appendChild(_);let M=Mi(e,o);g.appendChild(M);let A=document.createElement("div");A.className="cw-configs-section",A.innerHTML=`
    ...
    `;let D=A.querySelector("#cw-config-sound-toggle");D.onchange=k=>{S.setMuted(!k.target.checked),k.target.checked&&S.playClick()},g.appendChild(A);let h=document.createElement("div");h.className="cw-configs-section",h.innerHTML=`
        ...
        <div class="cw-configs-card">
            <div style="display:flex; flex-direction:column; gap:12px;">
                <a class="cw-configs-btn js-support-link" href="${It}" target="_blank" rel="noopener noreferrer"></a>
            </div>
        </div>
  ...
  `,document.head.appendChild(e)};var yt={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",i18nKey:"description_justificativa",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",i18nKey:"seId_descarte",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",i18nKey:"description_descarte",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var gs={advName:{label:"Nombre del Anunciante",placeholder:"Nombre del Anunciante"},cid:{label:"CID",placeholder:"000-000-0000",tooltip:"Usa el formato 000-000-0000 o 10 d\xEDgitos",error:"Formato de CID incorrecto"},amName:{label:"Account Manager (AM)",placeholder:"Nombre del AM"},website:{label:"Website",placeholder:"https://www.ejemplo.com"},seId:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID",buttonTitle:"Buscar ID autom\xE1ticamente"},seId_descarte:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID"},reason:{label:"Qu\xE9 debe hacerse en BAU",placeholder:"Describe las acciones esperadas..."},taskType:{label:"Tareas para BAU (Selecciona 1 o m\xE1s)",tooltip:"Selecciona los tipos de implementaci\xF3n t\xE9cnica"},nonImplementationReason:{label:"Motivo de la No Implementaci\xF3n (Justificaci\xF3n BAU)"},description_justificativa:{label:"Justificaci\xF3n / Descripci\xF3n",placeholder:"Describe detalladamente qu\xE9 se necesita hacer..."},availability:{label:"Disponibilidad (m\xEDnimo 1 opci\xF3n)"},availability_1:{label:"Opci\xF3n 1 (Prioridad)"},availability_2:{label:"Opci\xF3n 2 (Opcional)"},availability_3:{label:"Opci\xF3n 3 (Opcional)"},caseId:{label:"Case ID",placeholder:"Case ID"},language:{label:"Idioma",placeholder:"Idioma"},description_descarte:{label:"Descripci\xF3n",placeholder:"Describe el motivo del descarte..."},discardReason:{label:"Motivo del Descarte"}},bs={"Selecione um motivo...":"Selecciona un motivo...","Tempo da consultoria esgotado":"Tiempo de la consultor\xEDa agotado","Solicita\xE7\xE3o de reagendamento pelo anunciante":"Solicitud de reprogramaci\xF3n por parte del anunciante","Falta de acessos ou backup do site":"Falta de accesos o copia de seguridad del sitio","Anunciante indispon\xEDvel ou n\xE3o preparado":"Anunciante no disponible o no preparado","Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)":"Implementaci\xF3n parcial (no todas las tareas completadas)","Solicita\xE7\xE3o de tarefas (tasks) adicionais":"Solicitud de tareas adicionales","Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)":"Necesidad de nuevos cambios (fase de seguimiento)","Retorno de contato ap\xF3s prazo de 14 dias expirado":"Retorno de contacto despu\xE9s de vencido el plazo de 14 d\xEDas","Caso Filho gerado no atendimento":"Caso Hijo generado en la atenci\xF3n","3\xAA Tentativa de contato sem sucesso":"3.\xBA intento de contacto sin \xE9xito","Apenas o AM presente":"Solo el AM presente","Estouro de tempo para conclus\xE3o":"Tiempo excedido para la conclusi\xF3n","Gera\xE7\xE3o de caso BAU (Reagendamento)":"Generaci\xF3n de caso BAU (Reprogramaci\xF3n)"};function fs(e){return e?.i18nKey||e?.id||e?.name}function Ke(e,t){let a=e?.[t];return se()!=="es"?a:gs[fs(e)]?.[t]??a}function at(e){return se()!=="es"?e:bs[e]??e}var zi={pt:{statusPending:"Aguardando TL",statusApproved:"Aprovado / Criado",statusDiscarded:"Descartado pelo TL",statusCanceled:"Cancelado",statusDefault:"Pendente",timezoneWarningStrong:"Aten\xE7\xE3o:",timezoneWarningText:"Para clientes fora do fuso hor\xE1rio do Brasil, o hor\xE1rio inserido deve corresponder sempre ao hor\xE1rio local do cliente, e n\xE3o ao do agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone n\xE3o encontrado.",headerTitle:"BAU Central",headerDesc:"Dashboard de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Fluxo completo para implementa\xE7\xF5es t\xE9cnicas e suporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Fluxo simplificado para casos que n\xE3o requerem implementa\xE7\xE3o.",back:"Voltar",next:"Pr\xF3ximo",configuringEdit:"Configurando Edi\xE7\xE3o...",loadDashboardError:"Erro ao carregar Dashboard. Verifique sua conex\xE3o.",copiedToClipboard:"Copiado para a \xE1rea de transfer\xEAncia!",noAdditionalContext:"Nenhum contexto adicional fornecido pelo agente.",notCaptured:"N\xE3o capturado",none:"Nenhuma",language:"Idioma",editPageWarning:"Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",onCorrectPage:"Estou na p\xE1gina correta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso criado, mas n\xE3o conseguimos confirmar por email.",unknownError:"Erro desconhecido",newBauCase:"Novo Caso BAU",backToDashboard:"Voltar ao Dashboard",confirmDataBeforeSending:"Confirme os dados antes de enviar",submitToTl:"Enviar para o TL",saveChanges:"Salvar Altera\xE7\xF5es",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Preencha os detalhes abaixo",caseSentSuccess:"Caso enviado com sucesso!",caseSentSuccessSub:"Sua solicita\xE7\xE3o foi recebida e ser\xE1 processada em breve.",genericErrorTitle:"Ops! Algo deu errado",genericErrorSub:"N\xE3o conseguimos carregar seus casos BAU no momento.",tryAgain:"Tentar Novamente",notInformed:"N\xE3o informado",reasonTooltip:"O que deve ser feito em BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Aguardando TL",caseDetailsTitle:"Detalhes do Caso",copy:"Copiar",advertiser:"Anunciante",status:"Status",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email do Anunciante",site:"Site",timezone:"Timezone",responsibleAm:"AM Respons\xE1vel",salesProgram:"Programa de Vendas",bauReason:"Motivo BAU",requestedTasks:"Tasks solicitadas",justification:"Justificativa",detailedDescription:"Descri\xE7\xE3o detalhada",availability:"Disponibilidade",urgent:"Urgente",undefinedName:"Nome indefinido",customerIdTooltip:"Customer ID do Anunciante",cidTooltip:"CID do Anunciante (Formato: 000-000-0000)",incompleteData:"Dados Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contate o Suporte",editRequest:"Editar Solicita\xE7\xE3o",edit:"Editar",refresh:"Atualizar",noRecentCases:"Nenhum caso recente",casesWillAppear:"Seus casos BAU aparecer\xE3o aqui",createdApproved:"Criados / Aprovados",refreshDashboard:"Atualizar Dashboard",errorPrefix:e=>`Erro: ${e}`,selectAtLeastOne:e=>`Erro: Selecione pelo menos uma op\xE7\xE3o para "${e}".`,fieldRequiredDouble:e=>`Erro: O campo "${e}" \xE9 obrigat\xF3rio.`,fieldRequiredSingle:e=>`Erro: O campo '${e}' \xE9 obrigat\xF3rio.`,whatMustBeDone:"O que deve ser feito",editTasksHint:"Para editar as tasks, volte ao Passo 2",bauJustification:"Justificativa BAU",description:"Descri\xE7\xE3o",availabilityPriority:"Disponibilidade (Prioridade)",editingCaseHash:e=>`Voc\xEA est\xE1 editando o caso #${e}`,editingDiscardHash:e=>`Voc\xEA est\xE1 editando o descarte do caso #${e}`,discardReason:"Motivo do Descarte",discardDescription:"Descri\xE7\xE3o do Descarte",notInformedPlaceholder:"N\xE3o informado",caseUpdatedSuccess:"Caso atualizado com sucesso!",caseDiscardSentSuccess:"Caso enviado para descarte com sucesso!"},es:{statusPending:"Esperando al TL",statusApproved:"Aprobado / Creado",statusDiscarded:"Descartado por el TL",statusCanceled:"Cancelado",statusDefault:"Pendiente",timezoneWarningStrong:"Atenci\xF3n:",timezoneWarningText:"Para clientes fuera del huso horario de Brasil, el horario ingresado siempre debe corresponder al horario local del cliente, no al del agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone no encontrado.",headerTitle:"BAU Central",headerDesc:"Panel de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Flujo completo para implementaciones t\xE9cnicas y soporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Flujo simplificado para casos que no requieren implementaci\xF3n.",back:"Volver",next:"Siguiente",configuringEdit:"Configurando Edici\xF3n...",loadDashboardError:"Error al cargar el Panel. Verifica tu conexi\xF3n.",copiedToClipboard:"\xA1Copiado al portapapeles!",noAdditionalContext:"Ning\xFAn contexto adicional proporcionado por el agente.",notCaptured:"No capturado",none:"Ninguna",language:"Idioma",editPageWarning:"Atenci\xF3n: Para editar la informaci\xF3n, debes tener abierta en el sistema la p\xE1gina de este Caso espec\xEDfico. De lo contrario, los datos capturados estar\xE1n incorrectos.",onCorrectPage:"Estoy en la p\xE1gina correcta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso creado, pero no pudimos confirmar por email.",unknownError:"Error desconocido",newBauCase:"Nuevo Caso BAU",backToDashboard:"Volver al Panel",confirmDataBeforeSending:"Confirma los datos antes de enviar",submitToTl:"Enviar al TL",saveChanges:"Guardar Cambios",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Completa los detalles a continuaci\xF3n",caseSentSuccess:"\xA1Caso enviado con \xE9xito!",caseSentSuccessSub:"Tu solicitud fue recibida y ser\xE1 procesada en breve.",genericErrorTitle:"\xA1Ups! Algo sali\xF3 mal",genericErrorSub:"No pudimos cargar tus casos BAU en este momento.",tryAgain:"Intentar de Nuevo",notInformed:"No informado",reasonTooltip:"Qu\xE9 debe hacerse en BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Esperando al TL",caseDetailsTitle:"Detalles del Caso",copy:"Copiar",advertiser:"Anunciante",status:"Estado",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email del Anunciante",site:"Sitio",timezone:"Timezone",responsibleAm:"AM Responsable",salesProgram:"Programa de Ventas",bauReason:"Motivo BAU",requestedTasks:"Tareas solicitadas",justification:"Justificaci\xF3n",detailedDescription:"Descripci\xF3n detallada",availability:"Disponibilidad",urgent:"Urgente",undefinedName:"Nombre indefinido",customerIdTooltip:"Customer ID del Anunciante",cidTooltip:"CID del Anunciante (Formato: 000-000-0000)",incompleteData:"Datos Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contacta al Soporte",editRequest:"Editar Solicitud",edit:"Editar",refresh:"Actualizar",noRecentCases:"Ning\xFAn caso reciente",casesWillAppear:"Tus casos BAU aparecer\xE1n aqu\xED",createdApproved:"Creados / Aprobados",refreshDashboard:"Actualizar Panel",errorPrefix:e=>`Error: ${e}`,selectAtLeastOne:e=>`Error: Selecciona al menos una opci\xF3n para "${e}".`,fieldRequiredDouble:e=>`Error: El campo "${e}" es obligatorio.`,fieldRequiredSingle:e=>`Error: El campo '${e}' es obligatorio.`,whatMustBeDone:"Qu\xE9 debe hacerse",editTasksHint:"Para editar las tareas, vuelve al Paso 2",bauJustification:"Justificaci\xF3n BAU",description:"Descripci\xF3n",availabilityPriority:"Disponibilidad (Prioridad)",editingCaseHash:e=>`Est\xE1s editando el caso #${e}`,editingDiscardHash:e=>`Est\xE1s editando el descarte del caso #${e}`,discardReason:"Motivo del Descarte",discardDescription:"Descripci\xF3n del Descarte",notInformedPlaceholder:"No informado",caseUpdatedSuccess:"\xA1Caso actualizado con \xE9xito!",caseDiscardSentSuccess:"\xA1Caso enviado a descarte con \xE9xito!"}};function B(e){let t=se();return zi[t]?.[e]??zi.pt[e]}var ke={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function Ri(e){switch(e){case"PENDING_TL_CREATION":return{text:B("statusPending"),class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:B("statusApproved"),class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:B("statusDiscarded"),class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:B("statusCanceled"),class:"status-gray",aura:""};default:return{text:e||B("statusDefault"),class:"status-gray",aura:""}}}function $i(e){let t=document.createElement("div");if(t.className="bau-dynamic-input",t.id=`wrapper-${e.id}`,e.label){let o=document.createElement("label");o.className="bau-label",o.textContent=Ke(e,"label"),e.tooltip&&o.setAttribute("data-tooltip",Ke(e,"tooltip")),t.appendChild(o)}let a;switch(e.type){case"textarea":a=document.createElement("textarea"),a.style.minHeight="80px",t.appendChild(a);break;case"select":a=document.createElement("select"),e.groups?e.groups.forEach(r=>{let l=document.createElement("optgroup");l.label=r.label,r.options.forEach(c=>{let g=document.createElement("option");g.value=c.value,g.textContent=at(c.text),l.appendChild(g)}),a.appendChild(l)}):e.options&&e.options.forEach(r=>{let l=document.createElement("option");l.value=r.value,l.textContent=at(r.text),a.appendChild(l)}),t.appendChild(a);break;case"checkbox-grid":return a=document.createElement("div"),a.className="bau-tasks-grid",e.options.forEach(r=>{let l=document.createElement("label");l.className="bau-task-item",l.innerHTML=`<input type="checkbox" name="${e.name}" value="${r}"><span>${r}</span>`,l.addEventListener("click",c=>{c.preventDefault();let g=l.querySelector("input");g.checked=!g.checked,l.classList.toggle("active",g.checked),S.playClick()}),a.appendChild(l)}),t.appendChild(a),t;case"datetime-group":a=document.createElement("div"),a.className="bau-availability-container",e.fields.forEach(r=>{let l=document.createElement("div");l.className="bau-availability-field",l.innerHTML=`
    ...
    `,M.appendChild(A);let D=s=>{A.classList.toggle("active",s)},h=document.createElement("div");h.className="bau-progress-indicator",M.appendChild(h);let q=document.createElement("form");q.id="bau-escalation-form",q.noValidate=!0,M.appendChild(q),yt.steps.forEach(s=>{let y=document.createElement("div");if(y.className="bau-step"+(s.id===o?" active":""),y.id=`bau-step-${s.id}`,s.isBranching)y.innerHTML=`
                <div class="bau-branching-container">
                    <div class="bau-branching-card" id="bau-opt-full">
                        <div class="bau-branching-icon">${ke.add}</div>
                    ...
                    <div class="bau-branching-card" id="bau-opt-discard">
                        <div class="bau-branching-icon">${ke.empty}</div>
                        <h3 class="bau-branching-title">${B("requestDiscard")}</h3>
                        <p class="bau-branching-subtitle">${B("requestDiscardDesc")}</p>
                    </div>
                </div>
            `,y.querySelector("#bau-opt-full").onclick=()=>{n="BAU",o=1,q.querySelectorAll(".bau-highlight-panel").forEach(L=>L.classList.remove("discard-theme")),W(),S.playClick()},y.querySelector("#bau-opt-discard").onclick=()=>{n="DISCARD",o=5,q.querySelectorAll(".bau-highlight-panel").forEach(L=>L.classList.add("discard-theme")),W(),S.playClick()};else if(s.isConfirmation)y.innerHTML=`
                <div class="bau-card">
            ...
            `;else{let L=document.createElement("div");if(L.className="bau-card",s.id===1||s.id===5){L.innerHTML=`
                ...
                `;let b=L.querySelector(".bau-dynamic-inputs-container");s.fields.forEach(I=>{b.appendChild($i(I))});let f=L.querySelector("#wrapper-cid");if(f){let I=document.createElement("div");I.id="bau-cid-error",I.className="bau-cid-error-hint",I.style.display="none",I.textContent="Formato de CID incorreto",f.appendChild(I)}}else s.fields.forEach(b=>{L.appendChild($i(b))});y.appendChild(L)}q.appendChild(y)});let $=document.createElement("div");$.className="bau-footer";let T=document.createElement("button");T.type="button",T.id="bau-step-back-btn",T.className="bau-btn-secondary",T.textContent=B("back");let C=document.createElement("button");C.type="button",C.id="bau-step-next-btn",C.className="bau-btn-primary",C.textContent=B("next");let N=document.createElement("button");N.type="submit",N.className="bau-btn-submit",N.innerHTML=`${ke.send} ${B("submitToTl")}`,N.style.display="none",$.appendChild(T),$.appendChild(C),$.appendChild(N),q.appendChild($),d.appendChild(w);let k=document.createElement("div");k.id="bau-view-success",k.className="bau-view bau-success-view",k.innerHTML=`
        <div class="bau-success-content">
            <div class="bau-success-icon" style="color: ${vt.green};">${ke.check}</div>
    ...
    `,d.appendChild(k),document.body.appendChild(c);function F(s){t=s,c.querySelectorAll(".bau-view").forEach(I=>I.classList.remove("active"));let y=c.querySelector(`#bau-view-${s}`);y&&y.classList.add("active");let L=v.querySelector(".cw-module-header-title")||v.querySelector("h2"),b=v.querySelector(".cw-module-header-subtitle")||v.querySelector("p");L&&(s==="form"?L.textContent=i?B("editingCase")(r):B("newBauCase"):L.textContent=B("headerTitle")),b&&(b.textContent=B(s==="form"?"fillDetailsBelow":"headerDesc"));let f=q.querySelector(".bau-btn-submit");f&&(f.innerHTML=i?`${ke.send} ${B("saveChanges")}`:`${ke.send} ${B("submitToTl")}`)}function j(){let s=c.querySelector("#bau-case-list-container"),y=c.querySelector("#bau-dashboard-metrics");y&&(y.innerHTML=`
        ...
        `).join(""))}async function z(){let s=c.querySelector("#bau-case-list-container"),y=c.querySelector("#bau-dashboard-metrics");if(!(!s||!y)){j();try{let L=await Eo();if(!Array.isArray(L))throw new Error("API response is not a valid array");le(L)}catch(L){console.error("Critical Error loading BAU cases:",L),y&&(y.innerHTML=""),s.innerHTML=`
            ...
            `,c.querySelector("#bau-retry-btn")?.addEventListener("click",()=>z()),S.playError(),X(B("loadDashboardError"),{error:!0})}}}function K(s){if(!s)return;let y=Ri(s.status),L=(f,I)=>{navigator.clipboard.writeText(f).then(()=>{X(B("copiedToClipboard")),S.playClick();let m=I.style.color;I.style.color="#1E8E3E",setTimeout(()=>{I.style.color=m},800)})};p.innerHTML=`
                ...
                <div class="bau-details-grid">
                    <div class="bau-details-card">
                        <div class="bau-details-row">
                            ...
                            <button class="bau-copy-btn" title="${B("copy")}">${ke.wand}</button>
                        </div>
                        <div class="bau-details-row">
        ...
        `;let b=p.querySelector(".bau-details-close-btn");b.onclick=()=>{p.classList.remove("active"),S.playSwoosh(),setTimeout(()=>{p.style.display="none"},600)},p.querySelectorAll(".bau-copy-btn").forEach(f=>{f.onclick=I=>{let m=I.target.closest(".bau-details-row").querySelector(".bau-details-value").textContent;L(m,f)}}),p.style.display="flex",requestAnimationFrame(()=>{p.classList.add("active"),S.playClick()})}function ie(s){if(!s)return"";let y=Ri(s?.status),L=la(s?.date),b="",f="";if(s?.status==="PENDING_TL_CREATION"&&s?.availability_1){let de=new Date(s.availability_1),x=new Date;(de<=x||de-x<36e5*2)&&(b=`<span class="bau-sla-badge">${B("urgent")}</span>`,f="bau-pulse-attention")}let I=s?.reason&&s.reason.trim()?s.reason:B("noAdditionalContext"),P=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(s?.cid||""),Z=!s?.caseId||s.caseId==="N/A"||!P;return Z&&s?.status==="PENDING_TL_CREATION"&&(f="bau-pulse-attention"),`
                ...
                <div class="bau-case-main">
                    ...
                    <div class="bau-case-info">
                        ...
                        <p class="bau-case-details">
                            ...
                            <span data-tooltip="${B("reasonTooltip")}">${B("reasonPrefix")} ${I}</span>
                        </p>
                        ${Z?`<div class="bau-data-error-hint">${!s?.caseId||s?.caseId==="N/A"?B("incompleteData"):B("invalidCid")} - ${B("contactSupport")}</div>`:""}
                    </div>
                </div>
        ...
        `}function le(s){let y=c.querySelector("#bau-case-list-container"),L=c.querySelector("#bau-dashboard-metrics");if(!y||!L)return;let b=Array.isArray(s)?s.filter(Boolean):[];if(b.length===0){L.innerHTML=`
            ...
            `,c.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>z());return}let f=b.filter(de=>de.status==="PENDING_TL_CREATION").length,I=b.filter(de=>de.status==="CREATED").length;L.innerHTML=`
        ...
        `;let m=L.querySelector("#bau-refresh-dashboard");m?.addEventListener("click",async()=>{m.classList.contains("spinning")||(m.classList.add("spinning"),S.playClick(),await z(),setTimeout(()=>m.classList.remove("spinning"),1e3))}),y.innerHTML="";let P=b.slice(0,5),Z=b.slice(5);if(P.forEach(de=>{let x=ie(de),O=document.createElement("div");O.innerHTML=x;let U=O.firstElementChild;U.addEventListener("click",ne=>{ne.target.closest(".bau-case-edit-btn")||K(de)});let Q=U.querySelector(".bau-case-edit-btn");Q&&(Q.onclick=ne=>{ne.stopPropagation(),te(de)}),y.appendChild(U)}),Z.length>0){let de=document.createElement("li");de.className="bau-accordion-container";let x=document.createElement("button");x.className="bau-accordion-toggle",x.innerHTML=`${ke.expand} <span>Mostrar ${Z.length} casos mais antigos</span>`;let O=document.createElement("ul");O.className="bau-case-list bau-accordion-content",O.style.display="none",Z.forEach(U=>{let Q=ie(U),ne=document.createElement("div");ne.innerHTML=Q;let ce=ne.firstElementChild;ce.addEventListener("click",we=>{we.target.closest(".bau-case-edit-btn")||K(U)});let re=ce.querySelector(".bau-case-edit-btn");re&&(re.onclick=we=>{we.stopPropagation(),te(U)}),O.appendChild(ce)}),x.addEventListener("click",()=>{let U=O.style.display==="none";O.style.display=U?"block":"none",x.classList.toggle("expanded",U),x.querySelector("span").textContent=U?"Esconder casos mais antigos":`Mostrar ${Z.length} casos mais antigos`,S.playClick()}),de.appendChild(x),de.appendChild(O),y.appendChild(de)}}function W(){let s=n==="BAU"?[1,2,3,4]:[5,4];q.querySelectorAll(".bau-step").forEach(b=>{let f=parseInt(b.id.replace("bau-step-","")),I=f===o,m=s.includes(f)||f===0;b.classList.toggle("active",I),b.style.display=I?"block":"none",b.querySelectorAll("input, select, textarea").forEach(P=>{P.disabled=!m})});let y=o===0;if(h.style.display=y?"none":"flex",!y){h.innerHTML="";let b=n==="BAU"?[1,2,3,4]:[5,4];b.forEach((f,I)=>{let m=document.createElement("div"),P=f===o,Z=b.indexOf(o),de=I<Z;m.className=`bau-progress-step ${P?"active":de?"completed":""}`,m.textContent=I+1,h.appendChild(m)})}let L=o===4;T.style.display=o>0?"inline-block":"none",C.style.display=!y&&!L?"inline-block":"none",N.style.display=L?"flex":"none",L&&J()}function ee(s){let y=yt.steps.find(L=>L.id===s);if(!y||!y.fields||y.isConfirmation)return!0;for(let L of y.fields){let b=q.querySelector(`#bau-step-${s} #wrapper-${L.id}`);if(!(b&&b.style.display==="none")&&L.validation){let f=q.querySelector(`#bau-step-${s} [name="${L.name}"]`);if(f&&f.offsetParent!==null&&f.value.trim())if(new RegExp(L.validation.regex).test(f.value.trim())){f.classList.remove("invalid-cid");let m=q.querySelector("#bau-cid-error");m&&(m.style.display="none")}else{console.warn(`Validation failed for field "${L.name}" in step ${s}: Regex mismatch.`),S.playError(),X(B("errorPrefix")(Ke(L,"error")||L.validation.error),{error:!0}),f.classList.add("invalid-cid");let m=q.querySelector("#bau-cid-error");return m&&(m.style.display="flex"),!1}}}return!0}function H(s){if(!q.querySelector(`#bau-step-${s}`))return!1;let L=yt.steps.find(f=>f.id===s);if(!L||!L.fields||L.isConfirmation)return!0;let b=!0;for(let f of L.fields){let I=q.querySelector(`#bau-step-${s} #wrapper-${f.id}`);if(!(I&&I.style.display==="none")&&f.required){let m=!0,P="";if(f.type==="checkbox-grid")q.querySelector(`#bau-step-${s} input[name="${f.name}"]:checked`)||(P="No option selected in checkbox-grid",S.playError(),X(B("selectAtLeastOne")(Ke(f,"label")),{error:!0}),m=!1);else if(f.type==="datetime-group"){let Z=q.querySelector(`#bau-step-${s} input[name="${f.fields[0].name}"]`);if(!Z||Z.offsetParent===null)continue;Z.value.trim()||(P="Datetime group first field is empty",S.playError(),X(B("fieldRequiredDouble")(Ke(f.fields[0],"label")),{error:!0}),m=!1)}else{let Z=q.querySelector(`#bau-step-${s} [name="${f.name}"]`);if(!Z||Z.offsetParent===null)continue;Z.value.trim()||(P="Field is empty",S.playError(),X(B("fieldRequiredSingle")(Ke(f,"label")),{error:!0}),m=!1)}if(!m){console.warn(`Validation failed for required field "${f.name}" in step ${s}: ${P}`),b=!1;break}}}return b}C.addEventListener("click",()=>{if(ee(o)&&H(o)){n==="BAU"?o++:o===5?o=4:o++,W();let s=c.querySelector(".bau-content");s&&(s.scrollTop=0),S.playClick()}}),T.addEventListener("click",()=>{o>0&&(n==="BAU"?o--:o===4?o=5:o===5?o=0:o--,W(),S.playClick())});async function oe(){let s=await Je()||{};(!s.amName||s.amName==="N/A")&&(s.amName=s.internalEmail||"N/A"),a=s,q.querySelectorAll(".bau-vital-highlights").forEach(b=>{let f=[{label:"Anunciante",value:s.advName},{label:"CID",value:s.cid},{label:"Website",value:s.website||s.site},{label:"Case ID",value:s.caseId}];b.innerHTML=f.map(I=>{let m=I.value&&I.value!=="N/A"&&I.value!=="undefined"&&I.value!=="null"?I.value:B("notCaptured");return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${I.label}</span>
                        <span class="bau-highlight-value">${m}</span>
                    </div>
                `}).join("")}),yt.steps.forEach(b=>{b.fields&&b.fields.forEach(f=>{if(f.isSmart){let I=s[f.id];f.id==="language"&&s.userProfile?.defaultLanguage&&(I=s.userProfile.defaultLanguage);let m=q.querySelector(`#bau-step-${b.id} [name="${f.name}"]`),P=q.querySelector(`#bau-step-${b.id} #wrapper-${f.id}`);if(m&&(m.value=I&&I!=="N/A"?I:"",f.id==="language"&&I&&I!=="N/A"&&(m.readOnly=!0,m.style.background="#F1F3F4",m.style.cursor="not-allowed")),P){let Z=I&&I!==""&&I!=="N/A"&&I!=="undefined"&&I!=="null";f.id==="language"?P.style.display="block":P.style.display=Z?"none":"block"}}})}),q.querySelectorAll(".bau-all-data").forEach(b=>{let f=[{label:"Anunciante",value:s.advName},{label:"CID",value:s.cid},{label:"AM",value:s.amName},{label:"SE ID",value:s.seId},{label:"Site",value:s.website||s.site},{label:"Email",value:s.email},{label:"Timezone",value:s.timezone},{label:"Case ID",value:s.caseId},{label:"Programa",value:s.salesProgram},{label:"Idioma",value:s.language}];b.innerHTML=`
                <div class="bau-context-badges-grid">
                    ${f.filter(I=>I.value&&I.value!=="N/A"&&I.value!=="---"&&I.value!=="undefined"&&I.value!=="null").map(I=>`
            ...
            `})}c.querySelector("#bau-top-se-search")?.addEventListener("click",s=>{s.preventDefault(),ga("bau-form-seId")});let R=c.querySelector("#bau-form-cid");R&&R.addEventListener("input",()=>ee(1));function J(){let s=new FormData(q),y=Object.fromEntries(s.entries()),L=c.querySelector("#bau-confirmation-details");if(L){if(n==="BAU"){let b=s.getAll("taskType"),f=b.length>0?b.join(", "):B("none");L.innerHTML=`
                ...
                <div class="bau-confirmation-grid">
                    ...
                    <div class="bau-confirm-row">
                        ...
                        <input class="bau-confirm-value-input" data-field="seId" data-step="1" value="${y.seId||""}" placeholder="${B("notInformedPlaceholder")}">
                    </div>
            ...
            `;L.querySelectorAll(".bau-confirm-value-input").forEach(b=>{b.addEventListener("input",f=>{let I=f.target.dataset.field,m=f.target.dataset.step;if(!I||!m)return;let P=q.querySelector(`#bau-step-${m} [name="${I}"]`);P&&(P.value=f.target.value,I==="cid"&&ee(1))})})}}async function te(s){if(!await Fe(B("editPageWarning"),{confirmText:B("onCorrectPage")}))return;D(!0),V(),i=!0,r=s.id,n=s.status==="PENDING_TL_DISCARD"||s.reason&&!s.task?"DISCARD":"BAU",F("form"),await oe(),a={...a,advName:s.advName||a.advName,cid:s.cid||a.cid,caseId:s.caseId||a.caseId,seId:s.seId||a.seId,site:s.site||s.website||a.site||a.website,email:s.advEmail||a.email,timezone:s.timezone||a.timezone,language:s.language||a.language,amName:s.amName||a.amName,salesProgram:s.salesProgram||a.salesProgram};let L=s.availability?s.availability.split("|").map(b=>b.trim()):[];q.querySelectorAll("input, select, textarea").forEach(b=>{let f=b.name,m={advEmail:"advEmail",website:"site",site:"site"}[f]||f;if(f==="taskType"){let P=(s.task||s.taskType||"").split(",").map(Z=>Z.trim());b.type==="checkbox"&&(b.checked=P.includes(b.value),b.closest(".bau-task-item")?.classList.toggle("active",b.checked))}else if(f.startsWith("availability_")){let P=parseInt(f.split("_")[1])-1,Z=L[P];if(Z&&b.type==="datetime-local")try{let de=new Date(Z);if(!isNaN(de.getTime())){let x=new Date(de.getTime()-de.getTimezoneOffset()*6e4).toISOString().slice(0,16);b.value=x}}catch{}}else s[m]!==void 0?b.value=s[m]:f==="reason"?b.value=s.reason:f==="description"?b.value=s.description:f==="nonImplementationReason"&&(b.value=s.nonImplementationReason||"")}),o=n==="BAU"?1:5,W(),S.playClick(),setTimeout(()=>D(!1),500)}q.onsubmit=async s=>{s.preventDefault();let y=n==="BAU"?[1,2,3]:[5];for(let P of y)if(!yt.steps.find(de=>de.id===P)?.isConfirmation&&(!ee(P)||!H(P))){console.warn(`Form submission blocked by validation failure in step ${P}`),o=P,W();return}let L=c.querySelector(".bau-btn-submit");L.disabled=!0,L.innerHTML=B("sending");let b=new FormData(q),f=Object.fromEntries(b.entries()),I=a||{},m={...I,...f,requestType:n};if(f.advEmail?m.advEmail=f.advEmail:I.email&&(m.advEmail=I.email),f.website?m.website=f.website:I.website?m.website=I.website:I.site&&(m.website=I.site),n==="BAU"){let P=b.getAll("taskType"),Z=[f.availability_1,f.availability_2,f.availability_3].filter(de=>de&&de.trim()!=="").join(" | ");m.taskType=P.join(", "),m.availability=Z,i?(f.nonImplementationReason?m.nonImplementationReason=f.nonImplementationReason:delete m.nonImplementationReason,f.description?m.description=f.description:delete m.description):(m.nonImplementationReason=f.nonImplementationReason||"",m.description=f.description||"",m.nonImplementationReason||console.warn("Aviso: Campo 'Justificativa' (nonImplementationReason) est\xE1 saindo vazio."),m.description||console.warn("Aviso: Campo 'Descri\xE7\xE3o detalhada' (description) est\xE1 saindo vazio."))}else m.reason=f.reason,i?(f.description?m.description=f.description:delete m.description,delete m.taskType,delete m.availability,delete m.nonImplementationReason):(m.taskType="",m.availability="",m.nonImplementationReason="",m.description=f.description||"");try{let P=null;i?await Co(r,m):P=await So(m,I.agentEmail||"anon"),S.playSuccess();let Z=c.querySelector(".bau-success-title");Z&&(i?Z.textContent=B("caseUpdatedSuccess"):Z.textContent=B(n==="DISCARD"?"caseDiscardSentSuccess":"caseSentSuccess")),F("success"),!i&&P&&P.emailSent===!1&&(S.playError(),X(B("caseCreatedNoEmailConfirm"),{error:!0}))}catch(P){S.playError(),X(B("errorPrefix")(P.message||B("unknownError")),{error:!0}),console.error("Payload que tentou enviar:",m)}finally{L.disabled=!1,L.innerHTML=`${ke.send} ${B("submitToTl")}`}};function V(){q.reset(),o=0,n="BAU",i=!1,r=null,W(),q.querySelectorAll(".bau-task-item.active").forEach(y=>y.classList.remove("active"));let s=q.querySelector('[name="language"]');s&&(s.readOnly=!1,s.style.background="",s.style.cursor="")}c.querySelector("#bau-new-case-btn").addEventListener("click",()=>{V(),F("form"),oe()}),c.querySelector("#bau-form-back-btn").addEventListener("click",()=>F("dashboard")),c.querySelector("#bau-success-back-btn").addEventListener("click",()=>F("dashboard"));async function ae(){e=!He(c),e&&(c.style.display="flex"),e?(Te(),F("dashboard"),z()):qe(),ze(e,c,"cw-btn-bauform")}return W(),Se(()=>{let s=c.querySelector(".cw-help-title");s&&(s.textContent=B("headerTitle"));let y=c.querySelector(".cw-help-description");y&&(y.textContent=B("headerDesc"));let L=c.querySelector(".js-bau-new-case");L&&(L.textContent=B("newBauCase"));let b=c.querySelector(".js-bau-back-dashboard");b&&(b.textContent=B("backToDashboard"));let f=c.querySelector(".js-bau-configuring-edit");f&&(f.textContent=B("configuringEdit"));let I=c.querySelector(".js-bau-success-title");I&&(I.textContent=B("caseSentSuccess"));let m=c.querySelector(".js-bau-success-sub");m&&(m.textContent=B("caseSentSuccessSub"));let P=c.querySelector(".js-bau-success-back");P&&(P.textContent=B("backToDashboard")),T.textContent=B("back"),C.textContent=B("next"),F(t),t==="form"&&q.querySelectorAll(".bau-step").forEach(Z=>{let de=parseInt(Z.id.replace("bau-step-",""),10),x=yt.steps.find(O=>O.id===de);!x||x.isBranching||x.isConfirmation||Z.querySelectorAll(".bau-dynamic-input").forEach(O=>{let U=O.id.replace("wrapper-",""),Q=x.fields?.find(re=>re.id===U);if(!Q)return;let ne=O.querySelector(".bau-label");ne&&Q.label&&(ne.textContent=Ke(Q,"label"),Q.tooltip&&ne.setAttribute("data-tooltip",Ke(Q,"tooltip")));let ce=O.querySelector("input, textarea, select");if(ce&&Q.placeholder&&(ce.placeholder=Ke(Q,"placeholder")),Q.type==="select"){let re=Q.groups?Q.groups.flatMap(we=>we.options):Q.options||[];O.querySelectorAll("option").forEach((we,Ce)=>{let Ve=re[Ce];Ve&&(we.textContent=at(Ve.text))})}})}),t==="dashboard"&&z()}),ae}var Pe={notes:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>',email:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>',script:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>',links:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>',library:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H8V4h12v12z"/></svg>',timezone:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg>',configs:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58c-.18.14-.23.41-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6z"/></svg>',bauform:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14zm-1-6h-3v3h-2v-3H8v-2h3V8h2v3h3v2z"/></svg>',broadcast:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>',search:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',enter:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 10 4 15 9 20"></polyline><path d="M20 4v7a4 4 0 0 1-4 4H4"></path></svg>',arrowDown:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>',arrowUp:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"></polyline></svg>',bolt:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>'};function hs(){if(document.getElementById("cw-palette-styles"))return;let e=document.createElement("style");e.id="cw-palette-styles",e.textContent=`
        .cw-palette-overlay {
            position: fixed; inset: 0;
    ...
    `,g.appendChild(u),g.onmousedown=A=>{A.target===g&&E()};let v=u.querySelector(".cw-palette-input"),d=u.querySelector(".cw-palette-list");function p(){if(d.innerHTML="",c.length===0){d.innerHTML=`<div class="cw-palette-empty">${ot("empty")}</div>`;return}let A=[],D=null;c.forEach((q,$)=>{if(q.group!==D){D=q.group;let C=document.createElement("div");C.className="cw-palette-group",C.textContent=ot(q.group==="shortcuts"?"groupShortcuts":"groupModules"),C.setAttribute("aria-hidden","true"),d.appendChild(C)}let T=document.createElement("div");T.className="cw-palette-item"+($===r?" selected":""),T.innerHTML=`
            ...
            `,T.onmouseenter=()=>{r=$,p()},T.onclick=()=>_($),d.appendChild(T),A.push(T)});let h=A[r];h&&h.scrollIntoView({block:"nearest"})}function _(A){let D=c[A];D&&(S.playClick(),E(),D.run())}function w(){i||(i=!0,l=n(),c=l,r=0,v.value="",p(),Te(),document.body.appendChild(g),S.playGenieOpen(),requestAnimationFrame(()=>{g.classList.add("active"),v.focus()}))}function E(){i&&(i=!1,qe(),g.classList.remove("active"),setTimeout(()=>g.remove(),200))}function M(){i?E():w()}return v.addEventListener("input",()=>{let A=t(v.value.trim());c=A?l.filter(D=>D._haystack.includes(A)):l,r=0,p()}),v.addEventListener("keydown",A=>{A.key==="ArrowDown"?(A.preventDefault(),r=Math.min(r+1,c.length-1),p()):A.key==="ArrowUp"?(A.preventDefault(),r=Math.max(r-1,0),p()):A.key==="Enter"?(A.preventDefault(),_(r)):A.key==="Escape"&&(A.preventDefault(),E())}),document.addEventListener("keydown",A=>{(A.metaKey||A.ctrlKey)&&A.key.toLowerCase()==="k"&&(A.preventDefault(),M())}),Se(()=>{g.setAttribute("aria-label",ot("ariaLabel")),v.placeholder=ot("placeholder");let A=u.querySelector(".js-cp-navigate");A&&(A.innerHTML=`${Pe.arrowDown}${Pe.arrowUp} ${ot("navigate")}`);let D=u.querySelector(".js-cp-select");D&&(D.innerHTML=`${Pe.enter} ${ot("select")}`);let h=u.querySelector(".js-cp-close");h&&(h.textContent=ot("close")),p()}),{open:w,close:E,toggle:M}}function xs(){if(window.techSolInitialized){Ga();return}window.techSolInitialized=!0;let e="v6.1.0";console.log(`\u{1F680} TechSol Suite Initializing (${e})...`);try{Ro();try{S.initGlobalListeners()}catch(d){console.warn("\xC1udio bloqueado:",d)}me.fetchContentModules(["tips","broadcast","bau_availability","links","call_script","email_template","note_template"]);let t=Ga(),a=Gn(),o=Xn(),n=ti(),i=si(),r=Ii(),l=Fi(),c=Oi(),g=Bi(),u=fi(),v={toggleNotes:a,toggleEmail:o,toggleScript:n,toggleLinks:i,toggleTimezone:r,toggleLibrary:l,toggleConfigs:c,toggleBAUForm:g,broadcastControl:u};hn(v,t),Gi(v),setTimeout(()=>{me.logEvent("App","Start","Session Start");let d=Ie();dt.sync(),(d?Tt(d.split("@")[0]).then(_=>{_&&(Mo(_),Io(_))}).catch(_=>console.warn("N\xE3o foi poss\xEDvel resolver o idioma do perfil:",_)):Promise.resolve()).finally(()=>{Ei(),setTimeout(()=>{Ai(e)},500)})},2500)}catch(t){console.error("Erro fatal na inicializa\xE7\xE3o:",t),S.playError(),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}xs();})();
