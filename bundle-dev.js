...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(M)}let p=document.createElement("div");p.className="cw-zen-container";let d=document.createElement("div");Object.assign(d.style,{display:"none"});let c=document.createElement("div");c.className="cw-screens-container",d.appendChild(c),p.innerHTML=`
    ...
    `;let x=p.querySelector(".cw-hero-grid"),g=p.querySelector(".cw-acc-container"),b=p.querySelector(".cw-results-container"),m=p.querySelector(".cw-search-input"),v=p.querySelector(".cw-status-bar"),C=p.querySelector(".cw-status-text"),P=p.querySelector(".cw-footer-icons");s.forEach(([M,F])=>{let D=i(F.name),U=document.createElement("div");U.className="cw-hero-card",U.id=`hero-${M}`,U.style.setProperty("--hero-color",D.color),U.innerHTML=`
            <div class="cw-hero-main">
                <div class="cw-hero-icon">${ze[D.icon]}</div>
        ...
        `,U.onclick=_=>{if(_.target.closest(".cw-step-btn"))return;let k=a[M]?a[M].count:0;z(M,k>0?-k:1,F)},U.querySelector(".minus").onclick=()=>z(M,-1,F),U.querySelector(".plus").onclick=()=>z(M,1,F),U.dataset.color=D.color,x.appendChild(U)});function j(M,F){let D=i(F.name),U=document.createElement("div");return U.className="cw-task-item",U.dataset.id=M,U.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${D.bg}; color:${D.color}">
                    ${ze[D.icon]||ze.default}
                </div>
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(m,v)=>{G.playClick(),a.querySelector(`.${m}`).classList.toggle("active"),v()};if(a.querySelector(".notes").onclick=m=>{m.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=m=>{m.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=m=>{m.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=m=>{m.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=m=>{m.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=m=>{m.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=m=>{m.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=m=>{m.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=m=>{m.stopPropagation(),i("broadcast",()=>{let v=m.currentTarget.querySelector(".cw-badge");v&&v.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(m=>{m.addEventListener("mouseenter",()=>G.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let m=document.createElement("div");m.className="cw-badge",a.querySelector(".broadcast").appendChild(m)}let s=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(s=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{s&&clearTimeout(s)},(async function(){let v=()=>{let P=ve();if(P){let j=P.split("@")[0].toLowerCase();if(lt.includes(j)){let z=a.querySelector("#cw-admin-tag");z&&z.classList.add("visible")}}else setTimeout(v,2e3)};v(),await ct(2800),a.classList.add("docked"),await ct(300);let C=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(P=>P.classList.add("visible"));for(let P=0;P<C.length;P++)C[P].classList.add("popped"),await ct(90);await ct(200),a.classList.add("system-check")})();let r=!1,l,p,d,c,x=3;a.onmousedown=m=>{if(m.target.closest("button"))return;m.preventDefault(),l=m.clientX,p=m.clientY;let v=a.getBoundingClientRect();d=v.left,c=v.top,document.addEventListener("mousemove",g),document.addEventListener("mouseup",b)};function g(m){let v=m.clientX-l,C=m.clientY-p;!r&&Math.sqrt(v*v+C*C)>x&&(r=!0,a.classList.add("dragging"),a.style.transition="none",s&&clearTimeout(s)),r&&(a.style.left=`${d+v}px`,a.style.top=`${c+C}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function b(m){if(document.removeEventListener("mousemove",g),document.removeEventListener("mouseup",b),r){r=!1,a.classList.remove("dragging");let v=window.innerWidth,C=window.innerHeight,P=a.getBoundingClientRect(),j=P.left+P.width/2,z;j<v/2?(z=24,a.classList.remove("side-right"),a.classList.add("side-left")):(z=v-P.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let Z=Math.max(24,Math.min(P.top,C-P.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${z}px`,a.style.top=`${Z}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let v=a.querySelector(".cw-btn.active"),C=m.target.closest("button");if(a.classList.contains("collapsed")){let P=a.getBoundingClientRect(),j=window.innerHeight,z=P.top>j/2;if(a.style.setProperty("transition","none","important"),z){let Z=j-P.bottom;a.style.top="auto",a.style.bottom=`${Z}px`}else a.style.bottom="auto",a.style.top=`${P.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),G.playGenieOpen()}else!v&&!C&&(a.classList.add("collapsed"),G.playGenieOpen());C&&(C.style.transform="scale(0.9)",setTimeout(()=>C.style.transform="",150))}}}function Je(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
`.replace(/\n/g,"<br>");Ke(M);let F=await mt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,M),ut(F),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var be=t=>new Promise(e=>setTimeout(e,t));function he(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function ke(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function gt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let d=e.getBoundingClientRect();s=d.left+d.width/2,r=d.top+d.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,p=i.y-r;t?(G.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof uo=="function"&&uo(e,o)):(G.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Ft=="function"&&Ft(e))}function uo(t,e){Ft(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Ft(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function mo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Wt(t,K),s=eo(h),r=Qt(()=>{k(),Y.setActiveTasks(r.getCheckedElements())},h,Y),l=document.createElement("div");l.style.display="none";let p=Zt((u,y)=>{E(u,y)});l.appendChild(p);let d=io({onSaveCurrent:async()=>{let u=await N();return q(),u},onLoadDraft:u=>{W(u)},t:u=>h(u)}),c=F(),x=D(),g=document.createElement("div"),b=S(),m=O(d,h);o.appendChild(c),o.appendChild(x),o.appendChild(b),o.appendChild(l),o.appendChild(g),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let v=document.createElement("button");v.id="manual-task-toggle",v.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",v.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${$.primary}; background: ${$.surface}; color: ${$.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,v.onmouseenter=()=>{v.style.background=$.primaryBg},v.onmouseleave=()=>{v.style.background=$.surface},v.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",v.style.display="none"},o.appendChild(v),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(m);let C=document.createElement("div");C.style.display="none",C.style.flexGrow="1",C.style.minHeight="0",C.style.overflow="hidden";let P=lo(()=>M());P.style.height="100%",C.appendChild(P),e.insertBefore(C,i);let j=a.lastElementChild;j&&(j.insertBefore(d.historyBtnWrapper,j.firstChild),j.insertBefore(V(),j.firstChild)),e.appendChild(d.drawer);let z=null;Y.subscribe(u=>{T(u),Z(),u.isDirty?(z&&clearTimeout(z),z=setTimeout(async()=>{let y=await N(!0);y.subStatus?ge.saveEmergency(y):ge.clearEmergency(),u.isDirty=!1},2e3)):z&&(clearTimeout(z),z=null)});function Z(){let u=ge.getCount()>0,y=!!Y.currentSubStatus;dt(u||y)}function K(){Y.visible=!Y.visible,ue(Y.visible,e,"cw-btn-notes")}function M(){Y.isSplitView=!Y.isSplitView,Y.isSplitView?(o.style.display="none",C.style.display="flex",C.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",C.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function F(){let u=document.createElement("div");if(u.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let w=document.createElement("style");w.id="cw-segmented-styles",w.innerHTML=`
            ...
            `,document.head.appendChild(w)}let y=(w,H)=>{let J=u.querySelector(`#${w}`).querySelector(".cw-segmented-indicator");J&&(J.style.transform=`translateX(${H*100}%) translateX(${H*2}px)`)};return u.querySelectorAll("#lang-selector button").forEach((w,H)=>{w.onclick=()=>{Y.setLanguage(w.dataset.lang),u.querySelectorAll("#lang-selector button").forEach(L=>L.classList.remove("active")),w.classList.add("active"),y("lang-selector",H),G.playHover(),Y.currentSubStatus&&_(Y.currentSubStatus)}}),u.querySelectorAll("#type-selector button").forEach((w,H)=>{w.onclick=()=>{Y.setCaseType(w.dataset.type),u.querySelectorAll("#type-selector button").forEach(L=>L.classList.remove("active")),w.classList.add("active"),y("type-selector",H),G.playHover(),Y.currentSubStatus&&_(Y.currentSubStatus)}}),u.querySelectorAll("#portugal-selector button").forEach((w,H)=>{w.onclick=()=>{Y.setPortugalCase(w.dataset.val==="true"),u.querySelectorAll("#portugal-selector button").forEach(L=>L.classList.remove("active")),w.classList.add("active"),y("portugal-selector",H),G.playHover(),Y.currentSubStatus&&_(Y.currentSubStatus)}}),u}function D(){let u=document.createElement("div");u.className="cw-status-section",u.style.cssText="display: flex; flex-direction: column; gap: 8px;",u.innerHTML=`
        ...
        `;let y=u.querySelector("#main-status-select"),w=u.querySelector("#sub-status-select");return y.onchange=()=>{Y.setStatus(y.value),U(y.value,w),Y.setSubStatus(""),_("")},w.onchange=()=>{Y.setSubStatus(w.value),_(w.value)},u}function U(u,y){if(y.innerHTML=`<option value="">${h("select_substatus")}</option>`,!u){y.disabled=!0;return}for(let w in Te)if(Te[w].status===u){let H=document.createElement("option");H.value=w,H.textContent=Te[w].name,y.appendChild(H)}y.disabled=!1}function _(u){if(p.render&&p.render(u,Y.currentCaseType),!u){l.style.display="none",g.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",b.style.display="flex",b.style.opacity="1",m.style.display="none";return}b.style.opacity="0",setTimeout(()=>{Y.currentSubStatus&&(b.style.display="none")},400),m.style.display="grid";let y=Te[u];y&&y.templateFields&&Y.setActiveFields(y.templateFields),I(),Ct(u,g,Y),g.style.display="block",l.style.display="block";let w=u.startsWith("SO_"),H=u==="NI_Awaiting_Validation",L=document.getElementById("manual-task-toggle");w||H?(r.selectionElement.style.display="block",L.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",L.style.display="block");let J=u==="SO_Education_Only"?"education":"implementation";Y.setScreenshotMode(J),Y.currentCaseType==="lm"?Y.toggleFieldExclusion("field-ON_CALL",!0):Y.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(u),k();let R=document.getElementById("email-automation-toggle-row");R&&(R.style.display=He[u]?"flex":"none")}function k(){let u=r.getCheckedElements().map(y=>y.value);s.updateVisibility(Y.currentSubStatus,u)}function E(u,y){let w=it[u];if(w){for(let H in w)if(H==="linkedTask")r.toggleTask(w.linkedTask,y);else if(H==="activeTasks")w.activeTasks.forEach(L=>{y?r.setTaskCount(L.value,L.count):r.setTaskCount(L.value,0)});else if(H.startsWith("field-")){let L=H,J=w[H],R=document.getElementById(L);if(R){let ee=$e.includes(L.replace("field-",""));if(y)if(ee){let oe=R.value.trim();oe.includes(J.trim())||(R.value=oe?oe+`
`+J.trim():J.trim())}else R.value=J;else if(ee){let oe=R.value.trim(),Q=J.trim();oe.includes(Q)&&(R.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else R.value.trim()===J.trim()&&(R.value="");Y.updateField(L,R.value),R.dispatchEvent(new Event("input"))}}}}function O(u,y){let w=document.createElement("div");if(w.className="cw-actions-section",w.style.cssText=`
            display: grid;
        ...
        `;let L=u.parkButton;L.classList.add("js-btn-park"),L.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let J=document.createElement("button");J.className="cw-btn-secondary js-btn-reset",J.textContent=y("limpar"),J.style.cssText=`width: 100%; height: 34px; background: ${$.surface}; color: ${$.textSub}; border: 1px solid ${$.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,J.onclick=()=>q();let R=document.createElement("button");R.className="cw-btn-secondary js-btn-copy",R.textContent=y("copiar"),R.style.cssText=`width: 100%; height: 34px; background: ${$.surface}; color: ${$.primary}; border: 1px solid ${$.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,R.onclick=()=>f();let ee=document.createElement("button");return ee.className="cw-btn-primary js-btn-generate",ee.textContent=y("preencher"),ee.style.cssText=`width: 100%; height: 38px; background: ${$.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ee.onclick=()=>A(),w.appendChild(H),w.appendChild(L),w.appendChild(J),w.appendChild(R),w.appendChild(ee),w}async function f(){if(!Y.currentSubStatus){X(h("select_substatus"),{error:!0});return}let u=Et(Y,r,s);u?(Ke(u),X(h("copiado_sucesso")),G.playClick()):X(h("select_substatus"),{error:!0})}async function A(){if(!Y.currentSubStatus){X(h("select_substatus"),{error:!0});return}let u=Et(Y,r,s);Ke(u),K();let y=Je(),w=await mt();if(w){w.focus(),document.execCommand("insertHTML",!1,u),ut(w);let H=document.getElementById("email-automation-checkbox");(!H||H.checked)&&Y.currentSubStatus&&He[Y.currentSubStatus]&&await ft(He[Y.currentSubStatus]),X(h("inserido_copiado")),G.playSuccess(),q()}y()}function I(){if(Y.currentSubStatus){if(Y.currentCaseType==="lm")Y.removeField("ON_CALL");else{let u=Te[Y.currentSubStatus];u&&u.templateFields.includes("ON_CALL")&&Y.addFieldAt("ON_CALL",1)}Y.isPortugalCase?(Y.addFieldAt("CASO_PORTUGAL",1),Y.addFieldAt("CONSENTIU_GRAVACAO",2)):(Y.removeField("CASO_PORTUGAL"),Y.removeField("CONSENTIU_GRAVACAO"))}}function q(){Y.reset(),r.reset(),s.reset(),Z(),ge.clearEmergency(),o.querySelectorAll("select").forEach(y=>y.value=""),o.querySelector("#sub-status-select").disabled=!0;let u=document.getElementById("email-automation-toggle-row");u&&(u.style.display="none"),g.innerHTML="",l.style.display="none",b.style.display="flex",b.style.opacity="1",m.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none"}async function N(u=!1){let y={};g.querySelectorAll("input, textarea, select").forEach(R=>{(R.id.startsWith("field-")||R.id==="consent-select")&&(y[R.id]=R.value)});let w="Cliente",H="---";if(!u)try{let R=await we();w=R.advertiserName,H=R.cid}catch(R){console.warn("Erro ao coletar pageData:",R)}let L=r.getCheckedElements().map(R=>({key:R.value,count:R.count})),J=L.map(R=>{let ee=Ce[R.key];return ee?ee.name:R.key});return{currentCaseType:Y.currentCaseType,currentLang:Y.currentLang,isPortugalCase:Y.isPortugalCase,consent:Y.consent,tagSupportUsed:Y.tagSupportUsed,forcedScreenshots:[...Y.forcedScreenshots],excludedFields:[...Y.excludedFields],activeFields:Y.activeFields,status:Y.currentStatus,subStatus:Y.currentSubStatus,formData:y,activeTasks:L,summaryTags:J,clientName:w,cid:H,timestamp:new Date().toISOString()}}let B=u=>new Promise(y=>setTimeout(y,u));async function W(u){Y.setLanguage(u.currentLang||"pt"),Y.setCaseType(u.currentCaseType||"bau"),Y.setPortugalCase(u.isPortugalCase||!1),Y.setConsent(u.consent||!1),Y.setExcludedFields(u.excludedFields||[]),u.activeFields&&Y.setActiveFields(u.activeFields);let y=o.querySelector(`#lang-selector button[data-lang="${Y.currentLang}"]`);y&&y.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(L=>{L!==y&&L.classList.remove("active")});let w=o.querySelector(`#type-selector button[data-type="${Y.currentCaseType}"]`);w&&w.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(L=>{L!==w&&L.classList.remove("active")});let H=o.querySelector(`#portugal-selector button[data-val="${Y.isPortugalCase}"]`);if(H&&H.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(L=>{L!==H&&L.classList.remove("active")}),u.status){let L=o.querySelector("#main-status-select");L.value=u.status,Y.setStatus(u.status);let J=o.querySelector("#sub-status-select");if(U(u.status,J),await B(50),u.subStatus){if(J.value=u.subStatus,Y.setSubStatus(u.subStatus),_(u.subStatus),await B(100),u.tagSupportUsed!==void 0){Y.setTagSupportUsed(u.tagSupportUsed);let R=s.element.querySelector('input[value="Sim"]'),ee=s.element.querySelector('input[value="N\xE3o"]');u.tagSupportUsed&&R?R.checked=!0:ee&&(ee.checked=!0),s.element.querySelector("div:last-child").style.display=u.tagSupportUsed?"none":"block"}u.forcedScreenshots&&Y.setForcedScreenshots(u.forcedScreenshots);for(let R in u.formData){let ee=document.getElementById(R);ee&&(ee.value=u.formData[R],Y.updateField(R,ee.value))}u.activeTasks&&(u.activeTasks.forEach(R=>r.setTaskCount(R.key,R.count)),Y.setActiveTasks(r.getCheckedElements()))}}Y.isDirty=!1}function h(u){return Se[Y.currentLang]?.[u]||Se.pt?.[u]||u}function V(){let u=document.createElement("div");return u.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',u.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",u.onclick=y=>{y.stopPropagation(),M()},u.title="Alternar para Split & Transfer",u}function S(){let u=document.createElement("div");return u.id="notes-empty-state",u.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
...
E-mail: ${y.clientEmail||"---"}`;H&&(H.value=J),L&&(L.style.display="block",L.style.maxHeight="300px",L.style.opacity="1",L.scrollIntoView({behavior:"smooth",block:"end"}))})}function g(){r=!r,ue(r,l,"cw-btn-script"),r?(c(),d||(d=setInterval(c,2e3))):d&&(clearInterval(d),d=null)}let b=pe(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",p,()=>{g()});l.appendChild(b);let m=document.createElement("div");Object.assign(m.style,a.contextBanner),m.innerHTML=`
  ...
  `;let v=m.querySelector("#csa-toggle-options"),C=m.querySelector("#csa-options-content"),P=m.querySelector("#csa-options-arrow"),j=!1;v.onclick=()=>{j=!j,P.style.transform=j?"rotate(180deg)":"rotate(0deg)",C.style.maxHeight=j?"400px":"0",C.style.opacity=j?"1":"0",C.style.marginTop=j?"8px":"0",G.playClick()};let z=m.querySelector("#cw-pill-message"),Z=m.querySelector("#cw-am-copy-final"),K=m.querySelector("#cw-am-message-area");z.onmouseenter=()=>{z.style.borderColor="#007AFF",z.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},z.onmouseleave=()=>{z.style.borderColor="#DADCE0",z.style.boxShadow="0 1px 2px rgba(0,0,0,0.02)"},z.addEventListener("click",()=>{x()}),Z.addEventListener("click",()=>{K.value&&(navigator.clipboard.writeText(K.value),X("Mensagem copiada!"),G.playSuccess(),Z.style.background="#34A853",Z.textContent="Copiado!",setTimeout(()=>{Z.style.background="#1A73E8",Z.textContent="Copiar Mensagem Final"},2e3))});let M=(y,w)=>{let H=m.querySelector(y),L=m.querySelector(w);H.onclick=()=>{let J=L.textContent;!J||J.includes("---")||J.includes("N\xE3o encontrado")||(navigator.clipboard.writeText(J),G.playSuccess(),H.classList.add("copied"),setTimeout(()=>H.classList.remove("copied"),1500))}};l.appendChild(m);let F=document.createElement("div");Object.assign(F.style,a.progressBarContainer);let D=document.createElement("div");D.className="csa-progress-fill",Object.assign(D.style,a.progressBarFill),F.appendChild(D),l.appendChild(F);let U=document.createElement("div");U.id="csa-content",Object.assign(U.style,a.contentArea),l.appendChild(U);let _=document.createElement("div");Object.assign(_.style,a.footer);let k=document.createElement("span");k.textContent="by lucaste@",Object.assign(k.style,{fontSize:"10px",color:"#bdc1c6"});let E=document.createElement("button");E.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> Resetar Script',Object.assign(E.style,a.resetBtn),E.onmouseenter=()=>E.style.background="#fce8e6",E.onmouseleave=()=>E.style.background="transparent",E.onclick=()=>{E.style.transform="scale(0.9)",setTimeout(()=>E.style.transform="scale(1)",150);for(let y in n)delete n[y];S()},_.appendChild(k),_.appendChild(E),l.appendChild(_);let O=document.createElement("div");Object.assign(O.style,{display:"flex",flexDirection:"column",gap:"8px",marginBottom:"16px"});let f=document.createElement("div");f.className="csa-segmented-control",f.innerHTML=`
  ...
  `,m.onfocus=()=>{g.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",g.style.border="1px solid #1a73e8"},m.onblur=()=>{g.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",g.style.border="1px solid transparent"},g.appendChild(b),g.appendChild(m),x.appendChild(g),c.appendChild(x);let v=document.createElement("div");v.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",c.appendChild(v);let C=null;function P(){if(C)return;C=document.createElement("div"),C.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let k=document.createElement("div");k.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",k.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let E=document.createElement("button");E.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',E.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",E.onclick=()=>{z(),n=!1,F()},k.appendChild(E),C.appendChild(k);let O=document.createElement("div");O.id="cw-history-list",O.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",C.appendChild(O),c.appendChild(C)}function j(){C||P();let k=C.querySelector("#cw-history-list");k.innerHTML="";let E=oa();E.length===0?k.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':E.forEach(O=>{let f=U(O,Be[O._originalCat],!0,O._originalCat);k.appendChild(f)}),requestAnimationFrame(()=>C.style.transform="translateY(0)")}function z(){C&&(C.style.transform="translateY(100%)")}function Z(){d.innerHTML="";let k=K("history","Recentes",Be.history);k.id="cw-sidebar-btn-history",k.onclick=()=>{G.playClick(),n=!n,n?j():z(),F()},d.appendChild(k);let E=document.createElement("div");E.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(E),Object.keys(Ze).forEach(O=>{let f=Ze[O],A=K(O,f.label,Be[O]);A.id=`cw-sidebar-btn-${O}`,A.onclick=()=>{G.playClick(),n&&(n=!1,z()),M(O)},d.appendChild(A)})}function K(k,E,O){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=E,f.dataset.key=k;let A=document.createElement("div");A.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",A.innerHTML=O||Be.tasks;let I=document.createElement("div");return I.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",I.textContent=E,f.appendChild(A),f.appendChild(I),f.onmouseenter=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="#F1F3F4",A.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="transparent",A.style.transform="scale(1)")},f}function M(k){let E=document.getElementById(`cat-anchor-${k}`);E&&(E.scrollIntoView({behavior:"smooth",block:"start"}),a=k,F())}function F(){Object.keys(Ze).forEach(E=>{let O=d.querySelector(`#cw-sidebar-btn-${E}`);if(O)if(a===E&&!n){let f=xt[E];O.style.background=f.bg,O.style.color=f.color,O.querySelector("div:first-child").style.transform="scale(1.1)"}else O.style.background="transparent",O.style.color=i.textSecondary,O.querySelector("div:first-child").style.transform="scale(1)"});let k=d.querySelector("#cw-sidebar-btn-history");k&&(n?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=i.textSecondary))}function D(){if(v.innerHTML="",e.trim()!==""){let E=[];if(Object.entries(Ze).forEach(([f,A])=>{let I=A.links.filter(q=>q.name.toLowerCase().includes(e.toLowerCase())||q.desc.toLowerCase().includes(e.toLowerCase()));E.push(...I.map(q=>({...q,_cat:f})))}),E.length===0){v.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let O=document.createElement("div");O.innerHTML="Resultados da busca",O.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",v.appendChild(O),E.forEach(f=>{let A=U(f,Be[f._cat],!1,f._cat);v.appendChild(A)});return}Object.entries(Ze).forEach(([E,O])=>{let f=xt[E],A=document.createElement("div"),I=document.createElement("div");I.id=`cat-anchor-${E}`,I.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,I.innerHTML=`
            ...
            ${O.label}
          `,A.appendChild(I);let q=document.createElement("div");q.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",O.links.forEach(N=>{let B=U(N,Be[E],!1,E);q.appendChild(B)}),A.appendChild(q),v.appendChild(A)});let k=document.createElement("div");k.style.height="80px",v.appendChild(k)}function U(k,E,O,f){let A=document.createElement("div"),I=xt[f]||xt.history;A.style.cssText=`
      ...
      `,b.querySelectorAll('input[name="cw-bc-type"]').forEach(q=>{q.addEventListener("change",()=>{b.querySelectorAll(".cw-radio-option").forEach(N=>N.classList.remove("checked")),q.parentElement.classList.add("checked")})}),setTimeout(()=>{let q=b.querySelector(".cw-radio-option.info");q&&q.classList.add("checked")},100);let f=b.querySelector("#cw-bc-cancel"),A=b.querySelector("#cw-bc-close-x"),I=b.querySelector("#cw-bc-send");f.onclick=j,A.onclick=j,I.onclick=z,p.appendChild(b)}function P(f=null){if(!b)return;let A=b.querySelector("#cw-editor-title-label"),I=b.querySelector("#cw-bc-title"),q=b.querySelector("#cw-bc-text"),N=b.querySelector("#cw-bc-send");if(f){a=f.id,A.textContent="Editar Aviso",I.value=f.title||"",q.value=f.text||"",N.textContent="Salvar Altera\xE7\xF5es";let B=f.type||"info",W=b.querySelector(`input[name="cw-bc-type"][value="${B}"]`);W&&W.click()}else{a=null,A.textContent="Novo Aviso",I.value="",q.value="",N.textContent="Publicar";let B=b.querySelector('input[name="cw-bc-type"][value="info"]');B&&B.click()}b.classList.add("active"),setTimeout(()=>I.focus(),300)}function j(){b&&b.classList.remove("active"),a=null}async function z(){let f=b.querySelector("#cw-bc-send"),A=b.querySelector("#cw-bc-title"),I=b.querySelector("#cw-bc-text"),q=b.querySelector('input[name="cw-bc-type"]:checked'),N=q?q.value:"info";if(!A.value.trim()||!I.value.trim()){X("Preencha todos os campos!",{error:!0});return}f.textContent="Salvando...",f.style.opacity="0.7";let B=!1;a?B=await ce.updateBroadcast(a,{title:A.value,text:I.value,type:N}):B=await ce.sendBroadcast({title:A.value,text:I.value,type:N,author:window._cwCurrentUser||"admin"}),B?(X(a?"Atualizado!":"Publicado!"),G.playSuccess(),j(),setTimeout(()=>M(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),f.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",f.style.opacity="1")}async function Z(f){if(await fe("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await ce.deleteBroadcast(f)){X("Aviso removido."),G.playClick();let q=qe.findIndex(N=>N.id===f);q>-1&&qe.splice(q,1),D(),setTimeout(()=>M(),1500)}else X("Erro ao excluir.",{error:!0})}let K=document.createElement("div");K.className="cw-nice-scroll",Object.assign(K.style,i.feedContainer),p.appendChild(K);async function M(){e&&(v.style.display="block",v.innerHTML="\u{1F504} Sincronizando...");try{let f=await ce.fetchData();f&&f.broadcast&&(Lt(f.broadcast),F(),e&&(D(),v.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{v.style.display="none"},1500)))}catch{e&&(v.innerHTML="\u26A0\uFE0F Offline")}}function F(){let f=document.getElementById("cw-btn-broadcast");if(!f)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(qe.some(q=>!A.includes(q.id))){if(f.classList.add("has-new"),!f.querySelector(".cw-badge")){let q=document.createElement("div");q.className="cw-badge",Object.assign(q.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),f.appendChild(q)}}else{f.classList.remove("has-new");let q=f.querySelector(".cw-badge");q&&q.remove()}}function D(){K.innerHTML="";let f=p.querySelector("#cw-bau-widget");f&&f.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),I=[...qe].sort((h,V)=>{let S=new Date(h.date).getTime()||0;return(new Date(V.date).getTime()||0)-S}),q=I.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(q!==-1){let h=I[q];I.splice(q,1);let V=document.createElement("div");V.id="cw-bau-widget",Object.assign(V.style,i.bauContainer);let S=[],T=(h.text||"").split(`
`),u=/\d{1,2}\/\d{1,2}/,y="\u{1F4C5}";if(T.forEach(R=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(R)?y="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(R)&&(y="\u{1F1EA}\u{1F1F8}");let ee=R.match(u);if(ee){let oe=ee[0],Q=y;/🇧🇷|🇵🇹|PT|BR/i.test(R)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(R)&&(Q="\u{1F1EA}\u{1F1F8}"),S.some(te=>te.flag===Q&&te.date===oe)||S.push({flag:Q,date:oe})}}),S.length===0){let R=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);R&&[...new Set(R)].forEach(ee=>S.push({flag:"\u{1F4C5}",date:ee}))}let w="",H='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(H=`
          ...
          `,v.after(V);let L=V.querySelector("#cw-bau-toggle-btn"),J=V.querySelector("#cw-bau-full");if(L&&J&&(L.onclick=()=>{let R=J.style.display==="none";J.style.display=R?"block":"none",L.textContent=R?"Ocultar":"Detalhes"}),window._cwIsAdmin){let R=V.querySelector(".cw-bau-edit");R&&(R.onclick=()=>P(h))}}let N=I.sort((h,V)=>{let S=A.includes(h.id),T=A.includes(V.id);return S===T?0:S?1:-1});if(N.length===0&&!q){let h=document.createElement("div");Object.assign(h.style,i.emptyState),h.innerHTML=`
           ...
           `,K.appendChild(h)}let B=N.filter(h=>!A.includes(h.id)),W=N.filter(h=>A.includes(h.id));if(B.forEach(h=>K.appendChild(U(h,!1))),W.length>0){let h=document.createElement("div");Object.assign(h.style,i.historyDivider),h.innerHTML=`<span>Hist\xF3rico (${W.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let V=document.createElement("div");Object.assign(V.style,i.historyContainer),W.forEach(T=>V.appendChild(U(T,!0)));let S=!1;h.onclick=()=>{G.playClick(),S=!S,V.style.display=S?"flex":"none",h.querySelector("svg").style.transform=S?"rotate(180deg)":"rotate(0deg)"},K.appendChild(h),K.appendChild(V)}}function U(f,A){let I=document.createElement("div");Object.assign(I.style,A?i.cardHistory:i.card);let q=s[f.type]||s.info,N=document.createElement("div");Object.assign(N.style,i.cardHeader);let B=document.createElement("div");Object.assign(B.style,i.typeTag,{color:q.color,background:q.bg}),B.innerHTML=`${q.icon} <span>${f.type}</span>`;let W=document.createElement("span");if(Object.assign(W.style,i.dateTag),W.textContent=n(f.date),N.appendChild(B),A)N.appendChild(W);else{let u=document.createElement("button");u.className="cw-btn-interactive",Object.assign(u.style,i.dismissBtn),u.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',u.onmouseenter=()=>{u.style.color="#1e8e3e",u.style.background="#e6f4ea",u.style.borderColor="#1e8e3e"},u.onmouseleave=()=>{u.style.color="#5f6368",u.style.background="#fff",u.style.borderColor="rgba(0,0,0,0.1)"},u.onclick=y=>{y.stopPropagation(),G.playClick(),I.style.transform="translateX(20px)",I.style.opacity="0",setTimeout(()=>{let w=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");w.push(f.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(w)),D(),F()},200)},N.appendChild(u)}let h=document.createElement("div");Object.assign(h.style,i.cardContent);let V=document.createElement("div");Object.assign(V.style,i.msgTitle),V.textContent=f.title;let S=document.createElement("div");Object.assign(S.style,i.msgBody),S.innerHTML=l(f.text);let T=document.createElement("div");if(Object.assign(T.style,i.msgMeta),T.innerHTML=`Publicado por <b>${f.author||"Sistema"}</b>`,A||(T.innerHTML+=` \u2022 ${n(f.date)}`),h.appendChild(V),h.appendChild(S),h.appendChild(T),I.appendChild(N),I.appendChild(h),window._cwIsAdmin){let u=document.createElement("div");u.className="cw-card-actions";let y=document.createElement("button");y.className="cw-action-btn edit",y.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',y.onclick=()=>P(f);let w=document.createElement("button");w.className="cw-action-btn delete",w.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',w.onclick=()=>Z(f.id),u.appendChild(y),u.appendChild(w),I.appendChild(u)}return I}let _=ce.getCachedBroadcasts();_.length>0&&(Lt(_),D()),setTimeout(m,500),M(),o||(o=setInterval(M,aa));let k=document.createElement("div");Object.assign(k.style,Ee),k.className="no-drag",p.appendChild(k),Ae(p,k),document.body.appendChild(p);let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=qe.some(f=>!E.includes(f.id));return{toggle:c,hasUnread:O}}function Co(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let l=document.createElement("div");Object.assign(l.style,o.dotsContainer);let p=document.createElement("div");Object.assign(p.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let c=document.createElement("button");c.textContent="Pr\xF3ximo",Object.assign(c.style,o.btn,o.btnNext),c.onmouseover=()=>c.style.transform="scale(1.05)",c.onmouseout=()=>c.style.transform="scale(1)",p.appendChild(d),p.appendChild(c),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(l),n.appendChild(p),a.appendChild(n),document.body.appendChild(a);function x(b){let m=t[b];i.textContent=m.icon,s.textContent=m.title,r.textContent=m.text,l.innerHTML="",t.forEach((v,C)=>{let P=document.createElement("div");Object.assign(P.style,o.dot),C===b&&Object.assign(P.style,o.dotActive),l.appendChild(P)}),m.isLast?(d.style.display="none",c.textContent="Come\xE7ar \u{1F680}",c.style.width="100%"):(d.style.display="block",c.textContent="Pr\xF3ximo",c.style.width="auto")}function g(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),G.playSuccess(),X("Tudo pronto! Use o menu flutuante.")}c.onclick=()=>{G.playClick(),e<t.length-1?(e++,x(e)):g()},d.onclick=async()=>{await fe("Pular o tutorial?")&&g()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var Eo={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function Ao(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&na(t)}function na(t){let e=Eo.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let l=document.createElement("div");Object.assign(l.style,a.title);let p=document.createElement("div");Object.assign(p.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let c=document.createElement("button");Object.assign(c.style,a.btn),c.onmouseover=()=>c.style.transform="scale(1.02)",c.onmouseout=()=>c.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(l),i.appendChild(p),i.appendChild(d),i.appendChild(c),n.appendChild(i),document.body.appendChild(n);function x(b){let m=e[b];r.textContent=m.icon,l.textContent=m.title,p.textContent=m.text,d.innerHTML="",e.forEach((v,C)=>{let P=document.createElement("div");Object.assign(P.style,a.dot),C===b&&Object.assign(P.style,a.dotActive),d.appendChild(P)}),b===e.length-1?c.textContent="Entendi, vamos l\xE1! \u{1F44D}":c.textContent="Pr\xF3ximo"}function g(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),G.playSuccess(),X(`TechSol atualizado para ${t}!`)}c.onclick=()=>{G.playClick(),o<e.length-1?(o++,x(o)):g()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var To="cw_timezone_pinned",It=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],ia=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function ko(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(To)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},p={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=pe(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>A());d.appendChild(x);let g=document.createElement("div");Object.assign(g.style,p.container),d.appendChild(g);let b=document.createElement("div");Object.assign(b.style,p.tabHeader);let m=document.createElement("div");m.textContent="Monitoramento",Object.assign(m.style,p.tabBtn,p.tabActive);let v=document.createElement("div");v.textContent="Planejador",Object.assign(v.style,p.tabBtn),b.appendChild(m),b.appendChild(v),g.appendChild(b);let C=document.createElement("div");Object.assign(C.style,p.toolbar);let P=document.createElement("div");Object.assign(P.style,p.searchInputWrapper);let j=document.createElement("div");j.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(j.style,p.searchIcon);let z=document.createElement("input");z.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(z.style,p.searchInput),z.onfocus=()=>{z.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",z.style.borderColor="rgba(26,115,232,0.3)"},z.onblur=()=>{z.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",z.style.borderColor="transparent"},z.oninput=I=>{i=I.target.value.toLowerCase(),k()},P.appendChild(j),P.appendChild(z),C.appendChild(P);let Z=document.createElement("div");Object.assign(Z.style,p.chipsRow),ia.forEach(I=>{let q=document.createElement("div");q.textContent=I.label,q.id=`tz-filter-${I.id}`,Object.assign(q.style,p.chip),I.id===s&&Object.assign(q.style,p.chipActive),q.onclick=()=>{G.playClick(),s=I.id,Array.from(Z.children).forEach(N=>{Object.assign(N.style,p.chip)}),Object.assign(q.style,p.chipActive),k()},Z.appendChild(q)}),C.appendChild(Z),g.appendChild(C);let K=document.createElement("div");Object.assign(K.style,p.listContainer);let M=document.createElement("style");M.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",g.appendChild(M);let F=document.createElement("div");Object.assign(F.style,p.plannerWrapper,{display:"none"}),g.appendChild(K),g.appendChild(F),m.onclick=()=>D("live"),v.onclick=()=>D("plan");function D(I){G.playClick(),I==="live"?(Object.assign(m.style,p.tabActive),Object.assign(v.style,p.tabBtn),v.style.borderBottomColor="transparent",K.style.display="flex",C.style.display="flex",F.style.display="none",O()):(Object.assign(v.style,p.tabActive),Object.assign(m.style,p.tabBtn),m.style.borderBottomColor="transparent",F.style.display="flex",K.style.display="none",C.style.display="none",f(),E())}function U(I){return I>=9&&I<17?{color:l.success,bg:l.successBg,label:"Aberto",icon:"\u{1F7E2}"}:I>=8&&I<9?{color:l.warning,bg:l.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:I>=17&&I<19?{color:l.warning,bg:l.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function _(I){n.includes(I)?n=n.filter(q=>q!==I):n.push(I),localStorage.setItem(To,JSON.stringify(n)),k(),G.playClick()}function k(){K.innerHTML="";let I=new Date,q=It.filter(B=>{let W=B.name.toLowerCase().includes(i)||B.label.toLowerCase().includes(i),h=s==="all"||B.region===s;return W&&h});if(q.sort((B,W)=>{let h=n.includes(B.id),V=n.includes(W.id);return h&&!V?-1:!h&&V?1:B.name.localeCompare(W.name)}),q.length===0){K.innerHTML=`
            ...
            `,u.onmouseenter=()=>{u.style.transform="translateY(-2px)",u.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},u.onmouseleave=()=>{u.style.transform="translateY(0)",u.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let H=u.querySelector(".cw-pin-btn");H.onmouseenter=()=>{H.style.backgroundColor="#F1F3F4"},H.onmouseleave=()=>{H.style.backgroundColor="transparent"},H.onclick=L=>{L.stopPropagation(),_(B.id)},u.onclick=()=>{a=B.id,D("plan")},K.appendChild(u)});let N=document.createElement("div");N.style.height="20px",N.style.width="100%",K.appendChild(N)}function E(){F.innerHTML="";let I=document.createElement("div"),q=document.createElement("label");q.textContent="Onde est\xE1 o cliente?",q.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let N=document.createElement("select");Object.assign(N.style,Pt),N.style.padding="14px",[...It].sort((ne,te)=>ne.name.localeCompare(te.name)).forEach(ne=>{let te=document.createElement("option");te.value=ne.id,te.textContent=`${ne.flag} ${ne.name} (${ne.zone})`,ne.id===a&&(te.selected=!0),N.appendChild(te)}),N.onchange=ne=>{a=ne.target.value,Q(),G.playClick()},I.appendChild(q),I.appendChild(N),F.appendChild(I);let W=document.createElement("div");Object.assign(W.style,p.timeComparisonRow);let h=document.createElement("div");Object.assign(h.style,p.timeCard),h.style.backgroundColor="#F8FAFF",h.style.borderColor="#E8F0FE",h.innerHTML=`
        ...
        `,W.appendChild(h),W.appendChild(V),F.appendChild(W);let S=document.createElement("div");S.id="cw-planner-status",Object.assign(S.style,p.statusBadge),F.appendChild(S);let T=document.createElement("div");Object.assign(T.style,{padding:"0 4px",marginTop:"12px"});let u=document.createElement("div");u.textContent="Arraste para simular o hor\xE1rio:",u.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let y=document.createElement("div");Object.assign(y.style,p.timelineContainer);let w=document.createElement("div");Object.assign(w.style,p.timelineTrack);let H=document.createElement("div");Object.assign(H.style,p.dayZone),w.appendChild(H);let L=document.createElement("input");L.type="range",L.min="0",L.max="1439",L.step="15",L.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let J=document.createElement("div");J.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",J.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",y.appendChild(w),y.appendChild(L),y.appendChild(J),T.appendChild(u),T.appendChild(y),F.appendChild(T);let R=h.querySelector("#cw-time-input-br"),ee=V.querySelector("#cw-time-display-client"),oe=V.querySelector("#cw-client-label");function Q(){let ne=It.find(Me=>Me.id===a);oe.textContent=`${ne.flag} ${ne.label} (${ne.zone})`;let te=r.getHours(),re=r.getMinutes(),Ve=`${String(te).padStart(2,"0")}:${String(re).padStart(2,"0")}`;R.value=Ve,L.value=te*60+re;let Qe=r.toLocaleTimeString("pt-BR",{timeZone:ne.zone,hour:"2-digit",minute:"2-digit"});ee.textContent=Qe;let Ie=parseInt(Qe.split(":")[0]);Ie>=9&&Ie<17?(S.style.background=l.successBg,S.style.color=l.success,S.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):Ie>=8&&Ie<9||Ie>=17&&Ie<19?(S.style.background=l.warningBg,S.style.color=l.warning,S.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(S.style.background=l.errorBg,S.style.color=l.error,S.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}L.oninput=ne=>{let te=parseInt(ne.target.value);r.setHours(Math.floor(te/60)),r.setMinutes(te%60),Q()},R.oninput=ne=>{let[te,re]=ne.target.value.split(":");te&&re&&(r.setHours(parseInt(te)),r.setMinutes(parseInt(re)),Q())},Q()}function O(){k(),o||(o=setInterval(k,6e4))}function f(){o&&(clearInterval(o),o=null)}function A(){e=!e,ue(e,d,"cw-btn-timezone"),e?D("live"):f()}return document.body.appendChild(d),A}function Fo(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let E=document.createElement("style");E.id="cw-lib-styles",E.innerHTML=`
        ...
        `,document.head.appendChild(E)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},s={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let p=pe(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>k());r.appendChild(p);let d=document.createElement("div");Object.assign(d.style,s.container),r.appendChild(d);let c=document.createElement("div");Object.assign(c.style,s.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(E=>{let O=document.createElement("div");O.innerHTML=`${E.icon} ${E.label}`,O.id=`lib-tab-${E.id}`,Object.assign(O.style,s.tabBtn),E.id===o&&Object.assign(O.style,s.tabActive),O.onmouseenter=()=>G.playHover(),O.onclick=()=>Z(E.id),c.appendChild(O)}),d.appendChild(c);let g=document.createElement("div");Object.assign(g.style,s.listContainer),d.appendChild(g);let b=document.createElement("div");b.className="cw-fab cw-tactile",Object.assign(b.style,s.fab),b.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',b.onmouseenter=()=>b.style.transform="scale(1.1)",b.onmouseleave=()=>b.style.transform="scale(1)",b.onclick=()=>M(),d.appendChild(b),a=document.createElement("div"),Object.assign(a.style,s.editorOverlay);let m=document.createElement("div");Object.assign(m.style,s.editorHeader),m.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let v=document.createElement("button");v.innerHTML="Cancelar",v.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",v.onclick=F,m.appendChild(v),a.appendChild(m);let C=document.createElement("div");Object.assign(C.style,s.editorBody),a.appendChild(C);let P=document.createElement("div");P.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let j=document.createElement("button");j.textContent="Salvar",j.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",j.onclick=D,P.appendChild(j),a.appendChild(P),d.appendChild(a);let z=document.createElement("div");Object.assign(z.style,Ee),z.className="no-drag",r.appendChild(z),Ae(r,z),document.body.appendChild(r);function Z(E){G.playClick(),o=E,x.forEach(O=>{let f=document.getElementById(`lib-tab-${O.id}`);O.id===E?Object.assign(f.style,s.tabActive):Object.assign(f.style,s.tabBtn)}),K()}function K(){g.innerHTML="";let E=xe.getSnippets(o);if(E.length===0){g.innerHTML=`
            ...
            `;return}E.forEach(O=>{let f=document.createElement("div");f.className="cw-lib-card",Object.assign(f.style,s.card),O.isCode&&(f.style.borderLeft=`4px solid ${i.primary}`,f.style.background="rgba(0, 122, 255, 0.02)");let A=O.content;if(O.isRich){let I=document.createElement("div");I.innerHTML=O.content;let q=I.querySelector("img");A=I.innerText.substring(0,150)+(I.innerText.length>150?"...":""),q&&(A="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+A)}f.innerHTML=`
                ...
                <div style="${_(s.cardPreview)}; ${O.isCode?"font-family:'Roboto Mono', monospace; font-size:11px;":""}">${A}</div>
            ...
            `,f.onmouseenter=()=>{G.playHover()},f.querySelector(".cw-act-copy").onclick=I=>{if(I.stopPropagation(),G.playClick(),O.isRich){let q=new Blob([O.content],{type:"text/html"}),N=document.createElement("div");N.style.whiteSpace="pre-wrap",N.innerHTML=O.content;let B=new Blob([N.innerText],{type:"text/plain"}),W=[new ClipboardItem({"text/html":q,"text/plain":B})];navigator.clipboard.write(W)}else navigator.clipboard.writeText(O.content);X("Copiado!")},f.querySelector(".cw-act-edit").onclick=I=>{I.stopPropagation(),G.playClick(),M(O)},f.querySelector(".cw-act-del").onclick=async I=>{I.stopPropagation(),G.playClick(),await fe("Excluir este item?")&&(xe.delete(O.id),K(),X("Item exclu\xEDdo."))},g.appendChild(f)})}function M(E=null){n=E?E.id:null,C.innerHTML="",C.appendChild(U("title","T\xEDtulo / Nome",E?E.title:"")),o==="email"&&C.appendChild(U("subject","Assunto do Email",E?E.subject:""));let O="Conte\xFAdo";o==="email"&&(O="Corpo do Email (HTML)"),o==="note"&&(O="Texto da Nota (Reason)"),C.appendChild(U("content",O,E?E.content:"",{isRich:!0,isCode:E?E.isCode:!1})),m.querySelector("span").textContent=E?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let f=C.querySelector("input");f&&f.focus()},300)}function F(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function D(){let E=C.querySelector("#cw-inp-title"),O=C.querySelector("#cw-inp-content"),f=E.value.trim(),A=O.contentEditable==="true"?O.innerHTML:O.value.trim(),I=O.getAttribute("data-is-code")==="true";if(!f||!A||A==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let q={id:n,type:o,title:f,content:A,isCode:I,isRich:O.contentEditable==="true"};if(o==="email"){let N=C.querySelector("#cw-inp-subject").value.trim();if(!N){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}q.subject=N}j.textContent="Salvando...",await xe.save(q),j.textContent="Salvar",F(),K(),X("Salvo com sucesso!"),G.playSuccess()}function U(E,O,f,A={}){let I=document.createElement("div");Object.assign(I.style,s.inputGroup);let q=document.createElement("label");q.textContent=O,Object.assign(q.style,s.label);let N;if(A.isRich){let B=document.createElement("div");B.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",B.innerHTML=`
  ...
  `,document.head.appendChild(t)};var _e={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>'};function qo(){Io();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=pe(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>V());i.appendChild(s);let r=document.createElement("div");r.className="bau-view-container",i.appendChild(r);let l=document.createElement("div");l.id="bau-view-dashboard",l.className="bau-view active",l.innerHTML=`
    ...
    `,P.querySelectorAll(".bau-task-item").forEach(S=>{let T=S.querySelector("input");S.addEventListener("click",()=>{T.checked=!T.checked,S.classList.toggle("active",T.checked),G.playClick()})}),C.appendChild(P),g.appendChild(C);let z=document.createElement("div");z.className="bau-step",z.id="bau-step-3";let Z=document.createElement("div");Z.className="bau-card",Z.innerHTML=`
    ...
    `,z.appendChild(Z),g.appendChild(z);let K=document.createElement("div");K.className="bau-step",K.id="bau-step-4",K.innerHTML=`
        <div class="bau-card">
            <h3 class="bau-step-title">Confirme os dados antes de enviar</h3>
            <div id="bau-confirmation-details"></div>
        </div>
    `,g.appendChild(K);let M=document.createElement("div");M.className="bau-footer";let F=document.createElement("button");F.type="button",F.id="bau-step-back-btn",F.className="bau-btn-secondary",F.textContent="Voltar";let D=document.createElement("button");D.type="button",D.id="bau-step-next-btn",D.className="bau-btn-primary",D.textContent="Pr\xF3ximo";let U=document.createElement("button");U.type="submit",U.className="bau-btn-submit",U.innerHTML=`${_e.send} Enviar para o TL`,U.style.display="none",g.appendChild(F),g.appendChild(D),g.appendChild(U),g.appendChild(M),r.appendChild(p);let _=document.createElement("div");_.id="bau-view-success",_.className="bau-view",_.innerHTML=`
    ...
    `,r.appendChild(_),document.body.appendChild(i);function k(S){e=S,i.querySelectorAll(".bau-view").forEach(w=>w.classList.remove("active"));let T=i.querySelector(`#bau-view-${S}`);T&&T.classList.add("active");let u=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),y=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");u&&(u.textContent=S==="form"?"Novo Caso BAU":"BAU Central"),y&&(y.textContent=S==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function E(){let S=i.querySelector("#bau-case-list-container");if(S){S.innerHTML="<p>Carregando casos...</p>";try{let T=await ao();O(T)}catch{S.innerHTML='<p class="bau-error-text">Erro ao carregar casos.</p>'}}}function O(S){let T=i.querySelector("#bau-case-list-container"),u=i.querySelector("#bau-dashboard-metrics");if(!T)return;let y=L=>{switch(L){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray"};default:return{text:L||"Pendente",class:"status-gray"}}};if(!S||S.length===0){u&&(u.innerHTML=""),T.innerHTML=`
            ...
            `;return}let w=S.filter(L=>L.status==="PENDING_TL_CREATION").length,H=S.filter(L=>L.status==="CREATED").length;u&&(u.innerHTML=`
            ...
            `),T.innerHTML=S.map(L=>{let J=y(L.status),R=L.date?new Date(L.date).toLocaleDateString("pt-BR"):"";return`
                    ...
                    <div class="bau-case-main">
                        ...
                        <div class="bau-case-info">
                            <div class="bau-case-header">
                                ...
                                <span class="bau-case-date">${R}</span>
                            </div>
                            <p class="bau-case-details">CID: ${L.cid||"N/A"} \u2022 Motivo: ${L.reason||"N/A"}</p>
                        </div>
                    </div>
                    <span class="bau-case-status-badge ${J.class}">${J.text}</span>
                </li>
            `}).join("")}function f(){g.querySelectorAll(".bau-step").forEach((S,T)=>{S.classList.toggle("active",T+1===a)}),x.innerHTML="";for(let S=1;S<=n;S++){let T=document.createElement("div");T.className=`bau-progress-step ${S===a?"active":S<a?"completed":""}`,T.textContent=S,x.appendChild(T)}F.style.display=a>1?"inline-block":"none",D.style.display=a<n?"inline-block":"none",U.style.display=a===n?"inline-block":"none",a===4&&q()}function A(S){let T=i.querySelector(`#bau-step-${S}`);if(!T)return!0;if(S===2)return g.querySelector('textarea[name="reason"]').value.trim()?g.querySelector('input[name="taskType"]:checked')?!0:(X("Erro: Selecione pelo menos uma Task.",{error:!0}),!1):(X("Erro: A descri\xE7\xE3o do que deve ser feito \xE9 obrigat\xF3ria.",{error:!0}),!1);for(let u of T.querySelectorAll("[required]"))if(!u.value.trim())return X(`Erro: O campo '${u.name||u.placeholder}' \xE9 obrigat\xF3rio.`,{error:!0}),!1;return!0}D.onclick=()=>{A(a)&&(a++,f(),G.playClick())},F.onclick=()=>{a>1&&(a--,f(),G.playClick())};async function I(){let S=await we()||{};o=S,g.querySelector('[name="advName"]').value=S.advName||"",g.querySelector('[name="cid"]').value=S.cid||"",g.querySelector('[name="amName"]').value=S.amName||"",g.querySelector('[name="seId"]').value=S.seId||"";let T=i.querySelector("#bau-all-data");if(T){let u=[{label:"Site",value:S.site},{label:"Email",value:S.email},{label:"Timezone",value:S.timezone},{label:"Case ID",value:S.caseId},{label:"Programa",value:S.salesProgram},{label:"Idioma",value:S.language}];T.innerHTML=`
            ...
            `}}i.querySelector("#bau-top-se-search").onclick=S=>{S.preventDefault(),st("bau-context-se-id-input")};function q(){let S=new FormData(g),T=Object.fromEntries(S.entries()),u=S.getAll("taskType"),y=i.querySelector("#bau-confirmation-details");if(!y)return;let w=u.length>0?u.join(", "):"Nenhuma";y.innerHTML=`
