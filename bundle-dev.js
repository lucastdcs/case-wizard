...
.cw-dropdown-option.selected { 
    ...
    `,document.head.appendChild(e)}function K(t,e={}){let o=document.createElement("div");e.error&&(o.className="toast-error");let a=e.error?"rgba(217, 48, 37, 0.90)":"rgba(32, 33, 36, 0.85)";Object.assign(o.style,{position:"fixed",bottom:"32px",left:"50%",transform:"translateX(-50%) scale(0.9)",background:a,backdropFilter:"blur(12px)",color:"#fff",padding:"12px 24px",borderRadius:"50px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",fontWeight:"500",lineHeight:"20px",zIndex:"9999999",opacity:"0",transition:"all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",pointerEvents:"none"}),o.textContent=t,document.body.appendChild(o),e.error?j.playError():j.playSuccess(),requestAnimationFrame(()=>{o.style.opacity="1",o.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{o.style.opacity="0",o.style.transform="translateX(-50%) scale(0.9) translateY(10px)",setTimeout(()=>o.remove(),400)},e.duration||4e3)}function Gt(t,e=null){let o=0,a=0,n=0,i=0,s=e||t;s.style.cursor="grab",s.onmousedown=r;function r(p){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(p.target.tagName)||p.target.closest(".no-drag"))return;p=p||window.event,s.style.cursor="grabbing",t.style.transition="none";let m=t.getBoundingClientRect();t.style.transform="none",t.style.left=m.left+"px",t.style.top=m.top+"px",t.style.margin="0",t.style.bottom="auto",t.style.right="auto",Ht++,t.style.zIndex=Ht,n=p.clientX,i=p.clientY,t.setAttribute("data-dragging","true"),document.onmouseup=u,document.onmousemove=c}function c(p){p=p||window.event,p.preventDefault(),o=n-p.clientX,a=i-p.clientY,n=p.clientX,i=p.clientY;let m=t.offsetTop-a,h=t.offsetLeft-o,b=16,d=window.innerWidth,g=window.innerHeight,S=t.offsetWidth,A=t.offsetHeight;h<b?h=b:h+S>d-b&&(h=d-S-b),m<b?m=b:m+A>g-b&&(m=g-A-b),t.style.top=m+"px",t.style.left=h+"px"}function u(){document.onmouseup=null,document.onmousemove=null,s.style.cursor="grab",setTimeout(()=>{t.style.transition="all 0.5s cubic-bezier(0.19, 1, 0.22, 1), opacity 0.3s ease",t.setAttribute("data-dragging","false"),t.setAttribute("data-moved","true")},50)}}var me={position:"fixed",top:"50%",left:"50%",width:"400px",maxHeight:"85vh",zIndex:"99999",overflow:"hidden",backgroundColor:"rgba(255, 255, 255, 0.98)",backdropFilter:"blur(20px)",webkitBackdropFilter:"blur(20px)",borderRadius:"16px",boxShadow:`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(M)}let u=document.createElement("div");u.className="cw-zen-container";let p=document.createElement("div");Object.assign(p.style,{display:"none"});let m=document.createElement("div");m.className="cw-screens-container",p.appendChild(m),u.innerHTML=`
    ...
    `;let h=u.querySelector(".cw-hero-grid"),b=u.querySelector(".cw-acc-container"),d=u.querySelector(".cw-results-container"),g=u.querySelector(".cw-search-input"),S=u.querySelector(".cw-status-bar"),A=u.querySelector(".cw-status-text"),$=u.querySelector(".cw-footer-icons");s.forEach(([M,F])=>{let z=i(F.name),U=document.createElement("div");U.className="cw-hero-card",U.id=`hero-${M}`,U.style.setProperty("--hero-color",z.color),U.innerHTML=`
        ...
        `,U.onclick=I=>{if(I.target.closest(".cw-step-btn"))return;let T=a[M]?a[M].count:0;H(M,T>0?-T:1,F)},U.querySelector(".minus").onclick=()=>H(M,-1,F),U.querySelector(".plus").onclick=()=>H(M,1,F),U.dataset.color=z.color,h.appendChild(U)});function R(M,F){let z=i(F.name),U=document.createElement("div");return U.className="cw-task-item",U.dataset.id=M,U.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${z.bg}; color:${z.color}">
                    ${Be[z.icon]||Be.default}
                </div>
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,K("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let s=Date.now()-n,r=Math.max(0,2e3-s);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let c=o.querySelector(".cw-center-dots"),u=o.querySelector(".cw-center-text"),p=o.querySelector(".cw-center-success"),m=o.querySelector(".cw-abort-btn");c&&(c.style.display="none"),u&&(u.style.display="none"),m&&(m.style.display="none"),p&&p.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},r)}}function ro(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let u=document.createElement("div");u.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",u.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let p=document.createElement("button");p.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',p.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",p.onmouseenter=()=>p.style.background="#F1F3F4",p.onmouseleave=()=>p.style.background="transparent",p.onclick=()=>h(!1),u.appendChild(p);let m=document.createElement("div");m.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",c.appendChild(u),c.appendChild(m);function h(d){let g=c.style.transform==="translateY(0%)";(d!==void 0?d:!g)?(b(),c.style.transform="translateY(0%)"):c.style.transform="translateY(110%)"}function b(){let d=ge.getAll();if(m.innerHTML="",d.length===0){m.innerHTML=`
                ...
                </div>`;return}d.forEach(g=>{let S=document.createElement("div");S.style.cssText=`
...
`.replace(/\n/g,"<br>");Ze(M);let F=await mt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,M),ut(F),K("Nota gerada e inserida!")):K("Copiado! Abra uma nota para colar.")},e}var be=t=>new Promise(e=>setTimeout(e,t));function ve(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Te(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function gt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let p=a.getBoundingClientRect();i.x=p.left+p.width/2,i.y=p.top+p.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let p=e.getBoundingClientRect();s=p.left+p.width/2,r=p.top+p.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let c=i.x-s,u=i.y-r;t?(j.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof go=="function"&&go(e,o)):(j.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${c}px, ${u}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${u}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Lt=="function"&&Lt(e))}function go(t,e){Lt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Lt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function bo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Qt(t,Z),s=io(y),r=no(()=>{T(),Y.setActiveTasks(r.getCheckedElements())},y,Y),c=document.createElement("div");c.style.display="none";let u=ao((l,v)=>{C(l,v)});c.appendChild(u);let p=ro({onSaveCurrent:async()=>{let l=await D();return q(),l},onLoadDraft:l=>{W(l)},t:l=>y(l)}),m=F(),h=z(),b=document.createElement("div"),d=X(),g=O(p,y);o.appendChild(m),o.appendChild(h),o.appendChild(d),o.appendChild(c),o.appendChild(b),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let S=document.createElement("button");S.id="manual-task-toggle",S.textContent=y("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",S.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${P.primary}; background: ${P.surface}; color: ${P.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,S.onmouseenter=()=>{S.style.background=P.primaryBg},S.onmouseleave=()=>{S.style.background=P.surface},S.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",S.style.display="none"},o.appendChild(S),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(g);let A=document.createElement("div");A.style.display="none",A.style.flexGrow="1",A.style.minHeight="0",A.style.overflow="hidden";let $=po(()=>M());$.style.height="100%",A.appendChild($),e.insertBefore(A,i);let R=a.lastElementChild;R&&(R.insertBefore(p.historyBtnWrapper,R.firstChild),R.insertBefore(V(),R.firstChild)),e.appendChild(p.drawer);let H=null;Y.subscribe(l=>{x(l),J(),l.isDirty?(H&&clearTimeout(H),H=setTimeout(async()=>{let v=await D(!0);v.subStatus?ge.saveEmergency(v):ge.clearEmergency(),l.isDirty=!1},2e3)):H&&(clearTimeout(H),H=null)});function J(){let l=ge.getCount()>0,v=!!Y.currentSubStatus;dt(l||v)}function Z(){Y.visible=!Y.visible,ue(Y.visible,e,"cw-btn-notes")}function M(){Y.isSplitView=!Y.isSplitView,Y.isSplitView?(o.style.display="none",A.style.display="flex",A.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",A.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function F(){let l=document.createElement("div");if(l.innerHTML=`
        ...
        `;let v=l.querySelector("#main-status-select"),w=l.querySelector("#sub-status-select");return v.onchange=()=>{Y.setStatus(v.value),U(v.value,w),Y.setSubStatus(""),I("")},w.onchange=()=>{Y.setSubStatus(w.value),I(w.value)},l}function U(l,v){if(v.innerHTML=`<option value="">${y("select_substatus")}</option>`,!l){v.disabled=!0;return}for(let w in ke)if(ke[w].status===l){let _=document.createElement("option");_.value=w,_.textContent=ke[w].name,v.appendChild(_)}v.disabled=!1}function I(l){if(u.render&&u.render(l,Y.currentCaseType),!l){c.style.display="none",b.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",d.style.display="flex",d.style.opacity="1",g.style.display="none";return}d.style.opacity="0",setTimeout(()=>{Y.currentSubStatus&&(d.style.display="none")},400),g.style.display="grid";let v=ke[l];v&&v.templateFields&&Y.setActiveFields(v.templateFields),L(),kt(l,b,Y),b.style.display="block",c.style.display="block";let w=l.startsWith("SO_"),_=l==="NI_Awaiting_Validation",k=document.getElementById("manual-task-toggle");w||_?(r.selectionElement.style.display="block",k.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",k.style.display="block");let G=l==="SO_Education_Only"?"education":"implementation";Y.setScreenshotMode(G),Y.currentCaseType==="lm"?Y.toggleFieldExclusion("field-ON_CALL",!0):Y.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(l),T();let N=document.getElementById("email-automation-toggle-row");N&&(N.style.display=He[l]?"flex":"none")}function T(){let l=r.getCheckedElements().map(v=>v.value);s.updateVisibility(Y.currentSubStatus,l)}function C(l,v){let w=it[l];if(w){for(let _ in w)if(_==="linkedTask")r.toggleTask(w.linkedTask,v);else if(_==="activeTasks")w.activeTasks.forEach(k=>{v?r.setTaskCount(k.value,k.count):r.setTaskCount(k.value,0)});else if(_.startsWith("field-")){let k=_,G=w[_],N=document.getElementById(k);if(N){let Q=je.includes(k.replace("field-",""));if(v)if(Q){let oe=N.value.trim();oe.includes(G.trim())||(N.value=oe?oe+`
`+G.trim():G.trim())}else N.value=G;else if(Q){let oe=N.value.trim(),ee=G.trim();oe.includes(ee)&&(N.value=oe.replace(ee,"").trim().replace(/\n{3,}/g,`

`))}else N.value.trim()===G.trim()&&(N.value="");Y.updateField(k,N.value),N.dispatchEvent(new Event("input"))}}}}function O(l,v){let w=document.createElement("div");if(w.className="cw-actions-section",w.style.cssText=`
            display: grid;
...
CID: ${v.cid||"---"}
Case ID: ${v.caseId||"---"}
E-mail: ${v.clientEmail||"---"}`;_&&(_.value=G),k&&(k.style.display="block",k.style.maxHeight="300px",k.style.opacity="1",k.scrollIntoView({behavior:"smooth",block:"end"}))})}function b(){r=!r,ue(r,c,"cw-btn-script"),r?(m(),p||(p=setInterval(m,2e3))):p&&(clearInterval(p),p=null)}let d=pe(c,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",u,()=>{b()});c.appendChild(d);let g=document.createElement("div");Object.assign(g.style,a.contextBanner),g.innerHTML=`
  ...
  `,g.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},g.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(d),b.appendChild(g),h.appendChild(b),m.appendChild(h);let S=document.createElement("div");S.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",m.appendChild(S);let A=null;function $(){if(A)return;A=document.createElement("div"),A.style.cssText=`
      ...
      `;let T=document.createElement("div");T.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",T.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let C=document.createElement("button");C.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',C.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",C.onclick=()=>{H(),n=!1,F()},T.appendChild(C),A.appendChild(T);let O=document.createElement("div");O.id="cw-history-list",O.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",A.appendChild(O),m.appendChild(A)}function R(){A||$();let T=A.querySelector("#cw-history-list");T.innerHTML="";let C=na();C.length===0?T.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':C.forEach(O=>{let f=U(O,Pe[O._originalCat],!0,O._originalCat);T.appendChild(f)}),requestAnimationFrame(()=>A.style.transform="translateY(0)")}function H(){A&&(A.style.transform="translateY(100%)")}function J(){p.innerHTML="";let T=Z("history","Recentes",Pe.history);T.id="cw-sidebar-btn-history",T.onclick=()=>{j.playClick(),n=!n,n?R():H(),F()},p.appendChild(T);let C=document.createElement("div");C.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",p.appendChild(C),Object.keys(Qe).forEach(O=>{let f=Qe[O],E=Z(O,f.label,Pe[O]);E.id=`cw-sidebar-btn-${O}`,E.onclick=()=>{j.playClick(),n&&(n=!1,H()),M(O)},p.appendChild(E)})}function Z(T,C,O){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=C,f.dataset.key=T;let E=document.createElement("div");E.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",E.innerHTML=O||Pe.tasks;let L=document.createElement("div");return L.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",L.textContent=C,f.appendChild(E),f.appendChild(L),f.onmouseenter=()=>{a!==T&&!(T==="history"&&n)&&(f.style.background="#F1F3F4",E.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==T&&!(T==="history"&&n)&&(f.style.background="transparent",E.style.transform="scale(1)")},f}function M(T){let C=document.getElementById(`cat-anchor-${T}`);C&&(C.scrollIntoView({behavior:"smooth",block:"start"}),a=T,F())}function F(){Object.keys(Qe).forEach(C=>{let O=p.querySelector(`#cw-sidebar-btn-${C}`);if(O)if(a===C&&!n){let f=xt[C];O.style.background=f.bg,O.style.color=f.color,O.querySelector("div:first-child").style.transform="scale(1.1)"}else O.style.background="transparent",O.style.color=i.textSecondary,O.querySelector("div:first-child").style.transform="scale(1)"});let T=p.querySelector("#cw-sidebar-btn-history");T&&(n?(T.style.background="#3C4043",T.style.color="#FFFFFF"):(T.style.background="transparent",T.style.color=i.textSecondary))}function z(){if(S.innerHTML="",e.trim()!==""){let C=[];if(Object.entries(Qe).forEach(([f,E])=>{let L=E.links.filter(q=>q.name.toLowerCase().includes(e.toLowerCase())||q.desc.toLowerCase().includes(e.toLowerCase()));C.push(...L.map(q=>({...q,_cat:f})))}),C.length===0){S.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let O=document.createElement("div");O.innerHTML="Resultados da busca",O.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",S.appendChild(O),C.forEach(f=>{let E=U(f,Pe[f._cat],!1,f._cat);S.appendChild(E)});return}Object.entries(Qe).forEach(([C,O])=>{let f=xt[C],E=document.createElement("div"),L=document.createElement("div");L.id=`cat-anchor-${C}`,L.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,L.innerHTML=`
            ...
            ${O.label}
          `,E.appendChild(L);let q=document.createElement("div");q.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",O.links.forEach(D=>{let B=U(D,Pe[C],!1,C);q.appendChild(B)}),E.appendChild(q),S.appendChild(E)});let T=document.createElement("div");T.style.height="80px",S.appendChild(T)}function U(T,C,O,f){let E=document.createElement("div"),L=xt[f]||xt.history;E.style.cssText=`
...
`),l=/\d{1,2}\/\d{1,2}/,v="\u{1F4C5}";if(x.forEach(N=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(N)?v="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(N)&&(v="\u{1F1EA}\u{1F1F8}");let Q=N.match(l);if(Q){let oe=Q[0],ee=v;/🇧🇷|🇵🇹|PT|BR/i.test(N)?ee="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(N)&&(ee="\u{1F1EA}\u{1F1F8}"),X.some(te=>te.flag===ee&&te.date===oe)||X.push({flag:ee,date:oe})}}),X.length===0){let N=(y.text||"").match(/\d{1,2}\/\d{1,2}/g);N&&[...new Set(N)].forEach(Q=>X.push({flag:"\u{1F4C5}",date:Q}))}let w="",_='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(_=`
        ...
        `,W.appendChild(y),W.appendChild(V),F.appendChild(W);let X=document.createElement("div");X.id="cw-planner-status",Object.assign(X.style,u.statusBadge),F.appendChild(X);let x=document.createElement("div");Object.assign(x.style,{padding:"0 4px",marginTop:"12px"});let l=document.createElement("div");l.textContent="Arraste para simular o hor\xE1rio:",l.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let v=document.createElement("div");Object.assign(v.style,u.timelineContainer);let w=document.createElement("div");Object.assign(w.style,u.timelineTrack);let _=document.createElement("div");Object.assign(_.style,u.dayZone),w.appendChild(_);let k=document.createElement("input");k.type="range",k.min="0",k.max="1439",k.step="15",k.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let G=document.createElement("div");G.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",G.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",v.appendChild(w),v.appendChild(k),v.appendChild(G),x.appendChild(l),x.appendChild(v),F.appendChild(x);let N=y.querySelector("#cw-time-input-br"),Q=V.querySelector("#cw-time-display-client"),oe=V.querySelector("#cw-client-label");function ee(){let ne=_t.find(Me=>Me.id===a);oe.textContent=`${ne.flag} ${ne.label} (${ne.zone})`;let te=r.getHours(),re=r.getMinutes(),Ve=`${String(te).padStart(2,"0")}:${String(re).padStart(2,"0")}`;N.value=Ve,k.value=te*60+re;let et=r.toLocaleTimeString("pt-BR",{timeZone:ne.zone,hour:"2-digit",minute:"2-digit"});Q.textContent=et;let qe=parseInt(et.split(":")[0]);qe>=9&&qe<17?(X.style.background=c.successBg,X.style.color=c.success,X.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):qe>=8&&qe<9||qe>=17&&qe<19?(X.style.background=c.warningBg,X.style.color=c.warning,X.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(X.style.background=c.errorBg,X.style.color=c.error,X.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}k.oninput=ne=>{let te=parseInt(ne.target.value);r.setHours(Math.floor(te/60)),r.setMinutes(te%60),ee()},N.oninput=ne=>{let[te,re]=ne.target.value.split(":");te&&re&&(r.setHours(parseInt(te)),r.setMinutes(parseInt(re)),ee())},ee()}function O(){T(),o||(o=setInterval(T,6e4))}function f(){o&&(clearInterval(o),o=null)}function E(){e=!e,ue(e,p,"cw-btn-timezone"),e?z("live"):f()}return document.body.appendChild(p),E}function Lo(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let C=document.createElement("style");C.id="cw-lib-styles",C.innerHTML=`
        ...
        `;try{let d=await fe(),g=d.userProfile,S=d.agentEmail?d.agentEmail.split("@")[0]:"user";if(!g){c.innerHTML=`
                ...
                <div class="cw-profile-info">
                    ...
                    <div class="cw-profile-badges">
                        <span class="cw-profile-badge">${g.roleCategory||"N/A"}</span>
                        <span class="cw-profile-badge">${g.segment||"N/A"}</span>
                        <span class="cw-profile-badge">${g.defaultLanguage||"N/A"}</span>
            ...
            `}catch(d){console.warn("Erro ao renderizar perfil:",d),c.style.display="none"}}u();let p=document.createElement("div");p.className="cw-configs-section",p.innerHTML=`
    ...
    `;let m=p.querySelector("#cw-config-sound-toggle");m.onchange=d=>{j.setMuted(!d.target.checked),d.target.checked&&j.playClick()},r.appendChild(p);let h=document.createElement("div");h.className="cw-configs-section",h.innerHTML=`
  ...
  `,document.head.appendChild(t)};var Ie={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>'};function Mo(){_o();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=pe(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>X()),r=s.querySelector("div:last-child");if(r){let x=document.createElement("div");x.className="bau-refresh-btn no-drag",x.innerHTML=Ie.refresh,x.title="Atualizar Dashboard",x.onclick=async l=>{l.stopPropagation(),!x.classList.contains("spinning")&&(x.classList.add("spinning"),j.playClick(),await O(),setTimeout(()=>x.classList.remove("spinning"),1e3))},r.insertBefore(x,r.firstChild)}i.appendChild(s);let c=document.createElement("div");c.className="bau-view-container",i.appendChild(c);let u=document.createElement("div");u.id="bau-view-dashboard",u.className="bau-view active",u.innerHTML=`
    ...
    `,c.appendChild(u);let p=document.createElement("div");p.id="bau-view-form",p.className="bau-view";let m=document.createElement("div");m.className="bau-view-header",m.innerHTML=`
      <button class="bau-back-btn" id="bau-form-back-btn">
        ${Ie.back}
        Voltar ao Dashboard
      </button>
    `,p.appendChild(m);let h=document.createElement("div");h.className="bau-content",p.appendChild(h);let b=document.createElement("div");b.className="bau-progress-indicator",h.appendChild(b);let d=document.createElement("form");d.id="bau-escalation-form",h.appendChild(d);let g=document.createElement("div");g.className="bau-step active",g.id="bau-step-1";let S=document.createElement("div");S.className="bau-card bau-context-card",S.innerHTML=`
    ...
    `,R.querySelectorAll(".bau-task-item").forEach(x=>{let l=x.querySelector("input");x.addEventListener("click",()=>{l.checked=!l.checked,x.classList.toggle("active",l.checked),j.playClick()})}),$.appendChild(R),d.appendChild($);let J=document.createElement("div");J.className="bau-step",J.id="bau-step-3";let Z=document.createElement("div");Z.className="bau-card",Z.innerHTML=`
    ...
    `,J.appendChild(Z),d.appendChild(J);let M=document.createElement("div");M.className="bau-step",M.id="bau-step-4",M.innerHTML=`
        <div class="bau-card">
            <h3 class="bau-step-title">Confirme os dados antes de enviar</h3>
            <div id="bau-confirmation-details"></div>
        </div>
    `,d.appendChild(M);let F=document.createElement("div");F.className="bau-footer";let z=document.createElement("button");z.type="button",z.id="bau-step-back-btn",z.className="bau-btn-secondary",z.textContent="Voltar";let U=document.createElement("button");U.type="button",U.id="bau-step-next-btn",U.className="bau-btn-primary",U.textContent="Pr\xF3ximo";let I=document.createElement("button");I.type="submit",I.className="bau-btn-submit",I.innerHTML=`${Ie.send} Enviar para o TL`,I.style.display="none",d.appendChild(z),d.appendChild(U),d.appendChild(I),d.appendChild(F),c.appendChild(p);let T=document.createElement("div");T.id="bau-view-success",T.className="bau-view",T.innerHTML=`
    ...
    `,c.appendChild(T),document.body.appendChild(i);function C(x){e=x,i.querySelectorAll(".bau-view").forEach(_=>_.classList.remove("active"));let l=i.querySelector(`#bau-view-${x}`);l&&l.classList.add("active");let v=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),w=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");v&&(v.textContent=x==="form"?"Novo Caso BAU":"BAU Central"),w&&(w.textContent=x==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function O(){let x=i.querySelector("#bau-case-list-container");if(x){x.innerHTML='<p style="padding: 24px; text-align: center; color: #5f6368;">Sincronizando casos...</p>';try{let l=await zt();f(l)}catch{x.innerHTML='<p class="bau-error-text">Erro ao carregar casos.</p>'}}}function f(x){let l=i.querySelector("#bau-case-list-container"),v=i.querySelector("#bau-dashboard-metrics");if(!l)return;let w=G=>{switch(G){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:G||"Pendente",class:"status-gray",aura:""}}};if(!x||x.length===0){v&&(v.innerHTML=""),l.innerHTML=`
            ...
            `;return}let _=x.filter(G=>G.status==="PENDING_TL_CREATION").length,k=x.filter(G=>G.status==="CREATED").length;v&&(v.innerHTML=`
            ...
            `}}i.querySelector("#bau-top-se-search").onclick=x=>{x.preventDefault(),st("bau-context-se-id-input")};function D(){let x=new FormData(d),l=Object.fromEntries(x.entries()),v=x.getAll("taskType"),w=i.querySelector("#bau-confirmation-details");if(!w)return;let _=v.length>0?v.join(", "):"Nenhuma";w.innerHTML=`
        ...
        `}d.onsubmit=async x=>{if(x.preventDefault(),!L(n))return;let l=i.querySelector(".bau-btn-submit");l.disabled=!0,l.innerHTML="Enviando...";let v=new FormData(d),w=Object.fromEntries(v.entries()),_=v.getAll("taskType"),k=o||{},G=[w.availability_1,w.availability_2,w.availability_3].filter(Q=>Q&&Q.trim()!=="").join(" | "),N={...k,...w,advEmail:k.email||"",website:k.site||"",taskType:_.join(", "),availability:G};try{await Dt(N,k.agentEmail||"anon"),j.playSuccess(),C("success")}catch(Q){K("Erro: "+(Q.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",N)}finally{l.disabled=!1,l.innerHTML=`${Ie.send} Enviar para o TL`}};function B(){d.reset(),a=1,E(),R.querySelectorAll(".bau-task-item.active").forEach(x=>x.classList.remove("active"))}let W=i.querySelector("#bau-new-case-btn");W&&(W.onclick=()=>{B(),C("form"),q()});let y=i.querySelector("#bau-form-back-btn");y&&(y.onclick=()=>C("dashboard"));let V=i.querySelector("#bau-success-back-btn");V&&(V.onclick=()=>C("dashboard"));async function X(){t=!t,i.style.display=t?"flex":"none",t&&(C("dashboard"),O()),ue(t,i,"cw-btn-bauform")}return E(),X}function la(){if(window.techSolInitialized){At();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{jt();try{j.initGlobalListeners(),j.playStartup()}catch(p){console.warn("\xC1udio bloqueado:",p)}le.fetchTips(),At();let e=bo(),o=yo(),a=wo(),n=Co(),i=Oo(),s=Lo(),r=Io(),c=Mo(),u=Ao();so({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:c,broadcastControl:u}),setTimeout(()=>{le.logEvent("App","Start","Session Start"),Eo(),setTimeout(()=>{To(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),K("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}la();})();
