...
`),w=/\d{1,2}\/\d{1,2}/,g="\u{1F4C5}";if(E.forEach(O=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(O)?g="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(O)&&(g="\u{1F1EA}\u{1F1F8}");let $=O.match(w);if($){let J=$[0],V=g;/🇧🇷|🇵🇹|PT|BR/i.test(O)?V="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(O)&&(V="\u{1F1EA}\u{1F1F8}"),v.some(Y=>Y.flag===V&&Y.date===J)||v.push({flag:V,date:J})}}),v.length===0){let O=(l.text||"").match(/\d{1,2}\/\d{1,2}/g);O&&[...new Set(O)].forEach($=>v.push({flag:"\u{1F4C5}",date:$}))}let T="",U='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(U=`
  ...
  `,document.head.appendChild(t)};var Ve={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var pe={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function $o(t){let e=document.createElement("div");if(e.className="bau-dynamic-input",e.id=`wrapper-${t.id}`,t.label){let a=document.createElement("label");a.className="bau-label",a.textContent=t.label,t.tooltip&&a.setAttribute("data-tooltip",t.tooltip),e.appendChild(a)}let o;switch(t.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",e.appendChild(o);break;case"select":o=document.createElement("select"),t.groups?t.groups.forEach(s=>{let r=document.createElement("optgroup");r.label=s.label,s.options.forEach(c=>{let u=document.createElement("option");u.value=c.value,u.textContent=c.text,r.appendChild(u)}),o.appendChild(r)}):t.options&&t.options.forEach(s=>{let r=document.createElement("option");r.value=s.value,r.textContent=s.text,o.appendChild(r)}),e.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",t.options.forEach(s=>{let r=document.createElement("label");r.className="bau-task-item",r.innerHTML=`<input type="checkbox" name="${t.name}" value="${s}"><span>${s}</span>`,r.addEventListener("click",c=>{c.preventDefault();let u=r.querySelector("input");u.checked=!u.checked,r.classList.toggle("active",u.checked),P.playClick()}),o.appendChild(r)}),e.appendChild(o),e;case"datetime-group":o=document.createElement("div"),o.className="bau-availability-container",t.fields.forEach(s=>{let r=document.createElement("div");r.className="bau-availability-field",r.innerHTML=`
    ...
    `,y.appendChild(b);let m=document.createElement("div");m.className="bau-content",y.appendChild(m);let k=document.createElement("div");k.className="bau-progress-indicator",m.appendChild(k);let C=document.createElement("form");C.id="bau-escalation-form",C.noValidate=!0,m.appendChild(C),Ve.steps.forEach(l=>{let S=document.createElement("div");if(S.className="bau-step"+(l.id===a?" active":""),S.id=`bau-step-${l.id}`,l.isBranching)S.innerHTML=`
            ...
            `,S.querySelector("#bau-opt-full").onclick=()=>{n="BAU",a=1,C.querySelectorAll(".bau-highlight-panel").forEach(v=>v.classList.remove("discard-theme")),z(),P.playClick()},S.querySelector("#bau-opt-discard").onclick=()=>{n="DISCARD",a=5,C.querySelectorAll(".bau-highlight-panel").forEach(v=>v.classList.add("discard-theme")),z(),P.playClick()};else if(l.isConfirmation)S.innerHTML=`
                <div class="bau-card">
            ...
            `;else{let v=document.createElement("div");if(v.className="bau-card",l.id===1||l.id===5){v.innerHTML=`
                ...
                `;let E=v.querySelector(".bau-dynamic-inputs-container");l.fields.forEach(g=>{E.appendChild($o(g))});let w=v.querySelector("#wrapper-cid");if(w){let g=document.createElement("div");g.id="bau-cid-error",g.className="bau-cid-error-hint",g.style.display="none",g.textContent="Formato de CID incorreto",w.appendChild(g)}}else l.fields.forEach(E=>{v.appendChild($o(E))});S.appendChild(v)}C.appendChild(S)});let F=document.createElement("div");F.className="bau-footer";let j=document.createElement("button");j.type="button",j.id="bau-step-back-btn",j.className="bau-btn-secondary",j.textContent="Voltar";let M=document.createElement("button");M.type="button",M.id="bau-step-next-btn",M.className="bau-btn-primary",M.textContent="Pr\xF3ximo";let Q=document.createElement("button");Q.type="submit",Q.className="bau-btn-submit",Q.innerHTML=`${pe.send} Enviar para o TL`,Q.style.display="none",F.appendChild(j),F.appendChild(M),F.appendChild(Q),C.appendChild(F),d.appendChild(y);let ae=document.createElement("div");ae.id="bau-view-success",ae.className="bau-view bau-success-view",ae.innerHTML=`
    ...
    `,d.appendChild(ae),document.body.appendChild(c);function _(l){e=l,c.querySelectorAll(".bau-view").forEach(g=>g.classList.remove("active"));let S=c.querySelector(`#bau-view-${l}`);S&&S.classList.add("active");let v=u.querySelector(".cw-module-header-title")||u.querySelector("h2"),E=u.querySelector(".cw-module-header-subtitle")||u.querySelector("p");v&&(l==="form"?v.textContent=i?`Editando Caso #${s}`:"Novo Caso BAU":v.textContent="BAU Central"),E&&(E.textContent=l==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU");let w=C.querySelector(".bau-btn-submit");w&&(w.innerHTML=i?`${pe.send} Salvar Altera\xE7\xF5es`:`${pe.send} Enviar para o TL`)}function q(){let l=c.querySelector("#bau-case-list-container"),S=c.querySelector("#bau-dashboard-metrics");S&&(S.innerHTML=`
        ...
        `).join(""))}async function B(){let l=c.querySelector("#bau-case-list-container"),S=c.querySelector("#bau-dashboard-metrics");if(!(!l||!S)){q();try{let v=await Ut();if(!Array.isArray(v))throw new Error("API response is not a valid array");L(v)}catch(v){console.error("Critical Error loading BAU cases:",v),S&&(S.innerHTML=""),l.innerHTML=`
        ...
        `}function L(l){let S=c.querySelector("#bau-case-list-container"),v=c.querySelector("#bau-dashboard-metrics");if(!S||!v)return;let E=Array.isArray(l)?l.filter(Boolean):[];if(E.length===0){v.innerHTML=`
            ...
            `,c.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>B());return}let w=E.filter(x=>x.status==="PENDING_TL_CREATION").length,g=E.filter(x=>x.status==="CREATED").length;v.innerHTML=`
        ...
        `;let T=v.querySelector("#bau-refresh-dashboard");T?.addEventListener("click",async()=>{T.classList.contains("spinning")||(T.classList.add("spinning"),P.playClick(),await B(),setTimeout(()=>T.classList.remove("spinning"),1e3))}),S.innerHTML="";let U=E.slice(0,5),ee=E.slice(5);if(U.forEach(x=>{let O=G(x),$=document.createElement("div");$.innerHTML=O;let J=$.firstElementChild;J.addEventListener("click",oe=>{oe.target.closest(".bau-case-edit-btn")||X(x)});let V=J.querySelector(".bau-case-edit-btn");V&&(V.onclick=oe=>{oe.stopPropagation(),K(x)}),S.appendChild(J)}),ee.length>0){let x=document.createElement("li");x.className="bau-accordion-container";let O=document.createElement("button");O.className="bau-accordion-toggle",O.innerHTML=`${pe.expand} <span>Mostrar ${ee.length} casos mais antigos</span>`;let $=document.createElement("ul");$.className="bau-case-list bau-accordion-content",$.style.display="none",ee.forEach(J=>{let V=G(J),oe=document.createElement("div");oe.innerHTML=V;let Y=oe.firstElementChild;Y.addEventListener("click",re=>{re.target.closest(".bau-case-edit-btn")||X(J)});let ne=Y.querySelector(".bau-case-edit-btn");ne&&(ne.onclick=re=>{re.stopPropagation(),K(J)}),$.appendChild(Y)}),O.addEventListener("click",()=>{let J=$.style.display==="none";$.style.display=J?"block":"none",O.classList.toggle("expanded",J),O.querySelector("span").textContent=J?"Esconder casos mais antigos":`Mostrar ${ee.length} casos mais antigos`,P.playClick()}),x.appendChild(O),x.appendChild($),S.appendChild(x)}}function z(){let l=n==="BAU"?[1,2,3,4]:[5,4];C.querySelectorAll(".bau-step").forEach(E=>{let w=parseInt(E.id.replace("bau-step-","")),g=w===a,T=l.includes(w)||w===0;E.classList.toggle("active",g),E.style.display=g?"block":"none",E.querySelectorAll("input, select, textarea").forEach(U=>{U.disabled=!T})});let S=a===0;if(k.style.display=S?"none":"flex",!S){k.innerHTML="";let E=n==="BAU"?[1,2,3,4]:[5,4];E.forEach((w,g)=>{let T=document.createElement("div"),U=w===a,ee=E.indexOf(a),x=g<ee;T.className=`bau-progress-step ${U?"active":x?"completed":""}`,T.textContent=g+1,k.appendChild(T)})}let v=a===4;j.style.display=a>0?"inline-block":"none",M.style.display=!S&&!v?"inline-block":"none",Q.style.display=v?"flex":"none",v&&N()}function D(l){let S=Ve.steps.find(v=>v.id===l);if(!S||!S.fields||S.isConfirmation)return!0;for(let v of S.fields){let E=C.querySelector(`#bau-step-${l} #wrapper-${v.id}`);if(!(E&&E.style.display==="none")&&v.validation){let w=C.querySelector(`#bau-step-${l} [name="${v.name}"]`);if(w&&w.offsetParent!==null&&w.value.trim())if(new RegExp(v.validation.regex).test(w.value.trim())){w.classList.remove("invalid-cid");let T=C.querySelector("#bau-cid-error");T&&(T.style.display="none")}else{console.warn(`Validation failed for field "${v.name}" in step ${l}: Regex mismatch.`),te(`Erro: ${v.validation.error}`,{error:!0}),w.classList.add("invalid-cid");let T=C.querySelector("#bau-cid-error");return T&&(T.style.display="flex"),!1}}}return!0}function f(l){if(!C.querySelector(`#bau-step-${l}`))return!1;let v=Ve.steps.find(w=>w.id===l);if(!v||!v.fields||v.isConfirmation)return!0;let E=!0;for(let w of v.fields){let g=C.querySelector(`#bau-step-${l} #wrapper-${w.id}`);if(!(g&&g.style.display==="none")&&w.required){let T=!0,U="";if(w.type==="checkbox-grid")C.querySelector(`#bau-step-${l} input[name="${w.name}"]:checked`)||(U="No option selected in checkbox-grid",te(`Erro: Selecione pelo menos uma op\xE7\xE3o para "${w.label}".`,{error:!0}),T=!1);else if(w.type==="datetime-group"){let ee=C.querySelector(`#bau-step-${l} input[name="${w.fields[0].name}"]`);if(!ee||ee.offsetParent===null)continue;ee.value.trim()||(U="Datetime group first field is empty",te(`Erro: O campo "${w.fields[0].label}" \xE9 obrigat\xF3rio.`,{error:!0}),T=!1)}else{let ee=C.querySelector(`#bau-step-${l} [name="${w.name}"]`);if(!ee||ee.offsetParent===null)continue;ee.value.trim()||(U="Field is empty",te(`Erro: O campo '${w.label}' \xE9 obrigat\xF3rio.`,{error:!0}),T=!1)}if(!T){console.warn(`Validation failed for required field "${w.name}" in step ${l}: ${U}`),E=!1;break}}}return E}M.addEventListener("click",()=>{if(D(a)&&f(a)){n==="BAU"?a++:a===5?a=4:a++,z();let l=c.querySelector(".bau-content");l&&(l.scrollTop=0),P.playClick()}}),j.addEventListener("click",()=>{a>0&&(n==="BAU"?a--:a===4?a=5:a===5?a=0:a--,z(),P.playClick())});async function A(){let l=await Ce()||{};(!l.amName||l.amName==="N/A")&&(l.amName=l.internalEmail||"N/A"),o=l,C.querySelectorAll(".bau-vital-highlights").forEach(E=>{let w=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"Website",value:l.site||l.website},{label:"Case ID",value:l.caseId}];E.innerHTML=w.map(g=>{let T=g.value&&g.value!=="N/A"&&g.value!=="undefined"&&g.value!=="null"?g.value:"N\xE3o capturado";return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${g.label}</span>
                        <span class="bau-highlight-value">${T}</span>
                    </div>
                `}).join("")}),Ve.steps.forEach(E=>{E.fields&&E.fields.forEach(w=>{if(w.isSmart){let g=l[w.id];w.id==="language"&&l.userProfile?.defaultLanguage&&(g=l.userProfile.defaultLanguage);let T=C.querySelector(`#bau-step-${E.id} [name="${w.name}"]`),U=C.querySelector(`#bau-step-${E.id} #wrapper-${w.id}`);if(T&&(T.value=g&&g!=="N/A"?g:"",w.id==="language"&&g&&g!=="N/A"&&(T.readOnly=!0,T.style.background="#F1F3F4",T.style.cursor="not-allowed")),U){let ee=g&&g!==""&&g!=="N/A"&&g!=="undefined"&&g!=="null";w.id==="language"?U.style.display="block":U.style.display=ee?"none":"block"}}})}),C.querySelectorAll(".bau-all-data").forEach(E=>{let w=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"AM",value:l.amName},{label:"SE ID",value:l.seId},{label:"Site",value:l.site},{label:"Email",value:l.email},{label:"Timezone",value:l.timezone},{label:"Case ID",value:l.caseId},{label:"Programa",value:l.salesProgram},{label:"Idioma",value:l.language}];E.innerHTML=`
            ...
            `})}c.querySelector("#bau-top-se-search")?.addEventListener("click",l=>{l.preventDefault(),mt("bau-form-seId")});let R=c.querySelector("#bau-form-cid");R&&R.addEventListener("input",()=>D(1));function N(){let l=new FormData(C),S=Object.fromEntries(l.entries()),v=c.querySelector("#bau-confirmation-details");if(v){if(n==="BAU"){let E=l.getAll("taskType"),w=E.length>0?E.join(", "):"Nenhuma";v.innerHTML=`
            ...
            `;v.querySelectorAll(".bau-confirm-value-input").forEach(E=>{E.addEventListener("input",w=>{let g=w.target.dataset.field,T=w.target.dataset.step;if(!g||!T)return;let U=C.querySelector(`#bau-step-${T} [name="${g}"]`);U&&(U.value=w.target.value,g==="cid"&&D(1))})})}}async function K(l){I(),i=!0,s=l.id,n=l.status==="PENDING_TL_DISCARD"||l.reason&&!l.task?"DISCARD":"BAU",_("form"),await A(),o={...o,advName:l.advName||o.advName,cid:l.cid||o.cid,caseId:l.caseId||o.caseId,seId:l.seId||o.seId,site:l.site||o.site,email:l.advEmail||o.email,timezone:l.timezone||o.timezone,language:l.language||o.language,amName:l.amName||o.amName,salesProgram:l.salesProgram||o.salesProgram};let S=l.availability?l.availability.split("|").map(v=>v.trim()):[];C.querySelectorAll("input, select, textarea").forEach(v=>{let E=v.name,w={advEmail:"advEmail",website:"site",site:"site"};if(E==="taskType"){let g=(l.task||l.taskType||"").split(",").map(T=>T.trim());v.type==="checkbox"&&(v.checked=g.includes(v.value),v.closest(".bau-task-item")?.classList.toggle("active",v.checked))}else if(E.startsWith("availability_")){let g=parseInt(E.split("_")[1])-1,T=S[g];if(T&&v.type==="datetime-local")try{let U=new Date(T);if(!isNaN(U.getTime())){let ee=new Date(U.getTime()-U.getTimezoneOffset()*6e4).toISOString().slice(0,16);v.value=ee}}catch{}}else l[E]!==void 0?v.value=l[E]:E==="reason"?v.value=l.reason:E==="description"?v.value=l.description:E==="nonImplementationReason"&&(v.value=l.nonImplementationReason||"")}),a=n==="BAU"?1:5,z(),P.playClick()}C.onsubmit=async l=>{l.preventDefault();let S=n==="BAU"?[1,2,3]:[5];for(let U of S)if(!Ve.steps.find(x=>x.id===U)?.isConfirmation&&(!D(U)||!f(U))){console.warn(`Form submission blocked by validation failure in step ${U}`),a=U,z();return}let v=c.querySelector(".bau-btn-submit");v.disabled=!0,v.innerHTML="Enviando...";let E=new FormData(C),w=Object.fromEntries(E.entries()),g=o||{},T={...g,...w,requestType:n};if(w.advEmail?T.advEmail=w.advEmail:g.email&&(T.advEmail=g.email),w.website?T.website=w.website:g.site&&(T.website=g.site),n==="BAU"){let U=E.getAll("taskType"),ee=[w.availability_1,w.availability_2,w.availability_3].filter(x=>x&&x.trim()!=="").join(" | ");T.taskType=U.join(", "),T.availability=ee,T.nonImplementationReason=w.nonImplementationReason||"",T.description=w.description||"",T.nonImplementationReason||console.warn("Aviso: Campo 'Justificativa' (nonImplementationReason) est\xE1 saindo vazio."),T.description||console.warn("Aviso: Campo 'Descri\xE7\xE3o detalhada' (description) est\xE1 saindo vazio.")}else T.taskType="",T.availability="",T.nonImplementationReason="",T.reason=w.reason;try{i?await Vt(s,T):await Gt(T,g.agentEmail||"anon"),P.playSuccess();let U=c.querySelector(".bau-success-title");U&&(i?U.textContent="Caso atualizado com sucesso!":U.textContent=n==="DISCARD"?"Caso enviado para descarte com sucesso!":"Caso enviado com sucesso!"),_("success")}catch(U){te("Erro: "+(U.message||"Erro desconhecido"),{error:!0}),console.error("Payload que tentou enviar:",T)}finally{v.disabled=!1,v.innerHTML=`${pe.send} Enviar para o TL`}};function I(){C.reset(),a=0,n="BAU",i=!1,s=null,z(),C.querySelectorAll(".bau-task-item.active").forEach(S=>S.classList.remove("active"));let l=C.querySelector('[name="language"]');l&&(l.readOnly=!1,l.style.background="",l.style.cursor="")}c.querySelector("#bau-new-case-btn").addEventListener("click",()=>{I(),_("form"),A()}),c.querySelector("#bau-form-back-btn").addEventListener("click",()=>_("dashboard")),c.querySelector("#bau-success-back-btn").addEventListener("click",()=>_("dashboard"));async function Z(){t=!t,c.style.display=t?"flex":"none",t&&(_("dashboard"),B()),ge(t,c,"cw-btn-bauform")}return z(),Z}function fa(){if(window.techSolInitialized){Ot();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Jt();try{P.initGlobalListeners(),P.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}de.fetchTips(),Ot();let e=So(),o=ko(),a=Fo(),n=Lo(),i=No(),s=zo(),r=Ro(),c=Po(),u=Oo();go({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:c,broadcastControl:u}),setTimeout(()=>{de.logEvent("App","Start","Session Start"),qo(),setTimeout(()=>{Do(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),te("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}fa();})();
