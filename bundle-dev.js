...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ct={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},jt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Ut={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Le=t=>new Promise(e=>setTimeout(e,t));async function Yo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Le(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let r=Math.floor(Math.random()*60)+30;a===0&&(r=150),a>e.length-3&&(r=30),await Le(r)}await Le(600),o&&(o.style.display="none")}async function Et(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Le(200);let e=await zt(),o=Bt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),r=t.querySelector("#p3"),s=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),r&&(r.textContent=o.suffix),await Le(300);let p=a?a.querySelector("svg"):null;if(p&&(p.style.opacity="1",p.style.transform="scale(1)"),await Le(400),n&&(n.style.opacity="1"),$.playStartup(),i&&await Yo(i,o.name),r&&(r.style.opacity="1",r.style.transform="translateY(0)"),o.isFriday&&s){await Le(400),s.style.display="block",s.offsetWidth;let l=s.querySelector(".sextou-badge");l&&(l.style.opacity="1",l.style.transform="scale(1)")}await Le(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Le(900),t.parentNode&&t.parentNode.removeChild(t)}}function Vt(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,r=a-e.height-n,s=parseFloat(t.style.left)||e.left,p=parseFloat(t.style.top)||e.top,l=Math.max(n,Math.min(s,i)),c=Math.max(n,Math.min(p,r));if(l!==s||c!==p){let d=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${l}px`,t.style.top=`${c}px`,setTimeout(()=>{t.style.transition=d},300)}}var Ae={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Te(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,r=a.clientY,s=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),p=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),l=i,c=r,d=!1;function h(u){l=u.clientX,c=u.clientY,d||(window.requestAnimationFrame(()=>{b(),d=!1}),d=!0)}function b(){let u=s+(l-i),v=p+(c-r);u>360&&(t.style.width=u+"px"),v>300&&(t.style.height=v+"px")}function f(){document.removeEventListener("mousemove",h),document.removeEventListener("mouseup",f),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",h),document.addEventListener("mouseup",f)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Wt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Yt(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Xt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function xe(t,e={}){return new Promise(o=>{let a=Yt(),n=Xt(),i=e.danger?"#FF3B30":"#007AFF",r=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let s=c=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(c)},300)},p=n.querySelector("#cw-conf-cancel"),l=n.querySelector("#cw-conf-ok");[p,l].forEach(c=>c.onmouseenter=()=>$.playHover()),p.onclick=()=>{$.playClick(),s(!1)},l.onclick=()=>{$.playClick(),s(!0)}})}function Kt(t,e=""){return new Promise(o=>{let a=Yt(),n=Xt();n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let h=l.querySelector(".cw-hero-grid"),b=l.querySelector(".cw-acc-container"),f=l.querySelector(".cw-results-container"),u=l.querySelector(".cw-search-input"),v=l.querySelector(".cw-status-bar"),E=l.querySelector(".cw-status-text"),G=l.querySelector(".cw-footer-icons");r.forEach(([q,I])=>{let B=i(I.name),j=document.createElement("div");j.className="cw-hero-card",j.id=`hero-${q}`,j.style.setProperty("--hero-color",B.color),j.innerHTML=`
        ...
        `,j.onclick=M=>{if(M.target.closest(".cw-step-btn"))return;let T=a[q]?a[q].count:0;z(q,T>0?-T:1,I)},j.querySelector(".minus").onclick=()=>z(q,-1,I),j.querySelector(".plus").onclick=()=>z(q,1,I),j.dataset.color=B.color,h.appendChild(j)});function N(q,I){let B=i(I.name),j=document.createElement("div");return j.className="cw-task-item",j.dataset.id=q,j.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(u,v)=>{$.playClick(),a.querySelector(`.${u}`).classList.toggle("active"),v()};if(a.querySelector(".notes").onclick=u=>{u.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=u=>{u.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=u=>{u.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=u=>{u.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=u=>{u.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=u=>{u.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=u=>{u.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=u=>{u.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=u=>{u.stopPropagation(),i("broadcast",()=>{let v=u.currentTarget.querySelector(".cw-badge");v&&v.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(u=>{u.addEventListener("mouseenter",()=>$.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let u=document.createElement("div");u.className="cw-badge",a.querySelector(".broadcast").appendChild(u)}let r=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(r=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{r&&clearTimeout(r)},(async function(){let v=()=>{let G=Ee();if(G){let N=G.split("@")[0].toLowerCase();if(dt.includes(N)){let z=a.querySelector("#cw-admin-tag");z&&z.classList.add("visible")}}else setTimeout(v,2e3)};v(),await pt(2800),a.classList.add("docked"),await pt(300);let E=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(G=>G.classList.add("visible"));for(let G=0;G<E.length;G++)E[G].classList.add("popped"),await pt(90);await pt(200),a.classList.add("system-check")})();let s=!1,p,l,c,d,h=3;a.onmousedown=u=>{if(u.target.closest("button"))return;u.preventDefault(),p=u.clientX,l=u.clientY;let v=a.getBoundingClientRect();c=v.left,d=v.top,document.addEventListener("mousemove",b),document.addEventListener("mouseup",f)};function b(u){let v=u.clientX-p,E=u.clientY-l;!s&&Math.sqrt(v*v+E*E)>h&&(s=!0,a.classList.add("dragging"),a.style.transition="none",r&&clearTimeout(r)),s&&(a.style.left=`${c+v}px`,a.style.top=`${d+E}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function f(u){if(document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",f),s){s=!1,a.classList.remove("dragging");let v=window.innerWidth,E=window.innerHeight,G=a.getBoundingClientRect(),N=G.left+G.width/2,z;N<v/2?(z=24,a.classList.remove("side-right"),a.classList.add("side-left")):(z=v-G.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let J=Math.max(24,Math.min(G.top,E-G.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${z}px`,a.style.top=`${J}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let v=a.querySelector(".cw-btn.active"),E=u.target.closest("button");if(a.classList.contains("collapsed")){let G=a.getBoundingClientRect(),N=window.innerHeight,z=G.top>N/2;if(a.style.setProperty("transition","none","important"),z){let J=N-G.bottom;a.style.top="auto",a.style.bottom=`${J}px`}else a.style.bottom="auto",a.style.top=`${G.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),$.playGenieOpen()}else!v&&!E&&(a.classList.add("collapsed"),$.playGenieOpen());E&&(E.style.transform="scale(0.9)",setTimeout(()=>E.style.transform="",150))}}}function Ze(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,Y("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let r=Date.now()-n,s=Math.max(0,2e3-r);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let p=o.querySelector(".cw-center-dots"),l=o.querySelector(".cw-center-text"),c=o.querySelector(".cw-center-success"),d=o.querySelector(".cw-abort-btn");p&&(p.style.display="none"),l&&(l.style.display="none"),d&&(d.style.display="none"),c&&c.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},s)}}function lo(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let l=document.createElement("div");l.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",l.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let c=document.createElement("button");c.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',c.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",c.onmouseenter=()=>c.style.background="#F1F3F4",c.onmouseleave=()=>c.style.background="transparent",c.onclick=()=>h(!1),l.appendChild(c);let d=document.createElement("div");d.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",p.appendChild(l),p.appendChild(d);function h(f){let u=p.style.transform==="translateY(0%)";(f!==void 0?f:!u)?(b(),p.style.transform="translateY(0%)"):p.style.transform="translateY(110%)"}function b(){let f=ge.getAll();if(d.innerHTML="",f.length===0){d.innerHTML=`
                ...
                </div>`;return}f.forEach(u=>{let v=document.createElement("div");v.style.cssText=`
            ...
            `;let G=new Date(u.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),N="";u.summaryTags&&u.summaryTags.length>0&&(N=`<div style="font-size:11px; color:#1A73E8; background:#E8F0FE; display:inline-block; padding:2px 6px; border-radius:4px; margin-top:4px;">\u{1F3F7}\uFE0F ${u.summaryTags.slice(0,3).join(", ")+(u.summaryTags.length>3?"...":"")}</div>`),v.innerHTML=`
                <div style="display:flex; justify-content:space-between; margin-bottom:6px; align-items:flex-start;">
                    ...
                    <div style="font-size:11px; color:#9AA0A6;">${G}</div>
                </div>
...
`.replace(/\n/g,"<br>");Qe(q);let I=await ft();I?(I.innerText.trim()===""&&(I.innerHTML=""),document.execCommand("insertHTML",!1,q),gt(I),Y("Nota gerada e inserida!")):Y("Copiado! Abra uma nota para colar.")},e}var fe=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Fe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function bt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let c=a.getBoundingClientRect();i.x=c.left+c.width/2,i.y=c.top+c.height/2}let r,s;if(!n)r=window.innerWidth/2,s=window.innerHeight/2;else{let c=e.getBoundingClientRect();r=c.left+c.width/2,s=c.top+c.height/2,r===0&&s===0&&(r=window.innerWidth/2,s=window.innerHeight/2)}let p=i.x-r,l=i.y-s;t?($.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${p}px, ${l}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${l}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof fo=="function"&&fo(e,o)):($.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${p}px, ${l}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${p}px), calc(-50% + ${l}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Lt=="function"&&Lt(e))}function fo(t,e){Lt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),r=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):r||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Lt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function bo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Zt(t,Z),r=no(m),s=ao(()=>{T(),V.setActiveTasks(s.getCheckedElements())},m,V),p=document.createElement("div");p.style.display="none";let l=oo((g,A)=>{w(g,A)});p.appendChild(l);let c=lo({onSaveCurrent:async()=>{let g=await y();return F(),g},onLoadDraft:g=>{W(g)},t:g=>m(g)}),d=I(),h=B(),b=document.createElement("div"),f=U(),u=L(c,m);o.appendChild(d),o.appendChild(h),o.appendChild(f),o.appendChild(p),o.appendChild(b),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none";let v=document.createElement("button");v.id="manual-task-toggle",v.textContent=m("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",v.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${P.primary}; background: ${P.surface}; color: ${P.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${re}; text-transform: uppercase; letter-spacing: 0.5px;`,v.onmouseenter=()=>{v.style.background=P.primaryBg},v.onmouseleave=()=>{v.style.background=P.surface},v.onclick=()=>{s.selectionElement.style.display="block",s.screenshotsElement.style.display="block",v.style.display="none"},o.appendChild(v),o.appendChild(s.selectionElement),o.appendChild(r.element),o.appendChild(s.screenshotsElement),o.appendChild(u);let E=document.createElement("div");E.style.display="none",E.style.flexGrow="1",E.style.minHeight="0",E.style.overflow="hidden";let G=uo(()=>q());G.style.height="100%",E.appendChild(G),e.insertBefore(E,i);let N=a.lastElementChild;N&&(N.insertBefore(c.historyBtnWrapper,N.firstChild),N.insertBefore(D(),N.firstChild)),e.appendChild(c.drawer);let z=null;V.subscribe(g=>{K(g),J(),g.isDirty?(z&&clearTimeout(z),z=setTimeout(async()=>{let A=await y(!0);A.subStatus?ge.saveEmergency(A):ge.clearEmergency(),g.isDirty=!1},2e3)):z&&(clearTimeout(z),z=null)});function J(){let g=ge.getCount()>0,A=!!V.currentSubStatus;ut(g||A)}function Z(){V.visible=!V.visible,ue(V.visible,e,"cw-btn-notes")}function q(){V.isSplitView=!V.isSplitView,V.isSplitView?(o.style.display="none",E.style.display="flex",E.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",E.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function I(){let g=document.createElement("div");if(g.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let C=document.createElement("style");C.id="cw-segmented-styles",C.innerHTML=`
            ...
            `,document.head.appendChild(C)}let A=(C,R)=>{let X=g.querySelector(`#${C}`).querySelector(".cw-segmented-indicator");X&&(X.style.transform=`translateX(${R*100}%) translateX(${R*2}px)`)};return g.querySelectorAll("#lang-selector button").forEach((C,R)=>{C.onclick=()=>{V.setLanguage(C.dataset.lang),g.querySelectorAll("#lang-selector button").forEach(_=>_.classList.remove("active")),C.classList.add("active"),A("lang-selector",R),$.playHover(),V.currentSubStatus&&M(V.currentSubStatus)}}),g.querySelectorAll("#type-selector button").forEach((C,R)=>{C.onclick=()=>{V.setCaseType(C.dataset.type),g.querySelectorAll("#type-selector button").forEach(_=>_.classList.remove("active")),C.classList.add("active"),A("type-selector",R),$.playHover(),V.currentSubStatus&&M(V.currentSubStatus)}}),g.querySelectorAll("#portugal-selector button").forEach((C,R)=>{C.onclick=()=>{V.setPortugalCase(C.dataset.val==="true"),g.querySelectorAll("#portugal-selector button").forEach(_=>_.classList.remove("active")),C.classList.add("active"),A("portugal-selector",R),$.playHover(),V.currentSubStatus&&M(V.currentSubStatus)}}),g}function B(){let g=document.createElement("div");g.className="cw-status-section",g.style.cssText="display: flex; flex-direction: column; gap: 8px;",g.innerHTML=`
        ...
        `;let A=g.querySelector("#main-status-select"),C=g.querySelector("#sub-status-select");return A.onchange=()=>{V.setStatus(A.value),j(A.value,C),V.setSubStatus(""),M("")},C.onchange=()=>{V.setSubStatus(C.value),M(C.value)},g}function j(g,A){if(A.innerHTML=`<option value="">${m("select_substatus")}</option>`,!g){A.disabled=!0;return}for(let C in ke)if(ke[C].status===g){let R=document.createElement("option");R.value=C,R.textContent=ke[C].name,A.appendChild(R)}A.disabled=!1}function M(g){if(l.render&&l.render(g,V.currentCaseType),!g){p.style.display="none",b.style.display="none",document.getElementById("manual-task-toggle").style.display="none",s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",f.style.display="flex",f.style.opacity="1",u.style.display="none";return}f.style.opacity="0",setTimeout(()=>{V.currentSubStatus&&(f.style.display="none")},400),u.style.display="grid";let A=ke[g];A&&A.templateFields&&V.setActiveFields(A.templateFields),S(),Tt(g,b,V),b.style.display="block",p.style.display="block";let C=g.startsWith("SO_"),R=g==="NI_Awaiting_Validation",_=document.getElementById("manual-task-toggle");C||R?(s.selectionElement.style.display="block",_.style.display="none"):(s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",_.style.display="block");let X=g==="SO_Education_Only"?"education":"implementation";V.setScreenshotMode(X),V.currentCaseType==="lm"?V.toggleFieldExclusion("field-ON_CALL",!0):V.toggleFieldExclusion("field-ON_CALL",!1),s.updateSubStatus(g),T();let H=document.getElementById("email-automation-toggle-row");H&&(H.style.display=He[g]?"flex":"none")}function T(){let g=s.getCheckedElements().map(A=>A.value);r.updateVisibility(V.currentSubStatus,g)}function w(g,A){let C=st[g];if(C){for(let R in C)if(R==="linkedTask")s.toggleTask(C.linkedTask,A);else if(R==="activeTasks")C.activeTasks.forEach(_=>{A?s.setTaskCount(_.value,_.count):s.setTaskCount(_.value,0)});else if(R.startsWith("field-")){let _=R,X=C[R],H=document.getElementById(_);if(H){let Q=Ge.includes(_.replace("field-",""));if(A)if(Q){let ne=H.value.trim();ne.includes(X.trim())||(H.value=ne?ne+`
`+X.trim():X.trim())}else H.value=X;else if(Q){let ne=H.value.trim(),se=X.trim();ne.includes(se)&&(H.value=ne.replace(se,"").trim().replace(/\n{3,}/g,`

`))}else H.value.trim()===X.trim()&&(H.value="");V.updateField(_,H.value),H.dispatchEvent(new Event("input"))}}}}function L(g,A){let C=document.createElement("div");if(C.className="cw-actions-section",C.style.cssText=`
            display: grid;
        ...
        `,!document.getElementById("cw-actions-hover-styles")){let ne=document.createElement("style");ne.id="cw-actions-hover-styles",ne.innerHTML=`
            ...
            `,document.head.appendChild(ne)}let R=document.createElement("div");R.id="email-automation-toggle-row",R.style.cssText="grid-column: span 2; display: none; align-items: center; justify-content: center; padding-bottom: 6px; border-bottom: 1px solid rgba(0,0,0,0.05); margin-bottom: 2px;",R.innerHTML=`
        ...
        `;let _=g.parkButton;_.classList.add("js-btn-park"),_.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let X=document.createElement("button");X.className="cw-btn-secondary js-btn-reset",X.textContent=A("limpar"),X.style.cssText=`width: 100%; height: 34px; background: ${P.surface}; color: ${P.textSub}; border: 1px solid ${P.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,X.onclick=()=>F();let H=document.createElement("button");H.className="cw-btn-secondary js-btn-copy",H.textContent=A("copiar"),H.style.cssText=`width: 100%; height: 34px; background: ${P.surface}; color: ${P.primary}; border: 1px solid ${P.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,H.onclick=()=>x();let Q=document.createElement("button");return Q.className="cw-btn-primary js-btn-generate",Q.textContent=A("preencher"),Q.style.cssText=`width: 100%; height: 38px; background: ${P.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,Q.onclick=()=>k(),C.appendChild(R),C.appendChild(_),C.appendChild(X),C.appendChild(H),C.appendChild(Q),C}async function x(){if(!V.currentSubStatus){Y(m("select_substatus"),{error:!0});return}let g=kt(V,s,r);g?(Qe(g),Y(m("copiado_sucesso")),$.playClick()):Y(m("select_substatus"),{error:!0})}async function k(){if(!V.currentSubStatus){Y(m("select_substatus"),{error:!0});return}let g=kt(V,s,r);Qe(g),Z();let A=Ze(),C=await ft();if(C){C.focus(),document.execCommand("insertHTML",!1,g),gt(C);let R=document.getElementById("email-automation-checkbox");(!R||R.checked)&&V.currentSubStatus&&He[V.currentSubStatus]&&await ht(He[V.currentSubStatus]),Y(m("inserido_copiado")),$.playSuccess(),F()}A()}function S(){if(V.currentSubStatus){if(V.currentCaseType==="lm")V.removeField("ON_CALL");else{let g=ke[V.currentSubStatus];g&&g.templateFields.includes("ON_CALL")&&V.addFieldAt("ON_CALL",1)}V.isPortugalCase?(V.addFieldAt("CASO_PORTUGAL",1),V.addFieldAt("CONSENTIU_GRAVACAO",2)):(V.removeField("CASO_PORTUGAL"),V.removeField("CONSENTIU_GRAVACAO"))}}function F(){V.reset(),s.reset(),r.reset(),J(),ge.clearEmergency(),o.querySelectorAll("select").forEach(A=>A.value=""),o.querySelector("#sub-status-select").disabled=!0;let g=document.getElementById("email-automation-toggle-row");g&&(g.style.display="none"),b.innerHTML="",p.style.display="none",f.style.display="flex",f.style.opacity="1",u.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none"}async function y(g=!1){let A={};b.querySelectorAll("input, textarea, select").forEach(H=>{(H.id.startsWith("field-")||H.id==="consent-select")&&(A[H.id]=H.value)});let C="Cliente",R="---";if(!g)try{let H=await we();C=H.advertiserName,R=H.cid}catch(H){console.warn("Erro ao coletar pageData:",H)}let _=s.getCheckedElements().map(H=>({key:H.value,count:H.count})),X=_.map(H=>{let Q=Ce[H.key];return Q?Q.name:H.key});return{currentCaseType:V.currentCaseType,currentLang:V.currentLang,isPortugalCase:V.isPortugalCase,consent:V.consent,tagSupportUsed:V.tagSupportUsed,forcedScreenshots:[...V.forcedScreenshots],excludedFields:[...V.excludedFields],activeFields:V.activeFields,status:V.currentStatus,subStatus:V.currentSubStatus,formData:A,activeTasks:_,summaryTags:X,clientName:C,cid:R,timestamp:new Date().toISOString()}}let O=g=>new Promise(A=>setTimeout(A,g));async function W(g){V.setLanguage(g.currentLang||"pt"),V.setCaseType(g.currentCaseType||"bau"),V.setPortugalCase(g.isPortugalCase||!1),V.setConsent(g.consent||!1),V.setExcludedFields(g.excludedFields||[]),g.activeFields&&V.setActiveFields(g.activeFields);let A=o.querySelector(`#lang-selector button[data-lang="${V.currentLang}"]`);A&&A.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(_=>{_!==A&&_.classList.remove("active")});let C=o.querySelector(`#type-selector button[data-type="${V.currentCaseType}"]`);C&&C.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(_=>{_!==C&&_.classList.remove("active")});let R=o.querySelector(`#portugal-selector button[data-val="${V.isPortugalCase}"]`);if(R&&R.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(_=>{_!==R&&_.classList.remove("active")}),g.status){let _=o.querySelector("#main-status-select");_.value=g.status,V.setStatus(g.status);let X=o.querySelector("#sub-status-select");if(j(g.status,X),await O(50),g.subStatus){if(X.value=g.subStatus,V.setSubStatus(g.subStatus),M(g.subStatus),await O(100),g.tagSupportUsed!==void 0){V.setTagSupportUsed(g.tagSupportUsed);let H=r.element.querySelector('input[value="Sim"]'),Q=r.element.querySelector('input[value="N\xE3o"]');g.tagSupportUsed&&H?H.checked=!0:Q&&(Q.checked=!0),r.element.querySelector("div:last-child").style.display=g.tagSupportUsed?"none":"block"}g.forcedScreenshots&&V.setForcedScreenshots(g.forcedScreenshots);for(let H in g.formData){let Q=document.getElementById(H);Q&&(Q.value=g.formData[H],V.updateField(H,Q.value))}g.activeTasks&&(g.activeTasks.forEach(H=>s.setTaskCount(H.key,H.count)),V.setActiveTasks(s.getCheckedElements()))}}V.isDirty=!1}function m(g){return Se[V.currentLang]?.[g]||Se.pt?.[g]||g}function D(){let g=document.createElement("div");return g.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',g.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",g.onclick=A=>{A.stopPropagation(),q()},g.title="Alternar para Split & Transfer",g}function U(){let g=document.createElement("div");return g.id="notes-empty-state",g.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,e=document.createElement("style");e.textContent=t,document.head.appendChild(e),vo=!0}function wo(){ia();let t="v6.1.1",e=!1,o=[],a=null,n="",i=new Set,r=document.createElement("div");r.id="email-assistant-popup",r.className="cw-module-window cw-email-popup",Object.assign(r.style,me,{display:"none"});let s=pe(r,"Email Assistant",t,"UI Refatorada com CSS-in-JS Injetado e Classes.",{popup:r},()=>j()),p=document.createElement("div");p.className="cw-email-main";let l=document.createElement("div");l.className="cw-email-left-panel";let c=document.createElement("div");c.className="cw-email-search-container";let d=document.createElement("input");d.placeholder="Buscar templates...",d.className="cw-email-search-input";let h=document.createElement("div");h.innerHTML="\u2715",h.className="cw-email-search-clear",h.onclick=()=>{d.value="",n="",h.style.display="none",T(),d.focus()},c.appendChild(d),c.appendChild(h);let b=document.createElement("div");b.id="email-template-list",l.appendChild(c),l.appendChild(b);let f=document.createElement("div");f.className="cw-email-right-panel";let u=document.createElement("div");u.className="cw-email-fields-section";let v=document.createElement("div");v.className="cw-email-preview-section";let E=document.createElement("div");E.className="cw-email-preview-header";let G=document.createElement("span");G.textContent="Preview do E-mail",G.className="cw-email-preview-title";let N=document.createElement("div");N.className="cw-email-preview-actions";let z=(S,F="secondary",y="")=>{let O=document.createElement("button");return O.textContent=S,O.className=`cw-btn cw-btn-${F} ${y}`,O},J=z("Copiar HTML","secondary"),Z=z("Preencher no CRM","primary"),q=z("Smart CR","secondary","cw-btn-smart-cr");N.appendChild(q),N.appendChild(J),N.appendChild(Z),E.appendChild(G),E.appendChild(N);let I=document.createElement("div");I.contentEditable="true",I.className="cw-email-preview-content",v.appendChild(E),v.appendChild(I),f.appendChild(u),f.appendChild(v),p.appendChild(l),p.appendChild(f),r.appendChild(s),r.appendChild(p);let B=document.createElement("div");Object.assign(B.style,Ae),r.appendChild(B),Te(r,B),document.body.appendChild(r),k();function j(){e=!e,e?(r.style.display="flex",Vt(r),o.length===0&&M()):r.style.display="none",ue(e,r,"cw-btn-email")}async function M(){b.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await ho.getTemplates(),T()}function T(){b.innerHTML="";let S=o.filter(m=>m.name.toLowerCase().includes(n.toLowerCase())||m.category.toLowerCase().includes(n.toLowerCase())),F=Object.entries(He).filter(([m,D])=>D&&(m.toLowerCase().includes(n.toLowerCase())||D.toLowerCase().includes(n.toLowerCase()))).map(([m,D])=>({id:m,name:m.replace(/_/g," "),category:"\u26A1 Smart CRs",code:D,isSmartCR:!0})),y=he.getSnippets("email").filter(m=>m.title.toLowerCase().includes(n.toLowerCase())||m.subject&&m.subject.toLowerCase().includes(n.toLowerCase())).map(m=>{let D=[],U=m.content.match(/\[([^\]]+)\]/g);return U&&[...new Set(U)].forEach(K=>{D.push({key:K,label:K.replace("[","").replace("]",""),type:K.toLowerCase().includes("data")?"date":"text",auto:K.toLowerCase().includes("nome")&&K.toLowerCase().includes("seu")?"agentName":null})}),{id:m.id||`snippet-${Math.random()}`,name:m.title,category:"\u{1F464} Pessoal",subject:m.subject||"Sem Assunto",template:m.content,placeholders:D}}),O=[...S,...F,...y];if(O.length===0){b.innerHTML=`
                ...
                </div>`;return}[...new Set(O.map(m=>m.category))].sort((m,D)=>m.localeCompare(D)).forEach(m=>{let D=i.has(m)||n.length>0,U=O.filter(_=>_.category===m),K=document.createElement("div");K.className="cw-email-category-header";let g=document.createElement("span");g.textContent=m;let A=document.createElement("div");A.style.display="flex",A.style.alignItems="center";let C=document.createElement("span");C.textContent=U.length,C.className="cw-email-category-badge";let R=document.createElement("span");R.innerHTML=D?"\u25BE":"\u25B8",R.style.marginLeft="8px",R.style.transition="transform 0.3s ease",A.appendChild(C),A.appendChild(R),K.appendChild(g),K.appendChild(A),K.onclick=()=>{i.has(m)?i.delete(m):i.add(m),T()},b.appendChild(K),D&&U.forEach(_=>{let X=document.createElement("div");X.className="cw-email-template-item",a&&a.id===_.id&&X.classList.add("selected");let H=document.createElement("span");H.className="cw-email-template-item-icon",H.innerHTML=_.isSmartCR?"\u26A1":_.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}";let Q=document.createElement("span");Q.className="cw-email-template-item-text",Q.textContent=_.name,X.appendChild(H),X.appendChild(Q),X.onclick=()=>L(_),b.appendChild(X)})})}let w=null;function L(S){a?.id!==S.id&&(a=S,w&&clearTimeout(w),f.style.opacity="0",f.style.transform="translateY(5px)",w=setTimeout(()=>{q.style.display=S.isSmartCR?"block":"none",Z.style.display=S.isSmartCR?"none":"block",J.style.display=S.isSmartCR?"none":"block",T(),x(),k(),f.style.opacity="1",f.style.transform="translateY(0)",w=null},150))}function x(){if(u.innerHTML="",!a||a.isSmartCR){a?.isSmartCR?(u.style.display="block",u.innerHTML=`<div style="padding: 12px; font-size: 13px; color: #856404; background: #FFF3CD; border: 1px solid #FFEEBA; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
                ...
                </div>`):u.style.display="none";return}let S=a.placeholders&&a.placeholders.length>0;if(u.style.display=S?"block":"none",!S)return;let F=document.createElement("div");F.className="cw-email-fields-grid",(a.placeholders||[]).forEach(y=>{let O=document.createElement("div"),W=document.createElement("label");W.textContent=y.label,W.className="cw-email-field-label";let m=document.createElement("input");m.type=y.type||"text",m.dataset.key=y.key,m.className="cw-email-field-input",y.auto==="agentName"&&(m.value=Ye().split(" ")[0]),m.addEventListener("input",k),O.appendChild(W),O.appendChild(m),F.appendChild(O)}),u.appendChild(F)}function k(){if(!a){I.innerHTML=`
...
CID: ${A.cid||"---"}
Case ID: ${A.caseId||"---"}
E-mail: ${A.clientEmail||"---"}`;R&&(R.value=X),_&&(_.style.display="block",_.style.maxHeight="300px",_.style.opacity="1",_.scrollIntoView({behavior:"smooth",block:"end"}))})}function b(){s=!s,ue(s,p,"cw-btn-script"),s?(d(),c||(c=setInterval(d,2e3))):c&&(clearInterval(c),c=null)}let f=pe(p,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{b()});p.appendChild(f);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `;let v=u.querySelector("#csa-toggle-options"),E=u.querySelector("#csa-options-content"),G=u.querySelector("#csa-options-arrow"),N=!1;v.onclick=()=>{N=!N,G.style.transform=N?"rotate(180deg)":"rotate(0deg)",E.style.maxHeight=N?"400px":"0",E.style.opacity=N?"1":"0",E.style.marginTop=N?"8px":"0",$.playClick()};let z=u.querySelector("#cw-pill-message"),J=u.querySelector("#cw-am-copy-final"),Z=u.querySelector("#cw-am-message-area");z.onmouseenter=()=>{z.style.borderColor="#007AFF",z.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},z.onmouseleave=()=>{z.style.borderColor="#DADCE0",z.style.boxShadow="0 1px 2px rgba(0,0,0,0.02)"},z.addEventListener("click",()=>{h()}),J.addEventListener("click",()=>{Z.value&&(navigator.clipboard.writeText(Z.value),Y("Mensagem copiada!"),$.playSuccess(),J.style.background="#34A853",J.textContent="Copiado!",setTimeout(()=>{J.style.background="#1A73E8",J.textContent="Copiar Mensagem Final"},2e3))});let q=(A,C)=>{let R=u.querySelector(A),_=u.querySelector(C);R.onclick=()=>{let X=_.textContent;!X||X.includes("---")||X.includes("N\xE3o encontrado")||(navigator.clipboard.writeText(X),$.playSuccess(),R.classList.add("copied"),setTimeout(()=>R.classList.remove("copied"),1500))}};p.appendChild(u);let I=document.createElement("div");Object.assign(I.style,a.progressBarContainer);let B=document.createElement("div");B.className="csa-progress-fill",Object.assign(B.style,a.progressBarFill),I.appendChild(B),p.appendChild(I);let j=document.createElement("div");j.id="csa-content",Object.assign(j.style,a.contentArea),p.appendChild(j);let M=document.createElement("div");Object.assign(M.style,a.footer);let T=document.createElement("span");T.textContent="by lucaste@",Object.assign(T.style,{fontSize:"10px",color:"#bdc1c6"});let w=document.createElement("button");w.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> Resetar Script',Object.assign(w.style,a.resetBtn),w.onmouseenter=()=>w.style.background="#fce8e6",w.onmouseleave=()=>w.style.background="transparent",w.onclick=()=>{w.style.transform="scale(0.9)",setTimeout(()=>w.style.transform="scale(1)",150);for(let A in n)delete n[A];U()},M.appendChild(T),M.appendChild(w),p.appendChild(M);let L=document.createElement("div");Object.assign(L.style,{display:"flex",flexDirection:"column",gap:"8px",marginBottom:"16px"});let x=document.createElement("div");x.className="csa-segmented-control",x.innerHTML=`
  ...
  `;let k=document.createElement("div");k.className="csa-segmented-control",k.innerHTML=`
  ...
  `,u.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},u.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(f),b.appendChild(u),h.appendChild(b),d.appendChild(h);let v=document.createElement("div");v.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",d.appendChild(v);let E=null;function G(){if(E)return;E=document.createElement("div"),E.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let T=document.createElement("div");T.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",T.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let w=document.createElement("button");w.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',w.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",w.onclick=()=>{z(),n=!1,I()},T.appendChild(w),E.appendChild(T);let L=document.createElement("div");L.id="cw-history-list",L.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",E.appendChild(L),d.appendChild(E)}function N(){E||G();let T=E.querySelector("#cw-history-list");T.innerHTML="";let w=ra();w.length===0?T.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':w.forEach(L=>{let x=j(L,Be[L._originalCat],!0,L._originalCat);T.appendChild(x)}),requestAnimationFrame(()=>E.style.transform="translateY(0)")}function z(){E&&(E.style.transform="translateY(100%)")}function J(){c.innerHTML="";let T=Z("history","Recentes",Be.history);T.id="cw-sidebar-btn-history",T.onclick=()=>{$.playClick(),n=!n,n?N():z(),I()},c.appendChild(T);let w=document.createElement("div");w.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",c.appendChild(w),Object.keys(et).forEach(L=>{let x=et[L],k=Z(L,x.label,Be[L]);k.id=`cw-sidebar-btn-${L}`,k.onclick=()=>{$.playClick(),n&&(n=!1,z()),q(L)},c.appendChild(k)})}function Z(T,w,L){let x=document.createElement("div");x.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,x.title=w,x.dataset.key=T;let k=document.createElement("div");k.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",k.innerHTML=L||Be.tasks;let S=document.createElement("div");return S.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",S.textContent=w,x.appendChild(k),x.appendChild(S),x.onmouseenter=()=>{a!==T&&!(T==="history"&&n)&&(x.style.background="#F1F3F4",k.style.transform="scale(1.1)")},x.onmouseleave=()=>{a!==T&&!(T==="history"&&n)&&(x.style.background="transparent",k.style.transform="scale(1)")},x}function q(T){let w=document.getElementById(`cat-anchor-${T}`);w&&(w.scrollIntoView({behavior:"smooth",block:"start"}),a=T,I())}function I(){Object.keys(et).forEach(w=>{let L=c.querySelector(`#cw-sidebar-btn-${w}`);if(L)if(a===w&&!n){let x=yt[w];L.style.background=x.bg,L.style.color=x.color,L.querySelector("div:first-child").style.transform="scale(1.1)"}else L.style.background="transparent",L.style.color=i.textSecondary,L.querySelector("div:first-child").style.transform="scale(1)"});let T=c.querySelector("#cw-sidebar-btn-history");T&&(n?(T.style.background="#3C4043",T.style.color="#FFFFFF"):(T.style.background="transparent",T.style.color=i.textSecondary))}function B(){if(v.innerHTML="",e.trim()!==""){let w=[];if(Object.entries(et).forEach(([x,k])=>{let S=k.links.filter(F=>F.name.toLowerCase().includes(e.toLowerCase())||F.desc.toLowerCase().includes(e.toLowerCase()));w.push(...S.map(F=>({...F,_cat:x})))}),w.length===0){v.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let L=document.createElement("div");L.innerHTML="Resultados da busca",L.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",v.appendChild(L),w.forEach(x=>{let k=j(x,Be[x._cat],!1,x._cat);v.appendChild(k)});return}Object.entries(et).forEach(([w,L])=>{let x=yt[w],k=document.createElement("div"),S=document.createElement("div");S.id=`cat-anchor-${w}`,S.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,S.innerHTML=`
            ...
            ${L.label}
          `,k.appendChild(S);let F=document.createElement("div");F.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",L.links.forEach(y=>{let O=j(y,Be[w],!1,w);F.appendChild(O)}),k.appendChild(F),v.appendChild(k)});let T=document.createElement("div");T.style.height="80px",v.appendChild(T)}function j(T,w,L,x){let k=document.createElement("div"),S=yt[x]||yt.history;k.style.cssText=`
      ...
      `;let F=document.createElement("div");F.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,F.innerHTML=w||Be.tasks;let y=F.querySelector("svg");y&&(y.style.width="22px",y.style.height="22px");let O=document.createElement("div");O.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let W=document.createElement("div");W.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,W.textContent=T.name;let m=document.createElement("div");m.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,m.textContent=T.desc,O.appendChild(W),O.appendChild(m);let D=document.createElement("div");return D.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',D.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,D.title="Copiar URL",k.onmouseenter=()=>{k.style.transform="translateY(-2px)",k.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",k.style.borderColor="rgba(0,0,0,0.05)",k.style.borderLeft=`4px solid ${S.color}`,D.style.opacity="1",D.style.background="#F1F3F4"},k.onmouseleave=()=>{k.style.transform="translateY(0)",k.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",k.style.border="1px solid transparent",D.style.opacity="0",D.style.background="transparent"},k.onclick=()=>{!L&&x&&Eo(T,x),window.open(T.url,"_blank")},D.onclick=U=>{U.stopPropagation(),$.playClick(),navigator.clipboard.writeText(T.url),!L&&x&&Eo(T,x),Y("Link copiado!")},k.appendChild(F),k.appendChild(O),k.appendChild(D),k}u.addEventListener("input",T=>{e=T.target.value,B()});function M(){o=!o,ue(o,r,"cw-btn-links")}return document.body.appendChild(r),J(),B(),M}var _e=[];function _t(t){_e=t}var sa=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function To(){let t="v4.9",e=!1,o=null,a=null;function n(x){if(!x)return"";try{let k=new Date(x);return isNaN(k.getTime())?String(x):k.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(x)}}if(!document.getElementById("cw-broadcast-hd-css")){let x=document.createElement("style");x.id="cw-broadcast-hd-css",x.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,f.querySelectorAll('input[name="cw-bc-type"]').forEach(F=>{F.addEventListener("change",()=>{f.querySelectorAll(".cw-radio-option").forEach(y=>y.classList.remove("checked")),F.parentElement.classList.add("checked")})}),setTimeout(()=>{let F=f.querySelector(".cw-radio-option.info");F&&F.classList.add("checked")},100);let x=f.querySelector("#cw-bc-cancel"),k=f.querySelector("#cw-bc-close-x"),S=f.querySelector("#cw-bc-send");x.onclick=N,k.onclick=N,S.onclick=z,l.appendChild(f)}function G(x=null){if(!f)return;let k=f.querySelector("#cw-editor-title-label"),S=f.querySelector("#cw-bc-title"),F=f.querySelector("#cw-bc-text"),y=f.querySelector("#cw-bc-send");if(x){a=x.id,k.textContent="Editar Aviso",S.value=x.title||"",F.value=x.text||"",y.textContent="Salvar Altera\xE7\xF5es";let O=x.type||"info",W=f.querySelector(`input[name="cw-bc-type"][value="${O}"]`);W&&W.click()}else{a=null,k.textContent="Novo Aviso",S.value="",F.value="",y.textContent="Publicar";let O=f.querySelector('input[name="cw-bc-type"][value="info"]');O&&O.click()}f.classList.add("active"),setTimeout(()=>S.focus(),300)}function N(){f&&f.classList.remove("active"),a=null}async function z(){let x=f.querySelector("#cw-bc-send"),k=f.querySelector("#cw-bc-title"),S=f.querySelector("#cw-bc-text"),F=f.querySelector('input[name="cw-bc-type"]:checked'),y=F?F.value:"info";if(!k.value.trim()||!S.value.trim()){Y("Preencha todos os campos!",{error:!0});return}x.textContent="Salvando...",x.style.opacity="0.7";let O=!1;a?O=await be.updateBroadcast(a,{title:k.value,text:S.value,type:y}):O=await be.sendBroadcast({title:k.value,text:S.value,type:y,author:window._cwCurrentUser||"admin"}),O?(Y(a?"Atualizado!":"Publicado!"),$.playSuccess(),N(),setTimeout(()=>q(),1500)):(Y("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),x.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",x.style.opacity="1")}async function J(x){if(await xe("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await be.deleteBroadcast(x)){Y("Aviso removido."),$.playClick();let F=_e.findIndex(y=>y.id===x);F>-1&&_e.splice(F,1),B(),setTimeout(()=>q(),1500)}else Y("Erro ao excluir.",{error:!0})}let Z=document.createElement("div");Z.className="cw-nice-scroll",Object.assign(Z.style,i.feedContainer),l.appendChild(Z);async function q(){e&&(v.style.display="block",v.innerHTML="\u{1F504} Sincronizando...");try{let x=await be.fetchData();x&&x.broadcast&&(_t(x.broadcast),I(),e&&(B(),v.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{v.style.display="none"},1500)))}catch{e&&(v.innerHTML="\u26A0\uFE0F Offline")}}function I(){let x=document.getElementById("cw-btn-broadcast");if(!x)return;let k=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(_e.some(F=>!k.includes(F.id))){if(x.classList.add("has-new"),!x.querySelector(".cw-badge")){let F=document.createElement("div");F.className="cw-badge",Object.assign(F.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),x.appendChild(F)}}else{x.classList.remove("has-new");let F=x.querySelector(".cw-badge");F&&F.remove()}}function B(){Z.innerHTML="";let x=l.querySelector("#cw-bau-widget");x&&x.remove();let k=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),S=[..._e].sort((m,D)=>{let U=new Date(m.date).getTime()||0;return(new Date(D.date).getTime()||0)-U}),F=S.findIndex(m=>m.title&&m.title.toLowerCase().includes("disponibilidade bau"));if(F!==-1){let m=S[F];S.splice(F,1);let D=document.createElement("div");D.id="cw-bau-widget",Object.assign(D.style,i.bauContainer);let U=[],K=(m.text||"").split(`
`),g=/\d{1,2}\/\d{1,2}/,A="\u{1F4C5}";if(K.forEach(H=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(H)?A="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(H)&&(A="\u{1F1EA}\u{1F1F8}");let Q=H.match(g);if(Q){let ne=Q[0],se=A;/🇧🇷|🇵🇹|PT|BR/i.test(H)?se="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(H)&&(se="\u{1F1EA}\u{1F1F8}"),U.some(oe=>oe.flag===se&&oe.date===ne)||U.push({flag:se,date:ne})}}),U.length===0){let H=(m.text||"").match(/\d{1,2}\/\d{1,2}/g);H&&[...new Set(H)].forEach(Q=>U.push({flag:"\u{1F4C5}",date:Q}))}let C="",R='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(R=`
              ...
              `),U.length>0?C=`
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                      <div style="flex:1; display:flex; gap:8px;">${U.map(Q=>`
          ...
          `,v.after(D);let _=D.querySelector("#cw-bau-toggle-btn"),X=D.querySelector("#cw-bau-full");if(_&&X&&(_.onclick=()=>{let H=X.style.display==="none";X.style.display=H?"block":"none",_.textContent=H?"Ocultar":"Detalhes"}),window._cwIsAdmin){let H=D.querySelector(".cw-bau-edit");H&&(H.onclick=()=>G(m))}}let y=S.sort((m,D)=>{let U=k.includes(m.id),K=k.includes(D.id);return U===K?0:U?1:-1});if(y.length===0&&!F){let m=document.createElement("div");Object.assign(m.style,i.emptyState),m.innerHTML=`
           ...
           `,Z.appendChild(m)}let O=y.filter(m=>!k.includes(m.id)),W=y.filter(m=>k.includes(m.id));if(O.forEach(m=>Z.appendChild(j(m,!1))),W.length>0){let m=document.createElement("div");Object.assign(m.style,i.historyDivider),m.innerHTML=`<span>Hist\xF3rico (${W.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let D=document.createElement("div");Object.assign(D.style,i.historyContainer),W.forEach(K=>D.appendChild(j(K,!0)));let U=!1;m.onclick=()=>{$.playClick(),U=!U,D.style.display=U?"flex":"none",m.querySelector("svg").style.transform=U?"rotate(180deg)":"rotate(0deg)"},Z.appendChild(m),Z.appendChild(D)}}function j(x,k){let S=document.createElement("div");Object.assign(S.style,k?i.cardHistory:i.card);let F=r[x.type]||r.info,y=document.createElement("div");Object.assign(y.style,i.cardHeader);let O=document.createElement("div");Object.assign(O.style,i.typeTag,{color:F.color,background:F.bg}),O.innerHTML=`${F.icon} <span>${x.type}</span>`;let W=document.createElement("span");if(Object.assign(W.style,i.dateTag),W.textContent=n(x.date),y.appendChild(O),k)y.appendChild(W);else{let g=document.createElement("button");g.className="cw-btn-interactive",Object.assign(g.style,i.dismissBtn),g.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',g.onmouseenter=()=>{g.style.color="#1e8e3e",g.style.background="#e6f4ea",g.style.borderColor="#1e8e3e"},g.onmouseleave=()=>{g.style.color="#5f6368",g.style.background="#fff",g.style.borderColor="rgba(0,0,0,0.1)"},g.onclick=A=>{A.stopPropagation(),$.playClick(),S.style.transform="translateX(20px)",S.style.opacity="0",setTimeout(()=>{let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");C.push(x.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(C)),B(),I()},200)},y.appendChild(g)}let m=document.createElement("div");Object.assign(m.style,i.cardContent);let D=document.createElement("div");Object.assign(D.style,i.msgTitle),D.textContent=x.title;let U=document.createElement("div");Object.assign(U.style,i.msgBody),U.innerHTML=p(x.text);let K=document.createElement("div");if(Object.assign(K.style,i.msgMeta),K.innerHTML=`Publicado por <b>${x.author||"Sistema"}</b>`,k||(K.innerHTML+=` \u2022 ${n(x.date)}`),m.appendChild(D),m.appendChild(U),m.appendChild(K),S.appendChild(y),S.appendChild(m),window._cwIsAdmin){let g=document.createElement("div");g.className="cw-card-actions";let A=document.createElement("button");A.className="cw-action-btn edit",A.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',A.onclick=()=>G(x);let C=document.createElement("button");C.className="cw-action-btn delete",C.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',C.onclick=()=>J(x.id),g.appendChild(A),g.appendChild(C),S.appendChild(g)}return S}let M=be.getCachedBroadcasts();M.length>0&&(_t(M),B()),setTimeout(u,500),q(),o||(o=setInterval(q,sa));let T=document.createElement("div");Object.assign(T.style,Ae),T.className="no-drag",l.appendChild(T),Te(l,T),document.body.appendChild(l);let w=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),L=_e.some(x=>!w.includes(x.id));return{toggle:d,hasUnread:L}}function ko(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let r=document.createElement("div");Object.assign(r.style,o.title);let s=document.createElement("div");Object.assign(s.style,o.text);let p=document.createElement("div");Object.assign(p.style,o.dotsContainer);let l=document.createElement("div");Object.assign(l.style,o.btnContainer);let c=document.createElement("button");c.textContent="Pular",Object.assign(c.style,o.btn,o.btnSkip),c.onmouseover=()=>c.style.color="#202124",c.onmouseout=()=>c.style.color="#5f6368";let d=document.createElement("button");d.textContent="Pr\xF3ximo",Object.assign(d.style,o.btn,o.btnNext),d.onmouseover=()=>d.style.transform="scale(1.05)",d.onmouseout=()=>d.style.transform="scale(1)",l.appendChild(c),l.appendChild(d),n.appendChild(i),n.appendChild(r),n.appendChild(s),n.appendChild(p),n.appendChild(l),a.appendChild(n),document.body.appendChild(a);function h(f){let u=t[f];i.textContent=u.icon,r.textContent=u.title,s.textContent=u.text,p.innerHTML="",t.forEach((v,E)=>{let G=document.createElement("div");Object.assign(G.style,o.dot),E===f&&Object.assign(G.style,o.dotActive),p.appendChild(G)}),u.isLast?(c.style.display="none",d.textContent="Come\xE7ar \u{1F680}",d.style.width="100%"):(c.style.display="block",d.textContent="Pr\xF3ximo",d.style.width="auto")}function b(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),$.playSuccess(),Y("Tudo pronto! Use o menu flutuante.")}d.onclick=()=>{$.playClick(),e<t.length-1?(e++,h(e)):b()},c.onclick=async()=>{await xe("Pular o tutorial?")&&b()},h(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var Fo={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function Oo(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&la(t)}function la(t){let e=Fo.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let r=document.createElement("div");Object.assign(r.style,a.badge),r.textContent=`Atualiza\xE7\xE3o ${t}`;let s=document.createElement("div");Object.assign(s.style,a.icon);let p=document.createElement("div");Object.assign(p.style,a.title);let l=document.createElement("div");Object.assign(l.style,a.text);let c=document.createElement("div");Object.assign(c.style,a.dotsContainer);let d=document.createElement("button");Object.assign(d.style,a.btn),d.onmouseover=()=>d.style.transform="scale(1.02)",d.onmouseout=()=>d.style.transform="scale(1)",i.appendChild(r),i.appendChild(s),i.appendChild(p),i.appendChild(l),i.appendChild(c),i.appendChild(d),n.appendChild(i),document.body.appendChild(n);function h(f){let u=e[f];s.textContent=u.icon,p.textContent=u.title,l.textContent=u.text,c.innerHTML="",e.forEach((v,E)=>{let G=document.createElement("div");Object.assign(G.style,a.dot),E===f&&Object.assign(G.style,a.dotActive),c.appendChild(G)}),f===e.length-1?d.textContent="Entendi, vamos l\xE1! \u{1F44D}":d.textContent="Pr\xF3ximo"}function b(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),$.playSuccess(),Y(`TechSol atualizado para ${t}!`)}d.onclick=()=>{$.playClick(),o<e.length-1?(o++,h(o)):b()},h(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Io="cw_timezone_pinned",Mt=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],ca=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function Lo(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Io)||"[]"),i="",r="all",s=new Date;s.setHours(14,0,0,0);let p={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},l={container:{display:"flex",flexDirection:"column",height:"100%",background:p.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:p.surface,borderBottom:`1px solid ${p.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:p.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:p.primary,borderBottomColor:p.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:p.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:p.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${p.border}`,background:p.surface,color:p.textSub,transition:"all 0.2s"},chipActive:{background:p.primaryBg,color:p.primary,borderColor:p.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:p.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${p.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:p.surface,border:`1px solid ${p.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:p.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},c=document.createElement("div");c.id="timezone-popup",c.classList.add("cw-module-window"),Object.assign(c.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let h=pe(c,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:c},()=>k());c.appendChild(h);let b=document.createElement("div");Object.assign(b.style,l.container),c.appendChild(b);let f=document.createElement("div");Object.assign(f.style,l.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,l.tabBtn,l.tabActive);let v=document.createElement("div");v.textContent="Planejador",Object.assign(v.style,l.tabBtn),f.appendChild(u),f.appendChild(v),b.appendChild(f);let E=document.createElement("div");Object.assign(E.style,l.toolbar);let G=document.createElement("div");Object.assign(G.style,l.searchInputWrapper);let N=document.createElement("div");N.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(N.style,l.searchIcon);let z=document.createElement("input");z.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(z.style,l.searchInput),z.onfocus=()=>{z.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",z.style.borderColor="rgba(26,115,232,0.3)"},z.onblur=()=>{z.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",z.style.borderColor="transparent"},z.oninput=S=>{i=S.target.value.toLowerCase(),T()},G.appendChild(N),G.appendChild(z),E.appendChild(G);let J=document.createElement("div");Object.assign(J.style,l.chipsRow),ca.forEach(S=>{let F=document.createElement("div");F.textContent=S.label,F.id=`tz-filter-${S.id}`,Object.assign(F.style,l.chip),S.id===r&&Object.assign(F.style,l.chipActive),F.onclick=()=>{$.playClick(),r=S.id,Array.from(J.children).forEach(y=>{Object.assign(y.style,l.chip)}),Object.assign(F.style,l.chipActive),T()},J.appendChild(F)}),E.appendChild(J),b.appendChild(E);let Z=document.createElement("div");Object.assign(Z.style,l.listContainer);let q=document.createElement("style");q.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",b.appendChild(q);let I=document.createElement("div");Object.assign(I.style,l.plannerWrapper,{display:"none"}),b.appendChild(Z),b.appendChild(I),u.onclick=()=>B("live"),v.onclick=()=>B("plan");function B(S){$.playClick(),S==="live"?(Object.assign(u.style,l.tabActive),Object.assign(v.style,l.tabBtn),v.style.borderBottomColor="transparent",Z.style.display="flex",E.style.display="flex",I.style.display="none",L()):(Object.assign(v.style,l.tabActive),Object.assign(u.style,l.tabBtn),u.style.borderBottomColor="transparent",I.style.display="flex",Z.style.display="none",E.style.display="none",x(),w())}function j(S){return S>=9&&S<17?{color:p.success,bg:p.successBg,label:"Aberto",icon:"\u{1F7E2}"}:S>=8&&S<9?{color:p.warning,bg:p.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:S>=17&&S<19?{color:p.warning,bg:p.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:p.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function M(S){n.includes(S)?n=n.filter(F=>F!==S):n.push(S),localStorage.setItem(Io,JSON.stringify(n)),T(),$.playClick()}function T(){Z.innerHTML="";let S=new Date,F=Mt.filter(O=>{let W=O.name.toLowerCase().includes(i)||O.label.toLowerCase().includes(i),m=r==="all"||O.region===r;return W&&m});if(F.sort((O,W)=>{let m=n.includes(O.id),D=n.includes(W.id);return m&&!D?-1:!m&&D?1:O.name.localeCompare(W.name)}),F.length===0){Z.innerHTML=`
            ...
            `,g.onmouseenter=()=>{g.style.transform="translateY(-2px)",g.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},g.onmouseleave=()=>{g.style.transform="translateY(0)",g.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let R=g.querySelector(".cw-pin-btn");R.onmouseenter=()=>{R.style.backgroundColor="#F1F3F4"},R.onmouseleave=()=>{R.style.backgroundColor="transparent"},R.onclick=_=>{_.stopPropagation(),M(O.id)},g.onclick=()=>{a=O.id,B("plan")},Z.appendChild(g)});let y=document.createElement("div");y.style.height="20px",y.style.width="100%",Z.appendChild(y)}function w(){I.innerHTML="";let S=document.createElement("div"),F=document.createElement("label");F.textContent="Onde est\xE1 o cliente?",F.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let y=document.createElement("select");Object.assign(y.style,jt),y.style.padding="14px",[...Mt].sort((ie,oe)=>ie.name.localeCompare(oe.name)).forEach(ie=>{let oe=document.createElement("option");oe.value=ie.id,oe.textContent=`${ie.flag} ${ie.name} (${ie.zone})`,ie.id===a&&(oe.selected=!0),y.appendChild(oe)}),y.onchange=ie=>{a=ie.target.value,se(),$.playClick()},S.appendChild(F),S.appendChild(y),I.appendChild(S);let W=document.createElement("div");Object.assign(W.style,l.timeComparisonRow);let m=document.createElement("div");Object.assign(m.style,l.timeCard),m.style.backgroundColor="#F8FAFF",m.style.borderColor="#E8F0FE",m.innerHTML=`
        ...
        `;let D=document.createElement("div");Object.assign(D.style,l.timeCard),D.style.backgroundColor="#FFF8E1",D.style.borderColor="#FEF7E0",D.innerHTML=`
            <div style="font-size:11px; font-weight:700; color:#E37400; text-transform:uppercase; letter-spacing:0.5px;">Cliente</div>
            <div id="cw-time-display-client" style="font-size:28px; font-weight:700; color:#E37400; border:none; background:transparent; width:100%; text-align:center; font-family:'Google Sans';">--:--</div>
            <div id="cw-client-label" style="font-size:12px; color:#5F6368;">...</div>
        `,W.appendChild(m),W.appendChild(D),I.appendChild(W);let U=document.createElement("div");U.id="cw-planner-status",Object.assign(U.style,l.statusBadge),I.appendChild(U);let K=document.createElement("div");Object.assign(K.style,{padding:"0 4px",marginTop:"12px"});let g=document.createElement("div");g.textContent="Arraste para simular o hor\xE1rio:",g.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let A=document.createElement("div");Object.assign(A.style,l.timelineContainer);let C=document.createElement("div");Object.assign(C.style,l.timelineTrack);let R=document.createElement("div");Object.assign(R.style,l.dayZone),C.appendChild(R);let _=document.createElement("input");_.type="range",_.min="0",_.max="1439",_.step="15",_.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let X=document.createElement("div");X.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",X.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",A.appendChild(C),A.appendChild(_),A.appendChild(X),K.appendChild(g),K.appendChild(A),I.appendChild(K);let H=m.querySelector("#cw-time-input-br"),Q=D.querySelector("#cw-time-display-client"),ne=D.querySelector("#cw-client-label");function se(){let ie=Mt.find(Me=>Me.id===a);ne.textContent=`${ie.flag} ${ie.label} (${ie.zone})`;let oe=s.getHours(),ce=s.getMinutes(),We=`${String(oe).padStart(2,"0")}:${String(ce).padStart(2,"0")}`;H.value=We,_.value=oe*60+ce;let tt=s.toLocaleTimeString("pt-BR",{timeZone:ie.zone,hour:"2-digit",minute:"2-digit"});Q.textContent=tt;let qe=parseInt(tt.split(":")[0]);qe>=9&&qe<17?(U.style.background=p.successBg,U.style.color=p.success,U.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):qe>=8&&qe<9||qe>=17&&qe<19?(U.style.background=p.warningBg,U.style.color=p.warning,U.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(U.style.background=p.errorBg,U.style.color=p.error,U.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}_.oninput=ie=>{let oe=parseInt(ie.target.value);s.setHours(Math.floor(oe/60)),s.setMinutes(oe%60),se()},H.oninput=ie=>{let[oe,ce]=ie.target.value.split(":");oe&&ce&&(s.setHours(parseInt(oe)),s.setMinutes(parseInt(ce)),se())},se()}function L(){T(),o||(o=setInterval(T,6e4))}function x(){o&&(clearInterval(o),o=null)}function k(){e=!e,ue(e,c,"cw-btn-timezone"),e?B("live"):x()}return document.body.appendChild(c),k}function qo(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let w=document.createElement("style");w.id="cw-lib-styles",w.innerHTML=`
        ...
        `,document.head.appendChild(w)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},r={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},s=document.createElement("div");s.id="library-popup",s.classList.add("cw-module-window"),Object.assign(s.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let l=pe(s,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:s},()=>T());s.appendChild(l);let c=document.createElement("div");Object.assign(c.style,r.container),s.appendChild(c);let d=document.createElement("div");Object.assign(d.style,r.tabHeader);let h=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];h.forEach(w=>{let L=document.createElement("div");L.innerHTML=`${w.icon} ${w.label}`,L.id=`lib-tab-${w.id}`,Object.assign(L.style,r.tabBtn),w.id===o&&Object.assign(L.style,r.tabActive),L.onmouseenter=()=>$.playHover(),L.onclick=()=>J(w.id),d.appendChild(L)}),c.appendChild(d);let b=document.createElement("div");Object.assign(b.style,r.listContainer),c.appendChild(b);let f=document.createElement("div");f.className="cw-fab cw-tactile",Object.assign(f.style,r.fab),f.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',f.onmouseenter=()=>f.style.transform="scale(1.1)",f.onmouseleave=()=>f.style.transform="scale(1)",f.onclick=()=>q(),c.appendChild(f),a=document.createElement("div"),Object.assign(a.style,r.editorOverlay);let u=document.createElement("div");Object.assign(u.style,r.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let v=document.createElement("button");v.innerHTML="Cancelar",v.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",v.onclick=I,u.appendChild(v),a.appendChild(u);let E=document.createElement("div");Object.assign(E.style,r.editorBody),a.appendChild(E);let G=document.createElement("div");G.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let N=document.createElement("button");N.textContent="Salvar",N.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",N.onclick=B,G.appendChild(N),a.appendChild(G),c.appendChild(a);let z=document.createElement("div");Object.assign(z.style,Ae),z.className="no-drag",s.appendChild(z),Te(s,z),document.body.appendChild(s);function J(w){$.playClick(),o=w,h.forEach(L=>{let x=document.getElementById(`lib-tab-${L.id}`);L.id===w?Object.assign(x.style,r.tabActive):Object.assign(x.style,r.tabBtn)}),Z()}function Z(){b.innerHTML="";let w=he.getSnippets(o);if(w.length===0){b.innerHTML=`
            ...
            `;return}w.forEach(L=>{let x=document.createElement("div");x.className="cw-lib-card",Object.assign(x.style,r.card),L.isCode&&(x.style.borderLeft=`4px solid ${i.primary}`,x.style.background="rgba(0, 122, 255, 0.02)");let k=L.content;if(L.isRich){let S=document.createElement("div");S.innerHTML=L.content;let F=S.querySelector("img");k=S.innerText.substring(0,150)+(S.innerText.length>150?"...":""),F&&(k="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+k)}x.innerHTML=`
                <div style="${M(r.cardHeader)}">
                    <div style="${M(r.cardTitle)}">${L.title}</div>
                ...
                <div style="${M(r.cardPreview)}; ${L.isCode?"font-family:'Roboto Mono', monospace; font-size:11px;":""}">${k}</div>
            ...
            `,x.onmouseenter=()=>{$.playHover()},x.querySelector(".cw-act-copy").onclick=S=>{if(S.stopPropagation(),$.playClick(),L.isRich){let F=new Blob([L.content],{type:"text/html"}),y=document.createElement("div");y.style.whiteSpace="pre-wrap",y.innerHTML=L.content;let O=new Blob([y.innerText],{type:"text/plain"}),W=[new ClipboardItem({"text/html":F,"text/plain":O})];navigator.clipboard.write(W)}else navigator.clipboard.writeText(L.content);Y("Copiado!")},x.querySelector(".cw-act-edit").onclick=S=>{S.stopPropagation(),$.playClick(),q(L)},x.querySelector(".cw-act-del").onclick=async S=>{S.stopPropagation(),$.playClick(),await xe("Excluir este item?")&&(he.delete(L.id),Z(),Y("Item exclu\xEDdo."))},b.appendChild(x)})}function q(w=null){n=w?w.id:null,E.innerHTML="",E.appendChild(j("title","T\xEDtulo / Nome",w?w.title:"")),o==="email"&&E.appendChild(j("subject","Assunto do Email",w?w.subject:""));let L="Conte\xFAdo";o==="email"&&(L="Corpo do Email (HTML)"),o==="note"&&(L="Texto da Nota (Reason)"),E.appendChild(j("content",L,w?w.content:"",{isRich:!0,isCode:w?w.isCode:!1})),u.querySelector("span").textContent=w?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let x=E.querySelector("input");x&&x.focus()},300)}function I(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function B(){let w=E.querySelector("#cw-inp-title"),L=E.querySelector("#cw-inp-content"),x=w.value.trim(),k=L.contentEditable==="true"?L.innerHTML:L.value.trim(),S=L.getAttribute("data-is-code")==="true";if(!x||!k||k==="<br>"){Y("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let F={id:n,type:o,title:x,content:k,isCode:S,isRich:L.contentEditable==="true"};if(o==="email"){let y=E.querySelector("#cw-inp-subject").value.trim();if(!y){Y("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}F.subject=y}N.textContent="Salvando...",await he.save(F),N.textContent="Salvar",I(),Z(),Y("Salvo com sucesso!"),$.playSuccess()}function j(w,L,x,k={}){let S=document.createElement("div");Object.assign(S.style,r.inputGroup);let F=document.createElement("label");F.textContent=L,Object.assign(F.style,r.label);let y;if(k.isRich){let O=document.createElement("div");O.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",O.innerHTML=`
            ...
            `,y=document.createElement("div"),y.contentEditable="true",Object.assign(y.style,r.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),y.innerHTML=x||"",k.isCode&&(y.style.fontFamily="'Roboto Mono', monospace",y.style.backgroundColor="#F8F9FA",y.setAttribute("data-is-code","true")),O.querySelectorAll(".cw-toolbar-btn").forEach(W=>{W.onmouseenter=()=>$.playHover(),W.onmousedown=()=>$.playClick()}),O.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),y.focus()},O.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),y.focus()},O.querySelector(".cw-tb-code").onclick=W=>{let D=!(y.getAttribute("data-is-code")==="true");y.setAttribute("data-is-code",D),y.style.fontFamily=D?"'Roboto Mono', monospace":"inherit",y.style.backgroundColor=D?"rgba(0, 122, 255, 0.03)":i.surface,D?W.currentTarget.classList.add("active"):W.currentTarget.classList.remove("active"),y.focus()},O.querySelector(".cw-tb-img").onclick=async()=>{let W=await Kt("Cole a URL da imagem:");W&&(document.execCommand("insertImage",!1,W),y.querySelectorAll("img").forEach(D=>{D.style.maxWidth="100%",D.style.borderRadius="8px"}))},y.onpaste=W=>{let m=(W.clipboardData||W.originalEvent.clipboardData).items;for(let D of m)if(D.kind==="file"&&D.type.startsWith("image/")){W.preventDefault();let U=D.getAsFile(),K=new FileReader;K.onload=g=>{let A=`<img src="${g.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,A)},K.readAsDataURL(U)}},S.appendChild(F),S.appendChild(O)}else y=document.createElement("input"),y.type="text",Object.assign(y.style,r.input),y.value=x||"",S.appendChild(F);return y.id=`cw-inp-${w}`,y.onfocus=()=>{y.style.borderColor=i.primary,y.style.boxShadow=`0 0 0 2px ${i.primaryBg}`},y.onblur=()=>{y.style.borderColor=i.border,y.style.boxShadow="none"},S.appendChild(y),S}function M(w){return Object.entries(w).map(([L,x])=>`${L.replace(/[A-Z]/g,k=>"-"+k.toLowerCase())}:${x}`).join(";")}function T(){e=!e,ue(e,s,"cw-btn-library"),e&&Z()}return T}function _o(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let h=document.createElement("style");h.id=a,h.innerHTML=`
    ...
    `;let l=p.querySelector("#cw-config-sound-toggle");l.onchange=h=>{$.setMuted(!h.target.checked),h.target.checked&&$.playClick()},s.appendChild(p);let c=document.createElement("div");c.className="cw-configs-section",c.innerHTML=`
  ...
  `,document.head.appendChild(t)};function No(){Mo();let t=!1,e=null,o=1,a=4,n=document.createElement("div");n.id="bau-form-popup",n.className="bau-popup cw-module-window",n.style.display="none";let r=pe(n,"BAU Form","v1.2.0","Solicite a abertura de casos BAU em um fluxo guiado.",{googleLine:null},()=>F());n.appendChild(r);let s=document.createElement("div");s.className="bau-progress-indicator",n.appendChild(s);let p=document.createElement("div");p.className="bau-content",n.appendChild(p);let l=document.createElement("form");p.appendChild(l);let c=document.createElement("div");c.className="bau-step active",c.id="bau-step-1";let d=document.createElement("div");d.className="bau-card bau-context-card";let h=document.createElement("div");h.className="bau-header-banner",d.appendChild(h);let b=document.createElement("div");b.innerHTML=`
    ...
    `,u.querySelectorAll(".bau-task-item").forEach(y=>{let O=y.querySelector("input");O.addEventListener("change",()=>{y.classList.toggle("active",O.checked),O.checked&&$.playClick()})}),f.appendChild(u),l.appendChild(f);let v=document.createElement("div");v.className="bau-step",v.id="bau-step-3";let E=document.createElement("div");E.className="bau-card";let G=document.createElement("label");G.className="bau-label",G.textContent="Justificativa / Descri\xE7\xE3o",E.appendChild(G);let N=document.createElement("textarea");N.name="description",N.required=!0,N.className="bau-textarea",N.placeholder="Descreva detalhadamente o que precisa ser feito...",N.style.minHeight="120px",E.appendChild(N);let z=document.createElement("label");z.className="bau-label",z.textContent="Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",z.style.marginTop="20px",E.appendChild(z);let J=document.createElement("div");J.className="bau-availability-container";for(let y=1;y<=3;y++){let O=document.createElement("input");O.type="datetime-local",O.name=`availability_${y}`,O.required=y===1,O.className="bau-input",J.appendChild(O)}E.appendChild(J);let Z=document.createElement("div");Z.className="bau-availability-hint",E.appendChild(Z),v.appendChild(E),l.appendChild(v);let q=document.createElement("div");q.className="bau-step",q.id="bau-step-4";let I=document.createElement("div");I.className="bau-card",I.innerHTML=`
    ...
    `,q.appendChild(I),l.appendChild(q);let B=document.createElement("div");B.className="bau-footer";let j=document.createElement("button");j.type="button",j.className="bau-btn-secondary",j.textContent="Voltar",B.appendChild(j);let M=document.createElement("button");M.type="button",M.className="bau-btn-primary",M.textContent="Pr\xF3ximo",B.appendChild(M);let T=document.createElement("button");T.type="submit",T.className="bau-btn-submit",T.innerHTML="<span>\u{1F4DD}</span> Enviar para o TL",T.style.display="none",B.appendChild(T),n.appendChild(B),document.body.appendChild(n);function w(){l.querySelectorAll(".bau-step").forEach((y,O)=>{y.classList.toggle("active",O+1===o)}),s.innerHTML="";for(let y=1;y<=a;y++){let O=document.createElement("div");O.className=`bau-progress-step ${y===o?"active":y<o?"completed":""}`,O.textContent=y,s.appendChild(O)}j.style.display=o>1?"inline-block":"none",M.style.display=o<a?"inline-block":"none",T.style.display=o===a?"inline-block":"none",o===4&&L()}function L(){let y=new FormData(l),O=Object.fromEntries(y.entries()),W=y.getAll("taskType"),m=[O.availability_1,O.availability_2,O.availability_3].filter(U=>U&&U.trim()!=="").map(U=>U.replace("T"," ")).join(" | "),D=document.getElementById("bau-confirmation-details");D.innerHTML=`
            ...
            <div class="bau-confirm-row"><span class="bau-confirm-label">Email:</span><span class="bau-confirm-value">${O.email||"N/A"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Programa:</span><span class="bau-confirm-value">${O.salesProgram||"N/A"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Speakeasy ID:</span><span class="bau-confirm-value">${O.seId||"N/A"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Motivo:</span><span class="bau-confirm-value">${O.reason}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Tasks:</span><span class="bau-confirm-value">${W.join(", ")}</span></div>
            <div class="bau-confirm-row" style="flex-direction: column; align-items: flex-start; gap: 8px;">
                ...
                <div style="font-size: 13px; color: ${te.textPrimary}; background: #f8f9fa; padding: 12px; border-radius: 8px; width: 100%; box-sizing: border-box; white-space: pre-wrap;">${O.description}</div>
            </div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Disponibilidade:</span><span class="bau-confirm-value">${m||"N/A"}</span></div>
        `}function x(y){let O=document.getElementById(`bau-step-${y}`);if(!O)return!0;if(y===2){let m=l.querySelector('select[name="reason"]').value,D=Array.from(l.querySelectorAll('input[name="taskType"]:checked'));return m?D.length===0?(Y("Erro: Selecione pelo menos uma Task.","error"),!1):!0:(Y("Erro: O Motivo da Abertura \xE9 obrigat\xF3rio.","error"),!1)}let W=O.querySelectorAll("[required]");for(let m of W)if(!m.value.trim()){let D="",U=m.closest("div")?.querySelector(".bau-label");if(U)D=U.textContent;else{let K=m.closest(".bau-inline-field")?.querySelector("span");D=K?K.textContent:m.placeholder||m.name}return Y(`Erro: O campo '${D.replace(":","")}' \xE9 obrigat\xF3rio.`,{error:!0}),m.classList.add("input-error"),setTimeout(()=>m.classList.remove("input-error"),3e3),!1}return!0}M.onclick=()=>{x(o)&&(o++,w(),$.playClick())},j.onclick=()=>{o>1&&(o--,w(),$.playClick())};async function k(){let y=await we()||{};e=y,S(y)}function S(y){if(!y)return;l.querySelector('[name="advName"]').value=y.advName||"",l.querySelector('[name="cid"]').value=y.cid||"",l.querySelector('[name="amName"]').value=y.amName||"",l.querySelector('[name="seId"]').value=y.seId||"";let O=document.getElementById("bau-top-se-search");O&&(O.onclick=async U=>{U.stopPropagation(),U.preventDefault(),await lt("bau-context-se-id-input")});let W=document.getElementById("bau-all-data");W&&(W.innerHTML="",[{label:"Email",name:"email",value:y.email,type:"text"},{label:"Idioma",name:"language",value:y.language,type:"select",options:["Portugu\xEAs","Espanhol"]},{label:"Programa",name:"salesProgram",value:y.salesProgram,type:"text"},{label:"Timezone",name:"timezone",value:y.timezone,type:"text"}].forEach(K=>{let g=document.createElement("div");g.className="bau-inline-field",g.title="Clique para editar";let A=document.createElement("b");A.textContent=`${K.label}:`,g.appendChild(A);let C;if(K.type==="select"){C=document.createElement("select"),C.name=K.name,C.className="bau-inline-input",C.style.appearance="none",C.style.cursor="pointer";let R=document.createElement("option");R.value="",R.textContent=`Selecionar ${K.label}...`,C.appendChild(R),K.options.forEach(_=>{let X=document.createElement("option");X.value=_,X.textContent=_,K.value&&(K.value.toLowerCase().includes(_.toLowerCase())||_.toLowerCase().includes(K.value.toLowerCase()))&&(X.selected=!0),C.appendChild(X)})}else C=document.createElement("input"),C.type="text",C.name=K.name,C.className="bau-inline-input",C.value=K.value||"",C.placeholder=`Preencher ${K.label}...`;C.tagName==="INPUT"&&(!K.value||K.value==="N/A"||K.value==="---")&&(C.value=""),g.appendChild(C),g.onclick=()=>C.focus(),W.appendChild(g)})),Z.innerHTML=`\u2139\uFE0F Lembrete: Os hor\xE1rios s\xE3o baseados no seu fuso hor\xE1rio atual (${y.timezone||"n\xE3o detectado"}). Fornecer mais de uma op\xE7\xE3o aumenta a chance de agendamento r\xE1pido.`,[{key:"advName",label:"Nome do Anunciante"},{key:"cid",label:"Customer ID (CID)"},{key:"amName",label:"Account Manager"}].filter(U=>!y[U.key]||y[U.key]==="N/A"||y[U.key].trim()==="---").length>0?h.innerHTML="<span>\u26A0\uFE0F</span> Alguns dados n\xE3o foram encontrados. Por favor, complete os campos edit\xE1veis acima.":h.innerHTML="<span>\u2705</span> Dados do CRM carregados. Voc\xEA pode editar qualquer campo clicando nele."}l.onsubmit=async y=>{if(y.preventDefault(),!x(a))return;let O=T.innerHTML;T.disabled=!0,T.innerHTML="Enviando...";let W=new FormData(l),m=Object.fromEntries(W.entries()),D=W.getAll("taskType"),U={caseId:e.caseId||"",cid:m.cid||e.cid||"",seId:m.seId||e.seId||"",advName:m.advName||e.advName||"",email:m.email||e.email||"",language:m.language||e.language||"",amName:m.amName||e.amName||"",salesProgram:m.salesProgram||e.salesProgram||"",site:m.site||e.site||"",timezone:m.timezone||e.timezone||"",reason:m.reason,taskType:D.join(", "),description:m.description,availability:`${m.availability_1||""} | ${m.availability_2||""} | ${m.availability_3||""}`.trim()};try{await ro(U,e.agentEmail||"anon"),$.playSuccess(),Y("Escalonamento enviado com sucesso!","success"),l.reset(),o=1,e=null,w(),F()}catch(K){console.error("Erro BAU:",K),Y("Falha ao enviar: "+(K.message||"Erro desconhecido"),"error")}finally{T.disabled=!1,T.innerHTML=O}};async function F(){t=!t,n.style.display=t?"flex":"none",t&&!e&&(o=1,w(),await k()),ue(t,n,"cw-btn-bauform")}return w(),F}function pa(){if(window.techSolInitialized){Et();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Ht();try{$.initGlobalListeners(),$.playStartup()}catch(c){console.warn("\xC1udio bloqueado:",c)}be.fetchTips(),Et();let e=bo(),o=wo(),a=Co(),n=Ao(),i=Lo(),r=qo(),s=_o(),p=No(),l=To();so({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:r,toggleConfigs:s,toggleBAUForm:p,broadcastControl:l}),setTimeout(()=>{be.logEvent("App","Start","Session Start"),ko(),setTimeout(()=>{Oo(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),Y("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}pa();})();
