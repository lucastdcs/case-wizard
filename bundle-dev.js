...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var St={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ht={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Gt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Ie=t=>new Promise(e=>setTimeout(e,t));async function Ho(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Ie(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let s=Math.floor(Math.random()*60)+30;a===0&&(s=150),a>e.length-3&&(s=30),await Ie(s)}await Ie(600),o&&(o.style.display="none")}async function Ct(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Ie(200);let e=await Nt(),o=Rt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),s=t.querySelector("#p3"),r=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),s&&(s.textContent=o.suffix),await Ie(300);let l=a?a.querySelector("svg"):null;if(l&&(l.style.opacity="1",l.style.transform="scale(1)"),await Ie(400),n&&(n.style.opacity="1"),H.playStartup(),i&&await Ho(i,o.name),s&&(s.style.opacity="1",s.style.transform="translateY(0)"),o.isFriday&&r){await Ie(400),r.style.display="block",r.offsetWidth;let d=r.querySelector(".sextou-badge");d&&(d.style.opacity="1",d.style.transform="scale(1)")}await Ie(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Ie(900),t.parentNode&&t.parentNode.removeChild(t)}}function jt(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,s=a-e.height-n,r=parseFloat(t.style.left)||e.left,l=parseFloat(t.style.top)||e.top,d=Math.max(n,Math.min(r,i)),c=Math.max(n,Math.min(l,s));if(d!==r||c!==l){let p=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${d}px`,t.style.top=`${c}px`,setTimeout(()=>{t.style.transition=p},300)}}var Ae={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Te(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,s=a.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),l=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),d=i,c=s,p=!1;function x(u){d=u.clientX,c=u.clientY,p||(window.requestAnimationFrame(()=>{b(),p=!1}),p=!0)}function b(){let u=r+(d-i),y=l+(c-s);u>360&&(t.style.width=u+"px"),y>300&&(t.style.height=y+"px")}function g(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",g),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",g)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Vt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Ut(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Wt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function be(t,e={}){return new Promise(o=>{let a=Ut(),n=Wt(),i=e.danger?"#FF3B30":"#007AFF",s=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let r=c=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(c)},300)},l=n.querySelector("#cw-conf-cancel"),d=n.querySelector("#cw-conf-ok");[l,d].forEach(c=>c.onmouseenter=()=>H.playHover()),l.onclick=()=>{H.playClick(),r(!1)},d.onclick=()=>{H.playClick(),r(!0)}})}function Yt(t,e=""){return new Promise(o=>{let a=Ut(),n=Wt();n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(L)}let d=document.createElement("div");d.className="cw-zen-container";let c=document.createElement("div");Object.assign(c.style,{display:"none"});let p=document.createElement("div");p.className="cw-screens-container",c.appendChild(p),d.innerHTML=`
    ...
    `;let x=d.querySelector(".cw-hero-grid"),b=d.querySelector(".cw-acc-container"),g=d.querySelector(".cw-results-container"),u=d.querySelector(".cw-search-input"),y=d.querySelector(".cw-status-bar"),v=d.querySelector(".cw-status-text"),D=d.querySelector(".cw-footer-icons");s.forEach(([L,T])=>{let B=i(T.name),j=document.createElement("div");j.className="cw-hero-card",j.id=`hero-${L}`,j.style.setProperty("--hero-color",B.color),j.innerHTML=`
        ...
        `,j.onclick=I=>{if(I.target.closest(".cw-step-btn"))return;let A=a[L]?a[L].count:0;R(L,A>0?-A:1,T)},j.querySelector(".minus").onclick=()=>R(L,-1,T),j.querySelector(".plus").onclick=()=>R(L,1,T),j.dataset.color=B.color,x.appendChild(j)});function q(L,T){let B=i(T.name),j=document.createElement("div");return j.className="cw-task-item",j.dataset.id=L,j.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(u,y)=>{H.playClick(),a.querySelector(`.${u}`).classList.toggle("active"),y()};if(a.querySelector(".notes").onclick=u=>{u.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=u=>{u.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=u=>{u.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=u=>{u.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=u=>{u.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=u=>{u.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=u=>{u.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=u=>{u.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=u=>{u.stopPropagation(),i("broadcast",()=>{let y=u.currentTarget.querySelector(".cw-badge");y&&y.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(u=>{u.addEventListener("mouseenter",()=>H.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let u=document.createElement("div");u.className="cw-badge",a.querySelector(".broadcast").appendChild(u)}let s=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(s=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{s&&clearTimeout(s)},(async function(){let y=()=>{let D=Ee();if(D){let q=D.split("@")[0].toLowerCase();if(ct.includes(q)){let R=a.querySelector("#cw-admin-tag");R&&R.classList.add("visible")}}else setTimeout(y,2e3)};y(),await dt(2800),a.classList.add("docked"),await dt(300);let v=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(D=>D.classList.add("visible"));for(let D=0;D<v.length;D++)v[D].classList.add("popped"),await dt(90);await dt(200),a.classList.add("system-check")})();let r=!1,l,d,c,p,x=3;a.onmousedown=u=>{if(u.target.closest("button"))return;u.preventDefault(),l=u.clientX,d=u.clientY;let y=a.getBoundingClientRect();c=y.left,p=y.top,document.addEventListener("mousemove",b),document.addEventListener("mouseup",g)};function b(u){let y=u.clientX-l,v=u.clientY-d;!r&&Math.sqrt(y*y+v*v)>x&&(r=!0,a.classList.add("dragging"),a.style.transition="none",s&&clearTimeout(s)),r&&(a.style.left=`${c+y}px`,a.style.top=`${p+v}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function g(u){if(document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",g),r){r=!1,a.classList.remove("dragging");let y=window.innerWidth,v=window.innerHeight,D=a.getBoundingClientRect(),q=D.left+D.width/2,R;q<y/2?(R=24,a.classList.remove("side-right"),a.classList.add("side-left")):(R=y-D.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let Y=Math.max(24,Math.min(D.top,v-D.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${R}px`,a.style.top=`${Y}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let y=a.querySelector(".cw-btn.active"),v=u.target.closest("button");if(a.classList.contains("collapsed")){let D=a.getBoundingClientRect(),q=window.innerHeight,R=D.top>q/2;if(a.style.setProperty("transition","none","important"),R){let Y=q-D.bottom;a.style.top="auto",a.style.bottom=`${Y}px`}else a.style.bottom="auto",a.style.top=`${D.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),H.playGenieOpen()}else!y&&!v&&(a.classList.add("collapsed"),H.playGenieOpen());v&&(v.style.transform="scale(0.9)",setTimeout(()=>v.style.transform="",150))}}}function Ze(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
`.replace(/\n/g,"<br>");Qe(L);let T=await gt();T?(T.innerText.trim()===""&&(T.innerHTML=""),document.execCommand("insertHTML",!1,L),mt(T),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var ge=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Fe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let c=a.getBoundingClientRect();i.x=c.left+c.width/2,i.y=c.top+c.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let c=e.getBoundingClientRect();s=c.left+c.width/2,r=c.top+c.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,d=i.y-r;t?(H.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${d}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${d}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof go=="function"&&go(e,o)):(H.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${d}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${d}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Lt=="function"&&Lt(e))}function go(t,e){Lt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Lt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function fo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Kt(t,J),s=ao(h),r=oo(()=>{A(),G.setActiveTasks(r.getCheckedElements())},h,G),l=document.createElement("div");l.style.display="none";let d=to((m,S)=>{w(m,S)});l.appendChild(d);let c=ro({onSaveCurrent:async()=>{let m=await _();return O(),m},onLoadDraft:m=>{U(m)},t:m=>h(m)}),p=T(),x=B(),b=document.createElement("div"),g=K(),u=k(c,h);o.appendChild(p),o.appendChild(x),o.appendChild(g),o.appendChild(l),o.appendChild(b),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let y=document.createElement("button");y.id="manual-task-toggle",y.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",y.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${M.primary}; background: ${M.surface}; color: ${M.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,y.onmouseenter=()=>{y.style.background=M.primaryBg},y.onmouseleave=()=>{y.style.background=M.surface},y.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",y.style.display="none"},o.appendChild(y),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(u);let v=document.createElement("div");v.style.display="none",v.style.flexGrow="1",v.style.minHeight="0",v.style.overflow="hidden";let D=po(()=>L());D.style.height="100%",v.appendChild(D),e.insertBefore(v,i);let q=a.lastElementChild;q&&(q.insertBefore(c.historyBtnWrapper,q.firstChild),q.insertBefore(V(),q.firstChild)),e.appendChild(c.drawer);let R=null;G.subscribe(m=>{W(m),Y(),m.isDirty&&(R&&clearTimeout(R),R=setTimeout(async()=>{let S=await _(!0);xe.saveEmergency(S),m.isDirty=!1},2e3))});function Y(){let m=xe.getCount()>0,S=!!G.currentSubStatus;pt(m||S)}function J(){G.visible=!G.visible,ue(G.visible,e,"cw-btn-notes")}function L(){G.isSplitView=!G.isSplitView,G.isSplitView?(o.style.display="none",v.style.display="flex",v.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",v.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function T(){let m=document.createElement("div");if(m.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let C=document.createElement("style");C.id="cw-segmented-styles",C.innerHTML=`
            ...
            `,document.head.appendChild(C)}let S=(C,P)=>{let Z=m.querySelector(`#${C}`).querySelector(".cw-segmented-indicator");Z&&(Z.style.transform=`translateX(${P*100}%) translateX(${P*2}px)`)};return m.querySelectorAll("#lang-selector button").forEach((C,P)=>{C.onclick=()=>{G.setLanguage(C.dataset.lang),m.querySelectorAll("#lang-selector button").forEach(z=>z.classList.remove("active")),C.classList.add("active"),S("lang-selector",P),H.playHover(),G.currentSubStatus&&I(G.currentSubStatus)}}),m.querySelectorAll("#type-selector button").forEach((C,P)=>{C.onclick=()=>{G.setCaseType(C.dataset.type),m.querySelectorAll("#type-selector button").forEach(z=>z.classList.remove("active")),C.classList.add("active"),S("type-selector",P),H.playHover(),G.currentSubStatus&&I(G.currentSubStatus)}}),m.querySelectorAll("#portugal-selector button").forEach((C,P)=>{C.onclick=()=>{G.setPortugalCase(C.dataset.val==="true"),m.querySelectorAll("#portugal-selector button").forEach(z=>z.classList.remove("active")),C.classList.add("active"),S("portugal-selector",P),H.playHover(),G.currentSubStatus&&I(G.currentSubStatus)}}),m}function B(){let m=document.createElement("div");m.className="cw-status-section",m.style.cssText="display: flex; flex-direction: column; gap: 8px;",m.innerHTML=`
        ...
        `;let S=m.querySelector("#main-status-select"),C=m.querySelector("#sub-status-select");return S.onchange=()=>{G.setStatus(S.value),j(S.value,C),G.setSubStatus(""),I("")},C.onchange=()=>{G.setSubStatus(C.value),I(C.value)},m}function j(m,S){if(S.innerHTML=`<option value="">${h("select_substatus")}</option>`,!m){S.disabled=!0;return}for(let C in ke)if(ke[C].status===m){let P=document.createElement("option");P.value=C,P.textContent=ke[C].name,S.appendChild(P)}S.disabled=!1}function I(m){if(d.render&&d.render(m,G.currentCaseType),!m){l.style.display="none",b.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",g.style.display="flex",g.style.opacity="1",u.style.display="none";return}g.style.opacity="0",setTimeout(()=>{G.currentSubStatus&&(g.style.display="none")},400),u.style.display="grid";let S=ke[m];S&&S.templateFields&&G.setActiveFields(S.templateFields),F(),At(m,b,G),b.style.display="block",l.style.display="block";let C=m.startsWith("SO_"),P=m==="NI_Awaiting_Validation",z=document.getElementById("manual-task-toggle");C||P?(r.selectionElement.style.display="block",z.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",z.style.display="block");let Z=m==="SO_Education_Only"?"education":"implementation";G.setScreenshotMode(Z),G.currentCaseType==="lm"?G.toggleFieldExclusion("field-ON_CALL",!0):G.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(m),A();let $=document.getElementById("email-automation-toggle-row");$&&($.style.display=$e[m]?"flex":"none")}function A(){let m=r.getCheckedElements().map(S=>S.value);s.updateVisibility(G.currentSubStatus,m)}function w(m,S){let C=rt[m];if(C){for(let P in C)if(P==="linkedTask")r.toggleTask(C.linkedTask,S);else if(P==="activeTasks")C.activeTasks.forEach(z=>{S?r.setTaskCount(z.value,z.count):r.setTaskCount(z.value,0)});else if(P.startsWith("field-")){let z=P,Z=C[P],$=document.getElementById(z);if($){let ee=He.includes(z.replace("field-",""));if(S)if(ee){let oe=$.value.trim();oe.includes(Z.trim())||($.value=oe?oe+`
`+Z.trim():Z.trim())}else $.value=Z;else if(ee){let oe=$.value.trim(),Q=Z.trim();oe.includes(Q)&&($.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else $.value.trim()===Z.trim()&&($.value="");G.updateField(z,$.value),$.dispatchEvent(new Event("input"))}}}}function k(m,S){let C=document.createElement("div");if(C.className="cw-actions-section",C.style.cssText=`
            display: grid;
        ...
        `,!document.getElementById("cw-actions-hover-styles")){let oe=document.createElement("style");oe.id="cw-actions-hover-styles",oe.innerHTML=`
            ...
            `,document.head.appendChild(oe)}let P=document.createElement("div");P.id="email-automation-toggle-row",P.style.cssText="grid-column: span 2; display: none; align-items: center; justify-content: center; padding-bottom: 6px; border-bottom: 1px solid rgba(0,0,0,0.05); margin-bottom: 2px;",P.innerHTML=`
        ...
        `;let z=m.parkButton;z.classList.add("js-btn-park"),z.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let Z=document.createElement("button");Z.className="cw-btn-secondary js-btn-reset",Z.textContent=S("limpar"),Z.style.cssText=`width: 100%; height: 34px; background: ${M.surface}; color: ${M.textSub}; border: 1px solid ${M.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,Z.onclick=()=>O();let $=document.createElement("button");$.className="cw-btn-secondary js-btn-copy",$.textContent=S("copiar"),$.style.cssText=`width: 100%; height: 34px; background: ${M.surface}; color: ${M.primary}; border: 1px solid ${M.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,$.onclick=()=>f();let ee=document.createElement("button");return ee.className="cw-btn-primary js-btn-generate",ee.textContent=S("preencher"),ee.style.cssText=`width: 100%; height: 38px; background: ${M.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ee.onclick=()=>E(),C.appendChild(P),C.appendChild(z),C.appendChild(Z),C.appendChild($),C.appendChild(ee),C}async function f(){if(!G.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Tt(G,r,s);m?(Qe(m),X(h("copiado_sucesso")),H.playClick()):X(h("select_substatus"),{error:!0})}async function E(){if(!G.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Tt(G,r,s);Qe(m),J();let S=Ze(),C=await gt();if(C){C.focus(),document.execCommand("insertHTML",!1,m),mt(C);let P=document.getElementById("email-automation-checkbox");(!P||P.checked)&&G.currentSubStatus&&$e[G.currentSubStatus]&&await xt($e[G.currentSubStatus]),X(h("inserido_copiado")),H.playSuccess(),O()}S()}function F(){if(G.currentSubStatus){if(G.currentCaseType==="lm")G.removeField("ON_CALL");else{let m=ke[G.currentSubStatus];m&&m.templateFields.includes("ON_CALL")&&G.addFieldAt("ON_CALL",1)}G.isPortugalCase?(G.addFieldAt("CASO_PORTUGAL",1),G.addFieldAt("CONSENTIU_GRAVACAO",2)):(G.removeField("CASO_PORTUGAL"),G.removeField("CONSENTIU_GRAVACAO"))}}function O(){G.reset(),r.reset(),s.reset(),Y(),o.querySelectorAll("select").forEach(S=>S.value=""),o.querySelector("#sub-status-select").disabled=!0;let m=document.getElementById("email-automation-toggle-row");m&&(m.style.display="none"),b.innerHTML="",l.style.display="none",g.style.display="flex",g.style.opacity="1",u.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none"}async function _(m=!1){let S={};b.querySelectorAll("input, textarea, select").forEach($=>{($.id.startsWith("field-")||$.id==="consent-select")&&(S[$.id]=$.value)});let C="Cliente",P="---";if(!m)try{let $=await we();C=$.advertiserName,P=$.cid}catch($){console.warn("Erro ao coletar pageData:",$)}let z=r.getCheckedElements().map($=>({key:$.value,count:$.count})),Z=z.map($=>{let ee=Ce[$.key];return ee?ee.name:$.key});return{currentCaseType:G.currentCaseType,currentLang:G.currentLang,isPortugalCase:G.isPortugalCase,consent:G.consent,tagSupportUsed:G.tagSupportUsed,forcedScreenshots:[...G.forcedScreenshots],excludedFields:[...G.excludedFields],activeFields:G.activeFields,status:G.currentStatus,subStatus:G.currentSubStatus,formData:S,activeTasks:z,summaryTags:Z,clientName:C,cid:P,timestamp:new Date().toISOString()}}let N=m=>new Promise(S=>setTimeout(S,m));async function U(m){G.setLanguage(m.currentLang||"pt"),G.setCaseType(m.currentCaseType||"bau"),G.setPortugalCase(m.isPortugalCase||!1),G.setConsent(m.consent||!1),G.setExcludedFields(m.excludedFields||[]),m.activeFields&&G.setActiveFields(m.activeFields);let S=o.querySelector(`#lang-selector button[data-lang="${G.currentLang}"]`);S&&S.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(z=>{z!==S&&z.classList.remove("active")});let C=o.querySelector(`#type-selector button[data-type="${G.currentCaseType}"]`);C&&C.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(z=>{z!==C&&z.classList.remove("active")});let P=o.querySelector(`#portugal-selector button[data-val="${G.isPortugalCase}"]`);if(P&&P.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(z=>{z!==P&&z.classList.remove("active")}),m.status){let z=o.querySelector("#main-status-select");z.value=m.status,G.setStatus(m.status);let Z=o.querySelector("#sub-status-select");if(j(m.status,Z),await N(50),m.subStatus){if(Z.value=m.subStatus,G.setSubStatus(m.subStatus),I(m.subStatus),await N(100),m.tagSupportUsed!==void 0){G.setTagSupportUsed(m.tagSupportUsed);let $=s.element.querySelector('input[value="Sim"]'),ee=s.element.querySelector('input[value="N\xE3o"]');m.tagSupportUsed&&$?$.checked=!0:ee&&(ee.checked=!0),s.element.querySelector("div:last-child").style.display=m.tagSupportUsed?"none":"block"}m.forcedScreenshots&&G.setForcedScreenshots(m.forcedScreenshots);for(let $ in m.formData){let ee=document.getElementById($);ee&&(ee.value=m.formData[$],G.updateField($,ee.value))}m.activeTasks&&(m.activeTasks.forEach($=>r.setTaskCount($.key,$.count)),G.setActiveTasks(r.getCheckedElements()))}}G.isDirty=!1}function h(m){return Se[G.currentLang]?.[m]||Se.pt?.[m]||m}function V(){let m=document.createElement("div");return m.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',m.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",m.onclick=S=>{S.stopPropagation(),L()},m.title="Alternar para Split & Transfer",m}function K(){let m=document.createElement("div");return m.id="notes-empty-state",m.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
...
CID: ${S.cid||"---"}
Case ID: ${S.caseId||"---"}
E-mail: ${S.clientEmail||"---"}`;P&&(P.value=Z),z&&(z.style.display="block",z.style.maxHeight="300px",z.style.opacity="1",z.scrollIntoView({behavior:"smooth",block:"end"}))})}function b(){r=!r,ue(r,l,"cw-btn-script"),r?(p(),c||(c=setInterval(p,2e3))):c&&(clearInterval(c),c=null)}let g=pe(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",d,()=>{b()});l.appendChild(g);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `;let y=u.querySelector("#csa-toggle-options"),v=u.querySelector("#csa-options-content"),D=u.querySelector("#csa-options-arrow"),q=!1;y.onclick=()=>{q=!q,D.style.transform=q?"rotate(180deg)":"rotate(0deg)",v.style.maxHeight=q?"400px":"0",v.style.opacity=q?"1":"0",v.style.marginTop=q?"8px":"0",H.playClick()};let R=u.querySelector("#cw-pill-message"),Y=u.querySelector("#cw-am-copy-final"),J=u.querySelector("#cw-am-message-area");R.onmouseenter=()=>{R.style.borderColor="#007AFF",R.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},R.onmouseleave=()=>{R.style.borderColor="#DADCE0",R.style.boxShadow="0 1px 2px rgba(0,0,0,0.02)"},R.addEventListener("click",()=>{x()}),Y.addEventListener("click",()=>{J.value&&(navigator.clipboard.writeText(J.value),X("Mensagem copiada!"),H.playSuccess(),Y.style.background="#34A853",Y.textContent="Copiado!",setTimeout(()=>{Y.style.background="#1A73E8",Y.textContent="Copiar Mensagem Final"},2e3))});let L=(S,C)=>{let P=u.querySelector(S),z=u.querySelector(C);P.onclick=()=>{let Z=z.textContent;!Z||Z.includes("---")||Z.includes("N\xE3o encontrado")||(navigator.clipboard.writeText(Z),H.playSuccess(),P.classList.add("copied"),setTimeout(()=>P.classList.remove("copied"),1500))}};l.appendChild(u);let T=document.createElement("div");Object.assign(T.style,a.progressBarContainer);let B=document.createElement("div");B.className="csa-progress-fill",Object.assign(B.style,a.progressBarFill),T.appendChild(B),l.appendChild(T);let j=document.createElement("div");j.id="csa-content",Object.assign(j.style,a.contentArea),l.appendChild(j);let I=document.createElement("div");Object.assign(I.style,a.footer);let A=document.createElement("span");A.textContent="by lucaste@",Object.assign(A.style,{fontSize:"10px",color:"#bdc1c6"});let w=document.createElement("button");w.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> Resetar Script',Object.assign(w.style,a.resetBtn),w.onmouseenter=()=>w.style.background="#fce8e6",w.onmouseleave=()=>w.style.background="transparent",w.onclick=()=>{w.style.transform="scale(0.9)",setTimeout(()=>w.style.transform="scale(1)",150);for(let S in n)delete n[S];K()},I.appendChild(A),I.appendChild(w),l.appendChild(I);let k=document.createElement("div");Object.assign(k.style,{display:"flex",flexDirection:"column",gap:"8px",marginBottom:"16px"});let f=document.createElement("div");f.className="csa-segmented-control",f.innerHTML=`
  ...
  `,u.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},u.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(g),b.appendChild(u),x.appendChild(b),p.appendChild(x);let y=document.createElement("div");y.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(y);let v=null;function D(){if(v)return;v=document.createElement("div"),v.style.cssText=`
      ...
      `;let A=document.createElement("div");A.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",A.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let w=document.createElement("button");w.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',w.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",w.onclick=()=>{R(),n=!1,T()},A.appendChild(w),v.appendChild(A);let k=document.createElement("div");k.id="cw-history-list",k.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",v.appendChild(k),p.appendChild(v)}function q(){v||D();let A=v.querySelector("#cw-history-list");A.innerHTML="";let w=Qo();w.length===0?A.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':w.forEach(k=>{let f=j(k,Be[k._originalCat],!0,k._originalCat);A.appendChild(f)}),requestAnimationFrame(()=>v.style.transform="translateY(0)")}function R(){v&&(v.style.transform="translateY(100%)")}function Y(){c.innerHTML="";let A=J("history","Recentes",Be.history);A.id="cw-sidebar-btn-history",A.onclick=()=>{H.playClick(),n=!n,n?q():R(),T()},c.appendChild(A);let w=document.createElement("div");w.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",c.appendChild(w),Object.keys(et).forEach(k=>{let f=et[k],E=J(k,f.label,Be[k]);E.id=`cw-sidebar-btn-${k}`,E.onclick=()=>{H.playClick(),n&&(n=!1,R()),L(k)},c.appendChild(E)})}function J(A,w,k){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=w,f.dataset.key=A;let E=document.createElement("div");E.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",E.innerHTML=k||Be.tasks;let F=document.createElement("div");return F.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",F.textContent=w,f.appendChild(E),f.appendChild(F),f.onmouseenter=()=>{a!==A&&!(A==="history"&&n)&&(f.style.background="#F1F3F4",E.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==A&&!(A==="history"&&n)&&(f.style.background="transparent",E.style.transform="scale(1)")},f}function L(A){let w=document.getElementById(`cat-anchor-${A}`);w&&(w.scrollIntoView({behavior:"smooth",block:"start"}),a=A,T())}function T(){Object.keys(et).forEach(w=>{let k=c.querySelector(`#cw-sidebar-btn-${w}`);if(k)if(a===w&&!n){let f=ht[w];k.style.background=f.bg,k.style.color=f.color,k.querySelector("div:first-child").style.transform="scale(1.1)"}else k.style.background="transparent",k.style.color=i.textSecondary,k.querySelector("div:first-child").style.transform="scale(1)"});let A=c.querySelector("#cw-sidebar-btn-history");A&&(n?(A.style.background="#3C4043",A.style.color="#FFFFFF"):(A.style.background="transparent",A.style.color=i.textSecondary))}function B(){if(y.innerHTML="",e.trim()!==""){let w=[];if(Object.entries(et).forEach(([f,E])=>{let F=E.links.filter(O=>O.name.toLowerCase().includes(e.toLowerCase())||O.desc.toLowerCase().includes(e.toLowerCase()));w.push(...F.map(O=>({...O,_cat:f})))}),w.length===0){y.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let k=document.createElement("div");k.innerHTML="Resultados da busca",k.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",y.appendChild(k),w.forEach(f=>{let E=j(f,Be[f._cat],!1,f._cat);y.appendChild(E)});return}Object.entries(et).forEach(([w,k])=>{let f=ht[w],E=document.createElement("div"),F=document.createElement("div");F.id=`cat-anchor-${w}`,F.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,F.innerHTML=`
            ...
            ${k.label}
          `,E.appendChild(F);let O=document.createElement("div");O.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",k.links.forEach(_=>{let N=j(_,Be[w],!1,w);O.appendChild(N)}),E.appendChild(O),y.appendChild(E)});let A=document.createElement("div");A.style.height="80px",y.appendChild(A)}function j(A,w,k,f){let E=document.createElement("div"),F=ht[f]||ht.history;E.style.cssText=`
      ...
      `,g.querySelectorAll('input[name="cw-bc-type"]').forEach(O=>{O.addEventListener("change",()=>{g.querySelectorAll(".cw-radio-option").forEach(_=>_.classList.remove("checked")),O.parentElement.classList.add("checked")})}),setTimeout(()=>{let O=g.querySelector(".cw-radio-option.info");O&&O.classList.add("checked")},100);let f=g.querySelector("#cw-bc-cancel"),E=g.querySelector("#cw-bc-close-x"),F=g.querySelector("#cw-bc-send");f.onclick=q,E.onclick=q,F.onclick=R,d.appendChild(g)}function D(f=null){if(!g)return;let E=g.querySelector("#cw-editor-title-label"),F=g.querySelector("#cw-bc-title"),O=g.querySelector("#cw-bc-text"),_=g.querySelector("#cw-bc-send");if(f){a=f.id,E.textContent="Editar Aviso",F.value=f.title||"",O.value=f.text||"",_.textContent="Salvar Altera\xE7\xF5es";let N=f.type||"info",U=g.querySelector(`input[name="cw-bc-type"][value="${N}"]`);U&&U.click()}else{a=null,E.textContent="Novo Aviso",F.value="",O.value="",_.textContent="Publicar";let N=g.querySelector('input[name="cw-bc-type"][value="info"]');N&&N.click()}g.classList.add("active"),setTimeout(()=>F.focus(),300)}function q(){g&&g.classList.remove("active"),a=null}async function R(){let f=g.querySelector("#cw-bc-send"),E=g.querySelector("#cw-bc-title"),F=g.querySelector("#cw-bc-text"),O=g.querySelector('input[name="cw-bc-type"]:checked'),_=O?O.value:"info";if(!E.value.trim()||!F.value.trim()){X("Preencha todos os campos!",{error:!0});return}f.textContent="Salvando...",f.style.opacity="0.7";let N=!1;a?N=await fe.updateBroadcast(a,{title:E.value,text:F.value,type:_}):N=await fe.sendBroadcast({title:E.value,text:F.value,type:_,author:window._cwCurrentUser||"admin"}),N?(X(a?"Atualizado!":"Publicado!"),H.playSuccess(),q(),setTimeout(()=>L(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),f.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",f.style.opacity="1")}async function Y(f){if(await be("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await fe.deleteBroadcast(f)){X("Aviso removido."),H.playClick();let O=_e.findIndex(_=>_.id===f);O>-1&&_e.splice(O,1),B(),setTimeout(()=>L(),1500)}else X("Erro ao excluir.",{error:!0})}let J=document.createElement("div");J.className="cw-nice-scroll",Object.assign(J.style,i.feedContainer),d.appendChild(J);async function L(){e&&(y.style.display="block",y.innerHTML="\u{1F504} Sincronizando...");try{let f=await fe.fetchData();f&&f.broadcast&&(qt(f.broadcast),T(),e&&(B(),y.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{y.style.display="none"},1500)))}catch{e&&(y.innerHTML="\u26A0\uFE0F Offline")}}function T(){let f=document.getElementById("cw-btn-broadcast");if(!f)return;let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(_e.some(O=>!E.includes(O.id))){if(f.classList.add("has-new"),!f.querySelector(".cw-badge")){let O=document.createElement("div");O.className="cw-badge",Object.assign(O.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),f.appendChild(O)}}else{f.classList.remove("has-new");let O=f.querySelector(".cw-badge");O&&O.remove()}}function B(){J.innerHTML="";let f=d.querySelector("#cw-bau-widget");f&&f.remove();let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),F=[..._e].sort((h,V)=>{let K=new Date(h.date).getTime()||0;return(new Date(V.date).getTime()||0)-K}),O=F.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(O!==-1){let h=F[O];F.splice(O,1);let V=document.createElement("div");V.id="cw-bau-widget",Object.assign(V.style,i.bauContainer);let K=[],W=(h.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,S="\u{1F4C5}";if(W.forEach($=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test($)?S="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test($)&&(S="\u{1F1EA}\u{1F1F8}");let ee=$.match(m);if(ee){let oe=ee[0],Q=S;/🇧🇷|🇵🇹|PT|BR/i.test($)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test($)&&(Q="\u{1F1EA}\u{1F1F8}"),K.some(te=>te.flag===Q&&te.date===oe)||K.push({flag:Q,date:oe})}}),K.length===0){let $=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);$&&[...new Set($)].forEach(ee=>K.push({flag:"\u{1F4C5}",date:ee}))}let C="",P='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(P=`
          ...
          `,y.after(V);let z=V.querySelector("#cw-bau-toggle-btn"),Z=V.querySelector("#cw-bau-full");if(z&&Z&&(z.onclick=()=>{let $=Z.style.display==="none";Z.style.display=$?"block":"none",z.textContent=$?"Ocultar":"Detalhes"}),window._cwIsAdmin){let $=V.querySelector(".cw-bau-edit");$&&($.onclick=()=>D(h))}}let _=F.sort((h,V)=>{let K=E.includes(h.id),W=E.includes(V.id);return K===W?0:K?1:-1});if(_.length===0&&!O){let h=document.createElement("div");Object.assign(h.style,i.emptyState),h.innerHTML=`
           ...
           `,J.appendChild(h)}let N=_.filter(h=>!E.includes(h.id)),U=_.filter(h=>E.includes(h.id));if(N.forEach(h=>J.appendChild(j(h,!1))),U.length>0){let h=document.createElement("div");Object.assign(h.style,i.historyDivider),h.innerHTML=`<span>Hist\xF3rico (${U.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let V=document.createElement("div");Object.assign(V.style,i.historyContainer),U.forEach(W=>V.appendChild(j(W,!0)));let K=!1;h.onclick=()=>{H.playClick(),K=!K,V.style.display=K?"flex":"none",h.querySelector("svg").style.transform=K?"rotate(180deg)":"rotate(0deg)"},J.appendChild(h),J.appendChild(V)}}function j(f,E){let F=document.createElement("div");Object.assign(F.style,E?i.cardHistory:i.card);let O=s[f.type]||s.info,_=document.createElement("div");Object.assign(_.style,i.cardHeader);let N=document.createElement("div");Object.assign(N.style,i.typeTag,{color:O.color,background:O.bg}),N.innerHTML=`${O.icon} <span>${f.type}</span>`;let U=document.createElement("span");if(Object.assign(U.style,i.dateTag),U.textContent=n(f.date),_.appendChild(N),E)_.appendChild(U);else{let m=document.createElement("button");m.className="cw-btn-interactive",Object.assign(m.style,i.dismissBtn),m.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',m.onmouseenter=()=>{m.style.color="#1e8e3e",m.style.background="#e6f4ea",m.style.borderColor="#1e8e3e"},m.onmouseleave=()=>{m.style.color="#5f6368",m.style.background="#fff",m.style.borderColor="rgba(0,0,0,0.1)"},m.onclick=S=>{S.stopPropagation(),H.playClick(),F.style.transform="translateX(20px)",F.style.opacity="0",setTimeout(()=>{let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");C.push(f.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(C)),B(),T()},200)},_.appendChild(m)}let h=document.createElement("div");Object.assign(h.style,i.cardContent);let V=document.createElement("div");Object.assign(V.style,i.msgTitle),V.textContent=f.title;let K=document.createElement("div");Object.assign(K.style,i.msgBody),K.innerHTML=l(f.text);let W=document.createElement("div");if(Object.assign(W.style,i.msgMeta),W.innerHTML=`Publicado por <b>${f.author||"Sistema"}</b>`,E||(W.innerHTML+=` \u2022 ${n(f.date)}`),h.appendChild(V),h.appendChild(K),h.appendChild(W),F.appendChild(_),F.appendChild(h),window._cwIsAdmin){let m=document.createElement("div");m.className="cw-card-actions";let S=document.createElement("button");S.className="cw-action-btn edit",S.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',S.onclick=()=>D(f);let C=document.createElement("button");C.className="cw-action-btn delete",C.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',C.onclick=()=>Y(f.id),m.appendChild(S),m.appendChild(C),F.appendChild(m)}return F}let I=fe.getCachedBroadcasts();I.length>0&&(qt(I),B()),setTimeout(u,500),L(),o||(o=setInterval(L,ea));let A=document.createElement("div");Object.assign(A.style,Ae),A.className="no-drag",d.appendChild(A),Te(d,A),document.body.appendChild(d);let w=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),k=_e.some(f=>!w.includes(f.id));return{toggle:p,hasUnread:k}}function Ao(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let l=document.createElement("div");Object.assign(l.style,o.dotsContainer);let d=document.createElement("div");Object.assign(d.style,o.btnContainer);let c=document.createElement("button");c.textContent="Pular",Object.assign(c.style,o.btn,o.btnSkip),c.onmouseover=()=>c.style.color="#202124",c.onmouseout=()=>c.style.color="#5f6368";let p=document.createElement("button");p.textContent="Pr\xF3ximo",Object.assign(p.style,o.btn,o.btnNext),p.onmouseover=()=>p.style.transform="scale(1.05)",p.onmouseout=()=>p.style.transform="scale(1)",d.appendChild(c),d.appendChild(p),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(l),n.appendChild(d),a.appendChild(n),document.body.appendChild(a);function x(g){let u=t[g];i.textContent=u.icon,s.textContent=u.title,r.textContent=u.text,l.innerHTML="",t.forEach((y,v)=>{let D=document.createElement("div");Object.assign(D.style,o.dot),v===g&&Object.assign(D.style,o.dotActive),l.appendChild(D)}),u.isLast?(c.style.display="none",p.textContent="Come\xE7ar \u{1F680}",p.style.width="100%"):(c.style.display="block",p.textContent="Pr\xF3ximo",p.style.width="auto")}function b(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),H.playSuccess(),X("Tudo pronto! Use o menu flutuante.")}p.onclick=()=>{H.playClick(),e<t.length-1?(e++,x(e)):b()},c.onclick=async()=>{await be("Pular o tutorial?")&&b()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var To={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function ko(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&ta(t)}function ta(t){let e=To.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let l=document.createElement("div");Object.assign(l.style,a.title);let d=document.createElement("div");Object.assign(d.style,a.text);let c=document.createElement("div");Object.assign(c.style,a.dotsContainer);let p=document.createElement("button");Object.assign(p.style,a.btn),p.onmouseover=()=>p.style.transform="scale(1.02)",p.onmouseout=()=>p.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(l),i.appendChild(d),i.appendChild(c),i.appendChild(p),n.appendChild(i),document.body.appendChild(n);function x(g){let u=e[g];r.textContent=u.icon,l.textContent=u.title,d.textContent=u.text,c.innerHTML="",e.forEach((y,v)=>{let D=document.createElement("div");Object.assign(D.style,a.dot),v===g&&Object.assign(D.style,a.dotActive),c.appendChild(D)}),g===e.length-1?p.textContent="Entendi, vamos l\xE1! \u{1F44D}":p.textContent="Pr\xF3ximo"}function b(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),H.playSuccess(),X(`TechSol atualizado para ${t}!`)}p.onclick=()=>{H.playClick(),o<e.length-1?(o++,x(o)):b()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Fo="cw_timezone_pinned",_t=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],oa=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function Oo(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Fo)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},d={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},c=document.createElement("div");c.id="timezone-popup",c.classList.add("cw-module-window"),Object.assign(c.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=pe(c,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:c},()=>E());c.appendChild(x);let b=document.createElement("div");Object.assign(b.style,d.container),c.appendChild(b);let g=document.createElement("div");Object.assign(g.style,d.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,d.tabBtn,d.tabActive);let y=document.createElement("div");y.textContent="Planejador",Object.assign(y.style,d.tabBtn),g.appendChild(u),g.appendChild(y),b.appendChild(g);let v=document.createElement("div");Object.assign(v.style,d.toolbar);let D=document.createElement("div");Object.assign(D.style,d.searchInputWrapper);let q=document.createElement("div");q.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(q.style,d.searchIcon);let R=document.createElement("input");R.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(R.style,d.searchInput),R.onfocus=()=>{R.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",R.style.borderColor="rgba(26,115,232,0.3)"},R.onblur=()=>{R.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",R.style.borderColor="transparent"},R.oninput=F=>{i=F.target.value.toLowerCase(),A()},D.appendChild(q),D.appendChild(R),v.appendChild(D);let Y=document.createElement("div");Object.assign(Y.style,d.chipsRow),oa.forEach(F=>{let O=document.createElement("div");O.textContent=F.label,O.id=`tz-filter-${F.id}`,Object.assign(O.style,d.chip),F.id===s&&Object.assign(O.style,d.chipActive),O.onclick=()=>{H.playClick(),s=F.id,Array.from(Y.children).forEach(_=>{Object.assign(_.style,d.chip)}),Object.assign(O.style,d.chipActive),A()},Y.appendChild(O)}),v.appendChild(Y),b.appendChild(v);let J=document.createElement("div");Object.assign(J.style,d.listContainer);let L=document.createElement("style");L.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",b.appendChild(L);let T=document.createElement("div");Object.assign(T.style,d.plannerWrapper,{display:"none"}),b.appendChild(J),b.appendChild(T),u.onclick=()=>B("live"),y.onclick=()=>B("plan");function B(F){H.playClick(),F==="live"?(Object.assign(u.style,d.tabActive),Object.assign(y.style,d.tabBtn),y.style.borderBottomColor="transparent",J.style.display="flex",v.style.display="flex",T.style.display="none",k()):(Object.assign(y.style,d.tabActive),Object.assign(u.style,d.tabBtn),u.style.borderBottomColor="transparent",T.style.display="flex",J.style.display="none",v.style.display="none",f(),w())}function j(F){return F>=9&&F<17?{color:l.success,bg:l.successBg,label:"Aberto",icon:"\u{1F7E2}"}:F>=8&&F<9?{color:l.warning,bg:l.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:F>=17&&F<19?{color:l.warning,bg:l.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function I(F){n.includes(F)?n=n.filter(O=>O!==F):n.push(F),localStorage.setItem(Fo,JSON.stringify(n)),A(),H.playClick()}function A(){J.innerHTML="";let F=new Date,O=_t.filter(N=>{let U=N.name.toLowerCase().includes(i)||N.label.toLowerCase().includes(i),h=s==="all"||N.region===s;return U&&h});if(O.sort((N,U)=>{let h=n.includes(N.id),V=n.includes(U.id);return h&&!V?-1:!h&&V?1:N.name.localeCompare(U.name)}),O.length===0){J.innerHTML=`
            ...
            `,m.onmouseenter=()=>{m.style.transform="translateY(-2px)",m.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},m.onmouseleave=()=>{m.style.transform="translateY(0)",m.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let P=m.querySelector(".cw-pin-btn");P.onmouseenter=()=>{P.style.backgroundColor="#F1F3F4"},P.onmouseleave=()=>{P.style.backgroundColor="transparent"},P.onclick=z=>{z.stopPropagation(),I(N.id)},m.onclick=()=>{a=N.id,B("plan")},J.appendChild(m)});let _=document.createElement("div");_.style.height="20px",_.style.width="100%",J.appendChild(_)}function w(){T.innerHTML="";let F=document.createElement("div"),O=document.createElement("label");O.textContent="Onde est\xE1 o cliente?",O.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let _=document.createElement("select");Object.assign(_.style,Ht),_.style.padding="14px",[..._t].sort((ne,te)=>ne.name.localeCompare(te.name)).forEach(ne=>{let te=document.createElement("option");te.value=ne.id,te.textContent=`${ne.flag} ${ne.name} (${ne.zone})`,ne.id===a&&(te.selected=!0),_.appendChild(te)}),_.onchange=ne=>{a=ne.target.value,Q(),H.playClick()},F.appendChild(O),F.appendChild(_),T.appendChild(F);let U=document.createElement("div");Object.assign(U.style,d.timeComparisonRow);let h=document.createElement("div");Object.assign(h.style,d.timeCard),h.style.backgroundColor="#F8FAFF",h.style.borderColor="#E8F0FE",h.innerHTML=`
        ...
        `,U.appendChild(h),U.appendChild(V),T.appendChild(U);let K=document.createElement("div");K.id="cw-planner-status",Object.assign(K.style,d.statusBadge),T.appendChild(K);let W=document.createElement("div");Object.assign(W.style,{padding:"0 4px",marginTop:"12px"});let m=document.createElement("div");m.textContent="Arraste para simular o hor\xE1rio:",m.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let S=document.createElement("div");Object.assign(S.style,d.timelineContainer);let C=document.createElement("div");Object.assign(C.style,d.timelineTrack);let P=document.createElement("div");Object.assign(P.style,d.dayZone),C.appendChild(P);let z=document.createElement("input");z.type="range",z.min="0",z.max="1439",z.step="15",z.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let Z=document.createElement("div");Z.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",Z.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",S.appendChild(C),S.appendChild(z),S.appendChild(Z),W.appendChild(m),W.appendChild(S),T.appendChild(W);let $=h.querySelector("#cw-time-input-br"),ee=V.querySelector("#cw-time-display-client"),oe=V.querySelector("#cw-client-label");function Q(){let ne=_t.find(Me=>Me.id===a);oe.textContent=`${ne.flag} ${ne.label} (${ne.zone})`;let te=r.getHours(),le=r.getMinutes(),We=`${String(te).padStart(2,"0")}:${String(le).padStart(2,"0")}`;$.value=We,z.value=te*60+le;let tt=r.toLocaleTimeString("pt-BR",{timeZone:ne.zone,hour:"2-digit",minute:"2-digit"});ee.textContent=tt;let qe=parseInt(tt.split(":")[0]);qe>=9&&qe<17?(K.style.background=l.successBg,K.style.color=l.success,K.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):qe>=8&&qe<9||qe>=17&&qe<19?(K.style.background=l.warningBg,K.style.color=l.warning,K.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(K.style.background=l.errorBg,K.style.color=l.error,K.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}z.oninput=ne=>{let te=parseInt(ne.target.value);r.setHours(Math.floor(te/60)),r.setMinutes(te%60),Q()},$.oninput=ne=>{let[te,le]=ne.target.value.split(":");te&&le&&(r.setHours(parseInt(te)),r.setMinutes(parseInt(le)),Q())},Q()}function k(){A(),o||(o=setInterval(A,6e4))}function f(){o&&(clearInterval(o),o=null)}function E(){e=!e,ue(e,c,"cw-btn-timezone"),e?B("live"):f()}return document.body.appendChild(c),E}function Lo(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let w=document.createElement("style");w.id="cw-lib-styles",w.innerHTML=`
        ...
        `,document.head.appendChild(w)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},s={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let d=pe(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>A());r.appendChild(d);let c=document.createElement("div");Object.assign(c.style,s.container),r.appendChild(c);let p=document.createElement("div");Object.assign(p.style,s.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(w=>{let k=document.createElement("div");k.innerHTML=`${w.icon} ${w.label}`,k.id=`lib-tab-${w.id}`,Object.assign(k.style,s.tabBtn),w.id===o&&Object.assign(k.style,s.tabActive),k.onmouseenter=()=>H.playHover(),k.onclick=()=>Y(w.id),p.appendChild(k)}),c.appendChild(p);let b=document.createElement("div");Object.assign(b.style,s.listContainer),c.appendChild(b);let g=document.createElement("div");g.className="cw-fab cw-tactile",Object.assign(g.style,s.fab),g.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',g.onmouseenter=()=>g.style.transform="scale(1.1)",g.onmouseleave=()=>g.style.transform="scale(1)",g.onclick=()=>L(),c.appendChild(g),a=document.createElement("div"),Object.assign(a.style,s.editorOverlay);let u=document.createElement("div");Object.assign(u.style,s.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let y=document.createElement("button");y.innerHTML="Cancelar",y.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",y.onclick=T,u.appendChild(y),a.appendChild(u);let v=document.createElement("div");Object.assign(v.style,s.editorBody),a.appendChild(v);let D=document.createElement("div");D.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let q=document.createElement("button");q.textContent="Salvar",q.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",q.onclick=B,D.appendChild(q),a.appendChild(D),c.appendChild(a);let R=document.createElement("div");Object.assign(R.style,Ae),R.className="no-drag",r.appendChild(R),Te(r,R),document.body.appendChild(r);function Y(w){H.playClick(),o=w,x.forEach(k=>{let f=document.getElementById(`lib-tab-${k.id}`);k.id===w?Object.assign(f.style,s.tabActive):Object.assign(f.style,s.tabBtn)}),J()}function J(){b.innerHTML="";let w=he.getSnippets(o);if(w.length===0){b.innerHTML=`
            ...
            `;return}w.forEach(k=>{let f=document.createElement("div");f.className="cw-lib-card",Object.assign(f.style,s.card),k.isCode&&(f.style.borderLeft=`4px solid ${i.primary}`,f.style.background="rgba(0, 122, 255, 0.02)");let E=k.content;if(k.isRich){let F=document.createElement("div");F.innerHTML=k.content;let O=F.querySelector("img");E=F.innerText.substring(0,150)+(F.innerText.length>150?"...":""),O&&(E="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+E)}f.innerHTML=`
                ...
                <div style="${I(s.cardPreview)}; ${k.isCode?"font-family:'Roboto Mono', monospace; font-size:11px;":""}">${E}</div>
            ...
            `,f.onmouseenter=()=>{H.playHover()},f.querySelector(".cw-act-copy").onclick=F=>{if(F.stopPropagation(),H.playClick(),k.isRich){let O=new Blob([k.content],{type:"text/html"}),_=document.createElement("div");_.style.whiteSpace="pre-wrap",_.innerHTML=k.content;let N=new Blob([_.innerText],{type:"text/plain"}),U=[new ClipboardItem({"text/html":O,"text/plain":N})];navigator.clipboard.write(U)}else navigator.clipboard.writeText(k.content);X("Copiado!")},f.querySelector(".cw-act-edit").onclick=F=>{F.stopPropagation(),H.playClick(),L(k)},f.querySelector(".cw-act-del").onclick=async F=>{F.stopPropagation(),H.playClick(),await be("Excluir este item?")&&(he.delete(k.id),J(),X("Item exclu\xEDdo."))},b.appendChild(f)})}function L(w=null){n=w?w.id:null,v.innerHTML="",v.appendChild(j("title","T\xEDtulo / Nome",w?w.title:"")),o==="email"&&v.appendChild(j("subject","Assunto do Email",w?w.subject:""));let k="Conte\xFAdo";o==="email"&&(k="Corpo do Email (HTML)"),o==="note"&&(k="Texto da Nota (Reason)"),v.appendChild(j("content",k,w?w.content:"",{isRich:!0,isCode:w?w.isCode:!1})),u.querySelector("span").textContent=w?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let f=v.querySelector("input");f&&f.focus()},300)}function T(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function B(){let w=v.querySelector("#cw-inp-title"),k=v.querySelector("#cw-inp-content"),f=w.value.trim(),E=k.contentEditable==="true"?k.innerHTML:k.value.trim(),F=k.getAttribute("data-is-code")==="true";if(!f||!E||E==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let O={id:n,type:o,title:f,content:E,isCode:F,isRich:k.contentEditable==="true"};if(o==="email"){let _=v.querySelector("#cw-inp-subject").value.trim();if(!_){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}O.subject=_}q.textContent="Salvando...",await he.save(O),q.textContent="Salvar",T(),J(),X("Salvo com sucesso!"),H.playSuccess()}function j(w,k,f,E={}){let F=document.createElement("div");Object.assign(F.style,s.inputGroup);let O=document.createElement("label");O.textContent=k,Object.assign(O.style,s.label);let _;if(E.isRich){let N=document.createElement("div");N.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",N.innerHTML=`
            ...
            `,_=document.createElement("div"),_.contentEditable="true",Object.assign(_.style,s.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),_.innerHTML=f||"",E.isCode&&(_.style.fontFamily="'Roboto Mono', monospace",_.style.backgroundColor="#F8F9FA",_.setAttribute("data-is-code","true")),N.querySelectorAll(".cw-toolbar-btn").forEach(U=>{U.onmouseenter=()=>H.playHover(),U.onmousedown=()=>H.playClick()}),N.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),_.focus()},N.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),_.focus()},N.querySelector(".cw-tb-code").onclick=U=>{let V=!(_.getAttribute("data-is-code")==="true");_.setAttribute("data-is-code",V),_.style.fontFamily=V?"'Roboto Mono', monospace":"inherit",_.style.backgroundColor=V?"rgba(0, 122, 255, 0.03)":i.surface,V?U.currentTarget.classList.add("active"):U.currentTarget.classList.remove("active"),_.focus()},N.querySelector(".cw-tb-img").onclick=async()=>{let U=await Yt("Cole a URL da imagem:");U&&(document.execCommand("insertImage",!1,U),_.querySelectorAll("img").forEach(V=>{V.style.maxWidth="100%",V.style.borderRadius="8px"}))},_.onpaste=U=>{let h=(U.clipboardData||U.originalEvent.clipboardData).items;for(let V of h)if(V.kind==="file"&&V.type.startsWith("image/")){U.preventDefault();let K=V.getAsFile(),W=new FileReader;W.onload=m=>{let S=`<img src="${m.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,S)},W.readAsDataURL(K)}},F.appendChild(O),F.appendChild(N)}else _=document.createElement("input"),_.type="text",Object.assign(_.style,s.input),_.value=f||"",F.appendChild(O);return _.id=`cw-inp-${w}`,_.onfocus=()=>{_.style.borderColor=i.primary,_.style.boxShadow=`0 0 0 2px ${i.primaryBg}`},_.onblur=()=>{_.style.borderColor=i.border,_.style.boxShadow="none"},F.appendChild(_),F}function I(w){return Object.entries(w).map(([k,f])=>`${k.replace(/[A-Z]/g,E=>"-"+E.toLowerCase())}:${f}`).join(";")}function A(){e=!e,ue(e,r,"cw-btn-library"),e&&J()}return A}function Io(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let x=document.createElement("style");x.id=a,x.innerHTML=`
    ...
    `;let d=l.querySelector("#cw-config-sound-toggle");d.onchange=x=>{H.setMuted(!x.target.checked),x.target.checked&&H.playClick()},r.appendChild(l);let c=document.createElement("div");c.className="cw-configs-section",c.innerHTML=`
  ...
  `,document.head.appendChild(t)};function Mo(){_o();let t=!1,e=document.createElement("div");e.id="bau-form-popup",e.className="bau-popup cw-module-window",e.style.display="none";let a=pe(e,"BAU Form","v1.0.0","Solicite a abertura de casos BAU rapidamente.",{googleLine:null},()=>J());e.appendChild(a);let n=document.createElement("div");n.className="bau-content",e.appendChild(n);let i=document.createElement("form");n.appendChild(i);let s=document.createElement("div");s.className="bau-card";let r=document.createElement("div");r.className="bau-header-banner",r.innerHTML="<span>\u26A0\uFE0F</span> 2 dados ausentes no CRM",s.appendChild(r);let l=document.createElement("div");l.innerHTML=`
    ...
    `,i.appendChild(d);let c=document.createElement("div");c.className="bau-card";let p=document.createElement("label");p.className="bau-label",p.textContent="A\xE7\xF5es R\xE1pidas",c.appendChild(p);let x=document.createElement("div");x.className="bau-chips-container",[{id:"gtm",text:"\u{1F680} Instala\xE7\xE3o GTM"},{id:"ecw4",text:"\u{1F6D2} ECW4 Purchase"},{id:"consent",text:"\u{1F6E1}\uFE0F Consent Mode"}].forEach(L=>{let T=document.createElement("div");T.className="bau-chip",T.textContent=L.text,T.dataset.id=L.id,T.onclick=()=>{T.classList.toggle("active"),H.playClick()},x.appendChild(T)}),c.appendChild(x);let g=document.createElement("input");g.type="hidden",g.name="quickActions",c.appendChild(g);let u=document.createElement("div");u.className="bau-grid-2",u.style.marginTop="16px",u.innerHTML=`
        <div>
    ...
    `,c.appendChild(u);let y=document.createElement("label");y.className="bau-label",y.textContent="Justificativa / Descri\xE7\xE3o",y.style.marginTop="16px",c.appendChild(y);let v=document.createElement("textarea");v.name="description",v.required=!0,v.className="bau-textarea",v.placeholder="Descreva detalhadamente o que precisa ser feito...",v.style.minHeight="100px",c.appendChild(v);let D=document.createElement("label");D.className="bau-label",D.textContent="Disponibilidade do Anunciante",D.style.marginTop="16px",c.appendChild(D);let q=document.createElement("input");q.type="datetime-local",q.name="availability",q.required=!0,q.className="bau-input",c.appendChild(q),i.appendChild(c);let R=document.createElement("div");R.className="bau-footer";let Y=document.createElement("button");Y.type="submit",Y.className="bau-btn-submit",Y.innerHTML="<span>\u26A1</span> Enviar para o TL abrir o Caso",R.appendChild(Y),i.appendChild(R),document.body.appendChild(e),i.onsubmit=async L=>{L.preventDefault();let T=Array.from(x.querySelectorAll(".bau-chip.active")).map(k=>k.dataset.id);g.value=T.join(",");let B=new FormData(i),j=Object.fromEntries(B.entries()),I=we(),A={...I,...j};if(!A.reason||!A.taskType||!A.description||!A.availability){X("Por favor, preencha todos os campos obrigat\xF3rios.","error");return}let w=Y.innerHTML;Y.disabled=!0,Y.innerHTML="Carregando...";try{await io(A,I.agentEmail),H.playSuccess(),X("Escalonamento enviado com sucesso!","success"),i.reset(),x.querySelectorAll(".bau-chip.active").forEach(k=>k.classList.remove("active")),J()}catch(k){console.error("Erro BAU:",k),X("Falha ao enviar: "+(k.message||"Erro desconhecido"),"error")}finally{Y.disabled=!1,Y.innerHTML=w}};function J(){t=!t,t&&(e.style.display="flex"),ue(t,e,"cw-btn-bauform")}return J}function na(){if(window.techSolInitialized){Ct();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Pt();try{H.initGlobalListeners(),H.playStartup()}catch(c){console.warn("\xC1udio bloqueado:",c)}fe.fetchTips(),Ct();let e=fo(),o=yo(),a=wo(),n=Co(),i=Oo(),s=Lo(),r=Io(),l=Mo(),d=Eo();so({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:l,broadcastControl:d}),setTimeout(()=>{fe.logEvent("App","Start","Session Start"),Ao(),setTimeout(()=>{ko(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}na();})();
