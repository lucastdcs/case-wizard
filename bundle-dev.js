...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let m=g.querySelector(".cw-hero-grid"),b=g.querySelector(".cw-acc-container"),T=g.querySelector(".cw-results-container"),y=g.querySelector(".cw-search-input");ma(g,".cw-acc-header, .cw-task-item");let w=g.querySelector(".cw-status-bar"),_=g.querySelector(".cw-status-text"),A=g.querySelector(".cw-footer-icons");function D(S,q){return B=>{if(B.target.closest(".cw-step-btn-hero, .cw-step-btn-list"))return;let C=o[S]?o[S].count:0;U(S,C>0?-C:1,q)}}function f(){m.innerHTML="",n.forEach(([S,q])=>{let B=i(q.name),C=document.createElement("div");C.className="cw-hero-card",C.id=`hero-${S}`,C.style.setProperty("--hero-color",B.color),C.innerHTML=`
          ...
          `,C.onclick=D(S,q),C.querySelector(".minus").onclick=()=>U(S,-1,q),C.querySelector(".plus").onclick=()=>U(S,1,q),C.tabIndex=0,C.setAttribute("role","button"),C.setAttribute("aria-pressed","false"),C.addEventListener("keydown",$=>{($.key==="Enter"||$.key===" ")&&($.preventDefault(),C.click())}),C.dataset.color=B.color,m.appendChild(C)})}f();function M(S,q){let B=i(q.name),C=document.createElement("div");return C.className="cw-task-item",C.dataset.id=S,C.innerHTML=`
    ...
    `;let r=document.createElement("div");r.className="cw-focus-backdrop",document.body.appendChild(r),document.body.appendChild(n),Pn(),Ee(()=>{let f=n.querySelector(".js-cc-quicksearch");f&&(f.title=_t("quickSearch"));let M=n.querySelector(".js-cc-casestoday");M&&(M.title=_t("casesToday"));let R=n.querySelector(".js-cc-drag");R&&(R.title=_t("drag"))});let s=f=>{v.playClick(),f()};if(n.querySelector(".notes").onclick=f=>{f.stopPropagation(),s(e.toggleNotes)},n.querySelector(".bauform").onclick=f=>{f.stopPropagation(),s(e.toggleBAUForm)},n.querySelector(".email").onclick=f=>{f.stopPropagation(),s(e.toggleEmail)},n.querySelector(".script").onclick=f=>{f.stopPropagation(),s(e.toggleScript)},n.querySelector(".links").onclick=f=>{f.stopPropagation(),s(e.toggleLinks)},n.querySelector(".library").onclick=f=>{f.stopPropagation(),s(e.toggleLibrary)},n.querySelector(".timezone").onclick=f=>{f.stopPropagation(),s(e.toggleTimezone)},n.querySelector(".configs").onclick=f=>{f.stopPropagation(),s(e.toggleConfigs)},n.querySelector(".broadcast").onclick=f=>{f.stopPropagation(),s(()=>{let M=f.currentTarget.querySelector(".cw-badge");M&&M.remove(),e.broadcastControl&&e.broadcastControl.toggle()})},n.querySelectorAll(".cw-btn").forEach(f=>{f.addEventListener("mouseenter",()=>v.playHover())}),e.broadcastControl&&e.broadcastControl.hasUnread){let f=document.createElement("div");f.className="cw-badge",n.querySelector(".broadcast").appendChild(f)}let c=()=>window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function g(){if(c()){n.classList.remove("collapsed"),v.playGenieOpen();return}let f=n.getBoundingClientRect(),M=window.innerHeight,R=f.top>M/2,U=f.height;n.style.setProperty("transition","none","important"),n.classList.remove("collapsed");let P=n.scrollHeight;if(n.classList.add("collapsed"),n.style.height=`${U}px`,R){let G=M-f.bottom;n.style.top="auto",n.style.bottom=`${G}px`}else n.style.bottom="auto",n.style.top=`${f.top}px`;n.style.overflow="hidden",n.offsetWidth,n.style.removeProperty("transition"),n.classList.remove("collapsed"),n.style.height=`${P}px`,v.playGenieOpen(),setTimeout(()=>{n.style.height="",n.style.overflow=""},350)}function u(f=!0){if(n.classList.contains("collapsed"))return;if(c()){n.classList.add("collapsed"),f&&v.playSwoosh();return}let M=n.getBoundingClientRect().height;n.style.setProperty("transition","none","important"),n.style.height=`${M}px`,n.offsetWidth,n.style.removeProperty("transition"),n.classList.add("collapsed"),n.style.height=`${so}px`,f&&v.playSwoosh(),setTimeout(()=>{n.style.height=""},700)}lo=u;let h=null;n.onmouseleave=()=>{document.querySelector(".cw-processing-card")||(h=setTimeout(()=>{n.querySelector(".cw-btn.active")||u()},3e3))},n.onmouseenter=()=>{h&&clearTimeout(h)},(async function(){let M=()=>{let R=Ne();if(R){let U=R.split("@")[0].toLowerCase();if(nn.includes(U)){let P=n.querySelector("#cw-admin-tag");P&&P.classList.add("visible")}}else setTimeout(M,2e3)};if(M(),t&&typeof t.then=="function"){try{await t}catch{}await ue(150)}else await ue(2800);n.classList.add("arriving"),v.playReady(),n.querySelectorAll(".cw-sep").forEach(R=>R.classList.add("visible"))})();let m=!1,b,T,y,w,_=3;n.onmousedown=f=>{if(f.target.closest("button"))return;f.preventDefault(),b=f.clientX,T=f.clientY;let M=n.getBoundingClientRect();y=M.left,w=M.top,document.addEventListener("mousemove",A),document.addEventListener("mouseup",D)};function A(f){let M=f.clientX-b,R=f.clientY-T;!m&&Math.sqrt(M*M+R*R)>_&&(m=!0,n.classList.add("dragging"),n.style.transition="none",h&&clearTimeout(h)),m&&(n.style.left=`${y+M}px`,n.style.top=`${w+R}px`,n.style.right="auto",n.style.bottom="auto",n.style.transform="none")}function D(f){if(document.removeEventListener("mousemove",A),document.removeEventListener("mouseup",D),m){m=!1,n.classList.remove("dragging");let M=window.innerWidth,R=window.innerHeight,U=n.getBoundingClientRect(),P=U.left+U.width/2,G;P<M/2?(G=24,n.classList.remove("side-right"),n.classList.add("side-left")):(G=M-U.width-24,n.classList.remove("side-left"),n.classList.add("side-right"));let S=qt(U.top,24,R-U.height-24);setTimeout(()=>{n.style.setProperty("transition","left 0.3s cubic-bezier(0.4, 0, 0.2, 1), top 0.3s cubic-bezier(0.4, 0, 0.2, 1)","important"),n.style.left=`${G}px`,n.style.top=`${S}px`,n.style.bottom="auto",n.style.transform=""},10),setTimeout(()=>{n.style.transition="",n.style.removeProperty("transition")},700)}else{let M=n.querySelector(".cw-btn.active"),R=f.target.closest("button");n.classList.contains("collapsed")?g():!M&&!R&&u(),R&&(R.style.transform="scale(0.9)",setTimeout(()=>R.style.transform="",150))}}}function sa(){let e=document.querySelector(".cw-pill"),t=document.querySelector(".cw-focus-backdrop");window._CW_ABORT_PROCESS=!1;let a=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;e&&lo?lo(!1):e&&e.classList.add("collapsed"),e&&e.classList.add("cw-busy");let o=document.createElement("div");o.className="cw-processing-card",o.innerHTML=`
...
`))}else ce.value.trim()===re.trim()&&(ce.value="");K.updateField(Z,ce.value),ce.dispatchEvent(new Event("input"))}}}}function le(d,E){let k=document.createElement("div");if(k.className="cw-actions-section",k.style.cssText=`
    ...
    `,document.head.appendChild(e)}function Ns(e,t){return e.map(a=>bi(a,de())).filter(a=>a.name.toLowerCase().includes(t.toLowerCase())||a.category.toLowerCase().includes(t.toLowerCase()))}function Is(e){return Object.entries(Rt).filter(([t,a])=>a&&(t.toLowerCase().includes(e.toLowerCase())||a.toLowerCase().includes(e.toLowerCase()))).map(([t,a])=>({id:t,name:t.replace(/_/g," "),category:"\u26A1 Smart CRs",code:a,isSmartCR:!0}))}function _s(e){return je.getSnippets("email").filter(t=>t.title.toLowerCase().includes(e.toLowerCase())||t.subject&&t.subject.toLowerCase().includes(e.toLowerCase())).map(t=>{let a=[],o=t.content.match(/\[([^\]]+)\]/g);return o&&[...new Set(o)].forEach(i=>{a.push({key:i,label:i.replace("[","").replace("]",""),type:i.toLowerCase().includes("data")?"date":"text",auto:i.toLowerCase().includes("nome")&&i.toLowerCase().includes("seu")?"agentName":null})}),{id:t.id||`snippet-${Math.random()}`,name:t.title,category:"\u{1F464} Pessoal",subject:t.subject||Qe("noSubject"),template:t.content,placeholders:a}})}function Ds(e,t){return[...Ns(e,t),...Is(t),..._s(t)]}function yi(){let e="v6.0.0",t=!1,a=[],o=null,i="",n=new Set;Ls();let r=document.createElement("div");r.id="email-assistant-popup",r.classList.add("cw-module-window","cw-email-popup"),Object.assign(r.style,Ue,{width:"850px",height:"650px"}),r.style.display="none",r.style.flexDirection="column";let s=$e(r,Qe("headerTitle"),e,Qe("headerDesc"),{popup:r},()=>S()),c=document.createElement("div");c.className="cw-email-main";let g=document.createElement("div");g.className="cw-email-left-panel";let u=document.createElement("div");u.className="cw-email-search-container";let h=document.createElement("input");h.className="cw-email-search-input",h.placeholder=Qe("searchPlaceholder");let m=document.createElement("div");m.id="email-template-list",ma(m,".cw-email-cat-header, .cw-email-list-item");let b=document.createElement("div");b.className="cw-email-clear-btn",b.innerHTML="\u2715",b.onclick=()=>{h.value="",i="",b.style.display="none",$(),h.focus()},u.appendChild(h),u.appendChild(b),g.appendChild(u),g.appendChild(m);let T=document.createElement("div");T.className="cw-email-right-panel";let y=document.createElement("div");y.className="cw-email-fields-section";let w=document.createElement("div");w.className="cw-email-preview-section";let _=document.createElement("div");_.className="cw-email-preview-header";let A=document.createElement("span");A.textContent=Qe("previewTitle"),A.className="cw-email-preview-title";let D=document.createElement("div");D.className="cw-email-preview-actions";let f=(J,le=!1)=>{let F=document.createElement("button");return F.textContent=J,F.className="cw-email-btn"+(le?" primary":""),F},M=f("Copiar HTML"),R=f("Preencher no CRM",!0),U=f("Smart CR");U.classList.add("warning"),D.appendChild(U),D.appendChild(M),D.appendChild(R),_.appendChild(A),_.appendChild(D);let P=document.createElement("div");P.contentEditable="true",P.className="cw-email-preview-content",w.appendChild(_),w.appendChild(P),oe(),T.appendChild(y),T.appendChild(w),c.appendChild(g),c.appendChild(T),r.appendChild(s),r.appendChild(c);let G=document.createElement("div");Object.assign(G.style,ct),r.appendChild(G),dt(r,G),document.body.appendChild(r);function S(){t=!We(r),t?(Te(),r.style.display="flex",un(r),a.length===0&&q()):(qe(),r.style.display="none"),Be(t,r,"cw-btn-email")}async function q(){m.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',a=await hi.getTemplates(),$()}function B(J,le,F){let ae=document.createElement("div");ae.className="cw-email-cat-header",ae.tabIndex=0,ae.setAttribute("role","button"),ae.setAttribute("aria-expanded",String(F));let ie=document.createElement("span");ie.textContent=J,ae.appendChild(ie);let W=document.createElement("span");W.className="cw-email-cat-badge",W.textContent=le;let se=document.createElement("span");se.className="cw-email-cat-arrow",se.textContent=F?"\u25BE":"\u25B8";let L=document.createElement("div");return L.className="cw-email-cat-right",L.appendChild(W),L.appendChild(se),ae.appendChild(L),ae.onclick=()=>{n.has(J)?n.delete(J):n.add(J),$()},ae.addEventListener("keydown",j=>{(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),ae.click())}),ae}function C(J){let le=o&&o.id===J.id,F=document.createElement("div");if(F.className="cw-email-list-item"+(le?" selected":""),F.tabIndex=0,F.setAttribute("role","button"),F.setAttribute("aria-pressed",String(!!le)),le){let W=document.createElement("div");W.className="cw-email-list-indicator",F.appendChild(W)}let ae=document.createElement("span");ae.className="cw-email-list-icon",ae.innerHTML=J.isSmartCR?"\u26A1":J.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",F.appendChild(ae);let ie=document.createElement("span");return ie.className="cw-email-list-text",ie.textContent=J.name,F.appendChild(ie),F.onclick=()=>ne(J),F.addEventListener("keydown",W=>{(W.key==="Enter"||W.key===" ")&&(W.preventDefault(),F.click())}),F}function $(){m.innerHTML="";let J=Ds(a,i);if(J.length===0){m.innerHTML=`
                ...
                </div>`;return}[...new Set(J.map(F=>F.category))].sort((F,ae)=>F.localeCompare(ae)).forEach(F=>{let ae=n.has(F)||i.length>0,ie=J.filter(W=>W.category===F);m.appendChild(B(F,ie.length,ae)),ae&&ie.forEach(W=>{m.appendChild(C(W))})})}let Q=null;async function ne(J){o?.id!==J.id&&(o=J,Q&&clearTimeout(Q),T.style.opacity="0",T.style.transform="translateY(5px)",Q=setTimeout(()=>{U.style.display=J.isSmartCR?"block":"none",R.style.display=J.isSmartCR?"none":"block",M.style.display=J.isSmartCR?"none":"block",$(),H(),oe(),T.style.opacity="1",T.style.transform="translateY(0)",Q=null},150))}function H(){if(y.innerHTML="",!o||o.isSmartCR){o?.isSmartCR?(y.style.display="block",y.innerHTML=`<div class="cw-email-smartcr-hint">
                ...
                </div>`):y.style.display="none";return}let J=o.placeholders&&o.placeholders.length>0;if(y.style.display=J?"block":"none",!J)return;let le=document.createElement("div");le.className="cw-email-fields-grid",(o.placeholders||[]).forEach(F=>{let ae=document.createElement("div"),ie=document.createElement("label");ie.className="cw-email-field-label",ie.textContent=F.label;let W=document.createElement("input");W.className="cw-email-field-input",W.type=F.type||"text",W.dataset.key=F.key,F.auto==="agentName"&&(W.value=Jt().split(" ")[0]),W.addEventListener("input",oe),ae.appendChild(ie),ae.appendChild(W),le.appendChild(ae)}),y.appendChild(le)}function oe(){if(!o){P.innerHTML=`
...
CID: ${e.cid||"---"}
Case ID: ${e.caseId||"---"}
E-mail: ${e.clientEmail||"---"}`,dateLocale:"es-ES"}};function Ci(){return de()==="es"?"ES":"PT"}function ve(e){let t=de();return Ai[t]?.[e]??Ai.pt[e]}var be={bgApp:"#F5F5F7",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.07)",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",textPrimary:"#1D1D1F",textSecondary:"#6E6E73",danger:"#D93025",dangerBg:"#FCE8E6",success:"#34A853",successBg:"#E6F4EA"},Fs={inicio:{PT:"Abertura",ES:"Apertura"},meio:{PT:"Implementa\xE7\xE3o (Tag Support)",ES:"Implementaci\xF3n"},fim:{PT:"Fechamento",ES:"Cierre"}};function Ms(){if(document.getElementById("csa-styles-v2"))return;let e=document.createElement("style");e.id="csa-styles-v2",e.textContent=`
  ...
  `,B.appendChild(C),P.appendChild(B);let $=C.querySelectorAll("button"),Q=C.querySelector("#type-indicator");$.forEach((W,se)=>{W.onclick=()=>{$.forEach(L=>L.classList.remove("active")),W.classList.add("active"),Q.style.transform=`translateX(${se*(C.offsetWidth/2-2)}px)`,o=W.dataset.type,v.playClick(),F()}}),Ee(()=>{a=Ci(),m&&(m.textContent=ve("headerTitle"));let W=n.querySelector(".cw-help-title");W&&(W.textContent=ve("headerTitle"));let se=n.querySelector(".cw-help-description");se&&(se.textContent=ve("headerDesc"));let L=b.querySelector(".js-csa-monitoring");L&&(L.title=ve("activeMonitoring"));let j=b.querySelector(".js-csa-cid-label");j&&(j.textContent=ve("cidLabel"));let ee=b.querySelector(".js-csa-email-label");ee&&(ee.textContent=ve("emailLabel")),b.querySelectorAll(".csa-copy-hint").forEach(p=>p.textContent=ve("copied"));let z=b.querySelector(".js-csa-am-title");z&&(z.textContent=ve("amMessageTitle"));let l=b.querySelector(".js-csa-am-sub");l&&(l.textContent=ve("amMessageSub")),D&&(D.textContent=ve("copyFinalMessage"));let x=q.querySelector(".js-csa-reset-label");x&&(x.textContent=ve("resetScript")),F()});let ne=document.createElement("div");ne.id="csa-checklist-area",P.appendChild(ne);let H=document.createElement("div");Object.assign(H.style,ct),H.className="no-drag",H.title=ve("resize"),n.appendChild(H),dt(n,H),document.body.appendChild(n),M("#cw-pill-cid","#cw-ctx-cid"),M("#cw-pill-email","#cw-ctx-email");function oe(W){return W.replace(/\n/g,"<br>")}function J(W,se,L,j){let ee=`${W}-${se}-${j}`,z=!!t[ee],l=document.createElement("div");l.className="csa-item-row"+(z?" completed":"");let x=document.createElement("div");x.className="csa-checkbox"+(z?" checked":""),x.innerHTML=z?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"";let p=document.createElement("span");return p.className="csa-item-text"+(z?" completed":""),p.innerHTML=oe(L),l.onclick=()=>{let N=!t[ee];t[ee]=N,v.playClick(),l.classList.toggle("completed",N),p.classList.toggle("completed",N),x.classList.toggle("checked",N),x.innerHTML=N?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"",N&&(x.classList.add("pulse"),setTimeout(()=>x.classList.remove("pulse"),150)),ae(W,Gt[W])},l.appendChild(x),l.appendChild(p),{row:l,isDone:z}}function le(W,se,L){let j=document.createElement("div");j.className="csa-card";let ee=document.createElement("div");ee.className="csa-card-title",ee.textContent=Fs[se][a]||"";let z=document.createElement("span");z.className="csa-card-counter",ee.appendChild(z),j.appendChild(ee);let l=0;L.forEach((p,N)=>{let{row:O,isDone:Y}=J(W,se,p,N);Y&&l++,j.appendChild(O)});let x=l===L.length&&L.length>0;return j.classList.toggle("done",x),z.classList.toggle("done",x),z.textContent=`${l}/${L.length}`,j}function F(){ne.innerHTML="";let W=`${a} ${o}`,se=Gt[W];if(!se){ne.innerHTML=`<div class="csa-empty-state"><div class="csa-empty-state-icon">\u2615</div><div>${ve("scriptNotConfigured")}</div></div>`,U.style.width="0%";return}let L=0,j=0;["inicio","meio","fim"].forEach(ee=>{se[ee]&&(L+=se[ee].length)}),["inicio","meio","fim"].forEach(ee=>{let z=se[ee];!z||z.length===0||(z.forEach((l,x)=>{let p=`${W}-${ee}-${x}`;t[p]&&j++}),ne.appendChild(le(W,ee,z)))}),ie(L,j)}function ae(W,se){let L=0,j=0;["inicio","meio","fim"].forEach(ee=>{let z=se[ee]||[];L+=z.length,z.forEach((l,x)=>{t[`${W}-${ee}-${x}`]&&j++})}),ie(L,j),setTimeout(()=>F(),200)}function ie(W,se){let L=W===0?0:se/W*100;U.style.width=`${L}%`,U.classList.toggle("complete",L===100)}return F(),Ei(()=>F()),u}var zs={"Ponto Eletr\xF4nico":"Control de Asistencia","Ferramenta de ajuda":"Herramienta de ayuda","Intranet Google":"Intranet Google","Relat\xF3rio Follow-ups":"Informe de Follow-ups","Dashboard WFM":"Dashboard WFM","Tech Solutions SAO":"Tech Solutions SAO","Form Grava\xE7\xE3o":"Form Grabaci\xF3n","Form Escala\xE7\xE3o":"Form Escalaci\xF3n","Instru\xE7\xF5es Split":"Instrucciones Split","Single Page App":"Single Page App","Procedimento Padr\xE3o":"Procedimiento Est\xE1ndar","Valida\xE7\xE3o C\xF3digo":"Validaci\xF3n C\xF3digo","Convers\xE3o Chamada":"Conversi\xF3n Llamada","Valida\xE7\xE3o WCC":"Validaci\xF3n WCC",ECW4:"ECW4","Monitoramento EC":"Monitoreo EC","Resolu\xE7\xE3o problemas":"Resoluci\xF3n de problemas","Implementa\xE7\xE3o RMKT":"Implementaci\xF3n RMKT","Pontua\xE7\xE3o Leads":"Puntuaci\xF3n de Leads","Instala\xE7\xE3o Container":"Instalaci\xF3n Container","Instala\xE7\xE3o Config.":"Instalaci\xF3n Config.","Valida\xE7\xE3o GA4":"Validaci\xF3n GA4","Guia Dev":"Gu\xEDa Dev","Resolu\xE7\xE3o Problemas":"Resoluci\xF3n de Problemas","Dom\xEDnio Cruzado":"Dominio Cruzado","Lista Oficial":"Lista Oficial","Criador URLs":"Creador de URLs","Setup Inicial":"Setup Inicial","Otimiza\xE7\xE3o Feed":"Optimizaci\xF3n Feed","Ferramenta Interna":"Herramienta Interna",Avalia\u00E7\u00F5es:"Rese\xF1as","Feeds Offline":"Feeds Offline","Help Center":"Help Center","Guias CMS":"Gu\xEDas CMS","Solu\xE7\xF5es Iframes":"Soluciones Iframes","Ghost Ads":"Ghost Ads","Ghost Analytics":"Ghost Analytics","Ghost GTM":"Ghost GTM",Ferramenta:"Herramienta","Ghost MC":"Ghost MC","Playground JS":"Playground JS","Testador Regex":"Probador Regex","Doc. CSP":"Doc. CSP","Guia CoMo":"Gu\xEDa CoMo","Debug CoMo":"Debug CoMo","Portal Colaborador":"Portal del Colaborador","Apps e Sistemas":"Apps y Sistemas","Folha Pagamento":"N\xF3mina","Reportar problemas":"Reportar problemas","Registro chamadas":"Registro de llamadas","Erros de sistema":"Errores de sistema","BAU/Descarte/Monitoria":"BAU/Descarte/Monitoreo","Feedback positivo":"Feedback positivo","Casos dif\xEDceis":"Casos dif\xEDciles","Chat/Email Ads":"Chat/Email Ads","Chat/Email Shopping":"Chat/Email Shopping","Perfil da Empresa":"Perfil de la Empresa","Console API":"Console API","Lista de n\xFAmeros":"Lista de n\xFAmeros",Cursos:"Cursos"};function Ti(e){let t=e&&typeof e=="object"?e:{desc:e},a=t.desc||"";return de()!=="es"?a:t.descEs||zs[a]||a}var qi={pt:{headerTitle:"Central de Links",headerDesc:"Navegue pelas categorias ou use a busca.",searchPlaceholder:"Buscar ferramenta ou SOP...",recent:"Recentes",nothingHereYet:"Nada por aqui ainda",nothingHereSub:"Os links que voc\xEA abrir aparecem aqui pra acesso r\xE1pido depois.",searchResults:"Resultados da busca",nothingFound:"Nada encontrado",noLinkMatches:e=>`Nenhum link bate com "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"Link copiado!",copyFailedToast:"N\xE3o foi poss\xEDvel copiar o link.",categoryLabels:{tasks:"Tarefas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RH",lm:"Forms",qa:"QA",suporte:"Ajuda"}},es:{headerTitle:"Central de Enlaces",headerDesc:"Navega por las categor\xEDas o usa la b\xFAsqueda.",searchPlaceholder:"Buscar herramienta o SOP...",recent:"Recientes",nothingHereYet:"Todav\xEDa no hay nada aqu\xED",nothingHereSub:"Los enlaces que abras aparecen aqu\xED para acceso r\xE1pido despu\xE9s.",searchResults:"Resultados de la b\xFAsqueda",nothingFound:"No se encontr\xF3 nada",noLinkMatches:e=>`Ning\xFAn enlace coincide con "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"\xA1Enlace copiado!",copyFailedToast:"No se pudo copiar el enlace.",categoryLabels:{tasks:"Tareas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RRHH",lm:"Forms",qa:"QA",suporte:"Ayuda"}}};function Pe(e){let t=de();return qi[t]?.[e]??qi.pt[e]}function Li(e){return Pe("categoryLabels")[e]??ht[e]?.label??e}var ht={tasks:{label:"Tarefas",links:[{name:"Web Clock Punch",url:"https://compass.talent.cognizant.com/psp/HCMPRD/EMPLOYEE/HRMS/h/?tab=DEFAULT",desc:"Ponto Eletr\xF4nico"},{name:"Web\xE3o Help Deluxe",url:"http://go/webao-help-deluxe",desc:"Ferramenta de ajuda"},{name:"Moma Home",url:"https://moma.corp.google.com/",desc:"Intranet Google"},{name:"Plx DataSites",url:"https://data.corp.google.com/sites/7kpryuwxw9jw/agents_follow_ups_report/",desc:"Relat\xF3rio Follow-ups"},{name:"Escala & Ader\xEAncia",url:"https://lookerstudio.google.com/c/u/0/reporting/f8966844-b70e-4070-9b7f-a29028401bf4/page/p_0tayxfleid",desc:"Dashboard WFM"},{name:"Performance Indiv.",url:"https://dashboards.corp.google.com/_a981e311_424f_410b_925f_9b019ee186ce",desc:"Tech Solutions SAO"},{name:"Solicitar Grava\xE7\xE3o",url:"https://support.google.com/policies/contact/sar",desc:"Form Grava\xE7\xE3o"},{name:"Escala\xE7\xE3o Sellers",url:"https://forms.gle/HWMhML56eE4CPZCs5",desc:"Form Escala\xE7\xE3o"},{name:"[SOP] Split",url:"https://sites.google.com/corp/google.com/technicalsolutions/case-handling_1/out-of-scope?authuser=0#h.obb5iieru15o",desc:"Instru\xE7\xF5es Split"}]},ads:{label:"Ads",links:[{name:"SPA (Tag Support)",url:"https://tagsupport.corp.google.com/create-session",desc:"Single Page App"},{name:"[SOP] Conv. Tracking",url:"https://docs.google.com/document/d/1By5Jv40kGeGWFUzMXT9xuNAeUl_s1clYybZO1nhNnAI/edit",desc:"Procedimento Padr\xE3o"},{name:"Win Criteria: Code",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit",desc:"Valida\xE7\xE3o C\xF3digo"},{name:"[SOP] Call Conv.",url:"https://docs.google.com/document/d/1es_tvx8nhMkWn-Hh9n3Jd3vzo91RpY6PuwMBlsTd-kA/edit",desc:"Convers\xE3o Chamada"},{name:"Win Criteria: WCC",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A10:A15",desc:"Valida\xE7\xE3o WCC"},{name:"[SOP] Enhanced Conv.",url:"https://docs.google.com/document/d/1R59-cUeBaX-5dOxAXxvzsRXgkVdFPzTzOCSBQWt42H0/edit",desc:"ECW4"},{name:"Ads EC Dashboard",url:"https://dashboards.corp.google.com/edit/_0ded1099_6ef3_4bc9_bba0_2445840d1b69",desc:"Monitoramento EC"},{name:"[SOP] Troubleshooting",url:"https://docs.google.com/document/d/10M0FAkMFmlhgHQJtAQPNtLRGh-BpPzR_6z1s6xYOQEk/edit",desc:"Resolu\xE7\xE3o problemas"},{name:"[SOP] Remarketing",url:"https://docs.google.com/document/d/1awOuj4rFBrukfByYuvcCFOAGbZX7H1j_EelPeCaUcoU/edit",desc:"Implementa\xE7\xE3o RMKT"},{name:"[SOP] Lead Scoring",url:"https://docs.google.com/document/d/1jyFVLvKnk1K2ojyj-K37PXcmQdU9A8wiHWj-w49yOBg/edit",desc:"Pontua\xE7\xE3o Leads"},{name:"[SOP] GTM Install",url:"https://docs.google.com/document/d/1Uj-fkPNxygeL-YQIVgLfIPo579SKF1oe78i5nHx5eLs/edit",desc:"Instala\xE7\xE3o Container"}]},analytics:{label:"GA4",links:[{name:"[SOP] GA4 Setup",url:"https://docs.google.com/document/d/1cLDh6RIo-lxfv-pffvBwhFpI-fSTOaAsMXwwsID1yNk/edit",desc:"Instala\xE7\xE3o Config."},{name:"Win Criteria: GA4",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A45:A51",desc:"Valida\xE7\xE3o GA4"},{name:"GA4 E-commerce",url:"https://developers.google.com/analytics/devguides/collection/ga4/ecommerce?hl=pt-br",desc:"Guia Dev"},{name:"[SOP] Troubleshoot GA4",url:"https://docs.google.com/document/d/14fxyQMlcT57ILtsaBdYBFZs2DDZeSbXsvniXfo_eJaU/edit",desc:"Resolu\xE7\xE3o Problemas"},{name:"[SOP] Cross Domain",url:"https://support.google.com/ads-help/answer/12282402",desc:"Dom\xEDnio Cruzado"},{name:"Eventos Recomendados",url:"https://developers.google.com/analytics/devguides/collection/ga4/reference/events",desc:"Lista Oficial"},{name:"UTM Builder",url:"https://ga-dev-tools.google/ga4/campaign-url-builder/",desc:"Criador URLs"}]},shopping:{label:"Shop",links:[{name:"[SOP] Onboarding MC",url:"https://docs.google.com/document/d/1yJGEssn9Uvxa3eWjp2Y5MQSkL26AElh6sSAKgD6qmjg/edit",desc:"Setup Inicial"},{name:"[SOP] Feed Opt",url:"https://docs.google.com/document/d/1VBYH6b3r0uyjXHN749pDK7IajF5Ii0-rm6M-BZuaJGY/edit",desc:"Otimiza\xE7\xE3o Feed"},{name:"ShopTroubleshooting",url:"http://go/shoptroubleshooting",desc:"Ferramenta Interna"},{name:"[SOP] Product Reviews",url:"https://docs.google.com/document/d/1v2xH6QLgWc5_-C85Pmj40GSe5lxstRXnjd8vEW92TBk/edit",desc:"Avalia\xE7\xF5es"},{name:"[SOP] Offline Feed",url:"https://docs.google.com/document/d/1Q3cJxf4ucfA_bu6vDId63Tj1P8ZofgE7CqnK9KUgLuU/edit",desc:"Feeds Offline"},{name:"Especifica\xE7\xE3o Dados",url:"https://support.google.com/merchants/answer/7052112",desc:"Help Center"}]},tech:{label:"Tech",links:[{name:"Solu\xE7\xF5es por CMS",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-via-cms?authuser=0",desc:"Guias CMS"},{name:"Iframes & Cross-Origin",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-t%C3%A9cnicas/iframes-contentdocument-e-message?authuser=0",desc:"Solu\xE7\xF5es Iframes"},{name:"Ads ICS Ghost",url:"http://go/pqp",desc:"Ghost Ads"},{name:"Analytics ICS Ghost",url:"http://go/analytics-ics",desc:"Ghost Analytics"},{name:"GTM ICS Ghost",url:"http://go/tagmanager-ics",desc:"Ghost GTM"},{name:"Gearloose",url:"http://go/gearloose",desc:"Ferramenta"},{name:"MC ICS Ghost",url:"https://mcn-ics.corp.google.com/mc/overview",desc:"Ghost MC"},{name:"JSFiddle",url:"https://jsfiddle.net/",desc:"Playground JS"},{name:"RegExr",url:"https://regexr.com/",desc:"Testador Regex"},{name:"Doc. CSP",url:"https://developers.google.com/tag-platform/tag-manager/web/csp?hl=pt-br.",desc:"Doc. CSP"},{name:"Consent Mode Install",url:"https://developers.google.com/tag-platform/security/guides/consent?consentmode=advanced",desc:"Guia CoMo"},{name:"Consent Mode Debug",url:"https://developers.google.com/tag-platform/security/guides/consent-debugging",desc:"Debug CoMo"}]},hr:{label:"RH",links:[{name:"Be.Cognizant",url:"https://cognizantonline.sharepoint.com/sites/GlobalHR/SitePages/Brazil.aspx",desc:"Portal Colaborador"},{name:"OneCognizant",url:"https://onecognizant.cognizant.com/Home",desc:"Apps e Sistemas"},{name:"ADP eXpert",url:"https://expert.cloud.brasil.adp.com/expert2/v4/",desc:"Folha Pagamento"}]},lm:{label:"Forms",links:[{name:"Ocorr\xEAncias e Pausas",url:"https://docs.google.com/forms/d/e/1FAIpQLSc6CamPehrREeVr7yCWMyqFETrFYYezNcLb_13W4yZDQkfY6Q/viewform",desc:"Reportar problemas"},{name:"Chamadas >50min",url:"https://docs.google.com/forms/d/e/1FAIpQLSfE8EMHNJMTKYeA6XM2RZjZ9AQ4LhGk1Dwm_WLu3kcMdKMikA/viewform",desc:"Registro chamadas"},{name:"Relat\xF3rio de Bugs",url:"https://docs.google.com/forms/d/e/1FAIpQLSfkqRqT2Kbf08IStz31fQPE84MDOtGxk7cetJmc3xzShXIXRA/viewform",desc:"Erros de sistema"},{name:"Suporte LM",url:"https://script.google.com/a/macros/google.com/s/AKfycbxYMlFCMZvqgHMIImeS_u-lNZPiertXmem-5m9Fox3jvZaq0ZOQDoc5ma96ltSvWHY/exec",desc:"BAU/Descarte/Monitoria"}]},qa:{label:"QA",links:[{name:"Elogios",url:"https://docs.google.com/forms/d/e/1FAIpQLSezY5K-trQDv0LkL5IoTlV0Tl0oOqGTEszylmgcbMRXcC9Weg/viewform",desc:"Feedback positivo"},{name:"Casos Complexos",url:"https://docs.google.com/forms/d/e/1FAIpQLSe26q1LEloFNRfOAVZtA7DCOQTqdu1BAEeWuxtK6oPwZhLp-A/viewform?resourcekey=0-c1N4h8gntza2gQowqYAqMw",desc:"Casos dif\xEDceis"}]},suporte:{label:"Ajuda",links:[{name:"Fale Conosco Ads",url:"https://support.google.com/google-ads/gethelp",desc:"Chat/Email Ads"},{name:"Fale Conosco Merchant",url:"https://support.google.com/merchants/gethelp",desc:"Chat/Email Shopping"},{name:"Fale Conosco GMB",url:"https://support.google.com/business/gethelp",desc:"Perfil da Empresa"},{name:"Suporte API",url:"https://support.google.com/googleapi",desc:"Console API"},{name:"Telefones Suporte",url:"https://www.adwordsrobot.com/en/list-of-google-adwords-support-phone-numbers",desc:"Lista de n\xFAmeros"},{name:"Skill Shop",url:"https://skillshop.withgoogle.com/intl/pt-BR_ALL/",desc:"Cursos"}]}};function Ni(e){if(!Array.isArray(e)||!e.length)return!1;let t={};for(let a of e){let o=a.key;if(!o)continue;let i;try{i=JSON.parse(a.value||"{}")}catch{continue}!i.name||!i.url||(t[o]||(t[o]={label:ht[o]?.label||o,links:[]}),t[o].links.push({name:i.name,url:i.url,desc:i.desc||"",descEs:i.desc_es||""}))}if(!Object.keys(t).length)return!1;for(let a of Object.keys(ht))delete ht[a];return Object.assign(ht,t),!0}async function Rs(e){let t=ge.getCachedContent("links");Ni(t)&&e?.();try{let a=await ge.fetchContentModule("links");Ni(a)&&e?.()}catch(a){console.warn("Central de Conte\xFAdo indispon\xEDvel; usando links embutidos.",a)}}var At={tasks:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>',lm:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/></svg>',qa:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>',suporte:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',ads:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>',analytics:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>',shopping:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>',tech:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg>',hr:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',history:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>'},Ct={bgApp:"#F8F9FA",bgSidebar:"#FFFFFF",bgSurface:"#FFFFFF",textPrimary:"#202124",textSecondary:"#5F6368",borderSubtle:"rgba(0,0,0,0.06)"},Da={tasks:{color:"#0097A7",bg:"#E0F7FA"},ads:{color:"#1967D2",bg:"#E8F0FE"},analytics:{color:"#E37400",bg:"#FEF7E0"},shopping:{color:"#188038",bg:"#E6F4EA"},tech:{color:"#9334E6",bg:"#F3E8FD"},hr:{color:"#C5221F",bg:"#FCE8E6"},lm:{color:"#5F6368",bg:"#F1F3F4"},qa:{color:"#F09D00",bg:"#FFF3E0"},suporte:{color:"#0B57D0",bg:"#D3E3FD"},history:{color:"#5F6368",bg:"#FFFFFF"}};function $s(){if(document.getElementById("cw-links-styles"))return;let e=document.createElement("style");e.id="cw-links-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}var Us={pt:"pt-BR",es:"es-ES"};function Bi(e){if(!e)return"";try{let t=new Date(e);return isNaN(t.getTime())?String(e):new Intl.DateTimeFormat(Us[de()]||"pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).format(t)}catch{return String(e)}}function Vs(e){let t=String(e||"").split("-");return t.length===3?`${t[2]}/${t[1]}`:String(e||"")}function Ws(e){let t=new Date(e).getTime();if(!t||isNaN(t))return"";let a=Math.floor((Date.now()-t)/6e4);if(a<1)return fe("justNow");if(a<60)return fe("minutesAgo")(a);let o=Math.floor(a/60);return o<24?fe("hoursAgo")(o):o<48?fe("yesterday"):Bi(e).split(",")[0]}function Oi(e){if(!e||typeof e!="string")return"";let t=e;return t=t.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="cw-bc-link">$1</a>'),t=t.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),t=t.replace(/_(.*?)_/g,"<i>$1</i>"),t=t.replace(/\n/g,"<br>"),t=mn(t),t}function Fi(e){if(!e)return null;let t={};try{t=JSON.parse(e.value||"{}")}catch{return null}let a=String(t.title||e.label||"").trim(),o=String(t.text||"").trim();return!a||!o?null:{id:String(e.key||e.id||""),type:wo[t.type]?t.type:"info",title:a,text:o,date:String(t.publishedAt||e.publishedAt||""),author:String(t.author||e.publishedBy||""),lang:String(e.lang||"ALL").toUpperCase()}}function Ys(e){if(!e)return null;let t=String(e.title||"").trim(),a=String(e.text||"").trim();return!t||!a||t.toLowerCase().includes("disponibilidade bau")?null:{id:String(e.id||""),type:wo[e.type]?e.type:"info",title:t,text:a,date:String(e.date||""),author:String(e.author||""),lang:"ALL"}}function Mi(e){let t=(e||[])[0];if(!t)return null;let a={};try{a=JSON.parse(t.value||"{}")}catch{return null}let o=a.segments||{},i={};return Object.keys(o).forEach(n=>{let r=String(o[n]?.attention||""),s=String(o[n]?.full||"");(r||s)&&(i[n]={attention:r,full:s})}),Object.keys(i).length?{updatedAt:String(a.updatedAt||t.publishedAt||""),author:String(a.author||t.publishedBy||""),note:String(a.note||""),segments:i}:null}function zi(e,t){return e.lang==="ALL"||e.lang===t}function Ht(){try{let e=JSON.parse(localStorage.getItem($i)||"[]");return Array.isArray(e)?e:[]}catch{return[]}}function Ri(e){try{localStorage.setItem($i,JSON.stringify(e))}catch{}}function Pi(){let e="v5.0",t=!1,a=null,o="",i=null,n=null,r=!1,s=[],c=null,g=null,u=null,h=null;Hs();let m=document.createElement("div");m.id="broadcast-popup",m.classList.add("cw-module-window"),Object.assign(m.style,Ue,{right:"auto",left:"50%",width:"760px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let b={popup:m,googleLine:null};function T(){if(t=!We(m),Be(t,m,"cw-btn-broadcast"),t){Te();let z=document.getElementById("cw-btn-broadcast");z&&z.classList.remove("has-new"),i=null,n=null,r=!1,$()}else qe()}let y=$e(m,fe("headerTitle"),e,fe("headerDesc"),b,()=>T()),w=y.querySelector("span");m.appendChild(y);let _=document.createElement("div");_.className="cw-bc-search-wrap";let A=document.createElement("div");A.className="cw-bc-search-icon",A.setAttribute("aria-hidden","true"),A.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let D=document.createElement("input");D.className="cw-bc-search-input no-drag",D.type="search",D.name="cw-broadcast-search",D.autocomplete="off",D.spellcheck=!1,D.placeholder=fe("searchPlaceholder"),D.setAttribute("aria-label",fe("searchPlaceholder"));let f=document.createElement("button");f.type="button",f.className="cw-bc-search-clear",f.setAttribute("aria-label",fe("clearSearch")),f.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';let M=document.createElement("div");M.className="cw-bc-search-field",M.append(A,D,f),_.appendChild(M),m.appendChild(_),D.addEventListener("input",z=>{o=z.target.value,f.classList.toggle("visible",o.length>0),se()}),f.onclick=()=>{D.value="",o="",f.classList.remove("visible"),se(),D.focus()};let R=document.createElement("div");R.className="cw-bc-body",m.appendChild(R);let U=document.createElement("div");U.className="cw-nice-scroll cw-bc-feed",U.setAttribute("role","feed"),U.setAttribute("aria-label",fe("headerTitle")),R.appendChild(U);let P=document.createElement("aside");P.className="cw-nice-scroll cw-bc-aside",P.setAttribute("aria-label",fe("asideLabel")),R.appendChild(P);let G=document.createElement("div");G.id="cw-bau-widget",G.className="cw-bc-panel",G.style.display="none",P.appendChild(G);let S=document.createElement("div");S.className="cw-bc-panel",P.appendChild(S);let q=document.createElement("div");q.className="cw-bc-panel",P.appendChild(q);let B=document.createElement("div");B.id="cw-update-status",B.className="cw-bc-sync",B.setAttribute("role","status"),B.setAttribute("aria-live","polite"),P.appendChild(B);function C({syncing:z=!1,online:l=!0}={}){if(B.classList.toggle("offline",!z&&!l),z){B.innerHTML=`<span class="cw-bc-spinner" aria-hidden="true"></span><span>${fe("syncing")}</span>`;return}let x=h?Ws(h):"",p=l?x?fe("updatedAgo")(x):fe("updated"):fe("offline");B.innerHTML=`<span class="cw-bc-sync-dot" aria-hidden="true"></span><span>${p}</span>`}async function $(){C({syncing:!0});let z=!0,l=Zt();try{let[x,p]=await Promise.all([ge.fetchContentModule("broadcast"),ge.fetchContentModule("bau_availability")]);if(Array.isArray(x)){let N=x.map(Fi).filter(Boolean).filter(O=>zi(O,l));s=ne(N)}else z=!1;c=Mi(p)}catch{z=!1}z&&(h=new Date().toISOString()),Q(),H(),se(),C({online:z})}function Q(){let z=c?c.updatedAt:null;if(!(g===null)&&!t){let x=Ht();(s.some(O=>!g.has(O.id)&&!x.includes(O.id))||z&&z!==u)&&v.playNotification()}g=new Set(s.map(x=>x.id)),u=z}function ne(z){return z.slice().sort((l,x)=>{let p=new Date(l.date).getTime()||0;return(new Date(x.date).getTime()||0)-p})}function H(){let z=document.getElementById("cw-btn-broadcast");if(!z)return;let l=Ht();if(s.some(p=>!l.includes(p.id))){if(z.classList.add("has-new"),!z.querySelector(".cw-badge")){let p=document.createElement("div");p.className="cw-badge",Object.assign(p.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),z.appendChild(p)}}else{z.classList.remove("has-new");let p=z.querySelector(".cw-badge");p&&p.remove()}}function oe(){if(!c){G.style.display="none",G.innerHTML="";return}let z=Object.keys(Oa).filter(k=>c.segments[k]);if(!z.length){G.style.display="none",G.innerHTML="";return}let l=i&&z.includes(i)?i:z.includes(Zt())?Zt():z[0],x=Oa[l],p=c.segments[l]||{},N=(k,X)=>`
          ...
          </span>`,O=[p.attention?N("attention",p.attention):"",p.full?N("full",p.full):""].join(""),Y=z.find(k=>k!==l),d=Y?`<button class="cw-bc-bau-swap" type="button"
                     aria-label="${fe("swapTo")(Oa[Y].label)}"
                     title="${fe("swapTo")(Oa[Y].label)}">${Gs}</button>`:"";G.style.display="flex",G.innerHTML=`
          ...
          <div class="cw-bc-bau-dates">
              ${O||`<span class="cw-bc-bau-empty">${fe("noDates")}</span>`}
          </div>
          ${c.note?`<div class="cw-bc-bau-note">${Oi(c.note)}</div>`:""}
      `;let E=G.querySelector(".cw-bc-bau-swap");E&&(E.onclick=()=>{i=Y,v.playClick(),oe()})}function J(){let z={critical:0,info:0,success:0};s.forEach(p=>{z[p.type]=(z[p.type]||0)+1});let l=(p,N,O)=>`
          <button class="cw-bc-filter" type="button" data-tipo="${p}"
                  aria-pressed="${n===p}">
              ${p==="all"?"":`<span class="cw-bc-type-dot ${p}"></span>`}
              <span>${N}</span>
              <span class="cw-bc-filter-count">${O}</span>
          </button>`;S.innerHTML=`
      ...
      `,q.querySelector(".cw-bc-history-divider").onclick=()=>{v.playClick(),r=!r,se()},q.querySelector(".cw-bc-clear-btn").onclick=()=>{x&&(v.playSuccess(),Ri(s.map(p=>p.id)),se(),H())}}let F=0;function ae(z,l){let x=document.createElement("article");x.className="cw-bc-card"+(l?" history":"");let p=wo[z.type]?z.type:"info",N=`cw-bc-title-${++F}`;x.setAttribute("aria-labelledby",N);let O=document.createElement("div");if(O.className="cw-bc-card-meta",O.innerHTML=`
    ...
    `,!l){let k=document.createElement("button");k.type="button",k.className="cw-bc-dismiss-btn",k.setAttribute("aria-label",fe("markRead")(z.title)),k.title=fe("markReadShort"),k.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>',k.onclick=X=>{X.stopPropagation(),v.playClick(),x.style.transform="translateX(20px)",x.style.opacity="0",setTimeout(()=>{let Z=Ht();Z.push(z.id),Ri(Z),se(),H()},300)},O.appendChild(k)}let Y=document.createElement("h3");Y.className="cw-bc-msg-title",Y.id=N,Y.textContent=z.title;let d=document.createElement("div");d.className="cw-bc-msg-body",d.innerHTML=Oi(z.text);let E=document.createElement("div");return E.className="cw-bc-msg-author",E.textContent=fe("publishedBy")(z.author||fe("system")),x.append(O,Y,d,E),x}function ie(z,l){return n&&z.type!==n?!1:l?`${z.title||""} ${z.text||""}`.toLowerCase().includes(l):!0}function W(z,l){let x=z.filter(N=>!l.includes(N.id)),p=z.filter(N=>l.includes(N.id));if(!x.length&&!(r&&p.length)){let N=o.trim().length>0||n!==null,O=document.createElement("div");O.className="cw-bc-empty",O.innerHTML=N?`<div>${fe("nothingFound")}</div>`:`
    ...
    `,document.head.appendChild(e)}function rr(){let e="v2.0",t=!1,a="general",o="",i=null,n=null;nl();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,Ue,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let s={popup:r},c=$e(r,me("headerTitle"),e,me("headerDesc"),s,()=>se());r.appendChild(c);let g=c.querySelector("span"),u=document.createElement("div");u.className="cw-lib-container",r.appendChild(u);let h=document.createElement("div");h.className="cw-lib-toolbar";let m=document.createElement("div");m.className="cw-lib-search-wrap";let b=document.createElement("div");b.className="cw-lib-search-icon",b.innerHTML=Ge.search;let T=document.createElement("input");T.className="cw-lib-search no-drag",T.placeholder=me("searchPlaceholder"),T.type="text";let y=document.createElement("div");y.className="cw-lib-search-clear cw-tactile",y.innerHTML=Ge.clear,m.append(b,T,y);let w=document.createElement("div");w.className="cw-lib-tabs",To.forEach(L=>{let j=document.createElement("div");j.className="cw-lib-tab"+(L.id===a?" active":""),j.id=`lib-tab-${L.id}`,j.innerHTML=`${L.icon}<span class="js-lib-tab-label">${me("tabs")[L.id]}</span>`,j.onmouseenter=()=>v.playHover(),j.onclick=()=>C(L.id),w.appendChild(j)}),h.append(m,w),u.appendChild(h);let _=document.createElement("div");_.className="cw-lib-grid",u.appendChild(_);let A=document.createElement("div");A.className="cw-lib-fab cw-tactile",A.title=me("newItem"),A.innerHTML=Ge.add,A.onclick=()=>le(),u.appendChild(A);let D=document.createElement("div");D.className="cw-lib-sheet";let f=document.createElement("div");f.className="cw-lib-sheet-handle";let M=document.createElement("div");M.className="cw-lib-sheet-head";let R=document.createElement("div");R.className="cw-lib-sheet-back no-drag",R.innerHTML=Ge.back,R.title=me("cancel"),R.onclick=F;let U=document.createElement("span");U.className="cw-lib-sheet-title",U.textContent=me("newItemTitle"),M.append(R,U);let P=document.createElement("div");P.className="cw-lib-sheet-body";let G=document.createElement("div");G.className="cw-lib-sheet-foot";let S=document.createElement("button");S.className="cw-lib-save-btn no-drag",S.textContent=me("save"),S.onclick=ae,G.appendChild(S);let q=document.createElement("div");q.className="cw-lib-loading",q.innerHTML=`<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text js-lib-saving">${me("saving")}</div>`,D.append(f,M,P,G,q),u.appendChild(D);let B=document.createElement("div");Object.assign(B.style,ct),B.className="no-drag",r.appendChild(B),dt(r,B),document.body.appendChild(r),document.addEventListener("mousedown",L=>{n&&!n.contains(L.target)&&$()});function C(L){v.playClick(),a=L,To.forEach(j=>{document.getElementById(`lib-tab-${j.id}`).classList.toggle("active",j.id===L)}),H()}function $(){if(n){let L=n.querySelector(".cw-lib-menu");L&&L.classList.remove("open"),n.classList.remove("menu-open"),n=null}}function Q(L,j){return j?`${L.title} ${L.content}`.toLowerCase().includes(j):!0}function ne(L){let j=document.createElement("div");j.className="cw-lib-recent-section",j.innerHTML=`<div class="cw-lib-recent-title">${me("recentlyUsed")}</div>`;let ee=document.createElement("div");return ee.className="cw-lib-recent-row",L.forEach(z=>{let l=document.createElement("div");l.className="cw-lib-recent-chip",l.tabIndex=0,l.setAttribute("role","button"),l.title=z.title,l.innerHTML=`<span>${W(z.title)}</span>`,l.onclick=()=>{v.playClick(),J(z)},l.addEventListener("keydown",x=>{(x.key==="Enter"||x.key===" ")&&(x.preventDefault(),l.click())}),ee.appendChild(l)}),j.appendChild(ee),j}function H(){$(),_.innerHTML="";let L=o.trim().toLowerCase(),j=je.getSnippets(a).filter(ee=>Q(ee,L));if(!L){let ee=ol(a);ee.length>0&&_.appendChild(ne(ee))}if(j.length===0){let ee=document.createElement("div");ee.className="cw-lib-empty";let z=L.length>0;ee.innerHTML=`
            ...
            `,_.appendChild(ee);return}j.forEach(ee=>_.appendChild(oe(ee)))}function oe(L){let j=document.createElement("div");j.className="cw-lib-card"+(L.isCode?" is-code":"");let ee=L.content,z="";if(L.isRich){let N=document.createElement("div");N.innerHTML=L.content;let O=!!N.querySelector("img");ee=N.innerText.substring(0,200),O&&(z=`<span class="cw-lib-media-tag">${Ge.media} M\xEDdia</span>`)}let l=[L.isCode?'<span class="cw-lib-badge code">CODE</span>':"",a==="email"?'<span class="cw-lib-badge template">TEMPLATE</span>':""].join("");j.innerHTML=`
    ...
    `;let o=a.querySelector(".js-sc-body"),i=a.querySelector(".js-sc-sort-toggle");i.onchange=async m=>{v.playClick(),await Le.setSortedByUsage(m.target.checked),s()};function n(m){let b=Oe[m.payload.subStatus],T=b?b.name:m.payload.subStatus,y=(m.payload.scenarios||[]).length,w=[m.payload.caseType.toUpperCase(),T,y===1?e("scOneScenario"):e("scNScenarios").replace("{n}",y)];return m.alias&&w.push(`"${m.alias}"`),w.join(" \xB7 ")}function r(m,b,T){if(m.textContent="",T){let y=document.createElement("span");y.className="cw-sc-warn",y.textContent=e("scBroken"),m.appendChild(y),m.appendChild(document.createTextNode(" \xB7 "))}m.appendChild(document.createTextNode(n(b)))}function s(){o.innerHTML="",i.checked=Le.isSortedByUsage();let m=Le.isSortedByUsage(),b=m?Le.list():Le.listRaw(),T=!m;if(!b.length){let w=document.createElement("div");w.className="cw-sc-empty",w.textContent=e("scEmpty"),o.appendChild(w)}b.forEach((w,_)=>{let A=Qn(w),D=document.createElement("div");D.className="cw-sc-item"+(A.length?" broken":""),D.dataset.id=w.id,D.dataset.index=String(_),D.innerHTML=`
            ...
            `;let f=D.querySelector(".cw-sc-label");f.textContent=w.label,f.title=w.label,r(D.querySelector(".cw-sc-meta"),w,A.length>0),D.querySelector(".js-sc-edit").onclick=()=>h(w),D.querySelector(".js-sc-del").onclick=()=>c(w),T&&g(D,_,b.length),o.appendChild(D)});let y=document.createElement("button");y.type="button",y.className="cw-sc-add",y.textContent=e("scAdd"),y.disabled=b.length>=ft,y.disabled&&(y.textContent=e("scLimit").replace("{max}",ft)),y.onclick=()=>h(null),o.appendChild(y)}async function c(m){await Fe(e("scDeleteConfirm").replace("{name}",m.label),{danger:!0})&&(await Le.remove(m.id),v.playClick(),s())}function g(m,b,T){let y=m.querySelector(".cw-sc-grip");m.draggable=!0;let w=!1;y.onmousedown=()=>{w=!0},m.onmouseup=()=>{w=!1},y.onkeydown=async _=>{let A=_.key==="ArrowUp"?-1:_.key==="ArrowDown"?1:0;if(!A)return;_.preventDefault();let D=b+A;if(D<0||D>=T)return;await Le.reorder(m.dataset.id,D),v.playClick(),s();let f=o.querySelector(`.cw-sc-item[data-id="${m.dataset.id}"] .cw-sc-grip`);f&&f.focus()},m.ondragstart=_=>{if(!w){_.preventDefault();return}_.dataTransfer.effectAllowed="move",_.dataTransfer.setData("text/plain",m.dataset.id),m.classList.add("dragging")},m.ondragend=()=>{m.classList.remove("dragging"),w=!1,o.querySelectorAll(".drop-target").forEach(_=>_.classList.remove("drop-target"))},m.ondragover=_=>{_.preventDefault(),m.classList.add("drop-target")},m.ondragleave=()=>m.classList.remove("drop-target"),m.ondrop=async _=>{_.preventDefault(),m.classList.remove("drop-target");let A=_.dataTransfer.getData("text/plain");!A||A===m.dataset.id||(await Le.reorder(A,Number(m.dataset.index)),v.playClick(),s())}}function u(){let m=[];for(let b in Oe){let T=Oe[b].status;T&&!m.includes(T)&&m.push(T)}return m}function h(m){let T=!!m?JSON.parse(JSON.stringify(m)):{id:pa(),kind:"note",label:"",alias:"",payload:{caseType:"bau",status:"",subStatus:"",scenarios:[]}};o.innerHTML="";let y=document.createElement("div");y.style.cssText="display: flex; flex-direction: column; gap: 14px;",y.innerHTML=`
    ...
    `}async function b(){u.style.display="flex",u.innerHTML=`
        ...
        `,(async()=>{try{Ne()||await Kt();let S=Ne(),q=S?S.split("@")[0]:"user",B=await Ft(q);m(q,B)}catch(S){console.warn("Erro ao renderizar perfil:",S),u.style.display="none"}})()}b();let T=document.createElement("div");if(T.className="cw-configs-section",T.innerHTML=`
    ...
    `;let D=A.querySelector("#cw-config-sound-toggle");D.onchange=S=>{v.setMuted(!S.target.checked),S.target.checked&&v.playClick()},g.appendChild(A);let f=document.createElement("div");f.className="cw-configs-section",f.innerHTML=`
    ...
    `,g.appendChild(f);let M=Vt(),R=document.createElement("div");R.className="cw-configs-section",R.innerHTML=`
    ...
    `,R.querySelector(".cw-env-chip").textContent=`${M.isDev?"DEV":"PROD"} \xB7 \u2026${M.fingerprint}`,g.appendChild(R);let U=document.createElement("style");U.innerHTML=`
        .cw-env-chip {
    ...
    .bau-popup {
      ...
      animation: cw-genie-effect-in 0.4s ${Ot};
      color: #202124;
    }
    ...
    .bau-success-view.active .bau-success-content::before {
        ...
        z-index: -1;
        opacity: 0;
        animation: bauAuraCombined 5s ${Ot} 0.2s infinite;
    }
    ...
    .bau-success-view.active .bau-check-path {
        ...
        animation: bauCheckDraw 0.55s ${Ot} 0.75s forwards;
    }
    ...
    .bau-success-view.active .bau-success-title {
        ...
        margin: 0 0 8px 0;
        opacity: 0;
        animation: bauSlideUpFade 0.6s ${Ot} 0.85s forwards;
    }
    ...
    .bau-success-view.active .bau-success-subtitle {
        ...
        margin-bottom: 36px;
        opacity: 0;
        animation: bauSlideUpFade 0.6s ${Ot} 0.95s forwards;
    }

    .bau-success-view.active #bau-success-back-btn {
        opacity: 0;
        animation: bauSlideUpFade 0.6s ${Ot} 1.05s forwards;
        position: relative;
        overflow: hidden;
    }
    ...
    .bau-rescan-btn:hover { color: ${Ye.blue}; border-color: ${Ye.blue}; box-shadow: 0 1px 3px rgba(60,64,67,0.25); }
  ...
  `,document.head.appendChild(e)};function pr(){return Object.values(Me).map(e=>String(e?.name||"").trim()).filter(Boolean)}var dr=[{value:"PT-BR",text:"Portugu\xEAs (PT-BR)"},{value:"ES",text:"Espanhol (ES)"},{value:"EN",text:"Ingl\xEAs (EN)"}],vt={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"advLastName",name:"advLastName",label:"Sobrenome do Anunciante",type:"text",placeholder:"Sobrenome do Anunciante",required:!1,isSmart:!0},{id:"advPhone",name:"advPhone",label:"Telefone do Anunciante",type:"text",placeholder:"+55 11 90000-0000",required:!1,isSmart:!0},{id:"advEmail",name:"advEmail",label:"Email do Anunciante",type:"text",placeholder:"email@exemplo.com",required:!0,isSmart:!0,validation:{regex:"^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$",error:"Formato de email inv\xE1lido"}},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"am@google.com",required:!0,isSmart:!0,validation:{regex:"^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$",error:"Informe o e-mail do AM (ex.: am@google.com)"}},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}},{id:"language",name:"language",label:"Idioma do Atendimento",type:"select",required:!0,tooltip:"Vem do seu segmento na planilha People. Troque s\xF3 quando este caso fugir da regra.",options:dr}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica"}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",i18nKey:"description_justificativa",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]},{id:"suggestDiscard",name:"suggestDiscard",label:"O caso deve ser descartado pelo TL?",type:"select",required:!1,options:[{value:"N\xE3o",text:"N\xE3o"},{value:"Sim",text:"Sim"}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",i18nKey:"language_descarte",name:"language",label:"Idioma do Atendimento",type:"select",required:!0,options:dr},{id:"seId",i18nKey:"seId_descarte",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!0,isSmart:!0,button:{id:"bau-discard-se-search",icon:"wand",title:"Buscar ID automaticamente"}},{id:"description",i18nKey:"description_descarte",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var pl={advName:{label:"Nombre del Anunciante",placeholder:"Nombre del Anunciante"},advLastName:{label:"Apellido del Anunciante",placeholder:"Apellido del Anunciante"},advPhone:{label:"Tel\xE9fono del Anunciante",placeholder:"+55 11 90000-0000"},advEmail:{label:"Email del Anunciante",placeholder:"email@ejemplo.com",error:"Formato de correo inv\xE1lido"},cid:{label:"CID",placeholder:"000-000-0000",tooltip:"Usa el formato 000-000-0000 o 10 d\xEDgitos",error:"Formato de CID incorrecto"},amName:{label:"Account Manager (AM)",placeholder:"am@google.com",error:"Informa el correo del AM (ej.: am@google.com)"},website:{label:"Website",placeholder:"https://www.ejemplo.com"},seId:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID",buttonTitle:"Buscar ID autom\xE1ticamente"},seId_descarte:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID",buttonTitle:"Buscar ID autom\xE1ticamente"},reason:{label:"Qu\xE9 debe hacerse en BAU",placeholder:"Describe las acciones esperadas..."},taskType:{label:"Tareas para BAU (Selecciona 1 o m\xE1s)",tooltip:"Selecciona los tipos de implementaci\xF3n t\xE9cnica"},nonImplementationReason:{label:"Motivo de la No Implementaci\xF3n (Justificaci\xF3n BAU)"},description_justificativa:{label:"Justificaci\xF3n / Descripci\xF3n",placeholder:"Describe detalladamente qu\xE9 se necesita hacer..."},availability:{label:"Disponibilidad (m\xEDnimo 1 opci\xF3n)"},availability_1:{label:"Opci\xF3n 1 (Prioridad)"},availability_2:{label:"Opci\xF3n 2 (Opcional)"},availability_3:{label:"Opci\xF3n 3 (Opcional)"},suggestDiscard:{label:"\xBFEl caso debe ser descartado por el TL?"},caseId:{label:"Case ID",placeholder:"Case ID"},language:{label:"Idioma de la Atenci\xF3n",tooltip:"Viene de tu segmento en la hoja People. C\xE1mbialo solo cuando este caso se salga de la regla."},language_descarte:{label:"Idioma de la Atenci\xF3n"},description_descarte:{label:"Descripci\xF3n",placeholder:"Describe el motivo del descarte..."},discardReason:{label:"Motivo del Descarte"}},ul={"Selecione um motivo...":"Selecciona un motivo...","Tempo da consultoria esgotado":"Tiempo de la consultor\xEDa agotado","Solicita\xE7\xE3o de reagendamento pelo anunciante":"Solicitud de reprogramaci\xF3n por parte del anunciante","Falta de acessos ou backup do site":"Falta de accesos o copia de seguridad del sitio","Anunciante indispon\xEDvel ou n\xE3o preparado":"Anunciante no disponible o no preparado","Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)":"Implementaci\xF3n parcial (no todas las tareas completadas)","Solicita\xE7\xE3o de tarefas (tasks) adicionais":"Solicitud de tareas adicionales","Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)":"Necesidad de nuevos cambios (fase de seguimiento)","Retorno de contato ap\xF3s prazo de 14 dias expirado":"Retorno de contacto despu\xE9s de vencido el plazo de 14 d\xEDas","Caso Filho gerado no atendimento":"Caso Hijo generado en la atenci\xF3n","3\xAA Tentativa de contato sem sucesso":"3.\xBA intento de contacto sin \xE9xito","Apenas o AM presente":"Solo el AM presente","Estouro de tempo para conclus\xE3o":"Tiempo excedido para la conclusi\xF3n","Gera\xE7\xE3o de caso BAU (Reagendamento)":"Generaci\xF3n de caso BAU (Reprogramaci\xF3n)",Sim:"S\xED",N\u00E3o:"No","Portugu\xEAs (PT-BR)":"Portugu\xE9s (PT-BR)","Espanhol (ES)":"Espa\xF1ol (ES)","Ingl\xEAs (EN)":"Ingl\xE9s (EN)"};function ml(e){return e?.i18nKey||e?.id||e?.name}function et(e,t){let a=e?.[t];return de()!=="es"?a:pl[ml(e)]?.[t]??a}function Xe(e){return de()!=="es"?e:ul[e]??e}var gl=(()=>{let e=[];for(let t=420;t<=1260;t+=30)e.push(String(Math.floor(t/60)).padStart(2,"0")+":"+String(t%60).padStart(2,"0"));return e})(),ur={pt:{statusPending:"Aguardando TL",statusApproved:"Aprovado / Criado",statusDiscarded:"Descartado pelo TL",statusCanceled:"Cancelado",statusDefault:"Pendente",timezoneWarningStrong:"Aten\xE7\xE3o:",timezoneWarningText:"Para clientes fora do fuso hor\xE1rio do Brasil, o hor\xE1rio inserido deve corresponder sempre ao hor\xE1rio local do cliente, e n\xE3o ao do agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone n\xE3o encontrado.",headerTitle:"BAU Central",headerDesc:"Dashboard de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Fluxo completo para implementa\xE7\xF5es t\xE9cnicas e suporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Fluxo simplificado para casos que n\xE3o requerem implementa\xE7\xE3o.",back:"Voltar",next:"Pr\xF3ximo",configuringEdit:"Configurando Edi\xE7\xE3o...",loadDashboardError:"Erro ao carregar Dashboard. Verifique sua conex\xE3o.",copiedToClipboard:"Copiado para a \xE1rea de transfer\xEAncia!",noAdditionalContext:"Nenhum contexto adicional fornecido pelo agente.",notCaptured:"N\xE3o capturado",none:"Nenhuma",language:"Idioma",lastName:"Sobrenome",phone:"Telefone",clientTimezone:"Fuso hor\xE1rio do cliente",echoEquivalence:(e,t,a)=>`<strong>${e}</strong> em ${t} equivale a <strong>${a}</strong> em Bras\xEDlia.`,echoSameZone:"O cliente est\xE1 no mesmo fuso que voc\xEA.",editPageWarning:"Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",onCorrectPage:"Estou na p\xE1gina correta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso criado, mas n\xE3o conseguimos confirmar por email.",unknownError:"Erro desconhecido",newBauCase:"Novo Caso BAU",backToDashboard:"Voltar ao Dashboard",confirmDataBeforeSending:"Confirme os dados antes de enviar",submitToTl:"Enviar para o TL",saveChanges:"Salvar Altera\xE7\xF5es",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Preencha os detalhes abaixo",caseSentSuccess:"Caso enviado com sucesso!",caseSentSuccessSub:"Sua solicita\xE7\xE3o foi recebida e ser\xE1 processada em breve.",genericErrorTitle:"Ops! Algo deu errado",genericErrorSub:"N\xE3o conseguimos carregar seus casos BAU no momento.",tryAgain:"Tentar Novamente",notInformed:"N\xE3o informado",reasonTooltip:"O que deve ser feito em BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Aguardando TL",caseDetailsTitle:"Detalhes do Caso",copy:"Copiar",advertiser:"Anunciante",status:"Status",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email do Anunciante",site:"Site",timezone:"Timezone",responsibleAm:"AM Respons\xE1vel",salesProgram:"Programa de Vendas",bauReason:"Motivo BAU",requestedTasks:"Tasks solicitadas",justification:"Justificativa",detailedDescription:"Descri\xE7\xE3o detalhada",availability:"Disponibilidade",urgent:"Urgente",undefinedName:"Nome indefinido",customerIdTooltip:"Customer ID do Anunciante",cidTooltip:"CID do Anunciante (Formato: 000-000-0000)",incompleteData:"Dados Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contate o Suporte",editRequest:"Editar Solicita\xE7\xE3o",edit:"Editar",refresh:"Atualizar",noRecentCases:"Nenhum caso recente",casesWillAppear:"Seus casos BAU aparecer\xE3o aqui",createdApproved:"Criados / Aprovados",refreshDashboard:"Atualizar Dashboard",statusPendingDiscard:"Descarte em avalia\xE7\xE3o",selectACase:"Escolha um caso na lista para ver os detalhes.",copyFieldAria:e=>`Copiar ${e} para a \xE1rea de transfer\xEAncia`,metricAwaitingDiscard:"Descarte em avalia\xE7\xE3o",rescanTitle:"Recapturar os dados desta tela",rescanDone:"Dados recapturados da tela atual.",errorPrefix:e=>`Erro: ${e}`,selectAtLeastOne:e=>`Erro: Selecione pelo menos uma op\xE7\xE3o para "${e}".`,fieldRequiredDouble:e=>`Erro: O campo "${e}" \xE9 obrigat\xF3rio.`,fieldRequiredSingle:e=>`Erro: O campo '${e}' \xE9 obrigat\xF3rio.`,whatMustBeDone:"O que deve ser feito",editTasksHint:"Para editar as tasks, volte ao Passo 2",editScheduleHint:"Para editar o agendamento, volte ao Passo 3",bauJustification:"Justificativa BAU",description:"Descri\xE7\xE3o",availabilityPriority:"Disponibilidade (Prioridade)",suggestDiscardQuestion:"O caso deve ser descartado pelo TL?",editingCaseHash:e=>`Voc\xEA est\xE1 editando o caso #${e}`,editingDiscardHash:e=>`Voc\xEA est\xE1 editando o descarte do caso #${e}`,discardReason:"Motivo do Descarte",discardDescription:"Descri\xE7\xE3o do Descarte",notInformedPlaceholder:"N\xE3o informado",caseUpdatedSuccess:"Caso atualizado com sucesso!",caseDiscardSentSuccess:"Caso enviado para descarte com sucesso!"},es:{statusPending:"Esperando al TL",statusApproved:"Aprobado / Creado",statusDiscarded:"Descartado por el TL",statusCanceled:"Cancelado",statusDefault:"Pendiente",timezoneWarningStrong:"Atenci\xF3n:",timezoneWarningText:"Para clientes fuera del huso horario de Brasil, el horario ingresado siempre debe corresponder al horario local del cliente, no al del agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone no encontrado.",headerTitle:"BAU Central",headerDesc:"Panel de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Flujo completo para implementaciones t\xE9cnicas y soporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Flujo simplificado para casos que no requieren implementaci\xF3n.",back:"Volver",next:"Siguiente",configuringEdit:"Configurando Edici\xF3n...",loadDashboardError:"Error al cargar el Panel. Verifica tu conexi\xF3n.",copiedToClipboard:"\xA1Copiado al portapapeles!",noAdditionalContext:"Ning\xFAn contexto adicional proporcionado por el agente.",notCaptured:"No capturado",none:"Ninguna",language:"Idioma",lastName:"Apellido",phone:"Tel\xE9fono",clientTimezone:"Huso horario del cliente",echoEquivalence:(e,t,a)=>`<strong>${e}</strong> en ${t} equivale a <strong>${a}</strong> en Brasilia.`,echoSameZone:"El cliente est\xE1 en el mismo huso que t\xFA.",editPageWarning:"Atenci\xF3n: Para editar la informaci\xF3n, debes tener abierta en el sistema la p\xE1gina de este Caso espec\xEDfico. De lo contrario, los datos capturados estar\xE1n incorrectos.",onCorrectPage:"Estoy en la p\xE1gina correcta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso creado, pero no pudimos confirmar por email.",unknownError:"Error desconocido",newBauCase:"Nuevo Caso BAU",backToDashboard:"Volver al Panel",confirmDataBeforeSending:"Confirma los datos antes de enviar",submitToTl:"Enviar al TL",saveChanges:"Guardar Cambios",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Completa los detalles a continuaci\xF3n",caseSentSuccess:"\xA1Caso enviado con \xE9xito!",caseSentSuccessSub:"Tu solicitud fue recibida y ser\xE1 procesada en breve.",genericErrorTitle:"\xA1Ups! Algo sali\xF3 mal",genericErrorSub:"No pudimos cargar tus casos BAU en este momento.",tryAgain:"Intentar de Nuevo",notInformed:"No informado",reasonTooltip:"Qu\xE9 debe hacerse en BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Esperando al TL",caseDetailsTitle:"Detalles del Caso",copy:"Copiar",advertiser:"Anunciante",status:"Estado",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email del Anunciante",site:"Sitio",timezone:"Timezone",responsibleAm:"AM Responsable",salesProgram:"Programa de Ventas",bauReason:"Motivo BAU",requestedTasks:"Tareas solicitadas",justification:"Justificaci\xF3n",detailedDescription:"Descripci\xF3n detallada",availability:"Disponibilidad",urgent:"Urgente",undefinedName:"Nombre indefinido",customerIdTooltip:"Customer ID del Anunciante",cidTooltip:"CID del Anunciante (Formato: 000-000-0000)",incompleteData:"Datos Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contacta al Soporte",editRequest:"Editar Solicitud",edit:"Editar",refresh:"Actualizar",noRecentCases:"Ning\xFAn caso reciente",casesWillAppear:"Tus casos BAU aparecer\xE1n aqu\xED",createdApproved:"Creados / Aprobados",refreshDashboard:"Actualizar Panel",statusPendingDiscard:"Descarte en evaluaci\xF3n",selectACase:"Elige un caso de la lista para ver los detalles.",copyFieldAria:e=>`Copiar ${e} al portapapeles`,metricAwaitingDiscard:"Descarte en evaluaci\xF3n",rescanTitle:"Recapturar los datos de esta pantalla",rescanDone:"Datos recapturados de la pantalla actual.",errorPrefix:e=>`Error: ${e}`,selectAtLeastOne:e=>`Error: Selecciona al menos una opci\xF3n para "${e}".`,fieldRequiredDouble:e=>`Error: El campo "${e}" es obligatorio.`,fieldRequiredSingle:e=>`Error: El campo '${e}' es obligatorio.`,whatMustBeDone:"Qu\xE9 debe hacerse",editTasksHint:"Para editar las tareas, vuelve al Paso 2",editScheduleHint:"Para editar la programaci\xF3n, vuelve al Paso 3",bauJustification:"Justificaci\xF3n BAU",description:"Descripci\xF3n",availabilityPriority:"Disponibilidad (Prioridad)",suggestDiscardQuestion:"\xBFEl caso debe ser descartado por el TL?",editingCaseHash:e=>`Est\xE1s editando el caso #${e}`,editingDiscardHash:e=>`Est\xE1s editando el descarte del caso #${e}`,discardReason:"Motivo del Descarte",discardDescription:"Descripci\xF3n del Descarte",notInformedPlaceholder:"No informado",caseUpdatedSuccess:"\xA1Caso actualizado con \xE9xito!",caseDiscardSentSuccess:"\xA1Caso enviado a descarte con \xE9xito!"}};function I(e){let t=de();return ur[t]?.[e]??ur.pt[e]}var Ce={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function mr(e){switch(e){case"PENDING_TL_CREATION":return{text:I("statusPending"),class:"status-yellow",aura:"status-yellow-aura"};case"PENDING_TL_DISCARD":return{text:I("statusPendingDiscard"),class:"status-orange",aura:"status-orange-aura"};case"CREATED":return{text:I("statusApproved"),class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:I("statusDiscarded"),class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:I("statusCanceled"),class:"status-gray",aura:""};default:return{text:e||I("statusDefault"),class:"status-gray",aura:""}}}function bl(e,t,a){let o=document.createElement("label");return o.className="bau-task-item",o.classList.toggle("active",a),o.innerHTML=`<input type="checkbox" name="${t}" value="${e}"><span>${e}</span>`,o.querySelector("input").checked=a,o.addEventListener("click",i=>{i.preventDefault();let n=o.querySelector("input");n.checked=!n.checked,o.classList.toggle("active",n.checked),v.playClick()}),o}function Lo(e,t=[]){let a=e.dataset.fieldName||"taskType",o=new Set(Array.from(e.querySelectorAll("input:checked")).map(n=>n.value));t.map(n=>String(n||"").trim()).filter(Boolean).forEach(n=>o.add(n));let i=pr();o.forEach(n=>{i.includes(n)||i.push(n)}),e.innerHTML="",i.forEach(n=>e.appendChild(bl(n,a,o.has(n))))}function gr(e,t=[]){e.querySelectorAll("input:checked").forEach(a=>{a.checked=!1}),Lo(e,t)}function br(e){let t=document.createElement("div");if(t.className="bau-dynamic-input",t.id=`wrapper-${e.id}`,e.label){let o=document.createElement("label");o.className="bau-label",o.textContent=et(e,"label"),e.tooltip&&o.setAttribute("data-tooltip",et(e,"tooltip")),t.appendChild(o)}let a;switch(e.type){case"textarea":a=document.createElement("textarea"),a.style.minHeight="80px",t.appendChild(a);break;case"select":a=document.createElement("select"),e.groups?e.groups.forEach(c=>{let g=document.createElement("optgroup");g.label=c.label,c.options.forEach(u=>{let h=document.createElement("option");h.value=u.value,h.textContent=Xe(u.text),g.appendChild(h)}),a.appendChild(g)}):e.options&&e.options.forEach(c=>{let g=document.createElement("option");g.value=c.value,g.textContent=Xe(c.text),a.appendChild(g)}),t.appendChild(a);break;case"checkbox-grid":return a=document.createElement("div"),a.className="bau-tasks-grid",a.dataset.fieldName=e.name,Lo(a),t.appendChild(a),t;case"datetime-group":a=document.createElement("div"),a.className="bau-availability-container";let o=document.createElement("div");o.className="bau-timezone-row",o.innerHTML=`
    ...
    `,w.appendChild(_);let A=l=>{_.classList.toggle("active",l)},D=document.createElement("div");D.className="bau-progress-indicator",w.appendChild(D);let f=document.createElement("form");f.id="bau-escalation-form",f.noValidate=!0,w.appendChild(f),vt.steps.forEach(l=>{let x=document.createElement("div");if(x.className="bau-step"+(l.id===o?" active":""),x.id=`bau-step-${l.id}`,l.isBranching)x.innerHTML=`
            ...
            `;else{let p=document.createElement("div");if(p.className="bau-card",l.id===1||l.id===5){p.innerHTML=`
                ...
                `;let N=p.querySelector(".bau-dynamic-inputs-container");l.fields.forEach(Y=>{N.appendChild(br(Y))});let O=p.querySelector("#wrapper-cid");if(O){let Y=document.createElement("div");Y.id="bau-cid-error",Y.className="bau-cid-error-hint",Y.style.display="none",Y.textContent="Formato de CID incorreto",O.appendChild(Y)}}else l.fields.forEach(N=>{p.appendChild(br(N))});x.appendChild(p)}f.appendChild(x)});let M=document.createElement("div");M.className="bau-footer";let R=document.createElement("button");R.type="button",R.id="bau-step-back-btn",R.className="bau-btn-secondary",R.textContent=I("back");let U=document.createElement("button");U.type="button",U.id="bau-step-next-btn",U.className="bau-btn-primary",U.textContent=I("next");let P=document.createElement("button");P.type="submit",P.className="bau-btn-submit",P.innerHTML=`${Ce.send} ${I("submitToTl")}`,P.style.display="none",M.appendChild(R),M.appendChild(U),M.appendChild(P),f.appendChild(M),m.appendChild(T);let G=document.createElement("div");G.id="bau-view-success",G.className="bau-view bau-success-view",G.innerHTML=`
    ...
    `,m.appendChild(G),document.body.appendChild(c),Ea(()=>{let l=f.querySelector(".bau-tasks-grid");l&&Lo(l)});function S(l){t=l,c.querySelectorAll(".bau-view").forEach(Y=>Y.classList.remove("active"));let x=c.querySelector(`#bau-view-${l}`);x&&x.classList.add("active");let p=h.querySelector(".cw-module-header-title")||h.querySelector("h2"),N=h.querySelector(".cw-module-header-subtitle")||h.querySelector("p");p&&(l==="form"?p.textContent=n?I("editingCase")(r):I("newBauCase"):p.textContent=I("headerTitle")),N&&(N.textContent=I(l==="form"?"fillDetailsBelow":"headerDesc"));let O=f.querySelector(".bau-btn-submit");O&&(O.innerHTML=n?`${Ce.send} ${I("saveChanges")}`:`${Ce.send} ${I("submitToTl")}`)}function q(){let l=c.querySelector("#bau-case-list-container"),x=c.querySelector("#bau-dashboard-metrics");x&&(x.innerHTML=`
        ...
        `).join(""))}async function B(){let l=c.querySelector("#bau-case-list-container"),x=c.querySelector("#bau-dashboard-metrics");if(!(!l||!x)){q();try{let p=await zo();if(!Array.isArray(p))throw new Error("API response is not a valid array");ne(p)}catch(p){console.error("Critical Error loading BAU cases:",p),x&&(x.innerHTML=""),l.innerHTML=`
            ...
            <section class="bau-md-data" aria-label="${I("caseDetailsTitle")}">
                ${O.map((d,E)=>`
                    <div class="bau-md-line${E===O.length-1?" is-last":""}">
                        <span class="bau-md-label">${d.rotulo}</span>
        ...
        `}function $(l){if(!l)return"";let x=mr(l?.status),p=ta(l?.date),N="",O="",Y=String(l?.availability||"").split("|")[0].trim();if(l?.status==="PENDING_TL_CREATION"&&Y){let Z=new Date(Y),re=new Date;!isNaN(Z.getTime())&&(Z<=re||Z-re<36e5*2)&&(N=`<span class="bau-sla-badge">${I("urgent")}</span>`,O="bau-pulse-attention")}let d=l?.reason&&l.reason.trim()?l.reason:I("noAdditionalContext"),k=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(l?.cid||""),X=!l?.caseId||l.caseId==="N/A"||!k;return X&&l?.status==="PENDING_TL_CREATION"&&(O="bau-pulse-attention"),`
            <li class="bau-case-card ${x.aura} ${O}" data-case-id="${l?.id||""}">
        ...
        `}function Q(l,x){c.querySelectorAll("#bau-case-list-container .bau-case-card").forEach(p=>{let N=p===l;p.classList.toggle("is-selected",N),p.setAttribute("aria-current",N?"true":"false")}),C(x),v.playClick()}function ne(l){let x=c.querySelector("#bau-case-list-container"),p=c.querySelector("#bau-dashboard-metrics");if(!x||!p)return;let N=Array.isArray(l)?l.filter(Boolean):[];if(N.length===0){p.innerHTML=`
            ...
            `,c.querySelector("#bau-refresh-dashboard")?.addEventListener("click",()=>B());return}let O=N.filter(Z=>Z.status==="PENDING_TL_CREATION").length,Y=N.filter(Z=>Z.status==="PENDING_TL_DISCARD").length,d=N.filter(Z=>Z.status==="CREATED").length;p.innerHTML=`
        ...
        `;let E=p.querySelector("#bau-refresh-dashboard");E?.addEventListener("click",async()=>{E.classList.contains("spinning")||(E.classList.add("spinning"),v.playClick(),await B(),setTimeout(()=>E.classList.remove("spinning"),1e3))}),x.innerHTML="";let k=N.slice(0,5),X=N.slice(5);if(k.forEach(Z=>{let re=$(Z),ce=document.createElement("div");ce.innerHTML=re;let pe=ce.firstElementChild;pe.addEventListener("click",De=>{De.target.closest(".bau-case-edit-btn")||Q(pe,Z)});let we=pe.querySelector(".bau-case-edit-btn");we&&(we.onclick=De=>{De.stopPropagation(),j(Z)}),x.appendChild(pe)}),X.length>0){let Z=document.createElement("li");Z.className="bau-accordion-container";let re=document.createElement("button");re.className="bau-accordion-toggle",re.innerHTML=`${Ce.expand} <span>Mostrar ${X.length} casos mais antigos</span>`;let ce=document.createElement("ul");ce.className="bau-case-list bau-accordion-content",ce.style.display="none",X.forEach(pe=>{let we=$(pe),De=document.createElement("div");De.innerHTML=we;let ke=De.firstElementChild;ke.addEventListener("click",yt=>{yt.target.closest(".bau-case-edit-btn")||Q(ke,pe)});let Ke=ke.querySelector(".bau-case-edit-btn");Ke&&(Ke.onclick=yt=>{yt.stopPropagation(),j(pe)}),ce.appendChild(ke)}),re.addEventListener("click",()=>{let pe=ce.style.display==="none";ce.style.display=pe?"block":"none",re.classList.toggle("expanded",pe),re.querySelector("span").textContent=pe?"Esconder casos mais antigos":`Mostrar ${X.length} casos mais antigos`,v.playClick()}),Z.appendChild(re),Z.appendChild(ce),x.appendChild(Z)}}function H(){let l=i==="BAU"?[1,2,3,4]:[5,4];f.querySelectorAll(".bau-step").forEach(N=>{let O=parseInt(N.id.replace("bau-step-","")),Y=O===o,d=l.includes(O)||O===0;N.classList.toggle("active",Y),N.style.display=Y?"block":"none",N.querySelectorAll("input, select, textarea").forEach(E=>{E.disabled=!d})});let x=o===0;if(D.style.display=x?"none":"flex",!x){D.innerHTML="";let N=i==="BAU"?[1,2,3,4]:[5,4];N.forEach((O,Y)=>{let d=document.createElement("div"),E=O===o,k=N.indexOf(o),X=Y<k;d.className=`bau-progress-step ${E?"active":X?"completed":""}`,d.textContent=Y+1,D.appendChild(d)})}let p=o===4;R.style.display=o>0?"inline-block":"none",U.style.display=!x&&!p?"inline-block":"none",P.style.display=p?"flex":"none",p&&L()}function oe(l){let x=vt.steps.find(p=>p.id===l);if(!x||!x.fields||x.isConfirmation)return!0;for(let p of x.fields){let N=f.querySelector(`#bau-step-${l} #wrapper-${p.id}`);if(!(N&&N.style.display==="none")&&p.validation){let O=f.querySelector(`#bau-step-${l} [name="${p.name}"]`);if(O&&O.offsetParent!==null&&O.value.trim())if(new RegExp(p.validation.regex).test(O.value.trim())){O.classList.remove("invalid-cid");let d=f.querySelector("#bau-cid-error");d&&(d.style.display="none")}else{console.warn(`Validation failed for field "${p.name}" in step ${l}: Regex mismatch.`),v.playError(),te(I("errorPrefix")(et(p,"error")||p.validation.error),{error:!0}),O.classList.add("invalid-cid");let d=f.querySelector("#bau-cid-error");return d&&(d.style.display="flex"),!1}}}return!0}function J(l){if(!f.querySelector(`#bau-step-${l}`))return!1;let p=vt.steps.find(O=>O.id===l);if(!p||!p.fields||p.isConfirmation)return!0;let N=!0;for(let O of p.fields){let Y=f.querySelector(`#bau-step-${l} #wrapper-${O.id}`);if(!(Y&&Y.style.display==="none")&&O.required){let d=!0,E="";if(O.type==="checkbox-grid")f.querySelector(`#bau-step-${l} input[name="${O.name}"]:checked`)||(E="No option selected in checkbox-grid",v.playError(),te(I("selectAtLeastOne")(et(O,"label")),{error:!0}),d=!1);else if(O.type==="datetime-group"){let k=O.fields[0].name,X=f.querySelector(`#bau-step-${l} input[name="${k}_date"]`),Z=f.querySelector(`#bau-step-${l} select[name="${k}_time"]`);if(!X||X.offsetParent===null)continue;(!X.value.trim()||!Z||!Z.value.trim())&&(E="Datetime group first field is empty",v.playError(),te(I("fieldRequiredDouble")(et(O.fields[0],"label")),{error:!0}),d=!1)}else{let k=f.querySelector(`#bau-step-${l} [name="${O.name}"]`);if(!k||k.offsetParent===null)continue;k.value.trim()||(E="Field is empty",v.playError(),te(I("fieldRequiredSingle")(et(O,"label")),{error:!0}),d=!1)}if(!d){console.warn(`Validation failed for required field "${O.name}" in step ${l}: ${E}`),N=!1;break}}}return N}U.addEventListener("click",()=>{if(oe(o)&&J(o)){i==="BAU"?o++:o===5?o=4:o++,H();let l=c.querySelector(".bau-content");l&&(l.scrollTop=0),v.playClick()}}),R.addEventListener("click",()=>{o>0&&(i==="BAU"?o--:o===4?o=5:o===5?o=0:o--,H(),v.playClick())});async function le(){let l=await tt()||{};a=l,f.querySelectorAll(".bau-vital-highlights").forEach(d=>{let E=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"Website",value:l.website||l.site},{label:"Case ID",value:l.caseId}];d.innerHTML=E.map(k=>{let X=k.value&&k.value!=="N/A"&&k.value!=="undefined"&&k.value!=="null"?k.value:I("notCaptured");return`
            ...
            `}),vt.steps.forEach(d=>{d.fields&&d.fields.forEach(E=>{if(E.isSmart){let k=l[E.id],X=f.querySelector(`#bau-step-${d.id} [name="${E.name}"]`),Z=f.querySelector(`#bau-step-${d.id} #wrapper-${E.id}`);if(X&&(X.value=k&&k!=="N/A"?k:""),Z){let re=k&&k!==""&&k!=="N/A"&&k!=="undefined"&&k!=="null";Z.style.display=re?"none":"block"}}})});let p=Ao(l.timezone)||Tt,N=f.querySelector('select[name="availabilityTimezone"]');N&&(N.value=p,W());let O=l.userProfile?.defaultLanguage;O&&f.querySelectorAll('select[name="language"]').forEach(d=>{d.value=O}),f.querySelectorAll(".bau-all-data").forEach(d=>{let E=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"AM",value:l.amName},{label:"SE ID",value:l.seId},{label:"Site",value:l.website||l.site},{label:"Email",value:l.email},{label:"Timezone",value:l.timezone},{label:"Case ID",value:l.caseId},{label:"Programa",value:l.salesProgram},{label:"Idioma",value:l.language}];d.innerHTML=`
            ...
            `})}c.addEventListener("click",async l=>{let x=l.target.closest(".bau-md-copy");if(!x)return;l.preventDefault();let p=x.getAttribute("data-valor")||"";if(p){try{await navigator.clipboard.writeText(p)}catch(N){console.warn("Falha ao copiar:",N),v.playError(),te(I("genericErrorTitle"),{error:!0});return}x.classList.add("is-done"),x.innerHTML=Ce.check||Ce.wand,v.playClick(),navigator.vibrate&&navigator.vibrate(10),te(I("copiedToClipboard")),setTimeout(()=>{x.classList.remove("is-done"),x.innerHTML=Ce.wand},1500)}}),c.addEventListener("click",async l=>{let x=l.target.closest(".bau-rescan-btn");if(!(!x||x.classList.contains("spinning"))){l.preventDefault(),x.classList.add("spinning"),v.playClick();try{await le(),te(I("rescanDone"))}catch(p){console.warn("Falha ao recapturar o contexto:",p),v.playError(),te(I("genericErrorTitle"),{error:!0})}finally{c.querySelectorAll(".bau-rescan-btn.spinning").forEach(p=>p.classList.remove("spinning"))}}}),c.addEventListener("click",l=>{let x=l.target.closest(".bau-mini-btn-input");if(!x)return;let p=x.closest(".bau-input-group")?.querySelector('input[name="seId"]');p&&(l.preventDefault(),v.playClick(),Sa(p))});let F=c.querySelector("#bau-form-cid");F&&F.addEventListener("input",()=>oe(1)),f.addEventListener("change",l=>{let x=l.target?.name||"";(x==="availabilityTimezone"||x.startsWith("availability_"))&&W()});function ae(l){let x=l.availabilityTimezone||Tt;return["availability_1","availability_2","availability_3"].map(p=>{let N=l[`${p}_date`],O=l[`${p}_time`];return!N||!O?"":Eo(`${N}T${O}`,x)}).filter(Boolean)}function ie(l){let x=l.availabilityTimezone||Tt,p=Dt.find(Y=>Y.zone===x),N=ae(l);return N.length===0?I("notInformedPlaceholder"):`${N.map(Y=>{let[d,E]=Y.split("T"),[k,X,Z]=d.split("-");return`${Z}/${X} ${E.slice(0,5)}`}).join("  \xB7  ")} \u2014 ${p?p.label:x}`}function W(){let l=f.querySelector("#bau-availability-echo");if(!l)return;let x=Object.fromEntries(new FormData(f).entries()),p=x.availabilityTimezone||Tt,N=x.availability_1_date,O=x.availability_1_time;if(!N||!O){l.innerHTML="";return}if(p===Tt){l.textContent=I("echoSameZone");return}let Y=Eo(`${N}T${O}`,p),d=new Date(Y);if(isNaN(d.getTime())){l.innerHTML="";return}let E=new Intl.DateTimeFormat("pt-BR",{timeZone:Tt,day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",hour12:!1}).format(d),k=Dt.find(X=>X.zone===p);l.innerHTML=I("echoEquivalence")(O,k?k.label:p,E)}function se(l){return(vt.steps.flatMap(p=>p.fields||[]).find(p=>p.id==="language")?.options||[]).map(p=>`<option value="${p.value}" ${p.value===l?"selected":""}>${Xe(p.text)}</option>`).join("")}function L(){let l=new FormData(f),x=Object.fromEntries(l.entries()),p=c.querySelector("#bau-confirmation-details");if(p){if(i==="BAU"){let N=l.getAll("taskType"),O=N.length>0?N.join(", "):I("none");p.innerHTML=`
                ...
                <div class="bau-confirmation-grid">
                    ...
                    <div class="bau-confirm-row full-width">
                        ...
                        <span class="bau-confirm-value-input" style="cursor: default; opacity: 0.8;" title="${I("editTasksHint")}">${O}</span>
                    </div>
    ...
    `,g.appendChild(u),g.onmousedown=A=>{A.target===g&&w()};let h=u.querySelector(".cw-palette-input"),m=u.querySelector(".cw-palette-list");function b(){if(m.innerHTML="",c.length===0){m.innerHTML=`<div class="cw-palette-empty">${it("empty")}</div>`;return}let A=[],D=null;c.forEach((M,R)=>{if(M.group!==D){D=M.group;let P=document.createElement("div");P.className="cw-palette-group",P.textContent=it(M.group==="shortcuts"?"groupShortcuts":"groupModules"),P.setAttribute("aria-hidden","true"),m.appendChild(P)}let U=document.createElement("div");U.className="cw-palette-item"+(R===r?" selected":""),U.innerHTML=`
            ...
            `,U.onmouseenter=()=>{r=R,b()},U.onclick=()=>T(R),m.appendChild(U),A.push(U)});let f=A[r];f&&f.scrollIntoView({block:"nearest"})}function T(A){let D=c[A];D&&(v.playClick(),w(),D.run())}function y(){n||(n=!0,s=i(),c=s,r=0,h.value="",b(),Te(),document.body.appendChild(g),v.playGenieOpen(),requestAnimationFrame(()=>{g.classList.add("active"),h.focus()}))}function w(){n&&(n=!1,qe(),g.classList.remove("active"),setTimeout(()=>g.remove(),200))}function _(){n?w():y()}return h.addEventListener("input",()=>{let A=t(h.value.trim());c=A?s.filter(D=>D._haystack.includes(A)):s,r=0,b()}),h.addEventListener("keydown",A=>{A.key==="ArrowDown"?(A.preventDefault(),r=Math.min(r+1,c.length-1),b()):A.key==="ArrowUp"?(A.preventDefault(),r=Math.max(r-1,0),b()):A.key==="Enter"?(A.preventDefault(),T(r)):A.key==="Escape"&&(A.preventDefault(),w())}),document.addEventListener("keydown",A=>{(A.metaKey||A.ctrlKey)&&A.key.toLowerCase()==="k"&&(A.preventDefault(),_())}),Ee(()=>{g.setAttribute("aria-label",it("ariaLabel")),h.placeholder=it("placeholder");let A=u.querySelector(".js-cp-navigate");A&&(A.innerHTML=`${He.arrowDown}${He.arrowUp} ${it("navigate")}`);let D=u.querySelector(".js-cp-select");D&&(D.innerHTML=`${He.enter} ${it("select")}`);let f=u.querySelector(".js-cp-close");f&&(f.textContent=it("close")),b()}),{open:y,close:w,toggle:_}}function hl(){if(window.techSolInitialized){Qa();return}window.techSolInitialized=!0;let e="v6.3.3";console.log(`\u{1F680} TechSol Suite Initializing (${e})...`);try{sn();try{v.initGlobalListeners()}catch(m){console.warn("\xC1udio bloqueado:",m)}ge.fetchContentModules(["tips","broadcast","bau_availability","links","call_script","email_template","note_template","task_screenshots"]);let t=Qa(),a=mi(),o=yi(),i=ki(),n=_i(),r=or(),s=rr(),c=lr(),g=fr(),u=Pi(),h={toggleNotes:a,toggleEmail:o,toggleScript:i,toggleLinks:n,toggleTimezone:r,toggleLibrary:s,toggleConfigs:c,toggleBAUForm:g,broadcastControl:u};Gn(h,t),xr(h),setTimeout(()=>{ge.logEvent("App","Start","Session Start");let m=Ne();mt.sync(),(m?Ft(m.split("@")[0]).then(T=>{T&&(an(T),Zo(T))}).catch(T=>console.warn("N\xE3o foi poss\xEDvel resolver o idioma do perfil:",T)):Promise.resolve()).finally(()=>{Yi(),setTimeout(()=>{Ki(e)},500)})},2500)}catch(t){console.error("Erro fatal na inicializa\xE7\xE3o:",t),v.playError(),te("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}hl();})();
