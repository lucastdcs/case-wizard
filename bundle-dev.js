...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var St={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ht={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Gt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Le=t=>new Promise(e=>setTimeout(e,t));async function Ho(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Le(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let s=Math.floor(Math.random()*60)+30;a===0&&(s=150),a>e.length-3&&(s=30),await Le(s)}await Le(600),o&&(o.style.display="none")}async function Ct(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Le(200);let e=await Dt(),o=Rt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),s=t.querySelector("#p3"),r=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),s&&(s.textContent=o.suffix),await Le(300);let l=a?a.querySelector("svg"):null;if(l&&(l.style.opacity="1",l.style.transform="scale(1)"),await Le(400),n&&(n.style.opacity="1"),G.playStartup(),i&&await Ho(i,o.name),s&&(s.style.opacity="1",s.style.transform="translateY(0)"),o.isFriday&&r){await Le(400),r.style.display="block",r.offsetWidth;let d=r.querySelector(".sextou-badge");d&&(d.style.opacity="1",d.style.transform="scale(1)")}await Le(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Le(900),t.parentNode&&t.parentNode.removeChild(t)}}function jt(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,s=a-e.height-n,r=parseFloat(t.style.left)||e.left,l=parseFloat(t.style.top)||e.top,d=Math.max(n,Math.min(r,i)),c=Math.max(n,Math.min(l,s));if(d!==r||c!==l){let p=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${d}px`,t.style.top=`${c}px`,setTimeout(()=>{t.style.transition=p},300)}}var Ae={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Te(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,s=a.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),l=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),d=i,c=s,p=!1;function x(u){d=u.clientX,c=u.clientY,p||(window.requestAnimationFrame(()=>{b(),p=!1}),p=!0)}function b(){let u=r+(d-i),y=l+(c-s);u>360&&(t.style.width=u+"px"),y>300&&(t.style.height=y+"px")}function g(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",g),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",g)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Vt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Ut(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Wt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function be(t,e={}){return new Promise(o=>{let a=Ut(),n=Wt(),i=e.danger?"#FF3B30":"#007AFF",s=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let r=c=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(c)},300)},l=n.querySelector("#cw-conf-cancel"),d=n.querySelector("#cw-conf-ok");[l,d].forEach(c=>c.onmouseenter=()=>G.playHover()),l.onclick=()=>{G.playClick(),r(!1)},d.onclick=()=>{G.playClick(),r(!0)}})}function Yt(t,e=""){return new Promise(o=>{let a=Ut(),n=Wt();n.innerHTML=`
...
`+r;this.value=n.substring(0,o)+l+n.substring(a),this.selectionStart=this.selectionEnd=o+l.length}else if(e.key==="Tab")e.preventDefault(),e.shiftKey?s.startsWith("  ")&&(this.value=n.substring(0,i)+s.substring(2)+n.substring(o),this.selectionStart=this.selectionEnd=o-2):(this.value=n.substring(0,i)+"  "+s+n.substring(o),this.selectionStart=this.selectionEnd=o+2);else if(e.key==="Backspace"&&o===a&&o>0){let r=n.substring(0,o);r.endsWith("\u2022 ")?(e.preventDefault(),this.value=r.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2):r.endsWith("  ")&&s.trim().startsWith("\u2022")&&(e.preventDefault(),this.value=r.substring(0,o-2)+n.substring(a),this.selectionStart=this.selectionEnd=o-2)}}))}function At(t,e,o){if(e.innerHTML="",!!ke[t]&&(o.activeFields.forEach(n=>{if(["TAGS_IMPLEMENTED","SCREENSHOTS_LIST","CONSENTIU_GRAVACAO","CASO_PORTUGAL","label_substatus"].includes(n))return;let i=`field-${n}`,s=document.createElement("label"),r=p=>Se[o.currentLang]?.[p]||Se.pt?.[p]||p;s.textContent=r(n.toLowerCase())!==n.toLowerCase()?r(n.toLowerCase()):n.replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase())+":",Object.assign(s.style,{display:"flex",alignItems:"center",justifyContent:"space-between",fontSize:"13px",fontWeight:"700",color:R.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let l=document.createElement("span");if(l.textContent=s.textContent,s.innerHTML="",s.appendChild(l),n==="SPEAKEASY_ID"){let p=document.createElement("button");p.innerHTML="\u2728 Auto Busca",p.style.cssText=`font-size: 11px; font-weight: 700; color: ${R.primary}; background-color: ${R.primaryBg}; border: none; border-radius: ${de.pill}; padding: 6px 14px; margin-left: 10px; cursor: pointer; transition: all 0.2s ${se};`,p.onmouseenter=()=>p.style.backgroundColor="#d2e3fc",p.onmouseleave=()=>p.style.backgroundColor=R.primaryBg,p.onclick=x=>{x.preventDefault(),Qt(i)},s.appendChild(p)}let d=document.createElement("button");d.innerHTML="\u2715",d.style.cssText=`font-size: 14px; background: ${R.bgInput}; border: none; color: ${R.textSub}; cursor: pointer; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-left: auto; transition: all 0.2s ${se};`,d.onmouseenter=()=>{d.style.background=R.error,d.style.color=R.surface},d.onmouseleave=()=>{d.style.background=R.bgInput,d.style.color=R.textSub},d.onclick=async p=>{p.preventDefault(),await be(`Tem certeza que deseja remover o campo "${l.textContent.replace(":","")}"?`)&&(o.removeField(n),At(t,e,o))},s.appendChild(d);let c;He.includes(n)?(c=document.createElement("textarea"),c.classList.add("bullet-textarea","cw-textarea"),c.placeholder="Utilize marcadores para detalhar...",eo(c)):st.includes(n)?(c=document.createElement("textarea"),c.classList.add("cw-textarea"),c.placeholder="Descreva as considera\xE7\xF5es..."):(c=document.createElement("input"),c.type="text",c.classList.add("cw-input")),c.id=i,c.value=o.formData[i]||"",c.addEventListener("input",p=>o.updateField(i,p.target.value)),e.appendChild(s),e.appendChild(c)}),o.activeFields.includes("CONSENTIU_GRAVACAO"))){let n=r=>Se[o.currentLang]?.[r]||Se.pt?.[r]||r,i=document.createElement("label");i.textContent=n("consentiu_gravacao"),Object.assign(i.style,{display:"block",fontSize:"13px",fontWeight:"700",color:R.textSub,marginBottom:"8px",marginTop:"24px",textTransform:"uppercase",letterSpacing:"0.5px"});let s=document.createElement("select");s.className="cw-select",s.innerHTML=`
            <option value="false">${n("nao")}</option>
            <option value="true">${n("sim")}</option>
        `,s.value=o.consent?"true":"false",s.onchange=()=>o.setConsent(s.value==="true"),e.appendChild(i),e.appendChild(s)}}function Tt(t,e,o){let a=t.currentSubStatus;if(!a)return null;let n=ke[a],i=Se[t.currentLang]||Se.pt,s=d=>i[d]||Se.pt?.[d]||d,r='style="margin-bottom: 12px; padding-left: 30px;"',l="";if(t.activeFields.forEach(d=>{let c=s(d.toLowerCase()),p="N/A";if(d==="label_substatus")c=s("label_substatus"),p=n.name;else if(d==="TAGS_IMPLEMENTED"){c=s("tags_implemented");let x=[];e.getCheckedElements().forEach(g=>{let u=g.value,y=Ce[u],w=g.count||1,D=u==="ads_conversion_tracking"||u==="ads_enhanced_conversions";t.tagSupportUsed&&D&&!t.forcedScreenshots.has(u)?x.push(`${y.name} - ${s("ts_output_disclaimer")}`):x.push(w>1?`${y.name} (x${w})`:y.name)}),p=x.join(", ")||"N/A"}else if(d==="SCREENSHOTS_LIST"){c=s("screenshots_list");let x="",b=e.screenshotsElement;b&&Array.from(b.querySelectorAll('input[id^="name-"]')).forEach(u=>{let y=u.value,w=u.closest(".cw-screen-card");if(w){let D=w.querySelectorAll('input[id^="screen-"]'),z=!1,_="";D.forEach(Z=>{let T=Z.closest(".cw-input-group")?.querySelector(".cw-input-label")?.textContent||"Evid\xEAncia",A=Z.value.trim();A&&(_+=`<li>${T} - ${A}</li>`,z=!0)}),z&&(x+=`<div style="margin-bottom: 8px;"><b>${y}</b><ul ${r}>${_}</ul></div>`)}}),p=x||"N/A"}else if(d==="CASO_PORTUGAL")c=s("caso_portugal"),p=s("sim");else if(d==="CONSENTIU_GRAVACAO")c=s("consentiu_gravacao"),p=t.consent?s("sim"):s("nao");else{let x=`field-${d}`,b=t.formData[x],g="";if(n.fieldPrefixes&&n.fieldPrefixes[d]&&(g=n.fieldPrefixes[d]+" "),b&&b.trim()!==""&&b.trim()!=="\u2022"){let u=b.trim();if(He.includes(d)){let y=u.split(`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(T)}let d=document.createElement("div");d.className="cw-zen-container";let c=document.createElement("div");Object.assign(c.style,{display:"none"});let p=document.createElement("div");p.className="cw-screens-container",c.appendChild(p),d.innerHTML=`
    ...
    `;let x=d.querySelector(".cw-hero-grid"),b=d.querySelector(".cw-acc-container"),g=d.querySelector(".cw-results-container"),u=d.querySelector(".cw-search-input"),y=d.querySelector(".cw-status-bar"),w=d.querySelector(".cw-status-text"),D=d.querySelector(".cw-footer-icons");s.forEach(([T,A])=>{let q=i(A.name),M=document.createElement("div");M.className="cw-hero-card",M.id=`hero-${T}`,M.style.setProperty("--hero-color",q.color),M.innerHTML=`
        ...
        `,M.onclick=I=>{if(I.target.closest(".cw-step-btn"))return;let k=a[T]?a[T].count:0;_(T,k>0?-k:1,A)},M.querySelector(".minus").onclick=()=>_(T,-1,A),M.querySelector(".plus").onclick=()=>_(T,1,A),M.dataset.color=q.color,x.appendChild(M)});function z(T,A){let q=i(A.name),M=document.createElement("div");return M.className="cw-task-item",M.dataset.id=T,M.innerHTML=`
            <div class="cw-task-left">
                <div class="cw-list-icon" style="background:${q.bg}; color:${q.color}">
                    ${ze[q.icon]||ze.default}
                </div>
        ...
        `,M.onclick=I=>{if(I.target.closest(".cw-step-btn"))return;let k=a[T]?a[T].count:0;_(T,k>0?-k:1,A)},M.querySelector(".minus").onclick=()=>_(T,-1,A),M.querySelector(".plus").onclick=()=>_(T,1,A),M}Object.entries(r).forEach(([T,A])=>{let q=document.createElement("div");q.className="cw-acc-group";let M=document.createElement("div");M.className="cw-acc-header",M.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${A.brand.color}"></div>
                ${T}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,M.onclick=()=>{b.querySelectorAll(".cw-acc-group.open").forEach(k=>{k!==q&&k.classList.remove("open")}),q.classList.toggle("open")};let I=document.createElement("div");I.className="cw-acc-body",A.tasks.forEach(k=>{let v=z(k.key,k);I.appendChild(v)}),q.appendChild(M),q.appendChild(I),b.appendChild(q)});function _(T,A,q){a[T]||(a[T]={count:0,data:q,brand:i(q.name)}),a[T].count+=A,a[T].count<=0&&delete a[T],Z(),K(),t&&t()}function Z(){let T=o.tagSupportUsed;s.forEach(([k])=>{let v=x.querySelector(`#hero-${k}`);if(!v)return;let F=a[k];F?(v.classList.add("active"),v.querySelector(".cw-step-val").textContent=F.count,v.querySelector(".cw-step-val").style.color=v.dataset.color,T&&(k==="ads_conversion_tracking"||k==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(k)?v.classList.add("ts-success"):v.classList.remove("ts-success")):(v.classList.remove("active"),v.classList.remove("ts-success"))}),d.querySelectorAll(".cw-task-item").forEach(k=>{let v=k.dataset.id,F=a[v];F?(k.classList.add("selected"),k.querySelector(".cw-step-val").textContent=F.count,T&&(v==="ads_conversion_tracking"||v==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(v)?k.classList.add("ts-success"):k.classList.remove("ts-success")):(k.classList.remove("selected"),k.classList.remove("ts-success"))});let q=Object.keys(a),M=0,I=[];if(q.forEach(k=>{let v=a[k];M+=v.count;for(let F=0;F<v.count;F++)I.length<6&&I.push(v.brand)}),M>0){y.classList.add("visible");let k=M>1?"A\xE7\xF5es":"A\xE7\xE3o",v=M>1?"definidas":"definida";w.textContent=`${M} ${k} ${v}`,D.innerHTML="",I.forEach(F=>{let f=document.createElement("div");f.className="cw-mini-icon",f.innerHTML=ze[F.icon]||ze.default;let E=f.querySelector("svg");E&&(E.style.width="14px",E.style.height="14px"),D.appendChild(f)})}else y.classList.remove("visible")}u.addEventListener("input",T=>{let A=T.target.value.toLowerCase();if(A.length>0){b.style.display="none",g.style.display="block",g.innerHTML="";let q=!1;Object.entries(Ce).forEach(([M,I])=>{if(I.name.toLowerCase().includes(A)){q=!0;let k=z(M,I);a[M]&&(k.classList.add("selected"),k.querySelector(".cw-step-val").textContent=a[M].count),g.appendChild(k)}}),q||(g.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else b.style.display="block",g.style.display="none"});function K(){p.innerHTML="";let T=Object.keys(a),A=!1;if(T.length===0){p.innerHTML=`<div class="cw-empty-state">${e("selecione_tarefas")}</div>`,c.style.display="none";return}let q=o.tagSupportUsed,M=document.createElement("div");M.className="cw-info-banner",M.innerHTML=`
            <span style="font-size:14px">\u2139\uFE0F</span>
            <span>
                Os screenshots seguem as diretrizes atuais do Win Criteria e pol\xEDticas de Tag Support.
            </span>
        `,p.appendChild(M),T.forEach(I=>{let k=a[I].data,v=a[I].count,F=a[I].brand,E=q&&(I==="ads_conversion_tracking"||I==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(I),O=o.screenshotMode||"implementation",L=k.screenshots?.[O]||[];if(L.length>0||E){A=!0;for(let N=1;N<=v;N++){let B=document.createElement("div");B.className="cw-screen-card",E&&B.classList.add("ts-success"),B.style.setProperty("--brand-color",F.color),B.style.setProperty("--brand-bg",F.bg),B.style.setProperty("--brand-shadow",F.color+"40");let U=document.createElement("div");U.className="cw-card-header";let h=document.createElement("div");h.className="cw-card-icon",h.innerHTML=ze[F.icon]||ze.default;let V=document.createElement("div");V.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let X=document.createElement("input");X.className="cw-card-title-input",X.id=`name-${I}-${N}`,X.value=`${k.name}${v>1?" #"+N:""}`,X.title="Clique para renomear esta task";let W=document.createElement("span");if(W.className="cw-edit-hint",W.innerHTML="\u270E Renomear",V.appendChild(X),V.appendChild(W),U.appendChild(h),U.appendChild(V),B.appendChild(U),E){let m=document.createElement("div");m.className="cw-ts-disclaimer-box",m.innerHTML=`
                <span>${e("ts_disclaimer")}</span>
                <button class="cw-btn-ts-force">${e("incluir_mesmo_assim")}</button>
            `,m.querySelector("button").onclick=()=>{o.toggleForcedScreenshot(I,!0)},B.appendChild(m)}else L.forEach((m,S)=>{let C=document.createElement("div");C.className="cw-input-group";let $=document.createElement("label");$.className="cw-input-label",$.textContent=m;let P=document.createElement("input");P.className="cw-input-field",P.id=`screen-${I}-${N}-${S}`,P.placeholder="Cole o link aqui...",P.setAttribute("autocomplete","off"),P.addEventListener("input",()=>{P.value.trim().length>5?P.classList.add("filled"):P.classList.remove("filled")});let J=document.createElement("div");J.className="cw-input-check",J.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',C.appendChild($),C.appendChild(P),C.appendChild(J),B.appendChild(C)});p.appendChild(B)}}}),c.style.display=A?"block":"none"}return{selectionElement:d,screenshotsElement:c,updateSubStatus:()=>K(),getCheckedElements:()=>Object.keys(a).map(T=>({value:T,count:a[T].count})),setTaskCount:(T,A)=>{a[T]&&delete a[T],A>0&&Ce[T]&&_(T,A,Ce[T])},toggleTask:(T,A=!0)=>{let q=a[T];A&&!q?_(T,1,Ce[T]):!A&&q&&_(T,-q.count,Ce[T])},setLanguage:T=>{e=T;let A=d.querySelector(".js-hero-title");A&&(A.textContent=e("acesso_rapido"));let q=d.querySelector(".cw-search-input");q&&(q.placeholder=e("buscar_catalogo")),K()},reset:()=>{for(let T in a)delete a[T];u.value="",b.style.display="block",g.style.display="none",Z(),K()}}}var Wo={marginTop:"24px",marginBottom:"16px",padding:"20px",background:"#fff9e6",borderRadius:"20px",border:"1.5px solid #fbbc0540",display:"none",boxShadow:"0 4px 12px rgba(251, 188, 5, 0.05)"},Yo={fontSize:"12px",color:"#b06000",marginTop:"8px",lineHeight:"1.4"},Xo={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1.5px solid #dadce0",fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",background:"#fff"},Ko={display:"flex",gap:"20px",marginBottom:"12px"};function ao(t){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Wo);let o=document.createElement("label");o.className="js-ts-main-label",o.textContent=t("utilizou_tag_support"),Object.assign(o.style,St,{marginTop:"0"});let a=document.createElement("div");Object.assign(a.style,Ko);let n=document.createElement("input");n.type="radio",n.name="ts_usage_mod",n.value="Sim",Object.assign(n.style,Et);let i=document.createElement("label");i.textContent="Sim";let s=document.createElement("div");Object.assign(s.style,{display:"flex",alignItems:"center"}),s.appendChild(n),s.appendChild(i);let r=document.createElement("input");r.type="radio",r.name="ts_usage_mod",r.value="N\xE3o",r.checked=!0,Object.assign(r.style,Et);let l=document.createElement("label");l.textContent="N\xE3o";let d=document.createElement("div");Object.assign(d.style,{display:"flex",alignItems:"center"}),d.appendChild(r),d.appendChild(l),a.appendChild(s),a.appendChild(d);let c=document.createElement("div");c.style.display="block";let p=document.createElement("label");p.className="js-ts-reason-label",p.textContent=t("motivo_ts"),Object.assign(p.style,St,{fontSize:"12px"});let x=document.createElement("input");x.type="text",Object.assign(x.style,Xo);let b=document.createElement("div");b.className="js-ts-warning",b.innerHTML=`\u26A0\uFE0F <strong>${t("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>`,Object.assign(b.style,Yo),c.appendChild(p),c.appendChild(x),c.appendChild(b),e.appendChild(o),e.appendChild(a),e.appendChild(c),n.onchange=()=>{c.style.display="none",Promise.resolve().then(()=>(Xe(),it)).then(D=>D.notesState.setTagSupportUsed(!0))},r.onchange=()=>{c.style.display="block",Promise.resolve().then(()=>(Xe(),it)).then(D=>D.notesState.setTagSupportUsed(!1))};function g(D,z){if(e.style.display="none",!D||!z||z.length===0)return;z.some(Z=>Z==="ads_conversion_tracking"||Z==="ads_enhanced_conversions")?e.style.display="block":(w(),Promise.resolve().then(()=>(Xe(),it)).then(Z=>Z.notesState.setTagSupportUsed(!1)))}function u(){if(e.style.display==="none")return"";let D=`<br><b>Utilizou Tag Support?</b> ${n.checked?"\u2705 Sim":"\u274C N\xE3o"}`;return r.checked&&x.value.trim()!==""&&(D+=`<br><b>Motivo:</b> ${x.value}`),D+="<br>",D}function y(D){t=D,o.textContent=t("utilizou_tag_support"),p.textContent=t("motivo_ts"),b.innerHTML=`\u26A0\uFE0F <strong>${t("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#b06000; text-decoration:underline;">Link aqui</a>`}function w(){e.style.display="none",r.checked=!0,n.checked=!1,c.style.display="block",x.value=""}return{element:e,updateVisibility:g,getOutput:u,setLanguage:y,reset:w}}var kt="cw_notes_parking_lot",lt="cw_notes_emergency_save";var xe={getAll:()=>{try{return JSON.parse(localStorage.getItem(kt)||"[]")}catch{return[]}},save:t=>{let e=xe.getAll(),o={id:Date.now().toString(),timestamp:new Date().toISOString(),...t};return e.unshift(o),e.length>5&&e.pop(),localStorage.setItem(kt,JSON.stringify(e)),o},delete:t=>{let e=xe.getAll();return e=e.filter(o=>o.id!==t),localStorage.setItem(kt,JSON.stringify(e)),e},getCount:()=>xe.getAll().length,saveEmergency:t=>{let e={timestamp:Date.now(),data:t};localStorage.setItem(lt,JSON.stringify(e))},getEmergency:()=>{try{let t=localStorage.getItem(lt);if(!t)return null;let e=JSON.parse(t);return Date.now()-e.timestamp>432e5?(localStorage.removeItem(lt),null):e.data}catch{return null}},clearEmergency:()=>{localStorage.removeItem(lt)}};var Jo="https://script.google.com/a/macros/google.com/s/AKfycbzqotRrJBMsxJEgi5J2mvmow1jMLoghFniq8IXKkojhZbbFtIa9KkjUAWuZ9g7fTnOIuA/exec",Ft="cw_data_broadcast",no="cw_data_tips",Zo=["Processando...","Mantenha o foco!","Aguarde..."];function Je(t,e={}){return new Promise((o,a)=>{let n="cw_cb_"+Math.round(1e5*Math.random()),i=document.createElement("script");window[n]=l=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],o(l)};let s=Object.keys(e).map(l=>encodeURIComponent(l)+"="+encodeURIComponent(e[l])).join("&"),r=`${Jo}?op=${t}&callback=${n}&t=${Date.now()}&${s}`;i.src=r,i.onerror=()=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],a(new Error("JSONP Error (Check Corp Login)"))},document.body.appendChild(i)})}async function je(t,e){try{console.log(`\u{1F4E4} Executando ${t}...`,e);let o=await Je(t,e);if(o&&o.status==="success")return console.log("\u2705 Sucesso:",t),o;throw console.warn("\u26A0\uFE0F Falha:",o),new Error(o.message||`Opera\xE7\xE3o ${t} falhou.`)}catch(o){throw console.error(`\u274C Erro na opera\xE7\xE3o ${t}:`,o),o}}var fe={fetchTips:async()=>{try{let t=await Je("tips");t?.tips&&localStorage.setItem(no,JSON.stringify(t.tips))}catch(t){console.warn("Tips offline",t)}},fetchData:async()=>{try{let t=await Je("broadcast");if(t?.broadcast)return localStorage.setItem(Ft,JSON.stringify(t.broadcast)),t}catch(t){console.warn("Broadcast offline",t)}return{broadcast:JSON.parse(localStorage.getItem(Ft)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Ft)||"[]"),getRandomTip:()=>{let t=Zo,e=localStorage.getItem(no);if(e)try{t=JSON.parse(e)}catch{}return t[Math.floor(Math.random()*t.length)]},sendBroadcast:async t=>{let e={...t,date:new Date().toISOString(),id:Date.now().toString()};return await je("new_broadcast",e)},updateBroadcast:async(t,e)=>{let o={id:t,...e};return await je("update_broadcast",o)},deleteBroadcast:async t=>await je("delete_broadcast",{id:t}),logEvent:(t,e,o="",a=null)=>{try{let n="anon";try{let s=Ee();s&&(n=s.split("@")[0].toLowerCase())}catch{}let i={timestamp:new Date().toISOString(),user:n,version:"v5.1",category:t,action:e,label:o,value:a||""};Je("log",i).catch(s=>{})}catch(n){console.warn("Analytics error",n)}},logUsage:()=>{},getUserSnippets:async t=>{try{return await Je("get_user_snippets",{user:t})}catch(e){return console.warn("Erro ao buscar snippets:",e),null}},saveSnippet:async(t,e)=>{let o={...t,user:e};return await je("save_snippet",o)},deleteSnippet:async(t,e)=>await je("delete_snippet",{id:t,user:e})},io=async(t,e)=>{let o={...t,user:e,date:new Date().toISOString()};return await je("create_bau_escalation",o),!0};var ct=["lucaste","ricardogi"];var ie={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00",teal:"#00BFA5",pink:"#F48FB1",gray:"#9AA0A6"},dt=t=>new Promise(e=>setTimeout(e,t));function pt(t){let e=document.getElementById("cw-btn-notes");if(!e)return;let o=e.querySelector(".cw-dot-dirty");t?o||(o=document.createElement("div"),o.className="cw-dot-dirty",e.appendChild(o)):o&&o.remove()}function so(t){let e="cw-command-center-style";if(!document.getElementById(e)){let u=document.createElement("style");u.id=e,u.innerHTML=`
...
`.replace(/\n/g,"<br>");Qe(T);let A=await gt();A?(A.innerText.trim()===""&&(A.innerHTML=""),document.execCommand("insertHTML",!1,T),mt(A),Y("Nota gerada e inserida!")):Y("Copiado! Abra uma nota para colar.")},e}var ge=t=>new Promise(e=>setTimeout(e,t));function ve(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Fe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,i.innerHTML=`
        ...
        ">\xD7</div>
    `;let s=i.querySelector(".cw-close-btn");s.onclick=()=>{i.style.opacity="0",i.style.transform="translateY(-5px)",setTimeout(()=>i.remove(),300)},document.body.appendChild(i),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"}),setTimeout(()=>{document.body.contains(i)&&s.click()},25e3)}async function bt(t,e){if(!t||!e)return;t.focus(),t.value="",t.dispatchEvent(new Event("input",{bubbles:!0})),await ge(50),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(t,e),t.dispatchEvent(new Event("input",{bubbles:!0})),t.dispatchEvent(new Event("change",{bubbles:!0})),await ge(100),t.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",code:"Enter",bubbles:!0})),t.dispatchEvent(new KeyboardEvent("keyup",{key:"Enter",code:"Enter",bubbles:!0}))}function Ot(){let e=Array.from(document.querySelectorAll('[id="email-body-content-top-content"]')).find(o=>{let a=o.offsetParent!==null,n=o.closest("case-message-view")!==null,i=o.closest(".editor")!==null||o.closest("write-card")!==null;return a&&!n&&i});return e&&ve("Editor visualmente detectado.","success"),e}async function uo(){ve("\u{1F680} FASE 1: Tentando abrir a janela de email...");let t=!1,o=Array.from(document.querySelectorAll("i.material-icons-extended")).find(p=>p.innerText.trim()==="email");if(o&&o.offsetParent!==null){ve("Bot\xE3o de email direto encontrado.");let p=o.closest("material-button")||o.closest("material-fab")||o;Fe(p),t=!0}else{ve("Bot\xE3o direto n\xE3o vis\xEDvel. Tentando Speed Dial (+)...","warn");let p=document.querySelector("material-fab-speed-dial");if(p){let x=p.querySelector(".trigger");if(x){Fe(x),await ge(800);let g=Array.from(document.querySelectorAll("i.material-icons-extended")).find(u=>u.innerText.trim()==="email");g&&(Fe(g),t=!0)}}}if(!t)return Y("Erro: Bot\xE3o de email n\xE3o encontrado.",{error:!0}),!1;ve("\u{1F680} FASE 2: Verificando rascunhos...");let a=null,n=0,i=20;for(;n<i;){await ge(250);let p=document.querySelectorAll('material-button[debug-id="discard-prewrite-draft-button"]');if(a=Array.from(p).find(x=>x.offsetParent!==null),a){ve("\u26A0\uFE0F Rascunho detectado!","warn");break}n++}if(a){ve("\u{1F5D1}\uFE0F Descartando..."),Fe(a),a.click();let p=null,x=0;for(;x<15;){await ge(300);let b=document.querySelectorAll('material-button[debug-id="confirm-button"]');if(p=Array.from(b).find(g=>g.offsetParent!==null),p)break;x++}p&&(Fe(p),Y("Limpando rascunho antigo...",{duration:2e3}),await ge(2500))}ve("\u{1F680} FASE 3: Buscando editor final...");let s=0,r=null;for(;s<20&&(r=Ot(),!r);)await ge(250),s++;if(!r)return Y("Erro: Editor n\xE3o carregou.",{error:!0}),!1;let l=r.closest('[id="email-body-content-top"]'),c=(r.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');if(l){if(c){let x=c.closest('[aria-hidden="true"]');x&&x.removeAttribute("aria-hidden"),c.focus(),Fe(c)}await ge(300),l.innerHTML=`
            <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block">
                <span id="cases-body-field"><br></span>
            </div>
        `;let p=l.querySelector("#cases-body-field");if(p){let x=document.createRange();x.selectNodeContents(p),x.collapse(!0);let b=window.getSelection();b.removeAllRanges(),b.addRange(x)}return!0}return!1}async function xt(t){if(!t||!await uo())return;let o=await ye();ve("\u{1F4E7} Processando destinat\xE1rios para CR...","info");let a=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(a&&(a.click(),await ge(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let i=document.querySelector('input[aria-label="Enter To email address"]');i&&(await bt(i,o.clientEmail),ft(i,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let i=document.querySelector('input[aria-label="Enter Bcc email address"]');i&&(await bt(i,o.internalEmail),ft(i,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}await ge(500);let n=document.querySelector('material-button[debug-id="canned_response_button"]');if(n){Fe(n),await ge(1e3);let i=document.querySelector("material-auto-suggest-input input");if(i){Fe(i),document.execCommand("insertText",!1,t),i.dispatchEvent(new Event("input",{bubbles:!0})),ve("\u23F3 Buscando resultado da Canned Response...","info");let s=null,r=0,l=15e3,d=500;for(;r<l&&(s=document.querySelector("material-select-dropdown-item"),!s);)await ge(d),r+=d;if(s){Fe(s),await ge(1500);let c=Ot();if(c){let x=Array.from(c.querySelectorAll("span.field")).filter(g=>g.innerText.includes("{Requested Task Type}"));if(x.length>0){let g=x.map(y=>y.closest("tr")).filter(y=>y!==null),u=[...new Set(g)];if(u.length>0){let w=u[0].querySelector('td[width="100%"]');w&&(w.innerHTML='<span class="field" style="color:rgb(60, 64, 67)">Enhanced Conversions - Aguardando Valida\xE7\xE3o - Dentro de 7 dias</span>');for(let D=1;D<u.length;D++)u[D].remove()}}let b=c.innerHTML;o.advertiserName&&b.includes("{%ADVERTISER_NAME%}")&&(b=b.replace(/{%ADVERTISER_NAME%}/g,o.advertiserName)),b.includes("{%^79285%}")&&(b=b.replace(/{%\^79285%}/g,o.websiteUrl||"seu site")),c.innerHTML=b}Y("Canned Response aplicada!")}else ve(`\u274C Timeout: Resultado '${t}' n\xE3o apareceu ap\xF3s 15s.`,"error"),Y(`Timeout: Template '${t}' n\xE3o carregou.`,{error:!0})}}else Y("Bot\xE3o Canned Response n\xE3o encontrado.",{error:!0})}async function mo(t){if(ve(`\u{1F680} Iniciando Quick Email: ${t.name}`),!await uo())return;let o=await ye(),a=Ye();await ge(600);let n=document.querySelector('material-icon[aria-label="Show CC and BCC fields"]')||document.querySelector('material-icon[debug-id="expand-button"][aria-pressed="false"]');if(n&&(n.click(),await ge(600)),o.clientEmail&&o.clientEmail!=="N/A"&&o.clientEmail!=="N/A (Bloqueado)"){let r=document.querySelector('input[aria-label="Enter To email address"]');r&&(await bt(r,o.clientEmail),ft(r,"<strong>Verifique o e-mail:</strong> O CRM pode traduzir caracteres incorretamente."))}if(o.internalEmail){let r=document.querySelector('input[aria-label="Enter Bcc email address"]');r&&(await bt(r,o.internalEmail),ft(r,"<strong>Aten\xE7\xE3o:</strong> Verifique se o e-mail do AM deve estar em c\xF3pia."))}let i=document.querySelector('input[aria-label="Subject"]');i&&t.subject&&(i.focus(),Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set.call(i,t.subject),i.dispatchEvent(new Event("input",{bubbles:!0})),await ge(300));let s=Ot();if(s){let l=(s.closest(".email-body-content")||document.body).querySelector('div[contenteditable="true"][aria-label="Email body"]');l&&(l.focus(),Fe(l));let d=new Date;d.setDate(d.getDate()+3);let c=d.getDay();c===6?d.setDate(d.getDate()+2):c===0&&d.setDate(d.getDate()+1);let p=d.toLocaleDateString("pt-BR"),x=t.body;x=x.replace(/\[Nome do Cliente\]/g,o.advertiserName||"Cliente"),x=x.replace(/\[INSERIR URL\]/g,o.websiteUrl||"seu site"),x=x.replace(/\[URL\]/g,o.websiteUrl||"seu site"),x=x.replace(/\[Seu Nome\]/g,a),x=x.replace(/\[MM\/DD\/YYYY\]/g,p),document.execCommand("insertHTML",!1,x),l&&(l.dispatchEvent(new Event("input",{bubbles:!0})),l.dispatchEvent(new Event("change",{bubbles:!0}))),Y("Email preenchido com sucesso!",{duration:2e3}),ve("\u2705 Processo finalizado com sucesso.","success")}else Y("Erro ao focar no editor.",{error:!0})}if(!document.getElementById("cw-module-styles")){let t=document.createElement("style");t.id="cw-module-styles",t.innerHTML=`
        /* M\xD3DULO BASE */
        .cw-module-window {
...
CID: ${S.cid||"---"}
Case ID: ${S.caseId||"---"}
E-mail: ${S.clientEmail||"---"}`;$&&($.value=J),P&&(P.style.display="block",P.style.maxHeight="300px",P.style.opacity="1",P.scrollIntoView({behavior:"smooth",block:"end"}))})}function b(){r=!r,ue(r,l,"cw-btn-script"),r?(p(),c||(c=setInterval(p,2e3))):c&&(clearInterval(c),c=null)}let g=pe(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",d,()=>{b()});l.appendChild(g);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `,u.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},u.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(g),b.appendChild(u),x.appendChild(b),p.appendChild(x);let y=document.createElement("div");y.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(y);let w=null;function D(){if(w)return;w=document.createElement("div"),w.style.cssText=`
      ...
      `;let k=document.createElement("div");k.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",k.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let v=document.createElement("button");v.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',v.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",v.onclick=()=>{_(),n=!1,A()},k.appendChild(v),w.appendChild(k);let F=document.createElement("div");F.id="cw-history-list",F.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",w.appendChild(F),p.appendChild(w)}function z(){w||D();let k=w.querySelector("#cw-history-list");k.innerHTML="";let v=Qo();v.length===0?k.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':v.forEach(F=>{let f=M(F,Be[F._originalCat],!0,F._originalCat);k.appendChild(f)}),requestAnimationFrame(()=>w.style.transform="translateY(0)")}function _(){w&&(w.style.transform="translateY(100%)")}function Z(){c.innerHTML="";let k=K("history","Recentes",Be.history);k.id="cw-sidebar-btn-history",k.onclick=()=>{G.playClick(),n=!n,n?z():_(),A()},c.appendChild(k);let v=document.createElement("div");v.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",c.appendChild(v),Object.keys(et).forEach(F=>{let f=et[F],E=K(F,f.label,Be[F]);E.id=`cw-sidebar-btn-${F}`,E.onclick=()=>{G.playClick(),n&&(n=!1,_()),T(F)},c.appendChild(E)})}function K(k,v,F){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=v,f.dataset.key=k;let E=document.createElement("div");E.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",E.innerHTML=F||Be.tasks;let O=document.createElement("div");return O.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",O.textContent=v,f.appendChild(E),f.appendChild(O),f.onmouseenter=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="#F1F3F4",E.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="transparent",E.style.transform="scale(1)")},f}function T(k){let v=document.getElementById(`cat-anchor-${k}`);v&&(v.scrollIntoView({behavior:"smooth",block:"start"}),a=k,A())}function A(){Object.keys(et).forEach(v=>{let F=c.querySelector(`#cw-sidebar-btn-${v}`);if(F)if(a===v&&!n){let f=ht[v];F.style.background=f.bg,F.style.color=f.color,F.querySelector("div:first-child").style.transform="scale(1.1)"}else F.style.background="transparent",F.style.color=i.textSecondary,F.querySelector("div:first-child").style.transform="scale(1)"});let k=c.querySelector("#cw-sidebar-btn-history");k&&(n?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=i.textSecondary))}function q(){if(y.innerHTML="",e.trim()!==""){let v=[];if(Object.entries(et).forEach(([f,E])=>{let O=E.links.filter(L=>L.name.toLowerCase().includes(e.toLowerCase())||L.desc.toLowerCase().includes(e.toLowerCase()));v.push(...O.map(L=>({...L,_cat:f})))}),v.length===0){y.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let F=document.createElement("div");F.innerHTML="Resultados da busca",F.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",y.appendChild(F),v.forEach(f=>{let E=M(f,Be[f._cat],!1,f._cat);y.appendChild(E)});return}Object.entries(et).forEach(([v,F])=>{let f=ht[v],E=document.createElement("div"),O=document.createElement("div");O.id=`cat-anchor-${v}`,O.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,O.innerHTML=`
            ...
            ${F.label}
          `,E.appendChild(O);let L=document.createElement("div");L.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",F.links.forEach(N=>{let B=M(N,Be[v],!1,v);L.appendChild(B)}),E.appendChild(L),y.appendChild(E)});let k=document.createElement("div");k.style.height="80px",y.appendChild(k)}function M(k,v,F,f){let E=document.createElement("div"),O=ht[f]||ht.history;E.style.cssText=`
      ...
      `,V.title="Copiar URL",E.onmouseenter=()=>{E.style.transform="translateY(-2px)",E.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",E.style.borderColor="rgba(0,0,0,0.05)",E.style.borderLeft=`4px solid ${O.color}`,V.style.opacity="1",V.style.background="#F1F3F4"},E.onmouseleave=()=>{E.style.transform="translateY(0)",E.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",E.style.border="1px solid transparent",V.style.opacity="0",V.style.background="transparent"},E.onclick=()=>{!F&&f&&So(k,f),window.open(k.url,"_blank")},V.onclick=X=>{X.stopPropagation(),G.playClick(),navigator.clipboard.writeText(k.url),!F&&f&&So(k,f),Y("Link copiado!")},E.appendChild(L),E.appendChild(B),E.appendChild(V),E}u.addEventListener("input",k=>{e=k.target.value,q()});function I(){o=!o,ue(o,s,"cw-btn-links")}return document.body.appendChild(s),Z(),q(),I}var _e=[];function qt(t){_e=t}var ea=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Eo(){let t="v4.9",e=!1,o=null,a=null;function n(f){if(!f)return"";try{let E=new Date(f);return isNaN(E.getTime())?String(f):E.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,g.querySelectorAll('input[name="cw-bc-type"]').forEach(L=>{L.addEventListener("change",()=>{g.querySelectorAll(".cw-radio-option").forEach(N=>N.classList.remove("checked")),L.parentElement.classList.add("checked")})}),setTimeout(()=>{let L=g.querySelector(".cw-radio-option.info");L&&L.classList.add("checked")},100);let f=g.querySelector("#cw-bc-cancel"),E=g.querySelector("#cw-bc-close-x"),O=g.querySelector("#cw-bc-send");f.onclick=z,E.onclick=z,O.onclick=_,d.appendChild(g)}function D(f=null){if(!g)return;let E=g.querySelector("#cw-editor-title-label"),O=g.querySelector("#cw-bc-title"),L=g.querySelector("#cw-bc-text"),N=g.querySelector("#cw-bc-send");if(f){a=f.id,E.textContent="Editar Aviso",O.value=f.title||"",L.value=f.text||"",N.textContent="Salvar Altera\xE7\xF5es";let B=f.type||"info",U=g.querySelector(`input[name="cw-bc-type"][value="${B}"]`);U&&U.click()}else{a=null,E.textContent="Novo Aviso",O.value="",L.value="",N.textContent="Publicar";let B=g.querySelector('input[name="cw-bc-type"][value="info"]');B&&B.click()}g.classList.add("active"),setTimeout(()=>O.focus(),300)}function z(){g&&g.classList.remove("active"),a=null}async function _(){let f=g.querySelector("#cw-bc-send"),E=g.querySelector("#cw-bc-title"),O=g.querySelector("#cw-bc-text"),L=g.querySelector('input[name="cw-bc-type"]:checked'),N=L?L.value:"info";if(!E.value.trim()||!O.value.trim()){Y("Preencha todos os campos!",{error:!0});return}f.textContent="Salvando...",f.style.opacity="0.7";let B=!1;a?B=await fe.updateBroadcast(a,{title:E.value,text:O.value,type:N}):B=await fe.sendBroadcast({title:E.value,text:O.value,type:N,author:window._cwCurrentUser||"admin"}),B?(Y(a?"Atualizado!":"Publicado!"),G.playSuccess(),z(),setTimeout(()=>T(),1500)):(Y("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),f.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",f.style.opacity="1")}async function Z(f){if(await be("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await fe.deleteBroadcast(f)){Y("Aviso removido."),G.playClick();let L=_e.findIndex(N=>N.id===f);L>-1&&_e.splice(L,1),q(),setTimeout(()=>T(),1500)}else Y("Erro ao excluir.",{error:!0})}let K=document.createElement("div");K.className="cw-nice-scroll",Object.assign(K.style,i.feedContainer),d.appendChild(K);async function T(){e&&(y.style.display="block",y.innerHTML="\u{1F504} Sincronizando...");try{let f=await fe.fetchData();f&&f.broadcast&&(qt(f.broadcast),A(),e&&(q(),y.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{y.style.display="none"},1500)))}catch{e&&(y.innerHTML="\u26A0\uFE0F Offline")}}function A(){let f=document.getElementById("cw-btn-broadcast");if(!f)return;let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(_e.some(L=>!E.includes(L.id))){if(f.classList.add("has-new"),!f.querySelector(".cw-badge")){let L=document.createElement("div");L.className="cw-badge",Object.assign(L.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),f.appendChild(L)}}else{f.classList.remove("has-new");let L=f.querySelector(".cw-badge");L&&L.remove()}}function q(){K.innerHTML="";let f=d.querySelector("#cw-bau-widget");f&&f.remove();let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=[..._e].sort((h,V)=>{let X=new Date(h.date).getTime()||0;return(new Date(V.date).getTime()||0)-X}),L=O.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(L!==-1){let h=O[L];O.splice(L,1);let V=document.createElement("div");V.id="cw-bau-widget",Object.assign(V.style,i.bauContainer);let X=[],W=(h.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,S="\u{1F4C5}";if(W.forEach(H=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(H)?S="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(H)&&(S="\u{1F1EA}\u{1F1F8}");let ee=H.match(m);if(ee){let oe=ee[0],Q=S;/🇧🇷|🇵🇹|PT|BR/i.test(H)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(H)&&(Q="\u{1F1EA}\u{1F1F8}"),X.some(te=>te.flag===Q&&te.date===oe)||X.push({flag:Q,date:oe})}}),X.length===0){let H=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);H&&[...new Set(H)].forEach(ee=>X.push({flag:"\u{1F4C5}",date:ee}))}let C="",$='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&($=`
          ...
          `,y.after(V);let P=V.querySelector("#cw-bau-toggle-btn"),J=V.querySelector("#cw-bau-full");if(P&&J&&(P.onclick=()=>{let H=J.style.display==="none";J.style.display=H?"block":"none",P.textContent=H?"Ocultar":"Detalhes"}),window._cwIsAdmin){let H=V.querySelector(".cw-bau-edit");H&&(H.onclick=()=>D(h))}}let N=O.sort((h,V)=>{let X=E.includes(h.id),W=E.includes(V.id);return X===W?0:X?1:-1});if(N.length===0&&!L){let h=document.createElement("div");Object.assign(h.style,i.emptyState),h.innerHTML=`
           ...
           `,K.appendChild(h)}let B=N.filter(h=>!E.includes(h.id)),U=N.filter(h=>E.includes(h.id));if(B.forEach(h=>K.appendChild(M(h,!1))),U.length>0){let h=document.createElement("div");Object.assign(h.style,i.historyDivider),h.innerHTML=`<span>Hist\xF3rico (${U.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let V=document.createElement("div");Object.assign(V.style,i.historyContainer),U.forEach(W=>V.appendChild(M(W,!0)));let X=!1;h.onclick=()=>{G.playClick(),X=!X,V.style.display=X?"flex":"none",h.querySelector("svg").style.transform=X?"rotate(180deg)":"rotate(0deg)"},K.appendChild(h),K.appendChild(V)}}function M(f,E){let O=document.createElement("div");Object.assign(O.style,E?i.cardHistory:i.card);let L=s[f.type]||s.info,N=document.createElement("div");Object.assign(N.style,i.cardHeader);let B=document.createElement("div");Object.assign(B.style,i.typeTag,{color:L.color,background:L.bg}),B.innerHTML=`${L.icon} <span>${f.type}</span>`;let U=document.createElement("span");if(Object.assign(U.style,i.dateTag),U.textContent=n(f.date),N.appendChild(B),E)N.appendChild(U);else{let m=document.createElement("button");m.className="cw-btn-interactive",Object.assign(m.style,i.dismissBtn),m.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',m.onmouseenter=()=>{m.style.color="#1e8e3e",m.style.background="#e6f4ea",m.style.borderColor="#1e8e3e"},m.onmouseleave=()=>{m.style.color="#5f6368",m.style.background="#fff",m.style.borderColor="rgba(0,0,0,0.1)"},m.onclick=S=>{S.stopPropagation(),G.playClick(),O.style.transform="translateX(20px)",O.style.opacity="0",setTimeout(()=>{let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");C.push(f.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(C)),q(),A()},200)},N.appendChild(m)}let h=document.createElement("div");Object.assign(h.style,i.cardContent);let V=document.createElement("div");Object.assign(V.style,i.msgTitle),V.textContent=f.title;let X=document.createElement("div");Object.assign(X.style,i.msgBody),X.innerHTML=l(f.text);let W=document.createElement("div");if(Object.assign(W.style,i.msgMeta),W.innerHTML=`Publicado por <b>${f.author||"Sistema"}</b>`,E||(W.innerHTML+=` \u2022 ${n(f.date)}`),h.appendChild(V),h.appendChild(X),h.appendChild(W),O.appendChild(N),O.appendChild(h),window._cwIsAdmin){let m=document.createElement("div");m.className="cw-card-actions";let S=document.createElement("button");S.className="cw-action-btn edit",S.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',S.onclick=()=>D(f);let C=document.createElement("button");C.className="cw-action-btn delete",C.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',C.onclick=()=>Z(f.id),m.appendChild(S),m.appendChild(C),O.appendChild(m)}return O}let I=fe.getCachedBroadcasts();I.length>0&&(qt(I),q()),setTimeout(u,500),T(),o||(o=setInterval(T,ea));let k=document.createElement("div");Object.assign(k.style,Ae),k.className="no-drag",d.appendChild(k),Te(d,k),document.body.appendChild(d);let v=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),F=_e.some(f=>!v.includes(f.id));return{toggle:p,hasUnread:F}}function Ao(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let l=document.createElement("div");Object.assign(l.style,o.dotsContainer);let d=document.createElement("div");Object.assign(d.style,o.btnContainer);let c=document.createElement("button");c.textContent="Pular",Object.assign(c.style,o.btn,o.btnSkip),c.onmouseover=()=>c.style.color="#202124",c.onmouseout=()=>c.style.color="#5f6368";let p=document.createElement("button");p.textContent="Pr\xF3ximo",Object.assign(p.style,o.btn,o.btnNext),p.onmouseover=()=>p.style.transform="scale(1.05)",p.onmouseout=()=>p.style.transform="scale(1)",d.appendChild(c),d.appendChild(p),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(l),n.appendChild(d),a.appendChild(n),document.body.appendChild(a);function x(g){let u=t[g];i.textContent=u.icon,s.textContent=u.title,r.textContent=u.text,l.innerHTML="",t.forEach((y,w)=>{let D=document.createElement("div");Object.assign(D.style,o.dot),w===g&&Object.assign(D.style,o.dotActive),l.appendChild(D)}),u.isLast?(c.style.display="none",p.textContent="Come\xE7ar \u{1F680}",p.style.width="100%"):(c.style.display="block",p.textContent="Pr\xF3ximo",p.style.width="auto")}function b(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),G.playSuccess(),Y("Tudo pronto! Use o menu flutuante.")}p.onclick=()=>{G.playClick(),e<t.length-1?(e++,x(e)):b()},c.onclick=async()=>{await be("Pular o tutorial?")&&b()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var To={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function ko(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&ta(t)}function ta(t){let e=To.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let l=document.createElement("div");Object.assign(l.style,a.title);let d=document.createElement("div");Object.assign(d.style,a.text);let c=document.createElement("div");Object.assign(c.style,a.dotsContainer);let p=document.createElement("button");Object.assign(p.style,a.btn),p.onmouseover=()=>p.style.transform="scale(1.02)",p.onmouseout=()=>p.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(l),i.appendChild(d),i.appendChild(c),i.appendChild(p),n.appendChild(i),document.body.appendChild(n);function x(g){let u=e[g];r.textContent=u.icon,l.textContent=u.title,d.textContent=u.text,c.innerHTML="",e.forEach((y,w)=>{let D=document.createElement("div");Object.assign(D.style,a.dot),w===g&&Object.assign(D.style,a.dotActive),c.appendChild(D)}),g===e.length-1?p.textContent="Entendi, vamos l\xE1! \u{1F44D}":p.textContent="Pr\xF3ximo"}function b(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),G.playSuccess(),Y(`TechSol atualizado para ${t}!`)}p.onclick=()=>{G.playClick(),o<e.length-1?(o++,x(o)):b()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Fo="cw_timezone_pinned",_t=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],oa=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function Oo(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Fo)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},d={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},c=document.createElement("div");c.id="timezone-popup",c.classList.add("cw-module-window"),Object.assign(c.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=pe(c,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:c},()=>E());c.appendChild(x);let b=document.createElement("div");Object.assign(b.style,d.container),c.appendChild(b);let g=document.createElement("div");Object.assign(g.style,d.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,d.tabBtn,d.tabActive);let y=document.createElement("div");y.textContent="Planejador",Object.assign(y.style,d.tabBtn),g.appendChild(u),g.appendChild(y),b.appendChild(g);let w=document.createElement("div");Object.assign(w.style,d.toolbar);let D=document.createElement("div");Object.assign(D.style,d.searchInputWrapper);let z=document.createElement("div");z.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(z.style,d.searchIcon);let _=document.createElement("input");_.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(_.style,d.searchInput),_.onfocus=()=>{_.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",_.style.borderColor="rgba(26,115,232,0.3)"},_.onblur=()=>{_.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",_.style.borderColor="transparent"},_.oninput=O=>{i=O.target.value.toLowerCase(),k()},D.appendChild(z),D.appendChild(_),w.appendChild(D);let Z=document.createElement("div");Object.assign(Z.style,d.chipsRow),oa.forEach(O=>{let L=document.createElement("div");L.textContent=O.label,L.id=`tz-filter-${O.id}`,Object.assign(L.style,d.chip),O.id===s&&Object.assign(L.style,d.chipActive),L.onclick=()=>{G.playClick(),s=O.id,Array.from(Z.children).forEach(N=>{Object.assign(N.style,d.chip)}),Object.assign(L.style,d.chipActive),k()},Z.appendChild(L)}),w.appendChild(Z),b.appendChild(w);let K=document.createElement("div");Object.assign(K.style,d.listContainer);let T=document.createElement("style");T.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",b.appendChild(T);let A=document.createElement("div");Object.assign(A.style,d.plannerWrapper,{display:"none"}),b.appendChild(K),b.appendChild(A),u.onclick=()=>q("live"),y.onclick=()=>q("plan");function q(O){G.playClick(),O==="live"?(Object.assign(u.style,d.tabActive),Object.assign(y.style,d.tabBtn),y.style.borderBottomColor="transparent",K.style.display="flex",w.style.display="flex",A.style.display="none",F()):(Object.assign(y.style,d.tabActive),Object.assign(u.style,d.tabBtn),u.style.borderBottomColor="transparent",A.style.display="flex",K.style.display="none",w.style.display="none",f(),v())}function M(O){return O>=9&&O<17?{color:l.success,bg:l.successBg,label:"Aberto",icon:"\u{1F7E2}"}:O>=8&&O<9?{color:l.warning,bg:l.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:O>=17&&O<19?{color:l.warning,bg:l.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function I(O){n.includes(O)?n=n.filter(L=>L!==O):n.push(O),localStorage.setItem(Fo,JSON.stringify(n)),k(),G.playClick()}function k(){K.innerHTML="";let O=new Date,L=_t.filter(B=>{let U=B.name.toLowerCase().includes(i)||B.label.toLowerCase().includes(i),h=s==="all"||B.region===s;return U&&h});if(L.sort((B,U)=>{let h=n.includes(B.id),V=n.includes(U.id);return h&&!V?-1:!h&&V?1:B.name.localeCompare(U.name)}),L.length===0){K.innerHTML=`
            ...
            `,m.onmouseenter=()=>{m.style.transform="translateY(-2px)",m.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},m.onmouseleave=()=>{m.style.transform="translateY(0)",m.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let $=m.querySelector(".cw-pin-btn");$.onmouseenter=()=>{$.style.backgroundColor="#F1F3F4"},$.onmouseleave=()=>{$.style.backgroundColor="transparent"},$.onclick=P=>{P.stopPropagation(),I(B.id)},m.onclick=()=>{a=B.id,q("plan")},K.appendChild(m)});let N=document.createElement("div");N.style.height="20px",N.style.width="100%",K.appendChild(N)}function v(){A.innerHTML="";let O=document.createElement("div"),L=document.createElement("label");L.textContent="Onde est\xE1 o cliente?",L.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let N=document.createElement("select");Object.assign(N.style,Ht),N.style.padding="14px",[..._t].sort((ne,te)=>ne.name.localeCompare(te.name)).forEach(ne=>{let te=document.createElement("option");te.value=ne.id,te.textContent=`${ne.flag} ${ne.name} (${ne.zone})`,ne.id===a&&(te.selected=!0),N.appendChild(te)}),N.onchange=ne=>{a=ne.target.value,Q(),G.playClick()},O.appendChild(L),O.appendChild(N),A.appendChild(O);let U=document.createElement("div");Object.assign(U.style,d.timeComparisonRow);let h=document.createElement("div");Object.assign(h.style,d.timeCard),h.style.backgroundColor="#F8FAFF",h.style.borderColor="#E8F0FE",h.innerHTML=`
        ...
        `,document.head.appendChild(v)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},s={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let d=pe(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>k());r.appendChild(d);let c=document.createElement("div");Object.assign(c.style,s.container),r.appendChild(c);let p=document.createElement("div");Object.assign(p.style,s.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(v=>{let F=document.createElement("div");F.innerHTML=`${v.icon} ${v.label}`,F.id=`lib-tab-${v.id}`,Object.assign(F.style,s.tabBtn),v.id===o&&Object.assign(F.style,s.tabActive),F.onmouseenter=()=>G.playHover(),F.onclick=()=>Z(v.id),p.appendChild(F)}),c.appendChild(p);let b=document.createElement("div");Object.assign(b.style,s.listContainer),c.appendChild(b);let g=document.createElement("div");g.className="cw-fab cw-tactile",Object.assign(g.style,s.fab),g.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',g.onmouseenter=()=>g.style.transform="scale(1.1)",g.onmouseleave=()=>g.style.transform="scale(1)",g.onclick=()=>T(),c.appendChild(g),a=document.createElement("div"),Object.assign(a.style,s.editorOverlay);let u=document.createElement("div");Object.assign(u.style,s.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let y=document.createElement("button");y.innerHTML="Cancelar",y.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",y.onclick=A,u.appendChild(y),a.appendChild(u);let w=document.createElement("div");Object.assign(w.style,s.editorBody),a.appendChild(w);let D=document.createElement("div");D.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let z=document.createElement("button");z.textContent="Salvar",z.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",z.onclick=q,D.appendChild(z),a.appendChild(D),c.appendChild(a);let _=document.createElement("div");Object.assign(_.style,Ae),_.className="no-drag",r.appendChild(_),Te(r,_),document.body.appendChild(r);function Z(v){G.playClick(),o=v,x.forEach(F=>{let f=document.getElementById(`lib-tab-${F.id}`);F.id===v?Object.assign(f.style,s.tabActive):Object.assign(f.style,s.tabBtn)}),K()}function K(){b.innerHTML="";let v=he.getSnippets(o);if(v.length===0){b.innerHTML=`
            ...
            `;return}v.forEach(F=>{let f=document.createElement("div");f.className="cw-lib-card",Object.assign(f.style,s.card),F.isCode&&(f.style.borderLeft=`4px solid ${i.primary}`,f.style.background="rgba(0, 122, 255, 0.02)");let E=F.content;if(F.isRich){let O=document.createElement("div");O.innerHTML=F.content;let L=O.querySelector("img");E=O.innerText.substring(0,150)+(O.innerText.length>150?"...":""),L&&(E="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+E)}f.innerHTML=`
                ...
                <div style="${I(s.cardPreview)}; ${F.isCode?"font-family:'Roboto Mono', monospace; font-size:11px;":""}">${E}</div>
            ...
            `,f.onmouseenter=()=>{G.playHover()},f.querySelector(".cw-act-copy").onclick=O=>{if(O.stopPropagation(),G.playClick(),F.isRich){let L=new Blob([F.content],{type:"text/html"}),N=document.createElement("div");N.style.whiteSpace="pre-wrap",N.innerHTML=F.content;let B=new Blob([N.innerText],{type:"text/plain"}),U=[new ClipboardItem({"text/html":L,"text/plain":B})];navigator.clipboard.write(U)}else navigator.clipboard.writeText(F.content);Y("Copiado!")},f.querySelector(".cw-act-edit").onclick=O=>{O.stopPropagation(),G.playClick(),T(F)},f.querySelector(".cw-act-del").onclick=async O=>{O.stopPropagation(),G.playClick(),await be("Excluir este item?")&&(he.delete(F.id),K(),Y("Item exclu\xEDdo."))},b.appendChild(f)})}function T(v=null){n=v?v.id:null,w.innerHTML="",w.appendChild(M("title","T\xEDtulo / Nome",v?v.title:"")),o==="email"&&w.appendChild(M("subject","Assunto do Email",v?v.subject:""));let F="Conte\xFAdo";o==="email"&&(F="Corpo do Email (HTML)"),o==="note"&&(F="Texto da Nota (Reason)"),w.appendChild(M("content",F,v?v.content:"",{isRich:!0,isCode:v?v.isCode:!1})),u.querySelector("span").textContent=v?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let f=w.querySelector("input");f&&f.focus()},300)}function A(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function q(){let v=w.querySelector("#cw-inp-title"),F=w.querySelector("#cw-inp-content"),f=v.value.trim(),E=F.contentEditable==="true"?F.innerHTML:F.value.trim(),O=F.getAttribute("data-is-code")==="true";if(!f||!E||E==="<br>"){Y("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let L={id:n,type:o,title:f,content:E,isCode:O,isRich:F.contentEditable==="true"};if(o==="email"){let N=w.querySelector("#cw-inp-subject").value.trim();if(!N){Y("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}L.subject=N}z.textContent="Salvando...",await he.save(L),z.textContent="Salvar",A(),K(),Y("Salvo com sucesso!"),G.playSuccess()}function M(v,F,f,E={}){let O=document.createElement("div");Object.assign(O.style,s.inputGroup);let L=document.createElement("label");L.textContent=F,Object.assign(L.style,s.label);let N;if(E.isRich){let B=document.createElement("div");B.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",B.innerHTML=`
    ...
    `;let d=l.querySelector("#cw-config-sound-toggle");d.onchange=x=>{G.setMuted(!x.target.checked),x.target.checked&&G.playClick()},r.appendChild(l);let c=document.createElement("div");c.className="cw-configs-section",c.innerHTML=`
    ...
    `,r.appendChild(c);function p(){e=!e,ue(e,n,"cw-btn-configs"),e&&G.playClick()}return document.body.appendChild(n),p}var re={blue:"#1A73E8",red:"#D93025",yellow:"#F9AB00",green:"#1E8E3E",blueLight:"#E8F0FE",redLight:"#FCE8E6",yellowLight:"#FEF7E0",greenLight:"#E6F4EA",textPrimary:"#202124",textSecondary:"#5F6368",border:"#DADCE0",surface:"rgba(255, 255, 255, 0.8)",white:"#FFFFFF"},Ue={small:"8px",medium:"12px",large:"16px",pill:"100px"},qo={deep:"0 12px 40px rgba(0,0,0,0.12)",subtle:"0 4px 12px rgba(0,0,0,0.05)"},aa="cubic-bezier(0.4, 0, 0.2, 1)",yt=`all 0.2s ${aa}`,_o=()=>{if(document.getElementById("bau-form-global-styles"))return;let t=document.createElement("style");t.id="bau-form-global-styles",t.innerHTML=`
    .bau-popup {
      display: flex !important;
      flex-direction: column !important;
      width: 480px !important;
      max-height: 85vh !important;
      background: ${re.surface} !important;
    ...
    .bau-title {
      ...
      font-weight: 700;
      margin: 0;
      color: ${re.textPrimary};
    }

    .bau-subtitle {
      font-size: 13px;
      color: ${re.textSecondary};
      margin: 4px 0 12px 0;
    }
    ...
    .bau-accordion-btn:hover { background: ${re.blueLight}; color: ${re.blue}; border-color: ${re.blue}; }
  ...
  `,document.head.appendChild(t)};function Mo(){_o();let t=!1,e=document.createElement("div");e.id="bau-form-popup",e.className="bau-popup cw-module-window",e.style.display="none";let a=pe(e,"BAU Form","v1.0.0","Solicite a abertura de casos BAU rapidamente.",{googleLine:null},()=>K());e.appendChild(a);let n=document.createElement("div");n.className="bau-content",e.appendChild(n);let i=document.createElement("form");n.appendChild(i);let s=document.createElement("div");s.className="bau-card";let r=document.createElement("div");r.className="bau-header-banner",r.innerHTML="<span>\u26A0\uFE0F</span> Verifique os dados capturados do CRM",s.appendChild(r);let l=document.createElement("div");l.innerHTML=`
    ...
    `,s.appendChild(l),i.appendChild(s);let d=document.createElement("div");d.className="bau-card bau-fallback-card",d.innerHTML=`
    ...
    `,i.appendChild(d);let c=document.createElement("div");c.className="bau-card";let p=document.createElement("label");p.className="bau-label",p.textContent="A\xE7\xF5es R\xE1pidas (Preenche Motivo e Task)",c.appendChild(p);let x=document.createElement("div");x.className="bau-chips-container",[{id:"gtm",text:"\u{1F680} Instala\xE7\xE3o GTM",reason:"Nova Implementa\xE7\xE3o",task:"Setup GTM"},{id:"ecw4",text:"\u{1F6D2} ECW4 Purchase",reason:"Nova Implementa\xE7\xE3o",task:"Google Ads Conversion"},{id:"consent",text:"\u{1F6E1}\uFE0F Consent Mode",reason:"Corre\xE7\xE3o de Tag",task:"GA4 Events"}].forEach(T=>{let A=document.createElement("div");A.className="bau-chip",A.textContent=T.text,A.dataset.id=T.id,A.onclick=()=>{x.querySelectorAll(".bau-chip").forEach(I=>I.classList.remove("active")),A.classList.add("active"),G.playClick();let q=i.querySelector('select[name="reason"]'),M=i.querySelector('select[name="taskType"]');q&&(q.value=T.reason),M&&(M.value=T.task)},x.appendChild(A)}),c.appendChild(x);let g=document.createElement("div");g.className="bau-grid-2",g.style.marginTop="16px",g.innerHTML=`
        <div>
    ...
    `,c.appendChild(g);let u=document.createElement("label");u.className="bau-label",u.textContent="Justificativa / Descri\xE7\xE3o",u.style.marginTop="16px",c.appendChild(u);let y=document.createElement("textarea");y.name="description",y.required=!0,y.className="bau-textarea",y.placeholder="Descreva detalhadamente o que precisa ser feito...",y.style.minHeight="100px",c.appendChild(y);let w=document.createElement("label");w.className="bau-label",w.textContent="Disponibilidade do Anunciante",w.style.marginTop="16px",c.appendChild(w);let D=document.createElement("input");D.type="datetime-local",D.name="availability",D.required=!0,D.className="bau-input",c.appendChild(D),i.appendChild(c);let z=document.createElement("div");z.className="bau-footer";let _=document.createElement("button");_.type="submit",_.className="bau-btn-submit",_.innerHTML="<span>\u26A1</span> Enviar para o TL abrir o Caso",z.appendChild(_),i.appendChild(z),document.body.appendChild(e);function Z(){let T=ye();if(T){document.getElementById("bau-adv-name").textContent=T.advName||"Anunciante Desconhecido",document.getElementById("bau-adv-details").textContent=`CID: ${T.cid||"N/A"} \u2022 AM: ${T.amName||"N/A"}`;let A=i.querySelector('input[name="timezone"]'),q=i.querySelector('input[name="site"]');T.timezone&&(A.value=T.timezone,d.style.display="none"),T.site&&(q.value=T.site,d.style.display="none"),(!T.timezone||!T.site)&&(d.style.display="block")}}i.onsubmit=async T=>{T.preventDefault();let A=new FormData(i),q=Object.fromEntries(A.entries()),M=ye()||{},I={caseId:M.caseId||"",cid:M.cid||"",seId:M.seId||"",advName:M.advName||"",email:M.email||"",language:M.language||"",amName:M.amName||"",salesProgram:M.salesProgram||"",site:q.site||M.site||"",timezone:q.timezone||M.timezone||"",reason:q.reason,taskType:q.taskType,description:q.description,availability:q.availability},k=_.innerHTML;_.disabled=!0,_.innerHTML="Carregando...";try{await io(I,M.agentEmail||"anon"),G.playSuccess(),Y("Escalonamento enviado com sucesso!","success"),i.reset(),x.querySelectorAll(".bau-chip.active").forEach(v=>v.classList.remove("active")),K()}catch(v){console.error("Erro BAU:",v),Y("Falha ao enviar: "+(v.message||"Erro desconhecido"),"error")}finally{_.disabled=!1,_.innerHTML=k}};function K(){t=!t,t&&(e.style.display="flex",Z()),ue(t,e,"cw-btn-bauform")}return K}function na(){if(window.techSolInitialized){Ct();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Pt();try{G.initGlobalListeners(),G.playStartup()}catch(c){console.warn("\xC1udio bloqueado:",c)}fe.fetchTips(),Ct();let e=fo(),o=yo(),a=wo(),n=Co(),i=Oo(),s=Io(),r=Lo(),l=Mo(),d=Eo();so({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:l,broadcastControl:d}),setTimeout(()=>{fe.logEvent("App","Start","Session Start"),Ao(),setTimeout(()=>{ko(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),Y("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}na();})();
