...
CID: ${p.cid||"---"}
Case ID: ${p.caseId||"---"}
E-mail: ${p.clientEmail||"---"}`;w&&(w.value=v),k&&(k.classList.add("visible"),k.scrollIntoView({behavior:"smooth",block:"end"}))})}function d(){a=!a,ye(a,i,"cw-btn-script"),a?(me(),c(),s||(s=setInterval(c,2e3))):(ge(),s&&(clearInterval(s),s=null))}let y=xe(i,"Call Script",e,"Guia interativo para condu\xE7\xE3o de chamadas.",r,()=>{d()});i.appendChild(y);let b=document.createElement("div");b.className="csa-context-banner",b.innerHTML=`
...
`),n=/\d{1,2}\/\d{1,2}/,a="\u{1F4C5}";if(o.forEach(i=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(i)?a="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(i)&&(a="\u{1F1EA}\u{1F1F8}");let r=i.match(n);if(r){let s=r[0],c=a;/🇧🇷|🇵🇹|PT|BR/i.test(i)?c="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(i)&&(c="\u{1F1EA}\u{1F1F8}"),t.some(d=>d.flag===c&&d.date===s)||t.push({flag:c,date:s})}}),t.length===0){let i=(e||"").match(/\d{1,2}\/\d{1,2}/g);i&&[...new Set(i)].forEach(r=>t.push({flag:"\u{1F4C5}",date:r}))}return t}function Zo(){let e="v4.9",t=!1,o=null,n=null,a="",i=!1,r=!1,s=null,c=0,u=null;Za();let d=document.createElement("div");d.id="broadcast-popup",d.classList.add("cw-module-window"),Object.assign(d.style,Ee,{right:"auto",left:"50%",width:"420px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",backgroundColor:"#FAFAFA",overflow:"hidden"});let y={popup:d,googleLine:null};function b(){if(t=!t,ye(t,d,"cw-btn-broadcast"),t){me();let F=document.getElementById("cw-btn-broadcast");F&&F.classList.remove("has-new"),L()}else ge()}let E=xe(d,"Central de Avisos",e,"Comunica\xE7\xE3o oficial da opera\xE7\xE3o.",y,()=>b()),S=E.querySelector(".cw-header-actions")||E.lastElementChild,g=null;function x(){let F=null;try{F=he()}catch{console.warn("TechSol: Auth Pending")}if(F){if(s=F.split("@")[0].toLowerCase(),r=wt.includes(s),r&&S&&!S.querySelector("#cw-admin-btn")){let l=document.createElement("div");l.id="cw-admin-btn",l.className="cw-btn-interactive",l.innerHTML='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',Object.assign(l.style,{width:"32px",height:"32px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#1a73e8",background:"rgba(26, 115, 232, 0.1)",marginRight:"8px"}),l.title="Novo Aviso",l.onclick=h=>{h.stopPropagation(),I()},S.insertBefore(l,S.firstChild),g||K(),Q()}}else c<5&&(c++,setTimeout(x,2e3))}if(S){let F=document.createElement("button");F.textContent="Limpar",F.className="cw-btn-interactive",Object.assign(F.style,{fontSize:"12px",color:"#1a73e8",background:"transparent",border:"none",padding:"8px",fontWeight:"600"}),F.onclick=l=>{l.stopPropagation(),C.playSuccess();let h=He.map(p=>p.id);localStorage.setItem("cw_read_broadcasts",JSON.stringify(h)),Q(),R()},S.insertBefore(F,S.firstChild)}d.appendChild(E);let O=document.createElement("div");O.className="cw-bc-search-wrap";let N=document.createElement("div");N.className="cw-bc-search-icon",N.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let M=document.createElement("input");M.className="cw-bc-search-input no-drag",M.type="text",M.placeholder="Buscar avisos...";let D=document.createElement("div");D.className="cw-bc-search-clear cw-btn-interactive",D.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',O.append(N,M,D),d.appendChild(O),M.addEventListener("input",F=>{a=F.target.value,D.classList.toggle("visible",a.length>0),Q()}),D.onclick=()=>{M.value="",a="",D.classList.remove("visible"),Q(),M.focus()};let G=document.createElement("div");G.id="cw-update-status",G.style.cssText="padding: 8px; text-align: center; font-size: 11px; color: #5f6368; background: #FAFAFA; border-bottom: 1px solid transparent; font-weight:500; display:none;",d.appendChild(G);function K(){g=document.createElement("div"),g.className="cw-editor-overlay",g.innerHTML=`
    ...
    `,document.head.appendChild(e)}function ra(){let e="v2.0",t=!1,o="general",n="",a=null,i=null;rn();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,Ee,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let c=xe(r,"Minha Biblioteca",e,"Gerencie seus snippets, textos e templates.",{popup:r},()=>l());r.appendChild(c);let u=document.createElement("div");u.className="cw-lib-container",r.appendChild(u);let d=document.createElement("div");d.className="cw-lib-toolbar";let y=document.createElement("div");y.className="cw-lib-search-wrap";let b=document.createElement("div");b.className="cw-lib-search-icon",b.innerHTML=we.search;let E=document.createElement("input");E.className="cw-lib-search no-drag",E.placeholder="Buscar por t\xEDtulo ou conte\xFAdo...",E.type="text";let S=document.createElement("div");S.className="cw-lib-search-clear cw-tactile",S.innerHTML=we.clear,y.append(b,E,S);let g=document.createElement("div");g.className="cw-lib-tabs",na.forEach(h=>{let p=document.createElement("div");p.className="cw-lib-tab"+(h.id===o?" active":""),p.id=`lib-tab-${h.id}`,p.innerHTML=`${h.icon}<span>${h.label}</span>`,p.onmouseenter=()=>C.playHover(),p.onclick=()=>L(h.id),g.appendChild(p)}),d.append(y,g),u.appendChild(d);let x=document.createElement("div");x.className="cw-lib-grid",u.appendChild(x);let O=document.createElement("div");O.className="cw-lib-fab cw-tactile",O.title="Novo item",O.innerHTML=we.add,O.onclick=()=>j(),u.appendChild(O);let N=document.createElement("div");N.className="cw-lib-sheet";let M=document.createElement("div");M.className="cw-lib-sheet-handle";let D=document.createElement("div");D.className="cw-lib-sheet-head";let G=document.createElement("div");G.className="cw-lib-sheet-back no-drag",G.innerHTML=we.back,G.title="Cancelar",G.onclick=te;let K=document.createElement("span");K.className="cw-lib-sheet-title",K.textContent="Novo Item",D.append(G,K);let I=document.createElement("div");I.className="cw-lib-sheet-body";let q=document.createElement("div");q.className="cw-lib-sheet-foot";let z=document.createElement("button");z.className="cw-lib-save-btn no-drag",z.textContent="Salvar",z.onclick=X,q.appendChild(z);let $=document.createElement("div");$.className="cw-lib-loading",$.innerHTML='<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text">Salvando...</div>',N.append(M,D,I,q,$),u.appendChild(N);let H=document.createElement("div");Object.assign(H.style,De),H.className="no-drag",r.appendChild(H),_e(r,H),document.body.appendChild(r),document.addEventListener("mousedown",h=>{i&&!i.contains(h.target)&&R()});function L(h){C.playClick(),o=h,na.forEach(p=>{document.getElementById(`lib-tab-${p.id}`).classList.toggle("active",p.id===h)}),ae()}function R(){if(i){let h=i.querySelector(".cw-lib-menu");h&&h.classList.remove("open"),i.classList.remove("menu-open"),i=null}}function ee(h,p){return p?`${h.title} ${h.content}`.toLowerCase().includes(p):!0}function oe(h){let p=document.createElement("div");p.className="cw-lib-recent-section",p.innerHTML='<div class="cw-lib-recent-title">\u{1F552} Usados recentemente</div>';let f=document.createElement("div");return f.className="cw-lib-recent-row",h.forEach(w=>{let k=document.createElement("div");k.className="cw-lib-recent-chip",k.tabIndex=0,k.setAttribute("role","button"),k.title=w.title,k.innerHTML=`<span>${F(w.title)}</span>`,k.onclick=()=>{C.playClick(),J(w)},k.addEventListener("keydown",v=>{(v.key==="Enter"||v.key===" ")&&(v.preventDefault(),k.click())}),f.appendChild(k)}),p.appendChild(f),p}function ae(){R(),x.innerHTML="";let h=n.trim().toLowerCase(),p=ve.getSnippets(o).filter(f=>ee(f,h));if(!h){let f=nn(o);f.length>0&&x.appendChild(oe(f))}if(p.length===0){let f=document.createElement("div");f.className="cw-lib-empty";let w=h.length>0;f.innerHTML=`
        ...
        `,(async()=>{try{he()||await ot();let S=he(),g=S?S.split("@")[0]:"user",x=await lt(g);if(!x){c.innerHTML=`
  ...
  `,document.head.appendChild(e)};var Xe={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var be={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function la(e){switch(e){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:e||"Pendente",class:"status-gray",aura:""}}}function da(e){let t=document.createElement("div");if(t.className="bau-dynamic-input",t.id=`wrapper-${e.id}`,e.label){let n=document.createElement("label");n.className="bau-label",n.textContent=e.label,e.tooltip&&n.setAttribute("data-tooltip",e.tooltip),t.appendChild(n)}let o;switch(e.type){case"textarea":o=document.createElement("textarea"),o.style.minHeight="80px",t.appendChild(o);break;case"select":o=document.createElement("select"),e.groups?e.groups.forEach(r=>{let s=document.createElement("optgroup");s.label=r.label,r.options.forEach(c=>{let u=document.createElement("option");u.value=c.value,u.textContent=c.text,s.appendChild(u)}),o.appendChild(s)}):e.options&&e.options.forEach(r=>{let s=document.createElement("option");s.value=r.value,s.textContent=r.text,o.appendChild(s)}),t.appendChild(o);break;case"checkbox-grid":return o=document.createElement("div"),o.className="bau-tasks-grid",e.options.forEach(r=>{let s=document.createElement("label");s.className="bau-task-item",s.innerHTML=`<input type="checkbox" name="${e.name}" value="${r}"><span>${r}</span>`,s.addEventListener("click",c=>{c.preventDefault();let u=s.querySelector("input");u.checked=!u.checked,s.classList.toggle("active",u.checked),C.playClick()}),o.appendChild(s)}),t.appendChild(o),t;case"datetime-group":o=document.createElement("div"),o.className="bau-availability-container",e.fields.forEach(r=>{let s=document.createElement("div");s.className="bau-availability-field",s.innerHTML=`
    ...
    `,d.appendChild(q),document.body.appendChild(c);function z(l){t=l,c.querySelectorAll(".bau-view").forEach(k=>k.classList.remove("active"));let h=c.querySelector(`#bau-view-${l}`);h&&h.classList.add("active");let p=u.querySelector(".cw-module-header-title")||u.querySelector("h2"),f=u.querySelector(".cw-module-header-subtitle")||u.querySelector("p");p&&(l==="form"?p.textContent=i?`Editando Caso #${r}`:"Novo Caso BAU":p.textContent="BAU Central"),f&&(f.textContent=l==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU");let w=M.querySelector(".bau-btn-submit");w&&(w.innerHTML=i?`${be.send} Salvar Altera\xE7\xF5es`:`${be.send} Enviar para o TL`)}function $(){let l=c.querySelector("#bau-case-list-container"),h=c.querySelector("#bau-dashboard-metrics");h&&(h.innerHTML=`
        ...
        `;let v=p.querySelector("#bau-refresh-dashboard");v?.addEventListener("click",async()=>{v.classList.contains("spinning")||(v.classList.add("spinning"),C.playClick(),await H(),setTimeout(()=>v.classList.remove("spinning"),1e3))}),h.innerHTML="";let m=f.slice(0,5),A=f.slice(5);if(m.forEach(T=>{let P=R(T),_=document.createElement("div");_.innerHTML=P;let Y=_.firstElementChild;Y.addEventListener("click",se=>{se.target.closest(".bau-case-edit-btn")||L(T)});let W=Y.querySelector(".bau-case-edit-btn");W&&(W.onclick=se=>{se.stopPropagation(),X(T)}),h.appendChild(Y)}),A.length>0){let T=document.createElement("li");T.className="bau-accordion-container";let P=document.createElement("button");P.className="bau-accordion-toggle",P.innerHTML=`${be.expand} <span>Mostrar ${A.length} casos mais antigos</span>`;let _=document.createElement("ul");_.className="bau-case-list bau-accordion-content",_.style.display="none",A.forEach(Y=>{let W=R(Y),se=document.createElement("div");se.innerHTML=W;let ue=se.firstElementChild;ue.addEventListener("click",Fe=>{Fe.target.closest(".bau-case-edit-btn")||L(Y)});let Te=ue.querySelector(".bau-case-edit-btn");Te&&(Te.onclick=Fe=>{Fe.stopPropagation(),X(Y)}),_.appendChild(ue)}),P.addEventListener("click",()=>{let Y=_.style.display==="none";_.style.display=Y?"block":"none",P.classList.toggle("expanded",Y),P.querySelector("span").textContent=Y?"Esconder casos mais antigos":`Mostrar ${A.length} casos mais antigos`,C.playClick()}),T.appendChild(P),T.appendChild(_),h.appendChild(T)}}function oe(){let l=a==="BAU"?[1,2,3,4]:[5,4];M.querySelectorAll(".bau-step").forEach(f=>{let w=parseInt(f.id.replace("bau-step-","")),k=w===n,v=l.includes(w)||w===0;f.classList.toggle("active",k),f.style.display=k?"block":"none",f.querySelectorAll("input, select, textarea").forEach(m=>{m.disabled=!v})});let h=n===0;if(N.style.display=h?"none":"flex",!h){N.innerHTML="";let f=a==="BAU"?[1,2,3,4]:[5,4];f.forEach((w,k)=>{let v=document.createElement("div"),m=w===n,A=f.indexOf(n),T=k<A;v.className=`bau-progress-step ${m?"active":T?"completed":""}`,v.textContent=k+1,N.appendChild(v)})}let p=n===4;G.style.display=n>0?"inline-block":"none",K.style.display=!h&&!p?"inline-block":"none",I.style.display=p?"flex":"none",p&&te()}function ae(l){let h=Xe.steps.find(p=>p.id===l);if(!h||!h.fields||h.isConfirmation)return!0;for(let p of h.fields){let f=M.querySelector(`#bau-step-${l} #wrapper-${p.id}`);if(!(f&&f.style.display==="none")&&p.validation){let w=M.querySelector(`#bau-step-${l} [name="${p.name}"]`);if(w&&w.offsetParent!==null&&w.value.trim())if(new RegExp(p.validation.regex).test(w.value.trim())){w.classList.remove("invalid-cid");let v=M.querySelector("#bau-cid-error");v&&(v.style.display="none")}else{console.warn(`Validation failed for field "${p.name}" in step ${l}: Regex mismatch.`),C.playError(),U(`Erro: ${p.validation.error}`,{error:!0}),w.classList.add("invalid-cid");let v=M.querySelector("#bau-cid-error");return v&&(v.style.display="flex"),!1}}}return!0}function Q(l){if(!M.querySelector(`#bau-step-${l}`))return!1;let p=Xe.steps.find(w=>w.id===l);if(!p||!p.fields||p.isConfirmation)return!0;let f=!0;for(let w of p.fields){let k=M.querySelector(`#bau-step-${l} #wrapper-${w.id}`);if(!(k&&k.style.display==="none")&&w.required){let v=!0,m="";if(w.type==="checkbox-grid")M.querySelector(`#bau-step-${l} input[name="${w.name}"]:checked`)||(m="No option selected in checkbox-grid",C.playError(),U(`Erro: Selecione pelo menos uma op\xE7\xE3o para "${w.label}".`,{error:!0}),v=!1);else if(w.type==="datetime-group"){let A=M.querySelector(`#bau-step-${l} input[name="${w.fields[0].name}"]`);if(!A||A.offsetParent===null)continue;A.value.trim()||(m="Datetime group first field is empty",C.playError(),U(`Erro: O campo "${w.fields[0].label}" \xE9 obrigat\xF3rio.`,{error:!0}),v=!1)}else{let A=M.querySelector(`#bau-step-${l} [name="${w.name}"]`);if(!A||A.offsetParent===null)continue;A.value.trim()||(m="Field is empty",C.playError(),U(`Erro: O campo '${w.label}' \xE9 obrigat\xF3rio.`,{error:!0}),v=!1)}if(!v){console.warn(`Validation failed for required field "${w.name}" in step ${l}: ${m}`),f=!1;break}}}return f}K.addEventListener("click",()=>{if(ae(n)&&Q(n)){a==="BAU"?n++:n===5?n=4:n++,oe();let l=c.querySelector(".bau-content");l&&(l.scrollTop=0),C.playClick()}}),G.addEventListener("click",()=>{n>0&&(a==="BAU"?n--:n===4?n=5:n===5?n=0:n--,oe(),C.playClick())});async function J(){let l=await Ne()||{};(!l.amName||l.amName==="N/A")&&(l.amName=l.internalEmail||"N/A"),o=l,M.querySelectorAll(".bau-vital-highlights").forEach(f=>{let w=[{label:"Anunciante",value:l.advName},{label:"CID",value:l.cid},{label:"Website",value:l.website||l.site},{label:"Case ID",value:l.caseId}];f.innerHTML=w.map(k=>{let v=k.value&&k.value!=="N/A"&&k.value!=="undefined"&&k.value!=="null"?k.value:"N\xE3o capturado";return`
            ...
            `})}c.querySelector("#bau-top-se-search")?.addEventListener("click",l=>{l.preventDefault(),xt("bau-form-seId")});let j=c.querySelector("#bau-form-cid");j&&j.addEventListener("input",()=>ae(1));function te(){let l=new FormData(M),h=Object.fromEntries(l.entries()),p=c.querySelector("#bau-confirmation-details");if(p){if(a==="BAU"){let f=l.getAll("taskType"),w=f.length>0?f.join(", "):"Nenhuma";p.innerHTML=`
