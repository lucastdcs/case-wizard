(()=>{var ho={production:"AKfycbxkheuq28ENsHMZMH8t9-u4EIrktHC6cBi-87boDre0jJfl1lnSCPBzaEkw6hy3Cx6fAg",development:"AKfycbyUtczRMulDAyO_1ku39Rb01zarPMw1JvO7aNOdJPYeAgCC7G9mmb-P_EuXP6kvo8l2LA"},na="development",Pi=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",vo=ho[na]||ho.development,Na=Pi?"dev":"exec",Gi=`https://script.google.com/a/macros/google.com/s/${vo}/${Na}`,yo=vo.slice(-6);function Rt(){return{env:na,isDev:na!=="production",endpoint:Na,fingerprint:yo}}console.log(`[Case Wizard] backend: ${na}/${Na} \xB7 implanta\xE7\xE3o \u2026${yo}`);var ji="cw_data_broadcast",Hi="cw_data_tips",xo="cw_content_",Ui=["Processando...","Mantenha o foco!","Aguarde..."];function Ke(e,t={}){return new Promise((a,o)=>{let n="cw_cb_"+Math.round(1e5*Math.random()),i=document.createElement("script"),r=setTimeout(()=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],o(new Error("Timeout: A API demorou muito para responder. (Apps Script bloqueado ou erro 500)"))},15e3);window[n]=g=>{clearTimeout(r),document.body.contains(i)&&document.body.removeChild(i),delete window[n],a(g)};let l=Object.keys(t).map(g=>encodeURIComponent(g)+"="+encodeURIComponent(t[g])).join("&"),c=`${Gi}?op=${e}&callback=${n}&t=${Date.now()}&${l}`;i.src=c,i.onerror=()=>{clearTimeout(r),document.body.contains(i)&&document.body.removeChild(i),delete window[n],o(new Error("Erro de conex\xE3o JSONP."))},document.body.appendChild(i)})}var me={fetchTips:async()=>{try{await me.fetchContentModule("tips")}catch(e){console.warn("Tips offline",e)}},getCachedBroadcasts:()=>{try{return JSON.parse(localStorage.getItem(ji)||"[]")}catch{return[]}},fetchContentModule:async e=>{let t=`${xo}${e}`;try{let a=await Ke("content_public",{module:e});if(a?.status==="success"&&Array.isArray(a.items))return localStorage.setItem(t,JSON.stringify(a.items)),a.items}catch(a){console.warn(`Conte\xFAdo '${e}' offline`,a)}return me.getCachedContent(e)},getCachedContent:e=>{try{return JSON.parse(localStorage.getItem(`${xo}${e}`)||"null")}catch{return null}},getRandomTip:()=>{let e=null,t=me.getCachedContent("tips");if(Array.isArray(t)&&t.length&&(e=t.map(a=>a.value).filter(Boolean)),!e||!e.length){let a=localStorage.getItem(Hi);if(a)try{e=JSON.parse(a)}catch{}}return(!Array.isArray(e)||!e.length)&&(e=Ui),e[Math.floor(Math.random()*e.length)]},logEvent:(e,t,a="",o=null)=>{try{let n="anon";try{let r=Le();r&&(n=r.split("@")[0].toLowerCase())}catch{}let i={timestamp:new Date().toISOString(),user:n,version:"v5.1",category:e,action:t,label:a,value:o||""};Ke("log",i).catch(r=>{})}catch(n){console.warn("Analytics error",n)}},logUsage:()=>{},sendBAUEscalation:async(e,t)=>{let a={...e,user:t,date:new Date().toISOString()};try{console.log("Executando create_bau...",a);let o=await Ke("create_bau",a);if(o&&o.status==="success")return console.log("Sucesso: create_bau"),o;throw new Error(o?.error||o?.message||"Falha na opera\xE7\xE3o BAU")}catch(o){throw console.error("Erro JSONP (BAU):",o),o}},readAgentBAU:async()=>{let e=Le();if(!e)return console.warn("Email n\xE3o encontrado. N\xE3o foi poss\xEDvel buscar casos BAU."),[];try{console.log("Buscando casos BAU para:",e);let t=await Ke("read_agent_bau",{user:e});if(t&&t.status==="success"&&Array.isArray(t.cases))return t.cases;if(t&&t.status==="error")throw new Error(t.message||"Erro retornado pela API de leitura");return[]}catch(t){throw console.error("Erro ao buscar casos BAU:",t),t}},updateBAUStatus:async(e,t,a={})=>{let o=Le();try{console.log(`Atualizando status BAU ${e} para ${t}...`);let n=await Ke("update_bau_status",{id:e,status:t,user:o,...a});return n&&n.status==="success"}catch(n){return console.error("Erro ao atualizar status BAU:",n),!1}},updateBAUEscalation:async(e,t)=>{let a=Le(),o={...t,id:e,user:a,date_edited:new Date().toISOString()};try{console.log(`Executando update_bau para ${e}...`,o);let n=await Ke("update_bau",o);if(n&&n.status==="success")return console.log("Sucesso: update_bau"),n;throw new Error(n?.error||n?.message||"Falha na atualiza\xE7\xE3o BAU")}catch(n){throw console.error("Erro JSONP (Update BAU):",n),n}},fetchUserProfile:async e=>{try{console.log(`Buscando perfil para: ${e}`);let t=await Ke("get_user_profile",{ldap:e});return console.log("Resposta bruta do servidor:",t),t&&t.status==="success"&&t.profile?t.profile:null}catch(t){return console.error("Erro ao buscar perfil:",t),null}},getUserSnippets:async e=>{try{return console.log("Buscando snippets para:",e),await Ke("get_user_snippets",{user:e})}catch(t){return console.error("Erro ao carregar snippets:",t),{status:"error",snippets:[]}}},saveSnippet:async(e,t)=>{let a={id:e.id,type:e.type,title:e.title,content:e.content,subject:e.subject||"",isCode:e.isCode,isRich:e.isRich,user:t};try{console.log("Salvando snippet na nuvem:",a);let o=await Ke("save_snippet",a);return o&&o.status==="success"}catch(o){return console.error("Erro ao salvar snippet:",o),!1}},deleteSnippet:async(e,t)=>{try{console.log(`Deletando snippet ${e}...`);let a=await Ke("delete_snippet",{id:e,user:t});return a&&a.status==="success"}catch(a){return console.error("Erro ao deletar snippet:",a),!1}},getUserPrefs:async e=>{try{let t=await Ke("get_user_prefs",{user:e});return t&&t.status==="success"?t.prefs||{}:null}catch(t){return console.warn("Erro ao carregar prefer\xEAncias:",t),null}},saveUserPrefs:async(e,t)=>{try{let a=await Ke("save_user_prefs",{user:t,prefs:JSON.stringify(e||{})});return!!(a&&a.status==="success")}catch(a){return console.warn("Erro ao salvar prefer\xEAncias:",a),!1}}},wo=me.sendBAUEscalation,So=me.readAgentBAU,hs=me.updateBAUStatus,Eo=me.updateBAUEscalation,Tt=me.fetchUserProfile,xs=me.getUserSnippets,vs=me.saveSnippet,ys=me.deleteSnippet,ws=me.getUserPrefs,Ss=me.saveUserPrefs;var ue=e=>new Promise(t=>setTimeout(t,e));function Pe(e){if(!e)return;let t={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(a=>e.dispatchEvent(new MouseEvent(a,t)))}function Lt(e){e&&["mousedown","mouseup","click"].forEach(t=>e.dispatchEvent(new MouseEvent(t,{bubbles:!0,cancelable:!0,view:window})))}function St(e,t,a){return Math.max(t,Math.min(e,a))}var $t=0,qt=0;function ke(){if($t===0&&(qt=window.innerWidth-document.documentElement.clientWidth,qt>0)){let e=parseFloat(getComputedStyle(document.body).paddingRight)||0;document.body.style.paddingRight=`${e+qt}px`}$t++,document.body.style.overflow="hidden"}function Te(){if($t=Math.max(0,$t-1),$t===0&&(document.body.style.overflow="",qt>0)){let e=parseFloat(getComputedStyle(document.body).paddingRight)||0,t=Math.max(0,e-qt);document.body.style.paddingRight=t?`${t}px`:"",qt=0}}var Co=!1;function Vi(){if(Co||document.getElementById("cw-filled-check-styles"))return;let e=document.createElement("style");e.id="cw-filled-check-styles",e.textContent=`
    ...
    `,document.head.appendChild(e),Co=!0}var Ao=!1;function Wi(){if(Ao||document.getElementById("cw-empty-state-styles"))return;let e=document.createElement("style");e.id="cw-empty-state-styles",e.textContent=`
    ...
    `,document.head.appendChild(e),Ao=!0}function Bt({icon:e,title:t,subtitle:a="",size:o=88}){Wi();let n=document.createElement("div");return n.className="cw-empty-illustrated",n.innerHTML=`
...
@media (prefers-reduced-motion: reduce) {
    ...
    `,document.head.appendChild(t)}function X(e,t={}){let a=document.createElement("div"),o=t.error?"rgba(217, 48, 37, 0.90)":"rgba(32, 33, 36, 0.85)";Object.assign(a.style,{position:"fixed",bottom:"32px",left:"50%",transform:"translateX(-50%) scale(0.9)",background:o,backdropFilter:"blur(12px)",color:"#fff",padding:"12px 24px",borderRadius:"50px",boxShadow:"0 8px 24px rgba(0,0,0,0.15)",fontFamily:"'Google Sans', 'Roboto'",fontSize:"14px",fontWeight:"500",lineHeight:"20px",zIndex:String(Me.TOAST),opacity:"0",transition:"all 0.4s var(--cw-ease-spring)",pointerEvents:"none"}),a.textContent=e,document.body.appendChild(a),t.error?S.playError():S.playSuccess(),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateX(-50%) scale(1)"}),setTimeout(()=>{a.style.opacity="0",a.style.transform="translateX(-50%) scale(0.9) translateY(10px)",setTimeout(()=>a.remove(),400)},t.duration||4e3)}function Ro(e,t=null){let a=0,o=0,n=0,i=0,r=t||e;r.style.cursor="grab",r.onmousedown=l;function l(u){if(["INPUT","TEXTAREA","SELECT","BUTTON"].includes(u.target.tagName)||u.target.closest(".no-drag"))return;u=u||window.event,r.style.cursor="grabbing",e.style.transition="none";let v=e.getBoundingClientRect();e.style.transform="none",e.style.left=v.left+"px",e.style.top=v.top+"px",e.style.margin="0",e.style.bottom="auto",e.style.right="auto",za=Math.min(za+1,Me.MODULE_FOCUSED),e.style.zIndex=za,n=u.clientX,i=u.clientY,e.setAttribute("data-dragging","true"),document.onmouseup=g,document.onmousemove=c}function c(u){u=u||window.event,u.preventDefault(),a=n-u.clientX,o=i-u.clientY,n=u.clientX,i=u.clientY;let v=e.offsetTop-o,d=e.offsetLeft-a,p=16,_=window.innerWidth,w=window.innerHeight,E=e.offsetWidth,M=e.offsetHeight;d=St(d,p,_-E-p),v=St(v,p,w-M-p),e.style.top=v+"px",e.style.left=d+"px"}function g(){document.onmouseup=null,document.onmousemove=null,r.style.cursor="grab",setTimeout(()=>{e.style.transition="all 0.5s var(--cw-ease-decelerate), opacity 0.3s ease",e.setAttribute("data-dragging","false"),e.setAttribute("data-moved","true")},50)}}var Ge={position:"fixed",top:"50%",left:"50%",width:"400px",maxHeight:"85vh",zIndex:String(Me.MODULE_RESTING),overflow:"hidden",backgroundColor:"rgba(255, 255, 255, 0.98)",backdropFilter:"blur(20px)",webkitBackdropFilter:"blur(20px)",borderRadius:"16px",boxShadow:`
    0 0 1px rgba(0,0,0,0.08),
    0 8px 24px rgba(0,0,0,0.12),
    0 20px 60px rgba(0,0,0,0.08)
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var Ra={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},$o={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Bo={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Do=!1;function rr(){if(Do||document.getElementById("techsol-google-styles"))return;let e=document.createElement("style");e.id="techsol-google-styles",e.innerHTML=`
    ...
    `,document.head.appendChild(e),Do=!0}function Po(e){rr(),e.classList.remove("google-animate-click"),e.offsetWidth,e.classList.add("google-animate-click"),setTimeout(()=>{e.classList.remove("google-animate-click")},600)}async function sr(e,t){if(!e)return;e.style.opacity="1",e.innerHTML='<span class="cursor">|</span>';let a=e.querySelector(".cursor");await ue(200);for(let o=0;o<t.length;o++){let n=t.charAt(o),i=document.createElement("span");i.textContent=n,a&&a.parentNode===e?a.before(i):e.appendChild(i);let r=Math.floor(Math.random()*60)+30;o===0&&(r=150),o>t.length-3&&(r=30),await ue(r)}await ue(600),a&&(a.style.display="none")}async function $a(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let t=document.createElement("style");t.id="google-splash-style",t.innerHTML=`
    ...
    `,document.body.appendChild(e),requestAnimationFrame(()=>e.style.opacity="1");try{await ue(200);let t=await jt(),a=qo(t),o=e.querySelector("#w-icon"),n=e.querySelector("#p1"),i=e.querySelector("#p2"),r=e.querySelector("#p3"),l=e.querySelector("#p-sextou");o&&(o.innerHTML=a.icon),n&&(n.textContent=a.prefix),r&&(r.textContent=a.suffix),await ue(300);let c=o?o.querySelector("svg"):null;if(c&&(c.style.opacity="1",c.style.transform="scale(1)"),await ue(400),n&&(n.style.opacity="1"),S.playStartup(),i&&await sr(i,a.name),r&&(r.style.opacity="1",r.style.transform="translateY(0)"),a.isFriday&&l){await ue(400),l.style.display="block",l.offsetWidth;let g=l.querySelector(".sextou-badge");g&&(g.style.opacity="1",g.style.transform="scale(1)")}await ue(1500)}catch(t){console.warn("Splash error, skipping...",t)}finally{e.classList.add("splash-exit"),await ue(900),e.parentNode&&e.parentNode.removeChild(e)}}function Go(e){if(!e)return;let t=e.getBoundingClientRect(),a=window.innerWidth,o=window.innerHeight,n=24,i=a-t.width-n,r=o-t.height-n,l=parseFloat(e.style.left)||t.left,c=parseFloat(e.style.top)||t.top,g=St(l,n,i),u=St(c,n,r);if(g!==l||u!==c){let v=e.style.transition;e.style.transition="left 0.3s var(--cw-ease-elastic), top 0.3s var(--cw-ease-elastic)",e.style.left=`${g}px`,e.style.top=`${u}px`,setTimeout(()=>{e.style.transition=v},300)}}var rt={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function st(e,t){t.onmousedown=a;function a(o){o.stopPropagation(),o.preventDefault();let n=e.style.transition;e.style.transition="none";let i=o.clientX,r=o.clientY,l=parseFloat(getComputedStyle(e,null).getPropertyValue("width").replace("px","")),c=parseFloat(getComputedStyle(e,null).getPropertyValue("height").replace("px","")),g=i,u=r,v=!1;function d(w){g=w.clientX,u=w.clientY,v||(window.requestAnimationFrame(()=>{p(),v=!1}),v=!0)}function p(){let w=l+(g-i),E=c+(u-r);w>360&&(e.style.width=w+"px"),E>300&&(e.style.height=E+"px")}function _(){document.removeEventListener("mousemove",d),document.removeEventListener("mouseup",_),setTimeout(()=>{e.style.transition=n},50)}document.addEventListener("mousemove",d),document.addEventListener("mouseup",_)}t.onmouseenter=()=>t.style.opacity="1",t.onmouseleave=()=>t.style.opacity="0.6"}function la(e){if(!e||e==="N/A"||e==="undefined")return"Data indispon\xEDvel";if(String(e).includes(" | "))return e.split(" | ").map(t=>la(t.trim())).filter(t=>t!=="Data indispon\xEDvel").join(" | ");try{let t=new Date(e);if(isNaN(t.getTime()))return"Data indispon\xEDvel";let a=t.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}),o=t.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"});return`${a} \xE0s ${o}`}catch{return"Data indispon\xEDvel"}}function jo(e){if(!e)return"";let t={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return e.replace(/:([a-zA-Z0-9-_+]+):/g,a=>t[a]?t[a]:"")}function Ho(){let e=document.createElement("div");return e.className="cw-dialog-overlay",Object.assign(e.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:Me.TOP,opacity:0,transition:"opacity 0.3s ease"}),e}function Uo(){let e=document.createElement("div");return Object.assign(e.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s var(--cw-ease-spring)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),e}function _e(e,t={}){return new Promise(a=>{let o=Ho(),n=Uo(),i=t.danger?"#FF3B30":"#007AFF",r=se()==="es"?"Eliminar":"Excluir",l=t.confirmText||(t.danger?r:"Confirmar");n.innerHTML=`
        ...
        `,o.appendChild(n),document.body.appendChild(o),requestAnimationFrame(()=>{o.style.opacity=1,n.style.transform="scale(1)"});let c=v=>{o.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{o.remove(),a(v)},300)},g=n.querySelector("#cw-conf-cancel"),u=n.querySelector("#cw-conf-ok");[g,u].forEach(v=>v.onmouseenter=()=>S.playHover()),g.onclick=()=>{S.playClick(),c(!1)},u.onclick=()=>{S.playClick(),c(!0)}})}function ca(e,t=""){return new Promise(a=>{let o=Ho(),n=Uo();n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let v=c.querySelector(".cw-hero-grid"),d=c.querySelector(".cw-acc-container"),p=c.querySelector(".cw-results-container"),_=c.querySelector(".cw-search-input");ia(c,".cw-acc-header, .cw-task-item");let w=c.querySelector(".cw-status-bar"),E=c.querySelector(".cw-status-text"),M=c.querySelector(".cw-footer-icons");function A(T,C){return I=>{if(I.target.closest(".cw-step-btn-hero, .cw-step-btn-list"))return;let k=o[T]?o[T].count:0;h(T,k>0?-k:1,C)}}i.forEach(([T,C])=>{let I=n(C.name),k=document.createElement("div");k.className="cw-hero-card",k.id=`hero-${T}`,k.style.setProperty("--hero-color",I.color),k.innerHTML=`
        ...
        `,k.tabIndex=0,k.setAttribute("role","button"),k.setAttribute("aria-expanded","false"),k.onclick=()=>{d.querySelectorAll(".cw-acc-group.open").forEach(z=>{z!==I&&(z.classList.remove("open"),z.querySelector(".cw-acc-header")?.setAttribute("aria-expanded","false"))});let j=I.classList.toggle("open");k.setAttribute("aria-expanded",String(j))},k.addEventListener("keydown",j=>{(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),k.click())});let F=document.createElement("div");F.className="cw-acc-body",C.tasks.forEach(j=>{let z=D(j.key,j);F.appendChild(z)}),I.appendChild(k),I.appendChild(F),d.appendChild(I)});function h(T,C,I){o[T]||(o[T]={count:0,data:I,brand:n(I.name)}),o[T].count+=C,o[T].count<=0&&delete o[T],q(),$(),e&&e()}function q(){i.forEach(([F])=>{let j=v.querySelector(`#hero-${F}`);if(!j)return;let z=o[F];z?(j.classList.add("active"),j.setAttribute("aria-pressed","true"),j.querySelector(".cw-step-val").textContent=z.count,j.querySelector(".cw-step-val").style.color=j.dataset.color,j.classList.toggle("ts-success",ja(F,a))):(j.classList.remove("active"),j.setAttribute("aria-pressed","false"),j.classList.remove("ts-success"))}),c.querySelectorAll(".cw-task-item").forEach(F=>{let j=F.dataset.id,z=o[j];z?(F.classList.add("selected"),F.setAttribute("aria-pressed","true"),F.querySelector(".cw-step-val").textContent=z.count,F.classList.toggle("ts-success",ja(j,a))):(F.classList.remove("selected"),F.setAttribute("aria-pressed","false"),F.classList.remove("ts-success"))});let C=Object.keys(o),I=0,k=[];if(C.forEach(F=>{let j=o[F];I+=j.count;for(let z=0;z<j.count;z++)k.length<6&&k.push(j.brand)}),I>0){w.classList.add("visible");let F=I>1?t("acoes_plural"):t("acao_singular"),j=I>1?t("definidas_plural"):t("definida_singular");E.textContent=`${I} ${F} ${j}`,M.innerHTML="",k.forEach(z=>{let K=document.createElement("div");K.className="cw-mini-icon-status",K.innerHTML=Ct[z.icon]||Ct.default;let ie=K.querySelector("svg");ie&&(ie.style.width="14px",ie.style.height="14px"),M.appendChild(K)})}else w.classList.remove("visible"),E.textContent="",M.innerHTML=""}_.addEventListener("input",T=>{let C=T.target.value.toLowerCase();if(C.length>0){d.style.display="none",p.style.display="block",p.innerHTML="";let I=!1;Object.entries(et).forEach(([k,F])=>{if(F.name.toLowerCase().includes(C)){I=!0;let j=D(k,F);o[k]&&(j.classList.add("selected"),j.setAttribute("aria-pressed","true"),j.querySelector(".cw-step-val").textContent=o[k].count),p.appendChild(j)}}),I||(p.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else d.style.display="block",p.style.display="none"});function $(){let T={};u.querySelectorAll(".cw-input-field").forEach(F=>{T[F.id]=F.value}),u.innerHTML="";let C=Object.keys(o),I=!1;if(C.length===0){u.appendChild(Bt({icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><path d="M21 15l-5-5L5 21"></path></svg>',title:t("selecione_tarefas")})),g.style.display="none";return}let k=document.createElement("div");k.className="cw-info-banner",k.innerHTML=`
            <span style="font-size:14px">\u2139\uFE0F</span>
            <span>
                Os screenshots seguem as diretrizes atuais do Win Criteria e pol\xEDticas de Tag Support.
            </span>
        `,u.appendChild(k),C.forEach(F=>{let j=o[F].data,z=o[F].count,K=o[F].brand,ie=ja(F,a),le=a.screenshotMode||"implementation",W=Xo(j,le,a.currentLang);if(W.length>0||ie){I=!0;for(let ee=1;ee<=z;ee++){let H=document.createElement("div");H.className="cw-screen-card",ie&&H.classList.add("ts-success"),H.style.setProperty("--brand-color",K.color),H.style.setProperty("--brand-bg",K.bg),H.style.setProperty("--brand-shadow",K.color+"40");let oe=document.createElement("div");oe.className="cw-card-header";let R=document.createElement("div");R.className="cw-card-icon",R.innerHTML=Ct[K.icon]||Ct.default;let J=document.createElement("div");J.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let te=document.createElement("input");te.className="cw-card-title-input",te.id=`name-${F}-${ee}`,te.value=`${j.name}${z>1?" #"+ee:""}`,te.title=t("renomear_tooltip");let V=document.createElement("span");if(V.className="cw-edit-hint",V.innerHTML=t("renomear_hint"),J.appendChild(te),J.appendChild(V),oe.appendChild(R),oe.appendChild(J),H.appendChild(oe),ie){let ae=document.createElement("div");ae.className="cw-ts-disclaimer-box",ae.innerHTML=`
                <span>${t("ts_disclaimer")}</span>
                <button class="cw-btn-ts-force">${t("incluir_mesmo_assim")}</button>
            `,ae.querySelector("button").onclick=()=>{a.toggleForcedScreenshot(F,!0)},H.appendChild(ae)}else W.forEach((ae,s)=>{let y=document.createElement("div");y.className="cw-input-group";let L=document.createElement("label");L.className="cw-input-label",L.textContent=ae;let b=document.createElement("input");b.className="cw-input-field",b.id=`screen-${F}-${ee}-${s}`,b.placeholder=t("cole_link_placeholder"),b.setAttribute("autocomplete","off"),T[b.id]&&(b.value=T[b.id],b.value.trim().length>5&&b.classList.add("filled")),b.addEventListener("input",()=>{b.value.trim().length>5?b.classList.add("filled"):b.classList.remove("filled")});let f=document.createElement("div");f.className="cw-input-check",f.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',y.appendChild(L),y.appendChild(b),y.appendChild(f),H.appendChild(y)});u.appendChild(H)}}}),g.style.display=I?"block":"none"}return{selectionElement:c,screenshotsElement:g,updateSubStatus:()=>$(),getCheckedElements:()=>Object.keys(o).map(T=>({value:T,count:o[T].count})),setTaskCount:(T,C)=>{o[T]&&delete o[T],C>0&&et[T]&&h(T,C,et[T])},toggleTask:(T,C=!0)=>{let I=o[T];C&&!I?h(T,1,et[T]):!C&&I&&h(T,-I.count,et[T])},setLanguage:T=>{t=T;let C=c.querySelector(".js-hero-title");C&&(C.textContent=t("acesso_rapido"));let I=c.querySelector(".cw-search-input");I&&(I.placeholder=t("buscar_catalogo")),$(),q()},reset:()=>{for(let T in o)delete o[T];_.value="",d.style.display="block",p.style.display="none",q(),$()}}}var xr={marginTop:"24px",marginBottom:"16px",padding:"20px",background:"#fff9e6",borderRadius:"20px",border:"1.5px solid #fbbc0540",display:"none",boxShadow:"0 4px 12px rgba(251, 188, 5, 0.05)"},vr={fontSize:"12px",color:"#b06000",marginTop:"8px",lineHeight:"1.4"},yr={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1.5px solid #dadce0",fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",background:"#fff"},wr={display:"flex",gap:"20px",marginBottom:"12px"};function cn(e){let t=document.createElement("div");t.id="tag-support-container",Object.assign(t.style,xr);let a=document.createElement("label");a.className="js-ts-main-label",a.textContent=e("utilizou_tag_support"),Object.assign(a.style,Ra,{marginTop:"0"});let o=document.createElement("div");Object.assign(o.style,wr);let n=document.createElement("input");n.type="radio",n.name="ts_usage_mod",n.value="Sim",Object.assign(n.style,Pa);let i=document.createElement("label");i.className="js-ts-sim-label",i.textContent=e("sim");let r=document.createElement("div");Object.assign(r.style,{display:"flex",alignItems:"center"}),r.appendChild(n),r.appendChild(i);let l=document.createElement("input");l.type="radio",l.name="ts_usage_mod",l.value="N\xE3o",l.checked=!0,Object.assign(l.style,Pa);let c=document.createElement("label");c.className="js-ts-nao-label",c.textContent=e("nao");let g=document.createElement("div");Object.assign(g.style,{display:"flex",alignItems:"center"}),g.appendChild(l),g.appendChild(c),o.appendChild(r),o.appendChild(g);let u=document.createElement("div");u.style.display="block";let v=document.createElement("label");v.className="js-ts-reason-label",v.textContent=e("motivo_ts"),Object.assign(v.style,Ra,{fontSize:"12px"});let d=document.createElement("input");d.type="text",Object.assign(d.style,yr);let p=document.createElement("div");p.className="js-ts-warning",p.innerHTML=`\u26A0\uFE0F <strong>${e("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" rel="noopener noreferrer" style="color:#e37400; text-decoration:underline;">${e("link_aqui")}</a>`,Object.assign(p.style,vr),u.appendChild(v),u.appendChild(d),u.appendChild(p),t.appendChild(a),t.appendChild(o),t.appendChild(u),n.onchange=()=>{S.playClick(),u.style.display="none",Y.setTagSupportUsed(!0)},l.onchange=()=>{S.playClick(),u.style.display="block",Y.setTagSupportUsed(!1)};function _(A,D){if(t.style.display="none",!A||!D||D.length===0)return;D.some(q=>q==="ads_conversion_tracking"||q==="ads_enhanced_conversions")?t.style.display="block":(M(),Y.setTagSupportUsed(!1))}function w(){if(t.style.display==="none")return"";let A=`<br><b>${e("tag_support_output_label")}</b> ${n.checked?`\u2705 ${e("sim")}`:`\u274C ${e("nao")}`}`;return l.checked&&d.value.trim()!==""&&(A+=`<br><b>${e("motivo_output_label")}</b> ${d.value}`),A+="<br>",A}function E(A){e=A,a.textContent=e("utilizou_tag_support"),v.textContent=e("motivo_ts"),i.textContent=e("sim"),c.textContent=e("nao"),p.innerHTML=`\u26A0\uFE0F <strong>${e("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" rel="noopener noreferrer" style="color:#b06000; text-decoration:underline;">${e("link_aqui")}</a>`}function M(){t.style.display="none",l.checked=!0,n.checked=!1,u.style.display="block",d.value=""}return{element:t,updateVisibility:_,getOutput:w,setLanguage:E,reset:M}}var Ha="cw_notes_parking_lot",ba="cw_notes_emergency_save";var je={getAll:()=>{try{return JSON.parse(localStorage.getItem(Ha)||"[]")}catch{return[]}},save:e=>{let t=je.getAll(),a={id:Date.now().toString(),timestamp:new Date().toISOString(),...e};return t.unshift(a),t.length>5&&t.pop(),localStorage.setItem(Ha,JSON.stringify(t)),a},delete:e=>{let t=je.getAll();return t=t.filter(a=>a.id!==e),localStorage.setItem(Ha,JSON.stringify(t)),t},getCount:()=>je.getAll().length,saveEmergency:e=>{let t={timestamp:Date.now(),data:e};localStorage.setItem(ba,JSON.stringify(t))},getEmergency:()=>{try{let e=localStorage.getItem(ba);if(!e)return null;let t=JSON.parse(e);return Date.now()-t.timestamp>432e5?(localStorage.removeItem(ba),null):!t.data||!t.data.subStatus?null:t.data}catch{return null}},clearEmergency:()=>{localStorage.removeItem(ba)}};var dn="cw_case_streak_v1",Sr=[5,10,15,20,25,30,40,50];function pn(){let e=new Date;return`${e.getFullYear()}-${e.getMonth()+1}-${e.getDate()}`}function Ua(){try{let e=JSON.parse(localStorage.getItem(dn)||"{}");return e.date===pn()&&e.count||0}catch{return 0}}function un(){let e=Ua()+1;try{localStorage.setItem(dn,JSON.stringify({date:pn(),count:e}))}catch{}return{count:e,isMilestone:Sr.includes(e)}}var mn={pt:{milestoneToast:e=>`\u{1F525} ${e} casos hoje!`,quickSearch:"Busca r\xE1pida: Ctrl/Cmd+K",casesToday:"Casos conclu\xEDdos hoje",drag:"Arrastar",cancel:"Cancelar",cancelledToast:"Cancelado!"},es:{milestoneToast:e=>`\u{1F525} \xA1${e} casos hoy!`,quickSearch:"B\xFAsqueda r\xE1pida: Ctrl/Cmd+K",casesToday:"Casos completados hoy",drag:"Arrastrar",cancel:"Cancelar",cancelledToast:"\xA1Cancelado!"}};function At(e){let t=se();return mn[t]?.[e]??mn.pt[e]}var ye={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00",teal:"#00BFA5",pink:"#F48FB1",gray:"#9AA0A6"},Va=50,Wa=null;function fa(e){let t=document.getElementById("cw-btn-notes");if(!t)return;let a=t.querySelector(".cw-dot-dirty");e?a||(a=document.createElement("div"),a.className="cw-dot-dirty",t.appendChild(a)):a&&a.remove()}function gn(){let e=document.getElementById("cw-streak-badge"),t=document.getElementById("cw-streak-count");if(!e||!t)return;let a=Ua();t.textContent=a,e.classList.toggle("visible",a>0);let o=document.querySelector(".cw-pill");o&&(o.classList.toggle("has-streak",a>0),o.classList.toggle("streak-tier-2",a>=5&&a<15),o.classList.toggle("streak-tier-3",a>=15&&a<30),o.classList.toggle("streak-tier-4",a>=30))}function bn(){let{count:e,isMilestone:t}=un();if(gn(),t){let a=document.querySelector(".cw-pill");S.playSuccess(),a&&Po(a),X(At("milestoneToast")(e))}}function fn(e,t){let a="cw-command-center-style";if(!document.getElementById(a)){let h=document.createElement("style");h.id=a,h.innerHTML=`
...
`.replace(/\n/g,"<br>");ea(C);let I=await xa();I?(I.innerText.trim()===""&&(I.innerHTML=""),document.execCommand("insertHTML",!1,C),ha(I),S.playSuccess(),X(ct("noteGeneratedToast"))):X(ct("copiedOpenNoteToast"))},t}var Sn="cw_user_prefs_v1",Ka="cw_user_prefs_pending_v1",Ya=!1,ta=null;function Mt(){try{let e=localStorage.getItem(Sn),t=e?JSON.parse(e):null;return t&&typeof t=="object"?t:{}}catch{return{}}}function wn(e){try{localStorage.setItem(Sn,JSON.stringify(e))}catch(t){console.warn("N\xE3o consegui gravar as prefer\xEAncias localmente:",t)}}function Xa(e){try{e?localStorage.setItem(Ka,"1"):localStorage.removeItem(Ka)}catch{}}function Er(){try{return localStorage.getItem(Ka)==="1"}catch{return!1}}var dt={get(e,t=null){let a=Mt();return e in a?a[e]:t},async set(e,t){let a=Mt();a[e]=t,wn(a);let o=Le();if(!o)return Xa(!0),{saved:!0,synced:!1};Ya=!0;let n=!1;try{n=await me.saveUserPrefs(a,o)}catch(i){console.warn("Falha ao salvar prefer\xEAncias na nuvem:",i)}finally{Xa(!n),setTimeout(()=>{Ya=!1},2e3)}return{saved:!0,synced:n}},sync(){return ta||(ta=(async()=>{let e=Le();if(!e)return Mt();try{if(Er()){let a=Mt(),o=await me.saveUserPrefs(a,e);return Xa(!o),a}let t=await me.getUserPrefs(e);if(t&&typeof t=="object"&&!Ya){let a=Mt();JSON.stringify(t)!==JSON.stringify(a)&&wn(t)}}catch(t){console.warn("Prefer\xEAncias indispon\xEDveis; seguindo com o cache local.",t)}finally{ta=null}return Mt()})(),ta)}};var aa="shortcuts",En="shortcutsSortByUsage",An="cw_shortcut_usage_v1",mt=8,Cr=[{id:"sc_default_ni_attempted",kind:"note",label:"NI Attempted \u2014 In\xEDcio 2 Day Rule",alias:"2day inicio",payload:{caseType:"bau",status:"NI",subStatus:"NI_Attempted_Contact",scenarios:[{id:"quickfill-ni-attempted-2day",substatus:"NI_Attempted_Contact"}]}},{id:"sc_default_in_not_reachable",kind:"note",label:"IN Not Reachable \u2014 Finaliza\xE7\xE3o 2 Day Rule",alias:"2day fim",payload:{caseType:"bau",status:"IN",subStatus:"IN_Not_Reachable",scenarios:[{id:"quickfill-in-no-show-bau",substatus:"IN_Not_Reachable"}]}}];function oa(){return"sc_"+Date.now().toString(36)+Math.floor(Math.random()*1e3).toString(36)}function Za(e){if(!e||!e.id)return null;if(lt[e.id])return e.id;let t=Xt(e.id,e.substatus),a=Object.entries(lt),o=a.find(([i,r])=>Xt(i,e.substatus)===t&&Array.isArray(r.substatus)&&r.substatus.includes(e.substatus));if(o)return o[0];let n=a.find(([i])=>Xt(i,e.substatus)===t);return n?n[0]:null}function kn(e){return(e.payload&&e.payload.scenarios||[]).filter(a=>!Za(a)).map(a=>a.id)}function Cn(){try{return JSON.parse(localStorage.getItem(An)||"{}")}catch{return{}}}function Ja(e){return Array.isArray(e)?e.filter(t=>t&&t.id&&t.payload&&t.payload.subStatus).map((t,a)=>({id:t.id,kind:t.kind||"note",label:String(t.label||"Atalho"),alias:String(t.alias||""),order:Number.isFinite(t.order)?t.order:a,payload:{caseType:t.payload.caseType||"bau",status:t.payload.status||String(t.payload.subStatus).split("_")[0],subStatus:t.payload.subStatus,scenarios:Array.isArray(t.payload.scenarios)?t.payload.scenarios.filter(o=>o&&o.id).map(o=>({id:o.id,substatus:o.substatus||t.payload.subStatus})):[]}})):[]}var qe={list(){let e=dt.get(aa,null),t=Ja(e===null?qe.defaults():e),a=Cn();return t.slice().sort((o,n)=>{if(qe.isSortedByUsage()){let i=(a[n.id]||0)-(a[o.id]||0);if(i)return i}return o.order-n.order})},listRaw(){let e=dt.get(aa,null);return Ja(e===null?qe.defaults():e).sort((t,a)=>t.order-a.order)},defaults(){return Cr.map((e,t)=>({...e,order:t}))},isSortedByUsage(){return dt.get(En,!0)!==!1},setSortedByUsage(e){return dt.set(En,!!e)},async save(e){let t=qe.listRaw(),a=t.findIndex(i=>i.id===e.id);if(a===-1&&t.length>=mt)return{ok:!1,reason:"limit"};let o=Ja([{...e,id:e.id||oa()}])[0];return o?(a===-1?(o.order=t.length,t.push(o)):(o.order=t[a].order,t[a]=o),{ok:!0,synced:(await dt.set(aa,t)).synced,shortcut:o}):{ok:!1,reason:"invalid"}},async remove(e){let t=qe.listRaw().filter(a=>a.id!==e).map((a,o)=>({...a,order:o}));await dt.set(aa,t)},async reorder(e,t){let a=qe.listRaw(),o=a.findIndex(r=>r.id===e);if(o===-1)return;let[n]=a.splice(o,1),i=Math.max(0,Math.min(t,a.length));a.splice(i,0,n),await dt.set(aa,a.map((r,l)=>({...r,order:l})))},registerUse(e){try{let t=Cn();t[e]=(t[e]||0)+1,localStorage.setItem(An,JSON.stringify(t))}catch{}}};var Tn={pt:{emailButtonNotFound:"Erro: Bot\xE3o de email n\xE3o encontrado.",clearingOldDraft:"Limpando rascunho antigo...",editorNotLoaded:"Erro: Editor n\xE3o carregou.",cannedResponseApplied:"Canned Response aplicada!",cannedResponseTimeout:e=>`Timeout: Template '${e}' n\xE3o carregou.`,cannedResponseButtonNotFound:"Bot\xE3o Canned Response n\xE3o encontrado.",emailFilledSuccess:"Email preenchido com sucesso!",editorFocusError:"Erro ao focar no editor.",fallbackClient:"Cliente",fallbackSite:"seu site"},es:{emailButtonNotFound:"Error: Bot\xF3n de email no encontrado.",clearingOldDraft:"Limpiando borrador antiguo...",editorNotLoaded:"Error: El editor no carg\xF3.",cannedResponseApplied:"\xA1Canned Response aplicada!",cannedResponseTimeout:e=>`Tiempo agotado: la plantilla '${e}' no carg\xF3.`,cannedResponseButtonNotFound:"Bot\xF3n Canned Response no encontrado.",emailFilledSuccess:"\xA1Email completado con \xE9xito!",editorFocusError:"Error al enfocar el editor.",fallbackClient:"Cliente",fallbackSite:"su sitio"}};function tt(e){let t=se();return Tn[t]?.[e]??Tn.pt[e]}function Fe(e,t="info"){let a={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${e}`,a[t]||a.info)}function va(e,t){if(!e)return;let a=`cw-warning-${e.id||Math.random().toString(36).substr(2,9)}`,o=document.getElementById(a);o&&o.remove();let n=e.getBoundingClientRect(),i=document.createElement("div");i.id=a,i.style.cssText=`
        position: fixed;
        top: ${n.bottom+8}px;
        left: ${n.left}px;
        min-width: 300px;
    ...
    `,document.head.appendChild(e)}window._cwEscapeListenerActive||(window._cwEscapeListenerActive=!0,document.addEventListener("keydown",e=>{if(e.key!=="Escape"||document.querySelector(".cw-dialog-overlay"))return;let t=document.querySelector(".cw-module-window.open");if(!t)return;let a=t.querySelector(".cw-header-close");a&&a.click()}));function zn(){return!!(window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)}function In(e){let t=document.querySelector(".cw-pill"),a=e?document.getElementById(e):null,o=!!(t&&t.classList.contains("collapsed")),n=i=>{if(!i)return null;let r=i.getBoundingClientRect();return!r.width||!r.height?null:{x:r.left+r.width/2,y:r.top+r.height/2}};if(!o){let i=n(a);if(i)return i}return n(t)}function _n(e,t){let a=e.style.transition,o=e.style.transform;e.style.transition="none",e.style.transform="none";let n=e.getBoundingClientRect();return e.style.transform=o,e.offsetWidth,e.style.transition=a,{left:t?n.left:n.left-n.width/2,top:t?n.top:n.top-n.height/2,width:n.width,height:n.height}}function Fn(e,t,a){if(!t){e.style.transformOrigin="50% 50%",e._cwOrigin=null;return}let o=`${Math.round(t.x-a.left)}px ${Math.round(t.y-a.top)}px`;e.style.transformOrigin=o,e._cwOrigin=o}function Mn(e){return e?`translate(0, 0) scale(${oo})`:`translate(-50%, -50%) scale(${oo})`}function Lr(e){return e?"translate(0, 0) scale(1)":"translate(-50%, -50%) scale(1)"}function On(e){!e||zn()||(e.classList.remove("cw-absorbing"),e.offsetWidth,e.classList.add("cw-absorbing"),setTimeout(()=>e.classList.remove("cw-absorbing"),400))}function He(e){return e?typeof e._cwOpen=="boolean"?e._cwOpen:e.classList.contains("open"):!1}function De(e,t,a){let o=a?document.getElementById(a):null;if(!t)return;t._cwOpen=!!e;let n=(t._cwAnimToken||0)+1;t._cwAnimToken=n;let i=()=>t._cwAnimToken!==n;t._cwTeardown&&(t._cwTeardown(),t._cwTeardown=null);let r=zn(),l=t.getAttribute("data-moved")==="true";if(e){S.playGenieOpen();let c=_n(t,l);Fn(t,In(a),c),t.style.transition="none",t.style.opacity="0",t.style.pointerEvents="auto",t.style.transform=Mn(l),t.style.willChange="transform, opacity",t.classList.add("cw-animating"),t.offsetWidth,requestAnimationFrame(()=>{i()||(t.classList.add("open"),t.classList.remove("idle"),o&&o.classList.add("active"),On(o),t.style.transition=r?"opacity 0.15s ease":`opacity ${Math.round(to*.6)}ms ease-out, transform ${to}ms var(--cw-ease-decelerate), filter 0.3s ease, box-shadow 0.3s ease, border-color 0.3s ease`,t.style.opacity="1",t.style.transform=Lr(l),Dn(t,n,r?150:to,()=>{t.style.willChange="auto",t.classList.remove("cw-animating"),t._cwSettled=!0}))}),t._cwSettled=!1,Nr(t,a)}else{if(S.playSwoosh(),t._cwSettled||!t._cwOrigin){let c=_n(t,l);Fn(t,In(a),c)}if(t.style.transition=r?"opacity 0.15s ease":`opacity ${Math.round(ao*.8)}ms ease, transform ${ao}ms var(--cw-ease-accelerate)`,t.style.pointerEvents="none",t.style.willChange="transform, opacity",t.classList.add("cw-animating"),o&&t.contains(document.activeElement))try{o.focus({preventScroll:!0})}catch{o.focus()}requestAnimationFrame(()=>{i()||(t.style.opacity="0",t.style.transform=Mn(l),Dn(t,n,r?150:ao,()=>{t.classList.remove("open"),t.classList.remove("idle"),t.style.zIndex="",o&&o.classList.remove("active"),On(o),t.style.willChange="auto",t.classList.remove("cw-animating"),t.style.transition=""}))}),Rn(t)}}function Dn(e,t,a,o){let n=!1,i=()=>{e.removeEventListener("transitionend",l),clearTimeout(c),e._cwTeardown===i&&(e._cwTeardown=null)},r=()=>{n||(n=!0,i(),e._cwAnimToken===t&&o())},l=g=>{g.target===e&&g.propertyName==="transform"&&r()};e.addEventListener("transitionend",l);let c=setTimeout(r,a+qr);e._cwTeardown=i}function Nr(e,t){Rn(e);let a=o=>{if(!e.classList.contains("open"))return;let n=e.contains(o.target),i=document.querySelector(".cw-pill"),r=i&&i.contains(o.target);n?(e.classList.remove("idle"),e.style.zIndex=String(Me.MODULE_FOCUSED)):r||(e.classList.add("idle"),e.style.zIndex=String(Me.MODULE_RESTING))};e._idleHandler=a,document.addEventListener("mousedown",a)}function Rn(e){e._idleHandler&&(document.removeEventListener("mousedown",e._idleHandler),e._idleHandler=null)}var $n='<svg viewBox="0 0 24 24" fill="currentColor" style="width:13px;height:13px;flex-shrink:0;"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>';function Bn(){let e="v4.0.0",{popup:t,content:a,header:o,animRefs:n,credit:i}=Yo(e,F),r=cn(m),l=ln(()=>{ee(),Y.setActiveTasks(l.getCheckedElements())},m,Y),c=document.createElement("div");c.style.display="none";let g=sn((x,O)=>{H(x,O)});c.appendChild(g);let u=document.createElement("button");u.type="button",u.className="cw-save-shortcut-btn",u.style.cssText=`
    ...
    `,u.onmouseenter=()=>{u.style.borderColor=G.primary,u.style.color=G.primary,S.playHover()},u.onmouseleave=()=>{u.style.borderColor=G.border,u.style.color=G.textSub},u.onclick=()=>f(),u.innerHTML=`${$n}<span>${m("salvar_como_atalho")}</span>`,c.appendChild(u);let v=document.createElement("div");v.id="evidence-container",Object.assign(v.style,{display:"none",marginTop:"16px",padding:"16px",background:G.bgInput,border:`1px solid ${G.border}`,borderRadius:Ne.medium,boxShadow:ut.subtle});let d=document.createElement("div");d.className="cw-section-title",d.textContent=m("evidencias_contato"),v.appendChild(d);let p={},_=(x,O)=>{let U=document.createElement("div");U.style.marginBottom="12px";let Q=document.createElement("label");Q.textContent=O,Q.setAttribute("for",x),Q.style.cssText=`display: block; font-size: 11px; font-weight: 700; color: ${G.textSub}; margin-bottom: 6px; text-transform: uppercase;`;let ne=document.createElement("input");return ne.type="text",ne.id=x,ne.className="cw-input",ne.placeholder="https://screenshot.googleplex.com/...",ne.style.marginBottom="0",U.appendChild(Q),U.appendChild(ne),ra(ne,{minLength:8}),p[x]=ne,U};v.appendChild(_("evidence-l1",m("ligacao_1"))),v.appendChild(_("evidence-l2",m("ligacao_2"))),v.appendChild(_("evidence-msg",m("mensagem_am")));let w=hn({onSaveCurrent:async()=>{let x=await ae();return V(),x},onLoadDraft:x=>{y(x)},t:x=>m(x)}),E=z(),M=K(),A=document.createElement("div"),D=Z(),h=oe(w,m);a.appendChild(E),a.appendChild(M),a.appendChild(D),a.appendChild(c),a.appendChild(A),a.appendChild(v),l.selectionElement.style.display="none",l.screenshotsElement.style.display="none";let q=document.createElement("button");q.id="manual-task-toggle",q.textContent=m("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",q.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${G.primary}; background: ${G.surface}; color: ${G.primary}; border-radius: ${Ne.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${he}; text-transform: uppercase; letter-spacing: 0.5px;`,q.onmouseenter=()=>{q.style.background=G.primaryBg},q.onmouseleave=()=>{q.style.background=G.surface},q.onclick=()=>{l.selectionElement.style.display="block",l.screenshotsElement.style.display="block",q.style.display="none"},a.appendChild(q),a.appendChild(l.selectionElement),a.appendChild(r.element),a.appendChild(l.screenshotsElement),a.appendChild(h);let $=document.createElement("div");$.style.display="none",$.style.flexGrow="1",$.style.minHeight="0",$.style.overflow="hidden";let T=yn(()=>j());T.style.height="100%",$.appendChild(T),t.insertBefore($,i);let C=o.lastElementChild;C&&(C.insertBefore(w.historyBtnWrapper,C.firstChild),C.insertBefore(P(),C.firstChild)),t.appendChild(w.drawer);let I=null;Y.subscribe(x=>{de(x),k(),x.isDirty?(I&&clearTimeout(I),I=setTimeout(async()=>{let O=await ae(!0);O.subStatus?je.saveEmergency(O):je.clearEmergency(),x.isDirty=!1},2e3)):I&&(clearTimeout(I),I=null)});function k(){let x=je.getCount()>0,O=!!Y.currentSubStatus;fa(x||O)}function F(){Y.visible=!Y.visible,Y.visible?ke():Te(),De(Y.visible,t,"cw-btn-notes")}function j(){Y.isSplitView=!Y.isSplitView,Y.isSplitView?(a.style.display="none",$.style.display="flex",$.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(a.style.display="flex",$.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function z(){let x=document.createElement("div");if(x.innerHTML=`
        ...
        `;let O=x.querySelector("#main-status-select"),U=x.querySelector("#sub-status-select");return O.onchange=()=>{Y.setStatus(O.value),le(O.value,U),Y.setSubStatus(""),W("")},U.onchange=()=>{Y.setSubStatus(U.value),W(U.value)},x}function ie(){return v.style.display==="none"?null:{l1:p["evidence-l1"]?.value.trim()||"",l2:p["evidence-l2"]?.value.trim()||"",msg:p["evidence-msg"]?.value.trim()||""}}function le(x,O){if(O.innerHTML=`<option value="">${m("select_substatus")}</option>`,!x){O.disabled=!0;return}let U=x==="IN"?(()=>{let Q=document.createElement("optgroup");return Q.label="Fora de Escopo",Q})():null;for(let Q in Ie)if(Ie[Q].status===x){let ne=document.createElement("option");ne.value=Q,ne.textContent=Ie[Q].name,U&&Q.startsWith("IN_Out_of_Scope")?U.appendChild(ne):O.appendChild(ne)}U&&U.children.length>0&&O.appendChild(U),O.disabled=!1}function W(x){let O=Ie[x],U=x==="NI_Attempted_Contact"||O&&O.name&&O.name.toLowerCase().includes("attempted contact");if(g.render&&g.render(x,Y.currentCaseType),!x){v.style.display="none",p["evidence-l1"]&&(p["evidence-l1"].value=""),p["evidence-l2"]&&(p["evidence-l2"].value=""),p["evidence-msg"]&&(p["evidence-msg"].value=""),c.style.display="none",A.style.display="none";let Ce=document.getElementById("manual-task-toggle");Ce&&(Ce.style.display="none"),l.selectionElement.style.display="none",l.screenshotsElement.style.display="none",D.style.display="flex",D.style.opacity="1",h.style.display="none";return}if(U?v.style.display="block":(v.style.display="none",p["evidence-l1"]&&(p["evidence-l1"].value=""),p["evidence-l2"]&&(p["evidence-l2"].value=""),p["evidence-msg"]&&(p["evidence-msg"].value="")),D.style.opacity="0",setTimeout(()=>{Y.currentSubStatus&&(D.style.display="none")},400),h.style.display="grid",O&&O.templateFields){let Ce=Jo(O);Y.setActiveFields(O.templateFields.filter(Ve=>!Ce.includes(Ve)))}te(),Zt(x,A,Y),A.style.display="block",c.style.display="block";let Q=x.startsWith("SO_"),ne=x==="NI_Awaiting_Validation",ce=document.getElementById("manual-task-toggle");Q||ne?(l.selectionElement.style.display="block",ce.style.display="none"):(l.selectionElement.style.display="none",l.screenshotsElement.style.display="none",ce.style.display="block");let re=x==="SO_Education_Only"?"education":"implementation";Y.setScreenshotMode(re),l.updateSubStatus(x),ee();let we=document.getElementById("email-automation-toggle-row");we&&(we.style.display=It[x]?"flex":"none")}function ee(){let x=l.getCheckedElements().map(O=>O.value);r.updateVisibility(Y.currentSubStatus,x)}function H(x,O){let U=da(lt[x],Y.currentLang,x);if(U){for(let Q in U)if(Q==="linkedTask")l.toggleTask(U.linkedTask,O);else if(Q==="activeTasks")U.activeTasks.forEach(ne=>{O?l.setTaskCount(ne.value,ne.count):l.setTaskCount(ne.value,0)});else if(Q.startsWith("field-")){let ne=Q,ce=U[Q],re=document.getElementById(ne);if(re){let we=_t.includes(ne.replace("field-",""));if(O)if(we){let Ce=re.value.trim();Ce.includes(ce.trim())||(re.value=Ce?Ce+`
...
`))}else re.value.trim()===ce.trim()&&(re.value="");Y.updateField(ne,re.value),re.dispatchEvent(new Event("input"))}}}}function oe(x,O){let U=document.createElement("div");if(U.className="cw-actions-section",U.style.cssText=`
    ...
    `,document.head.appendChild(e)}function _r(e,t){return e.map(a=>Gn(a,se())).filter(a=>a.name.toLowerCase().includes(t.toLowerCase())||a.category.toLowerCase().includes(t.toLowerCase()))}function Fr(e){return Object.entries(It).filter(([t,a])=>a&&(t.toLowerCase().includes(e.toLowerCase())||a.toLowerCase().includes(e.toLowerCase()))).map(([t,a])=>({id:t,name:t.replace(/_/g," "),category:"\u26A1 Smart CRs",code:a,isSmartCR:!0}))}function Mr(e){return Re.getSnippets("email").filter(t=>t.title.toLowerCase().includes(e.toLowerCase())||t.subject&&t.subject.toLowerCase().includes(e.toLowerCase())).map(t=>{let a=[],o=t.content.match(/\[([^\]]+)\]/g);return o&&[...new Set(o)].forEach(n=>{a.push({key:n,label:n.replace("[","").replace("]",""),type:n.toLowerCase().includes("data")?"date":"text",auto:n.toLowerCase().includes("nome")&&n.toLowerCase().includes("seu")?"agentName":null})}),{id:t.id||`snippet-${Math.random()}`,name:t.title,category:"\u{1F464} Pessoal",subject:t.subject||Ye("noSubject"),template:t.content,placeholders:a}})}function Or(e,t){return[..._r(e,t),...Fr(t),...Mr(t)]}function Wn(){let e="v6.0.0",t=!1,a=[],o=null,n="",i=new Set;Ir();let r=document.createElement("div");r.id="email-assistant-popup",r.classList.add("cw-module-window","cw-email-popup"),Object.assign(r.style,Ge,{width:"850px",height:"650px"}),r.style.display="none",r.style.flexDirection="column";let l=Oe(r,Ye("headerTitle"),e,Ye("headerDesc"),{popup:r},()=>k()),c=document.createElement("div");c.className="cw-email-main";let g=document.createElement("div");g.className="cw-email-left-panel";let u=document.createElement("div");u.className="cw-email-search-container";let v=document.createElement("input");v.className="cw-email-search-input",v.placeholder=Ye("searchPlaceholder");let d=document.createElement("div");d.id="email-template-list",ia(d,".cw-email-cat-header, .cw-email-list-item");let p=document.createElement("div");p.className="cw-email-clear-btn",p.innerHTML="\u2715",p.onclick=()=>{v.value="",n="",p.style.display="none",K(),v.focus()},u.appendChild(v),u.appendChild(p),g.appendChild(u),g.appendChild(d);let _=document.createElement("div");_.className="cw-email-right-panel";let w=document.createElement("div");w.className="cw-email-fields-section";let E=document.createElement("div");E.className="cw-email-preview-section";let M=document.createElement("div");M.className="cw-email-preview-header";let A=document.createElement("span");A.textContent=Ye("previewTitle"),A.className="cw-email-preview-title";let D=document.createElement("div");D.className="cw-email-preview-actions";let h=(H,oe=!1)=>{let R=document.createElement("button");return R.textContent=H,R.className="cw-email-btn"+(oe?" primary":""),R},q=h("Copiar HTML"),$=h("Preencher no CRM",!0),T=h("Smart CR");T.classList.add("warning"),D.appendChild(T),D.appendChild(q),D.appendChild($),M.appendChild(A),M.appendChild(D);let C=document.createElement("div");C.contentEditable="true",C.className="cw-email-preview-content",E.appendChild(M),E.appendChild(C),ee(),_.appendChild(w),_.appendChild(E),c.appendChild(g),c.appendChild(_),r.appendChild(l),r.appendChild(c);let I=document.createElement("div");Object.assign(I.style,rt),r.appendChild(I),st(r,I),document.body.appendChild(r);function k(){t=!He(r),t?(ke(),r.style.display="flex",Go(r),a.length===0&&F()):(Te(),r.style.display="none"),De(t,r,"cw-btn-email")}async function F(){d.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',a=await Hn.getTemplates(),K()}function j(H,oe,R){let J=document.createElement("div");J.className="cw-email-cat-header",J.tabIndex=0,J.setAttribute("role","button"),J.setAttribute("aria-expanded",String(R));let te=document.createElement("span");te.textContent=H,J.appendChild(te);let V=document.createElement("span");V.className="cw-email-cat-badge",V.textContent=oe;let ae=document.createElement("span");ae.className="cw-email-cat-arrow",ae.textContent=R?"\u25BE":"\u25B8";let s=document.createElement("div");return s.className="cw-email-cat-right",s.appendChild(V),s.appendChild(ae),J.appendChild(s),J.onclick=()=>{i.has(H)?i.delete(H):i.add(H),K()},J.addEventListener("keydown",y=>{(y.key==="Enter"||y.key===" ")&&(y.preventDefault(),J.click())}),J}function z(H){let oe=o&&o.id===H.id,R=document.createElement("div");if(R.className="cw-email-list-item"+(oe?" selected":""),R.tabIndex=0,R.setAttribute("role","button"),R.setAttribute("aria-pressed",String(!!oe)),oe){let V=document.createElement("div");V.className="cw-email-list-indicator",R.appendChild(V)}let J=document.createElement("span");J.className="cw-email-list-icon",J.innerHTML=H.isSmartCR?"\u26A1":H.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",R.appendChild(J);let te=document.createElement("span");return te.className="cw-email-list-text",te.textContent=H.name,R.appendChild(te),R.onclick=()=>le(H),R.addEventListener("keydown",V=>{(V.key==="Enter"||V.key===" ")&&(V.preventDefault(),R.click())}),R}function K(){d.innerHTML="";let H=Or(a,n);if(H.length===0){d.innerHTML=`
...
CID: ${e.cid||"---"}
Case ID: ${e.caseId||"---"}
E-mail: ${e.clientEmail||"---"}`,dateLocale:"es-ES"}};function Zn(){return se()==="es"?"ES":"PT"}function xe(e){let t=se();return Jn[t]?.[e]??Jn.pt[e]}var ge={bgApp:"#F5F5F7",bgSurface:"#FFFFFF",borderSubtle:"rgba(0, 0, 0, 0.07)",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",textPrimary:"#1D1D1F",textSecondary:"#6E6E73",danger:"#D93025",dangerBg:"#FCE8E6",success:"#34A853",successBg:"#E6F4EA"},zr={inicio:{PT:"Abertura",ES:"Apertura"},meio:{PT:"Implementa\xE7\xE3o (Tag Support)",ES:"Implementaci\xF3n"},fim:{PT:"Fechamento",ES:"Cierre"}};function Rr(){if(document.getElementById("csa-styles-v2"))return;let e=document.createElement("style");e.id="csa-styles-v2",e.textContent=`
  ...
  `,j.appendChild(z),C.appendChild(j);let K=z.querySelectorAll("button"),ie=z.querySelector("#type-indicator");K.forEach((V,ae)=>{V.onclick=()=>{K.forEach(s=>s.classList.remove("active")),V.classList.add("active"),ie.style.transform=`translateX(${ae*(z.offsetWidth/2-2)}px)`,o=V.dataset.type,S.playClick(),R()}}),Se(()=>{a=Zn(),d&&(d.textContent=xe("headerTitle"));let V=i.querySelector(".cw-help-title");V&&(V.textContent=xe("headerTitle"));let ae=i.querySelector(".cw-help-description");ae&&(ae.textContent=xe("headerDesc"));let s=p.querySelector(".js-csa-monitoring");s&&(s.title=xe("activeMonitoring"));let y=p.querySelector(".js-csa-cid-label");y&&(y.textContent=xe("cidLabel"));let L=p.querySelector(".js-csa-email-label");L&&(L.textContent=xe("emailLabel")),p.querySelectorAll(".csa-copy-hint").forEach(m=>m.textContent=xe("copied"));let b=p.querySelector(".js-csa-am-title");b&&(b.textContent=xe("amMessageTitle"));let f=p.querySelector(".js-csa-am-sub");f&&(f.textContent=xe("amMessageSub")),D&&(D.textContent=xe("copyFinalMessage"));let N=F.querySelector(".js-csa-reset-label");N&&(N.textContent=xe("resetScript")),R()});let le=document.createElement("div");le.id="csa-checklist-area",C.appendChild(le);let W=document.createElement("div");Object.assign(W.style,rt),W.className="no-drag",W.title=xe("resize"),i.appendChild(W),st(i,W),document.body.appendChild(i),q("#cw-pill-cid","#cw-ctx-cid"),q("#cw-pill-email","#cw-ctx-email");function ee(V){return V.replace(/\n/g,"<br>")}function H(V,ae,s,y){let L=`${V}-${ae}-${y}`,b=!!t[L],f=document.createElement("div");f.className="csa-item-row"+(b?" completed":"");let N=document.createElement("div");N.className="csa-checkbox"+(b?" checked":""),N.innerHTML=b?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"";let m=document.createElement("span");return m.className="csa-item-text"+(b?" completed":""),m.innerHTML=ee(s),f.onclick=()=>{let P=!t[L];t[L]=P,S.playClick(),f.classList.toggle("completed",P),m.classList.toggle("completed",P),N.classList.toggle("checked",P),N.innerHTML=P?'<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':"",P&&(N.classList.add("pulse"),setTimeout(()=>N.classList.remove("pulse"),150)),J(V,Dt[V])},f.appendChild(N),f.appendChild(m),{row:f,isDone:b}}function oe(V,ae,s){let y=document.createElement("div");y.className="csa-card";let L=document.createElement("div");L.className="csa-card-title",L.textContent=zr[ae][a]||"";let b=document.createElement("span");b.className="csa-card-counter",L.appendChild(b),y.appendChild(L);let f=0;s.forEach((m,P)=>{let{row:Z,isDone:de}=H(V,ae,m,P);de&&f++,y.appendChild(Z)});let N=f===s.length&&s.length>0;return y.classList.toggle("done",N),b.classList.toggle("done",N),b.textContent=`${f}/${s.length}`,y}function R(){le.innerHTML="";let V=`${a} ${o}`,ae=Dt[V];if(!ae){le.innerHTML=`<div class="csa-empty-state"><div class="csa-empty-state-icon">\u2615</div><div>${xe("scriptNotConfigured")}</div></div>`,T.style.width="0%";return}let s=0,y=0;["inicio","meio","fim"].forEach(L=>{ae[L]&&(s+=ae[L].length)}),["inicio","meio","fim"].forEach(L=>{let b=ae[L];!b||b.length===0||(b.forEach((f,N)=>{let m=`${V}-${L}-${N}`;t[m]&&y++}),le.appendChild(oe(V,L,b)))}),te(s,y)}function J(V,ae){let s=0,y=0;["inicio","meio","fim"].forEach(L=>{let b=ae[L]||[];s+=b.length,b.forEach((f,N)=>{t[`${V}-${L}-${N}`]&&y++})}),te(s,y),setTimeout(()=>R(),200)}function te(V,ae){let s=V===0?0:ae/V*100;T.style.width=`${s}%`,T.classList.toggle("complete",s===100)}return R(),Kn(()=>R()),u}var $r={"Ponto Eletr\xF4nico":"Control de Asistencia","Ferramenta de ajuda":"Herramienta de ayuda","Intranet Google":"Intranet Google","Relat\xF3rio Follow-ups":"Informe de Follow-ups","Dashboard WFM":"Dashboard WFM","Tech Solutions SAO":"Tech Solutions SAO","Form Grava\xE7\xE3o":"Form Grabaci\xF3n","Form Escala\xE7\xE3o":"Form Escalaci\xF3n","Instru\xE7\xF5es Split":"Instrucciones Split","Single Page App":"Single Page App","Procedimento Padr\xE3o":"Procedimiento Est\xE1ndar","Valida\xE7\xE3o C\xF3digo":"Validaci\xF3n C\xF3digo","Convers\xE3o Chamada":"Conversi\xF3n Llamada","Valida\xE7\xE3o WCC":"Validaci\xF3n WCC",ECW4:"ECW4","Monitoramento EC":"Monitoreo EC","Resolu\xE7\xE3o problemas":"Resoluci\xF3n de problemas","Implementa\xE7\xE3o RMKT":"Implementaci\xF3n RMKT","Pontua\xE7\xE3o Leads":"Puntuaci\xF3n de Leads","Instala\xE7\xE3o Container":"Instalaci\xF3n Container","Instala\xE7\xE3o Config.":"Instalaci\xF3n Config.","Valida\xE7\xE3o GA4":"Validaci\xF3n GA4","Guia Dev":"Gu\xEDa Dev","Resolu\xE7\xE3o Problemas":"Resoluci\xF3n de Problemas","Dom\xEDnio Cruzado":"Dominio Cruzado","Lista Oficial":"Lista Oficial","Criador URLs":"Creador de URLs","Setup Inicial":"Setup Inicial","Otimiza\xE7\xE3o Feed":"Optimizaci\xF3n Feed","Ferramenta Interna":"Herramienta Interna",Avalia\u00E7\u00F5es:"Rese\xF1as","Feeds Offline":"Feeds Offline","Help Center":"Help Center","Guias CMS":"Gu\xEDas CMS","Solu\xE7\xF5es Iframes":"Soluciones Iframes","Ghost Ads":"Ghost Ads","Ghost Analytics":"Ghost Analytics","Ghost GTM":"Ghost GTM",Ferramenta:"Herramienta","Ghost MC":"Ghost MC","Playground JS":"Playground JS","Testador Regex":"Probador Regex","Doc. CSP":"Doc. CSP","Guia CoMo":"Gu\xEDa CoMo","Debug CoMo":"Debug CoMo","Portal Colaborador":"Portal del Colaborador","Apps e Sistemas":"Apps y Sistemas","Folha Pagamento":"N\xF3mina","Reportar problemas":"Reportar problemas","Registro chamadas":"Registro de llamadas","Erros de sistema":"Errores de sistema","BAU/Descarte/Monitoria":"BAU/Descarte/Monitoreo","Feedback positivo":"Feedback positivo","Casos dif\xEDceis":"Casos dif\xEDciles","Chat/Email Ads":"Chat/Email Ads","Chat/Email Shopping":"Chat/Email Shopping","Perfil da Empresa":"Perfil de la Empresa","Console API":"Console API","Lista de n\xFAmeros":"Lista de n\xFAmeros",Cursos:"Cursos"};function ei(e){let t=e&&typeof e=="object"?e:{desc:e},a=t.desc||"";return se()!=="es"?a:t.descEs||$r[a]||a}var ti={pt:{headerTitle:"Central de Links",headerDesc:"Navegue pelas categorias ou use a busca.",searchPlaceholder:"Buscar ferramenta ou SOP...",recent:"Recentes",nothingHereYet:"Nada por aqui ainda",nothingHereSub:"Os links que voc\xEA abrir aparecem aqui pra acesso r\xE1pido depois.",searchResults:"Resultados da busca",nothingFound:"Nada encontrado",noLinkMatches:e=>`Nenhum link bate com "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"Link copiado!",copyFailedToast:"N\xE3o foi poss\xEDvel copiar o link.",categoryLabels:{tasks:"Tarefas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RH",lm:"Forms",qa:"QA",suporte:"Ajuda"}},es:{headerTitle:"Central de Enlaces",headerDesc:"Navega por las categor\xEDas o usa la b\xFAsqueda.",searchPlaceholder:"Buscar herramienta o SOP...",recent:"Recientes",nothingHereYet:"Todav\xEDa no hay nada aqu\xED",nothingHereSub:"Los enlaces que abras aparecen aqu\xED para acceso r\xE1pido despu\xE9s.",searchResults:"Resultados de la b\xFAsqueda",nothingFound:"No se encontr\xF3 nada",noLinkMatches:e=>`Ning\xFAn enlace coincide con "${e}".`,copyUrl:"Copiar URL",linkCopiedToast:"\xA1Enlace copiado!",copyFailedToast:"No se pudo copiar el enlace.",categoryLabels:{tasks:"Tareas",ads:"Ads",analytics:"GA4",shopping:"Shop",tech:"Tech",hr:"RRHH",lm:"Forms",qa:"QA",suporte:"Ayuda"}}};function ze(e){let t=se();return ti[t]?.[e]??ti.pt[e]}function ai(e){return ze("categoryLabels")[e]??gt[e]?.label??e}var gt={tasks:{label:"Tarefas",links:[{name:"Web Clock Punch",url:"https://compass.talent.cognizant.com/psp/HCMPRD/EMPLOYEE/HRMS/h/?tab=DEFAULT",desc:"Ponto Eletr\xF4nico"},{name:"Web\xE3o Help Deluxe",url:"http://go/webao-help-deluxe",desc:"Ferramenta de ajuda"},{name:"Moma Home",url:"https://moma.corp.google.com/",desc:"Intranet Google"},{name:"Plx DataSites",url:"https://data.corp.google.com/sites/7kpryuwxw9jw/agents_follow_ups_report/",desc:"Relat\xF3rio Follow-ups"},{name:"Escala & Ader\xEAncia",url:"https://lookerstudio.google.com/c/u/0/reporting/f8966844-b70e-4070-9b7f-a29028401bf4/page/p_0tayxfleid",desc:"Dashboard WFM"},{name:"Performance Indiv.",url:"https://dashboards.corp.google.com/_a981e311_424f_410b_925f_9b019ee186ce",desc:"Tech Solutions SAO"},{name:"Solicitar Grava\xE7\xE3o",url:"https://support.google.com/policies/contact/sar",desc:"Form Grava\xE7\xE3o"},{name:"Escala\xE7\xE3o Sellers",url:"https://forms.gle/HWMhML56eE4CPZCs5",desc:"Form Escala\xE7\xE3o"},{name:"[SOP] Split",url:"https://sites.google.com/corp/google.com/technicalsolutions/case-handling_1/out-of-scope?authuser=0#h.obb5iieru15o",desc:"Instru\xE7\xF5es Split"}]},ads:{label:"Ads",links:[{name:"SPA (Tag Support)",url:"https://tagsupport.corp.google.com/create-session",desc:"Single Page App"},{name:"[SOP] Conv. Tracking",url:"https://docs.google.com/document/d/1By5Jv40kGeGWFUzMXT9xuNAeUl_s1clYybZO1nhNnAI/edit",desc:"Procedimento Padr\xE3o"},{name:"Win Criteria: Code",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit",desc:"Valida\xE7\xE3o C\xF3digo"},{name:"[SOP] Call Conv.",url:"https://docs.google.com/document/d/1es_tvx8nhMkWn-Hh9n3Jd3vzo91RpY6PuwMBlsTd-kA/edit",desc:"Convers\xE3o Chamada"},{name:"Win Criteria: WCC",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A10:A15",desc:"Valida\xE7\xE3o WCC"},{name:"[SOP] Enhanced Conv.",url:"https://docs.google.com/document/d/1R59-cUeBaX-5dOxAXxvzsRXgkVdFPzTzOCSBQWt42H0/edit",desc:"ECW4"},{name:"Ads EC Dashboard",url:"https://dashboards.corp.google.com/edit/_0ded1099_6ef3_4bc9_bba0_2445840d1b69",desc:"Monitoramento EC"},{name:"[SOP] Troubleshooting",url:"https://docs.google.com/document/d/10M0FAkMFmlhgHQJtAQPNtLRGh-BpPzR_6z1s6xYOQEk/edit",desc:"Resolu\xE7\xE3o problemas"},{name:"[SOP] Remarketing",url:"https://docs.google.com/document/d/1awOuj4rFBrukfByYuvcCFOAGbZX7H1j_EelPeCaUcoU/edit",desc:"Implementa\xE7\xE3o RMKT"},{name:"[SOP] Lead Scoring",url:"https://docs.google.com/document/d/1jyFVLvKnk1K2ojyj-K37PXcmQdU9A8wiHWj-w49yOBg/edit",desc:"Pontua\xE7\xE3o Leads"},{name:"[SOP] GTM Install",url:"https://docs.google.com/document/d/1Uj-fkPNxygeL-YQIVgLfIPo579SKF1oe78i5nHx5eLs/edit",desc:"Instala\xE7\xE3o Container"}]},analytics:{label:"GA4",links:[{name:"[SOP] GA4 Setup",url:"https://docs.google.com/document/d/1cLDh6RIo-lxfv-pffvBwhFpI-fSTOaAsMXwwsID1yNk/edit",desc:"Instala\xE7\xE3o Config."},{name:"Win Criteria: GA4",url:"https://docs.google.com/spreadsheets/d/1X5yeIZZzWQRrPdSDM7oZt2Kt0ooSN4dgLN4J7gWe8O4/edit?resourcekey=0-GiUc9KwVTDkVaUxwlyNCtA#gid=971616043&range=A45:A51",desc:"Valida\xE7\xE3o GA4"},{name:"GA4 E-commerce",url:"https://developers.google.com/analytics/devguides/collection/ga4/ecommerce?hl=pt-br",desc:"Guia Dev"},{name:"[SOP] Troubleshoot GA4",url:"https://docs.google.com/document/d/14fxyQMlcT57ILtsaBdYBFZs2DDZeSbXsvniXfo_eJaU/edit",desc:"Resolu\xE7\xE3o Problemas"},{name:"[SOP] Cross Domain",url:"https://support.google.com/ads-help/answer/12282402",desc:"Dom\xEDnio Cruzado"},{name:"Eventos Recomendados",url:"https://developers.google.com/analytics/devguides/collection/ga4/reference/events",desc:"Lista Oficial"},{name:"UTM Builder",url:"https://ga-dev-tools.google/ga4/campaign-url-builder/",desc:"Criador URLs"}]},shopping:{label:"Shop",links:[{name:"[SOP] Onboarding MC",url:"https://docs.google.com/document/d/1yJGEssn9Uvxa3eWjp2Y5MQSkL26AElh6sSAKgD6qmjg/edit",desc:"Setup Inicial"},{name:"[SOP] Feed Opt",url:"https://docs.google.com/document/d/1VBYH6b3r0uyjXHN749pDK7IajF5Ii0-rm6M-BZuaJGY/edit",desc:"Otimiza\xE7\xE3o Feed"},{name:"ShopTroubleshooting",url:"http://go/shoptroubleshooting",desc:"Ferramenta Interna"},{name:"[SOP] Product Reviews",url:"https://docs.google.com/document/d/1v2xH6QLgWc5_-C85Pmj40GSe5lxstRXnjd8vEW92TBk/edit",desc:"Avalia\xE7\xF5es"},{name:"[SOP] Offline Feed",url:"https://docs.google.com/document/d/1Q3cJxf4ucfA_bu6vDId63Tj1P8ZofgE7CqnK9KUgLuU/edit",desc:"Feeds Offline"},{name:"Especifica\xE7\xE3o Dados",url:"https://support.google.com/merchants/answer/7052112",desc:"Help Center"}]},tech:{label:"Tech",links:[{name:"Solu\xE7\xF5es por CMS",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-via-cms?authuser=0",desc:"Guias CMS"},{name:"Iframes & Cross-Origin",url:"https://sites.google.com/corp/google.com/webao-sme-cms/solu%C3%A7%C3%B5es-t%C3%A9cnicas/iframes-contentdocument-e-message?authuser=0",desc:"Solu\xE7\xF5es Iframes"},{name:"Ads ICS Ghost",url:"http://go/pqp",desc:"Ghost Ads"},{name:"Analytics ICS Ghost",url:"http://go/analytics-ics",desc:"Ghost Analytics"},{name:"GTM ICS Ghost",url:"http://go/tagmanager-ics",desc:"Ghost GTM"},{name:"Gearloose",url:"http://go/gearloose",desc:"Ferramenta"},{name:"MC ICS Ghost",url:"https://mcn-ics.corp.google.com/mc/overview",desc:"Ghost MC"},{name:"JSFiddle",url:"https://jsfiddle.net/",desc:"Playground JS"},{name:"RegExr",url:"https://regexr.com/",desc:"Testador Regex"},{name:"Doc. CSP",url:"https://developers.google.com/tag-platform/tag-manager/web/csp?hl=pt-br.",desc:"Doc. CSP"},{name:"Consent Mode Install",url:"https://developers.google.com/tag-platform/security/guides/consent?consentmode=advanced",desc:"Guia CoMo"},{name:"Consent Mode Debug",url:"https://developers.google.com/tag-platform/security/guides/consent-debugging",desc:"Debug CoMo"}]},hr:{label:"RH",links:[{name:"Be.Cognizant",url:"https://cognizantonline.sharepoint.com/sites/GlobalHR/SitePages/Brazil.aspx",desc:"Portal Colaborador"},{name:"OneCognizant",url:"https://onecognizant.cognizant.com/Home",desc:"Apps e Sistemas"},{name:"ADP eXpert",url:"https://expert.cloud.brasil.adp.com/expert2/v4/",desc:"Folha Pagamento"}]},lm:{label:"Forms",links:[{name:"Ocorr\xEAncias e Pausas",url:"https://docs.google.com/forms/d/e/1FAIpQLSc6CamPehrREeVr7yCWMyqFETrFYYezNcLb_13W4yZDQkfY6Q/viewform",desc:"Reportar problemas"},{name:"Chamadas >50min",url:"https://docs.google.com/forms/d/e/1FAIpQLSfE8EMHNJMTKYeA6XM2RZjZ9AQ4LhGk1Dwm_WLu3kcMdKMikA/viewform",desc:"Registro chamadas"},{name:"Relat\xF3rio de Bugs",url:"https://docs.google.com/forms/d/e/1FAIpQLSfkqRqT2Kbf08IStz31fQPE84MDOtGxk7cetJmc3xzShXIXRA/viewform",desc:"Erros de sistema"},{name:"Suporte LM",url:"https://script.google.com/a/macros/google.com/s/AKfycbxYMlFCMZvqgHMIImeS_u-lNZPiertXmem-5m9Fox3jvZaq0ZOQDoc5ma96ltSvWHY/exec",desc:"BAU/Descarte/Monitoria"}]},qa:{label:"QA",links:[{name:"Elogios",url:"https://docs.google.com/forms/d/e/1FAIpQLSezY5K-trQDv0LkL5IoTlV0Tl0oOqGTEszylmgcbMRXcC9Weg/viewform",desc:"Feedback positivo"},{name:"Casos Complexos",url:"https://docs.google.com/forms/d/e/1FAIpQLSe26q1LEloFNRfOAVZtA7DCOQTqdu1BAEeWuxtK6oPwZhLp-A/viewform?resourcekey=0-c1N4h8gntza2gQowqYAqMw",desc:"Casos dif\xEDceis"}]},suporte:{label:"Ajuda",links:[{name:"Fale Conosco Ads",url:"https://support.google.com/google-ads/gethelp",desc:"Chat/Email Ads"},{name:"Fale Conosco Merchant",url:"https://support.google.com/merchants/gethelp",desc:"Chat/Email Shopping"},{name:"Fale Conosco GMB",url:"https://support.google.com/business/gethelp",desc:"Perfil da Empresa"},{name:"Suporte API",url:"https://support.google.com/googleapi",desc:"Console API"},{name:"Telefones Suporte",url:"https://www.adwordsrobot.com/en/list-of-google-adwords-support-phone-numbers",desc:"Lista de n\xFAmeros"},{name:"Skill Shop",url:"https://skillshop.withgoogle.com/intl/pt-BR_ALL/",desc:"Cursos"}]}};function oi(e){if(!Array.isArray(e)||!e.length)return!1;let t={};for(let a of e){let o=a.key;if(!o)continue;let n;try{n=JSON.parse(a.value||"{}")}catch{continue}!n.name||!n.url||(t[o]||(t[o]={label:gt[o]?.label||o,links:[]}),t[o].links.push({name:n.name,url:n.url,desc:n.desc||"",descEs:n.desc_es||""}))}if(!Object.keys(t).length)return!1;for(let a of Object.keys(gt))delete gt[a];return Object.assign(gt,t),!0}async function Br(e){let t=me.getCachedContent("links");oi(t)&&e?.();try{let a=await me.fetchContentModule("links");oi(a)&&e?.()}catch(a){console.warn("Central de Conte\xFAdo indispon\xEDvel; usando links embutidos.",a)}}var ft={tasks:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>',lm:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/></svg>',qa:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>',suporte:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',ads:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>',analytics:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>',shopping:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg>',tech:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg>',hr:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',history:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>'},ht={bgApp:"#F8F9FA",bgSidebar:"#FFFFFF",bgSurface:"#FFFFFF",textPrimary:"#202124",textSecondary:"#5F6368",borderSubtle:"rgba(0,0,0,0.06)"},Ca={tasks:{color:"#0097A7",bg:"#E0F7FA"},ads:{color:"#1967D2",bg:"#E8F0FE"},analytics:{color:"#E37400",bg:"#FEF7E0"},shopping:{color:"#188038",bg:"#E6F4EA"},tech:{color:"#9334E6",bg:"#F3E8FD"},hr:{color:"#C5221F",bg:"#FCE8E6"},lm:{color:"#5F6368",bg:"#F1F3F4"},qa:{color:"#F09D00",bg:"#FFF3E0"},suporte:{color:"#0B57D0",bg:"#D3E3FD"},history:{color:"#5F6368",bg:"#FFFFFF"}};function Pr(){if(document.getElementById("cw-links-styles"))return;let e=document.createElement("style");e.id="cw-links-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}var Wr={pt:"pt-BR",es:"es-ES"};function mi(e){if(!e)return"";try{let t=new Date(e);return isNaN(t.getTime())?String(e):new Intl.DateTimeFormat(Wr[se()]||"pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).format(t)}catch{return String(e)}}function Yr(e){let t=String(e||"").split("-");return t.length===3?`${t[2]}/${t[1]}`:String(e||"")}function Xr(e){let t=new Date(e).getTime();if(!t||isNaN(t))return"";let a=Math.floor((Date.now()-t)/6e4);if(a<1)return be("justNow");if(a<60)return be("minutesAgo")(a);let o=Math.floor(a/60);return o<24?be("hoursAgo")(o):o<48?be("yesterday"):mi(e).split(",")[0]}function si(e){if(!e||typeof e!="string")return"";let t=e;return t=t.replace(/(https?:\/\/[^\s]+)/g,'<a href="$1" target="_blank" class="cw-bc-link">$1</a>'),t=t.replace(/\*\*(.*?)\*\*/g,"<b>$1</b>"),t=t.replace(/_(.*?)_/g,"<i>$1</i>"),t=t.replace(/\n/g,"<br>"),t=jo(t),t}function li(e){if(!e)return null;let t={};try{t=JSON.parse(e.value||"{}")}catch{return null}let a=String(t.title||e.label||"").trim(),o=String(t.text||"").trim();return!a||!o?null:{id:String(e.key||e.id||""),type:io[t.type]?t.type:"info",title:a,text:o,date:String(t.publishedAt||e.publishedAt||""),author:String(t.author||e.publishedBy||""),lang:String(e.lang||"ALL").toUpperCase()}}function Kr(e){if(!e)return null;let t=String(e.title||"").trim(),a=String(e.text||"").trim();return!t||!a||t.toLowerCase().includes("disponibilidade bau")?null:{id:String(e.id||""),type:io[e.type]?e.type:"info",title:t,text:a,date:String(e.date||""),author:String(e.author||""),lang:"ALL"}}function ci(e){let t=(e||[])[0];if(!t)return null;let a={};try{a=JSON.parse(t.value||"{}")}catch{return null}let o=a.segments||{},n={};return Object.keys(o).forEach(i=>{let r=String(o[i]?.attention||""),l=String(o[i]?.full||"");(r||l)&&(n[i]={attention:r,full:l})}),Object.keys(n).length?{updatedAt:String(a.updatedAt||t.publishedAt||""),author:String(a.author||t.publishedBy||""),note:String(a.note||""),segments:n}:null}function di(e,t){return e.lang==="ALL"||e.lang===t}function zt(){try{let e=JSON.parse(localStorage.getItem(ui)||"[]");return Array.isArray(e)?e:[]}catch{return[]}}function pi(e){try{localStorage.setItem(ui,JSON.stringify(e))}catch{}}function gi(){let e="v5.0",t=!1,a=null,o="",n=null,i=null,r=!1,l=[],c=null,g=null,u=null,v=null;Vr();let d=document.createElement("div");d.id="broadcast-popup",d.classList.add("cw-module-window"),Object.assign(d.style,Ge,{right:"auto",left:"50%",width:"760px",height:"680px",display:"flex",flexDirection:"column",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let p={popup:d,googleLine:null};function _(){if(t=!He(d),De(t,d,"cw-btn-broadcast"),t){ke();let b=document.getElementById("cw-btn-broadcast");b&&b.classList.remove("has-new"),n=null,i=null,r=!1,K()}else Te()}let w=Oe(d,be("headerTitle"),e,be("headerDesc"),p,()=>_()),E=w.querySelector("span");d.appendChild(w);let M=document.createElement("div");M.className="cw-bc-search-wrap";let A=document.createElement("div");A.className="cw-bc-search-icon",A.setAttribute("aria-hidden","true"),A.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>';let D=document.createElement("input");D.className="cw-bc-search-input no-drag",D.type="search",D.name="cw-broadcast-search",D.autocomplete="off",D.spellcheck=!1,D.placeholder=be("searchPlaceholder"),D.setAttribute("aria-label",be("searchPlaceholder"));let h=document.createElement("button");h.type="button",h.className="cw-bc-search-clear",h.setAttribute("aria-label",be("clearSearch")),h.innerHTML='<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';let q=document.createElement("div");q.className="cw-bc-search-field",q.append(A,D,h),M.appendChild(q),d.appendChild(M),D.addEventListener("input",b=>{o=b.target.value,h.classList.toggle("visible",o.length>0),ae()}),h.onclick=()=>{D.value="",o="",h.classList.remove("visible"),ae(),D.focus()};let $=document.createElement("div");$.className="cw-bc-body",d.appendChild($);let T=document.createElement("div");T.className="cw-nice-scroll cw-bc-feed",T.setAttribute("role","feed"),T.setAttribute("aria-label",be("headerTitle")),$.appendChild(T);let C=document.createElement("aside");C.className="cw-nice-scroll cw-bc-aside",C.setAttribute("aria-label",be("asideLabel")),$.appendChild(C);let I=document.createElement("div");I.id="cw-bau-widget",I.className="cw-bc-panel",I.style.display="none",C.appendChild(I);let k=document.createElement("div");k.className="cw-bc-panel",C.appendChild(k);let F=document.createElement("div");F.className="cw-bc-panel",C.appendChild(F);let j=document.createElement("div");j.id="cw-update-status",j.className="cw-bc-sync",j.setAttribute("role","status"),j.setAttribute("aria-live","polite"),C.appendChild(j);function z({syncing:b=!1,online:f=!0}={}){if(j.classList.toggle("offline",!b&&!f),b){j.innerHTML=`<span class="cw-bc-spinner" aria-hidden="true"></span><span>${be("syncing")}</span>`;return}let N=v?Xr(v):"",m=f?N?be("updatedAgo")(N):be("updated"):be("offline");j.innerHTML=`<span class="cw-bc-sync-dot" aria-hidden="true"></span><span>${m}</span>`}async function K(){z({syncing:!0});let b=!0,f=Ut();try{let[N,m]=await Promise.all([me.fetchContentModule("broadcast"),me.fetchContentModule("bau_availability")]);if(Array.isArray(N)){let P=N.map(li).filter(Boolean).filter(Z=>di(Z,f));l=le(P)}else b=!1;c=ci(m)}catch{b=!1}b&&(v=new Date().toISOString()),ie(),W(),ae(),z({online:b})}function ie(){let b=c?c.updatedAt:null;if(!(g===null)&&!t){let N=zt();(l.some(Z=>!g.has(Z.id)&&!N.includes(Z.id))||b&&b!==u)&&S.playNotification()}g=new Set(l.map(N=>N.id)),u=b}function le(b){return b.slice().sort((f,N)=>{let m=new Date(f.date).getTime()||0;return(new Date(N.date).getTime()||0)-m})}function W(){let b=document.getElementById("cw-btn-broadcast");if(!b)return;let f=zt();if(l.some(m=>!f.includes(m.id))){if(b.classList.add("has-new"),!b.querySelector(".cw-badge")){let m=document.createElement("div");m.className="cw-badge",Object.assign(m.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),b.appendChild(m)}}else{b.classList.remove("has-new");let m=b.querySelector(".cw-badge");m&&m.remove()}}function ee(){if(!c){I.style.display="none",I.innerHTML="";return}let b=Object.keys(Aa).filter(U=>c.segments[U]);if(!b.length){I.style.display="none",I.innerHTML="";return}let f=n&&b.includes(n)?n:b.includes(Ut())?Ut():b[0],N=Aa[f],m=c.segments[f]||{},P=(U,Q)=>`
          <span class="cw-bc-bau-date ${U}">
              ...
              <span class="cw-bc-bau-value">${Yr(Q)}</span>
                     ...
                     title="${be("swapTo")(Aa[de].label)}">${Ur}</button>`:"";I.style.display="flex",I.innerHTML=`
          ...
          ${c.note?`<div class="cw-bc-bau-note">${si(c.note)}</div>`:""}
      `;let O=I.querySelector(".cw-bc-bau-swap");O&&(O.onclick=()=>{n=de,S.playClick(),ee()})}function H(){let b={critical:0,info:0,success:0};l.forEach(m=>{b[m.type]=(b[m.type]||0)+1});let f=(m,P,Z)=>`
      ...
      `,F.querySelector(".cw-bc-history-divider").onclick=()=>{S.playClick(),r=!r,ae()},F.querySelector(".cw-bc-clear-btn").onclick=()=>{N&&(S.playSuccess(),pi(l.map(m=>m.id)),ae(),W())}}let R=0;function J(b,f){let N=document.createElement("article");N.className="cw-bc-card"+(f?" history":"");let m=io[b.type]?b.type:"info",P=`cw-bc-title-${++R}`;N.setAttribute("aria-labelledby",P);let Z=document.createElement("div");if(Z.className="cw-bc-card-meta",Z.innerHTML=`
        <span class="cw-bc-type">
            <span class="cw-bc-type-dot ${m}"></span>${be("typeLabel")[m]}
        </span>
        <span class="cw-bc-meta-sep" aria-hidden="true">\xB7</span>
        <span class="cw-bc-date-tag">${mi(b.date)}</span>
    `,!f){let U=document.createElement("button");U.type="button",U.className="cw-bc-dismiss-btn",U.setAttribute("aria-label",be("markRead")(b.title)),U.title=be("markReadShort"),U.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><polyline points="20 6 9 17 4 12"></polyline></svg>',U.onclick=Q=>{Q.stopPropagation(),S.playClick(),N.style.transform="translateX(20px)",N.style.opacity="0",setTimeout(()=>{let ne=zt();ne.push(b.id),pi(ne),ae(),W()},300)},Z.appendChild(U)}let de=document.createElement("h3");de.className="cw-bc-msg-title",de.id=P,de.textContent=b.title;let x=document.createElement("div");x.className="cw-bc-msg-body",x.innerHTML=si(b.text);let O=document.createElement("div");return O.className="cw-bc-msg-author",O.textContent=be("publishedBy")(b.author||be("system")),N.append(Z,de,x,O),N}function te(b,f){return i&&b.type!==i?!1:f?`${b.title||""} ${b.text||""}`.toLowerCase().includes(f):!0}function V(b,f){let N=b.filter(P=>!f.includes(P.id)),m=b.filter(P=>f.includes(P.id));if(!N.length&&!(r&&m.length)){let P=o.trim().length>0||i!==null,Z=document.createElement("div");Z.className="cw-bc-empty",Z.innerHTML=P?`<div>${be("nothingFound")}</div>`:`
               ...
               <div>${be("allRead")}</div>
              `,T.appendChild(Z);return}if(N.forEach(P=>T.appendChild(J(P,!1))),r&&m.length){let P=document.createElement("div");P.className="cw-bc-history-container",P.id="cw-bc-history",P.style.display="flex",m.forEach(Z=>P.appendChild(J(Z,!0))),T.appendChild(P)}}function ae(){ee(),H(),oe(),T.innerHTML="";let b=zt(),f=o.trim().toLowerCase();V(l.filter(N=>te(N,f)),b)}let s=me.getCachedContent("broadcast");Array.isArray(s)&&s.length?l=le(s.map(li).filter(Boolean).filter(b=>di(b,Ut()))):l=le(me.getCachedBroadcasts().map(Kr).filter(Boolean)),c=ci(me.getCachedContent("bau_availability")),ae(),K(),a||(a=setInterval(K,Hr));let y=document.createElement("div");Object.assign(y.style,rt),y.className="no-drag",d.appendChild(y),st(d,y),document.body.appendChild(d);let L=l.some(b=>!zt().includes(b.id));return Se(()=>{E&&(E.textContent=be("headerTitle"));let b=d.querySelector(".cw-help-title");b&&(b.textContent=be("headerTitle"));let f=d.querySelector(".cw-help-description");f&&(f.textContent=be("headerDesc")),D.placeholder=be("searchPlaceholder"),D.setAttribute("aria-label",be("searchPlaceholder")),h.setAttribute("aria-label",be("clearSearch")),T.setAttribute("aria-label",be("headerTitle")),C.setAttribute("aria-label",be("asideLabel")),ae(),z({online:!0})}),{toggle:_,hasUnread:L}}var bi="cw-wizard-shell-styles",fi={pt:{back:"Voltar",skip:"Pular",next:"Pr\xF3ximo",done:"Concluir",dotsGroup:"Navega\xE7\xE3o entre os slides",report:"Reportar bug ou sugest\xE3o",slideLabel:(e,t)=>`Slide ${e} de ${t}`,announce:(e,t,a,o)=>`Slide ${e} de ${t}: ${a}. ${o}`},es:{back:"Volver",skip:"Omitir",next:"Siguiente",done:"Finalizar",dotsGroup:"Navegaci\xF3n entre las diapositivas",report:"Reportar error o sugerencia",slideLabel:(e,t)=>`Diapositiva ${e} de ${t}`,announce:(e,t,a,o)=>`Diapositiva ${e} de ${t}: ${a}. ${o}`}};function xt(e){let t=se();return fi[t]?.[e]??fi.pt[e]}var hi=160,ro=320,Jr=()=>window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function Zr(){if(document.getElementById(bi))return;let e=document.createElement("style");e.id=bi,e.textContent=`
        .cw-wiz-overlay {
            --cw-wiz-swap: ${hi}ms;
            --cw-wiz-shell: ${ro}ms;
    ...
    `,document.head.appendChild(e)}function Ii(){let e="v2.0",t=!1,a="general",o="",n=null,i=null;ns();let r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,Ge,{right:"auto",left:"50%",width:"620px",height:"680px",maxHeight:"90vh",transform:"translateX(-50%) scale(0.05)"});let l={popup:r},c=Oe(r,pe("headerTitle"),e,pe("headerDesc"),l,()=>ae());r.appendChild(c);let g=c.querySelector("span"),u=document.createElement("div");u.className="cw-lib-container",r.appendChild(u);let v=document.createElement("div");v.className="cw-lib-toolbar";let d=document.createElement("div");d.className="cw-lib-search-wrap";let p=document.createElement("div");p.className="cw-lib-search-icon",p.innerHTML=$e.search;let _=document.createElement("input");_.className="cw-lib-search no-drag",_.placeholder=pe("searchPlaceholder"),_.type="text";let w=document.createElement("div");w.className="cw-lib-search-clear cw-tactile",w.innerHTML=$e.clear,d.append(p,_,w);let E=document.createElement("div");E.className="cw-lib-tabs",co.forEach(s=>{let y=document.createElement("div");y.className="cw-lib-tab"+(s.id===a?" active":""),y.id=`lib-tab-${s.id}`,y.innerHTML=`${s.icon}<span class="js-lib-tab-label">${pe("tabs")[s.id]}</span>`,y.onmouseenter=()=>S.playHover(),y.onclick=()=>z(s.id),E.appendChild(y)}),v.append(d,E),u.appendChild(v);let M=document.createElement("div");M.className="cw-lib-grid",u.appendChild(M);let A=document.createElement("div");A.className="cw-lib-fab cw-tactile",A.title=pe("newItem"),A.innerHTML=$e.add,A.onclick=()=>oe(),u.appendChild(A);let D=document.createElement("div");D.className="cw-lib-sheet";let h=document.createElement("div");h.className="cw-lib-sheet-handle";let q=document.createElement("div");q.className="cw-lib-sheet-head";let $=document.createElement("div");$.className="cw-lib-sheet-back no-drag",$.innerHTML=$e.back,$.title=pe("cancel"),$.onclick=R;let T=document.createElement("span");T.className="cw-lib-sheet-title",T.textContent=pe("newItemTitle"),q.append($,T);let C=document.createElement("div");C.className="cw-lib-sheet-body";let I=document.createElement("div");I.className="cw-lib-sheet-foot";let k=document.createElement("button");k.className="cw-lib-save-btn no-drag",k.textContent=pe("save"),k.onclick=J,I.appendChild(k);let F=document.createElement("div");F.className="cw-lib-loading",F.innerHTML=`<div class="cw-lib-spinner"></div><div class="cw-lib-loading-text js-lib-saving">${pe("saving")}</div>`,D.append(h,q,C,I,F),u.appendChild(D);let j=document.createElement("div");Object.assign(j.style,rt),j.className="no-drag",r.appendChild(j),st(r,j),document.body.appendChild(r),document.addEventListener("mousedown",s=>{i&&!i.contains(s.target)&&K()});function z(s){S.playClick(),a=s,co.forEach(y=>{document.getElementById(`lib-tab-${y.id}`).classList.toggle("active",y.id===s)}),W()}function K(){if(i){let s=i.querySelector(".cw-lib-menu");s&&s.classList.remove("open"),i.classList.remove("menu-open"),i=null}}function ie(s,y){return y?`${s.title} ${s.content}`.toLowerCase().includes(y):!0}function le(s){let y=document.createElement("div");y.className="cw-lib-recent-section",y.innerHTML=`<div class="cw-lib-recent-title">${pe("recentlyUsed")}</div>`;let L=document.createElement("div");return L.className="cw-lib-recent-row",s.forEach(b=>{let f=document.createElement("div");f.className="cw-lib-recent-chip",f.tabIndex=0,f.setAttribute("role","button"),f.title=b.title,f.innerHTML=`<span>${V(b.title)}</span>`,f.onclick=()=>{S.playClick(),H(b)},f.addEventListener("keydown",N=>{(N.key==="Enter"||N.key===" ")&&(N.preventDefault(),f.click())}),L.appendChild(f)}),y.appendChild(L),y}function W(){K(),M.innerHTML="";let s=o.trim().toLowerCase(),y=Re.getSnippets(a).filter(L=>ie(L,s));if(!s){let L=os(a);L.length>0&&M.appendChild(le(L))}if(y.length===0){let L=document.createElement("div");L.className="cw-lib-empty";let b=s.length>0;L.innerHTML=`
            ...
            `,M.appendChild(L);return}y.forEach(L=>M.appendChild(ee(L)))}function ee(s){let y=document.createElement("div");y.className="cw-lib-card"+(s.isCode?" is-code":"");let L=s.content,b="";if(s.isRich){let P=document.createElement("div");P.innerHTML=s.content;let Z=!!P.querySelector("img");L=P.innerText.substring(0,200),Z&&(b=`<span class="cw-lib-media-tag">${$e.media} M\xEDdia</span>`)}let f=[s.isCode?'<span class="cw-lib-badge code">CODE</span>':"",a==="email"?'<span class="cw-lib-badge template">TEMPLATE</span>':""].join("");y.innerHTML=`
    ...
    `,document.head.appendChild(t)}function _i(e,t){cs(t);let a=document.createElement("div");a.className="cw-configs-section",a.innerHTML=`
    ...
    `,!document.getElementById("cw-lang-toggle-styles")){let k=document.createElement("style");k.id="cw-lang-toggle-styles",k.innerHTML=`
        ...
        `,document.head.appendChild(k)}let w=_.querySelector("#cw-config-lang-toggle");function E(){w.querySelectorAll("button").forEach(k=>{k.classList.toggle("active",k.dataset.lang===se())})}E(),w.querySelectorAll("button").forEach(k=>{k.onclick=()=>{Da(k.dataset.lang),S.playClick()}}),g.appendChild(_);let M=_i(e,o);g.appendChild(M);let A=document.createElement("div");A.className="cw-configs-section",A.innerHTML=`
  ...
  `,document.head.appendChild(e)};var yt={steps:[{id:0,title:"Selecione o tipo de atendimento",isBranching:!0},{id:1,title:"Contexto e Valida\xE7\xE3o",fields:[{id:"advName",name:"advName",label:"Nome do Anunciante",type:"text",placeholder:"Nome do Anunciante",required:!0,isSmart:!0},{id:"cid",name:"cid",label:"CID",type:"text",placeholder:"000-000-0000",required:!0,isSmart:!0,tooltip:"Use o formato 000-000-0000 ou 10 d\xEDgitos",validation:{regex:"^(\\d{3}-\\d{3}-\\d{4}|\\d{10})$",error:"Formato de CID incorreto"}},{id:"amName",name:"amName",label:"Account Manager (AM)",type:"text",placeholder:"Nome do AM",required:!0,isSmart:!0},{id:"website",name:"website",label:"Website",type:"text",placeholder:"https://www.exemplo.com",required:!0,isSmart:!0},{id:"seId",name:"seId",label:"Speakeasy ID (SE ID)",type:"text-with-button",placeholder:"Speakeasy ID",required:!1,isSmart:!0,button:{id:"bau-top-se-search",icon:"wand",title:"Buscar ID automaticamente"}}]},{id:2,title:"Tasks",fields:[{id:"reason",name:"reason",label:"O que deve ser feito em BAU",type:"textarea",placeholder:"Descreva as a\xE7\xF5es esperadas...",required:!0,style:{minHeight:"80px"}},{id:"taskType",name:"taskType",label:"Tasks para BAU (Selecione 1 ou mais)",type:"checkbox-grid",required:!0,tooltip:"Selecione os tipos de implementa\xE7\xE3o t\xE9cnica",options:["Ads Conversion Tracking","Ads Dynamic Remarketing","Ads Enhanced Conversions","Ads Website Call Conversion","Ads Remarketing","Analytics Cross Domain Tracking","Analytics E-Commerce Tracking","Analytics Enhanced E-Commerce Tracking","Analytics Event Tracking","Analytics Health Check","Analytics Remarketing","Analytics Setup","Fix GA4 implementation","Consent Mode","Fix Sitewide Tagging (OGT & CT)","Google Tag Manager Installation","Customer Match"]}]},{id:3,title:"Justificativa e Agendamento",fields:[{id:"nonImplementationReason",name:"nonImplementationReason",label:"Motivo da N\xE3o Implementa\xE7\xE3o (Justificativa BAU)",type:"select",required:!0,options:[{value:"",text:"Selecione um motivo..."},{value:"Tempo da consultoria esgotado",text:"Tempo da consultoria esgotado"},{value:"Solicita\xE7\xE3o de reagendamento pelo anunciante",text:"Solicita\xE7\xE3o de reagendamento pelo anunciante"},{value:"Falta de acessos ou backup do site",text:"Falta de acessos ou backup do site"},{value:"Anunciante indispon\xEDvel ou n\xE3o preparado",text:"Anunciante indispon\xEDvel ou n\xE3o preparado"},{value:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)",text:"Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)"},{value:"Solicita\xE7\xE3o de tarefas (tasks) adicionais",text:"Solicita\xE7\xE3o de tarefas (tasks) adicionais"},{value:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)",text:"Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)"},{value:"Retorno de contato ap\xF3s prazo de 14 dias expirado",text:"Retorno de contato ap\xF3s prazo de 14 dias expirado"}]},{id:"description",i18nKey:"description_justificativa",name:"description",label:"Justificativa / Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva detalhadamente o que precisa ser feito...",required:!0},{id:"availability",name:"availability",label:"Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",type:"datetime-group",required:!0,fields:[{name:"availability_1",label:"Op\xE7\xE3o 1 (Prioridade)",required:!0},{name:"availability_2",label:"Op\xE7\xE3o 2 (Opcional)",required:!1},{name:"availability_3",label:"Op\xE7\xE3o 3 (Opcional)",required:!1}]}]},{id:4,title:"Confirma\xE7\xE3o",isConfirmation:!0},{id:5,title:"Solicitar Descarte",fields:[{id:"caseId",name:"caseId",label:"Case ID",type:"text",placeholder:"Case ID",required:!0,isSmart:!0},{id:"language",name:"language",label:"Idioma",type:"text",placeholder:"Idioma",required:!0,isSmart:!0},{id:"seId",i18nKey:"seId_descarte",name:"seId",label:"Speakeasy ID (SE ID)",type:"text",placeholder:"Speakeasy ID",required:!0,isSmart:!0},{id:"description",i18nKey:"description_descarte",name:"description",label:"Descri\xE7\xE3o",type:"textarea",placeholder:"Descreva o motivo do descarte...",required:!0},{id:"discardReason",name:"reason",label:"Motivo do Descarte",type:"select",required:!0,groups:[{label:"Live Appointments",options:[{value:"Caso Filho gerado no atendimento",text:"Caso Filho gerado no atendimento"},{value:"3\xAA Tentativa de contato sem sucesso",text:"3\xAA Tentativa de contato sem sucesso"}]},{label:"Live Meet",options:[{value:"Apenas o AM presente",text:"Apenas o AM presente"},{value:"Estouro de tempo para conclus\xE3o",text:"Estouro de tempo para conclus\xE3o"},{value:"Gera\xE7\xE3o de caso BAU (Reagendamento)",text:"Gera\xE7\xE3o de caso BAU (Reagendamento)"}]}]}]}]};var ps={advName:{label:"Nombre del Anunciante",placeholder:"Nombre del Anunciante"},cid:{label:"CID",placeholder:"000-000-0000",tooltip:"Usa el formato 000-000-0000 o 10 d\xEDgitos",error:"Formato de CID incorrecto"},amName:{label:"Account Manager (AM)",placeholder:"Nombre del AM"},website:{label:"Website",placeholder:"https://www.ejemplo.com"},seId:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID",buttonTitle:"Buscar ID autom\xE1ticamente"},seId_descarte:{label:"Speakeasy ID (SE ID)",placeholder:"Speakeasy ID"},reason:{label:"Qu\xE9 debe hacerse en BAU",placeholder:"Describe las acciones esperadas..."},taskType:{label:"Tareas para BAU (Selecciona 1 o m\xE1s)",tooltip:"Selecciona los tipos de implementaci\xF3n t\xE9cnica"},nonImplementationReason:{label:"Motivo de la No Implementaci\xF3n (Justificaci\xF3n BAU)"},description_justificativa:{label:"Justificaci\xF3n / Descripci\xF3n",placeholder:"Describe detalladamente qu\xE9 se necesita hacer..."},availability:{label:"Disponibilidad (m\xEDnimo 1 opci\xF3n)"},availability_1:{label:"Opci\xF3n 1 (Prioridad)"},availability_2:{label:"Opci\xF3n 2 (Opcional)"},availability_3:{label:"Opci\xF3n 3 (Opcional)"},caseId:{label:"Case ID",placeholder:"Case ID"},language:{label:"Idioma",placeholder:"Idioma"},description_descarte:{label:"Descripci\xF3n",placeholder:"Describe el motivo del descarte..."},discardReason:{label:"Motivo del Descarte"}},us={"Selecione um motivo...":"Selecciona un motivo...","Tempo da consultoria esgotado":"Tiempo de la consultor\xEDa agotado","Solicita\xE7\xE3o de reagendamento pelo anunciante":"Solicitud de reprogramaci\xF3n por parte del anunciante","Falta de acessos ou backup do site":"Falta de accesos o copia de seguridad del sitio","Anunciante indispon\xEDvel ou n\xE3o preparado":"Anunciante no disponible o no preparado","Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)":"Implementaci\xF3n parcial (no todas las tareas completadas)","Solicita\xE7\xE3o de tarefas (tasks) adicionais":"Solicitud de tareas adicionales","Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)":"Necesidad de nuevos cambios (fase de seguimiento)","Retorno de contato ap\xF3s prazo de 14 dias expirado":"Retorno de contacto despu\xE9s de vencido el plazo de 14 d\xEDas","Caso Filho gerado no atendimento":"Caso Hijo generado en la atenci\xF3n","3\xAA Tentativa de contato sem sucesso":"3.\xBA intento de contacto sin \xE9xito","Apenas o AM presente":"Solo el AM presente","Estouro de tempo para conclus\xE3o":"Tiempo excedido para la conclusi\xF3n","Gera\xE7\xE3o de caso BAU (Reagendamento)":"Generaci\xF3n de caso BAU (Reprogramaci\xF3n)"};function ms(e){return e?.i18nKey||e?.id||e?.name}function Xe(e,t){let a=e?.[t];return se()!=="es"?a:ps[ms(e)]?.[t]??a}function at(e){return se()!=="es"?e:us[e]??e}var Oi={pt:{statusPending:"Aguardando TL",statusApproved:"Aprovado / Criado",statusDiscarded:"Descartado pelo TL",statusCanceled:"Cancelado",statusDefault:"Pendente",timezoneWarningStrong:"Aten\xE7\xE3o:",timezoneWarningText:"Para clientes fora do fuso hor\xE1rio do Brasil, o hor\xE1rio inserido deve corresponder sempre ao hor\xE1rio local do cliente, e n\xE3o ao do agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone n\xE3o encontrado.",headerTitle:"BAU Central",headerDesc:"Dashboard de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Fluxo completo para implementa\xE7\xF5es t\xE9cnicas e suporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Fluxo simplificado para casos que n\xE3o requerem implementa\xE7\xE3o.",back:"Voltar",next:"Pr\xF3ximo",configuringEdit:"Configurando Edi\xE7\xE3o...",loadDashboardError:"Erro ao carregar Dashboard. Verifique sua conex\xE3o.",copiedToClipboard:"Copiado para a \xE1rea de transfer\xEAncia!",noAdditionalContext:"Nenhum contexto adicional fornecido pelo agente.",notCaptured:"N\xE3o capturado",none:"Nenhuma",language:"Idioma",editPageWarning:"Aten\xE7\xE3o: Para editar as informa\xE7\xF5es, voc\xEA deve estar com a p\xE1gina deste Caso espec\xEDfico aberta no sistema. Caso contr\xE1rio, os dados capturados estar\xE3o incorretos.",onCorrectPage:"Estou na p\xE1gina correta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso criado, mas n\xE3o conseguimos confirmar por email.",unknownError:"Erro desconhecido",newBauCase:"Novo Caso BAU",backToDashboard:"Voltar ao Dashboard",confirmDataBeforeSending:"Confirme os dados antes de enviar",submitToTl:"Enviar para o TL",saveChanges:"Salvar Altera\xE7\xF5es",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Preencha os detalhes abaixo",caseSentSuccess:"Caso enviado com sucesso!",caseSentSuccessSub:"Sua solicita\xE7\xE3o foi recebida e ser\xE1 processada em breve.",genericErrorTitle:"Ops! Algo deu errado",genericErrorSub:"N\xE3o conseguimos carregar seus casos BAU no momento.",tryAgain:"Tentar Novamente",notInformed:"N\xE3o informado",reasonTooltip:"O que deve ser feito em BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Aguardando TL",caseDetailsTitle:"Detalhes do Caso",copy:"Copiar",advertiser:"Anunciante",status:"Status",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email do Anunciante",site:"Site",timezone:"Timezone",responsibleAm:"AM Respons\xE1vel",salesProgram:"Programa de Vendas",bauReason:"Motivo BAU",requestedTasks:"Tasks solicitadas",justification:"Justificativa",detailedDescription:"Descri\xE7\xE3o detalhada",availability:"Disponibilidade",urgent:"Urgente",undefinedName:"Nome indefinido",customerIdTooltip:"Customer ID do Anunciante",cidTooltip:"CID do Anunciante (Formato: 000-000-0000)",incompleteData:"Dados Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contate o Suporte",editRequest:"Editar Solicita\xE7\xE3o",edit:"Editar",refresh:"Atualizar",noRecentCases:"Nenhum caso recente",casesWillAppear:"Seus casos BAU aparecer\xE3o aqui",createdApproved:"Criados / Aprovados",refreshDashboard:"Atualizar Dashboard",errorPrefix:e=>`Erro: ${e}`,selectAtLeastOne:e=>`Erro: Selecione pelo menos uma op\xE7\xE3o para "${e}".`,fieldRequiredDouble:e=>`Erro: O campo "${e}" \xE9 obrigat\xF3rio.`,fieldRequiredSingle:e=>`Erro: O campo '${e}' \xE9 obrigat\xF3rio.`,whatMustBeDone:"O que deve ser feito",editTasksHint:"Para editar as tasks, volte ao Passo 2",bauJustification:"Justificativa BAU",description:"Descri\xE7\xE3o",availabilityPriority:"Disponibilidade (Prioridade)",editingCaseHash:e=>`Voc\xEA est\xE1 editando o caso #${e}`,editingDiscardHash:e=>`Voc\xEA est\xE1 editando o descarte do caso #${e}`,discardReason:"Motivo do Descarte",discardDescription:"Descri\xE7\xE3o do Descarte",notInformedPlaceholder:"N\xE3o informado",caseUpdatedSuccess:"Caso atualizado com sucesso!",caseDiscardSentSuccess:"Caso enviado para descarte com sucesso!"},es:{statusPending:"Esperando al TL",statusApproved:"Aprobado / Creado",statusDiscarded:"Descartado por el TL",statusCanceled:"Cancelado",statusDefault:"Pendiente",timezoneWarningStrong:"Atenci\xF3n:",timezoneWarningText:"Para clientes fuera del huso horario de Brasil, el horario ingresado siempre debe corresponder al horario local del cliente, no al del agente.",checkTimezone:"Consultar Time Zone",timezoneModuleNotFound:"M\xF3dulo Time Zone no encontrado.",headerTitle:"BAU Central",headerDesc:"Panel de Casos BAU",openBauCase:"Abrir caso para BAU",openBauCaseDesc:"Flujo completo para implementaciones t\xE9cnicas y soporte especializado.",requestDiscard:"Solicitar Descarte",requestDiscardDesc:"Flujo simplificado para casos que no requieren implementaci\xF3n.",back:"Volver",next:"Siguiente",configuringEdit:"Configurando Edici\xF3n...",loadDashboardError:"Error al cargar el Panel. Verifica tu conexi\xF3n.",copiedToClipboard:"\xA1Copiado al portapapeles!",noAdditionalContext:"Ning\xFAn contexto adicional proporcionado por el agente.",notCaptured:"No capturado",none:"Ninguna",language:"Idioma",editPageWarning:"Atenci\xF3n: Para editar la informaci\xF3n, debes tener abierta en el sistema la p\xE1gina de este Caso espec\xEDfico. De lo contrario, los datos capturados estar\xE1n incorrectos.",onCorrectPage:"Estoy en la p\xE1gina correcta",sending:"Enviando...",caseCreatedNoEmailConfirm:"Caso creado, pero no pudimos confirmar por email.",unknownError:"Error desconocido",newBauCase:"Nuevo Caso BAU",backToDashboard:"Volver al Panel",confirmDataBeforeSending:"Confirma los datos antes de enviar",submitToTl:"Enviar al TL",saveChanges:"Guardar Cambios",editingCase:e=>`Editando Caso #${e}`,fillDetailsBelow:"Completa los detalles a continuaci\xF3n",caseSentSuccess:"\xA1Caso enviado con \xE9xito!",caseSentSuccessSub:"Tu solicitud fue recibida y ser\xE1 procesada en breve.",genericErrorTitle:"\xA1Ups! Algo sali\xF3 mal",genericErrorSub:"No pudimos cargar tus casos BAU en este momento.",tryAgain:"Intentar de Nuevo",notInformed:"No informado",reasonTooltip:"Qu\xE9 debe hacerse en BAU",reasonPrefix:"Motivo:",metricAwaitingTl:"Esperando al TL",caseDetailsTitle:"Detalles del Caso",copy:"Copiar",advertiser:"Anunciante",status:"Estado",cidLabel:"CID",caseIdLabel:"Case ID",speakeasyId:"Speakeasy ID",advertiserEmail:"Email del Anunciante",site:"Sitio",timezone:"Timezone",responsibleAm:"AM Responsable",salesProgram:"Programa de Ventas",bauReason:"Motivo BAU",requestedTasks:"Tareas solicitadas",justification:"Justificaci\xF3n",detailedDescription:"Descripci\xF3n detallada",availability:"Disponibilidad",urgent:"Urgente",undefinedName:"Nombre indefinido",customerIdTooltip:"Customer ID del Anunciante",cidTooltip:"CID del Anunciante (Formato: 000-000-0000)",incompleteData:"Datos Incompletos",invalidCid:"CID Inv\xE1lido",contactSupport:"Contacta al Soporte",editRequest:"Editar Solicitud",edit:"Editar",refresh:"Actualizar",noRecentCases:"Ning\xFAn caso reciente",casesWillAppear:"Tus casos BAU aparecer\xE1n aqu\xED",createdApproved:"Creados / Aprobados",refreshDashboard:"Actualizar Panel",errorPrefix:e=>`Error: ${e}`,selectAtLeastOne:e=>`Error: Selecciona al menos una opci\xF3n para "${e}".`,fieldRequiredDouble:e=>`Error: El campo "${e}" es obligatorio.`,fieldRequiredSingle:e=>`Error: El campo '${e}' es obligatorio.`,whatMustBeDone:"Qu\xE9 debe hacerse",editTasksHint:"Para editar las tareas, vuelve al Paso 2",bauJustification:"Justificaci\xF3n BAU",description:"Descripci\xF3n",availabilityPriority:"Disponibilidad (Prioridad)",editingCaseHash:e=>`Est\xE1s editando el caso #${e}`,editingDiscardHash:e=>`Est\xE1s editando el descarte del caso #${e}`,discardReason:"Motivo del Descarte",discardDescription:"Descripci\xF3n del Descarte",notInformedPlaceholder:"No informado",caseUpdatedSuccess:"\xA1Caso actualizado con \xE9xito!",caseDiscardSentSuccess:"\xA1Caso enviado a descarte con \xE9xito!"}};function B(e){let t=se();return Oi[t]?.[e]??Oi.pt[e]}var Ae={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="none"><path class="bau-check-path" d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>',expand:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"/></svg>',edit:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>'};function Di(e){switch(e){case"PENDING_TL_CREATION":return{text:B("statusPending"),class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:B("statusApproved"),class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:B("statusDiscarded"),class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:B("statusCanceled"),class:"status-gray",aura:""};default:return{text:e||B("statusDefault"),class:"status-gray",aura:""}}}function zi(e){let t=document.createElement("div");if(t.className="bau-dynamic-input",t.id=`wrapper-${e.id}`,e.label){let o=document.createElement("label");o.className="bau-label",o.textContent=Xe(e,"label"),e.tooltip&&o.setAttribute("data-tooltip",Xe(e,"tooltip")),t.appendChild(o)}let a;switch(e.type){case"textarea":a=document.createElement("textarea"),a.style.minHeight="80px",t.appendChild(a);break;case"select":a=document.createElement("select"),e.groups?e.groups.forEach(r=>{let l=document.createElement("optgroup");l.label=r.label,r.options.forEach(c=>{let g=document.createElement("option");g.value=c.value,g.textContent=at(c.text),l.appendChild(g)}),a.appendChild(l)}):e.options&&e.options.forEach(r=>{let l=document.createElement("option");l.value=r.value,l.textContent=at(r.text),a.appendChild(l)}),t.appendChild(a);break;case"checkbox-grid":return a=document.createElement("div"),a.className="bau-tasks-grid",e.options.forEach(r=>{let l=document.createElement("label");l.className="bau-task-item",l.innerHTML=`<input type="checkbox" name="${e.name}" value="${r}"><span>${r}</span>`,l.addEventListener("click",c=>{c.preventDefault();let g=l.querySelector("input");g.checked=!g.checked,l.classList.toggle("active",g.checked),S.playClick()}),a.appendChild(l)}),t.appendChild(a),t;case"datetime-group":a=document.createElement("div"),a.className="bau-availability-container",e.fields.forEach(r=>{let l=document.createElement("div");l.className="bau-availability-field",l.innerHTML=`
    ...
    `,d.appendChild(k),document.body.appendChild(c);function F(s){t=s,c.querySelectorAll(".bau-view").forEach(N=>N.classList.remove("active"));let y=c.querySelector(`#bau-view-${s}`);y&&y.classList.add("active");let L=v.querySelector(".cw-module-header-title")||v.querySelector("h2"),b=v.querySelector(".cw-module-header-subtitle")||v.querySelector("p");L&&(s==="form"?L.textContent=i?B("editingCase")(r):B("newBauCase"):L.textContent=B("headerTitle")),b&&(b.textContent=B(s==="form"?"fillDetailsBelow":"headerDesc"));let f=q.querySelector(".bau-btn-submit");f&&(f.innerHTML=i?`${Ae.send} ${B("saveChanges")}`:`${Ae.send} ${B("submitToTl")}`)}function j(){let s=c.querySelector("#bau-case-list-container"),y=c.querySelector("#bau-dashboard-metrics");y&&(y.innerHTML=`
        ...
        `).join(""))}async function z(){let s=c.querySelector("#bau-case-list-container"),y=c.querySelector("#bau-dashboard-metrics");if(!(!s||!y)){j();try{let L=await So();if(!Array.isArray(L))throw new Error("API response is not a valid array");le(L)}catch(L){console.error("Critical Error loading BAU cases:",L),y&&(y.innerHTML=""),s.innerHTML=`
            ...
            `,c.querySelector("#bau-retry-btn")?.addEventListener("click",()=>z()),S.playError(),X(B("loadDashboardError"),{error:!0})}}}function K(s){if(!s)return;let y=Di(s.status),L=(f,N)=>{navigator.clipboard.writeText(f).then(()=>{X(B("copiedToClipboard")),S.playClick();let m=N.style.color;N.style.color="#1E8E3E",setTimeout(()=>{N.style.color=m},800)})};p.innerHTML=`
        ...
        `;let b=p.querySelector(".bau-details-close-btn");b.onclick=()=>{p.classList.remove("active"),S.playSwoosh(),setTimeout(()=>{p.style.display="none"},600)},p.querySelectorAll(".bau-copy-btn").forEach(f=>{f.onclick=N=>{let m=N.target.closest(".bau-details-row").querySelector(".bau-details-value").textContent;L(m,f)}}),p.style.display="flex",requestAnimationFrame(()=>{p.classList.add("active"),S.playClick()})}function ie(s){if(!s)return"";let y=Di(s?.status),L=la(s?.date),b="",f="";if(s?.status==="PENDING_TL_CREATION"&&s?.availability_1){let de=new Date(s.availability_1),x=new Date;(de<=x||de-x<36e5*2)&&(b=`<span class="bau-sla-badge">${B("urgent")}</span>`,f="bau-pulse-attention")}let N=s?.reason&&s.reason.trim()?s.reason:B("noAdditionalContext"),P=/^(\d{3}-\d{3}-\d{4}|\d{10})$/.test(s?.cid||""),Z=!s?.caseId||s.caseId==="N/A"||!P;return Z&&s?.status==="PENDING_TL_CREATION"&&(f="bau-pulse-attention"),`
