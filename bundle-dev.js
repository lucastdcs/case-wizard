...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var St={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ht={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Gt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Ie=t=>new Promise(e=>setTimeout(e,t));async function Wo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Ie(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let s=Math.floor(Math.random()*60)+30;a===0&&(s=150),a>e.length-3&&(s=30),await Ie(s)}await Ie(600),o&&(o.style.display="none")}async function Ct(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Ie(200);let e=await Nt(),o=Rt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),s=t.querySelector("#p3"),r=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),s&&(s.textContent=o.suffix),await Ie(300);let l=a?a.querySelector("svg"):null;if(l&&(l.style.opacity="1",l.style.transform="scale(1)"),await Ie(400),n&&(n.style.opacity="1"),G.playStartup(),i&&await Wo(i,o.name),s&&(s.style.opacity="1",s.style.transform="translateY(0)"),o.isFriday&&r){await Ie(400),r.style.display="block",r.offsetWidth;let p=r.querySelector(".sextou-badge");p&&(p.style.opacity="1",p.style.transform="scale(1)")}await Ie(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Ie(900),t.parentNode&&t.parentNode.removeChild(t)}}function jt(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,s=a-e.height-n,r=parseFloat(t.style.left)||e.left,l=parseFloat(t.style.top)||e.top,p=Math.max(n,Math.min(r,i)),d=Math.max(n,Math.min(l,s));if(p!==r||d!==l){let c=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${p}px`,t.style.top=`${d}px`,setTimeout(()=>{t.style.transition=c},300)}}var Ae={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Te(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,s=a.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),l=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),p=i,d=s,c=!1;function x(u){p=u.clientX,d=u.clientY,c||(window.requestAnimationFrame(()=>{b(),c=!1}),c=!0)}function b(){let u=r+(p-i),v=l+(d-s);u>360&&(t.style.width=u+"px"),v>300&&(t.style.height=v+"px")}function g(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",g),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",g)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Vt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Ut(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Wt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function xe(t,e={}){return new Promise(o=>{let a=Ut(),n=Wt(),i=e.danger?"#FF3B30":"#007AFF",s=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let r=d=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(d)},300)},l=n.querySelector("#cw-conf-cancel"),p=n.querySelector("#cw-conf-ok");[l,p].forEach(d=>d.onmouseenter=()=>G.playHover()),l.onclick=()=>{G.playClick(),r(!1)},p.onclick=()=>{G.playClick(),r(!0)}})}function Yt(t,e=""){return new Promise(o=>{let a=Ut(),n=Wt();n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let x=p.querySelector(".cw-hero-grid"),b=p.querySelector(".cw-acc-container"),g=p.querySelector(".cw-results-container"),u=p.querySelector(".cw-search-input"),v=p.querySelector(".cw-status-bar"),w=p.querySelector(".cw-status-text"),R=p.querySelector(".cw-footer-icons");s.forEach(([q,F])=>{let z=i(F.name),O=document.createElement("div");O.className="cw-hero-card",O.id=`hero-${q}`,O.style.setProperty("--hero-color",z.color),O.innerHTML=`
        ...
        `,O.onclick=k=>{if(k.target.closest(".cw-step-btn"))return;let T=a[q]?a[q].count:0;D(q,T>0?-T:1,F)},O.querySelector(".minus").onclick=()=>D(q,-1,F),O.querySelector(".plus").onclick=()=>D(q,1,F),O.dataset.color=z.color,x.appendChild(O)});function _(q,F){let z=i(F.name),O=document.createElement("div");return O.className="cw-task-item",O.dataset.id=q,O.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(u,v)=>{G.playClick(),a.querySelector(`.${u}`).classList.toggle("active"),v()};if(a.querySelector(".notes").onclick=u=>{u.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=u=>{u.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=u=>{u.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=u=>{u.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=u=>{u.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=u=>{u.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=u=>{u.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=u=>{u.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=u=>{u.stopPropagation(),i("broadcast",()=>{let v=u.currentTarget.querySelector(".cw-badge");v&&v.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(u=>{u.addEventListener("mouseenter",()=>G.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let u=document.createElement("div");u.className="cw-badge",a.querySelector(".broadcast").appendChild(u)}let s=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(s=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{s&&clearTimeout(s)},(async function(){let v=()=>{let R=Ee();if(R){let _=R.split("@")[0].toLowerCase();if(ct.includes(_)){let D=a.querySelector("#cw-admin-tag");D&&D.classList.add("visible")}}else setTimeout(v,2e3)};v(),await dt(2800),a.classList.add("docked"),await dt(300);let w=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(R=>R.classList.add("visible"));for(let R=0;R<w.length;R++)w[R].classList.add("popped"),await dt(90);await dt(200),a.classList.add("system-check")})();let r=!1,l,p,d,c,x=3;a.onmousedown=u=>{if(u.target.closest("button"))return;u.preventDefault(),l=u.clientX,p=u.clientY;let v=a.getBoundingClientRect();d=v.left,c=v.top,document.addEventListener("mousemove",b),document.addEventListener("mouseup",g)};function b(u){let v=u.clientX-l,w=u.clientY-p;!r&&Math.sqrt(v*v+w*w)>x&&(r=!0,a.classList.add("dragging"),a.style.transition="none",s&&clearTimeout(s)),r&&(a.style.left=`${d+v}px`,a.style.top=`${c+w}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function g(u){if(document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",g),r){r=!1,a.classList.remove("dragging");let v=window.innerWidth,w=window.innerHeight,R=a.getBoundingClientRect(),_=R.left+R.width/2,D;_<v/2?(D=24,a.classList.remove("side-right"),a.classList.add("side-left")):(D=v-R.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let Y=Math.max(24,Math.min(R.top,w-R.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${D}px`,a.style.top=`${Y}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let v=a.querySelector(".cw-btn.active"),w=u.target.closest("button");if(a.classList.contains("collapsed")){let R=a.getBoundingClientRect(),_=window.innerHeight,D=R.top>_/2;if(a.style.setProperty("transition","none","important"),D){let Y=_-R.bottom;a.style.top="auto",a.style.bottom=`${Y}px`}else a.style.bottom="auto",a.style.top=`${R.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),G.playGenieOpen()}else!v&&!w&&(a.classList.add("collapsed"),G.playGenieOpen());w&&(w.style.transform="scale(0.9)",setTimeout(()=>w.style.transform="",150))}}}function Ze(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
`.replace(/\n/g,"<br>");Qe(q);let F=await gt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,q),mt(F),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var fe=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Fe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let d=e.getBoundingClientRect();s=d.left+d.width/2,r=d.top+d.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,p=i.y-r;t?(G.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof go=="function"&&go(e,o)):(G.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Lt=="function"&&Lt(e))}function go(t,e){Lt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Lt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function fo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Kt(t,J),s=ao(h),r=oo(()=>{T(),j.setActiveTasks(r.getCheckedElements())},h,j),l=document.createElement("div");l.style.display="none";let p=to((m,C)=>{y(m,C)});l.appendChild(p);let d=ro({onSaveCurrent:async()=>{let m=await M();return I(),m},onLoadDraft:m=>{U(m)},t:m=>h(m)}),c=F(),x=z(),b=document.createElement("div"),g=K(),u=A(d,h);o.appendChild(c),o.appendChild(x),o.appendChild(g),o.appendChild(l),o.appendChild(b),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let v=document.createElement("button");v.id="manual-task-toggle",v.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",v.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${N.primary}; background: ${N.surface}; color: ${N.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${re}; text-transform: uppercase; letter-spacing: 0.5px;`,v.onmouseenter=()=>{v.style.background=N.primaryBg},v.onmouseleave=()=>{v.style.background=N.surface},v.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",v.style.display="none"},o.appendChild(v),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(u);let w=document.createElement("div");w.style.display="none",w.style.flexGrow="1",w.style.minHeight="0",w.style.overflow="hidden";let R=po(()=>q());R.style.height="100%",w.appendChild(R),e.insertBefore(w,i);let _=a.lastElementChild;_&&(_.insertBefore(d.historyBtnWrapper,_.firstChild),_.insertBefore(V(),_.firstChild)),e.appendChild(d.drawer);let D=null;j.subscribe(m=>{W(m),Y(),m.isDirty?(D&&clearTimeout(D),D=setTimeout(async()=>{let C=await M(!0);C.subStatus?ge.saveEmergency(C):ge.clearEmergency(),m.isDirty=!1},2e3)):D&&(clearTimeout(D),D=null)});function Y(){let m=ge.getCount()>0,C=!!j.currentSubStatus;pt(m||C)}function J(){j.visible=!j.visible,ue(j.visible,e,"cw-btn-notes")}function q(){j.isSplitView=!j.isSplitView,j.isSplitView?(o.style.display="none",w.style.display="flex",w.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",w.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function F(){let m=document.createElement("div");if(m.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let E=document.createElement("style");E.id="cw-segmented-styles",E.innerHTML=`
            ...
            `,document.head.appendChild(E)}let C=(E,$)=>{let Z=m.querySelector(`#${E}`).querySelector(".cw-segmented-indicator");Z&&(Z.style.transform=`translateX(${$*100}%) translateX(${$*2}px)`)};return m.querySelectorAll("#lang-selector button").forEach((E,$)=>{E.onclick=()=>{j.setLanguage(E.dataset.lang),m.querySelectorAll("#lang-selector button").forEach(P=>P.classList.remove("active")),E.classList.add("active"),C("lang-selector",$),G.playHover(),j.currentSubStatus&&k(j.currentSubStatus)}}),m.querySelectorAll("#type-selector button").forEach((E,$)=>{E.onclick=()=>{j.setCaseType(E.dataset.type),m.querySelectorAll("#type-selector button").forEach(P=>P.classList.remove("active")),E.classList.add("active"),C("type-selector",$),G.playHover(),j.currentSubStatus&&k(j.currentSubStatus)}}),m.querySelectorAll("#portugal-selector button").forEach((E,$)=>{E.onclick=()=>{j.setPortugalCase(E.dataset.val==="true"),m.querySelectorAll("#portugal-selector button").forEach(P=>P.classList.remove("active")),E.classList.add("active"),C("portugal-selector",$),G.playHover(),j.currentSubStatus&&k(j.currentSubStatus)}}),m}function z(){let m=document.createElement("div");m.className="cw-status-section",m.style.cssText="display: flex; flex-direction: column; gap: 8px;",m.innerHTML=`
        ...
        `;let C=m.querySelector("#main-status-select"),E=m.querySelector("#sub-status-select");return C.onchange=()=>{j.setStatus(C.value),O(C.value,E),j.setSubStatus(""),k("")},E.onchange=()=>{j.setSubStatus(E.value),k(E.value)},m}function O(m,C){if(C.innerHTML=`<option value="">${h("select_substatus")}</option>`,!m){C.disabled=!0;return}for(let E in ke)if(ke[E].status===m){let $=document.createElement("option");$.value=E,$.textContent=ke[E].name,C.appendChild($)}C.disabled=!1}function k(m){if(p.render&&p.render(m,j.currentCaseType),!m){l.style.display="none",b.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",g.style.display="flex",g.style.opacity="1",u.style.display="none";return}g.style.opacity="0",setTimeout(()=>{j.currentSubStatus&&(g.style.display="none")},400),u.style.display="grid";let C=ke[m];C&&C.templateFields&&j.setActiveFields(C.templateFields),L(),At(m,b,j),b.style.display="block",l.style.display="block";let E=m.startsWith("SO_"),$=m==="NI_Awaiting_Validation",P=document.getElementById("manual-task-toggle");E||$?(r.selectionElement.style.display="block",P.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",P.style.display="block");let Z=m==="SO_Education_Only"?"education":"implementation";j.setScreenshotMode(Z),j.currentCaseType==="lm"?j.toggleFieldExclusion("field-ON_CALL",!0):j.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(m),T();let H=document.getElementById("email-automation-toggle-row");H&&(H.style.display=$e[m]?"flex":"none")}function T(){let m=r.getCheckedElements().map(C=>C.value);s.updateVisibility(j.currentSubStatus,m)}function y(m,C){let E=rt[m];if(E){for(let $ in E)if($==="linkedTask")r.toggleTask(E.linkedTask,C);else if($==="activeTasks")E.activeTasks.forEach(P=>{C?r.setTaskCount(P.value,P.count):r.setTaskCount(P.value,0)});else if($.startsWith("field-")){let P=$,Z=E[$],H=document.getElementById(P);if(H){let ee=He.includes(P.replace("field-",""));if(C)if(ee){let oe=H.value.trim();oe.includes(Z.trim())||(H.value=oe?oe+`
`+Z.trim():Z.trim())}else H.value=Z;else if(ee){let oe=H.value.trim(),Q=Z.trim();oe.includes(Q)&&(H.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else H.value.trim()===Z.trim()&&(H.value="");j.updateField(P,H.value),H.dispatchEvent(new Event("input"))}}}}function A(m,C){let E=document.createElement("div");if(E.className="cw-actions-section",E.style.cssText=`
            display: grid;
...
E-mail: ${C.clientEmail||"---"}`;$&&($.value=Z),P&&(P.style.display="block",P.style.maxHeight="300px",P.style.opacity="1",P.scrollIntoView({behavior:"smooth",block:"end"}))})}function b(){r=!r,ue(r,l,"cw-btn-script"),r?(c(),d||(d=setInterval(c,2e3))):d&&(clearInterval(d),d=null)}let g=pe(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",p,()=>{b()});l.appendChild(g);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `;let v=u.querySelector("#csa-toggle-options"),w=u.querySelector("#csa-options-content"),R=u.querySelector("#csa-options-arrow"),_=!1;v.onclick=()=>{_=!_,R.style.transform=_?"rotate(180deg)":"rotate(0deg)",w.style.maxHeight=_?"400px":"0",w.style.opacity=_?"1":"0",w.style.marginTop=_?"8px":"0",G.playClick()};let D=u.querySelector("#cw-pill-message"),Y=u.querySelector("#cw-am-copy-final"),J=u.querySelector("#cw-am-message-area");D.onmouseenter=()=>{D.style.borderColor="#007AFF",D.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},D.onmouseleave=()=>{D.style.borderColor="#DADCE0",D.style.boxShadow="0 1px 2px rgba(0,0,0,0.02)"},D.addEventListener("click",()=>{x()}),Y.addEventListener("click",()=>{J.value&&(navigator.clipboard.writeText(J.value),X("Mensagem copiada!"),G.playSuccess(),Y.style.background="#34A853",Y.textContent="Copiado!",setTimeout(()=>{Y.style.background="#1A73E8",Y.textContent="Copiar Mensagem Final"},2e3))});let q=(C,E)=>{let $=u.querySelector(C),P=u.querySelector(E);$.onclick=()=>{let Z=P.textContent;!Z||Z.includes("---")||Z.includes("N\xE3o encontrado")||(navigator.clipboard.writeText(Z),G.playSuccess(),$.classList.add("copied"),setTimeout(()=>$.classList.remove("copied"),1500))}};l.appendChild(u);let F=document.createElement("div");Object.assign(F.style,a.progressBarContainer);let z=document.createElement("div");z.className="csa-progress-fill",Object.assign(z.style,a.progressBarFill),F.appendChild(z),l.appendChild(F);let O=document.createElement("div");O.id="csa-content",Object.assign(O.style,a.contentArea),l.appendChild(O);let k=document.createElement("div");Object.assign(k.style,a.footer);let T=document.createElement("span");T.textContent="by lucaste@",Object.assign(T.style,{fontSize:"10px",color:"#bdc1c6"});let y=document.createElement("button");y.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> Resetar Script',Object.assign(y.style,a.resetBtn),y.onmouseenter=()=>y.style.background="#fce8e6",y.onmouseleave=()=>y.style.background="transparent",y.onclick=()=>{y.style.transform="scale(0.9)",setTimeout(()=>y.style.transform="scale(1)",150);for(let C in n)delete n[C];K()},k.appendChild(T),k.appendChild(y),l.appendChild(k);let A=document.createElement("div");Object.assign(A.style,{display:"flex",flexDirection:"column",gap:"8px",marginBottom:"16px"});let f=document.createElement("div");f.className="csa-segmented-control",f.innerHTML=`
  ...
  `,u.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},u.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(g),b.appendChild(u),x.appendChild(b),c.appendChild(x);let v=document.createElement("div");v.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",c.appendChild(v);let w=null;function R(){if(w)return;w=document.createElement("div"),w.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let T=document.createElement("div");T.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",T.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let y=document.createElement("button");y.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',y.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",y.onclick=()=>{D(),n=!1,F()},T.appendChild(y),w.appendChild(T);let A=document.createElement("div");A.id="cw-history-list",A.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",w.appendChild(A),c.appendChild(w)}function _(){w||R();let T=w.querySelector("#cw-history-list");T.innerHTML="";let y=na();y.length===0?T.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':y.forEach(A=>{let f=O(A,Be[A._originalCat],!0,A._originalCat);T.appendChild(f)}),requestAnimationFrame(()=>w.style.transform="translateY(0)")}function D(){w&&(w.style.transform="translateY(100%)")}function Y(){d.innerHTML="";let T=J("history","Recentes",Be.history);T.id="cw-sidebar-btn-history",T.onclick=()=>{G.playClick(),n=!n,n?_():D(),F()},d.appendChild(T);let y=document.createElement("div");y.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(y),Object.keys(et).forEach(A=>{let f=et[A],S=J(A,f.label,Be[A]);S.id=`cw-sidebar-btn-${A}`,S.onclick=()=>{G.playClick(),n&&(n=!1,D()),q(A)},d.appendChild(S)})}function J(T,y,A){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=y,f.dataset.key=T;let S=document.createElement("div");S.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",S.innerHTML=A||Be.tasks;let L=document.createElement("div");return L.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",L.textContent=y,f.appendChild(S),f.appendChild(L),f.onmouseenter=()=>{a!==T&&!(T==="history"&&n)&&(f.style.background="#F1F3F4",S.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==T&&!(T==="history"&&n)&&(f.style.background="transparent",S.style.transform="scale(1)")},f}function q(T){let y=document.getElementById(`cat-anchor-${T}`);y&&(y.scrollIntoView({behavior:"smooth",block:"start"}),a=T,F())}function F(){Object.keys(et).forEach(y=>{let A=d.querySelector(`#cw-sidebar-btn-${y}`);if(A)if(a===y&&!n){let f=ht[y];A.style.background=f.bg,A.style.color=f.color,A.querySelector("div:first-child").style.transform="scale(1.1)"}else A.style.background="transparent",A.style.color=i.textSecondary,A.querySelector("div:first-child").style.transform="scale(1)"});let T=d.querySelector("#cw-sidebar-btn-history");T&&(n?(T.style.background="#3C4043",T.style.color="#FFFFFF"):(T.style.background="transparent",T.style.color=i.textSecondary))}function z(){if(v.innerHTML="",e.trim()!==""){let y=[];if(Object.entries(et).forEach(([f,S])=>{let L=S.links.filter(I=>I.name.toLowerCase().includes(e.toLowerCase())||I.desc.toLowerCase().includes(e.toLowerCase()));y.push(...L.map(I=>({...I,_cat:f})))}),y.length===0){v.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let A=document.createElement("div");A.innerHTML="Resultados da busca",A.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",v.appendChild(A),y.forEach(f=>{let S=O(f,Be[f._cat],!1,f._cat);v.appendChild(S)});return}Object.entries(et).forEach(([y,A])=>{let f=ht[y],S=document.createElement("div"),L=document.createElement("div");L.id=`cat-anchor-${y}`,L.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,L.innerHTML=`
            ...
            ${A.label}
          `,S.appendChild(L);let I=document.createElement("div");I.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",A.links.forEach(M=>{let B=O(M,Be[y],!1,y);I.appendChild(B)}),S.appendChild(I),v.appendChild(S)});let T=document.createElement("div");T.style.height="80px",v.appendChild(T)}function O(T,y,A,f){let S=document.createElement("div"),L=ht[f]||ht.history;S.style.cssText=`
      ...
      `;let I=document.createElement("div");I.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,I.innerHTML=y||Be.tasks;let M=I.querySelector("svg");M&&(M.style.width="22px",M.style.height="22px");let B=document.createElement("div");B.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let U=document.createElement("div");U.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,U.textContent=T.name;let h=document.createElement("div");h.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,h.textContent=T.desc,B.appendChild(U),B.appendChild(h);let V=document.createElement("div");return V.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',V.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,V.title="Copiar URL",S.onmouseenter=()=>{S.style.transform="translateY(-2px)",S.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",S.style.borderColor="rgba(0,0,0,0.05)",S.style.borderLeft=`4px solid ${L.color}`,V.style.opacity="1",V.style.background="#F1F3F4"},S.onmouseleave=()=>{S.style.transform="translateY(0)",S.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",S.style.border="1px solid transparent",V.style.opacity="0",V.style.background="transparent"},S.onclick=()=>{!A&&f&&So(T,f),window.open(T.url,"_blank")},V.onclick=K=>{K.stopPropagation(),G.playClick(),navigator.clipboard.writeText(T.url),!A&&f&&So(T,f),X("Link copiado!")},S.appendChild(I),S.appendChild(B),S.appendChild(V),S}u.addEventListener("input",T=>{e=T.target.value,z()});function k(){o=!o,ue(o,s,"cw-btn-links")}return document.body.appendChild(s),Y(),z(),k}var _e=[];function qt(t){_e=t}var ia=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Eo(){let t="v4.9",e=!1,o=null,a=null;function n(f){if(!f)return"";try{let S=new Date(f);return isNaN(S.getTime())?String(f):S.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,g.querySelectorAll('input[name="cw-bc-type"]').forEach(I=>{I.addEventListener("change",()=>{g.querySelectorAll(".cw-radio-option").forEach(M=>M.classList.remove("checked")),I.parentElement.classList.add("checked")})}),setTimeout(()=>{let I=g.querySelector(".cw-radio-option.info");I&&I.classList.add("checked")},100);let f=g.querySelector("#cw-bc-cancel"),S=g.querySelector("#cw-bc-close-x"),L=g.querySelector("#cw-bc-send");f.onclick=_,S.onclick=_,L.onclick=D,p.appendChild(g)}function R(f=null){if(!g)return;let S=g.querySelector("#cw-editor-title-label"),L=g.querySelector("#cw-bc-title"),I=g.querySelector("#cw-bc-text"),M=g.querySelector("#cw-bc-send");if(f){a=f.id,S.textContent="Editar Aviso",L.value=f.title||"",I.value=f.text||"",M.textContent="Salvar Altera\xE7\xF5es";let B=f.type||"info",U=g.querySelector(`input[name="cw-bc-type"][value="${B}"]`);U&&U.click()}else{a=null,S.textContent="Novo Aviso",L.value="",I.value="",M.textContent="Publicar";let B=g.querySelector('input[name="cw-bc-type"][value="info"]');B&&B.click()}g.classList.add("active"),setTimeout(()=>L.focus(),300)}function _(){g&&g.classList.remove("active"),a=null}async function D(){let f=g.querySelector("#cw-bc-send"),S=g.querySelector("#cw-bc-title"),L=g.querySelector("#cw-bc-text"),I=g.querySelector('input[name="cw-bc-type"]:checked'),M=I?I.value:"info";if(!S.value.trim()||!L.value.trim()){X("Preencha todos os campos!",{error:!0});return}f.textContent="Salvando...",f.style.opacity="0.7";let B=!1;a?B=await be.updateBroadcast(a,{title:S.value,text:L.value,type:M}):B=await be.sendBroadcast({title:S.value,text:L.value,type:M,author:window._cwCurrentUser||"admin"}),B?(X(a?"Atualizado!":"Publicado!"),G.playSuccess(),_(),setTimeout(()=>q(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),f.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",f.style.opacity="1")}async function Y(f){if(await xe("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await be.deleteBroadcast(f)){X("Aviso removido."),G.playClick();let I=_e.findIndex(M=>M.id===f);I>-1&&_e.splice(I,1),z(),setTimeout(()=>q(),1500)}else X("Erro ao excluir.",{error:!0})}let J=document.createElement("div");J.className="cw-nice-scroll",Object.assign(J.style,i.feedContainer),p.appendChild(J);async function q(){e&&(v.style.display="block",v.innerHTML="\u{1F504} Sincronizando...");try{let f=await be.fetchData();f&&f.broadcast&&(qt(f.broadcast),F(),e&&(z(),v.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{v.style.display="none"},1500)))}catch{e&&(v.innerHTML="\u26A0\uFE0F Offline")}}function F(){let f=document.getElementById("cw-btn-broadcast");if(!f)return;let S=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(_e.some(I=>!S.includes(I.id))){if(f.classList.add("has-new"),!f.querySelector(".cw-badge")){let I=document.createElement("div");I.className="cw-badge",Object.assign(I.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),f.appendChild(I)}}else{f.classList.remove("has-new");let I=f.querySelector(".cw-badge");I&&I.remove()}}function z(){J.innerHTML="";let f=p.querySelector("#cw-bau-widget");f&&f.remove();let S=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),L=[..._e].sort((h,V)=>{let K=new Date(h.date).getTime()||0;return(new Date(V.date).getTime()||0)-K}),I=L.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(I!==-1){let h=L[I];L.splice(I,1);let V=document.createElement("div");V.id="cw-bau-widget",Object.assign(V.style,i.bauContainer);let K=[],W=(h.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,C="\u{1F4C5}";if(W.forEach(H=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(H)?C="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(H)&&(C="\u{1F1EA}\u{1F1F8}");let ee=H.match(m);if(ee){let oe=ee[0],Q=C;/🇧🇷|🇵🇹|PT|BR/i.test(H)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(H)&&(Q="\u{1F1EA}\u{1F1F8}"),K.some(te=>te.flag===Q&&te.date===oe)||K.push({flag:Q,date:oe})}}),K.length===0){let H=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);H&&[...new Set(H)].forEach(ee=>K.push({flag:"\u{1F4C5}",date:ee}))}let E="",$='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&($=`
        ...
        `,document.head.appendChild(y)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},s={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let p=pe(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>T());r.appendChild(p);let d=document.createElement("div");Object.assign(d.style,s.container),r.appendChild(d);let c=document.createElement("div");Object.assign(c.style,s.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(y=>{let A=document.createElement("div");A.innerHTML=`${y.icon} ${y.label}`,A.id=`lib-tab-${y.id}`,Object.assign(A.style,s.tabBtn),y.id===o&&Object.assign(A.style,s.tabActive),A.onmouseenter=()=>G.playHover(),A.onclick=()=>Y(y.id),c.appendChild(A)}),d.appendChild(c);let b=document.createElement("div");Object.assign(b.style,s.listContainer),d.appendChild(b);let g=document.createElement("div");g.className="cw-fab cw-tactile",Object.assign(g.style,s.fab),g.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',g.onmouseenter=()=>g.style.transform="scale(1.1)",g.onmouseleave=()=>g.style.transform="scale(1)",g.onclick=()=>q(),d.appendChild(g),a=document.createElement("div"),Object.assign(a.style,s.editorOverlay);let u=document.createElement("div");Object.assign(u.style,s.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let v=document.createElement("button");v.innerHTML="Cancelar",v.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",v.onclick=F,u.appendChild(v),a.appendChild(u);let w=document.createElement("div");Object.assign(w.style,s.editorBody),a.appendChild(w);let R=document.createElement("div");R.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let _=document.createElement("button");_.textContent="Salvar",_.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",_.onclick=z,R.appendChild(_),a.appendChild(R),d.appendChild(a);let D=document.createElement("div");Object.assign(D.style,Ae),D.className="no-drag",r.appendChild(D),Te(r,D),document.body.appendChild(r);function Y(y){G.playClick(),o=y,x.forEach(A=>{let f=document.getElementById(`lib-tab-${A.id}`);A.id===y?Object.assign(f.style,s.tabActive):Object.assign(f.style,s.tabBtn)}),J()}function J(){b.innerHTML="";let y=he.getSnippets(o);if(y.length===0){b.innerHTML=`
            ...
            `;return}y.forEach(A=>{let f=document.createElement("div");f.className="cw-lib-card",Object.assign(f.style,s.card),A.isCode&&(f.style.borderLeft=`4px solid ${i.primary}`,f.style.background="rgba(0, 122, 255, 0.02)");let S=A.content;if(A.isRich){let L=document.createElement("div");L.innerHTML=A.content;let I=L.querySelector("img");S=L.innerText.substring(0,150)+(L.innerText.length>150?"...":""),I&&(S="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+S)}f.innerHTML=`
                <div style="${k(s.cardHeader)}">
                    <div style="${k(s.cardTitle)}">${A.title}</div>
                    <div style="display:flex; gap:4px;">
                        ${A.isCode?'<span style="font-size:10px; background:#F1F3F4; color:#5F6368; padding:2px 6px; border-radius:4px; font-family:monospace;">CODE</span>':""}
                        ${o==="email"?'<span style="font-size:10px; background:#E8F0FE; color:#1967D2; padding:2px 6px; border-radius:4px;">TEMPLATE</span>':""}
                    </div>
                </div>
                <div style="${k(s.cardPreview)}; ${A.isCode?"font-family:'Roboto Mono', monospace; font-size:11px;":""}">${S}</div>
                <div style="${k(s.cardActions)}">
                    <button class="cw-act-copy cw-tactile" title="Copiar" style="${k(s.actionBtn)}; color:#007AFF; display:flex; align-items:center; gap:4px;">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                        <span>Copiar</span>
                    </button>
                    <button class="cw-act-edit cw-tactile" title="Editar" style="${k(s.actionBtn)}; color:#8E8E93; display:flex; align-items:center; gap:4px;">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                        <span>Editar</span>
                    </button>
                    <button class="cw-act-del cw-tactile" title="Excluir" style="${k(s.actionBtn)}; color:#FF3B30; display:flex; align-items:center; gap:4px;">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                        <span>Excluir</span>
                    </button>
                </div>
            `,f.onmouseenter=()=>{G.playHover()},f.querySelector(".cw-act-copy").onclick=L=>{if(L.stopPropagation(),G.playClick(),A.isRich){let I=new Blob([A.content],{type:"text/html"}),M=document.createElement("div");M.style.whiteSpace="pre-wrap",M.innerHTML=A.content;let B=new Blob([M.innerText],{type:"text/plain"}),U=[new ClipboardItem({"text/html":I,"text/plain":B})];navigator.clipboard.write(U)}else navigator.clipboard.writeText(A.content);X("Copiado!")},f.querySelector(".cw-act-edit").onclick=L=>{L.stopPropagation(),G.playClick(),q(A)},f.querySelector(".cw-act-del").onclick=async L=>{L.stopPropagation(),G.playClick(),await xe("Excluir este item?")&&(he.delete(A.id),J(),X("Item exclu\xEDdo."))},b.appendChild(f)})}function q(y=null){n=y?y.id:null,w.innerHTML="",w.appendChild(O("title","T\xEDtulo / Nome",y?y.title:"")),o==="email"&&w.appendChild(O("subject","Assunto do Email",y?y.subject:""));let A="Conte\xFAdo";o==="email"&&(A="Corpo do Email (HTML)"),o==="note"&&(A="Texto da Nota (Reason)"),w.appendChild(O("content",A,y?y.content:"",{isRich:!0,isCode:y?y.isCode:!1})),u.querySelector("span").textContent=y?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let f=w.querySelector("input");f&&f.focus()},300)}function F(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function z(){let y=w.querySelector("#cw-inp-title"),A=w.querySelector("#cw-inp-content"),f=y.value.trim(),S=A.contentEditable==="true"?A.innerHTML:A.value.trim(),L=A.getAttribute("data-is-code")==="true";if(!f||!S||S==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let I={id:n,type:o,title:f,content:S,isCode:L,isRich:A.contentEditable==="true"};if(o==="email"){let M=w.querySelector("#cw-inp-subject").value.trim();if(!M){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}I.subject=M}_.textContent="Salvando...",await he.save(I),_.textContent="Salvar",F(),J(),X("Salvo com sucesso!"),G.playSuccess()}function O(y,A,f,S={}){let L=document.createElement("div");Object.assign(L.style,s.inputGroup);let I=document.createElement("label");I.textContent=A,Object.assign(I.style,s.label);let M;if(S.isRich){let B=document.createElement("div");B.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",B.innerHTML=`
  ...
  `,document.head.appendChild(t)};function Mo(){_o();let t=!1,e={},o=document.createElement("div");o.id="bau-form-popup",o.className="bau-popup cw-module-window",o.style.display="none";let n=pe(o,"BAU Form","v1.0.0","Solicite a abertura de casos BAU rapidamente.",{googleLine:null},()=>z());o.appendChild(n);let i=document.createElement("div");i.className="bau-content",o.appendChild(i);let s=document.createElement("form");i.appendChild(s);let r=document.createElement("div");r.className="bau-card";let l=document.createElement("div");l.className="bau-header-banner",l.innerHTML="<span>\u26A0\uFE0F</span> Verifique os dados capturados do CRM",r.appendChild(l);let p=document.createElement("div");p.innerHTML=`
    ...
    `,r.appendChild(p),s.appendChild(r);let d=document.createElement("div");d.className="bau-card bau-fallback-card",d.innerHTML=`
    ...
    `,s.appendChild(d);let c=document.createElement("div");c.className="bau-card";let x=document.createElement("label");x.className="bau-label",x.textContent="A\xE7\xF5es R\xE1pidas (Preenche Motivo e Task)",c.appendChild(x);let b=document.createElement("div");b.className="bau-chips-container",[{id:"gtm",text:"\u{1F680} Instala\xE7\xE3o GTM",reason:"Nova Implementa\xE7\xE3o",task:"Setup GTM"},{id:"ecw4",text:"\u{1F6D2} ECW4 Purchase",reason:"Nova Implementa\xE7\xE3o",task:"Google Ads Conversion"},{id:"consent",text:"\u{1F6E1}\uFE0F Consent Mode",reason:"Corre\xE7\xE3o de Tag",task:"GA4 Events"}].forEach(O=>{let k=document.createElement("div");k.className="bau-chip",k.textContent=O.text,k.dataset.id=O.id,k.onclick=()=>{b.querySelectorAll(".bau-chip").forEach(A=>A.classList.remove("active")),k.classList.add("active"),G.playClick();let T=s.querySelector('select[name="reason"]'),y=s.querySelector('select[name="taskType"]');T&&(T.value=O.reason),y&&(y.value=O.task)},b.appendChild(k)}),c.appendChild(b);let u=document.createElement("div");u.className="bau-grid-2",u.style.marginTop="16px",u.innerHTML=`
        <div>
    ...
    `,c.appendChild(u);let v=document.createElement("label");v.className="bau-label",v.textContent="Justificativa / Descri\xE7\xE3o",v.style.marginTop="16px",c.appendChild(v);let w=document.createElement("textarea");w.name="description",w.required=!0,w.className="bau-textarea",w.placeholder="Descreva detalhadamente o que precisa ser feito...",w.style.minHeight="100px",c.appendChild(w);let R=document.createElement("label");R.className="bau-label",R.textContent="Disponibilidade do Anunciante",R.style.marginTop="16px",c.appendChild(R);let _=document.createElement("input");_.type="datetime-local",_.name="availability",_.required=!0,_.className="bau-input",c.appendChild(_),s.appendChild(c);let D=document.createElement("div");D.className="bau-footer";let Y=document.createElement("button");Y.type="submit",Y.className="bau-btn-submit",Y.innerHTML="<span>\u26A1</span> Enviar para o TL abrir o Caso",D.appendChild(Y),s.appendChild(D),document.body.appendChild(o);let J=document.getElementById("bau-toggle-data"),q=document.getElementById("bau-hidden-data");J&&q&&(J.onclick=()=>{let O=q.style.display==="none";q.style.display=O?"block":"none",J.textContent=O?"Ocultar dados \u25B2":"Ver todos os dados capturados \u25BC",G.playClick()});async function F(){e=await we()||{};let O=e;if(O){document.getElementById("bau-adv-name").textContent=O.advName||"Anunciante Desconhecido",document.getElementById("bau-adv-details").textContent=`CID: ${O.cid||"N/A"} \u2022 AM: ${O.amName||"N/A"}`;let k=document.getElementById("bau-hidden-data");k&&(k.innerHTML=`
                    <b>Email:</b> ${O.email||"N/A"}<br>
                    <b>Idioma:</b> ${O.language||"N/A"}<br>
                    <b>Programa:</b> ${O.salesProgram||"N/A"}<br>
                    <b>Speakeasy ID:</b> ${O.seId||"N/A"}
                `);let T=s.querySelector('input[name="timezone"]'),y=s.querySelector('input[name="site"]'),A=!!O.timezone,f=!!O.site;O.timezone&&(T.value=O.timezone),O.site&&(y.value=O.site),A&&f?(d.style.display="none",l.style.background=ie.greenLight,l.style.color=ie.green,l.style.borderBottomColor=ie.green,l.innerHTML="<span>\u2705</span> Dados capturados com sucesso!"):(d.style.display="block",l.style.background=ie.yellowLight,l.style.color="#E37400",l.style.borderBottomColor="#FEF1D1",l.innerHTML="<span>\u26A0\uFE0F</span> Dados ausentes. Verifique o fallback abaixo.")}}s.onsubmit=async O=>{O.preventDefault();let k=Y.innerHTML;Y.disabled=!0,Y.innerHTML="Carregando...";let T=new FormData(s),y=Object.fromEntries(T.entries()),A=e,f={caseId:A.caseId||"",cid:A.cid||"",seId:A.seId||"",advName:A.advName||"",email:A.email||"",language:A.language||"",amName:A.amName||"",salesProgram:A.salesProgram||"",site:y.site||A.site||"",timezone:y.timezone||A.timezone||"",reason:y.reason,taskType:y.taskType,description:y.description,availability:y.availability};try{await io(f,A.agentEmail||"anon"),G.playSuccess(),X("Escalonamento enviado com sucesso!","success"),s.reset(),b.querySelectorAll(".bau-chip.active").forEach(S=>S.classList.remove("active")),z()}catch(S){console.error("Erro BAU:",S),X("Falha ao enviar: "+(S.message||"Erro desconhecido"),"error")}finally{Y.disabled=!1,Y.innerHTML=k}};async function z(){t=!t,t&&(o.style.display="flex",await F()),ue(t,o,"cw-btn-bauform")}return z}function ca(){if(window.techSolInitialized){Ct();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Pt();try{G.initGlobalListeners(),G.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}be.fetchTips(),Ct();let e=fo(),o=yo(),a=wo(),n=Co(),i=Oo(),s=Lo(),r=Io(),l=Mo(),p=Eo();so({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:l,broadcastControl:p}),setTimeout(()=>{be.logEvent("App","Start","Session Start"),Ao(),setTimeout(()=>{ko(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}ca();})();
