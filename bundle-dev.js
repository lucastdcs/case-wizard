...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let h=g.querySelector(".cw-hero-grid"),f=g.querySelector(".cw-acc-container"),d=g.querySelector(".cw-results-container"),p=g.querySelector(".cw-search-input"),S=g.querySelector(".cw-status-bar"),k=g.querySelector(".cw-status-text"),M=g.querySelector(".cw-footer-icons");s.forEach(([O,F])=>{let R=i(F.name),G=document.createElement("div");G.className="cw-hero-card",G.id=`hero-${O}`,G.style.setProperty("--hero-color",R.color),G.innerHTML=`
        ...
        `,G.onclick=_=>{if(_.target.closest(".cw-step-btn"))return;let E=a[O]?a[O].count:0;B(O,E>0?-E:1,F)},G.querySelector(".minus").onclick=()=>B(O,-1,F),G.querySelector(".plus").onclick=()=>B(O,1,F),G.dataset.color=R.color,h.appendChild(G)});function $(O,F){let R=i(F.name),G=document.createElement("div");return G.className="cw-task-item",G.dataset.id=O,G.innerHTML=`
...
`),c=/\d{1,2}\/\d{1,2}/,v="\u{1F4C5}";if(y.forEach(z=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(z)?v="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(z)&&(v="\u{1F1EA}\u{1F1F8}");let Q=z.match(c);if(Q){let oe=Q[0],ee=v;/🇧🇷|🇵🇹|PT|BR/i.test(z)?ee="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(z)&&(ee="\u{1F1EA}\u{1F1F8}"),V.some(te=>te.flag===ee&&te.date===oe)||V.push({flag:ee,date:oe})}}),V.length===0){let z=(x.text||"").match(/\d{1,2}\/\d{1,2}/g);z&&[...new Set(z)].forEach(Q=>V.push({flag:"\u{1F4C5}",date:Q}))}let w="",I='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(I=`
    ...
    `;let u=m.querySelector("#cw-config-sound-toggle");u.onchange=d=>{H.setMuted(!d.target.checked),d.target.checked&&H.playClick()},r.appendChild(m);let h=document.createElement("div");h.className="cw-configs-section",h.innerHTML=`
    ...
    `,r.appendChild(h);function f(){e=!e,ue(e,n,"cw-btn-configs"),e&&H.playClick()}return document.body.appendChild(n),f}var qo="cubic-bezier(0.4, 0, 0.2, 1)",Cs=`all 0.3s ${qo}`,_o=()=>{if(document.getElementById("bau-form-global-styles"))return;let t=document.createElement("style");t.id="bau-form-global-styles",t.textContent=`
  ...
  `,document.head.appendChild(t)};var Ie={add:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg>',back:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>',wand:'<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-2.5 1.4L17 2l1.4 2.5L17 7l2.5-1.4L22 7l-1.4-2.5zm-7.63 5.29c-.39-.39-1.02-.39-1.41 0L1.29 18.96c-.39.39-.39 1.02 0 1.41l2.34 2.34c.39.39 1.02.39 1.41 0L16.7 11.05c.39-.39.39-1.02 0-1.41l-2.33-2.35zm-1.03 5.41l-2.12-2.12 2.44-2.44 2.12 2.12-2.44 2.44z"/></svg>',send:'<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg>',check:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',folder:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>',empty:'<svg width="64" height="64" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5v-3h3.56c.69 1.19 1.97 2 3.44 2s2.75-.81 3.44-2H19v3zm0-5h-4.99c0 1.1-.9 2-2 2s-2-.9-2-2H5V5h14v9z"/></svg>',refresh:'<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg>'};function Mo(){_o();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=pe(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>V()),r=s.querySelector("div:last-child");if(r){let y=document.createElement("div");y.className="bau-refresh-btn no-drag",y.innerHTML=Ie.refresh,y.title="Atualizar Dashboard",y.onclick=async c=>{c.stopPropagation(),!y.classList.contains("spinning")&&(y.classList.add("spinning"),H.playClick(),await q(),setTimeout(()=>y.classList.remove("spinning"),1e3))},r.insertBefore(y,r.firstChild)}i.appendChild(s);let l=document.createElement("div");l.className="bau-view-container",i.appendChild(l);let g=document.createElement("div");g.id="bau-view-dashboard",g.className="bau-view active",g.innerHTML=`
    ...
    `,m.appendChild(u);let h=document.createElement("div");h.className="bau-content",m.appendChild(h);let f=document.createElement("div");f.className="bau-progress-indicator",h.appendChild(f);let d=document.createElement("form");d.id="bau-escalation-form",h.appendChild(d);let p=document.createElement("div");p.className="bau-step active",p.id="bau-step-1";let S=document.createElement("div");S.className="bau-card bau-context-card",S.innerHTML=`
    ...
    `,$.querySelectorAll(".bau-task-item").forEach(y=>{let c=y.querySelector("input");y.addEventListener("click",()=>{c.checked=!c.checked,y.classList.toggle("active",c.checked),H.playClick()})}),M.appendChild($),d.appendChild(M);let J=document.createElement("div");J.className="bau-step",J.id="bau-step-3";let Z=document.createElement("div");Z.className="bau-card",Z.innerHTML=`
    ...
    `,l.appendChild(E),document.body.appendChild(i);function D(y){e=y,i.querySelectorAll(".bau-view").forEach(I=>I.classList.remove("active"));let c=i.querySelector(`#bau-view-${y}`);c&&c.classList.add("active");let v=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),w=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");v&&(v.textContent=y==="form"?"Novo Caso BAU":"BAU Central"),w&&(w.textContent=y==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function q(){let y=i.querySelector("#bau-case-list-container");if(y){y.innerHTML='<p style="padding: 24px; text-align: center; color: #5f6368;">Sincronizando casos...</p>';try{let c=await zt();b(c)}catch{y.innerHTML='<p class="bau-error-text">Erro ao carregar casos.</p>'}}}function b(y){let c=i.querySelector("#bau-case-list-container"),v=i.querySelector("#bau-dashboard-metrics");if(!c)return;let w=j=>{switch(j){case"PENDING_TL_CREATION":return{text:"Aguardando TL",class:"status-yellow",aura:"status-yellow-aura"};case"CREATED":return{text:"Aprovado / Criado",class:"status-green",aura:"status-green-aura"};case"DISCARDED":return{text:"Descartado pelo TL",class:"status-red",aura:"status-red-aura"};case"CANCELED_BY_AGENT":return{text:"Cancelado",class:"status-gray",aura:""};default:return{text:j||"Pendente",class:"status-gray",aura:""}}};if(!y||y.length===0){v&&(v.innerHTML=""),c.innerHTML=`
            ...
            `;return}let I=y.filter(j=>j.status==="PENDING_TL_CREATION").length,A=y.filter(j=>j.status==="CREATED").length;v&&(v.innerHTML=`
            ...
            `),c.innerHTML=y.map(j=>{let z=w(j.status),Q=j.date?new Date(j.date).toLocaleDateString("pt-BR"):"";return`
            ...
            `}).join("")}function C(){d.querySelectorAll(".bau-step").forEach((y,c)=>{y.classList.toggle("active",c+1===a)}),f.innerHTML="";for(let y=1;y<=n;y++){let c=document.createElement("div");c.className=`bau-progress-step ${y===a?"active":y<a?"completed":""}`,c.textContent=y,f.appendChild(c)}R.style.display=a>1?"inline-block":"none",G.style.display=a<n?"inline-block":"none",_.style.display=a===n?"flex":"none",a===4&&W()}function N(y){let c=i.querySelector(`#bau-step-${y}`);if(!c)return!0;if(y===2)return d.querySelector('textarea[name="reason"]').value.trim()?d.querySelector('input[name="taskType"]:checked')?!0:(K("Erro: Selecione pelo menos uma Task.",{error:!0}),!1):(K("Erro: A descri\xE7\xE3o do que deve ser feito \xE9 obrigat\xF3ria.",{error:!0}),!1);for(let v of c.querySelectorAll("[required]"))if(!v.value.trim())return K(`Erro: O campo '${v.name||v.placeholder}' \xE9 obrigat\xF3rio.`,{error:!0}),!1;return!0}G.onclick=()=>{N(a)&&(a++,C(),H.playClick())},R.onclick=()=>{a>1&&(a--,C(),H.playClick())};async function L(){let y=await fe()||{};o=y;let c=d.querySelector("#bau-vital-highlights");if(c){let I=[{label:"Anunciante",value:y.advName},{label:"CID",value:y.cid},{label:"Website",value:y.site||y.website},{label:"Case ID",value:y.caseId}];c.innerHTML=I.map(A=>{let j=A.value&&A.value!=="N/A"&&A.value!=="undefined"&&A.value!=="null"?A.value:"N\xE3o capturado";return`
                    <div class="bau-highlight-item">
                        <span class="bau-highlight-label">${A.label}</span>
                        <span class="bau-highlight-value">${j}</span>
                    </div>
                `}).join("")}["advName","cid","amName","seId"].forEach(I=>{let A=y[I],j=d.querySelector(`[name="${I}"]`),z=i.querySelector(`#wrapper-${I}`);if(j&&(j.value=A&&A!=="N/A"?A:""),z){let Q=A&&A!==""&&A!=="N/A"&&A!=="undefined"&&A!=="null";z.style.display=Q?"none":"block"}});let w=i.querySelector("#bau-all-data");if(w){let I=[{label:"Anunciante",value:y.advName},{label:"CID",value:y.cid},{label:"AM",value:y.amName},{label:"SE ID",value:y.seId},{label:"Site",value:y.site},{label:"Email",value:y.email},{label:"Timezone",value:y.timezone},{label:"Case ID",value:y.caseId},{label:"Programa",value:y.salesProgram},{label:"Idioma",value:y.language}];w.innerHTML=`
            ...
            `}}i.querySelector("#bau-top-se-search").onclick=y=>{y.preventDefault(),st("bau-context-se-id-input")};function W(){let y=new FormData(d),c=Object.fromEntries(y.entries()),v=y.getAll("taskType"),w=i.querySelector("#bau-confirmation-details");if(!w)return;let I=v.length>0?v.join(", "):"Nenhuma";w.innerHTML=`
