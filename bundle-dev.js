...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",zIndex:"9999",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var mt={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},Ye={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Mt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var Pe={padding:"8px 12px",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:"#5f6368",background:"#f8f9fa",transition:"all 0.2s cubic-bezier(0.25, 0.8, 0.25, 1)",width:"100%",textAlign:"center",borderRadius:"8px"};var ut=[{background:"#E8F0FE",color:"#1967D2"},{background:"#FCE8E6",color:"#C5221F"},{background:"#FEF7E0",color:"#F29900"},{background:"#E6F4EA",color:"#1E8E3E"}],_t=-1;function Dt(){let t=Math.floor(Math.random()*ut.length);return t===_t&&(t=(t+1)%ut.length),_t=t,ut[t]}var Ae=t=>new Promise(e=>setTimeout(e,t));async function Fo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await Ae(200);for(let n=0;n<e.length;n++){let a=e.charAt(n),s=document.createElement("span");s.textContent=a,o&&o.parentNode===t?o.before(s):t.appendChild(s);let i=Math.floor(Math.random()*60)+30;n===0&&(i=150),n>e.length-3&&(i=30),await Ae(i)}await Ae(600),o&&(o.style.display="none")}async function gt(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await Ae(200);let e=await kt(),o=Ft(e),n=t.querySelector("#w-icon"),a=t.querySelector("#p1"),s=t.querySelector("#p2"),i=t.querySelector("#p3"),r=t.querySelector("#p-sextou");n&&(n.innerHTML=o.icon),a&&(a.textContent=o.prefix),i&&(i.textContent=o.suffix),await Ae(300);let m=n?n.querySelector("svg"):null;if(m&&(m.style.opacity="1",m.style.transform="scale(1)"),await Ae(400),a&&(a.style.opacity="1"),G.playStartup(),s&&await Fo(s,o.name),i&&(i.style.opacity="1",i.style.transform="translateY(0)"),o.isFriday&&r){await Ae(400),r.style.display="block",r.offsetWidth;let c=r.querySelector(".sextou-badge");c&&(c.style.opacity="1",c.style.transform="scale(1)")}await Ae(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await Ae(900),t.parentNode&&t.parentNode.removeChild(t)}}var ke={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Fe(t,e){e.onmousedown=o;function o(n){n.stopPropagation(),n.preventDefault();let a=t.style.transition;t.style.transition="none";let s=n.clientX,i=n.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),m=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),c=s,d=i,p=!1;function x(u){c=u.clientX,d=u.clientY,p||(window.requestAnimationFrame(()=>{b(),p=!1}),p=!0)}function b(){let u=r+(c-s),y=m+(d-i);u>360&&(t.style.width=u+"px"),y>300&&(t.style.height=y+"px")}function g(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",g),setTimeout(()=>{t.style.transition=a},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",g)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Nt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Rt(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function zt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function ge(t,e={}){return new Promise(o=>{let n=Rt(),a=zt(),s=e.danger?"#FF3B30":"#007AFF",i=e.confirmText||(e.danger?"Excluir":"Confirmar");a.innerHTML=`
        ...
        `,n.appendChild(a),document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity=1,a.style.transform="scale(1)"});let r=d=>{n.style.opacity=0,a.style.transform="scale(0.9)",setTimeout(()=>{n.remove(),o(d)},300)},m=a.querySelector("#cw-conf-cancel"),c=a.querySelector("#cw-conf-ok");[m,c].forEach(d=>d.onmouseenter=()=>G.playHover()),m.onclick=()=>{G.playClick(),r(!1)},c.onclick=()=>{G.playClick(),r(!0)}})}function Bt(t,e=""){return new Promise(o=>{let n=Rt(),a=zt();a.innerHTML=`
...
`))}else H.value.trim()===Z.trim()&&(H.value="");z.updateField(U,H.value),H.dispatchEvent(new Event("input"))}}}}function O(l,F){let q=document.createElement("div");if(q.className="cw-actions-section",q.style.cssText=`
        ...
        `;let D=C.querySelector("#csa-back-btn");D.onmouseenter=()=>D.style.background="#f1f3f4",D.onmouseleave=()=>D.style.background="none",D.onclick=A;let $=C.querySelector("#csa-insert-btn");$.onmouseenter=()=>{$.style.transform="translateY(-1px)",$.style.boxShadow="0 6px 16px rgba(26,115,232,0.4)"},$.onmouseleave=()=>{$.style.transform="translateY(0)",$.style.boxShadow="0 4px 12px rgba(26,115,232,0.3)"},$.onclick=()=>{$.style.transform="scale(0.96)",O(_,"email"),setTimeout(()=>{$.style.transform="scale(1)",A()},300)}}function A(){a="list",W.style.transform="translateX(0)"}function h(_,R,w=null){let D=document.createElement("button"),$=w?`<span style="margin-right:6px; font-size:14px; opacity:0.9;">${w}</span>`:"";return D.innerHTML=`${$}${_}`,Object.assign(D.style,b),o===R&&n===""?Object.assign(D.style,g):(D.onmouseenter=()=>{D.style.background="#F1F3F4",D.style.borderColor="#DADCE0"},D.onmouseleave=()=>{D.style.background="#FFFFFF",D.style.borderColor="#DADCE0"}),D.onclick=()=>{o=R,n="",M.value="",S(),E()},D}function S(){j.innerHTML="",j.appendChild(h("Smart CRs",e,"\u26A1")),j.appendChild(h("Pessoal","PERSONAL_LIBRARY","\u{1F464}")),Object.keys(De).forEach(_=>{j.appendChild(h(De[_].title,_))})}function E(){L.innerHTML="";let _=[];if(n.trim()!==""){let J=n.toLowerCase();Object.values(De).forEach(l=>{l.emails.forEach(F=>{(F.name.toLowerCase().includes(J)||F.subject.toLowerCase().includes(J))&&_.push({type:"email",data:F})})}),me.getSnippets("email").forEach(l=>{(l.title.toLowerCase().includes(J)||l.subject&&l.subject.toLowerCase().includes(J))&&_.push({type:"email",data:{name:l.title,subject:l.subject||"Sem Assunto",body:l.content}})}),Object.entries(Le).forEach(([l,F])=>{if(!F)return;(l.replace(/_/g," ").toLowerCase().includes(J)||F.toLowerCase().includes(J))&&_.push({type:"cr",key:l,code:F})})}else o===e?Object.entries(Le).forEach(([J,l])=>{l&&_.push({type:"cr",key:J,code:l})}):o==="PERSONAL_LIBRARY"?me.getSnippets("email").forEach(J=>{_.push({type:"email",data:{name:J.title,subject:J.subject||"Sem Assunto",body:J.content}})}):De[o]&&De[o].emails.forEach(J=>{_.push({type:"email",data:J})});if(_.length===0){L.innerHTML=`
  ...
  `,u.onfocus=()=>{b.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",b.style.border="1px solid #1a73e8"},u.onblur=()=>{b.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",b.style.border="1px solid transparent"},b.appendChild(g),b.appendChild(u),x.appendChild(b),p.appendChild(x);let y=document.createElement("div");y.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(y);let v=null;function V(){if(v)return;v=document.createElement("div"),v.style.cssText=`
      ...
      `,f.title=C,f.dataset.key=k;let A=document.createElement("div");A.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",A.innerHTML=O||Ne.tasks;let h=document.createElement("div");return h.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",h.textContent=C,f.appendChild(A),f.appendChild(h),f.onmouseenter=()=>{n!==k&&!(k==="history"&&a)&&(f.style.background="#F1F3F4",A.style.transform="scale(1.1)")},f.onmouseleave=()=>{n!==k&&!(k==="history"&&a)&&(f.style.background="transparent",A.style.transform="scale(1)")},f}function I(k){let C=document.getElementById(`cat-anchor-${k}`);C&&(C.scrollIntoView({behavior:"smooth",block:"start"}),n=k,T())}function T(){Object.keys(Ve).forEach(C=>{let O=d.querySelector(`#cw-sidebar-btn-${C}`);if(O)if(n===C&&!a){let f=ct[C];O.style.background=f.bg,O.style.color=f.color,O.querySelector("div:first-child").style.transform="scale(1.1)"}else O.style.background="transparent",O.style.color=s.textSecondary,O.querySelector("div:first-child").style.transform="scale(1)"});let k=d.querySelector("#cw-sidebar-btn-history");k&&(a?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=s.textSecondary))}function M(){if(y.innerHTML="",e.trim()!==""){let C=[];if(Object.entries(Ve).forEach(([f,A])=>{let h=A.links.filter(S=>S.name.toLowerCase().includes(e.toLowerCase())||S.desc.toLowerCase().includes(e.toLowerCase()));C.push(...h.map(S=>({...S,_cat:f})))}),C.length===0){y.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let O=document.createElement("div");O.innerHTML="Resultados da busca",O.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",y.appendChild(O),C.forEach(f=>{let A=j(f,Ne[f._cat],!1,f._cat);y.appendChild(A)});return}Object.entries(Ve).forEach(([C,O])=>{let f=ct[C],A=document.createElement("div"),h=document.createElement("div");h.id=`cat-anchor-${C}`,h.style.cssText=`
          ...
          `,h.innerHTML=`
            ...
            ${O.label}
          `,A.appendChild(h);let S=document.createElement("div");S.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",O.links.forEach(E=>{let _=j(E,Ne[C],!1,C);S.appendChild(_)}),A.appendChild(S),y.appendChild(A)});let k=document.createElement("div");k.style.height="80px",y.appendChild(k)}function j(k,C,O,f){let A=document.createElement("div"),h=ct[f]||ct.history;A.style.cssText=`
      ...
      `;let S=document.createElement("div");S.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,S.innerHTML=C||Ne.tasks;let E=S.querySelector("svg");E&&(E.style.width="22px",E.style.height="22px");let _=document.createElement("div");_.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let R=document.createElement("div");R.style.cssText=`font-size: 14px; font-weight: 600; color: ${s.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,R.textContent=k.name;let w=document.createElement("div");w.style.cssText=`font-size: 12px; color: ${s.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,w.textContent=k.desc,_.appendChild(R),_.appendChild(w);let D=document.createElement("div");return D.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',D.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,D.title="Copiar URL",A.onmouseenter=()=>{A.style.transform="translateY(-2px)",A.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",A.style.borderColor="rgba(0,0,0,0.05)",A.style.borderLeft=`4px solid ${h.color}`,D.style.opacity="1",D.style.background="#F1F3F4"},A.onmouseleave=()=>{A.style.transform="translateY(0)",A.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",A.style.border="1px solid transparent",D.style.opacity="0",D.style.background="transparent"},A.onclick=()=>{!O&&f&&co(k,f),window.open(k.url,"_blank")},D.onclick=$=>{$.stopPropagation(),G.playClick(),navigator.clipboard.writeText(k.url),!O&&f&&co(k,f),K("Link copiado!")},A.appendChild(S),A.appendChild(_),A.appendChild(D),A}u.addEventListener("input",k=>{e=k.target.value,M()});function L(){o=!o,ue(o,i,"cw-btn-links")}return document.body.appendChild(i),X(),M(),L}var Oe=[];function Ct(t){Oe=t}var Po=["lucaste","ricardogi"],jo=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function uo(){let t="v4.9",e=!1,o=null,n=null;function a(f){if(!f)return"";try{let A=new Date(f);return isNaN(A.getTime())?String(f):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
...
`),l=/\d{1,2}\/\d{1,2}/,F="\u{1F4C5}";if(J.forEach(H=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(H)?F="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(H)&&(F="\u{1F1EA}\u{1F1F8}");let te=H.match(l);if(te){let oe=te[0],ee=F;/🇧🇷|🇵🇹|PT|BR/i.test(H)?ee="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(H)&&(ee="\u{1F1EA}\u{1F1F8}"),$.some(se=>se.flag===ee&&se.date===oe)||$.push({flag:ee,date:oe})}}),$.length===0){let H=(w.text||"").match(/\d{1,2}\/\d{1,2}/g);H&&[...new Set(H)].forEach(te=>$.push({flag:"\u{1F4C5}",date:te}))}let q="",Y='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(Y=`
           ...
           `,W.appendChild(w)}let _=E.filter(w=>!A.includes(w.id)),R=E.filter(w=>A.includes(w.id));if(_.forEach(w=>W.appendChild(j(w,!1))),R.length>0){let w=document.createElement("div");Object.assign(w.style,s.historyDivider),w.innerHTML=`<span>Hist\xF3rico (${R.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let D=document.createElement("div");Object.assign(D.style,s.historyContainer),R.forEach(J=>D.appendChild(j(J,!0)));let $=!1;w.onclick=()=>{G.playClick(),$=!$,D.style.display=$?"flex":"none",w.querySelector("svg").style.transform=$?"rotate(180deg)":"rotate(0deg)"},W.appendChild(w),W.appendChild(D)}}function j(f,A){let h=document.createElement("div");Object.assign(h.style,A?s.cardHistory:s.card);let S=i[f.type]||i.info,E=document.createElement("div");Object.assign(E.style,s.cardHeader);let _=document.createElement("div");Object.assign(_.style,s.typeTag,{color:S.color,background:S.bg}),_.innerHTML=`${S.icon} <span>${f.type}</span>`;let R=document.createElement("span");if(Object.assign(R.style,s.dateTag),R.textContent=a(f.date),E.appendChild(_),A)E.appendChild(R);else{let l=document.createElement("button");l.className="cw-btn-interactive",Object.assign(l.style,s.dismissBtn),l.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',l.onmouseenter=()=>{l.style.color="#1e8e3e",l.style.background="#e6f4ea",l.style.borderColor="#1e8e3e"},l.onmouseleave=()=>{l.style.color="#5f6368",l.style.background="#fff",l.style.borderColor="rgba(0,0,0,0.1)"},l.onclick=F=>{F.stopPropagation(),G.playClick(),h.style.transform="translateX(20px)",h.style.opacity="0",setTimeout(()=>{let q=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");q.push(f.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(q)),M(),T()},200)},E.appendChild(l)}let w=document.createElement("div");Object.assign(w.style,s.cardContent);let D=document.createElement("div");Object.assign(D.style,s.msgTitle),D.textContent=f.title;let $=document.createElement("div");Object.assign($.style,s.msgBody),$.innerHTML=m(f.text);let J=document.createElement("div");if(Object.assign(J.style,s.msgMeta),J.innerHTML=`Publicado por <b>${f.author||"Sistema"}</b>`,A||(J.innerHTML+=` \u2022 ${a(f.date)}`),w.appendChild(D),w.appendChild($),w.appendChild(J),h.appendChild(E),h.appendChild(w),window._cwIsAdmin){let l=document.createElement("div");l.className="cw-card-actions";let F=document.createElement("button");F.className="cw-action-btn edit",F.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',F.onclick=()=>V(f);let q=document.createElement("button");q.className="cw-action-btn delete",q.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',q.onclick=()=>X(f.id),l.appendChild(F),l.appendChild(q),h.appendChild(l)}return h}let L=re.getCachedBroadcasts();L.length>0&&(Ct(L),M()),setTimeout(u,500),I(),o||(o=setInterval(I,jo));let k=document.createElement("div");Object.assign(k.style,ke),k.className="no-drag",c.appendChild(k),Fe(c,k),document.body.appendChild(c);let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=Oe.some(f=>!C.includes(f.id));return{toggle:p,hasUnread:O}}function mo(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,o.overlay);let a=document.createElement("div");Object.assign(a.style,o.card);let s=document.createElement("div");Object.assign(s.style,o.icon);let i=document.createElement("div");Object.assign(i.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let m=document.createElement("div");Object.assign(m.style,o.dotsContainer);let c=document.createElement("div");Object.assign(c.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let p=document.createElement("button");p.textContent="Pr\xF3ximo",Object.assign(p.style,o.btn,o.btnNext),p.onmouseover=()=>p.style.transform="scale(1.05)",p.onmouseout=()=>p.style.transform="scale(1)",c.appendChild(d),c.appendChild(p),a.appendChild(s),a.appendChild(i),a.appendChild(r),a.appendChild(m),a.appendChild(c),n.appendChild(a),document.body.appendChild(n);function x(g){let u=t[g];s.textContent=u.icon,i.textContent=u.title,r.textContent=u.text,m.innerHTML="",t.forEach((y,v)=>{let V=document.createElement("div");Object.assign(V.style,o.dot),v===g&&Object.assign(V.style,o.dotActive),m.appendChild(V)}),u.isLast?(d.style.display="none",p.textContent="Come\xE7ar \u{1F680}",p.style.width="100%"):(d.style.display="block",p.textContent="Pr\xF3ximo",p.style.width="auto")}function b(){localStorage.setItem("cw_onboarding_seen_v1","true"),n.style.opacity="0",a.style.transform="translateY(20px)",setTimeout(()=>n.remove(),400),G.playSuccess(),K("Tudo pronto! Use o menu flutuante.")}p.onclick=()=>{G.playClick(),e<t.length-1?(e++,x(e)):b()},d.onclick=async()=>{await ge("Pular o tutorial?")&&b()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",a.style.transform="translateY(0)"})}var go={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function fo(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&Go(t)}function Go(t){let e=go.slides,o=0,n={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,n.overlay);let s=document.createElement("div");Object.assign(s.style,n.card);let i=document.createElement("div");Object.assign(i.style,n.badge),i.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,n.icon);let m=document.createElement("div");Object.assign(m.style,n.title);let c=document.createElement("div");Object.assign(c.style,n.text);let d=document.createElement("div");Object.assign(d.style,n.dotsContainer);let p=document.createElement("button");Object.assign(p.style,n.btn),p.onmouseover=()=>p.style.transform="scale(1.02)",p.onmouseout=()=>p.style.transform="scale(1)",s.appendChild(i),s.appendChild(r),s.appendChild(m),s.appendChild(c),s.appendChild(d),s.appendChild(p),a.appendChild(s),document.body.appendChild(a);function x(g){let u=e[g];r.textContent=u.icon,m.textContent=u.title,c.textContent=u.text,d.innerHTML="",e.forEach((y,v)=>{let V=document.createElement("div");Object.assign(V.style,n.dot),v===g&&Object.assign(V.style,n.dotActive),d.appendChild(V)}),g===e.length-1?p.textContent="Entendi, vamos l\xE1! \u{1F44D}":p.textContent="Pr\xF3ximo"}function b(){localStorage.setItem("cw_last_version",t),a.style.opacity="0",s.style.transform="translateY(30px)",setTimeout(()=>a.remove(),400),G.playSuccess(),K(`TechSol atualizado para ${t}!`)}p.onclick=()=>{G.playClick(),o<e.length-1?(o++,x(o)):b()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",s.style.transform="translateY(0)"})}var bo="cw_timezone_pinned",At=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],Ho=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function xo(){let t="v2.2 Pro",e=!1,o=null,n="mx",a=JSON.parse(localStorage.getItem(bo)||"[]"),s="",i="all",r=new Date;r.setHours(14,0,0,0);let m={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},c={container:{display:"flex",flexDirection:"column",height:"100%",background:m.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:m.surface,borderBottom:`1px solid ${m.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:m.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:m.primary,borderBottomColor:m.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:m.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:m.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${m.border}`,background:m.surface,color:m.textSub,transition:"all 0.2s"},chipActive:{background:m.primaryBg,color:m.primary,borderColor:m.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:m.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${m.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:m.surface,border:`1px solid ${m.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:m.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,ce,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=de(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>A());d.appendChild(x);let b=document.createElement("div");Object.assign(b.style,c.container),d.appendChild(b);let g=document.createElement("div");Object.assign(g.style,c.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,c.tabBtn,c.tabActive);let y=document.createElement("div");y.textContent="Planejador",Object.assign(y.style,c.tabBtn),g.appendChild(u),g.appendChild(y),b.appendChild(g);let v=document.createElement("div");Object.assign(v.style,c.toolbar);let V=document.createElement("div");Object.assign(V.style,c.searchInputWrapper);let P=document.createElement("div");P.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(P.style,c.searchIcon);let B=document.createElement("input");B.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(B.style,c.searchInput),B.onfocus=()=>{B.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",B.style.borderColor="rgba(26,115,232,0.3)"},B.onblur=()=>{B.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",B.style.borderColor="transparent"},B.oninput=h=>{s=h.target.value.toLowerCase(),k()},V.appendChild(P),V.appendChild(B),v.appendChild(V);let X=document.createElement("div");Object.assign(X.style,c.chipsRow),Ho.forEach(h=>{let S=document.createElement("div");S.textContent=h.label,S.id=`tz-filter-${h.id}`,Object.assign(S.style,c.chip),h.id===i&&Object.assign(S.style,c.chipActive),S.onclick=()=>{G.playClick(),i=h.id,Array.from(X.children).forEach(E=>{Object.assign(E.style,c.chip)}),Object.assign(S.style,c.chipActive),k()},X.appendChild(S)}),v.appendChild(X),b.appendChild(v);let W=document.createElement("div");Object.assign(W.style,c.listContainer);let I=document.createElement("style");I.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",b.appendChild(I);let T=document.createElement("div");Object.assign(T.style,c.plannerWrapper,{display:"none"}),b.appendChild(W),b.appendChild(T),u.onclick=()=>M("live"),y.onclick=()=>M("plan");function M(h){G.playClick(),h==="live"?(Object.assign(u.style,c.tabActive),Object.assign(y.style,c.tabBtn),y.style.borderBottomColor="transparent",W.style.display="flex",v.style.display="flex",T.style.display="none",O()):(Object.assign(y.style,c.tabActive),Object.assign(u.style,c.tabBtn),u.style.borderBottomColor="transparent",T.style.display="flex",W.style.display="none",v.style.display="none",f(),C())}function j(h){return h>=9&&h<17?{color:m.success,bg:m.successBg,label:"Aberto",icon:"\u{1F7E2}"}:h>=8&&h<9?{color:m.warning,bg:m.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:h>=17&&h<19?{color:m.warning,bg:m.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:m.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function L(h){a.includes(h)?a=a.filter(S=>S!==h):a.push(h),localStorage.setItem(bo,JSON.stringify(a)),k(),G.playClick()}function k(){W.innerHTML="";let h=new Date,S=At.filter(_=>{let R=_.name.toLowerCase().includes(s)||_.label.toLowerCase().includes(s),w=i==="all"||_.region===i;return R&&w});if(S.sort((_,R)=>{let w=a.includes(_.id),D=a.includes(R.id);return w&&!D?-1:!w&&D?1:_.name.localeCompare(R.name)}),S.length===0){W.innerHTML=`
            ...
            `;return}S.forEach(_=>{let R=a.includes(_.id),w=h.toLocaleTimeString("pt-BR",{timeZone:_.zone,hour:"2-digit",minute:"2-digit"}),D=parseInt(w.split(":")[0]),$=j(D),J=D<6||D>18,l=document.createElement("div");Object.assign(l.style,c.hubCard),R&&Object.assign(l.style,c.hubCardPinned);let F=R?"\u2605":"\u2606",q=R?"#F9AB00":"#DADCE0";l.innerHTML=`
                <div style="display:flex; alignItems:center; gap:16px;">
                    ...
                    <div>
                        <div style="font-size:15px; font-weight:600; color:${m.text}; letter-spacing:-0.2px;">${_.name}</div>
        ...
        `,document.head.appendChild(C)}let s={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},i={container:{display:"flex",flexDirection:"column",height:"100%",background:s.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:s.surface,borderBottom:`1px solid ${s.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:s.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:s.primary,borderBottomColor:s.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:s.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${s.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:s.text},cardPreview:{fontSize:"12px",color:s.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${s.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:s.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:s.surface,borderBottom:`1px solid ${s.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:s.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${s.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:s.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,ce,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let c=de(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>k());r.appendChild(c);let d=document.createElement("div");Object.assign(d.style,i.container),r.appendChild(d);let p=document.createElement("div");Object.assign(p.style,i.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(C=>{let O=document.createElement("div");O.innerHTML=`${C.icon} ${C.label}`,O.id=`lib-tab-${C.id}`,Object.assign(O.style,i.tabBtn),C.id===o&&Object.assign(O.style,i.tabActive),O.onmouseenter=()=>G.playHover(),O.onclick=()=>X(C.id),p.appendChild(O)}),d.appendChild(p);let b=document.createElement("div");Object.assign(b.style,i.listContainer),d.appendChild(b);let g=document.createElement("div");g.className="cw-fab cw-tactile",Object.assign(g.style,i.fab),g.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',g.onmouseenter=()=>g.style.transform="scale(1.1)",g.onmouseleave=()=>g.style.transform="scale(1)",g.onclick=()=>I(),d.appendChild(g),n=document.createElement("div"),Object.assign(n.style,i.editorOverlay);let u=document.createElement("div");Object.assign(u.style,i.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let y=document.createElement("button");y.innerHTML="Cancelar",y.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",y.onclick=T,u.appendChild(y),n.appendChild(u);let v=document.createElement("div");Object.assign(v.style,i.editorBody),n.appendChild(v);let V=document.createElement("div");V.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let P=document.createElement("button");P.textContent="Salvar",P.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",P.onclick=M,V.appendChild(P),n.appendChild(V),d.appendChild(n);let B=document.createElement("div");Object.assign(B.style,ke),B.className="no-drag",r.appendChild(B),Fe(r,B),document.body.appendChild(r);function X(C){G.playClick(),o=C,x.forEach(O=>{let f=document.getElementById(`lib-tab-${O.id}`);O.id===C?Object.assign(f.style,i.tabActive):Object.assign(f.style,i.tabBtn)}),W()}function W(){b.innerHTML="";let C=me.getSnippets(o);if(C.length===0){b.innerHTML=`
            ...
            `,E=document.createElement("div"),E.contentEditable="true",Object.assign(E.style,i.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),E.innerHTML=f||"",A.isCode&&(E.style.fontFamily="'Roboto Mono', monospace",E.style.backgroundColor="#F8F9FA",E.setAttribute("data-is-code","true")),_.querySelectorAll(".cw-toolbar-btn").forEach(R=>{R.onmouseenter=()=>G.playHover(),R.onmousedown=()=>G.playClick()}),_.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),E.focus()},_.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),E.focus()},_.querySelector(".cw-tb-code").onclick=R=>{let D=!(E.getAttribute("data-is-code")==="true");E.setAttribute("data-is-code",D),E.style.fontFamily=D?"'Roboto Mono', monospace":"inherit",E.style.backgroundColor=D?"rgba(0, 122, 255, 0.03)":s.surface,D?R.currentTarget.classList.add("active"):R.currentTarget.classList.remove("active"),E.focus()},_.querySelector(".cw-tb-img").onclick=async()=>{let R=await Bt("Cole a URL da imagem:");R&&(document.execCommand("insertImage",!1,R),E.querySelectorAll("img").forEach(D=>{D.style.maxWidth="100%",D.style.borderRadius="8px"}))},E.onpaste=R=>{let w=(R.clipboardData||R.originalEvent.clipboardData).items;for(let D of w)if(D.kind==="file"&&D.type.startsWith("image/")){R.preventDefault();let $=D.getAsFile(),J=new FileReader;J.onload=l=>{let F=`<img src="${l.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,F)},J.readAsDataURL($)}},h.appendChild(S),h.appendChild(_)}else E=document.createElement("input"),E.type="text",Object.assign(E.style,i.input),E.value=f||"",h.appendChild(S);return E.id=`cw-inp-${C}`,E.onfocus=()=>{E.style.borderColor=s.primary,E.style.boxShadow=`0 0 0 2px ${s.primaryBg}`},E.onblur=()=>{E.style.borderColor=s.border,E.style.boxShadow="none"},h.appendChild(E),h}function L(C){return Object.entries(C).map(([O,f])=>`${O.replace(/[A-Z]/g,A=>"-"+A.toLowerCase())}:${f}`).join(";")}function k(){e=!e,ue(e,r,"cw-btn-library"),e&&W()}return k}function yo(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},n="cw-configs-styles";if(!document.getElementById(n)){let x=document.createElement("style");x.id=n,x.innerHTML=`
