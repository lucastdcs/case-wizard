...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let h=l.querySelector(".cw-hero-grid"),x=l.querySelector(".cw-acc-container"),g=l.querySelector(".cw-results-container"),u=l.querySelector(".cw-search-input"),w=l.querySelector(".cw-status-bar"),S=l.querySelector(".cw-status-text"),H=l.querySelector(".cw-footer-icons");r.forEach(([_,F])=>{let z=i(F.name),Y=document.createElement("div");Y.className="cw-hero-card",Y.id=`hero-${_}`,Y.style.setProperty("--hero-color",z.color),Y.innerHTML=`
        ...
        `,Y.onclick=L=>{if(L.target.closest(".cw-step-btn"))return;let k=a[_]?a[_].count:0;R(_,k>0?-k:1,F)},Y.querySelector(".minus").onclick=()=>R(_,-1,F),Y.querySelector(".plus").onclick=()=>R(_,1,F),Y.dataset.color=z.color,h.appendChild(Y)});function N(_,F){let z=i(F.name),Y=document.createElement("div");return Y.className="cw-task-item",Y.dataset.id=_,Y.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(u,w)=>{G.playClick(),a.querySelector(`.${u}`).classList.toggle("active"),w()};if(a.querySelector(".notes").onclick=u=>{u.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=u=>{u.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=u=>{u.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=u=>{u.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=u=>{u.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=u=>{u.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=u=>{u.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=u=>{u.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=u=>{u.stopPropagation(),i("broadcast",()=>{let w=u.currentTarget.querySelector(".cw-badge");w&&w.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(u=>{u.addEventListener("mouseenter",()=>G.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let u=document.createElement("div");u.className="cw-badge",a.querySelector(".broadcast").appendChild(u)}let r=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(r=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{r&&clearTimeout(r)},(async function(){let w=()=>{let H=Ee();if(H){let N=H.split("@")[0].toLowerCase();if(dt.includes(N)){let R=a.querySelector("#cw-admin-tag");R&&R.classList.add("visible")}}else setTimeout(w,2e3)};w(),await pt(2800),a.classList.add("docked"),await pt(300);let S=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(H=>H.classList.add("visible"));for(let H=0;H<S.length;H++)S[H].classList.add("popped"),await pt(90);await pt(200),a.classList.add("system-check")})();let s=!1,c,l,d,p,h=3;a.onmousedown=u=>{if(u.target.closest("button"))return;u.preventDefault(),c=u.clientX,l=u.clientY;let w=a.getBoundingClientRect();d=w.left,p=w.top,document.addEventListener("mousemove",x),document.addEventListener("mouseup",g)};function x(u){let w=u.clientX-c,S=u.clientY-l;!s&&Math.sqrt(w*w+S*S)>h&&(s=!0,a.classList.add("dragging"),a.style.transition="none",r&&clearTimeout(r)),s&&(a.style.left=`${d+w}px`,a.style.top=`${p+S}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function g(u){if(document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",g),s){s=!1,a.classList.remove("dragging");let w=window.innerWidth,S=window.innerHeight,H=a.getBoundingClientRect(),N=H.left+H.width/2,R;N<w/2?(R=24,a.classList.remove("side-right"),a.classList.add("side-left")):(R=w-H.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let Z=Math.max(24,Math.min(H.top,S-H.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${R}px`,a.style.top=`${Z}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let w=a.querySelector(".cw-btn.active"),S=u.target.closest("button");if(a.classList.contains("collapsed")){let H=a.getBoundingClientRect(),N=window.innerHeight,R=H.top>N/2;if(a.style.setProperty("transition","none","important"),R){let Z=N-H.bottom;a.style.top="auto",a.style.bottom=`${Z}px`}else a.style.bottom="auto",a.style.top=`${H.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),G.playGenieOpen()}else!w&&!S&&(a.classList.add("collapsed"),G.playGenieOpen());S&&(S.style.transform="scale(0.9)",setTimeout(()=>S.style.transform="",150))}}}function Ze(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
...
`.replace(/\n/g,"<br>");Qe(_);let F=await bt();F?(F.innerText.trim()===""&&(F.innerHTML=""),document.execCommand("insertHTML",!1,_),gt(F),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var be=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Fe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let r,s;if(!n)r=window.innerWidth/2,s=window.innerHeight/2;else{let d=e.getBoundingClientRect();r=d.left+d.width/2,s=d.top+d.height/2,r===0&&s===0&&(r=window.innerWidth/2,s=window.innerHeight/2)}let c=i.x-r,l=i.y-s;t?(G.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${c}px, ${l}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${l}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof bo=="function"&&bo(e,o)):(G.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${c}px, ${l}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${c}px), calc(-50% + ${l}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof Lt=="function"&&Lt(e))}function bo(t,e){Lt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),r=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):r||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function Lt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function fo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Zt(t,J),r=no(b),s=ao(()=>{k(),W.setActiveTasks(s.getCheckedElements())},b,W),c=document.createElement("div");c.style.display="none";let l=oo((m,A)=>{C(m,A)});c.appendChild(l);let d=lo({onSaveCurrent:async()=>{let m=await v();return I(),m},onLoadDraft:m=>{j(m)},t:m=>b(m)}),p=F(),h=z(),x=document.createElement("div"),g=U(),u=O(d,b);o.appendChild(p),o.appendChild(h),o.appendChild(g),o.appendChild(c),o.appendChild(x),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none";let w=document.createElement("button");w.id="manual-task-toggle",w.textContent=b("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",w.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${B.primary}; background: ${B.surface}; color: ${B.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,w.onmouseenter=()=>{w.style.background=B.primaryBg},w.onmouseleave=()=>{w.style.background=B.surface},w.onclick=()=>{s.selectionElement.style.display="block",s.screenshotsElement.style.display="block",w.style.display="none"},o.appendChild(w),o.appendChild(s.selectionElement),o.appendChild(r.element),o.appendChild(s.screenshotsElement),o.appendChild(u);let S=document.createElement("div");S.style.display="none",S.style.flexGrow="1",S.style.minHeight="0",S.style.overflow="hidden";let H=uo(()=>_());H.style.height="100%",S.appendChild(H),e.insertBefore(S,i);let N=a.lastElementChild;N&&(N.insertBefore(d.historyBtnWrapper,N.firstChild),N.insertBefore(P(),N.firstChild)),e.appendChild(d.drawer);let R=null;W.subscribe(m=>{M(m),Z(),m.isDirty?(R&&clearTimeout(R),R=setTimeout(async()=>{let A=await v(!0);A.subStatus?ge.saveEmergency(A):ge.clearEmergency(),m.isDirty=!1},2e3)):R&&(clearTimeout(R),R=null)});function Z(){let m=ge.getCount()>0,A=!!W.currentSubStatus;ut(m||A)}function J(){W.visible=!W.visible,ue(W.visible,e,"cw-btn-notes")}function _(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",S.style.display="flex",S.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",S.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function F(){let m=document.createElement("div");if(m.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let y=document.createElement("style");y.id="cw-segmented-styles",y.innerHTML=`
            ...
            `,document.head.appendChild(y)}let A=(y,$)=>{let K=m.querySelector(`#${y}`).querySelector(".cw-segmented-indicator");K&&(K.style.transform=`translateX(${$*100}%) translateX(${$*2}px)`)};return m.querySelectorAll("#lang-selector button").forEach((y,$)=>{y.onclick=()=>{W.setLanguage(y.dataset.lang),m.querySelectorAll("#lang-selector button").forEach(D=>D.classList.remove("active")),y.classList.add("active"),A("lang-selector",$),G.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m.querySelectorAll("#type-selector button").forEach((y,$)=>{y.onclick=()=>{W.setCaseType(y.dataset.type),m.querySelectorAll("#type-selector button").forEach(D=>D.classList.remove("active")),y.classList.add("active"),A("type-selector",$),G.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m.querySelectorAll("#portugal-selector button").forEach((y,$)=>{y.onclick=()=>{W.setPortugalCase(y.dataset.val==="true"),m.querySelectorAll("#portugal-selector button").forEach(D=>D.classList.remove("active")),y.classList.add("active"),A("portugal-selector",$),G.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m}function z(){let m=document.createElement("div");m.className="cw-status-section",m.style.cssText="display: flex; flex-direction: column; gap: 8px;",m.innerHTML=`
        ...
        `;let A=m.querySelector("#main-status-select"),y=m.querySelector("#sub-status-select");return A.onchange=()=>{W.setStatus(A.value),Y(A.value,y),W.setSubStatus(""),L("")},y.onchange=()=>{W.setSubStatus(y.value),L(y.value)},m}function Y(m,A){if(A.innerHTML=`<option value="">${b("select_substatus")}</option>`,!m){A.disabled=!0;return}for(let y in ke)if(ke[y].status===m){let $=document.createElement("option");$.value=y,$.textContent=ke[y].name,A.appendChild($)}A.disabled=!1}function L(m){if(l.render&&l.render(m,W.currentCaseType),!m){c.style.display="none",x.style.display="none",document.getElementById("manual-task-toggle").style.display="none",s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",g.style.display="flex",g.style.opacity="1",u.style.display="none";return}g.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(g.style.display="none")},400),u.style.display="grid";let A=ke[m];A&&A.templateFields&&W.setActiveFields(A.templateFields),q(),Tt(m,x,W),x.style.display="block",c.style.display="block";let y=m.startsWith("SO_"),$=m==="NI_Awaiting_Validation",D=document.getElementById("manual-task-toggle");y||$?(s.selectionElement.style.display="block",D.style.display="none"):(s.selectionElement.style.display="none",s.screenshotsElement.style.display="none",D.style.display="block");let K=m==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(K),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),s.updateSubStatus(m),k();let V=document.getElementById("email-automation-toggle-row");V&&(V.style.display=He[m]?"flex":"none")}function k(){let m=s.getCheckedElements().map(A=>A.value);r.updateVisibility(W.currentSubStatus,m)}function C(m,A){let y=st[m];if(y){for(let $ in y)if($==="linkedTask")s.toggleTask(y.linkedTask,A);else if($==="activeTasks")y.activeTasks.forEach(D=>{A?s.setTaskCount(D.value,D.count):s.setTaskCount(D.value,0)});else if($.startsWith("field-")){let D=$,K=y[$],V=document.getElementById(D);if(V){let ee=je.includes(D.replace("field-",""));if(A)if(ee){let oe=V.value.trim();oe.includes(K.trim())||(V.value=oe?oe+`
`+K.trim():K.trim())}else V.value=K;else if(ee){let oe=V.value.trim(),Q=K.trim();oe.includes(Q)&&(V.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else V.value.trim()===K.trim()&&(V.value="");W.updateField(D,V.value),V.dispatchEvent(new Event("input"))}}}}function O(m,A){let y=document.createElement("div");if(y.className="cw-actions-section",y.style.cssText=`
            display: grid;
        ...
        `;let D=m.parkButton;D.classList.add("js-btn-park"),D.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let K=document.createElement("button");K.className="cw-btn-secondary js-btn-reset",K.textContent=A("limpar"),K.style.cssText=`width: 100%; height: 34px; background: ${B.surface}; color: ${B.textSub}; border: 1px solid ${B.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,K.onclick=()=>I();let V=document.createElement("button");V.className="cw-btn-secondary js-btn-copy",V.textContent=A("copiar"),V.style.cssText=`width: 100%; height: 34px; background: ${B.surface}; color: ${B.primary}; border: 1px solid ${B.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,V.onclick=()=>f();let ee=document.createElement("button");return ee.className="cw-btn-primary js-btn-generate",ee.textContent=A("preencher"),ee.style.cssText=`width: 100%; height: 38px; background: ${B.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ee.onclick=()=>T(),y.appendChild($),y.appendChild(D),y.appendChild(K),y.appendChild(V),y.appendChild(ee),y}async function f(){if(!W.currentSubStatus){X(b("select_substatus"),{error:!0});return}let m=kt(W,s,r);m?(Qe(m),X(b("copiado_sucesso")),G.playClick()):X(b("select_substatus"),{error:!0})}async function T(){if(!W.currentSubStatus){X(b("select_substatus"),{error:!0});return}let m=kt(W,s,r);Qe(m),J();let A=Ze(),y=await bt();if(y){y.focus(),document.execCommand("insertHTML",!1,m),gt(y);let $=document.getElementById("email-automation-checkbox");(!$||$.checked)&&W.currentSubStatus&&He[W.currentSubStatus]&&await ht(He[W.currentSubStatus]),X(b("inserido_copiado")),G.playSuccess(),I()}A()}function q(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let m=ke[W.currentSubStatus];m&&m.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function I(){W.reset(),s.reset(),r.reset(),Z(),ge.clearEmergency(),o.querySelectorAll("select").forEach(A=>A.value=""),o.querySelector("#sub-status-select").disabled=!0;let m=document.getElementById("email-automation-toggle-row");m&&(m.style.display="none"),x.innerHTML="",c.style.display="none",g.style.display="flex",g.style.opacity="1",u.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),s.selectionElement.style.display="none",s.screenshotsElement.style.display="none"}async function v(m=!1){let A={};x.querySelectorAll("input, textarea, select").forEach(V=>{(V.id.startsWith("field-")||V.id==="consent-select")&&(A[V.id]=V.value)});let y="Cliente",$="---";if(!m)try{let V=await we();y=V.advertiserName,$=V.cid}catch(V){console.warn("Erro ao coletar pageData:",V)}let D=s.getCheckedElements().map(V=>({key:V.value,count:V.count})),K=D.map(V=>{let ee=Ce[V.key];return ee?ee.name:V.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:A,activeTasks:D,summaryTags:K,clientName:y,cid:$,timestamp:new Date().toISOString()}}let E=m=>new Promise(A=>setTimeout(A,m));async function j(m){W.setLanguage(m.currentLang||"pt"),W.setCaseType(m.currentCaseType||"bau"),W.setPortugalCase(m.isPortugalCase||!1),W.setConsent(m.consent||!1),W.setExcludedFields(m.excludedFields||[]),m.activeFields&&W.setActiveFields(m.activeFields);let A=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);A&&A.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(D=>{D!==A&&D.classList.remove("active")});let y=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);y&&y.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(D=>{D!==y&&D.classList.remove("active")});let $=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if($&&$.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(D=>{D!==$&&D.classList.remove("active")}),m.status){let D=o.querySelector("#main-status-select");D.value=m.status,W.setStatus(m.status);let K=o.querySelector("#sub-status-select");if(Y(m.status,K),await E(50),m.subStatus){if(K.value=m.subStatus,W.setSubStatus(m.subStatus),L(m.subStatus),await E(100),m.tagSupportUsed!==void 0){W.setTagSupportUsed(m.tagSupportUsed);let V=r.element.querySelector('input[value="Sim"]'),ee=r.element.querySelector('input[value="N\xE3o"]');m.tagSupportUsed&&V?V.checked=!0:ee&&(ee.checked=!0),r.element.querySelector("div:last-child").style.display=m.tagSupportUsed?"none":"block"}m.forcedScreenshots&&W.setForcedScreenshots(m.forcedScreenshots);for(let V in m.formData){let ee=document.getElementById(V);ee&&(ee.value=m.formData[V],W.updateField(V,ee.value))}m.activeTasks&&(m.activeTasks.forEach(V=>s.setTaskCount(V.key,V.count)),W.setActiveTasks(s.getCheckedElements()))}}W.isDirty=!1}function b(m){return Se[W.currentLang]?.[m]||Se.pt?.[m]||m}function P(){let m=document.createElement("div");return m.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',m.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",m.onclick=A=>{A.stopPropagation(),_()},m.title="Alternar para Split & Transfer",m}function U(){let m=document.createElement("div");return m.id="notes-empty-state",m.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(l),Object.assign(c.style,me,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let d=pe(c,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:c},()=>C()),p=document.createElement("div");Object.assign(p.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:s.bgApp});let h=document.createElement("div");Object.assign(h.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${s.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let x=document.createElement("div");Object.assign(x.style,{padding:"16px",borderBottom:`1px solid ${s.borderSubtle}`,position:"relative"});let g=document.createElement("input");g.placeholder="Buscar templates...",Object.assign(g.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:s.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),g.onfocus=()=>{g.style.backgroundColor="#FFFFFF",g.style.borderColor=s.primary,g.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",g.style.transform="scale(1.02)"},g.onblur=()=>{g.style.backgroundColor="#E3E3E8",g.style.borderColor="transparent",g.style.boxShadow="none",g.style.transform="scale(1)"};let u=document.createElement("div");u.id="email-template-list",Object.assign(u.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let w=document.createElement("div");w.innerHTML="\u2715",Object.assign(w.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),w.onclick=()=>{g.value="",n="",w.style.display="none",f(),g.focus()},x.appendChild(g),x.appendChild(w),h.appendChild(x),h.appendChild(u);let S=document.createElement("div");Object.assign(S.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:s.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let H=document.createElement("div");Object.assign(H.style,{padding:"20px",borderBottom:`1px solid ${s.borderSubtle}`,backgroundColor:s.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let N=document.createElement("div");Object.assign(N.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:s.bgApp,overflow:"hidden"});let R=document.createElement("div");Object.assign(R.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let Z=document.createElement("span");Z.textContent="Preview do E-mail",Object.assign(Z.style,{fontSize:"12px",fontWeight:"600",color:s.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let J=document.createElement("div");Object.assign(J.style,{display:"flex",gap:"8px"});let _=(E,j=!1)=>{let b=document.createElement("button");return b.textContent=E,Object.assign(b.style,{padding:"8px 14px",borderRadius:"10px",border:j?"none":`1.5px solid ${s.primary}`,background:j?s.primary:"transparent",color:j?"#fff":s.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:j?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),b.onmouseenter=()=>{j?(b.style.backgroundColor="#0062CC",b.style.transform="translateY(-1px)",b.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):b.style.backgroundColor="rgba(0, 122, 255, 0.05)"},b.onmouseleave=()=>{j?(b.style.backgroundColor=s.primary,b.style.transform="translateY(0)",b.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(b.style.backgroundColor="transparent",b.style.transform="translateY(0)")},b.onmousedown=()=>b.style.transform="scale(0.94)",b.onmouseup=()=>b.style.transform="scale(1)",b},F=_("Copiar HTML"),z=_("Preencher no CRM",!0),Y=_("Smart CR");Y.style.borderColor="#E67E22",Y.style.color="#E67E22",Y.style.display="none",J.appendChild(Y),J.appendChild(F),J.appendChild(z),R.appendChild(Z),R.appendChild(J);let L=document.createElement("div");L.contentEditable="true",Object.assign(L.style,{flex:"1",backgroundColor:s.bgSurface,border:`1px solid ${s.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:s.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),N.appendChild(R),N.appendChild(L),v(),S.appendChild(H),S.appendChild(N),p.appendChild(h),p.appendChild(S),c.appendChild(d),c.appendChild(p);let k=document.createElement("div");Object.assign(k.style,Ae),c.appendChild(k),Te(c,k),document.body.appendChild(c);function C(){e=!e,e?(c.style.display="flex",Vt(c),o.length===0&&O()):c.style.display="none",ue(e,c,"cw-btn-email")}async function O(){u.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await ho.getTemplates(),f()}function f(){u.innerHTML="";let E=o.filter(M=>M.name.toLowerCase().includes(n.toLowerCase())||M.category.toLowerCase().includes(n.toLowerCase())),j=Object.entries(He).filter(([M,m])=>m&&(M.toLowerCase().includes(n.toLowerCase())||m.toLowerCase().includes(n.toLowerCase()))).map(([M,m])=>({id:M,name:M.replace(/_/g," "),category:"\u26A1 Smart CRs",code:m,isSmartCR:!0})),b=he.getSnippets("email").filter(M=>M.title.toLowerCase().includes(n.toLowerCase())||M.subject&&M.subject.toLowerCase().includes(n.toLowerCase())).map(M=>{let m=[],A=M.content.match(/\[([^\]]+)\]/g);return A&&[...new Set(A)].forEach(y=>{m.push({key:y,label:y.replace("[","").replace("]",""),type:y.toLowerCase().includes("data")?"date":"text",auto:y.toLowerCase().includes("nome")&&y.toLowerCase().includes("seu")?"agentName":null})}),{id:M.id||`snippet-${Math.random()}`,name:M.title,category:"\u{1F464} Pessoal",subject:M.subject||"Sem Assunto",template:M.content,placeholders:m}}),P=[...E,...j,...b];if(P.length===0){u.innerHTML=`
                ...
                </div>`):H.style.display="none";return}let E=a.placeholders&&a.placeholders.length>0;if(H.style.display=E?"block":"none",!E)return;let j=document.createElement("div");Object.assign(j.style,{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"}),(a.placeholders||[]).forEach(b=>{let P=document.createElement("div"),U=document.createElement("label");U.textContent=b.label,Object.assign(U.style,{display:"block",fontSize:"11px",fontWeight:"700",color:s.textSecondary,marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.5px"});let M=document.createElement("input");M.type=b.type||"text",M.dataset.key=b.key,Object.assign(M.style,{width:"100%",padding:"10px 12px",borderRadius:"8px",border:`1.5px solid ${s.borderSubtle}`,backgroundColor:"#FBFBFD",fontSize:"14px",boxSizing:"border-box",transition:"all 0.2s ease",outline:"none"}),M.onfocus=()=>{M.style.borderColor=s.primary,M.style.backgroundColor="#FFFFFF",M.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)"},M.onblur=()=>{M.style.borderColor=s.borderSubtle,M.style.backgroundColor="#FBFBFD",M.style.boxShadow="none"},b.auto==="agentName"&&(M.value=We().split(" ")[0]),M.addEventListener("input",v),P.appendChild(U),P.appendChild(M),j.appendChild(P)}),H.appendChild(j)}function v(){if(!a){L.innerHTML=`
...
CID: ${A.cid||"---"}
Case ID: ${A.caseId||"---"}
E-mail: ${A.clientEmail||"---"}`;$&&($.value=K),D&&(D.style.display="block",D.style.maxHeight="300px",D.style.opacity="1",D.scrollIntoView({behavior:"smooth",block:"end"}))})}function x(){s=!s,ue(s,c,"cw-btn-script"),s?(p(),d||(d=setInterval(p,2e3))):d&&(clearInterval(d),d=null)}let g=pe(c,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",l,()=>{x()});c.appendChild(g);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `,u.onfocus=()=>{x.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",x.style.border="1px solid #1a73e8"},u.onblur=()=>{x.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",x.style.border="1px solid transparent"},x.appendChild(g),x.appendChild(u),h.appendChild(x),p.appendChild(h);let w=document.createElement("div");w.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",p.appendChild(w);let S=null;function H(){if(S)return;S=document.createElement("div"),S.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let k=document.createElement("div");k.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",k.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let C=document.createElement("button");C.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',C.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",C.onclick=()=>{R(),n=!1,F()},k.appendChild(C),S.appendChild(k);let O=document.createElement("div");O.id="cw-history-list",O.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",S.appendChild(O),p.appendChild(S)}function N(){S||H();let k=S.querySelector("#cw-history-list");k.innerHTML="";let C=na();C.length===0?k.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':C.forEach(O=>{let f=Y(O,Be[O._originalCat],!0,O._originalCat);k.appendChild(f)}),requestAnimationFrame(()=>S.style.transform="translateY(0)")}function R(){S&&(S.style.transform="translateY(100%)")}function Z(){d.innerHTML="";let k=J("history","Recentes",Be.history);k.id="cw-sidebar-btn-history",k.onclick=()=>{G.playClick(),n=!n,n?N():R(),F()},d.appendChild(k);let C=document.createElement("div");C.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(C),Object.keys(et).forEach(O=>{let f=et[O],T=J(O,f.label,Be[O]);T.id=`cw-sidebar-btn-${O}`,T.onclick=()=>{G.playClick(),n&&(n=!1,R()),_(O)},d.appendChild(T)})}function J(k,C,O){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary};
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=C,f.dataset.key=k;let T=document.createElement("div");T.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",T.innerHTML=O||Be.tasks;let q=document.createElement("div");return q.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",q.textContent=C,f.appendChild(T),f.appendChild(q),f.onmouseenter=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="#F1F3F4",T.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="transparent",T.style.transform="scale(1)")},f}function _(k){let C=document.getElementById(`cat-anchor-${k}`);C&&(C.scrollIntoView({behavior:"smooth",block:"start"}),a=k,F())}function F(){Object.keys(et).forEach(C=>{let O=d.querySelector(`#cw-sidebar-btn-${C}`);if(O)if(a===C&&!n){let f=yt[C];O.style.background=f.bg,O.style.color=f.color,O.querySelector("div:first-child").style.transform="scale(1.1)"}else O.style.background="transparent",O.style.color=i.textSecondary,O.querySelector("div:first-child").style.transform="scale(1)"});let k=d.querySelector("#cw-sidebar-btn-history");k&&(n?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=i.textSecondary))}function z(){if(w.innerHTML="",e.trim()!==""){let C=[];if(Object.entries(et).forEach(([f,T])=>{let q=T.links.filter(I=>I.name.toLowerCase().includes(e.toLowerCase())||I.desc.toLowerCase().includes(e.toLowerCase()));C.push(...q.map(I=>({...I,_cat:f})))}),C.length===0){w.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let O=document.createElement("div");O.innerHTML="Resultados da busca",O.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",w.appendChild(O),C.forEach(f=>{let T=Y(f,Be[f._cat],!1,f._cat);w.appendChild(T)});return}Object.entries(et).forEach(([C,O])=>{let f=yt[C],T=document.createElement("div"),q=document.createElement("div");q.id=`cat-anchor-${C}`,q.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,q.innerHTML=`
            ...
            ${O.label}
          `,T.appendChild(q);let I=document.createElement("div");I.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",O.links.forEach(v=>{let E=Y(v,Be[C],!1,C);I.appendChild(E)}),T.appendChild(I),w.appendChild(T)});let k=document.createElement("div");k.style.height="80px",w.appendChild(k)}function Y(k,C,O,f){let T=document.createElement("div"),q=yt[f]||yt.history;T.style.cssText=`
      ...
      `;let I=document.createElement("div");I.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,I.innerHTML=C||Be.tasks;let v=I.querySelector("svg");v&&(v.style.width="22px",v.style.height="22px");let E=document.createElement("div");E.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let j=document.createElement("div");j.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,j.textContent=k.name;let b=document.createElement("div");b.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,b.textContent=k.desc,E.appendChild(j),E.appendChild(b);let P=document.createElement("div");return P.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',P.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,P.title="Copiar URL",T.onmouseenter=()=>{T.style.transform="translateY(-2px)",T.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",T.style.borderColor="rgba(0,0,0,0.05)",T.style.borderLeft=`4px solid ${q.color}`,P.style.opacity="1",P.style.background="#F1F3F4"},T.onmouseleave=()=>{T.style.transform="translateY(0)",T.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",T.style.border="1px solid transparent",P.style.opacity="0",P.style.background="transparent"},T.onclick=()=>{!O&&f&&Co(k,f),window.open(k.url,"_blank")},P.onclick=U=>{U.stopPropagation(),G.playClick(),navigator.clipboard.writeText(k.url),!O&&f&&Co(k,f),X("Link copiado!")},T.appendChild(I),T.appendChild(E),T.appendChild(P),T}u.addEventListener("input",k=>{e=k.target.value,z()});function L(){o=!o,ue(o,r,"cw-btn-links")}return document.body.appendChild(r),Z(),z(),L}var _e=[];function _t(t){_e=t}var ia=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Ao(){let t="v4.9",e=!1,o=null,a=null;function n(f){if(!f)return"";try{let T=new Date(f);return isNaN(T.getTime())?String(f):T.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,g.querySelectorAll('input[name="cw-bc-type"]').forEach(I=>{I.addEventListener("change",()=>{g.querySelectorAll(".cw-radio-option").forEach(v=>v.classList.remove("checked")),I.parentElement.classList.add("checked")})}),setTimeout(()=>{let I=g.querySelector(".cw-radio-option.info");I&&I.classList.add("checked")},100);let f=g.querySelector("#cw-bc-cancel"),T=g.querySelector("#cw-bc-close-x"),q=g.querySelector("#cw-bc-send");f.onclick=N,T.onclick=N,q.onclick=R,l.appendChild(g)}function H(f=null){if(!g)return;let T=g.querySelector("#cw-editor-title-label"),q=g.querySelector("#cw-bc-title"),I=g.querySelector("#cw-bc-text"),v=g.querySelector("#cw-bc-send");if(f){a=f.id,T.textContent="Editar Aviso",q.value=f.title||"",I.value=f.text||"",v.textContent="Salvar Altera\xE7\xF5es";let E=f.type||"info",j=g.querySelector(`input[name="cw-bc-type"][value="${E}"]`);j&&j.click()}else{a=null,T.textContent="Novo Aviso",q.value="",I.value="",v.textContent="Publicar";let E=g.querySelector('input[name="cw-bc-type"][value="info"]');E&&E.click()}g.classList.add("active"),setTimeout(()=>q.focus(),300)}function N(){g&&g.classList.remove("active"),a=null}async function R(){let f=g.querySelector("#cw-bc-send"),T=g.querySelector("#cw-bc-title"),q=g.querySelector("#cw-bc-text"),I=g.querySelector('input[name="cw-bc-type"]:checked'),v=I?I.value:"info";if(!T.value.trim()||!q.value.trim()){X("Preencha todos os campos!",{error:!0});return}f.textContent="Salvando...",f.style.opacity="0.7";let E=!1;a?E=await fe.updateBroadcast(a,{title:T.value,text:q.value,type:v}):E=await fe.sendBroadcast({title:T.value,text:q.value,type:v,author:window._cwCurrentUser||"admin"}),E?(X(a?"Atualizado!":"Publicado!"),G.playSuccess(),N(),setTimeout(()=>_(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),f.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",f.style.opacity="1")}async function Z(f){if(await xe("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await fe.deleteBroadcast(f)){X("Aviso removido."),G.playClick();let I=_e.findIndex(v=>v.id===f);I>-1&&_e.splice(I,1),z(),setTimeout(()=>_(),1500)}else X("Erro ao excluir.",{error:!0})}let J=document.createElement("div");J.className="cw-nice-scroll",Object.assign(J.style,i.feedContainer),l.appendChild(J);async function _(){e&&(w.style.display="block",w.innerHTML="\u{1F504} Sincronizando...");try{let f=await fe.fetchData();f&&f.broadcast&&(_t(f.broadcast),F(),e&&(z(),w.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{w.style.display="none"},1500)))}catch{e&&(w.innerHTML="\u26A0\uFE0F Offline")}}function F(){let f=document.getElementById("cw-btn-broadcast");if(!f)return;let T=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(_e.some(I=>!T.includes(I.id))){if(f.classList.add("has-new"),!f.querySelector(".cw-badge")){let I=document.createElement("div");I.className="cw-badge",Object.assign(I.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),f.appendChild(I)}}else{f.classList.remove("has-new");let I=f.querySelector(".cw-badge");I&&I.remove()}}function z(){J.innerHTML="";let f=l.querySelector("#cw-bau-widget");f&&f.remove();let T=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),q=[..._e].sort((b,P)=>{let U=new Date(b.date).getTime()||0;return(new Date(P.date).getTime()||0)-U}),I=q.findIndex(b=>b.title&&b.title.toLowerCase().includes("disponibilidade bau"));if(I!==-1){let b=q[I];q.splice(I,1);let P=document.createElement("div");P.id="cw-bau-widget",Object.assign(P.style,i.bauContainer);let U=[],M=(b.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,A="\u{1F4C5}";if(M.forEach(V=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(V)?A="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(V)&&(A="\u{1F1EA}\u{1F1F8}");let ee=V.match(m);if(ee){let oe=ee[0],Q=A;/🇧🇷|🇵🇹|PT|BR/i.test(V)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(V)&&(Q="\u{1F1EA}\u{1F1F8}"),U.some(te=>te.flag===Q&&te.date===oe)||U.push({flag:Q,date:oe})}}),U.length===0){let V=(b.text||"").match(/\d{1,2}\/\d{1,2}/g);V&&[...new Set(V)].forEach(ee=>U.push({flag:"\u{1F4C5}",date:ee}))}let y="",$='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&($=`
              ...
              `),U.length>0?y=`
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                      <div style="flex:1; display:flex; gap:8px;">${U.map(ee=>`
          ...
          `,w.after(P);let D=P.querySelector("#cw-bau-toggle-btn"),K=P.querySelector("#cw-bau-full");if(D&&K&&(D.onclick=()=>{let V=K.style.display==="none";K.style.display=V?"block":"none",D.textContent=V?"Ocultar":"Detalhes"}),window._cwIsAdmin){let V=P.querySelector(".cw-bau-edit");V&&(V.onclick=()=>H(b))}}let v=q.sort((b,P)=>{let U=T.includes(b.id),M=T.includes(P.id);return U===M?0:U?1:-1});if(v.length===0&&!I){let b=document.createElement("div");Object.assign(b.style,i.emptyState),b.innerHTML=`
           ...
           `,J.appendChild(b)}let E=v.filter(b=>!T.includes(b.id)),j=v.filter(b=>T.includes(b.id));if(E.forEach(b=>J.appendChild(Y(b,!1))),j.length>0){let b=document.createElement("div");Object.assign(b.style,i.historyDivider),b.innerHTML=`<span>Hist\xF3rico (${j.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let P=document.createElement("div");Object.assign(P.style,i.historyContainer),j.forEach(M=>P.appendChild(Y(M,!0)));let U=!1;b.onclick=()=>{G.playClick(),U=!U,P.style.display=U?"flex":"none",b.querySelector("svg").style.transform=U?"rotate(180deg)":"rotate(0deg)"},J.appendChild(b),J.appendChild(P)}}function Y(f,T){let q=document.createElement("div");Object.assign(q.style,T?i.cardHistory:i.card);let I=r[f.type]||r.info,v=document.createElement("div");Object.assign(v.style,i.cardHeader);let E=document.createElement("div");Object.assign(E.style,i.typeTag,{color:I.color,background:I.bg}),E.innerHTML=`${I.icon} <span>${f.type}</span>`;let j=document.createElement("span");if(Object.assign(j.style,i.dateTag),j.textContent=n(f.date),v.appendChild(E),T)v.appendChild(j);else{let m=document.createElement("button");m.className="cw-btn-interactive",Object.assign(m.style,i.dismissBtn),m.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',m.onmouseenter=()=>{m.style.color="#1e8e3e",m.style.background="#e6f4ea",m.style.borderColor="#1e8e3e"},m.onmouseleave=()=>{m.style.color="#5f6368",m.style.background="#fff",m.style.borderColor="rgba(0,0,0,0.1)"},m.onclick=A=>{A.stopPropagation(),G.playClick(),q.style.transform="translateX(20px)",q.style.opacity="0",setTimeout(()=>{let y=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");y.push(f.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(y)),z(),F()},200)},v.appendChild(m)}let b=document.createElement("div");Object.assign(b.style,i.cardContent);let P=document.createElement("div");Object.assign(P.style,i.msgTitle),P.textContent=f.title;let U=document.createElement("div");Object.assign(U.style,i.msgBody),U.innerHTML=c(f.text);let M=document.createElement("div");if(Object.assign(M.style,i.msgMeta),M.innerHTML=`Publicado por <b>${f.author||"Sistema"}</b>`,T||(M.innerHTML+=` \u2022 ${n(f.date)}`),b.appendChild(P),b.appendChild(U),b.appendChild(M),q.appendChild(v),q.appendChild(b),window._cwIsAdmin){let m=document.createElement("div");m.className="cw-card-actions";let A=document.createElement("button");A.className="cw-action-btn edit",A.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',A.onclick=()=>H(f);let y=document.createElement("button");y.className="cw-action-btn delete",y.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',y.onclick=()=>Z(f.id),m.appendChild(A),m.appendChild(y),q.appendChild(m)}return q}let L=fe.getCachedBroadcasts();L.length>0&&(_t(L),z()),setTimeout(u,500),_(),o||(o=setInterval(_,ia));let k=document.createElement("div");Object.assign(k.style,Ae),k.className="no-drag",l.appendChild(k),Te(l,k),document.body.appendChild(l);let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=_e.some(f=>!C.includes(f.id));return{toggle:p,hasUnread:O}}function To(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let r=document.createElement("div");Object.assign(r.style,o.title);let s=document.createElement("div");Object.assign(s.style,o.text);let c=document.createElement("div");Object.assign(c.style,o.dotsContainer);let l=document.createElement("div");Object.assign(l.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let p=document.createElement("button");p.textContent="Pr\xF3ximo",Object.assign(p.style,o.btn,o.btnNext),p.onmouseover=()=>p.style.transform="scale(1.05)",p.onmouseout=()=>p.style.transform="scale(1)",l.appendChild(d),l.appendChild(p),n.appendChild(i),n.appendChild(r),n.appendChild(s),n.appendChild(c),n.appendChild(l),a.appendChild(n),document.body.appendChild(a);function h(g){let u=t[g];i.textContent=u.icon,r.textContent=u.title,s.textContent=u.text,c.innerHTML="",t.forEach((w,S)=>{let H=document.createElement("div");Object.assign(H.style,o.dot),S===g&&Object.assign(H.style,o.dotActive),c.appendChild(H)}),u.isLast?(d.style.display="none",p.textContent="Come\xE7ar \u{1F680}",p.style.width="100%"):(d.style.display="block",p.textContent="Pr\xF3ximo",p.style.width="auto")}function x(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),G.playSuccess(),X("Tudo pronto! Use o menu flutuante.")}p.onclick=()=>{G.playClick(),e<t.length-1?(e++,h(e)):x()},d.onclick=async()=>{await xe("Pular o tutorial?")&&x()},h(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var ko={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function Fo(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&ra(t)}function ra(t){let e=ko.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let r=document.createElement("div");Object.assign(r.style,a.badge),r.textContent=`Atualiza\xE7\xE3o ${t}`;let s=document.createElement("div");Object.assign(s.style,a.icon);let c=document.createElement("div");Object.assign(c.style,a.title);let l=document.createElement("div");Object.assign(l.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let p=document.createElement("button");Object.assign(p.style,a.btn),p.onmouseover=()=>p.style.transform="scale(1.02)",p.onmouseout=()=>p.style.transform="scale(1)",i.appendChild(r),i.appendChild(s),i.appendChild(c),i.appendChild(l),i.appendChild(d),i.appendChild(p),n.appendChild(i),document.body.appendChild(n);function h(g){let u=e[g];s.textContent=u.icon,c.textContent=u.title,l.textContent=u.text,d.innerHTML="",e.forEach((w,S)=>{let H=document.createElement("div");Object.assign(H.style,a.dot),S===g&&Object.assign(H.style,a.dotActive),d.appendChild(H)}),g===e.length-1?p.textContent="Entendi, vamos l\xE1! \u{1F44D}":p.textContent="Pr\xF3ximo"}function x(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),G.playSuccess(),X(`TechSol atualizado para ${t}!`)}p.onclick=()=>{G.playClick(),o<e.length-1?(o++,h(o)):x()},h(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Oo="cw_timezone_pinned",Mt=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],sa=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function Io(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Oo)||"[]"),i="",r="all",s=new Date;s.setHours(14,0,0,0);let c={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},l={container:{display:"flex",flexDirection:"column",height:"100%",background:c.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:c.surface,borderBottom:`1px solid ${c.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:c.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:c.primary,borderBottomColor:c.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:c.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:c.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${c.border}`,background:c.surface,color:c.textSub,transition:"all 0.2s"},chipActive:{background:c.primaryBg,color:c.primary,borderColor:c.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:c.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${c.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:c.surface,border:`1px solid ${c.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:c.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let h=pe(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>T());d.appendChild(h);let x=document.createElement("div");Object.assign(x.style,l.container),d.appendChild(x);let g=document.createElement("div");Object.assign(g.style,l.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,l.tabBtn,l.tabActive);let w=document.createElement("div");w.textContent="Planejador",Object.assign(w.style,l.tabBtn),g.appendChild(u),g.appendChild(w),x.appendChild(g);let S=document.createElement("div");Object.assign(S.style,l.toolbar);let H=document.createElement("div");Object.assign(H.style,l.searchInputWrapper);let N=document.createElement("div");N.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(N.style,l.searchIcon);let R=document.createElement("input");R.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(R.style,l.searchInput),R.onfocus=()=>{R.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",R.style.borderColor="rgba(26,115,232,0.3)"},R.onblur=()=>{R.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",R.style.borderColor="transparent"},R.oninput=q=>{i=q.target.value.toLowerCase(),k()},H.appendChild(N),H.appendChild(R),S.appendChild(H);let Z=document.createElement("div");Object.assign(Z.style,l.chipsRow),sa.forEach(q=>{let I=document.createElement("div");I.textContent=q.label,I.id=`tz-filter-${q.id}`,Object.assign(I.style,l.chip),q.id===r&&Object.assign(I.style,l.chipActive),I.onclick=()=>{G.playClick(),r=q.id,Array.from(Z.children).forEach(v=>{Object.assign(v.style,l.chip)}),Object.assign(I.style,l.chipActive),k()},Z.appendChild(I)}),S.appendChild(Z),x.appendChild(S);let J=document.createElement("div");Object.assign(J.style,l.listContainer);let _=document.createElement("style");_.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",x.appendChild(_);let F=document.createElement("div");Object.assign(F.style,l.plannerWrapper,{display:"none"}),x.appendChild(J),x.appendChild(F),u.onclick=()=>z("live"),w.onclick=()=>z("plan");function z(q){G.playClick(),q==="live"?(Object.assign(u.style,l.tabActive),Object.assign(w.style,l.tabBtn),w.style.borderBottomColor="transparent",J.style.display="flex",S.style.display="flex",F.style.display="none",O()):(Object.assign(w.style,l.tabActive),Object.assign(u.style,l.tabBtn),u.style.borderBottomColor="transparent",F.style.display="flex",J.style.display="none",S.style.display="none",f(),C())}function Y(q){return q>=9&&q<17?{color:c.success,bg:c.successBg,label:"Aberto",icon:"\u{1F7E2}"}:q>=8&&q<9?{color:c.warning,bg:c.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:q>=17&&q<19?{color:c.warning,bg:c.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:c.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function L(q){n.includes(q)?n=n.filter(I=>I!==q):n.push(q),localStorage.setItem(Oo,JSON.stringify(n)),k(),G.playClick()}function k(){J.innerHTML="";let q=new Date,I=Mt.filter(E=>{let j=E.name.toLowerCase().includes(i)||E.label.toLowerCase().includes(i),b=r==="all"||E.region===r;return j&&b});if(I.sort((E,j)=>{let b=n.includes(E.id),P=n.includes(j.id);return b&&!P?-1:!b&&P?1:E.name.localeCompare(j.name)}),I.length===0){J.innerHTML=`
            ...
            `,m.onmouseenter=()=>{m.style.transform="translateY(-2px)",m.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},m.onmouseleave=()=>{m.style.transform="translateY(0)",m.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let $=m.querySelector(".cw-pin-btn");$.onmouseenter=()=>{$.style.backgroundColor="#F1F3F4"},$.onmouseleave=()=>{$.style.backgroundColor="transparent"},$.onclick=D=>{D.stopPropagation(),L(E.id)},m.onclick=()=>{a=E.id,z("plan")},J.appendChild(m)});let v=document.createElement("div");v.style.height="20px",v.style.width="100%",J.appendChild(v)}function C(){F.innerHTML="";let q=document.createElement("div"),I=document.createElement("label");I.textContent="Onde est\xE1 o cliente?",I.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let v=document.createElement("select");Object.assign(v.style,Gt),v.style.padding="14px",[...Mt].sort((ie,te)=>ie.name.localeCompare(te.name)).forEach(ie=>{let te=document.createElement("option");te.value=ie.id,te.textContent=`${ie.flag} ${ie.name} (${ie.zone})`,ie.id===a&&(te.selected=!0),v.appendChild(te)}),v.onchange=ie=>{a=ie.target.value,Q(),G.playClick()},q.appendChild(I),q.appendChild(v),F.appendChild(q);let j=document.createElement("div");Object.assign(j.style,l.timeComparisonRow);let b=document.createElement("div");Object.assign(b.style,l.timeCard),b.style.backgroundColor="#F8FAFF",b.style.borderColor="#E8F0FE",b.innerHTML=`
        ...
        `,j.appendChild(b),j.appendChild(P),F.appendChild(j);let U=document.createElement("div");U.id="cw-planner-status",Object.assign(U.style,l.statusBadge),F.appendChild(U);let M=document.createElement("div");Object.assign(M.style,{padding:"0 4px",marginTop:"12px"});let m=document.createElement("div");m.textContent="Arraste para simular o hor\xE1rio:",m.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let A=document.createElement("div");Object.assign(A.style,l.timelineContainer);let y=document.createElement("div");Object.assign(y.style,l.timelineTrack);let $=document.createElement("div");Object.assign($.style,l.dayZone),y.appendChild($);let D=document.createElement("input");D.type="range",D.min="0",D.max="1439",D.step="15",D.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let K=document.createElement("div");K.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",K.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",A.appendChild(y),A.appendChild(D),A.appendChild(K),M.appendChild(m),M.appendChild(A),F.appendChild(M);let V=b.querySelector("#cw-time-input-br"),ee=P.querySelector("#cw-time-display-client"),oe=P.querySelector("#cw-client-label");function Q(){let ie=Mt.find(Me=>Me.id===a);oe.textContent=`${ie.flag} ${ie.label} (${ie.zone})`;let te=s.getHours(),le=s.getMinutes(),Ye=`${String(te).padStart(2,"0")}:${String(le).padStart(2,"0")}`;V.value=Ye,D.value=te*60+le;let tt=s.toLocaleTimeString("pt-BR",{timeZone:ie.zone,hour:"2-digit",minute:"2-digit"});ee.textContent=tt;let qe=parseInt(tt.split(":")[0]);qe>=9&&qe<17?(U.style.background=c.successBg,U.style.color=c.success,U.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):qe>=8&&qe<9||qe>=17&&qe<19?(U.style.background=c.warningBg,U.style.color=c.warning,U.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(U.style.background=c.errorBg,U.style.color=c.error,U.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}D.oninput=ie=>{let te=parseInt(ie.target.value);s.setHours(Math.floor(te/60)),s.setMinutes(te%60),Q()},V.oninput=ie=>{let[te,le]=ie.target.value.split(":");te&&le&&(s.setHours(parseInt(te)),s.setMinutes(parseInt(le)),Q())},Q()}function O(){k(),o||(o=setInterval(k,6e4))}function f(){o&&(clearInterval(o),o=null)}function T(){e=!e,ue(e,d,"cw-btn-timezone"),e?z("live"):f()}return document.body.appendChild(d),T}function Lo(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let C=document.createElement("style");C.id="cw-lib-styles",C.innerHTML=`
        ...
        `,document.head.appendChild(C)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},r={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},s=document.createElement("div");s.id="library-popup",s.classList.add("cw-module-window"),Object.assign(s.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let l=pe(s,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:s},()=>k());s.appendChild(l);let d=document.createElement("div");Object.assign(d.style,r.container),s.appendChild(d);let p=document.createElement("div");Object.assign(p.style,r.tabHeader);let h=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];h.forEach(C=>{let O=document.createElement("div");O.innerHTML=`${C.icon} ${C.label}`,O.id=`lib-tab-${C.id}`,Object.assign(O.style,r.tabBtn),C.id===o&&Object.assign(O.style,r.tabActive),O.onmouseenter=()=>G.playHover(),O.onclick=()=>Z(C.id),p.appendChild(O)}),d.appendChild(p);let x=document.createElement("div");Object.assign(x.style,r.listContainer),d.appendChild(x);let g=document.createElement("div");g.className="cw-fab cw-tactile",Object.assign(g.style,r.fab),g.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',g.onmouseenter=()=>g.style.transform="scale(1.1)",g.onmouseleave=()=>g.style.transform="scale(1)",g.onclick=()=>_(),d.appendChild(g),a=document.createElement("div"),Object.assign(a.style,r.editorOverlay);let u=document.createElement("div");Object.assign(u.style,r.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let w=document.createElement("button");w.innerHTML="Cancelar",w.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",w.onclick=F,u.appendChild(w),a.appendChild(u);let S=document.createElement("div");Object.assign(S.style,r.editorBody),a.appendChild(S);let H=document.createElement("div");H.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let N=document.createElement("button");N.textContent="Salvar",N.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",N.onclick=z,H.appendChild(N),a.appendChild(H),d.appendChild(a);let R=document.createElement("div");Object.assign(R.style,Ae),R.className="no-drag",s.appendChild(R),Te(s,R),document.body.appendChild(s);function Z(C){G.playClick(),o=C,h.forEach(O=>{let f=document.getElementById(`lib-tab-${O.id}`);O.id===C?Object.assign(f.style,r.tabActive):Object.assign(f.style,r.tabBtn)}),J()}function J(){x.innerHTML="";let C=he.getSnippets(o);if(C.length===0){x.innerHTML=`
            ...
            `,f.onmouseenter=()=>{G.playHover()},f.querySelector(".cw-act-copy").onclick=q=>{if(q.stopPropagation(),G.playClick(),O.isRich){let I=new Blob([O.content],{type:"text/html"}),v=document.createElement("div");v.style.whiteSpace="pre-wrap",v.innerHTML=O.content;let E=new Blob([v.innerText],{type:"text/plain"}),j=[new ClipboardItem({"text/html":I,"text/plain":E})];navigator.clipboard.write(j)}else navigator.clipboard.writeText(O.content);X("Copiado!")},f.querySelector(".cw-act-edit").onclick=q=>{q.stopPropagation(),G.playClick(),_(O)},f.querySelector(".cw-act-del").onclick=async q=>{q.stopPropagation(),G.playClick(),await xe("Excluir este item?")&&(he.delete(O.id),J(),X("Item exclu\xEDdo."))},x.appendChild(f)})}function _(C=null){n=C?C.id:null,S.innerHTML="",S.appendChild(Y("title","T\xEDtulo / Nome",C?C.title:"")),o==="email"&&S.appendChild(Y("subject","Assunto do Email",C?C.subject:""));let O="Conte\xFAdo";o==="email"&&(O="Corpo do Email (HTML)"),o==="note"&&(O="Texto da Nota (Reason)"),S.appendChild(Y("content",O,C?C.content:"",{isRich:!0,isCode:C?C.isCode:!1})),u.querySelector("span").textContent=C?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let f=S.querySelector("input");f&&f.focus()},300)}function F(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function z(){let C=S.querySelector("#cw-inp-title"),O=S.querySelector("#cw-inp-content"),f=C.value.trim(),T=O.contentEditable==="true"?O.innerHTML:O.value.trim(),q=O.getAttribute("data-is-code")==="true";if(!f||!T||T==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let I={id:n,type:o,title:f,content:T,isCode:q,isRich:O.contentEditable==="true"};if(o==="email"){let v=S.querySelector("#cw-inp-subject").value.trim();if(!v){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}I.subject=v}N.textContent="Salvando...",await he.save(I),N.textContent="Salvar",F(),J(),X("Salvo com sucesso!"),G.playSuccess()}function Y(C,O,f,T={}){let q=document.createElement("div");Object.assign(q.style,r.inputGroup);let I=document.createElement("label");I.textContent=O,Object.assign(I.style,r.label);let v;if(T.isRich){let E=document.createElement("div");E.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",E.innerHTML=`
            ...
            `,v=document.createElement("div"),v.contentEditable="true",Object.assign(v.style,r.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),v.innerHTML=f||"",T.isCode&&(v.style.fontFamily="'Roboto Mono', monospace",v.style.backgroundColor="#F8F9FA",v.setAttribute("data-is-code","true")),E.querySelectorAll(".cw-toolbar-btn").forEach(j=>{j.onmouseenter=()=>G.playHover(),j.onmousedown=()=>G.playClick()}),E.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),v.focus()},E.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),v.focus()},E.querySelector(".cw-tb-code").onclick=j=>{let P=!(v.getAttribute("data-is-code")==="true");v.setAttribute("data-is-code",P),v.style.fontFamily=P?"'Roboto Mono', monospace":"inherit",v.style.backgroundColor=P?"rgba(0, 122, 255, 0.03)":i.surface,P?j.currentTarget.classList.add("active"):j.currentTarget.classList.remove("active"),v.focus()},E.querySelector(".cw-tb-img").onclick=async()=>{let j=await Kt("Cole a URL da imagem:");j&&(document.execCommand("insertImage",!1,j),v.querySelectorAll("img").forEach(P=>{P.style.maxWidth="100%",P.style.borderRadius="8px"}))},v.onpaste=j=>{let b=(j.clipboardData||j.originalEvent.clipboardData).items;for(let P of b)if(P.kind==="file"&&P.type.startsWith("image/")){j.preventDefault();let U=P.getAsFile(),M=new FileReader;M.onload=m=>{let A=`<img src="${m.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,A)},M.readAsDataURL(U)}},q.appendChild(I),q.appendChild(E)}else v=document.createElement("input"),v.type="text",Object.assign(v.style,r.input),v.value=f||"",q.appendChild(I);return v.id=`cw-inp-${C}`,v.onfocus=()=>{v.style.borderColor=i.primary,v.style.boxShadow=`0 0 0 2px ${i.primaryBg}`},v.onblur=()=>{v.style.borderColor=i.border,v.style.boxShadow="none"},q.appendChild(v),q}function L(C){return Object.entries(C).map(([O,f])=>`${O.replace(/[A-Z]/g,T=>"-"+T.toLowerCase())}:${f}`).join(";")}function k(){e=!e,ue(e,s,"cw-btn-library"),e&&J()}return k}function qo(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let h=document.createElement("style");h.id=a,h.innerHTML=`
  ...
  `,document.head.appendChild(t)};function Mo(){_o();let t=!1,e=null,o=1,a=4,n=document.createElement("div");n.id="bau-form-popup",n.className="bau-popup cw-module-window",n.style.display="none";let r=pe(n,"BAU Form","v1.2.0","Solicite a abertura de casos BAU em um fluxo guiado.",{googleLine:null},()=>I());n.appendChild(r);let s=document.createElement("div");s.className="bau-progress-indicator",n.appendChild(s);let c=document.createElement("div");c.className="bau-content",n.appendChild(c);let l=document.createElement("form");c.appendChild(l);let d=document.createElement("div");d.className="bau-step active",d.id="bau-step-1";let p=document.createElement("div");p.className="bau-card bau-context-card";let h=document.createElement("div");h.className="bau-header-banner",p.appendChild(h);let x=document.createElement("div");x.innerHTML=`
    ...
    `,u.querySelectorAll(".bau-task-item").forEach(v=>{let E=v.querySelector("input");E.addEventListener("change",()=>{v.classList.toggle("active",E.checked),E.checked&&G.playClick()})}),g.appendChild(u),l.appendChild(g);let w=document.createElement("div");w.className="bau-step",w.id="bau-step-3";let S=document.createElement("div");S.className="bau-card";let H=document.createElement("label");H.className="bau-label",H.textContent="Justificativa / Descri\xE7\xE3o",S.appendChild(H);let N=document.createElement("textarea");N.name="description",N.required=!0,N.className="bau-textarea",N.placeholder="Descreva detalhadamente o que precisa ser feito...",N.style.minHeight="120px",S.appendChild(N);let R=document.createElement("label");R.className="bau-label",R.textContent="Disponibilidade (m\xEDnimo 1 op\xE7\xE3o)",R.style.marginTop="20px",S.appendChild(R);let Z=document.createElement("div");Z.className="bau-availability-container";for(let v=1;v<=3;v++){let E=document.createElement("input");E.type="datetime-local",E.name=`availability_${v}`,E.required=v===1,E.className="bau-input",Z.appendChild(E)}S.appendChild(Z);let J=document.createElement("div");J.className="bau-availability-hint",S.appendChild(J),w.appendChild(S),l.appendChild(w);let _=document.createElement("div");_.className="bau-step",_.id="bau-step-4";let F=document.createElement("div");F.className="bau-card",F.innerHTML=`
    ...
    `,_.appendChild(F),l.appendChild(_);let z=document.createElement("div");z.className="bau-footer";let Y=document.createElement("button");Y.type="button",Y.className="bau-btn-secondary",Y.textContent="Voltar",z.appendChild(Y);let L=document.createElement("button");L.type="button",L.className="bau-btn-primary",L.textContent="Pr\xF3ximo",z.appendChild(L);let k=document.createElement("button");k.type="submit",k.className="bau-btn-submit",k.innerHTML="<span>\u{1F4DD}</span> Enviar para o TL",k.style.display="none",z.appendChild(k),n.appendChild(z),document.body.appendChild(n);function C(){l.querySelectorAll(".bau-step").forEach((v,E)=>{v.classList.toggle("active",E+1===o)}),s.innerHTML="";for(let v=1;v<=a;v++){let E=document.createElement("div");E.className=`bau-progress-step ${v===o?"active":v<o?"completed":""}`,E.textContent=v,s.appendChild(E)}Y.style.display=o>1?"inline-block":"none",L.style.display=o<a?"inline-block":"none",k.style.display=o===a?"inline-block":"none",o===4&&O()}function O(){let v=new FormData(l),E=Object.fromEntries(v.entries()),j=v.getAll("taskType"),b=[E.availability_1,E.availability_2,E.availability_3].filter(U=>U&&U.trim()!=="").map(U=>U.replace("T"," ")).join(" | "),P=document.getElementById("bau-confirmation-details");P.innerHTML=`
            <div class="bau-confirm-row"><span class="bau-confirm-label">Anunciante:</span><span class="bau-confirm-value">${E.advName}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">CID:</span><span class="bau-confirm-value">${E.cid}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">AM:</span><span class="bau-confirm-value">${E.amName}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Email:</span><span class="bau-confirm-value">${E.email||"N/A"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Programa:</span><span class="bau-confirm-value">${E.salesProgram||"N/A"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Speakeasy ID:</span><span class="bau-confirm-value">${E.seId||"N/A"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Motivo:</span><span class="bau-confirm-value">${E.reason}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Tasks:</span><span class="bau-confirm-value">${j.join(", ")}</span></div>
            <div class="bau-confirm-row" style="flex-direction: column; align-items: flex-start; gap: 8px;">
                ...
                <div style="font-size: 13px; color: ${ne.textPrimary}; background: #f8f9fa; padding: 12px; border-radius: 8px; width: 100%; box-sizing: border-box; white-space: pre-wrap;">${E.description}</div>
            </div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Disponibilidade:</span><span class="bau-confirm-value">${b||"N/A"}</span></div>
        `}function f(v){let E=document.getElementById(`bau-step-${v}`);if(!E)return!0;if(v===2){let b=l.querySelector('select[name="reason"]').value,P=Array.from(l.querySelectorAll('input[name="taskType"]:checked'));return b?P.length===0?(X("Erro: Selecione pelo menos uma Task.","error"),!1):!0:(X("Erro: O Motivo da Abertura \xE9 obrigat\xF3rio.","error"),!1)}let j=E.querySelectorAll("[required]");for(let b of j)if(!b.value.trim()){let P="",U=b.closest("div")?.querySelector(".bau-label");if(U)P=U.textContent;else{let M=b.closest(".bau-inline-field")?.querySelector("span");P=M?M.textContent:b.placeholder||b.name}return X(`Erro: O campo '${P.replace(":","")}' \xE9 obrigat\xF3rio.`,{error:!0}),b.classList.add("input-error"),setTimeout(()=>b.classList.remove("input-error"),3e3),!1}return!0}L.onclick=()=>{f(o)&&(o++,C(),G.playClick())},Y.onclick=()=>{o>1&&(o--,C(),G.playClick())};async function T(){let v=await we()||{};e=v,q(v)}function q(v){if(!v)return;l.querySelector('[name="advName"]').value=v.advName||"",l.querySelector('[name="cid"]').value=v.cid||"",l.querySelector('[name="amName"]').value=v.amName||"",l.querySelector('[name="seId"]').value=v.seId||"";let E=document.getElementById("bau-top-se-search");E&&(E.onclick=async U=>{U.stopPropagation(),U.preventDefault(),await lt("bau-context-se-id-input")});let j=document.getElementById("bau-all-data");j&&(j.innerHTML="",[{label:"Email",name:"email",value:v.email,type:"text"},{label:"Idioma",name:"language",value:v.language,type:"select",options:["Portugu\xEAs","Espanhol"]},{label:"Programa",name:"salesProgram",value:v.salesProgram,type:"text"},{label:"Timezone",name:"timezone",value:v.timezone,type:"text"}].forEach(M=>{let m=document.createElement("div");m.className="bau-inline-field",m.title="Clique para editar";let A=document.createElement("b");A.textContent=`${M.label}:`,m.appendChild(A);let y;if(M.type==="select"){y=document.createElement("select"),y.name=M.name,y.className="bau-inline-input",y.style.appearance="none",y.style.cursor="pointer";let $=document.createElement("option");$.value="",$.textContent=`Selecionar ${M.label}...`,y.appendChild($),M.options.forEach(D=>{let K=document.createElement("option");K.value=D,K.textContent=D,M.value&&(M.value.toLowerCase().includes(D.toLowerCase())||D.toLowerCase().includes(M.value.toLowerCase()))&&(K.selected=!0),y.appendChild(K)})}else y=document.createElement("input"),y.type="text",y.name=M.name,y.className="bau-inline-input",y.value=M.value||"",y.placeholder=`Preencher ${M.label}...`;y.tagName==="INPUT"&&(!M.value||M.value==="N/A"||M.value==="---")&&(y.value=""),m.appendChild(y),m.onclick=()=>y.focus(),j.appendChild(m)})),J.innerHTML=`\u2139\uFE0F Lembrete: Os hor\xE1rios s\xE3o baseados no seu fuso hor\xE1rio atual (${v.timezone||"n\xE3o detectado"}). Fornecer mais de uma op\xE7\xE3o aumenta a chance de agendamento r\xE1pido.`,[{key:"advName",label:"Nome do Anunciante"},{key:"cid",label:"Customer ID (CID)"},{key:"amName",label:"Account Manager"}].filter(U=>!v[U.key]||v[U.key]==="N/A"||v[U.key].trim()==="---").length>0?h.innerHTML="<span>\u26A0\uFE0F</span> Alguns dados n\xE3o foram encontrados. Por favor, complete os campos edit\xE1veis acima.":h.innerHTML="<span>\u2705</span> Dados do CRM carregados. Voc\xEA pode editar qualquer campo clicando nele."}l.onsubmit=async v=>{if(v.preventDefault(),!f(a))return;let E=k.innerHTML;k.disabled=!0,k.innerHTML="Enviando...";let j=new FormData(l),b=Object.fromEntries(j.entries()),P=j.getAll("taskType"),U={caseId:e.caseId||"",cid:b.cid||e.cid||"",seId:b.seId||e.seId||"",advName:b.advName||e.advName||"",email:b.email||e.email||"",language:b.language||e.language||"",amName:b.amName||e.amName||"",salesProgram:b.salesProgram||e.salesProgram||"",site:b.site||e.site||"",timezone:b.timezone||e.timezone||"",reason:b.reason,taskType:P.join(", "),description:b.description,availability:`${b.availability_1||""} | ${b.availability_2||""} | ${b.availability_3||""}`.trim()};try{await ro(U,e.agentEmail||"anon"),G.playSuccess(),X("Escalonamento enviado com sucesso!","success"),l.reset(),o=1,e=null,C(),I()}catch(M){console.error("Erro BAU:",M),X("Falha ao enviar: "+(M.message||"Erro desconhecido"),"error")}finally{k.disabled=!1,k.innerHTML=E}};async function I(){t=!t,n.style.display=t?"flex":"none",t&&!e&&(o=1,C(),await T()),ue(t,n,"cw-btn-bauform")}return C(),I}function ca(){if(window.techSolInitialized){Et();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Ht();try{G.initGlobalListeners(),G.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}fe.fetchTips(),Et();let e=fo(),o=vo(),a=So(),n=Eo(),i=Io(),r=Lo(),s=qo(),c=Mo(),l=Ao();so({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:r,toggleConfigs:s,toggleBAUForm:c,broadcastControl:l}),setTimeout(()=>{fe.logEvent("App","Start","Session Start"),To(),setTimeout(()=>{Fo(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}ca();})();
