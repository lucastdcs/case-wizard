...
.cw-dropdown-option.selected { 
  ...
  `,border:"1px solid rgba(255, 255, 255, 0.6)",display:"flex",flexDirection:"column",fontFamily:"'Google Sans', Roboto, sans-serif",fontSize:"14px",color:"#3c4043",willChange:"transform, opacity, width, height",transformOrigin:"top right"};var St={display:"block",fontSize:"13px",fontWeight:"600",color:"#3c4043",marginBottom:"8px",marginTop:"16px"},jt={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1px solid #dadce0",backgroundColor:"#f8f9fa",fontSize:"14px",color:"#3c4043",boxSizing:"border-box",appearance:"none",backgroundImage:"url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%235f6368%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')",backgroundRepeat:"no-repeat",backgroundPosition:"right 12px center",backgroundSize:"16px",transition:"border-color 0.2s ease, box-shadow 0.2s ease",fontFamily:"'Google Sans', 'Roboto'",cursor:"pointer"};var Gt={fontSize:"11px",color:"#9aa0a6",textAlign:"center",padding:"12px 16px",borderTop:"1px solid rgba(0,0,0,0.05)",marginTop:"16px"};var qe=t=>new Promise(e=>setTimeout(e,t));async function Yo(t,e){if(!t)return;t.style.opacity="1",t.innerHTML='<span class="cursor">|</span>';let o=t.querySelector(".cursor");await qe(200);for(let a=0;a<e.length;a++){let n=e.charAt(a),i=document.createElement("span");i.textContent=n,o&&o.parentNode===t?o.before(i):t.appendChild(i);let s=Math.floor(Math.random()*60)+30;a===0&&(s=150),a>e.length-3&&(s=30),await qe(s)}await qe(600),o&&(o.style.display="none")}async function Ct(){if(document.getElementById("techsol-splash-screen"))return;if(!document.getElementById("google-splash-style")){let e=document.createElement("style");e.id="google-splash-style",e.innerHTML=`
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>t.style.opacity="1");try{await qe(200);let e=await Rt(),o=zt(e),a=t.querySelector("#w-icon"),n=t.querySelector("#p1"),i=t.querySelector("#p2"),s=t.querySelector("#p3"),r=t.querySelector("#p-sextou");a&&(a.innerHTML=o.icon),n&&(n.textContent=o.prefix),s&&(s.textContent=o.suffix),await qe(300);let l=a?a.querySelector("svg"):null;if(l&&(l.style.opacity="1",l.style.transform="scale(1)"),await qe(400),n&&(n.style.opacity="1"),j.playStartup(),i&&await Yo(i,o.name),s&&(s.style.opacity="1",s.style.transform="translateY(0)"),o.isFriday&&r){await qe(400),r.style.display="block",r.offsetWidth;let p=r.querySelector(".sextou-badge");p&&(p.style.opacity="1",p.style.transform="scale(1)")}await qe(1500)}catch(e){console.warn("Splash error, skipping...",e)}finally{t.classList.add("splash-exit"),await qe(900),t.parentNode&&t.parentNode.removeChild(t)}}function Ut(t){if(!t)return;let e=t.getBoundingClientRect(),o=window.innerWidth,a=window.innerHeight,n=24,i=o-e.width-n,s=a-e.height-n,r=parseFloat(t.style.left)||e.left,l=parseFloat(t.style.top)||e.top,p=Math.max(n,Math.min(r,i)),d=Math.max(n,Math.min(l,s));if(p!==r||d!==l){let c=t.style.transition;t.style.transition="left 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), top 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",t.style.left=`${p}px`,t.style.top=`${d}px`,setTimeout(()=>{t.style.transition=c},300)}}var Ae={position:"absolute",bottom:"1px",right:"1px",width:"20px",height:"20px",cursor:"nwse-resize",zIndex:"100000",opacity:"0.6",transition:"opacity 0.2s",backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="%235f6368" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="21" y1="15" x2="15" y2="21"></line><line x1="21" y1="9" x2="9" y2="21"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"bottom right"};function Te(t,e){e.onmousedown=o;function o(a){a.stopPropagation(),a.preventDefault();let n=t.style.transition;t.style.transition="none";let i=a.clientX,s=a.clientY,r=parseFloat(getComputedStyle(t,null).getPropertyValue("width").replace("px","")),l=parseFloat(getComputedStyle(t,null).getPropertyValue("height").replace("px","")),p=i,d=s,c=!1;function x(u){p=u.clientX,d=u.clientY,c||(window.requestAnimationFrame(()=>{g(),c=!1}),c=!0)}function g(){let u=r+(p-i),y=l+(d-s);u>360&&(t.style.width=u+"px"),y>300&&(t.style.height=y+"px")}function b(){document.removeEventListener("mousemove",x),document.removeEventListener("mouseup",b),setTimeout(()=>{t.style.transition=n},50)}document.addEventListener("mousemove",x),document.addEventListener("mouseup",b)}e.onmouseenter=()=>e.style.opacity="1",e.onmouseleave=()=>e.style.opacity="0.6"}function Vt(t){if(!t)return"";let e={":bufo-alarma:":"\u{1F438}\u{1F6A8}",":frog-hype-1:":"\u{1F438}\u{1F973}",":coffee-intensifies:":"\u2615\u26A1",":frog-eat:":"\u{1F438}\u2615",":alert-01:":"\u26A0\uFE0F",":alert-circle-i-notice:":"\u2139\uFE0F",":wind-face-animated:":"\u{1F32C}\uFE0F",":smile:":"\u{1F642}",":warning:":"\u26A0\uFE0F",":check:":"\u2705",":white_check_mark:":"\u2705",":x:":"\u274C",":rocket:":"\u{1F680}",":tada:":"\u{1F389}",":party_popper:":"\u{1F389}",":thumbsup:":"\u{1F44D}",":+1:":"\u{1F44D}",":purple_heart:":"\u{1F49C}",":heart:":"\u2764\uFE0F",":fire:":"\u{1F525}",":sunny:":"\u{1F31E}",":star:":"\u2B50",":coffee:":"\u2615"};return t.replace(/:([a-zA-Z0-9-_+]+):/g,o=>e[o]?e[o]:"")}function Wt(){let t=document.createElement("div");return Object.assign(t.style,{position:"fixed",top:0,left:0,width:"100%",height:"100%",background:"rgba(0,0,0,0.4)",backdropFilter:"blur(8px)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:2147483647,opacity:0,transition:"opacity 0.3s ease"}),t}function Yt(){let t=document.createElement("div");return Object.assign(t.style,{background:"rgba(255, 255, 255, 0.95)",padding:"24px",borderRadius:"20px",boxShadow:"0 24px 60px rgba(0,0,0,0.3)",width:"340px",textAlign:"center",transform:"scale(0.85)",transition:"transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",fontFamily:"'Google Sans', Roboto, sans-serif",border:"1px solid rgba(255,255,255,0.4)"}),t}function xe(t,e={}){return new Promise(o=>{let a=Wt(),n=Yt(),i=e.danger?"#FF3B30":"#007AFF",s=e.confirmText||(e.danger?"Excluir":"Confirmar");n.innerHTML=`
        ...
        `,a.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity=1,n.style.transform="scale(1)"});let r=d=>{a.style.opacity=0,n.style.transform="scale(0.9)",setTimeout(()=>{a.remove(),o(d)},300)},l=n.querySelector("#cw-conf-cancel"),p=n.querySelector("#cw-conf-ok");[l,p].forEach(d=>d.onmouseenter=()=>j.playHover()),l.onclick=()=>{j.playClick(),r(!1)},p.onclick=()=>{j.playClick(),r(!0)}})}function Xt(t,e=""){return new Promise(o=>{let a=Wt(),n=Yt();n.innerHTML=`
...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
        ...
        `,document.head.appendChild(I)}let p=document.createElement("div");p.className="cw-zen-container";let d=document.createElement("div");Object.assign(d.style,{display:"none"});let c=document.createElement("div");c.className="cw-screens-container",d.appendChild(c),p.innerHTML=`
    ...
    `;let x=p.querySelector(".cw-hero-grid"),g=p.querySelector(".cw-acc-container"),b=p.querySelector(".cw-results-container"),u=p.querySelector(".cw-search-input"),y=p.querySelector(".cw-status-bar"),S=p.querySelector(".cw-status-text"),z=p.querySelector(".cw-footer-icons");s.forEach(([I,T])=>{let M=i(T.name),V=document.createElement("div");V.className="cw-hero-card",V.id=`hero-${I}`,V.style.setProperty("--hero-color",M.color),V.innerHTML=`
        ...
        `,V.onclick=L=>{if(L.target.closest(".cw-step-btn"))return;let k=a[I]?a[I].count:0;$(I,k>0?-k:1,T)},V.querySelector(".minus").onclick=()=>$(I,-1,T),V.querySelector(".plus").onclick=()=>$(I,1,T),V.dataset.color=M.color,x.appendChild(V)});function B(I,T){let M=i(T.name),V=document.createElement("div");return V.className="cw-task-item",V.dataset.id=I,V.innerHTML=`
        ...
        `,V.onclick=L=>{if(L.target.closest(".cw-step-btn"))return;let k=a[I]?a[I].count:0;$(I,k>0?-k:1,T)},V.querySelector(".minus").onclick=()=>$(I,-1,T),V.querySelector(".plus").onclick=()=>$(I,1,T),V}Object.entries(r).forEach(([I,T])=>{let M=document.createElement("div");M.className="cw-acc-group";let V=document.createElement("div");V.className="cw-acc-header",V.innerHTML=`
            <div class="cw-acc-title">
                <div class="cw-acc-dot" style="background:${T.brand.color}"></div>
                ${I}
            </div>
            <div class="cw-acc-icon">\u25BC</div>
        `,V.onclick=()=>{g.querySelectorAll(".cw-acc-group.open").forEach(k=>{k!==M&&k.classList.remove("open")}),M.classList.toggle("open")};let L=document.createElement("div");L.className="cw-acc-body",T.tasks.forEach(k=>{let C=B(k.key,k);L.appendChild(C)}),M.appendChild(V),M.appendChild(L),g.appendChild(M)});function $(I,T,M){a[I]||(a[I]={count:0,data:M,brand:i(M.name)}),a[I].count+=T,a[I].count<=0&&delete a[I],K(),J(),t&&t()}function K(){let I=o.tagSupportUsed;s.forEach(([k])=>{let C=x.querySelector(`#hero-${k}`);if(!C)return;let F=a[k];F?(C.classList.add("active"),C.querySelector(".cw-step-val").textContent=F.count,C.querySelector(".cw-step-val").style.color=C.dataset.color,I&&(k==="ads_conversion_tracking"||k==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(k)?C.classList.add("ts-success"):C.classList.remove("ts-success")):(C.classList.remove("active"),C.classList.remove("ts-success"))}),p.querySelectorAll(".cw-task-item").forEach(k=>{let C=k.dataset.id,F=a[C];F?(k.classList.add("selected"),k.querySelector(".cw-step-val").textContent=F.count,I&&(C==="ads_conversion_tracking"||C==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(C)?k.classList.add("ts-success"):k.classList.remove("ts-success")):(k.classList.remove("selected"),k.classList.remove("ts-success"))});let M=Object.keys(a),V=0,L=[];if(M.forEach(k=>{let C=a[k];V+=C.count;for(let F=0;F<C.count;F++)L.length<6&&L.push(C.brand)}),V>0){y.classList.add("visible");let k=V>1?"A\xE7\xF5es":"A\xE7\xE3o",C=V>1?"definidas":"definida";S.textContent=`${V} ${k} ${C}`,z.innerHTML="",L.forEach(F=>{let f=document.createElement("div");f.className="cw-mini-icon",f.innerHTML=Be[F.icon]||Be.default;let A=f.querySelector("svg");A&&(A.style.width="14px",A.style.height="14px"),z.appendChild(f)})}else y.classList.remove("visible")}u.addEventListener("input",I=>{let T=I.target.value.toLowerCase();if(T.length>0){g.style.display="none",b.style.display="block",b.innerHTML="";let M=!1;Object.entries(Ee).forEach(([V,L])=>{if(L.name.toLowerCase().includes(T)){M=!0;let k=B(V,L);a[V]&&(k.classList.add("selected"),k.querySelector(".cw-step-val").textContent=a[V].count),b.appendChild(k)}}),M||(b.innerHTML='<div style="padding:20px; text-align:center; font-size:13px; color:#999">Nenhum resultado.</div>')}else g.style.display="block",b.style.display="none"});function J(){c.innerHTML="";let I=Object.keys(a),T=!1;if(I.length===0){c.innerHTML=`<div class="cw-empty-state">${e("selecione_tarefas")}</div>`,d.style.display="none";return}let M=o.tagSupportUsed,V=document.createElement("div");V.className="cw-info-banner",V.innerHTML=`
            <span style="font-size:14px">\u2139\uFE0F</span>
            <span>
                Os screenshots seguem as diretrizes atuais do Win Criteria e pol\xEDticas de Tag Support.
            </span>
        `,c.appendChild(V),I.forEach(L=>{let k=a[L].data,C=a[L].count,F=a[L].brand,A=M&&(L==="ads_conversion_tracking"||L==="ads_enhanced_conversions")&&!o.forcedScreenshots.has(L),O=o.screenshotMode||"implementation",q=k.screenshots?.[O]||[];if(q.length>0||A){T=!0;for(let N=1;N<=C;N++){let R=document.createElement("div");R.className="cw-screen-card",A&&R.classList.add("ts-success"),R.style.setProperty("--brand-color",F.color),R.style.setProperty("--brand-bg",F.bg),R.style.setProperty("--brand-shadow",F.color+"40");let Y=document.createElement("div");Y.className="cw-card-header";let h=document.createElement("div");h.className="cw-card-icon",h.innerHTML=Be[F.icon]||Be.default;let v=document.createElement("div");v.style.cssText="flex:1; display:flex; align-items:center; gap:8px;";let _=document.createElement("input");_.className="cw-card-title-input",_.id=`name-${L}-${N}`,_.value=`${k.name}${C>1?" #"+N:""}`,_.title="Clique para renomear esta task";let D=document.createElement("span");if(D.className="cw-edit-hint",D.innerHTML="\u270E Renomear",v.appendChild(_),v.appendChild(D),Y.appendChild(h),Y.appendChild(v),R.appendChild(Y),A){let m=document.createElement("div");m.className="cw-ts-disclaimer-box",m.innerHTML=`
                <span>${e("ts_disclaimer")}</span>
                <button class="cw-btn-ts-force">${e("incluir_mesmo_assim")}</button>
            `,m.querySelector("button").onclick=()=>{o.toggleForcedScreenshot(L,!0)},R.appendChild(m)}else q.forEach((m,w)=>{let E=document.createElement("div");E.className="cw-input-group";let G=document.createElement("label");G.className="cw-input-label",G.textContent=m;let H=document.createElement("input");H.className="cw-input-field",H.id=`screen-${L}-${N}-${w}`,H.placeholder="Cole o link aqui...",H.setAttribute("autocomplete","off"),H.addEventListener("input",()=>{H.value.trim().length>5?H.classList.add("filled"):H.classList.remove("filled")});let Q=document.createElement("div");Q.className="cw-input-check",Q.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>',E.appendChild(G),E.appendChild(H),E.appendChild(Q),R.appendChild(E)});c.appendChild(R)}}}),d.style.display=T?"block":"none"}return{selectionElement:p,screenshotsElement:d,updateSubStatus:()=>J(),getCheckedElements:()=>Object.keys(a).map(I=>({value:I,count:a[I].count})),setTaskCount:(I,T)=>{a[I]&&delete a[I],T>0&&Ee[I]&&$(I,T,Ee[I])},toggleTask:(I,T=!0)=>{let M=a[I];T&&!M?$(I,1,Ee[I]):!T&&M&&$(I,-M.count,Ee[I])},setLanguage:I=>{e=I;let T=p.querySelector(".js-hero-title");T&&(T.textContent=e("acesso_rapido"));let M=p.querySelector(".cw-search-input");M&&(M.placeholder=e("buscar_catalogo")),J()},reset:()=>{for(let I in a)delete a[I];u.value="",g.style.display="block",b.style.display="none",K(),J()}}}var Zo={marginTop:"24px",marginBottom:"16px",padding:"20px",background:"#fff9e6",borderRadius:"20px",border:"1.5px solid #fbbc0540",display:"none",boxShadow:"0 4px 12px rgba(251, 188, 5, 0.05)"},ea={fontSize:"12px",color:"#b06000",marginTop:"8px",lineHeight:"1.4"},ta={width:"100%",padding:"12px 16px",borderRadius:"12px",border:"1.5px solid #dadce0",fontSize:"14px",marginBottom:"16px",boxSizing:"border-box",background:"#fff"},oa={display:"flex",gap:"20px",marginBottom:"12px"};function ao(t){let e=document.createElement("div");e.id="tag-support-container",Object.assign(e.style,Zo);let o=document.createElement("label");o.className="js-ts-main-label",o.textContent=t("utilizou_tag_support"),Object.assign(o.style,St,{marginTop:"0"});let a=document.createElement("div");Object.assign(a.style,oa);let n=document.createElement("input");n.type="radio",n.name="ts_usage_mod",n.value="Sim",Object.assign(n.style,Et);let i=document.createElement("label");i.textContent="Sim";let s=document.createElement("div");Object.assign(s.style,{display:"flex",alignItems:"center"}),s.appendChild(n),s.appendChild(i);let r=document.createElement("input");r.type="radio",r.name="ts_usage_mod",r.value="N\xE3o",r.checked=!0,Object.assign(r.style,Et);let l=document.createElement("label");l.textContent="N\xE3o";let p=document.createElement("div");Object.assign(p.style,{display:"flex",alignItems:"center"}),p.appendChild(r),p.appendChild(l),a.appendChild(s),a.appendChild(p);let d=document.createElement("div");d.style.display="block";let c=document.createElement("label");c.className="js-ts-reason-label",c.textContent=t("motivo_ts"),Object.assign(c.style,St,{fontSize:"12px"});let x=document.createElement("input");x.type="text",Object.assign(x.style,ta);let g=document.createElement("div");g.className="js-ts-warning",g.innerHTML=`\u26A0\uFE0F <strong>${t("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#e37400; text-decoration:underline;">Link aqui</a>`,Object.assign(g.style,ea),d.appendChild(c),d.appendChild(x),d.appendChild(g),e.appendChild(o),e.appendChild(a),e.appendChild(d),n.onchange=()=>{d.style.display="none",Promise.resolve().then(()=>(Xe(),it)).then(z=>z.notesState.setTagSupportUsed(!0))},r.onchange=()=>{d.style.display="block",Promise.resolve().then(()=>(Xe(),it)).then(z=>z.notesState.setTagSupportUsed(!1))};function b(z,B){if(e.style.display="none",!z||!B||B.length===0)return;B.some(K=>K==="ads_conversion_tracking"||K==="ads_enhanced_conversions")?e.style.display="block":(S(),Promise.resolve().then(()=>(Xe(),it)).then(K=>K.notesState.setTagSupportUsed(!1)))}function u(){if(e.style.display==="none")return"";let z=`<br><b>Utilizou Tag Support?</b> ${n.checked?"\u2705 Sim":"\u274C N\xE3o"}`;return r.checked&&x.value.trim()!==""&&(z+=`<br><b>Motivo:</b> ${x.value}`),z+="<br>",z}function y(z){t=z,o.textContent=t("utilizou_tag_support"),c.textContent=t("motivo_ts"),g.innerHTML=`\u26A0\uFE0F <strong>${t("lembre_preencher_form")}</strong> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeP_JM8D-6qHa5ZC93aTzj38WiO5zx8nyrWNPvbZhjJj6CpkA/viewform" target="_blank" style="color:#b06000; text-decoration:underline;">Link aqui</a>`}function S(){e.style.display="none",r.checked=!0,n.checked=!1,d.style.display="block",x.value=""}return{element:e,updateVisibility:b,getOutput:u,setLanguage:y,reset:S}}var kt="cw_notes_parking_lot",ct="cw_notes_emergency_save";var be={getAll:()=>{try{return JSON.parse(localStorage.getItem(kt)||"[]")}catch{return[]}},save:t=>{let e=be.getAll(),o={id:Date.now().toString(),timestamp:new Date().toISOString(),...t};return e.unshift(o),e.length>5&&e.pop(),localStorage.setItem(kt,JSON.stringify(e)),o},delete:t=>{let e=be.getAll();return e=e.filter(o=>o.id!==t),localStorage.setItem(kt,JSON.stringify(e)),e},getCount:()=>be.getAll().length,saveEmergency:t=>{let e={timestamp:Date.now(),data:t};localStorage.setItem(ct,JSON.stringify(e))},getEmergency:()=>{try{let t=localStorage.getItem(ct);if(!t)return null;let e=JSON.parse(t);return Date.now()-e.timestamp>432e5?(localStorage.removeItem(ct),null):!e.data||!e.data.subStatus?null:e.data}catch{return null}},clearEmergency:()=>{localStorage.removeItem(ct)}};var aa="https://script.google.com/a/macros/google.com/s/AKfycbxFxh1cVk6r0t_JTA2TBfHBLJe_mOBQFsidwL1jwsUDcBtQYk3afu25SN-FR3vafJChHw/exec",Ft="cw_data_broadcast",no="cw_data_tips",na=["Processando...","Mantenha o foco!","Aguarde..."];function Ue(t,e={}){return new Promise((o,a)=>{let n="cw_cb_"+Math.round(1e5*Math.random()),i=document.createElement("script");window[n]=l=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],o(l)};let s=Object.keys(e).map(l=>encodeURIComponent(l)+"="+encodeURIComponent(e[l])).join("&"),r=`${aa}?op=${t}&callback=${n}&t=${Date.now()}&${s}`;i.src=r,i.onerror=()=>{document.body.contains(i)&&document.body.removeChild(i),delete window[n],a(new Error("JSONP Error (Check Corp Login)"))},document.body.appendChild(i)})}var de={fetchTips:async()=>{try{let t=await Ue("tips");t?.tips&&localStorage.setItem(no,JSON.stringify(t.tips))}catch(t){console.warn("Tips offline",t)}},fetchData:async()=>{try{let t=await Ue("broadcast");if(t?.broadcast)return localStorage.setItem(Ft,JSON.stringify(t.broadcast)),t}catch(t){console.warn("Broadcast offline",t)}return{broadcast:JSON.parse(localStorage.getItem(Ft)||"[]")}},getCachedBroadcasts:()=>JSON.parse(localStorage.getItem(Ft)||"[]"),getRandomTip:()=>{let t=na,e=localStorage.getItem(no);if(e)try{t=JSON.parse(e)}catch{}return t[Math.floor(Math.random()*t.length)]},sendBroadcast:async t=>{let e={...t,date:new Date().toISOString(),id:Date.now().toString()};return await de._performOp("new_broadcast",e)},updateBroadcast:async(t,e)=>{let o={id:t,...e};return await de._performOp("update_broadcast",o)},deleteBroadcast:async t=>await de._performOp("delete_broadcast",{id:t}),_performOp:async(t,e)=>{try{console.log(`\u{1F4E4} Executando ${t}...`,e);let o=await Ue(t,e);return o&&o.status==="success"?(console.log("\u2705 Sucesso:",t),!0):(console.warn("\u26A0\uFE0F Falha:",o),!1)}catch(o){return console.error("\u274C Erro JSONP:",o),!1}},logEvent:(t,e,o="",a=null)=>{try{let n="anon";try{let s=we();s&&(n=s.split("@")[0].toLowerCase())}catch{}let i={timestamp:new Date().toISOString(),user:n,version:"v5.1",category:t,action:e,label:o,value:a||""};Ue("log",i).catch(s=>{})}catch(n){console.warn("Analytics error",n)}},logUsage:()=>{},sendBAUEscalation:async(t,e)=>{let o={...t,user:e,date:new Date().toISOString()};try{console.log("\u{1F4E4} Executando create_bau...",o);let a=await Ue("create_bau",o);if(a&&a.status==="success")return console.log("\u2705 Sucesso: create_bau"),a;throw new Error(a?.message||"Falha na opera\xE7\xE3o BAU")}catch(a){throw console.error("\u274C Erro JSONP (BAU):",a),a}},readAgentBAU:async()=>{let t=we();if(!t)return console.warn("\u26A0\uFE0F Email n\xE3o encontrado. N\xE3o foi poss\xEDvel buscar casos BAU."),[];try{console.log("\u{1F50D} Buscando casos BAU para:",t);let e=await Ue("read_agent_bau",{user:t});return e&&e.status==="success"?e.cases||[]:[]}catch(e){return console.error("\u274C Erro ao buscar casos BAU:",e),[]}}},io=de.sendBAUEscalation,so=de.readAgentBAU;var dt=["lucaste","ricardogi"];var se={glassBg:"rgba(61, 61, 61, 0.77)",glassBorder:"rgba(255, 255, 255, 0.15)",glassActive:"rgba(79, 79, 79, 0.89)",glassHighlight:"rgba(255, 255, 255, 0.08)",iconIdle:"#c2c5c8ff",iconActive:"#FFFFFF",blue:"#8AB4F8",red:"#F28B82",purple:"#C58AF9",green:"#81C995",orange:"#F9AB00",teal:"#00BFA5",pink:"#F48FB1",gray:"#9AA0A6"},pt=t=>new Promise(e=>setTimeout(e,t));function ut(t){let e=document.getElementById("cw-btn-notes");if(!e)return;let o=e.querySelector(".cw-dot-dirty");t?o||(o=document.createElement("div"),o.className="cw-dot-dirty",e.appendChild(o)):o&&o.remove()}function ro(t){let e="cw-command-center-style";if(!document.getElementById(e)){let u=document.createElement("style");u.id=e,u.innerHTML=`
    ...
    `;let n=document.createElement("div");n.className="cw-focus-backdrop",document.body.appendChild(n),document.body.appendChild(a);let i=(u,y)=>{j.playClick(),a.querySelector(`.${u}`).classList.toggle("active"),y()};if(a.querySelector(".notes").onclick=u=>{u.stopPropagation(),i("notes",t.toggleNotes)},a.querySelector(".bauform").onclick=u=>{u.stopPropagation(),i("bauform",t.toggleBAUForm)},a.querySelector(".email").onclick=u=>{u.stopPropagation(),i("email",t.toggleEmail)},a.querySelector(".script").onclick=u=>{u.stopPropagation(),i("script",t.toggleScript)},a.querySelector(".links").onclick=u=>{u.stopPropagation(),i("links",t.toggleLinks)},a.querySelector(".library").onclick=u=>{u.stopPropagation(),i("library",t.toggleLibrary)},a.querySelector(".timezone").onclick=u=>{u.stopPropagation(),i("timezone",t.toggleTimezone)},a.querySelector(".configs").onclick=u=>{u.stopPropagation(),i("configs",t.toggleConfigs)},a.querySelector(".broadcast").onclick=u=>{u.stopPropagation(),i("broadcast",()=>{let y=u.currentTarget.querySelector(".cw-badge");y&&y.remove(),t.broadcastControl&&t.broadcastControl.toggle()})},a.querySelectorAll(".cw-btn").forEach(u=>{u.addEventListener("mouseenter",()=>j.playHover())}),t.broadcastControl&&t.broadcastControl.hasUnread){let u=document.createElement("div");u.className="cw-badge",a.querySelector(".broadcast").appendChild(u)}let s=null;a.onmouseleave=()=>{a.querySelector(".cw-btn.active")||a.classList.contains("processing-center")||(s=setTimeout(()=>{a.classList.add("collapsed")},3e3))},a.onmouseenter=()=>{s&&clearTimeout(s)},(async function(){let y=()=>{let z=we();if(z){let B=z.split("@")[0].toLowerCase();if(dt.includes(B)){let $=a.querySelector("#cw-admin-tag");$&&$.classList.add("visible")}}else setTimeout(y,2e3)};y(),await pt(2800),a.classList.add("docked"),await pt(300);let S=a.querySelectorAll(".cw-btn");a.querySelectorAll(".cw-sep").forEach(z=>z.classList.add("visible"));for(let z=0;z<S.length;z++)S[z].classList.add("popped"),await pt(90);await pt(200),a.classList.add("system-check")})();let r=!1,l,p,d,c,x=3;a.onmousedown=u=>{if(u.target.closest("button"))return;u.preventDefault(),l=u.clientX,p=u.clientY;let y=a.getBoundingClientRect();d=y.left,c=y.top,document.addEventListener("mousemove",g),document.addEventListener("mouseup",b)};function g(u){let y=u.clientX-l,S=u.clientY-p;!r&&Math.sqrt(y*y+S*S)>x&&(r=!0,a.classList.add("dragging"),a.style.transition="none",s&&clearTimeout(s)),r&&(a.style.left=`${d+y}px`,a.style.top=`${c+S}px`,a.style.right="auto",a.style.bottom="auto",a.style.transform="none")}function b(u){if(document.removeEventListener("mousemove",g),document.removeEventListener("mouseup",b),r){r=!1,a.classList.remove("dragging");let y=window.innerWidth,S=window.innerHeight,z=a.getBoundingClientRect(),B=z.left+z.width/2,$;B<y/2?($=24,a.classList.remove("side-right"),a.classList.add("side-left")):($=y-z.width-24,a.classList.remove("side-left"),a.classList.add("side-right"));let K=Math.max(24,Math.min(z.top,S-z.height-24));setTimeout(()=>{a.style.setProperty("transition","left 0.6s cubic-bezier(0.34, 1.56, 0.64, 1), top 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)","important"),a.style.left=`${$}px`,a.style.top=`${K}px`,a.style.bottom="auto",a.style.transform=""},10),setTimeout(()=>{a.style.transition="",a.style.removeProperty("transition")},700)}else{let y=a.querySelector(".cw-btn.active"),S=u.target.closest("button");if(a.classList.contains("collapsed")){let z=a.getBoundingClientRect(),B=window.innerHeight,$=z.top>B/2;if(a.style.setProperty("transition","none","important"),$){let K=B-z.bottom;a.style.top="auto",a.style.bottom=`${K}px`}else a.style.bottom="auto",a.style.top=`${z.top}px`;a.offsetWidth,a.style.removeProperty("transition"),a.classList.remove("collapsed"),j.playGenieOpen()}else!y&&!S&&(a.classList.add("collapsed"),j.playGenieOpen());S&&(S.style.transform="scale(0.9)",setTimeout(()=>S.style.transform="",150))}}}function Ke(){let t=document.querySelector(".cw-pill"),e=document.querySelector(".cw-focus-backdrop");if(!t)return()=>{};t.classList.remove("collapsed"),window._CW_ABORT_PROCESS=!1;let o=document.createElement("div");o.className="cw-center-stage",o.innerHTML=`
  ...
  `;let a=document.createElement("div");a.className="cw-abort-btn",a.textContent="Cancelar",a.onclick=i=>{i.stopPropagation(),window._CW_ABORT_PROCESS=!0,X("Cancelado!",{duration:3e3}),o.remove(),t.classList.remove("processing-center"),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},o.appendChild(a),t.appendChild(o);let n=Date.now();return t.classList.add("processing-center"),e&&e.classList.add("active"),function(){if(window._CW_ABORT_PROCESS||!t.contains(o))return;let s=Date.now()-n,r=Math.max(0,2e3-s);setTimeout(()=>{if(window._CW_ABORT_PROCESS||!t.contains(o))return;let l=o.querySelector(".cw-center-dots"),p=o.querySelector(".cw-center-text"),d=o.querySelector(".cw-center-success"),c=o.querySelector(".cw-abort-btn");l&&(l.style.display="none"),p&&(p.style.display="none"),c&&(c.style.display="none"),d&&d.classList.add("show"),t.classList.add("success"),setTimeout(()=>{t.classList.remove("processing-center"),setTimeout(()=>{o.remove(),t.classList.remove("success"),t.classList.add("collapsed"),e&&e.classList.remove("active")},400)},1e3)},r)}}function lo(t){let{onSaveCurrent:e,onLoadDraft:o,t:a}=t,n=document.createElement("button");n.className="js-btn-park",n.innerHTML=`
    ...
    `;let p=document.createElement("div");p.style.cssText="padding: 16px 24px; border-bottom: 1px solid #F1F3F4; display: flex; justify-content: space-between; align-items: center; background: #fff;",p.innerHTML=`<span class="js-drawer-title" style="font-size:16px; font-weight:700; color:#202124;">${a("rascunhos_salvos")}</span>`;let d=document.createElement("button");d.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5f6368" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',d.style.cssText="background:none; border:none; padding:4px; cursor:pointer; display:flex; align-items:center; justify-content:center; border-radius:50%; transition:background 0.2s;",d.onmouseenter=()=>d.style.background="#F1F3F4",d.onmouseleave=()=>d.style.background="transparent",d.onclick=()=>x(!1),p.appendChild(d);let c=document.createElement("div");c.style.cssText="flex: 1; overflow-y: auto; padding: 16px 24px; background: #F8F9FA; display: flex; flex-direction: column; gap: 12px;",l.appendChild(p),l.appendChild(c);function x(b){let u=l.style.transform==="translateY(0%)";(b!==void 0?b:!u)?(g(),l.style.transform="translateY(0%)"):l.style.transform="translateY(110%)"}function g(){let b=be.getAll();if(c.innerHTML="",b.length===0){c.innerHTML=`
                ...
                </div>`;return}b.forEach(u=>{let y=document.createElement("div");y.style.cssText=`
                background: ${P.surface}; padding: 20px; border-radius: ${pe.large};
                border: 1.5px solid ${P.bgInput}; box-shadow: ${ze.subtle};
                position: relative; transition: all 0.3s ${re};
            `;let z=new Date(u.timestamp).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),B="";u.summaryTags&&u.summaryTags.length>0&&(B=`<div style="font-size:11px; color:#1A73E8; background:#E8F0FE; display:inline-block; padding:2px 6px; border-radius:4px; margin-top:4px;">\u{1F3F7}\uFE0F ${u.summaryTags.slice(0,3).join(", ")+(u.summaryTags.length>3?"...":"")}</div>`),y.innerHTML=`
...
`.replace(/\n/g,"<br>");Qe(I);let T=await bt();T?(T.innerText.trim()===""&&(T.innerHTML=""),document.execCommand("insertHTML",!1,I),gt(T),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var fe=t=>new Promise(e=>setTimeout(e,t));function ye(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function Fe(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function ft(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function me(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let d=e.getBoundingClientRect();s=d.left+d.width/2,r=d.top+d.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,p=i.y-r;t?(j.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof bo=="function"&&bo(e,o)):(j.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof It=="function"&&It(e))}function bo(t,e){It(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function It(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function fo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Kt(t,J),s=ao(h),r=oo(()=>{k(),W.setActiveTasks(r.getCheckedElements())},h,W),l=document.createElement("div");l.style.display="none";let p=to((m,w)=>{C(m,w)});l.appendChild(p);let d=lo({onSaveCurrent:async()=>{let m=await N();return q(),m},onLoadDraft:m=>{Y(m)},t:m=>h(m)}),c=T(),x=M(),g=document.createElement("div"),b=_(),u=F(d,h);o.appendChild(c),o.appendChild(x),o.appendChild(b),o.appendChild(l),o.appendChild(g),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let y=document.createElement("button");y.id="manual-task-toggle",y.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",y.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${P.primary}; background: ${P.surface}; color: ${P.primary}; border-radius: ${pe.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${re}; text-transform: uppercase; letter-spacing: 0.5px;`,y.onmouseenter=()=>{y.style.background=P.primaryBg},y.onmouseleave=()=>{y.style.background=P.surface},y.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",y.style.display="none"},o.appendChild(y),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(u);let S=document.createElement("div");S.style.display="none",S.style.flexGrow="1",S.style.minHeight="0",S.style.overflow="hidden";let z=uo(()=>I());z.style.height="100%",S.appendChild(z),e.insertBefore(S,i);let B=a.lastElementChild;B&&(B.insertBefore(d.historyBtnWrapper,B.firstChild),B.insertBefore(v(),B.firstChild)),e.appendChild(d.drawer);let $=null;W.subscribe(m=>{D(m),K(),m.isDirty?($&&clearTimeout($),$=setTimeout(async()=>{let w=await N(!0);w.subStatus?be.saveEmergency(w):be.clearEmergency(),m.isDirty=!1},2e3)):$&&(clearTimeout($),$=null)});function K(){let m=be.getCount()>0,w=!!W.currentSubStatus;ut(m||w)}function J(){W.visible=!W.visible,me(W.visible,e,"cw-btn-notes")}function I(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",S.style.display="flex",S.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",S.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function T(){let m=document.createElement("div");if(m.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let E=document.createElement("style");E.id="cw-segmented-styles",E.innerHTML=`
            ...
            `,document.head.appendChild(E)}let w=(E,G)=>{let Q=m.querySelector(`#${E}`).querySelector(".cw-segmented-indicator");Q&&(Q.style.transform=`translateX(${G*100}%) translateX(${G*2}px)`)};return m.querySelectorAll("#lang-selector button").forEach((E,G)=>{E.onclick=()=>{W.setLanguage(E.dataset.lang),m.querySelectorAll("#lang-selector button").forEach(H=>H.classList.remove("active")),E.classList.add("active"),w("lang-selector",G),j.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m.querySelectorAll("#type-selector button").forEach((E,G)=>{E.onclick=()=>{W.setCaseType(E.dataset.type),m.querySelectorAll("#type-selector button").forEach(H=>H.classList.remove("active")),E.classList.add("active"),w("type-selector",G),j.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m.querySelectorAll("#portugal-selector button").forEach((E,G)=>{E.onclick=()=>{W.setPortugalCase(E.dataset.val==="true"),m.querySelectorAll("#portugal-selector button").forEach(H=>H.classList.remove("active")),E.classList.add("active"),w("portugal-selector",G),j.playHover(),W.currentSubStatus&&L(W.currentSubStatus)}}),m}function M(){let m=document.createElement("div");m.className="cw-status-section",m.style.cssText="display: flex; flex-direction: column; gap: 8px;",m.innerHTML=`
        ...
        `;let w=m.querySelector("#main-status-select"),E=m.querySelector("#sub-status-select");return w.onchange=()=>{W.setStatus(w.value),V(w.value,E),W.setSubStatus(""),L("")},E.onchange=()=>{W.setSubStatus(E.value),L(E.value)},m}function V(m,w){if(w.innerHTML=`<option value="">${h("select_substatus")}</option>`,!m){w.disabled=!0;return}for(let E in ke)if(ke[E].status===m){let G=document.createElement("option");G.value=E,G.textContent=ke[E].name,w.appendChild(G)}w.disabled=!1}function L(m){if(p.render&&p.render(m,W.currentCaseType),!m){l.style.display="none",g.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",b.style.display="flex",b.style.opacity="1",u.style.display="none";return}b.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(b.style.display="none")},400),u.style.display="grid";let w=ke[m];w&&w.templateFields&&W.setActiveFields(w.templateFields),O(),At(m,g,W),g.style.display="block",l.style.display="block";let E=m.startsWith("SO_"),G=m==="NI_Awaiting_Validation",H=document.getElementById("manual-task-toggle");E||G?(r.selectionElement.style.display="block",H.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",H.style.display="block");let Q=m==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(Q),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(m),k();let U=document.getElementById("email-automation-toggle-row");U&&(U.style.display=He[m]?"flex":"none")}function k(){let m=r.getCheckedElements().map(w=>w.value);s.updateVisibility(W.currentSubStatus,m)}function C(m,w){let E=rt[m];if(E){for(let G in E)if(G==="linkedTask")r.toggleTask(E.linkedTask,w);else if(G==="activeTasks")E.activeTasks.forEach(H=>{w?r.setTaskCount(H.value,H.count):r.setTaskCount(H.value,0)});else if(G.startsWith("field-")){let H=G,Q=E[G],U=document.getElementById(H);if(U){let te=je.includes(H.replace("field-",""));if(w)if(te){let ae=U.value.trim();ae.includes(Q.trim())||(U.value=ae?ae+`
`+Q.trim():Q.trim())}else U.value=Q;else if(te){let ae=U.value.trim(),Z=Q.trim();ae.includes(Z)&&(U.value=ae.replace(Z,"").trim().replace(/\n{3,}/g,`

`))}else U.value.trim()===Q.trim()&&(U.value="");W.updateField(H,U.value),U.dispatchEvent(new Event("input"))}}}}function F(m,w){let E=document.createElement("div");if(E.className="cw-actions-section",E.style.cssText=`
            display: grid;
        ...
        `,!document.getElementById("cw-actions-hover-styles")){let ae=document.createElement("style");ae.id="cw-actions-hover-styles",ae.innerHTML=`
            ...
            `,document.head.appendChild(ae)}let G=document.createElement("div");G.id="email-automation-toggle-row",G.style.cssText="grid-column: span 2; display: none; align-items: center; justify-content: center; padding-bottom: 6px; border-bottom: 1px solid rgba(0,0,0,0.05); margin-bottom: 2px;",G.innerHTML=`
        ...
        `;let H=m.parkButton;H.classList.add("js-btn-park"),H.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let Q=document.createElement("button");Q.className="cw-btn-secondary js-btn-reset",Q.textContent=w("limpar"),Q.style.cssText=`width: 100%; height: 34px; background: ${P.surface}; color: ${P.textSub}; border: 1px solid ${P.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,Q.onclick=()=>q();let U=document.createElement("button");U.className="cw-btn-secondary js-btn-copy",U.textContent=w("copiar"),U.style.cssText=`width: 100%; height: 34px; background: ${P.surface}; color: ${P.primary}; border: 1px solid ${P.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,U.onclick=()=>f();let te=document.createElement("button");return te.className="cw-btn-primary js-btn-generate",te.textContent=w("preencher"),te.style.cssText=`width: 100%; height: 38px; background: ${P.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,te.onclick=()=>A(),E.appendChild(G),E.appendChild(H),E.appendChild(Q),E.appendChild(U),E.appendChild(te),E}async function f(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Tt(W,r,s);m?(Qe(m),X(h("copiado_sucesso")),j.playClick()):X(h("select_substatus"),{error:!0})}async function A(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Tt(W,r,s);Qe(m),J();let w=Ke(),E=await bt();if(E){E.focus(),document.execCommand("insertHTML",!1,m),gt(E);let G=document.getElementById("email-automation-checkbox");(!G||G.checked)&&W.currentSubStatus&&He[W.currentSubStatus]&&await ht(He[W.currentSubStatus]),X(h("inserido_copiado")),j.playSuccess(),q()}w()}function O(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let m=ke[W.currentSubStatus];m&&m.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function q(){W.reset(),r.reset(),s.reset(),K(),be.clearEmergency(),o.querySelectorAll("select").forEach(w=>w.value=""),o.querySelector("#sub-status-select").disabled=!0;let m=document.getElementById("email-automation-toggle-row");m&&(m.style.display="none"),g.innerHTML="",l.style.display="none",b.style.display="flex",b.style.opacity="1",u.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none"}async function N(m=!1){let w={};g.querySelectorAll("input, textarea, select").forEach(U=>{(U.id.startsWith("field-")||U.id==="consent-select")&&(w[U.id]=U.value)});let E="Cliente",G="---";if(!m)try{let U=await Se();E=U.advertiserName,G=U.cid}catch(U){console.warn("Erro ao coletar pageData:",U)}let H=r.getCheckedElements().map(U=>({key:U.value,count:U.count})),Q=H.map(U=>{let te=Ee[U.key];return te?te.name:U.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:w,activeTasks:H,summaryTags:Q,clientName:E,cid:G,timestamp:new Date().toISOString()}}let R=m=>new Promise(w=>setTimeout(w,m));async function Y(m){W.setLanguage(m.currentLang||"pt"),W.setCaseType(m.currentCaseType||"bau"),W.setPortugalCase(m.isPortugalCase||!1),W.setConsent(m.consent||!1),W.setExcludedFields(m.excludedFields||[]),m.activeFields&&W.setActiveFields(m.activeFields);let w=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);w&&w.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(H=>{H!==w&&H.classList.remove("active")});let E=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);E&&E.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(H=>{H!==E&&H.classList.remove("active")});let G=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if(G&&G.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(H=>{H!==G&&H.classList.remove("active")}),m.status){let H=o.querySelector("#main-status-select");H.value=m.status,W.setStatus(m.status);let Q=o.querySelector("#sub-status-select");if(V(m.status,Q),await R(50),m.subStatus){if(Q.value=m.subStatus,W.setSubStatus(m.subStatus),L(m.subStatus),await R(100),m.tagSupportUsed!==void 0){W.setTagSupportUsed(m.tagSupportUsed);let U=s.element.querySelector('input[value="Sim"]'),te=s.element.querySelector('input[value="N\xE3o"]');m.tagSupportUsed&&U?U.checked=!0:te&&(te.checked=!0),s.element.querySelector("div:last-child").style.display=m.tagSupportUsed?"none":"block"}m.forcedScreenshots&&W.setForcedScreenshots(m.forcedScreenshots);for(let U in m.formData){let te=document.getElementById(U);te&&(te.value=m.formData[U],W.updateField(U,te.value))}m.activeTasks&&(m.activeTasks.forEach(U=>r.setTaskCount(U.key,U.count)),W.setActiveTasks(r.getCheckedElements()))}}W.isDirty=!1}function h(m){return Ce[W.currentLang]?.[m]||Ce.pt?.[m]||m}function v(){let m=document.createElement("div");return m.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',m.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",m.onclick=w=>{w.stopPropagation(),I()},m.title="Alternar para Split & Transfer",m}function _(){let m=document.createElement("div");return m.id="notes-empty-state",m.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
    ...
    `,document.head.appendChild(p),Object.assign(l.style,ge,{width:"850px",height:"650px",display:"none",flexDirection:"column",fontFamily:"'-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', sans-serif",borderRadius:"12px",overflow:"hidden"});let d=ue(l,"Email Assistant",t,"Refatora\xE7\xE3o completa do m\xF3dulo de e-mail para uma experi\xEAncia moderna e eficiente.",{popup:l},()=>C()),c=document.createElement("div");Object.assign(c.style,{display:"flex",flex:"1",overflow:"hidden",backgroundColor:r.bgApp});let x=document.createElement("div");Object.assign(x.style,{width:"320px",backgroundColor:"#EFEFF0",borderRight:`1px solid ${r.borderSubtle}`,display:"flex",flexDirection:"column",flexShrink:"0"});let g=document.createElement("div");Object.assign(g.style,{padding:"16px",borderBottom:`1px solid ${r.borderSubtle}`,position:"relative"});let b=document.createElement("input");b.placeholder="Buscar templates...",Object.assign(b.style,{width:"100%",padding:"10px 14px 10px 36px",borderRadius:"10px",border:"1.5px solid transparent",backgroundColor:"#E3E3E8",fontSize:"15px",outline:"none",boxSizing:"border-box",color:r.textPrimary,backgroundImage:`url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="%238A8A8E" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>')`,backgroundRepeat:"no-repeat",backgroundPosition:"12px center",transition:"all 0.2s ease-in-out"}),b.onfocus=()=>{b.style.backgroundColor="#FFFFFF",b.style.borderColor=r.primary,b.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)",b.style.transform="scale(1.02)"},b.onblur=()=>{b.style.backgroundColor="#E3E3E8",b.style.borderColor="transparent",b.style.boxShadow="none",b.style.transform="scale(1)"};let u=document.createElement("div");u.id="email-template-list",Object.assign(u.style,{flex:"1",overflowY:"auto",padding:"8px",scrollBehavior:"smooth"});let y=document.createElement("div");y.innerHTML="\u2715",Object.assign(y.style,{position:"absolute",right:"26px",top:"50%",transform:"translateY(-50%)",fontSize:"10px",color:"#fff",cursor:"pointer",display:"none",backgroundColor:"#C7C7CC",width:"16px",height:"16px",borderRadius:"50%",textAlign:"center",lineHeight:"16px",fontWeight:"bold"}),y.onclick=()=>{b.value="",n="",y.style.display="none",f(),b.focus()},g.appendChild(b),g.appendChild(y),x.appendChild(g),x.appendChild(u);let S=document.createElement("div");Object.assign(S.style,{flex:"1",display:"flex",flexDirection:"column",overflow:"hidden",backgroundColor:r.bgApp,transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)"});let z=document.createElement("div");Object.assign(z.style,{padding:"20px",borderBottom:`1px solid ${r.borderSubtle}`,backgroundColor:r.bgSurface,maxHeight:"250px",overflowY:"auto",display:"none"});let B=document.createElement("div");Object.assign(B.style,{flex:"1",display:"flex",flexDirection:"column",padding:"20px",backgroundColor:r.bgApp,overflow:"hidden"});let $=document.createElement("div");Object.assign($.style,{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px"});let K=document.createElement("span");K.textContent="Preview do E-mail",Object.assign(K.style,{fontSize:"12px",fontWeight:"600",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.5px"});let J=document.createElement("div");Object.assign(J.style,{display:"flex",gap:"8px"});let I=(R,Y=!1)=>{let h=document.createElement("button");return h.textContent=R,Object.assign(h.style,{padding:"8px 14px",borderRadius:"10px",border:Y?"none":`1.5px solid ${r.primary}`,background:Y?r.primary:"transparent",color:Y?"#fff":r.primary,fontSize:"13px",fontWeight:"600",cursor:"pointer",transition:"all 0.2s cubic-bezier(0.25, 1, 0.5, 1)",boxShadow:Y?"0 4px 12px rgba(0, 122, 255, 0.3)":"none"}),h.onmouseenter=()=>{Y?(h.style.backgroundColor="#0062CC",h.style.transform="translateY(-1px)",h.style.boxShadow="0 6px 16px rgba(0, 122, 255, 0.4)"):h.style.backgroundColor="rgba(0, 122, 255, 0.05)"},h.onmouseleave=()=>{Y?(h.style.backgroundColor=r.primary,h.style.transform="translateY(0)",h.style.boxShadow="0 4px 12px rgba(0, 122, 255, 0.3)"):(h.style.backgroundColor="transparent",h.style.transform="translateY(0)")},h.onmousedown=()=>h.style.transform="scale(0.94)",h.onmouseup=()=>h.style.transform="scale(1)",h},T=I("Copiar HTML"),M=I("Preencher no CRM",!0),V=I("Smart CR");V.style.borderColor="#E67E22",V.style.color="#E67E22",V.style.display="none",J.appendChild(V),J.appendChild(T),J.appendChild(M),$.appendChild(K),$.appendChild(J);let L=document.createElement("div");L.contentEditable="true",Object.assign(L.style,{flex:"1",backgroundColor:r.bgSurface,border:`1px solid ${r.borderSubtle}`,borderRadius:"8px",padding:"20px",fontSize:"15px",lineHeight:"1.6",color:r.textPrimary,overflowY:"auto",outline:"none",boxShadow:"inset 0 1px 2px rgba(0,0,0,0.02)"}),B.appendChild($),B.appendChild(L),N(),S.appendChild(z),S.appendChild(B),c.appendChild(x),c.appendChild(S),l.appendChild(d),l.appendChild(c);let k=document.createElement("div");Object.assign(k.style,Ae),l.appendChild(k),Te(l,k),document.body.appendChild(l);function C(){e=!e,e?(l.style.display="flex",Ut(l),o.length===0&&F()):l.style.display="none",me(e,l,"cw-btn-email")}async function F(){u.innerHTML='<div style="padding: 20px; text-align: center; color: #5f6368;">Carregando...</div>',o=await ho.getTemplates(),f()}function f(){u.innerHTML="";let R=o.filter(D=>D.name.toLowerCase().includes(n.toLowerCase())||D.category.toLowerCase().includes(n.toLowerCase())),Y=Object.entries(He).filter(([D,m])=>m&&(D.toLowerCase().includes(n.toLowerCase())||m.toLowerCase().includes(n.toLowerCase()))).map(([D,m])=>({id:D,name:D.replace(/_/g," "),category:"\u26A1 Smart CRs",code:m,isSmartCR:!0})),h=he.getSnippets("email").filter(D=>D.title.toLowerCase().includes(n.toLowerCase())||D.subject&&D.subject.toLowerCase().includes(n.toLowerCase())).map(D=>{let m=[],w=D.content.match(/\[([^\]]+)\]/g);return w&&[...new Set(w)].forEach(E=>{m.push({key:E,label:E.replace("[","").replace("]",""),type:E.toLowerCase().includes("data")?"date":"text",auto:E.toLowerCase().includes("nome")&&E.toLowerCase().includes("seu")?"agentName":null})}),{id:D.id||`snippet-${Math.random()}`,name:D.title,category:"\u{1F464} Pessoal",subject:D.subject||"Sem Assunto",template:D.content,placeholders:m}}),v=[...R,...Y,...h];if(v.length===0){u.innerHTML=`
                ...
                </div>`;return}[...new Set(v.map(D=>D.category))].sort((D,m)=>D.localeCompare(m)).forEach(D=>{let m=s.has(D)||n.length>0,w=v.filter(te=>te.category===D),E=document.createElement("div");Object.assign(E.style,{padding:"12px 16px 12px 24px",fontSize:"11px",fontWeight:"700",color:r.textSecondary,textTransform:"uppercase",letterSpacing:"0.8px",position:"sticky",top:"-8px",backgroundColor:"rgba(239, 239, 240, 0.9)",zIndex:"10",backdropFilter:"blur(20px)",margin:"0 -8px 8px -8px",borderBottom:`0.5px solid ${r.borderSubtle}`,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",userSelect:"none",transition:"background-color 0.2s ease"}),E.onmouseenter=()=>E.style.backgroundColor="rgba(230, 230, 232, 0.9)",E.onmouseleave=()=>E.style.backgroundColor="rgba(239, 239, 240, 0.9)";let G=document.createElement("span");G.textContent=D,E.appendChild(G);let H=document.createElement("span");H.textContent=w.length,Object.assign(H.style,{backgroundColor:"rgba(0, 0, 0, 0.05)",padding:"2px 8px",borderRadius:"10px",fontSize:"10px",color:r.textSecondary});let Q=document.createElement("span");Q.innerHTML=m?"\u{10012A}":"\u{10012B}",Q.innerHTML=m?"\u25BE":"\u25B8",Q.style.marginLeft="8px",Q.style.transition="transform 0.3s ease";let U=document.createElement("div");U.style.display="flex",U.style.alignItems="center",U.appendChild(H),U.appendChild(Q),E.appendChild(U),E.onclick=()=>{s.has(D)?s.delete(D):s.add(D),f()},u.appendChild(E),m&&w.forEach(te=>{let ae=a&&a.id===te.id,Z=document.createElement("div");if(Object.assign(Z.style,{padding:"12px 14px",fontSize:"14px",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.25, 1, 0.5, 1)",borderRadius:"10px",color:r.textPrimary,margin:"4px 6px",display:"flex",alignItems:"center",gap:"12px",backgroundColor:ae?r.primary:r.bgSurface,boxShadow:ae?"0 4px 12px rgba(0, 122, 255, 0.3)":"0 1px 2px rgba(0,0,0,0.05)",border:ae?"none":`1px solid ${r.borderSubtle}`,position:"relative",overflow:"hidden"}),ae){let le=document.createElement("div");Object.assign(le.style,{position:"absolute",left:"0",top:"0",bottom:"0",width:"4px",backgroundColor:"#fff",borderRadius:"0 4px 4px 0"}),Z.appendChild(le)}let ie=document.createElement("span");ie.innerHTML=te.isSmartCR?"\u26A1":te.category==="\u{1F464} Pessoal"?"\u{1F464}":"\u{1F4C4}",ie.style.fontSize="12px",ie.style.opacity="0.7",ie.style.flexShrink="0",Z.appendChild(ie);let oe=document.createElement("span");oe.textContent=te.name,oe.style.overflow="hidden",oe.style.textOverflow="ellipsis",oe.style.whiteSpace="nowrap",oe.style.flex="1",Z.appendChild(oe),ae&&(Z.style.color="#fff",Z.style.fontWeight="600",ie.style.opacity="1"),Z.onmouseenter=()=>{ae||(Z.style.backgroundColor="#f8f8f9",Z.style.transform="translateY(-1px) scale(1.01)",Z.style.boxShadow="0 4px 8px rgba(0,0,0,0.08)",Z.style.borderColor="rgba(0, 122, 255, 0.2)")},Z.onmouseleave=()=>{ae||(Z.style.backgroundColor=r.bgSurface,Z.style.transform="translateY(0) scale(1)",Z.style.boxShadow="0 1px 2px rgba(0,0,0,0.05)",Z.style.borderColor=r.borderSubtle)},Z.onmousedown=()=>{Z.style.transform=ae?"scale(0.97)":"scale(0.98)"},Z.onmouseup=()=>{Z.style.transform=ae?"scale(1)":"translateY(-1px) scale(1.01)"},Z.onclick=()=>{O(te)},u.appendChild(Z)})})}let A=null;async function O(R){a?.id!==R.id&&(a=R,A&&clearTimeout(A),S.style.opacity="0",S.style.transform="translateY(5px)",A=setTimeout(()=>{V.style.display=R.isSmartCR?"block":"none",M.style.display=R.isSmartCR?"none":"block",T.style.display=R.isSmartCR?"none":"block",f(),q(),N(),S.style.opacity="1",S.style.transform="translateY(0)",A=null},150))}function q(){if(z.innerHTML="",!a||a.isSmartCR){a?.isSmartCR?(z.style.display="block",z.innerHTML=`<div style="padding: 12px; font-size: 13px; color: #856404; background: #FFF3CD; border: 1px solid #FFEEBA; border-radius: 8px; display: flex; align-items: center; gap: 8px;">
                ...
                </div>`):z.style.display="none";return}let R=a.placeholders&&a.placeholders.length>0;if(z.style.display=R?"block":"none",!R)return;let Y=document.createElement("div");Object.assign(Y.style,{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"}),(a.placeholders||[]).forEach(h=>{let v=document.createElement("div"),_=document.createElement("label");_.textContent=h.label,Object.assign(_.style,{display:"block",fontSize:"11px",fontWeight:"700",color:r.textSecondary,marginBottom:"8px",textTransform:"uppercase",letterSpacing:"0.5px"});let D=document.createElement("input");D.type=h.type||"text",D.dataset.key=h.key,Object.assign(D.style,{width:"100%",padding:"10px 12px",borderRadius:"8px",border:`1.5px solid ${r.borderSubtle}`,backgroundColor:"#FBFBFD",fontSize:"14px",boxSizing:"border-box",transition:"all 0.2s ease",outline:"none"}),D.onfocus=()=>{D.style.borderColor=r.primary,D.style.backgroundColor="#FFFFFF",D.style.boxShadow="0 0 0 4px rgba(0, 122, 255, 0.1)"},D.onblur=()=>{D.style.borderColor=r.borderSubtle,D.style.backgroundColor="#FBFBFD",D.style.boxShadow="none"},h.auto==="agentName"&&(D.value=Ye().split(" ")[0]),D.addEventListener("input",N),v.appendChild(_),v.appendChild(D),Y.appendChild(v)}),z.appendChild(Y)}function N(){if(!a){L.innerHTML=`
...
E-mail: ${w.clientEmail||"---"}`;G&&(G.value=Q),H&&(H.style.display="block",H.style.maxHeight="300px",H.style.opacity="1",H.scrollIntoView({behavior:"smooth",block:"end"}))})}function g(){r=!r,me(r,l,"cw-btn-script"),r?(c(),d||(d=setInterval(c,2e3))):d&&(clearInterval(d),d=null)}let b=ue(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",p,()=>{g()});l.appendChild(b);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `;let y=u.querySelector("#csa-toggle-options"),S=u.querySelector("#csa-options-content"),z=u.querySelector("#csa-options-arrow"),B=!1;y.onclick=()=>{B=!B,z.style.transform=B?"rotate(180deg)":"rotate(0deg)",S.style.maxHeight=B?"400px":"0",S.style.opacity=B?"1":"0",S.style.marginTop=B?"8px":"0",j.playClick()};let $=u.querySelector("#cw-pill-message"),K=u.querySelector("#cw-am-copy-final"),J=u.querySelector("#cw-am-message-area");$.onmouseenter=()=>{$.style.borderColor="#007AFF",$.style.boxShadow="0 2px 8px rgba(0,0,0,0.05)"},$.onmouseleave=()=>{$.style.borderColor="#DADCE0",$.style.boxShadow="0 1px 2px rgba(0,0,0,0.02)"},$.addEventListener("click",()=>{x()}),K.addEventListener("click",()=>{J.value&&(navigator.clipboard.writeText(J.value),X("Mensagem copiada!"),j.playSuccess(),K.style.background="#34A853",K.textContent="Copiado!",setTimeout(()=>{K.style.background="#1A73E8",K.textContent="Copiar Mensagem Final"},2e3))});let I=(w,E)=>{let G=u.querySelector(w),H=u.querySelector(E);G.onclick=()=>{let Q=H.textContent;!Q||Q.includes("---")||Q.includes("N\xE3o encontrado")||(navigator.clipboard.writeText(Q),j.playSuccess(),G.classList.add("copied"),setTimeout(()=>G.classList.remove("copied"),1500))}};l.appendChild(u);let T=document.createElement("div");Object.assign(T.style,a.progressBarContainer);let M=document.createElement("div");M.className="csa-progress-fill",Object.assign(M.style,a.progressBarFill),T.appendChild(M),l.appendChild(T);let V=document.createElement("div");V.id="csa-content",Object.assign(V.style,a.contentArea),l.appendChild(V);let L=document.createElement("div");Object.assign(L.style,a.footer);let k=document.createElement("span");k.textContent="by lucaste@",Object.assign(k.style,{fontSize:"10px",color:"#bdc1c6"});let C=document.createElement("button");C.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg> Resetar Script',Object.assign(C.style,a.resetBtn),C.onmouseenter=()=>C.style.background="#fce8e6",C.onmouseleave=()=>C.style.background="transparent",C.onclick=()=>{C.style.transform="scale(0.9)",setTimeout(()=>C.style.transform="scale(1)",150);for(let w in n)delete n[w];_()},L.appendChild(k),L.appendChild(C),l.appendChild(L);let F=document.createElement("div");Object.assign(F.style,{display:"flex",flexDirection:"column",gap:"8px",marginBottom:"16px"});let f=document.createElement("div");f.className="csa-segmented-control",f.innerHTML=`
  ...
  `,u.onfocus=()=>{g.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",g.style.border="1px solid #1a73e8"},u.onblur=()=>{g.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",g.style.border="1px solid transparent"},g.appendChild(b),g.appendChild(u),x.appendChild(g),c.appendChild(x);let y=document.createElement("div");y.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",c.appendChild(y);let S=null;function z(){if(S)return;S=document.createElement("div"),S.style.cssText=`
          position: absolute; bottom: 0; left: 0; width: 100%; height: 100%;
          background: rgba(255,255,255,0.98); z-index: 20;
          display: flex; flex-direction: column;
          transform: translateY(100%); transition: transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1);
          box-shadow: 0 -4px 20px rgba(0,0,0,0.1);
      `;let k=document.createElement("div");k.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",k.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let C=document.createElement("button");C.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',C.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",C.onclick=()=>{$(),n=!1,T()},k.appendChild(C),S.appendChild(k);let F=document.createElement("div");F.id="cw-history-list",F.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",S.appendChild(F),c.appendChild(S)}function B(){S||z();let k=S.querySelector("#cw-history-list");k.innerHTML="";let C=ia();C.length===0?k.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':C.forEach(F=>{let f=V(F,$e[F._originalCat],!0,F._originalCat);k.appendChild(f)}),requestAnimationFrame(()=>S.style.transform="translateY(0)")}function $(){S&&(S.style.transform="translateY(100%)")}function K(){d.innerHTML="";let k=J("history","Recentes",$e.history);k.id="cw-sidebar-btn-history",k.onclick=()=>{j.playClick(),n=!n,n?B():$(),T()},d.appendChild(k);let C=document.createElement("div");C.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(C),Object.keys(Ze).forEach(F=>{let f=Ze[F],A=J(F,f.label,$e[F]);A.id=`cw-sidebar-btn-${F}`,A.onclick=()=>{j.playClick(),n&&(n=!1,$()),I(F)},d.appendChild(A)})}function J(k,C,F){let f=document.createElement("div");f.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,f.title=C,f.dataset.key=k;let A=document.createElement("div");A.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",A.innerHTML=F||$e.tasks;let O=document.createElement("div");return O.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",O.textContent=C,f.appendChild(A),f.appendChild(O),f.onmouseenter=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="#F1F3F4",A.style.transform="scale(1.1)")},f.onmouseleave=()=>{a!==k&&!(k==="history"&&n)&&(f.style.background="transparent",A.style.transform="scale(1)")},f}function I(k){let C=document.getElementById(`cat-anchor-${k}`);C&&(C.scrollIntoView({behavior:"smooth",block:"start"}),a=k,T())}function T(){Object.keys(Ze).forEach(C=>{let F=d.querySelector(`#cw-sidebar-btn-${C}`);if(F)if(a===C&&!n){let f=yt[C];F.style.background=f.bg,F.style.color=f.color,F.querySelector("div:first-child").style.transform="scale(1.1)"}else F.style.background="transparent",F.style.color=i.textSecondary,F.querySelector("div:first-child").style.transform="scale(1)"});let k=d.querySelector("#cw-sidebar-btn-history");k&&(n?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=i.textSecondary))}function M(){if(y.innerHTML="",e.trim()!==""){let C=[];if(Object.entries(Ze).forEach(([f,A])=>{let O=A.links.filter(q=>q.name.toLowerCase().includes(e.toLowerCase())||q.desc.toLowerCase().includes(e.toLowerCase()));C.push(...O.map(q=>({...q,_cat:f})))}),C.length===0){y.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let F=document.createElement("div");F.innerHTML="Resultados da busca",F.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",y.appendChild(F),C.forEach(f=>{let A=V(f,$e[f._cat],!1,f._cat);y.appendChild(A)});return}Object.entries(Ze).forEach(([C,F])=>{let f=yt[C],A=document.createElement("div"),O=document.createElement("div");O.id=`cat-anchor-${C}`,O.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,O.innerHTML=`
            ...
            ${F.label}
          `,A.appendChild(O);let q=document.createElement("div");q.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",F.links.forEach(N=>{let R=V(N,$e[C],!1,C);q.appendChild(R)}),A.appendChild(q),y.appendChild(A)});let k=document.createElement("div");k.style.height="80px",y.appendChild(k)}function V(k,C,F,f){let A=document.createElement("div"),O=yt[f]||yt.history;A.style.cssText=`
      ...
      `;let q=document.createElement("div");q.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,q.innerHTML=C||$e.tasks;let N=q.querySelector("svg");N&&(N.style.width="22px",N.style.height="22px");let R=document.createElement("div");R.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let Y=document.createElement("div");Y.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,Y.textContent=k.name;let h=document.createElement("div");h.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,h.textContent=k.desc,R.appendChild(Y),R.appendChild(h);let v=document.createElement("div");return v.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',v.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,v.title="Copiar URL",A.onmouseenter=()=>{A.style.transform="translateY(-2px)",A.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",A.style.borderColor="rgba(0,0,0,0.05)",A.style.borderLeft=`4px solid ${O.color}`,v.style.opacity="1",v.style.background="#F1F3F4"},A.onmouseleave=()=>{A.style.transform="translateY(0)",A.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",A.style.border="1px solid transparent",v.style.opacity="0",v.style.background="transparent"},A.onclick=()=>{!F&&f&&Co(k,f),window.open(k.url,"_blank")},v.onclick=_=>{_.stopPropagation(),j.playClick(),navigator.clipboard.writeText(k.url),!F&&f&&Co(k,f),X("Link copiado!")},A.appendChild(q),A.appendChild(R),A.appendChild(v),A}u.addEventListener("input",k=>{e=k.target.value,M()});function L(){o=!o,me(o,s,"cw-btn-links")}return document.body.appendChild(s),K(),M(),L}var Me=[];function qt(t){Me=t}var sa=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function Ao(){let t="v4.9",e=!1,o=null,a=null;function n(f){if(!f)return"";try{let A=new Date(f);return isNaN(A.getTime())?String(f):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(f)}}if(!document.getElementById("cw-broadcast-hd-css")){let f=document.createElement("style");f.id="cw-broadcast-hd-css",f.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,b.querySelectorAll('input[name="cw-bc-type"]').forEach(q=>{q.addEventListener("change",()=>{b.querySelectorAll(".cw-radio-option").forEach(N=>N.classList.remove("checked")),q.parentElement.classList.add("checked")})}),setTimeout(()=>{let q=b.querySelector(".cw-radio-option.info");q&&q.classList.add("checked")},100);let f=b.querySelector("#cw-bc-cancel"),A=b.querySelector("#cw-bc-close-x"),O=b.querySelector("#cw-bc-send");f.onclick=B,A.onclick=B,O.onclick=$,p.appendChild(b)}function z(f=null){if(!b)return;let A=b.querySelector("#cw-editor-title-label"),O=b.querySelector("#cw-bc-title"),q=b.querySelector("#cw-bc-text"),N=b.querySelector("#cw-bc-send");if(f){a=f.id,A.textContent="Editar Aviso",O.value=f.title||"",q.value=f.text||"",N.textContent="Salvar Altera\xE7\xF5es";let R=f.type||"info",Y=b.querySelector(`input[name="cw-bc-type"][value="${R}"]`);Y&&Y.click()}else{a=null,A.textContent="Novo Aviso",O.value="",q.value="",N.textContent="Publicar";let R=b.querySelector('input[name="cw-bc-type"][value="info"]');R&&R.click()}b.classList.add("active"),setTimeout(()=>O.focus(),300)}function B(){b&&b.classList.remove("active"),a=null}async function $(){let f=b.querySelector("#cw-bc-send"),A=b.querySelector("#cw-bc-title"),O=b.querySelector("#cw-bc-text"),q=b.querySelector('input[name="cw-bc-type"]:checked'),N=q?q.value:"info";if(!A.value.trim()||!O.value.trim()){X("Preencha todos os campos!",{error:!0});return}f.textContent="Salvando...",f.style.opacity="0.7";let R=!1;a?R=await de.updateBroadcast(a,{title:A.value,text:O.value,type:N}):R=await de.sendBroadcast({title:A.value,text:O.value,type:N,author:window._cwCurrentUser||"admin"}),R?(X(a?"Atualizado!":"Publicado!"),j.playSuccess(),B(),setTimeout(()=>I(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),f.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",f.style.opacity="1")}async function K(f){if(await xe("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await de.deleteBroadcast(f)){X("Aviso removido."),j.playClick();let q=Me.findIndex(N=>N.id===f);q>-1&&Me.splice(q,1),M(),setTimeout(()=>I(),1500)}else X("Erro ao excluir.",{error:!0})}let J=document.createElement("div");J.className="cw-nice-scroll",Object.assign(J.style,i.feedContainer),p.appendChild(J);async function I(){e&&(y.style.display="block",y.innerHTML="\u{1F504} Sincronizando...");try{let f=await de.fetchData();f&&f.broadcast&&(qt(f.broadcast),T(),e&&(M(),y.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{y.style.display="none"},1500)))}catch{e&&(y.innerHTML="\u26A0\uFE0F Offline")}}function T(){let f=document.getElementById("cw-btn-broadcast");if(!f)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Me.some(q=>!A.includes(q.id))){if(f.classList.add("has-new"),!f.querySelector(".cw-badge")){let q=document.createElement("div");q.className="cw-badge",Object.assign(q.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),f.appendChild(q)}}else{f.classList.remove("has-new");let q=f.querySelector(".cw-badge");q&&q.remove()}}function M(){J.innerHTML="";let f=p.querySelector("#cw-bau-widget");f&&f.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=[...Me].sort((h,v)=>{let _=new Date(h.date).getTime()||0;return(new Date(v.date).getTime()||0)-_}),q=O.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(q!==-1){let h=O[q];O.splice(q,1);let v=document.createElement("div");v.id="cw-bau-widget",Object.assign(v.style,i.bauContainer);let _=[],D=(h.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,w="\u{1F4C5}";if(D.forEach(U=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(U)?w="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(U)&&(w="\u{1F1EA}\u{1F1F8}");let te=U.match(m);if(te){let ae=te[0],Z=w;/🇧🇷|🇵🇹|PT|BR/i.test(U)?Z="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(U)&&(Z="\u{1F1EA}\u{1F1F8}"),_.some(oe=>oe.flag===Z&&oe.date===ae)||_.push({flag:Z,date:ae})}}),_.length===0){let U=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);U&&[...new Set(U)].forEach(te=>_.push({flag:"\u{1F4C5}",date:te}))}let E="",G='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&(G=`
              ...
              `),_.length>0?E=`
                  <div style="display:flex; justify-content:space-between; align-items:center;">
                      <div style="flex:1; display:flex; gap:8px;">${_.map(te=>`
          ...
          `,y.after(v);let H=v.querySelector("#cw-bau-toggle-btn"),Q=v.querySelector("#cw-bau-full");if(H&&Q&&(H.onclick=()=>{let U=Q.style.display==="none";Q.style.display=U?"block":"none",H.textContent=U?"Ocultar":"Detalhes"}),window._cwIsAdmin){let U=v.querySelector(".cw-bau-edit");U&&(U.onclick=()=>z(h))}}let N=O.sort((h,v)=>{let _=A.includes(h.id),D=A.includes(v.id);return _===D?0:_?1:-1});if(N.length===0&&!q){let h=document.createElement("div");Object.assign(h.style,i.emptyState),h.innerHTML=`
           ...
           `,J.appendChild(h)}let R=N.filter(h=>!A.includes(h.id)),Y=N.filter(h=>A.includes(h.id));if(R.forEach(h=>J.appendChild(V(h,!1))),Y.length>0){let h=document.createElement("div");Object.assign(h.style,i.historyDivider),h.innerHTML=`<span>Hist\xF3rico (${Y.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let v=document.createElement("div");Object.assign(v.style,i.historyContainer),Y.forEach(D=>v.appendChild(V(D,!0)));let _=!1;h.onclick=()=>{j.playClick(),_=!_,v.style.display=_?"flex":"none",h.querySelector("svg").style.transform=_?"rotate(180deg)":"rotate(0deg)"},J.appendChild(h),J.appendChild(v)}}function V(f,A){let O=document.createElement("div");Object.assign(O.style,A?i.cardHistory:i.card);let q=s[f.type]||s.info,N=document.createElement("div");Object.assign(N.style,i.cardHeader);let R=document.createElement("div");Object.assign(R.style,i.typeTag,{color:q.color,background:q.bg}),R.innerHTML=`${q.icon} <span>${f.type}</span>`;let Y=document.createElement("span");if(Object.assign(Y.style,i.dateTag),Y.textContent=n(f.date),N.appendChild(R),A)N.appendChild(Y);else{let m=document.createElement("button");m.className="cw-btn-interactive",Object.assign(m.style,i.dismissBtn),m.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',m.onmouseenter=()=>{m.style.color="#1e8e3e",m.style.background="#e6f4ea",m.style.borderColor="#1e8e3e"},m.onmouseleave=()=>{m.style.color="#5f6368",m.style.background="#fff",m.style.borderColor="rgba(0,0,0,0.1)"},m.onclick=w=>{w.stopPropagation(),j.playClick(),O.style.transform="translateX(20px)",O.style.opacity="0",setTimeout(()=>{let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");E.push(f.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(E)),M(),T()},200)},N.appendChild(m)}let h=document.createElement("div");Object.assign(h.style,i.cardContent);let v=document.createElement("div");Object.assign(v.style,i.msgTitle),v.textContent=f.title;let _=document.createElement("div");Object.assign(_.style,i.msgBody),_.innerHTML=l(f.text);let D=document.createElement("div");if(Object.assign(D.style,i.msgMeta),D.innerHTML=`Publicado por <b>${f.author||"Sistema"}</b>`,A||(D.innerHTML+=` \u2022 ${n(f.date)}`),h.appendChild(v),h.appendChild(_),h.appendChild(D),O.appendChild(N),O.appendChild(h),window._cwIsAdmin){let m=document.createElement("div");m.className="cw-card-actions";let w=document.createElement("button");w.className="cw-action-btn edit",w.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',w.onclick=()=>z(f);let E=document.createElement("button");E.className="cw-action-btn delete",E.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',E.onclick=()=>K(f.id),m.appendChild(w),m.appendChild(E),O.appendChild(m)}return O}let L=de.getCachedBroadcasts();L.length>0&&(qt(L),M()),setTimeout(u,500),I(),o||(o=setInterval(I,sa));let k=document.createElement("div");Object.assign(k.style,Ae),k.className="no-drag",p.appendChild(k),Te(p,k),document.body.appendChild(p);let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),F=Me.some(f=>!C.includes(f.id));return{toggle:c,hasUnread:F}}function To(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let l=document.createElement("div");Object.assign(l.style,o.dotsContainer);let p=document.createElement("div");Object.assign(p.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let c=document.createElement("button");c.textContent="Pr\xF3ximo",Object.assign(c.style,o.btn,o.btnNext),c.onmouseover=()=>c.style.transform="scale(1.05)",c.onmouseout=()=>c.style.transform="scale(1)",p.appendChild(d),p.appendChild(c),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(l),n.appendChild(p),a.appendChild(n),document.body.appendChild(a);function x(b){let u=t[b];i.textContent=u.icon,s.textContent=u.title,r.textContent=u.text,l.innerHTML="",t.forEach((y,S)=>{let z=document.createElement("div");Object.assign(z.style,o.dot),S===b&&Object.assign(z.style,o.dotActive),l.appendChild(z)}),u.isLast?(d.style.display="none",c.textContent="Come\xE7ar \u{1F680}",c.style.width="100%"):(d.style.display="block",c.textContent="Pr\xF3ximo",c.style.width="auto")}function g(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),j.playSuccess(),X("Tudo pronto! Use o menu flutuante.")}c.onclick=()=>{j.playClick(),e<t.length-1?(e++,x(e)):g()},d.onclick=async()=>{await xe("Pular o tutorial?")&&g()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var ko={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function Fo(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&ra(t)}function ra(t){let e=ko.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let l=document.createElement("div");Object.assign(l.style,a.title);let p=document.createElement("div");Object.assign(p.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let c=document.createElement("button");Object.assign(c.style,a.btn),c.onmouseover=()=>c.style.transform="scale(1.02)",c.onmouseout=()=>c.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(l),i.appendChild(p),i.appendChild(d),i.appendChild(c),n.appendChild(i),document.body.appendChild(n);function x(b){let u=e[b];r.textContent=u.icon,l.textContent=u.title,p.textContent=u.text,d.innerHTML="",e.forEach((y,S)=>{let z=document.createElement("div");Object.assign(z.style,a.dot),S===b&&Object.assign(z.style,a.dotActive),d.appendChild(z)}),b===e.length-1?c.textContent="Entendi, vamos l\xE1! \u{1F44D}":c.textContent="Pr\xF3ximo"}function g(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),j.playSuccess(),X(`TechSol atualizado para ${t}!`)}c.onclick=()=>{j.playClick(),o<e.length-1?(o++,x(o)):g()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Oo="cw_timezone_pinned",_t=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],la=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function Io(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Oo)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},p={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,ge,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=ue(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>A());d.appendChild(x);let g=document.createElement("div");Object.assign(g.style,p.container),d.appendChild(g);let b=document.createElement("div");Object.assign(b.style,p.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,p.tabBtn,p.tabActive);let y=document.createElement("div");y.textContent="Planejador",Object.assign(y.style,p.tabBtn),b.appendChild(u),b.appendChild(y),g.appendChild(b);let S=document.createElement("div");Object.assign(S.style,p.toolbar);let z=document.createElement("div");Object.assign(z.style,p.searchInputWrapper);let B=document.createElement("div");B.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(B.style,p.searchIcon);let $=document.createElement("input");$.placeholder="Buscar cidade ou pa\xEDs...",Object.assign($.style,p.searchInput),$.onfocus=()=>{$.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",$.style.borderColor="rgba(26,115,232,0.3)"},$.onblur=()=>{$.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",$.style.borderColor="transparent"},$.oninput=O=>{i=O.target.value.toLowerCase(),k()},z.appendChild(B),z.appendChild($),S.appendChild(z);let K=document.createElement("div");Object.assign(K.style,p.chipsRow),la.forEach(O=>{let q=document.createElement("div");q.textContent=O.label,q.id=`tz-filter-${O.id}`,Object.assign(q.style,p.chip),O.id===s&&Object.assign(q.style,p.chipActive),q.onclick=()=>{j.playClick(),s=O.id,Array.from(K.children).forEach(N=>{Object.assign(N.style,p.chip)}),Object.assign(q.style,p.chipActive),k()},K.appendChild(q)}),S.appendChild(K),g.appendChild(S);let J=document.createElement("div");Object.assign(J.style,p.listContainer);let I=document.createElement("style");I.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",g.appendChild(I);let T=document.createElement("div");Object.assign(T.style,p.plannerWrapper,{display:"none"}),g.appendChild(J),g.appendChild(T),u.onclick=()=>M("live"),y.onclick=()=>M("plan");function M(O){j.playClick(),O==="live"?(Object.assign(u.style,p.tabActive),Object.assign(y.style,p.tabBtn),y.style.borderBottomColor="transparent",J.style.display="flex",S.style.display="flex",T.style.display="none",F()):(Object.assign(y.style,p.tabActive),Object.assign(u.style,p.tabBtn),u.style.borderBottomColor="transparent",T.style.display="flex",J.style.display="none",S.style.display="none",f(),C())}function V(O){return O>=9&&O<17?{color:l.success,bg:l.successBg,label:"Aberto",icon:"\u{1F7E2}"}:O>=8&&O<9?{color:l.warning,bg:l.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:O>=17&&O<19?{color:l.warning,bg:l.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function L(O){n.includes(O)?n=n.filter(q=>q!==O):n.push(O),localStorage.setItem(Oo,JSON.stringify(n)),k(),j.playClick()}function k(){J.innerHTML="";let O=new Date,q=_t.filter(R=>{let Y=R.name.toLowerCase().includes(i)||R.label.toLowerCase().includes(i),h=s==="all"||R.region===s;return Y&&h});if(q.sort((R,Y)=>{let h=n.includes(R.id),v=n.includes(Y.id);return h&&!v?-1:!h&&v?1:R.name.localeCompare(Y.name)}),q.length===0){J.innerHTML=`
            ...
            `,m.onmouseenter=()=>{m.style.transform="translateY(-2px)",m.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},m.onmouseleave=()=>{m.style.transform="translateY(0)",m.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let G=m.querySelector(".cw-pin-btn");G.onmouseenter=()=>{G.style.backgroundColor="#F1F3F4"},G.onmouseleave=()=>{G.style.backgroundColor="transparent"},G.onclick=H=>{H.stopPropagation(),L(R.id)},m.onclick=()=>{a=R.id,M("plan")},J.appendChild(m)});let N=document.createElement("div");N.style.height="20px",N.style.width="100%",J.appendChild(N)}function C(){T.innerHTML="";let O=document.createElement("div"),q=document.createElement("label");q.textContent="Onde est\xE1 o cliente?",q.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let N=document.createElement("select");Object.assign(N.style,jt),N.style.padding="14px",[..._t].sort((ie,oe)=>ie.name.localeCompare(oe.name)).forEach(ie=>{let oe=document.createElement("option");oe.value=ie.id,oe.textContent=`${ie.flag} ${ie.name} (${ie.zone})`,ie.id===a&&(oe.selected=!0),N.appendChild(oe)}),N.onchange=ie=>{a=ie.target.value,Z(),j.playClick()},O.appendChild(q),O.appendChild(N),T.appendChild(O);let Y=document.createElement("div");Object.assign(Y.style,p.timeComparisonRow);let h=document.createElement("div");Object.assign(h.style,p.timeCard),h.style.backgroundColor="#F8FAFF",h.style.borderColor="#E8F0FE",h.innerHTML=`
        ...
        `,Y.appendChild(h),Y.appendChild(v),T.appendChild(Y);let _=document.createElement("div");_.id="cw-planner-status",Object.assign(_.style,p.statusBadge),T.appendChild(_);let D=document.createElement("div");Object.assign(D.style,{padding:"0 4px",marginTop:"12px"});let m=document.createElement("div");m.textContent="Arraste para simular o hor\xE1rio:",m.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let w=document.createElement("div");Object.assign(w.style,p.timelineContainer);let E=document.createElement("div");Object.assign(E.style,p.timelineTrack);let G=document.createElement("div");Object.assign(G.style,p.dayZone),E.appendChild(G);let H=document.createElement("input");H.type="range",H.min="0",H.max="1439",H.step="15",H.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let Q=document.createElement("div");Q.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",Q.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",w.appendChild(E),w.appendChild(H),w.appendChild(Q),D.appendChild(m),D.appendChild(w),T.appendChild(D);let U=h.querySelector("#cw-time-input-br"),te=v.querySelector("#cw-time-display-client"),ae=v.querySelector("#cw-client-label");function Z(){let ie=_t.find(Ne=>Ne.id===a);ae.textContent=`${ie.flag} ${ie.label} (${ie.zone})`;let oe=r.getHours(),le=r.getMinutes(),We=`${String(oe).padStart(2,"0")}:${String(le).padStart(2,"0")}`;U.value=We,H.value=oe*60+le;let tt=r.toLocaleTimeString("pt-BR",{timeZone:ie.zone,hour:"2-digit",minute:"2-digit"});te.textContent=tt;let _e=parseInt(tt.split(":")[0]);_e>=9&&_e<17?(_.style.background=l.successBg,_.style.color=l.success,_.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):_e>=8&&_e<9||_e>=17&&_e<19?(_.style.background=l.warningBg,_.style.color=l.warning,_.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(_.style.background=l.errorBg,_.style.color=l.error,_.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}H.oninput=ie=>{let oe=parseInt(ie.target.value);r.setHours(Math.floor(oe/60)),r.setMinutes(oe%60),Z()},U.oninput=ie=>{let[oe,le]=ie.target.value.split(":");oe&&le&&(r.setHours(parseInt(oe)),r.setMinutes(parseInt(le)),Z())},Z()}function F(){k(),o||(o=setInterval(k,6e4))}function f(){o&&(clearInterval(o),o=null)}function A(){e=!e,me(e,d,"cw-btn-timezone"),e?M("live"):f()}return document.body.appendChild(d),A}function Lo(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let C=document.createElement("style");C.id="cw-lib-styles",C.innerHTML=`
        ...
        `,document.head.appendChild(C)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},s={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,ge,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let p=ue(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>k());r.appendChild(p);let d=document.createElement("div");Object.assign(d.style,s.container),r.appendChild(d);let c=document.createElement("div");Object.assign(c.style,s.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(C=>{let F=document.createElement("div");F.innerHTML=`${C.icon} ${C.label}`,F.id=`lib-tab-${C.id}`,Object.assign(F.style,s.tabBtn),C.id===o&&Object.assign(F.style,s.tabActive),F.onmouseenter=()=>j.playHover(),F.onclick=()=>K(C.id),c.appendChild(F)}),d.appendChild(c);let g=document.createElement("div");Object.assign(g.style,s.listContainer),d.appendChild(g);let b=document.createElement("div");b.className="cw-fab cw-tactile",Object.assign(b.style,s.fab),b.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',b.onmouseenter=()=>b.style.transform="scale(1.1)",b.onmouseleave=()=>b.style.transform="scale(1)",b.onclick=()=>I(),d.appendChild(b),a=document.createElement("div"),Object.assign(a.style,s.editorOverlay);let u=document.createElement("div");Object.assign(u.style,s.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let y=document.createElement("button");y.innerHTML="Cancelar",y.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",y.onclick=T,u.appendChild(y),a.appendChild(u);let S=document.createElement("div");Object.assign(S.style,s.editorBody),a.appendChild(S);let z=document.createElement("div");z.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let B=document.createElement("button");B.textContent="Salvar",B.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",B.onclick=M,z.appendChild(B),a.appendChild(z),d.appendChild(a);let $=document.createElement("div");Object.assign($.style,Ae),$.className="no-drag",r.appendChild($),Te(r,$),document.body.appendChild(r);function K(C){j.playClick(),o=C,x.forEach(F=>{let f=document.getElementById(`lib-tab-${F.id}`);F.id===C?Object.assign(f.style,s.tabActive):Object.assign(f.style,s.tabBtn)}),J()}function J(){g.innerHTML="";let C=he.getSnippets(o);if(C.length===0){g.innerHTML=`
            ...
            `;return}C.forEach(F=>{let f=document.createElement("div");f.className="cw-lib-card",Object.assign(f.style,s.card),F.isCode&&(f.style.borderLeft=`4px solid ${i.primary}`,f.style.background="rgba(0, 122, 255, 0.02)");let A=F.content;if(F.isRich){let O=document.createElement("div");O.innerHTML=F.content;let q=O.querySelector("img");A=O.innerText.substring(0,150)+(O.innerText.length>150?"...":""),q&&(A="\u{1F5BC}\uFE0F [Cont\xE9m Imagens] "+A)}f.innerHTML=`
                <div style="${L(s.cardHeader)}">
                    <div style="${L(s.cardTitle)}">${F.title}</div>
                ...
                <div style="${L(s.cardPreview)}; ${F.isCode?"font-family:'Roboto Mono', monospace; font-size:11px;":""}">${A}</div>
            ...
            `,f.onmouseenter=()=>{j.playHover()},f.querySelector(".cw-act-copy").onclick=O=>{if(O.stopPropagation(),j.playClick(),F.isRich){let q=new Blob([F.content],{type:"text/html"}),N=document.createElement("div");N.style.whiteSpace="pre-wrap",N.innerHTML=F.content;let R=new Blob([N.innerText],{type:"text/plain"}),Y=[new ClipboardItem({"text/html":q,"text/plain":R})];navigator.clipboard.write(Y)}else navigator.clipboard.writeText(F.content);X("Copiado!")},f.querySelector(".cw-act-edit").onclick=O=>{O.stopPropagation(),j.playClick(),I(F)},f.querySelector(".cw-act-del").onclick=async O=>{O.stopPropagation(),j.playClick(),await xe("Excluir este item?")&&(he.delete(F.id),J(),X("Item exclu\xEDdo."))},g.appendChild(f)})}function I(C=null){n=C?C.id:null,S.innerHTML="",S.appendChild(V("title","T\xEDtulo / Nome",C?C.title:"")),o==="email"&&S.appendChild(V("subject","Assunto do Email",C?C.subject:""));let F="Conte\xFAdo";o==="email"&&(F="Corpo do Email (HTML)"),o==="note"&&(F="Texto da Nota (Reason)"),S.appendChild(V("content",F,C?C.content:"",{isRich:!0,isCode:C?C.isCode:!1})),u.querySelector("span").textContent=C?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let f=S.querySelector("input");f&&f.focus()},300)}function T(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function M(){let C=S.querySelector("#cw-inp-title"),F=S.querySelector("#cw-inp-content"),f=C.value.trim(),A=F.contentEditable==="true"?F.innerHTML:F.value.trim(),O=F.getAttribute("data-is-code")==="true";if(!f||!A||A==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let q={id:n,type:o,title:f,content:A,isCode:O,isRich:F.contentEditable==="true"};if(o==="email"){let N=S.querySelector("#cw-inp-subject").value.trim();if(!N){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}q.subject=N}B.textContent="Salvando...",await he.save(q),B.textContent="Salvar",T(),J(),X("Salvo com sucesso!"),j.playSuccess()}function V(C,F,f,A={}){let O=document.createElement("div");Object.assign(O.style,s.inputGroup);let q=document.createElement("label");q.textContent=F,Object.assign(q.style,s.label);let N;if(A.isRich){let R=document.createElement("div");R.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",R.innerHTML=`
            ...
            `,N=document.createElement("div"),N.contentEditable="true",Object.assign(N.style,s.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),N.innerHTML=f||"",A.isCode&&(N.style.fontFamily="'Roboto Mono', monospace",N.style.backgroundColor="#F8F9FA",N.setAttribute("data-is-code","true")),R.querySelectorAll(".cw-toolbar-btn").forEach(Y=>{Y.onmouseenter=()=>j.playHover(),Y.onmousedown=()=>j.playClick()}),R.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),N.focus()},R.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),N.focus()},R.querySelector(".cw-tb-code").onclick=Y=>{let v=!(N.getAttribute("data-is-code")==="true");N.setAttribute("data-is-code",v),N.style.fontFamily=v?"'Roboto Mono', monospace":"inherit",N.style.backgroundColor=v?"rgba(0, 122, 255, 0.03)":i.surface,v?Y.currentTarget.classList.add("active"):Y.currentTarget.classList.remove("active"),N.focus()},R.querySelector(".cw-tb-img").onclick=async()=>{let Y=await Xt("Cole a URL da imagem:");Y&&(document.execCommand("insertImage",!1,Y),N.querySelectorAll("img").forEach(v=>{v.style.maxWidth="100%",v.style.borderRadius="8px"}))},N.onpaste=Y=>{let h=(Y.clipboardData||Y.originalEvent.clipboardData).items;for(let v of h)if(v.kind==="file"&&v.type.startsWith("image/")){Y.preventDefault();let _=v.getAsFile(),D=new FileReader;D.onload=m=>{let w=`<img src="${m.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,w)},D.readAsDataURL(_)}},O.appendChild(q),O.appendChild(R)}else N=document.createElement("input"),N.type="text",Object.assign(N.style,s.input),N.value=f||"",O.appendChild(q);return N.id=`cw-inp-${C}`,N.onfocus=()=>{N.style.borderColor=i.primary,N.style.boxShadow=`0 0 0 2px ${i.primaryBg}`},N.onblur=()=>{N.style.borderColor=i.border,N.style.boxShadow="none"},O.appendChild(N),O}function L(C){return Object.entries(C).map(([F,f])=>`${F.replace(/[A-Z]/g,A=>"-"+A.toLowerCase())}:${f}`).join(";")}function k(){e=!e,me(e,r,"cw-btn-library"),e&&J()}return k}function qo(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let x=document.createElement("style");x.id=a,x.innerHTML=`
    ...
    `;let p=l.querySelector("#cw-config-sound-toggle");p.onchange=x=>{j.setMuted(!x.target.checked),x.target.checked&&j.playClick()},r.appendChild(l);let d=document.createElement("div");d.className="cw-configs-section",d.innerHTML=`
    ...
    `,r.appendChild(d);function c(){e=!e,me(e,n,"cw-btn-configs"),e&&j.playClick()}return document.body.appendChild(n),c}var ee={blue:"#1A73E8",red:"#D93025",yellow:"#F9AB00",green:"#1E8E3E",blueLight:"#E8F0FE",redLight:"#FCE8E6",yellowLight:"#FEF7E0",greenLight:"#E6F4EA",textPrimary:"#202124",textSecondary:"#5F6368",border:"#DADCE0",surface:"rgba(255, 255, 255, 0.8)",white:"#FFFFFF"},Oe={small:"8px",medium:"12px",large:"16px",pill:"100px"},_o={deep:"0 12px 40px rgba(0,0,0,0.12)",subtle:"0 4px 12px rgba(0,0,0,0.05)"},Mt="cubic-bezier(0.4, 0, 0.2, 1)",et=`all 0.3s ${Mt}`,Mo=()=>{if(document.getElementById("bau-form-global-styles"))return;let t=document.createElement("style");t.id="bau-form-global-styles",t.innerHTML=`
    ...
    .bau-step { display: none; animation: fadeIn 0.4s ${Mt}; }
  ...
  `,document.head.appendChild(t)};function No(){Mo();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=ue(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>h());i.appendChild(s);let r=document.createElement("div");r.className="bau-view-container",i.appendChild(r);let l=document.createElement("div");l.id="bau-view-dashboard",l.className="bau-view active",l.innerHTML=`
    ...
    `,u.appendChild(y),g.appendChild(u);let S=document.createElement("div");S.className="bau-step",S.id="bau-step-2";let z=document.createElement("div");z.className="bau-card",z.innerHTML=`
        ...
        <div class="bau-tasks-grid" id="bau-tasks-container">
            ${["Setup GTM","Google Ads Conversion","GA4 Events","Enhanced Conversions","Offline Conversions","Consent Mode","Troubleshooting","Outros"].map(v=>`
                <label class="bau-task-item">
                    <input type="checkbox" name="taskType" value="${v}">
                    <span>${v}</span>
                </label>
            `).join("")}
        </div>
    `,z.querySelectorAll(".bau-task-item").forEach(v=>{let _=v.querySelector("input");v.addEventListener("click",()=>{_.checked=!_.checked,v.classList.toggle("active",_.checked),j.playClick()})}),S.appendChild(z),g.appendChild(S);let B=document.createElement("div");B.className="bau-step",B.id="bau-step-3";let $=document.createElement("div");$.className="bau-card",$.innerHTML=`
        ...
        <select name="nonImplementationReason" required class="bau-select">
            ...
            ${["Tempo da consultoria esgotado","Solicita\xE7\xE3o de reagendamento pelo anunciante","Falta de acessos ou backup do site","Anunciante indispon\xEDvel ou n\xE3o preparado","Implementa\xE7\xE3o parcial (nem todas as tasks conclu\xEDdas)","Solicita\xE7\xE3o de tarefas (tasks) adicionais","Necessidade de novas altera\xE7\xF5es (fase de acompanhamento)","Retorno de contato ap\xF3s prazo de 14 dias expirado"].map(v=>`<option value="${v}">${v}</option>`).join("")}
        </select>
    ...
    `,B.appendChild($),g.appendChild(B);let K=document.createElement("div");K.className="bau-step",K.id="bau-step-4",K.innerHTML=`
        <div class="bau-card">
    ...
    `,g.appendChild(K);let J=document.createElement("div");J.className="bau-footer";let I=document.createElement("button");I.type="button",I.id="bau-step-back-btn",I.className="bau-btn-secondary",I.textContent="Voltar",J.appendChild(I);let T=document.createElement("button");T.type="button",T.id="bau-step-next-btn",T.className="bau-btn-primary",T.textContent="Pr\xF3ximo",J.appendChild(T);let M=document.createElement("button");M.type="submit",M.className="bau-btn-submit",M.setAttribute("form","bau-escalation-form"),M.innerHTML='<span class="material-icons">send</span> Enviar para o TL',M.style.display="none",J.appendChild(M),c.appendChild(J),r.appendChild(p);let V=document.createElement("div");V.id="bau-view-success",V.className="bau-view",V.innerHTML=`
    ...
    `,r.appendChild(V),document.body.appendChild(i);function L(v){e=v,i.querySelectorAll(".bau-view").forEach(w=>w.classList.remove("active"));let _=i.querySelector(`#bau-view-${v}`);_&&_.classList.add("active");let D=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),m=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");D&&(D.textContent=v==="form"?"Novo Caso BAU":"BAU Central"),m&&(m.textContent=v==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function k(){let v=i.querySelector("#bau-case-list-container");if(v){v.innerHTML="<p>Carregando casos...</p>";try{let _=await so();C(_)}catch{v.innerHTML='<p style="color: red;">Erro ao carregar casos.</p>'}}}function C(v){let _=i.querySelector("#bau-case-list-container");if(_){if(!v||v.length===0){_.innerHTML="<p>Nenhum caso BAU encontrado.</p>";return}_.innerHTML=v.map(D=>`
            <li class="bau-case-card" data-case-id="${D.id}">
                <div class="bau-case-info">
                    <h3 class="bau-case-title">${D.advName||"Nome indefinido"}</h3>
                    <p class="bau-case-details">CID: ${D.cid||"N/A"} \u2022 Motivo: ${D.reason||"N/A"}</p>
                </div>
                <span class="bau-case-status-badge" data-status="${D.status||"Pendente"}">${D.status||"Pendente"}</span>
            </li>
        `).join("")}}function F(){g.querySelectorAll(".bau-step").forEach((v,_)=>{v.classList.toggle("active",_+1===a)}),x.innerHTML="";for(let v=1;v<=n;v++){let _=document.createElement("div");_.className=`bau-progress-step ${v===a?"active":v<a?"completed":""}`,_.textContent=v,x.appendChild(_)}I.style.display=a>1?"inline-block":"none",T.style.display=a<n?"inline-block":"none",M.style.display=a===n?"inline-block":"none",a===4&&O()}function f(v){let _=i.querySelector(`#bau-step-${v}`);if(!_)return!0;if(v===2)return g.querySelector('select[name="reason"]').value?g.querySelector('input[name="taskType"]:checked')?!0:(X("Erro: Selecione pelo menos uma Task.",{error:!0}),!1):(X("Erro: O Motivo da Abertura \xE9 obrigat\xF3rio.",{error:!0}),!1);for(let D of _.querySelectorAll("[required]"))if(!D.value.trim())return X(`Erro: O campo '${D.name||D.placeholder}' \xE9 obrigat\xF3rio.`,{error:!0}),!1;return!0}T.onclick=()=>{f(a)&&(a++,F(),j.playClick())},I.onclick=()=>{a>1&&(a--,F(),j.playClick())};async function A(){let v=await Se()||{};o=v,g.querySelector('[name="advName"]').value=v.advName||"",g.querySelector('[name="cid"]').value=v.cid||"",g.querySelector('[name="amName"]').value=v.amName||"",g.querySelector('[name="seId"]').value=v.seId||""}i.querySelector("#bau-top-se-search").onclick=v=>{v.preventDefault(),lt("bau-context-se-id-input")};function O(){let v=new FormData(g),_=Object.fromEntries(v.entries()),D=v.getAll("taskType"),m=i.querySelector("#bau-confirmation-details");m&&(m.innerHTML=`
            <div class="bau-confirm-row"><span class="bau-confirm-label">Anunciante:</span><span class="bau-confirm-value">${_.advName}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">CID:</span><span class="bau-confirm-value">${_.cid}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Motivo:</span><span class="bau-confirm-value">${_.reason}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Tasks:</span><span class="bau-confirm-value">${D.join(", ")}</span></div>
        `)}g.onsubmit=async v=>{if(v.preventDefault(),!f(n))return;M.disabled=!0,M.innerHTML="Enviando...";let _=new FormData(g),D=Object.fromEntries(_.entries()),m=_.getAll("taskType"),w={...D,taskType:m.join(", "),...o};try{await io(w,o.agentEmail||"anon"),j.playSuccess(),L("success")}catch(E){X("Falha ao enviar: "+(E.message||"Erro desconhecido"),"error")}finally{M.disabled=!1,M.innerHTML='<span class="material-icons">send</span> Enviar para o TL'}};function q(){g.reset(),a=1,F(),z.querySelectorAll(".bau-task-item.active").forEach(v=>v.classList.remove("active"))}let N=i.querySelector("#bau-new-case-btn");N&&(N.onclick=()=>{q(),L("form"),A()});let R=i.querySelector("#bau-form-back-btn");R&&(R.onclick=()=>L("dashboard"));let Y=i.querySelector("#bau-success-back-btn");Y&&(Y.onclick=()=>L("dashboard"));async function h(){t=!t,i.style.display=t?"flex":"none",t&&(L("dashboard"),k()),me(t,i,"cw-btn-bauform")}return F(),h}function ca(){if(window.techSolInitialized){Ct();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Pt();try{j.initGlobalListeners(),j.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}de.fetchTips(),Ct();let e=fo(),o=vo(),a=So(),n=Eo(),i=Io(),s=Lo(),r=qo(),l=No(),p=Ao();ro({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:l,broadcastControl:p}),setTimeout(()=>{de.logEvent("App","Start","Session Start"),To(),setTimeout(()=>{Fo(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}ca();})();
