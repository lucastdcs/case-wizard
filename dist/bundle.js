...
/* --- SCREENSHOTS: FINE & ELEGANT (Step 3) --- */
    ...
    `;let x=p.querySelector(".cw-hero-grid"),g=p.querySelector(".cw-acc-container"),f=p.querySelector(".cw-results-container"),u=p.querySelector(".cw-search-input"),y=p.querySelector(".cw-status-bar"),S=p.querySelector(".cw-status-text"),z=p.querySelector(".cw-footer-icons");s.forEach(([I,T])=>{let N=i(T.name),V=document.createElement("div");V.className="cw-hero-card",V.id=`hero-${I}`,V.style.setProperty("--hero-color",N.color),V.innerHTML=`
        ...
        `,V.onclick=q=>{if(q.target.closest(".cw-step-btn"))return;let k=a[I]?a[I].count:0;P(I,k>0?-k:1,T)},V.querySelector(".minus").onclick=()=>P(I,-1,T),V.querySelector(".plus").onclick=()=>P(I,1,T),V.dataset.color=N.color,x.appendChild(V)});function B(I,T){let N=i(T.name),V=document.createElement("div");return V.className="cw-task-item",V.dataset.id=I,V.innerHTML=`
...
`.replace(/\n/g,"<br>");Je(I);let T=await ut();T?(T.innerText.trim()===""&&(T.innerHTML=""),document.execCommand("insertHTML",!1,I),pt(T),X("Nota gerada e inserida!")):X("Copiado! Abra uma nota para colar.")},e}var fe=t=>new Promise(e=>setTimeout(e,t));function he(t,e="info"){let o={info:"background: #e8f0fe; color: #1a73e8; padding: 2px 5px; border-radius: 3px;",warn:"background: #fef7e0; color: #b06000; padding: 2px 5px; border-radius: 3px;",error:"background: #fce8e6; color: #c5221f; padding: 2px 5px; border-radius: 3px;",success:"background: #e6f4ea; color: #137333; padding: 2px 5px; border-radius: 3px;"};console.log(`%c[EMAIL-BOT] ${t}`,o[e]||o.info)}function ke(t){if(!t)return;let e={bubbles:!0,cancelable:!0,view:window};["mouseover","mousedown","mouseup","click"].forEach(o=>t.dispatchEvent(new MouseEvent(o,e)))}function mt(t,e){if(!t)return;let o=`cw-warning-${t.id||Math.random().toString(36).substr(2,9)}`,a=document.getElementById(o);a&&a.remove();let n=t.getBoundingClientRect(),i=document.createElement("div");i.id=o,i.style.cssText=`
    ...
    `,document.head.appendChild(t)}function ue(t,e,o){let a=document.getElementById(o);if(!e)return;let n=e.getAttribute("data-moved")==="true",i={x:0,y:0};if(a){let d=a.getBoundingClientRect();i.x=d.left+d.width/2,i.y=d.top+d.height/2}let s,r;if(!n)s=window.innerWidth/2,r=window.innerHeight/2;else{let d=e.getBoundingClientRect();s=d.left+d.width/2,r=d.top+d.height/2,s===0&&r===0&&(s=window.innerWidth/2,r=window.innerHeight/2)}let l=i.x-s,p=i.y-r;t?(G.playGenieOpen(),e.style.transition="none",e.style.opacity="0",e.style.pointerEvents="auto",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.05)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.05)`,e.offsetWidth,requestAnimationFrame(()=>{e.classList.add("open"),a&&a.classList.add("active"),e.style.transition="opacity 0.4s ease-out, transform 0.5s cubic-bezier(0.19, 1, 0.22, 1)",e.style.opacity="1",n?e.style.transform="translate(0, 0) scale(1)":e.style.transform="translate(-50%, -50%) scale(1)"}),typeof po=="function"&&po(e,o)):(G.playSwoosh(),e.style.transition="opacity 0.25s ease, transform 0.3s cubic-bezier(0.5, 0, 1, 1)",e.style.pointerEvents="none",requestAnimationFrame(()=>{e.style.opacity="0",n?e.style.transform=`translate(${l}px, ${p}px) scale(0.1)`:e.style.transform=`translate(calc(-50% + ${l}px), calc(-50% + ${p}px)) scale(0.1)`}),setTimeout(()=>{e.classList.remove("open"),a&&a.classList.remove("active"),e.style.transition="",e.style.transform=""},300),typeof kt=="function"&&kt(e))}function po(t,e){kt(t);let o=a=>{if(!t.classList.contains("open"))return;let n=t.contains(a.target),i=document.querySelector(".cw-pill"),s=i&&i.contains(a.target);n?(t.classList.remove("idle"),t.style.zIndex="2147483648"):s||(t.classList.add("idle"),t.style.zIndex="2147483646")};t._idleHandler=o,document.addEventListener("mousedown",o)}function kt(t){t._idleHandler&&(document.removeEventListener("mousedown",t._idleHandler),t._idleHandler=null)}function uo(){let t="v4.0.0",{popup:e,content:o,header:a,animRefs:n,credit:i}=Wt(t,K),s=Qt(h),r=Zt(()=>{k(),W.setActiveTasks(r.getCheckedElements())},h,W),l=document.createElement("div");l.style.display="none";let p=Kt((m,v)=>{E(m,v)});l.appendChild(p);let d=no({onSaveCurrent:async()=>{let m=await D();return L(),m},onLoadDraft:m=>{Y(m)},t:m=>h(m)}),c=T(),x=N(),g=document.createElement("div"),f=_(),u=F(d,h);o.appendChild(c),o.appendChild(x),o.appendChild(f),o.appendChild(l),o.appendChild(g),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none";let y=document.createElement("button");y.id="manual-task-toggle",y.textContent=h("gostaria_de_adicionar_uma_task")||"Gostaria de adicionar uma task",y.style.cssText=`display: none; width: 100%; padding: 14px; border: 2px dashed ${H.primary}; background: ${H.surface}; color: ${H.primary}; border-radius: ${de.medium}; cursor: pointer; font-size: 13px; font-weight: 700; margin-top: 8px; transition: all 0.2s ${se}; text-transform: uppercase; letter-spacing: 0.5px;`,y.onmouseenter=()=>{y.style.background=H.primaryBg},y.onmouseleave=()=>{y.style.background=H.surface},y.onclick=()=>{r.selectionElement.style.display="block",r.screenshotsElement.style.display="block",y.style.display="none"},o.appendChild(y),o.appendChild(r.selectionElement),o.appendChild(s.element),o.appendChild(r.screenshotsElement),o.appendChild(u);let S=document.createElement("div");S.style.display="none",S.style.flexGrow="1",S.style.minHeight="0",S.style.overflow="hidden";let z=ro(()=>I());z.style.height="100%",S.appendChild(z),e.insertBefore(S,i);let B=a.lastElementChild;B&&(B.insertBefore(d.historyBtnWrapper,B.firstChild),B.insertBefore(w(),B.firstChild)),e.appendChild(d.drawer);let P=null;W.subscribe(m=>{M(m),J(),m.isDirty?(P&&clearTimeout(P),P=setTimeout(async()=>{let v=await D(!0);v.subStatus?ge.saveEmergency(v):ge.clearEmergency(),m.isDirty=!1},2e3)):P&&(clearTimeout(P),P=null)});function J(){let m=ge.getCount()>0,v=!!W.currentSubStatus;ct(m||v)}function K(){W.visible=!W.visible,ue(W.visible,e,"cw-btn-notes")}function I(){W.isSplitView=!W.isSplitView,W.isSplitView?(o.style.display="none",S.style.display="flex",S.style.flexDirection="column",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #8e24aa, #7b1fa2)")):(o.style.display="flex",S.style.display="none",n.googleLine&&(n.googleLine.style.background="linear-gradient(to right, #4285F4, #EA4335, #FBBC05, #34A853)"))}function T(){let m=document.createElement("div");if(m.innerHTML=`
        ...
        `,!document.getElementById("cw-segmented-styles")){let C=document.createElement("style");C.id="cw-segmented-styles",C.innerHTML=`
            ...
            `,document.head.appendChild(C)}let v=(C,$)=>{let Z=m.querySelector(`#${C}`).querySelector(".cw-segmented-indicator");Z&&(Z.style.transform=`translateX(${$*100}%) translateX(${$*2}px)`)};return m.querySelectorAll("#lang-selector button").forEach((C,$)=>{C.onclick=()=>{W.setLanguage(C.dataset.lang),m.querySelectorAll("#lang-selector button").forEach(j=>j.classList.remove("active")),C.classList.add("active"),v("lang-selector",$),G.playHover(),W.currentSubStatus&&q(W.currentSubStatus)}}),m.querySelectorAll("#type-selector button").forEach((C,$)=>{C.onclick=()=>{W.setCaseType(C.dataset.type),m.querySelectorAll("#type-selector button").forEach(j=>j.classList.remove("active")),C.classList.add("active"),v("type-selector",$),G.playHover(),W.currentSubStatus&&q(W.currentSubStatus)}}),m.querySelectorAll("#portugal-selector button").forEach((C,$)=>{C.onclick=()=>{W.setPortugalCase(C.dataset.val==="true"),m.querySelectorAll("#portugal-selector button").forEach(j=>j.classList.remove("active")),C.classList.add("active"),v("portugal-selector",$),G.playHover(),W.currentSubStatus&&q(W.currentSubStatus)}}),m}function N(){let m=document.createElement("div");m.className="cw-status-section",m.style.cssText="display: flex; flex-direction: column; gap: 8px;",m.innerHTML=`
        ...
        `;let v=m.querySelector("#main-status-select"),C=m.querySelector("#sub-status-select");return v.onchange=()=>{W.setStatus(v.value),V(v.value,C),W.setSubStatus(""),q("")},C.onchange=()=>{W.setSubStatus(C.value),q(C.value)},m}function V(m,v){if(v.innerHTML=`<option value="">${h("select_substatus")}</option>`,!m){v.disabled=!0;return}for(let C in Te)if(Te[C].status===m){let $=document.createElement("option");$.value=C,$.textContent=Te[C].name,v.appendChild($)}v.disabled=!1}function q(m){if(p.render&&p.render(m,W.currentCaseType),!m){l.style.display="none",g.style.display="none",document.getElementById("manual-task-toggle").style.display="none",r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",f.style.display="flex",f.style.opacity="1",u.style.display="none";return}f.style.opacity="0",setTimeout(()=>{W.currentSubStatus&&(f.style.display="none")},400),u.style.display="grid";let v=Te[m];v&&v.templateFields&&W.setActiveFields(v.templateFields),O(),St(m,g,W),g.style.display="block",l.style.display="block";let C=m.startsWith("SO_"),$=m==="NI_Awaiting_Validation",j=document.getElementById("manual-task-toggle");C||$?(r.selectionElement.style.display="block",j.style.display="none"):(r.selectionElement.style.display="none",r.screenshotsElement.style.display="none",j.style.display="block");let Z=m==="SO_Education_Only"?"education":"implementation";W.setScreenshotMode(Z),W.currentCaseType==="lm"?W.toggleFieldExclusion("field-ON_CALL",!0):W.toggleFieldExclusion("field-ON_CALL",!1),r.updateSubStatus(m),k();let U=document.getElementById("email-automation-toggle-row");U&&(U.style.display=Pe[m]?"flex":"none")}function k(){let m=r.getCheckedElements().map(v=>v.value);s.updateVisibility(W.currentSubStatus,m)}function E(m,v){let C=nt[m];if(C){for(let $ in C)if($==="linkedTask")r.toggleTask(C.linkedTask,v);else if($==="activeTasks")C.activeTasks.forEach(j=>{v?r.setTaskCount(j.value,j.count):r.setTaskCount(j.value,0)});else if($.startsWith("field-")){let j=$,Z=C[$],U=document.getElementById(j);if(U){let ee=He.includes(j.replace("field-",""));if(v)if(ee){let oe=U.value.trim();oe.includes(Z.trim())||(U.value=oe?oe+`
`+Z.trim():Z.trim())}else U.value=Z;else if(ee){let oe=U.value.trim(),Q=Z.trim();oe.includes(Q)&&(U.value=oe.replace(Q,"").trim().replace(/\n{3,}/g,`

`))}else U.value.trim()===Z.trim()&&(U.value="");W.updateField(j,U.value),U.dispatchEvent(new Event("input"))}}}}function F(m,v){let C=document.createElement("div");if(C.className="cw-actions-section",C.style.cssText=`
            display: grid;
        ...
        `;let j=m.parkButton;j.classList.add("js-btn-park"),j.style.cssText="width: 100%; margin: 0; border-radius: 10px; height: 34px; font-weight: 600; font-size: 11.5px;";let Z=document.createElement("button");Z.className="cw-btn-secondary js-btn-reset",Z.textContent=v("limpar"),Z.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.textSub}; border: 1px solid ${H.border}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,Z.onclick=()=>L();let U=document.createElement("button");U.className="cw-btn-secondary js-btn-copy",U.textContent=v("copiar"),U.style.cssText=`width: 100%; height: 34px; background: ${H.surface}; color: ${H.primary}; border: 1px solid ${H.primary}; border-radius: 10px; font-weight: 600; cursor: pointer; font-size: 11.5px;`,U.onclick=()=>b();let ee=document.createElement("button");return ee.className="cw-btn-primary js-btn-generate",ee.textContent=v("preencher"),ee.style.cssText=`width: 100%; height: 38px; background: ${H.primary}; color: #fff; border: none; border-radius: 10px; font-weight: 600; cursor: pointer; grid-column: span 2; font-size: 12.5px; box-shadow: 0 4px 10px rgba(26, 115, 232, 0.2); margin-top: 0px;`,ee.onclick=()=>A(),C.appendChild($),C.appendChild(j),C.appendChild(Z),C.appendChild(U),C.appendChild(ee),C}async function b(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Ct(W,r,s);m?(Je(m),X(h("copiado_sucesso")),G.playClick()):X(h("select_substatus"),{error:!0})}async function A(){if(!W.currentSubStatus){X(h("select_substatus"),{error:!0});return}let m=Ct(W,r,s);Je(m),K();let v=Xe(),C=await ut();if(C){C.focus(),document.execCommand("insertHTML",!1,m),pt(C);let $=document.getElementById("email-automation-checkbox");(!$||$.checked)&&W.currentSubStatus&&Pe[W.currentSubStatus]&&await ft(Pe[W.currentSubStatus]),X(h("inserido_copiado")),G.playSuccess(),L()}v()}function O(){if(W.currentSubStatus){if(W.currentCaseType==="lm")W.removeField("ON_CALL");else{let m=Te[W.currentSubStatus];m&&m.templateFields.includes("ON_CALL")&&W.addFieldAt("ON_CALL",1)}W.isPortugalCase?(W.addFieldAt("CASO_PORTUGAL",1),W.addFieldAt("CONSENTIU_GRAVACAO",2)):(W.removeField("CASO_PORTUGAL"),W.removeField("CONSENTIU_GRAVACAO"))}}function L(){W.reset(),r.reset(),s.reset(),J(),ge.clearEmergency(),o.querySelectorAll("select").forEach(v=>v.value=""),o.querySelector("#sub-status-select").disabled=!0;let m=document.getElementById("email-automation-toggle-row");m&&(m.style.display="none"),g.innerHTML="",l.style.display="none",f.style.display="flex",f.style.opacity="1",u.style.display="none",document.getElementById("manual-task-toggle")&&(document.getElementById("manual-task-toggle").style.display="none"),r.selectionElement.style.display="none",r.screenshotsElement.style.display="none"}async function D(m=!1){let v={};g.querySelectorAll("input, textarea, select").forEach(U=>{(U.id.startsWith("field-")||U.id==="consent-select")&&(v[U.id]=U.value)});let C="Cliente",$="---";if(!m)try{let U=await we();C=U.advertiserName,$=U.cid}catch(U){console.warn("Erro ao coletar pageData:",U)}let j=r.getCheckedElements().map(U=>({key:U.value,count:U.count})),Z=j.map(U=>{let ee=Ce[U.key];return ee?ee.name:U.key});return{currentCaseType:W.currentCaseType,currentLang:W.currentLang,isPortugalCase:W.isPortugalCase,consent:W.consent,tagSupportUsed:W.tagSupportUsed,forcedScreenshots:[...W.forcedScreenshots],excludedFields:[...W.excludedFields],activeFields:W.activeFields,status:W.currentStatus,subStatus:W.currentSubStatus,formData:v,activeTasks:j,summaryTags:Z,clientName:C,cid:$,timestamp:new Date().toISOString()}}let R=m=>new Promise(v=>setTimeout(v,m));async function Y(m){W.setLanguage(m.currentLang||"pt"),W.setCaseType(m.currentCaseType||"bau"),W.setPortugalCase(m.isPortugalCase||!1),W.setConsent(m.consent||!1),W.setExcludedFields(m.excludedFields||[]),m.activeFields&&W.setActiveFields(m.activeFields);let v=o.querySelector(`#lang-selector button[data-lang="${W.currentLang}"]`);v&&v.classList.add("active"),o.querySelectorAll("#lang-selector button").forEach(j=>{j!==v&&j.classList.remove("active")});let C=o.querySelector(`#type-selector button[data-type="${W.currentCaseType}"]`);C&&C.classList.add("active"),o.querySelectorAll("#type-selector button").forEach(j=>{j!==C&&j.classList.remove("active")});let $=o.querySelector(`#portugal-selector button[data-val="${W.isPortugalCase}"]`);if($&&$.classList.add("active"),o.querySelectorAll("#portugal-selector button").forEach(j=>{j!==$&&j.classList.remove("active")}),m.status){let j=o.querySelector("#main-status-select");j.value=m.status,W.setStatus(m.status);let Z=o.querySelector("#sub-status-select");if(V(m.status,Z),await R(50),m.subStatus){if(Z.value=m.subStatus,W.setSubStatus(m.subStatus),q(m.subStatus),await R(100),m.tagSupportUsed!==void 0){W.setTagSupportUsed(m.tagSupportUsed);let U=s.element.querySelector('input[value="Sim"]'),ee=s.element.querySelector('input[value="N\xE3o"]');m.tagSupportUsed&&U?U.checked=!0:ee&&(ee.checked=!0),s.element.querySelector("div:last-child").style.display=m.tagSupportUsed?"none":"block"}m.forcedScreenshots&&W.setForcedScreenshots(m.forcedScreenshots);for(let U in m.formData){let ee=document.getElementById(U);ee&&(ee.value=m.formData[U],W.updateField(U,ee.value))}m.activeTasks&&(m.activeTasks.forEach(U=>r.setTaskCount(U.key,U.count)),W.setActiveTasks(r.getCheckedElements()))}}W.isDirty=!1}function h(m){return Se[W.currentLang]?.[m]||Se.pt?.[m]||m}function w(){let m=document.createElement("div");return m.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 3 21 3 21 8"></polyline><line x1="4" y1="20" x2="21" y2="3"></line><polyline points="21 16 21 21 16 21"></polyline><line x1="15" y1="15" x2="21" y2="21"></line><line x1="4" y1="4" x2="9" y2="9"></line></svg>',m.style.cssText="width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; border-radius: 50%; cursor: pointer; color: #9AA0A6; transition: all 0.2s;",m.onclick=v=>{v.stopPropagation(),I()},m.title="Alternar para Split & Transfer",m}function _(){let m=document.createElement("div");return m.id="notes-empty-state",m.style.cssText=`
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
...
E-mail: ${v.clientEmail||"---"}`;$&&($.value=Z),j&&(j.style.display="block",j.style.maxHeight="300px",j.style.opacity="1",j.scrollIntoView({behavior:"smooth",block:"end"}))})}function g(){r=!r,ue(r,l,"cw-btn-script"),r?(c(),d||(d=setInterval(c,2e3))):d&&(clearInterval(d),d=null)}let f=pe(l,"Call Script",t,"Guia interativo para condu\xE7\xE3o de chamadas.",p,()=>{g()});l.appendChild(f);let u=document.createElement("div");Object.assign(u.style,a.contextBanner),u.innerHTML=`
  ...
  `,u.onfocus=()=>{g.style.boxShadow="0 4px 12px rgba(26,115,232,0.15)",g.style.border="1px solid #1a73e8"},u.onblur=()=>{g.style.boxShadow="0 2px 6px rgba(0,0,0,0.04)",g.style.border="1px solid transparent"},g.appendChild(f),g.appendChild(u),x.appendChild(g),c.appendChild(x);let y=document.createElement("div");y.style.cssText="flex: 1; overflow-y: auto; padding: 0 24px 40px 24px; scroll-behavior: smooth;",c.appendChild(y);let S=null;function z(){if(S)return;S=document.createElement("div"),S.style.cssText=`
      ...
      `;let k=document.createElement("div");k.style.cssText="padding: 16px 24px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #F1F3F4;",k.innerHTML='<span style="font-size: 16px; font-weight: 700; color: #202124;">\u{1F552} Recentes</span>';let E=document.createElement("button");E.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>',E.style.cssText="background: none; border: none; cursor: pointer; color: #5f6368;",E.onclick=()=>{P(),n=!1,T()},k.appendChild(E),S.appendChild(k);let F=document.createElement("div");F.id="cw-history-list",F.style.cssText="flex: 1; overflow-y: auto; padding: 20px; background: #F8F9FA;",S.appendChild(F),c.appendChild(S)}function B(){S||z();let k=S.querySelector("#cw-history-list");k.innerHTML="";let E=ta();E.length===0?k.innerHTML='<div style="text-align: center; color: #999; margin-top: 60px; font-size:13px;">Nada por aqui ainda.</div>':E.forEach(F=>{let b=V(F,ze[F._originalCat],!0,F._originalCat);k.appendChild(b)}),requestAnimationFrame(()=>S.style.transform="translateY(0)")}function P(){S&&(S.style.transform="translateY(100%)")}function J(){d.innerHTML="";let k=K("history","Recentes",ze.history);k.id="cw-sidebar-btn-history",k.onclick=()=>{G.playClick(),n=!n,n?B():P(),T()},d.appendChild(k);let E=document.createElement("div");E.style.cssText="width: 32px; height: 1px; background: rgba(0,0,0,0.08); margin: 4px 0;",d.appendChild(E),Object.keys(Ke).forEach(F=>{let b=Ke[F],A=K(F,b.label,ze[F]);A.id=`cw-sidebar-btn-${F}`,A.onclick=()=>{G.playClick(),n&&(n=!1,P()),I(F)},d.appendChild(A)})}function K(k,E,F){let b=document.createElement("div");b.style.cssText=`
          width: 56px; height: 56px; border-radius: 16px;
          display: flex; flex-direction: column; align-items: center; justify-content: center;
          cursor: pointer; color: ${i.textSecondary}; 
          transition: all 0.2s cubic-bezier(0.2, 0.0, 0.2, 1);
          position: relative;
      `,b.title=E,b.dataset.key=k;let A=document.createElement("div");A.style.cssText="width: 24px; height: 24px; margin-bottom: 2px; transition: transform 0.2s;",A.innerHTML=F||ze.tasks;let O=document.createElement("div");return O.style.cssText="font-size: 9px; font-weight: 600; opacity: 0.7; letter-spacing: 0.3px;",O.textContent=E,b.appendChild(A),b.appendChild(O),b.onmouseenter=()=>{a!==k&&!(k==="history"&&n)&&(b.style.background="#F1F3F4",A.style.transform="scale(1.1)")},b.onmouseleave=()=>{a!==k&&!(k==="history"&&n)&&(b.style.background="transparent",A.style.transform="scale(1)")},b}function I(k){let E=document.getElementById(`cat-anchor-${k}`);E&&(E.scrollIntoView({behavior:"smooth",block:"start"}),a=k,T())}function T(){Object.keys(Ke).forEach(E=>{let F=d.querySelector(`#cw-sidebar-btn-${E}`);if(F)if(a===E&&!n){let b=bt[E];F.style.background=b.bg,F.style.color=b.color,F.querySelector("div:first-child").style.transform="scale(1.1)"}else F.style.background="transparent",F.style.color=i.textSecondary,F.querySelector("div:first-child").style.transform="scale(1)"});let k=d.querySelector("#cw-sidebar-btn-history");k&&(n?(k.style.background="#3C4043",k.style.color="#FFFFFF"):(k.style.background="transparent",k.style.color=i.textSecondary))}function N(){if(y.innerHTML="",e.trim()!==""){let E=[];if(Object.entries(Ke).forEach(([b,A])=>{let O=A.links.filter(L=>L.name.toLowerCase().includes(e.toLowerCase())||L.desc.toLowerCase().includes(e.toLowerCase()));E.push(...O.map(L=>({...L,_cat:b})))}),E.length===0){y.innerHTML='<div style="text-align:center; padding: 60px; color:#999; font-size:13px;">Nada encontrado.</div>';return}let F=document.createElement("div");F.innerHTML="Resultados da busca",F.style.cssText="font-size:12px; font-weight:700; color:#5f6368; margin:20px 0 10px; text-transform:uppercase; letter-spacing:0.5px;",y.appendChild(F),E.forEach(b=>{let A=V(b,ze[b._cat],!1,b._cat);y.appendChild(A)});return}Object.entries(Ke).forEach(([E,F])=>{let b=bt[E],A=document.createElement("div"),O=document.createElement("div");O.id=`cat-anchor-${E}`,O.style.cssText=`
              display: flex; align-items: center; gap: 8px;
          ...
          `,O.innerHTML=`
            ...
            ${F.label}
          `,A.appendChild(O);let L=document.createElement("div");L.style.cssText="display: grid; grid-template-columns: 1fr; gap: 8px;",F.links.forEach(D=>{let R=V(D,ze[E],!1,E);L.appendChild(R)}),A.appendChild(L),y.appendChild(A)});let k=document.createElement("div");k.style.height="80px",y.appendChild(k)}function V(k,E,F,b){let A=document.createElement("div"),O=bt[b]||bt.history;A.style.cssText=`
      ...
      `;let L=document.createElement("div");L.style.cssText=`
          ...
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0; transition: all 0.2s;
      `,L.innerHTML=E||ze.tasks;let D=L.querySelector("svg");D&&(D.style.width="22px",D.style.height="22px");let R=document.createElement("div");R.style.cssText="flex: 1; display: flex; flex-direction: column; gap: 2px; overflow: hidden;";let Y=document.createElement("div");Y.style.cssText=`font-size: 14px; font-weight: 600; color: ${i.textPrimary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,Y.textContent=k.name;let h=document.createElement("div");h.style.cssText=`font-size: 12px; color: ${i.textSecondary}; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;`,h.textContent=k.desc,R.appendChild(Y),R.appendChild(h);let w=document.createElement("div");return w.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>',w.style.cssText=`
          width: 32px; height: 32px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          color: #9AA0A6; transition: all 0.2s; opacity: 0;
      `,w.title="Copiar URL",A.onmouseenter=()=>{A.style.transform="translateY(-2px)",A.style.boxShadow="0 8px 20px rgba(0,0,0,0.08)",A.style.borderColor="rgba(0,0,0,0.05)",A.style.borderLeft=`4px solid ${O.color}`,w.style.opacity="1",w.style.background="#F1F3F4"},A.onmouseleave=()=>{A.style.transform="translateY(0)",A.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",A.style.border="1px solid transparent",w.style.opacity="0",w.style.background="transparent"},A.onclick=()=>{!F&&b&&yo(k,b),window.open(k.url,"_blank")},w.onclick=_=>{_.stopPropagation(),G.playClick(),navigator.clipboard.writeText(k.url),!F&&b&&yo(k,b),X("Link copiado!")},A.appendChild(L),A.appendChild(R),A.appendChild(w),A}u.addEventListener("input",k=>{e=k.target.value,N()});function q(){o=!o,ue(o,s,"cw-btn-links")}return document.body.appendChild(s),J(),N(),q}var Le=[];function Ot(t){Le=t}var oa=60*1e3;window._cwIsAdmin=!1;window._cwCurrentUser=null;function wo(){let t="v4.9",e=!1,o=null,a=null;function n(b){if(!b)return"";try{let A=new Date(b);return isNaN(A.getTime())?String(b):A.toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}).replace(","," \xE0s")}catch{return String(b)}}if(!document.getElementById("cw-broadcast-hd-css")){let b=document.createElement("style");b.id="cw-broadcast-hd-css",b.innerHTML=`
        @keyframes cw-pulse {
      ...
      `,f.querySelectorAll('input[name="cw-bc-type"]').forEach(L=>{L.addEventListener("change",()=>{f.querySelectorAll(".cw-radio-option").forEach(D=>D.classList.remove("checked")),L.parentElement.classList.add("checked")})}),setTimeout(()=>{let L=f.querySelector(".cw-radio-option.info");L&&L.classList.add("checked")},100);let b=f.querySelector("#cw-bc-cancel"),A=f.querySelector("#cw-bc-close-x"),O=f.querySelector("#cw-bc-send");b.onclick=B,A.onclick=B,O.onclick=P,p.appendChild(f)}function z(b=null){if(!f)return;let A=f.querySelector("#cw-editor-title-label"),O=f.querySelector("#cw-bc-title"),L=f.querySelector("#cw-bc-text"),D=f.querySelector("#cw-bc-send");if(b){a=b.id,A.textContent="Editar Aviso",O.value=b.title||"",L.value=b.text||"",D.textContent="Salvar Altera\xE7\xF5es";let R=b.type||"info",Y=f.querySelector(`input[name="cw-bc-type"][value="${R}"]`);Y&&Y.click()}else{a=null,A.textContent="Novo Aviso",O.value="",L.value="",D.textContent="Publicar";let R=f.querySelector('input[name="cw-bc-type"][value="info"]');R&&R.click()}f.classList.add("active"),setTimeout(()=>O.focus(),300)}function B(){f&&f.classList.remove("active"),a=null}async function P(){let b=f.querySelector("#cw-bc-send"),A=f.querySelector("#cw-bc-title"),O=f.querySelector("#cw-bc-text"),L=f.querySelector('input[name="cw-bc-type"]:checked'),D=L?L.value:"info";if(!A.value.trim()||!O.value.trim()){X("Preencha todos os campos!",{error:!0});return}b.textContent="Salvando...",b.style.opacity="0.7";let R=!1;a?R=await ce.updateBroadcast(a,{title:A.value,text:O.value,type:D}):R=await ce.sendBroadcast({title:A.value,text:O.value,type:D,author:window._cwCurrentUser||"admin"}),R?(X(a?"Atualizado!":"Publicado!"),G.playSuccess(),B(),setTimeout(()=>I(),1500)):(X("Erro ao salvar. Verifique a conex\xE3o.",{error:!0}),b.textContent=a?"Salvar Altera\xE7\xF5es":"Publicar",b.style.opacity="1")}async function J(b){if(await be("Confirma a exclus\xE3o deste aviso?",{danger:!0}))if(await ce.deleteBroadcast(b)){X("Aviso removido."),G.playClick();let L=Le.findIndex(D=>D.id===b);L>-1&&Le.splice(L,1),N(),setTimeout(()=>I(),1500)}else X("Erro ao excluir.",{error:!0})}let K=document.createElement("div");K.className="cw-nice-scroll",Object.assign(K.style,i.feedContainer),p.appendChild(K);async function I(){e&&(y.style.display="block",y.innerHTML="\u{1F504} Sincronizando...");try{let b=await ce.fetchData();b&&b.broadcast&&(Ot(b.broadcast),T(),e&&(N(),y.innerHTML='<span style="color:#137333">\u2713 Atualizado</span>',setTimeout(()=>{y.style.display="none"},1500)))}catch{e&&(y.innerHTML="\u26A0\uFE0F Offline")}}function T(){let b=document.getElementById("cw-btn-broadcast");if(!b)return;let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");if(Le.some(L=>!A.includes(L.id))){if(b.classList.add("has-new"),!b.querySelector(".cw-badge")){let L=document.createElement("div");L.className="cw-badge",Object.assign(L.style,{position:"absolute",top:"8px",right:"8px",width:"8px",height:"8px",backgroundColor:"#d93025",borderRadius:"50%",border:"1px solid #fff",zIndex:"10"}),b.appendChild(L)}}else{b.classList.remove("has-new");let L=b.querySelector(".cw-badge");L&&L.remove()}}function N(){K.innerHTML="";let b=p.querySelector("#cw-bau-widget");b&&b.remove();let A=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),O=[...Le].sort((h,w)=>{let _=new Date(h.date).getTime()||0;return(new Date(w.date).getTime()||0)-_}),L=O.findIndex(h=>h.title&&h.title.toLowerCase().includes("disponibilidade bau"));if(L!==-1){let h=O[L];O.splice(L,1);let w=document.createElement("div");w.id="cw-bau-widget",Object.assign(w.style,i.bauContainer);let _=[],M=(h.text||"").split(`
`),m=/\d{1,2}\/\d{1,2}/,v="\u{1F4C5}";if(M.forEach(U=>{/🇧🇷|🇵🇹|PT|BR|BRASIL|BRAZIL|PORTUGAL|LISBOA/i.test(U)?v="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM|ESPANHA|SPAIN|MEXICO|MÉXICO/i.test(U)&&(v="\u{1F1EA}\u{1F1F8}");let ee=U.match(m);if(ee){let oe=ee[0],Q=v;/🇧🇷|🇵🇹|PT|BR/i.test(U)?Q="\u{1F1E7}\u{1F1F7}":/🇪🇸|🇲🇽|ES|LATAM/i.test(U)&&(Q="\u{1F1EA}\u{1F1F8}"),_.some(te=>te.flag===Q&&te.date===oe)||_.push({flag:Q,date:oe})}}),_.length===0){let U=(h.text||"").match(/\d{1,2}\/\d{1,2}/g);U&&[...new Set(U)].forEach(ee=>_.push({flag:"\u{1F4C5}",date:ee}))}let C="",$='<button id="cw-bau-toggle-btn" class="cw-btn-interactive" style="background:rgba(255,255,255,0.7); border:1px solid rgba(139, 92, 246, 0.4); border-radius:12px; padding:8px 12px; color:#6D28D9; font-size:12px; font-weight:600;">Detalhes</button>';window._cwIsAdmin&&($=`
          ...
          `,y.after(w);let j=w.querySelector("#cw-bau-toggle-btn"),Z=w.querySelector("#cw-bau-full");if(j&&Z&&(j.onclick=()=>{let U=Z.style.display==="none";Z.style.display=U?"block":"none",j.textContent=U?"Ocultar":"Detalhes"}),window._cwIsAdmin){let U=w.querySelector(".cw-bau-edit");U&&(U.onclick=()=>z(h))}}let D=O.sort((h,w)=>{let _=A.includes(h.id),M=A.includes(w.id);return _===M?0:_?1:-1});if(D.length===0&&!L){let h=document.createElement("div");Object.assign(h.style,i.emptyState),h.innerHTML=`
           ...
           `,K.appendChild(h)}let R=D.filter(h=>!A.includes(h.id)),Y=D.filter(h=>A.includes(h.id));if(R.forEach(h=>K.appendChild(V(h,!1))),Y.length>0){let h=document.createElement("div");Object.assign(h.style,i.historyDivider),h.innerHTML=`<span>Hist\xF3rico (${Y.length})</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>`;let w=document.createElement("div");Object.assign(w.style,i.historyContainer),Y.forEach(M=>w.appendChild(V(M,!0)));let _=!1;h.onclick=()=>{G.playClick(),_=!_,w.style.display=_?"flex":"none",h.querySelector("svg").style.transform=_?"rotate(180deg)":"rotate(0deg)"},K.appendChild(h),K.appendChild(w)}}function V(b,A){let O=document.createElement("div");Object.assign(O.style,A?i.cardHistory:i.card);let L=s[b.type]||s.info,D=document.createElement("div");Object.assign(D.style,i.cardHeader);let R=document.createElement("div");Object.assign(R.style,i.typeTag,{color:L.color,background:L.bg}),R.innerHTML=`${L.icon} <span>${b.type}</span>`;let Y=document.createElement("span");if(Object.assign(Y.style,i.dateTag),Y.textContent=n(b.date),D.appendChild(R),A)D.appendChild(Y);else{let m=document.createElement("button");m.className="cw-btn-interactive",Object.assign(m.style,i.dismissBtn),m.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg>',m.onmouseenter=()=>{m.style.color="#1e8e3e",m.style.background="#e6f4ea",m.style.borderColor="#1e8e3e"},m.onmouseleave=()=>{m.style.color="#5f6368",m.style.background="#fff",m.style.borderColor="rgba(0,0,0,0.1)"},m.onclick=v=>{v.stopPropagation(),G.playClick(),O.style.transform="translateX(20px)",O.style.opacity="0",setTimeout(()=>{let C=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]");C.push(b.id),localStorage.setItem("cw_read_broadcasts",JSON.stringify(C)),N(),T()},200)},D.appendChild(m)}let h=document.createElement("div");Object.assign(h.style,i.cardContent);let w=document.createElement("div");Object.assign(w.style,i.msgTitle),w.textContent=b.title;let _=document.createElement("div");Object.assign(_.style,i.msgBody),_.innerHTML=l(b.text);let M=document.createElement("div");if(Object.assign(M.style,i.msgMeta),M.innerHTML=`Publicado por <b>${b.author||"Sistema"}</b>`,A||(M.innerHTML+=` \u2022 ${n(b.date)}`),h.appendChild(w),h.appendChild(_),h.appendChild(M),O.appendChild(D),O.appendChild(h),window._cwIsAdmin){let m=document.createElement("div");m.className="cw-card-actions";let v=document.createElement("button");v.className="cw-action-btn edit",v.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg> Editar',v.onclick=()=>z(b);let C=document.createElement("button");C.className="cw-action-btn delete",C.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg> Excluir',C.onclick=()=>J(b.id),m.appendChild(v),m.appendChild(C),O.appendChild(m)}return O}let q=ce.getCachedBroadcasts();q.length>0&&(Ot(q),N()),setTimeout(u,500),I(),o||(o=setInterval(I,oa));let k=document.createElement("div");Object.assign(k.style,Ee),k.className="no-drag",p.appendChild(k),Ae(p,k),document.body.appendChild(p);let E=JSON.parse(localStorage.getItem("cw_read_broadcasts")||"[]"),F=Le.some(b=>!E.includes(b.id));return{toggle:c,hasUnread:F}}function So(){if(localStorage.getItem("cw_onboarding_seen_v1"))return;let t=[{icon:"\u{1F680}",title:"Bem-vindo ao TechSol Suite",text:"Sua nova central de opera\xE7\xF5es para maximizar produtividade e padroniza\xE7\xE3o no CRM."},{icon:"\u{1F4DD}",title:"Notas Autom\xE1ticas",text:"Gere notas de caso (BAU/LM) perfeitas em segundos. Selecione o Status, as Tasks e deixe o wizard escrever o texto t\xE9cnico para voc\xEA."},{icon:"\u26A1",title:"Quick Email & Scripts",text:"Responda e-mails com templates inteligentes que detectam o contexto e use scripts de chamada interativos que guiam seu atendimento."},{icon:"\u{1F4E2}",title:"Fique Informado",text:"O m\xF3dulo Broadcast traz avisos importantes e disponibilidade BAU direto na sua tela, sem precisar abrir planilhas externas."},{icon:"\u2705",title:"Tudo Pronto!",text:"Explore o Menu Flutuante para come\xE7ar. Bom trabalho!",isLast:!0}],e=0,o={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.6)",backdropFilter:"blur(4px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"380px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 20px 50px rgba(0,0,0,0.3)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(20px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},icon:{fontSize:"48px",marginBottom:"20px",display:"block"},title:{fontSize:"22px",fontWeight:"700",color:"#202124",marginBottom:"12px"},text:{fontSize:"15px",color:"#5f6368",lineHeight:"1.6",marginBottom:"32px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"8px",marginBottom:"24px"},dot:{width:"8px",height:"8px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"24px",borderRadius:"4px"},btnContainer:{display:"flex",justifyContent:"space-between",alignItems:"center"},btn:{padding:"10px 24px",borderRadius:"20px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"background 0.2s"},btnSkip:{background:"transparent",color:"#5f6368"},btnNext:{background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},a=document.createElement("div");Object.assign(a.style,o.overlay);let n=document.createElement("div");Object.assign(n.style,o.card);let i=document.createElement("div");Object.assign(i.style,o.icon);let s=document.createElement("div");Object.assign(s.style,o.title);let r=document.createElement("div");Object.assign(r.style,o.text);let l=document.createElement("div");Object.assign(l.style,o.dotsContainer);let p=document.createElement("div");Object.assign(p.style,o.btnContainer);let d=document.createElement("button");d.textContent="Pular",Object.assign(d.style,o.btn,o.btnSkip),d.onmouseover=()=>d.style.color="#202124",d.onmouseout=()=>d.style.color="#5f6368";let c=document.createElement("button");c.textContent="Pr\xF3ximo",Object.assign(c.style,o.btn,o.btnNext),c.onmouseover=()=>c.style.transform="scale(1.05)",c.onmouseout=()=>c.style.transform="scale(1)",p.appendChild(d),p.appendChild(c),n.appendChild(i),n.appendChild(s),n.appendChild(r),n.appendChild(l),n.appendChild(p),a.appendChild(n),document.body.appendChild(a);function x(f){let u=t[f];i.textContent=u.icon,s.textContent=u.title,r.textContent=u.text,l.innerHTML="",t.forEach((y,S)=>{let z=document.createElement("div");Object.assign(z.style,o.dot),S===f&&Object.assign(z.style,o.dotActive),l.appendChild(z)}),u.isLast?(d.style.display="none",c.textContent="Come\xE7ar \u{1F680}",c.style.width="100%"):(d.style.display="block",c.textContent="Pr\xF3ximo",c.style.width="auto")}function g(){localStorage.setItem("cw_onboarding_seen_v1","true"),a.style.opacity="0",n.style.transform="translateY(20px)",setTimeout(()=>a.remove(),400),G.playSuccess(),X("Tudo pronto! Use o menu flutuante.")}c.onclick=()=>{G.playClick(),e<t.length-1?(e++,x(e)):g()},d.onclick=async()=>{await be("Pular o tutorial?")&&g()},x(0),requestAnimationFrame(()=>{a.style.opacity="1",n.style.transform="translateY(0)"})}var Co={version:"v5.1",title:"Atualiza\xE7\xE3o: v5.1 - Produtividade Blindada \u{1F6E1}\uFE0F",slides:[{icon:"\u{1F17F}\uFE0F",title:"Estacionamento de Casos",text:"Interrup\xE7\xE3o urgente? Agora voc\xEA pode 'Estacionar' seu atendimento atual (Notas + Tasks) com um clique e retomar depois exatamente de onde parou."},{icon:"\u{1F6DF}",title:"Sistema 'Airbag'",text:"Caiu a internet? Fechou a aba sem querer? O TechSol agora possui Auto-Save de emerg\xEAncia a cada 5 segundos. Seu texto est\xE1 salvo, sempre."},{icon:"\u{1F7E0}",title:"Indicador de Progresso",text:"Nunca mais esque\xE7a uma nota aberta. Um indicador laranja ('Dirty State') avisa na P\xEDlula principal se h\xE1 trabalho n\xE3o salvo/estacionado."},{icon:"\u{1F50D}",title:"Time Zone Pro",text:"O m\xF3dulo de fusos hor\xE1rios ganhou superpoderes: nova barra de pesquisa global, filtros r\xE1pidos por regi\xE3o e corre\xE7\xE3o de visualiza\xE7\xE3o."},{icon:"\u{1F916}",title:"Leitura de BAU Aprimorada",text:"O sistema de Broadcast agora \xE9 mais inteligente ao ler avisos de disponibilidade, detectando datas e bandeiras mesmo quando quebradas em v\xE1rias linhas."},{icon:"\u{1F3A8}",title:"Refinamento Visual",text:"Bot\xF5es padronizados, sombras suavizadas e micro-intera\xE7\xF5es t\xE1teis em todo o sistema para uma experi\xEAncia mais fluida e profissional."}]};function Eo(t){let e=localStorage.getItem("cw_last_version");if(!e){localStorage.setItem("cw_last_version",t);return}e!==t&&aa(t)}function aa(t){let e=Co.slides,o=0,a={overlay:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0,0,0,0.7)",backdropFilter:"blur(5px)",zIndex:"2147483647",display:"flex",alignItems:"center",justifyContent:"center",opacity:"0",transition:"opacity 0.3s ease"},card:{width:"400px",background:"#fff",borderRadius:"24px",padding:"32px",textAlign:"center",position:"relative",boxShadow:"0 24px 60px rgba(0,0,0,0.4)",fontFamily:"'Google Sans', Roboto, sans-serif",transform:"translateY(30px)",transition:"all 0.4s cubic-bezier(0.19, 1, 0.22, 1)"},badge:{display:"inline-block",padding:"4px 12px",borderRadius:"12px",background:"#E8F0FE",color:"#1967D2",fontSize:"11px",fontWeight:"700",textTransform:"uppercase",marginBottom:"16px",letterSpacing:"0.5px"},icon:{fontSize:"42px",marginBottom:"16px",display:"block"},title:{fontSize:"20px",fontWeight:"700",color:"#202124",marginBottom:"8px"},text:{fontSize:"14px",color:"#5f6368",lineHeight:"1.5",marginBottom:"32px",minHeight:"42px"},dotsContainer:{display:"flex",justifyContent:"center",gap:"6px",marginBottom:"24px"},dot:{width:"6px",height:"6px",borderRadius:"50%",background:"#dadce0",transition:"all 0.3s"},dotActive:{background:"#1a73e8",width:"18px",borderRadius:"4px"},btn:{width:"100%",padding:"12px",borderRadius:"12px",border:"none",cursor:"pointer",fontSize:"14px",fontWeight:"600",transition:"all 0.2s",background:"#1a73e8",color:"#fff",boxShadow:"0 4px 12px rgba(26,115,232,0.3)"}},n=document.createElement("div");Object.assign(n.style,a.overlay);let i=document.createElement("div");Object.assign(i.style,a.card);let s=document.createElement("div");Object.assign(s.style,a.badge),s.textContent=`Atualiza\xE7\xE3o ${t}`;let r=document.createElement("div");Object.assign(r.style,a.icon);let l=document.createElement("div");Object.assign(l.style,a.title);let p=document.createElement("div");Object.assign(p.style,a.text);let d=document.createElement("div");Object.assign(d.style,a.dotsContainer);let c=document.createElement("button");Object.assign(c.style,a.btn),c.onmouseover=()=>c.style.transform="scale(1.02)",c.onmouseout=()=>c.style.transform="scale(1)",i.appendChild(s),i.appendChild(r),i.appendChild(l),i.appendChild(p),i.appendChild(d),i.appendChild(c),n.appendChild(i),document.body.appendChild(n);function x(f){let u=e[f];r.textContent=u.icon,l.textContent=u.title,p.textContent=u.text,d.innerHTML="",e.forEach((y,S)=>{let z=document.createElement("div");Object.assign(z.style,a.dot),S===f&&Object.assign(z.style,a.dotActive),d.appendChild(z)}),f===e.length-1?c.textContent="Entendi, vamos l\xE1! \u{1F44D}":c.textContent="Pr\xF3ximo"}function g(){localStorage.setItem("cw_last_version",t),n.style.opacity="0",i.style.transform="translateY(30px)",setTimeout(()=>n.remove(),400),G.playSuccess(),X(`TechSol atualizado para ${t}!`)}c.onclick=()=>{G.playClick(),o<e.length-1?(o++,x(o)):g()},x(0),requestAnimationFrame(()=>{n.style.opacity="1",i.style.transform="translateY(0)"})}var Ao="cw_timezone_pinned",It=[{id:"pt",name:"Portugal",flag:"\u{1F1F5}\u{1F1F9}",zone:"Europe/Lisbon",label:"Lisboa",region:"eu"},{id:"es",name:"Espanha",flag:"\u{1F1EA}\u{1F1F8}",zone:"Europe/Madrid",label:"Madrid",region:"eu"},{id:"ar",name:"Argentina",flag:"\u{1F1E6}\u{1F1F7}",zone:"America/Argentina/Buenos_Aires",label:"Buenos Aires",region:"sa"},{id:"bo",name:"Bol\xEDvia",flag:"\u{1F1E7}\u{1F1F4}",zone:"America/La_Paz",label:"La Paz",region:"sa"},{id:"cl",name:"Chile",flag:"\u{1F1E8}\u{1F1F1}",zone:"America/Santiago",label:"Santiago",region:"sa"},{id:"co",name:"Col\xF4mbia",flag:"\u{1F1E8}\u{1F1F4}",zone:"America/Bogota",label:"Bogot\xE1",region:"sa"},{id:"ec",name:"Equador",flag:"\u{1F1EA}\u{1F1E8}",zone:"America/Guayaquil",label:"Guayaquil",region:"sa"},{id:"py",name:"Paraguai",flag:"\u{1F1F5}\u{1F1FE}",zone:"America/Asuncion",label:"Assun\xE7\xE3o",region:"sa"},{id:"pe",name:"Peru",flag:"\u{1F1F5}\u{1F1EA}",zone:"America/Lima",label:"Lima",region:"sa"},{id:"uy",name:"Uruguai",flag:"\u{1F1FA}\u{1F1FE}",zone:"America/Montevideo",label:"Montevid\xE9u",region:"sa"},{id:"ve",name:"Venezuela",flag:"\u{1F1FB}\u{1F1EA}",zone:"America/Caracas",label:"Caracas",region:"sa"},{id:"mx",name:"M\xE9xico",flag:"\u{1F1F2}\u{1F1FD}",zone:"America/Mexico_City",label:"CDMX",region:"na"},{id:"cr",name:"Costa Rica",flag:"\u{1F1E8}\u{1F1F7}",zone:"America/Costa_Rica",label:"San Jos\xE9",region:"na"},{id:"sv",name:"El Salvador",flag:"\u{1F1F8}\u{1F1FB}",zone:"America/El_Salvador",label:"San Salvador",region:"na"},{id:"gt",name:"Guatemala",flag:"\u{1F1EC}\u{1F1F9}",zone:"America/Guatemala",label:"C. da Guatemala",region:"na"},{id:"hn",name:"Honduras",flag:"\u{1F1ED}\u{1F1F3}",zone:"America/Tegucigalpa",label:"Tegucigalpa",region:"na"},{id:"ni",name:"Nicar\xE1gua",flag:"\u{1F1F3}\u{1F1EE}",zone:"America/Managua",label:"Man\xE1gua",region:"na"},{id:"pa",name:"Panam\xE1",flag:"\u{1F1F5}\u{1F1E6}",zone:"America/Panama",label:"C. do Panam\xE1",region:"na"},{id:"do",name:"Rep. Dominicana",flag:"\u{1F1E9}\u{1F1F4}",zone:"America/Santo_Domingo",label:"Santo Domingo",region:"na"},{id:"pr",name:"Porto Rico",flag:"\u{1F1F5}\u{1F1F7}",zone:"America/Puerto_Rico",label:"San Juan",region:"na"}],na=[{id:"all",label:"Todos"},{id:"sa",label:"Am\xE9rica do Sul"},{id:"na",label:"Norte & Central"},{id:"eu",label:"Europa"}];function To(){let t="v2.2 Pro",e=!1,o=null,a="mx",n=JSON.parse(localStorage.getItem(Ao)||"[]"),i="",s="all",r=new Date;r.setHours(14,0,0,0);let l={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",primaryBg:"#E8F0FE",text:"#202124",textSub:"#5F6368",border:"#DADCE0",success:"#1E8E3E",successBg:"#E6F4EA",warning:"#E37400",warningBg:"#FEF7E0",error:"#D93025",errorBg:"#FCE8E6"},p={container:{display:"flex",flexDirection:"column",height:"100%",background:l.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",background:l.surface,borderBottom:`1px solid ${l.border}`,padding:"8px 16px 0 16px"},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:l.textSub,borderBottom:"3px solid transparent",transition:"all 0.2s ease",userSelect:"none"},tabActive:{color:l.primary,borderBottomColor:l.primary,fontWeight:"600"},toolbar:{padding:"12px 16px 8px 16px",background:l.bg,display:"flex",flexDirection:"column",gap:"12px",borderBottom:"1px solid rgba(0,0,0,0.03)"},searchInputWrapper:{position:"relative",width:"100%"},searchInput:{width:"100%",boxSizing:"border-box",padding:"10px 12px 10px 38px",borderRadius:"10px",border:"1px solid transparent",background:"#FFFFFF",fontSize:"14px",color:l.text,outline:"none",boxShadow:"0 1px 3px rgba(0,0,0,0.05)",transition:"all 0.2s",fontFamily:"'Google Sans', Roboto, sans-serif"},searchIcon:{position:"absolute",left:"12px",top:"50%",transform:"translateY(-50%)",width:"16px",height:"16px",color:"#9AA0A6",pointerEvents:"none"},chipsRow:{display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"4px",scrollbarWidth:"none",msOverflowStyle:"none"},chip:{whiteSpace:"nowrap",padding:"6px 12px",borderRadius:"16px",fontSize:"12px",fontWeight:"500",cursor:"pointer",border:`1px solid ${l.border}`,background:l.surface,color:l.textSub,transition:"all 0.2s"},chipActive:{background:l.primaryBg,color:l.primary,borderColor:l.primaryBg,fontWeight:"600"},listContainer:{padding:"16px 16px 40px 16px",overflowY:"auto",flex:1,display:"flex",flexDirection:"column",gap:"12px",scrollbarWidth:"none"},hubCard:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"16px 20px",background:l.surface,borderRadius:"16px",border:"1px solid transparent",boxShadow:"0 2px 6px rgba(60,64,67,0.05)",transition:"transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1), box-shadow 0.2s ease",cursor:"pointer",position:"relative"},hubCardPinned:{borderLeft:`4px solid ${l.primary}`,paddingLeft:"16px"},plannerWrapper:{padding:"24px",display:"flex",flexDirection:"column",gap:"24px",flex:1,overflowY:"auto"},timeComparisonRow:{display:"flex",gap:"16px",alignItems:"stretch"},timeCard:{flex:1,padding:"20px",borderRadius:"20px",background:l.surface,border:`1px solid ${l.border}`,display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",boxShadow:"0 4px 12px rgba(60,64,67,0.05)"},timelineContainer:{position:"relative",height:"60px",marginTop:"16px",userSelect:"none"},timelineTrack:{position:"absolute",top:"26px",left:"0",right:"0",height:"6px",borderRadius:"3px",background:"#E0E0E0",overflow:"hidden"},dayZone:{position:"absolute",top:"0",bottom:"0",left:"37.5%",width:"37.5%",background:"rgba(52, 168, 83, 0.3)",pointerEvents:"none"},hdInput:{fontSize:"28px",fontWeight:"700",color:l.text,border:"none",background:"transparent",width:"100%",textAlign:"center",outline:"none",fontFamily:"'Google Sans', sans-serif",cursor:"text"},statusBadge:{padding:"8px 16px",borderRadius:"50px",fontSize:"13px",fontWeight:"600",display:"inline-flex",alignItems:"center",gap:"8px",marginTop:"16px",alignSelf:"center",transition:"background-color 0.3s"}},d=document.createElement("div");d.id="timezone-popup",d.classList.add("cw-module-window"),Object.assign(d.style,me,{right:"100px",width:"450px",height:"720px",overflow:"hidden",borderRadius:"24px"});let x=pe(d,"Time Zone Traveler",t,"Monitoramento global e planejamento de chamadas.",{popup:d},()=>A());d.appendChild(x);let g=document.createElement("div");Object.assign(g.style,p.container),d.appendChild(g);let f=document.createElement("div");Object.assign(f.style,p.tabHeader);let u=document.createElement("div");u.textContent="Monitoramento",Object.assign(u.style,p.tabBtn,p.tabActive);let y=document.createElement("div");y.textContent="Planejador",Object.assign(y.style,p.tabBtn),f.appendChild(u),f.appendChild(y),g.appendChild(f);let S=document.createElement("div");Object.assign(S.style,p.toolbar);let z=document.createElement("div");Object.assign(z.style,p.searchInputWrapper);let B=document.createElement("div");B.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',Object.assign(B.style,p.searchIcon);let P=document.createElement("input");P.placeholder="Buscar cidade ou pa\xEDs...",Object.assign(P.style,p.searchInput),P.onfocus=()=>{P.style.boxShadow="0 2px 8px rgba(26,115,232,0.15)",P.style.borderColor="rgba(26,115,232,0.3)"},P.onblur=()=>{P.style.boxShadow="0 1px 3px rgba(0,0,0,0.05)",P.style.borderColor="transparent"},P.oninput=O=>{i=O.target.value.toLowerCase(),k()},z.appendChild(B),z.appendChild(P),S.appendChild(z);let J=document.createElement("div");Object.assign(J.style,p.chipsRow),na.forEach(O=>{let L=document.createElement("div");L.textContent=O.label,L.id=`tz-filter-${O.id}`,Object.assign(L.style,p.chip),O.id===s&&Object.assign(L.style,p.chipActive),L.onclick=()=>{G.playClick(),s=O.id,Array.from(J.children).forEach(D=>{Object.assign(D.style,p.chip)}),Object.assign(L.style,p.chipActive),k()},J.appendChild(L)}),S.appendChild(J),g.appendChild(S);let K=document.createElement("div");Object.assign(K.style,p.listContainer);let I=document.createElement("style");I.textContent="#timezone-popup ::-webkit-scrollbar { display: none; }",g.appendChild(I);let T=document.createElement("div");Object.assign(T.style,p.plannerWrapper,{display:"none"}),g.appendChild(K),g.appendChild(T),u.onclick=()=>N("live"),y.onclick=()=>N("plan");function N(O){G.playClick(),O==="live"?(Object.assign(u.style,p.tabActive),Object.assign(y.style,p.tabBtn),y.style.borderBottomColor="transparent",K.style.display="flex",S.style.display="flex",T.style.display="none",F()):(Object.assign(y.style,p.tabActive),Object.assign(u.style,p.tabBtn),u.style.borderBottomColor="transparent",T.style.display="flex",K.style.display="none",S.style.display="none",b(),E())}function V(O){return O>=9&&O<17?{color:l.success,bg:l.successBg,label:"Aberto",icon:"\u{1F7E2}"}:O>=8&&O<9?{color:l.warning,bg:l.warningBg,label:"Abrindo",icon:"\u{1F7E1}"}:O>=17&&O<19?{color:l.warning,bg:l.warningBg,label:"Fechando",icon:"\u{1F7E1}"}:{color:l.textSub,bg:"#F1F3F4",label:"Fechado",icon:"\u{1F534}"}}function q(O){n.includes(O)?n=n.filter(L=>L!==O):n.push(O),localStorage.setItem(Ao,JSON.stringify(n)),k(),G.playClick()}function k(){K.innerHTML="";let O=new Date,L=It.filter(R=>{let Y=R.name.toLowerCase().includes(i)||R.label.toLowerCase().includes(i),h=s==="all"||R.region===s;return Y&&h});if(L.sort((R,Y)=>{let h=n.includes(R.id),w=n.includes(Y.id);return h&&!w?-1:!h&&w?1:R.name.localeCompare(Y.name)}),L.length===0){K.innerHTML=`
            ...
            `,m.onmouseenter=()=>{m.style.transform="translateY(-2px)",m.style.boxShadow="0 6px 12px rgba(60,64,67,0.1)"},m.onmouseleave=()=>{m.style.transform="translateY(0)",m.style.boxShadow="0 2px 6px rgba(60,64,67,0.05)"};let $=m.querySelector(".cw-pin-btn");$.onmouseenter=()=>{$.style.backgroundColor="#F1F3F4"},$.onmouseleave=()=>{$.style.backgroundColor="transparent"},$.onclick=j=>{j.stopPropagation(),q(R.id)},m.onclick=()=>{a=R.id,N("plan")},K.appendChild(m)});let D=document.createElement("div");D.style.height="20px",D.style.width="100%",K.appendChild(D)}function E(){T.innerHTML="";let O=document.createElement("div"),L=document.createElement("label");L.textContent="Onde est\xE1 o cliente?",L.style.cssText="display:block; font-size:12px; font-weight:700; color:#5F6368; margin-bottom:8px; text-transform:uppercase; letter-spacing:0.5px;";let D=document.createElement("select");Object.assign(D.style,Bt),D.style.padding="14px",[...It].sort((ne,te)=>ne.name.localeCompare(te.name)).forEach(ne=>{let te=document.createElement("option");te.value=ne.id,te.textContent=`${ne.flag} ${ne.name} (${ne.zone})`,ne.id===a&&(te.selected=!0),D.appendChild(te)}),D.onchange=ne=>{a=ne.target.value,Q(),G.playClick()},O.appendChild(L),O.appendChild(D),T.appendChild(O);let Y=document.createElement("div");Object.assign(Y.style,p.timeComparisonRow);let h=document.createElement("div");Object.assign(h.style,p.timeCard),h.style.backgroundColor="#F8FAFF",h.style.borderColor="#E8F0FE",h.innerHTML=`
        ...
        `,Y.appendChild(h),Y.appendChild(w),T.appendChild(Y);let _=document.createElement("div");_.id="cw-planner-status",Object.assign(_.style,p.statusBadge),T.appendChild(_);let M=document.createElement("div");Object.assign(M.style,{padding:"0 4px",marginTop:"12px"});let m=document.createElement("div");m.textContent="Arraste para simular o hor\xE1rio:",m.style.cssText="font-size:12px; color:#5F6368; text-align:center; margin-bottom:12px;";let v=document.createElement("div");Object.assign(v.style,p.timelineContainer);let C=document.createElement("div");Object.assign(C.style,p.timelineTrack);let $=document.createElement("div");Object.assign($.style,p.dayZone),C.appendChild($);let j=document.createElement("input");j.type="range",j.min="0",j.max="1439",j.step="15",j.style.cssText="position:absolute; top:20px; left:0; width:100%; -webkit-appearance:none; background:transparent; z-index:2; cursor:pointer;";let Z=document.createElement("div");Z.style.cssText="position:absolute; top:36px; width:100%; display:flex; justify-content:space-between; font-size:10px; font-weight:600; color:#9AA0A6; padding:0 2px;",Z.innerHTML="<span>00h</span><span>06h</span><span>12h</span><span>18h</span><span>24h</span>",v.appendChild(C),v.appendChild(j),v.appendChild(Z),M.appendChild(m),M.appendChild(v),T.appendChild(M);let U=h.querySelector("#cw-time-input-br"),ee=w.querySelector("#cw-time-display-client"),oe=w.querySelector("#cw-client-label");function Q(){let ne=It.find(_e=>_e.id===a);oe.textContent=`${ne.flag} ${ne.label} (${ne.zone})`;let te=r.getHours(),re=r.getMinutes(),Ue=`${String(te).padStart(2,"0")}:${String(re).padStart(2,"0")}`;U.value=Ue,j.value=te*60+re;let Ze=r.toLocaleTimeString("pt-BR",{timeZone:ne.zone,hour:"2-digit",minute:"2-digit"});ee.textContent=Ze;let qe=parseInt(Ze.split(":")[0]);qe>=9&&qe<17?(_.style.background=l.successBg,_.style.color=l.success,_.innerHTML='<span style="font-size:16px">\u2705</span> Hor\xE1rio Comercial Ideal'):qe>=8&&qe<9||qe>=17&&qe<19?(_.style.background=l.warningBg,_.style.color=l.warning,_.innerHTML='<span style="font-size:16px">\u26A0\uFE0F</span> Hor\xE1rio Limite (Aten\xE7\xE3o)'):(_.style.background=l.errorBg,_.style.color=l.error,_.innerHTML='<span style="font-size:16px">\u26D4</span> Fora de Hor\xE1rio')}j.oninput=ne=>{let te=parseInt(ne.target.value);r.setHours(Math.floor(te/60)),r.setMinutes(te%60),Q()},U.oninput=ne=>{let[te,re]=ne.target.value.split(":");te&&re&&(r.setHours(parseInt(te)),r.setMinutes(parseInt(re)),Q())},Q()}function F(){k(),o||(o=setInterval(k,6e4))}function b(){o&&(clearInterval(o),o=null)}function A(){e=!e,ue(e,d,"cw-btn-timezone"),e?N("live"):b()}return document.body.appendChild(d),A}function ko(){let t="v1.1",e=!1,o="general",a=null,n=null;if(!document.getElementById("cw-lib-styles")){let E=document.createElement("style");E.id="cw-lib-styles",E.innerHTML=`
        ...
        `,document.head.appendChild(E)}let i={bg:"#F0F2F5",surface:"#FFFFFF",primary:"#007AFF",primaryBg:"rgba(0, 122, 255, 0.1)",text:"#1C1C1E",textSub:"#8E8E93",border:"rgba(0, 0, 0, 0.08)",danger:"#FF3B30"},s={container:{display:"flex",flexDirection:"column",height:"100%",background:i.bg,fontFamily:"'Google Sans', Roboto, sans-serif"},tabHeader:{display:"flex",padding:"12px 16px 0 16px",background:i.surface,borderBottom:`1px solid ${i.border}`},tabBtn:{flex:1,padding:"12px",textAlign:"center",cursor:"pointer",fontSize:"13px",fontWeight:"500",color:i.textSub,borderBottom:"3px solid transparent",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",userSelect:"none"},tabActive:{color:i.primary,borderBottomColor:i.primary,fontWeight:"600"},listContainer:{flex:1,overflowY:"auto",padding:"16px",display:"flex",flexDirection:"column",gap:"12px"},emptyState:{padding:"40px 20px",textAlign:"center",color:"#BDC1C6",display:"flex",flexDirection:"column",alignItems:"center",gap:"10px"},card:{background:i.surface,borderRadius:"16px",padding:"16px",border:`1px solid ${i.border}`,boxShadow:"0 4px 12px rgba(0,0,0,0.05)",transition:"all 0.4s cubic-bezier(0.165, 0.84, 0.44, 1)",cursor:"default",position:"relative",overflow:"hidden"},cardHeader:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"},cardTitle:{fontSize:"14px",fontWeight:"600",color:i.text},cardPreview:{fontSize:"12px",color:i.textSub,lineHeight:"1.5",display:"-webkit-box",webkitLineClamp:"3",webkitBoxOrient:"vertical",overflow:"hidden"},cardActions:{display:"flex",justifyContent:"flex-end",gap:"8px",marginTop:"12px",paddingTop:"12px",borderTop:`1px dashed ${i.border}`},actionBtn:{padding:"6px 12px",borderRadius:"6px",fontSize:"12px",fontWeight:"600",cursor:"pointer",border:"none",background:"transparent",transition:"background 0.2s"},fab:{position:"absolute",bottom:"24px",right:"24px",width:"56px",height:"56px",borderRadius:"16px",background:i.primary,color:"#FFF",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 12px rgba(26, 115, 232, 0.4)",cursor:"pointer",transition:"transform 0.2s",zIndex:10},editorOverlay:{position:"absolute",top:0,left:0,width:"100%",height:"100%",background:"rgba(255, 255, 255, 0.85)",backdropFilter:"blur(25px) saturate(180%)",webkitBackdropFilter:"blur(25px) saturate(180%)",zIndex:20,transform:"translateY(100%)",transition:"transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)",display:"flex",flexDirection:"column"},editorHeader:{padding:"16px 24px",background:i.surface,borderBottom:`1px solid ${i.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"},editorBody:{flex:1,padding:"24px",overflowY:"auto"},inputGroup:{marginBottom:"20px"},label:{display:"block",fontSize:"12px",fontWeight:"700",color:i.textSub,marginBottom:"8px",textTransform:"uppercase"},input:{width:"100%",padding:"12px",borderRadius:"8px",border:`1px solid ${i.border}`,fontSize:"14px",fontFamily:"inherit",outline:"none",background:i.surface,boxSizing:"border-box"}},r=document.createElement("div");r.id="library-popup",r.classList.add("cw-module-window"),Object.assign(r.style,me,{right:"auto",left:"50%",width:"400px",height:"600px",transform:"translateX(-50%) scale(0.05)",overflow:"hidden"});let p=pe(r,"Minha Biblioteca",t,"Gerencie seus snippets, textos e templates.",{popup:r},()=>k());r.appendChild(p);let d=document.createElement("div");Object.assign(d.style,s.container),r.appendChild(d);let c=document.createElement("div");Object.assign(c.style,s.tabHeader);let x=[{id:"general",label:"Geral",icon:"\u{1F4CB}"},{id:"note",label:"Notas",icon:"\u{1F4DD}"},{id:"email",label:"Emails",icon:"\u{1F4E7}"}];x.forEach(E=>{let F=document.createElement("div");F.innerHTML=`${E.icon} ${E.label}`,F.id=`lib-tab-${E.id}`,Object.assign(F.style,s.tabBtn),E.id===o&&Object.assign(F.style,s.tabActive),F.onmouseenter=()=>G.playHover(),F.onclick=()=>J(E.id),c.appendChild(F)}),d.appendChild(c);let g=document.createElement("div");Object.assign(g.style,s.listContainer),d.appendChild(g);let f=document.createElement("div");f.className="cw-fab cw-tactile",Object.assign(f.style,s.fab),f.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',f.onmouseenter=()=>f.style.transform="scale(1.1)",f.onmouseleave=()=>f.style.transform="scale(1)",f.onclick=()=>I(),d.appendChild(f),a=document.createElement("div"),Object.assign(a.style,s.editorOverlay);let u=document.createElement("div");Object.assign(u.style,s.editorHeader),u.innerHTML='<span style="font-weight:700; font-size:16px;">Novo Item</span>';let y=document.createElement("button");y.innerHTML="Cancelar",y.style.cssText="background:none; border:none; color:#5f6368; font-weight:600; cursor:pointer;",y.onclick=T,u.appendChild(y),a.appendChild(u);let S=document.createElement("div");Object.assign(S.style,s.editorBody),a.appendChild(S);let z=document.createElement("div");z.style.cssText="padding:16px 24px; border-top:1px solid #DADCE0; background:#FFF; display:flex; justify-content:flex-end;";let B=document.createElement("button");B.textContent="Salvar",B.style.cssText="padding:10px 24px; background:#1a73e8; color:white; border:none; border-radius:20px; font-weight:600; cursor:pointer; box-shadow:0 2px 5px rgba(26,115,232,0.3);",B.onclick=N,z.appendChild(B),a.appendChild(z),d.appendChild(a);let P=document.createElement("div");Object.assign(P.style,Ee),P.className="no-drag",r.appendChild(P),Ae(r,P),document.body.appendChild(r);function J(E){G.playClick(),o=E,x.forEach(F=>{let b=document.getElementById(`lib-tab-${F.id}`);F.id===E?Object.assign(b.style,s.tabActive):Object.assign(b.style,s.tabBtn)}),K()}function K(){g.innerHTML="";let E=xe.getSnippets(o);if(E.length===0){g.innerHTML=`
            ...
            `,b.onmouseenter=()=>{G.playHover()},b.querySelector(".cw-act-copy").onclick=O=>{if(O.stopPropagation(),G.playClick(),F.isRich){let L=new Blob([F.content],{type:"text/html"}),D=document.createElement("div");D.style.whiteSpace="pre-wrap",D.innerHTML=F.content;let R=new Blob([D.innerText],{type:"text/plain"}),Y=[new ClipboardItem({"text/html":L,"text/plain":R})];navigator.clipboard.write(Y)}else navigator.clipboard.writeText(F.content);X("Copiado!")},b.querySelector(".cw-act-edit").onclick=O=>{O.stopPropagation(),G.playClick(),I(F)},b.querySelector(".cw-act-del").onclick=async O=>{O.stopPropagation(),G.playClick(),await be("Excluir este item?")&&(xe.delete(F.id),K(),X("Item exclu\xEDdo."))},g.appendChild(b)})}function I(E=null){n=E?E.id:null,S.innerHTML="",S.appendChild(V("title","T\xEDtulo / Nome",E?E.title:"")),o==="email"&&S.appendChild(V("subject","Assunto do Email",E?E.subject:""));let F="Conte\xFAdo";o==="email"&&(F="Corpo do Email (HTML)"),o==="note"&&(F="Texto da Nota (Reason)"),S.appendChild(V("content",F,E?E.content:"",{isRich:!0,isCode:E?E.isCode:!1})),u.querySelector("span").textContent=E?"Editar Item":"Novo Item",a.style.transform="translateY(0)",setTimeout(()=>{let b=S.querySelector("input");b&&b.focus()},300)}function T(){a.style.transform="translateY(100%)",setTimeout(()=>n=null,300)}async function N(){let E=S.querySelector("#cw-inp-title"),F=S.querySelector("#cw-inp-content"),b=E.value.trim(),A=F.contentEditable==="true"?F.innerHTML:F.value.trim(),O=F.getAttribute("data-is-code")==="true";if(!b||!A||A==="<br>"){X("Preencha t\xEDtulo e conte\xFAdo.",{error:!0});return}let L={id:n,type:o,title:b,content:A,isCode:O,isRich:F.contentEditable==="true"};if(o==="email"){let D=S.querySelector("#cw-inp-subject").value.trim();if(!D){X("Assunto \xE9 obrigat\xF3rio para emails.",{error:!0});return}L.subject=D}B.textContent="Salvando...",await xe.save(L),B.textContent="Salvar",T(),K(),X("Salvo com sucesso!"),G.playSuccess()}function V(E,F,b,A={}){let O=document.createElement("div");Object.assign(O.style,s.inputGroup);let L=document.createElement("label");L.textContent=F,Object.assign(L.style,s.label);let D;if(A.isRich){let R=document.createElement("div");R.style.cssText="display:flex; gap:6px; margin-bottom:12px; background:rgba(241, 243, 244, 0.8); padding:6px; border-radius:12px; border:1px solid #DADCE0; backdrop-filter: blur(10px);",R.innerHTML=`
            ...
            `,D=document.createElement("div"),D.contentEditable="true",Object.assign(D.style,s.input,{minHeight:"180px",maxHeight:"350px",overflowY:"auto",whiteSpace:"pre-wrap",lineHeight:"1.6",outline:"none"}),D.innerHTML=b||"",A.isCode&&(D.style.fontFamily="'Roboto Mono', monospace",D.style.backgroundColor="#F8F9FA",D.setAttribute("data-is-code","true")),R.querySelectorAll(".cw-toolbar-btn").forEach(Y=>{Y.onmouseenter=()=>G.playHover(),Y.onmousedown=()=>G.playClick()}),R.querySelector(".cw-tb-bold").onclick=()=>{document.execCommand("bold"),D.focus()},R.querySelector(".cw-tb-italic").onclick=()=>{document.execCommand("italic"),D.focus()},R.querySelector(".cw-tb-code").onclick=Y=>{let w=!(D.getAttribute("data-is-code")==="true");D.setAttribute("data-is-code",w),D.style.fontFamily=w?"'Roboto Mono', monospace":"inherit",D.style.backgroundColor=w?"rgba(0, 122, 255, 0.03)":i.surface,w?Y.currentTarget.classList.add("active"):Y.currentTarget.classList.remove("active"),D.focus()},R.querySelector(".cw-tb-img").onclick=async()=>{let Y=await Ut("Cole a URL da imagem:");Y&&(document.execCommand("insertImage",!1,Y),D.querySelectorAll("img").forEach(w=>{w.style.maxWidth="100%",w.style.borderRadius="8px"}))},D.onpaste=Y=>{let h=(Y.clipboardData||Y.originalEvent.clipboardData).items;for(let w of h)if(w.kind==="file"&&w.type.startsWith("image/")){Y.preventDefault();let _=w.getAsFile(),M=new FileReader;M.onload=m=>{let v=`<img src="${m.target.result}" style="max-width:100%; border-radius:8px; margin:8px 0; display:block;">`;document.execCommand("insertHTML",!1,v)},M.readAsDataURL(_)}},O.appendChild(L),O.appendChild(R)}else D=document.createElement("input"),D.type="text",Object.assign(D.style,s.input),D.value=b||"",O.appendChild(L);return D.id=`cw-inp-${E}`,D.onfocus=()=>{D.style.borderColor=i.primary,D.style.boxShadow=`0 0 0 2px ${i.primaryBg}`},D.onblur=()=>{D.style.borderColor=i.border,D.style.boxShadow="none"},O.appendChild(D),O}function q(E){return Object.entries(E).map(([F,b])=>`${F.replace(/[A-Z]/g,A=>"-"+A.toLowerCase())}:${b}`).join(";")}function k(){e=!e,ue(e,r,"cw-btn-library"),e&&K()}return k}function Fo(){let t="v1.0",e=!1,o={bg:"#F8F9FA",surface:"#FFFFFF",primary:"#1A73E8",text:"#202124",textSub:"#5F6368",border:"#DADCE0"},a="cw-configs-styles";if(!document.getElementById(a)){let x=document.createElement("style");x.id=a,x.innerHTML=`
  ...
  `,document.head.appendChild(t)};function qo(){Io();let t=!1,e="dashboard",o=null,a=1,n=4,i=document.createElement("div");i.id="bau-form-popup",i.className="bau-popup cw-module-window",i.style.display="none";let s=pe(i,"BAU Central","v2.0.0","Dashboard de Casos BAU",{},()=>h());i.appendChild(s);let r=document.createElement("div");r.className="bau-view-container",i.appendChild(r);let l=document.createElement("div");l.id="bau-view-dashboard",l.className="bau-view active",l.innerHTML=`
    ...
    `,u.appendChild(y),g.appendChild(u);let S=document.createElement("div");S.className="bau-step",S.id="bau-step-2";let z=document.createElement("div");z.className="bau-card",z.innerHTML=`
        ...
        <div class="bau-tasks-grid" id="bau-tasks-container">
            ${["Setup GTM","Google Ads Conversion","GA4 Events","Enhanced Conversions","Offline Conversions","Consent Mode","Troubleshooting","Outros"].map(w=>`
    ...
    `,z.querySelectorAll(".bau-task-item").forEach(w=>{let _=w.querySelector("input");w.addEventListener("click",()=>{_.checked=!_.checked,w.classList.toggle("active",_.checked),G.playClick()})}),S.appendChild(z),g.appendChild(S);let B=document.createElement("div");B.className="bau-step",B.id="bau-step-3";let P=document.createElement("div");P.className="bau-card",P.innerHTML=`
    ...
    `,g.appendChild(J);let K=document.createElement("div");K.className="bau-footer";let I=document.createElement("button");I.type="button",I.id="bau-step-back-btn",I.className="bau-btn-secondary",I.textContent="Voltar";let T=document.createElement("button");T.type="button",T.id="bau-step-next-btn",T.className="bau-btn-primary",T.textContent="Pr\xF3ximo";let N=document.createElement("button");N.type="submit",N.className="bau-btn-submit",N.innerHTML='<span class="material-icons">send</span> Enviar para o TL',N.style.display="none",g.appendChild(I),g.appendChild(T),g.appendChild(N),g.appendChild(K),r.appendChild(p);let V=document.createElement("div");V.id="bau-view-success",V.className="bau-view",V.innerHTML=`
    ...
    `,r.appendChild(V),document.body.appendChild(i);function q(w){e=w,i.querySelectorAll(".bau-view").forEach(v=>v.classList.remove("active"));let _=i.querySelector(`#bau-view-${w}`);_&&_.classList.add("active");let M=s.querySelector(".cw-module-header-title")||s.querySelector("h2"),m=s.querySelector(".cw-module-header-subtitle")||s.querySelector("p");M&&(M.textContent=w==="form"?"Novo Caso BAU":"BAU Central"),m&&(m.textContent=w==="form"?"Preencha os detalhes abaixo":"Dashboard de Casos BAU")}async function k(){let w=i.querySelector("#bau-case-list-container");if(w){w.innerHTML="<p>Carregando casos...</p>";try{let _=await oo();E(_)}catch{w.innerHTML='<p class="bau-error-text">Erro ao carregar casos.</p>'}}}function E(w){let _=i.querySelector("#bau-case-list-container");if(_){if(!w||w.length===0){_.innerHTML="<p>Nenhum caso BAU encontrado.</p>";return}_.innerHTML=w.map(M=>`
        ...
        `).join("")}}function F(){g.querySelectorAll(".bau-step").forEach((w,_)=>{w.classList.toggle("active",_+1===a)}),x.innerHTML="";for(let w=1;w<=n;w++){let _=document.createElement("div");_.className=`bau-progress-step ${w===a?"active":w<a?"completed":""}`,_.textContent=w,x.appendChild(_)}I.style.display=a>1?"inline-block":"none",T.style.display=a<n?"inline-block":"none",N.style.display=a===n?"inline-block":"none",a===4&&O()}function b(w){let _=i.querySelector(`#bau-step-${w}`);if(!_)return!0;if(w===2)return g.querySelector('select[name="reason"]').value?g.querySelector('input[name="taskType"]:checked')?!0:(X("Erro: Selecione pelo menos uma Task.",{error:!0}),!1):(X("Erro: O Motivo da Abertura \xE9 obrigat\xF3rio.",{error:!0}),!1);for(let M of _.querySelectorAll("[required]"))if(!M.value.trim())return X(`Erro: O campo '${M.name||M.placeholder}' \xE9 obrigat\xF3rio.`,{error:!0}),!1;return!0}T.onclick=()=>{b(a)&&(a++,F(),G.playClick())},I.onclick=()=>{a>1&&(a--,F(),G.playClick())};async function A(){let w=await we()||{};o=w,g.querySelector('[name="advName"]').value=w.advName||"",g.querySelector('[name="cid"]').value=w.cid||"",g.querySelector('[name="amName"]').value=w.amName||"",g.querySelector('[name="seId"]').value=w.seId||""}i.querySelector("#bau-top-se-search").onclick=w=>{w.preventDefault(),it("bau-context-se-id-input")};function O(){let w=new FormData(g),_=Object.fromEntries(w.entries()),M=w.getAll("taskType"),m=i.querySelector("#bau-confirmation-details");if(!m)return;let v=M.length>0?M.join(", "):"Nenhuma";m.innerHTML=`
            ...
            <div class="bau-confirm-row"><span class="bau-confirm-label">AM:</span><span class="bau-confirm-value">${_.amName||"---"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Speakeasy ID:</span><span class="bau-confirm-value">${_.seId||"N\xE3o informado"}</span></div>
            <div class="bau-confirm-divider"></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Motivo Abertura:</span><span class="bau-confirm-value">${_.reason||"---"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Tasks:</span><span class="bau-confirm-value">${v}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Justificativa BAU:</span><span class="bau-confirm-value">${_.nonImplementationReason||"---"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Descri\xE7\xE3o:</span><span class="bau-confirm-value">${_.description||"---"}</span></div>
            <div class="bau-confirm-row"><span class="bau-confirm-label">Pr\xF3ximo Contato:</span><span class="bau-confirm-value">${_.availability_1?_.availability_1.replace("T"," "):"N\xE3o definida"}</span></div>
        `}g.onsubmit=async w=>{if(w.preventDefault(),!b(a))return;let _=N.innerHTML;N.disabled=!0,N.innerHTML="Enviando...";try{let M=new FormData(g),m=Object.fromEntries(M.entries()),v=M.getAll("taskType"),C=o||{},$={...C,...m,taskType:v.length>0?v.join(", "):"Nenhuma"};await to($,C.agentEmail||"anon"),G.playSuccess(),q("success")}catch(M){console.error("Erro no envio BAU:",M),X("Falha ao enviar: "+(M.message||"Erro desconhecido"),{error:!0})}finally{N.disabled=!1,N.innerHTML=_}};function L(){g.reset(),a=1,F(),z.querySelectorAll(".bau-task-item.active").forEach(w=>w.classList.remove("active"))}let D=i.querySelector("#bau-new-case-btn");D&&(D.onclick=()=>{L(),q("form"),A()});let R=i.querySelector("#bau-form-back-btn");R&&(R.onclick=()=>q("dashboard"));let Y=i.querySelector("#bau-success-back-btn");Y&&(Y.onclick=()=>q("dashboard"));async function h(){t=!t,i.style.display=t?"flex":"none",t&&(q("dashboard"),k()),ue(t,i,"cw-btn-bauform")}return F(),h}function ia(){if(window.techSolInitialized){vt();return}window.techSolInitialized=!0;let t="v5.2";console.log(`\u{1F680} TechSol Suite Initializing (${t})...`);try{Rt();try{G.initGlobalListeners(),G.playStartup()}catch(d){console.warn("\xC1udio bloqueado:",d)}ce.fetchTips(),vt();let e=uo(),o=bo(),a=ho(),n=vo(),i=To(),s=ko(),r=Fo(),l=qo(),p=wo();ao({toggleNotes:e,toggleEmail:o,toggleScript:a,toggleLinks:n,toggleTimezone:i,toggleLibrary:s,toggleConfigs:r,toggleBAUForm:l,broadcastControl:p}),setTimeout(()=>{ce.logEvent("App","Start","Session Start"),So(),setTimeout(()=>{Eo(t)},500)},2500)}catch(e){console.error("Erro fatal na inicializa\xE7\xE3o:",e),X("Erro cr\xEDtico ao iniciar o Case Wizard.",{error:!0})}}ia();})();
