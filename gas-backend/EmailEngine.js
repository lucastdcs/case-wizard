...
const EMAIL_I18N = {
  pt: {
    ...
    createdMessage: function (adv) { return "A liderança acabou de **CRIAR O CASO BAU** para o anunciante <strong style=\"color:#202124;\">" + adv + "</strong>. Tudo pronto para o atendimento."; },
    ...
    discardSentMessage: function (adv) { return "Sua solicitação de **DESCARTE** para o anunciante <strong style=\"color:#202124;\">" + adv + "</strong> foi enviada para avaliação do TL."; },
    ...
    discardDoneMessage: function (adv) { return "O descarte do caso do anunciante <strong style=\"color:#202124;\">" + adv + "</strong> foi **APROVADO E CONCLUÍDO** pela liderança."; },
  ...
  es: {
    ...
    createdMessage: function (adv) { return "La gerencia acaba de **CREAR EL CASO BAU** para el anunciante <strong style=\"color:#202124;\">" + adv + "</strong>. Todo listo para la atención."; },
    createdFooter: "SOLICITUD CONCLUIDA",
    createdSubject: function (adv) { return "✅ Caso Creado: " + adv; },
    discardSentSubtitle: "Descarte Evaluation",
    discardSentGreeting: "¡Hola, Agente!",
    discardSentMessage: function (adv) { return "Tu solicitud de **DESCARTE** para el anunciante <strong style=\"color:#202124;\">" + adv + "</strong> fue enviada para evaluación del TL."; },
    ...
    discardDoneGreeting: "Aviso Importante,",
    discardDoneMessage: function (adv) { return "El descarte del caso del anunciante <strong style=\"color:#202124;\">" + adv + "</strong> fue **APROBADO Y CONCLUIDO** por la gerencia."; },
    discardDoneFooter: "CASO DESCARTADO",
    discardDoneSubject: function (adv) { return "❌ Caso Descartado: " + adv; },
    labelContext: "Contexto / Motivo",
